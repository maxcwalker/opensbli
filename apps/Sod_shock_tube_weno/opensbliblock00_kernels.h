...
void opensbliblock00Kernel010(double *rhou0_B0, double *rhoE_B0, double *rho_B0, double *x0_B0, const int *idx)
{
   double p = 0.0;
   double u0 = 0.0;
   double d = 0.0;
...
: (
   ...
   rhou0_B0[OPS_ACC0(0)] = d*u0;

   rhoE_B0[OPS_ACC1(0)] = 0.5*d*pow(u0, 2.0) + p/(gama - 1.0);

}

void opensbliblock00Kernel008(double *rhou0_B0, double *rhoE_B0, double *rho_B0)
{
   double p = 0.0;
   double u0 = 0.0;
   double d = 0.0;
...
void opensbliblock00Kernel009(double *rhou0_B0, double *rhoE_B0, double *rho_B0)
{
   double p = 0.0;
   double u0 = 0.0;
   double d = 0.0;
...
void opensbliblock00Kernel005(const double *rhou0_B0, const double *rho_B0, double *u0_B0)
{
   u0_B0[OPS_ACC2(0)] = rhou0_B0[OPS_ACC0(0)]/rho_B0[OPS_ACC1(0)];

}

void opensbliblock00Kernel002(const double *rhoE_B0, const double *rho_B0, const double *u0_B0, double *p_B0)
{
   p_B0[OPS_ACC3(0)] = (gama - 1)*(rhoE_B0[OPS_ACC0(0)] - rc0*rho_B0[OPS_ACC1(0)]*pow(u0_B0[OPS_ACC2(0)], 2));

}

void opensbliblock00Kernel001(const double *p_B0, const double *rho_B0, double *a_B0)
{
   a_B0[OPS_ACC2(0)] = sqrt(gama*p_B0[OPS_ACC0(0)]/rho_B0[OPS_ACC1(0)]);

}

 void opensbliblock00Kernel000(const double *p_B0, const double *a_B0, const double *rhou0_B0, const double *rhoE_B0,
const double *rho_B0, const double *u0_B0, double *wk2_B0, double *wk0_B0, double *wk1_B0)
{
   ...
   double CF_20 = 0.0;
   double omega_2 = 0.0;
   AVG_0_rho = sqrt(rho_B0[OPS_ACC4(0)]*rho_B0[OPS_ACC4(1)]);

   AVG_0_inv_rho = 1.0/(sqrt(rho_B0[OPS_ACC4(0)]) + sqrt(rho_B0[OPS_ACC4(1)]));

    AVG_0_u0 = AVG_0_inv_rho*(sqrt(rho_B0[OPS_ACC4(0)])*u0_B0[OPS_ACC5(0)] +
      sqrt(rho_B0[OPS_ACC4(1)])*u0_B0[OPS_ACC5(1)]);

    AVG_0_a = sqrt(gamma_m1*(AVG_0_inv_rho*((p_B0[OPS_ACC0(1)] + rhoE_B0[OPS_ACC3(1)])/sqrt(rho_B0[OPS_ACC4(1)]) +
      (p_B0[OPS_ACC0(0)] + rhoE_B0[OPS_ACC3(0)])/sqrt(rho_B0[OPS_ACC4(0)])) - rc0*pow(AVG_0_u0, 2)));
   ...
   AVG_0_0_LEV_22 = (rc0)*gamma_m1*pow(inv_AVG_a, 2);
    ...
    CF_00 = AVG_0_0_LEV_00*rhou0_B0[OPS_ACC2(-2)] + AVG_0_0_LEV_01*p_B0[OPS_ACC0(-2)] +
      AVG_0_0_LEV_01*rhou0_B0[OPS_ACC2(-2)]*u0_B0[OPS_ACC5(-2)] + AVG_0_0_LEV_02*p_B0[OPS_ACC0(-2)]*u0_B0[OPS_ACC5(-2)]
      + AVG_0_0_LEV_02*rhoE_B0[OPS_ACC3(-2)]*u0_B0[OPS_ACC5(-2)];

    CF_10 = AVG_0_0_LEV_10*rhou0_B0[OPS_ACC2(-2)] + AVG_0_0_LEV_11*p_B0[OPS_ACC0(-2)] +
      AVG_0_0_LEV_11*rhou0_B0[OPS_ACC2(-2)]*u0_B0[OPS_ACC5(-2)] + AVG_0_0_LEV_12*p_B0[OPS_ACC0(-2)]*u0_B0[OPS_ACC5(-2)]
      + AVG_0_0_LEV_12*rhoE_B0[OPS_ACC3(-2)]*u0_B0[OPS_ACC5(-2)];

    CF_20 = AVG_0_0_LEV_20*rhou0_B0[OPS_ACC2(-2)] + AVG_0_0_LEV_21*p_B0[OPS_ACC0(-2)] +
      AVG_0_0_LEV_21*rhou0_B0[OPS_ACC2(-2)]*u0_B0[OPS_ACC5(-2)] + AVG_0_0_LEV_22*p_B0[OPS_ACC0(-2)]*u0_B0[OPS_ACC5(-2)]
      + AVG_0_0_LEV_22*rhoE_B0[OPS_ACC3(-2)]*u0_B0[OPS_ACC5(-2)];

    CF_01 = AVG_0_0_LEV_00*rhou0_B0[OPS_ACC2(-1)] + AVG_0_0_LEV_01*p_B0[OPS_ACC0(-1)] +
      AVG_0_0_LEV_01*rhou0_B0[OPS_ACC2(-1)]*u0_B0[OPS_ACC5(-1)] + AVG_0_0_LEV_02*p_B0[OPS_ACC0(-1)]*u0_B0[OPS_ACC5(-1)]
      + AVG_0_0_LEV_02*rhoE_B0[OPS_ACC3(-1)]*u0_B0[OPS_ACC5(-1)];

    CF_11 = AVG_0_0_LEV_10*rhou0_B0[OPS_ACC2(-1)] + AVG_0_0_LEV_11*p_B0[OPS_ACC0(-1)] +
      AVG_0_0_LEV_11*rhou0_B0[OPS_ACC2(-1)]*u0_B0[OPS_ACC5(-1)] + AVG_0_0_LEV_12*p_B0[OPS_ACC0(-1)]*u0_B0[OPS_ACC5(-1)]
      + AVG_0_0_LEV_12*rhoE_B0[OPS_ACC3(-1)]*u0_B0[OPS_ACC5(-1)];

    CF_21 = AVG_0_0_LEV_20*rhou0_B0[OPS_ACC2(-1)] + AVG_0_0_LEV_21*p_B0[OPS_ACC0(-1)] +
      AVG_0_0_LEV_21*rhou0_B0[OPS_ACC2(-1)]*u0_B0[OPS_ACC5(-1)] + AVG_0_0_LEV_22*p_B0[OPS_ACC0(-1)]*u0_B0[OPS_ACC5(-1)]
      + AVG_0_0_LEV_22*rhoE_B0[OPS_ACC3(-1)]*u0_B0[OPS_ACC5(-1)];

    CF_02 = AVG_0_0_LEV_00*rhou0_B0[OPS_ACC2(0)] + AVG_0_0_LEV_01*p_B0[OPS_ACC0(0)] +
      AVG_0_0_LEV_01*rhou0_B0[OPS_ACC2(0)]*u0_B0[OPS_ACC5(0)] + AVG_0_0_LEV_02*p_B0[OPS_ACC0(0)]*u0_B0[OPS_ACC5(0)] +
      AVG_0_0_LEV_02*rhoE_B0[OPS_ACC3(0)]*u0_B0[OPS_ACC5(0)];

    CF_12 = AVG_0_0_LEV_10*rhou0_B0[OPS_ACC2(0)] + AVG_0_0_LEV_11*p_B0[OPS_ACC0(0)] +
      AVG_0_0_LEV_11*rhou0_B0[OPS_ACC2(0)]*u0_B0[OPS_ACC5(0)] + AVG_0_0_LEV_12*p_B0[OPS_ACC0(0)]*u0_B0[OPS_ACC5(0)] +
      AVG_0_0_LEV_12*rhoE_B0[OPS_ACC3(0)]*u0_B0[OPS_ACC5(0)];

    CF_22 = AVG_0_0_LEV_20*rhou0_B0[OPS_ACC2(0)] + AVG_0_0_LEV_21*p_B0[OPS_ACC0(0)] +
      AVG_0_0_LEV_21*rhou0_B0[OPS_ACC2(0)]*u0_B0[OPS_ACC5(0)] + AVG_0_0_LEV_22*p_B0[OPS_ACC0(0)]*u0_B0[OPS_ACC5(0)] +
      AVG_0_0_LEV_22*rhoE_B0[OPS_ACC3(0)]*u0_B0[OPS_ACC5(0)];

    CF_03 = AVG_0_0_LEV_00*rhou0_B0[OPS_ACC2(1)] + AVG_0_0_LEV_01*p_B0[OPS_ACC0(1)] +
      AVG_0_0_LEV_01*rhou0_B0[OPS_ACC2(1)]*u0_B0[OPS_ACC5(1)] + AVG_0_0_LEV_02*p_B0[OPS_ACC0(1)]*u0_B0[OPS_ACC5(1)] +
      AVG_0_0_LEV_02*rhoE_B0[OPS_ACC3(1)]*u0_B0[OPS_ACC5(1)];

    CF_13 = AVG_0_0_LEV_10*rhou0_B0[OPS_ACC2(1)] + AVG_0_0_LEV_11*p_B0[OPS_ACC0(1)] +
      AVG_0_0_LEV_11*rhou0_B0[OPS_ACC2(1)]*u0_B0[OPS_ACC5(1)] + AVG_0_0_LEV_12*p_B0[OPS_ACC0(1)]*u0_B0[OPS_ACC5(1)] +
      AVG_0_0_LEV_12*rhoE_B0[OPS_ACC3(1)]*u0_B0[OPS_ACC5(1)];

    CF_23 = AVG_0_0_LEV_20*rhou0_B0[OPS_ACC2(1)] + AVG_0_0_LEV_21*p_B0[OPS_ACC0(1)] +
      AVG_0_0_LEV_21*rhou0_B0[OPS_ACC2(1)]*u0_B0[OPS_ACC5(1)] + AVG_0_0_LEV_22*p_B0[OPS_ACC0(1)]*u0_B0[OPS_ACC5(1)] +
      AVG_0_0_LEV_22*rhoE_B0[OPS_ACC3(1)]*u0_B0[OPS_ACC5(1)];

    CF_04 = AVG_0_0_LEV_00*rhou0_B0[OPS_ACC2(2)] + AVG_0_0_LEV_01*p_B0[OPS_ACC0(2)] +
      AVG_0_0_LEV_01*rhou0_B0[OPS_ACC2(2)]*u0_B0[OPS_ACC5(2)] + AVG_0_0_LEV_02*p_B0[OPS_ACC0(2)]*u0_B0[OPS_ACC5(2)] +
      AVG_0_0_LEV_02*rhoE_B0[OPS_ACC3(2)]*u0_B0[OPS_ACC5(2)];

    CF_14 = AVG_0_0_LEV_10*rhou0_B0[OPS_ACC2(2)] + AVG_0_0_LEV_11*p_B0[OPS_ACC0(2)] +
      AVG_0_0_LEV_11*rhou0_B0[OPS_ACC2(2)]*u0_B0[OPS_ACC5(2)] + AVG_0_0_LEV_12*p_B0[OPS_ACC0(2)]*u0_B0[OPS_ACC5(2)] +
      AVG_0_0_LEV_12*rhoE_B0[OPS_ACC3(2)]*u0_B0[OPS_ACC5(2)];

    CF_24 = AVG_0_0_LEV_20*rhou0_B0[OPS_ACC2(2)] + AVG_0_0_LEV_21*p_B0[OPS_ACC0(2)] +
      AVG_0_0_LEV_21*rhou0_B0[OPS_ACC2(2)]*u0_B0[OPS_ACC5(2)] + AVG_0_0_LEV_22*p_B0[OPS_ACC0(2)]*u0_B0[OPS_ACC5(2)] +
      AVG_0_0_LEV_22*rhoE_B0[OPS_ACC3(2)]*u0_B0[OPS_ACC5(2)];

    CF_05 = AVG_0_0_LEV_00*rhou0_B0[OPS_ACC2(3)] + AVG_0_0_LEV_01*p_B0[OPS_ACC0(3)] +
      AVG_0_0_LEV_01*rhou0_B0[OPS_ACC2(3)]*u0_B0[OPS_ACC5(3)] + AVG_0_0_LEV_02*p_B0[OPS_ACC0(3)]*u0_B0[OPS_ACC5(3)] +
      AVG_0_0_LEV_02*rhoE_B0[OPS_ACC3(3)]*u0_B0[OPS_ACC5(3)];

    CF_15 = AVG_0_0_LEV_10*rhou0_B0[OPS_ACC2(3)] + AVG_0_0_LEV_11*p_B0[OPS_ACC0(3)] +
      AVG_0_0_LEV_11*rhou0_B0[OPS_ACC2(3)]*u0_B0[OPS_ACC5(3)] + AVG_0_0_LEV_12*p_B0[OPS_ACC0(3)]*u0_B0[OPS_ACC5(3)] +
      AVG_0_0_LEV_12*rhoE_B0[OPS_ACC3(3)]*u0_B0[OPS_ACC5(3)];

    CF_25 = AVG_0_0_LEV_20*rhou0_B0[OPS_ACC2(3)] + AVG_0_0_LEV_21*p_B0[OPS_ACC0(3)] +
      AVG_0_0_LEV_21*rhou0_B0[OPS_ACC2(3)]*u0_B0[OPS_ACC5(3)] + AVG_0_0_LEV_22*p_B0[OPS_ACC0(3)]*u0_B0[OPS_ACC5(3)] +
      AVG_0_0_LEV_22*rhoE_B0[OPS_ACC3(3)]*u0_B0[OPS_ACC5(3)];

    CS_00 = AVG_0_0_LEV_00*rho_B0[OPS_ACC4(-2)] + AVG_0_0_LEV_01*rhou0_B0[OPS_ACC2(-2)] +
      AVG_0_0_LEV_02*rhoE_B0[OPS_ACC3(-2)];

    CS_01 = AVG_0_0_LEV_00*rho_B0[OPS_ACC4(-1)] + AVG_0_0_LEV_01*rhou0_B0[OPS_ACC2(-1)] +
      AVG_0_0_LEV_02*rhoE_B0[OPS_ACC3(-1)];

    CS_02 = AVG_0_0_LEV_00*rho_B0[OPS_ACC4(0)] + AVG_0_0_LEV_01*rhou0_B0[OPS_ACC2(0)] +
      AVG_0_0_LEV_02*rhoE_B0[OPS_ACC3(0)];

    CS_03 = AVG_0_0_LEV_00*rho_B0[OPS_ACC4(1)] + AVG_0_0_LEV_01*rhou0_B0[OPS_ACC2(1)] +
      AVG_0_0_LEV_02*rhoE_B0[OPS_ACC3(1)];

    CS_04 = AVG_0_0_LEV_00*rho_B0[OPS_ACC4(2)] + AVG_0_0_LEV_01*rhou0_B0[OPS_ACC2(2)] +
      AVG_0_0_LEV_02*rhoE_B0[OPS_ACC3(2)];

    CS_05 = AVG_0_0_LEV_00*rho_B0[OPS_ACC4(3)] + AVG_0_0_LEV_01*rhou0_B0[OPS_ACC2(3)] +
      AVG_0_0_LEV_02*rhoE_B0[OPS_ACC3(3)];

    CS_10 = AVG_0_0_LEV_10*rho_B0[OPS_ACC4(-2)] + AVG_0_0_LEV_11*rhou0_B0[OPS_ACC2(-2)] +
      AVG_0_0_LEV_12*rhoE_B0[OPS_ACC3(-2)];

    CS_11 = AVG_0_0_LEV_10*rho_B0[OPS_ACC4(-1)] + AVG_0_0_LEV_11*rhou0_B0[OPS_ACC2(-1)] +
      AVG_0_0_LEV_12*rhoE_B0[OPS_ACC3(-1)];

    CS_12 = AVG_0_0_LEV_10*rho_B0[OPS_ACC4(0)] + AVG_0_0_LEV_11*rhou0_B0[OPS_ACC2(0)] +
      AVG_0_0_LEV_12*rhoE_B0[OPS_ACC3(0)];

    CS_13 = AVG_0_0_LEV_10*rho_B0[OPS_ACC4(1)] + AVG_0_0_LEV_11*rhou0_B0[OPS_ACC2(1)] +
      AVG_0_0_LEV_12*rhoE_B0[OPS_ACC3(1)];

    CS_14 = AVG_0_0_LEV_10*rho_B0[OPS_ACC4(2)] + AVG_0_0_LEV_11*rhou0_B0[OPS_ACC2(2)] +
      AVG_0_0_LEV_12*rhoE_B0[OPS_ACC3(2)];

    CS_15 = AVG_0_0_LEV_10*rho_B0[OPS_ACC4(3)] + AVG_0_0_LEV_11*rhou0_B0[OPS_ACC2(3)] +
      AVG_0_0_LEV_12*rhoE_B0[OPS_ACC3(3)];

    CS_20 = AVG_0_0_LEV_20*rho_B0[OPS_ACC4(-2)] + AVG_0_0_LEV_21*rhou0_B0[OPS_ACC2(-2)] +
      AVG_0_0_LEV_22*rhoE_B0[OPS_ACC3(-2)];

    CS_21 = AVG_0_0_LEV_20*rho_B0[OPS_ACC4(-1)] + AVG_0_0_LEV_21*rhou0_B0[OPS_ACC2(-1)] +
      AVG_0_0_LEV_22*rhoE_B0[OPS_ACC3(-1)];

    CS_22 = AVG_0_0_LEV_20*rho_B0[OPS_ACC4(0)] + AVG_0_0_LEV_21*rhou0_B0[OPS_ACC2(0)] +
      AVG_0_0_LEV_22*rhoE_B0[OPS_ACC3(0)];

    CS_23 = AVG_0_0_LEV_20*rho_B0[OPS_ACC4(1)] + AVG_0_0_LEV_21*rhou0_B0[OPS_ACC2(1)] +
      AVG_0_0_LEV_22*rhoE_B0[OPS_ACC3(1)];

    CS_24 = AVG_0_0_LEV_20*rho_B0[OPS_ACC4(2)] + AVG_0_0_LEV_21*rhou0_B0[OPS_ACC2(2)] +
      AVG_0_0_LEV_22*rhoE_B0[OPS_ACC3(2)];

    CS_25 = AVG_0_0_LEV_20*rho_B0[OPS_ACC4(3)] + AVG_0_0_LEV_21*rhou0_B0[OPS_ACC2(3)] +
      AVG_0_0_LEV_22*rhoE_B0[OPS_ACC3(3)];

    max_lambda_0_00 = fmax(fabs(a_B0[OPS_ACC1(-2)] - u0_B0[OPS_ACC5(-2)]), fmax(fabs(a_B0[OPS_ACC1(-1)] -
      u0_B0[OPS_ACC5(-1)]), fmax(fabs(a_B0[OPS_ACC1(2)] - u0_B0[OPS_ACC5(2)]), fmax(fabs(a_B0[OPS_ACC1(1)] -
      u0_B0[OPS_ACC5(1)]), fmax(fabs(a_B0[OPS_ACC1(3)] - u0_B0[OPS_ACC5(3)]), fabs(a_B0[OPS_ACC1(0)] -
      u0_B0[OPS_ACC5(0)]))))));

    max_lambda_0_11 = fmax(fabs(u0_B0[OPS_ACC5(1)]), fmax(fabs(u0_B0[OPS_ACC5(-2)]), fmax(fabs(u0_B0[OPS_ACC5(-1)]),
      fmax(fabs(u0_B0[OPS_ACC5(0)]), fmax(fabs(u0_B0[OPS_ACC5(3)]), fabs(u0_B0[OPS_ACC5(2)]))))));

    max_lambda_0_22 = fmax(fabs(a_B0[OPS_ACC1(1)] + u0_B0[OPS_ACC5(1)]), fmax(fabs(a_B0[OPS_ACC1(-2)] +
      u0_B0[OPS_ACC5(-2)]), fmax(fabs(a_B0[OPS_ACC1(0)] + u0_B0[OPS_ACC5(0)]), fmax(fabs(a_B0[OPS_ACC1(3)] +
      u0_B0[OPS_ACC5(3)]), fmax(fabs(a_B0[OPS_ACC1(-1)] + u0_B0[OPS_ACC5(-1)]), fabs(a_B0[OPS_ACC1(2)] +
      u0_B0[OPS_ACC5(2)]))))));
   ...
   wk0_B0[OPS_ACC7(0)] = Recon_0 + Recon_1 + Recon_2;

   wk1_B0[OPS_ACC8(0)] = AVG_0_u0*Recon_1 + Recon_0*(-AVG_0_a + AVG_0_u0) + Recon_2*(AVG_0_a + AVG_0_u0);

    wk2_B0[OPS_ACC6(0)] = (rc0)*pow(AVG_0_u0, 2)*Recon_1 + Recon_0*(rcinv19*pow(AVG_0_a, 2) - AVG_0_a*AVG_0_u0 +
      (rc0)*pow(AVG_0_u0, 2)) + Recon_2*(rcinv19*pow(AVG_0_a, 2) + AVG_0_a*AVG_0_u0 + (rc0)*pow(AVG_0_u0, 2));

}

 void opensbliblock00Kernel006(const double *wk2_B0, const double *wk0_B0, const double *wk1_B0, double *Residual1_B0,
double *Residual0_B0, double *Residual2_B0)
{
   Residual0_B0[OPS_ACC4(0)] = -rcinv20*(-wk0_B0[OPS_ACC1(-1)] + wk0_B0[OPS_ACC1(0)]);

   Residual1_B0[OPS_ACC3(0)] = -rcinv20*(-wk1_B0[OPS_ACC2(-1)] + wk1_B0[OPS_ACC2(0)]);

   Residual2_B0[OPS_ACC5(0)] = -rcinv20*(wk2_B0[OPS_ACC0(0)] - wk2_B0[OPS_ACC0(-1)]);

}

 void opensbliblock00Kernel011(const double *Residual1_B0, const double *Residual0_B0, const double *Residual2_B0,
double *tempRK_rho_B0, double *tempRK_rhou0_B0, double *tempRK_rhoE_B0, double *rhou0_B0, double *rhoE_B0, double
*rho_B0, const double *rkB, const double *rkA)
{
   tempRK_rho_B0[OPS_ACC3(0)] = dt*Residual0_B0[OPS_ACC1(0)] + rkA[0]*tempRK_rho_B0[OPS_ACC3(0)];

   rho_B0[OPS_ACC8(0)] = rkB[0]*tempRK_rho_B0[OPS_ACC3(0)] + rho_B0[OPS_ACC8(0)];

   tempRK_rhou0_B0[OPS_ACC4(0)] = dt*Residual1_B0[OPS_ACC0(0)] + rkA[0]*tempRK_rhou0_B0[OPS_ACC4(0)];

   rhou0_B0[OPS_ACC6(0)] = rkB[0]*tempRK_rhou0_B0[OPS_ACC4(0)] + rhou0_B0[OPS_ACC6(0)];

   tempRK_rhoE_B0[OPS_ACC5(0)] = dt*Residual2_B0[OPS_ACC2(0)] + rkA[0]*tempRK_rhoE_B0[OPS_ACC5(0)];

   rhoE_B0[OPS_ACC7(0)] = rkB[0]*tempRK_rhoE_B0[OPS_ACC5(0)] + rhoE_B0[OPS_ACC7(0)];
