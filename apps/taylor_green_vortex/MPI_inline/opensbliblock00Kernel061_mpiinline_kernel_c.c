  ...
  for ( int n_z=0; n_z<z_size; n_z++ ){
    for ( int n_y=0; n_y<y_size; n_y++ ){
      for ( int n_x=0; n_x<x_size; n_x++ ){
        ...
        ptr_double wk9_B0 = { wk9_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel061*1 + n_z * xdim1_opensbliblock00Kernel061 * ydim1_opensbliblock00Kernel061*1, xdim1_opensbliblock00Kernel061, ydim1_opensbliblock00Kernel061};
        
    OPS_ACC(wk9_B0, 0,0,0) = -rc8*inv_0*(OPS_ACC(u0_B0, 0,0,2) - 8*OPS_ACC(u0_B0, 0,0,1) - OPS_ACC(u0_B0, 0,0,-2) +
