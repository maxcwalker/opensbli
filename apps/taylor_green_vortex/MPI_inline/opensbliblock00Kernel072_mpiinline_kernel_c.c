  ...
  for ( int n_z=0; n_z<z_size; n_z++ ){
    for ( int n_y=0; n_y<y_size; n_y++ ){
      for ( int n_x=0; n_x<x_size; n_x++ ){
        const ptr_double u2_B0 = { u2_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel072*1 + n_z * xdim0_opensbliblock00Kernel072 * ydim0_opensbliblock00Kernel072*1, xdim0_opensbliblock00Kernel072, ydim0_opensbliblock00Kernel072};
    ...
    OPS_ACC(wk20_B0, 0,0,0) = -rc8*inv_2*(-OPS_ACC(u2_B0, -2,0,0) - 8*OPS_ACC(u2_B0, 1,0,0) +
