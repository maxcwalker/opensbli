...
void ops_par_loop_opensbliblock00Kernel043_execute(ops_kernel_descriptor *desc) {
  ...
  double * __restrict__ wk31_B0_p = (double *)(args[1].data + base1);
  ...
  for ( int n_z=start[2]; n_z<end[2]; n_z++ ){
    for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
      ...
      for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
        const ACC<double> rhou0_B0(xdim0_opensbliblock00Kernel043, ydim0_opensbliblock00Kernel043, rhou0_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel043*1 + n_z * xdim0_opensbliblock00Kernel043 * ydim0_opensbliblock00Kernel043*1);
        ACC<double> wk31_B0(xdim1_opensbliblock00Kernel043, ydim1_opensbliblock00Kernel043, wk31_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel043*1 + n_z * xdim1_opensbliblock00Kernel043 * ydim1_opensbliblock00Kernel043*1);
