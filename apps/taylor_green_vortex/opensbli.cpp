...
ops_halo_transfer(periodicBC_direction0_side0_81_block0);
ops_halo_transfer(periodicBC_direction0_side1_82_block0);
ops_halo_transfer(periodicBC_direction1_side0_83_block0);
ops_halo_transfer(periodicBC_direction1_side1_84_block0);
ops_halo_transfer(periodicBC_direction2_side0_85_block0);
ops_halo_transfer(periodicBC_direction2_side1_86_block0);
...
ops_par_loop(opensbliblock00Kernel004, "CRu2_B0", opensbliblock00, 3, iteration_range_4_block0,
ops_arg_dat(rho_B0, 1, stencil_0_00_00_00_3, "double", OPS_READ),
ops_arg_dat(rhou2_B0, 1, stencil_0_00_00_00_3, "double", OPS_READ),
...
ops_par_loop(opensbliblock00Kernel038, "CRu1_B0", opensbliblock00, 3, iteration_range_38_block0,
ops_arg_dat(rho_B0, 1, stencil_0_00_00_00_3, "double", OPS_READ),
ops_arg_dat(rhou1_B0, 1, stencil_0_00_00_00_3, "double", OPS_READ),
...
ops_par_loop(opensbliblock00Kernel011, "CRp_B0", opensbliblock00, 3, iteration_range_11_block0,
ops_arg_dat(rhoE_B0, 1, stencil_0_00_00_00_3, "double", OPS_READ),
ops_arg_dat(rho_B0, 1, stencil_0_00_00_00_3, "double", OPS_READ),
...
ops_par_loop(opensbliblock00Kernel002, "Convective CD rho_B0 x2 ", opensbliblock00, 3, iteration_range_2_block0,
...
ops_par_loop(opensbliblock00Kernel005, "Convective CD rhoE_B0*u2_B0 x2 ", opensbliblock00, 3, iteration_range_5_block0,
...
ops_par_loop(opensbliblock00Kernel007, "Convective CD rhou1_B0*u2_B0 x2 ", opensbliblock00, 3, iteration_range_7_block0,
...
ops_par_loop(opensbliblock00Kernel009, "Convective CD rhou0_B0*u2_B0 x2 ", opensbliblock00, 3, iteration_range_9_block0,
...
ops_par_loop(opensbliblock00Kernel010, "Convective CD rhoE_B0 x2 ", opensbliblock00, 3, iteration_range_10_block0,
...
ops_par_loop(opensbliblock00Kernel012, "Convective CD p_B0 x2 ", opensbliblock00, 3, iteration_range_12_block0,
...
ops_par_loop(opensbliblock00Kernel013, "Convective CD rhou0_B0 x2 ", opensbliblock00, 3, iteration_range_13_block0,
...
ops_par_loop(opensbliblock00Kernel015, "Convective CD rhou2_B0 x2 ", opensbliblock00, 3, iteration_range_15_block0,
...
ops_par_loop(opensbliblock00Kernel016, "Convective CD u2_B0 x2 ", opensbliblock00, 3, iteration_range_16_block0,
...
ops_par_loop(opensbliblock00Kernel017, "Convective CD rhou1_B0 x2 ", opensbliblock00, 3, iteration_range_17_block0,
...
ops_par_loop(opensbliblock00Kernel018, "Convective CD p_B0*u2_B0 x2 ", opensbliblock00, 3, iteration_range_18_block0,
...
ops_par_loop(opensbliblock00Kernel019, "Convective CD rho_B0*u2_B0 x2 ", opensbliblock00, 3, iteration_range_19_block0,
...
ops_par_loop(opensbliblock00Kernel020, "Convective CD rhou2_B0*u2_B0 x2 ", opensbliblock00, 3, iteration_range_20_block0,
...
ops_par_loop(opensbliblock00Kernel022, "Convective CD rhou0_B0 x0 ", opensbliblock00, 3, iteration_range_22_block0,
...
ops_par_loop(opensbliblock00Kernel025, "Convective CD rho_B0*u0_B0 x0 ", opensbliblock00, 3, iteration_range_25_block0,
...
ops_par_loop(opensbliblock00Kernel026, "Convective CD p_B0 x0 ", opensbliblock00, 3, iteration_range_26_block0,
...
ops_par_loop(opensbliblock00Kernel027, "Convective CD rho_B0 x0 ", opensbliblock00, 3, iteration_range_27_block0,
...
ops_par_loop(opensbliblock00Kernel028, "Convective CD p_B0*u0_B0 x0 ", opensbliblock00, 3, iteration_range_28_block0,
...
ops_par_loop(opensbliblock00Kernel029, "Convective CD rhou2_B0 x0 ", opensbliblock00, 3, iteration_range_29_block0,
...
ops_par_loop(opensbliblock00Kernel030, "Convective CD rhou0_B0*u0_B0 x0 ", opensbliblock00, 3, iteration_range_30_block0,
...
ops_par_loop(opensbliblock00Kernel031, "Convective CD rhou2_B0*u0_B0 x0 ", opensbliblock00, 3, iteration_range_31_block0,
...
ops_par_loop(opensbliblock00Kernel032, "Convective CD rhoE_B0*u0_B0 x0 ", opensbliblock00, 3, iteration_range_32_block0,
...
ops_par_loop(opensbliblock00Kernel033, "Convective CD u0_B0 x0 ", opensbliblock00, 3, iteration_range_33_block0,
...
ops_par_loop(opensbliblock00Kernel034, "Convective CD rhou1_B0*u0_B0 x0 ", opensbliblock00, 3, iteration_range_34_block0,
...
ops_par_loop(opensbliblock00Kernel035, "Convective CD rhoE_B0 x0 ", opensbliblock00, 3, iteration_range_35_block0,
ops_arg_dat(rhoE_B0, 1, stencil_0_22_00_00_8, "double", OPS_READ),
ops_arg_dat(wk25_B0, 1, stencil_0_00_00_00_3, "double", OPS_WRITE));

int iteration_range_36_block0[] = {0, block0np0, -2, block0np1 + 2, 0, block0np2};
ops_par_loop(opensbliblock00Kernel036, "Convective terms group 1", opensbliblock00, 3, iteration_range_36_block0,
ops_arg_dat(p_B0, 1, stencil_0_00_00_00_3, "double", OPS_READ),
ops_arg_dat(rhoE_B0, 1, stencil_0_00_00_00_3, "double", OPS_READ),
ops_arg_dat(rho_B0, 1, stencil_0_00_00_00_3, "double", OPS_READ),
ops_arg_dat(rhou0_B0, 1, stencil_0_00_00_00_3, "double", OPS_READ),
...
ops_par_loop(opensbliblock00Kernel037, "Convective CD rhou2_B0 x1 ", opensbliblock00, 3, iteration_range_37_block0,
...
ops_par_loop(opensbliblock00Kernel039, "Convective CD rhou0_B0*u1_B0 x1 ", opensbliblock00, 3, iteration_range_39_block0,
...
ops_par_loop(opensbliblock00Kernel040, "Convective CD u1_B0 x1 ", opensbliblock00, 3, iteration_range_40_block0,
...
ops_par_loop(opensbliblock00Kernel041, "Convective CD rhou1_B0*u1_B0 x1 ", opensbliblock00, 3, iteration_range_41_block0,
...
ops_par_loop(opensbliblock00Kernel042, "Convective CD p_B0*u1_B0 x1 ", opensbliblock00, 3, iteration_range_42_block0,
...
ops_par_loop(opensbliblock00Kernel043, "Convective CD rho_B0 x1 ", opensbliblock00, 3, iteration_range_43_block0,
...
ops_par_loop(opensbliblock00Kernel044, "Convective CD rhoE_B0*u1_B0 x1 ", opensbliblock00, 3, iteration_range_44_block0,
...
ops_par_loop(opensbliblock00Kernel045, "Convective CD rhou0_B0 x1 ", opensbliblock00, 3, iteration_range_45_block0,
...
ops_par_loop(opensbliblock00Kernel046, "Convective CD rho_B0*u1_B0 x1 ", opensbliblock00, 3, iteration_range_46_block0,
...
ops_par_loop(opensbliblock00Kernel047, "Convective CD p_B0 x1 ", opensbliblock00, 3, iteration_range_47_block0,
...
ops_par_loop(opensbliblock00Kernel048, "Convective CD rhoE_B0 x1 ", opensbliblock00, 3, iteration_range_48_block0,
...
ops_par_loop(opensbliblock00Kernel049, "Convective CD rhou2_B0*u1_B0 x1 ", opensbliblock00, 3, iteration_range_49_block0,
...
ops_par_loop(opensbliblock00Kernel050, "Convective CD rhou1_B0 x1 ", opensbliblock00, 3, iteration_range_50_block0,
...
int iteration_range_52_block0[] = {0, block0np0, 0, block0np1, -2, block0np2 + 2};
ops_par_loop(opensbliblock00Kernel052, "Viscous CD u2_B0 x1 ", opensbliblock00, 3, iteration_range_52_block0,
...
ops_par_loop(opensbliblock00Kernel054, "Viscous CD u2_B0 x2 x2 ", opensbliblock00, 3, iteration_range_54_block0,
...
ops_par_loop(opensbliblock00Kernel055, "Viscous CD T_B0 x2 x2 ", opensbliblock00, 3, iteration_range_55_block0,
ops_arg_dat(T_B0, 1, stencil_0_00_00_22_11, "double", OPS_READ),
ops_arg_dat(wk3_B0, 1, stencil_0_00_00_00_3, "double", OPS_WRITE));

int iteration_range_56_block0[] = {0, block0np0, -2, block0np1 + 2, 0, block0np2};
ops_par_loop(opensbliblock00Kernel056, "Viscous CD u1_B0 x0 ", opensbliblock00, 3, iteration_range_56_block0,
...
ops_par_loop(opensbliblock00Kernel060, "Viscous CD u2_B0 x2 ", opensbliblock00, 3, iteration_range_60_block0,
ops_arg_dat(u2_B0, 1, stencil_0_00_00_22_8, "double", OPS_READ),
ops_arg_dat(wk8_B0, 1, stencil_0_00_00_00_3, "double", OPS_WRITE));
...
ops_par_loop(opensbliblock00Kernel065, "Viscous CD u0_B0 x1 x1 ", opensbliblock00, 3, iteration_range_65_block0,
...
ops_par_loop(opensbliblock00Kernel066, "Viscous CD u0_B0 x1 ", opensbliblock00, 3, iteration_range_66_block0,
...
ops_par_loop(opensbliblock00Kernel067, "Viscous CD T_B0 x1 x1 ", opensbliblock00, 3, iteration_range_67_block0,
...
ops_par_loop(opensbliblock00Kernel069, "Viscous CD u0_B0 x2 x2 ", opensbliblock00, 3, iteration_range_69_block0,
...
ops_par_loop(opensbliblock00Kernel071, "Viscous CD u1_B0 x2 ", opensbliblock00, 3, iteration_range_71_block0,
...
ops_par_loop(opensbliblock00Kernel073, "Viscous CD u1_B0 x2 x2 ", opensbliblock00, 3, iteration_range_73_block0,
...
ops_par_loop(opensbliblock00Kernel074, "Viscous CD u0_B0 x2 ", opensbliblock00, 3, iteration_range_74_block0,
ops_arg_dat(u0_B0, 1, stencil_0_00_00_22_8, "double", OPS_READ),
ops_arg_dat(wk22_B0, 1, stencil_0_00_00_00_3, "double", OPS_WRITE));

int iteration_range_75_block0[] = {0, block0np0, 0, block0np1, -2, block0np2 + 2};
ops_par_loop(opensbliblock00Kernel075, "Viscous CD u2_B0 x0 ", opensbliblock00, 3, iteration_range_75_block0,
...
ops_par_loop(opensbliblock00Kernel076, "Viscous CD u2_B0 x0 x0 ", opensbliblock00, 3, iteration_range_76_block0,
...
ops_par_loop(opensbliblock00Kernel077, "Viscous CD u1_B0 x1 x1 ", opensbliblock00, 3, iteration_range_77_block0,
...
ops_arg_dat(wk4_B0, 1, stencil_0_00_22_00_8, "double", OPS_READ),
ops_arg_dat(wk5_B0, 1, stencil_0_00_00_00_3, "double", OPS_WRITE));

int iteration_range_58_block0[] = {0, block0np0, 0, block0np1, 0, block0np2};
ops_par_loop(opensbliblock00Kernel058, "Viscous CD CD u2_B0 x0 x2 ", opensbliblock00, 3, iteration_range_58_block0,
ops_arg_dat(wk23_B0, 1, stencil_0_00_00_22_8, "double", OPS_READ),
ops_arg_dat(wk6_B0, 1, stencil_0_00_00_00_3, "double", OPS_WRITE));

int iteration_range_61_block0[] = {0, block0np0, 0, block0np1, 0, block0np2};
ops_par_loop(opensbliblock00Kernel061, "Viscous CD CD u0_B0 x0 x2 ", opensbliblock00, 3, iteration_range_61_block0,
ops_arg_dat(wk16_B0, 1, stencil_0_00_00_22_8, "double", OPS_READ),
ops_arg_dat(wk9_B0, 1, stencil_0_00_00_00_3, "double", OPS_WRITE));

int iteration_range_62_block0[] = {0, block0np0, 0, block0np1, 0, block0np2};
ops_par_loop(opensbliblock00Kernel062, "Viscous CD CD u1_B0 x1 x2 ", opensbliblock00, 3, iteration_range_62_block0,
ops_arg_dat(wk1_B0, 1, stencil_0_00_00_22_8, "double", OPS_READ),
ops_arg_dat(wk10_B0, 1, stencil_0_00_00_00_3, "double", OPS_WRITE));

int iteration_range_63_block0[] = {0, block0np0, 0, block0np1, 0, block0np2};
ops_par_loop(opensbliblock00Kernel063, "Viscous CD CD u2_B0 x1 x2 ", opensbliblock00, 3, iteration_range_63_block0,
ops_arg_dat(wk0_B0, 1, stencil_0_00_00_22_8, "double", OPS_READ),
ops_arg_dat(wk11_B0, 1, stencil_0_00_00_00_3, "double", OPS_WRITE));

int iteration_range_78_block0[] = {0, block0np0, 0, block0np1, 0, block0np2};
ops_par_loop(opensbliblock00Kernel078, "Viscous CD CD u0_B0 x0 x1 ", opensbliblock00, 3, iteration_range_78_block0,
ops_arg_dat(wk16_B0, 1, stencil_0_00_22_00_8, "double", OPS_READ),
ops_arg_dat(wk26_B0, 1, stencil_0_00_00_00_3, "double", OPS_WRITE));
...
HDF5_IO_Write_0_opensbliblock00_dynamic(opensbliblock00, iter, rho_B0, rhou0_B0, rhou1_B0, rhou2_B0, rhoE_B0, HDF5_timing);
}
