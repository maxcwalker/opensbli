...
void opensbliblock00Kernel046_gpu(const ACC<double> &wk42_B0,
  ACC<double> &wk34_B0)
{
...
void ops_par_loop_opensbliblock00Kernel046_execute(ops_kernel_descriptor *desc) {
  ...
  if (x_size > 0 && y_size > 0 && z_size > 0)
    hipLaunchKernelGGL(ops_opensbliblock00Kernel046,grid ,tblock ,0 ,0 , (double *)p_a[0], (double *)p_a[1],x_size, y_size, z_size);
