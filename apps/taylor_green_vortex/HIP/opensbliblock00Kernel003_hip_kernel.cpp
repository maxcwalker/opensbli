...
//
__constant__ int dims_opensbliblock00Kernel003 [2][2];
static int dims_opensbliblock00Kernel003_h [2][2] = {{0}};

//user function
__device__

void opensbliblock00Kernel003_gpu(const ACC<double> &wk39_B0,
  ACC<double> &wk0_B0)
{
    wk0_B0(0,0,0) = inv_0*(-rc7*wk39_B0(0,0,-1) + (rc8)*wk39_B0(0,0,-2) -
      rc8*wk39_B0(0,0,2) + (rc7)*wk39_B0(0,0,1));
...
int size2 ){
  ...
  if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
    ...
    ACC<double> argp1(dims_opensbliblock00Kernel003[1][0], dims_opensbliblock00Kernel003[1][1], arg1);
...
void ops_par_loop_opensbliblock00Kernel003_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_opensbliblock00Kernel003_h[0][0] || ydim0 != dims_opensbliblock00Kernel003_h[0][1] || xdim1 != dims_opensbliblock00Kernel003_h[1][0] || ydim1 != dims_opensbliblock00Kernel003_h[1][1]) {
  ...
  if (x_size > 0 && y_size > 0 && z_size > 0)
    hipLaunchKernelGGL(ops_opensbliblock00Kernel003,grid ,tblock ,0 ,0 , (double *)p_a[0], (double *)p_a[1],x_size, y_size, z_size);
