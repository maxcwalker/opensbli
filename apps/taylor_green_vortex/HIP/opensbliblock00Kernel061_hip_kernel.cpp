...
//
__constant__ int dims_opensbliblock00Kernel061 [2][2];
static int dims_opensbliblock00Kernel061_h [2][2] = {{0}};

//user function
__device__

void opensbliblock00Kernel061_gpu(const ACC<double> &u0_B0,
  ACC<double> &wk9_B0)
{
    wk9_B0(0,0,0) = -rc8*inv_0*(u0_B0(0,0,2) - 8*u0_B0(0,0,1) - u0_B0(0,0,-2) +
      8*u0_B0(0,0,-1));
...
int size2 ){
  ...
  if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
    ...
    opensbliblock00Kernel061_gpu(argp0, argp1);
  }
...
void ops_par_loop_opensbliblock00Kernel061_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_opensbliblock00Kernel061_h[0][0] || ydim0 != dims_opensbliblock00Kernel061_h[0][1] || xdim1 != dims_opensbliblock00Kernel061_h[1][0] || ydim1 != dims_opensbliblock00Kernel061_h[1][1]) {
  ...
  if (x_size > 0 && y_size > 0 && z_size > 0)
    hipLaunchKernelGGL(ops_opensbliblock00Kernel061,grid ,tblock ,0 ,0 , (double *)p_a[0], (double *)p_a[1],x_size, y_size, z_size);
