...
//
__constant__ int dims_opensbliblock00Kernel016 [2][2];
static int dims_opensbliblock00Kernel016_h [2][2] = {{0}};

//user function
__device__

void opensbliblock00Kernel016_gpu(const ACC<double> &wk44_B0,
  ACC<double> &wk8_B0)
{
    wk8_B0(0,0,0) = inv_0*(-rc8*wk44_B0(0,0,2) + (rc7)*wk44_B0(0,0,1) -
      rc7*wk44_B0(0,0,-1) + (rc8)*wk44_B0(0,0,-2));
...
int size2 ){
  ...
  if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
    ...
    ACC<double> argp1(dims_opensbliblock00Kernel016[1][0], dims_opensbliblock00Kernel016[1][1], arg1);
...
void ops_par_loop_opensbliblock00Kernel016_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_opensbliblock00Kernel016_h[0][0] || ydim0 != dims_opensbliblock00Kernel016_h[0][1] || xdim1 != dims_opensbliblock00Kernel016_h[1][0] || ydim1 != dims_opensbliblock00Kernel016_h[1][1]) {
  ...
  if (x_size > 0 && y_size > 0 && z_size > 0)
    hipLaunchKernelGGL(ops_opensbliblock00Kernel016,grid ,tblock ,0 ,0 , (double *)p_a[0], (double *)p_a[1],x_size, y_size, z_size);
