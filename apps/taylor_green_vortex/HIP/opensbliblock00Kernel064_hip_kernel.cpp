...
//
__constant__ int dims_opensbliblock00Kernel064 [2][2];
static int dims_opensbliblock00Kernel064_h [2][2] = {{0}};

//user function
__device__

void opensbliblock00Kernel064_gpu(const ACC<double> &wk19_B0,
  ACC<double> &wk12_B0)
{
...
int size2 ){
  ...
  if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
    ...
    opensbliblock00Kernel064_gpu(argp0, argp1);
  }
...
void ops_par_loop_opensbliblock00Kernel064_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_opensbliblock00Kernel064_h[0][0] || ydim0 != dims_opensbliblock00Kernel064_h[0][1] || xdim1 != dims_opensbliblock00Kernel064_h[1][0] || ydim1 != dims_opensbliblock00Kernel064_h[1][1]) {
  ...
  if (x_size > 0 && y_size > 0 && z_size > 0)
    hipLaunchKernelGGL(ops_opensbliblock00Kernel064,grid ,tblock ,0 ,0 , (double *)p_a[0], (double *)p_a[1],x_size, y_size, z_size);
