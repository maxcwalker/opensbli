...
//
__constant__ int dims_opensbliblock00Kernel071 [2][2];
static int dims_opensbliblock00Kernel071_h [2][2] = {{0}};

//user function
__device__

void opensbliblock00Kernel071_gpu(const ACC<double> &u1_B0,
  ACC<double> &wk19_B0)
{
    wk19_B0(0,0,0) = -rc8*inv_1*(-u1_B0(0,-2,0) - 8*u1_B0(0,1,0) +
      8*u1_B0(0,-1,0) + u1_B0(0,2,0));
...
int size2 ){
  ...
  if (size0==-1) dims_opensbliblock00Kernel071[0][0]=0;
  ...
  if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
    const ACC<double> argp0(dims_opensbliblock00Kernel071[0][0], dims_opensbliblock00Kernel071[0][1], arg0);
    ACC<double> argp1(dims_opensbliblock00Kernel071[1][0], dims_opensbliblock00Kernel071[1][1], arg1);
    opensbliblock00Kernel071_gpu(argp0, argp1);
  }
...
void ops_par_loop_opensbliblock00Kernel071_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_opensbliblock00Kernel071_h[0][0] || ydim0 != dims_opensbliblock00Kernel071_h[0][1] || xdim1 != dims_opensbliblock00Kernel071_h[1][0] || ydim1 != dims_opensbliblock00Kernel071_h[1][1]) {
    ...
    hipSafeCall(block->instance->ostream(), hipMemcpyToSymbol(HIP_SYMBOL(dims_opensbliblock00Kernel071), dims_opensbliblock00Kernel071_h, sizeof(dims_opensbliblock00Kernel071)));
  }
  ...
  if (x_size > 0 && y_size > 0 && z_size > 0)
    hipLaunchKernelGGL(ops_opensbliblock00Kernel071,grid ,tblock ,0 ,0 , (double *)p_a[0], (double *)p_a[1],x_size, y_size, z_size);
