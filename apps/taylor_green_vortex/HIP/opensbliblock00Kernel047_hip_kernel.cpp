...
void opensbliblock00Kernel047_gpu(const ACC<double> &wk43_B0,
  ACC<double> &wk35_B0)
{
...
int size2 ){
  ...
  if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
    ...
    opensbliblock00Kernel047_gpu(argp0, argp1);
  }
...
void ops_par_loop_opensbliblock00Kernel047_execute(ops_kernel_descriptor *desc) {
  ...
  if (x_size > 0 && y_size > 0 && z_size > 0)
    hipLaunchKernelGGL(ops_opensbliblock00Kernel047,grid ,tblock ,0 ,0 , (double *)p_a[0], (double *)p_a[1],x_size, y_size, z_size);
