...
//
__constant__ int dims_opensbliblock00Kernel025 [2][2];
static int dims_opensbliblock00Kernel025_h [2][2] = {{0}};

//user function
__device__

void opensbliblock00Kernel025_gpu(const ACC<double> &wk39_B0,
  ACC<double> &wk15_B0)
{
    wk15_B0(0,0,0) = inv_1*(-rc7*wk39_B0(0,-1,0) + (rc8)*wk39_B0(0,-2,0) +
      (rc7)*wk39_B0(0,1,0) - rc8*wk39_B0(0,2,0));
...
int size2 ){
  ...
  if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
    ...
    ACC<double> argp1(dims_opensbliblock00Kernel025[1][0], dims_opensbliblock00Kernel025[1][1], arg1);
...
void ops_par_loop_opensbliblock00Kernel025_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_opensbliblock00Kernel025_h[0][0] || ydim0 != dims_opensbliblock00Kernel025_h[0][1] || xdim1 != dims_opensbliblock00Kernel025_h[1][0] || ydim1 != dims_opensbliblock00Kernel025_h[1][1]) {
  ...
  if (x_size > 0 && y_size > 0 && z_size > 0)
    hipLaunchKernelGGL(ops_opensbliblock00Kernel025,grid ,tblock ,0 ,0 , (double *)p_a[0], (double *)p_a[1],x_size, y_size, z_size);
