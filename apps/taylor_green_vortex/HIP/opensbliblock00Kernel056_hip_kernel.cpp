...
void opensbliblock00Kernel056_gpu(const ACC<double> &u2_B0,
  ACC<double> &wk4_B0)
{
    wk4_B0(0,0,0) = -rc8*inv_1*(-u2_B0(0,-2,0) - 8*u2_B0(0,1,0) + u2_B0(0,2,0) +
      8*u2_B0(0,-1,0));
...
int size2 ){
  ...
  if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
    ...
    opensbliblock00Kernel056_gpu(argp0, argp1);
  }
...
void ops_par_loop_opensbliblock00Kernel056_execute(ops_kernel_descriptor *desc) {
  ...
  if (x_size > 0 && y_size > 0 && z_size > 0)
    hipLaunchKernelGGL(ops_opensbliblock00Kernel056,grid ,tblock ,0 ,0 , (double *)p_a[0], (double *)p_a[1],x_size, y_size, z_size);
