...
//
__constant__ int dims_opensbliblock00Kernel004 [6][2];
static int dims_opensbliblock00Kernel004_h [6][2] = {{0}};

//user function
__device__

 void opensbliblock00Kernel004_gpu(const ACC<double> &u2_B0,
...
int size2 ){
  ...
  arg5 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel004[5][0] + idx_z * 1*1 * dims_opensbliblock00Kernel004[5][0] * dims_opensbliblock00Kernel004[5][1];
  ...
  if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
    ...
    const ACC<double> argp4(dims_opensbliblock00Kernel004[4][0], dims_opensbliblock00Kernel004[4][1], arg4);
    ACC<double> argp5(dims_opensbliblock00Kernel004[5][0], dims_opensbliblock00Kernel004[5][1], arg5);
...
void ops_par_loop_opensbliblock00Kernel004_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_opensbliblock00Kernel004_h[0][0] || ydim0 != dims_opensbliblock00Kernel004_h[0][1] || xdim1 != dims_opensbliblock00Kernel004_h[1][0] || ydim1 != dims_opensbliblock00Kernel004_h[1][1] || xdim2 != dims_opensbliblock00Kernel004_h[2][0] || ydim2 != dims_opensbliblock00Kernel004_h[2][1] || xdim3 != dims_opensbliblock00Kernel004_h[3][0] || ydim3 != dims_opensbliblock00Kernel004_h[3][1] || xdim4 != dims_opensbliblock00Kernel004_h[4][0] || ydim4 != dims_opensbliblock00Kernel004_h[4][1] || xdim5 != dims_opensbliblock00Kernel004_h[5][0] || ydim5 != dims_opensbliblock00Kernel004_h[5][1]) {
    ...
    dims_opensbliblock00Kernel004_h[5][1] = ydim5;
