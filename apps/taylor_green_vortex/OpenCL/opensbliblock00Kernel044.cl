...
void opensbliblock00Kernel044(const ptr_double u0_B0,
  ptr_double wk32_B0, const double inv_2, const double rc7, const double rc8)
{
    OPS_ACCS(wk32_B0, 0,0,0) = inv_2*(-rc8*OPS_ACCS(u0_B0, 2,0,0) + (rc8)*OPS_ACCS(u0_B0, -2,0,0) -
      rc7*OPS_ACCS(u0_B0, -1,0,0) + (rc7)*OPS_ACCS(u0_B0, 1,0,0));
