...
//
    ...
    void buildOpenCLKernels_opensbliblock00Kernel004(OPS_instance *instance, int xdim0, int ydim0, int xdim1, int ydim1, int xdim2, int ydim2, int xdim3, int ydim3, int xdim4, int ydim4, int xdim5, int ydim5) {
      ...
      if(!isbuilt_opensbliblock00Kernel004) {
        ...
        instance->ostream() <<"Compiling opensbliblock00Kernel004 "<<OCL_FMA<<" source -- start \n";
          ...
          if (pPath!=NULL)
            if(OCL_FMA)
              sprintf(buildOpts,"-cl-mad-enable -DOCL_FMA -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_opensbliblock00Kernel004=%d  -Dydim0_opensbliblock00Kernel004=%d  -Dxdim1_opensbliblock00Kernel004=%d  -Dydim1_opensbliblock00Kernel004=%d  -Dxdim2_opensbliblock00Kernel004=%d  -Dydim2_opensbliblock00Kernel004=%d  -Dxdim3_opensbliblock00Kernel004=%d  -Dydim3_opensbliblock00Kernel004=%d  -Dxdim4_opensbliblock00Kernel004=%d  -Dydim4_opensbliblock00Kernel004=%d  -Dxdim5_opensbliblock00Kernel004=%d  -Dydim5_opensbliblock00Kernel004=%d ", pPath, 32,xdim0,ydim0,xdim1,ydim1,xdim2,ydim2,xdim3,ydim3,xdim4,ydim4,xdim5,ydim5);
            else
        ...
        instance->opencl_instance->OPS_opencl_core.kernel[5] = clCreateKernel(instance->opencl_instance->OPS_opencl_core.program, "ops_opensbliblock00Kernel004", &ret);
        clSafeCall( ret );
...
void ops_par_loop_opensbliblock00Kernel004(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4, ops_arg arg5) {
  ...
  if (block->instance->OPS_diags > 1) {
    ops_timing_realloc(block->instance,5,"opensbliblock00Kernel004");
  ...
  if (globalWorkSize[0]>0 && globalWorkSize[1]>0 && globalWorkSize[2]>0) {
    ...
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[5], 7, sizeof(cl_double), (void*) &rc6 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[5], 8, sizeof(cl_int), (void*) &base0 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[5], 9, sizeof(cl_int), (void*) &base1 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[5], 10, sizeof(cl_int), (void*) &base2 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[5], 11, sizeof(cl_int), (void*) &base3 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[5], 12, sizeof(cl_int), (void*) &base4 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[5], 13, sizeof(cl_int), (void*) &base5 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[5], 14, sizeof(cl_int), (void*) &x_size ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[5], 15, sizeof(cl_int), (void*) &y_size ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[5], 16, sizeof(cl_int), (void*) &z_size ));
