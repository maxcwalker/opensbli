...
void opensbliblock00Kernel076(const ptr_double T_B0,
  ptr_double wk24_B0, const double inv_3, const double rc8)
{
    OPS_ACCS(wk24_B0, 0,0,0) = -rc8*inv_3*(30*OPS_ACCS(T_B0, 0,0,0) - 16*OPS_ACCS(T_B0, 0,1,0) + OPS_ACCS(T_B0, 0,2,0) -
      16*OPS_ACCS(T_B0, 0,-1,0) + OPS_ACCS(T_B0, 0,-2,0));
