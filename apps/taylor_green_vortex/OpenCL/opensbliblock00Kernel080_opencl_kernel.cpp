...
//
    ...
    void buildOpenCLKernels_opensbliblock00Kernel080(OPS_instance *instance, int xdim0, int ydim0, int xdim1, int ydim1, int xdim2, int ydim2, int xdim3, int ydim3, int xdim4, int ydim4, int xdim5, int ydim5, int xdim6, int ydim6, int xdim7, int ydim7, int xdim8, int ydim8, int xdim9, int ydim9, int xdim10, int ydim10, int xdim11, int ydim11, int xdim12, int ydim12, int xdim13, int ydim13, int xdim14, int ydim14, int xdim15, int ydim15, int xdim16, int ydim16, int xdim17, int ydim17, int xdim18, int ydim18, int xdim19, int ydim19, int xdim20, int ydim20, int xdim21, int ydim21, int xdim22, int ydim22, int xdim23, int ydim23, int xdim24, int ydim24, int xdim25, int ydim25, int xdim26, int ydim26, int xdim27, int ydim27, int xdim28, int ydim28, int xdim29, int ydim29, int xdim30, int ydim30, int xdim31, int ydim31, int xdim32, int ydim32, int xdim33, int ydim33) {
      ...
      if(!isbuilt_opensbliblock00Kernel080) {
        ...
        instance->ostream() <<"Compiling opensbliblock00Kernel080 "<<OCL_FMA<<" source -- start \n";
          ...
          if (pPath!=NULL)
            if(OCL_FMA)
              sprintf(buildOpts,"-cl-mad-enable -DOCL_FMA -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_opensbliblock00Kernel080=%d  -Dydim0_opensbliblock00Kernel080=%d  -Dxdim1_opensbliblock00Kernel080=%d  -Dydim1_opensbliblock00Kernel080=%d  -Dxdim2_opensbliblock00Kernel080=%d  -Dydim2_opensbliblock00Kernel080=%d  -Dxdim3_opensbliblock00Kernel080=%d  -Dydim3_opensbliblock00Kernel080=%d  -Dxdim4_opensbliblock00Kernel080=%d  -Dydim4_opensbliblock00Kernel080=%d  -Dxdim5_opensbliblock00Kernel080=%d  -Dydim5_opensbliblock00Kernel080=%d  -Dxdim6_opensbliblock00Kernel080=%d  -Dydim6_opensbliblock00Kernel080=%d  -Dxdim7_opensbliblock00Kernel080=%d  -Dydim7_opensbliblock00Kernel080=%d  -Dxdim8_opensbliblock00Kernel080=%d  -Dydim8_opensbliblock00Kernel080=%d  -Dxdim9_opensbliblock00Kernel080=%d  -Dydim9_opensbliblock00Kernel080=%d  -Dxdim10_opensbliblock00Kernel080=%d  -Dydim10_opensbliblock00Kernel080=%d  -Dxdim11_opensbliblock00Kernel080=%d  -Dydim11_opensbliblock00Kernel080=%d  -Dxdim12_opensbliblock00Kernel080=%d  -Dydim12_opensbliblock00Kernel080=%d  -Dxdim13_opensbliblock00Kernel080=%d  -Dydim13_opensbliblock00Kernel080=%d  -Dxdim14_opensbliblock00Kernel080=%d  -Dydim14_opensbliblock00Kernel080=%d  -Dxdim15_opensbliblock00Kernel080=%d  -Dydim15_opensbliblock00Kernel080=%d  -Dxdim16_opensbliblock00Kernel080=%d  -Dydim16_opensbliblock00Kernel080=%d  -Dxdim17_opensbliblock00Kernel080=%d  -Dydim17_opensbliblock00Kernel080=%d  -Dxdim18_opensbliblock00Kernel080=%d  -Dydim18_opensbliblock00Kernel080=%d  -Dxdim19_opensbliblock00Kernel080=%d  -Dydim19_opensbliblock00Kernel080=%d  -Dxdim20_opensbliblock00Kernel080=%d  -Dydim20_opensbliblock00Kernel080=%d  -Dxdim21_opensbliblock00Kernel080=%d  -Dydim21_opensbliblock00Kernel080=%d  -Dxdim22_opensbliblock00Kernel080=%d  -Dydim22_opensbliblock00Kernel080=%d  -Dxdim23_opensbliblock00Kernel080=%d  -Dydim23_opensbliblock00Kernel080=%d  -Dxdim24_opensbliblock00Kernel080=%d  -Dydim24_opensbliblock00Kernel080=%d  -Dxdim25_opensbliblock00Kernel080=%d  -Dydim25_opensbliblock00Kernel080=%d  -Dxdim26_opensbliblock00Kernel080=%d  -Dydim26_opensbliblock00Kernel080=%d  -Dxdim27_opensbliblock00Kernel080=%d  -Dydim27_opensbliblock00Kernel080=%d  -Dxdim28_opensbliblock00Kernel080=%d  -Dydim28_opensbliblock00Kernel080=%d  -Dxdim29_opensbliblock00Kernel080=%d  -Dydim29_opensbliblock00Kernel080=%d  -Dxdim30_opensbliblock00Kernel080=%d  -Dydim30_opensbliblock00Kernel080=%d  -Dxdim31_opensbliblock00Kernel080=%d  -Dydim31_opensbliblock00Kernel080=%d  -Dxdim32_opensbliblock00Kernel080=%d  -Dydim32_opensbliblock00Kernel080=%d  -Dxdim33_opensbliblock00Kernel080=%d  -Dydim33_opensbliblock00Kernel080=%d ", pPath, 32,xdim0,ydim0,xdim1,ydim1,xdim2,ydim2,xdim3,ydim3,xdim4,ydim4,xdim5,ydim5,xdim6,ydim6,xdim7,ydim7,xdim8,ydim8,xdim9,ydim9,xdim10,ydim10,xdim11,ydim11,xdim12,ydim12,xdim13,ydim13,xdim14,ydim14,xdim15,ydim15,xdim16,ydim16,xdim17,ydim17,xdim18,ydim18,xdim19,ydim19,xdim20,ydim20,xdim21,ydim21,xdim22,ydim22,xdim23,ydim23,xdim24,ydim24,xdim25,ydim25,xdim26,ydim26,xdim27,ydim27,xdim28,ydim28,xdim29,ydim29,xdim30,ydim30,xdim31,ydim31,xdim32,ydim32,xdim33,ydim33);
            else
          ...
          instance->ostream() << "compiling opensbliblock00Kernel080 -- done\n";

        // Create the OpenCL kernel
        instance->opencl_instance->OPS_opencl_core.kernel[77] = clCreateKernel(instance->opencl_instance->OPS_opencl_core.program, "ops_opensbliblock00Kernel080", &ret);
        clSafeCall( ret );

        isbuilt_opensbliblock00Kernel080 = true;
        free(source_str[0]);
      }
...
void ops_par_loop_opensbliblock00Kernel080(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg29, ops_arg arg30, ops_arg arg31, ops_arg arg32, ops_arg arg33) {
  ...
  #ifdef CHECKPOINTING
  if (!ops_checkpointing_before(args,34,range,77)) return;
  #endif

  if (block->instance->OPS_diags > 1) {
    ops_timing_realloc(block->instance,77,"opensbliblock00Kernel080");
  ...
  buildOpenCLKernels_opensbliblock00Kernel080(block->instance,
  ...
  if (globalWorkSize[0]>0 && globalWorkSize[1]>0 && globalWorkSize[2]>0) {
    ...
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[77], 2, sizeof(cl_mem), (void*) &arg2.data_d ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[77], 3, sizeof(cl_mem), (void*) &arg3.data_d ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[77], 4, sizeof(cl_mem), (void*) &arg4.data_d ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[77], 5, sizeof(cl_mem), (void*) &arg5.data_d ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[77], 6, sizeof(cl_mem), (void*) &arg6.data_d ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[77], 7, sizeof(cl_mem), (void*) &arg7.data_d ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[77], 8, sizeof(cl_mem), (void*) &arg8.data_d ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[77], 9, sizeof(cl_mem), (void*) &arg9.data_d ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[77], 10, sizeof(cl_mem), (void*) &arg10.data_d ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[77], 11, sizeof(cl_mem), (void*) &arg11.data_d ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[77], 12, sizeof(cl_mem), (void*) &arg12.data_d ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[77], 13, sizeof(cl_mem), (void*) &arg13.data_d ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[77], 14, sizeof(cl_mem), (void*) &arg14.data_d ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[77], 15, sizeof(cl_mem), (void*) &arg15.data_d ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[77], 16, sizeof(cl_mem), (void*) &arg16.data_d ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[77], 17, sizeof(cl_mem), (void*) &arg17.data_d ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[77], 18, sizeof(cl_mem), (void*) &arg18.data_d ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[77], 19, sizeof(cl_mem), (void*) &arg19.data_d ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[77], 20, sizeof(cl_mem), (void*) &arg20.data_d ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[77], 21, sizeof(cl_mem), (void*) &arg21.data_d ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[77], 22, sizeof(cl_mem), (void*) &arg22.data_d ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[77], 23, sizeof(cl_mem), (void*) &arg23.data_d ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[77], 24, sizeof(cl_mem), (void*) &arg24.data_d ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[77], 25, sizeof(cl_mem), (void*) &arg25.data_d ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[77], 26, sizeof(cl_mem), (void*) &arg26.data_d ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[77], 27, sizeof(cl_mem), (void*) &arg27.data_d ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[77], 28, sizeof(cl_mem), (void*) &arg28.data_d ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[77], 29, sizeof(cl_mem), (void*) &arg29.data_d ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[77], 30, sizeof(cl_mem), (void*) &arg30.data_d ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[77], 31, sizeof(cl_mem), (void*) &arg31.data_d ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[77], 32, sizeof(cl_mem), (void*) &arg32.data_d ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[77], 33, sizeof(cl_mem), (void*) &arg33.data_d ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[77], 34, sizeof(cl_double), (void*) &rc7 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[77], 35, sizeof(cl_double), (void*) &rcinv9 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[77], 36, sizeof(cl_double), (void*) &rc10 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[77], 37, sizeof(cl_double), (void*) &rc11 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[77], 38, sizeof(cl_double), (void*) &rcinv12 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[77], 39, sizeof(cl_double), (void*) &rcinv13 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[77], 40, sizeof(cl_double), (void*) &rcinv14 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[77], 41, sizeof(cl_int), (void*) &base0 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[77], 42, sizeof(cl_int), (void*) &base1 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[77], 43, sizeof(cl_int), (void*) &base2 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[77], 44, sizeof(cl_int), (void*) &base3 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[77], 45, sizeof(cl_int), (void*) &base4 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[77], 46, sizeof(cl_int), (void*) &base5 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[77], 47, sizeof(cl_int), (void*) &base6 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[77], 48, sizeof(cl_int), (void*) &base7 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[77], 49, sizeof(cl_int), (void*) &base8 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[77], 50, sizeof(cl_int), (void*) &base9 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[77], 51, sizeof(cl_int), (void*) &base10 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[77], 52, sizeof(cl_int), (void*) &base11 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[77], 53, sizeof(cl_int), (void*) &base12 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[77], 54, sizeof(cl_int), (void*) &base13 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[77], 55, sizeof(cl_int), (void*) &base14 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[77], 56, sizeof(cl_int), (void*) &base15 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[77], 57, sizeof(cl_int), (void*) &base16 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[77], 58, sizeof(cl_int), (void*) &base17 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[77], 59, sizeof(cl_int), (void*) &base18 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[77], 60, sizeof(cl_int), (void*) &base19 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[77], 61, sizeof(cl_int), (void*) &base20 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[77], 62, sizeof(cl_int), (void*) &base21 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[77], 63, sizeof(cl_int), (void*) &base22 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[77], 64, sizeof(cl_int), (void*) &base23 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[77], 65, sizeof(cl_int), (void*) &base24 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[77], 66, sizeof(cl_int), (void*) &base25 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[77], 67, sizeof(cl_int), (void*) &base26 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[77], 68, sizeof(cl_int), (void*) &base27 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[77], 69, sizeof(cl_int), (void*) &base28 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[77], 70, sizeof(cl_int), (void*) &base29 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[77], 71, sizeof(cl_int), (void*) &base30 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[77], 72, sizeof(cl_int), (void*) &base31 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[77], 73, sizeof(cl_int), (void*) &base32 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[77], 74, sizeof(cl_int), (void*) &base33 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[77], 75, sizeof(cl_int), (void*) &x_size ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[77], 76, sizeof(cl_int), (void*) &y_size ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[77], 77, sizeof(cl_int), (void*) &z_size ));
  ...
  if (block->instance->OPS_diags > 1) {
    ...
    block->instance->OPS_kernels[77].transfer += ops_compute_transfer(dim, start, end, &arg2);
    block->instance->OPS_kernels[77].transfer += ops_compute_transfer(dim, start, end, &arg3);
    block->instance->OPS_kernels[77].transfer += ops_compute_transfer(dim, start, end, &arg4);
    block->instance->OPS_kernels[77].transfer += ops_compute_transfer(dim, start, end, &arg5);
    block->instance->OPS_kernels[77].transfer += ops_compute_transfer(dim, start, end, &arg6);
    block->instance->OPS_kernels[77].transfer += ops_compute_transfer(dim, start, end, &arg7);
    block->instance->OPS_kernels[77].transfer += ops_compute_transfer(dim, start, end, &arg8);
    block->instance->OPS_kernels[77].transfer += ops_compute_transfer(dim, start, end, &arg9);
    block->instance->OPS_kernels[77].transfer += ops_compute_transfer(dim, start, end, &arg10);
    block->instance->OPS_kernels[77].transfer += ops_compute_transfer(dim, start, end, &arg11);
    block->instance->OPS_kernels[77].transfer += ops_compute_transfer(dim, start, end, &arg12);
    block->instance->OPS_kernels[77].transfer += ops_compute_transfer(dim, start, end, &arg13);
    block->instance->OPS_kernels[77].transfer += ops_compute_transfer(dim, start, end, &arg14);
    block->instance->OPS_kernels[77].transfer += ops_compute_transfer(dim, start, end, &arg15);
    block->instance->OPS_kernels[77].transfer += ops_compute_transfer(dim, start, end, &arg16);
    block->instance->OPS_kernels[77].transfer += ops_compute_transfer(dim, start, end, &arg17);
    block->instance->OPS_kernels[77].transfer += ops_compute_transfer(dim, start, end, &arg18);
    block->instance->OPS_kernels[77].transfer += ops_compute_transfer(dim, start, end, &arg19);
    block->instance->OPS_kernels[77].transfer += ops_compute_transfer(dim, start, end, &arg20);
    block->instance->OPS_kernels[77].transfer += ops_compute_transfer(dim, start, end, &arg21);
    block->instance->OPS_kernels[77].transfer += ops_compute_transfer(dim, start, end, &arg22);
    block->instance->OPS_kernels[77].transfer += ops_compute_transfer(dim, start, end, &arg23);
    block->instance->OPS_kernels[77].transfer += ops_compute_transfer(dim, start, end, &arg24);
    block->instance->OPS_kernels[77].transfer += ops_compute_transfer(dim, start, end, &arg25);
    block->instance->OPS_kernels[77].transfer += ops_compute_transfer(dim, start, end, &arg26);
    block->instance->OPS_kernels[77].transfer += ops_compute_transfer(dim, start, end, &arg27);
    block->instance->OPS_kernels[77].transfer += ops_compute_transfer(dim, start, end, &arg28);
    block->instance->OPS_kernels[77].transfer += ops_compute_transfer(dim, start, end, &arg29);
    block->instance->OPS_kernels[77].transfer += ops_compute_transfer(dim, start, end, &arg30);
    block->instance->OPS_kernels[77].transfer += ops_compute_transfer(dim, start, end, &arg31);
    block->instance->OPS_kernels[77].transfer += ops_compute_transfer(dim, start, end, &arg32);
    block->instance->OPS_kernels[77].transfer += ops_compute_transfer(dim, start, end, &arg33);
  }
}
