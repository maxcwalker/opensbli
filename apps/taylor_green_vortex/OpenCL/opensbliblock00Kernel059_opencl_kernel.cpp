...
//
    ...
    void buildOpenCLKernels_opensbliblock00Kernel059(OPS_instance *instance, int xdim0, int ydim0, int xdim1, int ydim1) {
      ...
      if(!isbuilt_opensbliblock00Kernel059) {
        ...
        instance->ostream() <<"Compiling opensbliblock00Kernel059 "<<OCL_FMA<<" source -- start \n";
          ...
          if (pPath!=NULL)
            if(OCL_FMA)
              sprintf(buildOpts,"-cl-mad-enable -DOCL_FMA -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_opensbliblock00Kernel059=%d  -Dydim0_opensbliblock00Kernel059=%d  -Dxdim1_opensbliblock00Kernel059=%d  -Dydim1_opensbliblock00Kernel059=%d ", pPath, 32,xdim0,ydim0,xdim1,ydim1);
            else
              sprintf(buildOpts,"-cl-mad-enable -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_opensbliblock00Kernel059=%d  -Dydim0_opensbliblock00Kernel059=%d  -Dxdim1_opensbliblock00Kernel059=%d  -Dydim1_opensbliblock00Kernel059=%d ", pPath, 32,xdim0,ydim0,xdim1,ydim1);
          else {
        ...
        instance->opencl_instance->OPS_opencl_core.kernel[55] = clCreateKernel(instance->opencl_instance->OPS_opencl_core.program, "ops_opensbliblock00Kernel059", &ret);
        clSafeCall( ret );
...
void ops_par_loop_opensbliblock00Kernel059(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1) {
  ...
  if (block->instance->OPS_diags > 1) {
    ops_timing_realloc(block->instance,55,"opensbliblock00Kernel059");
  ...
  if (globalWorkSize[0]>0 && globalWorkSize[1]>0 && globalWorkSize[2]>0) {
    ...
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[55], 2, sizeof(cl_double), (void*) &inv_5 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[55], 3, sizeof(cl_double), (void*) &rc8 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[55], 4, sizeof(cl_int), (void*) &base0 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[55], 5, sizeof(cl_int), (void*) &base1 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[55], 6, sizeof(cl_int), (void*) &x_size ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[55], 7, sizeof(cl_int), (void*) &y_size ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[55], 8, sizeof(cl_int), (void*) &z_size ));
