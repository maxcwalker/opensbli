...
//
    ...
    void buildOpenCLKernels_opensbliblock00Kernel007(OPS_instance *instance, int xdim0, int ydim0, int xdim1, int ydim1) {
      ...
      if(!isbuilt_opensbliblock00Kernel007) {
        ...
        instance->ostream() <<"Compiling opensbliblock00Kernel007 "<<OCL_FMA<<" source -- start \n";
          ...
          if (pPath!=NULL)
            if(OCL_FMA)
              sprintf(buildOpts,"-cl-mad-enable -DOCL_FMA -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_opensbliblock00Kernel007=%d  -Dydim0_opensbliblock00Kernel007=%d  -Dxdim1_opensbliblock00Kernel007=%d  -Dydim1_opensbliblock00Kernel007=%d ", pPath, 32,xdim0,ydim0,xdim1,ydim1);
            else
              sprintf(buildOpts,"-cl-mad-enable -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_opensbliblock00Kernel007=%d  -Dydim0_opensbliblock00Kernel007=%d  -Dxdim1_opensbliblock00Kernel007=%d  -Dydim1_opensbliblock00Kernel007=%d ", pPath, 32,xdim0,ydim0,xdim1,ydim1);
          else {
        ...
        instance->opencl_instance->OPS_opencl_core.kernel[10] = clCreateKernel(instance->opencl_instance->OPS_opencl_core.program, "ops_opensbliblock00Kernel007", &ret);
        clSafeCall( ret );
...
void ops_par_loop_opensbliblock00Kernel007(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1) {
  ...
  if (block->instance->OPS_diags > 1) {
    ops_timing_realloc(block->instance,10,"opensbliblock00Kernel007");
  ...
  if (globalWorkSize[0]>0 && globalWorkSize[1]>0 && globalWorkSize[2]>0) {
    ...
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[10], 7, sizeof(cl_int), (void*) &x_size ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[10], 8, sizeof(cl_int), (void*) &y_size ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[10], 9, sizeof(cl_int), (void*) &z_size ));
