...
void opensbliblock00Kernel058(const ptr_double u1_B0,
  ptr_double wk6_B0, const double inv_2, const double rc8)
{
    OPS_ACCS(wk6_B0, 0,0,0) = -rc8*inv_2*(-OPS_ACCS(u1_B0, -2,0,0) - 8*OPS_ACCS(u1_B0, 1,0,0) + OPS_ACCS(u1_B0, 2,0,0) +
      8*OPS_ACCS(u1_B0, -1,0,0));
