...
//
__constant__ int dims_opensbliblock00Kernel070 [2][2];
static int dims_opensbliblock00Kernel070_h [2][2] = {0};

//user function
__device__

void opensbliblock00Kernel070_gpu(const ACC<double> &wk4_B0,
  ACC<double> &wk18_B0)
{
    wk18_B0(0,0,0) = -rc8*inv_0*(-wk4_B0(0,0,-2) - 8*wk4_B0(0,0,1) +
      8*wk4_B0(0,0,-1) + wk4_B0(0,0,2));
...
int size2 ){
  ...
  if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
    ...
    ACC<double> argp1(dims_opensbliblock00Kernel070[1][0], dims_opensbliblock00Kernel070[1][1], arg1);
    opensbliblock00Kernel070_gpu(argp0, argp1);
  }
...
void ops_par_loop_opensbliblock00Kernel070_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_opensbliblock00Kernel070_h[0][0] || ydim0 != dims_opensbliblock00Kernel070_h[0][1] || xdim1 != dims_opensbliblock00Kernel070_h[1][0] || ydim1 != dims_opensbliblock00Kernel070_h[1][1]) {
  ...
  if (x_size > 0 && y_size > 0 && z_size > 0)
    ops_opensbliblock00Kernel070<<<grid, tblock >>> (  (double *)p_a[0], (double *)p_a[1],x_size, y_size, z_size);
