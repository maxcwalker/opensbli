...
void opensbliblock00Kernel038_gpu(const ACC<double> &rhou0_B0,
...
int size2 ){
  ...
  if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
    ...
    ACC<double> argp2(dims_opensbliblock00Kernel038[2][0], dims_opensbliblock00Kernel038[2][1], arg2);
    opensbliblock00Kernel038_gpu(argp0, argp1, argp2);
  }
...
void ops_par_loop_opensbliblock00Kernel038_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_opensbliblock00Kernel038_h[0][0] || ydim0 != dims_opensbliblock00Kernel038_h[0][1] || xdim1 != dims_opensbliblock00Kernel038_h[1][0] || ydim1 != dims_opensbliblock00Kernel038_h[1][1] || xdim2 != dims_opensbliblock00Kernel038_h[2][0] || ydim2 != dims_opensbliblock00Kernel038_h[2][1]) {
