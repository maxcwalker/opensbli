...
void ops_par_loop_opensbliblock00Kernel009_execute(ops_kernel_descriptor *desc) {
  ...
  double* phi_RKold_B0_p = (double*)args[1].data_d;

  int base2 = args[2].dat->base_offset/sizeof(double);
  double* phi_B0_p = (double*)args[2].data_d;

  double rknew_val = *(double *)args[3].data;
  ...
  if ((end[0]-start[0])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      , [=](cl::sycl::nd_item<1> item
        ...
        const ACC<double> phi_RKold_B0(&phi_RKold_B0_p[0] + base1 + n_x*1);
        ACC<double> phi_B0(&phi_B0_p[0] + base2 + n_x*1);
        const double *rknew = &rknew_val;
        //USER CODE
        if (n_x < end_0) {
          
   phi_B0(0) = rknew[0]*dt_sycl[0]*Residual0_B0(0) + phi_RKold_B0(0);
