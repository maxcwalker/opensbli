...
void ops_par_loop_opensbliblock00Kernel008_execute(ops_kernel_descriptor *desc) {
  ...
  double rkold_val = *(double *)args[2].data;
  ...
  if ((end[0]-start[0])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      , [=](cl::sycl::nd_item<1> item
        ...
        ACC<double> phi_RKold_B0(&phi_RKold_B0_p[0] + base1 + n_x*1);
        const double *rkold = &rkold_val;
        //USER CODE
        if (n_x < end_0) {
          
   phi_RKold_B0(0) = rkold[0]*dt_sycl[0]*Residual0_B0(0) + phi_RKold_B0(0);
