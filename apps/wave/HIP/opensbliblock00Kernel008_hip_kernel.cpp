...
void opensbliblock00Kernel008_gpu(const ACC<double> &Residual0_B0,
  ACC<double> &phi_RKold_B0,
  const double *rkold)
{
   phi_RKold_B0(0) = dt*rkold[0]*Residual0_B0(0) + phi_RKold_B0(0);
...
int size0 ){
  ...
  if (idx_x < size0) {
    ...
    opensbliblock00Kernel008_gpu(argp0, argp1, &arg2);
  }
