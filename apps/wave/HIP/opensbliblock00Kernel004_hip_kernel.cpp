...
//
__constant__ int dims_opensbliblock00Kernel004 [2][1];
static int dims_opensbliblock00Kernel004_h [2][1] = {{0}};
...
int size0 ){
  ...
  if (idx_x < size0) {
    ...
    opensbliblock00Kernel004_gpu(argp0, argp1);
  }
...
void ops_par_loop_opensbliblock00Kernel004_execute(ops_kernel_descriptor *desc) {
  ...
  if (x_size > 0)
    hipLaunchKernelGGL(ops_opensbliblock00Kernel004,grid ,tblock ,0 ,0 , (double *)p_a[0], (double *)p_a[1],x_size);
