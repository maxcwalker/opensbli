...
//
__constant__ int dims_opensbliblock00Kernel007 [2][1];
static int dims_opensbliblock00Kernel007_h [2][1] = {{0}};

//user function
__device__

void opensbliblock00Kernel007_gpu(const ACC<double> &phi_B0,
...
void ops_par_loop_opensbliblock00Kernel007_execute(ops_kernel_descriptor *desc) {
  ...
  if (x_size > 0)
    hipLaunchKernelGGL(ops_opensbliblock00Kernel007,grid ,tblock ,0 ,0 , (double *)p_a[0], (double *)p_a[1],x_size);
