...
void opensbliblock00Kernel003_gpu(const ACC<double> &phi_B0,
  ACC<double> &wk0_B0)
{
...
void ops_par_loop_opensbliblock00Kernel003_execute(ops_kernel_descriptor *desc) {
  ...
  if (x_size > 0)
    hipLaunchKernelGGL(ops_opensbliblock00Kernel003,grid ,tblock ,0 ,0 , (double *)p_a[0], (double *)p_a[1],x_size);
