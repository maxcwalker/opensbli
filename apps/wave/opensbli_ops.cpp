...
ops_init(argc,argv,1);
  ops_init_backend();ops_decl_const2( "block0np0",1, "int",&block0np0);ops_decl_const2( "Delta0block0",1, "double",&Delta0block0);ops_decl_const2( "c0",1, "double",&c0);ops_decl_const2( "niter",1, "int",&niter);ops_decl_const2( "dt",1, "double",&dt);ops_decl_const2( "inv_0",1, "double",&inv_0);ops_decl_const2( "rc1",1, "double",&rc1);ops_decl_const2( "rc2",1, "double",&rc2);
...
int iteration_range_0_block0[] = {-5, block0np0 + 5}; ops_par_loop_opensbliblock00Kernel000("Grid_based_initialisation0", opensbliblock00, 1, iteration_range_0_block0,
...
int iteration_range_7_block0[] = {0, block0np0}; ops_par_loop_opensbliblock00Kernel007("Save equations", opensbliblock00, 1, iteration_range_7_block0,
             ops_arg_dat(phi_B0, 1, stencil_0_00, "double", OPS_READ),
             ops_arg_dat(phi_RKold_B0, 1, stencil_0_00, "double", OPS_WRITE));

for(int stage=0; stage<=2; stage++)
{
int iteration_range_3_block0[] = {0, block0np0}; ops_par_loop_opensbliblock00Kernel003("Convective CD phi_B0 x0 ", opensbliblock00, 1, iteration_range_3_block0,
             ops_arg_dat(phi_B0, 1, stencil_0_01, "double", OPS_READ),
             ops_arg_dat(wk0_B0, 1, stencil_0_00, "double", OPS_WRITE));

int iteration_range_4_block0[] = {0, block0np0}; ops_par_loop_opensbliblock00Kernel004("Convective residual ", opensbliblock00, 1, iteration_range_4_block0,
             ops_arg_dat(wk0_B0, 1, stencil_0_00, "double", OPS_READ),
             ops_arg_dat(Residual0_B0, 1, stencil_0_00, "double", OPS_WRITE));

int iteration_range_9_block0[] = {0, block0np0}; ops_par_loop_opensbliblock00Kernel009("Sub stage advancement", opensbliblock00, 1, iteration_range_9_block0,
...
int iteration_range_8_block0[] = {0, block0np0}; ops_par_loop_opensbliblock00Kernel008("Temporal solution advancement", opensbliblock00, 1, iteration_range_8_block0,
             ops_arg_dat(Residual0_B0, 1, stencil_0_00, "double", OPS_READ),
