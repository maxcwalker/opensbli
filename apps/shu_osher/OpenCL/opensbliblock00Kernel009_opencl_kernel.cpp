...
//
    ...
    void buildOpenCLKernels_opensbliblock00Kernel009(OPS_instance *instance, int xdim0, int xdim1, int xdim2) {
      ...
      if(!isbuilt_opensbliblock00Kernel009) {
        ...
        instance->opencl_instance->OPS_opencl_core.kernel[2] = clCreateKernel(instance->opencl_instance->OPS_opencl_core.program, "ops_opensbliblock00Kernel009", &ret);
        clSafeCall( ret );
...
void ops_par_loop_opensbliblock00Kernel009(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2, ops_arg arg3) {
  ...
  if (globalWorkSize[0]>0 && globalWorkSize[1]>0 && globalWorkSize[2]>0) {
    ...
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[2], 3, sizeof(cl_double), (void*) &Delta0block0 ));
    ...
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[2], 9, sizeof(cl_int), (void*) &x_size ));
