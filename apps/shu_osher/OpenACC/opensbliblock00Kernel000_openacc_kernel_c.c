  ...
  ptr_double wk1_B0)
{
   ...
   AVG_0_inv_rho = 1.0/(sqrt(OPS_ACC(rho_B0, 0)) + sqrt(OPS_ACC(rho_B0, 1)));
    ...
    AVG_0_u0 = AVG_0_inv_rho*(sqrt(OPS_ACC(rho_B0, 0))*OPS_ACC(u0_B0, 0) +
      sqrt(OPS_ACC(rho_B0, 1))*OPS_ACC(u0_B0, 1));
   ...
   AVG_0_0_LEV_22 = (rc0)*gamma_m1*pow(inv_AVG_a, 2);
    ...
    max_lambda_0_00 = fmax(fabs(OPS_ACC(a_B0, 3) - OPS_ACC(u0_B0, 3)), fmax(fabs(OPS_ACC(a_B0, -1) -
      OPS_ACC(u0_B0, -1)), fmax(fabs(OPS_ACC(a_B0, 2) - OPS_ACC(u0_B0, 2)), fmax(fabs(OPS_ACC(a_B0, 0) -
      OPS_ACC(u0_B0, 0)), fmax(fabs(OPS_ACC(a_B0, -2) - OPS_ACC(u0_B0, -2)), fabs(OPS_ACC(a_B0, 1) -
      OPS_ACC(u0_B0, 1)))))));

    max_lambda_0_11 = fmax(fabs(OPS_ACC(u0_B0, 3)), fmax(fabs(OPS_ACC(u0_B0, 2)), fmax(fabs(OPS_ACC(u0_B0, 1)),
      fmax(fabs(OPS_ACC(u0_B0, 0)), fmax(fabs(OPS_ACC(u0_B0, -1)), fabs(OPS_ACC(u0_B0, -2)))))));

    max_lambda_0_22 = fmax(fabs(OPS_ACC(a_B0, 0) + OPS_ACC(u0_B0, 0)), fmax(fabs(OPS_ACC(a_B0, 3) +
      OPS_ACC(u0_B0, 3)), fmax(fabs(OPS_ACC(a_B0, 1) + OPS_ACC(u0_B0, 1)), fmax(fabs(OPS_ACC(a_B0, -2) +
      OPS_ACC(u0_B0, -2)), fmax(fabs(OPS_ACC(a_B0, -1) + OPS_ACC(u0_B0, -1)), fabs(OPS_ACC(a_B0, 2) +
      OPS_ACC(u0_B0, 2)))))));
