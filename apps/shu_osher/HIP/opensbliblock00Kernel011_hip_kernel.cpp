...
//
__constant__ int dims_opensbliblock00Kernel011 [11][1];
static int dims_opensbliblock00Kernel011_h [11][1] = {{0}};

//user function
__device__

 void opensbliblock00Kernel011_gpu(const ACC<double> &Residual1_B0,
  ...
  const double *rkA)
{
   ...
   rho_B0(0) = rkB[0]*tempRK_rho_B0(0) + rho_B0(0);

   tempRK_rhou0_B0(0) = dt*Residual1_B0(0) + rkA[0]*tempRK_rhou0_B0(0);

   rhou0_B0(0) = rkB[0]*tempRK_rhou0_B0(0) + rhou0_B0(0);

   tempRK_rhoE_B0(0) = dt*Residual2_B0(0) + rkA[0]*tempRK_rhoE_B0(0);

   rhoE_B0(0) = rkB[0]*tempRK_rhoE_B0(0) + rhoE_B0(0);
...
int size0 ){
  ...
  if (idx_x < size0) {
    ...
    opensbliblock00Kernel011_gpu(argp0, argp1, argp2, argp3,
...
void ops_par_loop_opensbliblock00Kernel011_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_opensbliblock00Kernel011_h[0][0] || xdim1 != dims_opensbliblock00Kernel011_h[1][0] || xdim2 != dims_opensbliblock00Kernel011_h[2][0] || xdim3 != dims_opensbliblock00Kernel011_h[3][0] || xdim4 != dims_opensbliblock00Kernel011_h[4][0] || xdim5 != dims_opensbliblock00Kernel011_h[5][0] || xdim6 != dims_opensbliblock00Kernel011_h[6][0] || xdim7 != dims_opensbliblock00Kernel011_h[7][0] || xdim8 != dims_opensbliblock00Kernel011_h[8][0]) {
    ...
    dims_opensbliblock00Kernel011_h[7][0] = xdim7;
    dims_opensbliblock00Kernel011_h[8][0] = xdim8;
