...
void opensbliblock00Kernel064_c_wrapper(
  ...
  for ( int n_y=0; n_y<y_size; n_y++ ){
   ...
   OPS_ACC(rhoE_B0, 0,0) = Twall*rcinv9*OPS_ACC(rho_B0, 0,0)/(gama*(gama - 1.0));
   ...
   OPS_ACC(rhoE_B0, 0,-1) = rcinv5*Pwall + (rc10)*rho_halo_1*(pow(u01, 2) + pow(u11, 2));
   ...
   OPS_ACC(rhoE_B0, 0,-2) = rcinv5*Pwall + (rc10)*rho_halo_2*(pow(u02, 2) + pow(u12, 2));
   ...
   OPS_ACC(rhoE_B0, 0,-3) = rcinv5*Pwall + (rc10)*rho_halo_3*(pow(u03, 2) + pow(u13, 2));
