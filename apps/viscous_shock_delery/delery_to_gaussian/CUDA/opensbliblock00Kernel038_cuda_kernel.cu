  ...
  const int *idx)
{
   ...
   (rc30)*T_B0(0,0) + (rc27)*T_B0(0,4) -
      rc31*T_B0(0,3) + (rc32)*T_B0(0,2) - rc29*T_B0(0,1)
)
: ((idx[1] == 1) ? (

      (rc27)*T_B0(0,-1) - rc13*T_B0(0,0) - rc8*T_B0(0,3) + (rc18)*T_B0(0,2) +
      (rc10)*T_B0(0,1)
)
: ((idx[1] == block0np1 - 1) ? (
   -rc29*T_B0(0,-1) +
      (rc32)*T_B0(0,-2) + (rc30)*T_B0(0,0) - rc31*T_B0(0,-3) +
      (rc27)*T_B0(0,-4)
)
: ((idx[1] == block0np1 - 2) ? (
   (rc10)*T_B0(0,-1) +
      (rc18)*T_B0(0,-2) - rc13*T_B0(0,0) - rc8*T_B0(0,-3) + (rc27)*T_B0(0,1)
)
:
      (
   -rc8*T_B0(0,-2) + (rc33)*T_B0(0,-1) - rc34*T_B0(0,0) - rc8*T_B0(0,2)
      + (rc33)*T_B0(0,1)
)))));
