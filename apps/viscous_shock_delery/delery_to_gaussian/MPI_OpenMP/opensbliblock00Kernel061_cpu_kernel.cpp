...
void ops_par_loop_opensbliblock00Kernel061_execute(ops_kernel_descriptor *desc) {
  ...
  double * __restrict__ wk11_B0_p = (double *)(args[0].data + base0);

  int base1 = args[1].dat->base_offset;
  double * __restrict__ mu_B0_p = (double *)(args[1].data + base1);

  int base2 = args[2].dat->base_offset;
  double * __restrict__ SD001_B0_p = (double *)(args[2].data + base2);

  int base3 = args[3].dat->base_offset;
  double * __restrict__ wk10_B0_p = (double *)(args[3].data + base3);
  ...
  double * __restrict__ wk16_B0_p = (double *)(args[15].data + base15);
  ...
  double * __restrict__ D00_B0_p = (double *)(args[19].data + base19);
  ...
  double * __restrict__ D10_B0_p = (double *)(args[23].data + base23);

  int base24 = args[24].dat->base_offset;
  double * __restrict__ SD011_B0_p = (double *)(args[24].data + base24);
  ...
  double * __restrict__ wk14_B0_p = (double *)(args[28].data + base28);

  int base29 = args[29].dat->base_offset;
  double * __restrict__ SD110_B0_p = (double *)(args[29].data + base29);

  int base30 = args[30].dat->base_offset;
  double * __restrict__ wk15_B0_p = (double *)(args[30].data + base30);
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
      const ACC<double> wk11_B0(xdim0_opensbliblock00Kernel061, wk11_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel061*1);
      const ACC<double> mu_B0(xdim1_opensbliblock00Kernel061, mu_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel061*1);
      const ACC<double> SD001_B0(xdim2_opensbliblock00Kernel061, SD001_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel061*1);
      const ACC<double> wk10_B0(xdim3_opensbliblock00Kernel061, wk10_B0_p + n_x*1 + n_y * xdim3_opensbliblock00Kernel061*1);
      const ACC<double> SD111_B0(xdim4_opensbliblock00Kernel061, SD111_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel061*1);
      const ACC<double> D01_B0(xdim5_opensbliblock00Kernel061, D01_B0_p + n_x*1 + n_y * xdim5_opensbliblock00Kernel061*1);
      const ACC<double> wk0_B0(xdim6_opensbliblock00Kernel061, wk0_B0_p + n_x*1 + n_y * xdim6_opensbliblock00Kernel061*1);
      const ACC<double> u0_B0(xdim7_opensbliblock00Kernel061, u0_B0_p + n_x*1 + n_y * xdim7_opensbliblock00Kernel061*1);
      const ACC<double> wk12_B0(xdim8_opensbliblock00Kernel061, wk12_B0_p + n_x*1 + n_y * xdim8_opensbliblock00Kernel061*1);
      const ACC<double> SD100_B0(xdim9_opensbliblock00Kernel061, SD100_B0_p + n_x*1 + n_y * xdim9_opensbliblock00Kernel061*1);
      const ACC<double> D11_B0(xdim10_opensbliblock00Kernel061, D11_B0_p + n_x*1 + n_y * xdim10_opensbliblock00Kernel061*1);
      const ACC<double> wk1_B0(xdim11_opensbliblock00Kernel061, wk1_B0_p + n_x*1 + n_y * xdim11_opensbliblock00Kernel061*1);
      const ACC<double> wk4_B0(xdim12_opensbliblock00Kernel061, wk4_B0_p + n_x*1 + n_y * xdim12_opensbliblock00Kernel061*1);
      ...
      const ACC<double> wk16_B0(xdim15_opensbliblock00Kernel061, wk16_B0_p + n_x*1 + n_y * xdim15_opensbliblock00Kernel061*1);
      const ACC<double> SD000_B0(xdim16_opensbliblock00Kernel061, SD000_B0_p + n_x*1 + n_y * xdim16_opensbliblock00Kernel061*1);
      const ACC<double> wk7_B0(xdim17_opensbliblock00Kernel061, wk7_B0_p + n_x*1 + n_y * xdim17_opensbliblock00Kernel061*1);
      const ACC<double> SD101_B0(xdim18_opensbliblock00Kernel061, SD101_B0_p + n_x*1 + n_y * xdim18_opensbliblock00Kernel061*1);
      const ACC<double> D00_B0(xdim19_opensbliblock00Kernel061, D00_B0_p + n_x*1 + n_y * xdim19_opensbliblock00Kernel061*1);
      const ACC<double> SD010_B0(xdim20_opensbliblock00Kernel061, SD010_B0_p + n_x*1 + n_y * xdim20_opensbliblock00Kernel061*1);
      const ACC<double> wk2_B0(xdim21_opensbliblock00Kernel061, wk2_B0_p + n_x*1 + n_y * xdim21_opensbliblock00Kernel061*1);
      const ACC<double> wk3_B0(xdim22_opensbliblock00Kernel061, wk3_B0_p + n_x*1 + n_y * xdim22_opensbliblock00Kernel061*1);
      const ACC<double> D10_B0(xdim23_opensbliblock00Kernel061, D10_B0_p + n_x*1 + n_y * xdim23_opensbliblock00Kernel061*1);
      const ACC<double> SD011_B0(xdim24_opensbliblock00Kernel061, SD011_B0_p + n_x*1 + n_y * xdim24_opensbliblock00Kernel061*1);
      ...
      const ACC<double> wk14_B0(xdim28_opensbliblock00Kernel061, wk14_B0_p + n_x*1 + n_y * xdim28_opensbliblock00Kernel061*1);
      const ACC<double> SD110_B0(xdim29_opensbliblock00Kernel061, SD110_B0_p + n_x*1 + n_y * xdim29_opensbliblock00Kernel061*1);
      const ACC<double> wk15_B0(xdim30_opensbliblock00Kernel061, wk15_B0_p + n_x*1 + n_y * xdim30_opensbliblock00Kernel061*1);
    ...
    Residual1_B0(0,0) = rcinv35*(D00_B0(0,0)*wk14_B0(0,0) +
      D10_B0(0,0)*wk13_B0(0,0))*((rc33)*D00_B0(0,0)*wk11_B0(0,0) -
      rc7*D01_B0(0,0)*wk16_B0(0,0) + (rc33)*D10_B0(0,0)*wk12_B0(0,0) -
      rc7*D11_B0(0,0)*wk9_B0(0,0)) + rcinv35*(D01_B0(0,0)*wk14_B0(0,0) +
      D11_B0(0,0)*wk13_B0(0,0))*(D00_B0(0,0)*wk16_B0(0,0) +
      D01_B0(0,0)*wk11_B0(0,0) + D10_B0(0,0)*wk9_B0(0,0) +
      D11_B0(0,0)*wk12_B0(0,0)) + rcinv35*((rc33)*pow(D00_B0(0,0),
      2)*wk2_B0(0,0) + (rc18)*D00_B0(0,0)*D01_B0(0,0)*wk4_B0(0,0) +
      (rc36)*D00_B0(0,0)*D10_B0(0,0)*wk6_B0(0,0) +
      (rc18)*D00_B0(0,0)*D11_B0(0,0)*wk0_B0(0,0) +
      (rc33)*D00_B0(0,0)*SD000_B0(0,0)*wk11_B0(0,0) -
      rc7*D00_B0(0,0)*SD010_B0(0,0)*wk16_B0(0,0) +
      (rc33)*D00_B0(0,0)*SD100_B0(0,0)*wk12_B0(0,0) -
      rc7*D00_B0(0,0)*SD110_B0(0,0)*wk9_B0(0,0) + pow(D01_B0(0,0),
      2)*wk2_B0(0,0) + (rc18)*D01_B0(0,0)*D10_B0(0,0)*wk0_B0(0,0) +
      2*D01_B0(0,0)*D11_B0(0,0)*wk6_B0(0,0) +
      D01_B0(0,0)*SD000_B0(0,0)*wk16_B0(0,0) +
      D01_B0(0,0)*SD010_B0(0,0)*wk11_B0(0,0) +
      D01_B0(0,0)*SD100_B0(0,0)*wk9_B0(0,0) +
      D01_B0(0,0)*SD110_B0(0,0)*wk12_B0(0,0) + (rc33)*pow(D10_B0(0,0),
      2)*wk7_B0(0,0) + (rc18)*D10_B0(0,0)*D11_B0(0,0)*wk15_B0(0,0) +
      (rc33)*D10_B0(0,0)*SD001_B0(0,0)*wk11_B0(0,0) -
      rc7*D10_B0(0,0)*SD011_B0(0,0)*wk16_B0(0,0) +
      (rc33)*D10_B0(0,0)*SD101_B0(0,0)*wk12_B0(0,0) -
      rc7*D10_B0(0,0)*SD111_B0(0,0)*wk9_B0(0,0) + pow(D11_B0(0,0),
      2)*wk7_B0(0,0) + D11_B0(0,0)*SD001_B0(0,0)*wk16_B0(0,0) +
      D11_B0(0,0)*SD011_B0(0,0)*wk11_B0(0,0) +
      D11_B0(0,0)*SD101_B0(0,0)*wk9_B0(0,0) +
      D11_B0(0,0)*SD111_B0(0,0)*wk12_B0(0,0))*mu_B0(0,0) +
      Residual1_B0(0,0);

    Residual2_B0(0,0) = rcinv35*(D00_B0(0,0)*wk14_B0(0,0) +
      D10_B0(0,0)*wk13_B0(0,0))*(D00_B0(0,0)*wk16_B0(0,0) +
      D01_B0(0,0)*wk11_B0(0,0) + D10_B0(0,0)*wk9_B0(0,0) +
      D11_B0(0,0)*wk12_B0(0,0)) + rcinv35*(D01_B0(0,0)*wk14_B0(0,0) +
      D11_B0(0,0)*wk13_B0(0,0))*(-rc7*D00_B0(0,0)*wk11_B0(0,0) +
      (rc33)*D01_B0(0,0)*wk16_B0(0,0) - rc7*D10_B0(0,0)*wk12_B0(0,0) +
      (rc33)*D11_B0(0,0)*wk9_B0(0,0)) + rcinv35*(pow(D00_B0(0,0),
      2)*wk4_B0(0,0) + (rc18)*D00_B0(0,0)*D01_B0(0,0)*wk2_B0(0,0) +
      2*D00_B0(0,0)*D10_B0(0,0)*wk0_B0(0,0) +
      (rc18)*D00_B0(0,0)*D11_B0(0,0)*wk6_B0(0,0) +
      D00_B0(0,0)*SD000_B0(0,0)*wk16_B0(0,0) +
      D00_B0(0,0)*SD010_B0(0,0)*wk11_B0(0,0) +
      D00_B0(0,0)*SD100_B0(0,0)*wk9_B0(0,0) +
      D00_B0(0,0)*SD110_B0(0,0)*wk12_B0(0,0) + (rc33)*pow(D01_B0(0,0),
      2)*wk4_B0(0,0) + (rc18)*D01_B0(0,0)*D10_B0(0,0)*wk6_B0(0,0) +
      (rc36)*D01_B0(0,0)*D11_B0(0,0)*wk0_B0(0,0) -
      rc7*D01_B0(0,0)*SD000_B0(0,0)*wk11_B0(0,0) +
      (rc33)*D01_B0(0,0)*SD010_B0(0,0)*wk16_B0(0,0) -
      rc7*D01_B0(0,0)*SD100_B0(0,0)*wk12_B0(0,0) +
      (rc33)*D01_B0(0,0)*SD110_B0(0,0)*wk9_B0(0,0) + pow(D10_B0(0,0),
      2)*wk15_B0(0,0) + (rc18)*D10_B0(0,0)*D11_B0(0,0)*wk7_B0(0,0) +
      D10_B0(0,0)*SD001_B0(0,0)*wk16_B0(0,0) +
      D10_B0(0,0)*SD011_B0(0,0)*wk11_B0(0,0) +
      D10_B0(0,0)*SD101_B0(0,0)*wk9_B0(0,0) +
      D10_B0(0,0)*SD111_B0(0,0)*wk12_B0(0,0) + (rc33)*pow(D11_B0(0,0),
      2)*wk15_B0(0,0) - rc7*D11_B0(0,0)*SD001_B0(0,0)*wk11_B0(0,0) +
      (rc33)*D11_B0(0,0)*SD011_B0(0,0)*wk16_B0(0,0) -
      rc7*D11_B0(0,0)*SD101_B0(0,0)*wk12_B0(0,0) +
      (rc33)*D11_B0(0,0)*SD111_B0(0,0)*wk9_B0(0,0))*mu_B0(0,0) +
      Residual2_B0(0,0);

    Residual3_B0(0,0) = rcinv35*rcinv37*rcinv4*rcinv5*(D00_B0(0,0)*wk14_B0(0,0) +
      D10_B0(0,0)*wk13_B0(0,0))*(D00_B0(0,0)*wk3_B0(0,0) +
      D10_B0(0,0)*wk5_B0(0,0)) +
      rcinv35*rcinv37*rcinv4*rcinv5*(D01_B0(0,0)*wk14_B0(0,0) +
      D11_B0(0,0)*wk13_B0(0,0))*(D01_B0(0,0)*wk3_B0(0,0) +
      D11_B0(0,0)*wk5_B0(0,0)) + rcinv35*rcinv37*rcinv4*rcinv5*(pow(D00_B0(0,0),
      2)*wk1_B0(0,0) + 2*D00_B0(0,0)*D10_B0(0,0)*wk8_B0(0,0) +
      D00_B0(0,0)*SD000_B0(0,0)*wk3_B0(0,0) +
      D00_B0(0,0)*SD100_B0(0,0)*wk5_B0(0,0) + pow(D01_B0(0,0),
      2)*wk1_B0(0,0) + 2*D01_B0(0,0)*D11_B0(0,0)*wk8_B0(0,0) +
      D01_B0(0,0)*SD010_B0(0,0)*wk3_B0(0,0) +
      D01_B0(0,0)*SD110_B0(0,0)*wk5_B0(0,0) + pow(D10_B0(0,0),
      2)*wk10_B0(0,0) + D10_B0(0,0)*SD001_B0(0,0)*wk3_B0(0,0) +
      D10_B0(0,0)*SD101_B0(0,0)*wk5_B0(0,0) + pow(D11_B0(0,0),
      2)*wk10_B0(0,0) + D11_B0(0,0)*SD011_B0(0,0)*wk3_B0(0,0) +
      D11_B0(0,0)*SD111_B0(0,0)*wk5_B0(0,0))*mu_B0(0,0) +
      rcinv35*(D00_B0(0,0)*wk11_B0(0,0) +
      D10_B0(0,0)*wk12_B0(0,0))*((rc33)*D00_B0(0,0)*wk11_B0(0,0) -
      rc7*D01_B0(0,0)*wk16_B0(0,0) + (rc33)*D10_B0(0,0)*wk12_B0(0,0) -
      rc7*D11_B0(0,0)*wk9_B0(0,0))*mu_B0(0,0) +
      rcinv35*(D00_B0(0,0)*wk14_B0(0,0) +
      D10_B0(0,0)*wk13_B0(0,0))*((rc33)*D00_B0(0,0)*wk11_B0(0,0) -
      rc7*D01_B0(0,0)*wk16_B0(0,0) + (rc33)*D10_B0(0,0)*wk12_B0(0,0) -
      rc7*D11_B0(0,0)*wk9_B0(0,0))*u0_B0(0,0) +
      rcinv35*(D00_B0(0,0)*wk14_B0(0,0) +
      D10_B0(0,0)*wk13_B0(0,0))*(D00_B0(0,0)*wk16_B0(0,0) +
      D01_B0(0,0)*wk11_B0(0,0) + D10_B0(0,0)*wk9_B0(0,0) +
      D11_B0(0,0)*wk12_B0(0,0))*u1_B0(0,0) +
      rcinv35*(D00_B0(0,0)*wk16_B0(0,0) +
      D10_B0(0,0)*wk9_B0(0,0))*(D00_B0(0,0)*wk16_B0(0,0) +
      D01_B0(0,0)*wk11_B0(0,0) + D10_B0(0,0)*wk9_B0(0,0) +
      D11_B0(0,0)*wk12_B0(0,0))*mu_B0(0,0) +
      rcinv35*(D01_B0(0,0)*wk11_B0(0,0) +
      D11_B0(0,0)*wk12_B0(0,0))*(D00_B0(0,0)*wk16_B0(0,0) +
      D01_B0(0,0)*wk11_B0(0,0) + D10_B0(0,0)*wk9_B0(0,0) +
      D11_B0(0,0)*wk12_B0(0,0))*mu_B0(0,0) +
      rcinv35*(D01_B0(0,0)*wk14_B0(0,0) +
      D11_B0(0,0)*wk13_B0(0,0))*(-rc7*D00_B0(0,0)*wk11_B0(0,0) +
      (rc33)*D01_B0(0,0)*wk16_B0(0,0) - rc7*D10_B0(0,0)*wk12_B0(0,0) +
      (rc33)*D11_B0(0,0)*wk9_B0(0,0))*u1_B0(0,0) +
      rcinv35*(D01_B0(0,0)*wk14_B0(0,0) +
      D11_B0(0,0)*wk13_B0(0,0))*(D00_B0(0,0)*wk16_B0(0,0) +
      D01_B0(0,0)*wk11_B0(0,0) + D10_B0(0,0)*wk9_B0(0,0) +
      D11_B0(0,0)*wk12_B0(0,0))*u0_B0(0,0) +
      rcinv35*(D01_B0(0,0)*wk16_B0(0,0) +
      D11_B0(0,0)*wk9_B0(0,0))*(-rc7*D00_B0(0,0)*wk11_B0(0,0) +
      (rc33)*D01_B0(0,0)*wk16_B0(0,0) - rc7*D10_B0(0,0)*wk12_B0(0,0) +
      (rc33)*D11_B0(0,0)*wk9_B0(0,0))*mu_B0(0,0) +
      rcinv35*((rc33)*pow(D00_B0(0,0), 2)*wk2_B0(0,0) +
      (rc18)*D00_B0(0,0)*D01_B0(0,0)*wk4_B0(0,0) +
      (rc36)*D00_B0(0,0)*D10_B0(0,0)*wk6_B0(0,0) +
      (rc18)*D00_B0(0,0)*D11_B0(0,0)*wk0_B0(0,0) +
      (rc33)*D00_B0(0,0)*SD000_B0(0,0)*wk11_B0(0,0) -
      rc7*D00_B0(0,0)*SD010_B0(0,0)*wk16_B0(0,0) +
      ...
      D11_B0(0,0)*SD011_B0(0,0)*wk11_B0(0,0) +
      D11_B0(0,0)*SD101_B0(0,0)*wk9_B0(0,0) +
      D11_B0(0,0)*SD111_B0(0,0)*wk12_B0(0,0))*mu_B0(0,0)*u0_B0(0,0) +
      rcinv35*(pow(D00_B0(0,0), 2)*wk4_B0(0,0) +
      (rc18)*D00_B0(0,0)*D01_B0(0,0)*wk2_B0(0,0) +
      2*D00_B0(0,0)*D10_B0(0,0)*wk0_B0(0,0) +
      (rc18)*D00_B0(0,0)*D11_B0(0,0)*wk6_B0(0,0) +
      D00_B0(0,0)*SD000_B0(0,0)*wk16_B0(0,0) +
      D00_B0(0,0)*SD010_B0(0,0)*wk11_B0(0,0) +
      ...
      (rc33)*D11_B0(0,0)*SD011_B0(0,0)*wk16_B0(0,0) -
      rc7*D11_B0(0,0)*SD101_B0(0,0)*wk12_B0(0,0) +
      (rc33)*D11_B0(0,0)*SD111_B0(0,0)*wk9_B0(0,0))*mu_B0(0,0)*u1_B0(0,0)
      + Residual3_B0(0,0);
