...
void ops_par_loop_opensbliblock00Kernel090_execute(ops_kernel_descriptor *desc) {
  ...
  double * __restrict__ SD100_B0_p = (double *)(args[15].data + base15);
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
      ...
      const ACC<double> wk1_B0(xdim6_opensbliblock00Kernel090, wk1_B0_p + n_x*1 + n_y * xdim6_opensbliblock00Kernel090*1);
      const ACC<double> wk4_B0(xdim7_opensbliblock00Kernel090, wk4_B0_p + n_x*1 + n_y * xdim7_opensbliblock00Kernel090*1);
      ACC<double> SD010_B0(xdim8_opensbliblock00Kernel090, SD010_B0_p + n_x*1 + n_y * xdim8_opensbliblock00Kernel090*1);
      ...
      ACC<double> SD000_B0(xdim12_opensbliblock00Kernel090, SD000_B0_p + n_x*1 + n_y * xdim12_opensbliblock00Kernel090*1);
      ...
      ACC<double> SD100_B0(xdim15_opensbliblock00Kernel090, SD100_B0_p + n_x*1 + n_y * xdim15_opensbliblock00Kernel090*1);
