...
void ops_par_loop_opensbliblock00Kernel040_execute(ops_kernel_descriptor *desc) {
  ...
  double * __restrict__ wk12_B0_p = (double *)(args[1].data + base1);
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
      ...
      const ACC<double> u0_B0(xdim0_opensbliblock00Kernel040, u0_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel040*1);
      ACC<double> wk12_B0(xdim1_opensbliblock00Kernel040, wk12_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel040*1);
