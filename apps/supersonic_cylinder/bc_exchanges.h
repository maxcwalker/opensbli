...
ops_halo_group exchange31_block0 ;
{
int halo_iter[] = {3, block0np1 + 7};
int from_base[] = {0, -3};
int to_base[] = {block0np0, -3};
int from_dir[] = {1, 2};
int to_dir[] = {1, 2};
...
exchange31_block0 = ops_decl_halo_group(5,grp);
}
// Boundary condition exchange code on opensbliblock00 direction 0 right
ops_halo_group exchange32_block0 ;
{
int halo_iter[] = {4, block0np1 + 7};
int from_base[] = {block0np0 - 3, -3};
int to_base[] = {-3, -3};
int from_dir[] = {1, 2};
int to_dir[] = {1, 2};
ops_halo halo0 = ops_decl_halo(D00_B0, D00_B0, halo_iter, from_base, to_base, from_dir, to_dir);
...
ops_halo halo4 = ops_decl_halo(detJ_B0, detJ_B0, halo_iter, from_base, to_base, from_dir, to_dir);
ops_halo grp[] = {halo0,halo1,halo2,halo3,halo4};
exchange32_block0 = ops_decl_halo_group(5,grp);
}
// Boundary condition exchange code on opensbliblock00 direction 0 left
ops_halo_group exchange23_block0 ;
{
int halo_iter[] = {3, block0np1 + 7};
int from_base[] = {0, -3};
int to_base[] = {block0np0, -3};
...
exchange23_block0 = ops_decl_halo_group(4,grp);
}
// Boundary condition exchange code on opensbliblock00 direction 0 right
ops_halo_group exchange24_block0 ;
{
int halo_iter[] = {4, block0np1 + 7};
int from_base[] = {block0np0 - 3, -3};
int to_base[] = {-3, -3};
...
ops_halo halo3 = ops_decl_halo(rhoE_B0, rhoE_B0, halo_iter, from_base, to_base, from_dir, to_dir);
ops_halo grp[] = {halo0,halo1,halo2,halo3};
exchange24_block0 = ops_decl_halo_group(4,grp);
}