...
int xdim10_opensbliblock00Kernel042;
int xdim11_opensbliblock00Kernel042;
int xdim12_opensbliblock00Kernel042;
int xdim13_opensbliblock00Kernel042;
int xdim14_opensbliblock00Kernel042;
int xdim15_opensbliblock00Kernel042;

//user function
inline 
 void opensbliblock00Kernel042(const ptr_double U1_B0,
  ...
  ptr_double wk5_B0)
{
   ...
   AVG_1_1_LEV_33 = 0.707106781186547*gamma_m1*inv_AVG_a*inv_AVG_rho;
    ...
    CF_10 = (AVG_1_1_LEV_10*OPS_ACC(U1_B0, 0,-2)*OPS_ACC(rho_B0, 0,-2) +
      ...
      AVG_1_1_LEV_11*OPS_ACC(U1_B0, 0,-2)*OPS_ACC(rhou0_B0, 0,-2))*OPS_ACC(detJ_B0, 0,-2);
    ...
    CF_11 = (AVG_1_1_LEV_10*OPS_ACC(U1_B0, 0,-1)*OPS_ACC(rho_B0, 0,-1) +
      ...
      AVG_1_1_LEV_11*OPS_ACC(U1_B0, 0,-1)*OPS_ACC(rhou0_B0, 0,-1))*OPS_ACC(detJ_B0, 0,-1);
    ...
    CF_12 = (AVG_1_1_LEV_10*OPS_ACC(U1_B0, 0,0)*OPS_ACC(rho_B0, 0,0) +
      ...
      AVG_1_1_LEV_11*OPS_ACC(U1_B0, 0,0)*OPS_ACC(rhou0_B0, 0,0))*OPS_ACC(detJ_B0, 0,0);
    ...
    CF_15 = (AVG_1_1_LEV_10*OPS_ACC(U1_B0, 0,3)*OPS_ACC(rho_B0, 0,3) +
      ...
      AVG_1_1_LEV_11*OPS_ACC(U1_B0, 0,3)*OPS_ACC(rhou0_B0, 0,3))*OPS_ACC(detJ_B0, 0,3);
   ...
   CS_15 = AVG_1_1_LEV_10*OPS_ACC(rho_B0, 0,3) + AVG_1_1_LEV_11*OPS_ACC(rhou0_B0, 0,3);
    ...
    max_lambda_1_00 = fmax(fabs(OPS_ACC(u1_B0, 0,1)), fmax(fabs(OPS_ACC(u1_B0, 0,2)),
      fmax(fabs(OPS_ACC(u1_B0, 0,-2)), fmax(fabs(OPS_ACC(u1_B0, 0,3)), fmax(fabs(OPS_ACC(u1_B0, 0,-1)),
      fabs(OPS_ACC(u1_B0, 0,0)))))));

   max_lambda_1_11 = max_lambda_1_00;

    max_lambda_1_22 = fmax(fabs(OPS_ACC(a_B0, 0,-2) + OPS_ACC(u1_B0, 0,-2)), fmax(fabs(OPS_ACC(a_B0, 0,-1) +
      OPS_ACC(u1_B0, 0,-1)), fmax(fabs(OPS_ACC(a_B0, 0,3) + OPS_ACC(u1_B0, 0,3)), fmax(fabs(OPS_ACC(a_B0, 0,0) +
      OPS_ACC(u1_B0, 0,0)), fmax(fabs(OPS_ACC(a_B0, 0,1) + OPS_ACC(u1_B0, 0,1)), fabs(OPS_ACC(a_B0, 0,2) +
      OPS_ACC(u1_B0, 0,2)))))));

    max_lambda_1_33 = fmax(fabs(OPS_ACC(a_B0, 0,3) - OPS_ACC(u1_B0, 0,3)), fmax(fabs(OPS_ACC(a_B0, 0,-1) -
      OPS_ACC(u1_B0, 0,-1)), fmax(fabs(OPS_ACC(a_B0, 0,2) - OPS_ACC(u1_B0, 0,2)), fmax(fabs(OPS_ACC(a_B0, 0,1) -
      OPS_ACC(u1_B0, 0,1)), fmax(fabs(OPS_ACC(a_B0, 0,-2) - OPS_ACC(u1_B0, 0,-2)), fabs(OPS_ACC(a_B0, 0,0) -
      OPS_ACC(u1_B0, 0,0)))))));
...
void opensbliblock00Kernel042_c_wrapper(
  ...
  for ( int n_y=0; n_y<y_size; n_y++ ){
    ...
    for ( int n_x=0; n_x<x_size; n_x++ ){
      ...
      const ptr_double ptr1 = {  p_a1 + n_x*1*1 + n_y*xdim1_opensbliblock00Kernel042*1*1, xdim1_opensbliblock00Kernel042};
      const ptr_double ptr2 = {  p_a2 + n_x*1*1 + n_y*xdim2_opensbliblock00Kernel042*1*1, xdim2_opensbliblock00Kernel042};
      const ptr_double ptr3 = {  p_a3 + n_x*1*1 + n_y*xdim3_opensbliblock00Kernel042*1*1, xdim3_opensbliblock00Kernel042};
      const ptr_double ptr4 = {  p_a4 + n_x*1*1 + n_y*xdim4_opensbliblock00Kernel042*1*1, xdim4_opensbliblock00Kernel042};
      const ptr_double ptr5 = {  p_a5 + n_x*1*1 + n_y*xdim5_opensbliblock00Kernel042*1*1, xdim5_opensbliblock00Kernel042};
      const ptr_double ptr6 = {  p_a6 + n_x*1*1 + n_y*xdim6_opensbliblock00Kernel042*1*1, xdim6_opensbliblock00Kernel042};
      const ptr_double ptr7 = {  p_a7 + n_x*1*1 + n_y*xdim7_opensbliblock00Kernel042*1*1, xdim7_opensbliblock00Kernel042};
      const ptr_double ptr8 = {  p_a8 + n_x*1*1 + n_y*xdim8_opensbliblock00Kernel042*1*1, xdim8_opensbliblock00Kernel042};
      const ptr_double ptr9 = {  p_a9 + n_x*1*1 + n_y*xdim9_opensbliblock00Kernel042*1*1, xdim9_opensbliblock00Kernel042};
      const ptr_double ptr10 = {  p_a10 + n_x*1*1 + n_y*xdim10_opensbliblock00Kernel042*1*1, xdim10_opensbliblock00Kernel042};
      const ptr_double ptr11 = {  p_a11 + n_x*1*1 + n_y*xdim11_opensbliblock00Kernel042*1*1, xdim11_opensbliblock00Kernel042};
      ptr_double ptr12 = {  p_a12 + n_x*1*1 + n_y*xdim12_opensbliblock00Kernel042*1*1, xdim12_opensbliblock00Kernel042};
      ptr_double ptr13 = {  p_a13 + n_x*1*1 + n_y*xdim13_opensbliblock00Kernel042*1*1, xdim13_opensbliblock00Kernel042};
      ptr_double ptr14 = {  p_a14 + n_x*1*1 + n_y*xdim14_opensbliblock00Kernel042*1*1, xdim14_opensbliblock00Kernel042};
      ptr_double ptr15 = {  p_a15 + n_x*1*1 + n_y*xdim15_opensbliblock00Kernel042*1*1, xdim15_opensbliblock00Kernel042};
