...
//user function
inline 
 void opensbliblock00Kernel041(const ptr_double rhoE_B0,
  ...
  ptr_double wk2_B0)
{
   ...
   CS_15 = AVG_0_0_LEV_10*OPS_ACC(rho_B0, 3,0) + AVG_0_0_LEV_12*OPS_ACC(rhou1_B0, 3,0);
    ...
    max_lambda_0_00 = fmax(fabs(OPS_ACC(u0_B0, -2,0)), fmax(fabs(OPS_ACC(u0_B0, -1,0)),
      fmax(fabs(OPS_ACC(u0_B0, 0,0)), fmax(fabs(OPS_ACC(u0_B0, 3,0)), fmax(fabs(OPS_ACC(u0_B0, 1,0)),
      fabs(OPS_ACC(u0_B0, 2,0)))))));

   max_lambda_0_11 = max_lambda_0_00;

    max_lambda_0_22 = fmax(fabs(OPS_ACC(a_B0, -2,0) + OPS_ACC(u0_B0, -2,0)), fmax(fabs(OPS_ACC(a_B0, 3,0) +
      OPS_ACC(u0_B0, 3,0)), fmax(fabs(OPS_ACC(a_B0, -1,0) + OPS_ACC(u0_B0, -1,0)), fmax(fabs(OPS_ACC(a_B0, 1,0) +
      OPS_ACC(u0_B0, 1,0)), fmax(fabs(OPS_ACC(a_B0, 0,0) + OPS_ACC(u0_B0, 0,0)), fabs(OPS_ACC(a_B0, 2,0) +
      OPS_ACC(u0_B0, 2,0)))))));

    max_lambda_0_33 = fmax(fabs(OPS_ACC(a_B0, 3,0) - OPS_ACC(u0_B0, 3,0)), fmax(fabs(OPS_ACC(a_B0, 2,0) -
      OPS_ACC(u0_B0, 2,0)), fmax(fabs(OPS_ACC(a_B0, -1,0) - OPS_ACC(u0_B0, -1,0)), fmax(fabs(OPS_ACC(a_B0, -2,0) -
      OPS_ACC(u0_B0, -2,0)), fmax(fabs(OPS_ACC(a_B0, 0,0) - OPS_ACC(u0_B0, 0,0)), fabs(OPS_ACC(a_B0, 1,0) -
      OPS_ACC(u0_B0, 1,0)))))));
...
void opensbliblock00Kernel041_c_wrapper(
  ...
  for ( int n_y=0; n_y<y_size; n_y++ ){
    ...
    for ( int n_x=0; n_x<x_size; n_x++ ){
      ...
      ptr_double ptr12 = {  p_a12 + n_x*1*1 + n_y*xdim12_opensbliblock00Kernel041*1*1, xdim12_opensbliblock00Kernel041};
      ptr_double ptr13 = {  p_a13 + n_x*1*1 + n_y*xdim13_opensbliblock00Kernel041*1*1, xdim13_opensbliblock00Kernel041};
      ptr_double ptr14 = {  p_a14 + n_x*1*1 + n_y*xdim14_opensbliblock00Kernel041*1*1, xdim14_opensbliblock00Kernel041};
      ptr_double ptr15 = {  p_a15 + n_x*1*1 + n_y*xdim15_opensbliblock00Kernel041*1*1, xdim15_opensbliblock00Kernel041};
