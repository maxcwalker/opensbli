...
void opensbliblock00Kernel041_c_wrapper(
  ...
  for ( int n_y=0; n_y<y_size; n_y++ ){
    for ( int n_x=0; n_x<x_size; n_x++ ){
      const ptr_double rhoE_B0 = { rhoE_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel041*1, xdim0_opensbliblock00Kernel041};
      const ptr_double rho_B0 = { rho_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel041*1, xdim1_opensbliblock00Kernel041};
      const ptr_double D00_B0 = { D00_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel041*1, xdim2_opensbliblock00Kernel041};
      const ptr_double U0_B0 = { U0_B0_p + n_x*1 + n_y * xdim3_opensbliblock00Kernel041*1, xdim3_opensbliblock00Kernel041};
      const ptr_double detJ_B0 = { detJ_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel041*1, xdim4_opensbliblock00Kernel041};
      const ptr_double rhou0_B0 = { rhou0_B0_p + n_x*1 + n_y * xdim5_opensbliblock00Kernel041*1, xdim5_opensbliblock00Kernel041};
      const ptr_double rhou1_B0 = { rhou1_B0_p + n_x*1 + n_y * xdim6_opensbliblock00Kernel041*1, xdim6_opensbliblock00Kernel041};
      const ptr_double D01_B0 = { D01_B0_p + n_x*1 + n_y * xdim7_opensbliblock00Kernel041*1, xdim7_opensbliblock00Kernel041};
      const ptr_double a_B0 = { a_B0_p + n_x*1 + n_y * xdim8_opensbliblock00Kernel041*1, xdim8_opensbliblock00Kernel041};
      const ptr_double u0_B0 = { u0_B0_p + n_x*1 + n_y * xdim9_opensbliblock00Kernel041*1, xdim9_opensbliblock00Kernel041};
      const ptr_double u1_B0 = { u1_B0_p + n_x*1 + n_y * xdim10_opensbliblock00Kernel041*1, xdim10_opensbliblock00Kernel041};
      const ptr_double p_B0 = { p_B0_p + n_x*1 + n_y * xdim11_opensbliblock00Kernel041*1, xdim11_opensbliblock00Kernel041};
      ptr_double wk0_B0 = { wk0_B0_p + n_x*1 + n_y * xdim12_opensbliblock00Kernel041*1, xdim12_opensbliblock00Kernel041};
      ptr_double wk3_B0 = { wk3_B0_p + n_x*1 + n_y * xdim13_opensbliblock00Kernel041*1, xdim13_opensbliblock00Kernel041};
      ptr_double wk1_B0 = { wk1_B0_p + n_x*1 + n_y * xdim14_opensbliblock00Kernel041*1, xdim14_opensbliblock00Kernel041};
      ptr_double wk2_B0 = { wk2_B0_p + n_x*1 + n_y * xdim15_opensbliblock00Kernel041*1, xdim15_opensbliblock00Kernel041};
