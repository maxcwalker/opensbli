...
void ops_par_loop_opensbliblock00Kernel040_execute(ops_kernel_descriptor *desc) {
  ...
  int xdim12_opensbliblock00Kernel040 = args[12].dat->size[0];
  int xdim13_opensbliblock00Kernel040 = args[13].dat->size[0];
  int xdim14_opensbliblock00Kernel040 = args[14].dat->size[0];
  ...
  double * __restrict__ Mach_sensor_B0_p = (double *)(args[11].data + base11);
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
      const ACC<double> rhoE_B0(xdim0_opensbliblock00Kernel040, rhoE_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel040*1);
      const ACC<double> D11_B0(xdim1_opensbliblock00Kernel040, D11_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel040*1);
      const ACC<double> rho_B0(xdim2_opensbliblock00Kernel040, rho_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel040*1);
      const ACC<double> D10_B0(xdim3_opensbliblock00Kernel040, D10_B0_p + n_x*1 + n_y * xdim3_opensbliblock00Kernel040*1);
      const ACC<double> D00_B0(xdim4_opensbliblock00Kernel040, D00_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel040*1);
      const ACC<double> rhou0_B0(xdim5_opensbliblock00Kernel040, rhou0_B0_p + n_x*1 + n_y * xdim5_opensbliblock00Kernel040*1);
      const ACC<double> rhou1_B0(xdim6_opensbliblock00Kernel040, rhou1_B0_p + n_x*1 + n_y * xdim6_opensbliblock00Kernel040*1);
      const ACC<double> D01_B0(xdim7_opensbliblock00Kernel040, D01_B0_p + n_x*1 + n_y * xdim7_opensbliblock00Kernel040*1);
      ACC<double> a_B0(xdim8_opensbliblock00Kernel040, a_B0_p + n_x*1 + n_y * xdim8_opensbliblock00Kernel040*1);
      ACC<double> U1_B0(xdim9_opensbliblock00Kernel040, U1_B0_p + n_x*1 + n_y * xdim9_opensbliblock00Kernel040*1);
      ACC<double> U0_B0(xdim10_opensbliblock00Kernel040, U0_B0_p + n_x*1 + n_y * xdim10_opensbliblock00Kernel040*1);
      ACC<double> Mach_sensor_B0(xdim11_opensbliblock00Kernel040, Mach_sensor_B0_p + n_x*1 + n_y * xdim11_opensbliblock00Kernel040*1);
      ACC<double> u1_B0(xdim12_opensbliblock00Kernel040, u1_B0_p + n_x*1 + n_y * xdim12_opensbliblock00Kernel040*1);
      ACC<double> u0_B0(xdim13_opensbliblock00Kernel040, u0_B0_p + n_x*1 + n_y * xdim13_opensbliblock00Kernel040*1);
      ACC<double> p_B0(xdim14_opensbliblock00Kernel040, p_B0_p + n_x*1 + n_y * xdim14_opensbliblock00Kernel040*1);
