...
void ops_par_loop_opensbliblock00Kernel041_execute(ops_kernel_descriptor *desc) {
  ...
  if (!ops_checkpointing_before(args,16,range,22)) return;
  #endif

  if (block->instance->OPS_diags > 1) {
    ops_timing_realloc(block->instance,22,"opensbliblock00Kernel041");
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
      const ACC<double> rhoE_B0(xdim0_opensbliblock00Kernel041, rhoE_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel041*1);
      const ACC<double> rho_B0(xdim1_opensbliblock00Kernel041, rho_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel041*1);
      const ACC<double> D00_B0(xdim2_opensbliblock00Kernel041, D00_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel041*1);
      const ACC<double> U0_B0(xdim3_opensbliblock00Kernel041, U0_B0_p + n_x*1 + n_y * xdim3_opensbliblock00Kernel041*1);
      const ACC<double> detJ_B0(xdim4_opensbliblock00Kernel041, detJ_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel041*1);
      const ACC<double> rhou0_B0(xdim5_opensbliblock00Kernel041, rhou0_B0_p + n_x*1 + n_y * xdim5_opensbliblock00Kernel041*1);
      const ACC<double> rhou1_B0(xdim6_opensbliblock00Kernel041, rhou1_B0_p + n_x*1 + n_y * xdim6_opensbliblock00Kernel041*1);
      const ACC<double> D01_B0(xdim7_opensbliblock00Kernel041, D01_B0_p + n_x*1 + n_y * xdim7_opensbliblock00Kernel041*1);
      const ACC<double> a_B0(xdim8_opensbliblock00Kernel041, a_B0_p + n_x*1 + n_y * xdim8_opensbliblock00Kernel041*1);
      const ACC<double> u0_B0(xdim9_opensbliblock00Kernel041, u0_B0_p + n_x*1 + n_y * xdim9_opensbliblock00Kernel041*1);
      const ACC<double> u1_B0(xdim10_opensbliblock00Kernel041, u1_B0_p + n_x*1 + n_y * xdim10_opensbliblock00Kernel041*1);
      const ACC<double> p_B0(xdim11_opensbliblock00Kernel041, p_B0_p + n_x*1 + n_y * xdim11_opensbliblock00Kernel041*1);
      ACC<double> wk0_B0(xdim12_opensbliblock00Kernel041, wk0_B0_p + n_x*1 + n_y * xdim12_opensbliblock00Kernel041*1);
      ACC<double> wk3_B0(xdim13_opensbliblock00Kernel041, wk3_B0_p + n_x*1 + n_y * xdim13_opensbliblock00Kernel041*1);
      ACC<double> wk1_B0(xdim14_opensbliblock00Kernel041, wk1_B0_p + n_x*1 + n_y * xdim14_opensbliblock00Kernel041*1);
      ACC<double> wk2_B0(xdim15_opensbliblock00Kernel041, wk2_B0_p + n_x*1 + n_y * xdim15_opensbliblock00Kernel041*1);
   ...
   CS_15 = AVG_0_0_LEV_10*rho_B0(3,0) + AVG_0_0_LEV_12*rhou1_B0(3,0);
    ...
    max_lambda_0_00 = fmax(fabs(u0_B0(-2,0)), fmax(fabs(u0_B0(-1,0)),
      fmax(fabs(u0_B0(0,0)), fmax(fabs(u0_B0(3,0)), fmax(fabs(u0_B0(1,0)),
      fabs(u0_B0(2,0)))))));

   max_lambda_0_11 = max_lambda_0_00;

    max_lambda_0_22 = fmax(fabs(a_B0(-2,0) + u0_B0(-2,0)), fmax(fabs(a_B0(3,0) +
      u0_B0(3,0)), fmax(fabs(a_B0(-1,0) + u0_B0(-1,0)), fmax(fabs(a_B0(1,0) +
      u0_B0(1,0)), fmax(fabs(a_B0(0,0) + u0_B0(0,0)), fabs(a_B0(2,0) +
      u0_B0(2,0)))))));

    max_lambda_0_33 = fmax(fabs(a_B0(3,0) - u0_B0(3,0)), fmax(fabs(a_B0(2,0) -
      u0_B0(2,0)), fmax(fabs(a_B0(-1,0) - u0_B0(-1,0)), fmax(fabs(a_B0(-2,0) -
