...
void ops_par_loop_opensbliblock00Kernel042_execute(ops_kernel_descriptor *desc) {
  ...
  int xdim12_opensbliblock00Kernel042 = args[12].dat->size[0];
  int xdim13_opensbliblock00Kernel042 = args[13].dat->size[0];
  int xdim14_opensbliblock00Kernel042 = args[14].dat->size[0];
  int xdim15_opensbliblock00Kernel042 = args[15].dat->size[0];
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
      const ACC<double> U1_B0(xdim0_opensbliblock00Kernel042, U1_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel042*1);
      const ACC<double> rhoE_B0(xdim1_opensbliblock00Kernel042, rhoE_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel042*1);
      const ACC<double> D11_B0(xdim2_opensbliblock00Kernel042, D11_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel042*1);
      const ACC<double> rho_B0(xdim3_opensbliblock00Kernel042, rho_B0_p + n_x*1 + n_y * xdim3_opensbliblock00Kernel042*1);
      const ACC<double> detJ_B0(xdim4_opensbliblock00Kernel042, detJ_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel042*1);
      const ACC<double> D10_B0(xdim5_opensbliblock00Kernel042, D10_B0_p + n_x*1 + n_y * xdim5_opensbliblock00Kernel042*1);
      const ACC<double> rhou0_B0(xdim6_opensbliblock00Kernel042, rhou0_B0_p + n_x*1 + n_y * xdim6_opensbliblock00Kernel042*1);
      const ACC<double> rhou1_B0(xdim7_opensbliblock00Kernel042, rhou1_B0_p + n_x*1 + n_y * xdim7_opensbliblock00Kernel042*1);
      const ACC<double> a_B0(xdim8_opensbliblock00Kernel042, a_B0_p + n_x*1 + n_y * xdim8_opensbliblock00Kernel042*1);
      const ACC<double> u0_B0(xdim9_opensbliblock00Kernel042, u0_B0_p + n_x*1 + n_y * xdim9_opensbliblock00Kernel042*1);
      const ACC<double> u1_B0(xdim10_opensbliblock00Kernel042, u1_B0_p + n_x*1 + n_y * xdim10_opensbliblock00Kernel042*1);
      const ACC<double> p_B0(xdim11_opensbliblock00Kernel042, p_B0_p + n_x*1 + n_y * xdim11_opensbliblock00Kernel042*1);
      ACC<double> wk7_B0(xdim12_opensbliblock00Kernel042, wk7_B0_p + n_x*1 + n_y * xdim12_opensbliblock00Kernel042*1);
      ACC<double> wk4_B0(xdim13_opensbliblock00Kernel042, wk4_B0_p + n_x*1 + n_y * xdim13_opensbliblock00Kernel042*1);
      ACC<double> wk6_B0(xdim14_opensbliblock00Kernel042, wk6_B0_p + n_x*1 + n_y * xdim14_opensbliblock00Kernel042*1);
      ACC<double> wk5_B0(xdim15_opensbliblock00Kernel042, wk5_B0_p + n_x*1 + n_y * xdim15_opensbliblock00Kernel042*1);
