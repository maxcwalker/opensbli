...
//
__constant__ int dims_opensbliblock00Kernel034 [5][1];
static int dims_opensbliblock00Kernel034_h [5][1] = {0};

//user function
__device__

void opensbliblock00Kernel034_gpu(ACC<double> &D11_B0,
  ACC<double> &D00_B0,
  ACC<double> &detJ_B0,
  ACC<double> &D10_B0,
  ACC<double> &D01_B0)
...
int size1 ){
  ...
  if (idx_x < size0 && idx_y < size1) {
    ACC<double> argp0(dims_opensbliblock00Kernel034[0][0], arg0);
    ACC<double> argp1(dims_opensbliblock00Kernel034[1][0], arg1);
    ACC<double> argp2(dims_opensbliblock00Kernel034[2][0], arg2);
    ACC<double> argp3(dims_opensbliblock00Kernel034[3][0], arg3);
...
void ops_par_loop_opensbliblock00Kernel034_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_opensbliblock00Kernel034_h[0][0] || xdim1 != dims_opensbliblock00Kernel034_h[1][0] || xdim2 != dims_opensbliblock00Kernel034_h[2][0] || xdim3 != dims_opensbliblock00Kernel034_h[3][0] || xdim4 != dims_opensbliblock00Kernel034_h[4][0]) {
