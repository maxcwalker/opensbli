...
//
__constant__ int dims_opensbliblock00Kernel041 [16][1];
static int dims_opensbliblock00Kernel041_h [16][1] = {0};

//user function
__device__

 void opensbliblock00Kernel041_gpu(const ACC<double> &rhoE_B0,
...
int size1 ){
  ...
  if (idx_x < size0 && idx_y < size1) {
    ...
    ACC<double> argp12(dims_opensbliblock00Kernel041[12][0], arg12);
    ACC<double> argp13(dims_opensbliblock00Kernel041[13][0], arg13);
    ACC<double> argp14(dims_opensbliblock00Kernel041[14][0], arg14);
    ACC<double> argp15(dims_opensbliblock00Kernel041[15][0], arg15);
...
void ops_par_loop_opensbliblock00Kernel041_execute(ops_kernel_descriptor *desc) {
  ...
  if (x_size > 0 && y_size > 0)
    ops_opensbliblock00Kernel041<<<grid, tblock >>> (  (double *)p_a[0], (double *)p_a[1],
