...
//
__constant__ int dims_opensbliblock00Kernel025 [5][1];
static int dims_opensbliblock00Kernel025_h [5][1] = {{0}};

//user function
__device__

 void opensbliblock00Kernel025_gpu(const ACC<double> &x0_B0,
  ACC<double> &rhou0_B0,
  ACC<double> &rhoE_B0,
  ACC<double> &rhou1_B0,
  ACC<double>
&rho_B0)
{
   ...
   rhoE_B0(0,0) = Twall*rcinv5*rcinv6*rho_B0(0,0)/(gama - 1);

    Pwall = (gama - 1)*(-((rc7)*pow(rhou0_B0(0,0), 2) + (rc7)*pow(rhou1_B0(0,0),
   ...
   u13 = rhou1_B0(0,3)/rho_B0(0,3);
    ...
    T_above = pow(Minf, 2)*gama*(gama - 1)*(-((rc7)*pow(rhou0_B0(0,1), 2) + (rc7)*pow(rhou1_B0(0,1),
      2))/rho_B0(0,1) + rhoE_B0(0,1))/rho_B0(0,1);
...
int size1 ){
  ...
  if (size0==-1) dims_opensbliblock00Kernel025[0][0]=0;
  ...
  if (idx_x < size0 && idx_y < size1) {
    ...
    ACC<double> argp1(dims_opensbliblock00Kernel025[1][0], arg1);
    ACC<double> argp2(dims_opensbliblock00Kernel025[2][0], arg2);
    ACC<double> argp3(dims_opensbliblock00Kernel025[3][0], arg3);
    ACC<double> argp4(dims_opensbliblock00Kernel025[4][0], arg4);
...
void ops_par_loop_opensbliblock00Kernel025_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_opensbliblock00Kernel025_h[0][0] || xdim1 != dims_opensbliblock00Kernel025_h[1][0] || xdim2 != dims_opensbliblock00Kernel025_h[2][0] || xdim3 != dims_opensbliblock00Kernel025_h[3][0] || xdim4 != dims_opensbliblock00Kernel025_h[4][0]) {
    ...
    hipSafeCall(block->instance->ostream(), hipMemcpyToSymbol(HIP_SYMBOL(dims_opensbliblock00Kernel025), dims_opensbliblock00Kernel025_h, sizeof(dims_opensbliblock00Kernel025)));
  }
  ...
  if (x_size > 0 && y_size > 0)
    hipLaunchKernelGGL(ops_opensbliblock00Kernel025,grid ,tblock ,0 ,0 , (double *)p_a[0], (double *)p_a[1],
