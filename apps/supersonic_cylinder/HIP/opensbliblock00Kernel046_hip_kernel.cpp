...
//
__constant__ int dims_opensbliblock00Kernel046 [15][1];
static int dims_opensbliblock00Kernel046_h [15][1] = {{0}};

//user function
__device__

 void opensbliblock00Kernel046_gpu(const ACC<double> &wk4_B0,
  ...
  const int *idx)
{
   ...
   double Grid_1 = 0.0;
   double Grid_0 = 0.0;
    kappa_max = fmax(kappa_B0(0,2), fmax(kappa_B0(-1,0), fmax(kappa_B0(0,1),
      fmax(kappa_B0(-2,0), fmax(kappa_B0(1,0), fmax(kappa_B0(0,-2),
      fmax(kappa_B0(0,-1), fmax(kappa_B0(0,0), kappa_B0(2,0)))))))));
...
: (
   1
    ...
    rho_B0(0,0) = -dt*shock_filter_control*Wall*kappa_max*(inv_0*(wk0_B0(0,0) -
      wk0_B0(-1,0)) + inv_1*(wk4_B0(0,0) - wk4_B0(0,-1)))/detJ_B0(0,0) +
      rho_B0(0,0);

    rhou0_B0(0,0) = -dt*shock_filter_control*Wall*kappa_max*(inv_0*(wk1_B0(0,0) -
      wk1_B0(-1,0)) + inv_1*(wk5_B0(0,0) - wk5_B0(0,-1)))/detJ_B0(0,0) +
      rhou0_B0(0,0);

    rhou1_B0(0,0) = -dt*shock_filter_control*Wall*kappa_max*(inv_0*(-wk2_B0(-1,0) +
      wk2_B0(0,0)) + inv_1*(wk6_B0(0,0) - wk6_B0(0,-1)))/detJ_B0(0,0) +
      rhou1_B0(0,0);

    rhoE_B0(0,0) = -dt*shock_filter_control*Wall*kappa_max*(inv_0*(-wk3_B0(-1,0) +
      wk3_B0(0,0)) + inv_1*(wk7_B0(0,0) - wk7_B0(0,-1)))/detJ_B0(0,0) +
      rhoE_B0(0,0);
...
int size1 ){
  ...
  if (size0==-1) dims_opensbliblock00Kernel046[0][0]=0;
  ...
  arg0 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel046[0][0];
  arg1 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel046[1][0];
  arg2 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel046[2][0];
  arg3 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel046[3][0];
  arg4 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel046[4][0];
  arg5 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel046[5][0];
  arg6 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel046[6][0];
  arg7 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel046[7][0];
  arg8 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel046[8][0];
  arg9 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel046[9][0];
  arg10 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel046[10][0];
  arg11 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel046[11][0];
  arg12 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel046[12][0];
  arg13 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel046[13][0];

  if (idx_x < size0 && idx_y < size1) {
    const ACC<double> argp0(dims_opensbliblock00Kernel046[0][0], arg0);
    const ACC<double> argp1(dims_opensbliblock00Kernel046[1][0], arg1);
    const ACC<double> argp2(dims_opensbliblock00Kernel046[2][0], arg2);
    const ACC<double> argp3(dims_opensbliblock00Kernel046[3][0], arg3);
    const ACC<double> argp4(dims_opensbliblock00Kernel046[4][0], arg4);
    const ACC<double> argp5(dims_opensbliblock00Kernel046[5][0], arg5);
    const ACC<double> argp6(dims_opensbliblock00Kernel046[6][0], arg6);
    const ACC<double> argp7(dims_opensbliblock00Kernel046[7][0], arg7);
    const ACC<double> argp8(dims_opensbliblock00Kernel046[8][0], arg8);
    const ACC<double> argp9(dims_opensbliblock00Kernel046[9][0], arg9);
    ACC<double> argp10(dims_opensbliblock00Kernel046[10][0], arg10);
    ACC<double> argp11(dims_opensbliblock00Kernel046[11][0], arg11);
    ACC<double> argp12(dims_opensbliblock00Kernel046[12][0], arg12);
    ACC<double> argp13(dims_opensbliblock00Kernel046[13][0], arg13);
    opensbliblock00Kernel046_gpu(argp0, argp1, argp2, argp3,
...
void ops_par_loop_opensbliblock00Kernel046_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_opensbliblock00Kernel046_h[0][0] || xdim1 != dims_opensbliblock00Kernel046_h[1][0] || xdim2 != dims_opensbliblock00Kernel046_h[2][0] || xdim3 != dims_opensbliblock00Kernel046_h[3][0] || xdim4 != dims_opensbliblock00Kernel046_h[4][0] || xdim5 != dims_opensbliblock00Kernel046_h[5][0] || xdim6 != dims_opensbliblock00Kernel046_h[6][0] || xdim7 != dims_opensbliblock00Kernel046_h[7][0] || xdim8 != dims_opensbliblock00Kernel046_h[8][0] || xdim9 != dims_opensbliblock00Kernel046_h[9][0] || xdim10 != dims_opensbliblock00Kernel046_h[10][0] || xdim11 != dims_opensbliblock00Kernel046_h[11][0] || xdim12 != dims_opensbliblock00Kernel046_h[12][0] || xdim13 != dims_opensbliblock00Kernel046_h[13][0]) {
    ...
    hipSafeCall(block->instance->ostream(), hipMemcpyToSymbol(HIP_SYMBOL(dims_opensbliblock00Kernel046), dims_opensbliblock00Kernel046_h, sizeof(dims_opensbliblock00Kernel046)));
  }
  ...
  if (x_size > 0 && y_size > 0)
    hipLaunchKernelGGL(ops_opensbliblock00Kernel046,grid ,tblock ,0 ,0 , (double *)p_a[0], (double *)p_a[1],
