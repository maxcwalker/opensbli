...
//
__constant__ int dims_opensbliblock00Kernel006 [2][1];
static int dims_opensbliblock00Kernel006_h [2][1] = {{0}};
...
void opensbliblock00Kernel006_gpu(const ACC<double> &u1_B0,
  ACC<double> &wk2_B0)
{
    wk2_B0(0,0) = (rc4)*inv_0*(-u1_B0(2,0) + u1_B0(-2,0) + 8*u1_B0(1,0) -
      8*u1_B0(-1,0));
...
int size1 ){
  ...
  if (idx_x < size0 && idx_y < size1) {
    ...
    ACC<double> argp1(dims_opensbliblock00Kernel006[1][0], arg1);
    opensbliblock00Kernel006_gpu(argp0, argp1);
  }
...
void ops_par_loop_opensbliblock00Kernel006_execute(ops_kernel_descriptor *desc) {
  ...
  if (x_size > 0 && y_size > 0)
    hipLaunchKernelGGL(ops_opensbliblock00Kernel006,grid ,tblock ,0 ,0 , (double *)p_a[0], (double *)p_a[1],x_size, y_size);
