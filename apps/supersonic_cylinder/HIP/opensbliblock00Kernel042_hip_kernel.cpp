...
//
__constant__ int dims_opensbliblock00Kernel042 [16][1];
static int dims_opensbliblock00Kernel042_h [16][1] = {{0}};

//user function
__device__

 void opensbliblock00Kernel042_gpu(const ACC<double> &U1_B0,
...
&wk5_B0)
{
   ...
   AVG_1_1_LEV_33 = 0.707106781186547*gamma_m1*inv_AVG_a*inv_AVG_rho;
    ...
    CF_10 = (AVG_1_1_LEV_10*U1_B0(0,-2)*rho_B0(0,-2) +
      ...
      AVG_1_1_LEV_11*U1_B0(0,-2)*rhou0_B0(0,-2))*detJ_B0(0,-2);
    ...
    CF_11 = (AVG_1_1_LEV_10*U1_B0(0,-1)*rho_B0(0,-1) +
      ...
      AVG_1_1_LEV_11*U1_B0(0,-1)*rhou0_B0(0,-1))*detJ_B0(0,-1);
    ...
    CF_12 = (AVG_1_1_LEV_10*U1_B0(0,0)*rho_B0(0,0) +
      ...
      AVG_1_1_LEV_11*U1_B0(0,0)*rhou0_B0(0,0))*detJ_B0(0,0);
    ...
    CF_15 = (AVG_1_1_LEV_10*U1_B0(0,3)*rho_B0(0,3) +
      ...
      AVG_1_1_LEV_11*U1_B0(0,3)*rhou0_B0(0,3))*detJ_B0(0,3);
   ...
   CS_15 = AVG_1_1_LEV_10*rho_B0(0,3) + AVG_1_1_LEV_11*rhou0_B0(0,3);
    ...
    max_lambda_1_00 = fmax(fabs(u1_B0(0,1)), fmax(fabs(u1_B0(0,2)),
      fmax(fabs(u1_B0(0,-2)), fmax(fabs(u1_B0(0,3)), fmax(fabs(u1_B0(0,-1)),
      fabs(u1_B0(0,0)))))));

   max_lambda_1_11 = max_lambda_1_00;

    max_lambda_1_22 = fmax(fabs(a_B0(0,-2) + u1_B0(0,-2)), fmax(fabs(a_B0(0,-1) +
      u1_B0(0,-1)), fmax(fabs(a_B0(0,3) + u1_B0(0,3)), fmax(fabs(a_B0(0,0) +
      u1_B0(0,0)), fmax(fabs(a_B0(0,1) + u1_B0(0,1)), fabs(a_B0(0,2) +
      u1_B0(0,2)))))));

    max_lambda_1_33 = fmax(fabs(a_B0(0,3) - u1_B0(0,3)), fmax(fabs(a_B0(0,-1) -
      u1_B0(0,-1)), fmax(fabs(a_B0(0,2) - u1_B0(0,2)), fmax(fabs(a_B0(0,1) -
      u1_B0(0,1)), fmax(fabs(a_B0(0,-2) - u1_B0(0,-2)), fabs(a_B0(0,0) -
      u1_B0(0,0)))))));
...
int size1 ){
  ...
  if (size0==-1) dims_opensbliblock00Kernel042[0][0]=0;


  int idx_y = hipBlockDim_y * hipBlockIdx_y + hipThreadIdx_y;
  int idx_x = hipBlockDim_x * hipBlockIdx_x + hipThreadIdx_x;

  arg0 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel042[0][0];
  arg1 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel042[1][0];
  arg2 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel042[2][0];
  arg3 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel042[3][0];
  arg4 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel042[4][0];
  arg5 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel042[5][0];
  arg6 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel042[6][0];
  arg7 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel042[7][0];
  arg8 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel042[8][0];
  arg9 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel042[9][0];
  arg10 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel042[10][0];
  arg11 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel042[11][0];
  arg12 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel042[12][0];
  arg13 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel042[13][0];
  arg14 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel042[14][0];
  arg15 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel042[15][0];

  if (idx_x < size0 && idx_y < size1) {
    const ACC<double> argp0(dims_opensbliblock00Kernel042[0][0], arg0);
    const ACC<double> argp1(dims_opensbliblock00Kernel042[1][0], arg1);
    const ACC<double> argp2(dims_opensbliblock00Kernel042[2][0], arg2);
    const ACC<double> argp3(dims_opensbliblock00Kernel042[3][0], arg3);
    const ACC<double> argp4(dims_opensbliblock00Kernel042[4][0], arg4);
    const ACC<double> argp5(dims_opensbliblock00Kernel042[5][0], arg5);
    const ACC<double> argp6(dims_opensbliblock00Kernel042[6][0], arg6);
    const ACC<double> argp7(dims_opensbliblock00Kernel042[7][0], arg7);
    const ACC<double> argp8(dims_opensbliblock00Kernel042[8][0], arg8);
    const ACC<double> argp9(dims_opensbliblock00Kernel042[9][0], arg9);
    const ACC<double> argp10(dims_opensbliblock00Kernel042[10][0], arg10);
    const ACC<double> argp11(dims_opensbliblock00Kernel042[11][0], arg11);
    ACC<double> argp12(dims_opensbliblock00Kernel042[12][0], arg12);
    ACC<double> argp13(dims_opensbliblock00Kernel042[13][0], arg13);
    ACC<double> argp14(dims_opensbliblock00Kernel042[14][0], arg14);
    ACC<double> argp15(dims_opensbliblock00Kernel042[15][0], arg15);
    opensbliblock00Kernel042_gpu(argp0, argp1, argp2, argp3,
...
void ops_par_loop_opensbliblock00Kernel042_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_opensbliblock00Kernel042_h[0][0] || xdim1 != dims_opensbliblock00Kernel042_h[1][0] || xdim2 != dims_opensbliblock00Kernel042_h[2][0] || xdim3 != dims_opensbliblock00Kernel042_h[3][0] || xdim4 != dims_opensbliblock00Kernel042_h[4][0] || xdim5 != dims_opensbliblock00Kernel042_h[5][0] || xdim6 != dims_opensbliblock00Kernel042_h[6][0] || xdim7 != dims_opensbliblock00Kernel042_h[7][0] || xdim8 != dims_opensbliblock00Kernel042_h[8][0] || xdim9 != dims_opensbliblock00Kernel042_h[9][0] || xdim10 != dims_opensbliblock00Kernel042_h[10][0] || xdim11 != dims_opensbliblock00Kernel042_h[11][0] || xdim12 != dims_opensbliblock00Kernel042_h[12][0] || xdim13 != dims_opensbliblock00Kernel042_h[13][0] || xdim14 != dims_opensbliblock00Kernel042_h[14][0] || xdim15 != dims_opensbliblock00Kernel042_h[15][0]) {
    ...
    dims_opensbliblock00Kernel042_h[5][0] = xdim5;
    dims_opensbliblock00Kernel042_h[6][0] = xdim6;
    dims_opensbliblock00Kernel042_h[7][0] = xdim7;
    dims_opensbliblock00Kernel042_h[8][0] = xdim8;
    dims_opensbliblock00Kernel042_h[9][0] = xdim9;
    dims_opensbliblock00Kernel042_h[10][0] = xdim10;
    dims_opensbliblock00Kernel042_h[11][0] = xdim11;
    dims_opensbliblock00Kernel042_h[12][0] = xdim12;
    dims_opensbliblock00Kernel042_h[13][0] = xdim13;
    dims_opensbliblock00Kernel042_h[14][0] = xdim14;
    dims_opensbliblock00Kernel042_h[15][0] = xdim15;
    hipSafeCall(block->instance->ostream(), hipMemcpyToSymbol(HIP_SYMBOL(dims_opensbliblock00Kernel042), dims_opensbliblock00Kernel042_h, sizeof(dims_opensbliblock00Kernel042)));
  }
  ...
  if (x_size > 0 && y_size > 0)
    hipLaunchKernelGGL(ops_opensbliblock00Kernel042,grid ,tblock ,0 ,0 , (double *)p_a[0], (double *)p_a[1],
