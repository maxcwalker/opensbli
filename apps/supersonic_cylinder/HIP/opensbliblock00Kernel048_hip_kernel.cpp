...
//
__constant__ int dims_opensbliblock00Kernel048 [14][1];
static int dims_opensbliblock00Kernel048_h [14][1] = {{0}};

//user function
__device__

 void opensbliblock00Kernel048_gpu(const ACC<double> &Residual1_B0,
...
int size1 ){
  ...
  if (size0==-1) dims_opensbliblock00Kernel048[0][0]=0;


  int idx_y = hipBlockDim_y * hipBlockIdx_y + hipThreadIdx_y;
  int idx_x = hipBlockDim_x * hipBlockIdx_x + hipThreadIdx_x;

  arg0 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel048[0][0];
  arg1 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel048[1][0];
  arg2 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel048[2][0];
  arg3 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel048[3][0];
  arg4 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel048[4][0];
  arg5 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel048[5][0];
  arg6 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel048[6][0];
  arg7 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel048[7][0];
  arg8 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel048[8][0];
  arg9 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel048[9][0];
  arg10 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel048[10][0];
  arg11 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel048[11][0];

  if (idx_x < size0 && idx_y < size1) {
    const ACC<double> argp0(dims_opensbliblock00Kernel048[0][0], arg0);
    const ACC<double> argp1(dims_opensbliblock00Kernel048[1][0], arg1);
    const ACC<double> argp2(dims_opensbliblock00Kernel048[2][0], arg2);
    const ACC<double> argp3(dims_opensbliblock00Kernel048[3][0], arg3);
    ACC<double> argp4(dims_opensbliblock00Kernel048[4][0], arg4);
    ACC<double> argp5(dims_opensbliblock00Kernel048[5][0], arg5);
    ACC<double> argp6(dims_opensbliblock00Kernel048[6][0], arg6);
    ACC<double> argp7(dims_opensbliblock00Kernel048[7][0], arg7);
    ACC<double> argp8(dims_opensbliblock00Kernel048[8][0], arg8);
    ACC<double> argp9(dims_opensbliblock00Kernel048[9][0], arg9);
    ACC<double> argp10(dims_opensbliblock00Kernel048[10][0], arg10);
    ACC<double> argp11(dims_opensbliblock00Kernel048[11][0], arg11);
    opensbliblock00Kernel048_gpu(argp0, argp1, argp2, argp3,
...
void ops_par_loop_opensbliblock00Kernel048_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_opensbliblock00Kernel048_h[0][0] || xdim1 != dims_opensbliblock00Kernel048_h[1][0] || xdim2 != dims_opensbliblock00Kernel048_h[2][0] || xdim3 != dims_opensbliblock00Kernel048_h[3][0] || xdim4 != dims_opensbliblock00Kernel048_h[4][0] || xdim5 != dims_opensbliblock00Kernel048_h[5][0] || xdim6 != dims_opensbliblock00Kernel048_h[6][0] || xdim7 != dims_opensbliblock00Kernel048_h[7][0] || xdim8 != dims_opensbliblock00Kernel048_h[8][0] || xdim9 != dims_opensbliblock00Kernel048_h[9][0] || xdim10 != dims_opensbliblock00Kernel048_h[10][0] || xdim11 != dims_opensbliblock00Kernel048_h[11][0]) {
    ...
    hipSafeCall(block->instance->ostream(), hipMemcpyToSymbol(HIP_SYMBOL(dims_opensbliblock00Kernel048), dims_opensbliblock00Kernel048_h, sizeof(dims_opensbliblock00Kernel048)));
  }
  ...
  if (x_size > 0 && y_size > 0)
    hipLaunchKernelGGL(ops_opensbliblock00Kernel048,grid ,tblock ,0 ,0 , (double *)p_a[0], (double *)p_a[1],
