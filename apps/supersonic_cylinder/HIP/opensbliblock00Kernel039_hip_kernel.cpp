...
//
__constant__ int dims_opensbliblock00Kernel039 [13][1];
static int dims_opensbliblock00Kernel039_h [13][1] = {{0}};

//user function
__device__

 void opensbliblock00Kernel039_gpu(const ACC<double> &D11_B0,
