...
void opensbliblock00Kernel047_gpu(ACC<double> &rhou0_B0,
  ACC<double> &rhou1_B0,
  ACC<double> &rho_B0,
  ACC<double> &rhoE_B0,
  const int *idx)
...
int size1 ){
  ...
  if (idx_x < size0 && idx_y < size1) {
    ACC<double> argp0(dims_opensbliblock00Kernel047[0][0], arg0);
...
void ops_par_loop_opensbliblock00Kernel047_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_opensbliblock00Kernel047_h[0][0] || xdim1 != dims_opensbliblock00Kernel047_h[1][0] || xdim2 != dims_opensbliblock00Kernel047_h[2][0] || xdim3 != dims_opensbliblock00Kernel047_h[3][0]) {
