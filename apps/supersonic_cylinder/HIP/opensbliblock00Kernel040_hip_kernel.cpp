...
//
__constant__ int dims_opensbliblock00Kernel040 [15][1];
static int dims_opensbliblock00Kernel040_h [15][1] = {{0}};

//user function
__device__

 void opensbliblock00Kernel040_gpu(const ACC<double> &rhoE_B0,
  ...
  ACC<double> &p_B0)
{
   ...
   u0_B0(0,0) = inv_rho*rhou0_B0(0,0);

   u1_B0(0,0) = inv_rho*rhou1_B0(0,0);

    p_B0(0,0) = (gama - 1)*(-inv_rho*(0.5*pow(rhou0_B0(0,0), 2) + 0.5*pow(rhou1_B0(0,0),
      2)) + rhoE_B0(0,0));

   a_B0(0,0) = sqrt(gama*inv_rho*p_B0(0,0));

   U0_B0(0,0) = D00_B0(0,0)*u0_B0(0,0) + D01_B0(0,0)*u1_B0(0,0);

   U1_B0(0,0) = D10_B0(0,0)*u0_B0(0,0) + D11_B0(0,0)*u1_B0(0,0);

   inv_rho = 1.0/rho_B0(0,0);

   u0 = inv_rho*rhou0_B0(0,0);

   u1 = inv_rho*rhou1_B0(0,0);

    p = (gama - 1)*(-inv_rho*(0.5*pow(rhou0_B0(0,0), 2) + 0.5*pow(rhou1_B0(0,0), 2)) +
      rhoE_B0(0,0));
   ...
   Mach_sensor_B0(0,0) = fmin(1, 0.5*pow(M, 2)*sqrt(pow(-pow(M, 2) + 1, 2) + 4)/(pow(M, 2) + 1));
...
int size1 ){
  ...
  if (size0==-1) dims_opensbliblock00Kernel040[0][0]=0;
  ...
  arg12 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel040[12][0];
  arg13 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel040[13][0];
  arg14 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel040[14][0];
  ...
  if (idx_x < size0 && idx_y < size1) {
    ...
    ACC<double> argp12(dims_opensbliblock00Kernel040[12][0], arg12);
    ACC<double> argp13(dims_opensbliblock00Kernel040[13][0], arg13);
    ACC<double> argp14(dims_opensbliblock00Kernel040[14][0], arg14);
...
void ops_par_loop_opensbliblock00Kernel040_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_opensbliblock00Kernel040_h[0][0] || xdim1 != dims_opensbliblock00Kernel040_h[1][0] || xdim2 != dims_opensbliblock00Kernel040_h[2][0] || xdim3 != dims_opensbliblock00Kernel040_h[3][0] || xdim4 != dims_opensbliblock00Kernel040_h[4][0] || xdim5 != dims_opensbliblock00Kernel040_h[5][0] || xdim6 != dims_opensbliblock00Kernel040_h[6][0] || xdim7 != dims_opensbliblock00Kernel040_h[7][0] || xdim8 != dims_opensbliblock00Kernel040_h[8][0] || xdim9 != dims_opensbliblock00Kernel040_h[9][0] || xdim10 != dims_opensbliblock00Kernel040_h[10][0] || xdim11 != dims_opensbliblock00Kernel040_h[11][0] || xdim12 != dims_opensbliblock00Kernel040_h[12][0] || xdim13 != dims_opensbliblock00Kernel040_h[13][0] || xdim14 != dims_opensbliblock00Kernel040_h[14][0]) {
    ...
    dims_opensbliblock00Kernel040_h[12][0] = xdim12;
    dims_opensbliblock00Kernel040_h[13][0] = xdim13;
    dims_opensbliblock00Kernel040_h[14][0] = xdim14;
    hipSafeCall(block->instance->ostream(), hipMemcpyToSymbol(HIP_SYMBOL(dims_opensbliblock00Kernel040), dims_opensbliblock00Kernel040_h, sizeof(dims_opensbliblock00Kernel040)));
  }
  ...
  if (x_size > 0 && y_size > 0)
    hipLaunchKernelGGL(ops_opensbliblock00Kernel040,grid ,tblock ,0 ,0 , (double *)p_a[0], (double *)p_a[1],
...
#ifdef OPS_LAZY
void ops_par_loop_opensbliblock00Kernel040(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2, ops_arg arg3, ops_arg arg4, ops_arg arg5, ops_arg arg6, ops_arg arg7, ops_arg arg8, ops_arg arg9, ops_arg arg10, ops_arg arg11, ops_arg arg12, ops_arg arg13, ops_arg arg14) {
  ...
  desc->nargs = 15;
  desc->args = (ops_arg*)malloc(15*sizeof(ops_arg));
  desc->args[0] = arg0;
