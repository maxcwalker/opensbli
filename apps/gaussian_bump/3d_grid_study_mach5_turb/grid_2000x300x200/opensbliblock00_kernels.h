...
ACC<double> &rhou2_B0, ACC<double> &x0_B0, ACC<double> &x2_B0, ACC<double> &x1_B0, const int *idx)
{
   ...
   -1.72801507099211e-5 + 5.4698822680102e-14*pow(-x1b0 +
      x1_B0(0,0,0), 50) + 1.41284182348633*pow(-x1b0 + x1_B0(0,0,0), 16) + 0.534621605708419*x1_B0(0,0,0) +
      0.191660540270482*pow(-x1b0 + x1_B0(0,0,0), 15) + 0.0054444825919782*pow(-x1b0 + x1_B0(0,0,0), 21) +
      2.80168787933006e-12*pow(-x1b0 + x1_B0(0,0,0), 46) + 1.5178682370999e-9*pow(-x1b0 + x1_B0(0,0,0), 39) +
      30.9521429776629*pow(-x1b0 + x1_B0(0,0,0), 11) + 8.09129031059149e-6*pow(-x1b0 + x1_B0(0,0,0), 29) +
      2.10877890630144e-9*pow(-x1b0 + x1_B0(0,0,0), 37) + 1.66507573193752e-7*pow(-x1b0 + x1_B0(0,0,0), 32) +
      98.9528190539723*((-x1b0 + x1_B0(0,0,0))*(-x1b0 + x1_B0(0,0,0))*(-x1b0 + x1_B0(0,0,0))*(-x1b0 +
      x1_B0(0,0,0))*(-x1b0 + x1_B0(0,0,0))) + 50.3132872784468*pow(-x1b0 + x1_B0(0,0,0), 12) +
      1.6226232200586e-6*pow(-x1b0 + x1_B0(0,0,0), 31) + 9.12704455612709e-13*pow(-x1b0 + x1_B0(0,0,0), 45) +
      0.000136392559625748*pow(-x1b0 + x1_B0(0,0,0), 24) + 0.00227723069207926*pow(-x1b0 + x1_B0(0,0,0), 23) +
      597.999925318624*pow(-x1b0 + x1_B0(0,0,0), 7) + 4.94806474710927e-6*pow(-x1b0 + x1_B0(0,0,0), 30) +
      5.27432751948341*((-x1b0 + x1_B0(0,0,0))*(-x1b0 + x1_B0(0,0,0))*(-x1b0 + x1_B0(0,0,0))) +
      1.22853362684162e-12*pow(-x1b0 + x1_B0(0,0,0), 47) + 735.529308767713*pow(-x1b0 + x1_B0(0,0,0), 9) +
      0.365418319496192*pow(-x1b0 + x1_B0(0,0,0), 17) + 3.03692174788966e-9*pow(-x1b0 + x1_B0(0,0,0), 38) +
      0.00639466075369507*pow(-x1b0 + x1_B0(0,0,0), 22) + 4.18397864888952e-10*pow(-x1b0 + x1_B0(0,0,0), 40) -
      8.49308465902237*pow(-x1b0 + x1_B0(0,0,0), 14) - 0.534621605708419*x1b0 - 1.2782370230225e-7*pow(-x1b0 +
      x1_B0(0,0,0), 34) - 7.44399309509964e-11*pow(-x1b0 + x1_B0(0,0,0), 42) - 24.546916043903*((-x1b0 +
      x1_B0(0,0,0))*(-x1b0 + x1_B0(0,0,0))*(-x1b0 + x1_B0(0,0,0))*(-x1b0 + x1_B0(0,0,0))) - 8.59112899444776*pow(-x1b0 +
      x1_B0(0,0,0), 13) - 0.000295397989266797*pow(-x1b0 + x1_B0(0,0,0), 25) - 3.00625337856057e-13*pow(-x1b0 +
      x1_B0(0,0,0), 49) - 0.000182972869033163*pow(-x1b0 + x1_B0(0,0,0), 26) - 828.580718563902*pow(-x1b0 +
      x1_B0(0,0,0), 8) - 0.106559010282641*pow(-x1b0 + x1_B0(0,0,0), 18) - 3.71757686753925e-12*pow(-x1b0 +
      x1_B0(0,0,0), 41) - 291.630186086529*((-x1b0 + x1_B0(0,0,0))*(-x1b0 + x1_B0(0,0,0))*(-x1b0 + x1_B0(0,0,0))*(-x1b0
      + x1_B0(0,0,0))*(-x1b0 + x1_B0(0,0,0))*(-x1b0 + x1_B0(0,0,0))) - 1.1934947187912*((-x1b0 + x1_B0(0,0,0))*(-x1b0 +
      x1_B0(0,0,0))) - 1.22611687863736e-6*pow(-x1b0 + x1_B0(0,0,0), 28) - 1.64767406707825e-7*pow(-x1b0 + x1_B0(0,0,0),
      33) - 1.03828371840846e-8*pow(-x1b0 + x1_B0(0,0,0), 36) - 357.851150843021*pow(-x1b0 + x1_B0(0,0,0), 10) -
      4.3767180726462e-11*pow(-x1b0 + x1_B0(0,0,0), 43) - 0.0237482730175408*pow(-x1b0 + x1_B0(0,0,0), 20) -
      0.0991139710328284*pow(-x1b0 + x1_B0(0,0,0), 19) - 1.2373229818193e-11*pow(-x1b0 + x1_B0(0,0,0), 44) -
      4.85024717968415e-14*pow(-x1b0 + x1_B0(0,0,0), 48) - 5.12266354762672e-8*pow(-x1b0 + x1_B0(0,0,0), 35) -
      5.42516555331304e-5*pow(-x1b0 + x1_B0(0,0,0), 27)
)
: (
   0.999998697337246
));
   ...
   -8.17330792579943e-8 + 0.00300492169534584*pow(-x1b0 +
      x1_B0(0,0,0), 17) + 0.249514188673716*((-x1b0 + x1_B0(0,0,0))*(-x1b0 + x1_B0(0,0,0))*(-x1b0 + x1_B0(0,0,0))*(-x1b0
      + x1_B0(0,0,0))*(-x1b0 + x1_B0(0,0,0))) + 5.83674420523519e-7*pow(-x1b0 + x1_B0(0,0,0), 25) +
      7.5924457989275e-10*pow(-x1b0 + x1_B0(0,0,0), 33) + 6.9767734923428e-16*pow(-x1b0 + x1_B0(0,0,0), 50) +
      2.69736420528385e-8*pow(-x1b0 + x1_B0(0,0,0), 30) + 7.10229110152006e-12*pow(-x1b0 + x1_B0(0,0,0), 40) +
      0.00212013801830355*pow(-x1b0 + x1_B0(0,0,0), 16) + 1.92764387308301e-14*pow(-x1b0 + x1_B0(0,0,0), 47) +
      0.0446103920282859*pow(-x1b0 + x1_B0(0,0,0), 13) + 1.26968044895925e-5*x1_B0(0,0,0) +
      6.39527354383176e-9*pow(-x1b0 + x1_B0(0,0,0), 32) + 1.44407848288674e-5*pow(-x1b0 + x1_B0(0,0,0), 22) +
      1.51399475708606e-11*pow(-x1b0 + x1_B0(0,0,0), 39) + 0.00412146919151629*((-x1b0 + x1_B0(0,0,0))*(-x1b0 +
      x1_B0(0,0,0))*(-x1b0 + x1_B0(0,0,0))) + 0.141293118705699*pow(-x1b0 + x1_B0(0,0,0), 12) +
      1.77494403007339e-5*pow(-x1b0 + x1_B0(0,0,0), 23) + 1.81960057347263e-8*pow(-x1b0 + x1_B0(0,0,0), 31) +
      0.000615978669163688*((-x1b0 + x1_B0(0,0,0))*(-x1b0 + x1_B0(0,0,0))) + 0.000652917056111062*pow(-x1b0 +
      x1_B0(0,0,0), 18) + 1.4251888333356*pow(-x1b0 + x1_B0(0,0,0), 9) + 1.58613814206595*pow(-x1b0 + x1_B0(0,0,0), 7) +
      1.2447130596347e-11*pow(-x1b0 + x1_B0(0,0,0), 38) + 1.6118874732876e-12*pow(-x1b0 + x1_B0(0,0,0), 41) +
      6.80161526709939e-6*pow(-x1b0 + x1_B0(0,0,0), 24) + 1.62371356317582e-15*pow(-x1b0 + x1_B0(0,0,0), 48) +
      2.7439288690392e-14*pow(-x1b0 + x1_B0(0,0,0), 46) - 1.10671333593997e-8*pow(-x1b0 + x1_B0(0,0,0), 29) -
      4.35966350848161e-15*pow(-x1b0 + x1_B0(0,0,0), 49) - 0.258588030784355*pow(-x1b0 + x1_B0(0,0,0), 11) -
      4.85602609528223e-13*pow(-x1b0 + x1_B0(0,0,0), 43) - 0.000291885858505642*pow(-x1b0 + x1_B0(0,0,0), 19) -
      2.20891791630807e-13*pow(-x1b0 + x1_B0(0,0,0), 44) - 5.32642814256323e-10*pow(-x1b0 + x1_B0(0,0,0), 35) -
      0.0468686091798419*((-x1b0 + x1_B0(0,0,0))*(-x1b0 + x1_B0(0,0,0))*(-x1b0 + x1_B0(0,0,0))*(-x1b0 + x1_B0(0,0,0))) -
      0.790031536983019*((-x1b0 + x1_B0(0,0,0))*(-x1b0 + x1_B0(0,0,0))*(-x1b0 + x1_B0(0,0,0))*(-x1b0 +
      x1_B0(0,0,0))*(-x1b0 + x1_B0(0,0,0))*(-x1b0 + x1_B0(0,0,0))) - 1.93436326777823e-7*pow(-x1b0 + x1_B0(0,0,0), 28) -
      1.26968044895925e-5*x1b0 - 3.02720762432369e-14*pow(-x1b0 + x1_B0(0,0,0), 45) - 5.92189878512384e-7*pow(-x1b0 +
      x1_B0(0,0,0), 27) - 0.323669224643339*pow(-x1b0 + x1_B0(0,0,0), 10) - 6.45612460619847e-10*pow(-x1b0 +
      x1_B0(0,0,0), 34) - 3.18949222098411e-13*pow(-x1b0 + x1_B0(0,0,0), 42) - 4.18694034879799e-11*pow(-x1b0 +
      x1_B0(0,0,0), 37) - 0.01271500184034*pow(-x1b0 + x1_B0(0,0,0), 15) - 0.026432036475411*pow(-x1b0 + x1_B0(0,0,0),
      14) - 8.62049485822164e-7*pow(-x1b0 + x1_B0(0,0,0), 26) - 2.17877805751241e-10*pow(-x1b0 + x1_B0(0,0,0), 36) -
      5.90644643952354e-5*pow(-x1b0 + x1_B0(0,0,0), 21) - 0.000242580304417355*pow(-x1b0 + x1_B0(0,0,0), 20) -
      1.99746587352138*pow(-x1b0 + x1_B0(0,0,0), 8)
)
: (
   0.00404432122221511
));
   ...
   1.95382251448579 + 2.36986034907644e-9*pow(-x1b0 +
      x1_B0(0,0,0), 38) + 6.31107814959339e-11*pow(-x1b0 + x1_B0(0,0,0), 43) + 0.00513175112641737*pow(-x1b0 +
      x1_B0(0,0,0), 20) + 0.0105180701968522*pow(-x1b0 + x1_B0(0,0,0), 22) + 1.67977788694077e-8*pow(-x1b0 +
      x1_B0(0,0,0), 37) + 2.95002066272617*pow(-x1b0 + x1_B0(0,0,0), 16) + 4.39979961265009e-11*pow(-x1b0 +
      x1_B0(0,0,0), 44) + 1.12164851401269e-11*pow(-x1b0 + x1_B0(0,0,0), 45) + 0.000405357775900088*pow(-x1b0 +
      x1_B0(0,0,0), 23) + 5.3020237801766e-8*pow(-x1b0 + x1_B0(0,0,0), 35) + 2.01104477081272e-5*pow(-x1b0 +
      x1_B0(0,0,0), 29) + 2.67675839457139e-6*pow(-x1b0 + x1_B0(0,0,0), 30) + 1819.49592694268*pow(-x1b0 + x1_B0(0,0,0),
      7) + 123.787090500824*pow(-x1b0 + x1_B0(0,0,0), 11) + 1987.71852205375*pow(-x1b0 + x1_B0(0,0,0), 9) +
      18.2949412172379*((-x1b0 + x1_B0(0,0,0))*(-x1b0 + x1_B0(0,0,0))*(-x1b0 + x1_B0(0,0,0))) + 352.617915027218*((-x1b0
      + x1_B0(0,0,0))*(-x1b0 + x1_B0(0,0,0))*(-x1b0 + x1_B0(0,0,0))*(-x1b0 + x1_B0(0,0,0))*(-x1b0 + x1_B0(0,0,0))) +
      4.37472479230007e-8*pow(-x1b0 + x1_B0(0,0,0), 36) + 3.07043846241768*pow(-x1b0 + x1_B0(0,0,0), 15) +
      3.07059412200436*x1_B0(0,0,0) + 4.73098731650186e-5*pow(-x1b0 + x1_B0(0,0,0), 27) + 0.196886593553966*pow(-x1b0 +
      x1_B0(0,0,0), 17) + 5.11999557998436e-5*pow(-x1b0 + x1_B0(0,0,0), 28) + 108.976854420952*pow(-x1b0 + x1_B0(0,0,0),
      12) + 0.0269206248959736*pow(-x1b0 + x1_B0(0,0,0), 21) + 7.8921565399568e-13*pow(-x1b0 + x1_B0(0,0,0), 49) -
      1.14385527478727e-13*pow(-x1b0 + x1_B0(0,0,0), 50) - 3.63332423287944e-12*pow(-x1b0 + x1_B0(0,0,0), 47) -
      16.1827100539105*pow(-x1b0 + x1_B0(0,0,0), 14) - 1.84340333486956e-6*pow(-x1b0 + x1_B0(0,0,0), 31) -
      5.6007765084062e-7*pow(-x1b0 + x1_B0(0,0,0), 33) - 90.9020108462893*((-x1b0 + x1_B0(0,0,0))*(-x1b0 +
      x1_B0(0,0,0))*(-x1b0 + x1_B0(0,0,0))*(-x1b0 + x1_B0(0,0,0))) - 0.000794214022846622*pow(-x1b0 + x1_B0(0,0,0), 25)
      - 0.158623829010081*pow(-x1b0 + x1_B0(0,0,0), 19) - 0.00015824580189321*pow(-x1b0 + x1_B0(0,0,0), 26) -
      1.32434148940196e-9*pow(-x1b0 + x1_B0(0,0,0), 40) - 0.00149533544073196*pow(-x1b0 + x1_B0(0,0,0), 24) -
      6.38582259968234*((-x1b0 + x1_B0(0,0,0))*(-x1b0 + x1_B0(0,0,0))) - 3.06271294371186e-12*pow(-x1b0 + x1_B0(0,0,0),
      46) - 962.306360871999*((-x1b0 + x1_B0(0,0,0))*(-x1b0 + x1_B0(0,0,0))*(-x1b0 + x1_B0(0,0,0))*(-x1b0 +
      x1_B0(0,0,0))*(-x1b0 + x1_B0(0,0,0))*(-x1b0 + x1_B0(0,0,0))) - 963.219591181376*pow(-x1b0 + x1_B0(0,0,0), 10) -
      5.00332774998597e-10*pow(-x1b0 + x1_B0(0,0,0), 41) - 2350.50583558694*pow(-x1b0 + x1_B0(0,0,0), 8) -
      7.21842324650787e-8*pow(-x1b0 + x1_B0(0,0,0), 34) - 6.05520425821213e-13*pow(-x1b0 + x1_B0(0,0,0), 48) -
      3.07059412200436*x1b0 - 1.50427338371676e-6*pow(-x1b0 + x1_B0(0,0,0), 32) - 0.398609420164928*pow(-x1b0 +
      x1_B0(0,0,0), 18) - 1.53685015420679e-9*pow(-x1b0 + x1_B0(0,0,0), 39) - 4.99721448676308e-11*pow(-x1b0 +
      x1_B0(0,0,0), 42) - 30.1943435013091*pow(-x1b0 + x1_B0(0,0,0), 13)
)
: (
   1.0000013006707
));
...
void opensbliblock00Kernel016(const ACC<double> &rho_B0, const ACC<double> &rhou0_B0, ACC<double> &u0_B0)
{
...
ACC<double> &u1_B0, const ACC<double> &u2_B0, ACC<double> &p_B0)
{
 ...
 void opensbliblock00Kernel015(const ACC<double> &D00_B0, const ACC<double> &D01_B0, const ACC<double> &u0_B0, const
ACC<double> &u1_B0, ACC<double> &U0_B0)
{
 ...
 void opensbliblock00Kernel018(const ACC<double> &D10_B0, const ACC<double> &D11_B0, const ACC<double> &u0_B0, const
...
void opensbliblock00Kernel007(const ACC<double> &p_B0, const ACC<double> &rho_B0, ACC<double> &a_B0)
{
