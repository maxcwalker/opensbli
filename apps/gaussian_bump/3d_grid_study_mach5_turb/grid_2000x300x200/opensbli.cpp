...
ops_write_plane_group_hdf5({{0, 875}}, slice_name0, {{x2_B0, x1_B0}});
...
ops_par_loop(opensbliblock00Kernel006, "CRp", opensbliblock00, 3, iteration_range_6_block0,
...
ops_par_loop(opensbliblock00Kernel007, "CRa", opensbliblock00, 3, iteration_range_7_block0,
...
ops_par_loop(opensbliblock00Kernel031, "CRmu_B0", opensbliblock00, 3, iteration_range_31_block0,
...
if (iter == 0){
ops_fprintf(f0, "Iteration, Time, p_B0(250, 0, 100.0), p_B0(480, 0, 100.0), p_B0(500, 0, 100.0), p_B0(875, 0, 100.0), p_B0(935, 0, 100.0), p_B0(955, 0, 100.0), p_B0(1000, 0, 100.0), p_B0(1065, 0, 100.0), p_B0(1125, 0, 100.0), p_B0(1200, 0, 100.0), p_B0(1250, 0, 100.0), p_B0(1375, 0, 100.0), p_B0(1500, 0, 100.0), p_B0(1625, 0, 100.0), p_B0(1750, 0, 100.0), p_B0(1875, 0, 100.0), p_B0(1995, 0, 100.0), rhou0_B0(250, 1, 100.0), rhou0_B0(480, 1, 100.0), rhou0_B0(500, 1, 100.0), rhou0_B0(875, 1, 100.0), rhou0_B0(935, 1, 100.0), rhou0_B0(955, 1, 100.0), rhou0_B0(1000, 1, 100.0), rhou0_B0(1065, 1, 100.0), rhou0_B0(1125, 1, 100.0), rhou0_B0(1200, 1, 100.0), rhou0_B0(1250, 1, 100.0), rhou0_B0(1375, 1, 100.0), rhou0_B0(1500, 1, 100.0), rhou0_B0(1625, 1, 100.0), rhou0_B0(1750, 1, 100.0), rhou0_B0(1875, 1, 100.0), rhou0_B0(1995, 1, 100.0)\n");}
// Monitoring of p_B0
...
int i010 = 1250, j010 = 0, k010 = 100.0;
...
int i011 = 1375, j011 = 0, k011 = 100.0;
...
int i012 = 1500, j012 = 0, k012 = 100.0;
...
int i013 = 1625, j013 = 0, k013 = 100.0;
...
int i014 = 1750, j014 = 0, k014 = 100.0;
...
int i015 = 1875, j015 = 0, k015 = 100.0;
...
int i016 = 1995, j016 = 0, k016 = 100.0;
...
int i017 = 250, j017 = 1, k017 = 100.0;
...
int i018 = 480, j018 = 1, k018 = 100.0;
...
int i019 = 500, j019 = 1, k019 = 100.0;
...
int i020 = 875, j020 = 1, k020 = 100.0;
...
int i021 = 935, j021 = 1, k021 = 100.0;
...
int i022 = 955, j022 = 1, k022 = 100.0;
...
int i023 = 1000, j023 = 1, k023 = 100.0;
...
int i024 = 1065, j024 = 1, k024 = 100.0;
...
int i025 = 1125, j025 = 1, k025 = 100.0;
...
int i026 = 1200, j026 = 1, k026 = 100.0;
...
int i027 = 1250, j027 = 1, k027 = 100.0;
...
int i028 = 1375, j028 = 1, k028 = 100.0;
...
int i029 = 1500, j029 = 1, k029 = 100.0;
...
int i030 = 1625, j030 = 1, k030 = 100.0;
...
int i031 = 1750, j031 = 1, k031 = 100.0;
...
int i032 = 1875, j032 = 1, k032 = 100.0;
...
int i033 = 1995, j033 = 1, k033 = 100.0;
...
ops_write_plane_group_hdf5({{0, 875}}, slice_name0, {{rho_B0, rhou0_B0, rhou1_B0, rhou2_B0, rhoE_B0}});
