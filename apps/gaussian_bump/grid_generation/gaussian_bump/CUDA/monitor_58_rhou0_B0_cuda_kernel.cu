...
void monitor_58_rhou0_B0_gpu(const ACC<double> &rhou0_B0,
...
void ops_par_loop_monitor_58_rhou0_B0(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1) {
  ...
  create_kerneldesc_and_enque(name, args, 2, 97, dim, 1, range, block, ops_par_loop_monitor_58_rhou0_B0_execute);
}
#endif
