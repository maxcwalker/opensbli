...
void monitor_81_rhou2_B0_gpu(const ACC<double> &rhou2_B0,
...
void ops_par_loop_monitor_81_rhou2_B0(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1) {
  ...
  create_kerneldesc_and_enque(name, args, 2, 120, dim, 1, range, block, ops_par_loop_monitor_81_rhou2_B0_execute);
}
#endif
