  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0 && (end[2]-start[2])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      , [=](cl::sycl::nd_item<3> item
        ...
        const ACC<double> u0_B0(xdim2_opensbliblock00Kernel011, ydim2_opensbliblock00Kernel011, &u0_B0_p[0] + base2 + n_x*1 + n_y * xdim2_opensbliblock00Kernel011*1 + n_z * xdim2_opensbliblock00Kernel011 * ydim2_opensbliblock00Kernel011*1);
        const ACC<double> u1_B0(xdim3_opensbliblock00Kernel011, ydim3_opensbliblock00Kernel011, &u1_B0_p[0] + base3 + n_x*1 + n_y * xdim3_opensbliblock00Kernel011*1 + n_z * xdim3_opensbliblock00Kernel011 * ydim3_opensbliblock00Kernel011*1);
        ACC<double> U0_B0(xdim4_opensbliblock00Kernel011, ydim4_opensbliblock00Kernel011, &U0_B0_p[0] + base4 + n_x*1 + n_y * xdim4_opensbliblock00Kernel011*1 + n_z * xdim4_opensbliblock00Kernel011 * ydim4_opensbliblock00Kernel011*1);
        //USER CODE
