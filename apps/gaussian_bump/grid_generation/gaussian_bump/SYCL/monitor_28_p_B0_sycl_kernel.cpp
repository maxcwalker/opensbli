  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0 && (end[2]-start[2])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      , [=](cl::sycl::nd_item<3> item
        ...
        const ACC<double> p_B0(xdim0_monitor_28_p_B0, ydim0_monitor_28_p_B0, &p_B0_p[0] + base0 + n_x*1 + n_y * xdim0_monitor_28_p_B0*1 + n_z * xdim0_monitor_28_p_B0 * ydim0_monitor_28_p_B0*1);
