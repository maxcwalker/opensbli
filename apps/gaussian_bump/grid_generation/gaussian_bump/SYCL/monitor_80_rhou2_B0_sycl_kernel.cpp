...
void ops_par_loop_monitor_80_rhou2_B0_execute(ops_kernel_descriptor *desc) {
  ...
  if (block->instance->OPS_diags > 1) {
    ...
    block->instance->OPS_kernels[119].mpi_time += __t1-__t2;
  }
  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0 && (end[2]-start[2])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      , [=](cl::sycl::nd_item<3> item
        ...
        const ACC<double> rhou2_B0(xdim0_monitor_80_rhou2_B0, ydim0_monitor_80_rhou2_B0, &rhou2_B0_p[0] + base0 + n_x*1 + n_y * xdim0_monitor_80_rhou2_B0*1 + n_z * xdim0_monitor_80_rhou2_B0 * ydim0_monitor_80_rhou2_B0*1);
...
*reduce_80_rhou2_B0 = rhou2_B0(0,0,0);
  ...
  if (block->instance->OPS_diags > 1) {
    ...
    ops_timers_core(&__c2,&__t2);
    block->instance->OPS_kernels[119].time += __t2-__t1;
  }
  #ifndef OPS_LAZY
...
void ops_par_loop_monitor_80_rhou2_B0(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1) {
  ...
  desc->args[1] = arg1;
  desc->function = ops_par_loop_monitor_80_rhou2_B0_execute;
  if (block->instance->OPS_diags > 1) {
    ops_timing_realloc(block->instance,119,"monitor_80_rhou2_B0");
  }
