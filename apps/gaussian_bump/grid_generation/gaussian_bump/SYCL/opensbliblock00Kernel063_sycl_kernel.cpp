  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0 && (end[2]-start[2])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      , [=](cl::sycl::nd_item<3> item
        ...
        ACC<double> rho_B0(xdim4_opensbliblock00Kernel063, ydim4_opensbliblock00Kernel063, &rho_B0_p[0] + base4 + n_x*1 + n_y * xdim4_opensbliblock00Kernel063*1 + n_z * xdim4_opensbliblock00Kernel063 * ydim4_opensbliblock00Kernel063*1);
        ACC<double> rhou0_B0(xdim5_opensbliblock00Kernel063, ydim5_opensbliblock00Kernel063, &rhou0_B0_p[0] + base5 + n_x*1 + n_y * xdim5_opensbliblock00Kernel063*1 + n_z * xdim5_opensbliblock00Kernel063 * ydim5_opensbliblock00Kernel063*1);
        ACC<double> rhou1_B0(xdim6_opensbliblock00Kernel063, ydim6_opensbliblock00Kernel063, &rhou1_B0_p[0] + base6 + n_x*1 + n_y * xdim6_opensbliblock00Kernel063*1 + n_z * xdim6_opensbliblock00Kernel063 * ydim6_opensbliblock00Kernel063*1);
        ACC<double> rhou2_B0(xdim7_opensbliblock00Kernel063, ydim7_opensbliblock00Kernel063, &rhou2_B0_p[0] + base7 + n_x*1 + n_y * xdim7_opensbliblock00Kernel063*1 + n_z * xdim7_opensbliblock00Kernel063 * ydim7_opensbliblock00Kernel063*1);
