...
void ops_par_loop_monitor_119_rhou2_B0_execute(ops_kernel_descriptor *desc) {
  ...
  #ifdef OPS_DEBUG
  ops_register_args(block->instance, args, "monitor_119_rhou2_B0");
  #endif
  ...
  int xdim0_monitor_119_rhou2_B0 = args[0].dat->size[0];
  int ydim0_monitor_119_rhou2_B0 = args[0].dat->size[1];
  ...
  if (block->instance->OPS_diags > 1) {
    ...
    block->instance->OPS_kernels[158].mpi_time += __t1-__t2;
  }
  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0 && (end[2]-start[2])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      cgh.parallel_for<class monitor_119_rhou2_B0_kernel>(cl::sycl::nd_range<3>(cl::sycl::range<3>(
      ...
      , [=](cl::sycl::nd_item<3> item
        ...
        const ACC<double> rhou2_B0(xdim0_monitor_119_rhou2_B0, ydim0_monitor_119_rhou2_B0, &rhou2_B0_p[0] + base0 + n_x*1 + n_y * xdim0_monitor_119_rhou2_B0*1 + n_z * xdim0_monitor_119_rhou2_B0 * ydim0_monitor_119_rhou2_B0*1);
        double reduce_119_rhou2_B0[1];
        reduce_119_rhou2_B0[0] = ZERO_double;
        //USER CODE
...
*reduce_119_rhou2_B0 = rhou2_B0(0,0,0);
        ...
        for ( int d=0; d<1; d++ ){
          ops_reduction_sycl<OPS_INC>(arg1_data_d + d+item.get_group_linear_id()*1, reduce_119_rhou2_B0[d], (double*)&local_mem[0], item, group_size);
        }
      });
    });
  }
  ...
  if (block->instance->OPS_diags > 1) {
    ...
    ops_timers_core(&__c2,&__t2);
    block->instance->OPS_kernels[158].time += __t2-__t1;
  }
  #ifndef OPS_LAZY
...
void ops_par_loop_monitor_119_rhou2_B0(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1) {
  ...
  desc->index = 158;
  desc->hash = 5381;
  desc->hash = ((desc->hash << 5) + desc->hash) + 158;
  for ( int i=0; i<6; i++ ){
  ...
  desc->args[1] = arg1;
  desc->function = ops_par_loop_monitor_119_rhou2_B0_execute;
  if (block->instance->OPS_diags > 1) {
    ops_timing_realloc(block->instance,158,"monitor_119_rhou2_B0");
  }
