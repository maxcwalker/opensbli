  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0 && (end[2]-start[2])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      , [=](cl::sycl::nd_item<3> item
        ...
        const ACC<double> rhou0_B0(xdim0_monitor_59_rhou0_B0, ydim0_monitor_59_rhou0_B0, &rhou0_B0_p[0] + base0 + n_x*1 + n_y * xdim0_monitor_59_rhou0_B0*1 + n_z * xdim0_monitor_59_rhou0_B0 * ydim0_monitor_59_rhou0_B0*1);
...
void ops_par_loop_monitor_59_rhou0_B0(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1) {
  ...
  desc->args[1] = arg1;
  desc->function = ops_par_loop_monitor_59_rhou0_B0_execute;
  if (block->instance->OPS_diags > 1) {
    ops_timing_realloc(block->instance,98,"monitor_59_rhou0_B0");
  }
