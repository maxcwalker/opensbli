  ...
  for ( int n_z=start[2]; n_z<end[2]; n_z++ ){
    for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
      ...
      for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
        const ACC<double> rhoE_B0(xdim0_opensbliblock00Kernel006, ydim0_opensbliblock00Kernel006, rhoE_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel006*1 + n_z * xdim0_opensbliblock00Kernel006 * ydim0_opensbliblock00Kernel006*1);
        const ACC<double> rho_B0(xdim1_opensbliblock00Kernel006, ydim1_opensbliblock00Kernel006, rho_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel006*1 + n_z * xdim1_opensbliblock00Kernel006 * ydim1_opensbliblock00Kernel006*1);
        const ACC<double> u0_B0(xdim2_opensbliblock00Kernel006, ydim2_opensbliblock00Kernel006, u0_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel006*1 + n_z * xdim2_opensbliblock00Kernel006 * ydim2_opensbliblock00Kernel006*1);
        const ACC<double> u1_B0(xdim3_opensbliblock00Kernel006, ydim3_opensbliblock00Kernel006, u1_B0_p + n_x*1 + n_y * xdim3_opensbliblock00Kernel006*1 + n_z * xdim3_opensbliblock00Kernel006 * ydim3_opensbliblock00Kernel006*1);
        const ACC<double> u2_B0(xdim4_opensbliblock00Kernel006, ydim4_opensbliblock00Kernel006, u2_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel006*1 + n_z * xdim4_opensbliblock00Kernel006 * ydim4_opensbliblock00Kernel006*1);
        ACC<double> p_B0(xdim5_opensbliblock00Kernel006, ydim5_opensbliblock00Kernel006, p_B0_p + n_x*1 + n_y * xdim5_opensbliblock00Kernel006*1 + n_z * xdim5_opensbliblock00Kernel006 * ydim5_opensbliblock00Kernel006*1);
...
void ops_par_loop_opensbliblock00Kernel006(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4, ops_arg arg5) {
  ...
  create_kerneldesc_and_enque(name, args, 6, 14, dim, 0, range, block, ops_par_loop_opensbliblock00Kernel006_execute);
}
#endif
