...
//
    ...
    void buildOpenCLKernels_monitor_51_rhou0_B0(OPS_instance *instance, int xdim0, int ydim0) {
      ...
      if(!isbuilt_monitor_51_rhou0_B0) {
        ...
        instance->opencl_instance->OPS_opencl_core.kernel[90] = clCreateKernel(instance->opencl_instance->OPS_opencl_core.program, "ops_monitor_51_rhou0_B0", &ret);
        clSafeCall( ret );
...
void ops_par_loop_monitor_51_rhou0_B0(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1) {
  ...
  if (block->instance->OPS_diags > 1) {
    ops_timing_realloc(block->instance,90,"monitor_51_rhou0_B0");
