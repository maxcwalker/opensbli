...
//
    ...
    void buildOpenCLKernels_opensbliblock00Kernel008(OPS_instance *instance, int xdim0, int ydim0, int xdim1, int ydim1, int xdim2, int ydim2, int xdim3, int ydim3, int xdim4, int ydim4, int xdim5, int ydim5) {
      ...
      if(!isbuilt_opensbliblock00Kernel008) {
        ...
        instance->ostream() <<"Compiling opensbliblock00Kernel008 "<<OCL_FMA<<" source -- start \n";
          ...
          if (pPath!=NULL)
            if(OCL_FMA)
              sprintf(buildOpts,"-cl-mad-enable -DOCL_FMA -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_opensbliblock00Kernel008=%d  -Dydim0_opensbliblock00Kernel008=%d  -Dxdim1_opensbliblock00Kernel008=%d  -Dydim1_opensbliblock00Kernel008=%d  -Dxdim2_opensbliblock00Kernel008=%d  -Dydim2_opensbliblock00Kernel008=%d  -Dxdim3_opensbliblock00Kernel008=%d  -Dydim3_opensbliblock00Kernel008=%d  -Dxdim4_opensbliblock00Kernel008=%d  -Dydim4_opensbliblock00Kernel008=%d  -Dxdim5_opensbliblock00Kernel008=%d  -Dydim5_opensbliblock00Kernel008=%d ", pPath, 32,xdim0,ydim0,xdim1,ydim1,xdim2,ydim2,xdim3,ydim3,xdim4,ydim4,xdim5,ydim5);
            else
...
void ops_par_loop_opensbliblock00Kernel008(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4, ops_arg arg5) {
  ...
  if (globalWorkSize[0]>0 && globalWorkSize[1]>0 && globalWorkSize[2]>0) {
    ...
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[14], 6, sizeof(cl_double), (void*) &gama ));
    ...
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[14], 13, sizeof(cl_int), (void*) &x_size ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[14], 14, sizeof(cl_int), (void*) &y_size ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[14], 15, sizeof(cl_int), (void*) &z_size ));
