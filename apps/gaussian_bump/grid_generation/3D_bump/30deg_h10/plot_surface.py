...
class plots_3D(plotFunctions):
    ...
    def rotate_x(self, x, y, z, angle):
        """Rotate data around the x-axis by a given angle (in degrees)."""
    ...
    def plot_3d(self, x, y, z, data, label, x_rotation_angle=70):
        ...
        if x_rotation_angle != 0:
            x, y, z = self.rotate_x(x, y, z, x_rotation_angle)
    ...
    def main_plot(self, fname):
        ...
        self.plot_3d(self.x, self.y, self.z, rho, 'rho')  # Rotate by 45 degrees
