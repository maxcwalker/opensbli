// Auto-generated at 2024-09-02 15:36:03.315796 by ops-translator legacy
...
//  User function
//  =============
__device__ void opensbliblock00Kernel040_gpu(const ACC<double> &u0_B0,
  ACC<double> &wk4_B0,
  const int *idx)
{
   if (idx[1] == 0){
...
//call kernel wrapper function, passing in pointers to data
    ...
    if (block->instance->OPS_diags > 1) {
        ...
        ops_timers_core(&__c2, &__t2);
        block->instance->OPS_kernels[29].mpi_time += __t2 - __t1;
        block->instance->OPS_kernels[29].transfer += ops_compute_transfer(dim, start_indx, end_indx, &arg0);
        block->instance->OPS_kernels[29].transfer += ops_compute_transfer(dim, start_indx, end_indx, &arg1);
    }
}
