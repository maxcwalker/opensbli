// Auto-generated at 2024-09-02 15:36:03.419213 by ops-translator legacy
...
//  User function
//  =============
__device__ void opensbliblock00Kernel063_gpu(const int *iter,
  const ACC<double> &x0_B0,
  const ACC<double> &x2_B0,
  ACC<double>
&rhoE_B0,
  ACC<double> &rho_B0,
  ACC<double> &rhou0_B0,
...
int size2) {
    ...
    arg7 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel063[7][0] + idx_z * 1*1 * dims_opensbliblock00Kernel063[7][0] * dims_opensbliblock00Kernel063[7][1];

    if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
        const ACC<double> argp1(dims_opensbliblock00Kernel063[1][0], dims_opensbliblock00Kernel063[1][1], arg1);
        const ACC<double> argp2(dims_opensbliblock00Kernel063[2][0], dims_opensbliblock00Kernel063[2][1], arg2);
        ...
        ACC<double> argp7(dims_opensbliblock00Kernel063[7][0], dims_opensbliblock00Kernel063[7][1], arg7);
        opensbliblock00Kernel063_gpu(
...
//  =================================================
...
#else
    if (compute_ranges(args, 8, block, range, start_indx, end_indx, arg_idx) < 0) return;
#endif
    ...
    if (xdim1 != dims_opensbliblock00Kernel063_h[1][0] || ydim1 != dims_opensbliblock00Kernel063_h[1][1] || xdim2 != dims_opensbliblock00Kernel063_h[2][0] || ydim2 != dims_opensbliblock00Kernel063_h[2][1] || xdim3 != dims_opensbliblock00Kernel063_h[3][0] || ydim3 != dims_opensbliblock00Kernel063_h[3][1] || xdim4 != dims_opensbliblock00Kernel063_h[4][0] || ydim4 != dims_opensbliblock00Kernel063_h[4][1] || xdim5 != dims_opensbliblock00Kernel063_h[5][0] || ydim5 != dims_opensbliblock00Kernel063_h[5][1] || xdim6 != dims_opensbliblock00Kernel063_h[6][0] || ydim6 != dims_opensbliblock00Kernel063_h[6][1] || xdim7 != dims_opensbliblock00Kernel063_h[7][0] || ydim7 != dims_opensbliblock00Kernel063_h[7][1]) {
        ...
        dims_opensbliblock00Kernel063_h[7][0] = xdim7;
        dims_opensbliblock00Kernel063_h[7][1] = ydim7;

        hipSafeCall(block->instance->ostream(), hipMemcpyToSymbol( dims_opensbliblock00Kernel063, dims_opensbliblock00Kernel063_h, sizeof(dims_opensbliblock00Kernel063)));
    }
...
//call kernel wrapper function, passing in pointers to data
    if (x_size > 0 && y_size > 0 && z_size > 0) {
        ...
        ops_opensbliblock00Kernel063<<<grid, tblock >>> ( 
    ...
    if (block->instance->OPS_diags > 1) {
        ...
        block->instance->OPS_kernels[9].transfer += ops_compute_transfer(dim, start_indx, end_indx, &arg2);
        block->instance->OPS_kernels[9].transfer += ops_compute_transfer(dim, start_indx, end_indx, &arg3);
        block->instance->OPS_kernels[9].transfer += ops_compute_transfer(dim, start_indx, end_indx, &arg4);
        block->instance->OPS_kernels[9].transfer += ops_compute_transfer(dim, start_indx, end_indx, &arg5);
        block->instance->OPS_kernels[9].transfer += ops_compute_transfer(dim, start_indx, end_indx, &arg6);
        block->instance->OPS_kernels[9].transfer += ops_compute_transfer(dim, start_indx, end_indx, &arg7);
    }
}
