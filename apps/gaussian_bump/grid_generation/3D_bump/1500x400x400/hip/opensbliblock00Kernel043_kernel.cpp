// Auto-generated at 2024-09-02 15:36:03.545638 by ops-translator legacy

__constant__ int dims_opensbliblock00Kernel043 [3][2];
static int dims_opensbliblock00Kernel043_h [3][2] = {{0}};

//  =============
//  User function
//  =============
__device__ void opensbliblock00Kernel043_gpu(const ACC<double> &T_B0,
  ACC<double> &wk7_B0,
  const int *idx)
{
   if (idx[1] == 0){
...
int size2) {
    ...
    arg0 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel043[0][0] + idx_z * 1*1 * dims_opensbliblock00Kernel043[0][0] * dims_opensbliblock00Kernel043[0][1];
    arg1 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel043[1][0] + idx_z * 1*1 * dims_opensbliblock00Kernel043[1][0] * dims_opensbliblock00Kernel043[1][1];

    if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
        const ACC<double> argp0(dims_opensbliblock00Kernel043[0][0], dims_opensbliblock00Kernel043[0][1], arg0);
        ACC<double> argp1(dims_opensbliblock00Kernel043[1][0], dims_opensbliblock00Kernel043[1][1], arg1);
...
//  =================================================
    ...
    if (xdim0 != dims_opensbliblock00Kernel043_h[0][0] || ydim0 != dims_opensbliblock00Kernel043_h[0][1] || xdim1 != dims_opensbliblock00Kernel043_h[1][0] || ydim1 != dims_opensbliblock00Kernel043_h[1][1]) {
        dims_opensbliblock00Kernel043_h[0][0] = xdim0;
        dims_opensbliblock00Kernel043_h[0][1] = ydim0;
        dims_opensbliblock00Kernel043_h[1][0] = xdim1;
        dims_opensbliblock00Kernel043_h[1][1] = ydim1;

        hipSafeCall(block->instance->ostream(), hipMemcpyToSymbol( dims_opensbliblock00Kernel043, dims_opensbliblock00Kernel043_h, sizeof(dims_opensbliblock00Kernel043)));
    }
...
//call kernel wrapper function, passing in pointers to data
    ...
    if (block->instance->OPS_diags > 1) {
        ...
        ops_timers_core(&__c2, &__t2);
        block->instance->OPS_kernels[32].mpi_time += __t2 - __t1;
        block->instance->OPS_kernels[32].transfer += ops_compute_transfer(dim, start_indx, end_indx, &arg0);
        block->instance->OPS_kernels[32].transfer += ops_compute_transfer(dim, start_indx, end_indx, &arg1);
    }
}
