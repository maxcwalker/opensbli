// Auto-generated at 2024-09-02 15:36:03.557148 by ops-translator legacy
...
//  User function
//  =============
__device__ void opensbliblock00Kernel046_gpu(const ACC<double> &u2_B0,
  ACC<double> &wk10_B0)
{
...
//  =================================================
    ...
    if (xdim0 != dims_opensbliblock00Kernel046_h[0][0] || ydim0 != dims_opensbliblock00Kernel046_h[0][1] || xdim1 != dims_opensbliblock00Kernel046_h[1][0] || ydim1 != dims_opensbliblock00Kernel046_h[1][1]) {
        ...
        hipSafeCall(block->instance->ostream(), hipMemcpyToSymbol( dims_opensbliblock00Kernel046, dims_opensbliblock00Kernel046_h, sizeof(dims_opensbliblock00Kernel046)));
    }
...
//call kernel wrapper function, passing in pointers to data
    ...
    if (block->instance->OPS_diags > 1) {
        ...
        ops_timers_core(&__c2, &__t2);
        block->instance->OPS_kernels[35].mpi_time += __t2 - __t1;
        block->instance->OPS_kernels[35].transfer += ops_compute_transfer(dim, start_indx, end_indx, &arg0);
        block->instance->OPS_kernels[35].transfer += ops_compute_transfer(dim, start_indx, end_indx, &arg1);
    }
}
