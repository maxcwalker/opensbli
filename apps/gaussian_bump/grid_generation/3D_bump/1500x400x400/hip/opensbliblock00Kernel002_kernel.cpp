// Auto-generated at 2024-09-02 15:36:03.509102 by ops-translator legacy
...
//  User function
//  =============
__device__ void opensbliblock00Kernel002_gpu(const ACC<double> &U2_B0,
...
//  =================================================
...
#else
    if (compute_ranges(args, 17, block, range, start_indx, end_indx, arg_idx) < 0) return;
#endif
    ...
    if (xdim0 != dims_opensbliblock00Kernel002_h[0][0] || ydim0 != dims_opensbliblock00Kernel002_h[0][1] || xdim1 != dims_opensbliblock00Kernel002_h[1][0] || ydim1 != dims_opensbliblock00Kernel002_h[1][1] || xdim2 != dims_opensbliblock00Kernel002_h[2][0] || ydim2 != dims_opensbliblock00Kernel002_h[2][1] || xdim3 != dims_opensbliblock00Kernel002_h[3][0] || ydim3 != dims_opensbliblock00Kernel002_h[3][1] || xdim4 != dims_opensbliblock00Kernel002_h[4][0] || ydim4 != dims_opensbliblock00Kernel002_h[4][1] || xdim5 != dims_opensbliblock00Kernel002_h[5][0] || ydim5 != dims_opensbliblock00Kernel002_h[5][1] || xdim6 != dims_opensbliblock00Kernel002_h[6][0] || ydim6 != dims_opensbliblock00Kernel002_h[6][1] || xdim7 != dims_opensbliblock00Kernel002_h[7][0] || ydim7 != dims_opensbliblock00Kernel002_h[7][1] || xdim8 != dims_opensbliblock00Kernel002_h[8][0] || ydim8 != dims_opensbliblock00Kernel002_h[8][1] || xdim9 != dims_opensbliblock00Kernel002_h[9][0] || ydim9 != dims_opensbliblock00Kernel002_h[9][1] || xdim10 != dims_opensbliblock00Kernel002_h[10][0] || ydim10 != dims_opensbliblock00Kernel002_h[10][1] || xdim11 != dims_opensbliblock00Kernel002_h[11][0] || ydim11 != dims_opensbliblock00Kernel002_h[11][1] || xdim12 != dims_opensbliblock00Kernel002_h[12][0] || ydim12 != dims_opensbliblock00Kernel002_h[12][1] || xdim13 != dims_opensbliblock00Kernel002_h[13][0] || ydim13 != dims_opensbliblock00Kernel002_h[13][1] || xdim14 != dims_opensbliblock00Kernel002_h[14][0] || ydim14 != dims_opensbliblock00Kernel002_h[14][1] || xdim15 != dims_opensbliblock00Kernel002_h[15][0] || ydim15 != dims_opensbliblock00Kernel002_h[15][1] || xdim16 != dims_opensbliblock00Kernel002_h[16][0] || ydim16 != dims_opensbliblock00Kernel002_h[16][1]) {
        ...
        hipSafeCall(block->instance->ostream(), hipMemcpyToSymbol( dims_opensbliblock00Kernel002, dims_opensbliblock00Kernel002_h, sizeof(dims_opensbliblock00Kernel002)));
    }
...
//call kernel wrapper function, passing in pointers to data
    ...
    if (block->instance->OPS_diags > 1) {
        ...
        ops_timers_core(&__c2, &__t2);
        block->instance->OPS_kernels[23].mpi_time += __t2 - __t1;
        block->instance->OPS_kernels[23].transfer += ops_compute_transfer(dim, start_indx, end_indx, &arg0);
        block->instance->OPS_kernels[23].transfer += ops_compute_transfer(dim, start_indx, end_indx, &arg1);
        block->instance->OPS_kernels[23].transfer += ops_compute_transfer(dim, start_indx, end_indx, &arg2);
        block->instance->OPS_kernels[23].transfer += ops_compute_transfer(dim, start_indx, end_indx, &arg3);
        block->instance->OPS_kernels[23].transfer += ops_compute_transfer(dim, start_indx, end_indx, &arg4);
        block->instance->OPS_kernels[23].transfer += ops_compute_transfer(dim, start_indx, end_indx, &arg5);
        block->instance->OPS_kernels[23].transfer += ops_compute_transfer(dim, start_indx, end_indx, &arg6);
        block->instance->OPS_kernels[23].transfer += ops_compute_transfer(dim, start_indx, end_indx, &arg7);
        block->instance->OPS_kernels[23].transfer += ops_compute_transfer(dim, start_indx, end_indx, &arg8);
        block->instance->OPS_kernels[23].transfer += ops_compute_transfer(dim, start_indx, end_indx, &arg9);
        block->instance->OPS_kernels[23].transfer += ops_compute_transfer(dim, start_indx, end_indx, &arg10);
        block->instance->OPS_kernels[23].transfer += ops_compute_transfer(dim, start_indx, end_indx, &arg11);
        block->instance->OPS_kernels[23].transfer += ops_compute_transfer(dim, start_indx, end_indx, &arg12);
        block->instance->OPS_kernels[23].transfer += ops_compute_transfer(dim, start_indx, end_indx, &arg13);
        block->instance->OPS_kernels[23].transfer += ops_compute_transfer(dim, start_indx, end_indx, &arg14);
        block->instance->OPS_kernels[23].transfer += ops_compute_transfer(dim, start_indx, end_indx, &arg15);
        block->instance->OPS_kernels[23].transfer += ops_compute_transfer(dim, start_indx, end_indx, &arg16);
    }
}
