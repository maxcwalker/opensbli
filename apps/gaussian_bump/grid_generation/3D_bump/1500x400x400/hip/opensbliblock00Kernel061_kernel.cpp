// Auto-generated at 2024-09-02 15:36:03.410664 by ops-translator legacy

__constant__ int dims_opensbliblock00Kernel061 [5][2];
static int dims_opensbliblock00Kernel061_h [5][2] = {{0}};

//  =============
//  User function
//  =============
__device__ void opensbliblock00Kernel061_gpu(ACC<double> &rhoE_B0,
  ACC<double> &rho_B0,
  ACC<double> &rhou0_B0,
  ACC<double> &rhou1_B0,
  ACC<double> &rhou2_B0)
...
int size2) {
    ...
    if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
        ACC<double> argp0(dims_opensbliblock00Kernel061[0][0], dims_opensbliblock00Kernel061[0][1], arg0);
        ACC<double> argp1(dims_opensbliblock00Kernel061[1][0], dims_opensbliblock00Kernel061[1][1], arg1);
        ACC<double> argp2(dims_opensbliblock00Kernel061[2][0], dims_opensbliblock00Kernel061[2][1], arg2);
        ACC<double> argp3(dims_opensbliblock00Kernel061[3][0], dims_opensbliblock00Kernel061[3][1], arg3);
        ACC<double> argp4(dims_opensbliblock00Kernel061[4][0], dims_opensbliblock00Kernel061[4][1], arg4);
...
//  =================================================
    ...
    if (xdim0 != dims_opensbliblock00Kernel061_h[0][0] || ydim0 != dims_opensbliblock00Kernel061_h[0][1] || xdim1 != dims_opensbliblock00Kernel061_h[1][0] || ydim1 != dims_opensbliblock00Kernel061_h[1][1] || xdim2 != dims_opensbliblock00Kernel061_h[2][0] || ydim2 != dims_opensbliblock00Kernel061_h[2][1] || xdim3 != dims_opensbliblock00Kernel061_h[3][0] || ydim3 != dims_opensbliblock00Kernel061_h[3][1] || xdim4 != dims_opensbliblock00Kernel061_h[4][0] || ydim4 != dims_opensbliblock00Kernel061_h[4][1]) {
        ...
        hipSafeCall(block->instance->ostream(), hipMemcpyToSymbol( dims_opensbliblock00Kernel061, dims_opensbliblock00Kernel061_h, sizeof(dims_opensbliblock00Kernel061)));
    }
...
//call kernel wrapper function, passing in pointers to data
    ...
    if (block->instance->OPS_diags > 1) {
        ...
        block->instance->OPS_kernels[7].transfer += ops_compute_transfer(dim, start_indx, end_indx, &arg2);
        block->instance->OPS_kernels[7].transfer += ops_compute_transfer(dim, start_indx, end_indx, &arg3);
        block->instance->OPS_kernels[7].transfer += ops_compute_transfer(dim, start_indx, end_indx, &arg4);
    }
}
