...
#define OPENSBLIBLOCK00_KERNEL_H
 void opensbliblock00Kernel067(const ACC<double> &x1_B0, ACC<double> &rhoE_B0, ACC<double> &rho_B0, ACC<double>
&rhou0_B0, ACC<double> &rhou1_B0, ACC<double> &rhou2_B0)
{
   double T = 0.0;
   double rho = 0.0;
   double rhou0 = 0.0;
...
void opensbliblock00Kernel012(const ACC<double> &rho_B0, const ACC<double> &rhou1_B0, ACC<double> &u1_B0)
{
 ...
 void opensbliblock00Kernel004(const ACC<double> &D00_B0, const ACC<double> &D01_B0, const ACC<double> &u0_B0, const
