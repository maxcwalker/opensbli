...
ops_write_const_hdf5("b_f", 1, "double", (char*)&b_f, filename);
ops_write_const_hdf5("beta_0", 1, "double", (char*)&beta_0, filename);
...
void HDF5_IO_Write_1_opensbliblock00_dynamic(ops_block& opensbliblock00, int iter, ops_dat& rho_B0, ops_dat& rhou0_B0, ops_dat& rhou1_B0, ops_dat& rhou2_B0, ops_dat& rhoE_B0, ops_dat& x0_B0, ops_dat& x1_B0, ops_dat& x2_B0, ops_dat& D11_B0, ops_dat& p_B0, int HDF5_timing){
...
void HDF5_IO_Write_1_opensbliblock00(ops_block& opensbliblock00, ops_dat& rho_B0, ops_dat& rhou0_B0, ops_dat& rhou1_B0, ops_dat& rhou2_B0, ops_dat& rhoE_B0, ops_dat& x0_B0, ops_dat& x1_B0, ops_dat& x2_B0, ops_dat& D11_B0, ops_dat& p_B0, int HDF5_timing){
double cpu_start0, elapsed_start0;
if (HDF5_timing == 1){
ops_timers(&cpu_start0, &elapsed_start0);
}
