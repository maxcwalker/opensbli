// Auto-generated at 2024-09-02 15:36:04.195856 by ops-translator legacy
    ...
    if ((end[0]-start[0])>0 && (end[1]-start[1])>0 && (end[2]-start[2])>0) {
        block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
          ...
          , [=](cl::sycl::nd_item<3> item
              ...
              const ACC<double> x1_B0(xdim0_opensbliblock00Kernel067, ydim0_opensbliblock00Kernel067, x1_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel067*1 + n_z * xdim0_opensbliblock00Kernel067 * ydim0_opensbliblock00Kernel067*1);
              ACC<double> rhoE_B0(xdim1_opensbliblock00Kernel067, ydim1_opensbliblock00Kernel067, rhoE_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel067*1 + n_z * xdim1_opensbliblock00Kernel067 * ydim1_opensbliblock00Kernel067*1);
              ACC<double> rho_B0(xdim2_opensbliblock00Kernel067, ydim2_opensbliblock00Kernel067, rho_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel067*1 + n_z * xdim2_opensbliblock00Kernel067 * ydim2_opensbliblock00Kernel067*1);
              ACC<double> rhou0_B0(xdim3_opensbliblock00Kernel067, ydim3_opensbliblock00Kernel067, rhou0_B0_p + n_x*1 + n_y * xdim3_opensbliblock00Kernel067*1 + n_z * xdim3_opensbliblock00Kernel067 * ydim3_opensbliblock00Kernel067*1);
              ACC<double> rhou1_B0(xdim4_opensbliblock00Kernel067, ydim4_opensbliblock00Kernel067, rhou1_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel067*1 + n_z * xdim4_opensbliblock00Kernel067 * ydim4_opensbliblock00Kernel067*1);
              ACC<double> rhou2_B0(xdim5_opensbliblock00Kernel067, ydim5_opensbliblock00Kernel067, rhou2_B0_p + n_x*1 + n_y * xdim5_opensbliblock00Kernel067*1 + n_z * xdim5_opensbliblock00Kernel067 * ydim5_opensbliblock00Kernel067*1);
//  =========
//  User code
//  =========
