// Auto-generated at 2024-09-02 15:36:04.311343 by ops-translator legacy
...
//  ==================
#ifndef OPS_LAZY
void ops_par_loop_opensbliblock00Kernel030(
    const char *name,
    ops_block block,
    int dim,
    int* range,
    ...
    if ((end[0]-start[0])>0 && (end[1]-start[1])>0 && (end[2]-start[2])>0) {
        block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
          ...
          , [=](cl::sycl::nd_item<3> item
              ...
              const ACC<double> p_B0(xdim0_opensbliblock00Kernel030, ydim0_opensbliblock00Kernel030, p_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel030*1 + n_z * xdim0_opensbliblock00Kernel030 * ydim0_opensbliblock00Kernel030*1);
              const ACC<double> rho_B0(xdim1_opensbliblock00Kernel030, ydim1_opensbliblock00Kernel030, rho_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel030*1 + n_z * xdim1_opensbliblock00Kernel030 * ydim1_opensbliblock00Kernel030*1);
              ACC<double> T_B0(xdim2_opensbliblock00Kernel030, ydim2_opensbliblock00Kernel030, T_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel030*1 + n_z * xdim2_opensbliblock00Kernel030 * ydim2_opensbliblock00Kernel030*1);
//  =========
//  User code
//  =========
                if (n_x < end_0 && n_y < end_1 && n_z < end_2) {
                    
   T_B0(0,0,0) = (Minf_sycl[0]*Minf_sycl[0])*gama_sycl[0]*p_B0(0,0,0)/rho_B0(0,0,0);
