// Auto-generated at 2024-09-02 15:36:04.554108 by ops-translator legacy
...
//  ==================
#ifndef OPS_LAZY
void ops_par_loop_opensbliblock00Kernel036(
    const char *name,
    ops_block block,
    int dim,
    int* range,
...
//  =====================================================
    ...
    int ydim0_opensbliblock00Kernel036 = args[0].dat->size[1];
    int xdim1_opensbliblock00Kernel036 = args[1].dat->size[0];
    int ydim1_opensbliblock00Kernel036 = args[1].dat->size[1];
...
//  =======================================================
    ...
    double * __restrict__ wk2_B0_p = (double *)(args[1].data_d + base1);
...
//  ==============
    ...
    if ((end[0]-start[0])>0 && (end[1]-start[1])>0 && (end[2]-start[2])>0) {
        block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
          ...
          cgh.parallel_for<class opensbliblock00Kernel036_kernel>(cl::sycl::nd_range<3>(cl::sycl::range<3>(
          ...
          , [=](cl::sycl::nd_item<3> item
              ...
              const ACC<double> u2_B0(xdim0_opensbliblock00Kernel036, ydim0_opensbliblock00Kernel036, u2_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel036*1 + n_z * xdim0_opensbliblock00Kernel036 * ydim0_opensbliblock00Kernel036*1);
              ACC<double> wk2_B0(xdim1_opensbliblock00Kernel036, ydim1_opensbliblock00Kernel036, wk2_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel036*1 + n_z * xdim1_opensbliblock00Kernel036 * ydim1_opensbliblock00Kernel036*1);
//  =========
//  User code
//  =========
