// Auto-generated at 2024-09-02 15:36:04.262388 by ops-translator legacy
...
//  =========
   ...
   double u23 = 0.0;
   double u24 = 0.0;
    rhou1_B0(0,0,0) = tripA_sycl[0]*rho_B0(0,0,0)*cl::sycl::exp(-((-xts_sycl[0] + x0_B0(0,0,0))*(-xts_sycl[0] +
      x0_B0(0,0,0)))*b_f_sycl[0])*cl::sycl::sin(beta_0_sycl[0]*x2_B0(0,0,0))*cl::sycl::sin(dt_sycl[0]*omega_0_sycl[0]* *iter);
