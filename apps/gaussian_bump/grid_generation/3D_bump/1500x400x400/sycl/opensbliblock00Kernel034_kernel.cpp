// Auto-generated at 2024-09-02 15:36:04.548935 by ops-translator legacy
...
//  ==================
#ifndef OPS_LAZY
void ops_par_loop_opensbliblock00Kernel034(
    const char *name,
    ops_block block,
    int dim,
    int* range,
...
//  ==============
    ...
    if (block->instance->OPS_diags > 1) {
        ...
        block->instance->OPS_kernels[26].mpi_time += __t2 - __t1;
    }
    ...
    if ((end[0]-start[0])>0 && (end[1]-start[1])>0 && (end[2]-start[2])>0) {
        block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
          ...
          , [=](cl::sycl::nd_item<3> item
              ...
              const ACC<double> u1_B0(xdim0_opensbliblock00Kernel034, ydim0_opensbliblock00Kernel034, u1_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel034*1 + n_z * xdim0_opensbliblock00Kernel034 * ydim0_opensbliblock00Kernel034*1);
              ACC<double> wk1_B0(xdim1_opensbliblock00Kernel034, ydim1_opensbliblock00Kernel034, wk1_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel034*1 + n_z * xdim1_opensbliblock00Kernel034 * ydim1_opensbliblock00Kernel034*1);
//  =========
//  User code
//  =========
   ...
   if (idx[0] == 0){
       ...
       wk1_B0(0,0,0) = (-3*u1_B0(2,0,0) + 4*u1_B0(1,0,0) - (25.0/12.0)*u1_B0(0,0,0) - (1.0/4.0)*u1_B0(4,0,0) +
            ((4.0/3.0))*u1_B0(3,0,0))*invDelta0block0_sycl[0];
       ...
       wk1_B0(0,0,0) = (-(5.0/6.0)*u1_B0(0,0,0) - (1.0/2.0)*u1_B0(2,0,0) - (1.0/4.0)*u1_B0(-1,0,0) +
            ((1.0/12.0))*u1_B0(3,0,0) + ((3.0/2.0))*u1_B0(1,0,0))*invDelta0block0_sycl[0];
       ...
       wk1_B0(0,0,0) = (-4*u1_B0(-1,0,0) + 3*u1_B0(-2,0,0) - (4.0/3.0)*u1_B0(-3,0,0) + ((1.0/4.0))*u1_B0(-4,0,0) +
            ((25.0/12.0))*u1_B0(0,0,0))*invDelta0block0_sycl[0];
       ...
       wk1_B0(0,0,0) = (((1.0/2.0))*u1_B0(-2,0,0) - (3.0/2.0)*u1_B0(-1,0,0) - (1.0/12.0)*u1_B0(-3,0,0) +
            ((1.0/4.0))*u1_B0(1,0,0) + ((5.0/6.0))*u1_B0(0,0,0))*invDelta0block0_sycl[0];
    ...
    if (block->instance->OPS_diags > 1) {
        ...
        ops_timers_core(&__c1, &__t1);
        block->instance->OPS_kernels[26].time += __t1 -__t2;
    }
  ...
  )
{
    ...
    create_kerneldesc_and_enque("opensbliblock00Kernel034", args, 3, 26, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel034_execute);
}
#endif
