// Auto-generated at 2024-09-02 15:36:04.291608 by ops-translator legacy
...
//  ==================
#ifndef OPS_LAZY
void ops_par_loop_opensbliblock00Kernel009(
    const char *name,
    ops_block block,
    int dim,
    int* range,
    ...
    if ((end[0]-start[0])>0 && (end[1]-start[1])>0 && (end[2]-start[2])>0) {
        block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
          ...
          , [=](cl::sycl::nd_item<3> item
              ...
              const ACC<double> rhoE_B0(xdim0_opensbliblock00Kernel009, ydim0_opensbliblock00Kernel009, rhoE_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel009*1 + n_z * xdim0_opensbliblock00Kernel009 * ydim0_opensbliblock00Kernel009*1);
              const ACC<double> rho_B0(xdim1_opensbliblock00Kernel009, ydim1_opensbliblock00Kernel009, rho_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel009*1 + n_z * xdim1_opensbliblock00Kernel009 * ydim1_opensbliblock00Kernel009*1);
              const ACC<double> u0_B0(xdim2_opensbliblock00Kernel009, ydim2_opensbliblock00Kernel009, u0_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel009*1 + n_z * xdim2_opensbliblock00Kernel009 * ydim2_opensbliblock00Kernel009*1);
              const ACC<double> u1_B0(xdim3_opensbliblock00Kernel009, ydim3_opensbliblock00Kernel009, u1_B0_p + n_x*1 + n_y * xdim3_opensbliblock00Kernel009*1 + n_z * xdim3_opensbliblock00Kernel009 * ydim3_opensbliblock00Kernel009*1);
              const ACC<double> u2_B0(xdim4_opensbliblock00Kernel009, ydim4_opensbliblock00Kernel009, u2_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel009*1 + n_z * xdim4_opensbliblock00Kernel009 * ydim4_opensbliblock00Kernel009*1);
