...
ops_write_plane_group_hdf5({{1, 1}}, slice_name0, {{x0_B0, x2_B0}});
ops_write_plane_group_hdf5({{0, 187}}, slice_name0, {{x2_B0, x1_B0}});
ops_write_plane_group_hdf5({{0, 337}}, slice_name0, {{x2_B0, x1_B0}});
ops_write_plane_group_hdf5({{0, 375}}, slice_name0, {{x2_B0, x1_B0}});
ops_write_plane_group_hdf5({{0, 412}}, slice_name0, {{x2_B0, x1_B0}});
ops_write_plane_group_hdf5({{0, 468}}, slice_name0, {{x2_B0, x1_B0}});
ops_write_plane_group_hdf5({{0, 562}}, slice_name0, {{x2_B0, x1_B0}});
ops_write_plane_group_hdf5({{0, 600}}, slice_name0, {{x2_B0, x1_B0}});
ops_write_plane_group_hdf5({{0, 637}}, slice_name0, {{x2_B0, x1_B0}});
ops_write_plane_group_hdf5({{0, 675}}, slice_name0, {{x2_B0, x1_B0}});
ops_write_plane_group_hdf5({{0, 712}}, slice_name0, {{x2_B0, x1_B0}});
ops_write_plane_group_hdf5({{0, 750}}, slice_name0, {{x2_B0, x1_B0}});
ops_write_plane_group_hdf5({{0, 787}}, slice_name0, {{x2_B0, x1_B0}});
ops_write_plane_group_hdf5({{0, 825}}, slice_name0, {{x2_B0, x1_B0}});
ops_write_plane_group_hdf5({{0, 862}}, slice_name0, {{x2_B0, x1_B0}});
ops_write_plane_group_hdf5({{0, 900}}, slice_name0, {{x2_B0, x1_B0}});
ops_write_plane_group_hdf5({{0, 937}}, slice_name0, {{x2_B0, x1_B0}});
ops_write_plane_group_hdf5({{0, 1031}}, slice_name0, {{x2_B0, x1_B0}});
ops_write_plane_group_hdf5({{0, 1125}}, slice_name0, {{x2_B0, x1_B0}});
ops_write_plane_group_hdf5({{0, 1162}}, slice_name0, {{x2_B0, x1_B0}});
ops_write_plane_group_hdf5({{0, 1218}}, slice_name0, {{x2_B0, x1_B0}});
ops_write_plane_group_hdf5({{0, 1312}}, slice_name0, {{x2_B0, x1_B0}});
ops_write_plane_group_hdf5({{0, 1406}}, slice_name0, {{x2_B0, x1_B0}});
ops_write_plane_group_hdf5({{0, 1462}}, slice_name0, {{x2_B0, x1_B0}});
ops_write_plane_group_hdf5({{0, 1481}}, slice_name0, {{x2_B0, x1_B0}});
...
ops_par_loop(opensbliblock00Kernel009, "CRu1", opensbliblock00, 3, iteration_range_9_block0,
...
int iteration_range_15_block0[] = {-3, block0np0 + 4, 0, block0np1, 0, block0np2};
ops_par_loop(opensbliblock00Kernel015, "CRU0", opensbliblock00, 3, iteration_range_15_block0,
...
ops_par_loop(opensbliblock00Kernel016, "CRp", opensbliblock00, 3, iteration_range_16_block0,
...
ops_par_loop(opensbliblock00Kernel029, "CRT_B0", opensbliblock00, 3, iteration_range_29_block0,
ops_arg_dat(p_B0, 1, stencil_0_00_00_00_3, "double", OPS_READ),
ops_arg_dat(rho_B0, 1, stencil_0_00_00_00_3, "double", OPS_READ),
...
if (iter == 0){
ops_fprintf(f0, "Iteration, Time, p_B0(187, 0, 100.0), p_B0(337, 0, 100.0), p_B0(375, 0, 100.0), p_B0(412, 0, 100.0), p_B0(450, 0, 100.0), p_B0(487, 0, 100.0), p_B0(525, 0, 100.0), p_B0(562, 0, 100.0), p_B0(600, 0, 100.0), p_B0(637, 0, 100.0), p_B0(675, 0, 100.0), p_B0(693, 0, 100.0), p_B0(712, 0, 100.0), p_B0(731, 0, 100.0), p_B0(750, 0, 100.0), p_B0(768, 0, 100.0), p_B0(787, 0, 100.0), p_B0(806, 0, 100.0), p_B0(825, 0, 100.0), p_B0(862, 0, 100.0), p_B0(900, 0, 100.0), p_B0(937, 0, 100.0), p_B0(975, 0, 100.0), p_B0(1012, 0, 100.0), p_B0(1050, 0, 100.0), p_B0(1087, 0, 100.0), p_B0(1125, 0, 100.0), p_B0(1162, 0, 100.0), p_B0(1200, 0, 100.0), p_B0(1237, 0, 100.0), p_B0(1275, 0, 100.0), p_B0(1312, 0, 100.0), p_B0(1350, 0, 100.0), p_B0(1387, 0, 100.0), p_B0(1425, 0, 100.0), p_B0(1462, 0, 100.0), p_B0(1496, 0, 100.0), rhou0_B0(187, 1, 100.0), rhou0_B0(337, 1, 100.0), rhou0_B0(375, 1, 100.0), rhou0_B0(412, 1, 100.0), rhou0_B0(450, 1, 100.0), rhou0_B0(487, 1, 100.0), rhou0_B0(525, 1, 100.0), rhou0_B0(562, 1, 100.0), rhou0_B0(600, 1, 100.0), rhou0_B0(637, 1, 100.0), rhou0_B0(675, 1, 100.0), rhou0_B0(693, 1, 100.0), rhou0_B0(712, 1, 100.0), rhou0_B0(731, 1, 100.0), rhou0_B0(750, 1, 100.0), rhou0_B0(768, 1, 100.0), rhou0_B0(787, 1, 100.0), rhou0_B0(806, 1, 100.0), rhou0_B0(825, 1, 100.0), rhou0_B0(862, 1, 100.0), rhou0_B0(900, 1, 100.0), rhou0_B0(937, 1, 100.0), rhou0_B0(975, 1, 100.0), rhou0_B0(1012, 1, 100.0), rhou0_B0(1050, 1, 100.0), rhou0_B0(1087, 1, 100.0), rhou0_B0(1125, 1, 100.0), rhou0_B0(1162, 1, 100.0), rhou0_B0(1200, 1, 100.0), rhou0_B0(1237, 1, 100.0), rhou0_B0(1275, 1, 100.0), rhou0_B0(1312, 1, 100.0), rhou0_B0(1350, 1, 100.0), rhou0_B0(1387, 1, 100.0), rhou0_B0(1425, 1, 100.0), rhou0_B0(1462, 1, 100.0), rhou0_B0(1496, 1, 100.0), rhou2_B0(187, 1, 100.0), rhou2_B0(337, 1, 100.0), rhou2_B0(375, 1, 100.0), rhou2_B0(412, 1, 100.0), rhou2_B0(450, 1, 100.0), rhou2_B0(487, 1, 100.0), rhou2_B0(525, 1, 100.0), rhou2_B0(562, 1, 100.0), rhou2_B0(600, 1, 100.0), rhou2_B0(637, 1, 100.0), rhou2_B0(675, 1, 100.0), rhou2_B0(693, 1, 100.0), rhou2_B0(712, 1, 100.0), rhou2_B0(731, 1, 100.0), rhou2_B0(750, 1, 100.0), rhou2_B0(768, 1, 100.0), rhou2_B0(787, 1, 100.0), rhou2_B0(806, 1, 100.0), rhou2_B0(825, 1, 100.0), rhou2_B0(862, 1, 100.0), rhou2_B0(900, 1, 100.0), rhou2_B0(937, 1, 100.0), rhou2_B0(975, 1, 100.0), rhou2_B0(1012, 1, 100.0), rhou2_B0(1050, 1, 100.0), rhou2_B0(1087, 1, 100.0), rhou2_B0(1125, 1, 100.0), rhou2_B0(1162, 1, 100.0), rhou2_B0(1200, 1, 100.0), rhou2_B0(1237, 1, 100.0), rhou2_B0(1275, 1, 100.0), rhou2_B0(1312, 1, 100.0), rhou2_B0(1350, 1, 100.0), rhou2_B0(1387, 1, 100.0), rhou2_B0(1425, 1, 100.0), rhou2_B0(1462, 1, 100.0), rhou2_B0(1496, 1, 100.0)\n");}
// Monitoring of p_B0
...
int i010 = 675, j010 = 0, k010 = 100.0;
...
int i011 = 693, j011 = 0, k011 = 100.0;
...
int i012 = 712, j012 = 0, k012 = 100.0;
...
int i013 = 731, j013 = 0, k013 = 100.0;
...
int i014 = 750, j014 = 0, k014 = 100.0;
...
int i015 = 768, j015 = 0, k015 = 100.0;
...
int i016 = 787, j016 = 0, k016 = 100.0;
...
int i017 = 806, j017 = 0, k017 = 100.0;
...
int i018 = 825, j018 = 0, k018 = 100.0;
...
int i019 = 862, j019 = 0, k019 = 100.0;
...
int i020 = 900, j020 = 0, k020 = 100.0;
...
int i021 = 937, j021 = 0, k021 = 100.0;
...
int i022 = 975, j022 = 0, k022 = 100.0;
...
int i023 = 1012, j023 = 0, k023 = 100.0;
...
int i024 = 1050, j024 = 0, k024 = 100.0;
...
int i025 = 1087, j025 = 0, k025 = 100.0;
...
int i026 = 1125, j026 = 0, k026 = 100.0;
...
int i027 = 1162, j027 = 0, k027 = 100.0;
...
int i028 = 1200, j028 = 0, k028 = 100.0;
...
int i029 = 1237, j029 = 0, k029 = 100.0;
...
int i030 = 1275, j030 = 0, k030 = 100.0;
...
int i031 = 1312, j031 = 0, k031 = 100.0;
...
int i032 = 1350, j032 = 0, k032 = 100.0;
...
int i033 = 1387, j033 = 0, k033 = 100.0;
...
int i034 = 1425, j034 = 0, k034 = 100.0;
...
int i035 = 1462, j035 = 0, k035 = 100.0;
...
int i036 = 1496, j036 = 0, k036 = 100.0;
...
int i037 = 187, j037 = 1, k037 = 100.0;
...
int i038 = 337, j038 = 1, k038 = 100.0;
...
int i039 = 375, j039 = 1, k039 = 100.0;
...
int i040 = 412, j040 = 1, k040 = 100.0;
...
int i041 = 450, j041 = 1, k041 = 100.0;
...
int i042 = 487, j042 = 1, k042 = 100.0;
...
int i043 = 525, j043 = 1, k043 = 100.0;
...
int i044 = 562, j044 = 1, k044 = 100.0;
...
int i045 = 600, j045 = 1, k045 = 100.0;
...
int i046 = 637, j046 = 1, k046 = 100.0;
...
int i047 = 675, j047 = 1, k047 = 100.0;
...
int i048 = 693, j048 = 1, k048 = 100.0;
...
int i049 = 712, j049 = 1, k049 = 100.0;
...
int i050 = 731, j050 = 1, k050 = 100.0;
...
int i051 = 750, j051 = 1, k051 = 100.0;
...
int i052 = 768, j052 = 1, k052 = 100.0;
...
int i053 = 787, j053 = 1, k053 = 100.0;
...
int i054 = 806, j054 = 1, k054 = 100.0;
...
int i055 = 825, j055 = 1, k055 = 100.0;
...
int i056 = 862, j056 = 1, k056 = 100.0;
...
int i057 = 900, j057 = 1, k057 = 100.0;
...
int i058 = 937, j058 = 1, k058 = 100.0;
...
int i059 = 975, j059 = 1, k059 = 100.0;
...
int i060 = 1012, j060 = 1, k060 = 100.0;
...
int i061 = 1050, j061 = 1, k061 = 100.0;
...
int i062 = 1087, j062 = 1, k062 = 100.0;
...
int i063 = 1125, j063 = 1, k063 = 100.0;
...
int i064 = 1162, j064 = 1, k064 = 100.0;
...
int i065 = 1200, j065 = 1, k065 = 100.0;
...
int i066 = 1237, j066 = 1, k066 = 100.0;
...
int i067 = 1275, j067 = 1, k067 = 100.0;
...
int i068 = 1312, j068 = 1, k068 = 100.0;
...
int i069 = 1350, j069 = 1, k069 = 100.0;
...
int i070 = 1387, j070 = 1, k070 = 100.0;
...
int i071 = 1425, j071 = 1, k071 = 100.0;
...
int i072 = 1462, j072 = 1, k072 = 100.0;
...
int i073 = 1496, j073 = 1, k073 = 100.0;
...
int i074 = 187, j074 = 1, k074 = 100.0;
...
int i075 = 337, j075 = 1, k075 = 100.0;
...
int i076 = 375, j076 = 1, k076 = 100.0;
...
int i077 = 412, j077 = 1, k077 = 100.0;
...
int i078 = 450, j078 = 1, k078 = 100.0;
...
int i079 = 487, j079 = 1, k079 = 100.0;
...
int i080 = 525, j080 = 1, k080 = 100.0;
...
int i081 = 562, j081 = 1, k081 = 100.0;
...
int i082 = 600, j082 = 1, k082 = 100.0;
...
int i083 = 637, j083 = 1, k083 = 100.0;
...
int i084 = 675, j084 = 1, k084 = 100.0;
...
int i085 = 693, j085 = 1, k085 = 100.0;
...
int i086 = 712, j086 = 1, k086 = 100.0;
...
int i087 = 731, j087 = 1, k087 = 100.0;
...
int i088 = 750, j088 = 1, k088 = 100.0;
...
int i089 = 768, j089 = 1, k089 = 100.0;
...
int i090 = 787, j090 = 1, k090 = 100.0;
...
int i091 = 806, j091 = 1, k091 = 100.0;
...
int i092 = 825, j092 = 1, k092 = 100.0;
...
int i093 = 862, j093 = 1, k093 = 100.0;
...
int i094 = 900, j094 = 1, k094 = 100.0;
...
int i095 = 937, j095 = 1, k095 = 100.0;
...
int i096 = 975, j096 = 1, k096 = 100.0;
...
int i097 = 1012, j097 = 1, k097 = 100.0;
...
int i098 = 1050, j098 = 1, k098 = 100.0;
...
int i099 = 1087, j099 = 1, k099 = 100.0;
...
int i0100 = 1125, j0100 = 1, k0100 = 100.0;
...
int i0101 = 1162, j0101 = 1, k0101 = 100.0;
...
int i0102 = 1200, j0102 = 1, k0102 = 100.0;
...
int i0103 = 1237, j0103 = 1, k0103 = 100.0;
...
int i0104 = 1275, j0104 = 1, k0104 = 100.0;
...
int i0105 = 1312, j0105 = 1, k0105 = 100.0;
...
int i0106 = 1350, j0106 = 1, k0106 = 100.0;
...
int i0107 = 1387, j0107 = 1, k0107 = 100.0;
...
int i0108 = 1425, j0108 = 1, k0108 = 100.0;
...
int i0109 = 1462, j0109 = 1, k0109 = 100.0;
...
int i0110 = 1496, j0110 = 1, k0110 = 100.0;
...
ops_write_plane_group_hdf5({{0, 337}}, slice_name0, {{rho_B0, rhou0_B0, rhou1_B0, rhou2_B0, rhoE_B0}});
ops_write_plane_group_hdf5({{0, 375}}, slice_name0, {{rho_B0, rhou0_B0, rhou1_B0, rhou2_B0, rhoE_B0}});
ops_write_plane_group_hdf5({{0, 412}}, slice_name0, {{rho_B0, rhou0_B0, rhou1_B0, rhou2_B0, rhoE_B0}});
...
ops_write_plane_group_hdf5({{0, 600}}, slice_name0, {{rho_B0, rhou0_B0, rhou1_B0, rhou2_B0, rhoE_B0}});
ops_write_plane_group_hdf5({{0, 637}}, slice_name0, {{rho_B0, rhou0_B0, rhou1_B0, rhou2_B0, rhoE_B0}});
...
ops_write_plane_group_hdf5({{0, 862}}, slice_name0, {{rho_B0, rhou0_B0, rhou1_B0, rhou2_B0, rhoE_B0}});
...
ops_write_plane_group_hdf5({{0, 1162}}, slice_name0, {{rho_B0, rhou0_B0, rhou1_B0, rhou2_B0, rhoE_B0}});
...
ops_write_plane_group_hdf5({{0, 1462}}, slice_name0, {{rho_B0, rhou0_B0, rhou1_B0, rhou2_B0, rhoE_B0}});
ops_write_plane_group_hdf5({{0, 1481}}, slice_name0, {{rho_B0, rhou0_B0, rhou1_B0, rhou2_B0, rhoE_B0}});
