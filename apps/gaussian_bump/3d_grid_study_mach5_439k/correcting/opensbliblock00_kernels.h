...
ACC<double> &rhou2_B0, ACC<double> &x0_B0, ACC<double> &x2_B0, ACC<double> &x1_B0, const int *idx)
{
   ...
   x1b0 = ((1.0/20.0))*H*exp(-((-(1.0/2.0)*L + Delta0block0*idx[0])*(-(1.0/2.0)*L + Delta0block0*idx[0]))*inv2a);
    ...
    rhou0 = ((-x1b0 + x1_B0(0,0,0) < 2.70827082708271) ? (
   5.59800088138435e-5 + 3.56490845924309e-17*pow(-x1b0 +
      x1_B0(0,0,0), 50) + 13.1812570620691*pow(-x1b0 + x1_B0(0,0,0), 10) + 0.000188480742322351*pow(-x1b0 +
      x1_B0(0,0,0), 21) + 3.59310883618136e-9*pow(-x1b0 + x1_B0(0,0,0), 30) + 6.23537054922269e-8*pow(-x1b0 +
      x1_B0(0,0,0), 29) + 2.60430712568574e-7*pow(-x1b0 + x1_B0(0,0,0), 26) + 1.04754760632322e-12*pow(-x1b0 +
      x1_B0(0,0,0), 39) + 11.1580420863346*((-x1b0 + x1_B0(0,0,0))*(-x1b0 + x1_B0(0,0,0))*(-x1b0 + x1_B0(0,0,0))) +
      2.75333726019698e-15*pow(-x1b0 + x1_B0(0,0,0), 46) + 0.0975531168644489*pow(-x1b0 + x1_B0(0,0,0), 13) +
      6.08502702609729e-15*pow(-x1b0 + x1_B0(0,0,0), 45) + 2.49326649366505e-11*pow(-x1b0 + x1_B0(0,0,0), 37) +
      4.46491784751775e-16*pow(-x1b0 + x1_B0(0,0,0), 47) + 7.64063932774416e-12*pow(-x1b0 + x1_B0(0,0,0), 38) +
      5.04959191061084e-7*pow(-x1b0 + x1_B0(0,0,0), 27) + 67.9858771894905*((-x1b0 + x1_B0(0,0,0))*(-x1b0 +
      x1_B0(0,0,0))*(-x1b0 + x1_B0(0,0,0))*(-x1b0 + x1_B0(0,0,0))*(-x1b0 + x1_B0(0,0,0))) + 0.289481577614567*pow(-x1b0
      + x1_B0(0,0,0), 14) + 0.00115176284028465*pow(-x1b0 + x1_B0(0,0,0), 19) + 79.3596165038087*pow(-x1b0 +
      x1_B0(0,0,0), 7) + 2.60587988663396e-15*pow(-x1b0 + x1_B0(0,0,0), 44) + 0.000763540592756491*pow(-x1b0 +
      x1_B0(0,0,0), 20) + 0.0507786812924906*pow(-x1b0 + x1_B0(0,0,0), 15) + 0.822526005703101*x1_B0(0,0,0) +
      4.96845228620574e-11*pow(-x1b0 + x1_B0(0,0,0), 36) + 2.51764616528813e-11*pow(-x1b0 + x1_B0(0,0,0), 35) +
      2.35938065788415e-7*pow(-x1b0 + x1_B0(0,0,0), 28) - 28.3655409910307*pow(-x1b0 + x1_B0(0,0,0), 8) -
      1.2169873224312e-5*pow(-x1b0 + x1_B0(0,0,0), 22) - 6.08754028617237e-9*pow(-x1b0 + x1_B0(0,0,0), 31) -
      2.71097296483174e-10*pow(-x1b0 + x1_B0(0,0,0), 34) - 1.37060232692835e-9*pow(-x1b0 + x1_B0(0,0,0), 33) -
      0.0252178865820257*pow(-x1b0 + x1_B0(0,0,0), 16) - 3.03172105799093e-5*pow(-x1b0 + x1_B0(0,0,0), 23) -
      32.6240252753122*((-x1b0 + x1_B0(0,0,0))*(-x1b0 + x1_B0(0,0,0))*(-x1b0 + x1_B0(0,0,0))*(-x1b0 + x1_B0(0,0,0))) -
      3.38396645409102e-14*pow(-x1b0 + x1_B0(0,0,0), 43) - 10.8862924372949*pow(-x1b0 + x1_B0(0,0,0), 9) -
      2.83733417413169*((-x1b0 + x1_B0(0,0,0))*(-x1b0 + x1_B0(0,0,0))) - 3.75624122461967e-13*pow(-x1b0 + x1_B0(0,0,0),
      41) - 4.19643692916183e-13*pow(-x1b0 + x1_B0(0,0,0), 40) - 2.29554069155202e-16*pow(-x1b0 + x1_B0(0,0,0), 48) -
      3.85510712268958e-9*pow(-x1b0 + x1_B0(0,0,0), 32) - 0.00211498499743855*pow(-x1b0 + x1_B0(0,0,0), 18) -
      1.53383931566316e-13*pow(-x1b0 + x1_B0(0,0,0), 42) - 1.41927642209322*pow(-x1b0 + x1_B0(0,0,0), 11) -
      1.58705652211188e-16*pow(-x1b0 + x1_B0(0,0,0), 49) - 94.3923731001063*((-x1b0 + x1_B0(0,0,0))*(-x1b0 +
      x1_B0(0,0,0))*(-x1b0 + x1_B0(0,0,0))*(-x1b0 + x1_B0(0,0,0))*(-x1b0 + x1_B0(0,0,0))*(-x1b0 + x1_B0(0,0,0))) -
      2.84736907402416e-6*pow(-x1b0 + x1_B0(0,0,0), 25) - 0.822526005703101*x1b0 - 1.33866295477141e-5*pow(-x1b0 +
      x1_B0(0,0,0), 24) - 0.0150432513679413*pow(-x1b0 + x1_B0(0,0,0), 17) - 1.94197803024459*pow(-x1b0 + x1_B0(0,0,0),
      12)
)
: (
   0.999998689797178
    ...
    rhou1 = ((-x1b0 + x1_B0(0,0,0) < 2.70827082708271) ? (
   8.2284049262531e-8 + 0.000807649071829671*pow(-x1b0 +
      x1_B0(0,0,0), 15) + 4.63531010013241e-15*pow(-x1b0 + x1_B0(0,0,0), 39) + 0.00210401875460201*pow(-x1b0 +
      x1_B0(0,0,0), 14) + 4.36074906159751e-11*pow(-x1b0 + x1_B0(0,0,0), 30) + 0.127197529100472*pow(-x1b0 +
      x1_B0(0,0,0), 10) + 0.731342418028314*pow(-x1b0 + x1_B0(0,0,0), 8) + 0.0484430748842067*((-x1b0 +
      x1_B0(0,0,0))*(-x1b0 + x1_B0(0,0,0))*(-x1b0 + x1_B0(0,0,0))*(-x1b0 + x1_B0(0,0,0))) + 0.426142676799602*((-x1b0 +
      x1_B0(0,0,0))*(-x1b0 + x1_B0(0,0,0))*(-x1b0 + x1_B0(0,0,0))*(-x1b0 + x1_B0(0,0,0))*(-x1b0 + x1_B0(0,0,0))*(-x1b0 +
      x1_B0(0,0,0))) + 7.50607353229731e-19*pow(-x1b0 + x1_B0(0,0,0), 47) + 4.0510988197986e-6*pow(-x1b0 + x1_B0(0,0,0),
      19) + 4.97196656092727e-10*pow(-x1b0 + x1_B0(0,0,0), 29) + 1.00871355765096e-5*x1b0 +
      1.51225765700677e-19*pow(-x1b0 + x1_B0(0,0,0), 50) + 3.9674859566235e-17*pow(-x1b0 + x1_B0(0,0,0), 45) +
      1.69075635788981e-13*pow(-x1b0 + x1_B0(0,0,0), 37) + 0.00146000170072846*((-x1b0 + x1_B0(0,0,0))*(-x1b0 +
      x1_B0(0,0,0))) + 5.72438277233289e-6*pow(-x1b0 + x1_B0(0,0,0), 20) + 4.1885469259347e-17*pow(-x1b0 + x1_B0(0,0,0),
      44) + 3.53712525880869e-13*pow(-x1b0 + x1_B0(0,0,0), 36) + 0.0246857148222234*pow(-x1b0 + x1_B0(0,0,0), 11) +
      4.78981328954267e-14*pow(-x1b0 + x1_B0(0,0,0), 38) + 3.29314130485525e-9*pow(-x1b0 + x1_B0(0,0,0), 27) +
      2.04414223716228e-13*pow(-x1b0 + x1_B0(0,0,0), 35) + 1.74001342512377e-9*pow(-x1b0 + x1_B0(0,0,0), 28) +
      1.12612672820644e-7*pow(-x1b0 + x1_B0(0,0,0), 22) + 1.34211704195356e-17*pow(-x1b0 + x1_B0(0,0,0), 46) +
      1.89860009486229e-6*pow(-x1b0 + x1_B0(0,0,0), 21) - 0.69230330721221*pow(-x1b0 + x1_B0(0,0,0), 7) -
      7.41030696355683e-5*pow(-x1b0 + x1_B0(0,0,0), 16) - 1.89257446276261e-7*pow(-x1b0 + x1_B0(0,0,0), 23) -
      3.61659965267069e-15*pow(-x1b0 + x1_B0(0,0,0), 40) - 0.0190789150581056*pow(-x1b0 + x1_B0(0,0,0), 12) -
      0.00333021640941402*pow(-x1b0 + x1_B0(0,0,0), 13) - 1.88586005688165e-12*pow(-x1b0 + x1_B0(0,0,0), 34) -
      1.45100700798463e-16*pow(-x1b0 + x1_B0(0,0,0), 43) - 1.04290852193338e-7*pow(-x1b0 + x1_B0(0,0,0), 24) -
      0.46263869493256*pow(-x1b0 + x1_B0(0,0,0), 9) - 2.71196244527853e-11*pow(-x1b0 + x1_B0(0,0,0), 32) -
      9.0157794602887e-16*pow(-x1b0 + x1_B0(0,0,0), 42) - 0.000125072539392962*pow(-x1b0 + x1_B0(0,0,0), 17) -
      3.2306892789713e-5*pow(-x1b0 + x1_B0(0,0,0), 18) - 2.508826775229e-10*pow(-x1b0 + x1_B0(0,0,0), 26) -
      0.009027915557958*((-x1b0 + x1_B0(0,0,0))*(-x1b0 + x1_B0(0,0,0))*(-x1b0 + x1_B0(0,0,0))) -
      5.55385372241127e-19*pow(-x1b0 + x1_B0(0,0,0), 49) - 1.00871355765096e-5*x1_B0(0,0,0) -
      9.73852960004864e-12*pow(-x1b0 + x1_B0(0,0,0), 33) - 3.97730173346328e-11*pow(-x1b0 + x1_B0(0,0,0), 31) -
      0.174938071598087*((-x1b0 + x1_B0(0,0,0))*(-x1b0 + x1_B0(0,0,0))*(-x1b0 + x1_B0(0,0,0))*(-x1b0 +
      x1_B0(0,0,0))*(-x1b0 + x1_B0(0,0,0))) - 2.55466402882111e-15*pow(-x1b0 + x1_B0(0,0,0), 41) -
      1.48105590974843e-18*pow(-x1b0 + x1_B0(0,0,0), 48) - 2.69577374001446e-8*pow(-x1b0 + x1_B0(0,0,0), 25)
)
: (
    ...
    T = ((-x1b0 + x1_B0(0,0,0) < 2.70827082708271) ? (
   1.36960784989958 + 4.81298119980965e-5*pow(-x1b0 +
      x1_B0(0,0,0), 24) + 12.5594480250143*pow(-x1b0 + x1_B0(0,0,0), 12) + 0.120343695088882*pow(-x1b0 + x1_B0(0,0,0),
      16) + 8.13125757151512e-12*pow(-x1b0 + x1_B0(0,0,0), 40) + 2.8771489469438e-11*pow(-x1b0 + x1_B0(0,0,0), 38) +
      1.65004678348363e-8*pow(-x1b0 + x1_B0(0,0,0), 32) + 5.08338106851875e-16*pow(-x1b0 + x1_B0(0,0,0), 48) +
      0.0743526356281037*pow(-x1b0 + x1_B0(0,0,0), 17) + 1.89928947785192e-14*pow(-x1b0 + x1_B0(0,0,0), 46) +
      1.29682296523223e-12*pow(-x1b0 + x1_B0(0,0,0), 41) + 3.40507325461474e-10*pow(-x1b0 + x1_B0(0,0,0), 33) +
      1.04817753742946e-14*pow(-x1b0 + x1_B0(0,0,0), 47) + 1.05005643828757*pow(-x1b0 + x1_B0(0,0,0), 13) +
      6.35028239373474e-8*pow(-x1b0 + x1_B0(0,0,0), 31) + 556.072730019486*pow(-x1b0 + x1_B0(0,0,0), 7) +
      1.31477432241377e-7*pow(-x1b0 + x1_B0(0,0,0), 30) + 0.000273155599506684*pow(-x1b0 + x1_B0(0,0,0), 22) +
      319.296341366451*pow(-x1b0 + x1_B0(0,0,0), 9) + 2.91306912212827e-16*pow(-x1b0 + x1_B0(0,0,0), 50) +
      22.3432182938848*((-x1b0 + x1_B0(0,0,0))*(-x1b0 + x1_B0(0,0,0))*(-x1b0 + x1_B0(0,0,0))) +
      0.000183163494059215*pow(-x1b0 + x1_B0(0,0,0), 23) + 2.2086461850727e-11*pow(-x1b0 + x1_B0(0,0,0), 39) +
      198.085255351288*((-x1b0 + x1_B0(0,0,0))*(-x1b0 + x1_B0(0,0,0))*(-x1b0 + x1_B0(0,0,0))*(-x1b0 +
      x1_B0(0,0,0))*(-x1b0 + x1_B0(0,0,0))) + 5.11164792441438e-8*pow(-x1b0 + x1_B0(0,0,0), 29) +
      0.00682294326284353*pow(-x1b0 + x1_B0(0,0,0), 18) + 3.93385148071025*x1_B0(0,0,0) - 90.1892671235081*pow(-x1b0 +
      x1_B0(0,0,0), 10) - 1.421127280135e-6*pow(-x1b0 + x1_B0(0,0,0), 25) - 3.76833846031799e-10*pow(-x1b0 +
      x1_B0(0,0,0), 36) - 7.73333461473062e-7*pow(-x1b0 + x1_B0(0,0,0), 28) - 73.5476994299948*((-x1b0 +
      x1_B0(0,0,0))*(-x1b0 + x1_B0(0,0,0))*(-x1b0 + x1_B0(0,0,0))*(-x1b0 + x1_B0(0,0,0))) -
      4.31779545562197e-11*pow(-x1b0 + x1_B0(0,0,0), 37) - 1.4937470377197*pow(-x1b0 + x1_B0(0,0,0), 14) -
      3.37340996223726e-6*pow(-x1b0 + x1_B0(0,0,0), 27) - 1.33559224148094e-14*pow(-x1b0 + x1_B0(0,0,0), 45) -
      4.45084195470169e-13*pow(-x1b0 + x1_B0(0,0,0), 43) - 532.922356867556*pow(-x1b0 + x1_B0(0,0,0), 8) -
      4.75603752575018e-13*pow(-x1b0 + x1_B0(0,0,0), 42) - 8.660740496895*((-x1b0 + x1_B0(0,0,0))*(-x1b0 +
      x1_B0(0,0,0))) - 1.95315876370986e-15*pow(-x1b0 + x1_B0(0,0,0), 49) - 2.07642567036769e-9*pow(-x1b0 +
      x1_B0(0,0,0), 34) - 1.19606331111057e-9*pow(-x1b0 + x1_B0(0,0,0), 35) - 0.340761271470816*pow(-x1b0 +
      x1_B0(0,0,0), 15) - 1.61328584656652e-13*pow(-x1b0 + x1_B0(0,0,0), 44) - 11.6078601333753*pow(-x1b0 +
      x1_B0(0,0,0), 11) - 394.319421974632*((-x1b0 + x1_B0(0,0,0))*(-x1b0 + x1_B0(0,0,0))*(-x1b0 + x1_B0(0,0,0))*(-x1b0
      + x1_B0(0,0,0))*(-x1b0 + x1_B0(0,0,0))*(-x1b0 + x1_B0(0,0,0))) - 0.00359895040137741*pow(-x1b0 + x1_B0(0,0,0), 20)
      - 7.10740413071407e-6*pow(-x1b0 + x1_B0(0,0,0), 26) - 0.00732466136908977*pow(-x1b0 + x1_B0(0,0,0), 19) -
      0.000473277090540868*pow(-x1b0 + x1_B0(0,0,0), 21) - 3.93385148071025*x1b0
)
: (
   1.00000130767725
));
...
void opensbliblock00Kernel009(const ACC<double> &rho_B0, const ACC<double> &rhou1_B0, ACC<double> &u1_B0)
{
