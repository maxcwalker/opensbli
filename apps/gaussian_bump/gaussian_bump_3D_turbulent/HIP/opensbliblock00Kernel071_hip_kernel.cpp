...
void opensbliblock00Kernel071_gpu(ACC<double> &detJ_B0,
  ACC<double> &D00_B0,
  ACC<double> &D11_B0,
  ACC<double> &D01_B0,
  ACC<double> &D10_B0)
...
int size2 ){
  ...
  if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
    ...
    opensbliblock00Kernel071_gpu(argp0, argp1, argp2, argp3,
                   argp4);
  }
...
void ops_par_loop_opensbliblock00Kernel071_execute(ops_kernel_descriptor *desc) {
  ...
  if (x_size > 0 && y_size > 0 && z_size > 0)
    hipLaunchKernelGGL(ops_opensbliblock00Kernel071,grid ,tblock ,0 ,0 , (double *)p_a[0], (double *)p_a[1],
