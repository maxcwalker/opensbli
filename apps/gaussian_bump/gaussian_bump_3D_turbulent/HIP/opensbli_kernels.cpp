...
#define rcinv17 rcinv17_OPSCONSTANT
...
#define rcinv36 rcinv36_OPSCONSTANT
...
#define rcinv39 rcinv39_OPSCONSTANT
...
int size, char *dat, char const *name){
  ...
  if (!strcmp(name,"inv_4")) {
    hipSafeCall(OPS_instance::getOPSInstance()->ostream(),hipMemcpyToSymbol(HIP_SYMBOL(inv_4_OPSCONSTANT), dat, dim*size));
  }
  else
  if (!strcmp(name,"inv_5")) {
    hipSafeCall(OPS_instance::getOPSInstance()->ostream(),hipMemcpyToSymbol(HIP_SYMBOL(inv_5_OPSCONSTANT), dat, dim*size));
  }
  else
  ...
  if (!strcmp(name,"rcinv11")) {
    hipSafeCall(OPS_instance::getOPSInstance()->ostream(),hipMemcpyToSymbol(HIP_SYMBOL(rcinv11_OPSCONSTANT), dat, dim*size));
  }
  else
  ...
  if (!strcmp(name,"rcinv17")) {
    hipSafeCall(OPS_instance::getOPSInstance()->ostream(),hipMemcpyToSymbol(HIP_SYMBOL(rcinv17_OPSCONSTANT), dat, dim*size));
  }
  else
  ...
  if (!strcmp(name,"rcinv36")) {
    hipSafeCall(OPS_instance::getOPSInstance()->ostream(),hipMemcpyToSymbol(HIP_SYMBOL(rcinv36_OPSCONSTANT), dat, dim*size));
  }
  else
  ...
  if (!strcmp(name,"rcinv39")) {
    hipSafeCall(OPS_instance::getOPSInstance()->ostream(),hipMemcpyToSymbol(HIP_SYMBOL(rcinv39_OPSCONSTANT), dat, dim*size));
  }
  else
  {
