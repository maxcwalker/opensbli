  ...
  for ( int n_z=start[2]; n_z<end[2]; n_z++ ){
    for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
      ...
      for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
        ACC<double> detJ_B0(xdim0_opensbliblock00Kernel073, ydim0_opensbliblock00Kernel073, detJ_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel073*1 + n_z * xdim0_opensbliblock00Kernel073 * ydim0_opensbliblock00Kernel073*1);
        ACC<double> D00_B0(xdim1_opensbliblock00Kernel073, ydim1_opensbliblock00Kernel073, D00_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel073*1 + n_z * xdim1_opensbliblock00Kernel073 * ydim1_opensbliblock00Kernel073*1);
        ACC<double> D11_B0(xdim2_opensbliblock00Kernel073, ydim2_opensbliblock00Kernel073, D11_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel073*1 + n_z * xdim2_opensbliblock00Kernel073 * ydim2_opensbliblock00Kernel073*1);
        ACC<double> D01_B0(xdim3_opensbliblock00Kernel073, ydim3_opensbliblock00Kernel073, D01_B0_p + n_x*1 + n_y * xdim3_opensbliblock00Kernel073*1 + n_z * xdim3_opensbliblock00Kernel073 * ydim3_opensbliblock00Kernel073*1);
        ACC<double> D10_B0(xdim4_opensbliblock00Kernel073, ydim4_opensbliblock00Kernel073, D10_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel073*1 + n_z * xdim4_opensbliblock00Kernel073 * ydim4_opensbliblock00Kernel073*1);
