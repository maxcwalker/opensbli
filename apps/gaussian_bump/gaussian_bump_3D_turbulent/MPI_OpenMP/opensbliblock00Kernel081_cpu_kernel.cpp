...
void ops_par_loop_opensbliblock00Kernel081_execute(ops_kernel_descriptor *desc) {
  ...
  double * __restrict__ SD100_B0_p = (double *)(args[6].data + base6);

  int base7 = args[7].dat->base_offset;
  double * __restrict__ SD111_B0_p = (double *)(args[7].data + base7);
  ...
  for ( int n_z=start[2]; n_z<end[2]; n_z++ ){
    for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
      ...
      for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
        ...
        const ACC<double> D01_B0(xdim2_opensbliblock00Kernel081, ydim2_opensbliblock00Kernel081, D01_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel081*1 + n_z * xdim2_opensbliblock00Kernel081 * ydim2_opensbliblock00Kernel081*1);
        ...
        ACC<double> SD100_B0(xdim6_opensbliblock00Kernel081, ydim6_opensbliblock00Kernel081, SD100_B0_p + n_x*1 + n_y * xdim6_opensbliblock00Kernel081*1 + n_z * xdim6_opensbliblock00Kernel081 * ydim6_opensbliblock00Kernel081*1);
        ACC<double> SD111_B0(xdim7_opensbliblock00Kernel081, ydim7_opensbliblock00Kernel081, SD111_B0_p + n_x*1 + n_y * xdim7_opensbliblock00Kernel081*1 + n_z * xdim7_opensbliblock00Kernel081 * ydim7_opensbliblock00Kernel081*1);
        ACC<double> SD010_B0(xdim8_opensbliblock00Kernel081, ydim8_opensbliblock00Kernel081, SD010_B0_p + n_x*1 + n_y * xdim8_opensbliblock00Kernel081*1 + n_z * xdim8_opensbliblock00Kernel081 * ydim8_opensbliblock00Kernel081*1);
        ...
        ACC<double> SD011_B0(xdim10_opensbliblock00Kernel081, ydim10_opensbliblock00Kernel081, SD011_B0_p + n_x*1 + n_y * xdim10_opensbliblock00Kernel081*1 + n_z * xdim10_opensbliblock00Kernel081 * ydim10_opensbliblock00Kernel081*1);
   ...
   double localeval_0 = 0.0;
    localeval_0 = ((idx[1] == 0) ? (
   inv_0*(-rc15*D01_B0(0,4,0) + 4*D01_B0(0,1,0) -
      rc13*D01_B0(0,0,0) + (rc14)*D01_B0(0,3,0) - 3*D01_B0(0,2,0))
)
: ((idx[1] == 1) ? (

        (rc16)*inv_0*(18*D01_B0(0,1,0) - 10*D01_B0(0,0,0) + D01_B0(0,3,0) -
      3*D01_B0(0,-1,0) - 6*D01_B0(0,2,0))
)
: (
   (rc16)*inv_0*(8*D01_B0(0,1,0) -
    ...
    localeval_1 = ((idx[1] == 0) ? (
   inv_0*(-rc13*D11_B0(0,0,0) - rc15*D11_B0(0,4,0) +
      (rc14)*D11_B0(0,3,0) - 3*D11_B0(0,2,0) + 4*D11_B0(0,1,0))
)
: ((idx[1] == 1) ? (

      (rc16)*inv_0*(-10*D11_B0(0,0,0) + D11_B0(0,3,0) - 6*D11_B0(0,2,0) -
      3*D11_B0(0,-1,0) + 18*D11_B0(0,1,0))
)
: (
   (rc16)*inv_0*(-D11_B0(0,2,0) +
    ...
    localeval_2 = ((idx[0] == 0) ? (
   inv_2*(-3*D00_B0(2,0,0) + (rc14)*D00_B0(3,0,0) -
      rc15*D00_B0(4,0,0) - rc13*D00_B0(0,0,0) + 4*D00_B0(1,0,0))
)
: ((idx[0] == 1) ? (

      (rc16)*inv_2*(-6*D00_B0(2,0,0) + D00_B0(3,0,0) - 10*D00_B0(0,0,0) +
      18*D00_B0(1,0,0) - 3*D00_B0(-1,0,0))
)
: ((idx[0] == block0np0 - 1) ? (

      inv_2*((rc15)*D00_B0(-4,0,0) + 3*D00_B0(-2,0,0) + (rc13)*D00_B0(0,0,0) -
      rc14*D00_B0(-3,0,0) - 4*D00_B0(-1,0,0))
)
: ((idx[0] == block0np0 - 2) ? (

      (rc16)*inv_2*(6*D00_B0(-2,0,0) + 10*D00_B0(0,0,0) - D00_B0(-3,0,0) +
      3*D00_B0(1,0,0) - 18*D00_B0(-1,0,0))
)
: (
   (rc16)*inv_2*(-D00_B0(2,0,0) +
      8*D00_B0(1,0,0) - 8*D00_B0(-1,0,0) + D00_B0(-2,0,0))
)))));

    localeval_3 = ((idx[1] == 0) ? (
   inv_0*(-3*D00_B0(0,2,0) + (rc14)*D00_B0(0,3,0) -
      rc15*D00_B0(0,4,0) - rc13*D00_B0(0,0,0) + 4*D00_B0(0,1,0))
)
: ((idx[1] == 1) ? (

      (rc16)*inv_0*(-6*D00_B0(0,2,0) + D00_B0(0,3,0) - 10*D00_B0(0,0,0) +
      18*D00_B0(0,1,0) - 3*D00_B0(0,-1,0))
)
: (
   (rc16)*inv_0*(-D00_B0(0,2,0) +
      8*D00_B0(0,1,0) - 8*D00_B0(0,-1,0) + D00_B0(0,-2,0))
)));

    localeval_4 = ((idx[0] == 0) ? (
   inv_2*(-rc13*D11_B0(0,0,0) - rc15*D11_B0(4,0,0) +
      (rc14)*D11_B0(3,0,0) - 3*D11_B0(2,0,0) + 4*D11_B0(1,0,0))
)
: ((idx[0] == 1) ? (

      (rc16)*inv_2*(-10*D11_B0(0,0,0) + D11_B0(3,0,0) - 6*D11_B0(2,0,0) -
      3*D11_B0(-1,0,0) + 18*D11_B0(1,0,0))
)
: ((idx[0] == block0np0 - 1) ? (

      inv_2*(-rc14*D11_B0(-3,0,0) + (rc13)*D11_B0(0,0,0) + (rc15)*D11_B0(-4,0,0) -
      4*D11_B0(-1,0,0) + 3*D11_B0(-2,0,0))
)
: ((idx[0] == block0np0 - 2) ? (

      (rc16)*inv_2*(-D11_B0(-3,0,0) + 10*D11_B0(0,0,0) - 18*D11_B0(-1,0,0) +
      6*D11_B0(-2,0,0) + 3*D11_B0(1,0,0))
)
: (
   (rc16)*inv_2*(-D11_B0(2,0,0) +
    ...
    localeval_5 = ((idx[0] == 0) ? (
   inv_2*(-rc15*D01_B0(4,0,0) + 4*D01_B0(1,0,0) -
      rc13*D01_B0(0,0,0) + (rc14)*D01_B0(3,0,0) - 3*D01_B0(2,0,0))
)
: ((idx[0] == 1) ? (

        (rc16)*inv_2*(18*D01_B0(1,0,0) - 10*D01_B0(0,0,0) + D01_B0(3,0,0) -
      3*D01_B0(-1,0,0) - 6*D01_B0(2,0,0))
)
: ((idx[0] == block0np0 - 1) ? (

      inv_2*(-rc14*D01_B0(-3,0,0) + (rc15)*D01_B0(-4,0,0) + (rc13)*D01_B0(0,0,0) -
      4*D01_B0(-1,0,0) + 3*D01_B0(-2,0,0))
)
: ((idx[0] == block0np0 - 2) ? (

      (rc16)*inv_2*(-D01_B0(-3,0,0) + 3*D01_B0(1,0,0) + 10*D01_B0(0,0,0) -
      18*D01_B0(-1,0,0) + 6*D01_B0(-2,0,0))
)
: (
   (rc16)*inv_2*(8*D01_B0(1,0,0) -
    ...
    localeval_6 = ((idx[1] == 0) ? (
   inv_0*(-rc15*D10_B0(0,4,0) + 4*D10_B0(0,1,0) -
      rc13*D10_B0(0,0,0) + (rc14)*D10_B0(0,3,0) - 3*D10_B0(0,2,0))
)
: ((idx[1] == 1) ? (
...
: (
   (rc16)*inv_0*(8*D10_B0(0,1,0) -
    ...
    localeval_7 = ((idx[0] == 0) ? (
   inv_2*(-rc15*D10_B0(4,0,0) + 4*D10_B0(1,0,0) -
      rc13*D10_B0(0,0,0) + (rc14)*D10_B0(3,0,0) - 3*D10_B0(2,0,0))
)
: ((idx[0] == 1) ? (
...
: ((idx[0] == block0np0 - 1) ? (
      ...
      inv_2*((rc15)*D10_B0(-4,0,0) - 4*D10_B0(-1,0,0) + 3*D10_B0(-2,0,0) +
      (rc13)*D10_B0(0,0,0) - rc14*D10_B0(-3,0,0))
)
: ((idx[0] == block0np0 - 2) ? (

      (rc16)*inv_2*(6*D10_B0(-2,0,0) - 18*D10_B0(-1,0,0) + 3*D10_B0(1,0,0) +
...
: (
   ...
   SD000_B0(0,0,0) = localeval_2;

   SD001_B0(0,0,0) = localeval_3;

   SD010_B0(0,0,0) = localeval_5;

   SD011_B0(0,0,0) = localeval_0;

   SD100_B0(0,0,0) = localeval_7;

   SD101_B0(0,0,0) = localeval_6;

   SD110_B0(0,0,0) = localeval_4;

   SD111_B0(0,0,0) = localeval_1;
