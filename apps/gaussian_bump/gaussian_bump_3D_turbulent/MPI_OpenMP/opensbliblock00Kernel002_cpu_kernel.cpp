...
void ops_par_loop_opensbliblock00Kernel002_execute(ops_kernel_descriptor *desc) {
  ...
  double * __restrict__ a_B0_p = (double *)(args[6].data + base6);
  ...
  double * __restrict__ p_B0_p = (double *)(args[10].data + base10);
  ...
  double * __restrict__ wk13_B0_p = (double *)(args[13].data + base13);
  ...
  double * __restrict__ wk12_B0_p = (double *)(args[15].data + base15);
  ...
  for ( int n_z=start[2]; n_z<end[2]; n_z++ ){
    for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
      ...
      for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
        const ACC<double> u0_B0(xdim0_opensbliblock00Kernel002, ydim0_opensbliblock00Kernel002, u0_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel002*1 + n_z * xdim0_opensbliblock00Kernel002 * ydim0_opensbliblock00Kernel002*1);
        const ACC<double> u2_B0(xdim1_opensbliblock00Kernel002, ydim1_opensbliblock00Kernel002, u2_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel002*1 + n_z * xdim1_opensbliblock00Kernel002 * ydim1_opensbliblock00Kernel002*1);
        ...
        const ACC<double> u1_B0(xdim3_opensbliblock00Kernel002, ydim3_opensbliblock00Kernel002, u1_B0_p + n_x*1 + n_y * xdim3_opensbliblock00Kernel002*1 + n_z * xdim3_opensbliblock00Kernel002 * ydim3_opensbliblock00Kernel002*1);
        const ACC<double> rho_B0(xdim4_opensbliblock00Kernel002, ydim4_opensbliblock00Kernel002, rho_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel002*1 + n_z * xdim4_opensbliblock00Kernel002 * ydim4_opensbliblock00Kernel002*1);
        const ACC<double> rhou1_B0(xdim5_opensbliblock00Kernel002, ydim5_opensbliblock00Kernel002, rhou1_B0_p + n_x*1 + n_y * xdim5_opensbliblock00Kernel002*1 + n_z * xdim5_opensbliblock00Kernel002 * ydim5_opensbliblock00Kernel002*1);
        const ACC<double> a_B0(xdim6_opensbliblock00Kernel002, ydim6_opensbliblock00Kernel002, a_B0_p + n_x*1 + n_y * xdim6_opensbliblock00Kernel002*1 + n_z * xdim6_opensbliblock00Kernel002 * ydim6_opensbliblock00Kernel002*1);
        ...
        const ACC<double> U2_B0(xdim8_opensbliblock00Kernel002, ydim8_opensbliblock00Kernel002, U2_B0_p + n_x*1 + n_y * xdim8_opensbliblock00Kernel002*1 + n_z * xdim8_opensbliblock00Kernel002 * ydim8_opensbliblock00Kernel002*1);
        const ACC<double> rhou2_B0(xdim9_opensbliblock00Kernel002, ydim9_opensbliblock00Kernel002, rhou2_B0_p + n_x*1 + n_y * xdim9_opensbliblock00Kernel002*1 + n_z * xdim9_opensbliblock00Kernel002 * ydim9_opensbliblock00Kernel002*1);
        const ACC<double> p_B0(xdim10_opensbliblock00Kernel002, ydim10_opensbliblock00Kernel002, p_B0_p + n_x*1 + n_y * xdim10_opensbliblock00Kernel002*1 + n_z * xdim10_opensbliblock00Kernel002 * ydim10_opensbliblock00Kernel002*1);
        const ACC<double> rhou0_B0(xdim11_opensbliblock00Kernel002, ydim11_opensbliblock00Kernel002, rhou0_B0_p + n_x*1 + n_y * xdim11_opensbliblock00Kernel002*1 + n_z * xdim11_opensbliblock00Kernel002 * ydim11_opensbliblock00Kernel002*1);
        ...
        ACC<double> wk13_B0(xdim13_opensbliblock00Kernel002, ydim13_opensbliblock00Kernel002, wk13_B0_p + n_x*1 + n_y * xdim13_opensbliblock00Kernel002*1 + n_z * xdim13_opensbliblock00Kernel002 * ydim13_opensbliblock00Kernel002*1);
        ACC<double> wk11_B0(xdim14_opensbliblock00Kernel002, ydim14_opensbliblock00Kernel002, wk11_B0_p + n_x*1 + n_y * xdim14_opensbliblock00Kernel002*1 + n_z * xdim14_opensbliblock00Kernel002 * ydim14_opensbliblock00Kernel002*1);
        ACC<double> wk12_B0(xdim15_opensbliblock00Kernel002, ydim15_opensbliblock00Kernel002, wk12_B0_p + n_x*1 + n_y * xdim15_opensbliblock00Kernel002*1 + n_z * xdim15_opensbliblock00Kernel002 * ydim15_opensbliblock00Kernel002*1);
