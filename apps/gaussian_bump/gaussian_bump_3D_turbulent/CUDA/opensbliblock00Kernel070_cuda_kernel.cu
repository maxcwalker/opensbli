...
//
__constant__ int dims_opensbliblock00Kernel070 [8][2];
static int dims_opensbliblock00Kernel070_h [8][2] = {0};
...
int size2 ){
  ...
  if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
    ...
    opensbliblock00Kernel070_gpu(argp0, argp1, argp2, argp3,
...
void ops_par_loop_opensbliblock00Kernel070_execute(ops_kernel_descriptor *desc) {
  ...
  if (x_size > 0 && y_size > 0 && z_size > 0)
    ops_opensbliblock00Kernel070<<<grid, tblock >>> (  (double *)p_a[0], (double *)p_a[1],
         (double *)p_a[2], (double *)p_a[3],
         (double *)p_a[4], (double *)p_a[5],
         (double *)p_a[6], arg_idx[0], arg_idx[1], arg_idx[2],x_size, y_size, z_size);
