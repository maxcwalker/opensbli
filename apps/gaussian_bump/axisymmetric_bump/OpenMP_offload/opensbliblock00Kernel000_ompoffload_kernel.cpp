...
void ops_par_loop_opensbliblock00Kernel000_execute(ops_kernel_descriptor *desc) {
  ...
  double * __restrict__ a_B0_p = (double *)(args[4].data_d + base4);

  int base5 = args[5].dat->base_offset;
  double * __restrict__ detJ_B0_p = (double *)(args[5].data_d + base5);

  int base6 = args[6].dat->base_offset;
  double * __restrict__ p_B0_p = (double *)(args[6].data_d + base6);

  int base7 = args[7].dat->base_offset;
  double * __restrict__ rhoE_B0_p = (double *)(args[7].data_d + base7);
  ...
  double * __restrict__ rhou2_B0_p = (double *)(args[11].data_d + base11);

  int base12 = args[12].dat->base_offset;
  double * __restrict__ u0_B0_p = (double *)(args[12].data_d + base12);

  int base13 = args[13].dat->base_offset;
  double * __restrict__ u1_B0_p = (double *)(args[13].data_d + base13);

  int base14 = args[14].dat->base_offset;
  double * __restrict__ u2_B0_p = (double *)(args[14].data_d + base14);

  int base15 = args[15].dat->base_offset;
  double * __restrict__ wk0_B0_p = (double *)(args[15].data_d + base15);

  int base16 = args[16].dat->base_offset;
  double * __restrict__ wk1_B0_p = (double *)(args[16].data_d + base16);

  int base17 = args[17].dat->base_offset;
  double * __restrict__ wk2_B0_p = (double *)(args[17].data_d + base17);

  int base18 = args[18].dat->base_offset;
  double * __restrict__ wk3_B0_p = (double *)(args[18].data_d + base18);

  int base19 = args[19].dat->base_offset;
  double * __restrict__ wk4_B0_p = (double *)(args[19].data_d + base19);
  ...
  for ( int n_z=start2; n_z<end2; n_z++ ){
    for ( int n_y=start1; n_y<end1; n_y++ ){
      for ( int n_x=start0; n_x<end0; n_x++ ){
        ...
        const ACC<double> D02_B0(xdim2_opensbliblock00Kernel000, ydim2_opensbliblock00Kernel000, D02_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel000*1 + n_z * xdim2_opensbliblock00Kernel000 * ydim2_opensbliblock00Kernel000*1);
        const ACC<double> U0_B0(xdim3_opensbliblock00Kernel000, ydim3_opensbliblock00Kernel000, U0_B0_p + n_x*1 + n_y * xdim3_opensbliblock00Kernel000*1 + n_z * xdim3_opensbliblock00Kernel000 * ydim3_opensbliblock00Kernel000*1);
        const ACC<double> a_B0(xdim4_opensbliblock00Kernel000, ydim4_opensbliblock00Kernel000, a_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel000*1 + n_z * xdim4_opensbliblock00Kernel000 * ydim4_opensbliblock00Kernel000*1);
        const ACC<double> detJ_B0(xdim5_opensbliblock00Kernel000, ydim5_opensbliblock00Kernel000, detJ_B0_p + n_x*1 + n_y * xdim5_opensbliblock00Kernel000*1 + n_z * xdim5_opensbliblock00Kernel000 * ydim5_opensbliblock00Kernel000*1);
        const ACC<double> p_B0(xdim6_opensbliblock00Kernel000, ydim6_opensbliblock00Kernel000, p_B0_p + n_x*1 + n_y * xdim6_opensbliblock00Kernel000*1 + n_z * xdim6_opensbliblock00Kernel000 * ydim6_opensbliblock00Kernel000*1);
        ...
        const ACC<double> rho_B0(xdim8_opensbliblock00Kernel000, ydim8_opensbliblock00Kernel000, rho_B0_p + n_x*1 + n_y * xdim8_opensbliblock00Kernel000*1 + n_z * xdim8_opensbliblock00Kernel000 * ydim8_opensbliblock00Kernel000*1);
        const ACC<double> rhou0_B0(xdim9_opensbliblock00Kernel000, ydim9_opensbliblock00Kernel000, rhou0_B0_p + n_x*1 + n_y * xdim9_opensbliblock00Kernel000*1 + n_z * xdim9_opensbliblock00Kernel000 * ydim9_opensbliblock00Kernel000*1);
        const ACC<double> rhou1_B0(xdim10_opensbliblock00Kernel000, ydim10_opensbliblock00Kernel000, rhou1_B0_p + n_x*1 + n_y * xdim10_opensbliblock00Kernel000*1 + n_z * xdim10_opensbliblock00Kernel000 * ydim10_opensbliblock00Kernel000*1);
        ...
        const ACC<double> u0_B0(xdim12_opensbliblock00Kernel000, ydim12_opensbliblock00Kernel000, u0_B0_p + n_x*1 + n_y * xdim12_opensbliblock00Kernel000*1 + n_z * xdim12_opensbliblock00Kernel000 * ydim12_opensbliblock00Kernel000*1);
        const ACC<double> u1_B0(xdim13_opensbliblock00Kernel000, ydim13_opensbliblock00Kernel000, u1_B0_p + n_x*1 + n_y * xdim13_opensbliblock00Kernel000*1 + n_z * xdim13_opensbliblock00Kernel000 * ydim13_opensbliblock00Kernel000*1);
        const ACC<double> u2_B0(xdim14_opensbliblock00Kernel000, ydim14_opensbliblock00Kernel000, u2_B0_p + n_x*1 + n_y * xdim14_opensbliblock00Kernel000*1 + n_z * xdim14_opensbliblock00Kernel000 * ydim14_opensbliblock00Kernel000*1);
        ACC<double> wk0_B0(xdim15_opensbliblock00Kernel000, ydim15_opensbliblock00Kernel000, wk0_B0_p + n_x*1 + n_y * xdim15_opensbliblock00Kernel000*1 + n_z * xdim15_opensbliblock00Kernel000 * ydim15_opensbliblock00Kernel000*1);
        ...
        ACC<double> wk2_B0(xdim17_opensbliblock00Kernel000, ydim17_opensbliblock00Kernel000, wk2_B0_p + n_x*1 + n_y * xdim17_opensbliblock00Kernel000*1 + n_z * xdim17_opensbliblock00Kernel000 * ydim17_opensbliblock00Kernel000*1);
        ...
        ACC<double> wk4_B0(xdim19_opensbliblock00Kernel000, ydim19_opensbliblock00Kernel000, wk4_B0_p + n_x*1 + n_y * xdim19_opensbliblock00Kernel000*1 + n_z * xdim19_opensbliblock00Kernel000 * ydim19_opensbliblock00Kernel000*1);
...
void ops_par_loop_opensbliblock00Kernel000(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg16, ops_arg arg17, ops_arg arg18, ops_arg arg19) {
  ...
  create_kerneldesc_and_enque(name, args, 20, 21, dim, 0, range, block, ops_par_loop_opensbliblock00Kernel000_execute);
}
#endif
