  ...
  for ( int n_z=start2; n_z<end2; n_z++ ){
    for ( int n_y=start1; n_y<end1; n_y++ ){
      for ( int n_x=start0; n_x<end0; n_x++ ){
        ...
        ACC<double> rho_B0(xdim1_opensbliblock00Kernel087, ydim1_opensbliblock00Kernel087, rho_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel087*1 + n_z * xdim1_opensbliblock00Kernel087 * ydim1_opensbliblock00Kernel087*1);
        ACC<double> rhou0_B0(xdim2_opensbliblock00Kernel087, ydim2_opensbliblock00Kernel087, rhou0_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel087*1 + n_z * xdim2_opensbliblock00Kernel087 * ydim2_opensbliblock00Kernel087*1);
...
void ops_par_loop_opensbliblock00Kernel087(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4) {
  ...
  create_kerneldesc_and_enque(name, args, 5, 8, dim, 0, range, block, ops_par_loop_opensbliblock00Kernel087_execute);
}
#endif
