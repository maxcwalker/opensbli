...
void ops_par_loop_opensbliblock00Kernel012_execute(ops_kernel_descriptor *desc) {
  ...
  int xdim6_opensbliblock00Kernel012 = args[6].dat->size[0];
  int ydim6_opensbliblock00Kernel012 = args[6].dat->size[1];
  ...
  for ( int n_z=start2; n_z<end2; n_z++ ){
    for ( int n_y=start1; n_y<end1; n_y++ ){
      for ( int n_x=start0; n_x<end0; n_x++ ){
        const ACC<double> D00_B0(xdim0_opensbliblock00Kernel012, ydim0_opensbliblock00Kernel012, D00_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel012*1 + n_z * xdim0_opensbliblock00Kernel012 * ydim0_opensbliblock00Kernel012*1);
        const ACC<double> D01_B0(xdim1_opensbliblock00Kernel012, ydim1_opensbliblock00Kernel012, D01_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel012*1 + n_z * xdim1_opensbliblock00Kernel012 * ydim1_opensbliblock00Kernel012*1);
        const ACC<double> D02_B0(xdim2_opensbliblock00Kernel012, ydim2_opensbliblock00Kernel012, D02_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel012*1 + n_z * xdim2_opensbliblock00Kernel012 * ydim2_opensbliblock00Kernel012*1);
        const ACC<double> u0_B0(xdim3_opensbliblock00Kernel012, ydim3_opensbliblock00Kernel012, u0_B0_p + n_x*1 + n_y * xdim3_opensbliblock00Kernel012*1 + n_z * xdim3_opensbliblock00Kernel012 * ydim3_opensbliblock00Kernel012*1);
        const ACC<double> u1_B0(xdim4_opensbliblock00Kernel012, ydim4_opensbliblock00Kernel012, u1_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel012*1 + n_z * xdim4_opensbliblock00Kernel012 * ydim4_opensbliblock00Kernel012*1);
        const ACC<double> u2_B0(xdim5_opensbliblock00Kernel012, ydim5_opensbliblock00Kernel012, u2_B0_p + n_x*1 + n_y * xdim5_opensbliblock00Kernel012*1 + n_z * xdim5_opensbliblock00Kernel012 * ydim5_opensbliblock00Kernel012*1);
        ACC<double> U0_B0(xdim6_opensbliblock00Kernel012, ydim6_opensbliblock00Kernel012, U0_B0_p + n_x*1 + n_y * xdim6_opensbliblock00Kernel012*1 + n_z * xdim6_opensbliblock00Kernel012 * ydim6_opensbliblock00Kernel012*1);
...
void ops_par_loop_opensbliblock00Kernel012(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4, ops_arg arg5, ops_arg arg6) {
  ...
  create_kerneldesc_and_enque(name, args, 7, 15, dim, 0, range, block, ops_par_loop_opensbliblock00Kernel012_execute);
}
#endif
