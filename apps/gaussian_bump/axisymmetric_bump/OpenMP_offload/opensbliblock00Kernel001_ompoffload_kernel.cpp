...
void ops_par_loop_opensbliblock00Kernel001_execute(ops_kernel_descriptor *desc) {
  ...
  double * __restrict__ D12_B0_p = (double *)(args[2].data_d + base2);
  ...
  double * __restrict__ wk5_B0_p = (double *)(args[15].data_d + base15);

  int base16 = args[16].dat->base_offset;
  double * __restrict__ wk6_B0_p = (double *)(args[16].data_d + base16);

  int base17 = args[17].dat->base_offset;
  double * __restrict__ wk7_B0_p = (double *)(args[17].data_d + base17);

  int base18 = args[18].dat->base_offset;
  double * __restrict__ wk8_B0_p = (double *)(args[18].data_d + base18);

  int base19 = args[19].dat->base_offset;
  double * __restrict__ wk9_B0_p = (double *)(args[19].data_d + base19);
  ...
  for ( int n_z=start2; n_z<end2; n_z++ ){
    for ( int n_y=start1; n_y<end1; n_y++ ){
      for ( int n_x=start0; n_x<end0; n_x++ ){
        ...
        const ACC<double> D12_B0(xdim2_opensbliblock00Kernel001, ydim2_opensbliblock00Kernel001, D12_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel001*1 + n_z * xdim2_opensbliblock00Kernel001 * ydim2_opensbliblock00Kernel001*1);
        const ACC<double> U1_B0(xdim3_opensbliblock00Kernel001, ydim3_opensbliblock00Kernel001, U1_B0_p + n_x*1 + n_y * xdim3_opensbliblock00Kernel001*1 + n_z * xdim3_opensbliblock00Kernel001 * ydim3_opensbliblock00Kernel001*1);
        const ACC<double> a_B0(xdim4_opensbliblock00Kernel001, ydim4_opensbliblock00Kernel001, a_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel001*1 + n_z * xdim4_opensbliblock00Kernel001 * ydim4_opensbliblock00Kernel001*1);
        const ACC<double> detJ_B0(xdim5_opensbliblock00Kernel001, ydim5_opensbliblock00Kernel001, detJ_B0_p + n_x*1 + n_y * xdim5_opensbliblock00Kernel001*1 + n_z * xdim5_opensbliblock00Kernel001 * ydim5_opensbliblock00Kernel001*1);
        const ACC<double> p_B0(xdim6_opensbliblock00Kernel001, ydim6_opensbliblock00Kernel001, p_B0_p + n_x*1 + n_y * xdim6_opensbliblock00Kernel001*1 + n_z * xdim6_opensbliblock00Kernel001 * ydim6_opensbliblock00Kernel001*1);
        const ACC<double> rhoE_B0(xdim7_opensbliblock00Kernel001, ydim7_opensbliblock00Kernel001, rhoE_B0_p + n_x*1 + n_y * xdim7_opensbliblock00Kernel001*1 + n_z * xdim7_opensbliblock00Kernel001 * ydim7_opensbliblock00Kernel001*1);
        const ACC<double> rho_B0(xdim8_opensbliblock00Kernel001, ydim8_opensbliblock00Kernel001, rho_B0_p + n_x*1 + n_y * xdim8_opensbliblock00Kernel001*1 + n_z * xdim8_opensbliblock00Kernel001 * ydim8_opensbliblock00Kernel001*1);
        const ACC<double> rhou0_B0(xdim9_opensbliblock00Kernel001, ydim9_opensbliblock00Kernel001, rhou0_B0_p + n_x*1 + n_y * xdim9_opensbliblock00Kernel001*1 + n_z * xdim9_opensbliblock00Kernel001 * ydim9_opensbliblock00Kernel001*1);
        const ACC<double> rhou1_B0(xdim10_opensbliblock00Kernel001, ydim10_opensbliblock00Kernel001, rhou1_B0_p + n_x*1 + n_y * xdim10_opensbliblock00Kernel001*1 + n_z * xdim10_opensbliblock00Kernel001 * ydim10_opensbliblock00Kernel001*1);
        const ACC<double> rhou2_B0(xdim11_opensbliblock00Kernel001, ydim11_opensbliblock00Kernel001, rhou2_B0_p + n_x*1 + n_y * xdim11_opensbliblock00Kernel001*1 + n_z * xdim11_opensbliblock00Kernel001 * ydim11_opensbliblock00Kernel001*1);
        const ACC<double> u0_B0(xdim12_opensbliblock00Kernel001, ydim12_opensbliblock00Kernel001, u0_B0_p + n_x*1 + n_y * xdim12_opensbliblock00Kernel001*1 + n_z * xdim12_opensbliblock00Kernel001 * ydim12_opensbliblock00Kernel001*1);
        const ACC<double> u1_B0(xdim13_opensbliblock00Kernel001, ydim13_opensbliblock00Kernel001, u1_B0_p + n_x*1 + n_y * xdim13_opensbliblock00Kernel001*1 + n_z * xdim13_opensbliblock00Kernel001 * ydim13_opensbliblock00Kernel001*1);
        const ACC<double> u2_B0(xdim14_opensbliblock00Kernel001, ydim14_opensbliblock00Kernel001, u2_B0_p + n_x*1 + n_y * xdim14_opensbliblock00Kernel001*1 + n_z * xdim14_opensbliblock00Kernel001 * ydim14_opensbliblock00Kernel001*1);
        ACC<double> wk5_B0(xdim15_opensbliblock00Kernel001, ydim15_opensbliblock00Kernel001, wk5_B0_p + n_x*1 + n_y * xdim15_opensbliblock00Kernel001*1 + n_z * xdim15_opensbliblock00Kernel001 * ydim15_opensbliblock00Kernel001*1);
        ACC<double> wk6_B0(xdim16_opensbliblock00Kernel001, ydim16_opensbliblock00Kernel001, wk6_B0_p + n_x*1 + n_y * xdim16_opensbliblock00Kernel001*1 + n_z * xdim16_opensbliblock00Kernel001 * ydim16_opensbliblock00Kernel001*1);
        ...
        ACC<double> wk8_B0(xdim18_opensbliblock00Kernel001, ydim18_opensbliblock00Kernel001, wk8_B0_p + n_x*1 + n_y * xdim18_opensbliblock00Kernel001*1 + n_z * xdim18_opensbliblock00Kernel001 * ydim18_opensbliblock00Kernel001*1);
        ACC<double> wk9_B0(xdim19_opensbliblock00Kernel001, ydim19_opensbliblock00Kernel001, wk9_B0_p + n_x*1 + n_y * xdim19_opensbliblock00Kernel001*1 + n_z * xdim19_opensbliblock00Kernel001 * ydim19_opensbliblock00Kernel001*1);
...
void ops_par_loop_opensbliblock00Kernel001(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg16, ops_arg arg17, ops_arg arg18, ops_arg arg19) {
  ...
  create_kerneldesc_and_enque(name, args, 20, 22, dim, 0, range, block, ops_par_loop_opensbliblock00Kernel001_execute);
}
#endif
