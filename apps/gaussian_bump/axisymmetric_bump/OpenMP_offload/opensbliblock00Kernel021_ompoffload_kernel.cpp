  ...
  for ( int n_z=start2; n_z<end2; n_z++ ){
    for ( int n_y=start1; n_y<end1; n_y++ ){
      for ( int n_x=start0; n_x<end0; n_x++ ){
        const ACC<double> D10_B0(xdim0_opensbliblock00Kernel021, ydim0_opensbliblock00Kernel021, D10_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel021*1 + n_z * xdim0_opensbliblock00Kernel021 * ydim0_opensbliblock00Kernel021*1);
        const ACC<double> D11_B0(xdim1_opensbliblock00Kernel021, ydim1_opensbliblock00Kernel021, D11_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel021*1 + n_z * xdim1_opensbliblock00Kernel021 * ydim1_opensbliblock00Kernel021*1);
        const ACC<double> D12_B0(xdim2_opensbliblock00Kernel021, ydim2_opensbliblock00Kernel021, D12_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel021*1 + n_z * xdim2_opensbliblock00Kernel021 * ydim2_opensbliblock00Kernel021*1);
        const ACC<double> u0_B0(xdim3_opensbliblock00Kernel021, ydim3_opensbliblock00Kernel021, u0_B0_p + n_x*1 + n_y * xdim3_opensbliblock00Kernel021*1 + n_z * xdim3_opensbliblock00Kernel021 * ydim3_opensbliblock00Kernel021*1);
        const ACC<double> u1_B0(xdim4_opensbliblock00Kernel021, ydim4_opensbliblock00Kernel021, u1_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel021*1 + n_z * xdim4_opensbliblock00Kernel021 * ydim4_opensbliblock00Kernel021*1);
        const ACC<double> u2_B0(xdim5_opensbliblock00Kernel021, ydim5_opensbliblock00Kernel021, u2_B0_p + n_x*1 + n_y * xdim5_opensbliblock00Kernel021*1 + n_z * xdim5_opensbliblock00Kernel021 * ydim5_opensbliblock00Kernel021*1);
        ACC<double> U1_B0(xdim6_opensbliblock00Kernel021, ydim6_opensbliblock00Kernel021, U1_B0_p + n_x*1 + n_y * xdim6_opensbliblock00Kernel021*1 + n_z * xdim6_opensbliblock00Kernel021 * ydim6_opensbliblock00Kernel021*1);
...
void ops_par_loop_opensbliblock00Kernel021(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4, ops_arg arg5, ops_arg arg6) {
  ...
  create_kerneldesc_and_enque(name, args, 7, 16, dim, 0, range, block, ops_par_loop_opensbliblock00Kernel021_execute);
}
#endif
