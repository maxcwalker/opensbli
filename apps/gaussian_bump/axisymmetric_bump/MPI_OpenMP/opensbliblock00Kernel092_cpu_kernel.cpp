  ...
  for ( int n_z=start[2]; n_z<end[2]; n_z++ ){
    for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
      ...
      for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
        ...
        ACC<double> rhoE_B0(xdim0_opensbliblock00Kernel092, ydim0_opensbliblock00Kernel092, rhoE_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel092*1 + n_z * xdim0_opensbliblock00Kernel092 * ydim0_opensbliblock00Kernel092*1);
        ACC<double> rho_B0(xdim1_opensbliblock00Kernel092, ydim1_opensbliblock00Kernel092, rho_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel092*1 + n_z * xdim1_opensbliblock00Kernel092 * ydim1_opensbliblock00Kernel092*1);
        ACC<double> rhou0_B0(xdim2_opensbliblock00Kernel092, ydim2_opensbliblock00Kernel092, rhou0_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel092*1 + n_z * xdim2_opensbliblock00Kernel092 * ydim2_opensbliblock00Kernel092*1);
        ACC<double> rhou1_B0(xdim3_opensbliblock00Kernel092, ydim3_opensbliblock00Kernel092, rhou1_B0_p + n_x*1 + n_y * xdim3_opensbliblock00Kernel092*1 + n_z * xdim3_opensbliblock00Kernel092 * ydim3_opensbliblock00Kernel092*1);
        ACC<double> rhou2_B0(xdim4_opensbliblock00Kernel092, ydim4_opensbliblock00Kernel092, rhou2_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel092*1 + n_z * xdim4_opensbliblock00Kernel092 * ydim4_opensbliblock00Kernel092*1);
        ACC<double> x0_B0(xdim5_opensbliblock00Kernel092, ydim5_opensbliblock00Kernel092, x0_B0_p + n_x*1 + n_y * xdim5_opensbliblock00Kernel092*1 + n_z * xdim5_opensbliblock00Kernel092 * ydim5_opensbliblock00Kernel092*1);
        ACC<double> x2_B0(xdim6_opensbliblock00Kernel092, ydim6_opensbliblock00Kernel092, x2_B0_p + n_x*1 + n_y * xdim6_opensbliblock00Kernel092*1 + n_z * xdim6_opensbliblock00Kernel092 * ydim6_opensbliblock00Kernel092*1);
        ACC<double> x1_B0(xdim7_opensbliblock00Kernel092, ydim7_opensbliblock00Kernel092, x1_B0_p + n_x*1 + n_y * xdim7_opensbliblock00Kernel092*1 + n_z * xdim7_opensbliblock00Kernel092 * ydim7_opensbliblock00Kernel092*1);
...
void ops_par_loop_opensbliblock00Kernel092(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg8) {
  ...
  create_kerneldesc_and_enque(name, args, 9, 0, dim, 0, range, block, ops_par_loop_opensbliblock00Kernel092_execute);
}
#endif
