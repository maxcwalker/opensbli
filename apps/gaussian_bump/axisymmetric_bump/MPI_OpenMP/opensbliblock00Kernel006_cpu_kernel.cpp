  ...
  for ( int n_z=start[2]; n_z<end[2]; n_z++ ){
    for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
      ...
      for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
        ...
        const ACC<double> rhou1_B0(xdim1_opensbliblock00Kernel006, ydim1_opensbliblock00Kernel006, rhou1_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel006*1 + n_z * xdim1_opensbliblock00Kernel006 * ydim1_opensbliblock00Kernel006*1);
        ACC<double> u1_B0(xdim2_opensbliblock00Kernel006, ydim2_opensbliblock00Kernel006, u1_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel006*1 + n_z * xdim2_opensbliblock00Kernel006 * ydim2_opensbliblock00Kernel006*1);
...
void ops_par_loop_opensbliblock00Kernel006(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  create_kerneldesc_and_enque(name, args, 3, 11, dim, 0, range, block, ops_par_loop_opensbliblock00Kernel006_execute);
}
#endif
