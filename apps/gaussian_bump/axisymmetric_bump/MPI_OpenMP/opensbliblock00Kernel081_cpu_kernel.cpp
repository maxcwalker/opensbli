...
void ops_par_loop_opensbliblock00Kernel081_execute(ops_kernel_descriptor *desc) {
  ...
  double * __restrict__ T_B0_p = (double *)(args[36].data + base36);

  int base37 = args[37].dat->base_offset;
  double * __restrict__ mu_B0_p = (double *)(args[37].data + base37);

  int base38 = args[38].dat->base_offset;
  double * __restrict__ u0_B0_p = (double *)(args[38].data + base38);

  int base39 = args[39].dat->base_offset;
  double * __restrict__ u1_B0_p = (double *)(args[39].data + base39);

  int base40 = args[40].dat->base_offset;
  double * __restrict__ u2_B0_p = (double *)(args[40].data + base40);

  int base41 = args[41].dat->base_offset;
  double * __restrict__ wk0_B0_p = (double *)(args[41].data + base41);

  int base42 = args[42].dat->base_offset;
  double * __restrict__ wk10_B0_p = (double *)(args[42].data + base42);

  int base43 = args[43].dat->base_offset;
  double * __restrict__ wk11_B0_p = (double *)(args[43].data + base43);

  int base44 = args[44].dat->base_offset;
  double * __restrict__ wk1_B0_p = (double *)(args[44].data + base44);

  int base45 = args[45].dat->base_offset;
  double * __restrict__ wk2_B0_p = (double *)(args[45].data + base45);

  int base46 = args[46].dat->base_offset;
  double * __restrict__ wk3_B0_p = (double *)(args[46].data + base46);

  int base47 = args[47].dat->base_offset;
  double * __restrict__ wk4_B0_p = (double *)(args[47].data + base47);

  int base48 = args[48].dat->base_offset;
  double * __restrict__ wk5_B0_p = (double *)(args[48].data + base48);

  int base49 = args[49].dat->base_offset;
  double * __restrict__ wk6_B0_p = (double *)(args[49].data + base49);

  int base50 = args[50].dat->base_offset;
  double * __restrict__ wk7_B0_p = (double *)(args[50].data + base50);

  int base51 = args[51].dat->base_offset;
  double * __restrict__ wk8_B0_p = (double *)(args[51].data + base51);

  int base52 = args[52].dat->base_offset;
  double * __restrict__ wk9_B0_p = (double *)(args[52].data + base52);

  int base53 = args[53].dat->base_offset;
  double * __restrict__ Residual1_B0_p = (double *)(args[53].data + base53);

  int base54 = args[54].dat->base_offset;
  double * __restrict__ Residual2_B0_p = (double *)(args[54].data + base54);

  int base55 = args[55].dat->base_offset;
  double * __restrict__ Residual3_B0_p = (double *)(args[55].data + base55);

  int base56 = args[56].dat->base_offset;
  double * __restrict__ Residual4_B0_p = (double *)(args[56].data + base56);
