...
void ops_par_loop_opensbliblock00Kernel001_execute(ops_kernel_descriptor *desc) {
  ...
  double * __restrict__ D12_B0_p = (double *)(args[2].data + base2);
  ...
  double * __restrict__ wk6_B0_p = (double *)(args[16].data + base16);
  ...
  double * __restrict__ wk8_B0_p = (double *)(args[18].data + base18);

  int base19 = args[19].dat->base_offset;
  double * __restrict__ wk9_B0_p = (double *)(args[19].data + base19);
