...
void ops_par_loop_opensbliblock00Kernel002_execute(ops_kernel_descriptor *desc) {
 ...
 arg15, arg16, arg17, arg18, arg19};
  ...
  double* D20_B0_p = (double*)args[0].data_d;

  int base1 = args[1].dat->base_offset/sizeof(double);
  double* D21_B0_p = (double*)args[1].data_d;

  int base2 = args[2].dat->base_offset/sizeof(double);
  double* D22_B0_p = (double*)args[2].data_d;

  int base3 = args[3].dat->base_offset/sizeof(double);
  double* U2_B0_p = (double*)args[3].data_d;
  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0 && (end[2]-start[2])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      , [=](cl::sycl::nd_item<3> item
        ...
        const ACC<double> D20_B0(xdim0_opensbliblock00Kernel002, ydim0_opensbliblock00Kernel002, &D20_B0_p[0] + base0 + n_x*1 + n_y * xdim0_opensbliblock00Kernel002*1 + n_z * xdim0_opensbliblock00Kernel002 * ydim0_opensbliblock00Kernel002*1);
        const ACC<double> D21_B0(xdim1_opensbliblock00Kernel002, ydim1_opensbliblock00Kernel002, &D21_B0_p[0] + base1 + n_x*1 + n_y * xdim1_opensbliblock00Kernel002*1 + n_z * xdim1_opensbliblock00Kernel002 * ydim1_opensbliblock00Kernel002*1);
        const ACC<double> D22_B0(xdim2_opensbliblock00Kernel002, ydim2_opensbliblock00Kernel002, &D22_B0_p[0] + base2 + n_x*1 + n_y * xdim2_opensbliblock00Kernel002*1 + n_z * xdim2_opensbliblock00Kernel002 * ydim2_opensbliblock00Kernel002*1);
        const ACC<double> U2_B0(xdim3_opensbliblock00Kernel002, ydim3_opensbliblock00Kernel002, &U2_B0_p[0] + base3 + n_x*1 + n_y * xdim3_opensbliblock00Kernel002*1 + n_z * xdim3_opensbliblock00Kernel002 * ydim3_opensbliblock00Kernel002*1);
        const ACC<double> a_B0(xdim4_opensbliblock00Kernel002, ydim4_opensbliblock00Kernel002, &a_B0_p[0] + base4 + n_x*1 + n_y * xdim4_opensbliblock00Kernel002*1 + n_z * xdim4_opensbliblock00Kernel002 * ydim4_opensbliblock00Kernel002*1);
        const ACC<double> detJ_B0(xdim5_opensbliblock00Kernel002, ydim5_opensbliblock00Kernel002, &detJ_B0_p[0] + base5 + n_x*1 + n_y * xdim5_opensbliblock00Kernel002*1 + n_z * xdim5_opensbliblock00Kernel002 * ydim5_opensbliblock00Kernel002*1);
        const ACC<double> p_B0(xdim6_opensbliblock00Kernel002, ydim6_opensbliblock00Kernel002, &p_B0_p[0] + base6 + n_x*1 + n_y * xdim6_opensbliblock00Kernel002*1 + n_z * xdim6_opensbliblock00Kernel002 * ydim6_opensbliblock00Kernel002*1);
        const ACC<double> rhoE_B0(xdim7_opensbliblock00Kernel002, ydim7_opensbliblock00Kernel002, &rhoE_B0_p[0] + base7 + n_x*1 + n_y * xdim7_opensbliblock00Kernel002*1 + n_z * xdim7_opensbliblock00Kernel002 * ydim7_opensbliblock00Kernel002*1);
        const ACC<double> rho_B0(xdim8_opensbliblock00Kernel002, ydim8_opensbliblock00Kernel002, &rho_B0_p[0] + base8 + n_x*1 + n_y * xdim8_opensbliblock00Kernel002*1 + n_z * xdim8_opensbliblock00Kernel002 * ydim8_opensbliblock00Kernel002*1);
        const ACC<double> rhou0_B0(xdim9_opensbliblock00Kernel002, ydim9_opensbliblock00Kernel002, &rhou0_B0_p[0] + base9 + n_x*1 + n_y * xdim9_opensbliblock00Kernel002*1 + n_z * xdim9_opensbliblock00Kernel002 * ydim9_opensbliblock00Kernel002*1);
        const ACC<double> rhou1_B0(xdim10_opensbliblock00Kernel002, ydim10_opensbliblock00Kernel002, &rhou1_B0_p[0] + base10 + n_x*1 + n_y * xdim10_opensbliblock00Kernel002*1 + n_z * xdim10_opensbliblock00Kernel002 * ydim10_opensbliblock00Kernel002*1);
        const ACC<double> rhou2_B0(xdim11_opensbliblock00Kernel002, ydim11_opensbliblock00Kernel002, &rhou2_B0_p[0] + base11 + n_x*1 + n_y * xdim11_opensbliblock00Kernel002*1 + n_z * xdim11_opensbliblock00Kernel002 * ydim11_opensbliblock00Kernel002*1);
        const ACC<double> u0_B0(xdim12_opensbliblock00Kernel002, ydim12_opensbliblock00Kernel002, &u0_B0_p[0] + base12 + n_x*1 + n_y * xdim12_opensbliblock00Kernel002*1 + n_z * xdim12_opensbliblock00Kernel002 * ydim12_opensbliblock00Kernel002*1);
        const ACC<double> u1_B0(xdim13_opensbliblock00Kernel002, ydim13_opensbliblock00Kernel002, &u1_B0_p[0] + base13 + n_x*1 + n_y * xdim13_opensbliblock00Kernel002*1 + n_z * xdim13_opensbliblock00Kernel002 * ydim13_opensbliblock00Kernel002*1);
        const ACC<double> u2_B0(xdim14_opensbliblock00Kernel002, ydim14_opensbliblock00Kernel002, &u2_B0_p[0] + base14 + n_x*1 + n_y * xdim14_opensbliblock00Kernel002*1 + n_z * xdim14_opensbliblock00Kernel002 * ydim14_opensbliblock00Kernel002*1);
        ACC<double> wk10_B0(xdim15_opensbliblock00Kernel002, ydim15_opensbliblock00Kernel002, &wk10_B0_p[0] + base15 + n_x*1 + n_y * xdim15_opensbliblock00Kernel002*1 + n_z * xdim15_opensbliblock00Kernel002 * ydim15_opensbliblock00Kernel002*1);
        ACC<double> wk11_B0(xdim16_opensbliblock00Kernel002, ydim16_opensbliblock00Kernel002, &wk11_B0_p[0] + base16 + n_x*1 + n_y * xdim16_opensbliblock00Kernel002*1 + n_z * xdim16_opensbliblock00Kernel002 * ydim16_opensbliblock00Kernel002*1);
        ACC<double> wk12_B0(xdim17_opensbliblock00Kernel002, ydim17_opensbliblock00Kernel002, &wk12_B0_p[0] + base17 + n_x*1 + n_y * xdim17_opensbliblock00Kernel002*1 + n_z * xdim17_opensbliblock00Kernel002 * ydim17_opensbliblock00Kernel002*1);
        ACC<double> wk13_B0(xdim18_opensbliblock00Kernel002, ydim18_opensbliblock00Kernel002, &wk13_B0_p[0] + base18 + n_x*1 + n_y * xdim18_opensbliblock00Kernel002*1 + n_z * xdim18_opensbliblock00Kernel002 * ydim18_opensbliblock00Kernel002*1);
        ACC<double> wk14_B0(xdim19_opensbliblock00Kernel002, ydim19_opensbliblock00Kernel002, &wk14_B0_p[0] + base19 + n_x*1 + n_y * xdim19_opensbliblock00Kernel002*1 + n_z * xdim19_opensbliblock00Kernel002 * ydim19_opensbliblock00Kernel002*1);
        //USER CODE
   ...
   inv_AVG_met_fact = pow((AVG_2_D20*AVG_2_D20) + (AVG_2_D21*AVG_2_D21) + (AVG_2_D22*AVG_2_D22), (-1.0/2.0));
    ...
    AVG_2_2_LEV_00 = -(1.0/2.0)*(-2*AVG_2_D20 - (AVG_2_u0*AVG_2_u0)*(inv_AVG_a*inv_AVG_a)*AVG_2_D20 -
      ...
      (AVG_2_u0*AVG_2_u0)*(inv_AVG_a*inv_AVG_a)*gama_sycl[0]*AVG_2_D20 +
      (AVG_2_u1*AVG_2_u1)*(inv_AVG_a*inv_AVG_a)*gama_sycl[0]*AVG_2_D20 +
      (AVG_2_u2*AVG_2_u2)*(inv_AVG_a*inv_AVG_a)*gama_sycl[0]*AVG_2_D20)*inv_AVG_met_fact;

   AVG_2_2_LEV_01 = (inv_AVG_a*inv_AVG_a)*gamma_m1_sycl[0]*AVG_2_D20*AVG_2_u0*inv_AVG_met_fact;

    AVG_2_2_LEV_02 = (AVG_2_D22*inv_AVG_rho - (inv_AVG_a*inv_AVG_a)*AVG_2_D20*AVG_2_u1 +
      (inv_AVG_a*inv_AVG_a)*gama_sycl[0]*AVG_2_D20*AVG_2_u1)*inv_AVG_met_fact;

    AVG_2_2_LEV_03 = (-AVG_2_D21*inv_AVG_rho - (inv_AVG_a*inv_AVG_a)*AVG_2_D20*AVG_2_u2 +
      (inv_AVG_a*inv_AVG_a)*gama_sycl[0]*AVG_2_D20*AVG_2_u2)*inv_AVG_met_fact;

   AVG_2_2_LEV_04 = -(inv_AVG_a*inv_AVG_a)*gamma_m1_sycl[0]*AVG_2_D20*inv_AVG_met_fact;
    ...
    AVG_2_2_LEV_10 = -(1.0/2.0)*(-2*AVG_2_D21 - (AVG_2_u0*AVG_2_u0)*(inv_AVG_a*inv_AVG_a)*AVG_2_D21 -
      ...
      (AVG_2_u0*AVG_2_u0)*(inv_AVG_a*inv_AVG_a)*gama_sycl[0]*AVG_2_D21 +
      (AVG_2_u1*AVG_2_u1)*(inv_AVG_a*inv_AVG_a)*gama_sycl[0]*AVG_2_D21 +
      (AVG_2_u2*AVG_2_u2)*(inv_AVG_a*inv_AVG_a)*gama_sycl[0]*AVG_2_D21)*inv_AVG_met_fact;

    AVG_2_2_LEV_11 = (-AVG_2_D22*inv_AVG_rho - (inv_AVG_a*inv_AVG_a)*AVG_2_D21*AVG_2_u0 +
      (inv_AVG_a*inv_AVG_a)*gama_sycl[0]*AVG_2_D21*AVG_2_u0)*inv_AVG_met_fact;

   AVG_2_2_LEV_12 = (inv_AVG_a*inv_AVG_a)*gamma_m1_sycl[0]*AVG_2_D21*AVG_2_u1*inv_AVG_met_fact;

    AVG_2_2_LEV_13 = (AVG_2_D20*inv_AVG_rho - (inv_AVG_a*inv_AVG_a)*AVG_2_D21*AVG_2_u2 +
      (inv_AVG_a*inv_AVG_a)*gama_sycl[0]*AVG_2_D21*AVG_2_u2)*inv_AVG_met_fact;

   AVG_2_2_LEV_14 = -(inv_AVG_a*inv_AVG_a)*gamma_m1_sycl[0]*AVG_2_D21*inv_AVG_met_fact;
    ...
    AVG_2_2_LEV_20 = ((1.0/2.0))*(2*AVG_2_D22 + (AVG_2_u0*AVG_2_u0)*(inv_AVG_a*inv_AVG_a)*AVG_2_D22 +
      ...
      (AVG_2_u0*AVG_2_u0)*(inv_AVG_a*inv_AVG_a)*gama_sycl[0]*AVG_2_D22 -
      (AVG_2_u1*AVG_2_u1)*(inv_AVG_a*inv_AVG_a)*gama_sycl[0]*AVG_2_D22 -
      (AVG_2_u2*AVG_2_u2)*(inv_AVG_a*inv_AVG_a)*gama_sycl[0]*AVG_2_D22)*inv_AVG_met_fact;

    AVG_2_2_LEV_21 = (AVG_2_D21*inv_AVG_rho - (inv_AVG_a*inv_AVG_a)*AVG_2_D22*AVG_2_u0 +
      (inv_AVG_a*inv_AVG_a)*gama_sycl[0]*AVG_2_D22*AVG_2_u0)*inv_AVG_met_fact;

    AVG_2_2_LEV_22 = -(AVG_2_D20*inv_AVG_rho + (inv_AVG_a*inv_AVG_a)*AVG_2_D22*AVG_2_u1 -
      (inv_AVG_a*inv_AVG_a)*gama_sycl[0]*AVG_2_D22*AVG_2_u1)*inv_AVG_met_fact;

   AVG_2_2_LEV_23 = (inv_AVG_a*inv_AVG_a)*gamma_m1_sycl[0]*AVG_2_D22*AVG_2_u2*inv_AVG_met_fact;

   AVG_2_2_LEV_24 = -(inv_AVG_a*inv_AVG_a)*gamma_m1_sycl[0]*AVG_2_D22*inv_AVG_met_fact;
    ...
    AVG_2_2_LEV_31 = 0.707106781186547*(-gama_sycl[0]*AVG_2_u0 + AVG_2_D20*AVG_2_a*inv_AVG_met_fact +
      AVG_2_u0)*inv_AVG_a*inv_AVG_rho;

    AVG_2_2_LEV_32 = 0.707106781186547*(-gama_sycl[0]*AVG_2_u1 + AVG_2_D21*AVG_2_a*inv_AVG_met_fact +
      AVG_2_u1)*inv_AVG_a*inv_AVG_rho;

    AVG_2_2_LEV_33 = 0.707106781186547*(-gama_sycl[0]*AVG_2_u2 + AVG_2_D22*AVG_2_a*inv_AVG_met_fact +
   ...
   AVG_2_2_LEV_34 = 0.707106781186547*gamma_m1_sycl[0]*inv_AVG_a*inv_AVG_rho;
    ...
    AVG_2_2_LEV_41 = -0.707106781186547*(-AVG_2_u0 + gama_sycl[0]*AVG_2_u0 +
      AVG_2_D20*AVG_2_a*inv_AVG_met_fact)*inv_AVG_a*inv_AVG_rho;

    AVG_2_2_LEV_42 = -0.707106781186547*(-AVG_2_u1 + gama_sycl[0]*AVG_2_u1 +
      AVG_2_D21*AVG_2_a*inv_AVG_met_fact)*inv_AVG_a*inv_AVG_rho;

    AVG_2_2_LEV_43 = -0.707106781186547*(-AVG_2_u2 + gama_sycl[0]*AVG_2_u2 +
   ...
   AVG_2_2_LEV_44 = 0.707106781186547*gamma_m1_sycl[0]*inv_AVG_a*inv_AVG_rho;
    ...
    max_lambda_00 = shock_filter_control_sycl[0]*cl::sycl::fmax(cl::sycl::fabs(u0_B0(0,0,1)*D20_B0(0,0,1)*detJ_B0(0,0,1) +
      u1_B0(0,0,1)*D21_B0(0,0,1)*detJ_B0(0,0,1) + u2_B0(0,0,1)*D22_B0(0,0,1)*detJ_B0(0,0,1)),
      cl::sycl::fabs(u0_B0(0,0,0)*D20_B0(0,0,0)*detJ_B0(0,0,0) + u1_B0(0,0,0)*D21_B0(0,0,0)*detJ_B0(0,0,0) +
   ...
   max_lambda_22 = max_lambda_00;
    ...
    max_lambda_33 = shock_filter_control_sycl[0]*cl::sycl::fmax(cl::sycl::fabs(cl::sycl::sqrt((D20_B0(0,0,0)*D20_B0(0,0,0))*(detJ_B0(0,0,0)*detJ_B0(0,0,0)) +
      ...
      u2_B0(0,0,0)*D22_B0(0,0,0)*detJ_B0(0,0,0)),
      cl::sycl::fabs(cl::sycl::sqrt((D20_B0(0,0,1)*D20_B0(0,0,1))*(detJ_B0(0,0,1)*detJ_B0(0,0,1)) +
    ...
    max_lambda_44 = shock_filter_control_sycl[0]*cl::sycl::fmax(cl::sycl::fabs(-cl::sycl::sqrt((D20_B0(0,0,0)*D20_B0(0,0,0))*(detJ_B0(0,0,0)*detJ_B0(0,0,0)) +
      (D21_B0(0,0,0)*D21_B0(0,0,0))*(detJ_B0(0,0,0)*detJ_B0(0,0,0)) +
      (D22_B0(0,0,0)*D22_B0(0,0,0))*(detJ_B0(0,0,0)*detJ_B0(0,0,0)))*a_B0(0,0,0) +
      u0_B0(0,0,0)*D20_B0(0,0,0)*detJ_B0(0,0,0) + u1_B0(0,0,0)*D21_B0(0,0,0)*detJ_B0(0,0,0) +
      u2_B0(0,0,0)*D22_B0(0,0,0)*detJ_B0(0,0,0)),
   ...
   omega_2 = alpha_2*inv_alpha_sum;
    ...
    wk14_B0(0,0,0) = ((AVG_2_D20*AVG_2_u2*inv_AVG_met_fact - AVG_2_D22*AVG_2_u0*inv_AVG_met_fact)*AVG_2_rho +
      ...
      (AVG_2_u2*AVG_2_u2))*gamma_m1_sycl[0])*invgamma_m1_sycl[0] + (AVG_2_D20*AVG_2_u0*inv_AVG_met_fact +
