...
void ops_par_loop_opensbliblock00Kernel001_execute(ops_kernel_descriptor *desc) {
 ...
 arg15, arg16, arg17, arg18, arg19};
  ...
  if (!ops_checkpointing_before(args,20,range,22)) return;
  #endif
  ...
  int xdim19_opensbliblock00Kernel001 = args[19].dat->size[0];
  int ydim19_opensbliblock00Kernel001 = args[19].dat->size[1];
  ...
  double* D12_B0_p = (double*)args[2].data_d;
  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0 && (end[2]-start[2])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      , [=](cl::sycl::nd_item<3> item
        ...
        const ACC<double> D12_B0(xdim2_opensbliblock00Kernel001, ydim2_opensbliblock00Kernel001, &D12_B0_p[0] + base2 + n_x*1 + n_y * xdim2_opensbliblock00Kernel001*1 + n_z * xdim2_opensbliblock00Kernel001 * ydim2_opensbliblock00Kernel001*1);
        const ACC<double> U1_B0(xdim3_opensbliblock00Kernel001, ydim3_opensbliblock00Kernel001, &U1_B0_p[0] + base3 + n_x*1 + n_y * xdim3_opensbliblock00Kernel001*1 + n_z * xdim3_opensbliblock00Kernel001 * ydim3_opensbliblock00Kernel001*1);
        const ACC<double> a_B0(xdim4_opensbliblock00Kernel001, ydim4_opensbliblock00Kernel001, &a_B0_p[0] + base4 + n_x*1 + n_y * xdim4_opensbliblock00Kernel001*1 + n_z * xdim4_opensbliblock00Kernel001 * ydim4_opensbliblock00Kernel001*1);
        const ACC<double> detJ_B0(xdim5_opensbliblock00Kernel001, ydim5_opensbliblock00Kernel001, &detJ_B0_p[0] + base5 + n_x*1 + n_y * xdim5_opensbliblock00Kernel001*1 + n_z * xdim5_opensbliblock00Kernel001 * ydim5_opensbliblock00Kernel001*1);
        const ACC<double> p_B0(xdim6_opensbliblock00Kernel001, ydim6_opensbliblock00Kernel001, &p_B0_p[0] + base6 + n_x*1 + n_y * xdim6_opensbliblock00Kernel001*1 + n_z * xdim6_opensbliblock00Kernel001 * ydim6_opensbliblock00Kernel001*1);
        const ACC<double> rhoE_B0(xdim7_opensbliblock00Kernel001, ydim7_opensbliblock00Kernel001, &rhoE_B0_p[0] + base7 + n_x*1 + n_y * xdim7_opensbliblock00Kernel001*1 + n_z * xdim7_opensbliblock00Kernel001 * ydim7_opensbliblock00Kernel001*1);
        const ACC<double> rho_B0(xdim8_opensbliblock00Kernel001, ydim8_opensbliblock00Kernel001, &rho_B0_p[0] + base8 + n_x*1 + n_y * xdim8_opensbliblock00Kernel001*1 + n_z * xdim8_opensbliblock00Kernel001 * ydim8_opensbliblock00Kernel001*1);
        const ACC<double> rhou0_B0(xdim9_opensbliblock00Kernel001, ydim9_opensbliblock00Kernel001, &rhou0_B0_p[0] + base9 + n_x*1 + n_y * xdim9_opensbliblock00Kernel001*1 + n_z * xdim9_opensbliblock00Kernel001 * ydim9_opensbliblock00Kernel001*1);
        const ACC<double> rhou1_B0(xdim10_opensbliblock00Kernel001, ydim10_opensbliblock00Kernel001, &rhou1_B0_p[0] + base10 + n_x*1 + n_y * xdim10_opensbliblock00Kernel001*1 + n_z * xdim10_opensbliblock00Kernel001 * ydim10_opensbliblock00Kernel001*1);
        const ACC<double> rhou2_B0(xdim11_opensbliblock00Kernel001, ydim11_opensbliblock00Kernel001, &rhou2_B0_p[0] + base11 + n_x*1 + n_y * xdim11_opensbliblock00Kernel001*1 + n_z * xdim11_opensbliblock00Kernel001 * ydim11_opensbliblock00Kernel001*1);
        const ACC<double> u0_B0(xdim12_opensbliblock00Kernel001, ydim12_opensbliblock00Kernel001, &u0_B0_p[0] + base12 + n_x*1 + n_y * xdim12_opensbliblock00Kernel001*1 + n_z * xdim12_opensbliblock00Kernel001 * ydim12_opensbliblock00Kernel001*1);
        const ACC<double> u1_B0(xdim13_opensbliblock00Kernel001, ydim13_opensbliblock00Kernel001, &u1_B0_p[0] + base13 + n_x*1 + n_y * xdim13_opensbliblock00Kernel001*1 + n_z * xdim13_opensbliblock00Kernel001 * ydim13_opensbliblock00Kernel001*1);
        const ACC<double> u2_B0(xdim14_opensbliblock00Kernel001, ydim14_opensbliblock00Kernel001, &u2_B0_p[0] + base14 + n_x*1 + n_y * xdim14_opensbliblock00Kernel001*1 + n_z * xdim14_opensbliblock00Kernel001 * ydim14_opensbliblock00Kernel001*1);
        ACC<double> wk5_B0(xdim15_opensbliblock00Kernel001, ydim15_opensbliblock00Kernel001, &wk5_B0_p[0] + base15 + n_x*1 + n_y * xdim15_opensbliblock00Kernel001*1 + n_z * xdim15_opensbliblock00Kernel001 * ydim15_opensbliblock00Kernel001*1);
        ACC<double> wk6_B0(xdim16_opensbliblock00Kernel001, ydim16_opensbliblock00Kernel001, &wk6_B0_p[0] + base16 + n_x*1 + n_y * xdim16_opensbliblock00Kernel001*1 + n_z * xdim16_opensbliblock00Kernel001 * ydim16_opensbliblock00Kernel001*1);
        ACC<double> wk7_B0(xdim17_opensbliblock00Kernel001, ydim17_opensbliblock00Kernel001, &wk7_B0_p[0] + base17 + n_x*1 + n_y * xdim17_opensbliblock00Kernel001*1 + n_z * xdim17_opensbliblock00Kernel001 * ydim17_opensbliblock00Kernel001*1);
        ACC<double> wk8_B0(xdim18_opensbliblock00Kernel001, ydim18_opensbliblock00Kernel001, &wk8_B0_p[0] + base18 + n_x*1 + n_y * xdim18_opensbliblock00Kernel001*1 + n_z * xdim18_opensbliblock00Kernel001 * ydim18_opensbliblock00Kernel001*1);
        ACC<double> wk9_B0(xdim19_opensbliblock00Kernel001, ydim19_opensbliblock00Kernel001, &wk9_B0_p[0] + base19 + n_x*1 + n_y * xdim19_opensbliblock00Kernel001*1 + n_z * xdim19_opensbliblock00Kernel001 * ydim19_opensbliblock00Kernel001*1);
        //USER CODE
   ...
   inv_AVG_met_fact = pow((AVG_1_D10*AVG_1_D10) + (AVG_1_D11*AVG_1_D11) + (AVG_1_D12*AVG_1_D12), (-1.0/2.0));
    ...
    AVG_1_1_LEV_00 = -(1.0/2.0)*(-2*AVG_1_D10 - (AVG_1_u0*AVG_1_u0)*(inv_AVG_a*inv_AVG_a)*AVG_1_D10 -
      ...
      (AVG_1_u0*AVG_1_u0)*(inv_AVG_a*inv_AVG_a)*gama_sycl[0]*AVG_1_D10 +
   ...
   AVG_1_1_LEV_01 = (inv_AVG_a*inv_AVG_a)*gamma_m1_sycl[0]*AVG_1_D10*AVG_1_u0*inv_AVG_met_fact;
    ...
    AVG_1_1_LEV_02 = (AVG_1_D12*inv_AVG_rho - (inv_AVG_a*inv_AVG_a)*AVG_1_D10*AVG_1_u1 +
      (inv_AVG_a*inv_AVG_a)*gama_sycl[0]*AVG_1_D10*AVG_1_u1)*inv_AVG_met_fact;
   ...
   AVG_1_1_LEV_04 = -(inv_AVG_a*inv_AVG_a)*gamma_m1_sycl[0]*AVG_1_D10*inv_AVG_met_fact;
    ...
    AVG_1_1_LEV_10 = -(1.0/2.0)*(-2*AVG_1_D11 - (AVG_1_u0*AVG_1_u0)*(inv_AVG_a*inv_AVG_a)*AVG_1_D11 -
      ...
      (AVG_1_u0*AVG_1_u0)*(inv_AVG_a*inv_AVG_a)*gama_sycl[0]*AVG_1_D11 +
    ...
    AVG_1_1_LEV_11 = (-AVG_1_D12*inv_AVG_rho - (inv_AVG_a*inv_AVG_a)*AVG_1_D11*AVG_1_u0 +
      (inv_AVG_a*inv_AVG_a)*gama_sycl[0]*AVG_1_D11*AVG_1_u0)*inv_AVG_met_fact;
   ...
   AVG_1_1_LEV_14 = -(inv_AVG_a*inv_AVG_a)*gamma_m1_sycl[0]*AVG_1_D11*inv_AVG_met_fact;
    ...
    AVG_1_1_LEV_20 = ((1.0/2.0))*(2*AVG_1_D12 + (AVG_1_u0*AVG_1_u0)*(inv_AVG_a*inv_AVG_a)*AVG_1_D12 +
      ...
      (AVG_1_u0*AVG_1_u0)*(inv_AVG_a*inv_AVG_a)*gama_sycl[0]*AVG_1_D12 -
      (AVG_1_u1*AVG_1_u1)*(inv_AVG_a*inv_AVG_a)*gama_sycl[0]*AVG_1_D12 -
      (AVG_1_u2*AVG_1_u2)*(inv_AVG_a*inv_AVG_a)*gama_sycl[0]*AVG_1_D12)*inv_AVG_met_fact;

    AVG_1_1_LEV_21 = (AVG_1_D11*inv_AVG_rho - (inv_AVG_a*inv_AVG_a)*AVG_1_D12*AVG_1_u0 +
      (inv_AVG_a*inv_AVG_a)*gama_sycl[0]*AVG_1_D12*AVG_1_u0)*inv_AVG_met_fact;

    AVG_1_1_LEV_22 = -(AVG_1_D10*inv_AVG_rho + (inv_AVG_a*inv_AVG_a)*AVG_1_D12*AVG_1_u1 -
      (inv_AVG_a*inv_AVG_a)*gama_sycl[0]*AVG_1_D12*AVG_1_u1)*inv_AVG_met_fact;

   AVG_1_1_LEV_23 = (inv_AVG_a*inv_AVG_a)*gamma_m1_sycl[0]*AVG_1_D12*AVG_1_u2*inv_AVG_met_fact;

   AVG_1_1_LEV_24 = -(inv_AVG_a*inv_AVG_a)*gamma_m1_sycl[0]*AVG_1_D12*inv_AVG_met_fact;
    ...
    AVG_1_1_LEV_33 = 0.707106781186547*(-gama_sycl[0]*AVG_1_u2 + AVG_1_D12*AVG_1_a*inv_AVG_met_fact +
   ...
   AVG_1_1_LEV_34 = 0.707106781186547*gamma_m1_sycl[0]*inv_AVG_a*inv_AVG_rho;
    ...
    AVG_1_1_LEV_43 = -0.707106781186547*(-AVG_1_u2 + gama_sycl[0]*AVG_1_u2 +
   ...
   AVG_1_1_LEV_44 = 0.707106781186547*gamma_m1_sycl[0]*inv_AVG_a*inv_AVG_rho;
    ...
    max_lambda_00 = shock_filter_control_sycl[0]*cl::sycl::fmax(cl::sycl::fabs(u0_B0(0,1,0)*D10_B0(0,1,0)*detJ_B0(0,1,0) +
      ...
      cl::sycl::fabs(u0_B0(0,0,0)*D10_B0(0,0,0)*detJ_B0(0,0,0) + u1_B0(0,0,0)*D11_B0(0,0,0)*detJ_B0(0,0,0) +
  ...
  if (block->instance->OPS_diags > 1) {
    ...
    block->instance->OPS_kernels[22].transfer += ops_compute_transfer(dim, start, end, &arg19);
  }
}
