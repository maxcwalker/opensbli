  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0 && (end[2]-start[2])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      , [=](cl::sycl::nd_item<3> item
        ...
        const ACC<double> x0_B0(xdim1_opensbliblock00Kernel088, ydim1_opensbliblock00Kernel088, &x0_B0_p[0] + base1 + n_x*1 + n_y * xdim1_opensbliblock00Kernel088*1 + n_z * xdim1_opensbliblock00Kernel088 * ydim1_opensbliblock00Kernel088*1);
        const ACC<double> x2_B0(xdim2_opensbliblock00Kernel088, ydim2_opensbliblock00Kernel088, &x2_B0_p[0] + base2 + n_x*1 + n_y * xdim2_opensbliblock00Kernel088*1 + n_z * xdim2_opensbliblock00Kernel088 * ydim2_opensbliblock00Kernel088*1);
        ACC<double> rhoE_B0(xdim3_opensbliblock00Kernel088, ydim3_opensbliblock00Kernel088, &rhoE_B0_p[0] + base3 + n_x*1 + n_y * xdim3_opensbliblock00Kernel088*1 + n_z * xdim3_opensbliblock00Kernel088 * ydim3_opensbliblock00Kernel088*1);
        ACC<double> rho_B0(xdim4_opensbliblock00Kernel088, ydim4_opensbliblock00Kernel088, &rho_B0_p[0] + base4 + n_x*1 + n_y * xdim4_opensbliblock00Kernel088*1 + n_z * xdim4_opensbliblock00Kernel088 * ydim4_opensbliblock00Kernel088*1);
        ACC<double> rhou0_B0(xdim5_opensbliblock00Kernel088, ydim5_opensbliblock00Kernel088, &rhou0_B0_p[0] + base5 + n_x*1 + n_y * xdim5_opensbliblock00Kernel088*1 + n_z * xdim5_opensbliblock00Kernel088 * ydim5_opensbliblock00Kernel088*1);
        ACC<double> rhou1_B0(xdim6_opensbliblock00Kernel088, ydim6_opensbliblock00Kernel088, &rhou1_B0_p[0] + base6 + n_x*1 + n_y * xdim6_opensbliblock00Kernel088*1 + n_z * xdim6_opensbliblock00Kernel088 * ydim6_opensbliblock00Kernel088*1);
        ACC<double> rhou2_B0(xdim7_opensbliblock00Kernel088, ydim7_opensbliblock00Kernel088, &rhou2_B0_p[0] + base7 + n_x*1 + n_y * xdim7_opensbliblock00Kernel088*1 + n_z * xdim7_opensbliblock00Kernel088 * ydim7_opensbliblock00Kernel088*1);
   ...
   double u24 = 0.0;
    rhou1_B0(0,0,0) = tripA_sycl[0]*rho_B0(0,0,0)*cl::sycl::exp(-((-xts_sycl[0] + x0_B0(0,0,0))*(-xts_sycl[0] +
      x0_B0(0,0,0)))*k_0_sycl[0])*cl::sycl::sin(beta_0_sycl[0]*x2_B0(0,0,0))*cl::sycl::sin(dt_sycl[0]*omega_0_sycl[0]* *iter);
