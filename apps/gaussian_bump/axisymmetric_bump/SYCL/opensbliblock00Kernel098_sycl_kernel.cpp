 ...
 arg5, arg6, arg7, arg8, arg9};
  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0 && (end[2]-start[2])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      cgh.parallel_for<class opensbliblock00Kernel098_kernel>(cl::sycl::nd_range<3>(cl::sycl::range<3>(
      ...
      , [=](cl::sycl::nd_item<3> item
        ...
        ACC<double> D00_B0(xdim0_opensbliblock00Kernel098, ydim0_opensbliblock00Kernel098, &D00_B0_p[0] + base0 + n_x*1 + n_y * xdim0_opensbliblock00Kernel098*1 + n_z * xdim0_opensbliblock00Kernel098 * ydim0_opensbliblock00Kernel098*1);
        ACC<double> D01_B0(xdim1_opensbliblock00Kernel098, ydim1_opensbliblock00Kernel098, &D01_B0_p[0] + base1 + n_x*1 + n_y * xdim1_opensbliblock00Kernel098*1 + n_z * xdim1_opensbliblock00Kernel098 * ydim1_opensbliblock00Kernel098*1);
        ACC<double> D02_B0(xdim2_opensbliblock00Kernel098, ydim2_opensbliblock00Kernel098, &D02_B0_p[0] + base2 + n_x*1 + n_y * xdim2_opensbliblock00Kernel098*1 + n_z * xdim2_opensbliblock00Kernel098 * ydim2_opensbliblock00Kernel098*1);
        ACC<double> D10_B0(xdim3_opensbliblock00Kernel098, ydim3_opensbliblock00Kernel098, &D10_B0_p[0] + base3 + n_x*1 + n_y * xdim3_opensbliblock00Kernel098*1 + n_z * xdim3_opensbliblock00Kernel098 * ydim3_opensbliblock00Kernel098*1);
        ACC<double> D11_B0(xdim4_opensbliblock00Kernel098, ydim4_opensbliblock00Kernel098, &D11_B0_p[0] + base4 + n_x*1 + n_y * xdim4_opensbliblock00Kernel098*1 + n_z * xdim4_opensbliblock00Kernel098 * ydim4_opensbliblock00Kernel098*1);
        ACC<double> D12_B0(xdim5_opensbliblock00Kernel098, ydim5_opensbliblock00Kernel098, &D12_B0_p[0] + base5 + n_x*1 + n_y * xdim5_opensbliblock00Kernel098*1 + n_z * xdim5_opensbliblock00Kernel098 * ydim5_opensbliblock00Kernel098*1);
        ACC<double> D20_B0(xdim6_opensbliblock00Kernel098, ydim6_opensbliblock00Kernel098, &D20_B0_p[0] + base6 + n_x*1 + n_y * xdim6_opensbliblock00Kernel098*1 + n_z * xdim6_opensbliblock00Kernel098 * ydim6_opensbliblock00Kernel098*1);
        ACC<double> D21_B0(xdim7_opensbliblock00Kernel098, ydim7_opensbliblock00Kernel098, &D21_B0_p[0] + base7 + n_x*1 + n_y * xdim7_opensbliblock00Kernel098*1 + n_z * xdim7_opensbliblock00Kernel098 * ydim7_opensbliblock00Kernel098*1);
        ACC<double> D22_B0(xdim8_opensbliblock00Kernel098, ydim8_opensbliblock00Kernel098, &D22_B0_p[0] + base8 + n_x*1 + n_y * xdim8_opensbliblock00Kernel098*1 + n_z * xdim8_opensbliblock00Kernel098 * ydim8_opensbliblock00Kernel098*1);
        ACC<double> detJ_B0(xdim9_opensbliblock00Kernel098, ydim9_opensbliblock00Kernel098, &detJ_B0_p[0] + base9 + n_x*1 + n_y * xdim9_opensbliblock00Kernel098*1 + n_z * xdim9_opensbliblock00Kernel098 * ydim9_opensbliblock00Kernel098*1);
        //USER CODE
...
void ops_par_loop_opensbliblock00Kernel098(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg8, ops_arg arg9) {
  ...
  desc->function = ops_par_loop_opensbliblock00Kernel098_execute;
  if (block->instance->OPS_diags > 1) {
    ops_timing_realloc(block->instance,3,"opensbliblock00Kernel098");
  }
