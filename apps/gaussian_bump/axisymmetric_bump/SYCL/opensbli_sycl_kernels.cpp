...
extern double Twall;
cl::sycl::buffer<double,1> *W_p=nullptr;
extern double W;
...
void ops_decl_const_char(OPS_instance *instance, int dim, char const * type, int size, char * dat, char const * name ) {
  ...
  if (!strcmp(name,"W")) {
    if (W_p == nullptr) W_p = new cl::sycl::buffer<double,1>(cl::sycl::range<1>(dim));
    auto accessor = (*W_p).get_access<cl::sycl::access::mode::write>();
    for ( int d=0; d<dim; d++ ){
      accessor[d] = ((double*)dat)[d];
    }
  }
...
//user kernel files
#include "opensbliblock00Kernel092_sycl_kernel.cpp"
#include "opensbliblock00Kernel096_sycl_kernel.cpp"
#include "opensbliblock00Kernel097_sycl_kernel.cpp"
#include "opensbliblock00Kernel098_sycl_kernel.cpp"
#include "opensbliblock00Kernel099_sycl_kernel.cpp"
#include "opensbliblock00Kernel100_sycl_kernel.cpp"
#include "opensbliblock00Kernel112_sycl_kernel.cpp"
...
#include "opensbliblock00Kernel113_sycl_kernel.cpp"
