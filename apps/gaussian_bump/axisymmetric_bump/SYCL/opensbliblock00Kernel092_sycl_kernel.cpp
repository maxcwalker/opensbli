...
void ops_par_loop_opensbliblock00Kernel092_execute(ops_kernel_descriptor *desc) {
 ...
 arg5, arg6, arg7, arg8};
  ...
  #ifdef OPS_DEBUG
  ops_register_args(block->instance, args, "opensbliblock00Kernel092");
  #endif
  ...
  int xdim0_opensbliblock00Kernel092 = args[0].dat->size[0];
  int ydim0_opensbliblock00Kernel092 = args[0].dat->size[1];
  int xdim1_opensbliblock00Kernel092 = args[1].dat->size[0];
  int ydim1_opensbliblock00Kernel092 = args[1].dat->size[1];
  int xdim2_opensbliblock00Kernel092 = args[2].dat->size[0];
  int ydim2_opensbliblock00Kernel092 = args[2].dat->size[1];
  int xdim3_opensbliblock00Kernel092 = args[3].dat->size[0];
  int ydim3_opensbliblock00Kernel092 = args[3].dat->size[1];
  int xdim4_opensbliblock00Kernel092 = args[4].dat->size[0];
  int ydim4_opensbliblock00Kernel092 = args[4].dat->size[1];
  int xdim5_opensbliblock00Kernel092 = args[5].dat->size[0];
  int ydim5_opensbliblock00Kernel092 = args[5].dat->size[1];
  int xdim6_opensbliblock00Kernel092 = args[6].dat->size[0];
  int ydim6_opensbliblock00Kernel092 = args[6].dat->size[1];
  int xdim7_opensbliblock00Kernel092 = args[7].dat->size[0];
  int ydim7_opensbliblock00Kernel092 = args[7].dat->size[1];
  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0 && (end[2]-start[2])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      auto W_sycl = (*W_p).template get_access<cl::sycl::access::mode::read>(cgh);
      ...
      cgh.parallel_for<class opensbliblock00Kernel092_kernel>(cl::sycl::nd_range<3>(cl::sycl::range<3>(
      ...
      , [=](cl::sycl::nd_item<3> item
        ...
        ACC<double> rhoE_B0(xdim0_opensbliblock00Kernel092, ydim0_opensbliblock00Kernel092, &rhoE_B0_p[0] + base0 + n_x*1 + n_y * xdim0_opensbliblock00Kernel092*1 + n_z * xdim0_opensbliblock00Kernel092 * ydim0_opensbliblock00Kernel092*1);
        ACC<double> rho_B0(xdim1_opensbliblock00Kernel092, ydim1_opensbliblock00Kernel092, &rho_B0_p[0] + base1 + n_x*1 + n_y * xdim1_opensbliblock00Kernel092*1 + n_z * xdim1_opensbliblock00Kernel092 * ydim1_opensbliblock00Kernel092*1);
        ACC<double> rhou0_B0(xdim2_opensbliblock00Kernel092, ydim2_opensbliblock00Kernel092, &rhou0_B0_p[0] + base2 + n_x*1 + n_y * xdim2_opensbliblock00Kernel092*1 + n_z * xdim2_opensbliblock00Kernel092 * ydim2_opensbliblock00Kernel092*1);
        ACC<double> rhou1_B0(xdim3_opensbliblock00Kernel092, ydim3_opensbliblock00Kernel092, &rhou1_B0_p[0] + base3 + n_x*1 + n_y * xdim3_opensbliblock00Kernel092*1 + n_z * xdim3_opensbliblock00Kernel092 * ydim3_opensbliblock00Kernel092*1);
        ACC<double> rhou2_B0(xdim4_opensbliblock00Kernel092, ydim4_opensbliblock00Kernel092, &rhou2_B0_p[0] + base4 + n_x*1 + n_y * xdim4_opensbliblock00Kernel092*1 + n_z * xdim4_opensbliblock00Kernel092 * ydim4_opensbliblock00Kernel092*1);
        ACC<double> x0_B0(xdim5_opensbliblock00Kernel092, ydim5_opensbliblock00Kernel092, &x0_B0_p[0] + base5 + n_x*1 + n_y * xdim5_opensbliblock00Kernel092*1 + n_z * xdim5_opensbliblock00Kernel092 * ydim5_opensbliblock00Kernel092*1);
        ACC<double> x2_B0(xdim6_opensbliblock00Kernel092, ydim6_opensbliblock00Kernel092, &x2_B0_p[0] + base6 + n_x*1 + n_y * xdim6_opensbliblock00Kernel092*1 + n_z * xdim6_opensbliblock00Kernel092 * ydim6_opensbliblock00Kernel092*1);
        ACC<double> x1_B0(xdim7_opensbliblock00Kernel092, ydim7_opensbliblock00Kernel092, &x1_B0_p[0] + base7 + n_x*1 + n_y * xdim7_opensbliblock00Kernel092*1 + n_z * xdim7_opensbliblock00Kernel092 * ydim7_opensbliblock00Kernel092*1);
        //USER CODE
   ...
   x0_B0(0,0,0) = Delta0block0_sycl[0]*idx[0];
    ...
    x1_B0(0,0,0) = (-(1.0/20.0)*H_sycl[0]*cl::sycl::exp(-((-(1.0/2.0)*L_sycl[0] + Delta0block0_sycl[0]*idx[0])*(-(1.0/2.0)*L_sycl[0] +
      Delta0block0_sycl[0]*idx[0]))*inv2a_sycl[0])*cl::sycl::exp(-((-(1.0/2.0)*W_sycl[0] + Delta2block0_sycl[0]*idx[2])*(-(1.0/2.0)*W_sycl[0] +
      Delta2block0_sycl[0]*idx[2]))*inv2a_sycl[0]) + H_sycl[0])*sinh(b_sycl[0]*invH_sycl[0]*Delta1block0_sycl[0]*idx[1])/sinh(b_sycl[0]) + ((1.0/20.0))*H_sycl[0]*cl::sycl::exp(-((-(1.0/2.0)*L_sycl[0] +
      Delta0block0_sycl[0]*idx[0])*(-(1.0/2.0)*L_sycl[0] + Delta0block0_sycl[0]*idx[0]))*inv2a_sycl[0])*cl::sycl::exp(-((-(1.0/2.0)*W_sycl[0] +
      Delta2block0_sycl[0]*idx[2])*(-(1.0/2.0)*W_sycl[0] + Delta2block0_sycl[0]*idx[2]))*inv2a_sycl[0]);
...
void ops_par_loop_opensbliblock00Kernel092(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg8) {
  ...
  desc->args[8] = arg8;
  desc->function = ops_par_loop_opensbliblock00Kernel092_execute;
  if (block->instance->OPS_diags > 1) {
    ops_timing_realloc(block->instance,0,"opensbliblock00Kernel092");
  }
