...
//
    ...
    void buildOpenCLKernels_opensbliblock00Kernel069(OPS_instance *instance, int xdim0, int ydim0, int xdim1, int ydim1) {
      ...
      if(!isbuilt_opensbliblock00Kernel069) {
        ...
        instance->opencl_instance->OPS_opencl_core.kernel[34] = clCreateKernel(instance->opencl_instance->OPS_opencl_core.program, "ops_opensbliblock00Kernel069", &ret);
        clSafeCall( ret );
...
void ops_par_loop_opensbliblock00Kernel069(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1) {
  ...
  if (block->instance->OPS_diags > 1) {
    ops_timing_realloc(block->instance,34,"opensbliblock00Kernel069");
