...
//
    ...
    static bool isbuilt_opensbliblock00Kernel098 = false;

    void buildOpenCLKernels_opensbliblock00Kernel098(OPS_instance *instance, int xdim0, int ydim0, int xdim1, int ydim1, int xdim2, int ydim2, int xdim3, int ydim3, int xdim4, int ydim4, int xdim5, int ydim5, int xdim6, int ydim6, int xdim7, int ydim7, int xdim8, int ydim8, int xdim9, int ydim9) {

      //int ocl_fma = OCL_FMA;
      if(!isbuilt_opensbliblock00Kernel098) {
        buildOpenCLKernels(instance);
        //clSafeCall( clUnloadCompiler() );
        cl_int ret;
        char* source_filename[1] = {(char*)"./OpenCL/opensbliblock00Kernel098.cl"};
        ...
        instance->ostream() <<"Compiling opensbliblock00Kernel098 "<<OCL_FMA<<" source -- start \n";
          ...
          if (pPath!=NULL)
            if(OCL_FMA)
              sprintf(buildOpts,"-cl-mad-enable -DOCL_FMA -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_opensbliblock00Kernel098=%d  -Dydim0_opensbliblock00Kernel098=%d  -Dxdim1_opensbliblock00Kernel098=%d  -Dydim1_opensbliblock00Kernel098=%d  -Dxdim2_opensbliblock00Kernel098=%d  -Dydim2_opensbliblock00Kernel098=%d  -Dxdim3_opensbliblock00Kernel098=%d  -Dydim3_opensbliblock00Kernel098=%d  -Dxdim4_opensbliblock00Kernel098=%d  -Dydim4_opensbliblock00Kernel098=%d  -Dxdim5_opensbliblock00Kernel098=%d  -Dydim5_opensbliblock00Kernel098=%d  -Dxdim6_opensbliblock00Kernel098=%d  -Dydim6_opensbliblock00Kernel098=%d  -Dxdim7_opensbliblock00Kernel098=%d  -Dydim7_opensbliblock00Kernel098=%d  -Dxdim8_opensbliblock00Kernel098=%d  -Dydim8_opensbliblock00Kernel098=%d  -Dxdim9_opensbliblock00Kernel098=%d  -Dydim9_opensbliblock00Kernel098=%d ", pPath, 32,xdim0,ydim0,xdim1,ydim1,xdim2,ydim2,xdim3,ydim3,xdim4,ydim4,xdim5,ydim5,xdim6,ydim6,xdim7,ydim7,xdim8,ydim8,xdim9,ydim9);
            else
          ...
          instance->ostream() << "compiling opensbliblock00Kernel098 -- done\n";

        // Create the OpenCL kernel
        instance->opencl_instance->OPS_opencl_core.kernel[3] = clCreateKernel(instance->opencl_instance->OPS_opencl_core.program, "ops_opensbliblock00Kernel098", &ret);
        clSafeCall( ret );

        isbuilt_opensbliblock00Kernel098 = true;
        free(source_str[0]);
      }
...
void ops_par_loop_opensbliblock00Kernel098(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg8, ops_arg arg9) {
  ...
  buildOpenCLKernels_opensbliblock00Kernel098(block->instance,
  ...
  if (globalWorkSize[0]>0 && globalWorkSize[1]>0 && globalWorkSize[2]>0) {
    ...
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[3], 5, sizeof(cl_mem), (void*) &arg5.data_d ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[3], 6, sizeof(cl_mem), (void*) &arg6.data_d ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[3], 7, sizeof(cl_mem), (void*) &arg7.data_d ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[3], 8, sizeof(cl_mem), (void*) &arg8.data_d ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[3], 9, sizeof(cl_mem), (void*) &arg9.data_d ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[3], 10, sizeof(cl_int), (void*) &base0 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[3], 11, sizeof(cl_int), (void*) &base1 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[3], 12, sizeof(cl_int), (void*) &base2 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[3], 13, sizeof(cl_int), (void*) &base3 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[3], 14, sizeof(cl_int), (void*) &base4 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[3], 15, sizeof(cl_int), (void*) &base5 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[3], 16, sizeof(cl_int), (void*) &base6 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[3], 17, sizeof(cl_int), (void*) &base7 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[3], 18, sizeof(cl_int), (void*) &base8 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[3], 19, sizeof(cl_int), (void*) &base9 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[3], 20, sizeof(cl_int), (void*) &x_size ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[3], 21, sizeof(cl_int), (void*) &y_size ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[3], 22, sizeof(cl_int), (void*) &z_size ));
