...
//
    ...
    void buildOpenCLKernels_opensbliblock00Kernel026(OPS_instance *instance, int xdim0, int ydim0, int xdim1, int ydim1, int xdim2, int ydim2, int xdim3, int ydim3, int xdim4, int ydim4, int xdim5, int ydim5, int xdim6, int ydim6, int xdim7, int ydim7, int xdim8, int ydim8, int xdim9, int ydim9, int xdim10, int ydim10, int xdim11, int ydim11, int xdim12, int ydim12, int xdim13, int ydim13, int xdim14, int ydim14, int xdim15, int ydim15, int xdim16, int ydim16, int xdim17, int ydim17, int xdim18, int ydim18, int xdim19, int ydim19, int xdim20, int ydim20) {
      ...
      if(!isbuilt_opensbliblock00Kernel026) {
        ...
        instance->ostream() <<"Compiling opensbliblock00Kernel026 "<<OCL_FMA<<" source -- start \n";
          ...
          if (pPath!=NULL)
            if(OCL_FMA)
              sprintf(buildOpts,"-cl-mad-enable -DOCL_FMA -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_opensbliblock00Kernel026=%d  -Dydim0_opensbliblock00Kernel026=%d  -Dxdim1_opensbliblock00Kernel026=%d  -Dydim1_opensbliblock00Kernel026=%d  -Dxdim2_opensbliblock00Kernel026=%d  -Dydim2_opensbliblock00Kernel026=%d  -Dxdim3_opensbliblock00Kernel026=%d  -Dydim3_opensbliblock00Kernel026=%d  -Dxdim4_opensbliblock00Kernel026=%d  -Dydim4_opensbliblock00Kernel026=%d  -Dxdim5_opensbliblock00Kernel026=%d  -Dydim5_opensbliblock00Kernel026=%d  -Dxdim6_opensbliblock00Kernel026=%d  -Dydim6_opensbliblock00Kernel026=%d  -Dxdim7_opensbliblock00Kernel026=%d  -Dydim7_opensbliblock00Kernel026=%d  -Dxdim8_opensbliblock00Kernel026=%d  -Dydim8_opensbliblock00Kernel026=%d  -Dxdim9_opensbliblock00Kernel026=%d  -Dydim9_opensbliblock00Kernel026=%d  -Dxdim10_opensbliblock00Kernel026=%d  -Dydim10_opensbliblock00Kernel026=%d  -Dxdim11_opensbliblock00Kernel026=%d  -Dydim11_opensbliblock00Kernel026=%d  -Dxdim12_opensbliblock00Kernel026=%d  -Dydim12_opensbliblock00Kernel026=%d  -Dxdim13_opensbliblock00Kernel026=%d  -Dydim13_opensbliblock00Kernel026=%d  -Dxdim14_opensbliblock00Kernel026=%d  -Dydim14_opensbliblock00Kernel026=%d  -Dxdim15_opensbliblock00Kernel026=%d  -Dydim15_opensbliblock00Kernel026=%d  -Dxdim16_opensbliblock00Kernel026=%d  -Dydim16_opensbliblock00Kernel026=%d  -Dxdim17_opensbliblock00Kernel026=%d  -Dydim17_opensbliblock00Kernel026=%d  -Dxdim18_opensbliblock00Kernel026=%d  -Dydim18_opensbliblock00Kernel026=%d  -Dxdim19_opensbliblock00Kernel026=%d  -Dydim19_opensbliblock00Kernel026=%d  -Dxdim20_opensbliblock00Kernel026=%d  -Dydim20_opensbliblock00Kernel026=%d ", pPath, 32,xdim0,ydim0,xdim1,ydim1,xdim2,ydim2,xdim3,ydim3,xdim4,ydim4,xdim5,ydim5,xdim6,ydim6,xdim7,ydim7,xdim8,ydim8,xdim9,ydim9,xdim10,ydim10,xdim11,ydim11,xdim12,ydim12,xdim13,ydim13,xdim14,ydim14,xdim15,ydim15,xdim16,ydim16,xdim17,ydim17,xdim18,ydim18,xdim19,ydim19,xdim20,ydim20);
            else
          ...
          instance->ostream() << "compiling opensbliblock00Kernel026 -- done\n";

        // Create the OpenCL kernel
        instance->opencl_instance->OPS_opencl_core.kernel[24] = clCreateKernel(instance->opencl_instance->OPS_opencl_core.program, "ops_opensbliblock00Kernel026", &ret);
        clSafeCall( ret );

        isbuilt_opensbliblock00Kernel026 = true;
        free(source_str[0]);
      }
...
void ops_par_loop_opensbliblock00Kernel026(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg20) {
  ...
  buildOpenCLKernels_opensbliblock00Kernel026(block->instance,
