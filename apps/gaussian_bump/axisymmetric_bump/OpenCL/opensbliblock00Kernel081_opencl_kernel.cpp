...
//
    ...
    void buildOpenCLKernels_opensbliblock00Kernel081(OPS_instance *instance, int xdim0, int ydim0, int xdim1, int ydim1, int xdim2, int ydim2, int xdim3, int ydim3, int xdim4, int ydim4, int xdim5, int ydim5, int xdim6, int ydim6, int xdim7, int ydim7, int xdim8, int ydim8, int xdim9, int ydim9, int xdim10, int ydim10, int xdim11, int ydim11, int xdim12, int ydim12, int xdim13, int ydim13, int xdim14, int ydim14, int xdim15, int ydim15, int xdim16, int ydim16, int xdim17, int ydim17, int xdim18, int ydim18, int xdim19, int ydim19, int xdim20, int ydim20, int xdim21, int ydim21, int xdim22, int ydim22, int xdim23, int ydim23, int xdim24, int ydim24, int xdim25, int ydim25, int xdim26, int ydim26, int xdim27, int ydim27, int xdim28, int ydim28, int xdim29, int ydim29, int xdim30, int ydim30, int xdim31, int ydim31, int xdim32, int ydim32, int xdim33, int ydim33, int xdim34, int ydim34, int xdim35, int ydim35, int xdim36, int ydim36, int xdim37, int ydim37, int xdim38, int ydim38, int xdim39, int ydim39, int xdim40, int ydim40, int xdim41, int ydim41, int xdim42, int ydim42, int xdim43, int ydim43, int xdim44, int ydim44, int xdim45, int ydim45, int xdim46, int ydim46, int xdim47, int ydim47, int xdim48, int ydim48, int xdim49, int ydim49, int xdim50, int ydim50, int xdim51, int ydim51, int xdim52, int ydim52, int xdim53, int ydim53, int xdim54, int ydim54, int xdim55, int ydim55, int xdim56, int ydim56) {
      ...
      if(!isbuilt_opensbliblock00Kernel081) {
        ...
        instance->opencl_instance->OPS_opencl_core.kernel[37] = clCreateKernel(instance->opencl_instance->OPS_opencl_core.program, "ops_opensbliblock00Kernel081", &ret);
        clSafeCall( ret );
...
void ops_par_loop_opensbliblock00Kernel081(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg56, ops_arg arg57) {
  ...
  base52 = base52 + args[52].dat->size[0] *1*
  (start[1] * args[52].stencil->stride[1] - args[52].dat->base[1] - d_m[1]);
  base52 = base52 + args[52].dat->size[0] *1*  args[52].dat->size[1] *1*
  (start[2] * args[52].stencil->stride[2] - args[52].dat->base[2] - d_m[2]);
  ...
  base53 = base53 + args[53].dat->size[0] *1*
  (start[1] * args[53].stencil->stride[1] - args[53].dat->base[1] - d_m[1]);
  base53 = base53 + args[53].dat->size[0] *1*  args[53].dat->size[1] *1*
  (start[2] * args[53].stencil->stride[2] - args[53].dat->base[2] - d_m[2]);
  ...
  base54 = base54 + args[54].dat->size[0] *1*
  (start[1] * args[54].stencil->stride[1] - args[54].dat->base[1] - d_m[1]);
  base54 = base54 + args[54].dat->size[0] *1*  args[54].dat->size[1] *1*
  (start[2] * args[54].stencil->stride[2] - args[54].dat->base[2] - d_m[2]);

  #ifdef OPS_MPI
  for (int d = 0; d < dim; d++) d_m[d] = args[55].dat->d_m[d] + OPS_sub_dat_list[args[55].dat->index]->d_im[d];
  #else
  for (int d = 0; d < dim; d++) d_m[d] = args[55].dat->d_m[d];
  #endif
  int base55 = 1 *1*
  (start[0] * args[55].stencil->stride[0] - args[55].dat->base[0] - d_m[0]);
  base55 = base55 + args[55].dat->size[0] *1*
  (start[1] * args[55].stencil->stride[1] - args[55].dat->base[1] - d_m[1]);
  base55 = base55 + args[55].dat->size[0] *1*  args[55].dat->size[1] *1*
  (start[2] * args[55].stencil->stride[2] - args[55].dat->base[2] - d_m[2]);

  #ifdef OPS_MPI
  for (int d = 0; d < dim; d++) d_m[d] = args[56].dat->d_m[d] + OPS_sub_dat_list[args[56].dat->index]->d_im[d];
  #else
  for (int d = 0; d < dim; d++) d_m[d] = args[56].dat->d_m[d];
  #endif
  int base56 = 1 *1*
  (start[0] * args[56].stencil->stride[0] - args[56].dat->base[0] - d_m[0]);
  base56 = base56 + args[56].dat->size[0] *1*
  (start[1] * args[56].stencil->stride[1] - args[56].dat->base[1] - d_m[1]);
  base56 = base56 + args[56].dat->size[0] *1*  args[56].dat->size[1] *1*
  (start[2] * args[56].stencil->stride[2] - args[56].dat->base[2] - d_m[2]);
  ...
  if (globalWorkSize[0]>0 && globalWorkSize[1]>0 && globalWorkSize[2]>0) {
    ...
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 33, sizeof(cl_mem), (void*) &arg33.data_d ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 34, sizeof(cl_mem), (void*) &arg34.data_d ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 35, sizeof(cl_mem), (void*) &arg35.data_d ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 36, sizeof(cl_mem), (void*) &arg36.data_d ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 37, sizeof(cl_mem), (void*) &arg37.data_d ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 38, sizeof(cl_mem), (void*) &arg38.data_d ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 39, sizeof(cl_mem), (void*) &arg39.data_d ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 40, sizeof(cl_mem), (void*) &arg40.data_d ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 41, sizeof(cl_mem), (void*) &arg41.data_d ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 42, sizeof(cl_mem), (void*) &arg42.data_d ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 43, sizeof(cl_mem), (void*) &arg43.data_d ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 44, sizeof(cl_mem), (void*) &arg44.data_d ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 45, sizeof(cl_mem), (void*) &arg45.data_d ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 46, sizeof(cl_mem), (void*) &arg46.data_d ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 47, sizeof(cl_mem), (void*) &arg47.data_d ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 48, sizeof(cl_mem), (void*) &arg48.data_d ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 49, sizeof(cl_mem), (void*) &arg49.data_d ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 50, sizeof(cl_mem), (void*) &arg50.data_d ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 51, sizeof(cl_mem), (void*) &arg51.data_d ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 52, sizeof(cl_mem), (void*) &arg52.data_d ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 53, sizeof(cl_mem), (void*) &arg53.data_d ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 54, sizeof(cl_mem), (void*) &arg54.data_d ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 55, sizeof(cl_mem), (void*) &arg55.data_d ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 56, sizeof(cl_mem), (void*) &arg56.data_d ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 57, sizeof(cl_int), (void*) &block0np0 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 58, sizeof(cl_double), (void*) &inv2Delta0block0 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 59, sizeof(cl_double), (void*) &inv2Delta1block0 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 60, sizeof(cl_double), (void*) &inv2Delta2block0 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 61, sizeof(cl_double), (void*) &inv2Minf ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 62, sizeof(cl_double), (void*) &invDelta0block0 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 63, sizeof(cl_double), (void*) &invDelta1block0 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 64, sizeof(cl_double), (void*) &invDelta2block0 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 65, sizeof(cl_double), (void*) &invPr ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 66, sizeof(cl_double), (void*) &invRe ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 67, sizeof(cl_double), (void*) &inv_gamma_m1 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 68, sizeof(cl_int), (void*) &base0 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 69, sizeof(cl_int), (void*) &base1 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 70, sizeof(cl_int), (void*) &base2 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 71, sizeof(cl_int), (void*) &base3 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 72, sizeof(cl_int), (void*) &base4 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 73, sizeof(cl_int), (void*) &base5 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 74, sizeof(cl_int), (void*) &base6 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 75, sizeof(cl_int), (void*) &base7 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 76, sizeof(cl_int), (void*) &base8 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 77, sizeof(cl_int), (void*) &base9 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 78, sizeof(cl_int), (void*) &base10 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 79, sizeof(cl_int), (void*) &base11 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 80, sizeof(cl_int), (void*) &base12 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 81, sizeof(cl_int), (void*) &base13 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 82, sizeof(cl_int), (void*) &base14 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 83, sizeof(cl_int), (void*) &base15 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 84, sizeof(cl_int), (void*) &base16 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 85, sizeof(cl_int), (void*) &base17 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 86, sizeof(cl_int), (void*) &base18 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 87, sizeof(cl_int), (void*) &base19 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 88, sizeof(cl_int), (void*) &base20 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 89, sizeof(cl_int), (void*) &base21 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 90, sizeof(cl_int), (void*) &base22 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 91, sizeof(cl_int), (void*) &base23 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 92, sizeof(cl_int), (void*) &base24 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 93, sizeof(cl_int), (void*) &base25 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 94, sizeof(cl_int), (void*) &base26 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 95, sizeof(cl_int), (void*) &base27 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 96, sizeof(cl_int), (void*) &base28 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 97, sizeof(cl_int), (void*) &base29 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 98, sizeof(cl_int), (void*) &base30 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 99, sizeof(cl_int), (void*) &base31 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 100, sizeof(cl_int), (void*) &base32 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 101, sizeof(cl_int), (void*) &base33 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 102, sizeof(cl_int), (void*) &base34 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 103, sizeof(cl_int), (void*) &base35 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 104, sizeof(cl_int), (void*) &base36 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 105, sizeof(cl_int), (void*) &base37 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 106, sizeof(cl_int), (void*) &base38 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 107, sizeof(cl_int), (void*) &base39 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 108, sizeof(cl_int), (void*) &base40 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 109, sizeof(cl_int), (void*) &base41 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 110, sizeof(cl_int), (void*) &base42 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 111, sizeof(cl_int), (void*) &base43 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 112, sizeof(cl_int), (void*) &base44 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 113, sizeof(cl_int), (void*) &base45 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 114, sizeof(cl_int), (void*) &base46 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 115, sizeof(cl_int), (void*) &base47 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 116, sizeof(cl_int), (void*) &base48 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 117, sizeof(cl_int), (void*) &base49 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 118, sizeof(cl_int), (void*) &base50 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 119, sizeof(cl_int), (void*) &base51 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 120, sizeof(cl_int), (void*) &base52 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 121, sizeof(cl_int), (void*) &base53 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 122, sizeof(cl_int), (void*) &base54 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 123, sizeof(cl_int), (void*) &base55 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 124, sizeof(cl_int), (void*) &base56 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 125, sizeof(cl_int), (void*) &arg_idx[0] ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 126, sizeof(cl_int), (void*) &arg_idx[1] ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 127, sizeof(cl_int), (void*) &arg_idx[2] ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 128, sizeof(cl_int), (void*) &x_size ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 129, sizeof(cl_int), (void*) &y_size ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 130, sizeof(cl_int), (void*) &z_size ));
