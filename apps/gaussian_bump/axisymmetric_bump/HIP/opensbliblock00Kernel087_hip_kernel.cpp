...
//
__constant__ int dims_opensbliblock00Kernel087 [5][2];
static int dims_opensbliblock00Kernel087_h [5][2] = {{0}};
...
int size2 ){
  ...
  arg0 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel087[0][0] + idx_z * 1*1 * dims_opensbliblock00Kernel087[0][0] * dims_opensbliblock00Kernel087[0][1];
  arg1 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel087[1][0] + idx_z * 1*1 * dims_opensbliblock00Kernel087[1][0] * dims_opensbliblock00Kernel087[1][1];
  arg2 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel087[2][0] + idx_z * 1*1 * dims_opensbliblock00Kernel087[2][0] * dims_opensbliblock00Kernel087[2][1];
  arg3 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel087[3][0] + idx_z * 1*1 * dims_opensbliblock00Kernel087[3][0] * dims_opensbliblock00Kernel087[3][1];
  arg4 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel087[4][0] + idx_z * 1*1 * dims_opensbliblock00Kernel087[4][0] * dims_opensbliblock00Kernel087[4][1];
...
void ops_par_loop_opensbliblock00Kernel087_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_opensbliblock00Kernel087_h[0][0] || ydim0 != dims_opensbliblock00Kernel087_h[0][1] || xdim1 != dims_opensbliblock00Kernel087_h[1][0] || ydim1 != dims_opensbliblock00Kernel087_h[1][1] || xdim2 != dims_opensbliblock00Kernel087_h[2][0] || ydim2 != dims_opensbliblock00Kernel087_h[2][1] || xdim3 != dims_opensbliblock00Kernel087_h[3][0] || ydim3 != dims_opensbliblock00Kernel087_h[3][1] || xdim4 != dims_opensbliblock00Kernel087_h[4][0] || ydim4 != dims_opensbliblock00Kernel087_h[4][1]) {
    ...
    hipSafeCall(block->instance->ostream(), hipMemcpyToSymbol( dims_opensbliblock00Kernel087, dims_opensbliblock00Kernel087_h, sizeof(dims_opensbliblock00Kernel087)));
  }
  ...
  if (x_size > 0 && y_size > 0 && z_size > 0)
    ops_opensbliblock00Kernel087<<<grid, tblock >>> ( 
...
void ops_par_loop_opensbliblock00Kernel087(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4) {
  ...
  create_kerneldesc_and_enque(name, args, 5, 8, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel087_execute);
}
#endif
