...
int size, char *dat, char const *name){
  ...
  if (!strcmp(name,"W")) {
    hipSafeCall(instance->ostream(),hipMemcpyToSymbol(HIP_SYMBOL(W), dat, dim*size));
  }
  else
  if (!strcmp(name,"a")) {
  ...
  if (!strcmp(name,"k_0")) {
    hipSafeCall(instance->ostream(),hipMemcpyToSymbol(HIP_SYMBOL(k_0), dat, dim*size));
  }
  else
...
//user kernel files
#include "opensbliblock00Kernel092_hip_kernel.cpp"
#include "opensbliblock00Kernel096_hip_kernel.cpp"
#include "opensbliblock00Kernel097_hip_kernel.cpp"
#include "opensbliblock00Kernel098_hip_kernel.cpp"
#include "opensbliblock00Kernel099_hip_kernel.cpp"
#include "opensbliblock00Kernel100_hip_kernel.cpp"
#include "opensbliblock00Kernel112_hip_kernel.cpp"
...
#include "opensbliblock00Kernel113_hip_kernel.cpp"
