...
void opensbliblock00Kernel034_gpu(const ACC<double> &p_B0,
...
int size2 ){
  ...
  if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
    ...
    ACC<double> argp2(dims_opensbliblock00Kernel034[2][0], dims_opensbliblock00Kernel034[2][1], arg2);
...
void ops_par_loop_opensbliblock00Kernel034_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_opensbliblock00Kernel034_h[0][0] || ydim0 != dims_opensbliblock00Kernel034_h[0][1] || xdim1 != dims_opensbliblock00Kernel034_h[1][0] || ydim1 != dims_opensbliblock00Kernel034_h[1][1] || xdim2 != dims_opensbliblock00Kernel034_h[2][0] || ydim2 != dims_opensbliblock00Kernel034_h[2][1]) {
...
void ops_par_loop_opensbliblock00Kernel034(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  create_kerneldesc_and_enque(name, args, 3, 19, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel034_execute);
}
#endif
