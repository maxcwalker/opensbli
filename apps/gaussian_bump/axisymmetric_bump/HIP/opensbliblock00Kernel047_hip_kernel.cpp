...
//
__constant__ int dims_opensbliblock00Kernel047 [3][2];
static int dims_opensbliblock00Kernel047_h [3][2] = {{0}};

//user function
__device__

void opensbliblock00Kernel047_gpu(const ACC<double> &p_B0,
...
void ops_par_loop_opensbliblock00Kernel047_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_opensbliblock00Kernel047_h[0][0] || ydim0 != dims_opensbliblock00Kernel047_h[0][1] || xdim1 != dims_opensbliblock00Kernel047_h[1][0] || ydim1 != dims_opensbliblock00Kernel047_h[1][1] || xdim2 != dims_opensbliblock00Kernel047_h[2][0] || ydim2 != dims_opensbliblock00Kernel047_h[2][1]) {
...
void ops_par_loop_opensbliblock00Kernel047(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  create_kerneldesc_and_enque(name, args, 3, 19, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel047_execute);
}
#endif
