...
//
__constant__ int dims_opensbliblock00Kernel000 [20][2];
static int dims_opensbliblock00Kernel000_h [20][2] = {{0}};

//user function
__device__

 void opensbliblock00Kernel000_gpu(const ACC<double> &D00_B0,
...
int size2 ){
  ...
  arg19 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel000[19][0] + idx_z * 1*1 * dims_opensbliblock00Kernel000[19][0] * dims_opensbliblock00Kernel000[19][1];
  ...
  if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
    ...
    const ACC<double> argp14(dims_opensbliblock00Kernel000[14][0], dims_opensbliblock00Kernel000[14][1], arg14);
    ...
    ACC<double> argp19(dims_opensbliblock00Kernel000[19][0], dims_opensbliblock00Kernel000[19][1], arg19);
...
void ops_par_loop_opensbliblock00Kernel000_execute(ops_kernel_descriptor *desc) {
  ...
  if (!ops_checkpointing_before(args,20,range,21)) return;
  #endif
  ...
  if (xdim0 != dims_opensbliblock00Kernel000_h[0][0] || ydim0 != dims_opensbliblock00Kernel000_h[0][1] || xdim1 != dims_opensbliblock00Kernel000_h[1][0] || ydim1 != dims_opensbliblock00Kernel000_h[1][1] || xdim2 != dims_opensbliblock00Kernel000_h[2][0] || ydim2 != dims_opensbliblock00Kernel000_h[2][1] || xdim3 != dims_opensbliblock00Kernel000_h[3][0] || ydim3 != dims_opensbliblock00Kernel000_h[3][1] || xdim4 != dims_opensbliblock00Kernel000_h[4][0] || ydim4 != dims_opensbliblock00Kernel000_h[4][1] || xdim5 != dims_opensbliblock00Kernel000_h[5][0] || ydim5 != dims_opensbliblock00Kernel000_h[5][1] || xdim6 != dims_opensbliblock00Kernel000_h[6][0] || ydim6 != dims_opensbliblock00Kernel000_h[6][1] || xdim7 != dims_opensbliblock00Kernel000_h[7][0] || ydim7 != dims_opensbliblock00Kernel000_h[7][1] || xdim8 != dims_opensbliblock00Kernel000_h[8][0] || ydim8 != dims_opensbliblock00Kernel000_h[8][1] || xdim9 != dims_opensbliblock00Kernel000_h[9][0] || ydim9 != dims_opensbliblock00Kernel000_h[9][1] || xdim10 != dims_opensbliblock00Kernel000_h[10][0] || ydim10 != dims_opensbliblock00Kernel000_h[10][1] || xdim11 != dims_opensbliblock00Kernel000_h[11][0] || ydim11 != dims_opensbliblock00Kernel000_h[11][1] || xdim12 != dims_opensbliblock00Kernel000_h[12][0] || ydim12 != dims_opensbliblock00Kernel000_h[12][1] || xdim13 != dims_opensbliblock00Kernel000_h[13][0] || ydim13 != dims_opensbliblock00Kernel000_h[13][1] || xdim14 != dims_opensbliblock00Kernel000_h[14][0] || ydim14 != dims_opensbliblock00Kernel000_h[14][1] || xdim15 != dims_opensbliblock00Kernel000_h[15][0] || ydim15 != dims_opensbliblock00Kernel000_h[15][1] || xdim16 != dims_opensbliblock00Kernel000_h[16][0] || ydim16 != dims_opensbliblock00Kernel000_h[16][1] || xdim17 != dims_opensbliblock00Kernel000_h[17][0] || ydim17 != dims_opensbliblock00Kernel000_h[17][1] || xdim18 != dims_opensbliblock00Kernel000_h[18][0] || ydim18 != dims_opensbliblock00Kernel000_h[18][1] || xdim19 != dims_opensbliblock00Kernel000_h[19][0] || ydim19 != dims_opensbliblock00Kernel000_h[19][1]) {
    ...
    dims_opensbliblock00Kernel000_h[19][0] = xdim19;
    dims_opensbliblock00Kernel000_h[19][1] = ydim19;
  ...
  if (block->instance->OPS_diags > 1) {
    ...
    block->instance->OPS_kernels[21].transfer += ops_compute_transfer(dim, start, end, &arg19);
  }
}
...
void ops_par_loop_opensbliblock00Kernel000(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg16, ops_arg arg17, ops_arg arg18, ops_arg arg19) {
  ...
  create_kerneldesc_and_enque(name, args, 20, 21, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel000_execute);
}
#endif
