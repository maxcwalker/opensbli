...
void opensbliblock00Kernel071_gpu(const ACC<double> &T_B0,
  ACC<double> &wk11_B0)
{
...
void ops_par_loop_opensbliblock00Kernel071(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1) {
  ...
  create_kerneldesc_and_enque(name, args, 2, 36, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel071_execute);
}
#endif
