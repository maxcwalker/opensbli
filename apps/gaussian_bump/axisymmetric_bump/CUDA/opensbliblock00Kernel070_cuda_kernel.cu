...
void opensbliblock00Kernel070_gpu(const ACC<double> &u2_B0,
  ACC<double> &wk10_B0)
{
...
void ops_par_loop_opensbliblock00Kernel070(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1) {
  ...
  create_kerneldesc_and_enque(name, args, 2, 35, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel070_execute);
}
#endif
