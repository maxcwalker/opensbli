...
//
__constant__ int dims_opensbliblock00Kernel025 [7][2];
static int dims_opensbliblock00Kernel025_h [7][2] = {{0}};

//user function
__device__

 void opensbliblock00Kernel025_gpu(const ACC<double> &D20_B0,
...
int size2 ){
  ...
  if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
    ...
    ACC<double> argp6(dims_opensbliblock00Kernel025[6][0], dims_opensbliblock00Kernel025[6][1], arg6);
...
void ops_par_loop_opensbliblock00Kernel025(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4, ops_arg arg5, ops_arg arg6) {
  ...
  create_kerneldesc_and_enque(name, args, 7, 17, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel025_execute);
}
#endif
