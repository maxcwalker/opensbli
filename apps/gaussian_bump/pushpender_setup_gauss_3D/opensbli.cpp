...
if (restart == 0){
int iteration_range_68_block0[] = {-5, block0np0 + 5, -5, block0np1 + 5, -5, block0np2 + 5};
ops_par_loop(opensbliblock00Kernel068, "Similiarity solution laminar boundary-layer initialisation0", opensbliblock00, 3, iteration_range_68_block0,
...
ops_par_loop(opensbliblock00Kernel071, "MetricsEquation evaluation", opensbliblock00, 3, iteration_range_71_block0,
...
int iteration_range_72_block0[] = {0, 1, -3, block0np1 + 4, -3, block0np2 + 4};
ops_par_loop(opensbliblock00Kernel072, "Metric_copy_block0 boundary dir0 side0", opensbliblock00, 3, iteration_range_72_block0,
...
int iteration_range_73_block0[] = {block0np0 - 1, block0np0, -3, block0np1 + 4, -3, block0np2 + 4};
ops_par_loop(opensbliblock00Kernel073, "Metric_copy_block0 boundary dir0 side1", opensbliblock00, 3, iteration_range_73_block0,
ops_arg_dat(D00_B0, 1, stencil_0_44_00_00_16, "double", OPS_RW),
ops_arg_dat(D01_B0, 1, stencil_0_44_00_00_16, "double", OPS_RW),
ops_arg_dat(D10_B0, 1, stencil_0_44_00_00_16, "double", OPS_RW),
ops_arg_dat(D11_B0, 1, stencil_0_44_00_00_16, "double", OPS_RW),
...
int iteration_range_74_block0[] = {-3, block0np0 + 4, 0, 1, -3, block0np2 + 4};
ops_par_loop(opensbliblock00Kernel074, "Metric_copy_block0 boundary dir1 side0", opensbliblock00, 3, iteration_range_74_block0,
...
int iteration_range_75_block0[] = {-3, block0np0 + 4, block0np1 - 1, block0np1, -3, block0np2 + 4};
ops_par_loop(opensbliblock00Kernel075, "Metric_copy_block0 boundary dir1 side1", opensbliblock00, 3, iteration_range_75_block0,
ops_arg_dat(D00_B0, 1, stencil_0_00_44_00_16, "double", OPS_RW),
ops_arg_dat(D01_B0, 1, stencil_0_00_44_00_16, "double", OPS_RW),
ops_arg_dat(D10_B0, 1, stencil_0_00_44_00_16, "double", OPS_RW),
ops_arg_dat(D11_B0, 1, stencil_0_00_44_00_16, "double", OPS_RW),
...
ops_halo_transfer(periodicBC_direction2_side0_76_block0);
ops_halo_transfer(periodicBC_direction2_side1_77_block0);
int iteration_range_82_block0[] = {0, block0np0, 0, block0np1, 0, block0np2};
ops_par_loop(opensbliblock00Kernel082, "MetricsEquation evaluation", opensbliblock00, 3, iteration_range_82_block0,
...
int iteration_range_62_block0[] = {0, 1, -3, block0np1 + 4, -3, block0np2 + 4};
ops_par_loop(opensbliblock00Kernel062, "InletTransfer boundary dir0 side0", opensbliblock00, 3, iteration_range_62_block0,
...
int iteration_range_63_block0[] = {block0np0 - 1, block0np0, -3, block0np1 + 4, -3, block0np2 + 4};
ops_par_loop(opensbliblock00Kernel063, "Extrapolation boundary dir0 side1", opensbliblock00, 3, iteration_range_63_block0,
...
int iteration_range_64_block0[] = {-3, block0np0 + 4, 0, 1, -3, block0np2 + 4};
ops_par_loop(opensbliblock00Kernel064, "ForcingStripWall boundary dir1 side0", opensbliblock00, 3, iteration_range_64_block0,
...
int iteration_range_65_block0[] = {-3, block0np0 + 4, block0np1 - 1, block0np1, -3, block0np2 + 4};
ops_par_loop(opensbliblock00Kernel065, "ZeroGradientOutlet boundary dir1 side1", opensbliblock00, 3, iteration_range_65_block0,
...
ops_halo_transfer(periodicBC_direction2_side0_66_block0);
ops_halo_transfer(periodicBC_direction2_side1_67_block0);
...
int iteration_range_6_block0[] = {-3, block0np0 + 4, 0, block0np1, 0, block0np2};
...
int iteration_range_20_block0[] = {0, block0np0, -3, block0np1 + 4, 0, block0np2};
ops_par_loop(opensbliblock00Kernel020, "CRU1", opensbliblock00, 3, iteration_range_20_block0,
...
int iteration_range_21_block0[] = {0, block0np0, 0, block0np1, -3, block0np2 + 4};
ops_par_loop(opensbliblock00Kernel021, "CRU2", opensbliblock00, 3, iteration_range_21_block0,
ops_arg_dat(u2_B0, 1, stencil_0_00_00_00_3, "double", OPS_READ),
ops_arg_dat(U2_B0, 1, stencil_0_00_00_00_3, "double", OPS_WRITE));
...
ops_arg_dat(kappa_B0, 1, stencil_0_00_00_00_3, "double", OPS_READ),
...
ops_arg_dat(TENO_B0, 1, stencil_0_00_00_00_3, "double", OPS_WRITE),
ops_arg_dat(wk0_B0, 1, stencil_0_00_00_00_3, "double", OPS_WRITE),
ops_arg_dat(wk1_B0, 1, stencil_0_00_00_00_3, "double", OPS_WRITE),
...
ops_par_loop(opensbliblock00Kernel022, "LFTeno Residual", opensbliblock00, 3, iteration_range_22_block0,
...
int iteration_range_33_block0[] = {0, block0np0, -2, block0np1 + 2, -2, block0np2 + 2};
ops_par_loop(opensbliblock00Kernel033, "Derivative evaluation CD u0_B0 xi0 ", opensbliblock00, 3, iteration_range_33_block0,
...
ops_par_loop(opensbliblock00Kernel035, "Derivative evaluation CD u1_B0 xi0 ", opensbliblock00, 3, iteration_range_35_block0,
ops_arg_dat(u1_B0, 1, stencil_0_44_00_00_19, "double", OPS_READ),
ops_arg_dat(wk1_B0, 1, stencil_0_00_00_00_3, "double", OPS_WRITE),
ops_arg_idx());

int iteration_range_37_block0[] = {0, block0np0, -2, block0np1 + 2, -2, block0np2 + 2};
ops_par_loop(opensbliblock00Kernel037, "Derivative evaluation CD u2_B0 xi0 ", opensbliblock00, 3, iteration_range_37_block0,
ops_arg_dat(u2_B0, 1, stencil_0_44_00_00_19, "double", OPS_READ),
ops_arg_dat(wk2_B0, 1, stencil_0_00_00_00_3, "double", OPS_WRITE),
ops_arg_idx());

int iteration_range_39_block0[] = {0, block0np0, -2, block0np1 + 2, 0, block0np2};
ops_par_loop(opensbliblock00Kernel039, "Derivative evaluation CD T_B0 xi0 ", opensbliblock00, 3, iteration_range_39_block0,
...
ops_par_loop(opensbliblock00Kernel041, "Derivative evaluation CD u0_B0 xi1 ", opensbliblock00, 3, iteration_range_41_block0,
...
ops_par_loop(opensbliblock00Kernel042, "Derivative evaluation CD u1_B0 xi1 ", opensbliblock00, 3, iteration_range_42_block0,
ops_arg_dat(u1_B0, 1, stencil_0_00_24_00_15, "double", OPS_READ),
ops_arg_dat(wk5_B0, 1, stencil_0_00_00_00_3, "double", OPS_WRITE),
ops_arg_idx());

int iteration_range_43_block0[] = {0, block0np0, 0, block0np1, -2, block0np2 + 2};
ops_par_loop(opensbliblock00Kernel043, "Derivative evaluation CD u2_B0 xi1 ", opensbliblock00, 3, iteration_range_43_block0,
...
ops_par_loop(opensbliblock00Kernel045, "Derivative evaluation CD u0_B0 xi2 ", opensbliblock00, 3, iteration_range_45_block0,
...
ops_par_loop(opensbliblock00Kernel046, "Derivative evaluation CD u1_B0 xi2 ", opensbliblock00, 3, iteration_range_46_block0,
...
ops_par_loop(opensbliblock00Kernel047, "Derivative evaluation CD u2_B0 xi2 ", opensbliblock00, 3, iteration_range_47_block0,
...
ops_par_loop(opensbliblock00Kernel048, "Derivative evaluation CD T_B0 xi2 ", opensbliblock00, 3, iteration_range_48_block0,
ops_arg_dat(T_B0, 1, stencil_0_00_00_22_8, "double", OPS_READ),
ops_arg_dat(wk11_B0, 1, stencil_0_00_00_00_3, "double", OPS_WRITE));

int iteration_range_57_block0[] = {0, block0np0, 0, block0np1, 0, block0np2};
ops_par_loop(opensbliblock00Kernel057, "Viscous terms", opensbliblock00, 3, iteration_range_57_block0,
ops_arg_dat(D00_B0, 1, stencil_0_00_00_00_3, "double", OPS_READ),
ops_arg_dat(D01_B0, 1, stencil_0_00_00_00_3, "double", OPS_READ),
ops_arg_dat(D10_B0, 1, stencil_0_00_00_00_3, "double", OPS_READ),
ops_arg_dat(D11_B0, 1, stencil_0_00_00_00_3, "double", OPS_READ),
...
ops_par_loop(opensbliblock00Kernel083, "Temporal solution advancement", opensbliblock00, 3, iteration_range_83_block0,
