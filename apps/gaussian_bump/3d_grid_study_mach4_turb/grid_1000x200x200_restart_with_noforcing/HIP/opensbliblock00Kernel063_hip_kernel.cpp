...
__device__
 ...
 void opensbliblock00Kernel063_gpu(const int *iter,
...
int size2 ){
  ...
  if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
    ...
    opensbliblock00Kernel063_gpu(&arg0, argp1, argp2, argp3,
...
void ops_par_loop_opensbliblock00Kernel063_execute(ops_kernel_descriptor *desc) {
  ...
  if (x_size > 0 && y_size > 0 && z_size > 0)
    hipLaunchKernelGGL(ops_opensbliblock00Kernel063,grid ,tblock ,0 ,0 , *(int *)arg0.data, (double *)p_a[1],
