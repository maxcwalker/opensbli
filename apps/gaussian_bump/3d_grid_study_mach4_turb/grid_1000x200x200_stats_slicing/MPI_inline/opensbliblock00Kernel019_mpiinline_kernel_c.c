  ...
  for ( int n_z=0; n_z<z_size; n_z++ ){
    for ( int n_y=0; n_y<y_size; n_y++ ){
      for ( int n_x=0; n_x<x_size; n_x++ ){
        ...
        ptr_double U1_B0 = { U1_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel019*1 + n_z * xdim4_opensbliblock00Kernel019 * ydim4_opensbliblock00Kernel019*1, xdim4_opensbliblock00Kernel019, ydim4_opensbliblock00Kernel019};
