...
ops_write_const_hdf5("H", 1, "double", (char*)&H, filename);
ops_write_const_hdf5("HDF5_timing", 1, "int", (char*)&HDF5_timing, filename);
ops_write_const_hdf5("L", 1, "double", (char*)&L, filename);
...
ops_write_const_hdf5("TENO_CT", 1, "double", (char*)&TENO_CT, filename);
ops_write_const_hdf5("Twall", 1, "double", (char*)&Twall, filename);
ops_write_const_hdf5("a", 1, "double", (char*)&a, filename);
...
ops_write_const_hdf5("eps", 1, "double", (char*)&eps, filename);
...
void HDF5_IO_Write_1_opensbliblock00(ops_block& opensbliblock00, ops_dat& rhomean_B0, ops_dat& rhou0mean_B0, ops_dat& rhou1mean_B0, ops_dat& rhou2mean_B0, ops_dat& E_mean_B0, ops_dat& rhou0u0mean_B0, ops_dat& rhou0u1mean_B0, ops_dat& rhou1u1mean_B0, ops_dat& rhou0u2mean_B0, ops_dat& rhou1u2mean_B0, ops_dat& rhou2u2mean_B0, int HDF5_timing){
double cpu_start0, elapsed_start0;
if (HDF5_timing == 1){
ops_timers(&cpu_start0, &elapsed_start0);
}
