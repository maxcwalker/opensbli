  ...
  for ( int n_z=start[2]; n_z<end[2]; n_z++ ){
    for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
      ...
      for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
        const ACC<double> D00_B0(xdim0_opensbliblock00Kernel005, ydim0_opensbliblock00Kernel005, D00_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel005*1 + n_z * xdim0_opensbliblock00Kernel005 * ydim0_opensbliblock00Kernel005*1);
        const ACC<double> D01_B0(xdim1_opensbliblock00Kernel005, ydim1_opensbliblock00Kernel005, D01_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel005*1 + n_z * xdim1_opensbliblock00Kernel005 * ydim1_opensbliblock00Kernel005*1);
        ...
        ACC<double> U0_B0(xdim4_opensbliblock00Kernel005, ydim4_opensbliblock00Kernel005, U0_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel005*1 + n_z * xdim4_opensbliblock00Kernel005 * ydim4_opensbliblock00Kernel005*1);
...
void ops_par_loop_opensbliblock00Kernel005(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4) {
  ...
  create_kerneldesc_and_enque(name, args, 5, 14, dim, 0, range, block, ops_par_loop_opensbliblock00Kernel005_execute);
}
#endif
