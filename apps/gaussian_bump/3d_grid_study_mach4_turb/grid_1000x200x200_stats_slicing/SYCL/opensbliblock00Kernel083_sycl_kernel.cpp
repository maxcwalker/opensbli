...
void ops_par_loop_opensbliblock00Kernel083_execute(ops_kernel_descriptor *desc) {
 ...
 arg10};
  ...
  double* E_mean_B0_p = (double*)args[0].data_d;

  int base1 = args[1].dat->base_offset/sizeof(double);
  double* rhomean_B0_p = (double*)args[1].data_d;

  int base2 = args[2].dat->base_offset/sizeof(double);
  double* rhou0mean_B0_p = (double*)args[2].data_d;

  int base3 = args[3].dat->base_offset/sizeof(double);
  double* rhou0u0mean_B0_p = (double*)args[3].data_d;

  int base4 = args[4].dat->base_offset/sizeof(double);
  double* rhou0u1mean_B0_p = (double*)args[4].data_d;

  int base5 = args[5].dat->base_offset/sizeof(double);
  double* rhou0u2mean_B0_p = (double*)args[5].data_d;

  int base6 = args[6].dat->base_offset/sizeof(double);
  double* rhou1mean_B0_p = (double*)args[6].data_d;

  int base7 = args[7].dat->base_offset/sizeof(double);
  double* rhou1u1mean_B0_p = (double*)args[7].data_d;

  int base8 = args[8].dat->base_offset/sizeof(double);
  double* rhou1u2mean_B0_p = (double*)args[8].data_d;

  int base9 = args[9].dat->base_offset/sizeof(double);
  double* rhou2mean_B0_p = (double*)args[9].data_d;

  int base10 = args[10].dat->base_offset/sizeof(double);
  double* rhou2u2mean_B0_p = (double*)args[10].data_d;
  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0 && (end[2]-start[2])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      , [=](cl::sycl::nd_item<3> item
        ...
        ACC<double> E_mean_B0(xdim0_opensbliblock00Kernel083, ydim0_opensbliblock00Kernel083, &E_mean_B0_p[0] + base0 + n_x*1 + n_y * xdim0_opensbliblock00Kernel083*1 + n_z * xdim0_opensbliblock00Kernel083 * ydim0_opensbliblock00Kernel083*1);
        ACC<double> rhomean_B0(xdim1_opensbliblock00Kernel083, ydim1_opensbliblock00Kernel083, &rhomean_B0_p[0] + base1 + n_x*1 + n_y * xdim1_opensbliblock00Kernel083*1 + n_z * xdim1_opensbliblock00Kernel083 * ydim1_opensbliblock00Kernel083*1);
        ACC<double> rhou0mean_B0(xdim2_opensbliblock00Kernel083, ydim2_opensbliblock00Kernel083, &rhou0mean_B0_p[0] + base2 + n_x*1 + n_y * xdim2_opensbliblock00Kernel083*1 + n_z * xdim2_opensbliblock00Kernel083 * ydim2_opensbliblock00Kernel083*1);
        ACC<double> rhou0u0mean_B0(xdim3_opensbliblock00Kernel083, ydim3_opensbliblock00Kernel083, &rhou0u0mean_B0_p[0] + base3 + n_x*1 + n_y * xdim3_opensbliblock00Kernel083*1 + n_z * xdim3_opensbliblock00Kernel083 * ydim3_opensbliblock00Kernel083*1);
        ACC<double> rhou0u1mean_B0(xdim4_opensbliblock00Kernel083, ydim4_opensbliblock00Kernel083, &rhou0u1mean_B0_p[0] + base4 + n_x*1 + n_y * xdim4_opensbliblock00Kernel083*1 + n_z * xdim4_opensbliblock00Kernel083 * ydim4_opensbliblock00Kernel083*1);
        ACC<double> rhou0u2mean_B0(xdim5_opensbliblock00Kernel083, ydim5_opensbliblock00Kernel083, &rhou0u2mean_B0_p[0] + base5 + n_x*1 + n_y * xdim5_opensbliblock00Kernel083*1 + n_z * xdim5_opensbliblock00Kernel083 * ydim5_opensbliblock00Kernel083*1);
        ACC<double> rhou1mean_B0(xdim6_opensbliblock00Kernel083, ydim6_opensbliblock00Kernel083, &rhou1mean_B0_p[0] + base6 + n_x*1 + n_y * xdim6_opensbliblock00Kernel083*1 + n_z * xdim6_opensbliblock00Kernel083 * ydim6_opensbliblock00Kernel083*1);
        ACC<double> rhou1u1mean_B0(xdim7_opensbliblock00Kernel083, ydim7_opensbliblock00Kernel083, &rhou1u1mean_B0_p[0] + base7 + n_x*1 + n_y * xdim7_opensbliblock00Kernel083*1 + n_z * xdim7_opensbliblock00Kernel083 * ydim7_opensbliblock00Kernel083*1);
        ACC<double> rhou1u2mean_B0(xdim8_opensbliblock00Kernel083, ydim8_opensbliblock00Kernel083, &rhou1u2mean_B0_p[0] + base8 + n_x*1 + n_y * xdim8_opensbliblock00Kernel083*1 + n_z * xdim8_opensbliblock00Kernel083 * ydim8_opensbliblock00Kernel083*1);
        ACC<double> rhou2mean_B0(xdim9_opensbliblock00Kernel083, ydim9_opensbliblock00Kernel083, &rhou2mean_B0_p[0] + base9 + n_x*1 + n_y * xdim9_opensbliblock00Kernel083*1 + n_z * xdim9_opensbliblock00Kernel083 * ydim9_opensbliblock00Kernel083*1);
        ACC<double> rhou2u2mean_B0(xdim10_opensbliblock00Kernel083, ydim10_opensbliblock00Kernel083, &rhou2u2mean_B0_p[0] + base10 + n_x*1 + n_y * xdim10_opensbliblock00Kernel083*1 + n_z * xdim10_opensbliblock00Kernel083 * ydim10_opensbliblock00Kernel083*1);
        //USER CODE
