...
void ops_par_loop_opensbliblock00Kernel031_execute(ops_kernel_descriptor *desc) {
  ...
  int ydim0_opensbliblock00Kernel031 = args[0].dat->size[1];
  int xdim1_opensbliblock00Kernel031 = args[1].dat->size[0];
  int ydim1_opensbliblock00Kernel031 = args[1].dat->size[1];
  int xdim2_opensbliblock00Kernel031 = args[2].dat->size[0];
  int ydim2_opensbliblock00Kernel031 = args[2].dat->size[1];
  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0 && (end[2]-start[2])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      cgh.parallel_for<class opensbliblock00Kernel031_kernel>(cl::sycl::nd_range<3>(cl::sycl::range<3>(
      ...
      , [=](cl::sycl::nd_item<3> item
        ...
        const ACC<double> p_B0(xdim0_opensbliblock00Kernel031, ydim0_opensbliblock00Kernel031, &p_B0_p[0] + base0 + n_x*1 + n_y * xdim0_opensbliblock00Kernel031*1 + n_z * xdim0_opensbliblock00Kernel031 * ydim0_opensbliblock00Kernel031*1);
        const ACC<double> rho_B0(xdim1_opensbliblock00Kernel031, ydim1_opensbliblock00Kernel031, &rho_B0_p[0] + base1 + n_x*1 + n_y * xdim1_opensbliblock00Kernel031*1 + n_z * xdim1_opensbliblock00Kernel031 * ydim1_opensbliblock00Kernel031*1);
        ACC<double> T_B0(xdim2_opensbliblock00Kernel031, ydim2_opensbliblock00Kernel031, &T_B0_p[0] + base2 + n_x*1 + n_y * xdim2_opensbliblock00Kernel031*1 + n_z * xdim2_opensbliblock00Kernel031 * ydim2_opensbliblock00Kernel031*1);
        //USER CODE
