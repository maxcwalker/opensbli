  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0 && (end[2]-start[2])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      , [=](cl::sycl::nd_item<3> item
        ...
        const ACC<double> detJ_B0(xdim0_opensbliblock00Kernel021, ydim0_opensbliblock00Kernel021, &detJ_B0_p[0] + base0 + n_x*1 + n_y * xdim0_opensbliblock00Kernel021*1 + n_z * xdim0_opensbliblock00Kernel021 * ydim0_opensbliblock00Kernel021*1);
        const ACC<double> wk0_B0(xdim1_opensbliblock00Kernel021, ydim1_opensbliblock00Kernel021, &wk0_B0_p[0] + base1 + n_x*1 + n_y * xdim1_opensbliblock00Kernel021*1 + n_z * xdim1_opensbliblock00Kernel021 * ydim1_opensbliblock00Kernel021*1);
        const ACC<double> wk10_B0(xdim2_opensbliblock00Kernel021, ydim2_opensbliblock00Kernel021, &wk10_B0_p[0] + base2 + n_x*1 + n_y * xdim2_opensbliblock00Kernel021*1 + n_z * xdim2_opensbliblock00Kernel021 * ydim2_opensbliblock00Kernel021*1);
        const ACC<double> wk11_B0(xdim3_opensbliblock00Kernel021, ydim3_opensbliblock00Kernel021, &wk11_B0_p[0] + base3 + n_x*1 + n_y * xdim3_opensbliblock00Kernel021*1 + n_z * xdim3_opensbliblock00Kernel021 * ydim3_opensbliblock00Kernel021*1);
        const ACC<double> wk12_B0(xdim4_opensbliblock00Kernel021, ydim4_opensbliblock00Kernel021, &wk12_B0_p[0] + base4 + n_x*1 + n_y * xdim4_opensbliblock00Kernel021*1 + n_z * xdim4_opensbliblock00Kernel021 * ydim4_opensbliblock00Kernel021*1);
        const ACC<double> wk13_B0(xdim5_opensbliblock00Kernel021, ydim5_opensbliblock00Kernel021, &wk13_B0_p[0] + base5 + n_x*1 + n_y * xdim5_opensbliblock00Kernel021*1 + n_z * xdim5_opensbliblock00Kernel021 * ydim5_opensbliblock00Kernel021*1);
        const ACC<double> wk14_B0(xdim6_opensbliblock00Kernel021, ydim6_opensbliblock00Kernel021, &wk14_B0_p[0] + base6 + n_x*1 + n_y * xdim6_opensbliblock00Kernel021*1 + n_z * xdim6_opensbliblock00Kernel021 * ydim6_opensbliblock00Kernel021*1);
        const ACC<double> wk1_B0(xdim7_opensbliblock00Kernel021, ydim7_opensbliblock00Kernel021, &wk1_B0_p[0] + base7 + n_x*1 + n_y * xdim7_opensbliblock00Kernel021*1 + n_z * xdim7_opensbliblock00Kernel021 * ydim7_opensbliblock00Kernel021*1);
        const ACC<double> wk2_B0(xdim8_opensbliblock00Kernel021, ydim8_opensbliblock00Kernel021, &wk2_B0_p[0] + base8 + n_x*1 + n_y * xdim8_opensbliblock00Kernel021*1 + n_z * xdim8_opensbliblock00Kernel021 * ydim8_opensbliblock00Kernel021*1);
        const ACC<double> wk3_B0(xdim9_opensbliblock00Kernel021, ydim9_opensbliblock00Kernel021, &wk3_B0_p[0] + base9 + n_x*1 + n_y * xdim9_opensbliblock00Kernel021*1 + n_z * xdim9_opensbliblock00Kernel021 * ydim9_opensbliblock00Kernel021*1);
        const ACC<double> wk4_B0(xdim10_opensbliblock00Kernel021, ydim10_opensbliblock00Kernel021, &wk4_B0_p[0] + base10 + n_x*1 + n_y * xdim10_opensbliblock00Kernel021*1 + n_z * xdim10_opensbliblock00Kernel021 * ydim10_opensbliblock00Kernel021*1);
        const ACC<double> wk5_B0(xdim11_opensbliblock00Kernel021, ydim11_opensbliblock00Kernel021, &wk5_B0_p[0] + base11 + n_x*1 + n_y * xdim11_opensbliblock00Kernel021*1 + n_z * xdim11_opensbliblock00Kernel021 * ydim11_opensbliblock00Kernel021*1);
        const ACC<double> wk6_B0(xdim12_opensbliblock00Kernel021, ydim12_opensbliblock00Kernel021, &wk6_B0_p[0] + base12 + n_x*1 + n_y * xdim12_opensbliblock00Kernel021*1 + n_z * xdim12_opensbliblock00Kernel021 * ydim12_opensbliblock00Kernel021*1);
        const ACC<double> wk7_B0(xdim13_opensbliblock00Kernel021, ydim13_opensbliblock00Kernel021, &wk7_B0_p[0] + base13 + n_x*1 + n_y * xdim13_opensbliblock00Kernel021*1 + n_z * xdim13_opensbliblock00Kernel021 * ydim13_opensbliblock00Kernel021*1);
        const ACC<double> wk8_B0(xdim14_opensbliblock00Kernel021, ydim14_opensbliblock00Kernel021, &wk8_B0_p[0] + base14 + n_x*1 + n_y * xdim14_opensbliblock00Kernel021*1 + n_z * xdim14_opensbliblock00Kernel021 * ydim14_opensbliblock00Kernel021*1);
        const ACC<double> wk9_B0(xdim15_opensbliblock00Kernel021, ydim15_opensbliblock00Kernel021, &wk9_B0_p[0] + base15 + n_x*1 + n_y * xdim15_opensbliblock00Kernel021*1 + n_z * xdim15_opensbliblock00Kernel021 * ydim15_opensbliblock00Kernel021*1);
        ACC<double> Residual0_B0(xdim16_opensbliblock00Kernel021, ydim16_opensbliblock00Kernel021, &Residual0_B0_p[0] + base16 + n_x*1 + n_y * xdim16_opensbliblock00Kernel021*1 + n_z * xdim16_opensbliblock00Kernel021 * ydim16_opensbliblock00Kernel021*1);
        ACC<double> Residual1_B0(xdim17_opensbliblock00Kernel021, ydim17_opensbliblock00Kernel021, &Residual1_B0_p[0] + base17 + n_x*1 + n_y * xdim17_opensbliblock00Kernel021*1 + n_z * xdim17_opensbliblock00Kernel021 * ydim17_opensbliblock00Kernel021*1);
        ACC<double> Residual2_B0(xdim18_opensbliblock00Kernel021, ydim18_opensbliblock00Kernel021, &Residual2_B0_p[0] + base18 + n_x*1 + n_y * xdim18_opensbliblock00Kernel021*1 + n_z * xdim18_opensbliblock00Kernel021 * ydim18_opensbliblock00Kernel021*1);
        ACC<double> Residual3_B0(xdim19_opensbliblock00Kernel021, ydim19_opensbliblock00Kernel021, &Residual3_B0_p[0] + base19 + n_x*1 + n_y * xdim19_opensbliblock00Kernel021*1 + n_z * xdim19_opensbliblock00Kernel021 * ydim19_opensbliblock00Kernel021*1);
        ACC<double> Residual4_B0(xdim20_opensbliblock00Kernel021, ydim20_opensbliblock00Kernel021, &Residual4_B0_p[0] + base20 + n_x*1 + n_y * xdim20_opensbliblock00Kernel021*1 + n_z * xdim20_opensbliblock00Kernel021 * ydim20_opensbliblock00Kernel021*1);
        //USER CODE
