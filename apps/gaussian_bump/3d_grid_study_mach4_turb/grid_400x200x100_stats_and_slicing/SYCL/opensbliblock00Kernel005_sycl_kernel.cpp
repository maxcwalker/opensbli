...
void ops_par_loop_opensbliblock00Kernel005_execute(ops_kernel_descriptor *desc) {
 ...
 arg5};
  ...
  int ydim3_opensbliblock00Kernel005 = args[3].dat->size[1];
  int xdim4_opensbliblock00Kernel005 = args[4].dat->size[0];
  int ydim4_opensbliblock00Kernel005 = args[4].dat->size[1];
  int xdim5_opensbliblock00Kernel005 = args[5].dat->size[0];
  int ydim5_opensbliblock00Kernel005 = args[5].dat->size[1];
  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0 && (end[2]-start[2])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      cgh.parallel_for<class opensbliblock00Kernel005_kernel>(cl::sycl::nd_range<3>(cl::sycl::range<3>(
      ...
      , [=](cl::sycl::nd_item<3> item
        ...
        const ACC<double> rhoE_B0(xdim0_opensbliblock00Kernel005, ydim0_opensbliblock00Kernel005, &rhoE_B0_p[0] + base0 + n_x*1 + n_y * xdim0_opensbliblock00Kernel005*1 + n_z * xdim0_opensbliblock00Kernel005 * ydim0_opensbliblock00Kernel005*1);
        const ACC<double> rho_B0(xdim1_opensbliblock00Kernel005, ydim1_opensbliblock00Kernel005, &rho_B0_p[0] + base1 + n_x*1 + n_y * xdim1_opensbliblock00Kernel005*1 + n_z * xdim1_opensbliblock00Kernel005 * ydim1_opensbliblock00Kernel005*1);
        const ACC<double> u0_B0(xdim2_opensbliblock00Kernel005, ydim2_opensbliblock00Kernel005, &u0_B0_p[0] + base2 + n_x*1 + n_y * xdim2_opensbliblock00Kernel005*1 + n_z * xdim2_opensbliblock00Kernel005 * ydim2_opensbliblock00Kernel005*1);
        const ACC<double> u1_B0(xdim3_opensbliblock00Kernel005, ydim3_opensbliblock00Kernel005, &u1_B0_p[0] + base3 + n_x*1 + n_y * xdim3_opensbliblock00Kernel005*1 + n_z * xdim3_opensbliblock00Kernel005 * ydim3_opensbliblock00Kernel005*1);
        const ACC<double> u2_B0(xdim4_opensbliblock00Kernel005, ydim4_opensbliblock00Kernel005, &u2_B0_p[0] + base4 + n_x*1 + n_y * xdim4_opensbliblock00Kernel005*1 + n_z * xdim4_opensbliblock00Kernel005 * ydim4_opensbliblock00Kernel005*1);
        ACC<double> p_B0(xdim5_opensbliblock00Kernel005, ydim5_opensbliblock00Kernel005, &p_B0_p[0] + base5 + n_x*1 + n_y * xdim5_opensbliblock00Kernel005*1 + n_z * xdim5_opensbliblock00Kernel005 * ydim5_opensbliblock00Kernel005*1);
        //USER CODE
