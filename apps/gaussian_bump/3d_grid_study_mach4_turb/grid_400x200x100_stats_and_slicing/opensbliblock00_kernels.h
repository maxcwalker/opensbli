...
void opensbliblock00Kernel011(const ACC<double> &rho_B0, const ACC<double> &rhou0_B0, ACC<double> &u0_B0)
{
...
void opensbliblock00Kernel015(const ACC<double> &p_B0, const ACC<double> &rho_B0, ACC<double> &a_B0)
{
