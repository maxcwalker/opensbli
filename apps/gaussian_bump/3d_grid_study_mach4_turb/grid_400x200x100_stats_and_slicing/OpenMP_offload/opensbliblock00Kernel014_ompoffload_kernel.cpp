  ...
  for ( int n_z=start2; n_z<end2; n_z++ ){
    for ( int n_y=start1; n_y<end1; n_y++ ){
      for ( int n_x=start0; n_x<end0; n_x++ ){
        ...
        const ACC<double> rhou1_B0(xdim1_opensbliblock00Kernel014, ydim1_opensbliblock00Kernel014, rhou1_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel014*1 + n_z * xdim1_opensbliblock00Kernel014 * ydim1_opensbliblock00Kernel014*1);
        ACC<double> u1_B0(xdim2_opensbliblock00Kernel014, ydim2_opensbliblock00Kernel014, u1_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel014*1 + n_z * xdim2_opensbliblock00Kernel014 * ydim2_opensbliblock00Kernel014*1);
