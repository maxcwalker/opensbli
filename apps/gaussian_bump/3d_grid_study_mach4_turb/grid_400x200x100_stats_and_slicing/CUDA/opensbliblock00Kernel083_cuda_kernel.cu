...
__device__
 ...
 void opensbliblock00Kernel083_gpu(ACC<double> &E_mean_B0,
...
void ops_par_loop_opensbliblock00Kernel083(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg8, ops_arg arg9, ops_arg arg10) {
  ...
  create_kerneldesc_and_enque(name, args, 11, 40, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel083_execute);
}
#endif
