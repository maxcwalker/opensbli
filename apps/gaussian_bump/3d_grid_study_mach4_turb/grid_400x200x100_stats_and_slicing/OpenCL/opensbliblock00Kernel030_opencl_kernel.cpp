...
//
    ...
    void buildOpenCLKernels_opensbliblock00Kernel030(OPS_instance *instance, int xdim0, int ydim0, int xdim1, int ydim1, int xdim2, int ydim2) {
      ...
      if(!isbuilt_opensbliblock00Kernel030) {
        ...
        instance->opencl_instance->OPS_opencl_core.kernel[19] = clCreateKernel(instance->opencl_instance->OPS_opencl_core.program, "ops_opensbliblock00Kernel030", &ret);
        clSafeCall( ret );
