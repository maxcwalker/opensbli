...
//user function
inline 
 void opensbliblock00Kernel002(const ptr_double U2_B0,
  ...
  ptr_double wk14_B0)
{
   ...
   AVG_2_rho = sqrt(OPS_ACC(rho_B0, 0,0,0)*OPS_ACC(rho_B0, 0,0,1));

   AVG_2_inv_rho = 1.0/((sqrt(OPS_ACC(rho_B0, 0,0,0)) + sqrt(OPS_ACC(rho_B0, 0,0,1))));

   AVG_2_u0 = (sqrt(OPS_ACC(rho_B0, 0,0,0))*OPS_ACC(u0_B0, 0,0,0) + sqrt(OPS_ACC(rho_B0, 0,0,1))*OPS_ACC(u0_B0, 0,0,1))*AVG_2_inv_rho;

   AVG_2_u1 = (sqrt(OPS_ACC(rho_B0, 0,0,0))*OPS_ACC(u1_B0, 0,0,0) + sqrt(OPS_ACC(rho_B0, 0,0,1))*OPS_ACC(u1_B0, 0,0,1))*AVG_2_inv_rho;

   AVG_2_u2 = (sqrt(OPS_ACC(rho_B0, 0,0,0))*OPS_ACC(u2_B0, 0,0,0) + sqrt(OPS_ACC(rho_B0, 0,0,1))*OPS_ACC(u2_B0, 0,0,1))*AVG_2_inv_rho;

    AVG_2_a = sqrt((-(1.0/2.0)*((AVG_2_u0*AVG_2_u0) + (AVG_2_u1*AVG_2_u1) + (AVG_2_u2*AVG_2_u2)) + ((OPS_ACC(p_B0, 0,0,0) +
      OPS_ACC(rhoE_B0, 0,0,0))/sqrt(OPS_ACC(rho_B0, 0,0,0)) + (OPS_ACC(p_B0, 0,0,1) +
      OPS_ACC(rhoE_B0, 0,0,1))/sqrt(OPS_ACC(rho_B0, 0,0,1)))*AVG_2_inv_rho)*gamma_m1);
   ...
   CF_00 = (OPS_ACC(rho_B0, 0,0,-2)*AVG_2_2_LEV_00 + OPS_ACC(rhou1_B0, 0,0,-2)*AVG_2_2_LEV_02)*OPS_ACC(U2_B0, 0,0,-2)*OPS_ACC(detJ_B0, 0,0,-2);

   CF_10 = (OPS_ACC(rho_B0, 0,0,-2)*AVG_2_2_LEV_10 + OPS_ACC(rhou0_B0, 0,0,-2)*AVG_2_2_LEV_11)*OPS_ACC(U2_B0, 0,0,-2)*OPS_ACC(detJ_B0, 0,0,-2);

    CF_20 = (OPS_ACC(p_B0, 0,0,-2)*AVG_2_2_LEV_23 + OPS_ACC(p_B0, 0,0,-2)*OPS_ACC(U2_B0, 0,0,-2)*AVG_2_2_LEV_24 +
    ...
    CF_30 = (OPS_ACC(p_B0, 0,0,-2)*AVG_2_2_LEV_33 + OPS_ACC(p_B0, 0,0,-2)*OPS_ACC(U2_B0, 0,0,-2)*AVG_2_2_LEV_34 +
    ...
    CF_40 = (OPS_ACC(p_B0, 0,0,-2)*AVG_2_2_LEV_43 + OPS_ACC(p_B0, 0,0,-2)*OPS_ACC(U2_B0, 0,0,-2)*AVG_2_2_LEV_44 +
   ...
   CS_00 = OPS_ACC(rho_B0, 0,0,-2)*AVG_2_2_LEV_00 + OPS_ACC(rhou1_B0, 0,0,-2)*AVG_2_2_LEV_02;

   CS_10 = OPS_ACC(rho_B0, 0,0,-2)*AVG_2_2_LEV_10 + OPS_ACC(rhou0_B0, 0,0,-2)*AVG_2_2_LEV_11;
   ...
   CF_01 = (OPS_ACC(rho_B0, 0,0,-1)*AVG_2_2_LEV_00 + OPS_ACC(rhou1_B0, 0,0,-1)*AVG_2_2_LEV_02)*OPS_ACC(U2_B0, 0,0,-1)*OPS_ACC(detJ_B0, 0,0,-1);

   CF_11 = (OPS_ACC(rho_B0, 0,0,-1)*AVG_2_2_LEV_10 + OPS_ACC(rhou0_B0, 0,0,-1)*AVG_2_2_LEV_11)*OPS_ACC(U2_B0, 0,0,-1)*OPS_ACC(detJ_B0, 0,0,-1);

    CF_21 = (OPS_ACC(p_B0, 0,0,-1)*AVG_2_2_LEV_23 + OPS_ACC(p_B0, 0,0,-1)*OPS_ACC(U2_B0, 0,0,-1)*AVG_2_2_LEV_24 +
    ...
    CF_31 = (OPS_ACC(p_B0, 0,0,-1)*AVG_2_2_LEV_33 + OPS_ACC(p_B0, 0,0,-1)*OPS_ACC(U2_B0, 0,0,-1)*AVG_2_2_LEV_34 +
    ...
    CF_41 = (OPS_ACC(p_B0, 0,0,-1)*AVG_2_2_LEV_43 + OPS_ACC(p_B0, 0,0,-1)*OPS_ACC(U2_B0, 0,0,-1)*AVG_2_2_LEV_44 +
   ...
   CS_01 = OPS_ACC(rho_B0, 0,0,-1)*AVG_2_2_LEV_00 + OPS_ACC(rhou1_B0, 0,0,-1)*AVG_2_2_LEV_02;

   CS_11 = OPS_ACC(rho_B0, 0,0,-1)*AVG_2_2_LEV_10 + OPS_ACC(rhou0_B0, 0,0,-1)*AVG_2_2_LEV_11;
   ...
   CF_02 = (OPS_ACC(rho_B0, 0,0,0)*AVG_2_2_LEV_00 + OPS_ACC(rhou1_B0, 0,0,0)*AVG_2_2_LEV_02)*OPS_ACC(U2_B0, 0,0,0)*OPS_ACC(detJ_B0, 0,0,0);

   CF_12 = (OPS_ACC(rho_B0, 0,0,0)*AVG_2_2_LEV_10 + OPS_ACC(rhou0_B0, 0,0,0)*AVG_2_2_LEV_11)*OPS_ACC(U2_B0, 0,0,0)*OPS_ACC(detJ_B0, 0,0,0);

    CF_22 = (OPS_ACC(p_B0, 0,0,0)*AVG_2_2_LEV_23 + OPS_ACC(p_B0, 0,0,0)*OPS_ACC(U2_B0, 0,0,0)*AVG_2_2_LEV_24 +
    ...
    CF_32 = (OPS_ACC(p_B0, 0,0,0)*AVG_2_2_LEV_33 + OPS_ACC(p_B0, 0,0,0)*OPS_ACC(U2_B0, 0,0,0)*AVG_2_2_LEV_34 +
    ...
    CF_42 = (OPS_ACC(p_B0, 0,0,0)*AVG_2_2_LEV_43 + OPS_ACC(p_B0, 0,0,0)*OPS_ACC(U2_B0, 0,0,0)*AVG_2_2_LEV_44 +
   ...
   CS_02 = OPS_ACC(rho_B0, 0,0,0)*AVG_2_2_LEV_00 + OPS_ACC(rhou1_B0, 0,0,0)*AVG_2_2_LEV_02;

   CS_12 = OPS_ACC(rho_B0, 0,0,0)*AVG_2_2_LEV_10 + OPS_ACC(rhou0_B0, 0,0,0)*AVG_2_2_LEV_11;
   ...
   CF_03 = (OPS_ACC(rho_B0, 0,0,1)*AVG_2_2_LEV_00 + OPS_ACC(rhou1_B0, 0,0,1)*AVG_2_2_LEV_02)*OPS_ACC(U2_B0, 0,0,1)*OPS_ACC(detJ_B0, 0,0,1);

   CF_13 = (OPS_ACC(rho_B0, 0,0,1)*AVG_2_2_LEV_10 + OPS_ACC(rhou0_B0, 0,0,1)*AVG_2_2_LEV_11)*OPS_ACC(U2_B0, 0,0,1)*OPS_ACC(detJ_B0, 0,0,1);

    CF_23 = (OPS_ACC(p_B0, 0,0,1)*AVG_2_2_LEV_23 + OPS_ACC(p_B0, 0,0,1)*OPS_ACC(U2_B0, 0,0,1)*AVG_2_2_LEV_24 +
      OPS_ACC(U2_B0, 0,0,1)*OPS_ACC(rho_B0, 0,0,1)*AVG_2_2_LEV_20 + OPS_ACC(U2_B0, 0,0,1)*OPS_ACC(rhoE_B0, 0,0,1)*AVG_2_2_LEV_24 +
      OPS_ACC(U2_B0, 0,0,1)*OPS_ACC(rhou0_B0, 0,0,1)*AVG_2_2_LEV_21 + OPS_ACC(U2_B0, 0,0,1)*OPS_ACC(rhou1_B0, 0,0,1)*AVG_2_2_LEV_22 +
      OPS_ACC(U2_B0, 0,0,1)*OPS_ACC(rhou2_B0, 0,0,1)*AVG_2_2_LEV_23)*OPS_ACC(detJ_B0, 0,0,1);

    CF_33 = (OPS_ACC(p_B0, 0,0,1)*AVG_2_2_LEV_33 + OPS_ACC(p_B0, 0,0,1)*OPS_ACC(U2_B0, 0,0,1)*AVG_2_2_LEV_34 +
      OPS_ACC(U2_B0, 0,0,1)*OPS_ACC(rho_B0, 0,0,1)*AVG_2_2_LEV_30 + OPS_ACC(U2_B0, 0,0,1)*OPS_ACC(rhoE_B0, 0,0,1)*AVG_2_2_LEV_34 +
      OPS_ACC(U2_B0, 0,0,1)*OPS_ACC(rhou0_B0, 0,0,1)*AVG_2_2_LEV_31 + OPS_ACC(U2_B0, 0,0,1)*OPS_ACC(rhou1_B0, 0,0,1)*AVG_2_2_LEV_32 +
      OPS_ACC(U2_B0, 0,0,1)*OPS_ACC(rhou2_B0, 0,0,1)*AVG_2_2_LEV_33)*OPS_ACC(detJ_B0, 0,0,1);

    CF_43 = (OPS_ACC(p_B0, 0,0,1)*AVG_2_2_LEV_43 + OPS_ACC(p_B0, 0,0,1)*OPS_ACC(U2_B0, 0,0,1)*AVG_2_2_LEV_44 +
      OPS_ACC(U2_B0, 0,0,1)*OPS_ACC(rho_B0, 0,0,1)*AVG_2_2_LEV_40 + OPS_ACC(U2_B0, 0,0,1)*OPS_ACC(rhoE_B0, 0,0,1)*AVG_2_2_LEV_44 +
      OPS_ACC(U2_B0, 0,0,1)*OPS_ACC(rhou0_B0, 0,0,1)*AVG_2_2_LEV_41 + OPS_ACC(U2_B0, 0,0,1)*OPS_ACC(rhou1_B0, 0,0,1)*AVG_2_2_LEV_42 +
      OPS_ACC(U2_B0, 0,0,1)*OPS_ACC(rhou2_B0, 0,0,1)*AVG_2_2_LEV_43)*OPS_ACC(detJ_B0, 0,0,1);

   CS_03 = OPS_ACC(rho_B0, 0,0,1)*AVG_2_2_LEV_00 + OPS_ACC(rhou1_B0, 0,0,1)*AVG_2_2_LEV_02;

   CS_13 = OPS_ACC(rho_B0, 0,0,1)*AVG_2_2_LEV_10 + OPS_ACC(rhou0_B0, 0,0,1)*AVG_2_2_LEV_11;
   ...
   CF_04 = (OPS_ACC(rho_B0, 0,0,2)*AVG_2_2_LEV_00 + OPS_ACC(rhou1_B0, 0,0,2)*AVG_2_2_LEV_02)*OPS_ACC(U2_B0, 0,0,2)*OPS_ACC(detJ_B0, 0,0,2);

   CF_14 = (OPS_ACC(rho_B0, 0,0,2)*AVG_2_2_LEV_10 + OPS_ACC(rhou0_B0, 0,0,2)*AVG_2_2_LEV_11)*OPS_ACC(U2_B0, 0,0,2)*OPS_ACC(detJ_B0, 0,0,2);

    CF_24 = (OPS_ACC(p_B0, 0,0,2)*AVG_2_2_LEV_23 + OPS_ACC(p_B0, 0,0,2)*OPS_ACC(U2_B0, 0,0,2)*AVG_2_2_LEV_24 +
      OPS_ACC(U2_B0, 0,0,2)*OPS_ACC(rho_B0, 0,0,2)*AVG_2_2_LEV_20 + OPS_ACC(U2_B0, 0,0,2)*OPS_ACC(rhoE_B0, 0,0,2)*AVG_2_2_LEV_24 +
      OPS_ACC(U2_B0, 0,0,2)*OPS_ACC(rhou0_B0, 0,0,2)*AVG_2_2_LEV_21 + OPS_ACC(U2_B0, 0,0,2)*OPS_ACC(rhou1_B0, 0,0,2)*AVG_2_2_LEV_22 +
      OPS_ACC(U2_B0, 0,0,2)*OPS_ACC(rhou2_B0, 0,0,2)*AVG_2_2_LEV_23)*OPS_ACC(detJ_B0, 0,0,2);

    CF_34 = (OPS_ACC(p_B0, 0,0,2)*AVG_2_2_LEV_33 + OPS_ACC(p_B0, 0,0,2)*OPS_ACC(U2_B0, 0,0,2)*AVG_2_2_LEV_34 +
      OPS_ACC(U2_B0, 0,0,2)*OPS_ACC(rho_B0, 0,0,2)*AVG_2_2_LEV_30 + OPS_ACC(U2_B0, 0,0,2)*OPS_ACC(rhoE_B0, 0,0,2)*AVG_2_2_LEV_34 +
      OPS_ACC(U2_B0, 0,0,2)*OPS_ACC(rhou0_B0, 0,0,2)*AVG_2_2_LEV_31 + OPS_ACC(U2_B0, 0,0,2)*OPS_ACC(rhou1_B0, 0,0,2)*AVG_2_2_LEV_32 +
      OPS_ACC(U2_B0, 0,0,2)*OPS_ACC(rhou2_B0, 0,0,2)*AVG_2_2_LEV_33)*OPS_ACC(detJ_B0, 0,0,2);

    CF_44 = (OPS_ACC(p_B0, 0,0,2)*AVG_2_2_LEV_43 + OPS_ACC(p_B0, 0,0,2)*OPS_ACC(U2_B0, 0,0,2)*AVG_2_2_LEV_44 +
      OPS_ACC(U2_B0, 0,0,2)*OPS_ACC(rho_B0, 0,0,2)*AVG_2_2_LEV_40 + OPS_ACC(U2_B0, 0,0,2)*OPS_ACC(rhoE_B0, 0,0,2)*AVG_2_2_LEV_44 +
      OPS_ACC(U2_B0, 0,0,2)*OPS_ACC(rhou0_B0, 0,0,2)*AVG_2_2_LEV_41 + OPS_ACC(U2_B0, 0,0,2)*OPS_ACC(rhou1_B0, 0,0,2)*AVG_2_2_LEV_42 +
      OPS_ACC(U2_B0, 0,0,2)*OPS_ACC(rhou2_B0, 0,0,2)*AVG_2_2_LEV_43)*OPS_ACC(detJ_B0, 0,0,2);

   CS_04 = OPS_ACC(rho_B0, 0,0,2)*AVG_2_2_LEV_00 + OPS_ACC(rhou1_B0, 0,0,2)*AVG_2_2_LEV_02;

   CS_14 = OPS_ACC(rho_B0, 0,0,2)*AVG_2_2_LEV_10 + OPS_ACC(rhou0_B0, 0,0,2)*AVG_2_2_LEV_11;
   ...
   CF_05 = (OPS_ACC(rho_B0, 0,0,3)*AVG_2_2_LEV_00 + OPS_ACC(rhou1_B0, 0,0,3)*AVG_2_2_LEV_02)*OPS_ACC(U2_B0, 0,0,3)*OPS_ACC(detJ_B0, 0,0,3);

   CF_15 = (OPS_ACC(rho_B0, 0,0,3)*AVG_2_2_LEV_10 + OPS_ACC(rhou0_B0, 0,0,3)*AVG_2_2_LEV_11)*OPS_ACC(U2_B0, 0,0,3)*OPS_ACC(detJ_B0, 0,0,3);

    CF_25 = (OPS_ACC(p_B0, 0,0,3)*AVG_2_2_LEV_23 + OPS_ACC(p_B0, 0,0,3)*OPS_ACC(U2_B0, 0,0,3)*AVG_2_2_LEV_24 +
    ...
    CF_35 = (OPS_ACC(p_B0, 0,0,3)*AVG_2_2_LEV_33 + OPS_ACC(p_B0, 0,0,3)*OPS_ACC(U2_B0, 0,0,3)*AVG_2_2_LEV_34 +
    ...
    CF_45 = (OPS_ACC(p_B0, 0,0,3)*AVG_2_2_LEV_43 + OPS_ACC(p_B0, 0,0,3)*OPS_ACC(U2_B0, 0,0,3)*AVG_2_2_LEV_44 +
   ...
   CS_05 = OPS_ACC(rho_B0, 0,0,3)*AVG_2_2_LEV_00 + OPS_ACC(rhou1_B0, 0,0,3)*AVG_2_2_LEV_02;

   CS_15 = OPS_ACC(rho_B0, 0,0,3)*AVG_2_2_LEV_10 + OPS_ACC(rhou0_B0, 0,0,3)*AVG_2_2_LEV_11;
   ...
   max_lambda_22 = max_lambda_00;
    ...
    max_lambda_44 = shock_filter_control*fmax(fabs(OPS_ACC(a_B0, 0,0,1)*OPS_ACC(detJ_B0, 0,0,1) - OPS_ACC(u2_B0, 0,0,1)*OPS_ACC(detJ_B0, 0,0,1)),
...
: (
   1.0
    ...
    OPS_ACC(wk10_B0, 0,0,0) = 0.707106781186547*AVG_2_rho*Recon_3*inv_AVG_a + 0.707106781186547*AVG_2_rho*Recon_4*inv_AVG_a +
      Recon_2;

    OPS_ACC(wk11_B0, 0,0,0) = AVG_2_u0*Recon_2 - AVG_2_rho*Recon_1 + 0.707106781186547*AVG_2_rho*AVG_2_u0*Recon_3*inv_AVG_a +
      0.707106781186547*AVG_2_rho*AVG_2_u0*Recon_4*inv_AVG_a;

    OPS_ACC(wk12_B0, 0,0,0) = AVG_2_rho*Recon_0 + AVG_2_u1*Recon_2 + 0.707106781186547*AVG_2_rho*AVG_2_u1*Recon_3*inv_AVG_a +
      0.707106781186547*AVG_2_rho*AVG_2_u1*Recon_4*inv_AVG_a;

    OPS_ACC(wk13_B0, 0,0,0) = AVG_2_u2*Recon_2 + 0.707106781186547*(-AVG_2_a + AVG_2_u2)*AVG_2_rho*Recon_4*inv_AVG_a +
      0.707106781186547*(AVG_2_a + AVG_2_u2)*AVG_2_rho*Recon_3*inv_AVG_a;

    OPS_ACC(wk14_B0, 0,0,0) = (((1.0/2.0))*(AVG_2_u0*AVG_2_u0) + ((1.0/2.0))*(AVG_2_u1*AVG_2_u1) +
  ...
  for ( int n_z=0; n_z<z_size; n_z++ ){
    ...
    for ( int n_y=0; n_y<y_size; n_y++ ){
      ...
      for ( int n_x=0; n_x<x_size; n_x++ ){
        ...
        ptr_double ptr12 = {  p_a12 + n_x*1*1 + n_y*xdim12_opensbliblock00Kernel002*1*1 + n_z*xdim12_opensbliblock00Kernel002*ydim12_opensbliblock00Kernel002*1*1, xdim12_opensbliblock00Kernel002, ydim12_opensbliblock00Kernel002};
        ptr_double ptr13 = {  p_a13 + n_x*1*1 + n_y*xdim13_opensbliblock00Kernel002*1*1 + n_z*xdim13_opensbliblock00Kernel002*ydim13_opensbliblock00Kernel002*1*1, xdim13_opensbliblock00Kernel002, ydim13_opensbliblock00Kernel002};
        ptr_double ptr14 = {  p_a14 + n_x*1*1 + n_y*xdim14_opensbliblock00Kernel002*1*1 + n_z*xdim14_opensbliblock00Kernel002*ydim14_opensbliblock00Kernel002*1*1, xdim14_opensbliblock00Kernel002, ydim14_opensbliblock00Kernel002};
