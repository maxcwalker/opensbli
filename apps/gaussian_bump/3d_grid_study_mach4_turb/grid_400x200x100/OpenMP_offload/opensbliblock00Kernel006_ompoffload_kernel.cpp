  ...
  for ( int n_z=start2; n_z<end2; n_z++ ){
    for ( int n_y=start1; n_y<end1; n_y++ ){
      for ( int n_x=start0; n_x<end0; n_x++ ){
        const ACC<double> p_B0(xdim0_opensbliblock00Kernel006, ydim0_opensbliblock00Kernel006, p_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel006*1 + n_z * xdim0_opensbliblock00Kernel006 * ydim0_opensbliblock00Kernel006*1);
        ...
        ACC<double> a_B0(xdim2_opensbliblock00Kernel006, ydim2_opensbliblock00Kernel006, a_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel006*1 + n_z * xdim2_opensbliblock00Kernel006 * ydim2_opensbliblock00Kernel006*1);
...
void ops_par_loop_opensbliblock00Kernel006(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  create_kerneldesc_and_enque(name, args, 3, 18, dim, 0, range, block, ops_par_loop_opensbliblock00Kernel006_execute);
}
#endif
