  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      , [=](cl::sycl::nd_item<2> item
        ...
        const ACC<double> rho_B0(xdim1_opensbliblock00Kernel027, &rho_B0_p[0] + base1 + n_x*1 + n_y * xdim1_opensbliblock00Kernel027*1);
        ACC<double> T_B0(xdim2_opensbliblock00Kernel027, &T_B0_p[0] + base2 + n_x*1 + n_y * xdim2_opensbliblock00Kernel027*1);
        //USER CODE
