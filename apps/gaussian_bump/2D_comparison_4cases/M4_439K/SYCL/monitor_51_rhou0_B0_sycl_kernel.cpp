...
void ops_par_loop_monitor_51_rhou0_B0_execute(ops_kernel_descriptor *desc) {
  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      cgh.parallel_for<class monitor_51_rhou0_B0_kernel>(cl::sycl::nd_range<2>(cl::sycl::range<2>(
      ...
      , [=](cl::sycl::nd_item<2> item
        ...
        const ACC<double> rhou0_B0(xdim0_monitor_51_rhou0_B0, &rhou0_B0_p[0] + base0 + n_x*1 + n_y * xdim0_monitor_51_rhou0_B0*1);
