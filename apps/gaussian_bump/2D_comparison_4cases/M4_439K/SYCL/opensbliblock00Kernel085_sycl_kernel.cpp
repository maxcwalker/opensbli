...
void ops_par_loop_opensbliblock00Kernel085_execute(ops_kernel_descriptor *desc) {
  ...
  double* wk7_B0_p = (double*)args[1].data_d;
  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      cgh.parallel_for<class opensbliblock00Kernel085_kernel>(cl::sycl::nd_range<2>(cl::sycl::range<2>(
      ...
      , [=](cl::sycl::nd_item<2> item
        ...
        const ACC<double> D00_B0(xdim0_opensbliblock00Kernel085, &D00_B0_p[0] + base0 + n_x*1 + n_y * xdim0_opensbliblock00Kernel085*1);
        ACC<double> wk7_B0(xdim1_opensbliblock00Kernel085, &wk7_B0_p[0] + base1 + n_x*1 + n_y * xdim1_opensbliblock00Kernel085*1);
        //USER CODE
        if (n_x < end_0 && n_y < end_1) {
          
    wk7_B0(0,0) = invDelta0block0_sycl[0]*((idx[0] == 0) ? (
