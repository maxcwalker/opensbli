  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      , [=](cl::sycl::nd_item<2> item
        ...
        const ACC<double> rhoE_B0(xdim0_opensbliblock00Kernel005, &rhoE_B0_p[0] + base0 + n_x*1 + n_y * xdim0_opensbliblock00Kernel005*1);
        const ACC<double> rho_B0(xdim1_opensbliblock00Kernel005, &rho_B0_p[0] + base1 + n_x*1 + n_y * xdim1_opensbliblock00Kernel005*1);
        const ACC<double> u0_B0(xdim2_opensbliblock00Kernel005, &u0_B0_p[0] + base2 + n_x*1 + n_y * xdim2_opensbliblock00Kernel005*1);
        const ACC<double> u1_B0(xdim3_opensbliblock00Kernel005, &u1_B0_p[0] + base3 + n_x*1 + n_y * xdim3_opensbliblock00Kernel005*1);
        ACC<double> p_B0(xdim4_opensbliblock00Kernel005, &p_B0_p[0] + base4 + n_x*1 + n_y * xdim4_opensbliblock00Kernel005*1);
        //USER CODE
