...
void ops_par_loop_opensbliblock00Kernel063_execute(ops_kernel_descriptor *desc) {
  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      cgh.parallel_for<class opensbliblock00Kernel063_kernel>(cl::sycl::nd_range<2>(cl::sycl::range<2>(
      ...
      , [=](cl::sycl::nd_item<2> item
        ...
        ACC<double> rhoE_B0(xdim0_opensbliblock00Kernel063, &rhoE_B0_p[0] + base0 + n_x*1 + n_y * xdim0_opensbliblock00Kernel063*1);
        ACC<double> rho_B0(xdim1_opensbliblock00Kernel063, &rho_B0_p[0] + base1 + n_x*1 + n_y * xdim1_opensbliblock00Kernel063*1);
        ACC<double> rhou0_B0(xdim2_opensbliblock00Kernel063, &rhou0_B0_p[0] + base2 + n_x*1 + n_y * xdim2_opensbliblock00Kernel063*1);
        ACC<double> rhou1_B0(xdim3_opensbliblock00Kernel063, &rhou1_B0_p[0] + base3 + n_x*1 + n_y * xdim3_opensbliblock00Kernel063*1);
        //USER CODE
