  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      , [=](cl::sycl::nd_item<2> item
        ...
        const ACC<double> rho_B0(xdim0_opensbliblock00Kernel010, &rho_B0_p[0] + base0 + n_x*1 + n_y * xdim0_opensbliblock00Kernel010*1);
        const ACC<double> rhou0_B0(xdim1_opensbliblock00Kernel010, &rhou0_B0_p[0] + base1 + n_x*1 + n_y * xdim1_opensbliblock00Kernel010*1);
        ACC<double> u0_B0(xdim2_opensbliblock00Kernel010, &u0_B0_p[0] + base2 + n_x*1 + n_y * xdim2_opensbliblock00Kernel010*1);
        //USER CODE
