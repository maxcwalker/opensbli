...
void opensbliblock00Kernel028_gpu(const ACC<double> &u0_B0,
  ACC<double> &wk0_B0,
  const int *idx)
{
   if (idx[0] == 0){
...
void ops_par_loop_opensbliblock00Kernel028(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  create_kerneldesc_and_enque(name, args, 3, 22, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel028_execute);
}
#endif
