...
void opensbliblock00Kernel046_gpu(ACC<double> &rhoE_B0,
  ACC<double> &rho_B0,
  ACC<double> &rhou0_B0,
  ACC<double> &rhou1_B0)
{
...
void ops_par_loop_opensbliblock00Kernel046(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2, ops_arg arg3) {
  ...
  create_kerneldesc_and_enque(name, args, 4, 8, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel046_execute);
}
#endif
