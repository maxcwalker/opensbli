...
void opensbliblock00Kernel067(const ACC<double> &x0_B0, ACC<double> &wk0_B0, const int *idx)
{
...
: (
 ...
 void opensbliblock00Kernel073(const ACC<double> &wk2_B0, ACC<double> &D00_B0, ACC<double> &D01_B0, ACC<double> &D10_B0,
ACC<double> &D11_B0, ACC<double> &detJ_B0, ACC<double> &wk0_B0, ACC<double> &wk1_B0, ACC<double> &wk3_B0)
{
   wk0_B0(0,0) = wk3_B0(0,0);

   wk1_B0(0,0) = wk0_B0(0,0);

   wk3_B0(0,0) = wk1_B0(0,0);

   detJ_B0(0,0) = wk1_B0(0,0)*wk3_B0(0,0) - wk0_B0(0,0)*wk2_B0(0,0);

   D00_B0(0,0) = wk1_B0(0,0)/(wk1_B0(0,0)*wk3_B0(0,0) - wk0_B0(0,0)*wk2_B0(0,0));

   D01_B0(0,0) = -wk0_B0(0,0)/(wk1_B0(0,0)*wk3_B0(0,0) - wk0_B0(0,0)*wk2_B0(0,0));

   D10_B0(0,0) = -wk2_B0(0,0)/(wk1_B0(0,0)*wk3_B0(0,0) - wk0_B0(0,0)*wk2_B0(0,0));

   D11_B0(0,0) = wk3_B0(0,0)/(wk1_B0(0,0)*wk3_B0(0,0) - wk0_B0(0,0)*wk2_B0(0,0));
...
void opensbliblock00Kernel078(const ACC<double> &D00_B0, ACC<double> &wk0_B0, const int *idx)
{
    wk0_B0(0,0) = invDelta1block0*((idx[1] == 0) ? (
...
{
    wk1_B0(0,0) = invDelta1block0*((idx[1] == 0) ? (
   3.0*D10_B0(0,1) + 0.333333333333333*D10_B0(0,3) -
      1.5*D10_B0(0,2) - 1.83333333333333*D10_B0(0,0)
)
: ((idx[1] == 1) ? (
...
{
    wk2_B0(0,0) = invDelta0block0*((idx[0] == 0) ? (
   3.0*D01_B0(1,0) + 0.333333333333333*D01_B0(3,0) -
      1.5*D01_B0(2,0) - 1.83333333333333*D01_B0(0,0)
)
: ((idx[0] == 1) ? (
...
void opensbliblock00Kernel081(const ACC<double> &D11_B0, ACC<double> &wk3_B0, const int *idx)
{
    wk3_B0(0,0) = invDelta1block0*((idx[1] == 0) ? (
   3.0*D11_B0(0,1) + 0.333333333333333*D11_B0(0,3) -
      1.5*D11_B0(0,2) - 1.83333333333333*D11_B0(0,0)
)
: ((idx[1] == 1) ? (
...
void opensbliblock00Kernel083(const ACC<double> &D01_B0, ACC<double> &wk5_B0, const int *idx)
{
    wk5_B0(0,0) = invDelta1block0*((idx[1] == 0) ? (
   3.0*D01_B0(0,1) + 0.333333333333333*D01_B0(0,3) -
      1.5*D01_B0(0,2) - 1.83333333333333*D01_B0(0,0)
)
: ((idx[1] == 1) ? (
...
void opensbliblock00Kernel084(const ACC<double> &D10_B0, ACC<double> &wk6_B0, const int *idx)
{
    wk6_B0(0,0) = invDelta0block0*((idx[0] == 0) ? (
   3.0*D10_B0(1,0) + 0.333333333333333*D10_B0(3,0) -
      1.5*D10_B0(2,0) - 1.83333333333333*D10_B0(0,0)
)
: ((idx[0] == 1) ? (
...
void opensbliblock00Kernel085(const ACC<double> &D00_B0, ACC<double> &wk7_B0, const int *idx)
{
   ...
   3.0*D00_B0(1,0) + 0.333333333333333*D00_B0(3,0) -
      1.5*D00_B0(2,0) - 1.83333333333333*D00_B0(0,0)
)
: ((idx[0] == 1) ? (
...
{
    wk2_B0(0,0) = invDelta0block0*((idx[0] == 0) ? (
   3.0*T_B0(1,0) + 0.333333333333333*T_B0(3,0) - 1.5*T_B0(2,0) -
      1.83333333333333*T_B0(0,0)
)
: ((idx[0] == 1) ? (
   0.0394168524399447*T_B0(2,0) + 0.00571369039775442*T_B0(4,0)
      + 0.719443173328855*T_B0(1,0) - 0.322484932882161*T_B0(0,0) - 0.0658051057710389*T_B0(3,0) -
      0.376283677513354*T_B0(-1,0)
)
: ((idx[0] == 2) ? (
   0.197184333887745*T_B0(0,0) + 0.521455851089587*T_B0(1,0) +
      0.113446470384241*T_B0(-2,0) - 0.00412637789557492*T_B0(3,0) - 0.0367146847001261*T_B0(2,0) -
      0.791245592765872*T_B0(-1,0)
)
: ((idx[0] == 3) ? (
   0.0451033223343881*T_B0(0,0) + 0.652141084861241*T_B0(1,0)
      + 0.121937153224065*T_B0(-2,0) - 0.00932597985049999*T_B0(-3,0) - 0.727822147724592*T_B0(-1,0) -
      0.082033432844602*T_B0(2,0)
)
: ((idx[0] == -1 + block0np0) ? (
   1.5*T_B0(-2,0) + 1.83333333333333*T_B0(0,0) -
      3.0*T_B0(-1,0) - 0.333333333333333*T_B0(-3,0)
)
: ((idx[0] == -2 + block0np0) ? (
   0.322484932882161*T_B0(0,0) +
      0.0658051057710389*T_B0(-3,0) + 0.376283677513354*T_B0(1,0) - 0.0394168524399447*T_B0(-2,0) -
      0.00571369039775442*T_B0(-4,0) - 0.719443173328855*T_B0(-1,0)
)
: ((idx[0] == -3 + block0np0) ? (
  
      0.00412637789557492*T_B0(-3,0) + 0.0367146847001261*T_B0(-2,0) + 0.791245592765872*T_B0(1,0) -
      0.197184333887745*T_B0(0,0) - 0.521455851089587*T_B0(-1,0) - 0.113446470384241*T_B0(2,0)
)
: ((idx[0] == -4 +
      block0np0) ? (
   0.00932597985049999*T_B0(3,0) + 0.727822147724592*T_B0(1,0) + 0.082033432844602*T_B0(-2,0) -
      0.0451033223343881*T_B0(0,0) - 0.652141084861241*T_B0(-1,0) - 0.121937153224065*T_B0(2,0)
)
: (
  
      -(2.0/3.0)*T_B0(-1,0) - (1.0/12.0)*T_B0(2,0) + ((1.0/12.0))*T_B0(-2,0) + ((2.0/3.0))*T_B0(1,0)
)))))))));
...
void opensbliblock00Kernel037(const ACC<double> &T_B0, ACC<double> &wk9_B0, const int *idx)
{
...
void opensbliblock00Kernel038(const ACC<double> &u0_B0, ACC<double> &wk10_B0, const int *idx)
{
...
void opensbliblock00Kernel039(const ACC<double> &mu_B0, ACC<double> &wk11_B0, const int *idx)
{
    wk11_B0(0,0) = invDelta1block0*((idx[1] == 0) ? (
   3.0*mu_B0(0,1) + 0.333333333333333*mu_B0(0,3) - 1.5*mu_B0(0,2)
      - 1.83333333333333*mu_B0(0,0)
)
: ((idx[1] == 1) ? (
   0.0394168524399447*mu_B0(0,2) +
      0.00571369039775442*mu_B0(0,4) + 0.719443173328855*mu_B0(0,1) - 0.322484932882161*mu_B0(0,0) -
      0.0658051057710389*mu_B0(0,3) - 0.376283677513354*mu_B0(0,-1)
)
: ((idx[1] == 2) ? (
  
      0.197184333887745*mu_B0(0,0) + 0.521455851089587*mu_B0(0,1) + 0.113446470384241*mu_B0(0,-2) -
      0.00412637789557492*mu_B0(0,3) - 0.0367146847001261*mu_B0(0,2) - 0.791245592765872*mu_B0(0,-1)
)
: ((idx[1] == 3)
      ? (
   0.0451033223343881*mu_B0(0,0) + 0.652141084861241*mu_B0(0,1) + 0.121937153224065*mu_B0(0,-2) -
      0.00932597985049999*mu_B0(0,-3) - 0.727822147724592*mu_B0(0,-1) - 0.082033432844602*mu_B0(0,2)
)
: (
...
{
    wk12_B0(0,0) = inv2Delta1block0*((idx[1] == 0) ? (
...
void opensbliblock00Kernel041(const ACC<double> &u0_B0, ACC<double> &wk13_B0, const int *idx)
{
    wk13_B0(0,0) = inv2Delta0block0*((idx[0] == 0) ? (
...
{
    wk14_B0(0,0) = inv2Delta0block0*((idx[0] == 0) ? (
...
void opensbliblock00Kernel028(const ACC<double> &wk10_B0, ACC<double> &wk0_B0, const int *idx)
{
    wk0_B0(0,0) = invDelta1block0*((idx[1] == 0) ? (
   3.0*wk10_B0(0,1) + 0.333333333333333*wk10_B0(0,3) -
      1.5*wk10_B0(0,2) - 1.83333333333333*wk10_B0(0,0)
)
: ((idx[1] == 1) ? (
   0.0394168524399447*wk10_B0(0,2) +
      0.00571369039775442*wk10_B0(0,4) + 0.719443173328855*wk10_B0(0,1) - 0.322484932882161*wk10_B0(0,0) -
      0.0658051057710389*wk10_B0(0,3) - 0.376283677513354*wk10_B0(0,-1)
)
: ((idx[1] == 2) ? (
  
      0.197184333887745*wk10_B0(0,0) + 0.521455851089587*wk10_B0(0,1) + 0.113446470384241*wk10_B0(0,-2) -
      0.00412637789557492*wk10_B0(0,3) - 0.0367146847001261*wk10_B0(0,2) - 0.791245592765872*wk10_B0(0,-1)
)
: ((idx[1]
      == 3) ? (
   0.0451033223343881*wk10_B0(0,0) + 0.652141084861241*wk10_B0(0,1) + 0.121937153224065*wk10_B0(0,-2) -
      0.00932597985049999*wk10_B0(0,-3) - 0.727822147724592*wk10_B0(0,-1) - 0.082033432844602*wk10_B0(0,2)
)
: (
...
void opensbliblock00Kernel033(const ACC<double> &wk2_B0, ACC<double> &wk5_B0, const int *idx)
{
    wk5_B0(0,0) = invDelta1block0*((idx[1] == 0) ? (
...
void opensbliblock00Kernel036(const ACC<double> &wk4_B0, ACC<double> &wk8_B0, const int *idx)
{
    wk8_B0(0,0) = invDelta1block0*((idx[1] == 0) ? (
   3.0*wk4_B0(0,1) + 0.333333333333333*wk4_B0(0,3) -
      1.5*wk4_B0(0,2) - 1.83333333333333*wk4_B0(0,0)
)
: ((idx[1] == 1) ? (
   0.0394168524399447*wk4_B0(0,2) +
      0.00571369039775442*wk4_B0(0,4) + 0.719443173328855*wk4_B0(0,1) - 0.322484932882161*wk4_B0(0,0) -
      0.0658051057710389*wk4_B0(0,3) - 0.376283677513354*wk4_B0(0,-1)
)
: ((idx[1] == 2) ? (
  
      0.197184333887745*wk4_B0(0,0) + 0.521455851089587*wk4_B0(0,1) + 0.113446470384241*wk4_B0(0,-2) -
      0.00412637789557492*wk4_B0(0,3) - 0.0367146847001261*wk4_B0(0,2) - 0.791245592765872*wk4_B0(0,-1)
)
: ((idx[1] ==
      3) ? (
   0.0451033223343881*wk4_B0(0,0) + 0.652141084861241*wk4_B0(0,1) + 0.121937153224065*wk4_B0(0,-2) -
      0.00932597985049999*wk4_B0(0,-3) - 0.727822147724592*wk4_B0(0,-1) - 0.082033432844602*wk4_B0(0,2)
)
: (
  
      -(2.0/3.0)*wk4_B0(0,-1) - (1.0/12.0)*wk4_B0(0,2) + ((1.0/12.0))*wk4_B0(0,-2) + ((2.0/3.0))*wk4_B0(0,1)
)))));
...
{
    Residual1_B0(0,0) = (D00_B0(0,0)*wk6_B0(0,0) + D10_B0(0,0)*wk11_B0(0,0))*(-(2.0/3.0)*D01_B0(0,0)*wk4_B0(0,0) -
      (2.0/3.0)*D11_B0(0,0)*wk1_B0(0,0) + ((4.0/3.0))*D00_B0(0,0)*wk10_B0(0,0) +
      ((4.0/3.0))*D10_B0(0,0)*wk7_B0(0,0))*invRe + (D01_B0(0,0)*wk6_B0(0,0) +
      D11_B0(0,0)*wk11_B0(0,0))*(D00_B0(0,0)*wk4_B0(0,0) + D01_B0(0,0)*wk10_B0(0,0) + D10_B0(0,0)*wk1_B0(0,0) +
      D11_B0(0,0)*wk7_B0(0,0))*invRe + ((D01_B0(0,0)*D01_B0(0,0))*wk13_B0(0,0) + (D11_B0(0,0)*D11_B0(0,0))*wk15_B0(0,0)
      + ((4.0/3.0))*(D00_B0(0,0)*D00_B0(0,0))*wk13_B0(0,0) + ((4.0/3.0))*(D10_B0(0,0)*D10_B0(0,0))*wk15_B0(0,0) +
      D01_B0(0,0)*wk1_B0(0,0)*SD100_B0(0,0) + D01_B0(0,0)*wk4_B0(0,0)*SD000_B0(0,0) +
      D01_B0(0,0)*wk7_B0(0,0)*SD110_B0(0,0) + D01_B0(0,0)*wk10_B0(0,0)*SD010_B0(0,0) +
      D11_B0(0,0)*wk1_B0(0,0)*SD101_B0(0,0) + D11_B0(0,0)*wk4_B0(0,0)*SD001_B0(0,0) +
      D11_B0(0,0)*wk7_B0(0,0)*SD111_B0(0,0) + D11_B0(0,0)*wk10_B0(0,0)*SD011_B0(0,0) +
      2*D01_B0(0,0)*D11_B0(0,0)*wk0_B0(0,0) - (2.0/3.0)*D00_B0(0,0)*wk1_B0(0,0)*SD110_B0(0,0) -
      (2.0/3.0)*D00_B0(0,0)*wk4_B0(0,0)*SD010_B0(0,0) - (2.0/3.0)*D10_B0(0,0)*wk1_B0(0,0)*SD111_B0(0,0) -
      (2.0/3.0)*D10_B0(0,0)*wk4_B0(0,0)*SD011_B0(0,0) + ((1.0/3.0))*D00_B0(0,0)*D01_B0(0,0)*wk14_B0(0,0) +
      ((1.0/3.0))*D00_B0(0,0)*D11_B0(0,0)*wk8_B0(0,0) + ((1.0/3.0))*D01_B0(0,0)*D10_B0(0,0)*wk8_B0(0,0) +
      ((1.0/3.0))*D10_B0(0,0)*D11_B0(0,0)*wk16_B0(0,0) + ((4.0/3.0))*D00_B0(0,0)*wk7_B0(0,0)*SD100_B0(0,0) +
      ((4.0/3.0))*D00_B0(0,0)*wk10_B0(0,0)*SD000_B0(0,0) + ((4.0/3.0))*D10_B0(0,0)*wk7_B0(0,0)*SD101_B0(0,0) +
      ((4.0/3.0))*D10_B0(0,0)*wk10_B0(0,0)*SD001_B0(0,0) +
      ((8.0/3.0))*D00_B0(0,0)*D10_B0(0,0)*wk0_B0(0,0))*invRe*mu_B0(0,0) + Residual1_B0(0,0);

    Residual2_B0(0,0) = (D00_B0(0,0)*wk6_B0(0,0) + D10_B0(0,0)*wk11_B0(0,0))*(D00_B0(0,0)*wk4_B0(0,0) +
      D01_B0(0,0)*wk10_B0(0,0) + D10_B0(0,0)*wk1_B0(0,0) + D11_B0(0,0)*wk7_B0(0,0))*invRe + (D01_B0(0,0)*wk6_B0(0,0) +
      D11_B0(0,0)*wk11_B0(0,0))*(-(2.0/3.0)*D00_B0(0,0)*wk10_B0(0,0) - (2.0/3.0)*D10_B0(0,0)*wk7_B0(0,0) +
      ((4.0/3.0))*D01_B0(0,0)*wk4_B0(0,0) + ((4.0/3.0))*D11_B0(0,0)*wk1_B0(0,0))*invRe +
      ((D00_B0(0,0)*D00_B0(0,0))*wk14_B0(0,0) + (D10_B0(0,0)*D10_B0(0,0))*wk16_B0(0,0) +
      ((4.0/3.0))*(D01_B0(0,0)*D01_B0(0,0))*wk14_B0(0,0) + ((4.0/3.0))*(D11_B0(0,0)*D11_B0(0,0))*wk16_B0(0,0) +
      D00_B0(0,0)*wk1_B0(0,0)*SD100_B0(0,0) + D00_B0(0,0)*wk4_B0(0,0)*SD000_B0(0,0) +
      D00_B0(0,0)*wk7_B0(0,0)*SD110_B0(0,0) + D00_B0(0,0)*wk10_B0(0,0)*SD010_B0(0,0) +
      D10_B0(0,0)*wk1_B0(0,0)*SD101_B0(0,0) + D10_B0(0,0)*wk4_B0(0,0)*SD001_B0(0,0) +
      D10_B0(0,0)*wk7_B0(0,0)*SD111_B0(0,0) + D10_B0(0,0)*wk10_B0(0,0)*SD011_B0(0,0) +
      2*D00_B0(0,0)*D10_B0(0,0)*wk8_B0(0,0) - (2.0/3.0)*D01_B0(0,0)*wk7_B0(0,0)*SD100_B0(0,0) -
      (2.0/3.0)*D01_B0(0,0)*wk10_B0(0,0)*SD000_B0(0,0) - (2.0/3.0)*D11_B0(0,0)*wk7_B0(0,0)*SD101_B0(0,0) -
      (2.0/3.0)*D11_B0(0,0)*wk10_B0(0,0)*SD001_B0(0,0) + ((1.0/3.0))*D00_B0(0,0)*D01_B0(0,0)*wk13_B0(0,0) +
      ((1.0/3.0))*D00_B0(0,0)*D11_B0(0,0)*wk0_B0(0,0) + ((1.0/3.0))*D01_B0(0,0)*D10_B0(0,0)*wk0_B0(0,0) +
      ((1.0/3.0))*D10_B0(0,0)*D11_B0(0,0)*wk15_B0(0,0) + ((4.0/3.0))*D01_B0(0,0)*wk1_B0(0,0)*SD110_B0(0,0) +
      ((4.0/3.0))*D01_B0(0,0)*wk4_B0(0,0)*SD010_B0(0,0) + ((4.0/3.0))*D11_B0(0,0)*wk1_B0(0,0)*SD111_B0(0,0) +
      ((4.0/3.0))*D11_B0(0,0)*wk4_B0(0,0)*SD011_B0(0,0) +
      ((8.0/3.0))*D01_B0(0,0)*D11_B0(0,0)*wk8_B0(0,0))*invRe*mu_B0(0,0) + Residual2_B0(0,0);

    Residual3_B0(0,0) = (D00_B0(0,0)*wk4_B0(0,0) + D10_B0(0,0)*wk1_B0(0,0))*(D00_B0(0,0)*wk4_B0(0,0) +
      D01_B0(0,0)*wk10_B0(0,0) + D10_B0(0,0)*wk1_B0(0,0) + D11_B0(0,0)*wk7_B0(0,0))*invRe*mu_B0(0,0) +
      (D00_B0(0,0)*wk6_B0(0,0) + D10_B0(0,0)*wk11_B0(0,0))*(D00_B0(0,0)*wk4_B0(0,0) + D01_B0(0,0)*wk10_B0(0,0) +
      D10_B0(0,0)*wk1_B0(0,0) + D11_B0(0,0)*wk7_B0(0,0))*invRe*u1_B0(0,0) + (D00_B0(0,0)*wk6_B0(0,0) +
      D10_B0(0,0)*wk11_B0(0,0))*(-(2.0/3.0)*D01_B0(0,0)*wk4_B0(0,0) - (2.0/3.0)*D11_B0(0,0)*wk1_B0(0,0) +
      ((4.0/3.0))*D00_B0(0,0)*wk10_B0(0,0) + ((4.0/3.0))*D10_B0(0,0)*wk7_B0(0,0))*invRe*u0_B0(0,0) +
      (D00_B0(0,0)*wk10_B0(0,0) + D10_B0(0,0)*wk7_B0(0,0))*(-(2.0/3.0)*D01_B0(0,0)*wk4_B0(0,0) -
      (2.0/3.0)*D11_B0(0,0)*wk1_B0(0,0) + ((4.0/3.0))*D00_B0(0,0)*wk10_B0(0,0) +
      ((4.0/3.0))*D10_B0(0,0)*wk7_B0(0,0))*invRe*mu_B0(0,0) + (D01_B0(0,0)*wk4_B0(0,0) +
      D11_B0(0,0)*wk1_B0(0,0))*(-(2.0/3.0)*D00_B0(0,0)*wk10_B0(0,0) - (2.0/3.0)*D10_B0(0,0)*wk7_B0(0,0) +
      ((4.0/3.0))*D01_B0(0,0)*wk4_B0(0,0) + ((4.0/3.0))*D11_B0(0,0)*wk1_B0(0,0))*invRe*mu_B0(0,0) +
      (D01_B0(0,0)*wk6_B0(0,0) + D11_B0(0,0)*wk11_B0(0,0))*(D00_B0(0,0)*wk4_B0(0,0) + D01_B0(0,0)*wk10_B0(0,0) +
      D10_B0(0,0)*wk1_B0(0,0) + D11_B0(0,0)*wk7_B0(0,0))*invRe*u0_B0(0,0) + (D01_B0(0,0)*wk6_B0(0,0) +
      D11_B0(0,0)*wk11_B0(0,0))*(-(2.0/3.0)*D00_B0(0,0)*wk10_B0(0,0) - (2.0/3.0)*D10_B0(0,0)*wk7_B0(0,0) +
      ((4.0/3.0))*D01_B0(0,0)*wk4_B0(0,0) + ((4.0/3.0))*D11_B0(0,0)*wk1_B0(0,0))*invRe*u1_B0(0,0) +
      (D01_B0(0,0)*wk10_B0(0,0) + D11_B0(0,0)*wk7_B0(0,0))*(D00_B0(0,0)*wk4_B0(0,0) + D01_B0(0,0)*wk10_B0(0,0) +
      D10_B0(0,0)*wk1_B0(0,0) + D11_B0(0,0)*wk7_B0(0,0))*invRe*mu_B0(0,0) + ((D00_B0(0,0)*D00_B0(0,0))*wk14_B0(0,0) +
      (D10_B0(0,0)*D10_B0(0,0))*wk16_B0(0,0) + ((4.0/3.0))*(D01_B0(0,0)*D01_B0(0,0))*wk14_B0(0,0) +
      ((4.0/3.0))*(D11_B0(0,0)*D11_B0(0,0))*wk16_B0(0,0) + D00_B0(0,0)*wk1_B0(0,0)*SD100_B0(0,0) +
      D00_B0(0,0)*wk4_B0(0,0)*SD000_B0(0,0) + D00_B0(0,0)*wk7_B0(0,0)*SD110_B0(0,0) +
      D00_B0(0,0)*wk10_B0(0,0)*SD010_B0(0,0) + D10_B0(0,0)*wk1_B0(0,0)*SD101_B0(0,0) +
      D10_B0(0,0)*wk4_B0(0,0)*SD001_B0(0,0) + D10_B0(0,0)*wk7_B0(0,0)*SD111_B0(0,0) +
      D10_B0(0,0)*wk10_B0(0,0)*SD011_B0(0,0) + 2*D00_B0(0,0)*D10_B0(0,0)*wk8_B0(0,0) -
      (2.0/3.0)*D01_B0(0,0)*wk7_B0(0,0)*SD100_B0(0,0) - (2.0/3.0)*D01_B0(0,0)*wk10_B0(0,0)*SD000_B0(0,0) -
      (2.0/3.0)*D11_B0(0,0)*wk7_B0(0,0)*SD101_B0(0,0) - (2.0/3.0)*D11_B0(0,0)*wk10_B0(0,0)*SD001_B0(0,0) +
      ((1.0/3.0))*D00_B0(0,0)*D01_B0(0,0)*wk13_B0(0,0) + ((1.0/3.0))*D00_B0(0,0)*D11_B0(0,0)*wk0_B0(0,0) +
      ((1.0/3.0))*D01_B0(0,0)*D10_B0(0,0)*wk0_B0(0,0) + ((1.0/3.0))*D10_B0(0,0)*D11_B0(0,0)*wk15_B0(0,0) +
      ((4.0/3.0))*D01_B0(0,0)*wk1_B0(0,0)*SD110_B0(0,0) + ((4.0/3.0))*D01_B0(0,0)*wk4_B0(0,0)*SD010_B0(0,0) +
      ((4.0/3.0))*D11_B0(0,0)*wk1_B0(0,0)*SD111_B0(0,0) + ((4.0/3.0))*D11_B0(0,0)*wk4_B0(0,0)*SD011_B0(0,0) +
      ((8.0/3.0))*D01_B0(0,0)*D11_B0(0,0)*wk8_B0(0,0))*invRe*mu_B0(0,0)*u1_B0(0,0) +
      ((D01_B0(0,0)*D01_B0(0,0))*wk13_B0(0,0) + (D11_B0(0,0)*D11_B0(0,0))*wk15_B0(0,0) +
      ((4.0/3.0))*(D00_B0(0,0)*D00_B0(0,0))*wk13_B0(0,0) + ((4.0/3.0))*(D10_B0(0,0)*D10_B0(0,0))*wk15_B0(0,0) +
      D01_B0(0,0)*wk1_B0(0,0)*SD100_B0(0,0) + D01_B0(0,0)*wk4_B0(0,0)*SD000_B0(0,0) +
      D01_B0(0,0)*wk7_B0(0,0)*SD110_B0(0,0) + D01_B0(0,0)*wk10_B0(0,0)*SD010_B0(0,0) +
      D11_B0(0,0)*wk1_B0(0,0)*SD101_B0(0,0) + D11_B0(0,0)*wk4_B0(0,0)*SD001_B0(0,0) +
      ...
      ((4.0/3.0))*D00_B0(0,0)*wk10_B0(0,0)*SD000_B0(0,0) + ((4.0/3.0))*D10_B0(0,0)*wk7_B0(0,0)*SD101_B0(0,0) +
      ((4.0/3.0))*D10_B0(0,0)*wk10_B0(0,0)*SD001_B0(0,0) +
      ((8.0/3.0))*D00_B0(0,0)*D10_B0(0,0)*wk0_B0(0,0))*invRe*mu_B0(0,0)*u0_B0(0,0) + (D00_B0(0,0)*wk2_B0(0,0) +
      D10_B0(0,0)*wk3_B0(0,0))*(D00_B0(0,0)*wk6_B0(0,0) + D10_B0(0,0)*wk11_B0(0,0))*invPr*invRe*inv2Minf*inv_gamma_m1 +
      (D01_B0(0,0)*wk2_B0(0,0) + D11_B0(0,0)*wk3_B0(0,0))*(D01_B0(0,0)*wk6_B0(0,0) +
      D11_B0(0,0)*wk11_B0(0,0))*invPr*invRe*inv2Minf*inv_gamma_m1 + ((D00_B0(0,0)*D00_B0(0,0))*wk9_B0(0,0) +
      (D01_B0(0,0)*D01_B0(0,0))*wk9_B0(0,0) + (D10_B0(0,0)*D10_B0(0,0))*wk12_B0(0,0) +
      (D11_B0(0,0)*D11_B0(0,0))*wk12_B0(0,0) + D00_B0(0,0)*wk2_B0(0,0)*SD000_B0(0,0) +
      D00_B0(0,0)*wk3_B0(0,0)*SD100_B0(0,0) + D01_B0(0,0)*wk2_B0(0,0)*SD010_B0(0,0) +
      D01_B0(0,0)*wk3_B0(0,0)*SD110_B0(0,0) + D10_B0(0,0)*wk2_B0(0,0)*SD001_B0(0,0) +
      D10_B0(0,0)*wk3_B0(0,0)*SD101_B0(0,0) + D11_B0(0,0)*wk2_B0(0,0)*SD011_B0(0,0) +
      D11_B0(0,0)*wk3_B0(0,0)*SD111_B0(0,0) + 2*D00_B0(0,0)*D10_B0(0,0)*wk5_B0(0,0) +
      2*D01_B0(0,0)*D11_B0(0,0)*wk5_B0(0,0))*invPr*invRe*inv2Minf*inv_gamma_m1*mu_B0(0,0) + Residual3_B0(0,0);
