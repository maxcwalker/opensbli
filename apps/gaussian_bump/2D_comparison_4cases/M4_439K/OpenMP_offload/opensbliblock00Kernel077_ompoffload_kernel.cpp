...
void ops_par_loop_opensbliblock00Kernel077_execute(ops_kernel_descriptor *desc) {
  ...
  for ( int n_y=start1; n_y<end1; n_y++ ){
    for ( int n_x=start0; n_x<end0; n_x++ ){
      ACC<double> D00_B0(xdim0_opensbliblock00Kernel077, D00_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel077*1);
      ACC<double> D01_B0(xdim1_opensbliblock00Kernel077, D01_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel077*1);
      ACC<double> D10_B0(xdim2_opensbliblock00Kernel077, D10_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel077*1);
...
void ops_par_loop_opensbliblock00Kernel077(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4) {
  ...
  create_kerneldesc_and_enque(name, args, 5, 9, dim, 0, range, block, ops_par_loop_opensbliblock00Kernel077_execute);
}
#endif
