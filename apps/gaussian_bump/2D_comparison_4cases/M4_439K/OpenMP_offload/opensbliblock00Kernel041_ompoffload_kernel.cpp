...
void ops_par_loop_opensbliblock00Kernel041_execute(ops_kernel_descriptor *desc) {
  ...
  double * __restrict__ wk0_B0_p = (double *)(args[16].data_d + base16);

  int base17 = args[17].dat->base_offset;
  double * __restrict__ wk1_B0_p = (double *)(args[17].data_d + base17);

  int base18 = args[18].dat->base_offset;
  double * __restrict__ wk2_B0_p = (double *)(args[18].data_d + base18);

  int base19 = args[19].dat->base_offset;
  double * __restrict__ wk3_B0_p = (double *)(args[19].data_d + base19);

  int base20 = args[20].dat->base_offset;
  double * __restrict__ wk4_B0_p = (double *)(args[20].data_d + base20);

  int base21 = args[21].dat->base_offset;
  double * __restrict__ wk5_B0_p = (double *)(args[21].data_d + base21);

  int base22 = args[22].dat->base_offset;
  double * __restrict__ Residual1_B0_p = (double *)(args[22].data_d + base22);

  int base23 = args[23].dat->base_offset;
  double * __restrict__ Residual2_B0_p = (double *)(args[23].data_d + base23);

  int base24 = args[24].dat->base_offset;
  double * __restrict__ Residual3_B0_p = (double *)(args[24].data_d + base24);
