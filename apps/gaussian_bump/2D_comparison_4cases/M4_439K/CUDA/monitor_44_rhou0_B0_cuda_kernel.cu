...
void ops_par_loop_monitor_44_rhou0_B0_execute(ops_kernel_descriptor *desc) {
  ...
  if (block->instance->OPS_diags > 1) {
    ops_timing_realloc(block->instance,97,"monitor_44_rhou0_B0");
...
void ops_par_loop_monitor_44_rhou0_B0(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1) {
  ...
  create_kerneldesc_and_enque(name, args, 2, 97, dim, 1, range, block, ops_par_loop_monitor_44_rhou0_B0_execute);
}
#endif
