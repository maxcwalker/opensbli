...
void opensbliblock00Kernel028_gpu(const ACC<double> &wk10_B0,
  ACC<double> &wk0_B0,
  const int *idx)
{
...
void ops_par_loop_opensbliblock00Kernel028(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  create_kerneldesc_and_enque(name, args, 3, 48, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel028_execute);
}
#endif
