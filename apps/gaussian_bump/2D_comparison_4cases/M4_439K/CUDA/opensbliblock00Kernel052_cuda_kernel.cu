...
//
__constant__ int dims_opensbliblock00Kernel052 [12][1];
static int dims_opensbliblock00Kernel052_h [12][1] = {{0}};

//user function
__device__

 void opensbliblock00Kernel052_gpu(const ACC<double> &x0_B0,
...
int size1 ){
  ...
  if (idx_x < size0 && idx_y < size1) {
    ...
    ACC<double> argp6(dims_opensbliblock00Kernel052[6][0], arg6);
    ACC<double> argp7(dims_opensbliblock00Kernel052[7][0], arg7);
    ACC<double> argp8(dims_opensbliblock00Kernel052[8][0], arg8);
    ACC<double> argp9(dims_opensbliblock00Kernel052[9][0], arg9);
    ACC<double> argp10(dims_opensbliblock00Kernel052[10][0], arg10);
...
void ops_par_loop_opensbliblock00Kernel052_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_opensbliblock00Kernel052_h[0][0] || xdim1 != dims_opensbliblock00Kernel052_h[1][0] || xdim2 != dims_opensbliblock00Kernel052_h[2][0] || xdim3 != dims_opensbliblock00Kernel052_h[3][0] || xdim4 != dims_opensbliblock00Kernel052_h[4][0] || xdim5 != dims_opensbliblock00Kernel052_h[5][0] || xdim6 != dims_opensbliblock00Kernel052_h[6][0] || xdim7 != dims_opensbliblock00Kernel052_h[7][0] || xdim8 != dims_opensbliblock00Kernel052_h[8][0] || xdim9 != dims_opensbliblock00Kernel052_h[9][0] || xdim10 != dims_opensbliblock00Kernel052_h[10][0]) {
...
void ops_par_loop_opensbliblock00Kernel052(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg8, ops_arg arg9, ops_arg arg10, ops_arg arg11) {
  ...
  create_kerneldesc_and_enque(name, args, 12, 1, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel052_execute);
}
#endif
