...
void ops_par_loop_opensbliblock00Kernel045_execute(ops_kernel_descriptor *desc) {
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
      ACC<double> rhoE_B0(xdim0_opensbliblock00Kernel045, rhoE_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel045*1);
      ACC<double> rho_B0(xdim1_opensbliblock00Kernel045, rho_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel045*1);
      ACC<double> rhou0_B0(xdim2_opensbliblock00Kernel045, rhou0_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel045*1);
      ACC<double> rhou1_B0(xdim3_opensbliblock00Kernel045, rhou1_B0_p + n_x*1 + n_y * xdim3_opensbliblock00Kernel045*1);
...
void ops_par_loop_opensbliblock00Kernel045(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2, ops_arg arg3) {
  ...
  create_kerneldesc_and_enque(name, args, 4, 7, dim, 0, range, block, ops_par_loop_opensbliblock00Kernel045_execute);
}
#endif
