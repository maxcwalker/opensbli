...
void ops_par_loop_opensbliblock00Kernel055_execute(ops_kernel_descriptor *desc) {
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
      ACC<double> D00_B0(xdim0_opensbliblock00Kernel055, D00_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel055*1);
...
void ops_par_loop_opensbliblock00Kernel055(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4) {
  ...
  create_kerneldesc_and_enque(name, args, 5, 4, dim, 0, range, block, ops_par_loop_opensbliblock00Kernel055_execute);
}
#endif
