...
//
    ...
    void buildOpenCLKernels_opensbliblock00Kernel048(OPS_instance *instance, int xdim0, int xdim1, int xdim2, int xdim3) {
      ...
      if(!isbuilt_opensbliblock00Kernel048) {
        ...
        instance->ostream() <<"Compiling opensbliblock00Kernel048 "<<OCL_FMA<<" source -- start \n";
          ...
          if (pPath!=NULL)
            if(OCL_FMA)
              sprintf(buildOpts,"-cl-mad-enable -DOCL_FMA -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_opensbliblock00Kernel048=%d  -Dxdim1_opensbliblock00Kernel048=%d  -Dxdim2_opensbliblock00Kernel048=%d  -Dxdim3_opensbliblock00Kernel048=%d ", pPath, 32,xdim0,xdim1,xdim2,xdim3);
            else
              sprintf(buildOpts,"-cl-mad-enable -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_opensbliblock00Kernel048=%d  -Dxdim1_opensbliblock00Kernel048=%d  -Dxdim2_opensbliblock00Kernel048=%d  -Dxdim3_opensbliblock00Kernel048=%d ", pPath, 32,xdim0,xdim1,xdim2,xdim3);
          else {
        ...
        instance->opencl_instance->OPS_opencl_core.kernel[10] = clCreateKernel(instance->opencl_instance->OPS_opencl_core.program, "ops_opensbliblock00Kernel048", &ret);
        clSafeCall( ret );
...
void ops_par_loop_opensbliblock00Kernel048(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2, ops_arg arg3) {
  ...
  #ifdef CHECKPOINTING
  if (!ops_checkpointing_before(args,4,range,10)) return;
  #endif

  if (block->instance->OPS_diags > 1) {
    ops_timing_realloc(block->instance,10,"opensbliblock00Kernel048");
  ...
  if (globalWorkSize[0]>0 && globalWorkSize[1]>0 && globalWorkSize[2]>0) {
    ...
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[10], 6, sizeof(cl_int), (void*) &base2 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[10], 7, sizeof(cl_int), (void*) &base3 ));
