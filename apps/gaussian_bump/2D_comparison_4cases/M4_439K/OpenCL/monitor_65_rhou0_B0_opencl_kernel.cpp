...
//
    ...
    void buildOpenCLKernels_monitor_65_rhou0_B0(OPS_instance *instance, int xdim0) {
      ...
      if(!isbuilt_monitor_65_rhou0_B0) {
        ...
        instance->ostream() <<"Compiling monitor_65_rhou0_B0 "<<OCL_FMA<<" source -- start \n";
          ...
          if (pPath!=NULL)
            if(OCL_FMA)
              sprintf(buildOpts,"-cl-mad-enable -DOCL_FMA -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_monitor_65_rhou0_B0=%d ", pPath, 32,xdim0);
            else
              sprintf(buildOpts,"-cl-mad-enable -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_monitor_65_rhou0_B0=%d ", pPath, 32,xdim0);
          else {
        ...
        instance->opencl_instance->OPS_opencl_core.kernel[118] = clCreateKernel(instance->opencl_instance->OPS_opencl_core.program, "ops_monitor_65_rhou0_B0", &ret);
        clSafeCall( ret );
...
void ops_par_loop_monitor_65_rhou0_B0(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1) {
  ...
  if (block->instance->OPS_diags > 1) {
    ops_timing_realloc(block->instance,118,"monitor_65_rhou0_B0");
