...
void ops_par_loop_opensbliblock00Kernel090_execute(ops_kernel_descriptor *desc) {
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
      const ACC<double> wk0_B0(xdim0_opensbliblock00Kernel090, wk0_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel090*1);
      const ACC<double> wk1_B0(xdim1_opensbliblock00Kernel090, wk1_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel090*1);
      const ACC<double> wk2_B0(xdim2_opensbliblock00Kernel090, wk2_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel090*1);
      ...
      const ACC<double> wk5_B0(xdim5_opensbliblock00Kernel090, wk5_B0_p + n_x*1 + n_y * xdim5_opensbliblock00Kernel090*1);
      const ACC<double> wk6_B0(xdim6_opensbliblock00Kernel090, wk6_B0_p + n_x*1 + n_y * xdim6_opensbliblock00Kernel090*1);
      const ACC<double> wk7_B0(xdim7_opensbliblock00Kernel090, wk7_B0_p + n_x*1 + n_y * xdim7_opensbliblock00Kernel090*1);
      ACC<double> SD000_B0(xdim8_opensbliblock00Kernel090, SD000_B0_p + n_x*1 + n_y * xdim8_opensbliblock00Kernel090*1);
      ...
      ACC<double> SD011_B0(xdim11_opensbliblock00Kernel090, SD011_B0_p + n_x*1 + n_y * xdim11_opensbliblock00Kernel090*1);
      ACC<double> SD100_B0(xdim12_opensbliblock00Kernel090, SD100_B0_p + n_x*1 + n_y * xdim12_opensbliblock00Kernel090*1);
      ACC<double> SD101_B0(xdim13_opensbliblock00Kernel090, SD101_B0_p + n_x*1 + n_y * xdim13_opensbliblock00Kernel090*1);
...
void ops_par_loop_opensbliblock00Kernel090(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg12, ops_arg arg13, ops_arg arg14, ops_arg arg15) {
  ...
  create_kerneldesc_and_enque(name, args, 16, 18, dim, 0, range, block, ops_par_loop_opensbliblock00Kernel090_execute);
}
#endif
