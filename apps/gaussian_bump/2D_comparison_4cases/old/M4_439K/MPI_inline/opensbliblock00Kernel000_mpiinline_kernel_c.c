...
void opensbliblock00Kernel000_c_wrapper(
  ...
  for ( int n_y=0; n_y<y_size; n_y++ ){
    for ( int n_x=0; n_x<x_size; n_x++ ){
      ...
      const ptr_double detJ_B0 = { detJ_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel000*1, xdim4_opensbliblock00Kernel000};
      const ptr_double p_B0 = { p_B0_p + n_x*1 + n_y * xdim5_opensbliblock00Kernel000*1, xdim5_opensbliblock00Kernel000};
      const ptr_double rhoE_B0 = { rhoE_B0_p + n_x*1 + n_y * xdim6_opensbliblock00Kernel000*1, xdim6_opensbliblock00Kernel000};
      const ptr_double rho_B0 = { rho_B0_p + n_x*1 + n_y * xdim7_opensbliblock00Kernel000*1, xdim7_opensbliblock00Kernel000};
      const ptr_double rhou0_B0 = { rhou0_B0_p + n_x*1 + n_y * xdim8_opensbliblock00Kernel000*1, xdim8_opensbliblock00Kernel000};
