...
void opensbliblock00Kernel001_c_wrapper(
  ...
  for ( int n_y=0; n_y<y_size; n_y++ ){
    for ( int n_x=0; n_x<x_size; n_x++ ){
      ...
      const ptr_double rhoE_B0 = { rhoE_B0_p + n_x*1 + n_y * xdim6_opensbliblock00Kernel001*1, xdim6_opensbliblock00Kernel001};
      const ptr_double rho_B0 = { rho_B0_p + n_x*1 + n_y * xdim7_opensbliblock00Kernel001*1, xdim7_opensbliblock00Kernel001};
   ...
   CS_15 = OPS_ACC(rho_B0, 0,3)*AVG_1_1_LEV_10 + OPS_ACC(rhou0_B0, 0,3)*AVG_1_1_LEV_11 + OPS_ACC(rhou1_B0, 0,3)*AVG_1_1_LEV_12;
    ...
    max_lambda_00 = shock_filter_control*fmax(fabs(OPS_ACC(u0_B0, 0,1)*OPS_ACC(D10_B0, 0,1)*OPS_ACC(detJ_B0, 0,1) +
      OPS_ACC(u1_B0, 0,1)*OPS_ACC(D11_B0, 0,1)*OPS_ACC(detJ_B0, 0,1)), fabs(OPS_ACC(u0_B0, 0,0)*OPS_ACC(D10_B0, 0,0)*OPS_ACC(detJ_B0, 0,0) +
