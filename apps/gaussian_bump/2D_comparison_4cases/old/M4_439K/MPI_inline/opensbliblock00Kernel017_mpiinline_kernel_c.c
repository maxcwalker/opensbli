...
void opensbliblock00Kernel017_c_wrapper(
  ...
  for ( int n_y=0; n_y<y_size; n_y++ ){
    for ( int n_x=0; n_x<x_size; n_x++ ){
      ...
      const ptr_double wk5_B0 = { wk5_B0_p + n_x*1 + n_y * xdim6_opensbliblock00Kernel017*1, xdim6_opensbliblock00Kernel017};
      const ptr_double wk6_B0 = { wk6_B0_p + n_x*1 + n_y * xdim7_opensbliblock00Kernel017*1, xdim7_opensbliblock00Kernel017};
      const ptr_double wk7_B0 = { wk7_B0_p + n_x*1 + n_y * xdim8_opensbliblock00Kernel017*1, xdim8_opensbliblock00Kernel017};
