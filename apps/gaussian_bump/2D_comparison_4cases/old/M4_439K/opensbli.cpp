...
ops_par_loop(opensbliblock00Kernel079, "MetricsEquation CD D00_B0 xi0 ", opensbliblock00, 2, iteration_range_79_block0,
...
ops_par_loop(opensbliblock00Kernel012, "CRu1", opensbliblock00, 2, iteration_range_12_block0,
ops_arg_dat(rho_B0, 1, stencil_0_00_00_2, "double", OPS_READ),
...
ops_par_loop(opensbliblock00Kernel036, "Viscous CD u0_B0 xi1 xi1 ", opensbliblock00, 2, iteration_range_36_block0,
ops_arg_dat(u0_B0, 1, stencil_0_00_24_8, "double", OPS_READ),
...
ops_par_loop(opensbliblock00Kernel042, "Viscous CD u0_B0 xi0 ", opensbliblock00, 2, iteration_range_42_block0,
ops_arg_dat(u0_B0, 1, stencil_0_44_00_10, "double", OPS_READ),
ops_arg_dat(wk14_B0, 1, stencil_0_00_00_2, "double", OPS_WRITE),
ops_arg_idx());

int iteration_range_43_block0[] = {0, block0np0, 0, block0np1};
ops_par_loop(opensbliblock00Kernel043, "Viscous CD T_B0 xi1 ", opensbliblock00, 2, iteration_range_43_block0,
ops_arg_dat(T_B0, 1, stencil_0_00_24_8, "double", OPS_READ),
ops_arg_dat(wk15_B0, 1, stencil_0_00_00_2, "double", OPS_WRITE),
ops_arg_idx());

int iteration_range_44_block0[] = {0, block0np0, 0, block0np1};
ops_par_loop(opensbliblock00Kernel044, "Viscous CD u1_B0 xi1 ", opensbliblock00, 2, iteration_range_44_block0,
ops_arg_dat(u1_B0, 1, stencil_0_00_24_8, "double", OPS_READ),
ops_arg_dat(wk16_B0, 1, stencil_0_00_00_2, "double", OPS_WRITE),
ops_arg_idx());

int iteration_range_33_block0[] = {0, block0np0, 0, block0np1};
ops_par_loop(opensbliblock00Kernel033, "Viscous CD CD u1_B0 xi0 xi1 ", opensbliblock00, 2, iteration_range_33_block0,
