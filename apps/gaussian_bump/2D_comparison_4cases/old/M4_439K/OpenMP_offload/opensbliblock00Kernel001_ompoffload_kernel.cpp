...
void ops_par_loop_opensbliblock00Kernel001_execute(ops_kernel_descriptor *desc) {
  ...
  double * __restrict__ wk4_B0_p = (double *)(args[12].data_d + base12);

  int base13 = args[13].dat->base_offset;
  double * __restrict__ wk5_B0_p = (double *)(args[13].data_d + base13);

  int base14 = args[14].dat->base_offset;
  double * __restrict__ wk6_B0_p = (double *)(args[14].data_d + base14);

  int base15 = args[15].dat->base_offset;
  double * __restrict__ wk7_B0_p = (double *)(args[15].data_d + base15);
  ...
  for ( int n_y=start1; n_y<end1; n_y++ ){
    for ( int n_x=start0; n_x<end0; n_x++ ){
      ...
      const ACC<double> rhoE_B0(xdim6_opensbliblock00Kernel001, rhoE_B0_p + n_x*1 + n_y * xdim6_opensbliblock00Kernel001*1);
      const ACC<double> rho_B0(xdim7_opensbliblock00Kernel001, rho_B0_p + n_x*1 + n_y * xdim7_opensbliblock00Kernel001*1);
...
void ops_par_loop_opensbliblock00Kernel001(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg12, ops_arg arg13, ops_arg arg14, ops_arg arg15) {
  ...
  create_kerneldesc_and_enque(name, args, 16, 32, dim, 0, range, block, ops_par_loop_opensbliblock00Kernel001_execute);
}
#endif
