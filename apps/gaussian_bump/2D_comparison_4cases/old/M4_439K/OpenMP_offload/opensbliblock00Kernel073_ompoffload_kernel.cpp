...
void ops_par_loop_opensbliblock00Kernel073_execute(ops_kernel_descriptor *desc) {
  ...
  for ( int n_y=start1; n_y<end1; n_y++ ){
    for ( int n_x=start0; n_x<end0; n_x++ ){
      const ACC<double> wk1_B0(xdim0_opensbliblock00Kernel073, wk1_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel073*1);
      const ACC<double> wk2_B0(xdim1_opensbliblock00Kernel073, wk2_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel073*1);
      ACC<double> D00_B0(xdim2_opensbliblock00Kernel073, D00_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel073*1);
      ACC<double> D01_B0(xdim3_opensbliblock00Kernel073, D01_B0_p + n_x*1 + n_y * xdim3_opensbliblock00Kernel073*1);
      ...
      ACC<double> wk0_B0(xdim7_opensbliblock00Kernel073, wk0_B0_p + n_x*1 + n_y * xdim7_opensbliblock00Kernel073*1);
