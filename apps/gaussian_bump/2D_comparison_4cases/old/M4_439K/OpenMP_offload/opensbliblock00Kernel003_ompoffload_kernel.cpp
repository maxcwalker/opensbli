...
void ops_par_loop_opensbliblock00Kernel003_execute(ops_kernel_descriptor *desc) {
  ...
  for ( int n_y=start1; n_y<end1; n_y++ ){
    for ( int n_x=start0; n_x<end0; n_x++ ){
      ...
      const ACC<double> u0_B0(xdim2_opensbliblock00Kernel003, u0_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel003*1);
      const ACC<double> u1_B0(xdim3_opensbliblock00Kernel003, u1_B0_p + n_x*1 + n_y * xdim3_opensbliblock00Kernel003*1);
      ACC<double> p_B0(xdim4_opensbliblock00Kernel003, p_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel003*1);
...
void ops_par_loop_opensbliblock00Kernel003(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4) {
  ...
  create_kerneldesc_and_enque(name, args, 5, 25, dim, 0, range, block, ops_par_loop_opensbliblock00Kernel003_execute);
}
#endif
