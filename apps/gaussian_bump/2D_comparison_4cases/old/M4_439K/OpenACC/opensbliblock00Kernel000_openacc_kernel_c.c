  ...
  ptr_double wk3_B0)
{
   ...
   AVG_0_u0 = (sqrt(OPS_ACC(rho_B0, 0,0))*OPS_ACC(u0_B0, 0,0) + sqrt(OPS_ACC(rho_B0, 1,0))*OPS_ACC(u0_B0, 1,0))*AVG_0_inv_rho;

   AVG_0_u1 = (sqrt(OPS_ACC(rho_B0, 0,0))*OPS_ACC(u1_B0, 0,0) + sqrt(OPS_ACC(rho_B0, 1,0))*OPS_ACC(u1_B0, 1,0))*AVG_0_inv_rho;

    AVG_0_a = sqrt((-(1.0/2.0)*((AVG_0_u0*AVG_0_u0) + (AVG_0_u1*AVG_0_u1)) + ((OPS_ACC(p_B0, 0,0) +
      OPS_ACC(rhoE_B0, 0,0))/sqrt(OPS_ACC(rho_B0, 0,0)) + (OPS_ACC(p_B0, 1,0) + OPS_ACC(rhoE_B0, 1,0))/sqrt(OPS_ACC(rho_B0, 1,0)))*AVG_0_inv_rho)*gamma_m1);
   ...
   max_lambda_11 = max_lambda_00;
    ...
    max_lambda_22 = shock_filter_control*fmax(fabs(sqrt((OPS_ACC(D00_B0, 1,0)*OPS_ACC(D00_B0, 1,0))*(OPS_ACC(detJ_B0, 1,0)*OPS_ACC(detJ_B0, 1,0)) +
    ...
    max_lambda_33 = shock_filter_control*fmax(fabs(-sqrt((OPS_ACC(D00_B0, 0,0)*OPS_ACC(D00_B0, 0,0))*(OPS_ACC(detJ_B0, 0,0)*OPS_ACC(detJ_B0, 0,0)) +
      (OPS_ACC(D01_B0, 0,0)*OPS_ACC(D01_B0, 0,0))*(OPS_ACC(detJ_B0, 0,0)*OPS_ACC(detJ_B0, 0,0)))*OPS_ACC(a_B0, 0,0) + OPS_ACC(u0_B0, 0,0)*OPS_ACC(D00_B0, 0,0)*OPS_ACC(detJ_B0, 0,0) +
