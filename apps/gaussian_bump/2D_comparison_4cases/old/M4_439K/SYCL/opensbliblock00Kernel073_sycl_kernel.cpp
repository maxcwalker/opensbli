  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      , [=](cl::sycl::nd_item<2> item
        ...
        const ACC<double> wk1_B0(xdim0_opensbliblock00Kernel073, &wk1_B0_p[0] + base0 + n_x*1 + n_y * xdim0_opensbliblock00Kernel073*1);
        const ACC<double> wk2_B0(xdim1_opensbliblock00Kernel073, &wk2_B0_p[0] + base1 + n_x*1 + n_y * xdim1_opensbliblock00Kernel073*1);
        ACC<double> D00_B0(xdim2_opensbliblock00Kernel073, &D00_B0_p[0] + base2 + n_x*1 + n_y * xdim2_opensbliblock00Kernel073*1);
        ACC<double> D01_B0(xdim3_opensbliblock00Kernel073, &D01_B0_p[0] + base3 + n_x*1 + n_y * xdim3_opensbliblock00Kernel073*1);
        ACC<double> D10_B0(xdim4_opensbliblock00Kernel073, &D10_B0_p[0] + base4 + n_x*1 + n_y * xdim4_opensbliblock00Kernel073*1);
        ACC<double> D11_B0(xdim5_opensbliblock00Kernel073, &D11_B0_p[0] + base5 + n_x*1 + n_y * xdim5_opensbliblock00Kernel073*1);
        ACC<double> detJ_B0(xdim6_opensbliblock00Kernel073, &detJ_B0_p[0] + base6 + n_x*1 + n_y * xdim6_opensbliblock00Kernel073*1);
        ACC<double> wk0_B0(xdim7_opensbliblock00Kernel073, &wk0_B0_p[0] + base7 + n_x*1 + n_y * xdim7_opensbliblock00Kernel073*1);
