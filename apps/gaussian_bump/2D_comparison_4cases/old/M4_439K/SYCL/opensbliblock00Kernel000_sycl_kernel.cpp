 ...
 arg15};
  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      cgh.parallel_for<class opensbliblock00Kernel000_kernel>(cl::sycl::nd_range<2>(cl::sycl::range<2>(
      ...
      , [=](cl::sycl::nd_item<2> item
        ...
        const ACC<double> D00_B0(xdim0_opensbliblock00Kernel000, &D00_B0_p[0] + base0 + n_x*1 + n_y * xdim0_opensbliblock00Kernel000*1);
        const ACC<double> D01_B0(xdim1_opensbliblock00Kernel000, &D01_B0_p[0] + base1 + n_x*1 + n_y * xdim1_opensbliblock00Kernel000*1);
        const ACC<double> U0_B0(xdim2_opensbliblock00Kernel000, &U0_B0_p[0] + base2 + n_x*1 + n_y * xdim2_opensbliblock00Kernel000*1);
        const ACC<double> a_B0(xdim3_opensbliblock00Kernel000, &a_B0_p[0] + base3 + n_x*1 + n_y * xdim3_opensbliblock00Kernel000*1);
        const ACC<double> detJ_B0(xdim4_opensbliblock00Kernel000, &detJ_B0_p[0] + base4 + n_x*1 + n_y * xdim4_opensbliblock00Kernel000*1);
        const ACC<double> p_B0(xdim5_opensbliblock00Kernel000, &p_B0_p[0] + base5 + n_x*1 + n_y * xdim5_opensbliblock00Kernel000*1);
        const ACC<double> rhoE_B0(xdim6_opensbliblock00Kernel000, &rhoE_B0_p[0] + base6 + n_x*1 + n_y * xdim6_opensbliblock00Kernel000*1);
        const ACC<double> rho_B0(xdim7_opensbliblock00Kernel000, &rho_B0_p[0] + base7 + n_x*1 + n_y * xdim7_opensbliblock00Kernel000*1);
        const ACC<double> rhou0_B0(xdim8_opensbliblock00Kernel000, &rhou0_B0_p[0] + base8 + n_x*1 + n_y * xdim8_opensbliblock00Kernel000*1);
        const ACC<double> rhou1_B0(xdim9_opensbliblock00Kernel000, &rhou1_B0_p[0] + base9 + n_x*1 + n_y * xdim9_opensbliblock00Kernel000*1);
        const ACC<double> u0_B0(xdim10_opensbliblock00Kernel000, &u0_B0_p[0] + base10 + n_x*1 + n_y * xdim10_opensbliblock00Kernel000*1);
        const ACC<double> u1_B0(xdim11_opensbliblock00Kernel000, &u1_B0_p[0] + base11 + n_x*1 + n_y * xdim11_opensbliblock00Kernel000*1);
        ACC<double> wk0_B0(xdim12_opensbliblock00Kernel000, &wk0_B0_p[0] + base12 + n_x*1 + n_y * xdim12_opensbliblock00Kernel000*1);
        ACC<double> wk1_B0(xdim13_opensbliblock00Kernel000, &wk1_B0_p[0] + base13 + n_x*1 + n_y * xdim13_opensbliblock00Kernel000*1);
        ACC<double> wk2_B0(xdim14_opensbliblock00Kernel000, &wk2_B0_p[0] + base14 + n_x*1 + n_y * xdim14_opensbliblock00Kernel000*1);
        ACC<double> wk3_B0(xdim15_opensbliblock00Kernel000, &wk3_B0_p[0] + base15 + n_x*1 + n_y * xdim15_opensbliblock00Kernel000*1);
        //USER CODE
   ...
   AVG_0_0_LEV_12 = -AVG_0_D00*inv_AVG_met_fact*inv_AVG_rho;
    ...
    AVG_0_0_LEV_20 = -0.353553390593274*((AVG_0_u0*AVG_0_u0) + (AVG_0_u1*AVG_0_u1) - (AVG_0_u0*AVG_0_u0)*gama_sycl[0] -
      (AVG_0_u1*AVG_0_u1)*gama_sycl[0] + 2*AVG_0_D00*AVG_0_a*AVG_0_u0*inv_AVG_met_fact +
      2*AVG_0_D01*AVG_0_a*AVG_0_u1*inv_AVG_met_fact)*inv_AVG_a*inv_AVG_rho;

    AVG_0_0_LEV_21 = 0.707106781186547*(-gama_sycl[0]*AVG_0_u0 + AVG_0_D00*AVG_0_a*inv_AVG_met_fact +
      AVG_0_u0)*inv_AVG_a*inv_AVG_rho;

    AVG_0_0_LEV_22 = 0.707106781186547*(-gama_sycl[0]*AVG_0_u1 + AVG_0_D01*AVG_0_a*inv_AVG_met_fact +
   ...
   AVG_0_0_LEV_23 = 0.707106781186547*gamma_m1_sycl[0]*inv_AVG_a*inv_AVG_rho;
    ...
    AVG_0_0_LEV_31 = -0.707106781186547*(-AVG_0_u0 + gama_sycl[0]*AVG_0_u0 +
      AVG_0_D00*AVG_0_a*inv_AVG_met_fact)*inv_AVG_a*inv_AVG_rho;

    AVG_0_0_LEV_32 = -0.707106781186547*(-AVG_0_u1 + gama_sycl[0]*AVG_0_u1 +
   ...
   CS_15 = rho_B0(3,0)*AVG_0_0_LEV_10 + rhou0_B0(3,0)*AVG_0_0_LEV_11 + rhou1_B0(3,0)*AVG_0_0_LEV_12;
    ...
    max_lambda_00 = shock_filter_control_sycl[0]*cl::sycl::fmax(cl::sycl::fabs(u0_B0(0,0)*D00_B0(0,0)*detJ_B0(0,0) +
      u1_B0(0,0)*D01_B0(0,0)*detJ_B0(0,0)), cl::sycl::fabs(u0_B0(1,0)*D00_B0(1,0)*detJ_B0(1,0) +
      u1_B0(1,0)*D01_B0(1,0)*detJ_B0(1,0)));

   max_lambda_11 = max_lambda_00;

    max_lambda_22 = shock_filter_control_sycl[0]*cl::sycl::fmax(cl::sycl::fabs(cl::sycl::sqrt((D00_B0(1,0)*D00_B0(1,0))*(detJ_B0(1,0)*detJ_B0(1,0)) +
      (D01_B0(1,0)*D01_B0(1,0))*(detJ_B0(1,0)*detJ_B0(1,0)))*a_B0(1,0) + u0_B0(1,0)*D00_B0(1,0)*detJ_B0(1,0) +
      u1_B0(1,0)*D01_B0(1,0)*detJ_B0(1,0)), cl::sycl::fabs(cl::sycl::sqrt((D00_B0(0,0)*D00_B0(0,0))*(detJ_B0(0,0)*detJ_B0(0,0)) +
      (D01_B0(0,0)*D01_B0(0,0))*(detJ_B0(0,0)*detJ_B0(0,0)))*a_B0(0,0) + u0_B0(0,0)*D00_B0(0,0)*detJ_B0(0,0) +
      u1_B0(0,0)*D01_B0(0,0)*detJ_B0(0,0)));

    max_lambda_33 = shock_filter_control_sycl[0]*cl::sycl::fmax(cl::sycl::fabs(-cl::sycl::sqrt((D00_B0(0,0)*D00_B0(0,0))*(detJ_B0(0,0)*detJ_B0(0,0)) +
      (D01_B0(0,0)*D01_B0(0,0))*(detJ_B0(0,0)*detJ_B0(0,0)))*a_B0(0,0) + u0_B0(0,0)*D00_B0(0,0)*detJ_B0(0,0) +
      u1_B0(0,0)*D01_B0(0,0)*detJ_B0(0,0)), cl::sycl::fabs(-cl::sycl::sqrt((D00_B0(1,0)*D00_B0(1,0))*(detJ_B0(1,0)*detJ_B0(1,0)) +
      (D01_B0(1,0)*D01_B0(1,0))*(detJ_B0(1,0)*detJ_B0(1,0)))*a_B0(1,0) + u0_B0(1,0)*D00_B0(1,0)*detJ_B0(1,0) +
      u1_B0(1,0)*D01_B0(1,0)*detJ_B0(1,0)));
   ...
   omega_2 = alpha_2*inv_alpha_sum;
    ...
    wk3_B0(0,0) = (((1.0/2.0))*(AVG_0_u0*AVG_0_u0) + ((1.0/2.0))*(AVG_0_u1*AVG_0_u1))*Recon_0 +
      ...
      (AVG_0_u1*AVG_0_u1))*gamma_m1_sycl[0])*invgamma_m1_sycl[0] + (AVG_0_D00*AVG_0_u0*inv_AVG_met_fact +
      AVG_0_D01*AVG_0_u1*inv_AVG_met_fact)*AVG_0_a)*AVG_0_rho*Recon_2*inv_AVG_a + 0.707106781186547*(((AVG_0_a*AVG_0_a)
      + ((1.0/2.0))*((AVG_0_u0*AVG_0_u0) + (AVG_0_u1*AVG_0_u1))*gamma_m1_sycl[0])*invgamma_m1_sycl[0] -
