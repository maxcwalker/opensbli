 ...
 arg15};
  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0) {
   ...
   CS_15 = rho_B0(0,3)*AVG_1_1_LEV_10 + rhou0_B0(0,3)*AVG_1_1_LEV_11 + rhou1_B0(0,3)*AVG_1_1_LEV_12;
    ...
    max_lambda_00 = shock_filter_control_sycl[0]*cl::sycl::fmax(cl::sycl::fabs(u0_B0(0,1)*D10_B0(0,1)*detJ_B0(0,1) +
      u1_B0(0,1)*D11_B0(0,1)*detJ_B0(0,1)), cl::sycl::fabs(u0_B0(0,0)*D10_B0(0,0)*detJ_B0(0,0) +
