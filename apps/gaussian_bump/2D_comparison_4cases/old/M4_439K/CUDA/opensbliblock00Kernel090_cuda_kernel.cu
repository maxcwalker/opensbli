...
__device__
 ...
 void opensbliblock00Kernel090_gpu(const ACC<double> &wk0_B0,
...
void ops_par_loop_opensbliblock00Kernel090_execute(ops_kernel_descriptor *desc) {
  ...
  if (x_size > 0 && y_size > 0)
    ops_opensbliblock00Kernel090<<<grid, tblock >>> ( 
...
void ops_par_loop_opensbliblock00Kernel090(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg12, ops_arg arg13, ops_arg arg14, ops_arg arg15) {
  ...
  create_kerneldesc_and_enque(name, args, 16, 18, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel090_execute);
}
#endif
