...
ops_par_loop(opensbliblock00Kernel082, "MetricsEquation CD D00_B0 xi0 ", opensbliblock00, 2, iteration_range_82_block0,
...
ops_par_loop(opensbliblock00Kernel029, "Viscous CD u1_B0 xi0 ", opensbliblock00, 2, iteration_range_29_block0,
ops_arg_dat(u1_B0, 1, stencil_0_44_00_10, "double", OPS_READ),
ops_arg_dat(wk1_B0, 1, stencil_0_00_00_2, "double", OPS_WRITE),
ops_arg_idx());

int iteration_range_30_block0[] = {0, block0np0, 0, block0np1};
ops_par_loop(opensbliblock00Kernel030, "Viscous CD u0_B0 xi1 ", opensbliblock00, 2, iteration_range_30_block0,
ops_arg_dat(u0_B0, 1, stencil_0_00_24_8, "double", OPS_READ),
ops_arg_dat(wk2_B0, 1, stencil_0_00_00_2, "double", OPS_WRITE),
ops_arg_idx());

int iteration_range_31_block0[] = {0, block0np0, 0, block0np1};
ops_par_loop(opensbliblock00Kernel031, "Viscous CD T_B0 xi1 xi1 ", opensbliblock00, 2, iteration_range_31_block0,
ops_arg_dat(T_B0, 1, stencil_0_00_24_8, "double", OPS_READ),
ops_arg_dat(wk3_B0, 1, stencil_0_00_00_2, "double", OPS_WRITE),
ops_arg_idx());

int iteration_range_32_block0[] = {0, block0np0, 0, block0np1};
ops_par_loop(opensbliblock00Kernel032, "Viscous CD mu_B0 xi0 ", opensbliblock00, 2, iteration_range_32_block0,
...
ops_par_loop(opensbliblock00Kernel037, "Viscous CD u1_B0 xi1 xi1 ", opensbliblock00, 2, iteration_range_37_block0,
ops_arg_dat(u1_B0, 1, stencil_0_00_24_8, "double", OPS_READ),
ops_arg_dat(wk9_B0, 1, stencil_0_00_00_2, "double", OPS_WRITE),
ops_arg_idx());

int iteration_range_38_block0[] = {0, block0np0, 0, block0np1};
ops_par_loop(opensbliblock00Kernel038, "Viscous CD T_B0 xi0 xi0 ", opensbliblock00, 2, iteration_range_38_block0,
...
ops_par_loop(opensbliblock00Kernel044, "Viscous CD u0_B0 xi0 ", opensbliblock00, 2, iteration_range_44_block0,
ops_arg_dat(u0_B0, 1, stencil_0_44_00_10, "double", OPS_READ),
...
ops_arg_dat(wk16_B0, 1, stencil_0_00_24_8, "double", OPS_READ),
ops_arg_dat(wk5_B0, 1, stencil_0_00_00_2, "double", OPS_WRITE),
ops_arg_idx());
...
ops_arg_dat(wk14_B0, 1, stencil_0_00_24_8, "double", OPS_READ),
ops_arg_dat(wk11_B0, 1, stencil_0_00_00_2, "double", OPS_WRITE),
ops_arg_idx());

int iteration_range_41_block0[] = {0, block0np0, 0, block0np1};
ops_par_loop(opensbliblock00Kernel041, "Viscous CD CD u1_B0 xi0 xi1 ", opensbliblock00, 2, iteration_range_41_block0,
