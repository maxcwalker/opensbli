...
void opensbliblock00Kernel030_gpu(const ACC<double> &wk13_B0,
  ACC<double> &wk2_B0,
  const int *idx)
{
    wk2_B0(0,0) = inv_0*((idx[1] == 0) ? (
   -3*wk13_B0(0,2) + (rc11)*wk13_B0(0,3) -
      rc13*wk13_B0(0,0) - rc12*wk13_B0(0,4) + 4*wk13_B0(0,1)
)
: ((idx[1] == 1) ? (

      -rc12*wk13_B0(0,-1) - rc7*wk13_B0(0,2) + (rc14)*wk13_B0(0,3) -
      rc15*wk13_B0(0,0) + (rc16)*wk13_B0(0,1)
)
: (
   -rc17*wk13_B0(0,-1) -
      rc14*wk13_B0(0,2) + (rc14)*wk13_B0(0,-2) + (rc17)*wk13_B0(0,1)
)));
