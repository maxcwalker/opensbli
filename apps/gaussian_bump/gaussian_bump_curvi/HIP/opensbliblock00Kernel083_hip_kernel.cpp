  ...
  const int *idx)
{
   ...
   -rc13*D01_B0(0,0) + 4*D01_B0(1,0) -
      3*D01_B0(2,0) - rc12*D01_B0(4,0) + (rc11)*D01_B0(3,0)
)
: ((idx[0] == 1) ? (

      -rc12*D01_B0(-1,0) - rc15*D01_B0(0,0) + (rc16)*D01_B0(1,0) -
      rc7*D01_B0(2,0) + (rc14)*D01_B0(3,0)
)
: ((idx[0] == block0np0 - 1) ? (

      (rc12)*D01_B0(-4,0) - rc11*D01_B0(-3,0) + 3*D01_B0(-2,0) - 4*D01_B0(-1,0)
      + (rc13)*D01_B0(0,0)
)
: ((idx[0] == block0np0 - 2) ? (
   -rc14*D01_B0(-3,0) -
      rc16*D01_B0(-1,0) + (rc7)*D01_B0(-2,0) + (rc15)*D01_B0(0,0) +
      (rc12)*D01_B0(1,0)
)
: (
