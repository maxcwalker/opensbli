  ...
  const int *idx)
{
   ...
   4*T_B0(1,0) - rc13*T_B0(0,0) +
      (rc11)*T_B0(3,0) - 3*T_B0(2,0) - rc12*T_B0(4,0)
)
: ((idx[0] == 1) ? (

      (rc16)*T_B0(1,0) - rc15*T_B0(0,0) + (rc14)*T_B0(3,0) - rc7*T_B0(2,0) -
      rc12*T_B0(-1,0)
)
: ((idx[0] == block0np0 - 1) ? (
   -rc11*T_B0(-3,0) +
      (rc13)*T_B0(0,0) + (rc12)*T_B0(-4,0) - 4*T_B0(-1,0) + 3*T_B0(-2,0)
)
:
      ((idx[0] == block0np0 - 2) ? (
   (rc12)*T_B0(1,0) - rc14*T_B0(-3,0) +
      (rc15)*T_B0(0,0) + (rc7)*T_B0(-2,0) - rc16*T_B0(-1,0)
)
: (
