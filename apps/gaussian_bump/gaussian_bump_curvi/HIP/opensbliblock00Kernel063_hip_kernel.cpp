...
void opensbliblock00Kernel063_gpu(ACC<double> &rhou0_B0,
  ACC<double> &rho_B0,
  ACC<double> &rhoE_B0,
  ACC<double> &rhou1_B0)
{
...
int size1 ){
  ...
  if (size0==-1) dims_opensbliblock00Kernel063[0][0]=0;
...
void ops_par_loop_opensbliblock00Kernel063_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_opensbliblock00Kernel063_h[0][0] || xdim1 != dims_opensbliblock00Kernel063_h[1][0] || xdim2 != dims_opensbliblock00Kernel063_h[2][0] || xdim3 != dims_opensbliblock00Kernel063_h[3][0]) {
    ...
    hipSafeCall(block->instance->ostream(), hipMemcpyToSymbol(HIP_SYMBOL(dims_opensbliblock00Kernel063), dims_opensbliblock00Kernel063_h, sizeof(dims_opensbliblock00Kernel063)));
  }
  ...
  if (x_size > 0 && y_size > 0)
    hipLaunchKernelGGL(ops_opensbliblock00Kernel063,grid ,tblock ,0 ,0 , (double *)p_a[0], (double *)p_a[1],
