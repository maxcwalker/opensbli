  ...
  const int *idx)
{
   ...
   -rc36*u1_B0(0,1) + (rc37)*u1_B0(0,2) -
      rc38*u1_B0(0,3) + (rc34)*u1_B0(0,4) + (rc39)*u1_B0(0,0)
)
: ((idx[1] == 1) ? (

      (rc7)*u1_B0(0,1) + (rc26)*u1_B0(0,2) - rc14*u1_B0(0,3) - rc21*u1_B0(0,0) +
      (rc34)*u1_B0(0,-1)
)
: (
   (rc11)*u1_B0(0,1) - rc14*u1_B0(0,2) +
      (rc11)*u1_B0(0,-1) - rc40*u1_B0(0,0) - rc14*u1_B0(0,-2)
)));
