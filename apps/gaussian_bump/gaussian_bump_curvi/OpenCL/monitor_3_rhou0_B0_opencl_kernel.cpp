...
//
    ...
    static bool isbuilt_monitor_3_rhou0_B0 = false;

    void buildOpenCLKernels_monitor_3_rhou0_B0(OPS_instance *instance, int xdim0) {

      //int ocl_fma = OCL_FMA;
      if(!isbuilt_monitor_3_rhou0_B0) {
        buildOpenCLKernels(instance);
        //clSafeCall( clUnloadCompiler() );
        cl_int ret;
        char* source_filename[1] = {(char*)"./OpenCL/monitor_3_rhou0_B0.cl"};
        ...
        instance->ostream() <<"Compiling monitor_3_rhou0_B0 "<<OCL_FMA<<" source -- start \n";
          ...
          if (pPath!=NULL)
            if(OCL_FMA)
              sprintf(buildOpts,"-cl-mad-enable -DOCL_FMA -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_monitor_3_rhou0_B0=%d ", pPath, 32,xdim0);
            else
              sprintf(buildOpts,"-cl-mad-enable -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_monitor_3_rhou0_B0=%d ", pPath, 32,xdim0);
          else {
          ...
          instance->ostream() << "compiling monitor_3_rhou0_B0 -- done\n";

        // Create the OpenCL kernel
        instance->opencl_instance->OPS_opencl_core.kernel[56] = clCreateKernel(instance->opencl_instance->OPS_opencl_core.program, "ops_monitor_3_rhou0_B0", &ret);
        clSafeCall( ret );

        isbuilt_monitor_3_rhou0_B0 = true;
        free(source_str[0]);
      }
...
// host stub function
void ops_par_loop_monitor_3_rhou0_B0(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1) {
  ...
  if (block->instance->OPS_diags > 1) {
    ops_timing_realloc(block->instance,56,"monitor_3_rhou0_B0");
  ...
  buildOpenCLKernels_monitor_3_rhou0_B0(block->instance,
  xdim0);
