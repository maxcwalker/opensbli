...
void ops_par_loop_opensbliblock00Kernel011_execute(ops_kernel_descriptor *desc) {
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
      ...
      const ACC<double> rhoE_B0(xdim2_opensbliblock00Kernel011, rhoE_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel011*1);
      const ACC<double> rho_B0(xdim3_opensbliblock00Kernel011, rho_B0_p + n_x*1 + n_y * xdim3_opensbliblock00Kernel011*1);
