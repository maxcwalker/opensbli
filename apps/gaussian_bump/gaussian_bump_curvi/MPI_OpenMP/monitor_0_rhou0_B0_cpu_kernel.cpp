...
void ops_par_loop_monitor_0_rhou0_B0_execute(ops_kernel_descriptor *desc) {
  ...
  #ifdef OPS_DEBUG
  ops_register_args(block->instance, args, "monitor_0_rhou0_B0");
  #endif
  ...
  int xdim0_monitor_0_rhou0_B0 = args[0].dat->size[0];
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
      const ACC<double> rhou0_B0(xdim0_monitor_0_rhou0_B0, rhou0_B0_p + n_x*1 + n_y * xdim0_monitor_0_rhou0_B0*1);
      double reduce_0_rhou0_B0[1];
      reduce_0_rhou0_B0[0] = ZERO_double;
      
*reduce_0_rhou0_B0 = rhou0_B0(0,0);

      p_a1_0 +=reduce_0_rhou0_B0[0];
    }
  }
  p_a1[0] = p_a1_0;
  if (block->instance->OPS_diags > 1) {
