...
void ops_par_loop_opensbliblock00Kernel000_execute(ops_kernel_descriptor *desc) {
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
      ...
      const ACC<double> rhoE_B0(xdim3_opensbliblock00Kernel000, rhoE_B0_p + n_x*1 + n_y * xdim3_opensbliblock00Kernel000*1);
      const ACC<double> D01_B0(xdim4_opensbliblock00Kernel000, D01_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel000*1);
      const ACC<double> U0_B0(xdim5_opensbliblock00Kernel000, U0_B0_p + n_x*1 + n_y * xdim5_opensbliblock00Kernel000*1);
      const ACC<double> rho_B0(xdim6_opensbliblock00Kernel000, rho_B0_p + n_x*1 + n_y * xdim6_opensbliblock00Kernel000*1);
      const ACC<double> rhou0_B0(xdim7_opensbliblock00Kernel000, rhou0_B0_p + n_x*1 + n_y * xdim7_opensbliblock00Kernel000*1);
      const ACC<double> rhou1_B0(xdim8_opensbliblock00Kernel000, rhou1_B0_p + n_x*1 + n_y * xdim8_opensbliblock00Kernel000*1);
