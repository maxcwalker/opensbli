...
void ops_par_loop_opensbliblock00Kernel090_execute(ops_kernel_descriptor *desc) {
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
      ...
      const ACC<double> wk5_B0(xdim1_opensbliblock00Kernel090, wk5_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel090*1);
      const ACC<double> wk0_B0(xdim2_opensbliblock00Kernel090, wk0_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel090*1);
      ...
      ACC<double> SD111_B0(xdim10_opensbliblock00Kernel090, SD111_B0_p + n_x*1 + n_y * xdim10_opensbliblock00Kernel090*1);
      ...
      ACC<double> SD100_B0(xdim13_opensbliblock00Kernel090, SD100_B0_p + n_x*1 + n_y * xdim13_opensbliblock00Kernel090*1);
