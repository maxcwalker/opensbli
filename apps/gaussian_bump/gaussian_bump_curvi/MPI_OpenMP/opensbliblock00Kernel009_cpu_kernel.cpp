...
void ops_par_loop_opensbliblock00Kernel009_execute(ops_kernel_descriptor *desc) {
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
      const ACC<double> u0_B0(xdim0_opensbliblock00Kernel009, u0_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel009*1);
      const ACC<double> u1_B0(xdim1_opensbliblock00Kernel009, u1_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel009*1);
      const ACC<double> D00_B0(xdim2_opensbliblock00Kernel009, D00_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel009*1);
      const ACC<double> D01_B0(xdim3_opensbliblock00Kernel009, D01_B0_p + n_x*1 + n_y * xdim3_opensbliblock00Kernel009*1);
