...
invgama = 1.0/(gama);
invgamma_m1 = 1.0/(gamma_m1);ops_decl_const2( "Delta0block0",1, "double",&Delta0block0);ops_decl_const2( "Delta1block0",1, "double",&Delta1block0);ops_decl_const2( "Delta2block0",1, "double",&Delta2block0);ops_decl_const2( "H",1, "double",&H);ops_decl_const2( "HDF5_timing",1, "int",&HDF5_timing);ops_decl_const2( "L",1, "double",&L);ops_decl_const2( "Minf",1, "double",&Minf);ops_decl_const2( "Pr",1, "double",&Pr);ops_decl_const2( "Re",1, "double",&Re);ops_decl_const2( "RefT",1, "double",&RefT);ops_decl_const2( "SuthT",1, "double",&SuthT);ops_decl_const2( "TENO_CT",1, "double",&TENO_CT);ops_decl_const2( "Twall",1, "double",&Twall);ops_decl_const2( "a",1, "double",&a);ops_decl_const2( "b",1, "double",&b);ops_decl_const2( "b_f",1, "double",&b_f);ops_decl_const2( "beta_0",1, "double",&beta_0);ops_decl_const2( "block0np0",1, "int",&block0np0);ops_decl_const2( "block0np1",1, "int",&block0np1);ops_decl_const2( "block0np2",1, "int",&block0np2);ops_decl_const2( "dt",1, "double",&dt);ops_decl_const2( "eps",1, "double",&eps);ops_decl_const2( "gama",1, "double",&gama);ops_decl_const2( "gamma_m1",1, "double",&gamma_m1);ops_decl_const2( "inv2Delta0block0",1, "double",&inv2Delta0block0);ops_decl_const2( "inv2Delta1block0",1, "double",&inv2Delta1block0);ops_decl_const2( "inv2Delta2block0",1, "double",&inv2Delta2block0);ops_decl_const2( "inv2Minf",1, "double",&inv2Minf);ops_decl_const2( "inv2a",1, "double",&inv2a);ops_decl_const2( "invDelta0block0",1, "double",&invDelta0block0);ops_decl_const2( "invDelta1block0",1, "double",&invDelta1block0);ops_decl_const2( "invDelta2block0",1, "double",&invDelta2block0);ops_decl_const2( "invH",1, "double",&invH);ops_decl_const2( "invPr",1, "double",&invPr);ops_decl_const2( "invRe",1, "double",&invRe);ops_decl_const2( "invRefT",1, "double",&invRefT);ops_decl_const2( "inv_gamma_m1",1, "double",&inv_gamma_m1);ops_decl_const2( "invgama",1, "double",&invgama);ops_decl_const2( "invgamma_m1",1, "double",&invgamma_m1);ops_decl_const2( "niter",1, "int",&niter);ops_decl_const2( "omega_0",1, "double",&omega_0);ops_decl_const2( "omega_1",1, "double",&omega_1);ops_decl_const2( "omega_2",1, "double",&omega_2);ops_decl_const2( "omega_3",1, "double",&omega_3);ops_decl_const2( "phi_0",1, "double",&phi_0);ops_decl_const2( "phi_1",1, "double",&phi_1);ops_decl_const2( "phi_2",1, "double",&phi_2);ops_decl_const2( "shock_filter_control",1, "double",&shock_filter_control);ops_decl_const2( "simulation_time",1, "double",&simulation_time);ops_decl_const2( "start_iter",1, "int",&start_iter);ops_decl_const2( "tripA",1, "double",&tripA);ops_decl_const2( "write_output_file",1, "int",&write_output_file);ops_decl_const2( "xts",1, "double",&xts);
...
if (restart == 0){
int iteration_range_67_block0[] = {-5, block0np0 + 5, -5, block0np1 + 5, -5, block0np2 + 5}; ops_par_loop_opensbliblock00Kernel067("Similiarity solution laminar boundary-layer initialisation0", opensbliblock00, 3, iteration_range_67_block0,
...
int iteration_range_70_block0[] = {0, block0np0, 0, block0np1, 0, block0np2}; ops_par_loop_opensbliblock00Kernel070("MetricsEquation evaluation", opensbliblock00, 3, iteration_range_70_block0,
...
int iteration_range_71_block0[] = {0, 1, -3, block0np1 + 4, -3, block0np2 + 4}; ops_par_loop_opensbliblock00Kernel071("Metric_copy_block0 boundary dir0 side0", opensbliblock00, 3, iteration_range_71_block0,
...
int iteration_range_72_block0[] = {block0np0 - 1, block0np0, -3, block0np1 + 4, -3, block0np2 + 4}; ops_par_loop_opensbliblock00Kernel072("Metric_copy_block0 boundary dir0 side1", opensbliblock00, 3, iteration_range_72_block0,
             ops_arg_dat(D00_B0, 1, stencil_0_44_00_00_16, "double", OPS_RW),
             ops_arg_dat(D01_B0, 1, stencil_0_44_00_00_16, "double", OPS_RW),
             ops_arg_dat(D10_B0, 1, stencil_0_44_00_00_16, "double", OPS_RW),
             ops_arg_dat(D11_B0, 1, stencil_0_44_00_00_16, "double", OPS_RW),
...
int iteration_range_73_block0[] = {-3, block0np0 + 4, 0, 1, -3, block0np2 + 4}; ops_par_loop_opensbliblock00Kernel073("Metric_copy_block0 boundary dir1 side0", opensbliblock00, 3, iteration_range_73_block0,
...
int iteration_range_74_block0[] = {-3, block0np0 + 4, block0np1 - 1, block0np1, -3, block0np2 + 4}; ops_par_loop_opensbliblock00Kernel074("Metric_copy_block0 boundary dir1 side1", opensbliblock00, 3, iteration_range_74_block0,
             ops_arg_dat(D00_B0, 1, stencil_0_00_44_00_16, "double", OPS_RW),
             ops_arg_dat(D01_B0, 1, stencil_0_00_44_00_16, "double", OPS_RW),
             ops_arg_dat(D10_B0, 1, stencil_0_00_44_00_16, "double", OPS_RW),
             ops_arg_dat(D11_B0, 1, stencil_0_00_44_00_16, "double", OPS_RW),
...
int iteration_range_81_block0[] = {0, block0np0, 0, block0np1, 0, block0np2}; ops_par_loop_opensbliblock00Kernel081("MetricsEquation evaluation", opensbliblock00, 3, iteration_range_81_block0,
...
int iteration_range_61_block0[] = {0, 1, -3, block0np1 + 4, -3, block0np2 + 4}; ops_par_loop_opensbliblock00Kernel061("InletTransfer boundary dir0 side0", opensbliblock00, 3, iteration_range_61_block0,
...
int iteration_range_62_block0[] = {block0np0 - 1, block0np0, -3, block0np1 + 4, -3, block0np2 + 4}; ops_par_loop_opensbliblock00Kernel062("Extrapolation boundary dir0 side1", opensbliblock00, 3, iteration_range_62_block0,
...
int iteration_range_63_block0[] = {-3, block0np0 + 4, 0, 1, -3, block0np2 + 4}; ops_par_loop_opensbliblock00Kernel063("ForcingStripWall boundary dir1 side0", opensbliblock00, 3, iteration_range_63_block0,
...
int iteration_range_64_block0[] = {-3, block0np0 + 4, block0np1 - 1, block0np1, -3, block0np2 + 4}; ops_par_loop_opensbliblock00Kernel064("ZeroGradientOutlet boundary dir1 side1", opensbliblock00, 3, iteration_range_64_block0,
...
{
int iteration_range_4_block0[] = {-3, block0np0 + 4, -3, block0np1 + 4, -3, block0np2 + 4}; ops_par_loop_opensbliblock00Kernel004("CRu0", opensbliblock00, 3, iteration_range_4_block0,
...
int iteration_range_5_block0[] = {-3, block0np0 + 4, -3, block0np1 + 4, -3, block0np2 + 4}; ops_par_loop_opensbliblock00Kernel005("CRu2", opensbliblock00, 3, iteration_range_5_block0,
             ops_arg_dat(rho_B0, 1, stencil_0_00_00_00_3, "double", OPS_READ),
             ops_arg_dat(rhou2_B0, 1, stencil_0_00_00_00_3, "double", OPS_READ),
             ops_arg_dat(u2_B0, 1, stencil_0_00_00_00_3, "double", OPS_WRITE));

int iteration_range_10_block0[] = {-3, block0np0 + 4, -3, block0np1 + 4, -3, block0np2 + 4}; ops_par_loop_opensbliblock00Kernel010("CRu1", opensbliblock00, 3, iteration_range_10_block0,
             ops_arg_dat(rho_B0, 1, stencil_0_00_00_00_3, "double", OPS_READ),
             ops_arg_dat(rhou1_B0, 1, stencil_0_00_00_00_3, "double", OPS_READ),
             ops_arg_dat(u1_B0, 1, stencil_0_00_00_00_3, "double", OPS_WRITE));

int iteration_range_9_block0[] = {-3, block0np0 + 4, -3, block0np1 + 4, -3, block0np2 + 4}; ops_par_loop_opensbliblock00Kernel009("CRp", opensbliblock00, 3, iteration_range_9_block0,
...
int iteration_range_13_block0[] = {-3, block0np0 + 4, 0, block0np1, 0, block0np2}; ops_par_loop_opensbliblock00Kernel013("CRU0", opensbliblock00, 3, iteration_range_13_block0,
...
int iteration_range_17_block0[] = {0, block0np0, -3, block0np1 + 4, 0, block0np2}; ops_par_loop_opensbliblock00Kernel017("CRU1", opensbliblock00, 3, iteration_range_17_block0,
...
int iteration_range_20_block0[] = {0, block0np0, 0, block0np1, -3, block0np2 + 4}; ops_par_loop_opensbliblock00Kernel020("CRU2", opensbliblock00, 3, iteration_range_20_block0,
             ops_arg_dat(u2_B0, 1, stencil_0_00_00_00_3, "double", OPS_READ),
             ops_arg_dat(U2_B0, 1, stencil_0_00_00_00_3, "double", OPS_WRITE));

int iteration_range_11_block0[] = {-3, block0np0 + 4, -3, block0np1 + 4, -3, block0np2 + 4}; ops_par_loop_opensbliblock00Kernel011("CRa", opensbliblock00, 3, iteration_range_11_block0,
             ops_arg_dat(p_B0, 1, stencil_0_00_00_00_3, "double", OPS_READ),
             ops_arg_dat(rho_B0, 1, stencil_0_00_00_00_3, "double", OPS_READ),
             ops_arg_dat(a_B0, 1, stencil_0_00_00_00_3, "double", OPS_WRITE));

int iteration_range_25_block0[] = {-2, block0np0 + 2, -2, block0np1 + 2, -2, block0np2 + 2}; ops_par_loop_opensbliblock00Kernel025("CRT_B0", opensbliblock00, 3, iteration_range_25_block0,
             ops_arg_dat(p_B0, 1, stencil_0_00_00_00_3, "double", OPS_READ),
             ops_arg_dat(rho_B0, 1, stencil_0_00_00_00_3, "double", OPS_READ),
             ops_arg_dat(T_B0, 1, stencil_0_00_00_00_3, "double", OPS_WRITE));

int iteration_range_26_block0[] = {-2, block0np0 + 2, -2, block0np1 + 2, -2, block0np2 + 2}; ops_par_loop_opensbliblock00Kernel026("CRmu_B0", opensbliblock00, 3, iteration_range_26_block0,
             ops_arg_dat(T_B0, 1, stencil_0_00_00_00_3, "double", OPS_READ),
             ops_arg_dat(mu_B0, 1, stencil_0_00_00_00_3, "double", OPS_WRITE));

int iteration_range_0_block0[] = {-1, block0np0 + 1, 0, block0np1, 0, block0np2}; ops_par_loop_opensbliblock00Kernel000("LFTeno_reconstruction_0_direction", opensbliblock00, 3, iteration_range_0_block0,
...
int iteration_range_1_block0[] = {0, block0np0, -1, block0np1 + 1, 0, block0np2}; ops_par_loop_opensbliblock00Kernel001("LFTeno_reconstruction_1_direction", opensbliblock00, 3, iteration_range_1_block0,
...
int iteration_range_2_block0[] = {0, block0np0, 0, block0np1, -1, block0np2 + 1}; ops_par_loop_opensbliblock00Kernel002("LFTeno_reconstruction_2_direction", opensbliblock00, 3, iteration_range_2_block0,
...
int iteration_range_21_block0[] = {0, block0np0, 0, block0np1, 0, block0np2}; ops_par_loop_opensbliblock00Kernel021("LFTeno Residual", opensbliblock00, 3, iteration_range_21_block0,
...
int iteration_range_32_block0[] = {0, block0np0, -2, block0np1 + 2, -2, block0np2 + 2}; ops_par_loop_opensbliblock00Kernel032("Derivative evaluation CD u0_B0 xi0 ", opensbliblock00, 3, iteration_range_32_block0,
             ops_arg_dat(u0_B0, 1, stencil_0_44_00_00_19, "double", OPS_READ),
             ops_arg_dat(wk0_B0, 1, stencil_0_00_00_00_3, "double", OPS_WRITE),
             ops_arg_idx());

int iteration_range_34_block0[] = {0, block0np0, -2, block0np1 + 2, -2, block0np2 + 2}; ops_par_loop_opensbliblock00Kernel034("Derivative evaluation CD u1_B0 xi0 ", opensbliblock00, 3, iteration_range_34_block0,
             ops_arg_dat(u1_B0, 1, stencil_0_44_00_00_19, "double", OPS_READ),
             ops_arg_dat(wk1_B0, 1, stencil_0_00_00_00_3, "double", OPS_WRITE),
             ops_arg_idx());

int iteration_range_36_block0[] = {0, block0np0, -2, block0np1 + 2, -2, block0np2 + 2}; ops_par_loop_opensbliblock00Kernel036("Derivative evaluation CD u2_B0 xi0 ", opensbliblock00, 3, iteration_range_36_block0,
             ops_arg_dat(u2_B0, 1, stencil_0_44_00_00_19, "double", OPS_READ),
             ops_arg_dat(wk2_B0, 1, stencil_0_00_00_00_3, "double", OPS_WRITE),
             ops_arg_idx());

int iteration_range_38_block0[] = {0, block0np0, -2, block0np1 + 2, 0, block0np2}; ops_par_loop_opensbliblock00Kernel038("Derivative evaluation CD T_B0 xi0 ", opensbliblock00, 3, iteration_range_38_block0,
             ops_arg_dat(T_B0, 1, stencil_0_44_00_00_19, "double", OPS_READ),
             ops_arg_dat(wk3_B0, 1, stencil_0_00_00_00_3, "double", OPS_WRITE),
             ops_arg_idx());

int iteration_range_40_block0[] = {0, block0np0, 0, block0np1, -2, block0np2 + 2}; ops_par_loop_opensbliblock00Kernel040("Derivative evaluation CD u0_B0 xi1 ", opensbliblock00, 3, iteration_range_40_block0,
             ops_arg_dat(u0_B0, 1, stencil_0_00_24_00_15, "double", OPS_READ),
             ops_arg_dat(wk4_B0, 1, stencil_0_00_00_00_3, "double", OPS_WRITE),
             ops_arg_idx());

int iteration_range_41_block0[] = {0, block0np0, 0, block0np1, -2, block0np2 + 2}; ops_par_loop_opensbliblock00Kernel041("Derivative evaluation CD u1_B0 xi1 ", opensbliblock00, 3, iteration_range_41_block0,
             ops_arg_dat(u1_B0, 1, stencil_0_00_24_00_15, "double", OPS_READ),
             ops_arg_dat(wk5_B0, 1, stencil_0_00_00_00_3, "double", OPS_WRITE),
             ops_arg_idx());

int iteration_range_42_block0[] = {0, block0np0, 0, block0np1, -2, block0np2 + 2}; ops_par_loop_opensbliblock00Kernel042("Derivative evaluation CD u2_B0 xi1 ", opensbliblock00, 3, iteration_range_42_block0,
             ops_arg_dat(u2_B0, 1, stencil_0_00_24_00_15, "double", OPS_READ),
             ops_arg_dat(wk6_B0, 1, stencil_0_00_00_00_3, "double", OPS_WRITE),
             ops_arg_idx());

int iteration_range_43_block0[] = {0, block0np0, 0, block0np1, 0, block0np2}; ops_par_loop_opensbliblock00Kernel043("Derivative evaluation CD T_B0 xi1 ", opensbliblock00, 3, iteration_range_43_block0,
             ops_arg_dat(T_B0, 1, stencil_0_00_24_00_15, "double", OPS_READ),
             ops_arg_dat(wk7_B0, 1, stencil_0_00_00_00_3, "double", OPS_WRITE),
             ops_arg_idx());

int iteration_range_44_block0[] = {0, block0np0, 0, block0np1, 0, block0np2}; ops_par_loop_opensbliblock00Kernel044("Derivative evaluation CD u0_B0 xi2 ", opensbliblock00, 3, iteration_range_44_block0,
             ops_arg_dat(u0_B0, 1, stencil_0_00_00_22_8, "double", OPS_READ),
             ops_arg_dat(wk8_B0, 1, stencil_0_00_00_00_3, "double", OPS_WRITE));

int iteration_range_45_block0[] = {0, block0np0, 0, block0np1, 0, block0np2}; ops_par_loop_opensbliblock00Kernel045("Derivative evaluation CD u1_B0 xi2 ", opensbliblock00, 3, iteration_range_45_block0,
             ops_arg_dat(u1_B0, 1, stencil_0_00_00_22_8, "double", OPS_READ),
             ops_arg_dat(wk9_B0, 1, stencil_0_00_00_00_3, "double", OPS_WRITE));

int iteration_range_46_block0[] = {0, block0np0, 0, block0np1, 0, block0np2}; ops_par_loop_opensbliblock00Kernel046("Derivative evaluation CD u2_B0 xi2 ", opensbliblock00, 3, iteration_range_46_block0,
             ops_arg_dat(u2_B0, 1, stencil_0_00_00_22_8, "double", OPS_READ),
             ops_arg_dat(wk10_B0, 1, stencil_0_00_00_00_3, "double", OPS_WRITE));

int iteration_range_47_block0[] = {0, block0np0, 0, block0np1, 0, block0np2}; ops_par_loop_opensbliblock00Kernel047("Derivative evaluation CD T_B0 xi2 ", opensbliblock00, 3, iteration_range_47_block0,
             ops_arg_dat(T_B0, 1, stencil_0_00_00_22_8, "double", OPS_READ),
             ops_arg_dat(wk11_B0, 1, stencil_0_00_00_00_3, "double", OPS_WRITE));

int iteration_range_56_block0[] = {0, block0np0, 0, block0np1, 0, block0np2}; ops_par_loop_opensbliblock00Kernel056("Viscous terms", opensbliblock00, 3, iteration_range_56_block0,
             ops_arg_dat(D00_B0, 1, stencil_0_00_00_00_3, "double", OPS_READ),
             ops_arg_dat(D01_B0, 1, stencil_0_00_00_00_3, "double", OPS_READ),
             ops_arg_dat(D10_B0, 1, stencil_0_00_00_00_3, "double", OPS_READ),
             ops_arg_dat(D11_B0, 1, stencil_0_00_00_00_3, "double", OPS_READ),
...
int iteration_range_82_block0[] = {0, block0np0, 0, block0np1, 0, block0np2}; ops_par_loop_opensbliblock00Kernel082("Temporal solution advancement", opensbliblock00, 3, iteration_range_82_block0,
