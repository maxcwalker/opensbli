...
void opensbliblock00Kernel030_gpu(const ACC<double> &wk8_B0,
  ACC<double> &wk2_B0,
  const int *idx)
{
    wk2_B0(0,0) = inv_0*((idx[1] == 0) ? (
   -3*wk8_B0(0,2) + 4*wk8_B0(0,1) -
      rc11*wk8_B0(0,0) - rc13*wk8_B0(0,4) + (rc12)*wk8_B0(0,3)
)
: ((idx[1] == 1) ? (

      -rc17*wk8_B0(0,2) + (rc14)*wk8_B0(0,1) - rc13*wk8_B0(0,-1) -
      rc15*wk8_B0(0,0) + (rc16)*wk8_B0(0,3)
)
: (
   -rc18*wk8_B0(0,-1) +
      (rc18)*wk8_B0(0,1) + (rc16)*wk8_B0(0,-2) - rc16*wk8_B0(0,2)
)));
