  ...
  const int *idx)
{
   ...
   (rc12)*u1_B0(3,0) - rc11*u1_B0(0,0) +
      4*u1_B0(1,0) - rc13*u1_B0(4,0) - 3*u1_B0(2,0)
)
: ((idx[0] == 1) ? (

      (rc16)*u1_B0(3,0) - rc15*u1_B0(0,0) + (rc14)*u1_B0(1,0) - rc13*u1_B0(-1,0)
      - rc17*u1_B0(2,0)
)
: ((idx[0] == block0np0 - 1) ? (
   (rc11)*u1_B0(0,0) -
      4*u1_B0(-1,0) + 3*u1_B0(-2,0) + (rc13)*u1_B0(-4,0) - rc12*u1_B0(-3,0)
)
:
      ((idx[0] == block0np0 - 2) ? (
   (rc15)*u1_B0(0,0) + (rc13)*u1_B0(1,0) +
      (rc17)*u1_B0(-2,0) - rc14*u1_B0(-1,0) - rc16*u1_B0(-3,0)
)
: (

      -rc18*u1_B0(-1,0) + (rc18)*u1_B0(1,0) - rc16*u1_B0(2,0) +
      (rc16)*u1_B0(-2,0)
)))));
