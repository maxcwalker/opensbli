...
void ops_par_loop_opensbliblock00Kernel002_execute(ops_kernel_descriptor *desc) {
 ...
 arg15, arg16};
  ...
  double* a_B0_p = (double*)args[1].data_d;
  ...
  double* p_B0_p = (double*)args[3].data_d;

  int base4 = args[4].dat->base_offset/sizeof(double);
  double* rhoE_B0_p = (double*)args[4].data_d;

  int base5 = args[5].dat->base_offset/sizeof(double);
  double* rho_B0_p = (double*)args[5].data_d;
  ...
  double* wk14_B0_p = (double*)args[16].data_d;
  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0 && (end[2]-start[2])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      auto TENO_CT_sycl = (*TENO_CT_p).template get_access<cl::sycl::access::mode::read>(cgh);
      ...
      , [=](cl::sycl::nd_item<3> item
        ...
        const ACC<double> U2_B0(xdim0_opensbliblock00Kernel002, ydim0_opensbliblock00Kernel002, &U2_B0_p[0] + base0 + n_x*1 + n_y * xdim0_opensbliblock00Kernel002*1 + n_z * xdim0_opensbliblock00Kernel002 * ydim0_opensbliblock00Kernel002*1);
        const ACC<double> a_B0(xdim1_opensbliblock00Kernel002, ydim1_opensbliblock00Kernel002, &a_B0_p[0] + base1 + n_x*1 + n_y * xdim1_opensbliblock00Kernel002*1 + n_z * xdim1_opensbliblock00Kernel002 * ydim1_opensbliblock00Kernel002*1);
        const ACC<double> detJ_B0(xdim2_opensbliblock00Kernel002, ydim2_opensbliblock00Kernel002, &detJ_B0_p[0] + base2 + n_x*1 + n_y * xdim2_opensbliblock00Kernel002*1 + n_z * xdim2_opensbliblock00Kernel002 * ydim2_opensbliblock00Kernel002*1);
        const ACC<double> p_B0(xdim3_opensbliblock00Kernel002, ydim3_opensbliblock00Kernel002, &p_B0_p[0] + base3 + n_x*1 + n_y * xdim3_opensbliblock00Kernel002*1 + n_z * xdim3_opensbliblock00Kernel002 * ydim3_opensbliblock00Kernel002*1);
        const ACC<double> rhoE_B0(xdim4_opensbliblock00Kernel002, ydim4_opensbliblock00Kernel002, &rhoE_B0_p[0] + base4 + n_x*1 + n_y * xdim4_opensbliblock00Kernel002*1 + n_z * xdim4_opensbliblock00Kernel002 * ydim4_opensbliblock00Kernel002*1);
        const ACC<double> rho_B0(xdim5_opensbliblock00Kernel002, ydim5_opensbliblock00Kernel002, &rho_B0_p[0] + base5 + n_x*1 + n_y * xdim5_opensbliblock00Kernel002*1 + n_z * xdim5_opensbliblock00Kernel002 * ydim5_opensbliblock00Kernel002*1);
        const ACC<double> rhou0_B0(xdim6_opensbliblock00Kernel002, ydim6_opensbliblock00Kernel002, &rhou0_B0_p[0] + base6 + n_x*1 + n_y * xdim6_opensbliblock00Kernel002*1 + n_z * xdim6_opensbliblock00Kernel002 * ydim6_opensbliblock00Kernel002*1);
        const ACC<double> rhou1_B0(xdim7_opensbliblock00Kernel002, ydim7_opensbliblock00Kernel002, &rhou1_B0_p[0] + base7 + n_x*1 + n_y * xdim7_opensbliblock00Kernel002*1 + n_z * xdim7_opensbliblock00Kernel002 * ydim7_opensbliblock00Kernel002*1);
        const ACC<double> rhou2_B0(xdim8_opensbliblock00Kernel002, ydim8_opensbliblock00Kernel002, &rhou2_B0_p[0] + base8 + n_x*1 + n_y * xdim8_opensbliblock00Kernel002*1 + n_z * xdim8_opensbliblock00Kernel002 * ydim8_opensbliblock00Kernel002*1);
        const ACC<double> u0_B0(xdim9_opensbliblock00Kernel002, ydim9_opensbliblock00Kernel002, &u0_B0_p[0] + base9 + n_x*1 + n_y * xdim9_opensbliblock00Kernel002*1 + n_z * xdim9_opensbliblock00Kernel002 * ydim9_opensbliblock00Kernel002*1);
        const ACC<double> u1_B0(xdim10_opensbliblock00Kernel002, ydim10_opensbliblock00Kernel002, &u1_B0_p[0] + base10 + n_x*1 + n_y * xdim10_opensbliblock00Kernel002*1 + n_z * xdim10_opensbliblock00Kernel002 * ydim10_opensbliblock00Kernel002*1);
        const ACC<double> u2_B0(xdim11_opensbliblock00Kernel002, ydim11_opensbliblock00Kernel002, &u2_B0_p[0] + base11 + n_x*1 + n_y * xdim11_opensbliblock00Kernel002*1 + n_z * xdim11_opensbliblock00Kernel002 * ydim11_opensbliblock00Kernel002*1);
        ACC<double> wk10_B0(xdim12_opensbliblock00Kernel002, ydim12_opensbliblock00Kernel002, &wk10_B0_p[0] + base12 + n_x*1 + n_y * xdim12_opensbliblock00Kernel002*1 + n_z * xdim12_opensbliblock00Kernel002 * ydim12_opensbliblock00Kernel002*1);
        ACC<double> wk11_B0(xdim13_opensbliblock00Kernel002, ydim13_opensbliblock00Kernel002, &wk11_B0_p[0] + base13 + n_x*1 + n_y * xdim13_opensbliblock00Kernel002*1 + n_z * xdim13_opensbliblock00Kernel002 * ydim13_opensbliblock00Kernel002*1);
        ACC<double> wk12_B0(xdim14_opensbliblock00Kernel002, ydim14_opensbliblock00Kernel002, &wk12_B0_p[0] + base14 + n_x*1 + n_y * xdim14_opensbliblock00Kernel002*1 + n_z * xdim14_opensbliblock00Kernel002 * ydim14_opensbliblock00Kernel002*1);
        ACC<double> wk13_B0(xdim15_opensbliblock00Kernel002, ydim15_opensbliblock00Kernel002, &wk13_B0_p[0] + base15 + n_x*1 + n_y * xdim15_opensbliblock00Kernel002*1 + n_z * xdim15_opensbliblock00Kernel002 * ydim15_opensbliblock00Kernel002*1);
        ACC<double> wk14_B0(xdim16_opensbliblock00Kernel002, ydim16_opensbliblock00Kernel002, &wk14_B0_p[0] + base16 + n_x*1 + n_y * xdim16_opensbliblock00Kernel002*1 + n_z * xdim16_opensbliblock00Kernel002 * ydim16_opensbliblock00Kernel002*1);
        //USER CODE
   ...
   max_lambda_00 = shock_filter_control_sycl[0]*cl::sycl::fmax(cl::sycl::fabs(u2_B0(0,0,0)*detJ_B0(0,0,0)), cl::sycl::fabs(u2_B0(0,0,1)*detJ_B0(0,0,1)));
   ...
   max_lambda_22 = max_lambda_00;
    ...
    max_lambda_44 = shock_filter_control_sycl[0]*cl::sycl::fmax(cl::sycl::fabs(a_B0(0,0,1)*detJ_B0(0,0,1) - u2_B0(0,0,1)*detJ_B0(0,0,1)),
   ...
   inv_beta_0 = 1.0/(eps_sycl[0] + beta_0_sycl[0]);

   inv_beta_1 = 1.0/(eps_sycl[0] + beta_1);

   inv_beta_2 = 1.0/(eps_sycl[0] + beta_2);

   inv_beta_3 = 1.0/(eps_sycl[0] + beta_3);

    alpha_0 = ((1 + cl::sycl::fabs(-beta_3 - (2.0/3.0)*beta_1 + ((1.0/6.0))*beta_0_sycl[0] + ((1.0/6.0))*beta_2)*inv_beta_0)*(1 +
      cl::sycl::fabs(-beta_3 - (2.0/3.0)*beta_1 + ((1.0/6.0))*beta_0_sycl[0] + ((1.0/6.0))*beta_2)*inv_beta_0)*(1 + cl::sycl::fabs(-beta_3 -
      (2.0/3.0)*beta_1 + ((1.0/6.0))*beta_0_sycl[0] + ((1.0/6.0))*beta_2)*inv_beta_0)*(1 + cl::sycl::fabs(-beta_3 - (2.0/3.0)*beta_1 +
      ((1.0/6.0))*beta_0_sycl[0] + ((1.0/6.0))*beta_2)*inv_beta_0)*(1 + cl::sycl::fabs(-beta_3 - (2.0/3.0)*beta_1 + ((1.0/6.0))*beta_0_sycl[0] +
      ((1.0/6.0))*beta_2)*inv_beta_0)*(1 + cl::sycl::fabs(-beta_3 - (2.0/3.0)*beta_1 + ((1.0/6.0))*beta_0_sycl[0] +
      ((1.0/6.0))*beta_2)*inv_beta_0));

    alpha_1 = ((1 + cl::sycl::fabs(-beta_3 - (2.0/3.0)*beta_1 + ((1.0/6.0))*beta_0_sycl[0] + ((1.0/6.0))*beta_2)*inv_beta_1)*(1 +
      cl::sycl::fabs(-beta_3 - (2.0/3.0)*beta_1 + ((1.0/6.0))*beta_0_sycl[0] + ((1.0/6.0))*beta_2)*inv_beta_1)*(1 + cl::sycl::fabs(-beta_3 -
      (2.0/3.0)*beta_1 + ((1.0/6.0))*beta_0_sycl[0] + ((1.0/6.0))*beta_2)*inv_beta_1)*(1 + cl::sycl::fabs(-beta_3 - (2.0/3.0)*beta_1 +
      ((1.0/6.0))*beta_0_sycl[0] + ((1.0/6.0))*beta_2)*inv_beta_1)*(1 + cl::sycl::fabs(-beta_3 - (2.0/3.0)*beta_1 + ((1.0/6.0))*beta_0_sycl[0] +
      ((1.0/6.0))*beta_2)*inv_beta_1)*(1 + cl::sycl::fabs(-beta_3 - (2.0/3.0)*beta_1 + ((1.0/6.0))*beta_0_sycl[0] +
      ((1.0/6.0))*beta_2)*inv_beta_1));

    alpha_2 = ((1 + cl::sycl::fabs(-beta_3 - (2.0/3.0)*beta_1 + ((1.0/6.0))*beta_0_sycl[0] + ((1.0/6.0))*beta_2)*inv_beta_2)*(1 +
      cl::sycl::fabs(-beta_3 - (2.0/3.0)*beta_1 + ((1.0/6.0))*beta_0_sycl[0] + ((1.0/6.0))*beta_2)*inv_beta_2)*(1 + cl::sycl::fabs(-beta_3 -
      (2.0/3.0)*beta_1 + ((1.0/6.0))*beta_0_sycl[0] + ((1.0/6.0))*beta_2)*inv_beta_2)*(1 + cl::sycl::fabs(-beta_3 - (2.0/3.0)*beta_1 +
      ((1.0/6.0))*beta_0_sycl[0] + ((1.0/6.0))*beta_2)*inv_beta_2)*(1 + cl::sycl::fabs(-beta_3 - (2.0/3.0)*beta_1 + ((1.0/6.0))*beta_0_sycl[0] +
      ((1.0/6.0))*beta_2)*inv_beta_2)*(1 + cl::sycl::fabs(-beta_3 - (2.0/3.0)*beta_1 + ((1.0/6.0))*beta_0_sycl[0] +
      ((1.0/6.0))*beta_2)*inv_beta_2));

    alpha_3 = ((1 + cl::sycl::fabs(-beta_3 - (2.0/3.0)*beta_1 + ((1.0/6.0))*beta_0_sycl[0] + ((1.0/6.0))*beta_2)*inv_beta_3)*(1 +
      cl::sycl::fabs(-beta_3 - (2.0/3.0)*beta_1 + ((1.0/6.0))*beta_0_sycl[0] + ((1.0/6.0))*beta_2)*inv_beta_3)*(1 + cl::sycl::fabs(-beta_3 -
      (2.0/3.0)*beta_1 + ((1.0/6.0))*beta_0_sycl[0] + ((1.0/6.0))*beta_2)*inv_beta_3)*(1 + cl::sycl::fabs(-beta_3 - (2.0/3.0)*beta_1 +
      ((1.0/6.0))*beta_0_sycl[0] + ((1.0/6.0))*beta_2)*inv_beta_3)*(1 + cl::sycl::fabs(-beta_3 - (2.0/3.0)*beta_1 + ((1.0/6.0))*beta_0_sycl[0] +
      ((1.0/6.0))*beta_2)*inv_beta_3)*(1 + cl::sycl::fabs(-beta_3 - (2.0/3.0)*beta_1 + ((1.0/6.0))*beta_0_sycl[0] +
      ((1.0/6.0))*beta_2)*inv_beta_3));

   inv_alpha_sum = 1.0/((alpha_0 + alpha_1 + alpha_2 + alpha_3));

   delta_0 = ((alpha_0*inv_alpha_sum < TENO_CT_sycl[0]) ? (
   0.0
)
: (
   1.0
   ...
   delta_1 = ((alpha_1*inv_alpha_sum < TENO_CT_sycl[0]) ? (
   0.0
)
: (
   1.0
   ...
   delta_2 = ((alpha_2*inv_alpha_sum < TENO_CT_sycl[0]) ? (
   0.0
)
: (
   1.0
   ...
   delta_3 = ((alpha_3*inv_alpha_sum < TENO_CT_sycl[0]) ? (
   0.0
)
: (
   1.0
    ...
    beta_0_sycl[0] = ((1.0/4.0))*((((1.0/2.0))*(-CS_02*max_lambda_00 + CF_02) - (1.0/2.0)*(-CS_04*max_lambda_00 +
...
: (
   1.0
    ...
    beta_0_sycl[0] = ((1.0/4.0))*((((1.0/2.0))*(CS_11*max_lambda_11 + CF_11) - (1.0/2.0)*(CS_13*max_lambda_11 +
...
: (
   1.0
    ...
    beta_0_sycl[0] = ((1.0/4.0))*((((1.0/2.0))*(-CS_12*max_lambda_11 + CF_12) - (1.0/2.0)*(-CS_14*max_lambda_11 +
...
: (
   1.0
    ...
    beta_0_sycl[0] = ((1.0/4.0))*((((1.0/2.0))*(CS_21*max_lambda_22 + CF_21) - (1.0/2.0)*(CS_23*max_lambda_22 +
...
: (
   1.0
    ...
    beta_0_sycl[0] = ((1.0/4.0))*((((1.0/2.0))*(-CS_22*max_lambda_22 + CF_22) - (1.0/2.0)*(-CS_24*max_lambda_22 +
...
: (
   1.0
    ...
    beta_0_sycl[0] = ((1.0/4.0))*((((1.0/2.0))*(CS_31*max_lambda_33 + CF_31) - (1.0/2.0)*(CS_33*max_lambda_33 +
...
: (
   1.0
    ...
    beta_0_sycl[0] = ((1.0/4.0))*((((1.0/2.0))*(-CS_32*max_lambda_33 + CF_32) - (1.0/2.0)*(-CS_34*max_lambda_33 +
...
: (
   1.0
    ...
    beta_0_sycl[0] = ((1.0/4.0))*((((1.0/2.0))*(CS_41*max_lambda_44 + CF_41) - (1.0/2.0)*(CS_43*max_lambda_44 +
...
: (
   1.0
    ...
    beta_0_sycl[0] = ((1.0/4.0))*((((1.0/2.0))*(-CS_42*max_lambda_44 + CF_42) - (1.0/2.0)*(-CS_44*max_lambda_44 +
