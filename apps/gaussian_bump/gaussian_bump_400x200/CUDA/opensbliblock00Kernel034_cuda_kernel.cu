...
void opensbliblock00Kernel034_gpu(const ACC<double> &wk3_B0,
  ACC<double> &wk6_B0,
  const int *idx)
{
    wk6_B0(0,0) = inv_0*((idx[1] == 0) ? (
   4*wk3_B0(0,1) - rc13*wk3_B0(0,4) -
      rc11*wk3_B0(0,0) + (rc12)*wk3_B0(0,3) - 3*wk3_B0(0,2)
)
: ((idx[1] == 1) ? (

      (rc14)*wk3_B0(0,1) - rc15*wk3_B0(0,0) + (rc16)*wk3_B0(0,3) -
      rc17*wk3_B0(0,2) - rc13*wk3_B0(0,-1)
)
: (
   (rc18)*wk3_B0(0,1) +
      (rc16)*wk3_B0(0,-2) - rc16*wk3_B0(0,2) - rc18*wk3_B0(0,-1)
)));
