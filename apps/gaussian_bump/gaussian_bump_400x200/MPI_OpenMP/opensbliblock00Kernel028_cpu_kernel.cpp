...
void ops_par_loop_opensbliblock00Kernel028_execute(ops_kernel_descriptor *desc) {
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
      ...
      const ACC<double> mu_B0(xdim0_opensbliblock00Kernel028, mu_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel028*1);
   ...
   (rc12)*mu_B0(0,3) - rc11*mu_B0(0,0) -
      rc13*mu_B0(0,4) + 4*mu_B0(0,1) - 3*mu_B0(0,2)
)
: ((idx[1] == 1) ? (

      (rc16)*mu_B0(0,3) - rc13*mu_B0(0,-1) - rc15*mu_B0(0,0) + (rc14)*mu_B0(0,1)
      - rc17*mu_B0(0,2)
)
: (
   -rc18*mu_B0(0,-1) + (rc18)*mu_B0(0,1) +
      (rc16)*mu_B0(0,-2) - rc16*mu_B0(0,2)
)));
