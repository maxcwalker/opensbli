  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      , [=](cl::sycl::nd_item<2> item
        ...
        const ACC<double> detJ_B0(xdim3_opensbliblock00Kernel000, &detJ_B0_p[0] + base3 + n_x*1 + n_y * xdim3_opensbliblock00Kernel000*1);
        const ACC<double> p_B0(xdim4_opensbliblock00Kernel000, &p_B0_p[0] + base4 + n_x*1 + n_y * xdim4_opensbliblock00Kernel000*1);
        const ACC<double> rhoE_B0(xdim5_opensbliblock00Kernel000, &rhoE_B0_p[0] + base5 + n_x*1 + n_y * xdim5_opensbliblock00Kernel000*1);
        const ACC<double> rho_B0(xdim6_opensbliblock00Kernel000, &rho_B0_p[0] + base6 + n_x*1 + n_y * xdim6_opensbliblock00Kernel000*1);
        const ACC<double> rhou0_B0(xdim7_opensbliblock00Kernel000, &rhou0_B0_p[0] + base7 + n_x*1 + n_y * xdim7_opensbliblock00Kernel000*1);
        const ACC<double> rhou1_B0(xdim8_opensbliblock00Kernel000, &rhou1_B0_p[0] + base8 + n_x*1 + n_y * xdim8_opensbliblock00Kernel000*1);
        ACC<double> wk10_B0(xdim9_opensbliblock00Kernel000, &wk10_B0_p[0] + base9 + n_x*1 + n_y * xdim9_opensbliblock00Kernel000*1);
        ACC<double> wk11_B0(xdim10_opensbliblock00Kernel000, &wk11_B0_p[0] + base10 + n_x*1 + n_y * xdim10_opensbliblock00Kernel000*1);
        ACC<double> wk8_B0(xdim11_opensbliblock00Kernel000, &wk8_B0_p[0] + base11 + n_x*1 + n_y * xdim11_opensbliblock00Kernel000*1);
        ACC<double> wk9_B0(xdim12_opensbliblock00Kernel000, &wk9_B0_p[0] + base12 + n_x*1 + n_y * xdim12_opensbliblock00Kernel000*1);
        //USER CODE
