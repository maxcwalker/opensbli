 ...
 arg15};
  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      cgh.parallel_for<class opensbliblock00Kernel081_kernel>(cl::sycl::nd_range<2>(cl::sycl::range<2>(
      ...
      , [=](cl::sycl::nd_item<2> item
        ...
        const ACC<double> wk0_B0(xdim0_opensbliblock00Kernel081, &wk0_B0_p[0] + base0 + n_x*1 + n_y * xdim0_opensbliblock00Kernel081*1);
        const ACC<double> wk1_B0(xdim1_opensbliblock00Kernel081, &wk1_B0_p[0] + base1 + n_x*1 + n_y * xdim1_opensbliblock00Kernel081*1);
        const ACC<double> wk2_B0(xdim2_opensbliblock00Kernel081, &wk2_B0_p[0] + base2 + n_x*1 + n_y * xdim2_opensbliblock00Kernel081*1);
        const ACC<double> wk3_B0(xdim3_opensbliblock00Kernel081, &wk3_B0_p[0] + base3 + n_x*1 + n_y * xdim3_opensbliblock00Kernel081*1);
        const ACC<double> wk4_B0(xdim4_opensbliblock00Kernel081, &wk4_B0_p[0] + base4 + n_x*1 + n_y * xdim4_opensbliblock00Kernel081*1);
        const ACC<double> wk5_B0(xdim5_opensbliblock00Kernel081, &wk5_B0_p[0] + base5 + n_x*1 + n_y * xdim5_opensbliblock00Kernel081*1);
        const ACC<double> wk6_B0(xdim6_opensbliblock00Kernel081, &wk6_B0_p[0] + base6 + n_x*1 + n_y * xdim6_opensbliblock00Kernel081*1);
        const ACC<double> wk7_B0(xdim7_opensbliblock00Kernel081, &wk7_B0_p[0] + base7 + n_x*1 + n_y * xdim7_opensbliblock00Kernel081*1);
        ACC<double> SD000_B0(xdim8_opensbliblock00Kernel081, &SD000_B0_p[0] + base8 + n_x*1 + n_y * xdim8_opensbliblock00Kernel081*1);
        ACC<double> SD001_B0(xdim9_opensbliblock00Kernel081, &SD001_B0_p[0] + base9 + n_x*1 + n_y * xdim9_opensbliblock00Kernel081*1);
        ACC<double> SD010_B0(xdim10_opensbliblock00Kernel081, &SD010_B0_p[0] + base10 + n_x*1 + n_y * xdim10_opensbliblock00Kernel081*1);
        ACC<double> SD011_B0(xdim11_opensbliblock00Kernel081, &SD011_B0_p[0] + base11 + n_x*1 + n_y * xdim11_opensbliblock00Kernel081*1);
        ACC<double> SD100_B0(xdim12_opensbliblock00Kernel081, &SD100_B0_p[0] + base12 + n_x*1 + n_y * xdim12_opensbliblock00Kernel081*1);
        ACC<double> SD101_B0(xdim13_opensbliblock00Kernel081, &SD101_B0_p[0] + base13 + n_x*1 + n_y * xdim13_opensbliblock00Kernel081*1);
        ACC<double> SD110_B0(xdim14_opensbliblock00Kernel081, &SD110_B0_p[0] + base14 + n_x*1 + n_y * xdim14_opensbliblock00Kernel081*1);
        ACC<double> SD111_B0(xdim15_opensbliblock00Kernel081, &SD111_B0_p[0] + base15 + n_x*1 + n_y * xdim15_opensbliblock00Kernel081*1);
        //USER CODE
