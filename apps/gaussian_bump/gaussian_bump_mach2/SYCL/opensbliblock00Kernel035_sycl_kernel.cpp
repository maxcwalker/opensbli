...
void ops_par_loop_opensbliblock00Kernel035_execute(ops_kernel_descriptor *desc) {
  ...
  double* wk12_B0_p = (double*)args[1].data_d;
  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      , [=](cl::sycl::nd_item<2> item
        ...
        ACC<double> wk12_B0(xdim1_opensbliblock00Kernel035, &wk12_B0_p[0] + base1 + n_x*1 + n_y * xdim1_opensbliblock00Kernel035*1);
        //USER CODE
        if (n_x < end_0 && n_y < end_1) {
          
    wk12_B0(0,0) = inv2Delta0block0_sycl[0]*((idx[0] == 0) ? (
