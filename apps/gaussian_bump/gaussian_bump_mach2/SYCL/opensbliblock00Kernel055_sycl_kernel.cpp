...
void ops_par_loop_opensbliblock00Kernel055_execute(ops_kernel_descriptor *desc) {
  ...
  int xdim0_opensbliblock00Kernel055 = args[0].dat->size[0];
  int xdim1_opensbliblock00Kernel055 = args[1].dat->size[0];
  int xdim2_opensbliblock00Kernel055 = args[2].dat->size[0];
  int xdim3_opensbliblock00Kernel055 = args[3].dat->size[0];
  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      cgh.parallel_for<class opensbliblock00Kernel055_kernel>(cl::sycl::nd_range<2>(cl::sycl::range<2>(
      ...
      , [=](cl::sycl::nd_item<2> item
        ...
        ACC<double> rhoE_B0(xdim0_opensbliblock00Kernel055, &rhoE_B0_p[0] + base0 + n_x*1 + n_y * xdim0_opensbliblock00Kernel055*1);
        ACC<double> rho_B0(xdim1_opensbliblock00Kernel055, &rho_B0_p[0] + base1 + n_x*1 + n_y * xdim1_opensbliblock00Kernel055*1);
        ACC<double> rhou0_B0(xdim2_opensbliblock00Kernel055, &rhou0_B0_p[0] + base2 + n_x*1 + n_y * xdim2_opensbliblock00Kernel055*1);
        ACC<double> rhou1_B0(xdim3_opensbliblock00Kernel055, &rhou1_B0_p[0] + base3 + n_x*1 + n_y * xdim3_opensbliblock00Kernel055*1);
        //USER CODE
   ...
   rhoE_B0(0,0) = Twall_sycl[0]*inv2Minf_sycl[0]*rho_B0(0,0)/(gama_sycl[0]*(-1.0 + gama_sycl[0]));

    Pwall = (-1 + gama_sycl[0])*(-(((1.0/2.0))*(rhou0_B0(0,0)*rhou0_B0(0,0)) +
   ...
   u12 = rhou1_B0(0,2)/rho_B0(0,2);
    ...
    T_above = (Minf_sycl[0]*Minf_sycl[0])*(-1 + gama_sycl[0])*(-(((1.0/2.0))*(rhou0_B0(0,1)*rhou0_B0(0,1)) +
      ((1.0/2.0))*(rhou1_B0(0,1)*rhou1_B0(0,1)))/rho_B0(0,1) + rhoE_B0(0,1))*gama_sycl[0]/rho_B0(0,1);
   ...
   rhoE_B0(0,-1) = inv_gamma_m1_sycl[0]*Pwall + ((1.0/2.0))*((u01*u01) + (u11*u11))*rho_halo_1;
   ...
   rhoE_B0(0,-2) = inv_gamma_m1_sycl[0]*Pwall + ((1.0/2.0))*((u02*u02) + (u12*u12))*rho_halo_2;
