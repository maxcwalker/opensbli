...
void ops_par_loop_opensbliblock00Kernel071_execute(ops_kernel_descriptor *desc) {
  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      cgh.parallel_for<class opensbliblock00Kernel071_kernel>(cl::sycl::nd_range<2>(cl::sycl::range<2>(
      ...
      , [=](cl::sycl::nd_item<2> item
        ...
        const ACC<double> D00_B0(xdim0_opensbliblock00Kernel071, &D00_B0_p[0] + base0 + n_x*1 + n_y * xdim0_opensbliblock00Kernel071*1);
        ACC<double> wk2_B0(xdim1_opensbliblock00Kernel071, &wk2_B0_p[0] + base1 + n_x*1 + n_y * xdim1_opensbliblock00Kernel071*1);
        //USER CODE
