...
void ops_par_loop_opensbliblock00Kernel000_execute(ops_kernel_descriptor *desc) {
  ...
  for ( int n_y=start1; n_y<end1; n_y++ ){
    for ( int n_x=start0; n_x<end0; n_x++ ){
      ...
      const ACC<double> detJ_B0(xdim3_opensbliblock00Kernel000, detJ_B0_p + n_x*1 + n_y * xdim3_opensbliblock00Kernel000*1);
      const ACC<double> p_B0(xdim4_opensbliblock00Kernel000, p_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel000*1);
      ...
      ACC<double> wk10_B0(xdim9_opensbliblock00Kernel000, wk10_B0_p + n_x*1 + n_y * xdim9_opensbliblock00Kernel000*1);
      ACC<double> wk11_B0(xdim10_opensbliblock00Kernel000, wk11_B0_p + n_x*1 + n_y * xdim10_opensbliblock00Kernel000*1);
      ACC<double> wk8_B0(xdim11_opensbliblock00Kernel000, wk8_B0_p + n_x*1 + n_y * xdim11_opensbliblock00Kernel000*1);
      ACC<double> wk9_B0(xdim12_opensbliblock00Kernel000, wk9_B0_p + n_x*1 + n_y * xdim12_opensbliblock00Kernel000*1);
...
void ops_par_loop_opensbliblock00Kernel000(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg12) {
  ...
  create_kerneldesc_and_enque(name, args, 13, 30, dim, 0, range, block, ops_par_loop_opensbliblock00Kernel000_execute);
}
#endif
