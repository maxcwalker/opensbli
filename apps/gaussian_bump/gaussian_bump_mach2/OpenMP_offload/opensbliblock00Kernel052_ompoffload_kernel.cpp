...
void ops_par_loop_opensbliblock00Kernel052_execute(ops_kernel_descriptor *desc) {
  ...
  for ( int n_y=start1; n_y<end1; n_y++ ){
    for ( int n_x=start0; n_x<end0; n_x++ ){
      const ACC<double> D00_B0(xdim0_opensbliblock00Kernel052, D00_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel052*1);
      const ACC<double> D01_B0(xdim1_opensbliblock00Kernel052, D01_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel052*1);
      const ACC<double> D10_B0(xdim2_opensbliblock00Kernel052, D10_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel052*1);
      const ACC<double> D11_B0(xdim3_opensbliblock00Kernel052, D11_B0_p + n_x*1 + n_y * xdim3_opensbliblock00Kernel052*1);
      const ACC<double> SD000_B0(xdim4_opensbliblock00Kernel052, SD000_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel052*1);
      const ACC<double> SD001_B0(xdim5_opensbliblock00Kernel052, SD001_B0_p + n_x*1 + n_y * xdim5_opensbliblock00Kernel052*1);
      const ACC<double> SD010_B0(xdim6_opensbliblock00Kernel052, SD010_B0_p + n_x*1 + n_y * xdim6_opensbliblock00Kernel052*1);
      const ACC<double> SD011_B0(xdim7_opensbliblock00Kernel052, SD011_B0_p + n_x*1 + n_y * xdim7_opensbliblock00Kernel052*1);
      const ACC<double> SD100_B0(xdim8_opensbliblock00Kernel052, SD100_B0_p + n_x*1 + n_y * xdim8_opensbliblock00Kernel052*1);
      const ACC<double> SD101_B0(xdim9_opensbliblock00Kernel052, SD101_B0_p + n_x*1 + n_y * xdim9_opensbliblock00Kernel052*1);
      const ACC<double> SD110_B0(xdim10_opensbliblock00Kernel052, SD110_B0_p + n_x*1 + n_y * xdim10_opensbliblock00Kernel052*1);
      const ACC<double> SD111_B0(xdim11_opensbliblock00Kernel052, SD111_B0_p + n_x*1 + n_y * xdim11_opensbliblock00Kernel052*1);
      const ACC<double> mu_B0(xdim12_opensbliblock00Kernel052, mu_B0_p + n_x*1 + n_y * xdim12_opensbliblock00Kernel052*1);
      const ACC<double> u0_B0(xdim13_opensbliblock00Kernel052, u0_B0_p + n_x*1 + n_y * xdim13_opensbliblock00Kernel052*1);
      const ACC<double> u1_B0(xdim14_opensbliblock00Kernel052, u1_B0_p + n_x*1 + n_y * xdim14_opensbliblock00Kernel052*1);
      const ACC<double> wk0_B0(xdim15_opensbliblock00Kernel052, wk0_B0_p + n_x*1 + n_y * xdim15_opensbliblock00Kernel052*1);
      const ACC<double> wk10_B0(xdim16_opensbliblock00Kernel052, wk10_B0_p + n_x*1 + n_y * xdim16_opensbliblock00Kernel052*1);
      const ACC<double> wk11_B0(xdim17_opensbliblock00Kernel052, wk11_B0_p + n_x*1 + n_y * xdim17_opensbliblock00Kernel052*1);
      const ACC<double> wk12_B0(xdim18_opensbliblock00Kernel052, wk12_B0_p + n_x*1 + n_y * xdim18_opensbliblock00Kernel052*1);
      const ACC<double> wk13_B0(xdim19_opensbliblock00Kernel052, wk13_B0_p + n_x*1 + n_y * xdim19_opensbliblock00Kernel052*1);
      const ACC<double> wk14_B0(xdim20_opensbliblock00Kernel052, wk14_B0_p + n_x*1 + n_y * xdim20_opensbliblock00Kernel052*1);
      const ACC<double> wk15_B0(xdim21_opensbliblock00Kernel052, wk15_B0_p + n_x*1 + n_y * xdim21_opensbliblock00Kernel052*1);
      const ACC<double> wk16_B0(xdim22_opensbliblock00Kernel052, wk16_B0_p + n_x*1 + n_y * xdim22_opensbliblock00Kernel052*1);
      const ACC<double> wk1_B0(xdim23_opensbliblock00Kernel052, wk1_B0_p + n_x*1 + n_y * xdim23_opensbliblock00Kernel052*1);
      const ACC<double> wk2_B0(xdim24_opensbliblock00Kernel052, wk2_B0_p + n_x*1 + n_y * xdim24_opensbliblock00Kernel052*1);
      const ACC<double> wk3_B0(xdim25_opensbliblock00Kernel052, wk3_B0_p + n_x*1 + n_y * xdim25_opensbliblock00Kernel052*1);
      const ACC<double> wk4_B0(xdim26_opensbliblock00Kernel052, wk4_B0_p + n_x*1 + n_y * xdim26_opensbliblock00Kernel052*1);
      const ACC<double> wk5_B0(xdim27_opensbliblock00Kernel052, wk5_B0_p + n_x*1 + n_y * xdim27_opensbliblock00Kernel052*1);
      const ACC<double> wk6_B0(xdim28_opensbliblock00Kernel052, wk6_B0_p + n_x*1 + n_y * xdim28_opensbliblock00Kernel052*1);
      const ACC<double> wk7_B0(xdim29_opensbliblock00Kernel052, wk7_B0_p + n_x*1 + n_y * xdim29_opensbliblock00Kernel052*1);
      const ACC<double> wk8_B0(xdim30_opensbliblock00Kernel052, wk8_B0_p + n_x*1 + n_y * xdim30_opensbliblock00Kernel052*1);
      const ACC<double> wk9_B0(xdim31_opensbliblock00Kernel052, wk9_B0_p + n_x*1 + n_y * xdim31_opensbliblock00Kernel052*1);
      ACC<double> Residual1_B0(xdim32_opensbliblock00Kernel052, Residual1_B0_p + n_x*1 + n_y * xdim32_opensbliblock00Kernel052*1);
      ACC<double> Residual2_B0(xdim33_opensbliblock00Kernel052, Residual2_B0_p + n_x*1 + n_y * xdim33_opensbliblock00Kernel052*1);
      ACC<double> Residual3_B0(xdim34_opensbliblock00Kernel052, Residual3_B0_p + n_x*1 + n_y * xdim34_opensbliblock00Kernel052*1);
...
void ops_par_loop_opensbliblock00Kernel052(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg32, ops_arg arg33, ops_arg arg34) {
  ...
  create_kerneldesc_and_enque(name, args, 35, 58, dim, 0, range, block, ops_par_loop_opensbliblock00Kernel052_execute);
}
#endif
