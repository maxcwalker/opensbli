...
void opensbliblock00Kernel069_c_wrapper(
  ...
  for ( int n_y=0; n_y<y_size; n_y++ ){
    for ( int n_x=0; n_x<x_size; n_x++ ){
      ...
      const ptr_double D10_B0 = { D10_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel069*1, xdim0_opensbliblock00Kernel069};
      ptr_double wk0_B0 = { wk0_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel069*1, xdim1_opensbliblock00Kernel069};
