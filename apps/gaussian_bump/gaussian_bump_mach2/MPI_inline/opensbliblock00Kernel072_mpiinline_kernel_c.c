...
void opensbliblock00Kernel072_c_wrapper(
  ...
  for ( int n_y=0; n_y<y_size; n_y++ ){
    for ( int n_x=0; n_x<x_size; n_x++ ){
      ...
      const ptr_double D01_B0 = { D01_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel072*1, xdim0_opensbliblock00Kernel072};
      ptr_double wk3_B0 = { wk3_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel072*1, xdim1_opensbliblock00Kernel072};
