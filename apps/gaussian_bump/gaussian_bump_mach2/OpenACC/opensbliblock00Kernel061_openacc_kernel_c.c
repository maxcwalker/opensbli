...
//user function
inline 
void opensbliblock00Kernel061(const ptr_double x0_B0,
  ptr_double wk3_B0,
  const int *idx)
{
...
void opensbliblock00Kernel061_c_wrapper(
  ...
  for ( int n_y=0; n_y<y_size; n_y++ ){
    ...
    for ( int n_x=0; n_x<x_size; n_x++ ){
      ...
      ptr_double ptr1 = {  p_a1 + n_x*1*1 + n_y*xdim1_opensbliblock00Kernel061*1*1, xdim1_opensbliblock00Kernel061};
      opensbliblock00Kernel061( ptr0, ptr1,arg_idx);
    }
  }
}
