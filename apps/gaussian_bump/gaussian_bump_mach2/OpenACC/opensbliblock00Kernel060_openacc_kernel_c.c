...
//user function
inline 
void opensbliblock00Kernel060(const ptr_double x1_B0,
  ptr_double wk2_B0,
  const int *idx)
{
...
void opensbliblock00Kernel060_c_wrapper(
  ...
  for ( int n_y=0; n_y<y_size; n_y++ ){
    ...
    for ( int n_x=0; n_x<x_size; n_x++ ){
      ...
      const ptr_double ptr0 = {  p_a0 + n_x*1*1 + n_y*xdim0_opensbliblock00Kernel060*1*1, xdim0_opensbliblock00Kernel060};
      ptr_double ptr1 = {  p_a1 + n_x*1*1 + n_y*xdim1_opensbliblock00Kernel060*1*1, xdim1_opensbliblock00Kernel060};
