...
void opensbliblock00Kernel021_gpu(const ACC<double> &wk11_B0,
  ACC<double> &wk7_B0,
  const int *idx)
{
...
void ops_par_loop_opensbliblock00Kernel021(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  create_kerneldesc_and_enque(name, args, 3, 39, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel021_execute);
}
#endif
