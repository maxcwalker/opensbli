...
//
__constant__ int dims_opensbliblock00Kernel061 [3][1];
static int dims_opensbliblock00Kernel061_h [3][1] = {{0}};

//user function
__device__

void opensbliblock00Kernel061_gpu(const ACC<double> &x0_B0,
  ACC<double> &wk3_B0,
  const int *idx)
{
...
int size1 ){
  ...
  if (idx_x < size0 && idx_y < size1) {
    ...
    ACC<double> argp1(dims_opensbliblock00Kernel061[1][0], arg1);
...
void ops_par_loop_opensbliblock00Kernel061_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_opensbliblock00Kernel061_h[0][0] || xdim1 != dims_opensbliblock00Kernel061_h[1][0]) {
...
void ops_par_loop_opensbliblock00Kernel061(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  create_kerneldesc_and_enque(name, args, 3, 4, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel061_execute);
}
#endif
