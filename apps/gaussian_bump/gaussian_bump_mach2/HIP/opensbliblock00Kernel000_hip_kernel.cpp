...
//
__constant__ int dims_opensbliblock00Kernel000 [13][1];
static int dims_opensbliblock00Kernel000_h [13][1] = {{0}};
...
int size1 ){
  ...
  if (idx_x < size0 && idx_y < size1) {
    ...
    ACC<double> argp9(dims_opensbliblock00Kernel000[9][0], arg9);
    ACC<double> argp10(dims_opensbliblock00Kernel000[10][0], arg10);
    ACC<double> argp11(dims_opensbliblock00Kernel000[11][0], arg11);
...
void ops_par_loop_opensbliblock00Kernel000(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg12) {
  ...
  create_kerneldesc_and_enque(name, args, 13, 30, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel000_execute);
}
#endif
