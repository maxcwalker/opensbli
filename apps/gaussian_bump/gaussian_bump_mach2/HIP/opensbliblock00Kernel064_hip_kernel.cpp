...
//
__constant__ int dims_opensbliblock00Kernel064 [9][1];
static int dims_opensbliblock00Kernel064_h [9][1] = {{0}};

//user function
__device__

 void opensbliblock00Kernel064_gpu(const ACC<double> &wk1_B0,
...
int size1 ){
  ...
  arg5 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel064[5][0];
  arg6 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel064[6][0];
  arg7 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel064[7][0];
  arg8 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel064[8][0];

  if (idx_x < size0 && idx_y < size1) {
    const ACC<double> argp0(dims_opensbliblock00Kernel064[0][0], arg0);
    const ACC<double> argp1(dims_opensbliblock00Kernel064[1][0], arg1);
    ...
    ACC<double> argp5(dims_opensbliblock00Kernel064[5][0], arg5);
    ACC<double> argp6(dims_opensbliblock00Kernel064[6][0], arg6);
    ACC<double> argp7(dims_opensbliblock00Kernel064[7][0], arg7);
    ACC<double> argp8(dims_opensbliblock00Kernel064[8][0], arg8);
...
void ops_par_loop_opensbliblock00Kernel064_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_opensbliblock00Kernel064_h[0][0] || xdim1 != dims_opensbliblock00Kernel064_h[1][0] || xdim2 != dims_opensbliblock00Kernel064_h[2][0] || xdim3 != dims_opensbliblock00Kernel064_h[3][0] || xdim4 != dims_opensbliblock00Kernel064_h[4][0] || xdim5 != dims_opensbliblock00Kernel064_h[5][0] || xdim6 != dims_opensbliblock00Kernel064_h[6][0] || xdim7 != dims_opensbliblock00Kernel064_h[7][0] || xdim8 != dims_opensbliblock00Kernel064_h[8][0]) {
...
void ops_par_loop_opensbliblock00Kernel064(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg8) {
  ...
  create_kerneldesc_and_enque(name, args, 9, 5, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel064_execute);
}
#endif
