...
void opensbliblock00Kernel017_gpu(const ACC<double> &wk8_B0,
  ACC<double> &wk4_B0,
  const int *idx)
{
...
void ops_par_loop_opensbliblock00Kernel017(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  create_kerneldesc_and_enque(name, args, 3, 36, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel017_execute);
}
#endif
