...
//
    ...
    void buildOpenCLKernels_opensbliblock00Kernel081(OPS_instance *instance, int xdim0, int xdim1, int xdim2, int xdim3, int xdim4, int xdim5, int xdim6, int xdim7, int xdim8, int xdim9, int xdim10, int xdim11, int xdim12, int xdim13, int xdim14, int xdim15) {
      ...
      if(!isbuilt_opensbliblock00Kernel081) {
        ...
        instance->ostream() <<"Compiling opensbliblock00Kernel081 "<<OCL_FMA<<" source -- start \n";
          ...
          if (pPath!=NULL)
            if(OCL_FMA)
              sprintf(buildOpts,"-cl-mad-enable -DOCL_FMA -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_opensbliblock00Kernel081=%d  -Dxdim1_opensbliblock00Kernel081=%d  -Dxdim2_opensbliblock00Kernel081=%d  -Dxdim3_opensbliblock00Kernel081=%d  -Dxdim4_opensbliblock00Kernel081=%d  -Dxdim5_opensbliblock00Kernel081=%d  -Dxdim6_opensbliblock00Kernel081=%d  -Dxdim7_opensbliblock00Kernel081=%d  -Dxdim8_opensbliblock00Kernel081=%d  -Dxdim9_opensbliblock00Kernel081=%d  -Dxdim10_opensbliblock00Kernel081=%d  -Dxdim11_opensbliblock00Kernel081=%d  -Dxdim12_opensbliblock00Kernel081=%d  -Dxdim13_opensbliblock00Kernel081=%d  -Dxdim14_opensbliblock00Kernel081=%d  -Dxdim15_opensbliblock00Kernel081=%d ", pPath, 32,xdim0,xdim1,xdim2,xdim3,xdim4,xdim5,xdim6,xdim7,xdim8,xdim9,xdim10,xdim11,xdim12,xdim13,xdim14,xdim15);
            else
        ...
        instance->opencl_instance->OPS_opencl_core.kernel[18] = clCreateKernel(instance->opencl_instance->OPS_opencl_core.program, "ops_opensbliblock00Kernel081", &ret);
        clSafeCall( ret );
...
void ops_par_loop_opensbliblock00Kernel081(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg12, ops_arg arg13, ops_arg arg14, ops_arg arg15) {
  ...
  if (block->instance->OPS_diags > 1) {
    ops_timing_realloc(block->instance,18,"opensbliblock00Kernel081");
