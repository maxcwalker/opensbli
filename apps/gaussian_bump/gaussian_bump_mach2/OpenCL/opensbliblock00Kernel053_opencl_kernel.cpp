...
//
    ...
    void buildOpenCLKernels_opensbliblock00Kernel053(OPS_instance *instance, int xdim0, int xdim1, int xdim2, int xdim3) {
      ...
      if(!isbuilt_opensbliblock00Kernel053) {
        ...
        instance->ostream() <<"Compiling opensbliblock00Kernel053 "<<OCL_FMA<<" source -- start \n";
          ...
          if (pPath!=NULL)
            if(OCL_FMA)
              sprintf(buildOpts,"-cl-mad-enable -DOCL_FMA -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_opensbliblock00Kernel053=%d  -Dxdim1_opensbliblock00Kernel053=%d  -Dxdim2_opensbliblock00Kernel053=%d  -Dxdim3_opensbliblock00Kernel053=%d ", pPath, 32,xdim0,xdim1,xdim2,xdim3);
            else
              sprintf(buildOpts,"-cl-mad-enable -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_opensbliblock00Kernel053=%d  -Dxdim1_opensbliblock00Kernel053=%d  -Dxdim2_opensbliblock00Kernel053=%d  -Dxdim3_opensbliblock00Kernel053=%d ", pPath, 32,xdim0,xdim1,xdim2,xdim3);
          else {
...
void ops_par_loop_opensbliblock00Kernel053(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2, ops_arg arg3) {
  ...
  if (globalWorkSize[0]>0 && globalWorkSize[1]>0 && globalWorkSize[2]>0) {
    ...
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[19], 6, sizeof(cl_int), (void*) &base2 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[19], 7, sizeof(cl_int), (void*) &base3 ));
