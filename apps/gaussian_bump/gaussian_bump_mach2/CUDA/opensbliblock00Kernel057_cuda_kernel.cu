...
//
__constant__ int dims_opensbliblock00Kernel057 [7][1];
static int dims_opensbliblock00Kernel057_h [7][1] = {{0}};

//user function
__device__

 void opensbliblock00Kernel057_gpu(ACC<double> &rhoE_B0,
  ACC<double> &rho_B0,
  ACC<double> &rhou0_B0,
  ACC<double> &rhou1_B0,
  ACC<double> &x0_B0,
...
int size1 ){
  ...
  arg0 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel057[0][0];
  arg1 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel057[1][0];
  arg2 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel057[2][0];
  arg3 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel057[3][0];
  arg4 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel057[4][0];
  arg5 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel057[5][0];

  if (idx_x < size0 && idx_y < size1) {
    ACC<double> argp0(dims_opensbliblock00Kernel057[0][0], arg0);
    ACC<double> argp1(dims_opensbliblock00Kernel057[1][0], arg1);
    ACC<double> argp2(dims_opensbliblock00Kernel057[2][0], arg2);
    ACC<double> argp3(dims_opensbliblock00Kernel057[3][0], arg3);
    ACC<double> argp4(dims_opensbliblock00Kernel057[4][0], arg4);
    ACC<double> argp5(dims_opensbliblock00Kernel057[5][0], arg5);
...
void ops_par_loop_opensbliblock00Kernel057_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_opensbliblock00Kernel057_h[0][0] || xdim1 != dims_opensbliblock00Kernel057_h[1][0] || xdim2 != dims_opensbliblock00Kernel057_h[2][0] || xdim3 != dims_opensbliblock00Kernel057_h[3][0] || xdim4 != dims_opensbliblock00Kernel057_h[4][0] || xdim5 != dims_opensbliblock00Kernel057_h[5][0]) {
...
void ops_par_loop_opensbliblock00Kernel057(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4, ops_arg arg5, ops_arg arg6) {
  ...
  create_kerneldesc_and_enque(name, args, 7, 0, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel057_execute);
}
#endif
