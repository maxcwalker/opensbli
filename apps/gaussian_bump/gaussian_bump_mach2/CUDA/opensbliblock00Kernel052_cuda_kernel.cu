...
//
__constant__ int dims_opensbliblock00Kernel052 [35][1];
static int dims_opensbliblock00Kernel052_h [35][1] = {{0}};

//user function
__device__

 void opensbliblock00Kernel052_gpu(const ACC<double> &D00_B0,
...
int size1 ){
  ...
  arg6 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel052[6][0];
  arg7 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel052[7][0];
  arg8 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel052[8][0];
  arg9 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel052[9][0];
  arg10 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel052[10][0];
  arg11 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel052[11][0];
  arg12 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel052[12][0];
  arg13 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel052[13][0];
  arg14 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel052[14][0];
  arg15 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel052[15][0];
  arg16 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel052[16][0];
  arg17 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel052[17][0];
  arg18 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel052[18][0];
  arg19 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel052[19][0];
  arg20 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel052[20][0];
  arg21 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel052[21][0];
  arg22 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel052[22][0];
  arg23 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel052[23][0];
  arg24 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel052[24][0];
  arg25 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel052[25][0];
  arg26 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel052[26][0];
  arg27 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel052[27][0];
  arg28 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel052[28][0];
  arg29 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel052[29][0];
  arg30 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel052[30][0];
  arg31 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel052[31][0];
  arg32 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel052[32][0];
  arg33 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel052[33][0];
  arg34 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel052[34][0];

  if (idx_x < size0 && idx_y < size1) {
    const ACC<double> argp0(dims_opensbliblock00Kernel052[0][0], arg0);
    const ACC<double> argp1(dims_opensbliblock00Kernel052[1][0], arg1);
    const ACC<double> argp2(dims_opensbliblock00Kernel052[2][0], arg2);
    const ACC<double> argp3(dims_opensbliblock00Kernel052[3][0], arg3);
    const ACC<double> argp4(dims_opensbliblock00Kernel052[4][0], arg4);
    const ACC<double> argp5(dims_opensbliblock00Kernel052[5][0], arg5);
    const ACC<double> argp6(dims_opensbliblock00Kernel052[6][0], arg6);
    const ACC<double> argp7(dims_opensbliblock00Kernel052[7][0], arg7);
    const ACC<double> argp8(dims_opensbliblock00Kernel052[8][0], arg8);
    const ACC<double> argp9(dims_opensbliblock00Kernel052[9][0], arg9);
    const ACC<double> argp10(dims_opensbliblock00Kernel052[10][0], arg10);
    const ACC<double> argp11(dims_opensbliblock00Kernel052[11][0], arg11);
    const ACC<double> argp12(dims_opensbliblock00Kernel052[12][0], arg12);
    const ACC<double> argp13(dims_opensbliblock00Kernel052[13][0], arg13);
    const ACC<double> argp14(dims_opensbliblock00Kernel052[14][0], arg14);
    const ACC<double> argp15(dims_opensbliblock00Kernel052[15][0], arg15);
    const ACC<double> argp16(dims_opensbliblock00Kernel052[16][0], arg16);
    const ACC<double> argp17(dims_opensbliblock00Kernel052[17][0], arg17);
    const ACC<double> argp18(dims_opensbliblock00Kernel052[18][0], arg18);
    const ACC<double> argp19(dims_opensbliblock00Kernel052[19][0], arg19);
    const ACC<double> argp20(dims_opensbliblock00Kernel052[20][0], arg20);
    const ACC<double> argp21(dims_opensbliblock00Kernel052[21][0], arg21);
    const ACC<double> argp22(dims_opensbliblock00Kernel052[22][0], arg22);
    const ACC<double> argp23(dims_opensbliblock00Kernel052[23][0], arg23);
    const ACC<double> argp24(dims_opensbliblock00Kernel052[24][0], arg24);
    const ACC<double> argp25(dims_opensbliblock00Kernel052[25][0], arg25);
    const ACC<double> argp26(dims_opensbliblock00Kernel052[26][0], arg26);
    const ACC<double> argp27(dims_opensbliblock00Kernel052[27][0], arg27);
    const ACC<double> argp28(dims_opensbliblock00Kernel052[28][0], arg28);
    const ACC<double> argp29(dims_opensbliblock00Kernel052[29][0], arg29);
    const ACC<double> argp30(dims_opensbliblock00Kernel052[30][0], arg30);
    const ACC<double> argp31(dims_opensbliblock00Kernel052[31][0], arg31);
    ACC<double> argp32(dims_opensbliblock00Kernel052[32][0], arg32);
    ACC<double> argp33(dims_opensbliblock00Kernel052[33][0], arg33);
    ACC<double> argp34(dims_opensbliblock00Kernel052[34][0], arg34);
    opensbliblock00Kernel052_gpu(
...
void ops_par_loop_opensbliblock00Kernel052_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_opensbliblock00Kernel052_h[0][0] || xdim1 != dims_opensbliblock00Kernel052_h[1][0] || xdim2 != dims_opensbliblock00Kernel052_h[2][0] || xdim3 != dims_opensbliblock00Kernel052_h[3][0] || xdim4 != dims_opensbliblock00Kernel052_h[4][0] || xdim5 != dims_opensbliblock00Kernel052_h[5][0] || xdim6 != dims_opensbliblock00Kernel052_h[6][0] || xdim7 != dims_opensbliblock00Kernel052_h[7][0] || xdim8 != dims_opensbliblock00Kernel052_h[8][0] || xdim9 != dims_opensbliblock00Kernel052_h[9][0] || xdim10 != dims_opensbliblock00Kernel052_h[10][0] || xdim11 != dims_opensbliblock00Kernel052_h[11][0] || xdim12 != dims_opensbliblock00Kernel052_h[12][0] || xdim13 != dims_opensbliblock00Kernel052_h[13][0] || xdim14 != dims_opensbliblock00Kernel052_h[14][0] || xdim15 != dims_opensbliblock00Kernel052_h[15][0] || xdim16 != dims_opensbliblock00Kernel052_h[16][0] || xdim17 != dims_opensbliblock00Kernel052_h[17][0] || xdim18 != dims_opensbliblock00Kernel052_h[18][0] || xdim19 != dims_opensbliblock00Kernel052_h[19][0] || xdim20 != dims_opensbliblock00Kernel052_h[20][0] || xdim21 != dims_opensbliblock00Kernel052_h[21][0] || xdim22 != dims_opensbliblock00Kernel052_h[22][0] || xdim23 != dims_opensbliblock00Kernel052_h[23][0] || xdim24 != dims_opensbliblock00Kernel052_h[24][0] || xdim25 != dims_opensbliblock00Kernel052_h[25][0] || xdim26 != dims_opensbliblock00Kernel052_h[26][0] || xdim27 != dims_opensbliblock00Kernel052_h[27][0] || xdim28 != dims_opensbliblock00Kernel052_h[28][0] || xdim29 != dims_opensbliblock00Kernel052_h[29][0] || xdim30 != dims_opensbliblock00Kernel052_h[30][0] || xdim31 != dims_opensbliblock00Kernel052_h[31][0] || xdim32 != dims_opensbliblock00Kernel052_h[32][0] || xdim33 != dims_opensbliblock00Kernel052_h[33][0] || xdim34 != dims_opensbliblock00Kernel052_h[34][0]) {
    ...
    cutilSafeCall(block->instance->ostream(), cudaMemcpyToSymbol( dims_opensbliblock00Kernel052, dims_opensbliblock00Kernel052_h, sizeof(dims_opensbliblock00Kernel052)));
  }
  ...
  if (x_size > 0 && y_size > 0)
    ops_opensbliblock00Kernel052<<<grid, tblock >>> ( 
...
void ops_par_loop_opensbliblock00Kernel052(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg32, ops_arg arg33, ops_arg arg34) {
  ...
  create_kerneldesc_and_enque(name, args, 35, 58, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel052_execute);
}
#endif
