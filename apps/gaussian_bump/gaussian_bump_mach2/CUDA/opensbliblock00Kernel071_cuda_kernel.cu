...
//
__constant__ int dims_opensbliblock00Kernel071 [3][1];
static int dims_opensbliblock00Kernel071_h [3][1] = {{0}};

//user function
__device__

void opensbliblock00Kernel071_gpu(const ACC<double> &D00_B0,
  ACC<double> &wk2_B0,
  const int *idx)
{
...
int size1 ){
  ...
  arg0 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel071[0][0];
  arg1 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel071[1][0];

  if (idx_x < size0 && idx_y < size1) {
    const ACC<double> argp0(dims_opensbliblock00Kernel071[0][0], arg0);
    ACC<double> argp1(dims_opensbliblock00Kernel071[1][0], arg1);
...
void ops_par_loop_opensbliblock00Kernel071_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_opensbliblock00Kernel071_h[0][0] || xdim1 != dims_opensbliblock00Kernel071_h[1][0]) {
...
void ops_par_loop_opensbliblock00Kernel071(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  create_kerneldesc_and_enque(name, args, 3, 12, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel071_execute);
}
#endif
