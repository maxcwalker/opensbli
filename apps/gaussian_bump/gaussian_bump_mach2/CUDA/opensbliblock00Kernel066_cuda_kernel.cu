...
//
__constant__ int dims_opensbliblock00Kernel066 [5][1];
static int dims_opensbliblock00Kernel066_h [5][1] = {{0}};

//user function
__device__

 void opensbliblock00Kernel066_gpu(ACC<double> &D00_B0,
  ACC<double> &D01_B0,
  ACC<double> &D10_B0,
  ACC<double> &D11_B0,
  ACC<double> &detJ_B0)
...
void ops_par_loop_opensbliblock00Kernel066_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_opensbliblock00Kernel066_h[0][0] || xdim1 != dims_opensbliblock00Kernel066_h[1][0] || xdim2 != dims_opensbliblock00Kernel066_h[2][0] || xdim3 != dims_opensbliblock00Kernel066_h[3][0] || xdim4 != dims_opensbliblock00Kernel066_h[4][0]) {
...
void ops_par_loop_opensbliblock00Kernel066(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4) {
  ...
  create_kerneldesc_and_enque(name, args, 5, 7, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel066_execute);
}
#endif
