...
{
    wk4_B0(0,0) = ((idx[1] == 0) ? (
   inv_0*(-rc11*T_B0(0,0) - rc12*T_B0(0,4) +
      4*T_B0(0,1) - 3*T_B0(0,2) + (rc13)*T_B0(0,3))
)
: ((idx[1] == 1) ? (

      (rc14)*inv_0*(-10*T_B0(0,0) + 18*T_B0(0,1) - 3*T_B0(0,-1) - 6*T_B0(0,2) +
      T_B0(0,3))
)
: (
   (rc14)*inv_0*(-8*T_B0(0,-1) - T_B0(0,2) + T_B0(0,-2) +
      8*T_B0(0,1))
)));
