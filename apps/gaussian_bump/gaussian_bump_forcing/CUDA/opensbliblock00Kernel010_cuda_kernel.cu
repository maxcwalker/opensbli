...
int size1 ){
  ...
  if (idx_x < size0 && idx_y < size1) {
    ...
    ACC<double> argp4(dims_opensbliblock00Kernel010[4][0], arg4);
...
void ops_par_loop_opensbliblock00Kernel010_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_opensbliblock00Kernel010_h[0][0] || xdim1 != dims_opensbliblock00Kernel010_h[1][0] || xdim2 != dims_opensbliblock00Kernel010_h[2][0] || xdim3 != dims_opensbliblock00Kernel010_h[3][0] || xdim4 != dims_opensbliblock00Kernel010_h[4][0]) {
