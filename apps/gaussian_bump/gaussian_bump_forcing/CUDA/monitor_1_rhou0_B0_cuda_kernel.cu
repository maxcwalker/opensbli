...
void ops_par_loop_monitor_1_rhou0_B0_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_monitor_1_rhou0_B0_h[0][0]) {
    ...
    cutilSafeCall(block->instance->ostream(), cudaMemcpyToSymbol( dims_monitor_1_rhou0_B0, dims_monitor_1_rhou0_B0_h, sizeof(dims_monitor_1_rhou0_B0)));
  }
  ...
  if (x_size > 0 && y_size > 0)
    ops_monitor_1_rhou0_B0<<<grid, tblock, nshared >>> (  (double *)p_a[0], (double *)arg1.data_d,x_size, y_size);
