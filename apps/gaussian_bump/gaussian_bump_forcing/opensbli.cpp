...
ops_par_loop(opensbliblock00Kernel069, "MetricsEquation CD x1_B0 xi1 ", opensbliblock00, 2, iteration_range_69_block0,
...
ops_par_loop(opensbliblock00Kernel079, "MetricsEquation CD D11_B0 xi1 ", opensbliblock00, 2, iteration_range_79_block0,
...
ops_par_loop(opensbliblock00Kernel080, "MetricsEquation CD D00_B0 xi0 ", opensbliblock00, 2, iteration_range_80_block0,
...
ops_par_loop(opensbliblock00Kernel082, "MetricsEquation CD D00_B0 xi1 ", opensbliblock00, 2, iteration_range_82_block0,
...
ops_par_loop(opensbliblock00Kernel064, "ForcingStripWall boundary dir1 side0", opensbliblock00, 2, iteration_range_64_block0,
...
ops_par_loop(opensbliblock00Kernel009, "CRu0", opensbliblock00, 2, iteration_range_9_block0,
...
ops_par_loop(opensbliblock00Kernel010, "CRp", opensbliblock00, 2, iteration_range_10_block0,
ops_arg_dat(u1_B0, 1, stencil_0_00, "double", OPS_READ),
ops_arg_dat(u0_B0, 1, stencil_0_00, "double", OPS_READ),
ops_arg_dat(rho_B0, 1, stencil_0_00, "double", OPS_READ),
...
ops_par_loop(opensbliblock00Kernel004, "CRa", opensbliblock00, 2, iteration_range_4_block0,
...
ops_par_loop(opensbliblock00Kernel028, "Viscous CD T_B0 xi1 ", opensbliblock00, 2, iteration_range_28_block0,
...
ops_par_loop(opensbliblock00Kernel030, "Viscous CD T_B0 xi1 xi1 ", opensbliblock00, 2, iteration_range_30_block0,
ops_arg_dat(T_B0, 1, stencil_0_05, "double", OPS_READ),
ops_arg_dat(wk2_B0, 1, stencil_0_00, "double", OPS_WRITE),
ops_arg_idx());
...
ops_par_loop(opensbliblock00Kernel032, "Viscous CD mu_B0 xi1 ", opensbliblock00, 2, iteration_range_32_block0,
...
ops_par_loop(opensbliblock00Kernel036, "Viscous CD u0_B0 xi0 xi0 ", opensbliblock00, 2, iteration_range_36_block0,
ops_arg_dat(u0_B0, 1, stencil_0_06, "double", OPS_READ),
ops_arg_dat(wk8_B0, 1, stencil_0_00, "double", OPS_WRITE),
ops_arg_idx());


int iteration_range_37_block0[] = {0, block0np0, -2, block0np1 + 2};
ops_par_loop(opensbliblock00Kernel037, "Viscous CD u1_B0 xi0 ", opensbliblock00, 2, iteration_range_37_block0,
...
ops_par_loop(opensbliblock00Kernel038, "Viscous CD mu_B0 xi0 ", opensbliblock00, 2, iteration_range_38_block0,
...
ops_par_loop(opensbliblock00Kernel040, "Viscous CD u0_B0 xi1 xi1 ", opensbliblock00, 2, iteration_range_40_block0,
ops_arg_dat(u0_B0, 1, stencil_0_05, "double", OPS_READ),
ops_arg_dat(wk12_B0, 1, stencil_0_00, "double", OPS_WRITE),
ops_arg_idx());


int iteration_range_41_block0[] = {0, block0np0, -2, block0np1 + 2};
ops_par_loop(opensbliblock00Kernel041, "Viscous CD T_B0 xi0 ", opensbliblock00, 2, iteration_range_41_block0,
ops_arg_dat(T_B0, 1, stencil_0_06, "double", OPS_READ),
...
ops_par_loop(opensbliblock00Kernel029, "Viscous CD CD T_B0 xi0 xi1 ", opensbliblock00, 2, iteration_range_29_block0,
ops_arg_dat(wk13_B0, 1, stencil_0_05, "double", OPS_READ),
ops_arg_dat(wk1_B0, 1, stencil_0_00, "double", OPS_WRITE),
ops_arg_idx());


int iteration_range_39_block0[] = {0, block0np0, 0, block0np1};
ops_par_loop(opensbliblock00Kernel039, "Viscous CD CD u0_B0 xi0 xi1 ", opensbliblock00, 2, iteration_range_39_block0,
...
ops_par_loop(opensbliblock00Kernel043, "Viscous CD CD u1_B0 xi0 xi1 ", opensbliblock00, 2, iteration_range_43_block0,
ops_arg_dat(wk9_B0, 1, stencil_0_05, "double", OPS_READ),
...
ops_NaNcheck(rhou0_B0);
if (iter == 0){
ops_fprintf(f, "Iteration, Time, rhou0_B0(178, 45), rhou0_B0(178, 72), rhou0_B0(178, 96), rhou0_B0(178, 118), rhou0_B0(178, 139), rhou0_B0(178, 160), rhou0_B0(178, 176)\n");}
...
ops_reduction reduce_0_rhou0_B0 = ops_decl_reduction_handle(sizeof(double), "double", "reduction_0_rhou0_B0");
double rhou0_B0_0_output = 0.0;
int i0 = 178, j0 = 45;
int monitor_range_0_rhou0_B0[] = {i0, i0+1, j0, j0+1};
ops_par_loop(monitor_0_rhou0_B0, "Reduction rhou0_B0_0", opensbliblock00, 2, monitor_range_0_rhou0_B0,
ops_arg_dat(rhou0_B0, 1, zero_stencil, "double", OPS_READ),
ops_arg_reduce(reduce_0_rhou0_B0, 1, "double", OPS_INC));
ops_reduction_result(reduce_0_rhou0_B0, &rhou0_B0_0_output);

// Monitoring of rhou0_B0
ops_reduction reduce_1_rhou0_B0 = ops_decl_reduction_handle(sizeof(double), "double", "reduction_1_rhou0_B0");
double rhou0_B0_1_output = 0.0;
int i1 = 178, j1 = 72;
int monitor_range_1_rhou0_B0[] = {i1, i1+1, j1, j1+1};
ops_par_loop(monitor_1_rhou0_B0, "Reduction rhou0_B0_1", opensbliblock00, 2, monitor_range_1_rhou0_B0,
ops_arg_dat(rhou0_B0, 1, zero_stencil, "double", OPS_READ),
ops_arg_reduce(reduce_1_rhou0_B0, 1, "double", OPS_INC));
ops_reduction_result(reduce_1_rhou0_B0, &rhou0_B0_1_output);

// Monitoring of rhou0_B0
ops_reduction reduce_2_rhou0_B0 = ops_decl_reduction_handle(sizeof(double), "double", "reduction_2_rhou0_B0");
double rhou0_B0_2_output = 0.0;
int i2 = 178, j2 = 96;
int monitor_range_2_rhou0_B0[] = {i2, i2+1, j2, j2+1};
ops_par_loop(monitor_2_rhou0_B0, "Reduction rhou0_B0_2", opensbliblock00, 2, monitor_range_2_rhou0_B0,
ops_arg_dat(rhou0_B0, 1, zero_stencil, "double", OPS_READ),
ops_arg_reduce(reduce_2_rhou0_B0, 1, "double", OPS_INC));
ops_reduction_result(reduce_2_rhou0_B0, &rhou0_B0_2_output);

// Monitoring of rhou0_B0
ops_reduction reduce_3_rhou0_B0 = ops_decl_reduction_handle(sizeof(double), "double", "reduction_3_rhou0_B0");
double rhou0_B0_3_output = 0.0;
int i3 = 178, j3 = 118;
int monitor_range_3_rhou0_B0[] = {i3, i3+1, j3, j3+1};
ops_par_loop(monitor_3_rhou0_B0, "Reduction rhou0_B0_3", opensbliblock00, 2, monitor_range_3_rhou0_B0,
ops_arg_dat(rhou0_B0, 1, zero_stencil, "double", OPS_READ),
ops_arg_reduce(reduce_3_rhou0_B0, 1, "double", OPS_INC));
ops_reduction_result(reduce_3_rhou0_B0, &rhou0_B0_3_output);

// Monitoring of rhou0_B0
ops_reduction reduce_4_rhou0_B0 = ops_decl_reduction_handle(sizeof(double), "double", "reduction_4_rhou0_B0");
double rhou0_B0_4_output = 0.0;
int i4 = 178, j4 = 139;
int monitor_range_4_rhou0_B0[] = {i4, i4+1, j4, j4+1};
ops_par_loop(monitor_4_rhou0_B0, "Reduction rhou0_B0_4", opensbliblock00, 2, monitor_range_4_rhou0_B0,
ops_arg_dat(rhou0_B0, 1, zero_stencil, "double", OPS_READ),
ops_arg_reduce(reduce_4_rhou0_B0, 1, "double", OPS_INC));
ops_reduction_result(reduce_4_rhou0_B0, &rhou0_B0_4_output);

// Monitoring of rhou0_B0
ops_reduction reduce_5_rhou0_B0 = ops_decl_reduction_handle(sizeof(double), "double", "reduction_5_rhou0_B0");
double rhou0_B0_5_output = 0.0;
int i5 = 178, j5 = 160;
int monitor_range_5_rhou0_B0[] = {i5, i5+1, j5, j5+1};
ops_par_loop(monitor_5_rhou0_B0, "Reduction rhou0_B0_5", opensbliblock00, 2, monitor_range_5_rhou0_B0,
ops_arg_dat(rhou0_B0, 1, zero_stencil, "double", OPS_READ),
ops_arg_reduce(reduce_5_rhou0_B0, 1, "double", OPS_INC));
ops_reduction_result(reduce_5_rhou0_B0, &rhou0_B0_5_output);

// Monitoring of rhou0_B0
ops_reduction reduce_6_rhou0_B0 = ops_decl_reduction_handle(sizeof(double), "double", "reduction_6_rhou0_B0");
double rhou0_B0_6_output = 0.0;
int i6 = 178, j6 = 176;
int monitor_range_6_rhou0_B0[] = {i6, i6+1, j6, j6+1};
ops_par_loop(monitor_6_rhou0_B0, "Reduction rhou0_B0_6", opensbliblock00, 2, monitor_range_6_rhou0_B0,
ops_arg_dat(rhou0_B0, 1, zero_stencil, "double", OPS_READ),
ops_arg_reduce(reduce_6_rhou0_B0, 1, "double", OPS_INC));
ops_reduction_result(reduce_6_rhou0_B0, &rhou0_B0_6_output);

// Write the output values
ops_fprintf(f, "%d, %.12f, %.12f, %.12f, %.12f, %.12f, %.12f, %.12f, %.12f\n", iter+1, (iter+1)*dt, rhou0_B0_0_output, rhou0_B0_1_output, rhou0_B0_2_output, rhou0_B0_3_output, rhou0_B0_4_output, rhou0_B0_5_output, rhou0_B0_6_output);
}
