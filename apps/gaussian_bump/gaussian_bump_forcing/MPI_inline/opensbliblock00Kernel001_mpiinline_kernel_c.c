...
void opensbliblock00Kernel001_c_wrapper(
  ...
  for ( int n_y=0; n_y<y_size; n_y++ ){
    for ( int n_x=0; n_x<x_size; n_x++ ){
      ...
      const ptr_double rhou0_B0 = { rhou0_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel001*1, xdim1_opensbliblock00Kernel001};
      ...
      const ptr_double p_B0 = { p_B0_p + n_x*1 + n_y * xdim5_opensbliblock00Kernel001*1, xdim5_opensbliblock00Kernel001};
      const ptr_double u0_B0 = { u0_B0_p + n_x*1 + n_y * xdim6_opensbliblock00Kernel001*1, xdim6_opensbliblock00Kernel001};
      const ptr_double rhou1_B0 = { rhou1_B0_p + n_x*1 + n_y * xdim7_opensbliblock00Kernel001*1, xdim7_opensbliblock00Kernel001};
      ...
      const ptr_double rho_B0 = { rho_B0_p + n_x*1 + n_y * xdim10_opensbliblock00Kernel001*1, xdim10_opensbliblock00Kernel001};
   ...
   double CS_23 = 0.0;
   double Recon_3 = 0.0;
   AVG_1_u0 = (rc7)*(OPS_ACC(u0_B0, 0,0) + OPS_ACC(u0_B0, 0,1));
   ...
   AVG_1_D11 = (rc7)*(OPS_ACC(D11_B0, 0,0) + OPS_ACC(D11_B0, 0,1));
   ...
   AVG_1_1_LEV_33 = 0.707106781186547*gamma_m1*inv_AVG_a*inv_AVG_rho;
    ...
    max_lambda_1_00 = fmax(fabs(OPS_ACC(D10_B0, 0,1)*OPS_ACC(u0_B0, 0,1) +
      ...
      OPS_ACC(D11_B0, 0,2)*OPS_ACC(u1_B0, 0,2)), fabs(OPS_ACC(D10_B0, 0,-2)*OPS_ACC(u0_B0, 0,-2) +
