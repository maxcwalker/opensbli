...
void opensbliblock00Kernel064_c_wrapper(
  ...
  for ( int n_y=0; n_y<y_size; n_y++ ){
   ...
   OPS_ACC(rhoE_B0, 0,-1) = rcinv9*Pwall + (rc7)*rho_halo_1*(pow(u01, 2) + pow(u11, 2));

   OPS_ACC(rhoE_B0, 0,-2) = rcinv9*Pwall + (rc7)*rho_halo_2*(pow(u02, 2) + pow(u12, 2));

   OPS_ACC(rhoE_B0, 0,-3) = rcinv9*Pwall + (rc7)*rho_halo_3*(pow(u03, 2) + pow(u13, 2));
