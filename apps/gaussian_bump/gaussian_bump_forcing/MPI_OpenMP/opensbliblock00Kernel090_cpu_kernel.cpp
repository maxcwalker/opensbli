...
void ops_par_loop_opensbliblock00Kernel090_execute(ops_kernel_descriptor *desc) {
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
      ...
      const ACC<double> wk4_B0(xdim2_opensbliblock00Kernel090, wk4_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel090*1);
      const ACC<double> wk0_B0(xdim3_opensbliblock00Kernel090, wk0_B0_p + n_x*1 + n_y * xdim3_opensbliblock00Kernel090*1);
      const ACC<double> wk3_B0(xdim4_opensbliblock00Kernel090, wk3_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel090*1);
