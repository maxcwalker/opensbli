...
void ops_par_loop_opensbliblock00Kernel063_execute(ops_kernel_descriptor *desc) {
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
      ACC<double> rho_B0(xdim0_opensbliblock00Kernel063, rho_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel063*1);
      ...
      ACC<double> rhou0_B0(xdim3_opensbliblock00Kernel063, rhou0_B0_p + n_x*1 + n_y * xdim3_opensbliblock00Kernel063*1);
