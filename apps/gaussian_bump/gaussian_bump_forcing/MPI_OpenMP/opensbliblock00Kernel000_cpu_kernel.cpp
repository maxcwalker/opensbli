...
void ops_par_loop_opensbliblock00Kernel000_execute(ops_kernel_descriptor *desc) {
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
      const ACC<double> u1_B0(xdim0_opensbliblock00Kernel000, u1_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel000*1);
      const ACC<double> detJ_B0(xdim1_opensbliblock00Kernel000, detJ_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel000*1);
      ...
      const ACC<double> u0_B0(xdim4_opensbliblock00Kernel000, u0_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel000*1);
      const ACC<double> a_B0(xdim5_opensbliblock00Kernel000, a_B0_p + n_x*1 + n_y * xdim5_opensbliblock00Kernel000*1);
