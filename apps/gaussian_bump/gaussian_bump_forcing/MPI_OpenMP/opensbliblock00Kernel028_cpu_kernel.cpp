...
void ops_par_loop_opensbliblock00Kernel028_execute(ops_kernel_descriptor *desc) {
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
      ...
      const ACC<double> wk4_B0(xdim0_opensbliblock00Kernel028, wk4_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel028*1);
   ...
   -3*wk4_B0(0,2) + (rc12)*wk4_B0(0,3) -
      rc11*wk4_B0(0,4) - rc13*wk4_B0(0,0) + 4*wk4_B0(0,1)
)
: ((idx[1] == 1) ? (

      -rc7*wk4_B0(0,2) - rc11*wk4_B0(0,-1) + (rc14)*wk4_B0(0,3) -
      rc15*wk4_B0(0,0) + (rc16)*wk4_B0(0,1)
)
: (
   (rc17)*wk4_B0(0,1) +
      (rc14)*wk4_B0(0,-2) - rc14*wk4_B0(0,2) - rc17*wk4_B0(0,-1)
)));
