 ...
 arg5};
  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      cgh.parallel_for<class opensbliblock00Kernel047_kernel>(cl::sycl::nd_range<2>(cl::sycl::range<2>(
      ...
      , [=](cl::sycl::nd_item<2> item
        ...
        const ACC<double> x0_B0(xdim1_opensbliblock00Kernel047, &x0_B0_p[0] + base1 + n_x*1 + n_y * xdim1_opensbliblock00Kernel047*1);
        ACC<double> rhoE_B0(xdim2_opensbliblock00Kernel047, &rhoE_B0_p[0] + base2 + n_x*1 + n_y * xdim2_opensbliblock00Kernel047*1);
        ACC<double> rho_B0(xdim3_opensbliblock00Kernel047, &rho_B0_p[0] + base3 + n_x*1 + n_y * xdim3_opensbliblock00Kernel047*1);
        ACC<double> rhou0_B0(xdim4_opensbliblock00Kernel047, &rhou0_B0_p[0] + base4 + n_x*1 + n_y * xdim4_opensbliblock00Kernel047*1);
        ACC<double> rhou1_B0(xdim5_opensbliblock00Kernel047, &rhou1_B0_p[0] + base5 + n_x*1 + n_y * xdim5_opensbliblock00Kernel047*1);
   ...
   double u13 = 0.0;
   double u14 = 0.0;
   rhou1_B0(0,0) = tripA_sycl[0]*rho_B0(0,0)*cl::sycl::exp(-((-xts_sycl[0] + x0_B0(0,0))*(-xts_sycl[0] + x0_B0(0,0)))*k_0_sycl[0])*cl::sycl::sin(dt_sycl[0]*omega_0_sycl[0]* *iter);
   ...
   rhoE_B0(0,-3) = inv_gamma_m1_sycl[0]*Pwall + ((1.0/2.0))*((u03*u03) + (u13*u13))*rho_halo_3;

   rhoE_B0(0,-4) = inv_gamma_m1_sycl[0]*Pwall + ((1.0/2.0))*((u04*u04) + (u14*u14))*rho_halo_4;
