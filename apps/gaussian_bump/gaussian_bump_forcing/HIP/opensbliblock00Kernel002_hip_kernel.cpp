...
int size1 ){
  ...
  arg4 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel002[4][0];
  ...
  if (idx_x < size0 && idx_y < size1) {
    ...
    const ACC<double> argp3(dims_opensbliblock00Kernel002[3][0], arg3);
    ACC<double> argp4(dims_opensbliblock00Kernel002[4][0], arg4);
...
void ops_par_loop_opensbliblock00Kernel002_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_opensbliblock00Kernel002_h[0][0] || xdim1 != dims_opensbliblock00Kernel002_h[1][0] || xdim2 != dims_opensbliblock00Kernel002_h[2][0] || xdim3 != dims_opensbliblock00Kernel002_h[3][0] || xdim4 != dims_opensbliblock00Kernel002_h[4][0]) {
...
void ops_par_loop_opensbliblock00Kernel002(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4) {
  ...
  create_kerneldesc_and_enque(name, args, 5, 13, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel002_execute);
}
#endif
