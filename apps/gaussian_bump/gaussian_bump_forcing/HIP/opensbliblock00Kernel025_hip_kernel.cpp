...
void opensbliblock00Kernel025_gpu(const ACC<double> &rho_B0,
...
int size1 ){
  ...
  if (idx_x < size0 && idx_y < size1) {
    ...
    opensbliblock00Kernel025_gpu(argp0, argp1, argp2);
  }
...
void ops_par_loop_opensbliblock00Kernel025_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_opensbliblock00Kernel025_h[0][0] || xdim1 != dims_opensbliblock00Kernel025_h[1][0] || xdim2 != dims_opensbliblock00Kernel025_h[2][0]) {
