  ...
  const int *idx)
{
   ...
   -rc36*T_B0(0,1) + (rc34)*T_B0(0,4) +
      (rc37)*T_B0(0,0) - rc38*T_B0(0,3) + (rc39)*T_B0(0,2)
)
: ((idx[1] == 1) ? (

      (rc7)*T_B0(0,1) - rc21*T_B0(0,0) - rc16*T_B0(0,3) + (rc26)*T_B0(0,2) +
      (rc34)*T_B0(0,-1)
)
: (
   (rc13)*T_B0(0,1) - rc40*T_B0(0,0) -
      rc16*T_B0(0,-2) - rc16*T_B0(0,2) + (rc13)*T_B0(0,-1)
)));
