...
//
__constant__ int dims_opensbliblock00Kernel017 [13][1];
static int dims_opensbliblock00Kernel017_h [13][1] = {{0}};

//user function
__device__

 void opensbliblock00Kernel017_gpu(const ACC<double> &wk6_B0,
...
{
    Residual0_B0(0,0) = -(inv_0*(wk4_B0(0,0) - wk4_B0(0,-1)) +
      inv_1*(-wk0_B0(-1,0) + wk0_B0(0,0)))/detJ_B0(0,0);

    Residual1_B0(0,0) = -(inv_0*(-wk5_B0(0,-1) + wk5_B0(0,0)) +
      inv_1*(wk1_B0(0,0) - wk1_B0(-1,0)))/detJ_B0(0,0);

    Residual2_B0(0,0) = -(inv_0*(wk6_B0(0,0) - wk6_B0(0,-1)) +
      inv_1*(-wk2_B0(-1,0) + wk2_B0(0,0)))/detJ_B0(0,0);

    Residual3_B0(0,0) = -(inv_0*(wk7_B0(0,0) - wk7_B0(0,-1)) +
      inv_1*(wk3_B0(0,0) - wk3_B0(-1,0)))/detJ_B0(0,0);
...
int size1 ){
  ...
  if (size0==-1) dims_opensbliblock00Kernel017[0][0]=0;
  ...
  if (idx_x < size0 && idx_y < size1) {
    ...
    ACC<double> argp9(dims_opensbliblock00Kernel017[9][0], arg9);
    ...
    opensbliblock00Kernel017_gpu(argp0, argp1, argp2, argp3,
...
void ops_par_loop_opensbliblock00Kernel017_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_opensbliblock00Kernel017_h[0][0] || xdim1 != dims_opensbliblock00Kernel017_h[1][0] || xdim2 != dims_opensbliblock00Kernel017_h[2][0] || xdim3 != dims_opensbliblock00Kernel017_h[3][0] || xdim4 != dims_opensbliblock00Kernel017_h[4][0] || xdim5 != dims_opensbliblock00Kernel017_h[5][0] || xdim6 != dims_opensbliblock00Kernel017_h[6][0] || xdim7 != dims_opensbliblock00Kernel017_h[7][0] || xdim8 != dims_opensbliblock00Kernel017_h[8][0] || xdim9 != dims_opensbliblock00Kernel017_h[9][0] || xdim10 != dims_opensbliblock00Kernel017_h[10][0] || xdim11 != dims_opensbliblock00Kernel017_h[11][0] || xdim12 != dims_opensbliblock00Kernel017_h[12][0]) {
    ...
    hipSafeCall(block->instance->ostream(), hipMemcpyToSymbol(HIP_SYMBOL(dims_opensbliblock00Kernel017), dims_opensbliblock00Kernel017_h, sizeof(dims_opensbliblock00Kernel017)));
  }
  ...
  if (x_size > 0 && y_size > 0)
    hipLaunchKernelGGL(ops_opensbliblock00Kernel017,grid ,tblock ,0 ,0 , (double *)p_a[0], (double *)p_a[1],
