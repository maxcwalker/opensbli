...
//
__constant__ int dims_opensbliblock00Kernel026 [3][1];
static int dims_opensbliblock00Kernel026_h [3][1] = {{0}};

//user function
__device__

void opensbliblock00Kernel026_gpu(const ACC<double> &rho_B0,
...
int size1 ){
  ...
  if (idx_x < size0 && idx_y < size1) {
    ...
    const ACC<double> argp1(dims_opensbliblock00Kernel026[1][0], arg1);
...
void ops_par_loop_opensbliblock00Kernel026_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_opensbliblock00Kernel026_h[0][0] || xdim1 != dims_opensbliblock00Kernel026_h[1][0] || xdim2 != dims_opensbliblock00Kernel026_h[2][0]) {
