  ...
  const int *idx)
{
   ...
   (rc38)*T_B0(0,2) - rc39*T_B0(0,3) +
      (rc34)*T_B0(0,4) + (rc36)*T_B0(0,0) - rc37*T_B0(0,1)
)
: ((idx[1] == 1) ? (

      (rc26)*T_B0(0,2) + (rc34)*T_B0(0,-1) - rc14*T_B0(0,3) - rc21*T_B0(0,0) +
      (rc7)*T_B0(0,1)
)
: (
   -rc14*T_B0(0,2) - rc14*T_B0(0,-2) +
      (rc12)*T_B0(0,-1) - rc40*T_B0(0,0) + (rc12)*T_B0(0,1)
)));
