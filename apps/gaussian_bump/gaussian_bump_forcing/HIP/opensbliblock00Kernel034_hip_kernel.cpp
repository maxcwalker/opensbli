...
void opensbliblock00Kernel034_gpu(const ACC<double> &wk15_B0,
  ACC<double> &wk6_B0,
  const int *idx)
{
    wk6_B0(0,0) = inv_0*((idx[1] == 0) ? (
   -3*wk15_B0(0,2) + 4*wk15_B0(0,1) -
      rc11*wk15_B0(0,4) - rc13*wk15_B0(0,0) + (rc12)*wk15_B0(0,3)
)
: ((idx[1] == 1) ? (

       -rc7*wk15_B0(0,2) + (rc16)*wk15_B0(0,1) - rc15*wk15_B0(0,0) -
      rc11*wk15_B0(0,-1) + (rc14)*wk15_B0(0,3)
)
: (
   (rc17)*wk15_B0(0,1) -
      rc14*wk15_B0(0,2) + (rc14)*wk15_B0(0,-2) - rc17*wk15_B0(0,-1)
)));
