...
{
    wk2_B0(0,0) = ((idx[1] == 0) ? (
   inv_0*(-3*u1_B0(0,2) + (rc13)*u1_B0(0,3) -
      rc12*u1_B0(0,4) - rc11*u1_B0(0,0) + 4*u1_B0(0,1))
)
: ((idx[1] == 1) ? (

      (rc14)*inv_0*(-6*u1_B0(0,2) - 3*u1_B0(0,-1) + u1_B0(0,3) - 10*u1_B0(0,0) +
      18*u1_B0(0,1))
)
: (
   (rc14)*inv_0*(8*u1_B0(0,1) - u1_B0(0,2) -
