...
void ops_par_loop_opensbliblock00Kernel009_execute(ops_kernel_descriptor *desc) {
  ...
  for ( int n_y=start1; n_y<end1; n_y++ ){
    for ( int n_x=start0; n_x<end0; n_x++ ){
      const ACC<double> p_B0(xdim0_opensbliblock00Kernel009, p_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel009*1);
      const ACC<double> rho_B0(xdim1_opensbliblock00Kernel009, rho_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel009*1);
      ACC<double> a_B0(xdim2_opensbliblock00Kernel009, a_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel009*1);
...
void ops_par_loop_opensbliblock00Kernel009(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  create_kerneldesc_and_enque(name, args, 3, 16, dim, 0, range, block, ops_par_loop_opensbliblock00Kernel009_execute);
}
#endif
