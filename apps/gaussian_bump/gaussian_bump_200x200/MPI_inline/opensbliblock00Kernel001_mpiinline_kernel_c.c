...
void opensbliblock00Kernel001_c_wrapper(
  ...
  for ( int n_y=0; n_y<y_size; n_y++ ){
    for ( int n_x=0; n_x<x_size; n_x++ ){
      ...
      const ptr_double D11_B0 = { D11_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel001*1, xdim2_opensbliblock00Kernel001};
      const ptr_double p_B0 = { p_B0_p + n_x*1 + n_y * xdim3_opensbliblock00Kernel001*1, xdim3_opensbliblock00Kernel001};
      const ptr_double detJ_B0 = { detJ_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel001*1, xdim4_opensbliblock00Kernel001};
      const ptr_double rho_B0 = { rho_B0_p + n_x*1 + n_y * xdim5_opensbliblock00Kernel001*1, xdim5_opensbliblock00Kernel001};
      const ptr_double rhou1_B0 = { rhou1_B0_p + n_x*1 + n_y * xdim6_opensbliblock00Kernel001*1, xdim6_opensbliblock00Kernel001};
      const ptr_double D10_B0 = { D10_B0_p + n_x*1 + n_y * xdim7_opensbliblock00Kernel001*1, xdim7_opensbliblock00Kernel001};
      const ptr_double rhou0_B0 = { rhou0_B0_p + n_x*1 + n_y * xdim8_opensbliblock00Kernel001*1, xdim8_opensbliblock00Kernel001};
      ...
      const ptr_double u0_B0 = { u0_B0_p + n_x*1 + n_y * xdim11_opensbliblock00Kernel001*1, xdim11_opensbliblock00Kernel001};
      ptr_double wk7_B0 = { wk7_B0_p + n_x*1 + n_y * xdim12_opensbliblock00Kernel001*1, xdim12_opensbliblock00Kernel001};
      ptr_double wk6_B0 = { wk6_B0_p + n_x*1 + n_y * xdim13_opensbliblock00Kernel001*1, xdim13_opensbliblock00Kernel001};
   ...
   AVG_1_u1 = (rc7)*(OPS_ACC(u1_B0, 0,1) + OPS_ACC(u1_B0, 0,0));
   ...
   max_lambda_1_11 = max_lambda_1_00;
    ...
    max_lambda_1_22 = fmax(fabs(sqrt(pow(OPS_ACC(D10_B0, 0,0), 2) + pow(OPS_ACC(D11_B0, 0,0), 2))*OPS_ACC(a_B0, 0,0)
      ...
      fmax(fabs(sqrt(pow(OPS_ACC(D10_B0, 0,-1), 2) + pow(OPS_ACC(D11_B0, 0,-1), 2))*OPS_ACC(a_B0, 0,-1) +
      OPS_ACC(D10_B0, 0,-1)*OPS_ACC(u0_B0, 0,-1) + OPS_ACC(D11_B0, 0,-1)*OPS_ACC(u1_B0, 0,-1)),
      fabs(sqrt(pow(OPS_ACC(D10_B0, 0,-2), 2) + pow(OPS_ACC(D11_B0, 0,-2), 2))*OPS_ACC(a_B0, 0,-2) +
      OPS_ACC(D10_B0, 0,-2)*OPS_ACC(u0_B0, 0,-2) + OPS_ACC(D11_B0, 0,-2)*OPS_ACC(u1_B0, 0,-2)))))));

    max_lambda_1_33 = fmax(fabs(-sqrt(pow(OPS_ACC(D10_B0, 0,3), 2) + pow(OPS_ACC(D11_B0, 0,3), 2))*OPS_ACC(a_B0, 0,3)
      + OPS_ACC(D10_B0, 0,3)*OPS_ACC(u0_B0, 0,3) + OPS_ACC(D11_B0, 0,3)*OPS_ACC(u1_B0, 0,3)),
      fmax(fabs(-sqrt(pow(OPS_ACC(D10_B0, 0,1), 2) + pow(OPS_ACC(D11_B0, 0,1), 2))*OPS_ACC(a_B0, 0,1) +
      OPS_ACC(D10_B0, 0,1)*OPS_ACC(u0_B0, 0,1) + OPS_ACC(D11_B0, 0,1)*OPS_ACC(u1_B0, 0,1)),
      fmax(fabs(-sqrt(pow(OPS_ACC(D10_B0, 0,-1), 2) + pow(OPS_ACC(D11_B0, 0,-1), 2))*OPS_ACC(a_B0, 0,-1) +
