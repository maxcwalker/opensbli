...
void ops_par_loop_opensbliblock00Kernel001_execute(ops_kernel_descriptor *desc) {
  ...
  double * __restrict__ D10_B0_p = (double *)(args[7].data + base7);
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
      ...
      const ACC<double> D11_B0(xdim2_opensbliblock00Kernel001, D11_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel001*1);
      const ACC<double> p_B0(xdim3_opensbliblock00Kernel001, p_B0_p + n_x*1 + n_y * xdim3_opensbliblock00Kernel001*1);
      const ACC<double> detJ_B0(xdim4_opensbliblock00Kernel001, detJ_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel001*1);
      const ACC<double> rho_B0(xdim5_opensbliblock00Kernel001, rho_B0_p + n_x*1 + n_y * xdim5_opensbliblock00Kernel001*1);
      const ACC<double> rhou1_B0(xdim6_opensbliblock00Kernel001, rhou1_B0_p + n_x*1 + n_y * xdim6_opensbliblock00Kernel001*1);
      const ACC<double> D10_B0(xdim7_opensbliblock00Kernel001, D10_B0_p + n_x*1 + n_y * xdim7_opensbliblock00Kernel001*1);
      ...
      const ACC<double> u0_B0(xdim11_opensbliblock00Kernel001, u0_B0_p + n_x*1 + n_y * xdim11_opensbliblock00Kernel001*1);
   ...
   max_lambda_1_11 = max_lambda_1_00;
    ...
    max_lambda_1_33 = fmax(fabs(-sqrt(pow(D10_B0(0,3), 2) + pow(D11_B0(0,3), 2))*a_B0(0,3)
      + D10_B0(0,3)*u0_B0(0,3) + D11_B0(0,3)*u1_B0(0,3)),
      fmax(fabs(-sqrt(pow(D10_B0(0,1), 2) + pow(D11_B0(0,1), 2))*a_B0(0,1) +
      D10_B0(0,1)*u0_B0(0,1) + D11_B0(0,1)*u1_B0(0,1)),
      fmax(fabs(-sqrt(pow(D10_B0(0,-1), 2) + pow(D11_B0(0,-1), 2))*a_B0(0,-1) +
