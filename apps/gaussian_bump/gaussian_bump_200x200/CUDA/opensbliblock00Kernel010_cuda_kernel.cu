...
//
__constant__ int dims_opensbliblock00Kernel010 [3][1];
static int dims_opensbliblock00Kernel010_h [3][1] = {0};

//user function
__device__

void opensbliblock00Kernel010_gpu(const ACC<double> &rhou0_B0,
...
int size1 ){
  ...
  if (idx_x < size0 && idx_y < size1) {
    ...
    ACC<double> argp2(dims_opensbliblock00Kernel010[2][0], arg2);
...
void ops_par_loop_opensbliblock00Kernel010_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_opensbliblock00Kernel010_h[0][0] || xdim1 != dims_opensbliblock00Kernel010_h[1][0] || xdim2 != dims_opensbliblock00Kernel010_h[2][0]) {
