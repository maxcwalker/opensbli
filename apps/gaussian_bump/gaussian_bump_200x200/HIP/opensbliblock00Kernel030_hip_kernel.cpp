...
void opensbliblock00Kernel030_gpu(const ACC<double> &wk4_B0,
  ACC<double> &wk2_B0,
  const int *idx)
{
    wk2_B0(0,0) = inv_0*((idx[1] == 0) ? (
   (rc11)*wk4_B0(0,3) - rc12*wk4_B0(0,0) -
      rc13*wk4_B0(0,4) + 4*wk4_B0(0,1) - 3*wk4_B0(0,2)
)
: ((idx[1] == 1) ? (

      (rc14)*wk4_B0(0,3) - rc13*wk4_B0(0,-1) - rc15*wk4_B0(0,0) +
      (rc16)*wk4_B0(0,1) - rc7*wk4_B0(0,2)
)
: (
   -rc17*wk4_B0(0,-1) -
      rc14*wk4_B0(0,2) + (rc17)*wk4_B0(0,1) + (rc14)*wk4_B0(0,-2)
)));
