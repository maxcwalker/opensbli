  ...
  const int *idx)
{
   ...
   -3*wk1_B0(0,2) + 4*wk1_B0(0,1) -
      rc13*wk1_B0(0,4) - rc12*wk1_B0(0,0) + (rc11)*wk1_B0(0,3)
)
: ((idx[1] == 1) ? (

      -rc7*wk1_B0(0,2) + (rc16)*wk1_B0(0,1) - rc15*wk1_B0(0,0) -
      rc13*wk1_B0(0,-1) + (rc14)*wk1_B0(0,3)
)
: (
   (rc17)*wk1_B0(0,1) +
      (rc14)*wk1_B0(0,-2) - rc14*wk1_B0(0,2) - rc17*wk1_B0(0,-1)
)));
