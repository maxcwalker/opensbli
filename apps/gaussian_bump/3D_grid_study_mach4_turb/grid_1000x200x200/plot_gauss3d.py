...
U=plt.contourf(x[:,1,:], z[:,1,:], u[:,1,:],levels=np.linspace(-0.07,0.15,25), cmap=cm.jet) #
cax1 = inset_axes(ax1, width="90%", height="20%", loc='lower center',borderpad=-10)
...
ax3.grid()
fig4.savefig('separation_u_vel.pdf',bbox_inches='tight')
...
ax4.grid()
fig4.savefig('thin_BL_region.pdf',bbox_inches='tight')
