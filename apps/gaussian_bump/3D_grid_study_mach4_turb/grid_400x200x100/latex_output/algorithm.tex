...
\noindent Ending condition loop %s\\\noindent The kernel is MetricsEquation evaluation, block is 0\\\noindent The ranges are 0,block0np0,0,block0np1,0,block0np2\\\begin{dmath}d_{1 x1 dx} = invDelta0block0 \,.\, \left(\begin{cases} - \frac{25 \,.\, {x_{1}{_{B0}}}[{0,0}]}{12} + 4 \,.\, {x_{1}{_{B0}}}[{1,0}] - 3 \,.\, {x_{1}{_{B0}}}[{2,0}] - \frac{{x_{1}{_{B0}}}[{4,0}]}{4} + \frac{4 \,.\, 
