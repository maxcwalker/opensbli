...
//
__constant__ int dims_opensbliblock00Kernel016 [5][2];
static int dims_opensbliblock00Kernel016_h [5][2] = {{0}};

//user function
__device__

 void opensbliblock00Kernel016_gpu(const ACC<double> &D00_B0,
...
int size2 ){
  ...
  arg3 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel016[3][0] + idx_z * 1*1 * dims_opensbliblock00Kernel016[3][0] * dims_opensbliblock00Kernel016[3][1];
  arg4 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel016[4][0] + idx_z * 1*1 * dims_opensbliblock00Kernel016[4][0] * dims_opensbliblock00Kernel016[4][1];
  ...
  if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
    ...
    const ACC<double> argp2(dims_opensbliblock00Kernel016[2][0], dims_opensbliblock00Kernel016[2][1], arg2);
    const ACC<double> argp3(dims_opensbliblock00Kernel016[3][0], dims_opensbliblock00Kernel016[3][1], arg3);
    ACC<double> argp4(dims_opensbliblock00Kernel016[4][0], dims_opensbliblock00Kernel016[4][1], arg4);
...
void ops_par_loop_opensbliblock00Kernel016_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_opensbliblock00Kernel016_h[0][0] || ydim0 != dims_opensbliblock00Kernel016_h[0][1] || xdim1 != dims_opensbliblock00Kernel016_h[1][0] || ydim1 != dims_opensbliblock00Kernel016_h[1][1] || xdim2 != dims_opensbliblock00Kernel016_h[2][0] || ydim2 != dims_opensbliblock00Kernel016_h[2][1] || xdim3 != dims_opensbliblock00Kernel016_h[3][0] || ydim3 != dims_opensbliblock00Kernel016_h[3][1] || xdim4 != dims_opensbliblock00Kernel016_h[4][0] || ydim4 != dims_opensbliblock00Kernel016_h[4][1]) {
    ...
    dims_opensbliblock00Kernel016_h[3][1] = ydim3;
    dims_opensbliblock00Kernel016_h[4][0] = xdim4;
    dims_opensbliblock00Kernel016_h[4][1] = ydim4;
...
void ops_par_loop_opensbliblock00Kernel016(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4) {
  ...
  create_kerneldesc_and_enque(name, args, 5, 15, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel016_execute);
}
#endif
