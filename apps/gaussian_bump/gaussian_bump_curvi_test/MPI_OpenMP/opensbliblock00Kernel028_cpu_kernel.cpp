...
void ops_par_loop_opensbliblock00Kernel028_execute(ops_kernel_descriptor *desc) {
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
      ...
      const ACC<double> u1_B0(xdim0_opensbliblock00Kernel028, u1_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel028*1);
   ...
   (rc34)*u1_B0(4,0) - rc36*u1_B0(1,0) -
      rc37*u1_B0(3,0) + (rc38)*u1_B0(0,0) + (rc39)*u1_B0(2,0)
)
: ((idx[0] == 1) ? (

      (rc7)*u1_B0(1,0) + (rc34)*u1_B0(-1,0) - rc16*u1_B0(3,0) - rc21*u1_B0(0,0)
      + (rc26)*u1_B0(2,0)
)
: ((idx[0] == block0np0 - 1) ? (
   (rc34)*u1_B0(-4,0) +
      (rc38)*u1_B0(0,0) - rc36*u1_B0(-1,0) + (rc39)*u1_B0(-2,0) -
      rc37*u1_B0(-3,0)
)
: ((idx[0] == block0np0 - 2) ? (
   (rc34)*u1_B0(1,0) +
      (rc7)*u1_B0(-1,0) - rc21*u1_B0(0,0) - rc16*u1_B0(-3,0) +
      (rc26)*u1_B0(-2,0)
)
: (
   (rc13)*u1_B0(1,0) - rc16*u1_B0(-2,0) -
      rc40*u1_B0(0,0) + (rc13)*u1_B0(-1,0) - rc16*u1_B0(2,0)
)))));
