...
void opensbliblock00Kernel031_gpu(const ACC<double> &wk1_B0,
  ACC<double> &wk3_B0,
  const int *idx)
{
    wk3_B0(0,0) = inv_2*((idx[1] == 0) ? (
   -rc12*wk1_B0(0,0) + 4*wk1_B0(0,1) -
      3*wk1_B0(0,2) + (rc13)*wk1_B0(0,3) - rc11*wk1_B0(0,4)
)
: ((idx[1] == 1) ? (

      -rc15*wk1_B0(0,0) + (rc14)*wk1_B0(0,1) - rc7*wk1_B0(0,2) +
      (rc16)*wk1_B0(0,3) - rc11*wk1_B0(0,-1)
)
: (
   (rc17)*wk1_B0(0,1) -
      rc16*wk1_B0(0,2) + (rc16)*wk1_B0(0,-2) - rc17*wk1_B0(0,-1)
)));
