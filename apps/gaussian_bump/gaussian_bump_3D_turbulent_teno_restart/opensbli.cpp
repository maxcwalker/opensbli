...
ops_decl_const("rc41" , 1, "double", &rc41);
ops_decl_const("rcinv42" , 1, "double", &rcinv42);
ops_decl_const("rcinv43" , 1, "double", &rcinv43);
ops_decl_const("rc44" , 1, "double", &rc44);
ops_decl_const("rc45" , 1, "double", &rc45);
ops_decl_const("rcinv46" , 1, "double", &rcinv46);
...
ops_par_loop(opensbliblock00Kernel000, "LLFTeno_reconstruction_0_direction", opensbliblock00, 3, iteration_range_0_block0,
...
ops_par_loop(opensbliblock00Kernel001, "LLFTeno_reconstruction_1_direction", opensbliblock00, 3, iteration_range_1_block0,
...
ops_par_loop(opensbliblock00Kernel002, "LLFTeno_reconstruction_2_direction", opensbliblock00, 3, iteration_range_2_block0,
...
ops_par_loop(opensbliblock00Kernel021, "LLFTeno Residual", opensbliblock00, 3, iteration_range_21_block0,
