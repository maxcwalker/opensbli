  ...
  const int *idx)
{
   ...
   (rc13)*u0_B0(0,3) - 3*u0_B0(0,2) +
      4*u0_B0(0,1) - rc12*u0_B0(0,0) - rc11*u0_B0(0,4)
)
: ((idx[1] == 1) ? (

      (rc16)*u0_B0(0,3) - rc7*u0_B0(0,2) + (rc14)*u0_B0(0,1) - rc15*u0_B0(0,0) -
      rc11*u0_B0(0,-1)
)
: (
   -rc16*u0_B0(0,2) + (rc17)*u0_B0(0,1) -
      rc17*u0_B0(0,-1) + (rc16)*u0_B0(0,-2)
)));
