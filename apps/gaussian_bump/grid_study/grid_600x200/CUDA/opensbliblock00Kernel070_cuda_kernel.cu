  ...
  const int *idx)
{
   ...
   4*x1_B0(1,0) - rc11*x1_B0(4,0) +
      (rc13)*x1_B0(3,0) - rc12*x1_B0(0,0) - 3*x1_B0(2,0)
)
: ((idx[0] == 1) ? (

      (rc14)*x1_B0(1,0) + (rc16)*x1_B0(3,0) - rc11*x1_B0(-1,0) - rc15*x1_B0(0,0)
      - rc7*x1_B0(2,0)
)
: ((idx[0] == block0np0 - 1) ? (
   3*x1_B0(-2,0) +
      (rc11)*x1_B0(-4,0) - 4*x1_B0(-1,0) - rc13*x1_B0(-3,0) +
      (rc12)*x1_B0(0,0)
)
: ((idx[0] == block0np0 - 2) ? (
   -rc14*x1_B0(-1,0) +
      (rc11)*x1_B0(1,0) + (rc7)*x1_B0(-2,0) - rc16*x1_B0(-3,0) +
      (rc15)*x1_B0(0,0)
)
: (
   (rc16)*x1_B0(-2,0) + (rc17)*x1_B0(1,0) -
      rc17*x1_B0(-1,0) - rc16*x1_B0(2,0)
)))));
