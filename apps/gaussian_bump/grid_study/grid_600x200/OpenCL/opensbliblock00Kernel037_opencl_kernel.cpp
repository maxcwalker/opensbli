...
//
    ...
    void buildOpenCLKernels_opensbliblock00Kernel037(OPS_instance *instance, int xdim0, int xdim1) {
      ...
      if(!isbuilt_opensbliblock00Kernel037) {
        ...
        instance->opencl_instance->OPS_opencl_core.kernel[37] = clCreateKernel(instance->opencl_instance->OPS_opencl_core.program, "ops_opensbliblock00Kernel037", &ret);
        clSafeCall( ret );
...
void ops_par_loop_opensbliblock00Kernel037(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  if (block->instance->OPS_diags > 1) {
    ops_timing_realloc(block->instance,37,"opensbliblock00Kernel037");
  ...
  if (globalWorkSize[0]>0 && globalWorkSize[1]>0 && globalWorkSize[2]>0) {
    ...
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 2, sizeof(cl_double), (void*) &inv_3 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 3, sizeof(cl_double), (void*) &rc7 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[37], 4, sizeof(cl_double), (void*) &rc13 ));
