...
void ops_par_loop_opensbliblock00Kernel073_execute(ops_kernel_descriptor *desc) {
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
      ...
      ACC<double> D00_B0(xdim4_opensbliblock00Kernel073, D00_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel073*1);
      ACC<double> D01_B0(xdim5_opensbliblock00Kernel073, D01_B0_p + n_x*1 + n_y * xdim5_opensbliblock00Kernel073*1);
      ACC<double> D11_B0(xdim6_opensbliblock00Kernel073, D11_B0_p + n_x*1 + n_y * xdim6_opensbliblock00Kernel073*1);
      ACC<double> D10_B0(xdim7_opensbliblock00Kernel073, D10_B0_p + n_x*1 + n_y * xdim7_opensbliblock00Kernel073*1);
