...
void ops_par_loop_opensbliblock00Kernel000_execute(ops_kernel_descriptor *desc) {
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
      ...
      const ACC<double> rho_B0(xdim8_opensbliblock00Kernel000, rho_B0_p + n_x*1 + n_y * xdim8_opensbliblock00Kernel000*1);
      const ACC<double> u0_B0(xdim9_opensbliblock00Kernel000, u0_B0_p + n_x*1 + n_y * xdim9_opensbliblock00Kernel000*1);
      const ACC<double> p_B0(xdim10_opensbliblock00Kernel000, p_B0_p + n_x*1 + n_y * xdim10_opensbliblock00Kernel000*1);
      const ACC<double> detJ_B0(xdim11_opensbliblock00Kernel000, detJ_B0_p + n_x*1 + n_y * xdim11_opensbliblock00Kernel000*1);
