...
{
    Residual0_B0(0,0) = -(inv_0*(-wk0_B0(-1,0) + wk0_B0(0,0)) +
      inv_2*(wk4_B0(0,0) - wk4_B0(0,-1)))/detJ_B0(0,0);

    Residual1_B0(0,0) = -(inv_0*(wk1_B0(0,0) - wk1_B0(-1,0)) +
      inv_2*(wk5_B0(0,0) - wk5_B0(0,-1)))/detJ_B0(0,0);

    Residual2_B0(0,0) = -(inv_0*(wk2_B0(0,0) - wk2_B0(-1,0)) +
      inv_2*(wk6_B0(0,0) - wk6_B0(0,-1)))/detJ_B0(0,0);

    Residual3_B0(0,0) = -(inv_0*(wk3_B0(0,0) - wk3_B0(-1,0)) +
