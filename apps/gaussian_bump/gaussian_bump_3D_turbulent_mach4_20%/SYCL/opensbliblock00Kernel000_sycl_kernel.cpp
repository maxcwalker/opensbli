...
void ops_par_loop_opensbliblock00Kernel000_execute(ops_kernel_descriptor *desc) {
 ...
 arg15, arg16, arg17, arg18};
  ...
  double* u0_B0_p = (double*)args[11].data_d;

  int base12 = args[12].dat->base_offset/sizeof(double);
  double* u1_B0_p = (double*)args[12].data_d;

  int base13 = args[13].dat->base_offset/sizeof(double);
  double* u2_B0_p = (double*)args[13].data_d;

  int base14 = args[14].dat->base_offset/sizeof(double);
  double* wk0_B0_p = (double*)args[14].data_d;
  ...
  double* wk3_B0_p = (double*)args[17].data_d;

  int base18 = args[18].dat->base_offset/sizeof(double);
  double* wk4_B0_p = (double*)args[18].data_d;
  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0 && (end[2]-start[2])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      , [=](cl::sycl::nd_item<3> item
        ...
        const ACC<double> a_B0(xdim3_opensbliblock00Kernel000, ydim3_opensbliblock00Kernel000, &a_B0_p[0] + base3 + n_x*1 + n_y * xdim3_opensbliblock00Kernel000*1 + n_z * xdim3_opensbliblock00Kernel000 * ydim3_opensbliblock00Kernel000*1);
        const ACC<double> detJ_B0(xdim4_opensbliblock00Kernel000, ydim4_opensbliblock00Kernel000, &detJ_B0_p[0] + base4 + n_x*1 + n_y * xdim4_opensbliblock00Kernel000*1 + n_z * xdim4_opensbliblock00Kernel000 * ydim4_opensbliblock00Kernel000*1);
        const ACC<double> p_B0(xdim5_opensbliblock00Kernel000, ydim5_opensbliblock00Kernel000, &p_B0_p[0] + base5 + n_x*1 + n_y * xdim5_opensbliblock00Kernel000*1 + n_z * xdim5_opensbliblock00Kernel000 * ydim5_opensbliblock00Kernel000*1);
        const ACC<double> rhoE_B0(xdim6_opensbliblock00Kernel000, ydim6_opensbliblock00Kernel000, &rhoE_B0_p[0] + base6 + n_x*1 + n_y * xdim6_opensbliblock00Kernel000*1 + n_z * xdim6_opensbliblock00Kernel000 * ydim6_opensbliblock00Kernel000*1);
        const ACC<double> rho_B0(xdim7_opensbliblock00Kernel000, ydim7_opensbliblock00Kernel000, &rho_B0_p[0] + base7 + n_x*1 + n_y * xdim7_opensbliblock00Kernel000*1 + n_z * xdim7_opensbliblock00Kernel000 * ydim7_opensbliblock00Kernel000*1);
        const ACC<double> rhou0_B0(xdim8_opensbliblock00Kernel000, ydim8_opensbliblock00Kernel000, &rhou0_B0_p[0] + base8 + n_x*1 + n_y * xdim8_opensbliblock00Kernel000*1 + n_z * xdim8_opensbliblock00Kernel000 * ydim8_opensbliblock00Kernel000*1);
        const ACC<double> rhou1_B0(xdim9_opensbliblock00Kernel000, ydim9_opensbliblock00Kernel000, &rhou1_B0_p[0] + base9 + n_x*1 + n_y * xdim9_opensbliblock00Kernel000*1 + n_z * xdim9_opensbliblock00Kernel000 * ydim9_opensbliblock00Kernel000*1);
        const ACC<double> rhou2_B0(xdim10_opensbliblock00Kernel000, ydim10_opensbliblock00Kernel000, &rhou2_B0_p[0] + base10 + n_x*1 + n_y * xdim10_opensbliblock00Kernel000*1 + n_z * xdim10_opensbliblock00Kernel000 * ydim10_opensbliblock00Kernel000*1);
        const ACC<double> u0_B0(xdim11_opensbliblock00Kernel000, ydim11_opensbliblock00Kernel000, &u0_B0_p[0] + base11 + n_x*1 + n_y * xdim11_opensbliblock00Kernel000*1 + n_z * xdim11_opensbliblock00Kernel000 * ydim11_opensbliblock00Kernel000*1);
        const ACC<double> u1_B0(xdim12_opensbliblock00Kernel000, ydim12_opensbliblock00Kernel000, &u1_B0_p[0] + base12 + n_x*1 + n_y * xdim12_opensbliblock00Kernel000*1 + n_z * xdim12_opensbliblock00Kernel000 * ydim12_opensbliblock00Kernel000*1);
        const ACC<double> u2_B0(xdim13_opensbliblock00Kernel000, ydim13_opensbliblock00Kernel000, &u2_B0_p[0] + base13 + n_x*1 + n_y * xdim13_opensbliblock00Kernel000*1 + n_z * xdim13_opensbliblock00Kernel000 * ydim13_opensbliblock00Kernel000*1);
        ACC<double> wk0_B0(xdim14_opensbliblock00Kernel000, ydim14_opensbliblock00Kernel000, &wk0_B0_p[0] + base14 + n_x*1 + n_y * xdim14_opensbliblock00Kernel000*1 + n_z * xdim14_opensbliblock00Kernel000 * ydim14_opensbliblock00Kernel000*1);
        ACC<double> wk1_B0(xdim15_opensbliblock00Kernel000, ydim15_opensbliblock00Kernel000, &wk1_B0_p[0] + base15 + n_x*1 + n_y * xdim15_opensbliblock00Kernel000*1 + n_z * xdim15_opensbliblock00Kernel000 * ydim15_opensbliblock00Kernel000*1);
        ACC<double> wk2_B0(xdim16_opensbliblock00Kernel000, ydim16_opensbliblock00Kernel000, &wk2_B0_p[0] + base16 + n_x*1 + n_y * xdim16_opensbliblock00Kernel000*1 + n_z * xdim16_opensbliblock00Kernel000 * ydim16_opensbliblock00Kernel000*1);
        ACC<double> wk3_B0(xdim17_opensbliblock00Kernel000, ydim17_opensbliblock00Kernel000, &wk3_B0_p[0] + base17 + n_x*1 + n_y * xdim17_opensbliblock00Kernel000*1 + n_z * xdim17_opensbliblock00Kernel000 * ydim17_opensbliblock00Kernel000*1);
        ACC<double> wk4_B0(xdim18_opensbliblock00Kernel000, ydim18_opensbliblock00Kernel000, &wk4_B0_p[0] + base18 + n_x*1 + n_y * xdim18_opensbliblock00Kernel000*1 + n_z * xdim18_opensbliblock00Kernel000 * ydim18_opensbliblock00Kernel000*1);
        //USER CODE
