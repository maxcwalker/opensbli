...
ACC<double> &u1_B0, const ACC<double> &u2_B0, ACC<double> &p_B0)
{
 ...
 void opensbliblock00Kernel014(const ACC<double> &D00_B0, const ACC<double> &D01_B0, const ACC<double> &u0_B0, const
...
void opensbliblock00Kernel009(const ACC<double> &p_B0, const ACC<double> &rho_B0, ACC<double> &a_B0)
{
   a_B0(0,0,0) = sqrt(gama*p_B0(0,0,0)/rho_B0(0,0,0));

}

void opensbliblock00Kernel028(const ACC<double> &p_B0, const ACC<double> &rho_B0, ACC<double> &T_B0)
{
