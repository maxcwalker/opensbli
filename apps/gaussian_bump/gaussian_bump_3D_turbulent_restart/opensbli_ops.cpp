...
ops_init(argc,argv,1);
  ops_init_backend();ops_decl_const2( "niter",1, "int",&niter);ops_decl_const2( "dt",1, "double",&dt);ops_decl_const2( "block0np0",1, "int",&block0np0);ops_decl_const2( "block0np1",1, "int",&block0np1);ops_decl_const2( "block0np2",1, "int",&block0np2);ops_decl_const2( "Delta0block0",1, "double",&Delta0block0);ops_decl_const2( "Delta1block0",1, "double",&Delta1block0);ops_decl_const2( "Delta2block0",1, "double",&Delta2block0);ops_decl_const2( "Minf",1, "double",&Minf);ops_decl_const2( "Twall",1, "double",&Twall);ops_decl_const2( "gama",1, "double",&gama);ops_decl_const2( "SuthT",1, "double",&SuthT);ops_decl_const2( "RefT",1, "double",&RefT);ops_decl_const2( "Pr",1, "double",&Pr);ops_decl_const2( "Re",1, "double",&Re);ops_decl_const2( "gamma_m1",1, "double",&gamma_m1);ops_decl_const2( "inv_0",1, "double",&inv_0);ops_decl_const2( "inv_1",1, "double",&inv_1);ops_decl_const2( "inv_2",1, "double",&inv_2);ops_decl_const2( "inv_3",1, "double",&inv_3);ops_decl_const2( "inv_4",1, "double",&inv_4);ops_decl_const2( "inv_5",1, "double",&inv_5);ops_decl_const2( "k_0",1, "double",&k_0);ops_decl_const2( "xts",1, "double",&xts);ops_decl_const2( "omega_0",1, "double",&omega_0);ops_decl_const2( "tripA",1, "double",&tripA);ops_decl_const2( "beta_0",1, "double",&beta_0);ops_decl_const2( "b",1, "double",&b);ops_decl_const2( "H",1, "double",&H);ops_decl_const2( "L",1, "double",&L);ops_decl_const2( "a",1, "double",&a);ops_decl_const2( "rcinv6",1, "double",&rcinv6);ops_decl_const2( "rcinv7",1, "double",&rcinv7);ops_decl_const2( "rc8",1, "double",&rc8);ops_decl_const2( "rc9",1, "double",&rc9);ops_decl_const2( "rcinv10",1, "double",&rcinv10);ops_decl_const2( "rcinv11",1, "double",&rcinv11);ops_decl_const2( "rcinv12",1, "double",&rcinv12);ops_decl_const2( "rc13",1, "double",&rc13);ops_decl_const2( "rc14",1, "double",&rc14);ops_decl_const2( "rc15",1, "double",&rc15);ops_decl_const2( "rc16",1, "double",&rc16);ops_decl_const2( "rcinv17",1, "double",&rcinv17);ops_decl_const2( "rcinv18",1, "double",&rcinv18);ops_decl_const2( "rc19",1, "double",&rc19);ops_decl_const2( "rc20",1, "double",&rc20);ops_decl_const2( "rc21",1, "double",&rc21);ops_decl_const2( "rc22",1, "double",&rc22);ops_decl_const2( "rc23",1, "double",&rc23);ops_decl_const2( "rc24",1, "double",&rc24);ops_decl_const2( "rc25",1, "double",&rc25);ops_decl_const2( "rc26",1, "double",&rc26);ops_decl_const2( "rc27",1, "double",&rc27);ops_decl_const2( "rc28",1, "double",&rc28);ops_decl_const2( "rc29",1, "double",&rc29);ops_decl_const2( "rc30",1, "double",&rc30);ops_decl_const2( "rc31",1, "double",&rc31);ops_decl_const2( "rc32",1, "double",&rc32);ops_decl_const2( "rc33",1, "double",&rc33);ops_decl_const2( "rc34",1, "double",&rc34);ops_decl_const2( "rc35",1, "double",&rc35);ops_decl_const2( "rcinv36",1, "double",&rcinv36);ops_decl_const2( "rcinv37",1, "double",&rcinv37);ops_decl_const2( "rc38",1, "double",&rc38);ops_decl_const2( "rcinv39",1, "double",&rcinv39);
...
{
int iteration_range_8_block0[] = {-3, block0np0 + 4, -3, block0np1 + 4, -3, block0np2 + 4}; ops_par_loop_opensbliblock00Kernel008("CRu0", opensbliblock00, 3, iteration_range_8_block0,
...
int iteration_range_12_block0[] = {-3, block0np0 + 4, -3, block0np1 + 4, -3, block0np2 + 4}; ops_par_loop_opensbliblock00Kernel012("CRu2", opensbliblock00, 3, iteration_range_12_block0,
             ops_arg_dat(rho_B0, 1, stencil_0_04, "double", OPS_READ),
             ops_arg_dat(rhou2_B0, 1, stencil_0_04, "double", OPS_READ),
             ops_arg_dat(u2_B0, 1, stencil_0_04, "double", OPS_WRITE));

int iteration_range_14_block0[] = {-3, block0np0 + 4, -3, block0np1 + 4, -3, block0np2 + 4}; ops_par_loop_opensbliblock00Kernel014("CRu1", opensbliblock00, 3, iteration_range_14_block0,
             ops_arg_dat(rho_B0, 1, stencil_0_04, "double", OPS_READ),
             ops_arg_dat(rhou1_B0, 1, stencil_0_04, "double", OPS_READ),
             ops_arg_dat(u1_B0, 1, stencil_0_04, "double", OPS_WRITE));

int iteration_range_4_block0[] = {-3, block0np0 + 4, 0, block0np1, 0, block0np2}; ops_par_loop_opensbliblock00Kernel004("CRU0", opensbliblock00, 3, iteration_range_4_block0,
...
int iteration_range_7_block0[] = {-3, block0np0 + 4, -3, block0np1 + 4, -3, block0np2 + 4}; ops_par_loop_opensbliblock00Kernel007("CRp", opensbliblock00, 3, iteration_range_7_block0,
             ops_arg_dat(u0_B0, 1, stencil_0_04, "double", OPS_READ),
             ops_arg_dat(rho_B0, 1, stencil_0_04, "double", OPS_READ),
             ops_arg_dat(u1_B0, 1, stencil_0_04, "double", OPS_READ),
...
int iteration_range_5_block0[] = {-3, block0np0 + 4, -3, block0np1 + 4, -3, block0np2 + 4}; ops_par_loop_opensbliblock00Kernel005("CRa", opensbliblock00, 3, iteration_range_5_block0,
             ops_arg_dat(rho_B0, 1, stencil_0_04, "double", OPS_READ),
...
int iteration_range_25_block0[] = {-2, block0np0 + 2, -2, block0np1 + 2, -2, block0np2 + 2}; ops_par_loop_opensbliblock00Kernel025("CRmu_B0", opensbliblock00, 3, iteration_range_25_block0,
             ops_arg_dat(T_B0, 1, stencil_0_04, "double", OPS_READ),
             ops_arg_dat(mu_B0, 1, stencil_0_04, "double", OPS_WRITE));

int iteration_range_0_block0[] = {-1, block0np0 + 1, 0, block0np1, 0, block0np2}; ops_par_loop_opensbliblock00Kernel000("LLFWeno_reconstruction_0_direction", opensbliblock00, 3, iteration_range_0_block0,
...
int iteration_range_1_block0[] = {0, block0np0, -1, block0np1 + 1, 0, block0np2}; ops_par_loop_opensbliblock00Kernel001("LLFWeno_reconstruction_1_direction", opensbliblock00, 3, iteration_range_1_block0,
...
int iteration_range_2_block0[] = {0, block0np0, 0, block0np1, -1, block0np2 + 1}; ops_par_loop_opensbliblock00Kernel002("LLFWeno_reconstruction_2_direction", opensbliblock00, 3, iteration_range_2_block0,
...
int iteration_range_21_block0[] = {0, block0np0, 0, block0np1, 0, block0np2}; ops_par_loop_opensbliblock00Kernel021("LLFWeno Residual", opensbliblock00, 3, iteration_range_21_block0,
