...
void ops_par_loop_opensbliblock00Kernel001_execute(ops_kernel_descriptor *desc) {
  ...
  double * __restrict__ wk9_B0_p = (double *)(args[17].data + base17);
  ...
  for ( int n_z=start[2]; n_z<end[2]; n_z++ ){
    for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
      ...
      for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
        const ACC<double> a_B0(xdim0_opensbliblock00Kernel001, ydim0_opensbliblock00Kernel001, a_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel001*1 + n_z * xdim0_opensbliblock00Kernel001 * ydim0_opensbliblock00Kernel001*1);
        const ACC<double> rhou2_B0(xdim1_opensbliblock00Kernel001, ydim1_opensbliblock00Kernel001, rhou2_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel001*1 + n_z * xdim1_opensbliblock00Kernel001 * ydim1_opensbliblock00Kernel001*1);
        ...
        const ACC<double> U1_B0(xdim5_opensbliblock00Kernel001, ydim5_opensbliblock00Kernel001, U1_B0_p + n_x*1 + n_y * xdim5_opensbliblock00Kernel001*1 + n_z * xdim5_opensbliblock00Kernel001 * ydim5_opensbliblock00Kernel001*1);
        ...
        const ACC<double> u2_B0(xdim8_opensbliblock00Kernel001, ydim8_opensbliblock00Kernel001, u2_B0_p + n_x*1 + n_y * xdim8_opensbliblock00Kernel001*1 + n_z * xdim8_opensbliblock00Kernel001 * ydim8_opensbliblock00Kernel001*1);
        ...
        const ACC<double> rhou0_B0(xdim10_opensbliblock00Kernel001, ydim10_opensbliblock00Kernel001, rhou0_B0_p + n_x*1 + n_y * xdim10_opensbliblock00Kernel001*1 + n_z * xdim10_opensbliblock00Kernel001 * ydim10_opensbliblock00Kernel001*1);
        const ACC<double> D11_B0(xdim11_opensbliblock00Kernel001, ydim11_opensbliblock00Kernel001, D11_B0_p + n_x*1 + n_y * xdim11_opensbliblock00Kernel001*1 + n_z * xdim11_opensbliblock00Kernel001 * ydim11_opensbliblock00Kernel001*1);
        ...
        const ACC<double> detJ_B0(xdim13_opensbliblock00Kernel001, ydim13_opensbliblock00Kernel001, detJ_B0_p + n_x*1 + n_y * xdim13_opensbliblock00Kernel001*1 + n_z * xdim13_opensbliblock00Kernel001 * ydim13_opensbliblock00Kernel001*1);
        ACC<double> wk6_B0(xdim14_opensbliblock00Kernel001, ydim14_opensbliblock00Kernel001, wk6_B0_p + n_x*1 + n_y * xdim14_opensbliblock00Kernel001*1 + n_z * xdim14_opensbliblock00Kernel001 * ydim14_opensbliblock00Kernel001*1);
        ACC<double> wk7_B0(xdim15_opensbliblock00Kernel001, ydim15_opensbliblock00Kernel001, wk7_B0_p + n_x*1 + n_y * xdim15_opensbliblock00Kernel001*1 + n_z * xdim15_opensbliblock00Kernel001 * ydim15_opensbliblock00Kernel001*1);
        ...
        ACC<double> wk9_B0(xdim17_opensbliblock00Kernel001, ydim17_opensbliblock00Kernel001, wk9_B0_p + n_x*1 + n_y * xdim17_opensbliblock00Kernel001*1 + n_z * xdim17_opensbliblock00Kernel001 * ydim17_opensbliblock00Kernel001*1);
        ACC<double> wk5_B0(xdim18_opensbliblock00Kernel001, ydim18_opensbliblock00Kernel001, wk5_B0_p + n_x*1 + n_y * xdim18_opensbliblock00Kernel001*1 + n_z * xdim18_opensbliblock00Kernel001 * ydim18_opensbliblock00Kernel001*1);
   ...
   AVG_1_1_LEV_44 = 0.707106781186547*gamma_m1*inv_AVG_a*inv_AVG_rho;
    ...
    max_lambda_1_00 = fmax(fabs(D10_B0(0,3,0)*u0_B0(0,3,0) +
      D11_B0(0,3,0)*u1_B0(0,3,0)), fmax(fabs(D10_B0(0,2,0)*u0_B0(0,2,0) +
      D11_B0(0,2,0)*u1_B0(0,2,0)), fmax(fabs(D10_B0(0,0,0)*u0_B0(0,0,0) +
      D11_B0(0,0,0)*u1_B0(0,0,0)), fmax(fabs(D10_B0(0,1,0)*u0_B0(0,1,0) +
   ...
   max_lambda_1_22 = max_lambda_1_00;
    ...
    max_lambda_1_33 = fmax(fabs(sqrt(pow(D10_B0(0,1,0), 2) + pow(D11_B0(0,1,0),
      2))*a_B0(0,1,0) + D10_B0(0,1,0)*u0_B0(0,1,0) +
      D11_B0(0,1,0)*u1_B0(0,1,0)), fmax(fabs(sqrt(pow(D10_B0(0,-2,0), 2) +
      pow(D11_B0(0,-2,0), 2))*a_B0(0,-2,0) + D10_B0(0,-2,0)*u0_B0(0,-2,0) +
      D11_B0(0,-2,0)*u1_B0(0,-2,0)), fmax(fabs(sqrt(pow(D10_B0(0,2,0), 2) +
      pow(D11_B0(0,2,0), 2))*a_B0(0,2,0) + D10_B0(0,2,0)*u0_B0(0,2,0) +
      D11_B0(0,2,0)*u1_B0(0,2,0)), fmax(fabs(sqrt(pow(D10_B0(0,0,0), 2) +
      pow(D11_B0(0,0,0), 2))*a_B0(0,0,0) + D10_B0(0,0,0)*u0_B0(0,0,0) +
      D11_B0(0,0,0)*u1_B0(0,0,0)), fmax(fabs(sqrt(pow(D10_B0(0,-1,0), 2) +
      pow(D11_B0(0,-1,0), 2))*a_B0(0,-1,0) + D10_B0(0,-1,0)*u0_B0(0,-1,0) +
      D11_B0(0,-1,0)*u1_B0(0,-1,0)), fabs(sqrt(pow(D10_B0(0,3,0), 2) +
      pow(D11_B0(0,3,0), 2))*a_B0(0,3,0) + D10_B0(0,3,0)*u0_B0(0,3,0) +
      D11_B0(0,3,0)*u1_B0(0,3,0)))))));

    max_lambda_1_44 = fmax(fabs(-sqrt(pow(D10_B0(0,3,0), 2) + pow(D11_B0(0,3,0),
      2))*a_B0(0,3,0) + D10_B0(0,3,0)*u0_B0(0,3,0) +
      D11_B0(0,3,0)*u1_B0(0,3,0)), fmax(fabs(-sqrt(pow(D10_B0(0,1,0), 2) +
      pow(D11_B0(0,1,0), 2))*a_B0(0,1,0) + D10_B0(0,1,0)*u0_B0(0,1,0) +
      D11_B0(0,1,0)*u1_B0(0,1,0)), fmax(fabs(-sqrt(pow(D10_B0(0,-2,0), 2) +
      pow(D11_B0(0,-2,0), 2))*a_B0(0,-2,0) + D10_B0(0,-2,0)*u0_B0(0,-2,0) +
      D11_B0(0,-2,0)*u1_B0(0,-2,0)), fmax(fabs(-sqrt(pow(D10_B0(0,2,0), 2) +
      ...
      D11_B0(0,2,0)*u1_B0(0,2,0)), fmax(fabs(-sqrt(pow(D10_B0(0,0,0), 2) +
      pow(D11_B0(0,0,0), 2))*a_B0(0,0,0) + D10_B0(0,0,0)*u0_B0(0,0,0) +
      D11_B0(0,0,0)*u1_B0(0,0,0)), fabs(-sqrt(pow(D10_B0(0,-1,0), 2) +
      pow(D11_B0(0,-1,0), 2))*a_B0(0,-1,0) + D10_B0(0,-1,0)*u0_B0(0,-1,0) +
