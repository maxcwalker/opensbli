  ...
  for ( int n_z=start[2]; n_z<end[2]; n_z++ ){
    for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
      ...
      for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
        ...
        ACC<double> rhou2_B0(xdim2_opensbliblock00Kernel063, ydim2_opensbliblock00Kernel063, rhou2_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel063*1 + n_z * xdim2_opensbliblock00Kernel063 * ydim2_opensbliblock00Kernel063*1);
        ACC<double> rho_B0(xdim3_opensbliblock00Kernel063, ydim3_opensbliblock00Kernel063, rho_B0_p + n_x*1 + n_y * xdim3_opensbliblock00Kernel063*1 + n_z * xdim3_opensbliblock00Kernel063 * ydim3_opensbliblock00Kernel063*1);
   ...
   rhoE_B0(0,-1,0) = rcinv11*Pwall + (rc9)*rho_halo_1*(pow(u01, 2) + pow(u11, 2) + pow(u21, 2));

   rhoE_B0(0,-2,0) = rcinv11*Pwall + (rc9)*rho_halo_2*(pow(u02, 2) + pow(u12, 2) + pow(u22, 2));

   rhoE_B0(0,-3,0) = rcinv11*Pwall + (rc9)*rho_halo_3*(pow(u03, 2) + pow(u13, 2) + pow(u23, 2));
