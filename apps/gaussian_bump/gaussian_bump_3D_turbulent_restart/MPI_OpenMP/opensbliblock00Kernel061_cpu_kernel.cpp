  ...
  for ( int n_z=start[2]; n_z<end[2]; n_z++ ){
    for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
      ...
      for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
        ACC<double> rhou2_B0(xdim0_opensbliblock00Kernel061, ydim0_opensbliblock00Kernel061, rhou2_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel061*1 + n_z * xdim0_opensbliblock00Kernel061 * ydim0_opensbliblock00Kernel061*1);
        ...
        ACC<double> rhou0_B0(xdim3_opensbliblock00Kernel061, ydim3_opensbliblock00Kernel061, rhou0_B0_p + n_x*1 + n_y * xdim3_opensbliblock00Kernel061*1 + n_z * xdim3_opensbliblock00Kernel061 * ydim3_opensbliblock00Kernel061*1);
        ACC<double> rhou1_B0(xdim4_opensbliblock00Kernel061, ydim4_opensbliblock00Kernel061, rhou1_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel061*1 + n_z * xdim4_opensbliblock00Kernel061 * ydim4_opensbliblock00Kernel061*1);
