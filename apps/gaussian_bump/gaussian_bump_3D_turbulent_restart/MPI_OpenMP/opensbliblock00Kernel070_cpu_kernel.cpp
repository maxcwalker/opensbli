  ...
  for ( int n_z=start[2]; n_z<end[2]; n_z++ ){
    for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
      ...
      for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
        ...
        ACC<double> D00_B0(xdim3_opensbliblock00Kernel070, ydim3_opensbliblock00Kernel070, D00_B0_p + n_x*1 + n_y * xdim3_opensbliblock00Kernel070*1 + n_z * xdim3_opensbliblock00Kernel070 * ydim3_opensbliblock00Kernel070*1);
        ACC<double> D11_B0(xdim4_opensbliblock00Kernel070, ydim4_opensbliblock00Kernel070, D11_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel070*1 + n_z * xdim4_opensbliblock00Kernel070 * ydim4_opensbliblock00Kernel070*1);
   ...
   double localeval_1 = 0.0;
    localeval_0 = ((idx[0] == 0) ? (
   inv_2*(4*x0_B0(1,0,0) - rc13*x0_B0(4,0,0) -
      3*x0_B0(2,0,0) + (rc14)*x0_B0(3,0,0) - rc15*x0_B0(0,0,0))
)
: ((idx[0] == 1) ? (

      (rc16)*inv_2*(18*x0_B0(1,0,0) - 6*x0_B0(2,0,0) - 3*x0_B0(-1,0,0) +
      x0_B0(3,0,0) - 10*x0_B0(0,0,0))
)
: ((idx[0] == block0np0 - 1) ? (

      inv_2*((rc13)*x0_B0(-4,0,0) - rc14*x0_B0(-3,0,0) + 3*x0_B0(-2,0,0) -
      4*x0_B0(-1,0,0) + (rc15)*x0_B0(0,0,0))
)
: ((idx[0] == block0np0 - 2) ? (

      (rc16)*inv_2*(3*x0_B0(1,0,0) - x0_B0(-3,0,0) + 6*x0_B0(-2,0,0) -
      18*x0_B0(-1,0,0) + 10*x0_B0(0,0,0))
)
: (
   (rc16)*inv_2*(-8*x0_B0(-1,0,0) +
    ...
    localeval_1 = ((idx[1] == 0) ? (
   inv_0*(4*x1_B0(0,1,0) - rc13*x1_B0(0,4,0) -
      3*x1_B0(0,2,0) + (rc14)*x1_B0(0,3,0) - rc15*x1_B0(0,0,0))
)
: ((idx[1] == 1) ? (

      (rc16)*inv_0*(18*x1_B0(0,1,0) - 6*x1_B0(0,2,0) - 3*x1_B0(0,-1,0) +
      x1_B0(0,3,0) - 10*x1_B0(0,0,0))
)
: (
   (rc16)*inv_0*(-8*x1_B0(0,-1,0) +
    ...
    localeval_2 = ((idx[1] == 0) ? (
   inv_0*(4*x0_B0(0,1,0) - rc13*x0_B0(0,4,0) -
      3*x0_B0(0,2,0) + (rc14)*x0_B0(0,3,0) - rc15*x0_B0(0,0,0))
)
: ((idx[1] == 1) ? (

      (rc16)*inv_0*(18*x0_B0(0,1,0) - 6*x0_B0(0,2,0) - 3*x0_B0(0,-1,0) +
      x0_B0(0,3,0) - 10*x0_B0(0,0,0))
)
: (
   (rc16)*inv_0*(-8*x0_B0(0,-1,0) +
    ...
    localeval_3 = ((idx[0] == 0) ? (
   inv_2*(4*x1_B0(1,0,0) - rc13*x1_B0(4,0,0) -
      3*x1_B0(2,0,0) + (rc14)*x1_B0(3,0,0) - rc15*x1_B0(0,0,0))
)
: ((idx[0] == 1) ? (

      (rc16)*inv_2*(18*x1_B0(1,0,0) - 6*x1_B0(2,0,0) - 3*x1_B0(-1,0,0) +
      x1_B0(3,0,0) - 10*x1_B0(0,0,0))
)
: ((idx[0] == block0np0 - 1) ? (

      inv_2*((rc13)*x1_B0(-4,0,0) - rc14*x1_B0(-3,0,0) + 3*x1_B0(-2,0,0) -
      4*x1_B0(-1,0,0) + (rc15)*x1_B0(0,0,0))
)
: ((idx[0] == block0np0 - 2) ? (

      (rc16)*inv_2*(3*x1_B0(1,0,0) - x1_B0(-3,0,0) + 6*x1_B0(-2,0,0) -
      18*x1_B0(-1,0,0) + 10*x1_B0(0,0,0))
)
: (
   ...
   detJ_B0(0,0,0) = localeval_0*localeval_1 - localeval_2*localeval_3;

   D00_B0(0,0,0) = localeval_1/(localeval_0*localeval_1 - localeval_2*localeval_3);

   D01_B0(0,0,0) = -localeval_2/(localeval_0*localeval_1 - localeval_2*localeval_3);

   D10_B0(0,0,0) = -localeval_3/(localeval_0*localeval_1 - localeval_2*localeval_3);

   D11_B0(0,0,0) = localeval_0/(localeval_0*localeval_1 - localeval_2*localeval_3);
