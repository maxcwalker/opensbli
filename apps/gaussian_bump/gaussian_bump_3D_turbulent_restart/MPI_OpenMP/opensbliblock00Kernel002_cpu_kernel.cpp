...
void ops_par_loop_opensbliblock00Kernel002_execute(ops_kernel_descriptor *desc) {
  ...
  double * __restrict__ detJ_B0_p = (double *)(args[11].data + base11);

  int base12 = args[12].dat->base_offset;
  double * __restrict__ wk11_B0_p = (double *)(args[12].data + base12);

  int base13 = args[13].dat->base_offset;
  double * __restrict__ wk14_B0_p = (double *)(args[13].data + base13);

  int base14 = args[14].dat->base_offset;
  double * __restrict__ wk13_B0_p = (double *)(args[14].data + base14);
  ...
  double * __restrict__ wk12_B0_p = (double *)(args[16].data + base16);
  ...
  for ( int n_z=start[2]; n_z<end[2]; n_z++ ){
    for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
      ...
      for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
        ...
        const ACC<double> rhou2_B0(xdim2_opensbliblock00Kernel002, ydim2_opensbliblock00Kernel002, rhou2_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel002*1 + n_z * xdim2_opensbliblock00Kernel002 * ydim2_opensbliblock00Kernel002*1);
        const ACC<double> rho_B0(xdim3_opensbliblock00Kernel002, ydim3_opensbliblock00Kernel002, rho_B0_p + n_x*1 + n_y * xdim3_opensbliblock00Kernel002*1 + n_z * xdim3_opensbliblock00Kernel002 * ydim3_opensbliblock00Kernel002*1);
        const ACC<double> p_B0(xdim4_opensbliblock00Kernel002, ydim4_opensbliblock00Kernel002, p_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel002*1 + n_z * xdim4_opensbliblock00Kernel002 * ydim4_opensbliblock00Kernel002*1);
        const ACC<double> u1_B0(xdim5_opensbliblock00Kernel002, ydim5_opensbliblock00Kernel002, u1_B0_p + n_x*1 + n_y * xdim5_opensbliblock00Kernel002*1 + n_z * xdim5_opensbliblock00Kernel002 * ydim5_opensbliblock00Kernel002*1);
        const ACC<double> u0_B0(xdim6_opensbliblock00Kernel002, ydim6_opensbliblock00Kernel002, u0_B0_p + n_x*1 + n_y * xdim6_opensbliblock00Kernel002*1 + n_z * xdim6_opensbliblock00Kernel002 * ydim6_opensbliblock00Kernel002*1);
        ...
        const ACC<double> detJ_B0(xdim11_opensbliblock00Kernel002, ydim11_opensbliblock00Kernel002, detJ_B0_p + n_x*1 + n_y * xdim11_opensbliblock00Kernel002*1 + n_z * xdim11_opensbliblock00Kernel002 * ydim11_opensbliblock00Kernel002*1);
        ACC<double> wk11_B0(xdim12_opensbliblock00Kernel002, ydim12_opensbliblock00Kernel002, wk11_B0_p + n_x*1 + n_y * xdim12_opensbliblock00Kernel002*1 + n_z * xdim12_opensbliblock00Kernel002 * ydim12_opensbliblock00Kernel002*1);
        ACC<double> wk14_B0(xdim13_opensbliblock00Kernel002, ydim13_opensbliblock00Kernel002, wk14_B0_p + n_x*1 + n_y * xdim13_opensbliblock00Kernel002*1 + n_z * xdim13_opensbliblock00Kernel002 * ydim13_opensbliblock00Kernel002*1);
        ACC<double> wk13_B0(xdim14_opensbliblock00Kernel002, ydim14_opensbliblock00Kernel002, wk13_B0_p + n_x*1 + n_y * xdim14_opensbliblock00Kernel002*1 + n_z * xdim14_opensbliblock00Kernel002 * ydim14_opensbliblock00Kernel002*1);
        ...
        ACC<double> wk12_B0(xdim16_opensbliblock00Kernel002, ydim16_opensbliblock00Kernel002, wk12_B0_p + n_x*1 + n_y * xdim16_opensbliblock00Kernel002*1 + n_z * xdim16_opensbliblock00Kernel002 * ydim16_opensbliblock00Kernel002*1);
