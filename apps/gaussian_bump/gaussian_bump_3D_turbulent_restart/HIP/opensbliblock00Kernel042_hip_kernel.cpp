...
//
__constant__ int dims_opensbliblock00Kernel042 [2][2];
static int dims_opensbliblock00Kernel042_h [2][2] = {{0}};

//user function
__device__

void opensbliblock00Kernel042_gpu(const ACC<double> &u2_B0,
  ACC<double> &wk7_B0)
{
    wk7_B0(0,0,0) = (rc16)*inv_1*(u2_B0(0,0,-2) - 8*u2_B0(0,0,-1) +
      8*u2_B0(0,0,1) - u2_B0(0,0,2));
...
int size2 ){
  ...
  if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
    ...
    opensbliblock00Kernel042_gpu(argp0, argp1);
  }
...
void ops_par_loop_opensbliblock00Kernel042_execute(ops_kernel_descriptor *desc) {
  ...
  if (x_size > 0 && y_size > 0 && z_size > 0)
    hipLaunchKernelGGL(ops_opensbliblock00Kernel042,grid ,tblock ,0 ,0 , (double *)p_a[0], (double *)p_a[1],x_size, y_size, z_size);
