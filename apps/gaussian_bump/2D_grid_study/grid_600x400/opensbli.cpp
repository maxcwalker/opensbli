...
ops_par_loop(opensbliblock00Kernel081, "MetricsEquation CD D10_B0 xi1 ", opensbliblock00, 2, iteration_range_81_block0,
ops_arg_dat(D10_B0, 1, stencil_0_00_24_8, "double", OPS_READ),
ops_arg_dat(wk3_B0, 1, stencil_0_00_00_2, "double", OPS_WRITE),
ops_arg_idx());

int iteration_range_82_block0[] = {0, block0np0, 0, block0np1};
ops_par_loop(opensbliblock00Kernel082, "MetricsEquation CD D01_B0 xi0 ", opensbliblock00, 2, iteration_range_82_block0,
...
ops_par_loop(opensbliblock00Kernel083, "MetricsEquation CD D11_B0 xi0 ", opensbliblock00, 2, iteration_range_83_block0,
...
ops_par_loop(opensbliblock00Kernel084, "MetricsEquation CD D00_B0 xi1 ", opensbliblock00, 2, iteration_range_84_block0,
...
ops_par_loop(opensbliblock00Kernel085, "MetricsEquation CD D01_B0 xi1 ", opensbliblock00, 2, iteration_range_85_block0,
...
ops_par_loop(opensbliblock00Kernel029, "Viscous CD u0_B0 xi1 xi1 ", opensbliblock00, 2, iteration_range_29_block0,
ops_arg_dat(u0_B0, 1, stencil_0_00_24_8, "double", OPS_READ),
ops_arg_dat(wk1_B0, 1, stencil_0_00_00_2, "double", OPS_WRITE),
ops_arg_idx());

int iteration_range_30_block0[] = {0, block0np0, 0, block0np1};
ops_par_loop(opensbliblock00Kernel030, "Viscous CD T_B0 xi0 xi0 ", opensbliblock00, 2, iteration_range_30_block0,
...
ops_par_loop(opensbliblock00Kernel033, "Viscous CD u1_B0 xi1 xi1 ", opensbliblock00, 2, iteration_range_33_block0,
ops_arg_dat(u1_B0, 1, stencil_0_00_24_8, "double", OPS_READ),
ops_arg_dat(wk5_B0, 1, stencil_0_00_00_2, "double", OPS_WRITE),
ops_arg_idx());

int iteration_range_34_block0[] = {0, block0np0, 0, block0np1};
ops_par_loop(opensbliblock00Kernel034, "Viscous CD mu_B0 xi1 ", opensbliblock00, 2, iteration_range_34_block0,
...
ops_par_loop(opensbliblock00Kernel036, "Viscous CD T_B0 xi1 xi1 ", opensbliblock00, 2, iteration_range_36_block0,
...
ops_par_loop(opensbliblock00Kernel039, "Viscous CD u1_B0 xi0 xi0 ", opensbliblock00, 2, iteration_range_39_block0,
ops_arg_dat(u1_B0, 1, stencil_0_44_00_10, "double", OPS_READ),
ops_arg_dat(wk11_B0, 1, stencil_0_00_00_2, "double", OPS_WRITE),
ops_arg_idx());

int iteration_range_40_block0[] = {0, block0np0, -2, block0np1 + 2};
ops_par_loop(opensbliblock00Kernel040, "Viscous CD u0_B0 xi0 ", opensbliblock00, 2, iteration_range_40_block0,
ops_arg_dat(u0_B0, 1, stencil_0_44_00_10, "double", OPS_READ),
ops_arg_dat(wk12_B0, 1, stencil_0_00_00_2, "double", OPS_WRITE),
ops_arg_idx());

int iteration_range_41_block0[] = {0, block0np0, 0, block0np1};
ops_par_loop(opensbliblock00Kernel041, "Viscous CD T_B0 xi1 ", opensbliblock00, 2, iteration_range_41_block0,
ops_arg_dat(T_B0, 1, stencil_0_00_24_8, "double", OPS_READ),
...
ops_par_loop(opensbliblock00Kernel043, "Viscous CD T_B0 xi0 ", opensbliblock00, 2, iteration_range_43_block0,
ops_arg_dat(T_B0, 1, stencil_0_44_00_10, "double", OPS_READ),
...
ops_par_loop(opensbliblock00Kernel038, "Viscous CD CD u0_B0 xi0 xi1 ", opensbliblock00, 2, iteration_range_38_block0,
ops_arg_dat(wk12_B0, 1, stencil_0_00_24_8, "double", OPS_READ),
ops_arg_dat(wk10_B0, 1, stencil_0_00_00_2, "double", OPS_WRITE),
ops_arg_idx());

int iteration_range_44_block0[] = {0, block0np0, 0, block0np1};
ops_par_loop(opensbliblock00Kernel044, "Viscous CD CD T_B0 xi0 xi1 ", opensbliblock00, 2, iteration_range_44_block0,
ops_arg_dat(wk15_B0, 1, stencil_0_00_24_8, "double", OPS_READ),
...
if (iter == 0){
ops_fprintf(f0, "Iteration, Time, p_B0(60, 10), p_B0(300, 10), p_B0(480, 10), p_B0(60, 50), p_B0(300, 50), p_B0(480, 50)\n");}
// Monitoring of p_B0
...
ops_fprintf(f0, "%d, %.12e, %.12e, %.12e, %.12e, %.12e, %.12e, %.12e\n", iter+1, simulation_time, p_B0_0_output, p_B0_1_output, p_B0_2_output, p_B0_3_output, p_B0_4_output, p_B0_5_output);
fflush(f0);
}
