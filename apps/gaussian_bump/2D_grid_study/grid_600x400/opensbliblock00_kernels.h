...
ACC<double> &detJ_B0, ACC<double> &wk0_B0, ACC<double> &wk1_B0, ACC<double> &wk2_B0, ACC<double> &wk3_B0)
{
   ...
   D01_B0(0,0) = -wk2_B0(0,0)/(wk0_B0(0,0)*wk3_B0(0,0) - wk1_B0(0,0)*wk2_B0(0,0));

   D10_B0(0,0) = -wk1_B0(0,0)/(wk0_B0(0,0)*wk3_B0(0,0) - wk1_B0(0,0)*wk2_B0(0,0));
...
void opensbliblock00Kernel079(const ACC<double> &D11_B0, ACC<double> &wk1_B0, const int *idx)
{
...
void opensbliblock00Kernel081(const ACC<double> &D10_B0, ACC<double> &wk3_B0, const int *idx)
{
...
void opensbliblock00Kernel082(const ACC<double> &D01_B0, ACC<double> &wk4_B0, const int *idx)
{
...
void opensbliblock00Kernel084(const ACC<double> &D00_B0, ACC<double> &wk6_B0, const int *idx)
{
...
void opensbliblock00Kernel085(const ACC<double> &D01_B0, ACC<double> &wk7_B0, const int *idx)
{
...
&SD100_B0, ACC<double> &SD101_B0, ACC<double> &SD110_B0, ACC<double> &SD111_B0)
{
   ...
   SD010_B0(0,0) = wk4_B0(0,0);

   SD011_B0(0,0) = wk7_B0(0,0);

   SD100_B0(0,0) = wk0_B0(0,0);

   SD101_B0(0,0) = wk3_B0(0,0);

   SD110_B0(0,0) = wk5_B0(0,0);

   SD111_B0(0,0) = wk1_B0(0,0);
...
ACC<double> &u1_B0, ACC<double> &p_B0)
{
 ...
 void opensbliblock00Kernel013(const ACC<double> &D00_B0, const ACC<double> &D01_B0, const ACC<double> &u0_B0, const
...
{
    wk1_B0(0,0) = inv2Delta1block0*((idx[1] == 0) ? (
...
void opensbliblock00Kernel030(const ACC<double> &T_B0, ACC<double> &wk2_B0, const int *idx)
{
    wk2_B0(0,0) = inv2Delta0block0*((idx[0] == 0) ? (
...
void opensbliblock00Kernel031(const ACC<double> &u0_B0, ACC<double> &wk3_B0, const int *idx)
{
    wk3_B0(0,0) = inv2Delta0block0*((idx[0] == 0) ? (
...
void opensbliblock00Kernel033(const ACC<double> &u1_B0, ACC<double> &wk5_B0, const int *idx)
{
    wk5_B0(0,0) = inv2Delta1block0*((idx[1] == 0) ? (
...
void opensbliblock00Kernel034(const ACC<double> &mu_B0, ACC<double> &wk6_B0, const int *idx)
{
    wk6_B0(0,0) = invDelta1block0*((idx[1] == 0) ? (
...
void opensbliblock00Kernel035(const ACC<double> &u0_B0, ACC<double> &wk7_B0, const int *idx)
{
    wk7_B0(0,0) = invDelta1block0*((idx[1] == 0) ? (
...
void opensbliblock00Kernel036(const ACC<double> &T_B0, ACC<double> &wk8_B0, const int *idx)
{
...
{
    wk9_B0(0,0) = invDelta0block0*((idx[0] == 0) ? (
...
void opensbliblock00Kernel039(const ACC<double> &u1_B0, ACC<double> &wk11_B0, const int *idx)
{
    wk11_B0(0,0) = inv2Delta0block0*((idx[0] == 0) ? (
...
{
    wk12_B0(0,0) = invDelta0block0*((idx[0] == 0) ? (
...
void opensbliblock00Kernel041(const ACC<double> &T_B0, ACC<double> &wk13_B0, const int *idx)
{
...
void opensbliblock00Kernel042(const ACC<double> &mu_B0, ACC<double> &wk14_B0, const int *idx)
{
...
void opensbliblock00Kernel043(const ACC<double> &T_B0, ACC<double> &wk15_B0, const int *idx)
{
    wk15_B0(0,0) = invDelta0block0*((idx[0] == 0) ? (
...
void opensbliblock00Kernel028(const ACC<double> &wk9_B0, ACC<double> &wk0_B0, const int *idx)
{
    wk0_B0(0,0) = invDelta1block0*((idx[1] == 0) ? (
...
void opensbliblock00Kernel038(const ACC<double> &wk12_B0, ACC<double> &wk10_B0, const int *idx)
{
    wk10_B0(0,0) = invDelta1block0*((idx[1] == 0) ? (
   -3*wk12_B0(0,2) + 4*wk12_B0(0,1) - (25.0/12.0)*wk12_B0(0,0) -
      (1.0/4.0)*wk12_B0(0,4) + ((4.0/3.0))*wk12_B0(0,3)
)
: ((idx[1] == 1) ? (
   -(5.0/6.0)*wk12_B0(0,0) -
      (1.0/2.0)*wk12_B0(0,2) - (1.0/4.0)*wk12_B0(0,-1) + ((1.0/12.0))*wk12_B0(0,3) + ((3.0/2.0))*wk12_B0(0,1)
)
: (
  
      -(2.0/3.0)*wk12_B0(0,-1) - (1.0/12.0)*wk12_B0(0,2) + ((1.0/12.0))*wk12_B0(0,-2) + ((2.0/3.0))*wk12_B0(0,1)
)));

}

void opensbliblock00Kernel044(const ACC<double> &wk15_B0, ACC<double> &wk16_B0, const int *idx)
{
    wk16_B0(0,0) = invDelta1block0*((idx[1] == 0) ? (
   -3*wk15_B0(0,2) + 4*wk15_B0(0,1) - (25.0/12.0)*wk15_B0(0,0) -
      (1.0/4.0)*wk15_B0(0,4) + ((4.0/3.0))*wk15_B0(0,3)
)
: ((idx[1] == 1) ? (
   -(5.0/6.0)*wk15_B0(0,0) -
      (1.0/2.0)*wk15_B0(0,2) - (1.0/4.0)*wk15_B0(0,-1) + ((1.0/12.0))*wk15_B0(0,3) + ((3.0/2.0))*wk15_B0(0,1)
)
: (
  
      -(2.0/3.0)*wk15_B0(0,-1) - (1.0/12.0)*wk15_B0(0,2) + ((1.0/12.0))*wk15_B0(0,-2) + ((2.0/3.0))*wk15_B0(0,1)
)));
...
{
    Residual1_B0(0,0) = (D00_B0(0,0)*wk14_B0(0,0) + D10_B0(0,0)*wk6_B0(0,0))*(-(2.0/3.0)*D01_B0(0,0)*wk9_B0(0,0) -
      (2.0/3.0)*D11_B0(0,0)*wk4_B0(0,0) + ((4.0/3.0))*D00_B0(0,0)*wk12_B0(0,0) +
      ((4.0/3.0))*D10_B0(0,0)*wk7_B0(0,0))*invRe + (D01_B0(0,0)*wk14_B0(0,0) +
      D11_B0(0,0)*wk6_B0(0,0))*(D00_B0(0,0)*wk9_B0(0,0) + D01_B0(0,0)*wk12_B0(0,0) + D10_B0(0,0)*wk4_B0(0,0) +
      D11_B0(0,0)*wk7_B0(0,0))*invRe + ((D01_B0(0,0)*D01_B0(0,0))*wk3_B0(0,0) + (D11_B0(0,0)*D11_B0(0,0))*wk1_B0(0,0) +
      ((4.0/3.0))*(D00_B0(0,0)*D00_B0(0,0))*wk3_B0(0,0) + ((4.0/3.0))*(D10_B0(0,0)*D10_B0(0,0))*wk1_B0(0,0) +
      D01_B0(0,0)*wk4_B0(0,0)*SD100_B0(0,0) + D01_B0(0,0)*wk7_B0(0,0)*SD110_B0(0,0) +
      D01_B0(0,0)*wk9_B0(0,0)*SD000_B0(0,0) + D01_B0(0,0)*wk12_B0(0,0)*SD010_B0(0,0) +
      D11_B0(0,0)*wk4_B0(0,0)*SD101_B0(0,0) + D11_B0(0,0)*wk7_B0(0,0)*SD111_B0(0,0) +
      D11_B0(0,0)*wk9_B0(0,0)*SD001_B0(0,0) + D11_B0(0,0)*wk12_B0(0,0)*SD011_B0(0,0) +
      2*D01_B0(0,0)*D11_B0(0,0)*wk10_B0(0,0) - (2.0/3.0)*D00_B0(0,0)*wk4_B0(0,0)*SD110_B0(0,0) -
      (2.0/3.0)*D00_B0(0,0)*wk9_B0(0,0)*SD010_B0(0,0) - (2.0/3.0)*D10_B0(0,0)*wk4_B0(0,0)*SD111_B0(0,0) -
      (2.0/3.0)*D10_B0(0,0)*wk9_B0(0,0)*SD011_B0(0,0) + ((1.0/3.0))*D00_B0(0,0)*D01_B0(0,0)*wk11_B0(0,0) +
      ((1.0/3.0))*D00_B0(0,0)*D11_B0(0,0)*wk0_B0(0,0) + ((1.0/3.0))*D01_B0(0,0)*D10_B0(0,0)*wk0_B0(0,0) +
      ((1.0/3.0))*D10_B0(0,0)*D11_B0(0,0)*wk5_B0(0,0) + ((4.0/3.0))*D00_B0(0,0)*wk7_B0(0,0)*SD100_B0(0,0) +
      ((4.0/3.0))*D00_B0(0,0)*wk12_B0(0,0)*SD000_B0(0,0) + ((4.0/3.0))*D10_B0(0,0)*wk7_B0(0,0)*SD101_B0(0,0) +
      ((4.0/3.0))*D10_B0(0,0)*wk12_B0(0,0)*SD001_B0(0,0) +
      ((8.0/3.0))*D00_B0(0,0)*D10_B0(0,0)*wk10_B0(0,0))*invRe*mu_B0(0,0) + Residual1_B0(0,0);

    Residual2_B0(0,0) = (D00_B0(0,0)*wk14_B0(0,0) + D10_B0(0,0)*wk6_B0(0,0))*(D00_B0(0,0)*wk9_B0(0,0) +
      D01_B0(0,0)*wk12_B0(0,0) + D10_B0(0,0)*wk4_B0(0,0) + D11_B0(0,0)*wk7_B0(0,0))*invRe + (D01_B0(0,0)*wk14_B0(0,0) +
      D11_B0(0,0)*wk6_B0(0,0))*(-(2.0/3.0)*D00_B0(0,0)*wk12_B0(0,0) - (2.0/3.0)*D10_B0(0,0)*wk7_B0(0,0) +
      ((4.0/3.0))*D01_B0(0,0)*wk9_B0(0,0) + ((4.0/3.0))*D11_B0(0,0)*wk4_B0(0,0))*invRe +
      ((D00_B0(0,0)*D00_B0(0,0))*wk11_B0(0,0) + (D10_B0(0,0)*D10_B0(0,0))*wk5_B0(0,0) +
      ((4.0/3.0))*(D01_B0(0,0)*D01_B0(0,0))*wk11_B0(0,0) + ((4.0/3.0))*(D11_B0(0,0)*D11_B0(0,0))*wk5_B0(0,0) +
      D00_B0(0,0)*wk4_B0(0,0)*SD100_B0(0,0) + D00_B0(0,0)*wk7_B0(0,0)*SD110_B0(0,0) +
      D00_B0(0,0)*wk9_B0(0,0)*SD000_B0(0,0) + D00_B0(0,0)*wk12_B0(0,0)*SD010_B0(0,0) +
      D10_B0(0,0)*wk4_B0(0,0)*SD101_B0(0,0) + D10_B0(0,0)*wk7_B0(0,0)*SD111_B0(0,0) +
      D10_B0(0,0)*wk9_B0(0,0)*SD001_B0(0,0) + D10_B0(0,0)*wk12_B0(0,0)*SD011_B0(0,0) +
      2*D00_B0(0,0)*D10_B0(0,0)*wk0_B0(0,0) - (2.0/3.0)*D01_B0(0,0)*wk7_B0(0,0)*SD100_B0(0,0) -
      (2.0/3.0)*D01_B0(0,0)*wk12_B0(0,0)*SD000_B0(0,0) - (2.0/3.0)*D11_B0(0,0)*wk7_B0(0,0)*SD101_B0(0,0) -
      (2.0/3.0)*D11_B0(0,0)*wk12_B0(0,0)*SD001_B0(0,0) + ((1.0/3.0))*D00_B0(0,0)*D01_B0(0,0)*wk3_B0(0,0) +
      ((1.0/3.0))*D00_B0(0,0)*D11_B0(0,0)*wk10_B0(0,0) + ((1.0/3.0))*D01_B0(0,0)*D10_B0(0,0)*wk10_B0(0,0) +
      ((1.0/3.0))*D10_B0(0,0)*D11_B0(0,0)*wk1_B0(0,0) + ((4.0/3.0))*D01_B0(0,0)*wk4_B0(0,0)*SD110_B0(0,0) +
      ((4.0/3.0))*D01_B0(0,0)*wk9_B0(0,0)*SD010_B0(0,0) + ((4.0/3.0))*D11_B0(0,0)*wk4_B0(0,0)*SD111_B0(0,0) +
      ((4.0/3.0))*D11_B0(0,0)*wk9_B0(0,0)*SD011_B0(0,0) +
      ((8.0/3.0))*D01_B0(0,0)*D11_B0(0,0)*wk0_B0(0,0))*invRe*mu_B0(0,0) + Residual2_B0(0,0);

    Residual3_B0(0,0) = (D00_B0(0,0)*wk9_B0(0,0) + D10_B0(0,0)*wk4_B0(0,0))*(D00_B0(0,0)*wk9_B0(0,0) +
      D01_B0(0,0)*wk12_B0(0,0) + D10_B0(0,0)*wk4_B0(0,0) + D11_B0(0,0)*wk7_B0(0,0))*invRe*mu_B0(0,0) +
      (D00_B0(0,0)*wk12_B0(0,0) + D10_B0(0,0)*wk7_B0(0,0))*(-(2.0/3.0)*D01_B0(0,0)*wk9_B0(0,0) -
      (2.0/3.0)*D11_B0(0,0)*wk4_B0(0,0) + ((4.0/3.0))*D00_B0(0,0)*wk12_B0(0,0) +
      ((4.0/3.0))*D10_B0(0,0)*wk7_B0(0,0))*invRe*mu_B0(0,0) + (D00_B0(0,0)*wk14_B0(0,0) +
      D10_B0(0,0)*wk6_B0(0,0))*(D00_B0(0,0)*wk9_B0(0,0) + D01_B0(0,0)*wk12_B0(0,0) + D10_B0(0,0)*wk4_B0(0,0) +
      D11_B0(0,0)*wk7_B0(0,0))*invRe*u1_B0(0,0) + (D00_B0(0,0)*wk14_B0(0,0) +
      D10_B0(0,0)*wk6_B0(0,0))*(-(2.0/3.0)*D01_B0(0,0)*wk9_B0(0,0) - (2.0/3.0)*D11_B0(0,0)*wk4_B0(0,0) +
      ((4.0/3.0))*D00_B0(0,0)*wk12_B0(0,0) + ((4.0/3.0))*D10_B0(0,0)*wk7_B0(0,0))*invRe*u0_B0(0,0) +
      (D01_B0(0,0)*wk9_B0(0,0) + D11_B0(0,0)*wk4_B0(0,0))*(-(2.0/3.0)*D00_B0(0,0)*wk12_B0(0,0) -
      (2.0/3.0)*D10_B0(0,0)*wk7_B0(0,0) + ((4.0/3.0))*D01_B0(0,0)*wk9_B0(0,0) +
      ((4.0/3.0))*D11_B0(0,0)*wk4_B0(0,0))*invRe*mu_B0(0,0) + (D01_B0(0,0)*wk12_B0(0,0) +
      D11_B0(0,0)*wk7_B0(0,0))*(D00_B0(0,0)*wk9_B0(0,0) + D01_B0(0,0)*wk12_B0(0,0) + D10_B0(0,0)*wk4_B0(0,0) +
      D11_B0(0,0)*wk7_B0(0,0))*invRe*mu_B0(0,0) + (D01_B0(0,0)*wk14_B0(0,0) +
      D11_B0(0,0)*wk6_B0(0,0))*(D00_B0(0,0)*wk9_B0(0,0) + D01_B0(0,0)*wk12_B0(0,0) + D10_B0(0,0)*wk4_B0(0,0) +
      D11_B0(0,0)*wk7_B0(0,0))*invRe*u0_B0(0,0) + (D01_B0(0,0)*wk14_B0(0,0) +
      D11_B0(0,0)*wk6_B0(0,0))*(-(2.0/3.0)*D00_B0(0,0)*wk12_B0(0,0) - (2.0/3.0)*D10_B0(0,0)*wk7_B0(0,0) +
      ((4.0/3.0))*D01_B0(0,0)*wk9_B0(0,0) + ((4.0/3.0))*D11_B0(0,0)*wk4_B0(0,0))*invRe*u1_B0(0,0) +
      ((D00_B0(0,0)*D00_B0(0,0))*wk11_B0(0,0) + (D10_B0(0,0)*D10_B0(0,0))*wk5_B0(0,0) +
      ((4.0/3.0))*(D01_B0(0,0)*D01_B0(0,0))*wk11_B0(0,0) + ((4.0/3.0))*(D11_B0(0,0)*D11_B0(0,0))*wk5_B0(0,0) +
      D00_B0(0,0)*wk4_B0(0,0)*SD100_B0(0,0) + D00_B0(0,0)*wk7_B0(0,0)*SD110_B0(0,0) +
      D00_B0(0,0)*wk9_B0(0,0)*SD000_B0(0,0) + D00_B0(0,0)*wk12_B0(0,0)*SD010_B0(0,0) +
      ...
      ((4.0/3.0))*D01_B0(0,0)*wk9_B0(0,0)*SD010_B0(0,0) + ((4.0/3.0))*D11_B0(0,0)*wk4_B0(0,0)*SD111_B0(0,0) +
      ((4.0/3.0))*D11_B0(0,0)*wk9_B0(0,0)*SD011_B0(0,0) +
      ((8.0/3.0))*D01_B0(0,0)*D11_B0(0,0)*wk0_B0(0,0))*invRe*mu_B0(0,0)*u1_B0(0,0) +
      ((D01_B0(0,0)*D01_B0(0,0))*wk3_B0(0,0) + (D11_B0(0,0)*D11_B0(0,0))*wk1_B0(0,0) +
      ((4.0/3.0))*(D00_B0(0,0)*D00_B0(0,0))*wk3_B0(0,0) + ((4.0/3.0))*(D10_B0(0,0)*D10_B0(0,0))*wk1_B0(0,0) +
      D01_B0(0,0)*wk4_B0(0,0)*SD100_B0(0,0) + D01_B0(0,0)*wk7_B0(0,0)*SD110_B0(0,0) +
      D01_B0(0,0)*wk9_B0(0,0)*SD000_B0(0,0) + D01_B0(0,0)*wk12_B0(0,0)*SD010_B0(0,0) +
      D11_B0(0,0)*wk4_B0(0,0)*SD101_B0(0,0) + D11_B0(0,0)*wk7_B0(0,0)*SD111_B0(0,0) +
      ...
      ((4.0/3.0))*D00_B0(0,0)*wk12_B0(0,0)*SD000_B0(0,0) + ((4.0/3.0))*D10_B0(0,0)*wk7_B0(0,0)*SD101_B0(0,0) +
      ((4.0/3.0))*D10_B0(0,0)*wk12_B0(0,0)*SD001_B0(0,0) +
      ((8.0/3.0))*D00_B0(0,0)*D10_B0(0,0)*wk10_B0(0,0))*invRe*mu_B0(0,0)*u0_B0(0,0) + (D00_B0(0,0)*wk14_B0(0,0) +
      D10_B0(0,0)*wk6_B0(0,0))*(D00_B0(0,0)*wk15_B0(0,0) + D10_B0(0,0)*wk13_B0(0,0))*invPr*invRe*inv2Minf*inv_gamma_m1 +
      (D01_B0(0,0)*wk14_B0(0,0) + D11_B0(0,0)*wk6_B0(0,0))*(D01_B0(0,0)*wk15_B0(0,0) +
      D11_B0(0,0)*wk13_B0(0,0))*invPr*invRe*inv2Minf*inv_gamma_m1 + ((D00_B0(0,0)*D00_B0(0,0))*wk2_B0(0,0) +
      (D01_B0(0,0)*D01_B0(0,0))*wk2_B0(0,0) + (D10_B0(0,0)*D10_B0(0,0))*wk8_B0(0,0) +
      (D11_B0(0,0)*D11_B0(0,0))*wk8_B0(0,0) + D00_B0(0,0)*wk13_B0(0,0)*SD100_B0(0,0) +
      D00_B0(0,0)*wk15_B0(0,0)*SD000_B0(0,0) + D01_B0(0,0)*wk13_B0(0,0)*SD110_B0(0,0) +
      D01_B0(0,0)*wk15_B0(0,0)*SD010_B0(0,0) + D10_B0(0,0)*wk13_B0(0,0)*SD101_B0(0,0) +
      D10_B0(0,0)*wk15_B0(0,0)*SD001_B0(0,0) + D11_B0(0,0)*wk13_B0(0,0)*SD111_B0(0,0) +
      D11_B0(0,0)*wk15_B0(0,0)*SD011_B0(0,0) + 2*D00_B0(0,0)*D10_B0(0,0)*wk16_B0(0,0) +
      2*D01_B0(0,0)*D11_B0(0,0)*wk16_B0(0,0))*invPr*invRe*inv2Minf*inv_gamma_m1*mu_B0(0,0) + Residual3_B0(0,0);
