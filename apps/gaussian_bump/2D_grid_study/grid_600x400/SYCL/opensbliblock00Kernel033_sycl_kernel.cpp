  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      , [=](cl::sycl::nd_item<2> item
        ...
        const ACC<double> u1_B0(xdim0_opensbliblock00Kernel033, &u1_B0_p[0] + base0 + n_x*1 + n_y * xdim0_opensbliblock00Kernel033*1);
    ...
    wk5_B0(0,0) = inv2Delta1block0_sycl[0]*((idx[1] == 0) ? (
