 ...
 arg15};
  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0) {
   ...
   CS_15 = rho_B0(3,0)*AVG_0_0_LEV_10 + rhou0_B0(3,0)*AVG_0_0_LEV_11 + rhou1_B0(3,0)*AVG_0_0_LEV_12;
    ...
    max_lambda_00 = shock_filter_control_sycl[0]*cl::sycl::fmax(cl::sycl::fabs(u0_B0(1,0)*D00_B0(1,0)*detJ_B0(1,0) +
      u1_B0(1,0)*D01_B0(1,0)*detJ_B0(1,0)), cl::sycl::fabs(u0_B0(0,0)*D00_B0(0,0)*detJ_B0(0,0) +
      u1_B0(0,0)*D01_B0(0,0)*detJ_B0(0,0)));

   max_lambda_11 = max_lambda_00;

    max_lambda_22 = shock_filter_control_sycl[0]*cl::sycl::fmax(cl::sycl::fabs(cl::sycl::sqrt((D00_B0(0,0)*D00_B0(0,0))*(detJ_B0(0,0)*detJ_B0(0,0)) +
    ...
    max_lambda_33 = shock_filter_control_sycl[0]*cl::sycl::fmax(cl::sycl::fabs(-cl::sycl::sqrt((D00_B0(1,0)*D00_B0(1,0))*(detJ_B0(1,0)*detJ_B0(1,0)) +
      (D01_B0(1,0)*D01_B0(1,0))*(detJ_B0(1,0)*detJ_B0(1,0)))*a_B0(1,0) + u0_B0(1,0)*D00_B0(1,0)*detJ_B0(1,0) +
