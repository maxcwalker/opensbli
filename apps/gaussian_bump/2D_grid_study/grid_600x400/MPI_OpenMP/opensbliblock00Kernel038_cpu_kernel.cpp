...
void ops_par_loop_opensbliblock00Kernel038_execute(ops_kernel_descriptor *desc) {
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
      ...
      const ACC<double> wk12_B0(xdim0_opensbliblock00Kernel038, wk12_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel038*1);
...
void ops_par_loop_opensbliblock00Kernel038(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  create_kerneldesc_and_enque(name, args, 3, 49, dim, 0, range, block, ops_par_loop_opensbliblock00Kernel038_execute);
}
#endif
