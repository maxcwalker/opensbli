...
//
__constant__ int dims_opensbliblock00Kernel026 [2][1];
static int dims_opensbliblock00Kernel026_h [2][1] = {{0}};
...
void ops_par_loop_opensbliblock00Kernel026_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_opensbliblock00Kernel026_h[0][0] || xdim1 != dims_opensbliblock00Kernel026_h[1][0]) {
  ...
  if (x_size > 0 && y_size > 0)
    hipLaunchKernelGGL(ops_opensbliblock00Kernel026,grid ,tblock ,0 ,0 , (double *)p_a[0], (double *)p_a[1],x_size, y_size);
