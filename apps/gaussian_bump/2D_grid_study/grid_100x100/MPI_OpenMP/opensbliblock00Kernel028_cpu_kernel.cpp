...
void ops_par_loop_opensbliblock00Kernel028_execute(ops_kernel_descriptor *desc) {
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
   ...
   -rc13*u0_B0(0,0) + (rc12)*u0_B0(3,0) -
      3*u0_B0(2,0) - rc11*u0_B0(4,0) + 4*u0_B0(1,0)
)
: ((idx[0] == 1) ? (

      -rc15*u0_B0(0,0) + (rc14)*u0_B0(3,0) - rc7*u0_B0(2,0) + (rc16)*u0_B0(1,0)
      - rc11*u0_B0(-1,0)
)
: ((idx[0] == block0np0 - 1) ? (
   (rc13)*u0_B0(0,0) -
      rc12*u0_B0(-3,0) - 4*u0_B0(-1,0) + (rc11)*u0_B0(-4,0) + 3*u0_B0(-2,0)
)
:
      ((idx[0] == block0np0 - 2) ? (
   (rc15)*u0_B0(0,0) - rc14*u0_B0(-3,0) +
      (rc7)*u0_B0(-2,0) + (rc11)*u0_B0(1,0) - rc16*u0_B0(-1,0)
)
: (

      (rc14)*u0_B0(-2,0) - rc14*u0_B0(2,0) + (rc17)*u0_B0(1,0) -
      rc17*u0_B0(-1,0)
)))));
