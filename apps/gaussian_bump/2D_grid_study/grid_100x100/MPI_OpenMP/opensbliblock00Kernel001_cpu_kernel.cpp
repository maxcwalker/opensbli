...
void ops_par_loop_opensbliblock00Kernel001_execute(ops_kernel_descriptor *desc) {
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
      const ACC<double> D11_B0(xdim0_opensbliblock00Kernel001, D11_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel001*1);
      const ACC<double> D10_B0(xdim1_opensbliblock00Kernel001, D10_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel001*1);
      const ACC<double> rhou0_B0(xdim2_opensbliblock00Kernel001, rhou0_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel001*1);
      const ACC<double> detJ_B0(xdim3_opensbliblock00Kernel001, detJ_B0_p + n_x*1 + n_y * xdim3_opensbliblock00Kernel001*1);
      const ACC<double> rhoE_B0(xdim4_opensbliblock00Kernel001, rhoE_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel001*1);
      ...
      const ACC<double> rho_B0(xdim8_opensbliblock00Kernel001, rho_B0_p + n_x*1 + n_y * xdim8_opensbliblock00Kernel001*1);
   ...
   AVG_1_D10 = (rc7)*(D10_B0(0,1) + D10_B0(0,0));
   ...
   AVG_1_1_LEV_33 = 0.707106781186547*gamma_m1*inv_AVG_a*inv_AVG_rho;
    ...
    max_lambda_1_00 = fmax(fabs(D10_B0(0,2)*u0_B0(0,2) +
      ...
      D11_B0(0,0)*u1_B0(0,0)), fabs(D10_B0(0,3)*u0_B0(0,3) +
