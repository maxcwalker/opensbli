  ...
  const int *idx)
{
   ...
   -3*x0_B0(2,0) + 4*x0_B0(1,0) -
      rc13*x0_B0(0,0) - rc11*x0_B0(4,0) + (rc12)*x0_B0(3,0)
)
: ((idx[0] == 1) ? (

      -rc7*x0_B0(2,0) + (rc16)*x0_B0(1,0) - rc15*x0_B0(0,0) - rc11*x0_B0(-1,0) +
      (rc14)*x0_B0(3,0)
)
: ((idx[0] == block0np0 - 1) ? (
   (rc13)*x0_B0(0,0) +
      3*x0_B0(-2,0) - 4*x0_B0(-1,0) - rc12*x0_B0(-3,0) + (rc11)*x0_B0(-4,0)
)
:
      ((idx[0] == block0np0 - 2) ? (
   (rc11)*x0_B0(1,0) + (rc15)*x0_B0(0,0) -
      rc16*x0_B0(-1,0) + (rc7)*x0_B0(-2,0) - rc14*x0_B0(-3,0)
)
: (

      -rc14*x0_B0(2,0) + (rc14)*x0_B0(-2,0) - rc17*x0_B0(-1,0) +
      (rc17)*x0_B0(1,0)
)))));
