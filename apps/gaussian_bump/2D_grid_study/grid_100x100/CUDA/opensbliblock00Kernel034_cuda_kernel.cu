...
void opensbliblock00Kernel034_gpu(const ACC<double> &wk0_B0,
  ACC<double> &wk6_B0,
  const int *idx)
{
    wk6_B0(0,0) = inv_2*((idx[1] == 0) ? (
   (rc12)*wk0_B0(0,3) - rc13*wk0_B0(0,0) -
      rc11*wk0_B0(0,4) + 4*wk0_B0(0,1) - 3*wk0_B0(0,2)
)
: ((idx[1] == 1) ? (

      (rc14)*wk0_B0(0,3) - rc11*wk0_B0(0,-1) - rc15*wk0_B0(0,0) +
      (rc16)*wk0_B0(0,1) - rc7*wk0_B0(0,2)
)
: (
   -rc17*wk0_B0(0,-1) +
      (rc17)*wk0_B0(0,1) - rc14*wk0_B0(0,2) + (rc14)*wk0_B0(0,-2)
)));
