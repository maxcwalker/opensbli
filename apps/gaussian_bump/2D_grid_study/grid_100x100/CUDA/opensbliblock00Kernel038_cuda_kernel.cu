...
void opensbliblock00Kernel038_gpu(const ACC<double> &u0_B0,
  ...
  const int *idx)
{
    wk10_B0(0,0) = inv_1*((idx[1] == 0) ? (
   (rc37)*u0_B0(0,0) - rc36*u0_B0(0,3) +
      (rc39)*u0_B0(0,2) - rc38*u0_B0(0,1) + (rc34)*u0_B0(0,4)
)
: ((idx[1] == 1) ? (

      -rc21*u0_B0(0,0) + (rc34)*u0_B0(0,-1) - rc14*u0_B0(0,3) +
      (rc26)*u0_B0(0,2) + (rc7)*u0_B0(0,1)
)
: (
   -rc40*u0_B0(0,0) +
      (rc12)*u0_B0(0,-1) - rc14*u0_B0(0,-2) - rc14*u0_B0(0,2) +
      (rc12)*u0_B0(0,1)
)));
