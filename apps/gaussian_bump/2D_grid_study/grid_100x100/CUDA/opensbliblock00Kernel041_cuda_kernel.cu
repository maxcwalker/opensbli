...
void opensbliblock00Kernel041_gpu(const ACC<double> &u0_B0,
  ACC<double> &wk13_B0,
  const int *idx)
{
    wk13_B0(0,0) = inv_2*((idx[1] == 0) ? (
   -rc13*u0_B0(0,0) + (rc12)*u0_B0(0,3) -
      3*u0_B0(0,2) + 4*u0_B0(0,1) - rc11*u0_B0(0,4)
)
: ((idx[1] == 1) ? (

      -rc15*u0_B0(0,0) - rc11*u0_B0(0,-1) + (rc14)*u0_B0(0,3) - rc7*u0_B0(0,2) +
      (rc16)*u0_B0(0,1)
)
: (
