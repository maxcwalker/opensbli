...
ops_arg_dat(wk1_B0, 1, stencil_0_06, "double", OPS_READ),
ops_arg_dat(wk3_B0, 1, stencil_0_00, "double", OPS_WRITE),
ops_arg_idx());
...
ops_NaNcheck(p_B0);
if (iter == 0){
ops_fprintf(f, "Iteration, Time, p_B0(60, 10), p_B0(300, 10), p_B0(480, 10), p_B0(60, 50), p_B0(300, 50), p_B0(480, 50)\n");}
...
ops_fprintf(f, "%d, %.12f, %.12f, %.12f, %.12f, %.12f, %.12f, %.12f\n", iter+1, (iter+1)*dt, p_B0_0_output, p_B0_1_output, p_B0_2_output, p_B0_3_output, p_B0_4_output, p_B0_5_output);
}
