// Auto-generated at 2024-10-10 09:28:40.892704 by ops-translator legacy
...
//  ==============
    ...
    if ((end[0]-start[0])>0 && (end[1]-start[1])>0 && (end[2]-start[2])>0) {
        block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
          ...
          cgh.parallel_for<class monitor_81_rhou2_B0_kernel>(cl::sycl::nd_range<3>(cl::sycl::range<3>(
...
*reduce_81_rhou2_B0 = rhou2_B0(0,0,0);
                ...
                for (int d = 0; d < 1; d++) {
                    ops_reduction_sycl<OPS_INC>(arg1_data_d + d+item.get_group_linear_id()*1, reduce_81_rhou2_B0[d], (double*)&local_mem[0], item, group_size);
                }
            });
        });
    }
