// Auto-generated at 2024-10-10 09:28:39.739218 by ops-translator legacy
...
//  =========
   ...
   x1b0 = ((1.0/20.0))*H_sycl[0]*cl::sycl::exp(-((-(1.0/2.0)*L_sycl[0] + Delta0block0_sycl[0]*idx[0])*(-(1.0/2.0)*L_sycl[0] + Delta0block0_sycl[0]*idx[0]))*inv2a_sycl[0]);
