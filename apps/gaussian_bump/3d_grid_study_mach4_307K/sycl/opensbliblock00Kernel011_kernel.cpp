// Auto-generated at 2024-10-10 09:28:39.855437 by ops-translator legacy
...
//  ==================
#ifndef OPS_LAZY
void ops_par_loop_opensbliblock00Kernel011(
    const char *name,
    ops_block block,
    int dim,
    int* range,
...
//  =====================================================
    ...
    int ydim0_opensbliblock00Kernel011 = args[0].dat->size[1];
    int xdim1_opensbliblock00Kernel011 = args[1].dat->size[0];
    int ydim1_opensbliblock00Kernel011 = args[1].dat->size[1];
    int xdim2_opensbliblock00Kernel011 = args[2].dat->size[0];
    int ydim2_opensbliblock00Kernel011 = args[2].dat->size[1];
    int xdim3_opensbliblock00Kernel011 = args[3].dat->size[0];
    int ydim3_opensbliblock00Kernel011 = args[3].dat->size[1];
    int xdim4_opensbliblock00Kernel011 = args[4].dat->size[0];
    int ydim4_opensbliblock00Kernel011 = args[4].dat->size[1];
...
//  ==============
    ...
    if ((end[0]-start[0])>0 && (end[1]-start[1])>0 && (end[2]-start[2])>0) {
        block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
          ...
          cgh.parallel_for<class opensbliblock00Kernel011_kernel>(cl::sycl::nd_range<3>(cl::sycl::range<3>(
          ...
          , [=](cl::sycl::nd_item<3> item
              ...
              const ACC<double> D00_B0(xdim0_opensbliblock00Kernel011, ydim0_opensbliblock00Kernel011, D00_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel011*1 + n_z * xdim0_opensbliblock00Kernel011 * ydim0_opensbliblock00Kernel011*1);
              const ACC<double> D01_B0(xdim1_opensbliblock00Kernel011, ydim1_opensbliblock00Kernel011, D01_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel011*1 + n_z * xdim1_opensbliblock00Kernel011 * ydim1_opensbliblock00Kernel011*1);
              const ACC<double> u0_B0(xdim2_opensbliblock00Kernel011, ydim2_opensbliblock00Kernel011, u0_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel011*1 + n_z * xdim2_opensbliblock00Kernel011 * ydim2_opensbliblock00Kernel011*1);
              const ACC<double> u1_B0(xdim3_opensbliblock00Kernel011, ydim3_opensbliblock00Kernel011, u1_B0_p + n_x*1 + n_y * xdim3_opensbliblock00Kernel011*1 + n_z * xdim3_opensbliblock00Kernel011 * ydim3_opensbliblock00Kernel011*1);
              ACC<double> U0_B0(xdim4_opensbliblock00Kernel011, ydim4_opensbliblock00Kernel011, U0_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel011*1 + n_z * xdim4_opensbliblock00Kernel011 * ydim4_opensbliblock00Kernel011*1);
//  =========
//  User code
//  =========
