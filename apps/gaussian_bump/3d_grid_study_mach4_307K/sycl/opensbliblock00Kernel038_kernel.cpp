// Auto-generated at 2024-10-10 09:28:40.207935 by ops-translator legacy
...
//  ==================
#ifndef OPS_LAZY
void ops_par_loop_opensbliblock00Kernel038(
    const char *name,
    ops_block block,
    int dim,
    int* range,
...
//  ==============
    ...
    if (block->instance->OPS_diags > 1) {
        ...
        block->instance->OPS_kernels[28].mpi_time += __t2 - __t1;
    }
    ...
    if ((end[0]-start[0])>0 && (end[1]-start[1])>0 && (end[2]-start[2])>0) {
        block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
          ...
          cgh.parallel_for<class opensbliblock00Kernel038_kernel>(cl::sycl::nd_range<3>(cl::sycl::range<3>(
...
//  =========
   ...
   if (idx[0] == 0){
       ...
       wk3_B0(0,0,0) = (-3*T_B0(2,0,0) + 4*T_B0(1,0,0) - (25.0/12.0)*T_B0(0,0,0) - (1.0/4.0)*T_B0(4,0,0) +
            ((4.0/3.0))*T_B0(3,0,0))*invDelta0block0_sycl[0];
       ...
       wk3_B0(0,0,0) = (-(5.0/6.0)*T_B0(0,0,0) - (1.0/2.0)*T_B0(2,0,0) - (1.0/4.0)*T_B0(-1,0,0) +
            ((1.0/12.0))*T_B0(3,0,0) + ((3.0/2.0))*T_B0(1,0,0))*invDelta0block0_sycl[0];
       ...
       wk3_B0(0,0,0) = (-4*T_B0(-1,0,0) + 3*T_B0(-2,0,0) - (4.0/3.0)*T_B0(-3,0,0) + ((1.0/4.0))*T_B0(-4,0,0) +
            ((25.0/12.0))*T_B0(0,0,0))*invDelta0block0_sycl[0];
       ...
       wk3_B0(0,0,0) = (((1.0/2.0))*T_B0(-2,0,0) - (3.0/2.0)*T_B0(-1,0,0) - (1.0/12.0)*T_B0(-3,0,0) +
            ((1.0/4.0))*T_B0(1,0,0) + ((5.0/6.0))*T_B0(0,0,0))*invDelta0block0_sycl[0];
       ...
       wk3_B0(0,0,0) = (-(2.0/3.0)*T_B0(-1,0,0) - (1.0/12.0)*T_B0(2,0,0) + ((1.0/12.0))*T_B0(-2,0,0) +
            ((2.0/3.0))*T_B0(1,0,0))*invDelta0block0_sycl[0];
    ...
    if (block->instance->OPS_diags > 1) {
        ...
        ops_timers_core(&__c1, &__t1);
        block->instance->OPS_kernels[28].time += __t1 -__t2;
    }
  ...
  )
{
    ...
    create_kerneldesc_and_enque("opensbliblock00Kernel038", args, 3, 28, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel038_execute);
}
#endif
