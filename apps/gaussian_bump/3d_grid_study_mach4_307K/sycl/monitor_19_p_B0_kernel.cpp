// Auto-generated at 2024-10-10 09:28:40.500310 by ops-translator legacy
...
//  ==================
#ifndef OPS_LAZY
void ops_par_loop_monitor_19_p_B0(
    const char *name,
    ops_block block,
    int dim,
    int* range,
...
#ifdef OPS_DEBUG
    ops_register_args(block->instance, args, "monitor_19_p_B0");
#endif
...
//  =====================================================
    int xdim0_monitor_19_p_B0 = args[0].dat->size[0];
    int ydim0_monitor_19_p_B0 = args[0].dat->size[1];
...
//  ==============
    ...
    if ((end[0]-start[0])>0 && (end[1]-start[1])>0 && (end[2]-start[2])>0) {
        block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
          ...
          cgh.parallel_for<class monitor_19_p_B0_kernel>(cl::sycl::nd_range<3>(cl::sycl::range<3>(
          ...
          , [=](cl::sycl::nd_item<3> item
              ...
              const ACC<double> p_B0(xdim0_monitor_19_p_B0, ydim0_monitor_19_p_B0, p_B0_p + n_x*1 + n_y * xdim0_monitor_19_p_B0*1 + n_z * xdim0_monitor_19_p_B0 * ydim0_monitor_19_p_B0*1);
              double reduce_19_p_B0[1];
              reduce_19_p_B0[0] = ZERO_double;
//  =========
//  User code
//  =========
...
*reduce_19_p_B0 = p_B0(0,0,0);
                ...
                for (int d = 0; d < 1; d++) {
                    ops_reduction_sycl<OPS_INC>(arg1_data_d + d+item.get_group_linear_id()*1, reduce_19_p_B0[d], (double*)&local_mem[0], item, group_size);
                }
            });
        });
    }
