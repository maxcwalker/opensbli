// Auto-generated at 2024-10-10 09:28:39.869309 by ops-translator legacy
...
//  =======================================================
    ...
    double * __restrict__ U2_B0_p = (double *)(args[1].data_d + base1);
...
//  ==============
    ...
    if ((end[0]-start[0])>0 && (end[1]-start[1])>0 && (end[2]-start[2])>0) {
        block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
          ...
          cgh.parallel_for<class opensbliblock00Kernel020_kernel>(cl::sycl::nd_range<3>(cl::sycl::range<3>(
