// Auto-generated at 2024-10-10 09:28:36.178790 by ops-translator legacy
...
//  User function
//  =============
__device__ void opensbliblock00Kernel070_gpu(const ACC<double> &x0_B0,
...
//  =================================================
...
#else
    if (compute_ranges(args, 12, block, range, start_indx, end_indx, arg_idx) < 0) return;
#endif
    ...
    if (xdim0 != dims_opensbliblock00Kernel070_h[0][0] || ydim0 != dims_opensbliblock00Kernel070_h[0][1] || xdim1 != dims_opensbliblock00Kernel070_h[1][0] || ydim1 != dims_opensbliblock00Kernel070_h[1][1] || xdim2 != dims_opensbliblock00Kernel070_h[2][0] || ydim2 != dims_opensbliblock00Kernel070_h[2][1] || xdim3 != dims_opensbliblock00Kernel070_h[3][0] || ydim3 != dims_opensbliblock00Kernel070_h[3][1] || xdim4 != dims_opensbliblock00Kernel070_h[4][0] || ydim4 != dims_opensbliblock00Kernel070_h[4][1] || xdim5 != dims_opensbliblock00Kernel070_h[5][0] || ydim5 != dims_opensbliblock00Kernel070_h[5][1] || xdim6 != dims_opensbliblock00Kernel070_h[6][0] || ydim6 != dims_opensbliblock00Kernel070_h[6][1] || xdim7 != dims_opensbliblock00Kernel070_h[7][0] || ydim7 != dims_opensbliblock00Kernel070_h[7][1] || xdim8 != dims_opensbliblock00Kernel070_h[8][0] || ydim8 != dims_opensbliblock00Kernel070_h[8][1] || xdim9 != dims_opensbliblock00Kernel070_h[9][0] || ydim9 != dims_opensbliblock00Kernel070_h[9][1] || xdim10 != dims_opensbliblock00Kernel070_h[10][0] || ydim10 != dims_opensbliblock00Kernel070_h[10][1]) {
        ...
        cutilSafeCall(block->instance->ostream(), cudaMemcpyToSymbol( dims_opensbliblock00Kernel070, dims_opensbliblock00Kernel070_h, sizeof(dims_opensbliblock00Kernel070)));
    }
...
//call kernel wrapper function, passing in pointers to data
    ...
    if (block->instance->OPS_diags > 1) {
        ...
        block->instance->OPS_kernels[1].transfer += ops_compute_transfer(dim, start_indx, end_indx, &arg1);
        block->instance->OPS_kernels[1].transfer += ops_compute_transfer(dim, start_indx, end_indx, &arg2);
        block->instance->OPS_kernels[1].transfer += ops_compute_transfer(dim, start_indx, end_indx, &arg3);
        ...
        block->instance->OPS_kernels[1].transfer += ops_compute_transfer(dim, start_indx, end_indx, &arg7);
        block->instance->OPS_kernels[1].transfer += ops_compute_transfer(dim, start_indx, end_indx, &arg8);
        block->instance->OPS_kernels[1].transfer += ops_compute_transfer(dim, start_indx, end_indx, &arg9);
        block->instance->OPS_kernels[1].transfer += ops_compute_transfer(dim, start_indx, end_indx, &arg10);
    }
}
