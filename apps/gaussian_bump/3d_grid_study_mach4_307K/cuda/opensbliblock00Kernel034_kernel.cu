// Auto-generated at 2024-10-10 09:28:36.353945 by ops-translator legacy

__constant__ int dims_opensbliblock00Kernel034 [3][2];
static int dims_opensbliblock00Kernel034_h [3][2] = {{0}};

//  =============
//  User function
//  =============
__device__ void opensbliblock00Kernel034_gpu(const ACC<double> &u1_B0,
  ACC<double> &wk1_B0,
  const int *idx)
{
   if (idx[0] == 0){
...
//call kernel wrapper function, passing in pointers to data
    ...
    if (block->instance->OPS_diags > 1) {
        ...
        ops_timers_core(&__c2, &__t2);
        block->instance->OPS_kernels[26].mpi_time += __t2 - __t1;
        block->instance->OPS_kernels[26].transfer += ops_compute_transfer(dim, start_indx, end_indx, &arg0);
        block->instance->OPS_kernels[26].transfer += ops_compute_transfer(dim, start_indx, end_indx, &arg1);
    }
}
