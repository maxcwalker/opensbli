// Auto-generated at 2024-10-10 09:28:36.402097 by ops-translator legacy

__constant__ int dims_opensbliblock00Kernel041 [3][2];
static int dims_opensbliblock00Kernel041_h [3][2] = {{0}};

//  =============
//  User function
//  =============
__device__ void opensbliblock00Kernel041_gpu(const ACC<double> &u1_B0,
  ACC<double> &wk5_B0,
  const int *idx)
{
   if (idx[1] == 0){
...
int size2) {
    ...
    arg0 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel041[0][0] + idx_z * 1*1 * dims_opensbliblock00Kernel041[0][0] * dims_opensbliblock00Kernel041[0][1];
    arg1 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel041[1][0] + idx_z * 1*1 * dims_opensbliblock00Kernel041[1][0] * dims_opensbliblock00Kernel041[1][1];

    if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
        const ACC<double> argp0(dims_opensbliblock00Kernel041[0][0], dims_opensbliblock00Kernel041[0][1], arg0);
        ACC<double> argp1(dims_opensbliblock00Kernel041[1][0], dims_opensbliblock00Kernel041[1][1], arg1);
...
//  =================================================
    ...
    if (xdim0 != dims_opensbliblock00Kernel041_h[0][0] || ydim0 != dims_opensbliblock00Kernel041_h[0][1] || xdim1 != dims_opensbliblock00Kernel041_h[1][0] || ydim1 != dims_opensbliblock00Kernel041_h[1][1]) {
        dims_opensbliblock00Kernel041_h[0][0] = xdim0;
        dims_opensbliblock00Kernel041_h[0][1] = ydim0;
        dims_opensbliblock00Kernel041_h[1][0] = xdim1;
        dims_opensbliblock00Kernel041_h[1][1] = ydim1;

        cutilSafeCall(block->instance->ostream(), cudaMemcpyToSymbol( dims_opensbliblock00Kernel041, dims_opensbliblock00Kernel041_h, sizeof(dims_opensbliblock00Kernel041)));
    }
...
//call kernel wrapper function, passing in pointers to data
    ...
    if (block->instance->OPS_diags > 1) {
        ...
        ops_timers_core(&__c2, &__t2);
        block->instance->OPS_kernels[30].mpi_time += __t2 - __t1;
        block->instance->OPS_kernels[30].transfer += ops_compute_transfer(dim, start_indx, end_indx, &arg0);
        block->instance->OPS_kernels[30].transfer += ops_compute_transfer(dim, start_indx, end_indx, &arg1);
    }
}
 ...
 ops_arg arg0, ops_arg arg1, ops_arg arg2)
{
    ...
    create_kerneldesc_and_enque("opensbliblock00Kernel041", args, 3, 30, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel041_execute);
}
#endif
