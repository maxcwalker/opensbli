// Auto-generated at 2024-10-10 09:28:37.026147 by ops-translator legacy

__constant__ int dims_monitor_94_rhou2_B0 [2][2];
static int dims_monitor_94_rhou2_B0_h [2][2] = {{0}};

//  =============
//  User function
//  =============
__device__ void monitor_94_rhou2_B0_gpu(const ACC<double> &rhou2_B0,
  double *reduce_94_rhou2_B0){
...
//  ============================
__global__ void ops_monitor_94_rhou2_B0(
...
int size2) {
    ...
    arg0 += idx_x * 1*1 + idx_y * 1*1 * dims_monitor_94_rhou2_B0[0][0] + idx_z * 1*1 * dims_monitor_94_rhou2_B0[0][0] * dims_monitor_94_rhou2_B0[0][1];

    if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
        const ACC<double> argp0(dims_monitor_94_rhou2_B0[0][0], dims_monitor_94_rhou2_B0[0][1], arg0);
        monitor_94_rhou2_B0_gpu(
         argp0, arg1_l);
    }
...
#else
void ops_par_loop_monitor_94_rhou2_B0_execute(ops_kernel_descriptor *desc) {
...
//  =================================================
    ...
    if (xdim0 != dims_monitor_94_rhou2_B0_h[0][0] || ydim0 != dims_monitor_94_rhou2_B0_h[0][1]) {
        dims_monitor_94_rhou2_B0_h[0][0] = xdim0;
        dims_monitor_94_rhou2_B0_h[0][1] = ydim0;

        cutilSafeCall(block->instance->ostream(), cudaMemcpyToSymbol( dims_monitor_94_rhou2_B0, dims_monitor_94_rhou2_B0_h, sizeof(dims_monitor_94_rhou2_B0)));
    }
...
//  =============
    ...
    if (block->instance->OPS_diags > 1) {
        ...
        block->instance->OPS_kernels[134].mpi_time += __t2 - __t1;
    }
...
//call kernel wrapper function, passing in pointers to data
    if (x_size > 0 && y_size > 0 && z_size > 0) {
        ...
        ops_monitor_94_rhou2_B0<<<grid, tblock, nshared >>> ( 
    ...
    if (block->instance->OPS_diags>1) {
        ...
        ops_timers_core(&__c1, &__t1);
        block->instance->OPS_kernels[134].time += __t1 - __t2;
    }
    ...
    if (block->instance->OPS_diags > 1) {
        ...
        ops_timers_core(&__c2, &__t2);
        block->instance->OPS_kernels[134].mpi_time += __t2 - __t1;
        block->instance->OPS_kernels[134].transfer += ops_compute_transfer(dim, start_indx, end_indx, &arg0);
    }
}
 ...
 ops_arg arg0, ops_arg arg1)
{
    ...
    create_kerneldesc_and_enque("monitor_94_rhou2_B0", args, 2, 134, dim, 1, range, block, ops_par_loop_monitor_94_rhou2_B0_execute);
}
#endif
