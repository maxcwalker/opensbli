// Auto-generated at 2024-10-10 09:28:36.687086 by ops-translator legacy
...
//  User function
//  =============
__device__ void monitor_39_rhou0_B0_gpu(const ACC<double> &rhou0_B0,
...
//  =================================================
    ...
    if (xdim0 != dims_monitor_39_rhou0_B0_h[0][0] || ydim0 != dims_monitor_39_rhou0_B0_h[0][1]) {
        ...
        cutilSafeCall(block->instance->ostream(), cudaMemcpyToSymbol( dims_monitor_39_rhou0_B0, dims_monitor_39_rhou0_B0_h, sizeof(dims_monitor_39_rhou0_B0)));
    }
...
//call kernel wrapper function, passing in pointers to data
    ...
    if (block->instance->OPS_diags > 1) {
        ...
        ops_timers_core(&__c2, &__t2);
        block->instance->OPS_kernels[79].mpi_time += __t2 - __t1;
        block->instance->OPS_kernels[79].transfer += ops_compute_transfer(dim, start_indx, end_indx, &arg0);
    }
}
