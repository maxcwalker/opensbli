// Auto-generated at 2024-10-10 09:28:34.257181 by ops-translator legacy
...
//  =======================================================
    ...
    double * __restrict__ wk10_B0_p = (double *)(args[2].data + base2);

    int base3 = args[3].dat->base_offset;
    double * __restrict__ wk11_B0_p = (double *)(args[3].data + base3);

    int base4 = args[4].dat->base_offset;
    double * __restrict__ wk12_B0_p = (double *)(args[4].data + base4);

    int base5 = args[5].dat->base_offset;
    double * __restrict__ wk13_B0_p = (double *)(args[5].data + base5);

    int base6 = args[6].dat->base_offset;
    double * __restrict__ wk14_B0_p = (double *)(args[6].data + base6);
    ...
    double * __restrict__ Residual4_B0_p = (double *)(args[20].data + base20);
...
)
{
    ...
    create_kerneldesc_and_enque("opensbliblock00Kernel021", args, 21, 24, dim, 0, range, block, ops_par_loop_opensbliblock00Kernel021_execute);
}
#endif
