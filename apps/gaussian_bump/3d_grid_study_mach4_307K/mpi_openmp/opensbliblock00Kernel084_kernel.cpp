// Auto-generated at 2024-10-10 09:28:34.339474 by ops-translator legacy
...
//  =======================================================
    ...
    double * __restrict__ rho_RKold_B0_p = (double *)(args[8].data + base8);

    int base9 = args[9].dat->base_offset;
    double * __restrict__ rhou0_B0_p = (double *)(args[9].data + base9);

    int base10 = args[10].dat->base_offset;
    double * __restrict__ rhou0_RKold_B0_p = (double *)(args[10].data + base10);

    int base11 = args[11].dat->base_offset;
    double * __restrict__ rhou1_B0_p = (double *)(args[11].data + base11);

    int base12 = args[12].dat->base_offset;
    double * __restrict__ rhou1_RKold_B0_p = (double *)(args[12].data + base12);

    int base13 = args[13].dat->base_offset;
    double * __restrict__ rhou2_B0_p = (double *)(args[13].data + base13);

    int base14 = args[14].dat->base_offset;
    double * __restrict__ rhou2_RKold_B0_p = (double *)(args[14].data + base14);

    double * __restrict__ rkA = (double *)args[15].data;

    double * __restrict__ rkB = (double *)args[16].data;
...
)
{
    ...
    create_kerneldesc_and_enque("opensbliblock00Kernel084", args, 17, 38, dim, 0, range, block, ops_par_loop_opensbliblock00Kernel084_execute);
}
#endif
