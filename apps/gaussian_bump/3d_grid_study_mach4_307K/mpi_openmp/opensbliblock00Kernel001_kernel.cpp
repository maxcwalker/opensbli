// Auto-generated at 2024-10-10 09:28:34.239204 by ops-translator legacy
...
//  =======================================================
    ...
    double * __restrict__ wk6_B0_p = (double *)(args[15].data + base15);

    int base16 = args[16].dat->base_offset;
    double * __restrict__ wk7_B0_p = (double *)(args[16].data + base16);

    int base17 = args[17].dat->base_offset;
    double * __restrict__ wk8_B0_p = (double *)(args[17].data + base17);

    int base18 = args[18].dat->base_offset;
    double * __restrict__ wk9_B0_p = (double *)(args[18].data + base18);
...
)
{
    ...
    create_kerneldesc_and_enque("opensbliblock00Kernel001", args, 19, 22, dim, 0, range, block, ops_par_loop_opensbliblock00Kernel001_execute);
}
#endif
