// Auto-generated at 2024-10-10 09:28:38.710796 by ops-translator legacy
    ...
    static bool isbuilt_opensbliblock00Kernel047 = false;

    void buildOpenCLKernels_opensbliblock00Kernel047(OPS_instance *instance, int xdim0, int ydim0, int xdim1, int ydim1) {

      //int ocl_fma = OCL_FMA;
      if(!isbuilt_opensbliblock00Kernel047) {
        buildOpenCLKernels(instance);
        //clSafeCall( clUnloadCompiler() );
        cl_int ret;
        char* source_filename[1] = {(char*)"./opencl/opensbliblock00Kernel047.cl"};
        ...
        instance->ostream() <<"Compiling opensbliblock00Kernel047 "<<OCL_FMA<<" source -- start \n";
          ...
          if (pPath!=NULL)
            if(OCL_FMA)
              sprintf(buildOpts,"-cl-mad-enable -DOCL_FMA -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_opensbliblock00Kernel047=%d  -Dydim0_opensbliblock00Kernel047=%d  -Dxdim1_opensbliblock00Kernel047=%d  -Dydim1_opensbliblock00Kernel047=%d ", pPath, 32,xdim0,ydim0,xdim1,ydim1);
            else
              sprintf(buildOpts,"-cl-mad-enable -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_opensbliblock00Kernel047=%d  -Dydim0_opensbliblock00Kernel047=%d  -Dxdim1_opensbliblock00Kernel047=%d  -Dydim1_opensbliblock00Kernel047=%d ", pPath, 32,xdim0,ydim0,xdim1,ydim1);
          else {
          ...
          instance->ostream() << "compiling opensbliblock00Kernel047 -- done\n";

        // Create the OpenCL kernel
        instance->opencl_instance->OPS_opencl_core.kernel[36] = clCreateKernel(instance->opencl_instance->OPS_opencl_core.program, "ops_opensbliblock00Kernel047", &ret);
        clSafeCall( ret );

        isbuilt_opensbliblock00Kernel047 = true;
        free(source_str[0]);
      }
...
void ops_par_loop_opensbliblock00Kernel047(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1) {
  ...
  buildOpenCLKernels_opensbliblock00Kernel047(block->instance,
  ...
  if (globalWorkSize[0]>0 && globalWorkSize[1]>0 && globalWorkSize[2]>0) {
      ...
      clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[36], 0, sizeof(cl_mem), (void*) &arg0.data_d ));
      clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[36], 1, sizeof(cl_mem), (void*) &arg1.data_d ));
      clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[36], 2, sizeof(cl_double), (void*) &invDelta2block0 ));
      clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[36], 3, sizeof(cl_int), (void*) &base0 ));
      clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[36], 4, sizeof(cl_int), (void*) &base1 ));
      clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[36], 5, sizeof(cl_int), (void*) &x_size ));
      clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[36], 6, sizeof(cl_int), (void*) &y_size ));
      clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[36], 7, sizeof(cl_int), (void*) &z_size ));

      //call/enqueue opencl kernel wrapper function
      clSafeCall( clEnqueueNDRangeKernel(block->instance->opencl_instance->OPS_opencl_core.command_queue, block->instance->opencl_instance->OPS_opencl_core.kernel[36], 3, NULL, globalWorkSize, localWorkSize, 0, NULL, NULL) );
  }
  if (block->instance->OPS_diags>1) {
