// Auto-generated at 2024-10-10 09:28:38.165311 by ops-translator legacy
    ...
    static bool isbuilt_opensbliblock00Kernel072 = false;

    void buildOpenCLKernels_opensbliblock00Kernel072(OPS_instance *instance, int xdim0, int ydim0, int xdim1, int ydim1, int xdim2, int ydim2, int xdim3, int ydim3, int xdim4, int ydim4) {

      //int ocl_fma = OCL_FMA;
      if(!isbuilt_opensbliblock00Kernel072) {
        buildOpenCLKernels(instance);
        //clSafeCall( clUnloadCompiler() );
        cl_int ret;
        char* source_filename[1] = {(char*)"./opencl/opensbliblock00Kernel072.cl"};
        ...
        instance->ostream() <<"Compiling opensbliblock00Kernel072 "<<OCL_FMA<<" source -- start \n";
          ...
          if (pPath!=NULL)
            if(OCL_FMA)
              sprintf(buildOpts,"-cl-mad-enable -DOCL_FMA -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_opensbliblock00Kernel072=%d  -Dydim0_opensbliblock00Kernel072=%d  -Dxdim1_opensbliblock00Kernel072=%d  -Dydim1_opensbliblock00Kernel072=%d  -Dxdim2_opensbliblock00Kernel072=%d  -Dydim2_opensbliblock00Kernel072=%d  -Dxdim3_opensbliblock00Kernel072=%d  -Dydim3_opensbliblock00Kernel072=%d  -Dxdim4_opensbliblock00Kernel072=%d  -Dydim4_opensbliblock00Kernel072=%d ", pPath, 32,xdim0,ydim0,xdim1,ydim1,xdim2,ydim2,xdim3,ydim3,xdim4,ydim4);
            else
          ...
          instance->ostream() << "compiling opensbliblock00Kernel072 -- done\n";

        // Create the OpenCL kernel
        instance->opencl_instance->OPS_opencl_core.kernel[3] = clCreateKernel(instance->opencl_instance->OPS_opencl_core.program, "ops_opensbliblock00Kernel072", &ret);
        clSafeCall( ret );

        isbuilt_opensbliblock00Kernel072 = true;
        free(source_str[0]);
      }
...
void ops_par_loop_opensbliblock00Kernel072(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4) {
  ...
  buildOpenCLKernels_opensbliblock00Kernel072(block->instance,
  ...
  if (globalWorkSize[0]>0 && globalWorkSize[1]>0 && globalWorkSize[2]>0) {
      ...
      clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[3], 1, sizeof(cl_mem), (void*) &arg1.data_d ));
      clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[3], 2, sizeof(cl_mem), (void*) &arg2.data_d ));
      clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[3], 3, sizeof(cl_mem), (void*) &arg3.data_d ));
      clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[3], 4, sizeof(cl_mem), (void*) &arg4.data_d ));
      clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[3], 5, sizeof(cl_int), (void*) &base0 ));
      clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[3], 6, sizeof(cl_int), (void*) &base1 ));
      clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[3], 7, sizeof(cl_int), (void*) &base2 ));
      clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[3], 8, sizeof(cl_int), (void*) &base3 ));
      clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[3], 9, sizeof(cl_int), (void*) &base4 ));
      clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[3], 10, sizeof(cl_int), (void*) &x_size ));
      clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[3], 11, sizeof(cl_int), (void*) &y_size ));
      clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[3], 12, sizeof(cl_int), (void*) &z_size ));
