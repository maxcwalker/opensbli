// Auto-generated at 2024-10-10 09:28:38.158329 by ops-translator legacy
    ...
    static bool isbuilt_opensbliblock00Kernel071 = false;

    void buildOpenCLKernels_opensbliblock00Kernel071(OPS_instance *instance, int xdim0, int ydim0, int xdim1, int ydim1, int xdim2, int ydim2, int xdim3, int ydim3, int xdim4, int ydim4) {

      //int ocl_fma = OCL_FMA;
      if(!isbuilt_opensbliblock00Kernel071) {
        buildOpenCLKernels(instance);
        //clSafeCall( clUnloadCompiler() );
        cl_int ret;
        char* source_filename[1] = {(char*)"./opencl/opensbliblock00Kernel071.cl"};
        ...
        instance->ostream() <<"Compiling opensbliblock00Kernel071 "<<OCL_FMA<<" source -- start \n";
          ...
          if (pPath!=NULL)
            if(OCL_FMA)
              sprintf(buildOpts,"-cl-mad-enable -DOCL_FMA -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_opensbliblock00Kernel071=%d  -Dydim0_opensbliblock00Kernel071=%d  -Dxdim1_opensbliblock00Kernel071=%d  -Dydim1_opensbliblock00Kernel071=%d  -Dxdim2_opensbliblock00Kernel071=%d  -Dydim2_opensbliblock00Kernel071=%d  -Dxdim3_opensbliblock00Kernel071=%d  -Dydim3_opensbliblock00Kernel071=%d  -Dxdim4_opensbliblock00Kernel071=%d  -Dydim4_opensbliblock00Kernel071=%d ", pPath, 32,xdim0,ydim0,xdim1,ydim1,xdim2,ydim2,xdim3,ydim3,xdim4,ydim4);
            else
          ...
          instance->ostream() << "compiling opensbliblock00Kernel071 -- done\n";

        // Create the OpenCL kernel
        instance->opencl_instance->OPS_opencl_core.kernel[2] = clCreateKernel(instance->opencl_instance->OPS_opencl_core.program, "ops_opensbliblock00Kernel071", &ret);
        clSafeCall( ret );

        isbuilt_opensbliblock00Kernel071 = true;
        free(source_str[0]);
      }
...
void ops_par_loop_opensbliblock00Kernel071(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4) {
  ...
  buildOpenCLKernels_opensbliblock00Kernel071(block->instance,
