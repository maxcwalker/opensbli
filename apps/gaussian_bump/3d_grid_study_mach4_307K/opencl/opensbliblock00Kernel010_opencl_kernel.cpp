// Auto-generated at 2024-10-10 09:28:38.274770 by ops-translator legacy
    ...
    static bool isbuilt_opensbliblock00Kernel010 = false;

    void buildOpenCLKernels_opensbliblock00Kernel010(OPS_instance *instance, int xdim0, int ydim0, int xdim1, int ydim1, int xdim2, int ydim2) {

      //int ocl_fma = OCL_FMA;
      if(!isbuilt_opensbliblock00Kernel010) {
        buildOpenCLKernels(instance);
        //clSafeCall( clUnloadCompiler() );
        cl_int ret;
        char* source_filename[1] = {(char*)"./opencl/opensbliblock00Kernel010.cl"};
        ...
        instance->ostream() <<"Compiling opensbliblock00Kernel010 "<<OCL_FMA<<" source -- start \n";
          ...
          if (pPath!=NULL)
            if(OCL_FMA)
              sprintf(buildOpts,"-cl-mad-enable -DOCL_FMA -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_opensbliblock00Kernel010=%d  -Dydim0_opensbliblock00Kernel010=%d  -Dxdim1_opensbliblock00Kernel010=%d  -Dydim1_opensbliblock00Kernel010=%d  -Dxdim2_opensbliblock00Kernel010=%d  -Dydim2_opensbliblock00Kernel010=%d ", pPath, 32,xdim0,ydim0,xdim1,ydim1,xdim2,ydim2);
            else
          ...
          instance->ostream() << "compiling opensbliblock00Kernel010 -- done\n";

        // Create the OpenCL kernel
        instance->opencl_instance->OPS_opencl_core.kernel[18] = clCreateKernel(instance->opencl_instance->OPS_opencl_core.program, "ops_opensbliblock00Kernel010", &ret);
        clSafeCall( ret );

        isbuilt_opensbliblock00Kernel010 = true;
        free(source_str[0]);
      }
...
void ops_par_loop_opensbliblock00Kernel010(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  if (block->instance->OPS_diags > 1) {
      ops_timing_realloc(block->instance,18,"opensbliblock00Kernel010");
  ...
  buildOpenCLKernels_opensbliblock00Kernel010(block->instance,
  ...
  if (globalWorkSize[0]>0 && globalWorkSize[1]>0 && globalWorkSize[2]>0) {
      ...
      clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[18], 0, sizeof(cl_mem), (void*) &arg0.data_d ));
      clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[18], 1, sizeof(cl_mem), (void*) &arg1.data_d ));
      clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[18], 2, sizeof(cl_mem), (void*) &arg2.data_d ));
      clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[18], 3, sizeof(cl_double), (void*) &gama ));
      clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[18], 4, sizeof(cl_int), (void*) &base0 ));
      clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[18], 5, sizeof(cl_int), (void*) &base1 ));
      clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[18], 6, sizeof(cl_int), (void*) &base2 ));
      clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[18], 7, sizeof(cl_int), (void*) &x_size ));
      clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[18], 8, sizeof(cl_int), (void*) &y_size ));
      clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[18], 9, sizeof(cl_int), (void*) &z_size ));

      //call/enqueue opencl kernel wrapper function
      clSafeCall( clEnqueueNDRangeKernel(block->instance->opencl_instance->OPS_opencl_core.command_queue, block->instance->opencl_instance->OPS_opencl_core.kernel[18], 3, NULL, globalWorkSize, localWorkSize, 0, NULL, NULL) );
  }
  if (block->instance->OPS_diags>1) {
