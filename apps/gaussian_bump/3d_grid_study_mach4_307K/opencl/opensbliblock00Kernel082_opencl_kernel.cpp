// Auto-generated at 2024-10-10 09:28:38.830166 by ops-translator legacy
    ...
    static bool isbuilt_opensbliblock00Kernel082 = false;

    void buildOpenCLKernels_opensbliblock00Kernel082(OPS_instance *instance, int xdim0, int ydim0, int xdim1, int ydim1, int xdim2, int ydim2, int xdim3, int ydim3, int xdim4, int ydim4, int xdim5, int ydim5, int xdim6, int ydim6, int xdim7, int ydim7, int xdim8, int ydim8, int xdim9, int ydim9, int xdim10, int ydim10, int xdim11, int ydim11, int xdim12, int ydim12, int xdim13, int ydim13, int xdim14, int ydim14, int xdim15, int ydim15) {

      //int ocl_fma = OCL_FMA;
      if(!isbuilt_opensbliblock00Kernel082) {
        buildOpenCLKernels(instance);
        //clSafeCall( clUnloadCompiler() );
        cl_int ret;
        char* source_filename[1] = {(char*)"./opencl/opensbliblock00Kernel082.cl"};
        ...
        instance->ostream() <<"Compiling opensbliblock00Kernel082 "<<OCL_FMA<<" source -- start \n";
          ...
          // Build the program
          char buildOpts[512*16];
          char* pPath = NULL;
          pPath = getenv ("OPS_INSTALL_PATH");
          if (pPath!=NULL)
            if(OCL_FMA)
              sprintf(buildOpts,"-cl-mad-enable -DOCL_FMA -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_opensbliblock00Kernel082=%d  -Dydim0_opensbliblock00Kernel082=%d  -Dxdim1_opensbliblock00Kernel082=%d  -Dydim1_opensbliblock00Kernel082=%d  -Dxdim2_opensbliblock00Kernel082=%d  -Dydim2_opensbliblock00Kernel082=%d  -Dxdim3_opensbliblock00Kernel082=%d  -Dydim3_opensbliblock00Kernel082=%d  -Dxdim4_opensbliblock00Kernel082=%d  -Dydim4_opensbliblock00Kernel082=%d  -Dxdim5_opensbliblock00Kernel082=%d  -Dydim5_opensbliblock00Kernel082=%d  -Dxdim6_opensbliblock00Kernel082=%d  -Dydim6_opensbliblock00Kernel082=%d  -Dxdim7_opensbliblock00Kernel082=%d  -Dydim7_opensbliblock00Kernel082=%d  -Dxdim8_opensbliblock00Kernel082=%d  -Dydim8_opensbliblock00Kernel082=%d  -Dxdim9_opensbliblock00Kernel082=%d  -Dydim9_opensbliblock00Kernel082=%d  -Dxdim10_opensbliblock00Kernel082=%d  -Dydim10_opensbliblock00Kernel082=%d  -Dxdim11_opensbliblock00Kernel082=%d  -Dydim11_opensbliblock00Kernel082=%d  -Dxdim12_opensbliblock00Kernel082=%d  -Dydim12_opensbliblock00Kernel082=%d  -Dxdim13_opensbliblock00Kernel082=%d  -Dydim13_opensbliblock00Kernel082=%d  -Dxdim14_opensbliblock00Kernel082=%d  -Dydim14_opensbliblock00Kernel082=%d  -Dxdim15_opensbliblock00Kernel082=%d  -Dydim15_opensbliblock00Kernel082=%d ", pPath, 32,xdim0,ydim0,xdim1,ydim1,xdim2,ydim2,xdim3,ydim3,xdim4,ydim4,xdim5,ydim5,xdim6,ydim6,xdim7,ydim7,xdim8,ydim8,xdim9,ydim9,xdim10,ydim10,xdim11,ydim11,xdim12,ydim12,xdim13,ydim13,xdim14,ydim14,xdim15,ydim15);
            else
          ...
          instance->ostream() << "compiling opensbliblock00Kernel082 -- done\n";

        // Create the OpenCL kernel
        instance->opencl_instance->OPS_opencl_core.kernel[39] = clCreateKernel(instance->opencl_instance->OPS_opencl_core.program, "ops_opensbliblock00Kernel082", &ret);
        clSafeCall( ret );

        isbuilt_opensbliblock00Kernel082 = true;
        free(source_str[0]);
      }
...
void ops_par_loop_opensbliblock00Kernel082(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg12, ops_arg arg13, ops_arg arg14, ops_arg arg15) {
  ...
  buildOpenCLKernels_opensbliblock00Kernel082(block->instance,
  xdim0,ydim0,xdim1,ydim1,xdim2,ydim2,xdim3,ydim3,xdim4,ydim4,xdim5,ydim5,xdim6,ydim6,xdim7,ydim7,xdim8,ydim8,xdim9,ydim9,xdim10,ydim10,xdim11,ydim11,xdim12,ydim12,xdim13,ydim13,xdim14,ydim14,xdim15,ydim15);
  ...
  if (globalWorkSize[0]>0 && globalWorkSize[1]>0 && globalWorkSize[2]>0) {
      ...
      clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[39], 2, sizeof(cl_mem), (void*) &arg2.data_d ));
      clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[39], 3, sizeof(cl_mem), (void*) &arg3.data_d ));
      clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[39], 4, sizeof(cl_mem), (void*) &arg4.data_d ));
      clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[39], 5, sizeof(cl_mem), (void*) &arg5.data_d ));
      clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[39], 6, sizeof(cl_mem), (void*) &arg6.data_d ));
      clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[39], 7, sizeof(cl_mem), (void*) &arg7.data_d ));
      clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[39], 8, sizeof(cl_mem), (void*) &arg8.data_d ));
      clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[39], 9, sizeof(cl_mem), (void*) &arg9.data_d ));
      clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[39], 10, sizeof(cl_mem), (void*) &arg10.data_d ));
      clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[39], 11, sizeof(cl_mem), (void*) &arg11.data_d ));
      clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[39], 12, sizeof(cl_mem), (void*) &arg12.data_d ));
      clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[39], 13, sizeof(cl_mem), (void*) &arg13.data_d ));
      clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[39], 14, sizeof(cl_mem), (void*) &arg14.data_d ));
      clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[39], 15, sizeof(cl_mem), (void*) &arg15.data_d ));
      clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[39], 16, sizeof(cl_int), (void*) &base0 ));
      clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[39], 17, sizeof(cl_int), (void*) &base1 ));
      clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[39], 18, sizeof(cl_int), (void*) &base2 ));
      clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[39], 19, sizeof(cl_int), (void*) &base3 ));
      clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[39], 20, sizeof(cl_int), (void*) &base4 ));
      clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[39], 21, sizeof(cl_int), (void*) &base5 ));
      clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[39], 22, sizeof(cl_int), (void*) &base6 ));
      clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[39], 23, sizeof(cl_int), (void*) &base7 ));
      clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[39], 24, sizeof(cl_int), (void*) &base8 ));
      clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[39], 25, sizeof(cl_int), (void*) &base9 ));
      clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[39], 26, sizeof(cl_int), (void*) &base10 ));
      clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[39], 27, sizeof(cl_int), (void*) &base11 ));
      clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[39], 28, sizeof(cl_int), (void*) &base12 ));
      clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[39], 29, sizeof(cl_int), (void*) &base13 ));
      clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[39], 30, sizeof(cl_int), (void*) &base14 ));
      clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[39], 31, sizeof(cl_int), (void*) &base15 ));
      clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[39], 32, sizeof(cl_int), (void*) &x_size ));
      clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[39], 33, sizeof(cl_int), (void*) &y_size ));
      clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[39], 34, sizeof(cl_int), (void*) &z_size ));
