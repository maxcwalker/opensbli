// Auto-generated at 2024-10-10 09:28:37.382727 by ops-translator legacy
...
//  User function
//  =============
__device__ void opensbliblock00Kernel038_gpu(const ACC<double> &T_B0,
  ACC<double> &wk3_B0,
  const int *idx)
{
   if (idx[0] == 0){
...
//  =================================================
    ...
    if (xdim0 != dims_opensbliblock00Kernel038_h[0][0] || ydim0 != dims_opensbliblock00Kernel038_h[0][1] || xdim1 != dims_opensbliblock00Kernel038_h[1][0] || ydim1 != dims_opensbliblock00Kernel038_h[1][1]) {
        ...
        hipSafeCall(block->instance->ostream(), hipMemcpyToSymbol( dims_opensbliblock00Kernel038, dims_opensbliblock00Kernel038_h, sizeof(dims_opensbliblock00Kernel038)));
    }
...
//call kernel wrapper function, passing in pointers to data
    ...
    if (block->instance->OPS_diags > 1) {
        ...
        ops_timers_core(&__c2, &__t2);
        block->instance->OPS_kernels[28].mpi_time += __t2 - __t1;
        block->instance->OPS_kernels[28].transfer += ops_compute_transfer(dim, start_indx, end_indx, &arg0);
        block->instance->OPS_kernels[28].transfer += ops_compute_transfer(dim, start_indx, end_indx, &arg1);
    }
}
