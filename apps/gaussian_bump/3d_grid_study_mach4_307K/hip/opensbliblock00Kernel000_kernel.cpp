// Auto-generated at 2024-10-10 09:28:37.309848 by ops-translator legacy

__constant__ int dims_opensbliblock00Kernel000 [19][2];
static int dims_opensbliblock00Kernel000_h [19][2] = {{0}};

//  =============
//  User function
//  =============
__device__ void opensbliblock00Kernel000_gpu(const ACC<double> &D00_B0,
...
int size2) {
    ...
    arg0 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel000[0][0] + idx_z * 1*1 * dims_opensbliblock00Kernel000[0][0] * dims_opensbliblock00Kernel000[0][1];
    arg1 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel000[1][0] + idx_z * 1*1 * dims_opensbliblock00Kernel000[1][0] * dims_opensbliblock00Kernel000[1][1];
    arg2 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel000[2][0] + idx_z * 1*1 * dims_opensbliblock00Kernel000[2][0] * dims_opensbliblock00Kernel000[2][1];
    arg3 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel000[3][0] + idx_z * 1*1 * dims_opensbliblock00Kernel000[3][0] * dims_opensbliblock00Kernel000[3][1];
    arg4 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel000[4][0] + idx_z * 1*1 * dims_opensbliblock00Kernel000[4][0] * dims_opensbliblock00Kernel000[4][1];
    arg5 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel000[5][0] + idx_z * 1*1 * dims_opensbliblock00Kernel000[5][0] * dims_opensbliblock00Kernel000[5][1];
    arg6 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel000[6][0] + idx_z * 1*1 * dims_opensbliblock00Kernel000[6][0] * dims_opensbliblock00Kernel000[6][1];
    arg7 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel000[7][0] + idx_z * 1*1 * dims_opensbliblock00Kernel000[7][0] * dims_opensbliblock00Kernel000[7][1];
    arg8 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel000[8][0] + idx_z * 1*1 * dims_opensbliblock00Kernel000[8][0] * dims_opensbliblock00Kernel000[8][1];
    arg9 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel000[9][0] + idx_z * 1*1 * dims_opensbliblock00Kernel000[9][0] * dims_opensbliblock00Kernel000[9][1];
    arg10 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel000[10][0] + idx_z * 1*1 * dims_opensbliblock00Kernel000[10][0] * dims_opensbliblock00Kernel000[10][1];
    arg11 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel000[11][0] + idx_z * 1*1 * dims_opensbliblock00Kernel000[11][0] * dims_opensbliblock00Kernel000[11][1];
    arg12 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel000[12][0] + idx_z * 1*1 * dims_opensbliblock00Kernel000[12][0] * dims_opensbliblock00Kernel000[12][1];
    arg13 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel000[13][0] + idx_z * 1*1 * dims_opensbliblock00Kernel000[13][0] * dims_opensbliblock00Kernel000[13][1];
    arg14 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel000[14][0] + idx_z * 1*1 * dims_opensbliblock00Kernel000[14][0] * dims_opensbliblock00Kernel000[14][1];
    arg15 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel000[15][0] + idx_z * 1*1 * dims_opensbliblock00Kernel000[15][0] * dims_opensbliblock00Kernel000[15][1];
    arg16 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel000[16][0] + idx_z * 1*1 * dims_opensbliblock00Kernel000[16][0] * dims_opensbliblock00Kernel000[16][1];
    arg17 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel000[17][0] + idx_z * 1*1 * dims_opensbliblock00Kernel000[17][0] * dims_opensbliblock00Kernel000[17][1];
    arg18 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel000[18][0] + idx_z * 1*1 * dims_opensbliblock00Kernel000[18][0] * dims_opensbliblock00Kernel000[18][1];

    if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
        const ACC<double> argp0(dims_opensbliblock00Kernel000[0][0], dims_opensbliblock00Kernel000[0][1], arg0);
        const ACC<double> argp1(dims_opensbliblock00Kernel000[1][0], dims_opensbliblock00Kernel000[1][1], arg1);
        const ACC<double> argp2(dims_opensbliblock00Kernel000[2][0], dims_opensbliblock00Kernel000[2][1], arg2);
        const ACC<double> argp3(dims_opensbliblock00Kernel000[3][0], dims_opensbliblock00Kernel000[3][1], arg3);
        const ACC<double> argp4(dims_opensbliblock00Kernel000[4][0], dims_opensbliblock00Kernel000[4][1], arg4);
        const ACC<double> argp5(dims_opensbliblock00Kernel000[5][0], dims_opensbliblock00Kernel000[5][1], arg5);
        const ACC<double> argp6(dims_opensbliblock00Kernel000[6][0], dims_opensbliblock00Kernel000[6][1], arg6);
        const ACC<double> argp7(dims_opensbliblock00Kernel000[7][0], dims_opensbliblock00Kernel000[7][1], arg7);
        const ACC<double> argp8(dims_opensbliblock00Kernel000[8][0], dims_opensbliblock00Kernel000[8][1], arg8);
        const ACC<double> argp9(dims_opensbliblock00Kernel000[9][0], dims_opensbliblock00Kernel000[9][1], arg9);
        const ACC<double> argp10(dims_opensbliblock00Kernel000[10][0], dims_opensbliblock00Kernel000[10][1], arg10);
        const ACC<double> argp11(dims_opensbliblock00Kernel000[11][0], dims_opensbliblock00Kernel000[11][1], arg11);
        const ACC<double> argp12(dims_opensbliblock00Kernel000[12][0], dims_opensbliblock00Kernel000[12][1], arg12);
        const ACC<double> argp13(dims_opensbliblock00Kernel000[13][0], dims_opensbliblock00Kernel000[13][1], arg13);
        ACC<double> argp14(dims_opensbliblock00Kernel000[14][0], dims_opensbliblock00Kernel000[14][1], arg14);
        ACC<double> argp15(dims_opensbliblock00Kernel000[15][0], dims_opensbliblock00Kernel000[15][1], arg15);
        ACC<double> argp16(dims_opensbliblock00Kernel000[16][0], dims_opensbliblock00Kernel000[16][1], arg16);
        ACC<double> argp17(dims_opensbliblock00Kernel000[17][0], dims_opensbliblock00Kernel000[17][1], arg17);
        ACC<double> argp18(dims_opensbliblock00Kernel000[18][0], dims_opensbliblock00Kernel000[18][1], arg18);
...
//  =================================================
...
#else
    if (compute_ranges(args, 19, block, range, start_indx, end_indx, arg_idx) < 0) return;
#endif
    ...
    if (xdim0 != dims_opensbliblock00Kernel000_h[0][0] || ydim0 != dims_opensbliblock00Kernel000_h[0][1] || xdim1 != dims_opensbliblock00Kernel000_h[1][0] || ydim1 != dims_opensbliblock00Kernel000_h[1][1] || xdim2 != dims_opensbliblock00Kernel000_h[2][0] || ydim2 != dims_opensbliblock00Kernel000_h[2][1] || xdim3 != dims_opensbliblock00Kernel000_h[3][0] || ydim3 != dims_opensbliblock00Kernel000_h[3][1] || xdim4 != dims_opensbliblock00Kernel000_h[4][0] || ydim4 != dims_opensbliblock00Kernel000_h[4][1] || xdim5 != dims_opensbliblock00Kernel000_h[5][0] || ydim5 != dims_opensbliblock00Kernel000_h[5][1] || xdim6 != dims_opensbliblock00Kernel000_h[6][0] || ydim6 != dims_opensbliblock00Kernel000_h[6][1] || xdim7 != dims_opensbliblock00Kernel000_h[7][0] || ydim7 != dims_opensbliblock00Kernel000_h[7][1] || xdim8 != dims_opensbliblock00Kernel000_h[8][0] || ydim8 != dims_opensbliblock00Kernel000_h[8][1] || xdim9 != dims_opensbliblock00Kernel000_h[9][0] || ydim9 != dims_opensbliblock00Kernel000_h[9][1] || xdim10 != dims_opensbliblock00Kernel000_h[10][0] || ydim10 != dims_opensbliblock00Kernel000_h[10][1] || xdim11 != dims_opensbliblock00Kernel000_h[11][0] || ydim11 != dims_opensbliblock00Kernel000_h[11][1] || xdim12 != dims_opensbliblock00Kernel000_h[12][0] || ydim12 != dims_opensbliblock00Kernel000_h[12][1] || xdim13 != dims_opensbliblock00Kernel000_h[13][0] || ydim13 != dims_opensbliblock00Kernel000_h[13][1] || xdim14 != dims_opensbliblock00Kernel000_h[14][0] || ydim14 != dims_opensbliblock00Kernel000_h[14][1] || xdim15 != dims_opensbliblock00Kernel000_h[15][0] || ydim15 != dims_opensbliblock00Kernel000_h[15][1] || xdim16 != dims_opensbliblock00Kernel000_h[16][0] || ydim16 != dims_opensbliblock00Kernel000_h[16][1] || xdim17 != dims_opensbliblock00Kernel000_h[17][0] || ydim17 != dims_opensbliblock00Kernel000_h[17][1] || xdim18 != dims_opensbliblock00Kernel000_h[18][0] || ydim18 != dims_opensbliblock00Kernel000_h[18][1]) {
        dims_opensbliblock00Kernel000_h[0][0] = xdim0;
        dims_opensbliblock00Kernel000_h[0][1] = ydim0;
        dims_opensbliblock00Kernel000_h[1][0] = xdim1;
        dims_opensbliblock00Kernel000_h[1][1] = ydim1;
        dims_opensbliblock00Kernel000_h[2][0] = xdim2;
        dims_opensbliblock00Kernel000_h[2][1] = ydim2;
        dims_opensbliblock00Kernel000_h[3][0] = xdim3;
        dims_opensbliblock00Kernel000_h[3][1] = ydim3;
        dims_opensbliblock00Kernel000_h[4][0] = xdim4;
        dims_opensbliblock00Kernel000_h[4][1] = ydim4;
        dims_opensbliblock00Kernel000_h[5][0] = xdim5;
        dims_opensbliblock00Kernel000_h[5][1] = ydim5;
        dims_opensbliblock00Kernel000_h[6][0] = xdim6;
        dims_opensbliblock00Kernel000_h[6][1] = ydim6;
        dims_opensbliblock00Kernel000_h[7][0] = xdim7;
        dims_opensbliblock00Kernel000_h[7][1] = ydim7;
        dims_opensbliblock00Kernel000_h[8][0] = xdim8;
        dims_opensbliblock00Kernel000_h[8][1] = ydim8;
        dims_opensbliblock00Kernel000_h[9][0] = xdim9;
        dims_opensbliblock00Kernel000_h[9][1] = ydim9;
        dims_opensbliblock00Kernel000_h[10][0] = xdim10;
        dims_opensbliblock00Kernel000_h[10][1] = ydim10;
        dims_opensbliblock00Kernel000_h[11][0] = xdim11;
        dims_opensbliblock00Kernel000_h[11][1] = ydim11;
        dims_opensbliblock00Kernel000_h[12][0] = xdim12;
        dims_opensbliblock00Kernel000_h[12][1] = ydim12;
        dims_opensbliblock00Kernel000_h[13][0] = xdim13;
        dims_opensbliblock00Kernel000_h[13][1] = ydim13;
        dims_opensbliblock00Kernel000_h[14][0] = xdim14;
        dims_opensbliblock00Kernel000_h[14][1] = ydim14;
        dims_opensbliblock00Kernel000_h[15][0] = xdim15;
        dims_opensbliblock00Kernel000_h[15][1] = ydim15;
        dims_opensbliblock00Kernel000_h[16][0] = xdim16;
        dims_opensbliblock00Kernel000_h[16][1] = ydim16;
        dims_opensbliblock00Kernel000_h[17][0] = xdim17;
        dims_opensbliblock00Kernel000_h[17][1] = ydim17;
        dims_opensbliblock00Kernel000_h[18][0] = xdim18;
        dims_opensbliblock00Kernel000_h[18][1] = ydim18;
...
//  =============
    ...
    if (block->instance->OPS_diags > 1) {
        ...
        block->instance->OPS_kernels[21].mpi_time += __t2 - __t1;
    }
...
//call kernel wrapper function, passing in pointers to data
    ...
    if (block->instance->OPS_diags>1) {
        ...
        ops_timers_core(&__c1, &__t1);
        block->instance->OPS_kernels[21].time += __t1 - __t2;
    }
    ...
    if (block->instance->OPS_diags > 1) {
        ...
        ops_timers_core(&__c2, &__t2);
        block->instance->OPS_kernels[21].mpi_time += __t2 - __t1;
        block->instance->OPS_kernels[21].transfer += ops_compute_transfer(dim, start_indx, end_indx, &arg0);
        block->instance->OPS_kernels[21].transfer += ops_compute_transfer(dim, start_indx, end_indx, &arg1);
        block->instance->OPS_kernels[21].transfer += ops_compute_transfer(dim, start_indx, end_indx, &arg2);
        block->instance->OPS_kernels[21].transfer += ops_compute_transfer(dim, start_indx, end_indx, &arg3);
        block->instance->OPS_kernels[21].transfer += ops_compute_transfer(dim, start_indx, end_indx, &arg4);
        block->instance->OPS_kernels[21].transfer += ops_compute_transfer(dim, start_indx, end_indx, &arg5);
        block->instance->OPS_kernels[21].transfer += ops_compute_transfer(dim, start_indx, end_indx, &arg6);
        block->instance->OPS_kernels[21].transfer += ops_compute_transfer(dim, start_indx, end_indx, &arg7);
        block->instance->OPS_kernels[21].transfer += ops_compute_transfer(dim, start_indx, end_indx, &arg8);
        block->instance->OPS_kernels[21].transfer += ops_compute_transfer(dim, start_indx, end_indx, &arg9);
        block->instance->OPS_kernels[21].transfer += ops_compute_transfer(dim, start_indx, end_indx, &arg10);
        block->instance->OPS_kernels[21].transfer += ops_compute_transfer(dim, start_indx, end_indx, &arg11);
        block->instance->OPS_kernels[21].transfer += ops_compute_transfer(dim, start_indx, end_indx, &arg12);
        block->instance->OPS_kernels[21].transfer += ops_compute_transfer(dim, start_indx, end_indx, &arg13);
        block->instance->OPS_kernels[21].transfer += ops_compute_transfer(dim, start_indx, end_indx, &arg14);
        block->instance->OPS_kernels[21].transfer += ops_compute_transfer(dim, start_indx, end_indx, &arg15);
        block->instance->OPS_kernels[21].transfer += ops_compute_transfer(dim, start_indx, end_indx, &arg16);
        block->instance->OPS_kernels[21].transfer += ops_compute_transfer(dim, start_indx, end_indx, &arg17);
        block->instance->OPS_kernels[21].transfer += ops_compute_transfer(dim, start_indx, end_indx, &arg18);
    }
}
 ...
 ops_arg arg16, ops_arg arg17, ops_arg arg18)
{
    ...
    create_kerneldesc_and_enque("opensbliblock00Kernel000", args, 19, 21, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel000_execute);
}
#endif
