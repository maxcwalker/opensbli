// Auto-generated at 2024-10-10 09:28:37.210992 by ops-translator legacy

__constant__ int dims_opensbliblock00Kernel006 [3][2];
static int dims_opensbliblock00Kernel006_h [3][2] = {{0}};

//  =============
//  User function
//  =============
__device__ void opensbliblock00Kernel006_gpu(const ACC<double> &rho_B0,
...
int size2) {
    ...
    arg0 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel006[0][0] + idx_z * 1*1 * dims_opensbliblock00Kernel006[0][0] * dims_opensbliblock00Kernel006[0][1];
    arg1 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel006[1][0] + idx_z * 1*1 * dims_opensbliblock00Kernel006[1][0] * dims_opensbliblock00Kernel006[1][1];
    arg2 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel006[2][0] + idx_z * 1*1 * dims_opensbliblock00Kernel006[2][0] * dims_opensbliblock00Kernel006[2][1];

    if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
        const ACC<double> argp0(dims_opensbliblock00Kernel006[0][0], dims_opensbliblock00Kernel006[0][1], arg0);
        const ACC<double> argp1(dims_opensbliblock00Kernel006[1][0], dims_opensbliblock00Kernel006[1][1], arg1);
        ACC<double> argp2(dims_opensbliblock00Kernel006[2][0], dims_opensbliblock00Kernel006[2][1], arg2);
...
//  =================================================
    ...
    if (xdim0 != dims_opensbliblock00Kernel006_h[0][0] || ydim0 != dims_opensbliblock00Kernel006_h[0][1] || xdim1 != dims_opensbliblock00Kernel006_h[1][0] || ydim1 != dims_opensbliblock00Kernel006_h[1][1] || xdim2 != dims_opensbliblock00Kernel006_h[2][0] || ydim2 != dims_opensbliblock00Kernel006_h[2][1]) {
        dims_opensbliblock00Kernel006_h[0][0] = xdim0;
        dims_opensbliblock00Kernel006_h[0][1] = ydim0;
        dims_opensbliblock00Kernel006_h[1][0] = xdim1;
        dims_opensbliblock00Kernel006_h[1][1] = ydim1;
        dims_opensbliblock00Kernel006_h[2][0] = xdim2;
        dims_opensbliblock00Kernel006_h[2][1] = ydim2;
...
//call kernel wrapper function, passing in pointers to data
    ...
    if (block->instance->OPS_diags > 1) {
        ...
        block->instance->OPS_kernels[11].transfer += ops_compute_transfer(dim, start_indx, end_indx, &arg2);
    }
}
