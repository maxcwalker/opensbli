...
void ops_par_loop_opensbliblock00Kernel000_execute(ops_kernel_descriptor *desc) {
  ...
  double * __restrict__ rhou0_B0_p = (double *)(args[10].data + base10);

  int base11 = args[11].dat->base_offset;
  double * __restrict__ a_B0_p = (double *)(args[11].data + base11);
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
      ...
      const ACC<double> rhou1_B0(xdim1_opensbliblock00Kernel000, rhou1_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel000*1);
      const ACC<double> p_B0(xdim2_opensbliblock00Kernel000, p_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel000*1);
      const ACC<double> D00_B0(xdim3_opensbliblock00Kernel000, D00_B0_p + n_x*1 + n_y * xdim3_opensbliblock00Kernel000*1);
      ...
      const ACC<double> u0_B0(xdim6_opensbliblock00Kernel000, u0_B0_p + n_x*1 + n_y * xdim6_opensbliblock00Kernel000*1);
      ...
      const ACC<double> D01_B0(xdim9_opensbliblock00Kernel000, D01_B0_p + n_x*1 + n_y * xdim9_opensbliblock00Kernel000*1);
      const ACC<double> rhou0_B0(xdim10_opensbliblock00Kernel000, rhou0_B0_p + n_x*1 + n_y * xdim10_opensbliblock00Kernel000*1);
      const ACC<double> a_B0(xdim11_opensbliblock00Kernel000, a_B0_p + n_x*1 + n_y * xdim11_opensbliblock00Kernel000*1);
