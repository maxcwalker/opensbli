...
void ops_par_loop_opensbliblock00Kernel064_execute(ops_kernel_descriptor *desc) {
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
      ...
      ACC<double> rho_B0(xdim3_opensbliblock00Kernel064, rho_B0_p + n_x*1 + n_y * xdim3_opensbliblock00Kernel064*1);
   ...
   rhoE_B0(0,0) = Twall*rcinv16*rho_B0(0,0)/(gama*(gama - 1.0));

    Pwall = (gama - 1)*(-((rc11)*pow(rhou0_B0(0,0), 2) + (rc11)*pow(rhou1_B0(0,0),
   ...
   u13 = rhou1_B0(0,3)/rho_B0(0,3);
    ...
    T_above = pow(Minf, 2)*gama*(gama - 1)*(-((rc11)*pow(rhou0_B0(0,1), 2) +
      (rc11)*pow(rhou1_B0(0,1), 2))/rho_B0(0,1) + rhoE_B0(0,1))/rho_B0(0,1);
   ...
   rhoE_B0(0,-1) = rcinv7*Pwall + (rc11)*rho_halo_1*(pow(u01, 2) + pow(u11, 2));
   ...
   rhoE_B0(0,-2) = rcinv7*Pwall + (rc11)*rho_halo_2*(pow(u02, 2) + pow(u12, 2));
   ...
   rhoE_B0(0,-3) = rcinv7*Pwall + (rc11)*rho_halo_3*(pow(u03, 2) + pow(u13, 2));
