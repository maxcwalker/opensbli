...
void ops_par_loop_opensbliblock00Kernel001_execute(ops_kernel_descriptor *desc) {
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
      ...
      const ACC<double> D11_B0(xdim5_opensbliblock00Kernel001, D11_B0_p + n_x*1 + n_y * xdim5_opensbliblock00Kernel001*1);
      ...
      const ACC<double> rhou0_B0(xdim10_opensbliblock00Kernel001, rhou0_B0_p + n_x*1 + n_y * xdim10_opensbliblock00Kernel001*1);
      const ACC<double> a_B0(xdim11_opensbliblock00Kernel001, a_B0_p + n_x*1 + n_y * xdim11_opensbliblock00Kernel001*1);
   ...
   double CS_14 = 0.0;
   double CS_02 = 0.0;
   AVG_1_u0 = (rc11)*(u0_B0(0,0) + u0_B0(0,1));

   AVG_1_u1 = (rc11)*(u1_B0(0,0) + u1_B0(0,1));

   AVG_1_a = (rc11)*(a_B0(0,1) + a_B0(0,0));

   AVG_1_rho = (rc11)*(rho_B0(0,0) + rho_B0(0,1));

   AVG_1_D10 = (rc11)*(D10_B0(0,1) + D10_B0(0,0));

   AVG_1_D11 = (rc11)*(D11_B0(0,1) + D11_B0(0,0));
   ...
   AVG_1_1_LEV_33 = 0.707106781186547*gamma_m1*inv_AVG_a*inv_AVG_rho;
    ...
    max_lambda_1_00 = fmax(fabs(D10_B0(0,-2)*u0_B0(0,-2) +
      ...
      D11_B0(0,3)*u1_B0(0,3)), fabs(D10_B0(0,-1)*u0_B0(0,-1) +
   ...
   max_lambda_1_11 = max_lambda_1_00;
    ...
    max_lambda_1_33 = fmax(fabs(-sqrt(pow(D10_B0(0,-2), 2) + pow(D11_B0(0,-2),
      ...
      pow(D11_B0(0,-1), 2))*a_B0(0,-1) + D10_B0(0,-1)*u0_B0(0,-1) +
      D11_B0(0,-1)*u1_B0(0,-1)), fabs(-sqrt(pow(D10_B0(0,3), 2) +
