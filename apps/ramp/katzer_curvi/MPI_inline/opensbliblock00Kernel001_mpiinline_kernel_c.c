...
void opensbliblock00Kernel001_c_wrapper(
  ...
  for ( int n_y=0; n_y<y_size; n_y++ ){
    for ( int n_x=0; n_x<x_size; n_x++ ){
      ...
      const ptr_double D11_B0 = { D11_B0_p + n_x*1 + n_y * xdim5_opensbliblock00Kernel001*1, xdim5_opensbliblock00Kernel001};
      ...
      const ptr_double U1_B0 = { U1_B0_p + n_x*1 + n_y * xdim9_opensbliblock00Kernel001*1, xdim9_opensbliblock00Kernel001};
      const ptr_double rhou0_B0 = { rhou0_B0_p + n_x*1 + n_y * xdim10_opensbliblock00Kernel001*1, xdim10_opensbliblock00Kernel001};
      const ptr_double a_B0 = { a_B0_p + n_x*1 + n_y * xdim11_opensbliblock00Kernel001*1, xdim11_opensbliblock00Kernel001};
   ...
   double CS_14 = 0.0;
   double CS_02 = 0.0;
   AVG_1_u0 = (rc11)*(OPS_ACC(u0_B0, 0,0) + OPS_ACC(u0_B0, 0,1));

   AVG_1_u1 = (rc11)*(OPS_ACC(u1_B0, 0,0) + OPS_ACC(u1_B0, 0,1));

   AVG_1_a = (rc11)*(OPS_ACC(a_B0, 0,1) + OPS_ACC(a_B0, 0,0));

   AVG_1_rho = (rc11)*(OPS_ACC(rho_B0, 0,0) + OPS_ACC(rho_B0, 0,1));

   AVG_1_D10 = (rc11)*(OPS_ACC(D10_B0, 0,1) + OPS_ACC(D10_B0, 0,0));

   AVG_1_D11 = (rc11)*(OPS_ACC(D11_B0, 0,1) + OPS_ACC(D11_B0, 0,0));
   ...
   AVG_1_1_LEV_33 = 0.707106781186547*gamma_m1*inv_AVG_a*inv_AVG_rho;
    ...
    max_lambda_1_00 = fmax(fabs(OPS_ACC(D10_B0, 0,-2)*OPS_ACC(u0_B0, 0,-2) +
      ...
      OPS_ACC(D11_B0, 0,0)*OPS_ACC(u1_B0, 0,0)), fmax(fabs(OPS_ACC(D10_B0, 0,3)*OPS_ACC(u0_B0, 0,3) +
      OPS_ACC(D11_B0, 0,3)*OPS_ACC(u1_B0, 0,3)), fabs(OPS_ACC(D10_B0, 0,-1)*OPS_ACC(u0_B0, 0,-1) +
   ...
   max_lambda_1_11 = max_lambda_1_00;
    ...
    max_lambda_1_33 = fmax(fabs(-sqrt(pow(OPS_ACC(D10_B0, 0,-2), 2) + pow(OPS_ACC(D11_B0, 0,-2),
      ...
      pow(OPS_ACC(D11_B0, 0,-1), 2))*OPS_ACC(a_B0, 0,-1) + OPS_ACC(D10_B0, 0,-1)*OPS_ACC(u0_B0, 0,-1) +
      OPS_ACC(D11_B0, 0,-1)*OPS_ACC(u1_B0, 0,-1)), fabs(-sqrt(pow(OPS_ACC(D10_B0, 0,3), 2) +
