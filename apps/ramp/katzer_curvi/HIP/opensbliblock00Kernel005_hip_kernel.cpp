...
//
__constant__ int dims_opensbliblock00Kernel005 [5][1];
static int dims_opensbliblock00Kernel005_h [5][1] = {{0}};

//user function
__device__

 void opensbliblock00Kernel005_gpu(const ACC<double> &u0_B0,
  const ACC<double> &rho_B0,
  const ACC<double> &u1_B0,
  const ACC<double> &rhoE_B0,
  ACC<double> &p_B0)
{
    p_B0(0,0) = (gama - 1)*(rhoE_B0(0,0) - rc11*rho_B0(0,0)*pow(u0_B0(0,0), 2) -
      rc11*rho_B0(0,0)*pow(u1_B0(0,0), 2));
...
int size1 ){
  ...
  if (idx_x < size0 && idx_y < size1) {
    ...
    ACC<double> argp4(dims_opensbliblock00Kernel005[4][0], arg4);
    opensbliblock00Kernel005_gpu(argp0, argp1, argp2, argp3,
                   argp4);
  }
...
void ops_par_loop_opensbliblock00Kernel005_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_opensbliblock00Kernel005_h[0][0] || xdim1 != dims_opensbliblock00Kernel005_h[1][0] || xdim2 != dims_opensbliblock00Kernel005_h[2][0] || xdim3 != dims_opensbliblock00Kernel005_h[3][0] || xdim4 != dims_opensbliblock00Kernel005_h[4][0]) {
