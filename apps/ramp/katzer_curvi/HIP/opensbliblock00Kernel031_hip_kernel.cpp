...
void opensbliblock00Kernel031_gpu(const ACC<double> &u1_B0,
  ...
  const int *idx)
{
    wk3_B0(0,0) = inv_1*((idx[1] == 0) ? (
   -rc34*u1_B0(0,3) + (rc35)*u1_B0(0,0) +
      (rc32)*u1_B0(0,4) - rc36*u1_B0(0,1) + (rc37)*u1_B0(0,2)
)
: ((idx[1] == 1) ? (

      -rc13*u1_B0(0,3) + (rc32)*u1_B0(0,-1) - rc19*u1_B0(0,0) +
      (rc11)*u1_B0(0,1) + (rc24)*u1_B0(0,2)
)
: (
   (rc9)*u1_B0(0,-1) -
      rc13*u1_B0(0,-2) - rc38*u1_B0(0,0) + (rc9)*u1_B0(0,1) -
      rc13*u1_B0(0,2)
)));
