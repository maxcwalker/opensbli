  ...
  const int *idx)
{
   ...
   -rc34*u0_B0(0,3) + (rc35)*u0_B0(0,0) +
      (rc32)*u0_B0(0,4) - rc36*u0_B0(0,1) + (rc37)*u0_B0(0,2)
)
: ((idx[1] == 1) ? (

      -rc13*u0_B0(0,3) + (rc32)*u0_B0(0,-1) - rc19*u0_B0(0,0) +
      (rc11)*u0_B0(0,1) + (rc24)*u0_B0(0,2)
)
: (
   -rc13*u0_B0(0,-2) +
      (rc9)*u0_B0(0,-1) - rc38*u0_B0(0,0) + (rc9)*u0_B0(0,1) -
      rc13*u0_B0(0,2)
)));
