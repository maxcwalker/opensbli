  ...
  const int *idx)
{
   ...
   -3*x0_B0(0,2) + (rc9)*x0_B0(0,3) -
      rc8*x0_B0(0,4) - rc10*x0_B0(0,0) + 4*x0_B0(0,1)
)
: ((idx[1] == 1) ? (

      -rc11*x0_B0(0,2) - rc8*x0_B0(0,-1) + (rc13)*x0_B0(0,3) - rc14*x0_B0(0,0) +
      (rc12)*x0_B0(0,1)
)
: (
   -rc13*x0_B0(0,2) + (rc15)*x0_B0(0,1) -
      rc15*x0_B0(0,-1) + (rc13)*x0_B0(0,-2)
)));
