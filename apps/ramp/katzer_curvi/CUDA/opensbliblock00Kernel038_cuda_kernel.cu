...
void opensbliblock00Kernel038_gpu(const ACC<double> &T_B0,
  ...
  const int *idx)
{
    wk10_B0(0,0) = inv_2*((idx[0] == 0) ? (
   -1.83333333333334*T_B0(0,0) +
      3.00000000000002*T_B0(1,0) - 1.50000000000003*T_B0(2,0) -
      8.34657956545823e-15*T_B0(4,0) + 0.333333333333356*T_B0(3,0) +
      1.06910315192207e-15*T_B0(5,0)
)
: ((idx[0] == 1) ? (
   -0.322484932882161*T_B0(0,0) +
      0.719443173328855*T_B0(1,0) + 0.0394168524399447*T_B0(2,0) +
      0.00571369039775442*T_B0(4,0) - 0.376283677513354*T_B0(-1,0) -
      0.0658051057710389*T_B0(3,0)
)
: ((idx[0] == 2) ? (
...
: ((idx[0] == block0np0 - 1) ? (
   (rc10)*T_B0(0,0) +
      (rc8)*T_B0(-4,0) - rc9*T_B0(-3,0) - 4*T_B0(-1,0) + 3*T_B0(-2,0)
)
:
      ((idx[0] == block0np0 - 2) ? (
   (rc14)*T_B0(0,0) + (rc8)*T_B0(1,0) -
      rc13*T_B0(-3,0) + (rc11)*T_B0(-2,0) - rc12*T_B0(-1,0)
)
: (

      (rc15)*T_B0(1,0) - rc15*T_B0(-1,0) + (rc13)*T_B0(-2,0) -
      rc13*T_B0(2,0)
)))))));
