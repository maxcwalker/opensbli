...
void opensbliblock00Kernel034_gpu(const ACC<double> &u1_B0,
  ACC<double> &wk6_B0,
  const int *idx)
{
    wk6_B0(0,0) = inv_2*((idx[0] == 0) ? (
   -1.83333333333334*u1_B0(0,0) +
      3.00000000000002*u1_B0(1,0) - 1.50000000000003*u1_B0(2,0) -
...
: ((idx[0] == 2) ? (
   0.113446470384241*u1_B0(-2,0) -
      ...
      0.521455851089587*u1_B0(1,0) - 0.0367146847001261*u1_B0(2,0) -
...
: ((idx[0] == block0np0 - 1) ? (
   (rc8)*u1_B0(-4,0) -
      rc9*u1_B0(-3,0) - 4*u1_B0(-1,0) + 3*u1_B0(-2,0) + (rc10)*u1_B0(0,0)
)
:
      ((idx[0] == block0np0 - 2) ? (
   -rc13*u1_B0(-3,0) + (rc11)*u1_B0(-2,0) -
      rc12*u1_B0(-1,0) + (rc14)*u1_B0(0,0) + (rc8)*u1_B0(1,0)
)
: (

      (rc13)*u1_B0(-2,0) + (rc15)*u1_B0(1,0) - rc15*u1_B0(-1,0) -
      rc13*u1_B0(2,0)
)))))));
