...
//
__constant__ int dims_opensbliblock00Kernel046 [4][1];
static int dims_opensbliblock00Kernel046_h [4][1] = {{0}};

//user function
__device__

void opensbliblock00Kernel046_gpu(ACC<double> &rhou1_B0,
  ACC<double> &rho_B0,
  ACC<double> &rhoE_B0,
  ACC<double> &rhou0_B0)
{
...
int size1 ){
  ...
  if (idx_x < size0 && idx_y < size1) {
    ACC<double> argp0(dims_opensbliblock00Kernel046[0][0], arg0);
    ACC<double> argp1(dims_opensbliblock00Kernel046[1][0], arg1);
    ACC<double> argp2(dims_opensbliblock00Kernel046[2][0], arg2);
    ACC<double> argp3(dims_opensbliblock00Kernel046[3][0], arg3);
...
void ops_par_loop_opensbliblock00Kernel046_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_opensbliblock00Kernel046_h[0][0] || xdim1 != dims_opensbliblock00Kernel046_h[1][0] || xdim2 != dims_opensbliblock00Kernel046_h[2][0] || xdim3 != dims_opensbliblock00Kernel046_h[3][0]) {
