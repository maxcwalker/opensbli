...
{
    wk1_B0(0,0) = ((idx[0] == 0) ? (
   inv_1*(-rc9*u0_B0(0,0) - rc7*u0_B0(4,0) +
      (rc8)*u0_B0(3,0) - 3*u0_B0(2,0) + 4*u0_B0(1,0))
)
: ((idx[0] == 1) ? (

      (rc10)*inv_1*(-10*u0_B0(0,0) + u0_B0(3,0) - 6*u0_B0(2,0) - 3*u0_B0(-1,0) +
      18*u0_B0(1,0))
)
: ((idx[0] == block0np0 - 1) ? (
   inv_1*(-rc8*u0_B0(-3,0) -
      4*u0_B0(-1,0) + (rc9)*u0_B0(0,0) + (rc7)*u0_B0(-4,0) + 3*u0_B0(-2,0))
)
:
      ((idx[0] == block0np0 - 2) ? (
   (rc10)*inv_1*(-u0_B0(-3,0) + 10*u0_B0(0,0) -
      18*u0_B0(-1,0) + 6*u0_B0(-2,0) + 3*u0_B0(1,0))
)
: (
