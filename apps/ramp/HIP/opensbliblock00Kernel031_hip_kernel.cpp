...
{
    wk2_B0(0,0) = ((idx[1] == 0) ? (
   inv_0*(-rc9*u1_B0(0,0) + 4*u1_B0(0,1) -
      3*u1_B0(0,2) + (rc8)*u1_B0(0,3) - rc7*u1_B0(0,4))
)
: ((idx[1] == 1) ? (

      (rc10)*inv_0*(-10*u1_B0(0,0) + 18*u1_B0(0,1) - 6*u1_B0(0,2) -
      3*u1_B0(0,-1) + u1_B0(0,3))
)
: (
   (rc10)*inv_0*(8*u1_B0(0,1) -
      u1_B0(0,2) + u1_B0(0,-2) - 8*u1_B0(0,-1))
)));
