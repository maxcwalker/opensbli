...
extern double rc36;
extern double rc37;
extern double rcinv38;
extern double rc39;
extern double rcinv40;
...
void ops_decl_const_char(int dim, char const * type, int typeSize, char * dat, char const * name ) {
  ...
  if (instance->opencl_instance->OPS_opencl_core.constant == NULL) {
    instance->opencl_instance->OPS_opencl_core.constant = (cl_mem*) malloc((62)*sizeof(cl_mem));
    for ( int i=0; i<62; i++ ){
  ...
  void buildOpenCLKernels(OPS_instance *instance) {
    ...
    if(!isbuilt) {
      ...
      instance->opencl_instance->OPS_opencl_core.n_kernels = 59;
      instance->opencl_instance->OPS_opencl_core.kernel = (cl_kernel*) malloc(59*sizeof(cl_kernel));
    }
    isbuilt = true;
  }
