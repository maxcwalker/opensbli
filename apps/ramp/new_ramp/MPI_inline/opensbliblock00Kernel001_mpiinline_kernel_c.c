...
void opensbliblock00Kernel001_c_wrapper(
  ...
  for ( int n_y=0; n_y<y_size; n_y++ ){
    for ( int n_x=0; n_x<x_size; n_x++ ){
      ...
      const ptr_double D11_B0 = { D11_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel001*1, xdim1_opensbliblock00Kernel001};
      const ptr_double D10_B0 = { D10_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel001*1, xdim2_opensbliblock00Kernel001};
      const ptr_double a_B0 = { a_B0_p + n_x*1 + n_y * xdim3_opensbliblock00Kernel001*1, xdim3_opensbliblock00Kernel001};
      const ptr_double rho_B0 = { rho_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel001*1, xdim4_opensbliblock00Kernel001};
      const ptr_double u0_B0 = { u0_B0_p + n_x*1 + n_y * xdim5_opensbliblock00Kernel001*1, xdim5_opensbliblock00Kernel001};
      const ptr_double detJ_B0 = { detJ_B0_p + n_x*1 + n_y * xdim6_opensbliblock00Kernel001*1, xdim6_opensbliblock00Kernel001};
      const ptr_double rhou0_B0 = { rhou0_B0_p + n_x*1 + n_y * xdim7_opensbliblock00Kernel001*1, xdim7_opensbliblock00Kernel001};
      const ptr_double u1_B0 = { u1_B0_p + n_x*1 + n_y * xdim8_opensbliblock00Kernel001*1, xdim8_opensbliblock00Kernel001};
      const ptr_double rhoE_B0 = { rhoE_B0_p + n_x*1 + n_y * xdim9_opensbliblock00Kernel001*1, xdim9_opensbliblock00Kernel001};
      const ptr_double rhou1_B0 = { rhou1_B0_p + n_x*1 + n_y * xdim10_opensbliblock00Kernel001*1, xdim10_opensbliblock00Kernel001};
   ...
   double CS_24 = 0.0;
   AVG_1_a = (rc13)*(OPS_ACC(a_B0, 0,0) + OPS_ACC(a_B0, 0,1));

   AVG_1_rho = (rc13)*(OPS_ACC(rho_B0, 0,1) + OPS_ACC(rho_B0, 0,0));

   AVG_1_u1 = (rc13)*(OPS_ACC(u1_B0, 0,1) + OPS_ACC(u1_B0, 0,0));

   AVG_1_u0 = (rc13)*(OPS_ACC(u0_B0, 0,0) + OPS_ACC(u0_B0, 0,1));

   AVG_1_D11 = (rc13)*(OPS_ACC(D11_B0, 0,0) + OPS_ACC(D11_B0, 0,1));

   AVG_1_D10 = (rc13)*(OPS_ACC(D10_B0, 0,0) + OPS_ACC(D10_B0, 0,1));
   ...
   AVG_1_1_LEV_33 = 0.707106781186547*gamma_m1*inv_AVG_a*inv_AVG_rho;
    ...
    max_lambda_1_00 = fmax(fabs(OPS_ACC(D10_B0, 0,2)*OPS_ACC(u0_B0, 0,2) +
      OPS_ACC(D11_B0, 0,2)*OPS_ACC(u1_B0, 0,2)), fmax(fabs(OPS_ACC(D10_B0, 0,-2)*OPS_ACC(u0_B0, 0,-2) +
      ...
      OPS_ACC(D11_B0, 0,0)*OPS_ACC(u1_B0, 0,0)), fabs(OPS_ACC(D10_B0, 0,-1)*OPS_ACC(u0_B0, 0,-1) +
   ...
   max_lambda_1_11 = max_lambda_1_00;
    ...
    max_lambda_1_33 = fmax(fabs(-sqrt(pow(OPS_ACC(D10_B0, 0,-2), 2) + pow(OPS_ACC(D11_B0, 0,-2),
      ...
      OPS_ACC(D11_B0, 0,3)*OPS_ACC(u1_B0, 0,3)), fmax(fabs(-sqrt(pow(OPS_ACC(D10_B0, 0,0), 2) +
