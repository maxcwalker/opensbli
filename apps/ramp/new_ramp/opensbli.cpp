...
ops_decl_const("Rcorn" , 1, "double", &Rcorn);
ops_decl_const("Lx" , 1, "double", &Lx);
ops_decl_const("x0" , 1, "double", &x0);
ops_decl_const("b" , 1, "double", &b);
ops_decl_const("Rcurv" , 1, "double", &Rcurv);
...
ops_par_loop(opensbliblock00Kernel078, "MetricsEquation CD D11_B0 xi0 ", opensbliblock00, 2, iteration_range_78_block0,
...
ops_par_loop(opensbliblock00Kernel084, "MetricsEquation CD D01_B0 xi1 ", opensbliblock00, 2, iteration_range_84_block0,
...
for(int iter=100000; iter<=200000 - 1; iter++)
{
...
int iteration_range_3_block0[] = {-3, block0np0 + 4, 0, block0np1};
...
ops_par_loop(opensbliblock00Kernel002, "CRa", opensbliblock00, 2, iteration_range_2_block0,
...
ops_par_loop(opensbliblock00Kernel018, "CRT_B0", opensbliblock00, 2, iteration_range_18_block0,
ops_arg_dat(p_B0, 1, stencil_0_00, "double", OPS_READ),
ops_arg_dat(rho_B0, 1, stencil_0_00, "double", OPS_READ),
...
ops_par_loop(opensbliblock00Kernel032, "Viscous CD u0_B0 xi0 xi0 ", opensbliblock00, 2, iteration_range_32_block0,
...
ops_par_loop(opensbliblock00Kernel034, "Viscous CD u1_B0 xi0 xi0 ", opensbliblock00, 2, iteration_range_34_block0,
...
ops_par_loop(opensbliblock00Kernel035, "Viscous CD u1_B0 xi1 ", opensbliblock00, 2, iteration_range_35_block0,
...
ops_par_loop(opensbliblock00Kernel037, "Viscous CD u0_B0 xi0 ", opensbliblock00, 2, iteration_range_37_block0,
...
ops_par_loop(opensbliblock00Kernel040, "Viscous CD u1_B0 xi1 xi1 ", opensbliblock00, 2, iteration_range_40_block0,
ops_arg_dat(u1_B0, 1, stencil_0_05, "double", OPS_READ),
...
ops_arg_dat(wk16_B0, 1, stencil_0_05, "double", OPS_READ),
...
char name0[80];
sprintf(name0, "opensbli_output_%06d.h5", (iter + 1)+100000);
