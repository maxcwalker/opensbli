...
__device__
 ...
 void opensbliblock00Kernel000_gpu(const ACC<double> &p_B0,
...
&wk3_B0)
{
   ...
   double beta_2 = 0.0;
   double CS_24 = 0.0;
   AVG_0_a = (rc13)*(a_B0(1,0) + a_B0(0,0));

   AVG_0_rho = (rc13)*(rho_B0(0,0) + rho_B0(1,0));

   AVG_0_u1 = (rc13)*(u1_B0(0,0) + u1_B0(1,0));

   AVG_0_u0 = (rc13)*(u0_B0(0,0) + u0_B0(1,0));

   AVG_0_D00 = (rc13)*(D00_B0(0,0) + D00_B0(1,0));

   AVG_0_D01 = (rc13)*(D01_B0(1,0) + D01_B0(0,0));
   ...
   max_lambda_0_11 = max_lambda_0_00;
    ...
    max_lambda_0_22 = fmax(fabs(sqrt(pow(D00_B0(2,0), 2) + pow(D01_B0(2,0), 2))*a_B0(2,0)
      ...
      fmax(fabs(sqrt(pow(D00_B0(1,0), 2) + pow(D01_B0(1,0), 2))*a_B0(1,0) +
      D00_B0(1,0)*u0_B0(1,0) + D01_B0(1,0)*u1_B0(1,0)),
      fabs(sqrt(pow(D00_B0(3,0), 2) + pow(D01_B0(3,0), 2))*a_B0(3,0) +
