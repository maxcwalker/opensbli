...
void opensbliblock00Kernel031_gpu(const ACC<double> &wk8_B0,
  ACC<double> &wk3_B0,
  const int *idx)
{
    wk3_B0(0,0) = inv_0*((idx[1] == 0) ? (
   -3*wk8_B0(0,2) + (rc7)*wk8_B0(0,3) -
      rc8*wk8_B0(0,0) - rc9*wk8_B0(0,4) + 4*wk8_B0(0,1)
)
: ((idx[1] == 1) ? (

      -rc9*wk8_B0(0,-1) - rc13*wk8_B0(0,2) + (rc10)*wk8_B0(0,3) -
      rc11*wk8_B0(0,0) + (rc12)*wk8_B0(0,1)
)
: (
   -rc14*wk8_B0(0,-1) +
      (rc10)*wk8_B0(0,-2) - rc10*wk8_B0(0,2) + (rc14)*wk8_B0(0,1)
)));
