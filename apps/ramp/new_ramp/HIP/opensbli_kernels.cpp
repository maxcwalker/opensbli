...
#define Rcorn Rcorn_OPSCONSTANT
__constant__ double Rcorn;
#define Lx Lx_OPSCONSTANT
__constant__ double Lx;
#define x0 x0_OPSCONSTANT
__constant__ double x0;
#define b b_OPSCONSTANT
__constant__ double b;
#define Rcurv Rcurv_OPSCONSTANT
__constant__ double Rcurv;
...
int size, char *dat, char const *name){
  ...
  if (!strcmp(name,"Rcorn")) {
    hipSafeCall(OPS_instance::getOPSInstance()->ostream(),hipMemcpyToSymbol(HIP_SYMBOL(Rcorn_OPSCONSTANT), dat, dim*size));
  }
  else
  if (!strcmp(name,"Lx")) {
    hipSafeCall(OPS_instance::getOPSInstance()->ostream(),hipMemcpyToSymbol(HIP_SYMBOL(Lx_OPSCONSTANT), dat, dim*size));
  }
  else
  if (!strcmp(name,"x0")) {
    hipSafeCall(OPS_instance::getOPSInstance()->ostream(),hipMemcpyToSymbol(HIP_SYMBOL(x0_OPSCONSTANT), dat, dim*size));
  }
  else
  if (!strcmp(name,"b")) {
  ...
  if (!strcmp(name,"Rcurv")) {
    hipSafeCall(OPS_instance::getOPSInstance()->ostream(),hipMemcpyToSymbol(HIP_SYMBOL(Rcurv_OPSCONSTANT), dat, dim*size));
  }
  else
