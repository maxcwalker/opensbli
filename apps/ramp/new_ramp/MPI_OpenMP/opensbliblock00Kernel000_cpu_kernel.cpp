...
void ops_par_loop_opensbliblock00Kernel000_execute(ops_kernel_descriptor *desc) {
  ...
  double * __restrict__ D00_B0_p = (double *)(args[9].data + base9);
  ...
  double * __restrict__ wk3_B0_p = (double *)(args[15].data + base15);
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
      const ACC<double> p_B0(xdim0_opensbliblock00Kernel000, p_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel000*1);
      const ACC<double> U0_B0(xdim1_opensbliblock00Kernel000, U0_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel000*1);
      const ACC<double> a_B0(xdim2_opensbliblock00Kernel000, a_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel000*1);
      const ACC<double> D01_B0(xdim3_opensbliblock00Kernel000, D01_B0_p + n_x*1 + n_y * xdim3_opensbliblock00Kernel000*1);
      const ACC<double> rho_B0(xdim4_opensbliblock00Kernel000, rho_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel000*1);
      ...
      const ACC<double> rhou0_B0(xdim7_opensbliblock00Kernel000, rhou0_B0_p + n_x*1 + n_y * xdim7_opensbliblock00Kernel000*1);
      const ACC<double> u1_B0(xdim8_opensbliblock00Kernel000, u1_B0_p + n_x*1 + n_y * xdim8_opensbliblock00Kernel000*1);
      const ACC<double> D00_B0(xdim9_opensbliblock00Kernel000, D00_B0_p + n_x*1 + n_y * xdim9_opensbliblock00Kernel000*1);
      const ACC<double> rhoE_B0(xdim10_opensbliblock00Kernel000, rhoE_B0_p + n_x*1 + n_y * xdim10_opensbliblock00Kernel000*1);
