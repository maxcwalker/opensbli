...
void ops_par_loop_opensbliblock00Kernel039_execute(ops_kernel_descriptor *desc) {
  ...
  double * __restrict__ wk9_B0_p = (double *)(args[0].data + base0);
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
      ...
      const ACC<double> wk9_B0(xdim0_opensbliblock00Kernel039, wk9_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel039*1);
