...
int size, char *dat, char const *name){
  ...
  if (!strcmp(name,"Rcorn")) {
    cutilSafeCall(OPS_instance::getOPSInstance()->ostream(),cudaMemcpyToSymbol(Rcorn, dat, dim*size));
  }
  else
  if (!strcmp(name,"Lx")) {
    cutilSafeCall(OPS_instance::getOPSInstance()->ostream(),cudaMemcpyToSymbol(Lx, dat, dim*size));
  }
  else
  if (!strcmp(name,"x0")) {
    cutilSafeCall(OPS_instance::getOPSInstance()->ostream(),cudaMemcpyToSymbol(x0, dat, dim*size));
  }
  else
  if (!strcmp(name,"b")) {
  ...
  if (!strcmp(name,"Rcurv")) {
    cutilSafeCall(OPS_instance::getOPSInstance()->ostream(),cudaMemcpyToSymbol(Rcurv, dat, dim*size));
  }
  else
