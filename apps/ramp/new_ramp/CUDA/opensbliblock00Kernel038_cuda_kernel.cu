  ...
  const int *idx)
{
   ...
   -rc36*T_B0(0,3) + (rc31)*T_B0(0,4) +
      (rc33)*T_B0(0,0) - rc34*T_B0(0,1) + (rc35)*T_B0(0,2)
)
: ((idx[1] == 1) ? (

      -rc10*T_B0(0,3) - rc18*T_B0(0,0) + (rc31)*T_B0(0,-1) + (rc13)*T_B0(0,1) +
      (rc23)*T_B0(0,2)
)
: (
   -rc37*T_B0(0,0) - rc10*T_B0(0,-2) +
      (rc7)*T_B0(0,-1) + (rc7)*T_B0(0,1) - rc10*T_B0(0,2)
)));
