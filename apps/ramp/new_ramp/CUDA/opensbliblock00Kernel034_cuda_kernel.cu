  ...
  const int *idx)
{
   ...
   -rc36*u1_B0(3,0) + (rc35)*u1_B0(2,0) -
      rc34*u1_B0(1,0) + (rc33)*u1_B0(0,0) + (rc31)*u1_B0(4,0)
)
: ((idx[0] == 1) ? (

      -rc10*u1_B0(3,0) + (rc23)*u1_B0(2,0) + (rc31)*u1_B0(-1,0) +
      (rc13)*u1_B0(1,0) - rc18*u1_B0(0,0)
)
: ((idx[0] == block0np0 - 1) ? (

      -rc34*u1_B0(-1,0) + (rc35)*u1_B0(-2,0) - rc36*u1_B0(-3,0) +
      (rc33)*u1_B0(0,0) + (rc31)*u1_B0(-4,0)
)
: ((idx[0] == block0np0 - 2) ? (

      (rc13)*u1_B0(-1,0) + (rc31)*u1_B0(1,0) + (rc23)*u1_B0(-2,0) -
      rc10*u1_B0(-3,0) - rc18*u1_B0(0,0)
)
: (
   -rc10*u1_B0(2,0) -
      rc10*u1_B0(-2,0) + (rc7)*u1_B0(1,0) + (rc7)*u1_B0(-1,0) -
      rc37*u1_B0(0,0)
)))));
