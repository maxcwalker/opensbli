  ...
  const int *idx)
{
   ...
   (rc32)*T_B0(0,4) - rc34*T_B0(0,3) +
      (rc35)*T_B0(0,2) - rc36*T_B0(0,1) + (rc37)*T_B0(0,0)
)
: ((idx[1] == 1) ? (

      -rc11*T_B0(0,3) + (rc32)*T_B0(0,-1) + (rc24)*T_B0(0,2) + (rc14)*T_B0(0,1)
      - rc19*T_B0(0,0)
)
: (
   -rc11*T_B0(0,-2) + (rc8)*T_B0(0,-1) -
      rc11*T_B0(0,2) + (rc8)*T_B0(0,1) - rc38*T_B0(0,0)
)));
