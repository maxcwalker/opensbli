...
void ops_par_loop_opensbliblock00Kernel090_execute(ops_kernel_descriptor *desc) {
  ...
  double * __restrict__ SD001_B0_p = (double *)(args[14].data + base14);
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
      ...
      const ACC<double> wk1_B0(xdim3_opensbliblock00Kernel090, wk1_B0_p + n_x*1 + n_y * xdim3_opensbliblock00Kernel090*1);
      const ACC<double> wk0_B0(xdim4_opensbliblock00Kernel090, wk0_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel090*1);
      const ACC<double> wk6_B0(xdim5_opensbliblock00Kernel090, wk6_B0_p + n_x*1 + n_y * xdim5_opensbliblock00Kernel090*1);
      ...
      ACC<double> SD001_B0(xdim14_opensbliblock00Kernel090, SD001_B0_p + n_x*1 + n_y * xdim14_opensbliblock00Kernel090*1);
