...
void ops_par_loop_opensbliblock00Kernel028_execute(ops_kernel_descriptor *desc) {
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
   ...
   (rc8)*u1_B0(0,3) - 3*u1_B0(0,2) +
      4*u1_B0(0,1) - rc9*u1_B0(0,4) - rc10*u1_B0(0,0)
)
: ((idx[1] == 1) ? (

      (rc11)*u1_B0(0,3) - rc14*u1_B0(0,2) - rc9*u1_B0(0,-1) + (rc13)*u1_B0(0,1)
      - rc12*u1_B0(0,0)
)
: (
   -rc11*u1_B0(0,2) + (rc15)*u1_B0(0,1) +
      (rc11)*u1_B0(0,-2) - rc15*u1_B0(0,-1)
)));
