...
void ops_par_loop_opensbliblock00Kernel064_execute(ops_kernel_descriptor *desc) {
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
   ...
   rhoE_B0(0,0) = Twall*rcinv16*rho_B0(0,0)/(gama*(gama - 1.0));
    ...
    Pwall = (gama - 1)*(-((rc14)*pow(rhou0_B0(0,0), 2) + (rc14)*pow(rhou1_B0(0,0),
   ...
   u13 = rhou1_B0(0,3)/rho_B0(0,3);
    ...
    T_above = pow(Minf, 2)*gama*(gama - 1)*(-((rc14)*pow(rhou0_B0(0,1), 2) +
      (rc14)*pow(rhou1_B0(0,1), 2))/rho_B0(0,1) + rhoE_B0(0,1))/rho_B0(0,1);
   ...
   rhoE_B0(0,-1) = rcinv6*Pwall + (rc14)*rho_halo_1*(pow(u01, 2) + pow(u11, 2));
   ...
   rhoE_B0(0,-2) = rcinv6*Pwall + (rc14)*rho_halo_2*(pow(u02, 2) + pow(u12, 2));
   ...
   rhoE_B0(0,-3) = rcinv6*Pwall + (rc14)*rho_halo_3*(pow(u03, 2) + pow(u13, 2));
