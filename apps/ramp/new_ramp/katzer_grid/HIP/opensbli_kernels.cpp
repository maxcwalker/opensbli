...
#define rcinv33 rcinv33_OPSCONSTANT
__constant__ double rcinv33;
...
int size, char *dat, char const *name){
  ...
  if (!strcmp(name,"rcinv33")) {
    hipSafeCall(OPS_instance::getOPSInstance()->ostream(),hipMemcpyToSymbol(HIP_SYMBOL(rcinv33_OPSCONSTANT), dat, dim*size));
  }
  else
  if (!strcmp(name,"rc34")) {
