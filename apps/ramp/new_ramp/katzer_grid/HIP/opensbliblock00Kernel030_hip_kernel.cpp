  ...
  const int *idx)
{
   ...
   (rc32)*u1_B0(4,0) - rc34*u1_B0(3,0) +
      (rc35)*u1_B0(2,0) - rc36*u1_B0(1,0) + (rc37)*u1_B0(0,0)
)
: ((idx[0] == 1) ? (

      (rc32)*u1_B0(-1,0) - rc11*u1_B0(3,0) + (rc24)*u1_B0(2,0) +
      (rc14)*u1_B0(1,0) - rc19*u1_B0(0,0)
)
: ((idx[0] == block0np0 - 1) ? (

      (rc35)*u1_B0(-2,0) - rc36*u1_B0(-1,0) - rc34*u1_B0(-3,0) +
      (rc32)*u1_B0(-4,0) + (rc37)*u1_B0(0,0)
)
: ((idx[0] == block0np0 - 2) ? (

      (rc24)*u1_B0(-2,0) + (rc14)*u1_B0(-1,0) - rc11*u1_B0(-3,0) +
      (rc32)*u1_B0(1,0) - rc19*u1_B0(0,0)
)
: (
   (rc8)*u1_B0(-1,0) -
      rc11*u1_B0(-2,0) - rc11*u1_B0(2,0) + (rc8)*u1_B0(1,0) -
      rc38*u1_B0(0,0)
)))));
