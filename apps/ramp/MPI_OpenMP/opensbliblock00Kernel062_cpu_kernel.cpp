...
void ops_par_loop_opensbliblock00Kernel062_execute(ops_kernel_descriptor *desc) {
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
      ...
      const ACC<double> Residual3_B0(xdim2_opensbliblock00Kernel062, Residual3_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel062*1);
      const ACC<double> Residual1_B0(xdim3_opensbliblock00Kernel062, Residual1_B0_p + n_x*1 + n_y * xdim3_opensbliblock00Kernel062*1);
      ACC<double> rho_B0(xdim4_opensbliblock00Kernel062, rho_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel062*1);
      ACC<double> tempRK_rho_B0(xdim5_opensbliblock00Kernel062, tempRK_rho_B0_p + n_x*1 + n_y * xdim5_opensbliblock00Kernel062*1);
      ACC<double> tempRK_rhou0_B0(xdim6_opensbliblock00Kernel062, tempRK_rhou0_B0_p + n_x*1 + n_y * xdim6_opensbliblock00Kernel062*1);
      ACC<double> rhou0_B0(xdim7_opensbliblock00Kernel062, rhou0_B0_p + n_x*1 + n_y * xdim7_opensbliblock00Kernel062*1);
      ACC<double> tempRK_rhoE_B0(xdim8_opensbliblock00Kernel062, tempRK_rhoE_B0_p + n_x*1 + n_y * xdim8_opensbliblock00Kernel062*1);
      ACC<double> rhoE_B0(xdim9_opensbliblock00Kernel062, rhoE_B0_p + n_x*1 + n_y * xdim9_opensbliblock00Kernel062*1);
      ACC<double> rhou1_B0(xdim10_opensbliblock00Kernel062, rhou1_B0_p + n_x*1 + n_y * xdim10_opensbliblock00Kernel062*1);
      ACC<double> tempRK_rhou1_B0(xdim11_opensbliblock00Kernel062, tempRK_rhou1_B0_p + n_x*1 + n_y * xdim11_opensbliblock00Kernel062*1);
