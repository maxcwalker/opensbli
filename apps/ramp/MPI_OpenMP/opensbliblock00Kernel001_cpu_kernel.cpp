...
void ops_par_loop_opensbliblock00Kernel001_execute(ops_kernel_descriptor *desc) {
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
      ...
      const ACC<double> u1_B0(xdim4_opensbliblock00Kernel001, u1_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel001*1);
      ...
      const ACC<double> rhoE_B0(xdim7_opensbliblock00Kernel001, rhoE_B0_p + n_x*1 + n_y * xdim7_opensbliblock00Kernel001*1);
