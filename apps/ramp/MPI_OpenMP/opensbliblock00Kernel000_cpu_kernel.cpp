...
void ops_par_loop_opensbliblock00Kernel000_execute(ops_kernel_descriptor *desc) {
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
      ...
      const ACC<double> rhou0_B0(xdim3_opensbliblock00Kernel000, rhou0_B0_p + n_x*1 + n_y * xdim3_opensbliblock00Kernel000*1);
      ...
      const ACC<double> rhou1_B0(xdim10_opensbliblock00Kernel000, rhou1_B0_p + n_x*1 + n_y * xdim10_opensbliblock00Kernel000*1);
      const ACC<double> U0_B0(xdim11_opensbliblock00Kernel000, U0_B0_p + n_x*1 + n_y * xdim11_opensbliblock00Kernel000*1);
