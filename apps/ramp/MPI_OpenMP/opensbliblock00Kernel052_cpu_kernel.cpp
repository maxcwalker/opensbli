...
void ops_par_loop_opensbliblock00Kernel052_execute(ops_kernel_descriptor *desc) {
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
      ...
      ACC<double> D00_B0(xdim4_opensbliblock00Kernel052, D00_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel052*1);
      ACC<double> D10_B0(xdim5_opensbliblock00Kernel052, D10_B0_p + n_x*1 + n_y * xdim5_opensbliblock00Kernel052*1);
      ACC<double> D11_B0(xdim6_opensbliblock00Kernel052, D11_B0_p + n_x*1 + n_y * xdim6_opensbliblock00Kernel052*1);
   ...
   double localeval_0 = 0.0;
    localeval_0 = ((idx[0] == 0) ? (
   inv_1*(-rc7*x1_B0(4,0) + (rc8)*x1_B0(3,0) -
      3*x1_B0(2,0) + 4*x1_B0(1,0) - rc9*x1_B0(0,0))
)
: ((idx[0] == 1) ? (

      (rc10)*inv_1*(-3*x1_B0(-1,0) + x1_B0(3,0) - 6*x1_B0(2,0) + 18*x1_B0(1,0) -
      10*x1_B0(0,0))
)
: ((idx[0] == block0np0 - 1) ? (
   inv_1*(3*x1_B0(-2,0) -
      4*x1_B0(-1,0) - rc8*x1_B0(-3,0) + (rc7)*x1_B0(-4,0) +
      (rc9)*x1_B0(0,0))
)
: ((idx[0] == block0np0 - 2) ? (
   (rc10)*inv_1*(6*x1_B0(-2,0) -
      18*x1_B0(-1,0) - x1_B0(-3,0) + 3*x1_B0(1,0) + 10*x1_B0(0,0))
)
: (

      (rc10)*inv_1*(x1_B0(-2,0) - x1_B0(2,0) - 8*x1_B0(-1,0) +
      8*x1_B0(1,0))
)))));

    localeval_1 = ((idx[1] == 0) ? (
   inv_0*(-rc7*x0_B0(0,4) + 4*x0_B0(0,1) -
      3*x0_B0(0,2) + (rc8)*x0_B0(0,3) - rc9*x0_B0(0,0))
)
: ((idx[1] == 1) ? (

      (rc10)*inv_0*(18*x0_B0(0,1) - 6*x0_B0(0,2) + x0_B0(0,3) - 3*x0_B0(0,-1) -
      10*x0_B0(0,0))
)
: (
   (rc10)*inv_0*(-8*x0_B0(0,-1) + x0_B0(0,-2) +
      8*x0_B0(0,1) - x0_B0(0,2))
)));

    localeval_2 = ((idx[0] == 0) ? (
   inv_1*(4*x0_B0(1,0) - 3*x0_B0(2,0) -
      rc7*x0_B0(4,0) + (rc8)*x0_B0(3,0) - rc9*x0_B0(0,0))
)
: ((idx[0] == 1) ? (

      (rc10)*inv_1*(18*x0_B0(1,0) - 6*x0_B0(2,0) + x0_B0(3,0) - 3*x0_B0(-1,0) -
      10*x0_B0(0,0))
)
: ((idx[0] == block0np0 - 1) ? (
   inv_1*(3*x0_B0(-2,0) +
      (rc7)*x0_B0(-4,0) - rc8*x0_B0(-3,0) - 4*x0_B0(-1,0) +
      (rc9)*x0_B0(0,0))
)
: ((idx[0] == block0np0 - 2) ? (
   (rc10)*inv_1*(3*x0_B0(1,0) +
      6*x0_B0(-2,0) - x0_B0(-3,0) - 18*x0_B0(-1,0) + 10*x0_B0(0,0))
)
: (

      (rc10)*inv_1*(8*x0_B0(1,0) - 8*x0_B0(-1,0) + x0_B0(-2,0) -
      x0_B0(2,0))
)))));

    localeval_3 = ((idx[1] == 0) ? (
   inv_0*((rc8)*x1_B0(0,3) - 3*x1_B0(0,2) +
      4*x1_B0(0,1) - rc7*x1_B0(0,4) - rc9*x1_B0(0,0))
)
: ((idx[1] == 1) ? (

      (rc10)*inv_0*(x1_B0(0,3) - 6*x1_B0(0,2) - 3*x1_B0(0,-1) + 18*x1_B0(0,1) -
      10*x1_B0(0,0))
)
: (
   (rc10)*inv_0*(-x1_B0(0,2) + 8*x1_B0(0,1) +
      x1_B0(0,-2) - 8*x1_B0(0,-1))
)));
   ...
   D01_B0(0,0) = -localeval_1/(-localeval_0*localeval_1 + localeval_2*localeval_3);

   D10_B0(0,0) = -localeval_0/(-localeval_0*localeval_1 + localeval_2*localeval_3);
