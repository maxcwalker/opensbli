...
{
int iteration_range_9_block0[] = {-3, block0np0 + 4, -3, block0np1 + 4}; ops_par_loop_opensbliblock00Kernel009("CRu1", opensbliblock00, 2, iteration_range_9_block0,
...
int iteration_range_12_block0[] = {-3, block0np0 + 4, -3, block0np1 + 4}; ops_par_loop_opensbliblock00Kernel012("CRu0", opensbliblock00, 2, iteration_range_12_block0,
             ops_arg_dat(rho_B0, 1, stencil_0_00, "double", OPS_READ),
...
int iteration_range_32_block0[] = {0, block0np0, 0, block0np1}; ops_par_loop_opensbliblock00Kernel032("Viscous CD u1_B0 xi1 xi1 ", opensbliblock00, 2, iteration_range_32_block0,
             ops_arg_dat(u1_B0, 1, stencil_0_05, "double", OPS_READ),
             ops_arg_dat(wk4_B0, 1, stencil_0_00, "double", OPS_WRITE),
             ops_arg_idx());

int iteration_range_33_block0[] = {0, block0np0, 0, block0np1}; ops_par_loop_opensbliblock00Kernel033("Viscous CD T_B0 xi1 xi1 ", opensbliblock00, 2, iteration_range_33_block0,
...
int iteration_range_39_block0[] = {0, block0np0, 0, block0np1}; ops_par_loop_opensbliblock00Kernel039("Viscous CD u1_B0 xi0 xi0 ", opensbliblock00, 2, iteration_range_39_block0,
             ops_arg_dat(u1_B0, 1, stencil_0_07, "double", OPS_READ),
             ops_arg_dat(wk11_B0, 1, stencil_0_00, "double", OPS_WRITE),
             ops_arg_idx());

int iteration_range_40_block0[] = {0, block0np0, -2, block0np1 + 2}; ops_par_loop_opensbliblock00Kernel040("Viscous CD T_B0 xi0 ", opensbliblock00, 2, iteration_range_40_block0,
             ops_arg_dat(T_B0, 1, stencil_0_06, "double", OPS_READ),
             ops_arg_dat(wk12_B0, 1, stencil_0_00, "double", OPS_WRITE),
             ops_arg_idx());

int iteration_range_41_block0[] = {0, block0np0, -2, block0np1 + 2}; ops_par_loop_opensbliblock00Kernel041("Viscous CD u1_B0 xi0 ", opensbliblock00, 2, iteration_range_41_block0,
