...
//user function
inline 
 void opensbliblock00Kernel004(const ptr_double rhoE_B0,
...
void opensbliblock00Kernel004_c_wrapper(
  ...
  for ( int n_y=0; n_y<y_size; n_y++ ){
    ...
    for ( int n_x=0; n_x<x_size; n_x++ ){
      ...
      ptr_double ptr4 = {  p_a4 + n_x*1*1 + n_y*xdim4_opensbliblock00Kernel004*1*1, xdim4_opensbliblock00Kernel004};
