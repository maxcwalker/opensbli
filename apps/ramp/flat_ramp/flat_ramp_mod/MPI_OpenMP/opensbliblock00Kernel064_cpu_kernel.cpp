...
void ops_par_loop_opensbliblock00Kernel064_execute(ops_kernel_descriptor *desc) {
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
   ...
   rhoE_B0(0,-1) = rcinv5*Pwall + (rc10)*rho_halo_1*(pow(u01, 2) + pow(u11, 2));
   ...
   rhoE_B0(0,-2) = rcinv5*Pwall + (rc10)*rho_halo_2*(pow(u02, 2) + pow(u12, 2));
   ...
   rhoE_B0(0,-3) = rcinv5*Pwall + (rc10)*rho_halo_3*(pow(u03, 2) + pow(u13, 2));
