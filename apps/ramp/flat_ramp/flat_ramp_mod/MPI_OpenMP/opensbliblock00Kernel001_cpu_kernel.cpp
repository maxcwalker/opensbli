...
void ops_par_loop_opensbliblock00Kernel001_execute(ops_kernel_descriptor *desc) {
  ...
  if (block->instance->OPS_diags > 1) {
    ops_timing_realloc(block->instance,31,"opensbliblock00Kernel001");
  ...
  double * __restrict__ wk7_B0_p = (double *)(args[15].data + base15);
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
      const ACC<double> a_B0(xdim0_opensbliblock00Kernel001, a_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel001*1);
      const ACC<double> rho_B0(xdim1_opensbliblock00Kernel001, rho_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel001*1);
      const ACC<double> p_B0(xdim2_opensbliblock00Kernel001, p_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel001*1);
      const ACC<double> u1_B0(xdim3_opensbliblock00Kernel001, u1_B0_p + n_x*1 + n_y * xdim3_opensbliblock00Kernel001*1);
      const ACC<double> D11_B0(xdim4_opensbliblock00Kernel001, D11_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel001*1);
      ...
      const ACC<double> u0_B0(xdim8_opensbliblock00Kernel001, u0_B0_p + n_x*1 + n_y * xdim8_opensbliblock00Kernel001*1);
      const ACC<double> detJ_B0(xdim9_opensbliblock00Kernel001, detJ_B0_p + n_x*1 + n_y * xdim9_opensbliblock00Kernel001*1);
      const ACC<double> rhoE_B0(xdim10_opensbliblock00Kernel001, rhoE_B0_p + n_x*1 + n_y * xdim10_opensbliblock00Kernel001*1);
      const ACC<double> D10_B0(xdim11_opensbliblock00Kernel001, D10_B0_p + n_x*1 + n_y * xdim11_opensbliblock00Kernel001*1);
      ...
      ACC<double> wk7_B0(xdim15_opensbliblock00Kernel001, wk7_B0_p + n_x*1 + n_y * xdim15_opensbliblock00Kernel001*1);
   ...
   double CF_22 = 0.0;
   double CS_33 = 0.0;
   AVG_1_u1 = (rc10)*(u1_B0(0,1) + u1_B0(0,0));

   AVG_1_rho = (rc10)*(rho_B0(0,0) + rho_B0(0,1));

   AVG_1_a = (rc10)*(a_B0(0,1) + a_B0(0,0));

   AVG_1_u0 = (rc10)*(u0_B0(0,0) + u0_B0(0,1));

   AVG_1_D10 = (rc10)*(D10_B0(0,0) + D10_B0(0,1));
   ...
   max_lambda_1_11 = max_lambda_1_00;
    ...
    max_lambda_1_22 = fmax(fabs(sqrt(pow(D10_B0(0,-2), 2) + pow(D11_B0(0,-2),
      ...
      D11_B0(0,2)*u1_B0(0,2)), fabs(sqrt(pow(D10_B0(0,1), 2) + pow(D11_B0(0,1),
