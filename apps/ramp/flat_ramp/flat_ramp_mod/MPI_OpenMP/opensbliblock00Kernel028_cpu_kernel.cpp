...
void ops_par_loop_opensbliblock00Kernel028_execute(ops_kernel_descriptor *desc) {
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
      ...
      const ACC<double> wk13_B0(xdim0_opensbliblock00Kernel028, wk13_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel028*1);
   ...
   4*wk13_B0(0,1) - rc7*wk13_B0(0,4) -
      rc9*wk13_B0(0,0) + (rc8)*wk13_B0(0,3) - 3*wk13_B0(0,2)
)
: ((idx[1] == 1) ? (

      (rc11)*wk13_B0(0,1) - rc13*wk13_B0(0,0) + (rc12)*wk13_B0(0,3) -
      rc10*wk13_B0(0,2) - rc7*wk13_B0(0,-1)
)
: (
   -rc12*wk13_B0(0,2) +
      (rc14)*wk13_B0(0,1) + (rc12)*wk13_B0(0,-2) - rc14*wk13_B0(0,-1)
)));
