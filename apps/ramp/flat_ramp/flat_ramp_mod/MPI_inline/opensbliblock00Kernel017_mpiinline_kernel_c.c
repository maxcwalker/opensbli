...
void opensbliblock00Kernel017_c_wrapper(
  ...
  for ( int n_y=0; n_y<y_size; n_y++ ){
    for ( int n_x=0; n_x<x_size; n_x++ ){
      ...
      const ptr_double wk3_B0 = { wk3_B0_p + n_x*1 + n_y * xdim8_opensbliblock00Kernel017*1, xdim8_opensbliblock00Kernel017};
    ...
    OPS_ACC(Residual2_B0, 0,0) = -(inv_0*(OPS_ACC(wk6_B0, 0,0) - OPS_ACC(wk6_B0, 0,-1)) +
      inv_2*(OPS_ACC(wk2_B0, 0,0) - OPS_ACC(wk2_B0, -1,0)))/OPS_ACC(detJ_B0, 0,0);
