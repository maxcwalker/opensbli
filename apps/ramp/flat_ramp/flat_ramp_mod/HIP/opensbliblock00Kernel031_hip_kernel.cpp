...
void opensbliblock00Kernel031_gpu(const ACC<double> &wk7_B0,
  ACC<double> &wk3_B0,
  const int *idx)
{
    wk3_B0(0,0) = inv_0*((idx[1] == 0) ? (
   -3*wk7_B0(0,2) + (rc8)*wk7_B0(0,3) -
      rc7*wk7_B0(0,4) - rc9*wk7_B0(0,0) + 4*wk7_B0(0,1)
)
: ((idx[1] == 1) ? (

      -rc10*wk7_B0(0,2) - rc7*wk7_B0(0,-1) + (rc12)*wk7_B0(0,3) -
      rc13*wk7_B0(0,0) + (rc11)*wk7_B0(0,1)
)
: (
   (rc14)*wk7_B0(0,1) -
      rc12*wk7_B0(0,2) + (rc12)*wk7_B0(0,-2) - rc14*wk7_B0(0,-1)
)));
