  ...
  ACC<double> &wk2_B0)
{
   ...
   double CF_22 = 0.0;
   double CS_33 = 0.0;
   AVG_0_u1 = (rc10)*(u1_B0(1,0) + u1_B0(0,0));

   AVG_0_rho = (rc10)*(rho_B0(1,0) + rho_B0(0,0));

   AVG_0_a = (rc10)*(a_B0(0,0) + a_B0(1,0));

   AVG_0_u0 = (rc10)*(u0_B0(1,0) + u0_B0(0,0));

   AVG_0_D00 = (rc10)*(D00_B0(0,0) + D00_B0(1,0));

   AVG_0_D01 = (rc10)*(D01_B0(0,0) + D01_B0(1,0));
   ...
   max_lambda_0_11 = max_lambda_0_00;
    ...
    max_lambda_0_22 = fmax(fabs(sqrt(pow(D00_B0(2,0), 2) + pow(D01_B0(2,0), 2))*a_B0(2,0)
...
void ops_par_loop_opensbliblock00Kernel000_execute(ops_kernel_descriptor *desc) {
  ...
  if (!ops_checkpointing_before(args,16,range,30)) return;
  #endif

  if (block->instance->OPS_diags > 1) {
    ops_timing_realloc(block->instance,30,"opensbliblock00Kernel000");
