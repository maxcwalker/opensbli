  ...
  const int *idx)
{
   ...
   -rc7*mu_B0(0,4) + (rc8)*mu_B0(0,3) -
      3*mu_B0(0,2) + 4*mu_B0(0,1) - rc9*mu_B0(0,0)
)
: ((idx[1] == 1) ? (

      (rc12)*mu_B0(0,3) - rc7*mu_B0(0,-1) - rc10*mu_B0(0,2) + (rc11)*mu_B0(0,1)
      - rc13*mu_B0(0,0)
)
: (
   (rc12)*mu_B0(0,-2) - rc14*mu_B0(0,-1) +
      (rc14)*mu_B0(0,1) - rc12*mu_B0(0,2)
)));
