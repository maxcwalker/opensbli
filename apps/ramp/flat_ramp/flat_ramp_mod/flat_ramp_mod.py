...
gridx1=parse_expr("Eq(DataObject(x1),Ly*sinh(b*block.deltas[1]*block.grid_indexes[1]/115.0)/sinh(b)+0.5*tramp*(block.deltas[0]*block.grid_indexes[0]+(aramp*Ly*sinh(b*block.deltas[1]*block.grid_indexes[1]/115.0)/sinh(b)+0.5*block.deltas[0])*(log(cosh((block.deltas[0]*block.grid_indexes[0]-xramp)/(aramp*Ly*sinh(b*block.deltas[1]*block.grid_indexes[1]/115.0)/sinh(b)+0.5*block.deltas[0])))-log(cosh(-xramp/(aramp*Ly*sinh(b*block.deltas[1]*block.grid_indexes[1]/115.0)/sinh(b)+0.5*block.deltas[0]))))))", local_dict=local_dict)
