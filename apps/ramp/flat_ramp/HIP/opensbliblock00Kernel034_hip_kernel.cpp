  ...
  const int *idx)
{
   ...
   3.00000000000002*u1_B0(1,0) -
      8.34657956545823e-15*u1_B0(4,0) + 1.06910315192207e-15*u1_B0(5,0) -
...
: ((idx[0] == 2) ? (
   0.521455851089587*u1_B0(1,0) -
      ...
      0.113446470384241*u1_B0(-2,0) - 0.00412637789557492*u1_B0(3,0) +
...
: ((idx[0] == block0np0 - 1) ? (
   (rc9)*u1_B0(-4,0) -
      rc8*u1_B0(-3,0) + 3*u1_B0(-2,0) - 4*u1_B0(-1,0) + (rc7)*u1_B0(0,0)
)
:
      ((idx[0] == block0np0 - 2) ? (
   (rc9)*u1_B0(1,0) - rc11*u1_B0(-3,0) -
      rc13*u1_B0(-1,0) + (rc12)*u1_B0(-2,0) + (rc10)*u1_B0(0,0)
)
: (

      -rc14*u1_B0(-1,0) + (rc14)*u1_B0(1,0) - rc11*u1_B0(2,0) +
      (rc11)*u1_B0(-2,0)
)))))));
