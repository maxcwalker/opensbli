...
&wk3_B0)
{
   ...
   AVG_0_0_LEV_33 = 0.707106781186547*gamma_m1*inv_AVG_a*inv_AVG_rho;
    ...
    max_lambda_0_00 = fmax(fabs(D00_B0(0,0)*u0_B0(0,0) +
      D01_B0(0,0)*u1_B0(0,0)), fmax(fabs(D00_B0(3,0)*u0_B0(3,0) +
   ...
   max_lambda_0_11 = max_lambda_0_00;
    ...
    max_lambda_0_22 = fmax(fabs(sqrt(pow(D00_B0(-2,0), 2) + pow(D01_B0(-2,0),
      ...
      D01_B0(3,0)*u1_B0(3,0)), fabs(sqrt(pow(D00_B0(2,0), 2) + pow(D01_B0(2,0),
      2))*a_B0(2,0) + D00_B0(2,0)*u0_B0(2,0) +
      D01_B0(2,0)*u1_B0(2,0)))))));
    ...
    max_lambda_0_33 = fmax(fabs(-sqrt(pow(D00_B0(-2,0), 2) + pow(D01_B0(-2,0),
      ...
      pow(D01_B0(3,0), 2))*a_B0(3,0) + D00_B0(3,0)*u0_B0(3,0) +
      D01_B0(3,0)*u1_B0(3,0)), fabs(-sqrt(pow(D00_B0(1,0), 2) + pow(D01_B0(1,0),
