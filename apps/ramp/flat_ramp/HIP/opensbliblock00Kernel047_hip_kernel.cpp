...
//
__constant__ int dims_opensbliblock00Kernel047 [5][1];
static int dims_opensbliblock00Kernel047_h [5][1] = {{0}};
...
&rhoE_B0)
{
   ...
   rhoE_B0(0,0) = Twall*rcinv11*rho_B0(0,0)/(gama*(gama - 1.0));
   ...
   rhoE_B0(0,-1) = rcinv5*Pwall + (rc12)*rho_halo_1*(pow(u01, 2) + pow(u11, 2));
   ...
   rhoE_B0(0,-2) = rcinv5*Pwall + (rc12)*rho_halo_2*(pow(u02, 2) + pow(u12, 2));
   ...
   rhoE_B0(0,-3) = rcinv5*Pwall + (rc12)*rho_halo_3*(pow(u03, 2) + pow(u13, 2));
