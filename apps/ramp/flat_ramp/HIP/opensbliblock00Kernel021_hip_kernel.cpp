...
//
__constant__ int dims_opensbliblock00Kernel021 [2][1];
static int dims_opensbliblock00Kernel021_h [2][1] = {{0}};

//user function
__device__

void opensbliblock00Kernel021_gpu(const ACC<double> &T_B0,
  ACC<double> &mu_B0)
{
...
int size1 ){
  ...
  if (idx_x < size0 && idx_y < size1) {
    ...
    opensbliblock00Kernel021_gpu(argp0, argp1);
  }
...
void ops_par_loop_opensbliblock00Kernel021_execute(ops_kernel_descriptor *desc) {
  ...
  if (x_size > 0 && y_size > 0)
    hipLaunchKernelGGL(ops_opensbliblock00Kernel021,grid ,tblock ,0 ,0 , (double *)p_a[0], (double *)p_a[1],x_size, y_size);
