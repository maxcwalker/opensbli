...
{
    wk2_B0(0,0) = ((idx[1] == 0) ? (
   inv_0*(-3*u1_B0(0,2) + 4*u1_B0(0,1) -
      rc9*u1_B0(0,0) - rc8*u1_B0(0,4) + (rc7)*u1_B0(0,3))
)
: ((idx[1] == 1) ? (

      (rc10)*inv_0*(-6*u1_B0(0,2) + 18*u1_B0(0,1) - 3*u1_B0(0,-1) -
      10*u1_B0(0,0) + u1_B0(0,3))
)
: (
   (rc10)*inv_0*(u1_B0(0,-2) -
      8*u1_B0(0,-1) - u1_B0(0,2) + 8*u1_B0(0,1))
)));
