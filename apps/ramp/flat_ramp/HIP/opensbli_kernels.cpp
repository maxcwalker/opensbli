...
#define rcinv31 rcinv31_OPSCONSTANT
__constant__ double rcinv31;
...
int size, char *dat, char const *name){
  ...
  if (!strcmp(name,"rcinv13")) {
    hipSafeCall(OPS_instance::getOPSInstance()->ostream(),hipMemcpyToSymbol(HIP_SYMBOL(rcinv13_OPSCONSTANT), dat, dim*size));
  }
  else
  if (!strcmp(name,"rc14")) {
  ...
  if (!strcmp(name,"rcinv31")) {
    hipSafeCall(OPS_instance::getOPSInstance()->ostream(),hipMemcpyToSymbol(HIP_SYMBOL(rcinv31_OPSCONSTANT), dat, dim*size));
  }
  else
