...
ops_decl_const("rcinv2" , 1, "double", &rcinv2);
ops_decl_const("rcinv3" , 1, "double", &rcinv3);
...
int stencil_0_02temp[] = {-2, 0, -1, 0, 0, 0, 1, 0, 2, 0, 3, 0};
ops_stencil stencil_0_02 = ops_decl_stencil(2,6,stencil_0_02temp,"stencil_0_02temp");
int stencil_0_03temp[] = {0, -2, 0, -1, 0, 0, 0, 1, 0, 2, 0, 3};
...
int iteration_range_47_block0[] = {-3, block0np0 + 4, -3, block0np1 + 4};
ops_par_loop(opensbliblock00Kernel047, "Grid_based_initialisation0", opensbliblock00, 2, iteration_range_47_block0,
...
int iteration_range_50_block0[] = {0, block0np0, 0, block0np1};
ops_par_loop(opensbliblock00Kernel050, "MetricsEquation evaluation", opensbliblock00, 2, iteration_range_50_block0,
...
int iteration_range_51_block0[] = {0, 1, -3, block0np1 + 4};
ops_par_loop(opensbliblock00Kernel051, "Metric boundary dir0 side0", opensbliblock00, 2, iteration_range_51_block0,
...
int iteration_range_52_block0[] = {block0np0 - 1, block0np0, -3, block0np1 + 4};
ops_par_loop(opensbliblock00Kernel052, "Metric boundary dir0 side1", opensbliblock00, 2, iteration_range_52_block0,
...
int iteration_range_53_block0[] = {-3, block0np0 + 4, 0, 1};
ops_par_loop(opensbliblock00Kernel053, "Metric boundary dir1 side0", opensbliblock00, 2, iteration_range_53_block0,
...
int iteration_range_54_block0[] = {-3, block0np0 + 4, block0np1 - 1, block0np1};
ops_par_loop(opensbliblock00Kernel054, "Metric boundary dir1 side1", opensbliblock00, 2, iteration_range_54_block0,
...
ops_par_loop(opensbliblock00Kernel059, "MetricsEquation evaluation", opensbliblock00, 2, iteration_range_59_block0,
...
ops_par_loop(opensbliblock00Kernel043, "InletTransfer boundary dir0 side0", opensbliblock00, 2, iteration_range_43_block0,
...
ops_par_loop(opensbliblock00Kernel044, "Extrapolation boundary dir0 side1", opensbliblock00, 2, iteration_range_44_block0,
...
ops_par_loop(opensbliblock00Kernel045, "IsothermalWall boundary dir1 side0", opensbliblock00, 2, iteration_range_45_block0,
...
ops_par_loop(opensbliblock00Kernel046, "ZeroGradientOutlet boundary dir1 side1", opensbliblock00, 2, iteration_range_46_block0,
...
ops_par_loop(opensbliblock00Kernel006, "CRu1", opensbliblock00, 2, iteration_range_6_block0,
...
ops_par_loop(opensbliblock00Kernel008, "CRp", opensbliblock00, 2, iteration_range_8_block0,
...
int iteration_range_11_block0[] = {-3, block0np0 + 4, 0, block0np1};
...
int iteration_range_31_block0[] = {-2, block0np0 + 2, -2, block0np1 + 2};
ops_par_loop(opensbliblock00Kernel031, "CRT_B0", opensbliblock00, 2, iteration_range_31_block0,
ops_arg_dat(rho_B0, 1, stencil_0_01, "double", OPS_READ),
ops_arg_dat(p_B0, 1, stencil_0_01, "double", OPS_READ),
...
ops_arg_dat(D10_B0, 1, stencil_0_03, "double", OPS_READ),
ops_arg_dat(u0_B0, 1, stencil_0_03, "double", OPS_READ),
ops_arg_dat(D11_B0, 1, stencil_0_03, "double", OPS_READ),
...
ops_arg_dat(wk7_B0, 1, stencil_0_05, "double", OPS_READ),
...
ops_arg_dat(wk4_B0, 1, stencil_0_05, "double", OPS_READ),
...
ops_par_loop(opensbliblock00Kernel024, "Derivative evaluation CD u0_B0 xi0 ", opensbliblock00, 2, iteration_range_24_block0,
ops_arg_dat(u0_B0, 1, stencil_0_06, "double", OPS_READ),
ops_arg_dat(wk0_B0, 1, stencil_0_01, "double", OPS_WRITE),
ops_arg_idx());


int iteration_range_26_block0[] = {0, block0np0, 0, block0np1};
ops_par_loop(opensbliblock00Kernel026, "Derivative evaluation CD u0_B0 xi1 ", opensbliblock00, 2, iteration_range_26_block0,
...
ops_par_loop(opensbliblock00Kernel027, "Derivative evaluation CD u1_B0 xi0 ", opensbliblock00, 2, iteration_range_27_block0,
...
ops_par_loop(opensbliblock00Kernel029, "Derivative evaluation CD u1_B0 xi1 ", opensbliblock00, 2, iteration_range_29_block0,
...
ops_par_loop(opensbliblock00Kernel032, "Derivative evaluation CD T_B0 xi1 ", opensbliblock00, 2, iteration_range_32_block0,
...
ops_par_loop(opensbliblock00Kernel039, "Convective terms", opensbliblock00, 2, iteration_range_39_block0,
ops_arg_dat(D01_B0, 1, stencil_0_01, "double", OPS_READ),
ops_arg_dat(tau11_B0, 1, stencil_0_00, "double", OPS_READ),
ops_arg_dat(wk3_B0, 1, stencil_0_01, "double", OPS_READ),
ops_arg_dat(u1_B0, 1, stencil_0_01, "double", OPS_READ),
ops_arg_dat(q0_B0, 1, stencil_0_00, "double", OPS_READ),
ops_arg_dat(q1_B0, 1, stencil_0_00, "double", OPS_READ),
ops_arg_dat(tau01_B0, 1, stencil_0_00, "double", OPS_READ),
ops_arg_dat(wk0_B0, 1, stencil_0_01, "double", OPS_READ),
ops_arg_dat(wk1_B0, 1, stencil_0_01, "double", OPS_READ),
ops_arg_dat(tau10_B0, 1, stencil_0_00, "double", OPS_READ),
...
ops_par_loop(opensbliblock00Kernel060, "Temporal solution advancement", opensbliblock00, 2, iteration_range_60_block0,
