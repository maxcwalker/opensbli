...
int base[] = {0, 0};
double* value = NULL;
q1_B0 = ops_decl_dat(opensbliblock00, 1, size, base, halo_m, halo_p, value, "double", "q1_B0");
}
...
int base[] = {0, 0};
double* value = NULL;
tau01_B0 = ops_decl_dat(opensbliblock00, 1, size, base, halo_m, halo_p, value, "double", "tau01_B0");
}
ops_dat tau10_B0;
{
int halo_p[] = {5, 5};
...
int base[] = {0, 0};
double* value = NULL;
tau10_B0 = ops_decl_dat(opensbliblock00, 1, size, base, halo_m, halo_p, value, "double", "tau10_B0");
}
ops_dat tau11_B0;
{
int halo_p[] = {5, 5};
...
int base[] = {0, 0};
double* value = NULL;
tau11_B0 = ops_decl_dat(opensbliblock00, 1, size, base, halo_m, halo_p, value, "double", "tau11_B0");
}
