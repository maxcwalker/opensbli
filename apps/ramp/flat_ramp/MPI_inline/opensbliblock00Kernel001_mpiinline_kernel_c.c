...
void opensbliblock00Kernel001_c_wrapper(
  ...
  for ( int n_y=0; n_y<y_size; n_y++ ){
    for ( int n_x=0; n_x<x_size; n_x++ ){
      ...
      const ptr_double p_B0 = { p_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel001*1, xdim1_opensbliblock00Kernel001};
      ...
      const ptr_double a_B0 = { a_B0_p + n_x*1 + n_y * xdim6_opensbliblock00Kernel001*1, xdim6_opensbliblock00Kernel001};
      ...
      const ptr_double detJ_B0 = { detJ_B0_p + n_x*1 + n_y * xdim10_opensbliblock00Kernel001*1, xdim10_opensbliblock00Kernel001};
   ...
   AVG_1_u0 = (rc12)*(OPS_ACC(u0_B0, 0,1) + OPS_ACC(u0_B0, 0,0));

   AVG_1_rho = (rc12)*(OPS_ACC(rho_B0, 0,0) + OPS_ACC(rho_B0, 0,1));

   AVG_1_u1 = (rc12)*(OPS_ACC(u1_B0, 0,1) + OPS_ACC(u1_B0, 0,0));

   AVG_1_a = (rc12)*(OPS_ACC(a_B0, 0,0) + OPS_ACC(a_B0, 0,1));

   AVG_1_D11 = (rc12)*(OPS_ACC(D11_B0, 0,0) + OPS_ACC(D11_B0, 0,1));

   AVG_1_D10 = (rc12)*(OPS_ACC(D10_B0, 0,1) + OPS_ACC(D10_B0, 0,0));
   ...
   max_lambda_1_11 = max_lambda_1_00;
    ...
    max_lambda_1_22 = fmax(fabs(sqrt(pow(OPS_ACC(D10_B0, 0,3), 2) + pow(OPS_ACC(D11_B0, 0,3), 2))*OPS_ACC(a_B0, 0,3)
