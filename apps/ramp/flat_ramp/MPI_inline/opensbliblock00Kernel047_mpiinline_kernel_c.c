...
void opensbliblock00Kernel047_c_wrapper(
  ...
  for ( int n_y=0; n_y<y_size; n_y++ ){
    for ( int n_x=0; n_x<x_size; n_x++ ){
      const ptr_double x0_B0 = { x0_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel047*1, xdim0_opensbliblock00Kernel047};
      ptr_double rhou1_B0 = { rhou1_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel047*1, xdim1_opensbliblock00Kernel047};
      ptr_double rhou0_B0 = { rhou0_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel047*1, xdim2_opensbliblock00Kernel047};
      ptr_double rho_B0 = { rho_B0_p + n_x*1 + n_y * xdim3_opensbliblock00Kernel047*1, xdim3_opensbliblock00Kernel047};
      ptr_double rhoE_B0 = { rhoE_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel047*1, xdim4_opensbliblock00Kernel047};
   ...
   OPS_ACC(rhoE_B0, 0,0) = Twall*rcinv11*OPS_ACC(rho_B0, 0,0)/(gama*(gama - 1.0));
   ...
   OPS_ACC(rhoE_B0, 0,-1) = rcinv5*Pwall + (rc12)*rho_halo_1*(pow(u01, 2) + pow(u11, 2));
   ...
   OPS_ACC(rhoE_B0, 0,-2) = rcinv5*Pwall + (rc12)*rho_halo_2*(pow(u02, 2) + pow(u12, 2));
   ...
   OPS_ACC(rhoE_B0, 0,-3) = rcinv5*Pwall + (rc12)*rho_halo_3*(pow(u03, 2) + pow(u13, 2));
