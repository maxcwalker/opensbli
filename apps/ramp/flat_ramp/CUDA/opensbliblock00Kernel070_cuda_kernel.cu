...
: ((idx[0] == block0np0 - 1) ? (
   (rc8)*x1_B0(-4,0) -
      4*x1_B0(-1,0) + 3*x1_B0(-2,0) + (rc7)*x1_B0(0,0) - rc9*x1_B0(-3,0)
)
:
      ((idx[0] == block0np0 - 2) ? (
   (rc10)*x1_B0(-2,0) - rc11*x1_B0(-1,0) +
      (rc8)*x1_B0(1,0) + (rc12)*x1_B0(0,0) - rc13*x1_B0(-3,0)
)
: (

      (rc14)*x1_B0(1,0) - rc14*x1_B0(-1,0) + (rc13)*x1_B0(-2,0) -
      rc13*x1_B0(2,0)
)))))));
