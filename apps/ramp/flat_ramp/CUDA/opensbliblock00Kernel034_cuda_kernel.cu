...
{
    wk4_B0(0,0) = ((idx[1] == 0) ? (
   inv_0*(4*T_B0(0,1) - 3*T_B0(0,2) +
      (rc7)*T_B0(0,3) - rc8*T_B0(0,4) - rc9*T_B0(0,0))
)
: ((idx[1] == 1) ? (

      (rc10)*inv_0*(18*T_B0(0,1) - 6*T_B0(0,2) + T_B0(0,3) - 10*T_B0(0,0) -
      3*T_B0(0,-1))
)
: (
   (rc10)*inv_0*(8*T_B0(0,1) - T_B0(0,2) + T_B0(0,-2)
      - 8*T_B0(0,-1))
)));
