  ...
  const int *idx)
{
   ...
   (rc9)*u1_B0(0,3) - rc8*u1_B0(0,4) -
      rc7*u1_B0(0,0) + 4*u1_B0(0,1) - 3*u1_B0(0,2)
)
: ((idx[1] == 1) ? (

      (rc13)*u1_B0(0,3) - rc12*u1_B0(0,0) - rc8*u1_B0(0,-1) + (rc11)*u1_B0(0,1)
      - rc10*u1_B0(0,2)
)
: (
   (rc14)*u1_B0(0,1) + (rc13)*u1_B0(0,-2) -
      rc13*u1_B0(0,2) - rc14*u1_B0(0,-1)
)));
