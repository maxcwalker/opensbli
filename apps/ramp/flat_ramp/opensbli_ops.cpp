...
int iteration_range_83_block0[] = {0, block0np0, 0, block0np1}; ops_par_loop_opensbliblock00Kernel083("MetricsEquation CD D11_B0 xi0 ", opensbliblock00, 2, iteration_range_83_block0,
...
int iteration_range_27_block0[] = {-2, block0np0 + 2, -2, block0np1 + 2}; ops_par_loop_opensbliblock00Kernel027("CRT_B0", opensbliblock00, 2, iteration_range_27_block0,
             ops_arg_dat(p_B0, 1, stencil_0_00, "double", OPS_READ),
             ops_arg_dat(rho_B0, 1, stencil_0_00, "double", OPS_READ),
             ops_arg_dat(T_B0, 1, stencil_0_00, "double", OPS_WRITE));

int iteration_range_24_block0[] = {-2, block0np0 + 2, -2, block0np1 + 2}; ops_par_loop_opensbliblock00Kernel024("CRmu_B0", opensbliblock00, 2, iteration_range_24_block0,
...
int iteration_range_28_block0[] = {0, block0np0, 0, block0np1}; ops_par_loop_opensbliblock00Kernel028("Viscous CD u0_B0 xi1 xi1 ", opensbliblock00, 2, iteration_range_28_block0,
...
int iteration_range_34_block0[] = {0, block0np0, 0, block0np1}; ops_par_loop_opensbliblock00Kernel034("Viscous CD T_B0 xi0 xi0 ", opensbliblock00, 2, iteration_range_34_block0,
             ops_arg_dat(T_B0, 1, stencil_0_07, "double", OPS_READ),
             ops_arg_dat(wk6_B0, 1, stencil_0_00, "double", OPS_WRITE),
             ops_arg_idx());

int iteration_range_35_block0[] = {0, block0np0, -2, block0np1 + 2}; ops_par_loop_opensbliblock00Kernel035("Viscous CD u0_B0 xi0 ", opensbliblock00, 2, iteration_range_35_block0,
             ops_arg_dat(u0_B0, 1, stencil_0_06, "double", OPS_READ),
             ops_arg_dat(wk7_B0, 1, stencil_0_00, "double", OPS_WRITE),
             ops_arg_idx());

int iteration_range_36_block0[] = {0, block0np0, 0, block0np1}; ops_par_loop_opensbliblock00Kernel036("Viscous CD u0_B0 xi1 ", opensbliblock00, 2, iteration_range_36_block0,
             ops_arg_dat(u0_B0, 1, stencil_0_05, "double", OPS_READ),
...
int iteration_range_41_block0[] = {0, block0np0, 0, block0np1}; ops_par_loop_opensbliblock00Kernel041("Viscous CD u1_B0 xi0 xi0 ", opensbliblock00, 2, iteration_range_41_block0,
             ops_arg_dat(u1_B0, 1, stencil_0_07, "double", OPS_READ),
             ops_arg_dat(wk13_B0, 1, stencil_0_00, "double", OPS_WRITE),
             ops_arg_idx());

int iteration_range_42_block0[] = {0, block0np0, 0, block0np1}; ops_par_loop_opensbliblock00Kernel042("Viscous CD mu_B0 xi1 ", opensbliblock00, 2, iteration_range_42_block0,
             ops_arg_dat(mu_B0, 1, stencil_0_05, "double", OPS_READ),
             ops_arg_dat(wk14_B0, 1, stencil_0_00, "double", OPS_WRITE),
             ops_arg_idx());

int iteration_range_44_block0[] = {0, block0np0, 0, block0np1}; ops_par_loop_opensbliblock00Kernel044("Viscous CD mu_B0 xi0 ", opensbliblock00, 2, iteration_range_44_block0,
