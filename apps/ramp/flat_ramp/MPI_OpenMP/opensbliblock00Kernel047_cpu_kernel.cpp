...
void ops_par_loop_opensbliblock00Kernel047_execute(ops_kernel_descriptor *desc) {
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
      ...
      ACC<double> rhou0_B0(xdim2_opensbliblock00Kernel047, rhou0_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel047*1);
      ACC<double> rho_B0(xdim3_opensbliblock00Kernel047, rho_B0_p + n_x*1 + n_y * xdim3_opensbliblock00Kernel047*1);
      ACC<double> rhoE_B0(xdim4_opensbliblock00Kernel047, rhoE_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel047*1);
