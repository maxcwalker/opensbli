...
void ops_par_loop_opensbliblock00Kernel000_execute(ops_kernel_descriptor *desc) {
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
      ...
      const ACC<double> rhou0_B0(xdim1_opensbliblock00Kernel000, rhou0_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel000*1);
      ...
      const ACC<double> a_B0(xdim6_opensbliblock00Kernel000, a_B0_p + n_x*1 + n_y * xdim6_opensbliblock00Kernel000*1);
      const ACC<double> rhou1_B0(xdim7_opensbliblock00Kernel000, rhou1_B0_p + n_x*1 + n_y * xdim7_opensbliblock00Kernel000*1);
      const ACC<double> D00_B0(xdim8_opensbliblock00Kernel000, D00_B0_p + n_x*1 + n_y * xdim8_opensbliblock00Kernel000*1);
      ...
      ACC<double> wk1_B0(xdim12_opensbliblock00Kernel000, wk1_B0_p + n_x*1 + n_y * xdim12_opensbliblock00Kernel000*1);
