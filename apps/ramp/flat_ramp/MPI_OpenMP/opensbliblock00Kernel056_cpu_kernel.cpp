...
void ops_par_loop_opensbliblock00Kernel056_execute(ops_kernel_descriptor *desc) {
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
      ACC<double> D10_B0(xdim0_opensbliblock00Kernel056, D10_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel056*1);
      ACC<double> D01_B0(xdim1_opensbliblock00Kernel056, D01_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel056*1);
      ACC<double> D00_B0(xdim2_opensbliblock00Kernel056, D00_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel056*1);
