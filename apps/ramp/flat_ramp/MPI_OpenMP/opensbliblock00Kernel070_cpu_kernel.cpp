...
void ops_par_loop_opensbliblock00Kernel070_execute(ops_kernel_descriptor *desc) {
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
   ...
   -1.83333333333334*x1_B0(0,0) +
      ...
      0.333333333333356*x1_B0(3,0) - 1.50000000000003*x1_B0(2,0) +
      3.00000000000002*x1_B0(1,0)
)
: ((idx[0] == 1) ? (
   -0.322484932882161*x1_B0(0,0) +
      0.00571369039775442*x1_B0(4,0) - 0.0658051057710389*x1_B0(3,0) +
      0.0394168524399447*x1_B0(2,0) - 0.376283677513354*x1_B0(-1,0) +
      0.719443173328855*x1_B0(1,0)
)
: ((idx[0] == 2) ? (
   0.197184333887745*x1_B0(0,0) -
      0.00412637789557492*x1_B0(3,0) - 0.0367146847001261*x1_B0(2,0) -
      0.791245592765872*x1_B0(-1,0) + 0.113446470384241*x1_B0(-2,0) +
      0.521455851089587*x1_B0(1,0)
)
: ((idx[0] == 3) ? (
   -0.00932597985049999*x1_B0(-3,0) +
      0.0451033223343881*x1_B0(0,0) - 0.082033432844602*x1_B0(2,0) +
      0.121937153224065*x1_B0(-2,0) - 0.727822147724592*x1_B0(-1,0) +
      0.652141084861241*x1_B0(1,0)
)
: ((idx[0] == block0np0 - 1) ? (
   -rc8*x1_B0(-3,0) +
      (rc7)*x1_B0(0,0) + (rc9)*x1_B0(-4,0) - 4*x1_B0(-1,0) + 3*x1_B0(-2,0)
)
:
      ((idx[0] == block0np0 - 2) ? (
   -rc11*x1_B0(-3,0) + (rc10)*x1_B0(0,0) +
      (rc12)*x1_B0(-2,0) - rc13*x1_B0(-1,0) + (rc9)*x1_B0(1,0)
)
: (

      -rc11*x1_B0(2,0) + (rc11)*x1_B0(-2,0) - rc14*x1_B0(-1,0) +
      (rc14)*x1_B0(1,0)
)))))));
