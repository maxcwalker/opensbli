...
void ops_par_loop_opensbliblock00Kernel001_execute(ops_kernel_descriptor *desc) {
  ...
  double * __restrict__ wk6_B0_p = (double *)(args[14].data + base14);
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
      const ACC<double> D10_B0(xdim0_opensbliblock00Kernel001, D10_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel001*1);
      ...
      const ACC<double> detJ_B0(xdim6_opensbliblock00Kernel001, detJ_B0_p + n_x*1 + n_y * xdim6_opensbliblock00Kernel001*1);
      const ACC<double> u0_B0(xdim7_opensbliblock00Kernel001, u0_B0_p + n_x*1 + n_y * xdim7_opensbliblock00Kernel001*1);
      const ACC<double> D11_B0(xdim8_opensbliblock00Kernel001, D11_B0_p + n_x*1 + n_y * xdim8_opensbliblock00Kernel001*1);
      const ACC<double> rhou0_B0(xdim9_opensbliblock00Kernel001, rhou0_B0_p + n_x*1 + n_y * xdim9_opensbliblock00Kernel001*1);
      const ACC<double> a_B0(xdim10_opensbliblock00Kernel001, a_B0_p + n_x*1 + n_y * xdim10_opensbliblock00Kernel001*1);
      const ACC<double> U1_B0(xdim11_opensbliblock00Kernel001, U1_B0_p + n_x*1 + n_y * xdim11_opensbliblock00Kernel001*1);
      ACC<double> wk7_B0(xdim12_opensbliblock00Kernel001, wk7_B0_p + n_x*1 + n_y * xdim12_opensbliblock00Kernel001*1);
      ACC<double> wk5_B0(xdim13_opensbliblock00Kernel001, wk5_B0_p + n_x*1 + n_y * xdim13_opensbliblock00Kernel001*1);
      ACC<double> wk6_B0(xdim14_opensbliblock00Kernel001, wk6_B0_p + n_x*1 + n_y * xdim14_opensbliblock00Kernel001*1);
   ...
   AVG_1_u0 = (rc12)*(u0_B0(0,0) + u0_B0(0,1));

   AVG_1_D11 = (rc12)*(D11_B0(0,1) + D11_B0(0,0));

   AVG_1_D10 = (rc12)*(D10_B0(0,0) + D10_B0(0,1));
   ...
   AVG_1_1_LEV_33 = 0.707106781186547*gamma_m1*inv_AVG_a*inv_AVG_rho;
    ...
    max_lambda_1_00 = fmax(fabs(D10_B0(0,2)*u0_B0(0,2) +
      ...
      D11_B0(0,1)*u1_B0(0,1)), fmax(fabs(D10_B0(0,0)*u0_B0(0,0) +
      D11_B0(0,0)*u1_B0(0,0)), fmax(fabs(D10_B0(0,-2)*u0_B0(0,-2) +
      D11_B0(0,-2)*u1_B0(0,-2)), fabs(D10_B0(0,-1)*u0_B0(0,-1) +
      D11_B0(0,-1)*u1_B0(0,-1)))))));

   max_lambda_1_11 = max_lambda_1_00;

    max_lambda_1_22 = fmax(fabs(sqrt(pow(D10_B0(0,-1), 2) + pow(D11_B0(0,-1),
      ...
      D11_B0(0,0)*u1_B0(0,0)), fabs(sqrt(pow(D10_B0(0,-2), 2) +
      pow(D11_B0(0,-2), 2))*a_B0(0,-2) + D10_B0(0,-2)*u0_B0(0,-2) +
    ...
    max_lambda_1_33 = fmax(fabs(-sqrt(pow(D10_B0(0,-2), 2) + pow(D11_B0(0,-2),
      ...
      D11_B0(0,2)*u1_B0(0,2)), fmax(fabs(-sqrt(pow(D10_B0(0,0), 2) +
      pow(D11_B0(0,0), 2))*a_B0(0,0) + D10_B0(0,0)*u0_B0(0,0) +
      D11_B0(0,0)*u1_B0(0,0)), fmax(fabs(-sqrt(pow(D10_B0(0,3), 2) +
      pow(D11_B0(0,3), 2))*a_B0(0,3) + D10_B0(0,3)*u0_B0(0,3) +
      D11_B0(0,3)*u1_B0(0,3)), fabs(-sqrt(pow(D10_B0(0,1), 2) + pow(D11_B0(0,1),
      2))*a_B0(0,1) + D10_B0(0,1)*u0_B0(0,1) +
      D11_B0(0,1)*u1_B0(0,1)))))));
