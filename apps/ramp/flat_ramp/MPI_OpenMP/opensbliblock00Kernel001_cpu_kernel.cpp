...
void ops_par_loop_opensbliblock00Kernel001_execute(ops_kernel_descriptor *desc) {
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
      ...
      const ACC<double> p_B0(xdim1_opensbliblock00Kernel001, p_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel001*1);
      ...
      const ACC<double> a_B0(xdim6_opensbliblock00Kernel001, a_B0_p + n_x*1 + n_y * xdim6_opensbliblock00Kernel001*1);
      ...
      const ACC<double> detJ_B0(xdim10_opensbliblock00Kernel001, detJ_B0_p + n_x*1 + n_y * xdim10_opensbliblock00Kernel001*1);
   ...
   AVG_1_u1 = (rc12)*(u1_B0(0,1) + u1_B0(0,0));

   AVG_1_a = (rc12)*(a_B0(0,0) + a_B0(0,1));

   AVG_1_D11 = (rc12)*(D11_B0(0,0) + D11_B0(0,1));
   ...
   max_lambda_1_11 = max_lambda_1_00;
    ...
    max_lambda_1_22 = fmax(fabs(sqrt(pow(D10_B0(0,3), 2) + pow(D11_B0(0,3), 2))*a_B0(0,3)
