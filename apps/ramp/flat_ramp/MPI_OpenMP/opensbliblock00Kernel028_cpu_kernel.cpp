...
void ops_par_loop_opensbliblock00Kernel028_execute(ops_kernel_descriptor *desc) {
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    wk0_B0(0,0) = ((idx[1] == 0) ? (
   inv_0*(4*u0_B0(0,1) - rc8*u0_B0(0,4) -
      rc9*u0_B0(0,0) + (rc7)*u0_B0(0,3) - 3*u0_B0(0,2))
)
: ((idx[1] == 1) ? (

      (rc10)*inv_0*(18*u0_B0(0,1) - 10*u0_B0(0,0) + u0_B0(0,3) - 6*u0_B0(0,2) -
      3*u0_B0(0,-1))
)
: (
   (rc10)*inv_0*(-u0_B0(0,2) + 8*u0_B0(0,1) +
