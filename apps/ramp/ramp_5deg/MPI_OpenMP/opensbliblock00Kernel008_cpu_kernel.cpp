...
void ops_par_loop_opensbliblock00Kernel008_execute(ops_kernel_descriptor *desc) {
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
      ...
      const ACC<double> D11_B0(xdim1_opensbliblock00Kernel008, D11_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel008*1);
      const ACC<double> u1_B0(xdim2_opensbliblock00Kernel008, u1_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel008*1);
      const ACC<double> D10_B0(xdim3_opensbliblock00Kernel008, D10_B0_p + n_x*1 + n_y * xdim3_opensbliblock00Kernel008*1);
      ACC<double> U1_B0(xdim4_opensbliblock00Kernel008, U1_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel008*1);
