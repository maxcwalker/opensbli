  ...
  const int *idx)
{
   ...
   -rc7*x1_B0(0,4) + 4*x1_B0(0,1) -
      rc8*x1_B0(0,0) + (rc9)*x1_B0(0,3) - 3*x1_B0(0,2)
)
: ((idx[1] == 1) ? (

      -rc7*x1_B0(0,-1) + (rc10)*x1_B0(0,1) - rc11*x1_B0(0,0) + (rc12)*x1_B0(0,3)
      - rc13*x1_B0(0,2)
)
: (
   (rc12)*x1_B0(0,-2) - rc14*x1_B0(0,-1) +
      (rc14)*x1_B0(0,1) - rc12*x1_B0(0,2)
)));
