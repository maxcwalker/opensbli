  ...
  const int *idx)
{
   ...
   -rc8*wk1_B0(0,0) + 4*wk1_B0(0,1) -
      3*wk1_B0(0,2) + (rc9)*wk1_B0(0,3) - rc7*wk1_B0(0,4)
)
: ((idx[1] == 1) ? (

      -rc11*wk1_B0(0,0) + (rc10)*wk1_B0(0,1) - rc13*wk1_B0(0,2) +
      (rc12)*wk1_B0(0,3) - rc7*wk1_B0(0,-1)
)
: (
   (rc14)*wk1_B0(0,1) -
      rc12*wk1_B0(0,2) + (rc12)*wk1_B0(0,-2) - rc14*wk1_B0(0,-1)
)));
