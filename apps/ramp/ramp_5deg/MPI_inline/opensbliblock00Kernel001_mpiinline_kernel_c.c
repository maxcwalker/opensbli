...
void opensbliblock00Kernel001_c_wrapper(
  ...
  for ( int n_y=0; n_y<y_size; n_y++ ){
    for ( int n_x=0; n_x<x_size; n_x++ ){
      ...
      const ptr_double rhoE_B0 = { rhoE_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel001*1, xdim1_opensbliblock00Kernel001};
      ...
      const ptr_double detJ_B0 = { detJ_B0_p + n_x*1 + n_y * xdim5_opensbliblock00Kernel001*1, xdim5_opensbliblock00Kernel001};
      ...
      ptr_double wk4_B0 = { wk4_B0_p + n_x*1 + n_y * xdim14_opensbliblock00Kernel001*1, xdim14_opensbliblock00Kernel001};
   ...
   AVG_1_u1 = (rc13)*(OPS_ACC(u1_B0, 0,0) + OPS_ACC(u1_B0, 0,1));

   AVG_1_rho = (rc13)*(OPS_ACC(rho_B0, 0,0) + OPS_ACC(rho_B0, 0,1));

   AVG_1_u0 = (rc13)*(OPS_ACC(u0_B0, 0,1) + OPS_ACC(u0_B0, 0,0));

   AVG_1_a = (rc13)*(OPS_ACC(a_B0, 0,0) + OPS_ACC(a_B0, 0,1));

   AVG_1_D11 = (rc13)*(OPS_ACC(D11_B0, 0,1) + OPS_ACC(D11_B0, 0,0));
   ...
   max_lambda_1_11 = max_lambda_1_00;
    ...
    max_lambda_1_33 = fmax(fabs(-sqrt(pow(OPS_ACC(D10_B0, 0,-2), 2) + pow(OPS_ACC(D11_B0, 0,-2),
      ...
      OPS_ACC(D11_B0, 0,3)*OPS_ACC(u1_B0, 0,3)), fabs(-sqrt(pow(OPS_ACC(D10_B0, 0,1), 2) +
      pow(OPS_ACC(D11_B0, 0,1), 2))*OPS_ACC(a_B0, 0,1) + OPS_ACC(D10_B0, 0,1)*OPS_ACC(u0_B0, 0,1) +
