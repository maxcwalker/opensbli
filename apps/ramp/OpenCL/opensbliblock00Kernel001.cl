...
ptr_double D11_B0,
  ...
  ptr_double wk4_B0,
  ptr_double wk7_B0,
  ptr_double wk6_B0, const double gama, const double gamma_m1, const double rc10, const double rc12, const double rc14, const double rc15, const double rc16, const double rc17, const double rc18, const double rc19, const double rc20, const double rc21, const double rc22, const double rc23, const double rc24, const double rc25, const double rc26, const double rc27, const double rc28, const double rc29, const double rc30, const double rcinv31)
{
   ...
   AVG_1_u1 = (rc12)*(OPS_ACCS(u1_B0, 0,0) + OPS_ACCS(u1_B0, 0,1));

   AVG_1_a = (rc12)*(OPS_ACCS(a_B0, 0,0) + OPS_ACCS(a_B0, 0,1));

   AVG_1_rho = (rc12)*(OPS_ACCS(rho_B0, 0,0) + OPS_ACCS(rho_B0, 0,1));

   AVG_1_D11 = (rc12)*(OPS_ACCS(D11_B0, 0,1) + OPS_ACCS(D11_B0, 0,0));
   ...
   AVG_1_1_LEV_33 = 0.707106781186547*gamma_m1*inv_AVG_a*inv_AVG_rho;
    ...
    max_lambda_1_00 = fmax(fabs(OPS_ACCS(D10_B0, 0,-2)*OPS_ACCS(u0_B0, 0,-2) +
      ...
      OPS_ACCS(D11_B0, 0,-1)*OPS_ACCS(u1_B0, 0,-1)), fmax(fabs(OPS_ACCS(D10_B0, 0,3)*OPS_ACCS(u0_B0, 0,3) +
      OPS_ACCS(D11_B0, 0,3)*OPS_ACCS(u1_B0, 0,3)), fmax(fabs(OPS_ACCS(D10_B0, 0,0)*OPS_ACCS(u0_B0, 0,0) +
      OPS_ACCS(D11_B0, 0,0)*OPS_ACCS(u1_B0, 0,0)), fmax(fabs(OPS_ACCS(D10_B0, 0,2)*OPS_ACCS(u0_B0, 0,2) +
   ...
   max_lambda_1_11 = max_lambda_1_00;
    ...
    max_lambda_1_22 = fmax(fabs(sqrt(pow(OPS_ACCS(D10_B0, 0,0), 2) + pow(OPS_ACCS(D11_B0, 0,0), 2))*OPS_ACCS(a_B0, 0,0)
