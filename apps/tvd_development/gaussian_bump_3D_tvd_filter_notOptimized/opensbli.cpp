...
ops_par_loop(opensbliblock00Kernel063, "Temporal solution advancement", opensbliblock00, 3, iteration_range_63_block0,
...
int iteration_range_58_block0[] = {-5, block0np0 + 5, -5, block0np1 + 5, -5, block0np2 + 5};
ops_par_loop(opensbliblock00Kernel058, "User kernel: Zero the work arrays", opensbliblock00, 3, iteration_range_58_block0,
ops_arg_dat(Residual0_B0, 1, stencil_0_00_00_00_3, "double", OPS_WRITE),
ops_arg_dat(Residual1_B0, 1, stencil_0_00_00_00_3, "double", OPS_WRITE),
ops_arg_dat(Residual2_B0, 1, stencil_0_00_00_00_3, "double", OPS_WRITE),
ops_arg_dat(Residual3_B0, 1, stencil_0_00_00_00_3, "double", OPS_WRITE),
...
int iteration_range_59_block0[] = {-1, block0np0 + 1, 0, block0np1, 0, block0np2};
ops_par_loop(opensbliblock00Kernel059, "User kernel: TVD reconstruction direction 0", opensbliblock00, 3, iteration_range_59_block0,
...
int iteration_range_60_block0[] = {0, block0np0, -1, block0np1 + 1, 0, block0np2};
ops_par_loop(opensbliblock00Kernel060, "User kernel: TVD reconstruction direction 1", opensbliblock00, 3, iteration_range_60_block0,
...
int iteration_range_61_block0[] = {0, block0np0, 0, block0np1, -1, block0np2 + 1};
ops_par_loop(opensbliblock00Kernel061, "User kernel: TVD reconstruction direction 2", opensbliblock00, 3, iteration_range_61_block0,
...
ops_par_loop(opensbliblock00Kernel062, "User kernel: Non-linear TVD Filter application", opensbliblock00, 3, iteration_range_62_block0,
