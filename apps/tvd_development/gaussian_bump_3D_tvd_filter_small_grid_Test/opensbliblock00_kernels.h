...
: (
 ...
 void opensbliblock00Kernel057(const ACC<double> &x0_B0, const ACC<double> &x1_B0, ACC<double> &D00_B0, ACC<double>
...
: (
 ...
 void opensbliblock00Kernel058(ACC<double> &D00_B0, ACC<double> &D01_B0, ACC<double> &D10_B0, ACC<double> &D11_B0,
ACC<double> &detJ_B0)
{
 ...
 void opensbliblock00Kernel059(ACC<double> &D00_B0, ACC<double> &D01_B0, ACC<double> &D10_B0, ACC<double> &D11_B0,
ACC<double> &detJ_B0)
{
   D00_B0(1,0,0) = D00_B0(-1,0,0);
 ...
 void opensbliblock00Kernel060(ACC<double> &D00_B0, ACC<double> &D01_B0, ACC<double> &D10_B0, ACC<double> &D11_B0,
ACC<double> &detJ_B0)
{
 ...
 void opensbliblock00Kernel061(ACC<double> &D00_B0, ACC<double> &D01_B0, ACC<double> &D10_B0, ACC<double> &D11_B0,
ACC<double> &detJ_B0)
{
   D00_B0(0,1,0) = D00_B0(0,-1,0);
 ...
 void opensbliblock00Kernel068(const ACC<double> &D00_B0, const ACC<double> &D01_B0, const ACC<double> &D10_B0, const
...
ACC<double> &rhou2_B0)
{
 ...
 void opensbliblock00Kernel050(const int *iter, const ACC<double> &x0_B0, const ACC<double> &x2_B0, ACC<double>
&rhoE_B0, ACC<double> &rho_B0, ACC<double> &rhou0_B0, ACC<double> &rhou1_B0, ACC<double> &rhou2_B0)
{
 ...
 void opensbliblock00Kernel051(ACC<double> &rhoE_B0, ACC<double> &rho_B0, ACC<double> &rhou0_B0, ACC<double> &rhou1_B0,
ACC<double> &rhou2_B0)
{
...
void opensbliblock00Kernel013(const ACC<double> &rho_B0, const ACC<double> &rhou2_B0, ACC<double> &u2_B0)
{
 ...
 void opensbliblock00Kernel025(const ACC<double> &rhoE_B0, const ACC<double> &rho_B0, const ACC<double> &u0_B0, const
ACC<double> &u1_B0, const ACC<double> &u2_B0, ACC<double> &p_B0)
{
 ...
 void opensbliblock00Kernel026(const ACC<double> &D00_B0, const ACC<double> &D01_B0, const ACC<double> &u0_B0, const
ACC<double> &u1_B0, ACC<double> &U0_B0)
{
 ...
 void opensbliblock00Kernel034(const ACC<double> &D10_B0, const ACC<double> &D11_B0, const ACC<double> &u0_B0, const
...
void opensbliblock00Kernel037(const ACC<double> &u2_B0, ACC<double> &U2_B0)
{
...
void opensbliblock00Kernel038(const ACC<double> &T_B0, ACC<double> &mu_B0)
{
   mu_B0(0,0,0) = T_B0(0,0,0)*sqrt(T_B0(0,0,0))*(1.0 + SuthT*invRefT)/(SuthT*invRefT + T_B0(0,0,0));

}

void opensbliblock00Kernel008(const ACC<double> &u0_B0, ACC<double> &wk0_B0, const int *idx)
{
   if (idx[0] == 0){
...
void opensbliblock00Kernel010(const ACC<double> &u1_B0, ACC<double> &wk1_B0, const int *idx)
{
   if (idx[0] == 0){
...
void opensbliblock00Kernel012(const ACC<double> &u2_B0, ACC<double> &wk2_B0, const int *idx)
{
   if (idx[0] == 0){
...
void opensbliblock00Kernel014(const ACC<double> &T_B0, ACC<double> &wk3_B0, const int *idx)
{
   if (idx[0] == 0){
...
void opensbliblock00Kernel016(const ACC<double> &u0_B0, ACC<double> &wk4_B0, const int *idx)
{
   if (idx[1] == 0){
...
void opensbliblock00Kernel017(const ACC<double> &u1_B0, ACC<double> &wk5_B0, const int *idx)
{
   if (idx[1] == 0){
...
void opensbliblock00Kernel018(const ACC<double> &u2_B0, ACC<double> &wk6_B0, const int *idx)
{
   if (idx[1] == 0){
...
void opensbliblock00Kernel019(const ACC<double> &T_B0, ACC<double> &wk7_B0, const int *idx)
{
   if (idx[1] == 0){
...
void opensbliblock00Kernel020(const ACC<double> &u0_B0, ACC<double> &wk8_B0)
{
...
void opensbliblock00Kernel021(const ACC<double> &u1_B0, ACC<double> &wk9_B0)
{
...
void opensbliblock00Kernel022(const ACC<double> &u2_B0, ACC<double> &wk10_B0)
{
...
void opensbliblock00Kernel023(const ACC<double> &T_B0, ACC<double> &wk11_B0)
{
...
ACC<double> &Residual2_B0, ACC<double> &Residual3_B0, ACC<double> &Residual4_B0, const int *idx)
{
 ...
 void opensbliblock00Kernel047(const ACC<double> &D00_B0, const ACC<double> &D01_B0, const ACC<double> &D10_B0, const
...
const int *idx)
{
 ...
 void opensbliblock00Kernel080(const ACC<double> &Residual0_B0, const ACC<double> &Residual1_B0, const ACC<double>
...
ACC<double> &u1_B0, ACC<double> &u2_B0, ACC<double> &p_B0)
{
 ...
 void opensbliblock00Kernel073(const ACC<double> &D00_B0, const ACC<double> &D01_B0, const ACC<double> &D10_B0, const
...
: (
 ...
 void opensbliblock00Kernel074(const ACC<double> &rhoE_B0, const ACC<double> &rho_B0, const ACC<double> &rhou0_B0, const
...
ACC<double> &u2_B0, ACC<double> &p_B0)
{
 ...
 void opensbliblock00Kernel075(ACC<double> &Residual0_B0, ACC<double> &Residual1_B0, ACC<double> &Residual2_B0,
...
ACC<double> &wk2_B0, ACC<double> &wk3_B0, ACC<double> &wk4_B0)
{
 ...
 void opensbliblock00Kernel076(const ACC<double> &D00_B0, const ACC<double> &D01_B0, const ACC<double> &a_B0, const
...
: (
 ...
 void opensbliblock00Kernel077(const ACC<double> &D10_B0, const ACC<double> &D11_B0, const ACC<double> &a_B0, const
ACC<double> &detJ_B0, const ACC<double> &rhoE_B0, const ACC<double> &rho_B0, const ACC<double> &rhou0_B0, const
ACC<double> &rhou1_B0, const ACC<double> &rhou2_B0, const ACC<double> &u0_B0, const ACC<double> &u1_B0, const
...
: (
 ...
 void opensbliblock00Kernel078(const ACC<double> &a_B0, const ACC<double> &detJ_B0, const ACC<double> &rhoE_B0, const
...
: (
 ...
 void opensbliblock00Kernel079(const ACC<double> &Residual0_B0, const ACC<double> &Residual1_B0, const ACC<double>
