  ...
  for ( int n_z=start2; n_z<end2; n_z++ ){
    for ( int n_y=start1; n_y<end1; n_y++ ){
      for ( int n_x=start0; n_x<end0; n_x++ ){
        ...
        const ACC<double> T_B0(xdim0_opensbliblock00Kernel014, ydim0_opensbliblock00Kernel014, T_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel014*1 + n_z * xdim0_opensbliblock00Kernel014 * ydim0_opensbliblock00Kernel014*1);
        ACC<double> wk3_B0(xdim1_opensbliblock00Kernel014, ydim1_opensbliblock00Kernel014, wk3_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel014*1 + n_z * xdim1_opensbliblock00Kernel014 * ydim1_opensbliblock00Kernel014*1);
