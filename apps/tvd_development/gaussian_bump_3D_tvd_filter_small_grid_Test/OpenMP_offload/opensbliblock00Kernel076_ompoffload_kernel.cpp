...
void ops_par_loop_opensbliblock00Kernel076_execute(ops_kernel_descriptor *desc) {
  ...
  double * __restrict__ wk4_B0_p = (double *)(args[16].data_d + base16);
  ...
  for ( int n_z=start2; n_z<end2; n_z++ ){
    for ( int n_y=start1; n_y<end1; n_y++ ){
      for ( int n_x=start0; n_x<end0; n_x++ ){
        const ACC<double> D00_B0(xdim0_opensbliblock00Kernel076, ydim0_opensbliblock00Kernel076, D00_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel076*1 + n_z * xdim0_opensbliblock00Kernel076 * ydim0_opensbliblock00Kernel076*1);
        const ACC<double> D01_B0(xdim1_opensbliblock00Kernel076, ydim1_opensbliblock00Kernel076, D01_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel076*1 + n_z * xdim1_opensbliblock00Kernel076 * ydim1_opensbliblock00Kernel076*1);
        const ACC<double> a_B0(xdim2_opensbliblock00Kernel076, ydim2_opensbliblock00Kernel076, a_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel076*1 + n_z * xdim2_opensbliblock00Kernel076 * ydim2_opensbliblock00Kernel076*1);
        const ACC<double> detJ_B0(xdim3_opensbliblock00Kernel076, ydim3_opensbliblock00Kernel076, detJ_B0_p + n_x*1 + n_y * xdim3_opensbliblock00Kernel076*1 + n_z * xdim3_opensbliblock00Kernel076 * ydim3_opensbliblock00Kernel076*1);
        const ACC<double> rhoE_B0(xdim4_opensbliblock00Kernel076, ydim4_opensbliblock00Kernel076, rhoE_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel076*1 + n_z * xdim4_opensbliblock00Kernel076 * ydim4_opensbliblock00Kernel076*1);
        const ACC<double> rho_B0(xdim5_opensbliblock00Kernel076, ydim5_opensbliblock00Kernel076, rho_B0_p + n_x*1 + n_y * xdim5_opensbliblock00Kernel076*1 + n_z * xdim5_opensbliblock00Kernel076 * ydim5_opensbliblock00Kernel076*1);
        const ACC<double> rhou0_B0(xdim6_opensbliblock00Kernel076, ydim6_opensbliblock00Kernel076, rhou0_B0_p + n_x*1 + n_y * xdim6_opensbliblock00Kernel076*1 + n_z * xdim6_opensbliblock00Kernel076 * ydim6_opensbliblock00Kernel076*1);
        const ACC<double> rhou1_B0(xdim7_opensbliblock00Kernel076, ydim7_opensbliblock00Kernel076, rhou1_B0_p + n_x*1 + n_y * xdim7_opensbliblock00Kernel076*1 + n_z * xdim7_opensbliblock00Kernel076 * ydim7_opensbliblock00Kernel076*1);
        const ACC<double> rhou2_B0(xdim8_opensbliblock00Kernel076, ydim8_opensbliblock00Kernel076, rhou2_B0_p + n_x*1 + n_y * xdim8_opensbliblock00Kernel076*1 + n_z * xdim8_opensbliblock00Kernel076 * ydim8_opensbliblock00Kernel076*1);
        const ACC<double> u0_B0(xdim9_opensbliblock00Kernel076, ydim9_opensbliblock00Kernel076, u0_B0_p + n_x*1 + n_y * xdim9_opensbliblock00Kernel076*1 + n_z * xdim9_opensbliblock00Kernel076 * ydim9_opensbliblock00Kernel076*1);
        const ACC<double> u1_B0(xdim10_opensbliblock00Kernel076, ydim10_opensbliblock00Kernel076, u1_B0_p + n_x*1 + n_y * xdim10_opensbliblock00Kernel076*1 + n_z * xdim10_opensbliblock00Kernel076 * ydim10_opensbliblock00Kernel076*1);
        const ACC<double> u2_B0(xdim11_opensbliblock00Kernel076, ydim11_opensbliblock00Kernel076, u2_B0_p + n_x*1 + n_y * xdim11_opensbliblock00Kernel076*1 + n_z * xdim11_opensbliblock00Kernel076 * ydim11_opensbliblock00Kernel076*1);
        ACC<double> wk0_B0(xdim12_opensbliblock00Kernel076, ydim12_opensbliblock00Kernel076, wk0_B0_p + n_x*1 + n_y * xdim12_opensbliblock00Kernel076*1 + n_z * xdim12_opensbliblock00Kernel076 * ydim12_opensbliblock00Kernel076*1);
        ACC<double> wk1_B0(xdim13_opensbliblock00Kernel076, ydim13_opensbliblock00Kernel076, wk1_B0_p + n_x*1 + n_y * xdim13_opensbliblock00Kernel076*1 + n_z * xdim13_opensbliblock00Kernel076 * ydim13_opensbliblock00Kernel076*1);
        ACC<double> wk2_B0(xdim14_opensbliblock00Kernel076, ydim14_opensbliblock00Kernel076, wk2_B0_p + n_x*1 + n_y * xdim14_opensbliblock00Kernel076*1 + n_z * xdim14_opensbliblock00Kernel076 * ydim14_opensbliblock00Kernel076*1);
        ACC<double> wk3_B0(xdim15_opensbliblock00Kernel076, ydim15_opensbliblock00Kernel076, wk3_B0_p + n_x*1 + n_y * xdim15_opensbliblock00Kernel076*1 + n_z * xdim15_opensbliblock00Kernel076 * ydim15_opensbliblock00Kernel076*1);
        ACC<double> wk4_B0(xdim16_opensbliblock00Kernel076, ydim16_opensbliblock00Kernel076, wk4_B0_p + n_x*1 + n_y * xdim16_opensbliblock00Kernel076*1 + n_z * xdim16_opensbliblock00Kernel076 * ydim16_opensbliblock00Kernel076*1);
...
void ops_par_loop_opensbliblock00Kernel076(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg16) {
  ...
  create_kerneldesc_and_enque(name, args, 17, 39, dim, 0, range, block, ops_par_loop_opensbliblock00Kernel076_execute);
}
#endif
