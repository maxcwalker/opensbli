...
void ops_par_loop_opensbliblock00Kernel046_execute(ops_kernel_descriptor *desc) {
  ...
  double * __restrict__ detJ_B0_p = (double *)(args[7].data_d + base7);

  int base8 = args[8].dat->base_offset;
  double * __restrict__ p_B0_p = (double *)(args[8].data_d + base8);

  int base9 = args[9].dat->base_offset;
  double * __restrict__ rhoE_B0_p = (double *)(args[9].data_d + base9);

  int base10 = args[10].dat->base_offset;
  double * __restrict__ rho_B0_p = (double *)(args[10].data_d + base10);

  int base11 = args[11].dat->base_offset;
  double * __restrict__ rhou0_B0_p = (double *)(args[11].data_d + base11);

  int base12 = args[12].dat->base_offset;
  double * __restrict__ rhou1_B0_p = (double *)(args[12].data_d + base12);

  int base13 = args[13].dat->base_offset;
  double * __restrict__ rhou2_B0_p = (double *)(args[13].data_d + base13);

  int base14 = args[14].dat->base_offset;
  double * __restrict__ Residual0_B0_p = (double *)(args[14].data_d + base14);

  int base15 = args[15].dat->base_offset;
  double * __restrict__ Residual1_B0_p = (double *)(args[15].data_d + base15);

  int base16 = args[16].dat->base_offset;
  double * __restrict__ Residual2_B0_p = (double *)(args[16].data_d + base16);

  int base17 = args[17].dat->base_offset;
  double * __restrict__ Residual3_B0_p = (double *)(args[17].data_d + base17);

  int base18 = args[18].dat->base_offset;
  double * __restrict__ Residual4_B0_p = (double *)(args[18].data_d + base18);
  ...
  for ( int n_z=start2; n_z<end2; n_z++ ){
    for ( int n_y=start1; n_y<end1; n_y++ ){
      for ( int n_x=start0; n_x<end0; n_x++ ){
        ...
        const ACC<double> D00_B0(xdim0_opensbliblock00Kernel046, ydim0_opensbliblock00Kernel046, D00_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel046*1 + n_z * xdim0_opensbliblock00Kernel046 * ydim0_opensbliblock00Kernel046*1);
        const ACC<double> D01_B0(xdim1_opensbliblock00Kernel046, ydim1_opensbliblock00Kernel046, D01_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel046*1 + n_z * xdim1_opensbliblock00Kernel046 * ydim1_opensbliblock00Kernel046*1);
        const ACC<double> D10_B0(xdim2_opensbliblock00Kernel046, ydim2_opensbliblock00Kernel046, D10_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel046*1 + n_z * xdim2_opensbliblock00Kernel046 * ydim2_opensbliblock00Kernel046*1);
        const ACC<double> D11_B0(xdim3_opensbliblock00Kernel046, ydim3_opensbliblock00Kernel046, D11_B0_p + n_x*1 + n_y * xdim3_opensbliblock00Kernel046*1 + n_z * xdim3_opensbliblock00Kernel046 * ydim3_opensbliblock00Kernel046*1);
        const ACC<double> U0_B0(xdim4_opensbliblock00Kernel046, ydim4_opensbliblock00Kernel046, U0_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel046*1 + n_z * xdim4_opensbliblock00Kernel046 * ydim4_opensbliblock00Kernel046*1);
        const ACC<double> U1_B0(xdim5_opensbliblock00Kernel046, ydim5_opensbliblock00Kernel046, U1_B0_p + n_x*1 + n_y * xdim5_opensbliblock00Kernel046*1 + n_z * xdim5_opensbliblock00Kernel046 * ydim5_opensbliblock00Kernel046*1);
        const ACC<double> U2_B0(xdim6_opensbliblock00Kernel046, ydim6_opensbliblock00Kernel046, U2_B0_p + n_x*1 + n_y * xdim6_opensbliblock00Kernel046*1 + n_z * xdim6_opensbliblock00Kernel046 * ydim6_opensbliblock00Kernel046*1);
        const ACC<double> detJ_B0(xdim7_opensbliblock00Kernel046, ydim7_opensbliblock00Kernel046, detJ_B0_p + n_x*1 + n_y * xdim7_opensbliblock00Kernel046*1 + n_z * xdim7_opensbliblock00Kernel046 * ydim7_opensbliblock00Kernel046*1);
        const ACC<double> p_B0(xdim8_opensbliblock00Kernel046, ydim8_opensbliblock00Kernel046, p_B0_p + n_x*1 + n_y * xdim8_opensbliblock00Kernel046*1 + n_z * xdim8_opensbliblock00Kernel046 * ydim8_opensbliblock00Kernel046*1);
        const ACC<double> rhoE_B0(xdim9_opensbliblock00Kernel046, ydim9_opensbliblock00Kernel046, rhoE_B0_p + n_x*1 + n_y * xdim9_opensbliblock00Kernel046*1 + n_z * xdim9_opensbliblock00Kernel046 * ydim9_opensbliblock00Kernel046*1);
        const ACC<double> rho_B0(xdim10_opensbliblock00Kernel046, ydim10_opensbliblock00Kernel046, rho_B0_p + n_x*1 + n_y * xdim10_opensbliblock00Kernel046*1 + n_z * xdim10_opensbliblock00Kernel046 * ydim10_opensbliblock00Kernel046*1);
        const ACC<double> rhou0_B0(xdim11_opensbliblock00Kernel046, ydim11_opensbliblock00Kernel046, rhou0_B0_p + n_x*1 + n_y * xdim11_opensbliblock00Kernel046*1 + n_z * xdim11_opensbliblock00Kernel046 * ydim11_opensbliblock00Kernel046*1);
        const ACC<double> rhou1_B0(xdim12_opensbliblock00Kernel046, ydim12_opensbliblock00Kernel046, rhou1_B0_p + n_x*1 + n_y * xdim12_opensbliblock00Kernel046*1 + n_z * xdim12_opensbliblock00Kernel046 * ydim12_opensbliblock00Kernel046*1);
        const ACC<double> rhou2_B0(xdim13_opensbliblock00Kernel046, ydim13_opensbliblock00Kernel046, rhou2_B0_p + n_x*1 + n_y * xdim13_opensbliblock00Kernel046*1 + n_z * xdim13_opensbliblock00Kernel046 * ydim13_opensbliblock00Kernel046*1);
        ACC<double> Residual0_B0(xdim14_opensbliblock00Kernel046, ydim14_opensbliblock00Kernel046, Residual0_B0_p + n_x*1 + n_y * xdim14_opensbliblock00Kernel046*1 + n_z * xdim14_opensbliblock00Kernel046 * ydim14_opensbliblock00Kernel046*1);
        ACC<double> Residual1_B0(xdim15_opensbliblock00Kernel046, ydim15_opensbliblock00Kernel046, Residual1_B0_p + n_x*1 + n_y * xdim15_opensbliblock00Kernel046*1 + n_z * xdim15_opensbliblock00Kernel046 * ydim15_opensbliblock00Kernel046*1);
        ACC<double> Residual2_B0(xdim16_opensbliblock00Kernel046, ydim16_opensbliblock00Kernel046, Residual2_B0_p + n_x*1 + n_y * xdim16_opensbliblock00Kernel046*1 + n_z * xdim16_opensbliblock00Kernel046 * ydim16_opensbliblock00Kernel046*1);
        ACC<double> Residual3_B0(xdim17_opensbliblock00Kernel046, ydim17_opensbliblock00Kernel046, Residual3_B0_p + n_x*1 + n_y * xdim17_opensbliblock00Kernel046*1 + n_z * xdim17_opensbliblock00Kernel046 * ydim17_opensbliblock00Kernel046*1);
        ACC<double> Residual4_B0(xdim18_opensbliblock00Kernel046, ydim18_opensbliblock00Kernel046, Residual4_B0_p + n_x*1 + n_y * xdim18_opensbliblock00Kernel046*1 + n_z * xdim18_opensbliblock00Kernel046 * ydim18_opensbliblock00Kernel046*1);
...
void ops_par_loop_opensbliblock00Kernel046(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg16, ops_arg arg17, ops_arg arg18, ops_arg arg19) {
  ...
  create_kerneldesc_and_enque(name, args, 20, 32, dim, 0, range, block, ops_par_loop_opensbliblock00Kernel046_execute);
}
#endif
