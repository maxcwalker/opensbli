...
void ops_par_loop_opensbliblock00Kernel028_execute(ops_kernel_descriptor *desc) {
  ...
  int ydim5_opensbliblock00Kernel028 = args[5].dat->size[1];
  ...
  for ( int n_z=start2; n_z<end2; n_z++ ){
    for ( int n_y=start1; n_y<end1; n_y++ ){
      for ( int n_x=start0; n_x<end0; n_x++ ){
        const ACC<double> rhoE_B0(xdim0_opensbliblock00Kernel028, ydim0_opensbliblock00Kernel028, rhoE_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel028*1 + n_z * xdim0_opensbliblock00Kernel028 * ydim0_opensbliblock00Kernel028*1);
        const ACC<double> rho_B0(xdim1_opensbliblock00Kernel028, ydim1_opensbliblock00Kernel028, rho_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel028*1 + n_z * xdim1_opensbliblock00Kernel028 * ydim1_opensbliblock00Kernel028*1);
        const ACC<double> u0_B0(xdim2_opensbliblock00Kernel028, ydim2_opensbliblock00Kernel028, u0_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel028*1 + n_z * xdim2_opensbliblock00Kernel028 * ydim2_opensbliblock00Kernel028*1);
        const ACC<double> u1_B0(xdim3_opensbliblock00Kernel028, ydim3_opensbliblock00Kernel028, u1_B0_p + n_x*1 + n_y * xdim3_opensbliblock00Kernel028*1 + n_z * xdim3_opensbliblock00Kernel028 * ydim3_opensbliblock00Kernel028*1);
        const ACC<double> u2_B0(xdim4_opensbliblock00Kernel028, ydim4_opensbliblock00Kernel028, u2_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel028*1 + n_z * xdim4_opensbliblock00Kernel028 * ydim4_opensbliblock00Kernel028*1);
        ACC<double> p_B0(xdim5_opensbliblock00Kernel028, ydim5_opensbliblock00Kernel028, p_B0_p + n_x*1 + n_y * xdim5_opensbliblock00Kernel028*1 + n_z * xdim5_opensbliblock00Kernel028 * ydim5_opensbliblock00Kernel028*1);
...
void ops_par_loop_opensbliblock00Kernel028(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4, ops_arg arg5) {
  ...
  create_kerneldesc_and_enque(name, args, 6, 15, dim, 0, range, block, ops_par_loop_opensbliblock00Kernel028_execute);
}
#endif
