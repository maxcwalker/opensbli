  ...
  for ( int n_z=start2; n_z<end2; n_z++ ){
    for ( int n_y=start1; n_y<end1; n_y++ ){
      for ( int n_x=start0; n_x<end0; n_x++ ){
        const ACC<double> D00_B0(xdim0_opensbliblock00Kernel026, ydim0_opensbliblock00Kernel026, D00_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel026*1 + n_z * xdim0_opensbliblock00Kernel026 * ydim0_opensbliblock00Kernel026*1);
        const ACC<double> D01_B0(xdim1_opensbliblock00Kernel026, ydim1_opensbliblock00Kernel026, D01_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel026*1 + n_z * xdim1_opensbliblock00Kernel026 * ydim1_opensbliblock00Kernel026*1);
        const ACC<double> u0_B0(xdim2_opensbliblock00Kernel026, ydim2_opensbliblock00Kernel026, u0_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel026*1 + n_z * xdim2_opensbliblock00Kernel026 * ydim2_opensbliblock00Kernel026*1);
        const ACC<double> u1_B0(xdim3_opensbliblock00Kernel026, ydim3_opensbliblock00Kernel026, u1_B0_p + n_x*1 + n_y * xdim3_opensbliblock00Kernel026*1 + n_z * xdim3_opensbliblock00Kernel026 * ydim3_opensbliblock00Kernel026*1);
        ACC<double> U0_B0(xdim4_opensbliblock00Kernel026, ydim4_opensbliblock00Kernel026, U0_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel026*1 + n_z * xdim4_opensbliblock00Kernel026 * ydim4_opensbliblock00Kernel026*1);
...
void ops_par_loop_opensbliblock00Kernel026(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4) {
  ...
  create_kerneldesc_and_enque(name, args, 5, 15, dim, 0, range, block, ops_par_loop_opensbliblock00Kernel026_execute);
}
#endif
