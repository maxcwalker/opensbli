...
if (restart == 0){
int iteration_range_54_block0[] = {-5, block0np0 + 5, -5, block0np1 + 5, -5, block0np2 + 5};
ops_par_loop(opensbliblock00Kernel054, "Similiarity solution laminar boundary-layer initialisation0", opensbliblock00, 3, iteration_range_54_block0,
...
ops_par_loop(opensbliblock00Kernel057, "MetricsEquation evaluation", opensbliblock00, 3, iteration_range_57_block0,
...
int iteration_range_58_block0[] = {0, 1, -2, block0np1 + 2, -2, block0np2 + 2};
ops_par_loop(opensbliblock00Kernel058, "Metric_copy_block0 boundary dir0 side0", opensbliblock00, 3, iteration_range_58_block0,
...
int iteration_range_59_block0[] = {block0np0 - 1, block0np0, -2, block0np1 + 2, -2, block0np2 + 2};
ops_par_loop(opensbliblock00Kernel059, "Metric_copy_block0 boundary dir0 side1", opensbliblock00, 3, iteration_range_59_block0,
ops_arg_dat(D00_B0, 1, stencil_0_22_00_00_8, "double", OPS_RW),
ops_arg_dat(D01_B0, 1, stencil_0_22_00_00_8, "double", OPS_RW),
ops_arg_dat(D10_B0, 1, stencil_0_22_00_00_8, "double", OPS_RW),
ops_arg_dat(D11_B0, 1, stencil_0_22_00_00_8, "double", OPS_RW),
...
int iteration_range_60_block0[] = {-2, block0np0 + 2, 0, 1, -2, block0np2 + 2};
ops_par_loop(opensbliblock00Kernel060, "Metric_copy_block0 boundary dir1 side0", opensbliblock00, 3, iteration_range_60_block0,
...
int iteration_range_61_block0[] = {-2, block0np0 + 2, block0np1 - 1, block0np1, -2, block0np2 + 2};
ops_par_loop(opensbliblock00Kernel061, "Metric_copy_block0 boundary dir1 side1", opensbliblock00, 3, iteration_range_61_block0,
ops_arg_dat(D00_B0, 1, stencil_0_00_22_00_8, "double", OPS_RW),
ops_arg_dat(D01_B0, 1, stencil_0_00_22_00_8, "double", OPS_RW),
ops_arg_dat(D10_B0, 1, stencil_0_00_22_00_8, "double", OPS_RW),
ops_arg_dat(D11_B0, 1, stencil_0_00_22_00_8, "double", OPS_RW),
...
ops_halo_transfer(periodicBC_direction2_side0_62_block0);
ops_halo_transfer(periodicBC_direction2_side1_63_block0);
int iteration_range_68_block0[] = {0, block0np0, 0, block0np1, 0, block0np2};
ops_par_loop(opensbliblock00Kernel068, "MetricsEquation evaluation", opensbliblock00, 3, iteration_range_68_block0,
...
int iteration_range_48_block0[] = {0, 1, -2, block0np1 + 2, -2, block0np2 + 2};
ops_par_loop(opensbliblock00Kernel048, "InletTransfer boundary dir0 side0", opensbliblock00, 3, iteration_range_48_block0,
...
int iteration_range_49_block0[] = {block0np0 - 1, block0np0, -2, block0np1 + 2, -2, block0np2 + 2};
ops_par_loop(opensbliblock00Kernel049, "Extrapolation boundary dir0 side1", opensbliblock00, 3, iteration_range_49_block0,
...
int iteration_range_50_block0[] = {-2, block0np0 + 2, 0, 1, -2, block0np2 + 2};
ops_par_loop(opensbliblock00Kernel050, "ForcingStripWall boundary dir1 side0", opensbliblock00, 3, iteration_range_50_block0,
...
int iteration_range_51_block0[] = {-2, block0np0 + 2, block0np1 - 1, block0np1, -2, block0np2 + 2};
ops_par_loop(opensbliblock00Kernel051, "ZeroGradientOutlet boundary dir1 side1", opensbliblock00, 3, iteration_range_51_block0,
...
ops_halo_transfer(periodicBC_direction2_side0_52_block0);
ops_halo_transfer(periodicBC_direction2_side1_53_block0);
for(stage=0; stage<=2; stage++)
{
int iteration_range_9_block0[] = {-2, block0np0 + 2, -2, block0np1 + 2, -2, block0np2 + 2};
ops_par_loop(opensbliblock00Kernel009, "CRu0_B0", opensbliblock00, 3, iteration_range_9_block0,
...
ops_par_loop(opensbliblock00Kernel011, "CRu1_B0", opensbliblock00, 3, iteration_range_11_block0,
ops_arg_dat(rho_B0, 1, stencil_0_00_00_00_3, "double", OPS_READ),
ops_arg_dat(rhou1_B0, 1, stencil_0_00_00_00_3, "double", OPS_READ),
ops_arg_dat(u1_B0, 1, stencil_0_00_00_00_3, "double", OPS_WRITE));

int iteration_range_13_block0[] = {-2, block0np0 + 2, -2, block0np1 + 2, -2, block0np2 + 2};
ops_par_loop(opensbliblock00Kernel013, "CRu2_B0", opensbliblock00, 3, iteration_range_13_block0,
ops_arg_dat(rho_B0, 1, stencil_0_00_00_00_3, "double", OPS_READ),
...
ops_par_loop(opensbliblock00Kernel025, "CRp_B0", opensbliblock00, 3, iteration_range_25_block0,
...
int iteration_range_26_block0[] = {-2, block0np0 + 2, 0, block0np1, 0, block0np2};
ops_par_loop(opensbliblock00Kernel026, "CRU0_B0", opensbliblock00, 3, iteration_range_26_block0,
...
int iteration_range_34_block0[] = {0, block0np0, -2, block0np1 + 2, 0, block0np2};
ops_par_loop(opensbliblock00Kernel034, "CRU1_B0", opensbliblock00, 3, iteration_range_34_block0,
...
int iteration_range_37_block0[] = {0, block0np0, 0, block0np1, -2, block0np2 + 2};
...
ops_par_loop(opensbliblock00Kernel038, "CRmu_B0", opensbliblock00, 3, iteration_range_38_block0,
...
ops_par_loop(opensbliblock00Kernel008, "Derivative evaluation CD u0_B0 xi0 ", opensbliblock00, 3, iteration_range_8_block0,
ops_arg_dat(u0_B0, 1, stencil_0_44_00_00_19, "double", OPS_READ),
ops_arg_dat(wk0_B0, 1, stencil_0_00_00_00_3, "double", OPS_WRITE),
ops_arg_idx());

int iteration_range_10_block0[] = {0, block0np0, -2, block0np1 + 2, -2, block0np2 + 2};
ops_par_loop(opensbliblock00Kernel010, "Derivative evaluation CD u1_B0 xi0 ", opensbliblock00, 3, iteration_range_10_block0,
ops_arg_dat(u1_B0, 1, stencil_0_44_00_00_19, "double", OPS_READ),
ops_arg_dat(wk1_B0, 1, stencil_0_00_00_00_3, "double", OPS_WRITE),
ops_arg_idx());

int iteration_range_12_block0[] = {0, block0np0, -2, block0np1 + 2, -2, block0np2 + 2};
ops_par_loop(opensbliblock00Kernel012, "Derivative evaluation CD u2_B0 xi0 ", opensbliblock00, 3, iteration_range_12_block0,
ops_arg_dat(u2_B0, 1, stencil_0_44_00_00_19, "double", OPS_READ),
ops_arg_dat(wk2_B0, 1, stencil_0_00_00_00_3, "double", OPS_WRITE),
ops_arg_idx());

int iteration_range_14_block0[] = {0, block0np0, -2, block0np1 + 2, 0, block0np2};
ops_par_loop(opensbliblock00Kernel014, "Derivative evaluation CD T_B0 xi0 ", opensbliblock00, 3, iteration_range_14_block0,
ops_arg_dat(T_B0, 1, stencil_0_44_00_00_19, "double", OPS_READ),
ops_arg_dat(wk3_B0, 1, stencil_0_00_00_00_3, "double", OPS_WRITE),
ops_arg_idx());

int iteration_range_16_block0[] = {0, block0np0, 0, block0np1, -2, block0np2 + 2};
ops_par_loop(opensbliblock00Kernel016, "Derivative evaluation CD u0_B0 xi1 ", opensbliblock00, 3, iteration_range_16_block0,
ops_arg_dat(u0_B0, 1, stencil_0_00_24_00_15, "double", OPS_READ),
ops_arg_dat(wk4_B0, 1, stencil_0_00_00_00_3, "double", OPS_WRITE),
ops_arg_idx());

int iteration_range_17_block0[] = {0, block0np0, 0, block0np1, -2, block0np2 + 2};
ops_par_loop(opensbliblock00Kernel017, "Derivative evaluation CD u1_B0 xi1 ", opensbliblock00, 3, iteration_range_17_block0,
ops_arg_dat(u1_B0, 1, stencil_0_00_24_00_15, "double", OPS_READ),
ops_arg_dat(wk5_B0, 1, stencil_0_00_00_00_3, "double", OPS_WRITE),
ops_arg_idx());

int iteration_range_18_block0[] = {0, block0np0, 0, block0np1, -2, block0np2 + 2};
ops_par_loop(opensbliblock00Kernel018, "Derivative evaluation CD u2_B0 xi1 ", opensbliblock00, 3, iteration_range_18_block0,
...
ops_par_loop(opensbliblock00Kernel019, "Derivative evaluation CD T_B0 xi1 ", opensbliblock00, 3, iteration_range_19_block0,
...
ops_par_loop(opensbliblock00Kernel020, "Derivative evaluation CD u0_B0 xi2 ", opensbliblock00, 3, iteration_range_20_block0,
...
ops_par_loop(opensbliblock00Kernel021, "Derivative evaluation CD u1_B0 xi2 ", opensbliblock00, 3, iteration_range_21_block0,
...
ops_par_loop(opensbliblock00Kernel022, "Derivative evaluation CD u2_B0 xi2 ", opensbliblock00, 3, iteration_range_22_block0,
...
ops_par_loop(opensbliblock00Kernel023, "Derivative evaluation CD T_B0 xi2 ", opensbliblock00, 3, iteration_range_23_block0,
...
ops_par_loop(opensbliblock00Kernel046, "Convective terms", opensbliblock00, 3, iteration_range_46_block0,
ops_arg_dat(D00_B0, 1, stencil_0_44_00_00_19, "double", OPS_READ),
ops_arg_dat(D01_B0, 1, stencil_0_44_00_00_19, "double", OPS_READ),
ops_arg_dat(D10_B0, 1, stencil_0_00_24_00_15, "double", OPS_READ),
ops_arg_dat(D11_B0, 1, stencil_0_00_24_00_15, "double", OPS_READ),
ops_arg_dat(U0_B0, 1, stencil_0_44_00_00_19, "double", OPS_READ),
ops_arg_dat(U1_B0, 1, stencil_0_00_24_00_15, "double", OPS_READ),
ops_arg_dat(U2_B0, 1, stencil_0_00_00_22_8, "double", OPS_READ),
ops_arg_dat(detJ_B0, 1, stencil_0_44_24_22_39, "double", OPS_READ),
...
ops_par_loop(opensbliblock00Kernel047, "Viscous terms", opensbliblock00, 3, iteration_range_47_block0,
ops_arg_dat(D00_B0, 1, stencil_0_00_00_00_3, "double", OPS_READ),
ops_arg_dat(D01_B0, 1, stencil_0_00_00_00_3, "double", OPS_READ),
ops_arg_dat(D10_B0, 1, stencil_0_00_00_00_3, "double", OPS_READ),
ops_arg_dat(D11_B0, 1, stencil_0_00_00_00_3, "double", OPS_READ),
...
ops_par_loop(opensbliblock00Kernel080, "Temporal solution advancement", opensbliblock00, 3, iteration_range_80_block0,
...
ops_halo_transfer(periodicBC_direction2_side0_81_block0);
ops_halo_transfer(periodicBC_direction2_side1_82_block0);
int iteration_range_69_block0[] = {-1, block0np0 + 2, -1, block0np1 + 2, -1, block0np2 + 2};
ops_par_loop(opensbliblock00Kernel069, "User kernel: Constituent Relations evaluation", opensbliblock00, 3, iteration_range_69_block0,
ops_arg_dat(rhoE_B0, 1, stencil_0_00_00_00_3, "double", OPS_READ),
ops_arg_dat(rho_B0, 1, stencil_0_00_00_00_3, "double", OPS_READ),
ops_arg_dat(rhou0_B0, 1, stencil_0_00_00_00_3, "double", OPS_READ),
ops_arg_dat(rhou1_B0, 1, stencil_0_00_00_00_3, "double", OPS_READ),
...
ops_par_loop(opensbliblock00Kernel073, "UserDefinedEquations evaluation", opensbliblock00, 3, iteration_range_73_block0,
ops_arg_dat(D00_B0, 1, stencil_0_00_00_00_3, "double", OPS_READ),
ops_arg_dat(D01_B0, 1, stencil_0_00_00_00_3, "double", OPS_READ),
ops_arg_dat(D10_B0, 1, stencil_0_00_00_00_3, "double", OPS_READ),
ops_arg_dat(D11_B0, 1, stencil_0_00_00_00_3, "double", OPS_READ),
...
int iteration_range_74_block0[] = {-1, block0np0 + 2, -1, block0np1 + 2, -1, block0np2 + 2};
ops_par_loop(opensbliblock00Kernel074, "User kernel: Constituent Relations evaluation", opensbliblock00, 3, iteration_range_74_block0,
ops_arg_dat(rhoE_B0, 1, stencil_0_00_00_00_3, "double", OPS_READ),
ops_arg_dat(rho_B0, 1, stencil_0_00_00_00_3, "double", OPS_READ),
ops_arg_dat(rhou0_B0, 1, stencil_0_00_00_00_3, "double", OPS_READ),
ops_arg_dat(rhou1_B0, 1, stencil_0_00_00_00_3, "double", OPS_READ),
...
int iteration_range_75_block0[] = {-5, block0np0 + 5, -5, block0np1 + 5, -5, block0np2 + 5};
ops_par_loop(opensbliblock00Kernel075, "User kernel: Zero the work arrays", opensbliblock00, 3, iteration_range_75_block0,
ops_arg_dat(Residual0_B0, 1, stencil_0_00_00_00_3, "double", OPS_WRITE),
ops_arg_dat(Residual1_B0, 1, stencil_0_00_00_00_3, "double", OPS_WRITE),
ops_arg_dat(Residual2_B0, 1, stencil_0_00_00_00_3, "double", OPS_WRITE),
ops_arg_dat(Residual3_B0, 1, stencil_0_00_00_00_3, "double", OPS_WRITE),
...
int iteration_range_76_block0[] = {-1, block0np0 + 1, 0, block0np1, 0, block0np2};
ops_par_loop(opensbliblock00Kernel076, "User kernel: TVD reconstruction direction 0", opensbliblock00, 3, iteration_range_76_block0,
...
int iteration_range_77_block0[] = {0, block0np0, -1, block0np1 + 1, 0, block0np2};
ops_par_loop(opensbliblock00Kernel077, "User kernel: TVD reconstruction direction 1", opensbliblock00, 3, iteration_range_77_block0,
...
int iteration_range_78_block0[] = {0, block0np0, 0, block0np1, -1, block0np2 + 1};
ops_par_loop(opensbliblock00Kernel078, "User kernel: TVD reconstruction direction 2", opensbliblock00, 3, iteration_range_78_block0,
...
ops_par_loop(opensbliblock00Kernel079, "User kernel: Non-linear TVD Filter application", opensbliblock00, 3, iteration_range_79_block0,
