...
//
__constant__ int dims_opensbliblock00Kernel054 [9][2];
static int dims_opensbliblock00Kernel054_h [9][2] = {{0}};

//user function
__device__

 void opensbliblock00Kernel054_gpu(ACC<double> &rhoE_B0,
  ACC<double> &rho_B0,
  ACC<double> &rhou0_B0,
  ACC<double> &rhou1_B0,
  ACC<double> &rhou2_B0,
...
__global__ void ops_opensbliblock00Kernel054(
...
int size2 ){
  ...
  arg0 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel054[0][0] + idx_z * 1*1 * dims_opensbliblock00Kernel054[0][0] * dims_opensbliblock00Kernel054[0][1];
  arg1 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel054[1][0] + idx_z * 1*1 * dims_opensbliblock00Kernel054[1][0] * dims_opensbliblock00Kernel054[1][1];
  arg2 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel054[2][0] + idx_z * 1*1 * dims_opensbliblock00Kernel054[2][0] * dims_opensbliblock00Kernel054[2][1];
  arg3 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel054[3][0] + idx_z * 1*1 * dims_opensbliblock00Kernel054[3][0] * dims_opensbliblock00Kernel054[3][1];
  arg4 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel054[4][0] + idx_z * 1*1 * dims_opensbliblock00Kernel054[4][0] * dims_opensbliblock00Kernel054[4][1];
  arg5 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel054[5][0] + idx_z * 1*1 * dims_opensbliblock00Kernel054[5][0] * dims_opensbliblock00Kernel054[5][1];
  arg6 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel054[6][0] + idx_z * 1*1 * dims_opensbliblock00Kernel054[6][0] * dims_opensbliblock00Kernel054[6][1];
  arg7 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel054[7][0] + idx_z * 1*1 * dims_opensbliblock00Kernel054[7][0] * dims_opensbliblock00Kernel054[7][1];

  if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
    ACC<double> argp0(dims_opensbliblock00Kernel054[0][0], dims_opensbliblock00Kernel054[0][1], arg0);
    ACC<double> argp1(dims_opensbliblock00Kernel054[1][0], dims_opensbliblock00Kernel054[1][1], arg1);
    ACC<double> argp2(dims_opensbliblock00Kernel054[2][0], dims_opensbliblock00Kernel054[2][1], arg2);
    ACC<double> argp3(dims_opensbliblock00Kernel054[3][0], dims_opensbliblock00Kernel054[3][1], arg3);
    ACC<double> argp4(dims_opensbliblock00Kernel054[4][0], dims_opensbliblock00Kernel054[4][1], arg4);
    ACC<double> argp5(dims_opensbliblock00Kernel054[5][0], dims_opensbliblock00Kernel054[5][1], arg5);
    ACC<double> argp6(dims_opensbliblock00Kernel054[6][0], dims_opensbliblock00Kernel054[6][1], arg6);
    ACC<double> argp7(dims_opensbliblock00Kernel054[7][0], dims_opensbliblock00Kernel054[7][1], arg7);
    opensbliblock00Kernel054_gpu(
...
void ops_par_loop_opensbliblock00Kernel054_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_opensbliblock00Kernel054_h[0][0] || ydim0 != dims_opensbliblock00Kernel054_h[0][1] || xdim1 != dims_opensbliblock00Kernel054_h[1][0] || ydim1 != dims_opensbliblock00Kernel054_h[1][1] || xdim2 != dims_opensbliblock00Kernel054_h[2][0] || ydim2 != dims_opensbliblock00Kernel054_h[2][1] || xdim3 != dims_opensbliblock00Kernel054_h[3][0] || ydim3 != dims_opensbliblock00Kernel054_h[3][1] || xdim4 != dims_opensbliblock00Kernel054_h[4][0] || ydim4 != dims_opensbliblock00Kernel054_h[4][1] || xdim5 != dims_opensbliblock00Kernel054_h[5][0] || ydim5 != dims_opensbliblock00Kernel054_h[5][1] || xdim6 != dims_opensbliblock00Kernel054_h[6][0] || ydim6 != dims_opensbliblock00Kernel054_h[6][1] || xdim7 != dims_opensbliblock00Kernel054_h[7][0] || ydim7 != dims_opensbliblock00Kernel054_h[7][1]) {
    dims_opensbliblock00Kernel054_h[0][0] = xdim0;
    dims_opensbliblock00Kernel054_h[0][1] = ydim0;
    dims_opensbliblock00Kernel054_h[1][0] = xdim1;
    dims_opensbliblock00Kernel054_h[1][1] = ydim1;
    dims_opensbliblock00Kernel054_h[2][0] = xdim2;
    dims_opensbliblock00Kernel054_h[2][1] = ydim2;
    dims_opensbliblock00Kernel054_h[3][0] = xdim3;
    dims_opensbliblock00Kernel054_h[3][1] = ydim3;
    dims_opensbliblock00Kernel054_h[4][0] = xdim4;
    dims_opensbliblock00Kernel054_h[4][1] = ydim4;
    dims_opensbliblock00Kernel054_h[5][0] = xdim5;
    dims_opensbliblock00Kernel054_h[5][1] = ydim5;
    dims_opensbliblock00Kernel054_h[6][0] = xdim6;
    dims_opensbliblock00Kernel054_h[6][1] = ydim6;
    dims_opensbliblock00Kernel054_h[7][0] = xdim7;
    dims_opensbliblock00Kernel054_h[7][1] = ydim7;
    cutilSafeCall(block->instance->ostream(), cudaMemcpyToSymbol( dims_opensbliblock00Kernel054, dims_opensbliblock00Kernel054_h, sizeof(dims_opensbliblock00Kernel054)));
  }
  ...
  if (x_size > 0 && y_size > 0 && z_size > 0)
    ops_opensbliblock00Kernel054<<<grid, tblock >>> ( 
...
void ops_par_loop_opensbliblock00Kernel054(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg8) {
  ...
  create_kerneldesc_and_enque(name, args, 9, 0, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel054_execute);
}
#endif
