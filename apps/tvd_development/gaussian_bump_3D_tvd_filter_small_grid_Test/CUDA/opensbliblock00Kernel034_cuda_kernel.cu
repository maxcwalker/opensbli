...
//
__constant__ int dims_opensbliblock00Kernel034 [5][2];
static int dims_opensbliblock00Kernel034_h [5][2] = {{0}};

//user function
__device__

 void opensbliblock00Kernel034_gpu(const ACC<double> &D10_B0,
...
int size2 ){
  ...
  if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
    ...
    ACC<double> argp4(dims_opensbliblock00Kernel034[4][0], dims_opensbliblock00Kernel034[4][1], arg4);
...
void ops_par_loop_opensbliblock00Kernel034(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4) {
  ...
  create_kerneldesc_and_enque(name, args, 5, 16, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel034_execute);
}
#endif
