...
//
__constant__ int dims_opensbliblock00Kernel077 [17][2];
static int dims_opensbliblock00Kernel077_h [17][2] = {{0}};

//user function
__device__

 void opensbliblock00Kernel077_gpu(const ACC<double> &D10_B0,
...
__global__ void ops_opensbliblock00Kernel077(
...
int size2 ){
  ...
  arg0 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel077[0][0] + idx_z * 1*1 * dims_opensbliblock00Kernel077[0][0] * dims_opensbliblock00Kernel077[0][1];
  arg1 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel077[1][0] + idx_z * 1*1 * dims_opensbliblock00Kernel077[1][0] * dims_opensbliblock00Kernel077[1][1];
  arg2 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel077[2][0] + idx_z * 1*1 * dims_opensbliblock00Kernel077[2][0] * dims_opensbliblock00Kernel077[2][1];
  arg3 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel077[3][0] + idx_z * 1*1 * dims_opensbliblock00Kernel077[3][0] * dims_opensbliblock00Kernel077[3][1];
  arg4 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel077[4][0] + idx_z * 1*1 * dims_opensbliblock00Kernel077[4][0] * dims_opensbliblock00Kernel077[4][1];
  arg5 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel077[5][0] + idx_z * 1*1 * dims_opensbliblock00Kernel077[5][0] * dims_opensbliblock00Kernel077[5][1];
  arg6 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel077[6][0] + idx_z * 1*1 * dims_opensbliblock00Kernel077[6][0] * dims_opensbliblock00Kernel077[6][1];
  arg7 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel077[7][0] + idx_z * 1*1 * dims_opensbliblock00Kernel077[7][0] * dims_opensbliblock00Kernel077[7][1];
  arg8 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel077[8][0] + idx_z * 1*1 * dims_opensbliblock00Kernel077[8][0] * dims_opensbliblock00Kernel077[8][1];
  arg9 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel077[9][0] + idx_z * 1*1 * dims_opensbliblock00Kernel077[9][0] * dims_opensbliblock00Kernel077[9][1];
  arg10 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel077[10][0] + idx_z * 1*1 * dims_opensbliblock00Kernel077[10][0] * dims_opensbliblock00Kernel077[10][1];
  arg11 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel077[11][0] + idx_z * 1*1 * dims_opensbliblock00Kernel077[11][0] * dims_opensbliblock00Kernel077[11][1];
  arg12 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel077[12][0] + idx_z * 1*1 * dims_opensbliblock00Kernel077[12][0] * dims_opensbliblock00Kernel077[12][1];
  arg13 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel077[13][0] + idx_z * 1*1 * dims_opensbliblock00Kernel077[13][0] * dims_opensbliblock00Kernel077[13][1];
  arg14 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel077[14][0] + idx_z * 1*1 * dims_opensbliblock00Kernel077[14][0] * dims_opensbliblock00Kernel077[14][1];
  arg15 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel077[15][0] + idx_z * 1*1 * dims_opensbliblock00Kernel077[15][0] * dims_opensbliblock00Kernel077[15][1];
  arg16 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel077[16][0] + idx_z * 1*1 * dims_opensbliblock00Kernel077[16][0] * dims_opensbliblock00Kernel077[16][1];

  if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
    const ACC<double> argp0(dims_opensbliblock00Kernel077[0][0], dims_opensbliblock00Kernel077[0][1], arg0);
    const ACC<double> argp1(dims_opensbliblock00Kernel077[1][0], dims_opensbliblock00Kernel077[1][1], arg1);
    const ACC<double> argp2(dims_opensbliblock00Kernel077[2][0], dims_opensbliblock00Kernel077[2][1], arg2);
    const ACC<double> argp3(dims_opensbliblock00Kernel077[3][0], dims_opensbliblock00Kernel077[3][1], arg3);
    const ACC<double> argp4(dims_opensbliblock00Kernel077[4][0], dims_opensbliblock00Kernel077[4][1], arg4);
    const ACC<double> argp5(dims_opensbliblock00Kernel077[5][0], dims_opensbliblock00Kernel077[5][1], arg5);
    const ACC<double> argp6(dims_opensbliblock00Kernel077[6][0], dims_opensbliblock00Kernel077[6][1], arg6);
    const ACC<double> argp7(dims_opensbliblock00Kernel077[7][0], dims_opensbliblock00Kernel077[7][1], arg7);
    const ACC<double> argp8(dims_opensbliblock00Kernel077[8][0], dims_opensbliblock00Kernel077[8][1], arg8);
    const ACC<double> argp9(dims_opensbliblock00Kernel077[9][0], dims_opensbliblock00Kernel077[9][1], arg9);
    const ACC<double> argp10(dims_opensbliblock00Kernel077[10][0], dims_opensbliblock00Kernel077[10][1], arg10);
    const ACC<double> argp11(dims_opensbliblock00Kernel077[11][0], dims_opensbliblock00Kernel077[11][1], arg11);
    ACC<double> argp12(dims_opensbliblock00Kernel077[12][0], dims_opensbliblock00Kernel077[12][1], arg12);
    ACC<double> argp13(dims_opensbliblock00Kernel077[13][0], dims_opensbliblock00Kernel077[13][1], arg13);
    ACC<double> argp14(dims_opensbliblock00Kernel077[14][0], dims_opensbliblock00Kernel077[14][1], arg14);
    ACC<double> argp15(dims_opensbliblock00Kernel077[15][0], dims_opensbliblock00Kernel077[15][1], arg15);
    ACC<double> argp16(dims_opensbliblock00Kernel077[16][0], dims_opensbliblock00Kernel077[16][1], arg16);
    opensbliblock00Kernel077_gpu(
...
// host stub function
#ifndef OPS_LAZY
void ops_par_loop_opensbliblock00Kernel077(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg16) {
#else
void ops_par_loop_opensbliblock00Kernel077_execute(ops_kernel_descriptor *desc) {
  int dim = desc->dim;
  #if OPS_MPI
  ...
  if (!ops_checkpointing_before(args,17,range,40)) return;
  #endif

  if (block->instance->OPS_diags > 1) {
    ops_timing_realloc(block->instance,40,"opensbliblock00Kernel077");
  ...
  if (xdim0 != dims_opensbliblock00Kernel077_h[0][0] || ydim0 != dims_opensbliblock00Kernel077_h[0][1] || xdim1 != dims_opensbliblock00Kernel077_h[1][0] || ydim1 != dims_opensbliblock00Kernel077_h[1][1] || xdim2 != dims_opensbliblock00Kernel077_h[2][0] || ydim2 != dims_opensbliblock00Kernel077_h[2][1] || xdim3 != dims_opensbliblock00Kernel077_h[3][0] || ydim3 != dims_opensbliblock00Kernel077_h[3][1] || xdim4 != dims_opensbliblock00Kernel077_h[4][0] || ydim4 != dims_opensbliblock00Kernel077_h[4][1] || xdim5 != dims_opensbliblock00Kernel077_h[5][0] || ydim5 != dims_opensbliblock00Kernel077_h[5][1] || xdim6 != dims_opensbliblock00Kernel077_h[6][0] || ydim6 != dims_opensbliblock00Kernel077_h[6][1] || xdim7 != dims_opensbliblock00Kernel077_h[7][0] || ydim7 != dims_opensbliblock00Kernel077_h[7][1] || xdim8 != dims_opensbliblock00Kernel077_h[8][0] || ydim8 != dims_opensbliblock00Kernel077_h[8][1] || xdim9 != dims_opensbliblock00Kernel077_h[9][0] || ydim9 != dims_opensbliblock00Kernel077_h[9][1] || xdim10 != dims_opensbliblock00Kernel077_h[10][0] || ydim10 != dims_opensbliblock00Kernel077_h[10][1] || xdim11 != dims_opensbliblock00Kernel077_h[11][0] || ydim11 != dims_opensbliblock00Kernel077_h[11][1] || xdim12 != dims_opensbliblock00Kernel077_h[12][0] || ydim12 != dims_opensbliblock00Kernel077_h[12][1] || xdim13 != dims_opensbliblock00Kernel077_h[13][0] || ydim13 != dims_opensbliblock00Kernel077_h[13][1] || xdim14 != dims_opensbliblock00Kernel077_h[14][0] || ydim14 != dims_opensbliblock00Kernel077_h[14][1] || xdim15 != dims_opensbliblock00Kernel077_h[15][0] || ydim15 != dims_opensbliblock00Kernel077_h[15][1] || xdim16 != dims_opensbliblock00Kernel077_h[16][0] || ydim16 != dims_opensbliblock00Kernel077_h[16][1]) {
    dims_opensbliblock00Kernel077_h[0][0] = xdim0;
    dims_opensbliblock00Kernel077_h[0][1] = ydim0;
    dims_opensbliblock00Kernel077_h[1][0] = xdim1;
    dims_opensbliblock00Kernel077_h[1][1] = ydim1;
    dims_opensbliblock00Kernel077_h[2][0] = xdim2;
    dims_opensbliblock00Kernel077_h[2][1] = ydim2;
    dims_opensbliblock00Kernel077_h[3][0] = xdim3;
    dims_opensbliblock00Kernel077_h[3][1] = ydim3;
    dims_opensbliblock00Kernel077_h[4][0] = xdim4;
    dims_opensbliblock00Kernel077_h[4][1] = ydim4;
    dims_opensbliblock00Kernel077_h[5][0] = xdim5;
    dims_opensbliblock00Kernel077_h[5][1] = ydim5;
    dims_opensbliblock00Kernel077_h[6][0] = xdim6;
    dims_opensbliblock00Kernel077_h[6][1] = ydim6;
    dims_opensbliblock00Kernel077_h[7][0] = xdim7;
    dims_opensbliblock00Kernel077_h[7][1] = ydim7;
    dims_opensbliblock00Kernel077_h[8][0] = xdim8;
    dims_opensbliblock00Kernel077_h[8][1] = ydim8;
    dims_opensbliblock00Kernel077_h[9][0] = xdim9;
    dims_opensbliblock00Kernel077_h[9][1] = ydim9;
    dims_opensbliblock00Kernel077_h[10][0] = xdim10;
    dims_opensbliblock00Kernel077_h[10][1] = ydim10;
    dims_opensbliblock00Kernel077_h[11][0] = xdim11;
    dims_opensbliblock00Kernel077_h[11][1] = ydim11;
    dims_opensbliblock00Kernel077_h[12][0] = xdim12;
    dims_opensbliblock00Kernel077_h[12][1] = ydim12;
    dims_opensbliblock00Kernel077_h[13][0] = xdim13;
    dims_opensbliblock00Kernel077_h[13][1] = ydim13;
    dims_opensbliblock00Kernel077_h[14][0] = xdim14;
    dims_opensbliblock00Kernel077_h[14][1] = ydim14;
    dims_opensbliblock00Kernel077_h[15][0] = xdim15;
    dims_opensbliblock00Kernel077_h[15][1] = ydim15;
    dims_opensbliblock00Kernel077_h[16][0] = xdim16;
    dims_opensbliblock00Kernel077_h[16][1] = ydim16;
    cutilSafeCall(block->instance->ostream(), cudaMemcpyToSymbol( dims_opensbliblock00Kernel077, dims_opensbliblock00Kernel077_h, sizeof(dims_opensbliblock00Kernel077)));
  }
  ...
  if (x_size > 0 && y_size > 0 && z_size > 0)
    ops_opensbliblock00Kernel077<<<grid, tblock >>> ( 
  ...
  if (block->instance->OPS_diags > 1) {
    ...
    block->instance->OPS_kernels[40].transfer += ops_compute_transfer(dim, start, end, &arg8);
    block->instance->OPS_kernels[40].transfer += ops_compute_transfer(dim, start, end, &arg9);
    block->instance->OPS_kernels[40].transfer += ops_compute_transfer(dim, start, end, &arg10);
    block->instance->OPS_kernels[40].transfer += ops_compute_transfer(dim, start, end, &arg11);
    block->instance->OPS_kernels[40].transfer += ops_compute_transfer(dim, start, end, &arg12);
    block->instance->OPS_kernels[40].transfer += ops_compute_transfer(dim, start, end, &arg13);
    block->instance->OPS_kernels[40].transfer += ops_compute_transfer(dim, start, end, &arg14);
    block->instance->OPS_kernels[40].transfer += ops_compute_transfer(dim, start, end, &arg15);
    block->instance->OPS_kernels[40].transfer += ops_compute_transfer(dim, start, end, &arg16);
  }
}
...
void ops_par_loop_opensbliblock00Kernel077(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg16) {
  ...
  create_kerneldesc_and_enque(name, args, 17, 40, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel077_execute);
}
#endif
