...
//
__constant__ int dims_opensbliblock00Kernel025 [6][2];
static int dims_opensbliblock00Kernel025_h [6][2] = {{0}};

//user function
__device__

 void opensbliblock00Kernel025_gpu(const ACC<double> &rhoE_B0,
...
int size2 ){
  ...
  if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
    ...
    ACC<double> argp5(dims_opensbliblock00Kernel025[5][0], dims_opensbliblock00Kernel025[5][1], arg5);
...
void ops_par_loop_opensbliblock00Kernel025(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4, ops_arg arg5) {
  ...
  create_kerneldesc_and_enque(name, args, 6, 14, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel025_execute);
}
#endif
