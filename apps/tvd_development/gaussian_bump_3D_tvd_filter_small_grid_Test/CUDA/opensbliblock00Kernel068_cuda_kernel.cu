...
//
__constant__ int dims_opensbliblock00Kernel068 [13][2];
static int dims_opensbliblock00Kernel068_h [13][2] = {{0}};

//user function
__device__

 void opensbliblock00Kernel068_gpu(const ACC<double> &D00_B0,
...
int size2 ){
  ...
  if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
    ...
    ACC<double> argp4(dims_opensbliblock00Kernel068[4][0], dims_opensbliblock00Kernel068[4][1], arg4);
...
void ops_par_loop_opensbliblock00Kernel068(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg12) {
  ...
  create_kerneldesc_and_enque(name, args, 13, 6, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel068_execute);
}
#endif
