...
//
__constant__ int dims_opensbliblock00Kernel073 [9][2];
static int dims_opensbliblock00Kernel073_h [9][2] = {{0}};

//user function
__device__

 void opensbliblock00Kernel073_gpu(const ACC<double> &D00_B0,
...
int size2 ){
  ...
  arg5 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel073[5][0] + idx_z * 1*1 * dims_opensbliblock00Kernel073[5][0] * dims_opensbliblock00Kernel073[5][1];
  arg6 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel073[6][0] + idx_z * 1*1 * dims_opensbliblock00Kernel073[6][0] * dims_opensbliblock00Kernel073[6][1];
  arg7 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel073[7][0] + idx_z * 1*1 * dims_opensbliblock00Kernel073[7][0] * dims_opensbliblock00Kernel073[7][1];

  if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
    const ACC<double> argp0(dims_opensbliblock00Kernel073[0][0], dims_opensbliblock00Kernel073[0][1], arg0);
    const ACC<double> argp1(dims_opensbliblock00Kernel073[1][0], dims_opensbliblock00Kernel073[1][1], arg1);
    const ACC<double> argp2(dims_opensbliblock00Kernel073[2][0], dims_opensbliblock00Kernel073[2][1], arg2);
    const ACC<double> argp3(dims_opensbliblock00Kernel073[3][0], dims_opensbliblock00Kernel073[3][1], arg3);
    const ACC<double> argp4(dims_opensbliblock00Kernel073[4][0], dims_opensbliblock00Kernel073[4][1], arg4);
    const ACC<double> argp5(dims_opensbliblock00Kernel073[5][0], dims_opensbliblock00Kernel073[5][1], arg5);
    const ACC<double> argp6(dims_opensbliblock00Kernel073[6][0], dims_opensbliblock00Kernel073[6][1], arg6);
    ACC<double> argp7(dims_opensbliblock00Kernel073[7][0], dims_opensbliblock00Kernel073[7][1], arg7);
...
void ops_par_loop_opensbliblock00Kernel073_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_opensbliblock00Kernel073_h[0][0] || ydim0 != dims_opensbliblock00Kernel073_h[0][1] || xdim1 != dims_opensbliblock00Kernel073_h[1][0] || ydim1 != dims_opensbliblock00Kernel073_h[1][1] || xdim2 != dims_opensbliblock00Kernel073_h[2][0] || ydim2 != dims_opensbliblock00Kernel073_h[2][1] || xdim3 != dims_opensbliblock00Kernel073_h[3][0] || ydim3 != dims_opensbliblock00Kernel073_h[3][1] || xdim4 != dims_opensbliblock00Kernel073_h[4][0] || ydim4 != dims_opensbliblock00Kernel073_h[4][1] || xdim5 != dims_opensbliblock00Kernel073_h[5][0] || ydim5 != dims_opensbliblock00Kernel073_h[5][1] || xdim6 != dims_opensbliblock00Kernel073_h[6][0] || ydim6 != dims_opensbliblock00Kernel073_h[6][1] || xdim7 != dims_opensbliblock00Kernel073_h[7][0] || ydim7 != dims_opensbliblock00Kernel073_h[7][1]) {
    ...
    dims_opensbliblock00Kernel073_h[5][0] = xdim5;
    dims_opensbliblock00Kernel073_h[5][1] = ydim5;
    dims_opensbliblock00Kernel073_h[6][0] = xdim6;
    dims_opensbliblock00Kernel073_h[6][1] = ydim6;
    dims_opensbliblock00Kernel073_h[7][0] = xdim7;
    dims_opensbliblock00Kernel073_h[7][1] = ydim7;
...
void ops_par_loop_opensbliblock00Kernel073(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg8) {
  ...
  create_kerneldesc_and_enque(name, args, 9, 36, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel073_execute);
}
#endif
