...
//
__constant__ int dims_opensbliblock00Kernel080 [17][2];
static int dims_opensbliblock00Kernel080_h [17][2] = {{0}};

//user function
__device__

 void opensbliblock00Kernel080_gpu(const ACC<double> &Residual0_B0,
...
int size2 ){
  ...
  if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
    ...
    ACC<double> argp5(dims_opensbliblock00Kernel080[5][0], dims_opensbliblock00Kernel080[5][1], arg5);
    ACC<double> argp6(dims_opensbliblock00Kernel080[6][0], dims_opensbliblock00Kernel080[6][1], arg6);
    ACC<double> argp7(dims_opensbliblock00Kernel080[7][0], dims_opensbliblock00Kernel080[7][1], arg7);
    ACC<double> argp8(dims_opensbliblock00Kernel080[8][0], dims_opensbliblock00Kernel080[8][1], arg8);
    ACC<double> argp9(dims_opensbliblock00Kernel080[9][0], dims_opensbliblock00Kernel080[9][1], arg9);
    ACC<double> argp10(dims_opensbliblock00Kernel080[10][0], dims_opensbliblock00Kernel080[10][1], arg10);
    ACC<double> argp11(dims_opensbliblock00Kernel080[11][0], dims_opensbliblock00Kernel080[11][1], arg11);
    ACC<double> argp12(dims_opensbliblock00Kernel080[12][0], dims_opensbliblock00Kernel080[12][1], arg12);
    ACC<double> argp13(dims_opensbliblock00Kernel080[13][0], dims_opensbliblock00Kernel080[13][1], arg13);
    ACC<double> argp14(dims_opensbliblock00Kernel080[14][0], dims_opensbliblock00Kernel080[14][1], arg14);
    opensbliblock00Kernel080_gpu(
...
void ops_par_loop_opensbliblock00Kernel080_execute(ops_kernel_descriptor *desc) {
  ...
  if (x_size > 0 && y_size > 0 && z_size > 0)
    ops_opensbliblock00Kernel080<<<grid, tblock >>> ( 
...
void ops_par_loop_opensbliblock00Kernel080(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg16) {
  ...
  create_kerneldesc_and_enque(name, args, 17, 34, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel080_execute);
}
#endif
