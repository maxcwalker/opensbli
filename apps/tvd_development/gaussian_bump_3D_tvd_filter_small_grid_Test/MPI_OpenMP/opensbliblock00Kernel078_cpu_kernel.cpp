...
void ops_par_loop_opensbliblock00Kernel078_execute(ops_kernel_descriptor *desc) {
  ...
  double * __restrict__ rhou2_B0_p = (double *)(args[6].data + base6);
  ...
  double * __restrict__ rhoE_RKold_B0_p = (double *)(args[10].data + base10);

  int base11 = args[11].dat->base_offset;
  double * __restrict__ rho_RKold_B0_p = (double *)(args[11].data + base11);

  int base12 = args[12].dat->base_offset;
  double * __restrict__ rhou0_RKold_B0_p = (double *)(args[12].data + base12);

  int base13 = args[13].dat->base_offset;
  double * __restrict__ rhou1_RKold_B0_p = (double *)(args[13].data + base13);
  ...
  for ( int n_z=start[2]; n_z<end[2]; n_z++ ){
    for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
      ...
      for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
        const ACC<double> a_B0(xdim0_opensbliblock00Kernel078, ydim0_opensbliblock00Kernel078, a_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel078*1 + n_z * xdim0_opensbliblock00Kernel078 * ydim0_opensbliblock00Kernel078*1);
        const ACC<double> detJ_B0(xdim1_opensbliblock00Kernel078, ydim1_opensbliblock00Kernel078, detJ_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel078*1 + n_z * xdim1_opensbliblock00Kernel078 * ydim1_opensbliblock00Kernel078*1);
        const ACC<double> rhoE_B0(xdim2_opensbliblock00Kernel078, ydim2_opensbliblock00Kernel078, rhoE_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel078*1 + n_z * xdim2_opensbliblock00Kernel078 * ydim2_opensbliblock00Kernel078*1);
        const ACC<double> rho_B0(xdim3_opensbliblock00Kernel078, ydim3_opensbliblock00Kernel078, rho_B0_p + n_x*1 + n_y * xdim3_opensbliblock00Kernel078*1 + n_z * xdim3_opensbliblock00Kernel078 * ydim3_opensbliblock00Kernel078*1);
        const ACC<double> rhou0_B0(xdim4_opensbliblock00Kernel078, ydim4_opensbliblock00Kernel078, rhou0_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel078*1 + n_z * xdim4_opensbliblock00Kernel078 * ydim4_opensbliblock00Kernel078*1);
        const ACC<double> rhou1_B0(xdim5_opensbliblock00Kernel078, ydim5_opensbliblock00Kernel078, rhou1_B0_p + n_x*1 + n_y * xdim5_opensbliblock00Kernel078*1 + n_z * xdim5_opensbliblock00Kernel078 * ydim5_opensbliblock00Kernel078*1);
        const ACC<double> rhou2_B0(xdim6_opensbliblock00Kernel078, ydim6_opensbliblock00Kernel078, rhou2_B0_p + n_x*1 + n_y * xdim6_opensbliblock00Kernel078*1 + n_z * xdim6_opensbliblock00Kernel078 * ydim6_opensbliblock00Kernel078*1);
        const ACC<double> u0_B0(xdim7_opensbliblock00Kernel078, ydim7_opensbliblock00Kernel078, u0_B0_p + n_x*1 + n_y * xdim7_opensbliblock00Kernel078*1 + n_z * xdim7_opensbliblock00Kernel078 * ydim7_opensbliblock00Kernel078*1);
        const ACC<double> u1_B0(xdim8_opensbliblock00Kernel078, ydim8_opensbliblock00Kernel078, u1_B0_p + n_x*1 + n_y * xdim8_opensbliblock00Kernel078*1 + n_z * xdim8_opensbliblock00Kernel078 * ydim8_opensbliblock00Kernel078*1);
        const ACC<double> u2_B0(xdim9_opensbliblock00Kernel078, ydim9_opensbliblock00Kernel078, u2_B0_p + n_x*1 + n_y * xdim9_opensbliblock00Kernel078*1 + n_z * xdim9_opensbliblock00Kernel078 * ydim9_opensbliblock00Kernel078*1);
        ACC<double> rhoE_RKold_B0(xdim10_opensbliblock00Kernel078, ydim10_opensbliblock00Kernel078, rhoE_RKold_B0_p + n_x*1 + n_y * xdim10_opensbliblock00Kernel078*1 + n_z * xdim10_opensbliblock00Kernel078 * ydim10_opensbliblock00Kernel078*1);
        ACC<double> rho_RKold_B0(xdim11_opensbliblock00Kernel078, ydim11_opensbliblock00Kernel078, rho_RKold_B0_p + n_x*1 + n_y * xdim11_opensbliblock00Kernel078*1 + n_z * xdim11_opensbliblock00Kernel078 * ydim11_opensbliblock00Kernel078*1);
        ACC<double> rhou0_RKold_B0(xdim12_opensbliblock00Kernel078, ydim12_opensbliblock00Kernel078, rhou0_RKold_B0_p + n_x*1 + n_y * xdim12_opensbliblock00Kernel078*1 + n_z * xdim12_opensbliblock00Kernel078 * ydim12_opensbliblock00Kernel078*1);
        ACC<double> rhou1_RKold_B0(xdim13_opensbliblock00Kernel078, ydim13_opensbliblock00Kernel078, rhou1_RKold_B0_p + n_x*1 + n_y * xdim13_opensbliblock00Kernel078*1 + n_z * xdim13_opensbliblock00Kernel078 * ydim13_opensbliblock00Kernel078*1);
        ACC<double> rhou2_RKold_B0(xdim14_opensbliblock00Kernel078, ydim14_opensbliblock00Kernel078, rhou2_RKold_B0_p + n_x*1 + n_y * xdim14_opensbliblock00Kernel078*1 + n_z * xdim14_opensbliblock00Kernel078 * ydim14_opensbliblock00Kernel078*1);
...
void ops_par_loop_opensbliblock00Kernel078(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg12, ops_arg arg13, ops_arg arg14) {
  ...
  create_kerneldesc_and_enque(name, args, 15, 41, dim, 0, range, block, ops_par_loop_opensbliblock00Kernel078_execute);
}
#endif
