...
void ops_par_loop_opensbliblock00Kernel077_execute(ops_kernel_descriptor *desc) {
  ...
  double * __restrict__ Residual4_B0_p = (double *)(args[16].data + base16);
  ...
  for ( int n_z=start[2]; n_z<end[2]; n_z++ ){
    for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
      ...
      for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
        const ACC<double> D10_B0(xdim0_opensbliblock00Kernel077, ydim0_opensbliblock00Kernel077, D10_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel077*1 + n_z * xdim0_opensbliblock00Kernel077 * ydim0_opensbliblock00Kernel077*1);
        const ACC<double> D11_B0(xdim1_opensbliblock00Kernel077, ydim1_opensbliblock00Kernel077, D11_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel077*1 + n_z * xdim1_opensbliblock00Kernel077 * ydim1_opensbliblock00Kernel077*1);
        const ACC<double> a_B0(xdim2_opensbliblock00Kernel077, ydim2_opensbliblock00Kernel077, a_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel077*1 + n_z * xdim2_opensbliblock00Kernel077 * ydim2_opensbliblock00Kernel077*1);
        const ACC<double> detJ_B0(xdim3_opensbliblock00Kernel077, ydim3_opensbliblock00Kernel077, detJ_B0_p + n_x*1 + n_y * xdim3_opensbliblock00Kernel077*1 + n_z * xdim3_opensbliblock00Kernel077 * ydim3_opensbliblock00Kernel077*1);
        const ACC<double> rhoE_B0(xdim4_opensbliblock00Kernel077, ydim4_opensbliblock00Kernel077, rhoE_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel077*1 + n_z * xdim4_opensbliblock00Kernel077 * ydim4_opensbliblock00Kernel077*1);
        const ACC<double> rho_B0(xdim5_opensbliblock00Kernel077, ydim5_opensbliblock00Kernel077, rho_B0_p + n_x*1 + n_y * xdim5_opensbliblock00Kernel077*1 + n_z * xdim5_opensbliblock00Kernel077 * ydim5_opensbliblock00Kernel077*1);
        const ACC<double> rhou0_B0(xdim6_opensbliblock00Kernel077, ydim6_opensbliblock00Kernel077, rhou0_B0_p + n_x*1 + n_y * xdim6_opensbliblock00Kernel077*1 + n_z * xdim6_opensbliblock00Kernel077 * ydim6_opensbliblock00Kernel077*1);
        const ACC<double> rhou1_B0(xdim7_opensbliblock00Kernel077, ydim7_opensbliblock00Kernel077, rhou1_B0_p + n_x*1 + n_y * xdim7_opensbliblock00Kernel077*1 + n_z * xdim7_opensbliblock00Kernel077 * ydim7_opensbliblock00Kernel077*1);
        const ACC<double> rhou2_B0(xdim8_opensbliblock00Kernel077, ydim8_opensbliblock00Kernel077, rhou2_B0_p + n_x*1 + n_y * xdim8_opensbliblock00Kernel077*1 + n_z * xdim8_opensbliblock00Kernel077 * ydim8_opensbliblock00Kernel077*1);
        const ACC<double> u0_B0(xdim9_opensbliblock00Kernel077, ydim9_opensbliblock00Kernel077, u0_B0_p + n_x*1 + n_y * xdim9_opensbliblock00Kernel077*1 + n_z * xdim9_opensbliblock00Kernel077 * ydim9_opensbliblock00Kernel077*1);
        const ACC<double> u1_B0(xdim10_opensbliblock00Kernel077, ydim10_opensbliblock00Kernel077, u1_B0_p + n_x*1 + n_y * xdim10_opensbliblock00Kernel077*1 + n_z * xdim10_opensbliblock00Kernel077 * ydim10_opensbliblock00Kernel077*1);
        const ACC<double> u2_B0(xdim11_opensbliblock00Kernel077, ydim11_opensbliblock00Kernel077, u2_B0_p + n_x*1 + n_y * xdim11_opensbliblock00Kernel077*1 + n_z * xdim11_opensbliblock00Kernel077 * ydim11_opensbliblock00Kernel077*1);
        ACC<double> Residual0_B0(xdim12_opensbliblock00Kernel077, ydim12_opensbliblock00Kernel077, Residual0_B0_p + n_x*1 + n_y * xdim12_opensbliblock00Kernel077*1 + n_z * xdim12_opensbliblock00Kernel077 * ydim12_opensbliblock00Kernel077*1);
        ACC<double> Residual1_B0(xdim13_opensbliblock00Kernel077, ydim13_opensbliblock00Kernel077, Residual1_B0_p + n_x*1 + n_y * xdim13_opensbliblock00Kernel077*1 + n_z * xdim13_opensbliblock00Kernel077 * ydim13_opensbliblock00Kernel077*1);
        ACC<double> Residual2_B0(xdim14_opensbliblock00Kernel077, ydim14_opensbliblock00Kernel077, Residual2_B0_p + n_x*1 + n_y * xdim14_opensbliblock00Kernel077*1 + n_z * xdim14_opensbliblock00Kernel077 * ydim14_opensbliblock00Kernel077*1);
        ACC<double> Residual3_B0(xdim15_opensbliblock00Kernel077, ydim15_opensbliblock00Kernel077, Residual3_B0_p + n_x*1 + n_y * xdim15_opensbliblock00Kernel077*1 + n_z * xdim15_opensbliblock00Kernel077 * ydim15_opensbliblock00Kernel077*1);
        ACC<double> Residual4_B0(xdim16_opensbliblock00Kernel077, ydim16_opensbliblock00Kernel077, Residual4_B0_p + n_x*1 + n_y * xdim16_opensbliblock00Kernel077*1 + n_z * xdim16_opensbliblock00Kernel077 * ydim16_opensbliblock00Kernel077*1);
...
void ops_par_loop_opensbliblock00Kernel077(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg16) {
  ...
  create_kerneldesc_and_enque(name, args, 17, 40, dim, 0, range, block, ops_par_loop_opensbliblock00Kernel077_execute);
}
#endif
