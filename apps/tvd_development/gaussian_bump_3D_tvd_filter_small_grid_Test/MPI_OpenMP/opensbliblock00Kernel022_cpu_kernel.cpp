  ...
  for ( int n_z=start[2]; n_z<end[2]; n_z++ ){
    for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
      ...
      for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
        const ACC<double> u2_B0(xdim0_opensbliblock00Kernel022, ydim0_opensbliblock00Kernel022, u2_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel022*1 + n_z * xdim0_opensbliblock00Kernel022 * ydim0_opensbliblock00Kernel022*1);
        ACC<double> wk10_B0(xdim1_opensbliblock00Kernel022, ydim1_opensbliblock00Kernel022, wk10_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel022*1 + n_z * xdim1_opensbliblock00Kernel022 * ydim1_opensbliblock00Kernel022*1);
...
void ops_par_loop_opensbliblock00Kernel022(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1) {
  ...
  create_kerneldesc_and_enque(name, args, 2, 30, dim, 0, range, block, ops_par_loop_opensbliblock00Kernel022_execute);
}
#endif
