...
void ops_par_loop_opensbliblock00Kernel077_execute(ops_kernel_descriptor *desc) {
 ...
 arg15, arg16};
  ...
  #ifdef OPS_DEBUG
  ops_register_args(block->instance, args, "opensbliblock00Kernel077");
  #endif
  ...
  int xdim0_opensbliblock00Kernel077 = args[0].dat->size[0];
  int ydim0_opensbliblock00Kernel077 = args[0].dat->size[1];
  int xdim1_opensbliblock00Kernel077 = args[1].dat->size[0];
  int ydim1_opensbliblock00Kernel077 = args[1].dat->size[1];
  int xdim2_opensbliblock00Kernel077 = args[2].dat->size[0];
  int ydim2_opensbliblock00Kernel077 = args[2].dat->size[1];
  int xdim3_opensbliblock00Kernel077 = args[3].dat->size[0];
  int ydim3_opensbliblock00Kernel077 = args[3].dat->size[1];
  int xdim4_opensbliblock00Kernel077 = args[4].dat->size[0];
  int ydim4_opensbliblock00Kernel077 = args[4].dat->size[1];
  int xdim5_opensbliblock00Kernel077 = args[5].dat->size[0];
  int ydim5_opensbliblock00Kernel077 = args[5].dat->size[1];
  int xdim6_opensbliblock00Kernel077 = args[6].dat->size[0];
  int ydim6_opensbliblock00Kernel077 = args[6].dat->size[1];
  int xdim7_opensbliblock00Kernel077 = args[7].dat->size[0];
  int ydim7_opensbliblock00Kernel077 = args[7].dat->size[1];
  int xdim8_opensbliblock00Kernel077 = args[8].dat->size[0];
  int ydim8_opensbliblock00Kernel077 = args[8].dat->size[1];
  int xdim9_opensbliblock00Kernel077 = args[9].dat->size[0];
  int ydim9_opensbliblock00Kernel077 = args[9].dat->size[1];
  int xdim10_opensbliblock00Kernel077 = args[10].dat->size[0];
  int ydim10_opensbliblock00Kernel077 = args[10].dat->size[1];
  int xdim11_opensbliblock00Kernel077 = args[11].dat->size[0];
  int ydim11_opensbliblock00Kernel077 = args[11].dat->size[1];
  int xdim12_opensbliblock00Kernel077 = args[12].dat->size[0];
  int ydim12_opensbliblock00Kernel077 = args[12].dat->size[1];
  int xdim13_opensbliblock00Kernel077 = args[13].dat->size[0];
  int ydim13_opensbliblock00Kernel077 = args[13].dat->size[1];
  int xdim14_opensbliblock00Kernel077 = args[14].dat->size[0];
  int ydim14_opensbliblock00Kernel077 = args[14].dat->size[1];
  int xdim15_opensbliblock00Kernel077 = args[15].dat->size[0];
  int ydim15_opensbliblock00Kernel077 = args[15].dat->size[1];
  int xdim16_opensbliblock00Kernel077 = args[16].dat->size[0];
  int ydim16_opensbliblock00Kernel077 = args[16].dat->size[1];
  ...
  double* Residual4_B0_p = (double*)args[16].data_d;
  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0 && (end[2]-start[2])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      cgh.parallel_for<class opensbliblock00Kernel077_kernel>(cl::sycl::nd_range<3>(cl::sycl::range<3>(
      ...
      , [=](cl::sycl::nd_item<3> item
        ...
        const ACC<double> D10_B0(xdim0_opensbliblock00Kernel077, ydim0_opensbliblock00Kernel077, &D10_B0_p[0] + base0 + n_x*1 + n_y * xdim0_opensbliblock00Kernel077*1 + n_z * xdim0_opensbliblock00Kernel077 * ydim0_opensbliblock00Kernel077*1);
        const ACC<double> D11_B0(xdim1_opensbliblock00Kernel077, ydim1_opensbliblock00Kernel077, &D11_B0_p[0] + base1 + n_x*1 + n_y * xdim1_opensbliblock00Kernel077*1 + n_z * xdim1_opensbliblock00Kernel077 * ydim1_opensbliblock00Kernel077*1);
        const ACC<double> a_B0(xdim2_opensbliblock00Kernel077, ydim2_opensbliblock00Kernel077, &a_B0_p[0] + base2 + n_x*1 + n_y * xdim2_opensbliblock00Kernel077*1 + n_z * xdim2_opensbliblock00Kernel077 * ydim2_opensbliblock00Kernel077*1);
        const ACC<double> detJ_B0(xdim3_opensbliblock00Kernel077, ydim3_opensbliblock00Kernel077, &detJ_B0_p[0] + base3 + n_x*1 + n_y * xdim3_opensbliblock00Kernel077*1 + n_z * xdim3_opensbliblock00Kernel077 * ydim3_opensbliblock00Kernel077*1);
        const ACC<double> rhoE_B0(xdim4_opensbliblock00Kernel077, ydim4_opensbliblock00Kernel077, &rhoE_B0_p[0] + base4 + n_x*1 + n_y * xdim4_opensbliblock00Kernel077*1 + n_z * xdim4_opensbliblock00Kernel077 * ydim4_opensbliblock00Kernel077*1);
        const ACC<double> rho_B0(xdim5_opensbliblock00Kernel077, ydim5_opensbliblock00Kernel077, &rho_B0_p[0] + base5 + n_x*1 + n_y * xdim5_opensbliblock00Kernel077*1 + n_z * xdim5_opensbliblock00Kernel077 * ydim5_opensbliblock00Kernel077*1);
        const ACC<double> rhou0_B0(xdim6_opensbliblock00Kernel077, ydim6_opensbliblock00Kernel077, &rhou0_B0_p[0] + base6 + n_x*1 + n_y * xdim6_opensbliblock00Kernel077*1 + n_z * xdim6_opensbliblock00Kernel077 * ydim6_opensbliblock00Kernel077*1);
        const ACC<double> rhou1_B0(xdim7_opensbliblock00Kernel077, ydim7_opensbliblock00Kernel077, &rhou1_B0_p[0] + base7 + n_x*1 + n_y * xdim7_opensbliblock00Kernel077*1 + n_z * xdim7_opensbliblock00Kernel077 * ydim7_opensbliblock00Kernel077*1);
        const ACC<double> rhou2_B0(xdim8_opensbliblock00Kernel077, ydim8_opensbliblock00Kernel077, &rhou2_B0_p[0] + base8 + n_x*1 + n_y * xdim8_opensbliblock00Kernel077*1 + n_z * xdim8_opensbliblock00Kernel077 * ydim8_opensbliblock00Kernel077*1);
        const ACC<double> u0_B0(xdim9_opensbliblock00Kernel077, ydim9_opensbliblock00Kernel077, &u0_B0_p[0] + base9 + n_x*1 + n_y * xdim9_opensbliblock00Kernel077*1 + n_z * xdim9_opensbliblock00Kernel077 * ydim9_opensbliblock00Kernel077*1);
        const ACC<double> u1_B0(xdim10_opensbliblock00Kernel077, ydim10_opensbliblock00Kernel077, &u1_B0_p[0] + base10 + n_x*1 + n_y * xdim10_opensbliblock00Kernel077*1 + n_z * xdim10_opensbliblock00Kernel077 * ydim10_opensbliblock00Kernel077*1);
        const ACC<double> u2_B0(xdim11_opensbliblock00Kernel077, ydim11_opensbliblock00Kernel077, &u2_B0_p[0] + base11 + n_x*1 + n_y * xdim11_opensbliblock00Kernel077*1 + n_z * xdim11_opensbliblock00Kernel077 * ydim11_opensbliblock00Kernel077*1);
        ACC<double> Residual0_B0(xdim12_opensbliblock00Kernel077, ydim12_opensbliblock00Kernel077, &Residual0_B0_p[0] + base12 + n_x*1 + n_y * xdim12_opensbliblock00Kernel077*1 + n_z * xdim12_opensbliblock00Kernel077 * ydim12_opensbliblock00Kernel077*1);
        ACC<double> Residual1_B0(xdim13_opensbliblock00Kernel077, ydim13_opensbliblock00Kernel077, &Residual1_B0_p[0] + base13 + n_x*1 + n_y * xdim13_opensbliblock00Kernel077*1 + n_z * xdim13_opensbliblock00Kernel077 * ydim13_opensbliblock00Kernel077*1);
        ACC<double> Residual2_B0(xdim14_opensbliblock00Kernel077, ydim14_opensbliblock00Kernel077, &Residual2_B0_p[0] + base14 + n_x*1 + n_y * xdim14_opensbliblock00Kernel077*1 + n_z * xdim14_opensbliblock00Kernel077 * ydim14_opensbliblock00Kernel077*1);
        ACC<double> Residual3_B0(xdim15_opensbliblock00Kernel077, ydim15_opensbliblock00Kernel077, &Residual3_B0_p[0] + base15 + n_x*1 + n_y * xdim15_opensbliblock00Kernel077*1 + n_z * xdim15_opensbliblock00Kernel077 * ydim15_opensbliblock00Kernel077*1);
        ACC<double> Residual4_B0(xdim16_opensbliblock00Kernel077, ydim16_opensbliblock00Kernel077, &Residual4_B0_p[0] + base16 + n_x*1 + n_y * xdim16_opensbliblock00Kernel077*1 + n_z * xdim16_opensbliblock00Kernel077 * ydim16_opensbliblock00Kernel077*1);
        //USER CODE
   ...
   ws_lambda_22 = (D10_B0(0,0,0)*AVG_1_u0 + D11_B0(0,0,0)*AVG_1_u1)*detJ_B0(0,0,0);
    ...
    ws_lambda_33 = cl::sycl::sqrt((D10_B0(0,0,0)*D10_B0(0,0,0))*(detJ_B0(0,0,0)*detJ_B0(0,0,0)) +
    ...
    ws_lambda_44 = -cl::sycl::sqrt((D10_B0(0,0,0)*D10_B0(0,0,0))*(detJ_B0(0,0,0)*detJ_B0(0,0,0)) +
      (D11_B0(0,0,0)*D11_B0(0,0,0))*(detJ_B0(0,0,0)*detJ_B0(0,0,0)))*AVG_1_a + D10_B0(0,0,0)*detJ_B0(0,0,0)*AVG_1_u0 +
      D11_B0(0,0,0)*detJ_B0(0,0,0)*AVG_1_u1;
...
void ops_par_loop_opensbliblock00Kernel077(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg16) {
  ...
  desc->function = ops_par_loop_opensbliblock00Kernel077_execute;
  if (block->instance->OPS_diags > 1) {
    ops_timing_realloc(block->instance,40,"opensbliblock00Kernel077");
  }
