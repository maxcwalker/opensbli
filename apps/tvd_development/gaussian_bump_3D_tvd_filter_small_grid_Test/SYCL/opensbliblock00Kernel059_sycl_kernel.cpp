...
void ops_par_loop_opensbliblock00Kernel059_execute(ops_kernel_descriptor *desc) {
  ...
  int xdim0_opensbliblock00Kernel059 = args[0].dat->size[0];
  int ydim0_opensbliblock00Kernel059 = args[0].dat->size[1];
  int xdim1_opensbliblock00Kernel059 = args[1].dat->size[0];
  int ydim1_opensbliblock00Kernel059 = args[1].dat->size[1];
  int xdim2_opensbliblock00Kernel059 = args[2].dat->size[0];
  int ydim2_opensbliblock00Kernel059 = args[2].dat->size[1];
  int xdim3_opensbliblock00Kernel059 = args[3].dat->size[0];
  int ydim3_opensbliblock00Kernel059 = args[3].dat->size[1];
  int xdim4_opensbliblock00Kernel059 = args[4].dat->size[0];
  int ydim4_opensbliblock00Kernel059 = args[4].dat->size[1];
  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0 && (end[2]-start[2])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      cgh.parallel_for<class opensbliblock00Kernel059_kernel>(cl::sycl::nd_range<3>(cl::sycl::range<3>(
      ...
      , [=](cl::sycl::nd_item<3> item
        ...
        ACC<double> D00_B0(xdim0_opensbliblock00Kernel059, ydim0_opensbliblock00Kernel059, &D00_B0_p[0] + base0 + n_x*1 + n_y * xdim0_opensbliblock00Kernel059*1 + n_z * xdim0_opensbliblock00Kernel059 * ydim0_opensbliblock00Kernel059*1);
        ACC<double> D01_B0(xdim1_opensbliblock00Kernel059, ydim1_opensbliblock00Kernel059, &D01_B0_p[0] + base1 + n_x*1 + n_y * xdim1_opensbliblock00Kernel059*1 + n_z * xdim1_opensbliblock00Kernel059 * ydim1_opensbliblock00Kernel059*1);
        ACC<double> D10_B0(xdim2_opensbliblock00Kernel059, ydim2_opensbliblock00Kernel059, &D10_B0_p[0] + base2 + n_x*1 + n_y * xdim2_opensbliblock00Kernel059*1 + n_z * xdim2_opensbliblock00Kernel059 * ydim2_opensbliblock00Kernel059*1);
        ACC<double> D11_B0(xdim3_opensbliblock00Kernel059, ydim3_opensbliblock00Kernel059, &D11_B0_p[0] + base3 + n_x*1 + n_y * xdim3_opensbliblock00Kernel059*1 + n_z * xdim3_opensbliblock00Kernel059 * ydim3_opensbliblock00Kernel059*1);
        ACC<double> detJ_B0(xdim4_opensbliblock00Kernel059, ydim4_opensbliblock00Kernel059, &detJ_B0_p[0] + base4 + n_x*1 + n_y * xdim4_opensbliblock00Kernel059*1 + n_z * xdim4_opensbliblock00Kernel059 * ydim4_opensbliblock00Kernel059*1);
        //USER CODE
