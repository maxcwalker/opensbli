...
void ops_par_loop_opensbliblock00Kernel073_execute(ops_kernel_descriptor *desc) {
 ...
 arg5, arg6, arg7, arg8};
  ...
  int xdim5_opensbliblock00Kernel073 = args[5].dat->size[0];
  int ydim5_opensbliblock00Kernel073 = args[5].dat->size[1];
  int xdim6_opensbliblock00Kernel073 = args[6].dat->size[0];
  int ydim6_opensbliblock00Kernel073 = args[6].dat->size[1];
  int xdim7_opensbliblock00Kernel073 = args[7].dat->size[0];
  int ydim7_opensbliblock00Kernel073 = args[7].dat->size[1];
  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0 && (end[2]-start[2])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      , [=](cl::sycl::nd_item<3> item
        ...
        const ACC<double> D00_B0(xdim0_opensbliblock00Kernel073, ydim0_opensbliblock00Kernel073, &D00_B0_p[0] + base0 + n_x*1 + n_y * xdim0_opensbliblock00Kernel073*1 + n_z * xdim0_opensbliblock00Kernel073 * ydim0_opensbliblock00Kernel073*1);
        const ACC<double> D01_B0(xdim1_opensbliblock00Kernel073, ydim1_opensbliblock00Kernel073, &D01_B0_p[0] + base1 + n_x*1 + n_y * xdim1_opensbliblock00Kernel073*1 + n_z * xdim1_opensbliblock00Kernel073 * ydim1_opensbliblock00Kernel073*1);
        const ACC<double> D10_B0(xdim2_opensbliblock00Kernel073, ydim2_opensbliblock00Kernel073, &D10_B0_p[0] + base2 + n_x*1 + n_y * xdim2_opensbliblock00Kernel073*1 + n_z * xdim2_opensbliblock00Kernel073 * ydim2_opensbliblock00Kernel073*1);
        const ACC<double> D11_B0(xdim3_opensbliblock00Kernel073, ydim3_opensbliblock00Kernel073, &D11_B0_p[0] + base3 + n_x*1 + n_y * xdim3_opensbliblock00Kernel073*1 + n_z * xdim3_opensbliblock00Kernel073 * ydim3_opensbliblock00Kernel073*1);
        const ACC<double> u0_B0(xdim4_opensbliblock00Kernel073, ydim4_opensbliblock00Kernel073, &u0_B0_p[0] + base4 + n_x*1 + n_y * xdim4_opensbliblock00Kernel073*1 + n_z * xdim4_opensbliblock00Kernel073 * ydim4_opensbliblock00Kernel073*1);
        const ACC<double> u1_B0(xdim5_opensbliblock00Kernel073, ydim5_opensbliblock00Kernel073, &u1_B0_p[0] + base5 + n_x*1 + n_y * xdim5_opensbliblock00Kernel073*1 + n_z * xdim5_opensbliblock00Kernel073 * ydim5_opensbliblock00Kernel073*1);
        const ACC<double> u2_B0(xdim6_opensbliblock00Kernel073, ydim6_opensbliblock00Kernel073, &u2_B0_p[0] + base6 + n_x*1 + n_y * xdim6_opensbliblock00Kernel073*1 + n_z * xdim6_opensbliblock00Kernel073 * ydim6_opensbliblock00Kernel073*1);
        ACC<double> kappa_B0(xdim7_opensbliblock00Kernel073, ydim7_opensbliblock00Kernel073, &kappa_B0_p[0] + base7 + n_x*1 + n_y * xdim7_opensbliblock00Kernel073*1 + n_z * xdim7_opensbliblock00Kernel073 * ydim7_opensbliblock00Kernel073*1);
        //USER CODE
   ...
   double d1_u2_dy = 0.0;
   double d1_u2_dz = 0.0;
    d1_u2_dx = invDelta0block0_sycl[0]*((idx[0] == 0) ? (
...
: (
    ...
    d1_u2_dy = invDelta1block0_sycl[0]*((idx[1] == 0) ? (
...
: (
    ...
    kappa_B0(0,0,0) = ((D00_B0(0,0,0)*d1_u0_dx + D01_B0(0,0,0)*d1_u1_dx + D10_B0(0,0,0)*d1_u0_dy +
      ...
      D10_B0(0,0,0)*d1_u0_dy + D11_B0(0,0,0)*d1_u1_dy + d1_u2_dz)/cl::sycl::sqrt((Delta0block0_sycl[0]*Delta0block0_sycl[0]) +
      (Delta1block0_sycl[0]*Delta1block0_sycl[0]) + (Delta2block0_sycl[0]*Delta2block0_sycl[0]))))/(1.0e-40 + ((-d1_u1_dz + D01_B0(0,0,0)*d1_u2_dx +
