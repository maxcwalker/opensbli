...
// host stub function
#ifndef OPS_LAZY
void ops_par_loop_opensbliblock00Kernel076(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg16) {
#else
void ops_par_loop_opensbliblock00Kernel076_execute(ops_kernel_descriptor *desc) {
 ...
 arg15, arg16};
  ...
  if (!ops_checkpointing_before(args,17,range,39)) return;
  #endif

  if (block->instance->OPS_diags > 1) {
    ops_timing_realloc(block->instance,39,"opensbliblock00Kernel076");
    block->instance->OPS_kernels[39].count++;
    ops_timers_core(&__c2,&__t2);
  }

  #ifdef OPS_DEBUG
  ops_register_args(block->instance, args, "opensbliblock00Kernel076");
  #endif
  ...
  int xdim0_opensbliblock00Kernel076 = args[0].dat->size[0];
  int ydim0_opensbliblock00Kernel076 = args[0].dat->size[1];
  int xdim1_opensbliblock00Kernel076 = args[1].dat->size[0];
  int ydim1_opensbliblock00Kernel076 = args[1].dat->size[1];
  int xdim2_opensbliblock00Kernel076 = args[2].dat->size[0];
  int ydim2_opensbliblock00Kernel076 = args[2].dat->size[1];
  int xdim3_opensbliblock00Kernel076 = args[3].dat->size[0];
  int ydim3_opensbliblock00Kernel076 = args[3].dat->size[1];
  int xdim4_opensbliblock00Kernel076 = args[4].dat->size[0];
  int ydim4_opensbliblock00Kernel076 = args[4].dat->size[1];
  int xdim5_opensbliblock00Kernel076 = args[5].dat->size[0];
  int ydim5_opensbliblock00Kernel076 = args[5].dat->size[1];
  int xdim6_opensbliblock00Kernel076 = args[6].dat->size[0];
  int ydim6_opensbliblock00Kernel076 = args[6].dat->size[1];
  int xdim7_opensbliblock00Kernel076 = args[7].dat->size[0];
  int ydim7_opensbliblock00Kernel076 = args[7].dat->size[1];
  int xdim8_opensbliblock00Kernel076 = args[8].dat->size[0];
  int ydim8_opensbliblock00Kernel076 = args[8].dat->size[1];
  int xdim9_opensbliblock00Kernel076 = args[9].dat->size[0];
  int ydim9_opensbliblock00Kernel076 = args[9].dat->size[1];
  int xdim10_opensbliblock00Kernel076 = args[10].dat->size[0];
  int ydim10_opensbliblock00Kernel076 = args[10].dat->size[1];
  int xdim11_opensbliblock00Kernel076 = args[11].dat->size[0];
  int ydim11_opensbliblock00Kernel076 = args[11].dat->size[1];
  int xdim12_opensbliblock00Kernel076 = args[12].dat->size[0];
  int ydim12_opensbliblock00Kernel076 = args[12].dat->size[1];
  int xdim13_opensbliblock00Kernel076 = args[13].dat->size[0];
  int ydim13_opensbliblock00Kernel076 = args[13].dat->size[1];
  int xdim14_opensbliblock00Kernel076 = args[14].dat->size[0];
  int ydim14_opensbliblock00Kernel076 = args[14].dat->size[1];
  int xdim15_opensbliblock00Kernel076 = args[15].dat->size[0];
  int ydim15_opensbliblock00Kernel076 = args[15].dat->size[1];
  int xdim16_opensbliblock00Kernel076 = args[16].dat->size[0];
  int ydim16_opensbliblock00Kernel076 = args[16].dat->size[1];
  ...
  double* wk0_B0_p = (double*)args[12].data_d;
  ...
  double* wk2_B0_p = (double*)args[14].data_d;

  int base15 = args[15].dat->base_offset/sizeof(double);
  double* wk3_B0_p = (double*)args[15].data_d;

  int base16 = args[16].dat->base_offset/sizeof(double);
  double* wk4_B0_p = (double*)args[16].data_d;
  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0 && (end[2]-start[2])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      cgh.parallel_for<class opensbliblock00Kernel076_kernel>(cl::sycl::nd_range<3>(cl::sycl::range<3>(
      ...
      , [=](cl::sycl::nd_item<3> item
        ...
        const ACC<double> D00_B0(xdim0_opensbliblock00Kernel076, ydim0_opensbliblock00Kernel076, &D00_B0_p[0] + base0 + n_x*1 + n_y * xdim0_opensbliblock00Kernel076*1 + n_z * xdim0_opensbliblock00Kernel076 * ydim0_opensbliblock00Kernel076*1);
        const ACC<double> D01_B0(xdim1_opensbliblock00Kernel076, ydim1_opensbliblock00Kernel076, &D01_B0_p[0] + base1 + n_x*1 + n_y * xdim1_opensbliblock00Kernel076*1 + n_z * xdim1_opensbliblock00Kernel076 * ydim1_opensbliblock00Kernel076*1);
        const ACC<double> a_B0(xdim2_opensbliblock00Kernel076, ydim2_opensbliblock00Kernel076, &a_B0_p[0] + base2 + n_x*1 + n_y * xdim2_opensbliblock00Kernel076*1 + n_z * xdim2_opensbliblock00Kernel076 * ydim2_opensbliblock00Kernel076*1);
        const ACC<double> detJ_B0(xdim3_opensbliblock00Kernel076, ydim3_opensbliblock00Kernel076, &detJ_B0_p[0] + base3 + n_x*1 + n_y * xdim3_opensbliblock00Kernel076*1 + n_z * xdim3_opensbliblock00Kernel076 * ydim3_opensbliblock00Kernel076*1);
        const ACC<double> rhoE_B0(xdim4_opensbliblock00Kernel076, ydim4_opensbliblock00Kernel076, &rhoE_B0_p[0] + base4 + n_x*1 + n_y * xdim4_opensbliblock00Kernel076*1 + n_z * xdim4_opensbliblock00Kernel076 * ydim4_opensbliblock00Kernel076*1);
        const ACC<double> rho_B0(xdim5_opensbliblock00Kernel076, ydim5_opensbliblock00Kernel076, &rho_B0_p[0] + base5 + n_x*1 + n_y * xdim5_opensbliblock00Kernel076*1 + n_z * xdim5_opensbliblock00Kernel076 * ydim5_opensbliblock00Kernel076*1);
        const ACC<double> rhou0_B0(xdim6_opensbliblock00Kernel076, ydim6_opensbliblock00Kernel076, &rhou0_B0_p[0] + base6 + n_x*1 + n_y * xdim6_opensbliblock00Kernel076*1 + n_z * xdim6_opensbliblock00Kernel076 * ydim6_opensbliblock00Kernel076*1);
        const ACC<double> rhou1_B0(xdim7_opensbliblock00Kernel076, ydim7_opensbliblock00Kernel076, &rhou1_B0_p[0] + base7 + n_x*1 + n_y * xdim7_opensbliblock00Kernel076*1 + n_z * xdim7_opensbliblock00Kernel076 * ydim7_opensbliblock00Kernel076*1);
        const ACC<double> rhou2_B0(xdim8_opensbliblock00Kernel076, ydim8_opensbliblock00Kernel076, &rhou2_B0_p[0] + base8 + n_x*1 + n_y * xdim8_opensbliblock00Kernel076*1 + n_z * xdim8_opensbliblock00Kernel076 * ydim8_opensbliblock00Kernel076*1);
        const ACC<double> u0_B0(xdim9_opensbliblock00Kernel076, ydim9_opensbliblock00Kernel076, &u0_B0_p[0] + base9 + n_x*1 + n_y * xdim9_opensbliblock00Kernel076*1 + n_z * xdim9_opensbliblock00Kernel076 * ydim9_opensbliblock00Kernel076*1);
        const ACC<double> u1_B0(xdim10_opensbliblock00Kernel076, ydim10_opensbliblock00Kernel076, &u1_B0_p[0] + base10 + n_x*1 + n_y * xdim10_opensbliblock00Kernel076*1 + n_z * xdim10_opensbliblock00Kernel076 * ydim10_opensbliblock00Kernel076*1);
        const ACC<double> u2_B0(xdim11_opensbliblock00Kernel076, ydim11_opensbliblock00Kernel076, &u2_B0_p[0] + base11 + n_x*1 + n_y * xdim11_opensbliblock00Kernel076*1 + n_z * xdim11_opensbliblock00Kernel076 * ydim11_opensbliblock00Kernel076*1);
        ACC<double> wk0_B0(xdim12_opensbliblock00Kernel076, ydim12_opensbliblock00Kernel076, &wk0_B0_p[0] + base12 + n_x*1 + n_y * xdim12_opensbliblock00Kernel076*1 + n_z * xdim12_opensbliblock00Kernel076 * ydim12_opensbliblock00Kernel076*1);
        ACC<double> wk1_B0(xdim13_opensbliblock00Kernel076, ydim13_opensbliblock00Kernel076, &wk1_B0_p[0] + base13 + n_x*1 + n_y * xdim13_opensbliblock00Kernel076*1 + n_z * xdim13_opensbliblock00Kernel076 * ydim13_opensbliblock00Kernel076*1);
        ACC<double> wk2_B0(xdim14_opensbliblock00Kernel076, ydim14_opensbliblock00Kernel076, &wk2_B0_p[0] + base14 + n_x*1 + n_y * xdim14_opensbliblock00Kernel076*1 + n_z * xdim14_opensbliblock00Kernel076 * ydim14_opensbliblock00Kernel076*1);
        ACC<double> wk3_B0(xdim15_opensbliblock00Kernel076, ydim15_opensbliblock00Kernel076, &wk3_B0_p[0] + base15 + n_x*1 + n_y * xdim15_opensbliblock00Kernel076*1 + n_z * xdim15_opensbliblock00Kernel076 * ydim15_opensbliblock00Kernel076*1);
        ACC<double> wk4_B0(xdim16_opensbliblock00Kernel076, ydim16_opensbliblock00Kernel076, &wk4_B0_p[0] + base16 + n_x*1 + n_y * xdim16_opensbliblock00Kernel076*1 + n_z * xdim16_opensbliblock00Kernel076 * ydim16_opensbliblock00Kernel076*1);
        //USER CODE
...
void ops_par_loop_opensbliblock00Kernel076(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg16) {
  ...
  desc->function = ops_par_loop_opensbliblock00Kernel076_execute;
  if (block->instance->OPS_diags > 1) {
    ops_timing_realloc(block->instance,39,"opensbliblock00Kernel076");
  }
