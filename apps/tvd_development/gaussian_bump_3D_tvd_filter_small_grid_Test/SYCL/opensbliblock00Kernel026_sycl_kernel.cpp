  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0 && (end[2]-start[2])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      , [=](cl::sycl::nd_item<3> item
        ...
        const ACC<double> D00_B0(xdim0_opensbliblock00Kernel026, ydim0_opensbliblock00Kernel026, &D00_B0_p[0] + base0 + n_x*1 + n_y * xdim0_opensbliblock00Kernel026*1 + n_z * xdim0_opensbliblock00Kernel026 * ydim0_opensbliblock00Kernel026*1);
        const ACC<double> D01_B0(xdim1_opensbliblock00Kernel026, ydim1_opensbliblock00Kernel026, &D01_B0_p[0] + base1 + n_x*1 + n_y * xdim1_opensbliblock00Kernel026*1 + n_z * xdim1_opensbliblock00Kernel026 * ydim1_opensbliblock00Kernel026*1);
        const ACC<double> u0_B0(xdim2_opensbliblock00Kernel026, ydim2_opensbliblock00Kernel026, &u0_B0_p[0] + base2 + n_x*1 + n_y * xdim2_opensbliblock00Kernel026*1 + n_z * xdim2_opensbliblock00Kernel026 * ydim2_opensbliblock00Kernel026*1);
        const ACC<double> u1_B0(xdim3_opensbliblock00Kernel026, ydim3_opensbliblock00Kernel026, &u1_B0_p[0] + base3 + n_x*1 + n_y * xdim3_opensbliblock00Kernel026*1 + n_z * xdim3_opensbliblock00Kernel026 * ydim3_opensbliblock00Kernel026*1);
        ACC<double> U0_B0(xdim4_opensbliblock00Kernel026, ydim4_opensbliblock00Kernel026, &U0_B0_p[0] + base4 + n_x*1 + n_y * xdim4_opensbliblock00Kernel026*1 + n_z * xdim4_opensbliblock00Kernel026 * ydim4_opensbliblock00Kernel026*1);
        //USER CODE
