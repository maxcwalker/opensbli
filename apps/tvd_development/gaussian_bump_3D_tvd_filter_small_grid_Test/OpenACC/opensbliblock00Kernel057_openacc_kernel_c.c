...
//user function
inline 
 void opensbliblock00Kernel057(const ptr_double x0_B0,
  ...
  for ( int n_z=0; n_z<z_size; n_z++ ){
    ...
    for ( int n_y=0; n_y<y_size; n_y++ ){
      ...
      for ( int n_x=0; n_x<x_size; n_x++ ){
        ...
        ptr_double ptr2 = {  p_a2 + n_x*1*1 + n_y*xdim2_opensbliblock00Kernel057*1*1 + n_z*xdim2_opensbliblock00Kernel057*ydim2_opensbliblock00Kernel057*1*1, xdim2_opensbliblock00Kernel057, ydim2_opensbliblock00Kernel057};
        ptr_double ptr3 = {  p_a3 + n_x*1*1 + n_y*xdim3_opensbliblock00Kernel057*1*1 + n_z*xdim3_opensbliblock00Kernel057*ydim3_opensbliblock00Kernel057*1*1, xdim3_opensbliblock00Kernel057, ydim3_opensbliblock00Kernel057};
        ptr_double ptr4 = {  p_a4 + n_x*1*1 + n_y*xdim4_opensbliblock00Kernel057*1*1 + n_z*xdim4_opensbliblock00Kernel057*ydim4_opensbliblock00Kernel057*1*1, xdim4_opensbliblock00Kernel057, ydim4_opensbliblock00Kernel057};
