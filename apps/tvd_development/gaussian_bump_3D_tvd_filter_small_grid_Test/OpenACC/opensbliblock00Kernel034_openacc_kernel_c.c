...
//user function
inline 
 void opensbliblock00Kernel034(const ptr_double D10_B0,
  ...
  for ( int n_z=0; n_z<z_size; n_z++ ){
    ...
    for ( int n_y=0; n_y<y_size; n_y++ ){
      ...
      for ( int n_x=0; n_x<x_size; n_x++ ){
        ...
        ptr_double ptr4 = {  p_a4 + n_x*1*1 + n_y*xdim4_opensbliblock00Kernel034*1*1 + n_z*xdim4_opensbliblock00Kernel034*ydim4_opensbliblock00Kernel034*1*1, xdim4_opensbliblock00Kernel034, ydim4_opensbliblock00Kernel034};
