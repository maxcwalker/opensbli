...
//
__constant__ int dims_opensbliblock00Kernel038 [2][2];
static int dims_opensbliblock00Kernel038_h [2][2] = {{0}};
...
void ops_par_loop_opensbliblock00Kernel038(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1) {
  ...
  create_kerneldesc_and_enque(name, args, 2, 19, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel038_execute);
}
#endif
