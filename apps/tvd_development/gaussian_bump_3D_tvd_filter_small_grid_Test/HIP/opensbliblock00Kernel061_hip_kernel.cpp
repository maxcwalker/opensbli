...
__device__
 ...
 void opensbliblock00Kernel061_gpu(ACC<double> &D00_B0,
  ACC<double> &D01_B0,
  ACC<double> &D10_B0,
  ACC<double> &D11_B0,
  ACC<double> &detJ_B0)
...
void ops_par_loop_opensbliblock00Kernel061(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4) {
  ...
  create_kerneldesc_and_enque(name, args, 5, 5, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel061_execute);
}
#endif
