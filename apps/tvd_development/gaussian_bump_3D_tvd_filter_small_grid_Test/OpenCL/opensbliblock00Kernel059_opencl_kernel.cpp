...
//
    ...
    void buildOpenCLKernels_opensbliblock00Kernel059(OPS_instance *instance, int xdim0, int ydim0, int xdim1, int ydim1, int xdim2, int ydim2, int xdim3, int ydim3, int xdim4, int ydim4) {
      ...
      if(!isbuilt_opensbliblock00Kernel059) {
        ...
        instance->ostream() <<"Compiling opensbliblock00Kernel059 "<<OCL_FMA<<" source -- start \n";
          ...
          if (pPath!=NULL)
            if(OCL_FMA)
              sprintf(buildOpts,"-cl-mad-enable -DOCL_FMA -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_opensbliblock00Kernel059=%d  -Dydim0_opensbliblock00Kernel059=%d  -Dxdim1_opensbliblock00Kernel059=%d  -Dydim1_opensbliblock00Kernel059=%d  -Dxdim2_opensbliblock00Kernel059=%d  -Dydim2_opensbliblock00Kernel059=%d  -Dxdim3_opensbliblock00Kernel059=%d  -Dydim3_opensbliblock00Kernel059=%d  -Dxdim4_opensbliblock00Kernel059=%d  -Dydim4_opensbliblock00Kernel059=%d ", pPath, 32,xdim0,ydim0,xdim1,ydim1,xdim2,ydim2,xdim3,ydim3,xdim4,ydim4);
            else
        ...
        instance->opencl_instance->OPS_opencl_core.kernel[3] = clCreateKernel(instance->opencl_instance->OPS_opencl_core.program, "ops_opensbliblock00Kernel059", &ret);
        clSafeCall( ret );
