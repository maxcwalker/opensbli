...
//
    ...
    static bool isbuilt_opensbliblock00Kernel054 = false;

    void buildOpenCLKernels_opensbliblock00Kernel054(OPS_instance *instance, int xdim0, int ydim0, int xdim1, int ydim1, int xdim2, int ydim2, int xdim3, int ydim3, int xdim4, int ydim4, int xdim5, int ydim5, int xdim6, int ydim6, int xdim7, int ydim7) {

      //int ocl_fma = OCL_FMA;
      if(!isbuilt_opensbliblock00Kernel054) {
        buildOpenCLKernels(instance);
        //clSafeCall( clUnloadCompiler() );
        cl_int ret;
        char* source_filename[1] = {(char*)"./OpenCL/opensbliblock00Kernel054.cl"};
        ...
        instance->ostream() <<"Compiling opensbliblock00Kernel054 "<<OCL_FMA<<" source -- start \n";
          ...
          if (pPath!=NULL)
            if(OCL_FMA)
              sprintf(buildOpts,"-cl-mad-enable -DOCL_FMA -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_opensbliblock00Kernel054=%d  -Dydim0_opensbliblock00Kernel054=%d  -Dxdim1_opensbliblock00Kernel054=%d  -Dydim1_opensbliblock00Kernel054=%d  -Dxdim2_opensbliblock00Kernel054=%d  -Dydim2_opensbliblock00Kernel054=%d  -Dxdim3_opensbliblock00Kernel054=%d  -Dydim3_opensbliblock00Kernel054=%d  -Dxdim4_opensbliblock00Kernel054=%d  -Dydim4_opensbliblock00Kernel054=%d  -Dxdim5_opensbliblock00Kernel054=%d  -Dydim5_opensbliblock00Kernel054=%d  -Dxdim6_opensbliblock00Kernel054=%d  -Dydim6_opensbliblock00Kernel054=%d  -Dxdim7_opensbliblock00Kernel054=%d  -Dydim7_opensbliblock00Kernel054=%d ", pPath, 32,xdim0,ydim0,xdim1,ydim1,xdim2,ydim2,xdim3,ydim3,xdim4,ydim4,xdim5,ydim5,xdim6,ydim6,xdim7,ydim7);
            else
          ...
          instance->ostream() << "compiling opensbliblock00Kernel054 -- done\n";

        // Create the OpenCL kernel
        instance->opencl_instance->OPS_opencl_core.kernel[0] = clCreateKernel(instance->opencl_instance->OPS_opencl_core.program, "ops_opensbliblock00Kernel054", &ret);
        clSafeCall( ret );

        isbuilt_opensbliblock00Kernel054 = true;
        free(source_str[0]);
      }
...
void ops_par_loop_opensbliblock00Kernel054(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg8) {
  ...
  buildOpenCLKernels_opensbliblock00Kernel054(block->instance,
