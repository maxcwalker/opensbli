...
void opensbliblock00Kernel017_gpu(const ACC<double> &q0_B0,
  ACC<double> &wk9_B0,
  const int *idx)
{
    wk9_B0(0) = inv_0*((idx[0] == 0) ? (
   0.333333333333356*q0_B0(3) -
      1.83333333333334*q0_B0(0) - 8.34657956545823e-15*q0_B0(4) +
      3.00000000000002*q0_B0(1) + 1.06910315192207e-15*q0_B0(5) -
      1.50000000000003*q0_B0(2)
)
: ((idx[0] == 1) ? (
   -0.0658051057710389*q0_B0(3) -
      0.376283677513354*q0_B0(-1) - 0.322484932882161*q0_B0(0) +
      0.00571369039775442*q0_B0(4) + 0.719443173328855*q0_B0(1) +
      0.0394168524399447*q0_B0(2)
)
: ((idx[0] == 2) ? (
   -0.00412637789557492*q0_B0(3) +
      0.113446470384241*q0_B0(-2) - 0.791245592765872*q0_B0(-1) +
      0.197184333887745*q0_B0(0) + 0.521455851089587*q0_B0(1) -
      0.0367146847001261*q0_B0(2)
)
: ((idx[0] == 3) ? (
   0.121937153224065*q0_B0(-2) -
      0.727822147724592*q0_B0(-1) + 0.0451033223343881*q0_B0(0) +
      0.652141084861241*q0_B0(1) - 0.082033432844602*q0_B0(2) -
      0.00932597985049999*q0_B0(-3)
)
: ((idx[0] == block0np0 - 1) ? (
   1.50000000000003*q0_B0(-2)
      - 3.00000000000002*q0_B0(-1) + 1.83333333333334*q0_B0(0) -
      1.06910315192207e-15*q0_B0(-5) + 8.34657956545823e-15*q0_B0(-4) -
      0.333333333333356*q0_B0(-3)
)
: ((idx[0] == block0np0 - 2) ? (

      -0.0394168524399447*q0_B0(-2) - 0.719443173328855*q0_B0(-1) +
      0.322484932882161*q0_B0(0) + 0.376283677513354*q0_B0(1) -
      0.00571369039775442*q0_B0(-4) + 0.0658051057710389*q0_B0(-3)
)
: ((idx[0] == block0np0 - 3) ?
      (
   0.0367146847001261*q0_B0(-2) - 0.521455851089587*q0_B0(-1) -
      0.197184333887745*q0_B0(0) + 0.791245592765872*q0_B0(1) - 0.113446470384241*q0_B0(2)
      + 0.00412637789557492*q0_B0(-3)
)
: ((idx[0] == block0np0 - 4) ? (

      0.00932597985049999*q0_B0(3) + 0.082033432844602*q0_B0(-2) -
      0.652141084861241*q0_B0(-1) - 0.0451033223343881*q0_B0(0) +
      0.727822147724592*q0_B0(1) - 0.121937153224065*q0_B0(2)
)
: (
   (rc3)*q0_B0(-2) -
      rc2*q0_B0(-1) + (rc2)*q0_B0(1) - rc3*q0_B0(2)
)))))))));
