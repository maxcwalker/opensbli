...
//
__constant__ int dims_opensbliblock00Kernel019 [19][1];
static int dims_opensbliblock00Kernel019_h [19][1] = {{0}};

//user function
__device__

 void opensbliblock00Kernel019_gpu(const ACC<double> &wk6_B0,
...
{
    Residual0_B0(0) = -rc1*rho_B0(0)*wk4_B0(0) -
      rc1*u0_B0(0)*wk6_B0(0) - rc1*wk10_B0(0);

    Residual1_B0(0) = -rc1*rhou0_B0(0)*wk4_B0(0) -
      rc1*u0_B0(0)*wk1_B0(0) - rc1*wk3_B0(0) - wk7_B0(0) +
      wk8_B0(0);

    Residual2_B0(0) = -rc1*rhoE_B0(0)*wk4_B0(0) +
      tau00_B0(0)*wk4_B0(0) - rc1*u0_B0(0)*wk2_B0(0) +
      u0_B0(0)*wk8_B0(0) - wk0_B0(0) - rc1*wk5_B0(0) + wk9_B0(0);
...
int size0 ){
  ...
  if (size0==-1) dims_opensbliblock00Kernel019[0][0]=0;
  ...
  if (idx_x < size0) {
    ...
    opensbliblock00Kernel019_gpu(argp0, argp1, argp2, argp3,
...
void ops_par_loop_opensbliblock00Kernel019_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_opensbliblock00Kernel019_h[0][0] || xdim1 != dims_opensbliblock00Kernel019_h[1][0] || xdim2 != dims_opensbliblock00Kernel019_h[2][0] || xdim3 != dims_opensbliblock00Kernel019_h[3][0] || xdim4 != dims_opensbliblock00Kernel019_h[4][0] || xdim5 != dims_opensbliblock00Kernel019_h[5][0] || xdim6 != dims_opensbliblock00Kernel019_h[6][0] || xdim7 != dims_opensbliblock00Kernel019_h[7][0] || xdim8 != dims_opensbliblock00Kernel019_h[8][0] || xdim9 != dims_opensbliblock00Kernel019_h[9][0] || xdim10 != dims_opensbliblock00Kernel019_h[10][0] || xdim11 != dims_opensbliblock00Kernel019_h[11][0] || xdim12 != dims_opensbliblock00Kernel019_h[12][0] || xdim13 != dims_opensbliblock00Kernel019_h[13][0] || xdim14 != dims_opensbliblock00Kernel019_h[14][0] || xdim15 != dims_opensbliblock00Kernel019_h[15][0] || xdim16 != dims_opensbliblock00Kernel019_h[16][0] || xdim17 != dims_opensbliblock00Kernel019_h[17][0] || xdim18 != dims_opensbliblock00Kernel019_h[18][0]) {
    ...
    hipSafeCall(block->instance->ostream(), hipMemcpyToSymbol(HIP_SYMBOL(dims_opensbliblock00Kernel019), dims_opensbliblock00Kernel019_h, sizeof(dims_opensbliblock00Kernel019)));
  }
  ...
  if (x_size > 0)
    hipLaunchKernelGGL(ops_opensbliblock00Kernel019,grid ,tblock ,0 ,0 , (double *)p_a[0], (double *)p_a[1],
