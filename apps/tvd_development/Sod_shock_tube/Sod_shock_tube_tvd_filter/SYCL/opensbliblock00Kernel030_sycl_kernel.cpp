...
void ops_par_loop_opensbliblock00Kernel030_execute(ops_kernel_descriptor *desc) {
 ...
 arg10};
  ...
  double* Residual1_B0_p = (double*)args[0].data_d;

  int base1 = args[1].dat->base_offset/sizeof(double);
  double* Residual2_B0_p = (double*)args[1].data_d;

  int base2 = args[2].dat->base_offset/sizeof(double);
  double* Residual0_B0_p = (double*)args[2].data_d;

  int base3 = args[3].dat->base_offset/sizeof(double);
  double* tempRK_rho_B0_p = (double*)args[3].data_d;

  int base4 = args[4].dat->base_offset/sizeof(double);
  double* tempRK_rhoE_B0_p = (double*)args[4].data_d;
  ...
  double* tempRK_rhou0_B0_p = (double*)args[7].data_d;

  int base8 = args[8].dat->base_offset/sizeof(double);
  double* rhoE_B0_p = (double*)args[8].data_d;

  double rkB_val = *(double *)args[9].data;


  double rkA_val = *(double *)args[10].data;
  ...
  if ((end[0]-start[0])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      cgh.parallel_for<class opensbliblock00Kernel030_kernel>(cl::sycl::nd_range<1>(cl::sycl::range<1>(
      ...
      , [=](cl::sycl::nd_item<1> item
        ...
        ACC<double> tempRK_rho_B0(&tempRK_rho_B0_p[0] + base3 + n_x*1);
        ACC<double> tempRK_rhoE_B0(&tempRK_rhoE_B0_p[0] + base4 + n_x*1);
        ACC<double> rho_B0(&rho_B0_p[0] + base5 + n_x*1);
        ACC<double> rhou0_B0(&rhou0_B0_p[0] + base6 + n_x*1);
        ACC<double> tempRK_rhou0_B0(&tempRK_rhou0_B0_p[0] + base7 + n_x*1);
   ...
   tempRK_rho_B0(0) = dt_sycl[0]*Residual0_B0(0) + rkA[0]*tempRK_rho_B0(0);

   rho_B0(0) = rkB[0]*tempRK_rho_B0(0) + rho_B0(0);

   tempRK_rhou0_B0(0) = dt_sycl[0]*Residual1_B0(0) + rkA[0]*tempRK_rhou0_B0(0);

   rhou0_B0(0) = rkB[0]*tempRK_rhou0_B0(0) + rhou0_B0(0);

   tempRK_rhoE_B0(0) = dt_sycl[0]*Residual2_B0(0) + rkA[0]*tempRK_rhoE_B0(0);
