 ...
 arg5, arg6, arg7, arg8};
  ...
  if ((end[0]-start[0])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      auto rc1_sycl = (*rc1_p).template get_access<cl::sycl::access::mode::read>(cgh);
      auto rc4_sycl = (*rc4_p).template get_access<cl::sycl::access::mode::read>(cgh);
      ...
      , [=](cl::sycl::nd_item<1> item
        ...
        const ACC<double> a_B0(&a_B0_p[0] + base5 + n_x*1);
        ACC<double> wk0_B0(&wk0_B0_p[0] + base6 + n_x*1);
        ACC<double> wk2_B0(&wk2_B0_p[0] + base7 + n_x*1);
   ...
   AVG_0_a = (rc1_sycl[0])*(a_B0(-1) + a_B0(0));

   AVG_0_u0 = (rc1_sycl[0])*(u0_B0(-1) + u0_B0(0));

   inv_AVG_a = 1.0/AVG_0_a;

   AVG_0_0_LEV_00 = (rc4_sycl[0])*AVG_0_u0*inv_AVG_a*(gama_sycl[0]*AVG_0_a*AVG_0_u0*pow(inv_AVG_a, 2) - AVG_0_a*AVG_0_u0*pow(inv_AVG_a,
      2) + 2);

   AVG_0_0_LEV_01 = -rc1_sycl[0]*inv_AVG_a*(gama_sycl[0]*AVG_0_a*AVG_0_u0*pow(inv_AVG_a, 2) - AVG_0_a*AVG_0_u0*pow(inv_AVG_a, 2) + 1);

   AVG_0_0_LEV_02 = (rc1_sycl[0])*gamma_m1_sycl[0]*pow(inv_AVG_a, 2);

   AVG_0_0_LEV_10 = -rc1_sycl[0]*(gama_sycl[0]*pow(AVG_0_u0, 2)*pow(inv_AVG_a, 2) - pow(AVG_0_u0, 2)*pow(inv_AVG_a, 2) - 2);

   AVG_0_0_LEV_11 = gamma_m1_sycl[0]*AVG_0_u0*pow(inv_AVG_a, 2);

   AVG_0_0_LEV_12 = -gamma_m1_sycl[0]*pow(inv_AVG_a, 2);

   AVG_0_0_LEV_20 = (rc4_sycl[0])*AVG_0_u0*inv_AVG_a*(gama_sycl[0]*AVG_0_a*AVG_0_u0*pow(inv_AVG_a, 2) - AVG_0_a*AVG_0_u0*pow(inv_AVG_a,
      2) - 2);

   AVG_0_0_LEV_21 = -rc1_sycl[0]*inv_AVG_a*(gama_sycl[0]*AVG_0_a*AVG_0_u0*pow(inv_AVG_a, 2) - AVG_0_a*AVG_0_u0*pow(inv_AVG_a, 2) - 1);

   AVG_0_0_LEV_22 = (rc1_sycl[0])*gamma_m1_sycl[0]*pow(inv_AVG_a, 2);
   ...
   AVG_0_a = (rc1_sycl[0])*(a_B0(0) + a_B0(1));

   AVG_0_u0 = (rc1_sycl[0])*(u0_B0(0) + u0_B0(1));
   ...
   AVG_0_0_REV_20 = pow(AVG_0_a,2) / gamma_m1_sycl[0] + 0.5*pow(AVG_0_u0,2) - AVG_0_u0*AVG_0_a;
   AVG_0_0_REV_21 = 0.5*pow(AVG_0_u0,2);
   AVG_0_0_REV_22 = pow(AVG_0_a,2)*(1/gamma_m1_sycl[0]+ AVG_0_u0*inv_AVG_a);
   ...
   AVG_0_a = (rc1_sycl[0])*(a_B0(1) + a_B0(2));

   AVG_0_u0 = (rc1_sycl[0])*(u0_B0(1) + u0_B0(2));
   ...
   sigma_0 = cl::sycl::fabs(ws_0) >= delta ? cl::sycl::fabs(ws_0) : (pow(ws_0,2) + pow(delta,2)) / (2*delta);
   sigma_1 = cl::sycl::fabs(ws_1) >= delta ? cl::sycl::fabs(ws_1) : (pow(ws_1,2) + pow(delta,2)) / (2*delta);
   sigma_2 = cl::sycl::fabs(ws_2) >= delta ? cl::sycl::fabs(ws_2) : (pow(ws_2,2) + pow(delta,2)) / (2*delta);
   ...
   g_00 = S*cl::sycl::fmax(cl::sycl::fmax(0,cl::sycl::fmin(2*cl::sycl::fabs(alpha_01), S*alpha_00)),cl::sycl::fmin(cl::sycl::fabs(alpha_01),2*S*alpha_00));

   S = alpha_11 < 0 ? -1 : (alpha_11 > 0 ? 1 : 0);
   g_10 = S*cl::sycl::fmax(cl::sycl::fmax(0,cl::sycl::fmin(2*cl::sycl::fabs(alpha_11), S*alpha_10)),cl::sycl::fmin(cl::sycl::fabs(alpha_11),2*S*alpha_10));

   S = alpha_21 < 0 ? -1 : (alpha_21 > 0 ? 1 : 0);
   g_20 = S*cl::sycl::fmax(cl::sycl::fmax(0,cl::sycl::fmin(2*cl::sycl::fabs(alpha_21), S*alpha_20)),cl::sycl::fmin(cl::sycl::fabs(alpha_21),2*S*alpha_20));



   S = alpha_02 < 0 ? -1 : (alpha_02 > 0 ? 1 : 0);
   g_01 = S*cl::sycl::fmax(cl::sycl::fmax(0,cl::sycl::fmin(2*cl::sycl::fabs(alpha_02), S*alpha_01)),cl::sycl::fmin(cl::sycl::fabs(alpha_02),2*S*alpha_01));

   S = alpha_12 < 0 ? -1 : (alpha_12 > 0 ? 1 : 0);
   g_11 = S*cl::sycl::fmax(cl::sycl::fmax(0,cl::sycl::fmin(2*cl::sycl::fabs(alpha_12), S*alpha_11)),cl::sycl::fmin(cl::sycl::fabs(alpha_12),2*S*alpha_11));

   S = alpha_22 < 0 ? -1 : (alpha_22 > 0 ? 1 : 0);
   g_21 = S*cl::sycl::fmax(cl::sycl::fmax(0,cl::sycl::fmin(2*cl::sycl::fabs(alpha_22), S*alpha_21)),cl::sycl::fmin(cl::sycl::fabs(alpha_22),2*S*alpha_21));
   ...
   sigma_3 = cl::sycl::fabs(gamma_0) >= delta ? cl::sycl::fabs(gamma_0) : (pow((gamma_0),2) + pow(delta,2)) / (2*delta);
   sigma_4 = cl::sycl::fabs(gamma_1) >= delta ? cl::sycl::fabs(gamma_1) : (pow((gamma_1),2) + pow(delta,2)) / (2*delta);
   sigma_5 = cl::sycl::fabs(gamma_2) >= delta ? cl::sycl::fabs(gamma_2) : (pow((gamma_2),2) + pow(delta,2)) / (2*delta);
   ...
   theta_hat_00 = pow(cl::sycl::fabs((cl::sycl::fabs(alpha_01) - cl::sycl::fabs(alpha_00)) / (cl::sycl::fabs(alpha_01) + cl::sycl::fabs(alpha_00)+eps)),power);
   theta_hat_10 = pow(cl::sycl::fabs((cl::sycl::fabs(alpha_11) - cl::sycl::fabs(alpha_10)) / (cl::sycl::fabs(alpha_11) + cl::sycl::fabs(alpha_10)+eps)),power);
   theta_hat_20 = pow(cl::sycl::fabs((cl::sycl::fabs(alpha_21) - cl::sycl::fabs(alpha_20)) / (cl::sycl::fabs(alpha_21) + cl::sycl::fabs(alpha_20)+eps)),power);


   theta_hat_01 = pow(cl::sycl::fabs((cl::sycl::fabs(alpha_02) - cl::sycl::fabs(alpha_01)) / (cl::sycl::fabs(alpha_02) + cl::sycl::fabs(alpha_01)+eps)),power);
   theta_hat_11 = pow(cl::sycl::fabs((cl::sycl::fabs(alpha_12) - cl::sycl::fabs(alpha_11)) / (cl::sycl::fabs(alpha_12) + cl::sycl::fabs(alpha_11)+eps)),power);
   theta_hat_21 = pow(cl::sycl::fabs((cl::sycl::fabs(alpha_22) - cl::sycl::fabs(alpha_21)) / (cl::sycl::fabs(alpha_22) + cl::sycl::fabs(alpha_21)+eps)),power);
