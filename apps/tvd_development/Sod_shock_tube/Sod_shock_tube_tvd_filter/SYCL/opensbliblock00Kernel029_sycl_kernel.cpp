...
void ops_par_loop_opensbliblock00Kernel029_execute(ops_kernel_descriptor *desc) {
 ...
 arg5, arg6, arg7};
  ...
  double* Mach_sensor_B0_p = (double*)args[1].data_d;
  ...
  double* wk1_B0_p = (double*)args[3].data_d;
  ...
  if ((end[0]-start[0])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      cgh.parallel_for<class opensbliblock00Kernel029_kernel>(cl::sycl::nd_range<1>(cl::sycl::range<1>(
      ...
      , [=](cl::sycl::nd_item<1> item
        ...
        const ACC<double> Mach_sensor_B0(&Mach_sensor_B0_p[0] + base1 + n_x*1);
        const ACC<double> wk2_B0(&wk2_B0_p[0] + base2 + n_x*1);
        const ACC<double> wk1_B0(&wk1_B0_p[0] + base3 + n_x*1);
        ACC<double> rho_B0(&rho_B0_p[0] + base4 + n_x*1);
        ACC<double> rhou0_B0(&rhou0_B0_p[0] + base5 + n_x*1);
        ACC<double> rhoE_B0(&rhoE_B0_p[0] + base6 + n_x*1);
        //USER CODE
        if (n_x < end_0) {
          


   rho_B0(0) = rho_B0(0) - dt_sycl[0]*inv_0_sycl[0]*(wk0_B0(0) - wk0_B0(-1));
   rhou0_B0(0) = rhou0_B0(0) - dt_sycl[0]*inv_0_sycl[0]*(wk1_B0(0) - wk1_B0(-1));
   rhoE_B0(0) = rhoE_B0(0) - dt_sycl[0]*inv_0_sycl[0]*(wk2_B0(0) - wk2_B0(-1));
