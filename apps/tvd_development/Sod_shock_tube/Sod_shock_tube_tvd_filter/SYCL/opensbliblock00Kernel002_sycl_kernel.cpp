...
void ops_par_loop_opensbliblock00Kernel002_execute(ops_kernel_descriptor *desc) {
 ...
 arg5, arg6, arg7, arg8};
  ...
  double* wk16_B0_p = (double*)args[5].data_d;
  ...
  double* wk17_B0_p = (double*)args[7].data_d;

  int base8 = args[8].dat->base_offset/sizeof(double);
  double* wk15_B0_p = (double*)args[8].data_d;
  ...
  if ((end[0]-start[0])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      , [=](cl::sycl::nd_item<1> item
        ...
        ACC<double> wk16_B0(&wk16_B0_p[0] + base5 + n_x*1);
        ACC<double> wk14_B0(&wk14_B0_p[0] + base6 + n_x*1);
        ACC<double> wk17_B0(&wk17_B0_p[0] + base7 + n_x*1);
        ACC<double> wk15_B0(&wk15_B0_p[0] + base8 + n_x*1);
        //USER CODE
        if (n_x < end_0) {
