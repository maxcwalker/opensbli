...
void ops_par_loop_opensbliblock00Kernel007_execute(ops_kernel_descriptor *desc) {
  ...
  double* q0_B0_p = (double*)args[0].data_d;
  ...
  if ((end[0]-start[0])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      , [=](cl::sycl::nd_item<1> item
        ...
        const ACC<double> q0_B0(&q0_B0_p[0] + base0 + n_x*1);
        ACC<double> wk4_B0(&wk4_B0_p[0] + base1 + n_x*1);
        //USER CODE
        if (n_x < end_0) {
          
    wk4_B0(0) = inv_0_sycl[0]*((idx[0] == 0) ? (
...
: (
   (rc2_sycl[0])*q0_B0(-2) -
      rc2_sycl[0]*q0_B0(2) - rc3_sycl[0]*q0_B0(-1) + (rc3_sycl[0])*q0_B0(1)
)))))))));
