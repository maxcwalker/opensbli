  ...
  if ((end[0]-start[0])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      , [=](cl::sycl::nd_item<1> item
        ...
        ACC<double> wk7_B0(&wk7_B0_p[0] + base1 + n_x*1);
        //USER CODE
        if (n_x < end_0) {
          
    wk7_B0(0) = inv_0_sycl[0]*((idx[0] == 0) ? (
...
: (
      ...
      -rc3_sycl[0]*rhoE_B0(-1) + (rc2_sycl[0])*rhoE_B0(-2) - rc2_sycl[0]*rhoE_B0(2) +
      (rc3_sycl[0])*rhoE_B0(1)
)))))))));
