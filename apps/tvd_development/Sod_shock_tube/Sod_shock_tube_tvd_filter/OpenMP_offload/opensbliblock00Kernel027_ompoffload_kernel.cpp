...
void ops_par_loop_opensbliblock00Kernel027_execute(ops_kernel_descriptor *desc) {
  ...
  double * __restrict__ Mach_sensor_B0_p = (double *)(args[3].data_d + base3);
...
void ops_par_loop_opensbliblock00Kernel027(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4, ops_arg arg5, ops_arg arg6) {
  ...
  create_kerneldesc_and_enque(name, args, 7, 21, dim, 0, range, block, ops_par_loop_opensbliblock00Kernel027_execute);
}
#endif
