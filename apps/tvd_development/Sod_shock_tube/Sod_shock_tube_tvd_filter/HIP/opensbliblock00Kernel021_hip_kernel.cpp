...
//
__constant__ int dims_opensbliblock00Kernel021 [19][1];
static int dims_opensbliblock00Kernel021_h [19][1] = {{0}};

//user function
__device__

 void opensbliblock00Kernel021_gpu(const ACC<double> &wk5_B0,
