...
//
__constant__ int dims_opensbliblock00Kernel030 [11][1];
static int dims_opensbliblock00Kernel030_h [11][1] = {{0}};

//user function
__device__

 void opensbliblock00Kernel030_gpu(const ACC<double> &Residual1_B0,
...
void ops_par_loop_opensbliblock00Kernel030_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_opensbliblock00Kernel030_h[0][0] || xdim1 != dims_opensbliblock00Kernel030_h[1][0] || xdim2 != dims_opensbliblock00Kernel030_h[2][0] || xdim3 != dims_opensbliblock00Kernel030_h[3][0] || xdim4 != dims_opensbliblock00Kernel030_h[4][0] || xdim5 != dims_opensbliblock00Kernel030_h[5][0] || xdim6 != dims_opensbliblock00Kernel030_h[6][0] || xdim7 != dims_opensbliblock00Kernel030_h[7][0] || xdim8 != dims_opensbliblock00Kernel030_h[8][0]) {
...
void ops_par_loop_opensbliblock00Kernel030(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg8, ops_arg arg9, ops_arg arg10) {
  ...
  create_kerneldesc_and_enque(name, args, 11, 20, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel030_execute);
}
#endif
