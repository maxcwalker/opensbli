...
void ops_par_loop_opensbliblock00Kernel004_execute(ops_kernel_descriptor *desc) {
 ...
 arg5, arg6};
  ...
  if ((end[0]-start[0])>0) {
   ...
   rho_B0(0) = -(-wk0_B0(-1) + wk0_B0(0))*dt_sycl[0]*inv_rfact0_block0_sycl[0] + rho_B0(0);

   rhou0_B0(0) = -(-wk1_B0(-1) + wk1_B0(0))*dt_sycl[0]*inv_rfact0_block0_sycl[0] + rhou0_B0(0);

   rhoE_B0(0) = -(-wk2_B0(-1) + wk2_B0(0))*dt_sycl[0]*inv_rfact0_block0_sycl[0] + rhoE_B0(0);
