 ...
 arg5, arg6, arg7, arg8};
  ...
  if ((end[0]-start[0])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      cgh.parallel_for<class opensbliblock00Kernel003_kernel>(cl::sycl::nd_range<1>(cl::sycl::range<1>(
   ...
   double rj1 = 0.0;
   double rj2 = 0.0;
   AVG_0_rho = cl::sycl::sqrt(rho_B0(0)*rho_B0(1));

   AVG_0_inv_rho = 1.0/((cl::sycl::sqrt(rho_B0(0)) + cl::sycl::sqrt(rho_B0(1))));

   AVG_0_u0 = (cl::sycl::sqrt(rho_B0(0))*u0_B0(0) + cl::sycl::sqrt(rho_B0(1))*u0_B0(1))*AVG_0_inv_rho;

    AVG_0_a = cl::sycl::sqrt((-(1.0/2.0)*(AVG_0_u0*AVG_0_u0) + ((p_B0(0) + rhoE_B0(0))/cl::sycl::sqrt(rho_B0(0)) + (p_B0(1) +
      rhoE_B0(1))/cl::sycl::sqrt(rho_B0(1)))*AVG_0_inv_rho)*gamma_m1_sycl[0]);
   ...
   inv_AVG_rho = 1.0/(AVG_0_rho);
    ...
    AVG_0_0_LEV_00 = ((1.0/4.0))*(2 - (inv_AVG_a*inv_AVG_a)*AVG_0_a*AVG_0_u0 +
      (inv_AVG_a*inv_AVG_a)*gama_sycl[0]*AVG_0_a*AVG_0_u0)*AVG_0_u0*inv_AVG_a;

    AVG_0_0_LEV_01 = -(1.0/2.0)*(1 - (inv_AVG_a*inv_AVG_a)*AVG_0_a*AVG_0_u0 +
      (inv_AVG_a*inv_AVG_a)*gama_sycl[0]*AVG_0_a*AVG_0_u0)*inv_AVG_a;

   AVG_0_0_LEV_02 = ((1.0/2.0))*(inv_AVG_a*inv_AVG_a)*gamma_m1_sycl[0];

    AVG_0_0_LEV_10 = -(1.0/2.0)*(-2 - (AVG_0_u0*AVG_0_u0)*(inv_AVG_a*inv_AVG_a) +
      (AVG_0_u0*AVG_0_u0)*(inv_AVG_a*inv_AVG_a)*gama_sycl[0]);

   AVG_0_0_LEV_11 = (inv_AVG_a*inv_AVG_a)*gamma_m1_sycl[0]*AVG_0_u0;

   AVG_0_0_LEV_12 = -(inv_AVG_a*inv_AVG_a)*gamma_m1_sycl[0];
   ...
   AVG_0_0_LEV_22 = ((1.0/2.0))*(inv_AVG_a*inv_AVG_a)*gamma_m1_sycl[0];
   ...
   max_lambda_00 = shock_filter_control_sycl[0]*cl::sycl::fmax(cl::sycl::fabs(-u0_B0(0) + a_B0(0)), cl::sycl::fabs(-u0_B0(1) + a_B0(1)));

   max_lambda_11 = shock_filter_control_sycl[0]*cl::sycl::fmax(cl::sycl::fabs(u0_B0(0)), cl::sycl::fabs(u0_B0(1)));

   max_lambda_22 = shock_filter_control_sycl[0]*cl::sycl::fmax(cl::sycl::fabs(a_B0(0) + u0_B0(0)), cl::sycl::fabs(a_B0(1) + u0_B0(1)));
   ...
   wk1_B0(0) = (-AVG_0_a + AVG_0_u0)*Recon_0 + (AVG_0_a + AVG_0_u0)*Recon_2 + AVG_0_u0*Recon_1;
    ...
    wk2_B0(0) = (((1.0/2.0))*(AVG_0_u0*AVG_0_u0) + (AVG_0_a*AVG_0_a)*invgamma_m1_sycl[0] + AVG_0_a*AVG_0_u0)*Recon_2 +
      (((1.0/2.0))*(AVG_0_u0*AVG_0_u0) + (AVG_0_a*AVG_0_a)*invgamma_m1_sycl[0] - AVG_0_a*AVG_0_u0)*Recon_0 +
