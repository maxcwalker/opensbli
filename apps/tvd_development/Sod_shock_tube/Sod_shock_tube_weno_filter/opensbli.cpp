...
if (restart == 0){
int iteration_range_27_block0[] = {-5, block0np0 + 5};
ops_par_loop(opensbliblock00Kernel027, "Grid_based_initialisation0", opensbliblock00, 1, iteration_range_27_block0,
...
int iteration_range_25_block0[] = {-3, 1};
ops_par_loop(opensbliblock00Kernel025, "Dirichlet boundary dir0 side0", opensbliblock00, 1, iteration_range_25_block0,
ops_arg_dat(rhoE_B0, 1, stencil_0_00_1, "double", OPS_WRITE),
ops_arg_dat(rho_B0, 1, stencil_0_00_1, "double", OPS_WRITE),
ops_arg_dat(rhou0_B0, 1, stencil_0_00_1, "double", OPS_WRITE));

int iteration_range_26_block0[] = {block0np0 - 1, block0np0 + 4};
ops_par_loop(opensbliblock00Kernel026, "Dirichlet boundary dir0 side1", opensbliblock00, 1, iteration_range_26_block0,
ops_arg_dat(rhoE_B0, 1, stencil_0_00_1, "double", OPS_WRITE),
ops_arg_dat(rho_B0, 1, stencil_0_00_1, "double", OPS_WRITE),
ops_arg_dat(rhou0_B0, 1, stencil_0_00_1, "double", OPS_WRITE));
...
int iteration_range_12_block0[] = {-2, block0np0 + 2};
ops_par_loop(opensbliblock00Kernel012, "CRp_B0", opensbliblock00, 1, iteration_range_12_block0,
...
int iteration_range_5_block0[] = {-2, block0np0 + 2};
ops_par_loop(opensbliblock00Kernel005, "Convective terms group 0", opensbliblock00, 1, iteration_range_5_block0,
ops_arg_dat(p_B0, 1, stencil_0_00_1, "double", OPS_READ),
ops_arg_dat(rhoE_B0, 1, stencil_0_00_1, "double", OPS_READ),
ops_arg_dat(rho_B0, 1, stencil_0_00_1, "double", OPS_READ),
ops_arg_dat(rhou0_B0, 1, stencil_0_00_1, "double", OPS_READ),
ops_arg_dat(u0_B0, 1, stencil_0_00_1, "double", OPS_READ),
ops_arg_dat(wk14_B0, 1, stencil_0_00_1, "double", OPS_WRITE),
ops_arg_dat(wk15_B0, 1, stencil_0_00_1, "double", OPS_WRITE),
ops_arg_dat(wk16_B0, 1, stencil_0_00_1, "double", OPS_WRITE),
ops_arg_dat(wk17_B0, 1, stencil_0_00_1, "double", OPS_WRITE));

int iteration_range_7_block0[] = {0, block0np0};
ops_par_loop(opensbliblock00Kernel007, "Convective CD tau00_B0 xi0 ", opensbliblock00, 1, iteration_range_7_block0,
ops_arg_dat(tau00_B0, 1, stencil_0_44_1, "double", OPS_READ),
...
ops_arg_dat(wk14_B0, 1, stencil_0_44_1, "double", OPS_READ),
ops_arg_dat(wk4_B0, 1, stencil_0_00_1, "double", OPS_WRITE),
ops_arg_idx());

int iteration_range_11_block0[] = {0, block0np0};
ops_par_loop(opensbliblock00Kernel011, "Convective CD rhoE_B0 xi0 ", opensbliblock00, 1, iteration_range_11_block0,
...
ops_par_loop(opensbliblock00Kernel013, "Convective CD p_B0*u0_B0 xi0 ", opensbliblock00, 1, iteration_range_13_block0,
ops_arg_dat(wk15_B0, 1, stencil_0_44_1, "double", OPS_READ),
ops_arg_dat(wk6_B0, 1, stencil_0_00_1, "double", OPS_WRITE),
ops_arg_idx());

int iteration_range_15_block0[] = {0, block0np0};
ops_par_loop(opensbliblock00Kernel015, "Convective CD q0_B0 xi0 ", opensbliblock00, 1, iteration_range_15_block0,
ops_arg_dat(q0_B0, 1, stencil_0_44_1, "double", OPS_READ),
ops_arg_dat(wk7_B0, 1, stencil_0_00_1, "double", OPS_WRITE),
ops_arg_idx());

int iteration_range_17_block0[] = {0, block0np0};
ops_par_loop(opensbliblock00Kernel017, "Convective CD rhou0_B0*u0_B0 xi0 ", opensbliblock00, 1, iteration_range_17_block0,
ops_arg_dat(wk16_B0, 1, stencil_0_44_1, "double", OPS_READ),
ops_arg_dat(wk8_B0, 1, stencil_0_00_1, "double", OPS_WRITE),
ops_arg_idx());

int iteration_range_19_block0[] = {0, block0np0};
ops_par_loop(opensbliblock00Kernel019, "Convective CD rho_B0*u0_B0 xi0 ", opensbliblock00, 1, iteration_range_19_block0,
ops_arg_dat(wk17_B0, 1, stencil_0_44_1, "double", OPS_READ),
ops_arg_dat(wk9_B0, 1, stencil_0_00_1, "double", OPS_WRITE),
ops_arg_idx());

int iteration_range_20_block0[] = {0, block0np0};
ops_par_loop(opensbliblock00Kernel020, "Convective CD rhou0_B0 xi0 ", opensbliblock00, 1, iteration_range_20_block0,
ops_arg_dat(rhou0_B0, 1, stencil_0_44_1, "double", OPS_READ),
ops_arg_dat(wk10_B0, 1, stencil_0_00_1, "double", OPS_WRITE),
ops_arg_idx());

int iteration_range_21_block0[] = {0, block0np0};
ops_par_loop(opensbliblock00Kernel021, "Convective CD u0_B0 xi0 ", opensbliblock00, 1, iteration_range_21_block0,
ops_arg_dat(u0_B0, 1, stencil_0_44_1, "double", OPS_READ),
ops_arg_dat(wk11_B0, 1, stencil_0_00_1, "double", OPS_WRITE),
ops_arg_idx());

int iteration_range_22_block0[] = {0, block0np0};
ops_par_loop(opensbliblock00Kernel022, "Convective CD p_B0 xi0 ", opensbliblock00, 1, iteration_range_22_block0,
ops_arg_dat(p_B0, 1, stencil_0_44_1, "double", OPS_READ),
ops_arg_dat(wk12_B0, 1, stencil_0_00_1, "double", OPS_WRITE),
ops_arg_idx());

int iteration_range_23_block0[] = {0, block0np0};
ops_par_loop(opensbliblock00Kernel023, "Convective CD rho_B0 xi0 ", opensbliblock00, 1, iteration_range_23_block0,
ops_arg_dat(rho_B0, 1, stencil_0_44_1, "double", OPS_READ),
ops_arg_dat(wk13_B0, 1, stencil_0_00_1, "double", OPS_WRITE),
ops_arg_idx());

int iteration_range_24_block0[] = {0, block0np0};
ops_par_loop(opensbliblock00Kernel024, "Convective residual ", opensbliblock00, 1, iteration_range_24_block0,
ops_arg_dat(rhoE_B0, 1, stencil_0_00_1, "double", OPS_READ),
ops_arg_dat(rho_B0, 1, stencil_0_00_1, "double", OPS_READ),
ops_arg_dat(rhou0_B0, 1, stencil_0_00_1, "double", OPS_READ),
ops_arg_dat(tau00_B0, 1, stencil_0_00_1, "double", OPS_READ),
ops_arg_dat(u0_B0, 1, stencil_0_00_1, "double", OPS_READ),
ops_arg_dat(wk10_B0, 1, stencil_0_00_1, "double", OPS_READ),
ops_arg_dat(wk11_B0, 1, stencil_0_00_1, "double", OPS_READ),
ops_arg_dat(wk12_B0, 1, stencil_0_00_1, "double", OPS_READ),
ops_arg_dat(wk13_B0, 1, stencil_0_00_1, "double", OPS_READ),
ops_arg_dat(wk3_B0, 1, stencil_0_00_1, "double", OPS_READ),
ops_arg_dat(wk4_B0, 1, stencil_0_00_1, "double", OPS_READ),
ops_arg_dat(wk5_B0, 1, stencil_0_00_1, "double", OPS_READ),
ops_arg_dat(wk6_B0, 1, stencil_0_00_1, "double", OPS_READ),
ops_arg_dat(wk7_B0, 1, stencil_0_00_1, "double", OPS_READ),
ops_arg_dat(wk8_B0, 1, stencil_0_00_1, "double", OPS_READ),
ops_arg_dat(wk9_B0, 1, stencil_0_00_1, "double", OPS_READ),
...
int iteration_range_28_block0[] = {0, block0np0};
ops_par_loop(opensbliblock00Kernel028, "Temporal solution advancement", opensbliblock00, 1, iteration_range_28_block0,
...
int iteration_range_2_block0[] = {-5, block0np0 + 5};
ops_par_loop(opensbliblock00Kernel002, "User kernel: Zero the work arrays", opensbliblock00, 1, iteration_range_2_block0,
...
int iteration_range_3_block0[] = {-1, block0np0 + 1};
ops_par_loop(opensbliblock00Kernel003, "User kernel: WENO reconstruction direction 0", opensbliblock00, 1, iteration_range_3_block0,
ops_arg_dat(a_B0, 1, stencil_0_01_1, "double", OPS_READ),
ops_arg_dat(p_B0, 1, stencil_0_23_1, "double", OPS_READ),
ops_arg_dat(rhoE_B0, 1, stencil_0_23_1, "double", OPS_READ),
ops_arg_dat(rho_B0, 1, stencil_0_23_1, "double", OPS_READ),
ops_arg_dat(rhou0_B0, 1, stencil_0_23_1, "double", OPS_READ),
ops_arg_dat(u0_B0, 1, stencil_0_23_1, "double", OPS_READ),
ops_arg_dat(wk0_B0, 1, stencil_0_00_1, "double", OPS_WRITE),
ops_arg_dat(wk1_B0, 1, stencil_0_00_1, "double", OPS_WRITE),
ops_arg_dat(wk2_B0, 1, stencil_0_00_1, "double", OPS_WRITE));

int iteration_range_4_block0[] = {0, block0np0};
ops_par_loop(opensbliblock00Kernel004, "User kernel: Non-linear filter application", opensbliblock00, 1, iteration_range_4_block0,
