...
wall_eqns = [rhoE_wall]
boundaries[direction][side] = IsothermalWallBC(direction, 0, wall_eqns, scheme=Carpenter())
...
# Filter application
TVD_filter = TVDFilter(block, airfoil=False, optimize=True, metrics=metriceq, species=None)
