  ...
  ACC<double> &wk2_B0)
{
   ...
   AVG_0_0_LEV_22 = (rc0)*gamma_m1*pow(inv_AVG_a, 2);
    ...
    max_lambda_0_00 = fmax(fabs(a_B0(3) - u0_B0(3)), fmax(fabs(a_B0(1) -
      u0_B0(1)), fmax(fabs(a_B0(-1) - u0_B0(-1)), fmax(fabs(a_B0(2) -
      u0_B0(2)), fmax(fabs(a_B0(0) - u0_B0(0)), fabs(a_B0(-2) -
      u0_B0(-2)))))));

    max_lambda_0_11 = fmax(fabs(u0_B0(-2)), fmax(fabs(u0_B0(-1)), fmax(fabs(u0_B0(0)),
      fmax(fabs(u0_B0(3)), fmax(fabs(u0_B0(2)), fabs(u0_B0(1)))))));

    max_lambda_0_22 = fmax(fabs(a_B0(-2) + u0_B0(-2)), fmax(fabs(a_B0(-1) +
      u0_B0(-1)), fmax(fabs(a_B0(2) + u0_B0(2)), fmax(fabs(a_B0(3) +
      u0_B0(3)), fmax(fabs(a_B0(1) + u0_B0(1)), fabs(a_B0(0) +
      u0_B0(0)))))));
