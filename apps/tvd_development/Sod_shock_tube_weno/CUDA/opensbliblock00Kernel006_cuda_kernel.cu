...
//
__constant__ int dims_opensbliblock00Kernel006 [6][1];
static int dims_opensbliblock00Kernel006_h [6][1] = {0};

//user function
__device__

 void opensbliblock00Kernel006_gpu(const ACC<double> &wk1_B0,
...
{
   Residual0_B0(0) = -rcinv20*(-wk0_B0(-1) + wk0_B0(0));

   Residual1_B0(0) = -rcinv20*(-wk1_B0(-1) + wk1_B0(0));

   Residual2_B0(0) = -rcinv20*(wk2_B0(0) - wk2_B0(-1));
...
void ops_par_loop_opensbliblock00Kernel006_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_opensbliblock00Kernel006_h[0][0] || xdim1 != dims_opensbliblock00Kernel006_h[1][0] || xdim2 != dims_opensbliblock00Kernel006_h[2][0] || xdim3 != dims_opensbliblock00Kernel006_h[3][0] || xdim4 != dims_opensbliblock00Kernel006_h[4][0] || xdim5 != dims_opensbliblock00Kernel006_h[5][0]) {
