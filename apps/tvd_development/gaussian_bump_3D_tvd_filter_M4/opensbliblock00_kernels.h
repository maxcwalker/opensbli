...
: (
   1
    ...
    TVD_filter_B0(0,0,0) = ((fmax(kappa_B0(-1,0,0), fmax(kappa_B0(0,-1,0), fmax(kappa_B0(0,0,0), fmax(kappa_B0(0,0,-1),
      fmax(kappa_B0(0,1,0), fmax(kappa_B0(1,0,0), kappa_B0(0,0,1))))))) >= Ducros_select) ? (
   1
)
: (
   0.0
