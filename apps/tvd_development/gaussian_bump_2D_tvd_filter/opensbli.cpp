...
ops_par_loop(opensbliblock00Kernel027, "Similiarity solution laminar boundary-layer initialisation0", opensbliblock00, 2, iteration_range_27_block0,
...
int iteration_range_31_block0[] = {0, 1, -2, block0np1 + 2};
ops_par_loop(opensbliblock00Kernel031, "Metric_copy_block0 boundary dir0 side0", opensbliblock00, 2, iteration_range_31_block0,
...
int iteration_range_32_block0[] = {block0np0 - 1, block0np0, -2, block0np1 + 2};
ops_par_loop(opensbliblock00Kernel032, "Metric_copy_block0 boundary dir0 side1", opensbliblock00, 2, iteration_range_32_block0,
ops_arg_dat(D00_B0, 1, stencil_0_22_00_4, "double", OPS_RW),
ops_arg_dat(D01_B0, 1, stencil_0_22_00_4, "double", OPS_RW),
ops_arg_dat(D10_B0, 1, stencil_0_22_00_4, "double", OPS_RW),
ops_arg_dat(D11_B0, 1, stencil_0_22_00_4, "double", OPS_RW),
...
int iteration_range_33_block0[] = {-2, block0np0 + 2, 0, 1};
ops_par_loop(opensbliblock00Kernel033, "Metric_copy_block0 boundary dir1 side0", opensbliblock00, 2, iteration_range_33_block0,
...
int iteration_range_34_block0[] = {-2, block0np0 + 2, block0np1 - 1, block0np1};
ops_par_loop(opensbliblock00Kernel034, "Metric_copy_block0 boundary dir1 side1", opensbliblock00, 2, iteration_range_34_block0,
ops_arg_dat(D00_B0, 1, stencil_0_00_22_4, "double", OPS_RW),
ops_arg_dat(D01_B0, 1, stencil_0_00_22_4, "double", OPS_RW),
ops_arg_dat(D10_B0, 1, stencil_0_00_22_4, "double", OPS_RW),
ops_arg_dat(D11_B0, 1, stencil_0_00_22_4, "double", OPS_RW),
...
int iteration_range_23_block0[] = {0, 1, -2, block0np1 + 2};
ops_par_loop(opensbliblock00Kernel023, "InletTransfer boundary dir0 side0", opensbliblock00, 2, iteration_range_23_block0,
...
int iteration_range_24_block0[] = {block0np0 - 1, block0np0, -2, block0np1 + 2};
ops_par_loop(opensbliblock00Kernel024, "Extrapolation boundary dir0 side1", opensbliblock00, 2, iteration_range_24_block0,
...
int iteration_range_25_block0[] = {-2, block0np0 + 2, 0, 1};
...
int iteration_range_26_block0[] = {-2, block0np0 + 2, block0np1 - 1, block0np1};
ops_par_loop(opensbliblock00Kernel026, "ZeroGradientOutlet boundary dir1 side1", opensbliblock00, 2, iteration_range_26_block0,
...
int iteration_range_40_block0[] = {-1, block0np0 + 2, -1, block0np1 + 2};
...
ops_par_loop(opensbliblock00Kernel043, "UserDefinedEquations evaluation", opensbliblock00, 2, iteration_range_43_block0,
ops_arg_dat(D00_B0, 1, stencil_0_00_00_2, "double", OPS_READ),
ops_arg_dat(D01_B0, 1, stencil_0_00_00_2, "double", OPS_READ),
ops_arg_dat(D10_B0, 1, stencil_0_00_00_2, "double", OPS_READ),
ops_arg_dat(D11_B0, 1, stencil_0_00_00_2, "double", OPS_READ),
...
int iteration_range_44_block0[] = {-1, block0np0 + 2, -1, block0np1 + 2};
ops_par_loop(opensbliblock00Kernel044, "User kernel: Constituent Relations evaluation", opensbliblock00, 2, iteration_range_44_block0,
ops_arg_dat(rhoE_B0, 1, stencil_0_00_00_2, "double", OPS_READ),
ops_arg_dat(rho_B0, 1, stencil_0_00_00_2, "double", OPS_READ),
ops_arg_dat(rhou0_B0, 1, stencil_0_00_00_2, "double", OPS_READ),
ops_arg_dat(rhou1_B0, 1, stencil_0_00_00_2, "double", OPS_READ),
...
int iteration_range_45_block0[] = {-5, block0np0 + 5, -5, block0np1 + 5};
ops_par_loop(opensbliblock00Kernel045, "User kernel: Zero the work arrays", opensbliblock00, 2, iteration_range_45_block0,
ops_arg_dat(Residual0_B0, 1, stencil_0_00_00_2, "double", OPS_WRITE),
ops_arg_dat(Residual1_B0, 1, stencil_0_00_00_2, "double", OPS_WRITE),
ops_arg_dat(Residual2_B0, 1, stencil_0_00_00_2, "double", OPS_WRITE),
ops_arg_dat(Residual3_B0, 1, stencil_0_00_00_2, "double", OPS_WRITE),
...
int iteration_range_46_block0[] = {-1, block0np0 + 1, 0, block0np1};
ops_par_loop(opensbliblock00Kernel046, "User kernel: TVD reconstruction direction 0", opensbliblock00, 2, iteration_range_46_block0,
ops_arg_dat(D00_B0, 1, stencil_0_01_00_3, "double", OPS_READ),
ops_arg_dat(D01_B0, 1, stencil_0_01_00_3, "double", OPS_READ),
...
int iteration_range_47_block0[] = {0, block0np0, -1, block0np1 + 1};
ops_par_loop(opensbliblock00Kernel047, "User kernel: TVD reconstruction direction 1", opensbliblock00, 2, iteration_range_47_block0,
ops_arg_dat(D10_B0, 1, stencil_0_00_01_3, "double", OPS_READ),
ops_arg_dat(D11_B0, 1, stencil_0_00_01_3, "double", OPS_READ),
...
ops_par_loop(opensbliblock00Kernel048, "User kernel: Non-linear TVD Filter application", opensbliblock00, 2, iteration_range_48_block0,
