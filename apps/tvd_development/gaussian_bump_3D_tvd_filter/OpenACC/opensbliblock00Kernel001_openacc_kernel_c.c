  ...
  ptr_double wk9_B0)
{
   ...
   AVG_1_rho = sqrt(OPS_ACC(rho_B0, 0,0,0)*OPS_ACC(rho_B0, 0,1,0));

   AVG_1_inv_rho = 1.0/((sqrt(OPS_ACC(rho_B0, 0,0,0)) + sqrt(OPS_ACC(rho_B0, 0,1,0))));

   AVG_1_u0 = (sqrt(OPS_ACC(rho_B0, 0,0,0))*OPS_ACC(u0_B0, 0,0,0) + sqrt(OPS_ACC(rho_B0, 0,1,0))*OPS_ACC(u0_B0, 0,1,0))*AVG_1_inv_rho;

   AVG_1_u1 = (sqrt(OPS_ACC(rho_B0, 0,0,0))*OPS_ACC(u1_B0, 0,0,0) + sqrt(OPS_ACC(rho_B0, 0,1,0))*OPS_ACC(u1_B0, 0,1,0))*AVG_1_inv_rho;

   AVG_1_u2 = (sqrt(OPS_ACC(rho_B0, 0,0,0))*OPS_ACC(u2_B0, 0,0,0) + sqrt(OPS_ACC(rho_B0, 0,1,0))*OPS_ACC(u2_B0, 0,1,0))*AVG_1_inv_rho;

    AVG_1_a = sqrt((-(1.0/2.0)*((AVG_1_u0*AVG_1_u0) + (AVG_1_u1*AVG_1_u1) + (AVG_1_u2*AVG_1_u2)) + ((OPS_ACC(p_B0, 0,0,0) +
      OPS_ACC(rhoE_B0, 0,0,0))/sqrt(OPS_ACC(rho_B0, 0,0,0)) + (OPS_ACC(p_B0, 0,1,0) +
      OPS_ACC(rhoE_B0, 0,1,0))/sqrt(OPS_ACC(rho_B0, 0,1,0)))*AVG_1_inv_rho)*gamma_m1);
   ...
   AVG_1_1_LEV_44 = 0.707106781186547*gamma_m1*inv_AVG_a*inv_AVG_rho;
    ...
    CF_00 = (OPS_ACC(p_B0, 0,-2,0)*OPS_ACC(U1_B0, 0,-2,0)*AVG_1_1_LEV_04 + OPS_ACC(p_B0, 0,-2,0)*OPS_ACC(D10_B0, 0,-2,0)*AVG_1_1_LEV_01 +
      OPS_ACC(p_B0, 0,-2,0)*OPS_ACC(D11_B0, 0,-2,0)*AVG_1_1_LEV_02 + OPS_ACC(U1_B0, 0,-2,0)*OPS_ACC(rho_B0, 0,-2,0)*AVG_1_1_LEV_00 +
      OPS_ACC(U1_B0, 0,-2,0)*OPS_ACC(rhoE_B0, 0,-2,0)*AVG_1_1_LEV_04 + OPS_ACC(U1_B0, 0,-2,0)*OPS_ACC(rhou0_B0, 0,-2,0)*AVG_1_1_LEV_01 +
      OPS_ACC(U1_B0, 0,-2,0)*OPS_ACC(rhou1_B0, 0,-2,0)*AVG_1_1_LEV_02 + OPS_ACC(U1_B0, 0,-2,0)*OPS_ACC(rhou2_B0, 0,-2,0)*AVG_1_1_LEV_03)*OPS_ACC(detJ_B0, 0,-2,0);

    CF_10 = (OPS_ACC(p_B0, 0,-2,0)*OPS_ACC(U1_B0, 0,-2,0)*AVG_1_1_LEV_14 + OPS_ACC(p_B0, 0,-2,0)*OPS_ACC(D10_B0, 0,-2,0)*AVG_1_1_LEV_11 +
      OPS_ACC(p_B0, 0,-2,0)*OPS_ACC(D11_B0, 0,-2,0)*AVG_1_1_LEV_12 + OPS_ACC(U1_B0, 0,-2,0)*OPS_ACC(rho_B0, 0,-2,0)*AVG_1_1_LEV_10 +
      OPS_ACC(U1_B0, 0,-2,0)*OPS_ACC(rhoE_B0, 0,-2,0)*AVG_1_1_LEV_14 + OPS_ACC(U1_B0, 0,-2,0)*OPS_ACC(rhou0_B0, 0,-2,0)*AVG_1_1_LEV_11 +
      OPS_ACC(U1_B0, 0,-2,0)*OPS_ACC(rhou1_B0, 0,-2,0)*AVG_1_1_LEV_12 + OPS_ACC(U1_B0, 0,-2,0)*OPS_ACC(rhou2_B0, 0,-2,0)*AVG_1_1_LEV_13)*OPS_ACC(detJ_B0, 0,-2,0);

    CF_20 = (OPS_ACC(p_B0, 0,-2,0)*OPS_ACC(D10_B0, 0,-2,0)*AVG_1_1_LEV_21 + OPS_ACC(p_B0, 0,-2,0)*OPS_ACC(D11_B0, 0,-2,0)*AVG_1_1_LEV_22 +
      OPS_ACC(U1_B0, 0,-2,0)*OPS_ACC(rho_B0, 0,-2,0)*AVG_1_1_LEV_20 + OPS_ACC(U1_B0, 0,-2,0)*OPS_ACC(rhou0_B0, 0,-2,0)*AVG_1_1_LEV_21 +
      OPS_ACC(U1_B0, 0,-2,0)*OPS_ACC(rhou1_B0, 0,-2,0)*AVG_1_1_LEV_22)*OPS_ACC(detJ_B0, 0,-2,0);

    CF_30 = (OPS_ACC(p_B0, 0,-2,0)*OPS_ACC(U1_B0, 0,-2,0)*AVG_1_1_LEV_34 + OPS_ACC(p_B0, 0,-2,0)*OPS_ACC(D10_B0, 0,-2,0)*AVG_1_1_LEV_31 +
      OPS_ACC(p_B0, 0,-2,0)*OPS_ACC(D11_B0, 0,-2,0)*AVG_1_1_LEV_32 + OPS_ACC(U1_B0, 0,-2,0)*OPS_ACC(rho_B0, 0,-2,0)*AVG_1_1_LEV_30 +
      OPS_ACC(U1_B0, 0,-2,0)*OPS_ACC(rhoE_B0, 0,-2,0)*AVG_1_1_LEV_34 + OPS_ACC(U1_B0, 0,-2,0)*OPS_ACC(rhou0_B0, 0,-2,0)*AVG_1_1_LEV_31 +
      OPS_ACC(U1_B0, 0,-2,0)*OPS_ACC(rhou1_B0, 0,-2,0)*AVG_1_1_LEV_32 + OPS_ACC(U1_B0, 0,-2,0)*OPS_ACC(rhou2_B0, 0,-2,0)*AVG_1_1_LEV_33)*OPS_ACC(detJ_B0, 0,-2,0);

    CF_40 = (OPS_ACC(p_B0, 0,-2,0)*OPS_ACC(U1_B0, 0,-2,0)*AVG_1_1_LEV_44 + OPS_ACC(p_B0, 0,-2,0)*OPS_ACC(D10_B0, 0,-2,0)*AVG_1_1_LEV_41 +
      OPS_ACC(p_B0, 0,-2,0)*OPS_ACC(D11_B0, 0,-2,0)*AVG_1_1_LEV_42 + OPS_ACC(U1_B0, 0,-2,0)*OPS_ACC(rho_B0, 0,-2,0)*AVG_1_1_LEV_40 +
      OPS_ACC(U1_B0, 0,-2,0)*OPS_ACC(rhoE_B0, 0,-2,0)*AVG_1_1_LEV_44 + OPS_ACC(U1_B0, 0,-2,0)*OPS_ACC(rhou0_B0, 0,-2,0)*AVG_1_1_LEV_41 +
      OPS_ACC(U1_B0, 0,-2,0)*OPS_ACC(rhou1_B0, 0,-2,0)*AVG_1_1_LEV_42 + OPS_ACC(U1_B0, 0,-2,0)*OPS_ACC(rhou2_B0, 0,-2,0)*AVG_1_1_LEV_43)*OPS_ACC(detJ_B0, 0,-2,0);
   ...
   CS_20 = OPS_ACC(rho_B0, 0,-2,0)*AVG_1_1_LEV_20 + OPS_ACC(rhou0_B0, 0,-2,0)*AVG_1_1_LEV_21 + OPS_ACC(rhou1_B0, 0,-2,0)*AVG_1_1_LEV_22;
    ...
    CF_01 = (OPS_ACC(p_B0, 0,-1,0)*OPS_ACC(U1_B0, 0,-1,0)*AVG_1_1_LEV_04 + OPS_ACC(p_B0, 0,-1,0)*OPS_ACC(D10_B0, 0,-1,0)*AVG_1_1_LEV_01 +
      OPS_ACC(p_B0, 0,-1,0)*OPS_ACC(D11_B0, 0,-1,0)*AVG_1_1_LEV_02 + OPS_ACC(U1_B0, 0,-1,0)*OPS_ACC(rho_B0, 0,-1,0)*AVG_1_1_LEV_00 +
      OPS_ACC(U1_B0, 0,-1,0)*OPS_ACC(rhoE_B0, 0,-1,0)*AVG_1_1_LEV_04 + OPS_ACC(U1_B0, 0,-1,0)*OPS_ACC(rhou0_B0, 0,-1,0)*AVG_1_1_LEV_01 +
      OPS_ACC(U1_B0, 0,-1,0)*OPS_ACC(rhou1_B0, 0,-1,0)*AVG_1_1_LEV_02 + OPS_ACC(U1_B0, 0,-1,0)*OPS_ACC(rhou2_B0, 0,-1,0)*AVG_1_1_LEV_03)*OPS_ACC(detJ_B0, 0,-1,0);

    CF_11 = (OPS_ACC(p_B0, 0,-1,0)*OPS_ACC(U1_B0, 0,-1,0)*AVG_1_1_LEV_14 + OPS_ACC(p_B0, 0,-1,0)*OPS_ACC(D10_B0, 0,-1,0)*AVG_1_1_LEV_11 +
      OPS_ACC(p_B0, 0,-1,0)*OPS_ACC(D11_B0, 0,-1,0)*AVG_1_1_LEV_12 + OPS_ACC(U1_B0, 0,-1,0)*OPS_ACC(rho_B0, 0,-1,0)*AVG_1_1_LEV_10 +
      OPS_ACC(U1_B0, 0,-1,0)*OPS_ACC(rhoE_B0, 0,-1,0)*AVG_1_1_LEV_14 + OPS_ACC(U1_B0, 0,-1,0)*OPS_ACC(rhou0_B0, 0,-1,0)*AVG_1_1_LEV_11 +
      OPS_ACC(U1_B0, 0,-1,0)*OPS_ACC(rhou1_B0, 0,-1,0)*AVG_1_1_LEV_12 + OPS_ACC(U1_B0, 0,-1,0)*OPS_ACC(rhou2_B0, 0,-1,0)*AVG_1_1_LEV_13)*OPS_ACC(detJ_B0, 0,-1,0);

    CF_21 = (OPS_ACC(p_B0, 0,-1,0)*OPS_ACC(D10_B0, 0,-1,0)*AVG_1_1_LEV_21 + OPS_ACC(p_B0, 0,-1,0)*OPS_ACC(D11_B0, 0,-1,0)*AVG_1_1_LEV_22 +
      OPS_ACC(U1_B0, 0,-1,0)*OPS_ACC(rho_B0, 0,-1,0)*AVG_1_1_LEV_20 + OPS_ACC(U1_B0, 0,-1,0)*OPS_ACC(rhou0_B0, 0,-1,0)*AVG_1_1_LEV_21 +
      OPS_ACC(U1_B0, 0,-1,0)*OPS_ACC(rhou1_B0, 0,-1,0)*AVG_1_1_LEV_22)*OPS_ACC(detJ_B0, 0,-1,0);

    CF_31 = (OPS_ACC(p_B0, 0,-1,0)*OPS_ACC(U1_B0, 0,-1,0)*AVG_1_1_LEV_34 + OPS_ACC(p_B0, 0,-1,0)*OPS_ACC(D10_B0, 0,-1,0)*AVG_1_1_LEV_31 +
      OPS_ACC(p_B0, 0,-1,0)*OPS_ACC(D11_B0, 0,-1,0)*AVG_1_1_LEV_32 + OPS_ACC(U1_B0, 0,-1,0)*OPS_ACC(rho_B0, 0,-1,0)*AVG_1_1_LEV_30 +
      OPS_ACC(U1_B0, 0,-1,0)*OPS_ACC(rhoE_B0, 0,-1,0)*AVG_1_1_LEV_34 + OPS_ACC(U1_B0, 0,-1,0)*OPS_ACC(rhou0_B0, 0,-1,0)*AVG_1_1_LEV_31 +
      OPS_ACC(U1_B0, 0,-1,0)*OPS_ACC(rhou1_B0, 0,-1,0)*AVG_1_1_LEV_32 + OPS_ACC(U1_B0, 0,-1,0)*OPS_ACC(rhou2_B0, 0,-1,0)*AVG_1_1_LEV_33)*OPS_ACC(detJ_B0, 0,-1,0);

    CF_41 = (OPS_ACC(p_B0, 0,-1,0)*OPS_ACC(U1_B0, 0,-1,0)*AVG_1_1_LEV_44 + OPS_ACC(p_B0, 0,-1,0)*OPS_ACC(D10_B0, 0,-1,0)*AVG_1_1_LEV_41 +
      OPS_ACC(p_B0, 0,-1,0)*OPS_ACC(D11_B0, 0,-1,0)*AVG_1_1_LEV_42 + OPS_ACC(U1_B0, 0,-1,0)*OPS_ACC(rho_B0, 0,-1,0)*AVG_1_1_LEV_40 +
      OPS_ACC(U1_B0, 0,-1,0)*OPS_ACC(rhoE_B0, 0,-1,0)*AVG_1_1_LEV_44 + OPS_ACC(U1_B0, 0,-1,0)*OPS_ACC(rhou0_B0, 0,-1,0)*AVG_1_1_LEV_41 +
      OPS_ACC(U1_B0, 0,-1,0)*OPS_ACC(rhou1_B0, 0,-1,0)*AVG_1_1_LEV_42 + OPS_ACC(U1_B0, 0,-1,0)*OPS_ACC(rhou2_B0, 0,-1,0)*AVG_1_1_LEV_43)*OPS_ACC(detJ_B0, 0,-1,0);
   ...
   CS_21 = OPS_ACC(rho_B0, 0,-1,0)*AVG_1_1_LEV_20 + OPS_ACC(rhou0_B0, 0,-1,0)*AVG_1_1_LEV_21 + OPS_ACC(rhou1_B0, 0,-1,0)*AVG_1_1_LEV_22;
    ...
    CF_02 = (OPS_ACC(p_B0, 0,0,0)*OPS_ACC(U1_B0, 0,0,0)*AVG_1_1_LEV_04 + OPS_ACC(p_B0, 0,0,0)*OPS_ACC(D10_B0, 0,0,0)*AVG_1_1_LEV_01 +
      OPS_ACC(p_B0, 0,0,0)*OPS_ACC(D11_B0, 0,0,0)*AVG_1_1_LEV_02 + OPS_ACC(U1_B0, 0,0,0)*OPS_ACC(rho_B0, 0,0,0)*AVG_1_1_LEV_00 +
      OPS_ACC(U1_B0, 0,0,0)*OPS_ACC(rhoE_B0, 0,0,0)*AVG_1_1_LEV_04 + OPS_ACC(U1_B0, 0,0,0)*OPS_ACC(rhou0_B0, 0,0,0)*AVG_1_1_LEV_01 +
      OPS_ACC(U1_B0, 0,0,0)*OPS_ACC(rhou1_B0, 0,0,0)*AVG_1_1_LEV_02 + OPS_ACC(U1_B0, 0,0,0)*OPS_ACC(rhou2_B0, 0,0,0)*AVG_1_1_LEV_03)*OPS_ACC(detJ_B0, 0,0,0);

    CF_12 = (OPS_ACC(p_B0, 0,0,0)*OPS_ACC(U1_B0, 0,0,0)*AVG_1_1_LEV_14 + OPS_ACC(p_B0, 0,0,0)*OPS_ACC(D10_B0, 0,0,0)*AVG_1_1_LEV_11 +
      OPS_ACC(p_B0, 0,0,0)*OPS_ACC(D11_B0, 0,0,0)*AVG_1_1_LEV_12 + OPS_ACC(U1_B0, 0,0,0)*OPS_ACC(rho_B0, 0,0,0)*AVG_1_1_LEV_10 +
      OPS_ACC(U1_B0, 0,0,0)*OPS_ACC(rhoE_B0, 0,0,0)*AVG_1_1_LEV_14 + OPS_ACC(U1_B0, 0,0,0)*OPS_ACC(rhou0_B0, 0,0,0)*AVG_1_1_LEV_11 +
      OPS_ACC(U1_B0, 0,0,0)*OPS_ACC(rhou1_B0, 0,0,0)*AVG_1_1_LEV_12 + OPS_ACC(U1_B0, 0,0,0)*OPS_ACC(rhou2_B0, 0,0,0)*AVG_1_1_LEV_13)*OPS_ACC(detJ_B0, 0,0,0);

    CF_22 = (OPS_ACC(p_B0, 0,0,0)*OPS_ACC(D10_B0, 0,0,0)*AVG_1_1_LEV_21 + OPS_ACC(p_B0, 0,0,0)*OPS_ACC(D11_B0, 0,0,0)*AVG_1_1_LEV_22 +
      OPS_ACC(U1_B0, 0,0,0)*OPS_ACC(rho_B0, 0,0,0)*AVG_1_1_LEV_20 + OPS_ACC(U1_B0, 0,0,0)*OPS_ACC(rhou0_B0, 0,0,0)*AVG_1_1_LEV_21 +
      OPS_ACC(U1_B0, 0,0,0)*OPS_ACC(rhou1_B0, 0,0,0)*AVG_1_1_LEV_22)*OPS_ACC(detJ_B0, 0,0,0);

    CF_32 = (OPS_ACC(p_B0, 0,0,0)*OPS_ACC(U1_B0, 0,0,0)*AVG_1_1_LEV_34 + OPS_ACC(p_B0, 0,0,0)*OPS_ACC(D10_B0, 0,0,0)*AVG_1_1_LEV_31 +
      OPS_ACC(p_B0, 0,0,0)*OPS_ACC(D11_B0, 0,0,0)*AVG_1_1_LEV_32 + OPS_ACC(U1_B0, 0,0,0)*OPS_ACC(rho_B0, 0,0,0)*AVG_1_1_LEV_30 +
      OPS_ACC(U1_B0, 0,0,0)*OPS_ACC(rhoE_B0, 0,0,0)*AVG_1_1_LEV_34 + OPS_ACC(U1_B0, 0,0,0)*OPS_ACC(rhou0_B0, 0,0,0)*AVG_1_1_LEV_31 +
      OPS_ACC(U1_B0, 0,0,0)*OPS_ACC(rhou1_B0, 0,0,0)*AVG_1_1_LEV_32 + OPS_ACC(U1_B0, 0,0,0)*OPS_ACC(rhou2_B0, 0,0,0)*AVG_1_1_LEV_33)*OPS_ACC(detJ_B0, 0,0,0);

    CF_42 = (OPS_ACC(p_B0, 0,0,0)*OPS_ACC(U1_B0, 0,0,0)*AVG_1_1_LEV_44 + OPS_ACC(p_B0, 0,0,0)*OPS_ACC(D10_B0, 0,0,0)*AVG_1_1_LEV_41 +
      OPS_ACC(p_B0, 0,0,0)*OPS_ACC(D11_B0, 0,0,0)*AVG_1_1_LEV_42 + OPS_ACC(U1_B0, 0,0,0)*OPS_ACC(rho_B0, 0,0,0)*AVG_1_1_LEV_40 +
      OPS_ACC(U1_B0, 0,0,0)*OPS_ACC(rhoE_B0, 0,0,0)*AVG_1_1_LEV_44 + OPS_ACC(U1_B0, 0,0,0)*OPS_ACC(rhou0_B0, 0,0,0)*AVG_1_1_LEV_41 +
      OPS_ACC(U1_B0, 0,0,0)*OPS_ACC(rhou1_B0, 0,0,0)*AVG_1_1_LEV_42 + OPS_ACC(U1_B0, 0,0,0)*OPS_ACC(rhou2_B0, 0,0,0)*AVG_1_1_LEV_43)*OPS_ACC(detJ_B0, 0,0,0);
   ...
   CS_22 = OPS_ACC(rho_B0, 0,0,0)*AVG_1_1_LEV_20 + OPS_ACC(rhou0_B0, 0,0,0)*AVG_1_1_LEV_21 + OPS_ACC(rhou1_B0, 0,0,0)*AVG_1_1_LEV_22;
    ...
    CF_23 = (OPS_ACC(p_B0, 0,1,0)*OPS_ACC(D10_B0, 0,1,0)*AVG_1_1_LEV_21 + OPS_ACC(p_B0, 0,1,0)*OPS_ACC(D11_B0, 0,1,0)*AVG_1_1_LEV_22 +
      OPS_ACC(U1_B0, 0,1,0)*OPS_ACC(rho_B0, 0,1,0)*AVG_1_1_LEV_20 + OPS_ACC(U1_B0, 0,1,0)*OPS_ACC(rhou0_B0, 0,1,0)*AVG_1_1_LEV_21 +
      OPS_ACC(U1_B0, 0,1,0)*OPS_ACC(rhou1_B0, 0,1,0)*AVG_1_1_LEV_22)*OPS_ACC(detJ_B0, 0,1,0);
   ...
   CS_23 = OPS_ACC(rho_B0, 0,1,0)*AVG_1_1_LEV_20 + OPS_ACC(rhou0_B0, 0,1,0)*AVG_1_1_LEV_21 + OPS_ACC(rhou1_B0, 0,1,0)*AVG_1_1_LEV_22;
    ...
    CF_24 = (OPS_ACC(p_B0, 0,2,0)*OPS_ACC(D10_B0, 0,2,0)*AVG_1_1_LEV_21 + OPS_ACC(p_B0, 0,2,0)*OPS_ACC(D11_B0, 0,2,0)*AVG_1_1_LEV_22 +
      OPS_ACC(U1_B0, 0,2,0)*OPS_ACC(rho_B0, 0,2,0)*AVG_1_1_LEV_20 + OPS_ACC(U1_B0, 0,2,0)*OPS_ACC(rhou0_B0, 0,2,0)*AVG_1_1_LEV_21 +
      OPS_ACC(U1_B0, 0,2,0)*OPS_ACC(rhou1_B0, 0,2,0)*AVG_1_1_LEV_22)*OPS_ACC(detJ_B0, 0,2,0);
   ...
   CS_24 = OPS_ACC(rho_B0, 0,2,0)*AVG_1_1_LEV_20 + OPS_ACC(rhou0_B0, 0,2,0)*AVG_1_1_LEV_21 + OPS_ACC(rhou1_B0, 0,2,0)*AVG_1_1_LEV_22;
    ...
    CF_05 = (OPS_ACC(p_B0, 0,3,0)*OPS_ACC(U1_B0, 0,3,0)*AVG_1_1_LEV_04 + OPS_ACC(p_B0, 0,3,0)*OPS_ACC(D10_B0, 0,3,0)*AVG_1_1_LEV_01 +
      OPS_ACC(p_B0, 0,3,0)*OPS_ACC(D11_B0, 0,3,0)*AVG_1_1_LEV_02 + OPS_ACC(U1_B0, 0,3,0)*OPS_ACC(rho_B0, 0,3,0)*AVG_1_1_LEV_00 +
      OPS_ACC(U1_B0, 0,3,0)*OPS_ACC(rhoE_B0, 0,3,0)*AVG_1_1_LEV_04 + OPS_ACC(U1_B0, 0,3,0)*OPS_ACC(rhou0_B0, 0,3,0)*AVG_1_1_LEV_01 +
      OPS_ACC(U1_B0, 0,3,0)*OPS_ACC(rhou1_B0, 0,3,0)*AVG_1_1_LEV_02 + OPS_ACC(U1_B0, 0,3,0)*OPS_ACC(rhou2_B0, 0,3,0)*AVG_1_1_LEV_03)*OPS_ACC(detJ_B0, 0,3,0);

    CF_15 = (OPS_ACC(p_B0, 0,3,0)*OPS_ACC(U1_B0, 0,3,0)*AVG_1_1_LEV_14 + OPS_ACC(p_B0, 0,3,0)*OPS_ACC(D10_B0, 0,3,0)*AVG_1_1_LEV_11 +
      OPS_ACC(p_B0, 0,3,0)*OPS_ACC(D11_B0, 0,3,0)*AVG_1_1_LEV_12 + OPS_ACC(U1_B0, 0,3,0)*OPS_ACC(rho_B0, 0,3,0)*AVG_1_1_LEV_10 +
      OPS_ACC(U1_B0, 0,3,0)*OPS_ACC(rhoE_B0, 0,3,0)*AVG_1_1_LEV_14 + OPS_ACC(U1_B0, 0,3,0)*OPS_ACC(rhou0_B0, 0,3,0)*AVG_1_1_LEV_11 +
      OPS_ACC(U1_B0, 0,3,0)*OPS_ACC(rhou1_B0, 0,3,0)*AVG_1_1_LEV_12 + OPS_ACC(U1_B0, 0,3,0)*OPS_ACC(rhou2_B0, 0,3,0)*AVG_1_1_LEV_13)*OPS_ACC(detJ_B0, 0,3,0);

    CF_25 = (OPS_ACC(p_B0, 0,3,0)*OPS_ACC(D10_B0, 0,3,0)*AVG_1_1_LEV_21 + OPS_ACC(p_B0, 0,3,0)*OPS_ACC(D11_B0, 0,3,0)*AVG_1_1_LEV_22 +
      OPS_ACC(U1_B0, 0,3,0)*OPS_ACC(rho_B0, 0,3,0)*AVG_1_1_LEV_20 + OPS_ACC(U1_B0, 0,3,0)*OPS_ACC(rhou0_B0, 0,3,0)*AVG_1_1_LEV_21 +
      OPS_ACC(U1_B0, 0,3,0)*OPS_ACC(rhou1_B0, 0,3,0)*AVG_1_1_LEV_22)*OPS_ACC(detJ_B0, 0,3,0);

    CF_35 = (OPS_ACC(p_B0, 0,3,0)*OPS_ACC(U1_B0, 0,3,0)*AVG_1_1_LEV_34 + OPS_ACC(p_B0, 0,3,0)*OPS_ACC(D10_B0, 0,3,0)*AVG_1_1_LEV_31 +
      OPS_ACC(p_B0, 0,3,0)*OPS_ACC(D11_B0, 0,3,0)*AVG_1_1_LEV_32 + OPS_ACC(U1_B0, 0,3,0)*OPS_ACC(rho_B0, 0,3,0)*AVG_1_1_LEV_30 +
      OPS_ACC(U1_B0, 0,3,0)*OPS_ACC(rhoE_B0, 0,3,0)*AVG_1_1_LEV_34 + OPS_ACC(U1_B0, 0,3,0)*OPS_ACC(rhou0_B0, 0,3,0)*AVG_1_1_LEV_31 +
      OPS_ACC(U1_B0, 0,3,0)*OPS_ACC(rhou1_B0, 0,3,0)*AVG_1_1_LEV_32 + OPS_ACC(U1_B0, 0,3,0)*OPS_ACC(rhou2_B0, 0,3,0)*AVG_1_1_LEV_33)*OPS_ACC(detJ_B0, 0,3,0);

    CF_45 = (OPS_ACC(p_B0, 0,3,0)*OPS_ACC(U1_B0, 0,3,0)*AVG_1_1_LEV_44 + OPS_ACC(p_B0, 0,3,0)*OPS_ACC(D10_B0, 0,3,0)*AVG_1_1_LEV_41 +
      OPS_ACC(p_B0, 0,3,0)*OPS_ACC(D11_B0, 0,3,0)*AVG_1_1_LEV_42 + OPS_ACC(U1_B0, 0,3,0)*OPS_ACC(rho_B0, 0,3,0)*AVG_1_1_LEV_40 +
      OPS_ACC(U1_B0, 0,3,0)*OPS_ACC(rhoE_B0, 0,3,0)*AVG_1_1_LEV_44 + OPS_ACC(U1_B0, 0,3,0)*OPS_ACC(rhou0_B0, 0,3,0)*AVG_1_1_LEV_41 +
      OPS_ACC(U1_B0, 0,3,0)*OPS_ACC(rhou1_B0, 0,3,0)*AVG_1_1_LEV_42 + OPS_ACC(U1_B0, 0,3,0)*OPS_ACC(rhou2_B0, 0,3,0)*AVG_1_1_LEV_43)*OPS_ACC(detJ_B0, 0,3,0);
   ...
   CS_25 = OPS_ACC(rho_B0, 0,3,0)*AVG_1_1_LEV_20 + OPS_ACC(rhou0_B0, 0,3,0)*AVG_1_1_LEV_21 + OPS_ACC(rhou1_B0, 0,3,0)*AVG_1_1_LEV_22;
    ...
    max_lambda_00 = shock_filter_control*fmax(fabs(OPS_ACC(u0_B0, 0,1,0)*OPS_ACC(D10_B0, 0,1,0)*OPS_ACC(detJ_B0, 0,1,0) +
      OPS_ACC(u1_B0, 0,1,0)*OPS_ACC(D11_B0, 0,1,0)*OPS_ACC(detJ_B0, 0,1,0)), fabs(OPS_ACC(u0_B0, 0,0,0)*OPS_ACC(D10_B0, 0,0,0)*OPS_ACC(detJ_B0, 0,0,0) +
      OPS_ACC(u1_B0, 0,0,0)*OPS_ACC(D11_B0, 0,0,0)*OPS_ACC(detJ_B0, 0,0,0)));

   max_lambda_11 = max_lambda_00;

   max_lambda_22 = max_lambda_00;

    max_lambda_33 = shock_filter_control*fmax(fabs(sqrt((OPS_ACC(D10_B0, 0,0,0)*OPS_ACC(D10_B0, 0,0,0))*(OPS_ACC(detJ_B0, 0,0,0)*OPS_ACC(detJ_B0, 0,0,0)) +
      (OPS_ACC(D11_B0, 0,0,0)*OPS_ACC(D11_B0, 0,0,0))*(OPS_ACC(detJ_B0, 0,0,0)*OPS_ACC(detJ_B0, 0,0,0)))*OPS_ACC(a_B0, 0,0,0) +
      ...
      (OPS_ACC(D11_B0, 0,1,0)*OPS_ACC(D11_B0, 0,1,0))*(OPS_ACC(detJ_B0, 0,1,0)*OPS_ACC(detJ_B0, 0,1,0)))*OPS_ACC(a_B0, 0,1,0) +
    ...
    max_lambda_44 = shock_filter_control*fmax(fabs(-sqrt((OPS_ACC(D10_B0, 0,1,0)*OPS_ACC(D10_B0, 0,1,0))*(OPS_ACC(detJ_B0, 0,1,0)*OPS_ACC(detJ_B0, 0,1,0)) +
      (OPS_ACC(D11_B0, 0,1,0)*OPS_ACC(D11_B0, 0,1,0))*(OPS_ACC(detJ_B0, 0,1,0)*OPS_ACC(detJ_B0, 0,1,0)))*OPS_ACC(a_B0, 0,1,0) +
      OPS_ACC(u0_B0, 0,1,0)*OPS_ACC(D10_B0, 0,1,0)*OPS_ACC(detJ_B0, 0,1,0) + OPS_ACC(u1_B0, 0,1,0)*OPS_ACC(D11_B0, 0,1,0)*OPS_ACC(detJ_B0, 0,1,0)),
...
: (
   1.0
    ...
    OPS_ACC(wk6_B0, 0,0,0) = AVG_1_D10*AVG_1_u0*Recon_0*inv_AVG_met_fact + AVG_1_D11*AVG_1_rho*Recon_2*inv_AVG_met_fact +
    ...
    OPS_ACC(wk7_B0, 0,0,0) = AVG_1_D10*AVG_1_u1*Recon_0*inv_AVG_met_fact + AVG_1_D11*AVG_1_u1*Recon_1*inv_AVG_met_fact -
    ...
    OPS_ACC(wk9_B0, 0,0,0) = (((1.0/2.0))*((AVG_1_u0*AVG_1_u0) + (AVG_1_u1*AVG_1_u1) +
  ...
  for ( int n_z=0; n_z<z_size; n_z++ ){
    ...
    for ( int n_y=0; n_y<y_size; n_y++ ){
      ...
      for ( int n_x=0; n_x<x_size; n_x++ ){
        ...
        ptr_double ptr14 = {  p_a14 + n_x*1*1 + n_y*xdim14_opensbliblock00Kernel001*1*1 + n_z*xdim14_opensbliblock00Kernel001*ydim14_opensbliblock00Kernel001*1*1, xdim14_opensbliblock00Kernel001, ydim14_opensbliblock00Kernel001};
