...
//
__constant__ int dims_opensbliblock00Kernel063 [5][2];
static int dims_opensbliblock00Kernel063_h [5][2] = {{0}};
...
void ops_par_loop_opensbliblock00Kernel063(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4) {
  ...
  create_kerneldesc_and_enque(name, args, 5, 9, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel063_execute);
}
#endif
