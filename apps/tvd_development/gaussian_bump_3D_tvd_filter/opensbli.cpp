...
if (restart == 0){
int iteration_range_50_block0[] = {-5, block0np0 + 5, -5, block0np1 + 5, -5, block0np2 + 5};
ops_par_loop(opensbliblock00Kernel050, "Similiarity solution laminar boundary-layer initialisation0", opensbliblock00, 3, iteration_range_50_block0,
...
ops_par_loop(opensbliblock00Kernel053, "MetricsEquation evaluation", opensbliblock00, 3, iteration_range_53_block0,
...
int iteration_range_54_block0[] = {0, 1, -2, block0np1 + 2, -2, block0np2 + 2};
ops_par_loop(opensbliblock00Kernel054, "Metric_copy_block0 boundary dir0 side0", opensbliblock00, 3, iteration_range_54_block0,
...
int iteration_range_55_block0[] = {block0np0 - 1, block0np0, -2, block0np1 + 2, -2, block0np2 + 2};
ops_par_loop(opensbliblock00Kernel055, "Metric_copy_block0 boundary dir0 side1", opensbliblock00, 3, iteration_range_55_block0,
ops_arg_dat(D00_B0, 1, stencil_0_22_00_00_8, "double", OPS_RW),
ops_arg_dat(D01_B0, 1, stencil_0_22_00_00_8, "double", OPS_RW),
ops_arg_dat(D10_B0, 1, stencil_0_22_00_00_8, "double", OPS_RW),
ops_arg_dat(D11_B0, 1, stencil_0_22_00_00_8, "double", OPS_RW),
...
int iteration_range_56_block0[] = {-2, block0np0 + 2, 0, 1, -2, block0np2 + 2};
ops_par_loop(opensbliblock00Kernel056, "Metric_copy_block0 boundary dir1 side0", opensbliblock00, 3, iteration_range_56_block0,
...
int iteration_range_57_block0[] = {-2, block0np0 + 2, block0np1 - 1, block0np1, -2, block0np2 + 2};
ops_par_loop(opensbliblock00Kernel057, "Metric_copy_block0 boundary dir1 side1", opensbliblock00, 3, iteration_range_57_block0,
ops_arg_dat(D00_B0, 1, stencil_0_00_22_00_8, "double", OPS_RW),
ops_arg_dat(D01_B0, 1, stencil_0_00_22_00_8, "double", OPS_RW),
ops_arg_dat(D10_B0, 1, stencil_0_00_22_00_8, "double", OPS_RW),
ops_arg_dat(D11_B0, 1, stencil_0_00_22_00_8, "double", OPS_RW),
...
ops_halo_transfer(periodicBC_direction2_side0_58_block0);
ops_halo_transfer(periodicBC_direction2_side1_59_block0);
int iteration_range_64_block0[] = {0, block0np0, 0, block0np1, 0, block0np2};
ops_par_loop(opensbliblock00Kernel064, "MetricsEquation evaluation", opensbliblock00, 3, iteration_range_64_block0,
...
int iteration_range_44_block0[] = {0, 1, -2, block0np1 + 2, -2, block0np2 + 2};
ops_par_loop(opensbliblock00Kernel044, "InletTransfer boundary dir0 side0", opensbliblock00, 3, iteration_range_44_block0,
...
int iteration_range_45_block0[] = {block0np0 - 1, block0np0, -2, block0np1 + 2, -2, block0np2 + 2};
ops_par_loop(opensbliblock00Kernel045, "Extrapolation boundary dir0 side1", opensbliblock00, 3, iteration_range_45_block0,
...
int iteration_range_46_block0[] = {-2, block0np0 + 2, 0, 1, -2, block0np2 + 2};
ops_par_loop(opensbliblock00Kernel046, "ForcingStripWall boundary dir1 side0", opensbliblock00, 3, iteration_range_46_block0,
...
int iteration_range_47_block0[] = {-2, block0np0 + 2, block0np1 - 1, block0np1, -2, block0np2 + 2};
ops_par_loop(opensbliblock00Kernel047, "ZeroGradientOutlet boundary dir1 side1", opensbliblock00, 3, iteration_range_47_block0,
...
int iteration_range_24_block0[] = {-2, block0np0 + 2, 0, block0np1, 0, block0np2};
...
ops_par_loop(opensbliblock00Kernel031, "CRU1_B0", opensbliblock00, 3, iteration_range_31_block0,
...
int iteration_range_33_block0[] = {0, block0np0, 0, block0np1, -2, block0np2 + 2};
ops_par_loop(opensbliblock00Kernel033, "CRU2_B0", opensbliblock00, 3, iteration_range_33_block0,
ops_arg_dat(u2_B0, 1, stencil_0_00_00_00_3, "double", OPS_READ),
ops_arg_dat(U2_B0, 1, stencil_0_00_00_00_3, "double", OPS_WRITE));
...
int iteration_range_34_block0[] = {-2, block0np0 + 2, -2, block0np1 + 2, -2, block0np2 + 2};
ops_par_loop(opensbliblock00Kernel034, "CRmu_B0", opensbliblock00, 3, iteration_range_34_block0,
...
ops_par_loop(opensbliblock00Kernel042, "Convective terms", opensbliblock00, 3, iteration_range_42_block0,
...
ops_par_loop(opensbliblock00Kernel076, "Temporal solution advancement", opensbliblock00, 3, iteration_range_76_block0,
...
int iteration_range_65_block0[] = {-1, block0np0 + 2, -1, block0np1 + 2, -1, block0np2 + 2};
ops_par_loop(opensbliblock00Kernel065, "User kernel: Constituent Relations evaluation", opensbliblock00, 3, iteration_range_65_block0,
ops_arg_dat(rhoE_B0, 1, stencil_0_00_00_00_3, "double", OPS_READ),
ops_arg_dat(rho_B0, 1, stencil_0_00_00_00_3, "double", OPS_READ),
ops_arg_dat(rhou0_B0, 1, stencil_0_00_00_00_3, "double", OPS_READ),
ops_arg_dat(rhou1_B0, 1, stencil_0_00_00_00_3, "double", OPS_READ),
...
ops_par_loop(opensbliblock00Kernel069, "UserDefinedEquations evaluation", opensbliblock00, 3, iteration_range_69_block0,
ops_arg_dat(D00_B0, 1, stencil_0_00_00_00_3, "double", OPS_READ),
ops_arg_dat(D01_B0, 1, stencil_0_00_00_00_3, "double", OPS_READ),
ops_arg_dat(D10_B0, 1, stencil_0_00_00_00_3, "double", OPS_READ),
ops_arg_dat(D11_B0, 1, stencil_0_00_00_00_3, "double", OPS_READ),
...
int iteration_range_70_block0[] = {-1, block0np0 + 2, -1, block0np1 + 2, -1, block0np2 + 2};
ops_par_loop(opensbliblock00Kernel070, "User kernel: Constituent Relations evaluation", opensbliblock00, 3, iteration_range_70_block0,
ops_arg_dat(rhoE_B0, 1, stencil_0_00_00_00_3, "double", OPS_READ),
ops_arg_dat(rho_B0, 1, stencil_0_00_00_00_3, "double", OPS_READ),
ops_arg_dat(rhou0_B0, 1, stencil_0_00_00_00_3, "double", OPS_READ),
ops_arg_dat(rhou1_B0, 1, stencil_0_00_00_00_3, "double", OPS_READ),
...
int iteration_range_71_block0[] = {-5, block0np0 + 5, -5, block0np1 + 5, -5, block0np2 + 5};
ops_par_loop(opensbliblock00Kernel071, "User kernel: Zero the work arrays", opensbliblock00, 3, iteration_range_71_block0,
ops_arg_dat(Residual0_B0, 1, stencil_0_00_00_00_3, "double", OPS_WRITE),
ops_arg_dat(Residual1_B0, 1, stencil_0_00_00_00_3, "double", OPS_WRITE),
ops_arg_dat(Residual2_B0, 1, stencil_0_00_00_00_3, "double", OPS_WRITE),
ops_arg_dat(Residual3_B0, 1, stencil_0_00_00_00_3, "double", OPS_WRITE),
...
int iteration_range_72_block0[] = {-1, block0np0 + 1, 0, block0np1, 0, block0np2};
ops_par_loop(opensbliblock00Kernel072, "User kernel: TVD reconstruction direction 0", opensbliblock00, 3, iteration_range_72_block0,
...
int iteration_range_73_block0[] = {0, block0np0, -1, block0np1 + 1, 0, block0np2};
ops_par_loop(opensbliblock00Kernel073, "User kernel: TVD reconstruction direction 1", opensbliblock00, 3, iteration_range_73_block0,
...
int iteration_range_74_block0[] = {0, block0np0, 0, block0np1, -1, block0np2 + 1};
ops_par_loop(opensbliblock00Kernel074, "User kernel: TVD reconstruction direction 2", opensbliblock00, 3, iteration_range_74_block0,
...
ops_par_loop(opensbliblock00Kernel075, "User kernel: Non-linear TVD Filter application", opensbliblock00, 3, iteration_range_75_block0,
