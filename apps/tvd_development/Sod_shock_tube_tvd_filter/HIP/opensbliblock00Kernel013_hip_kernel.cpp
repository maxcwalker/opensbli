...
//
__constant__ int dims_opensbliblock00Kernel013 [4][1];
static int dims_opensbliblock00Kernel013_h [4][1] = {{0}};
...
void opensbliblock00Kernel013_gpu(const ACC<double> &rho_B0,
  ...
  ACC<double> &p_B0)
{
   p_B0(0) = (gama - 1)*(rhoE_B0(0) - rc1*rho_B0(0)*pow(u0_B0(0), 2));
...
void ops_par_loop_opensbliblock00Kernel013_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_opensbliblock00Kernel013_h[0][0] || xdim1 != dims_opensbliblock00Kernel013_h[1][0] || xdim2 != dims_opensbliblock00Kernel013_h[2][0] || xdim3 != dims_opensbliblock00Kernel013_h[3][0]) {
