...
//
__constant__ int dims_opensbliblock00Kernel019 [1][1];
static int dims_opensbliblock00Kernel019_h [1][1] = {{0}};

//user function
__device__

void opensbliblock00Kernel019_gpu(ACC<double> &detJ_B0)
{
   detJ_B0(1) = detJ_B0(-1);
...
int size0 ){
  ...
  if (idx_x < size0) {
    ...
    opensbliblock00Kernel019_gpu(argp0);
  }
...
void ops_par_loop_opensbliblock00Kernel019_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_opensbliblock00Kernel019_h[0][0]) {
  ...
  if (x_size > 0)
    hipLaunchKernelGGL(ops_opensbliblock00Kernel019,grid ,tblock ,0 ,0 , (double *)p_a[0],x_size);
