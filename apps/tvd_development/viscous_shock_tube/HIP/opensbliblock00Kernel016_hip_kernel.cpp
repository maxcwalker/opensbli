...
//
__constant__ int dims_opensbliblock00Kernel016 [11][1];
static int dims_opensbliblock00Kernel016_h [11][1] = {{0}};

//user function
__device__

 void opensbliblock00Kernel016_gpu(const ACC<double> &p_B0,
...
int size1 ){
  ...
  if (idx_x < size0 && idx_y < size1) {
    ...
    ACC<double> argp6(dims_opensbliblock00Kernel016[6][0], arg6);
...
void ops_par_loop_opensbliblock00Kernel016(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg8, ops_arg arg9, ops_arg arg10) {
  ...
  create_kerneldesc_and_enque(name, args, 11, 15, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel016_execute);
}
#endif
