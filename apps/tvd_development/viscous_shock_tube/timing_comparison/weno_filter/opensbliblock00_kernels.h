...
void opensbliblock00Kernel012(const ACC<double> &p_B0, const ACC<double> &rho_B0, ACC<double> &T_B0)
{
   T_B0(0,0) = (Minf*Minf)*gama*p_B0(0,0)/rho_B0(0,0);

}

void opensbliblock00Kernel007(const ACC<double> &u0_B0, ACC<double> &wk0_B0, const int *idx)
{
   if (idx[0] == 0){
...
void opensbliblock00Kernel009(const ACC<double> &u1_B0, ACC<double> &wk1_B0, const int *idx)
{
   if (idx[0] == 0){
...
void opensbliblock00Kernel011(const ACC<double> &T_B0, ACC<double> &wk2_B0, const int *idx)
{
   if (idx[0] == 0){
...
void opensbliblock00Kernel013(const ACC<double> &u0_B0, ACC<double> &wk3_B0, const int *idx)
{
   if (idx[1] == 0){
...
void opensbliblock00Kernel014(const ACC<double> &u1_B0, ACC<double> &wk4_B0, const int *idx)
{
   if (idx[1] == 0){
...
void opensbliblock00Kernel015(const ACC<double> &T_B0, ACC<double> &wk5_B0, const int *idx)
{
   if (idx[1] == 0){
 ...
 void opensbliblock00Kernel024(const ACC<double> &p_B0, const ACC<double> &rhoE_B0, const ACC<double> &rho_B0, const
...
&Residual0_B0, ACC<double> &Residual1_B0, ACC<double> &Residual2_B0, ACC<double> &Residual3_B0, const int *idx)
{
 ...
 void opensbliblock00Kernel025(const ACC<double> &T_B0, const ACC<double> &mu_B0, const ACC<double> &u0_B0, const
...
&rhou1_RKold_B0, const double *rkA, const double *rkB)
{
 ...
 void opensbliblock00Kernel003(ACC<double> &Residual0_B0, ACC<double> &Residual1_B0, ACC<double> &Residual2_B0,
ACC<double> &Residual3_B0, ACC<double> &wk0_B0, ACC<double> &wk1_B0, ACC<double> &wk2_B0, ACC<double> &wk3_B0)
{
 ...
 void opensbliblock00Kernel004(const ACC<double> &a_B0, const ACC<double> &p_B0, const ACC<double> &rhoE_B0, const
...
ACC<double> &u1_B0, ACC<double> &wk0_B0, ACC<double> &wk1_B0, ACC<double> &wk2_B0, ACC<double> &wk3_B0)
{
 ...
 void opensbliblock00Kernel005(const ACC<double> &a_B0, const ACC<double> &p_B0, const ACC<double> &rhoE_B0, const
ACC<double> &rho_B0, const ACC<double> &rhou0_B0, const ACC<double> &rhou1_B0, const ACC<double> &u0_B0, const
...
&Residual3_B0)
{
 ...
 void opensbliblock00Kernel006(const ACC<double> &Residual0_B0, const ACC<double> &Residual1_B0, const ACC<double>
&Residual2_B0, const ACC<double> &Residual3_B0, const ACC<double> &wk0_B0, const ACC<double> &wk1_B0, const ACC<double>
&wk2_B0, const ACC<double> &wk3_B0, ACC<double> &rhoE_B0, ACC<double> &rho_B0, ACC<double> &rhou0_B0, ACC<double>
&rhou1_B0, const int *idx)
{
   double Grid_0 = 0.0;
   double Grid_1 = 0.0;
   double Wall = 0.0;
