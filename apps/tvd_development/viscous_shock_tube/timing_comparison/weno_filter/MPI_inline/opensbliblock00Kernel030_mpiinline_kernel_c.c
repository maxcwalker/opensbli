...
void opensbliblock00Kernel030_c_wrapper(
  ...
  for ( int n_y=0; n_y<y_size; n_y++ ){
    for ( int n_x=0; n_x<x_size; n_x++ ){
      ...
      ptr_double x0_B0 = { x0_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel030*1, xdim4_opensbliblock00Kernel030};
      ptr_double x1_B0 = { x1_B0_p + n_x*1 + n_y * xdim5_opensbliblock00Kernel030*1, xdim5_opensbliblock00Kernel030};
