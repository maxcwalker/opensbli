...
void ops_par_loop_opensbliblock00Kernel015_execute(ops_kernel_descriptor *desc) {
  ...
  for ( int n_y=start1; n_y<end1; n_y++ ){
    for ( int n_x=start0; n_x<end0; n_x++ ){
      ...
      const ACC<double> T_B0(xdim0_opensbliblock00Kernel015, T_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel015*1);
      ACC<double> wk5_B0(xdim1_opensbliblock00Kernel015, wk5_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel015*1);
