...
//
__constant__ int dims_opensbliblock00Kernel005 [12][1];
static int dims_opensbliblock00Kernel005_h [12][1] = {{0}};

//user function
__device__

 void opensbliblock00Kernel005_gpu(const ACC<double> &a_B0,
...
int size1 ){
  ...
  arg0 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel005[0][0];
  arg1 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel005[1][0];
  arg2 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel005[2][0];
  arg3 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel005[3][0];
  arg4 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel005[4][0];
  arg5 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel005[5][0];
  arg6 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel005[6][0];
  arg7 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel005[7][0];
  arg8 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel005[8][0];
  arg9 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel005[9][0];
  arg10 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel005[10][0];
  arg11 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel005[11][0];

  if (idx_x < size0 && idx_y < size1) {
    const ACC<double> argp0(dims_opensbliblock00Kernel005[0][0], arg0);
    const ACC<double> argp1(dims_opensbliblock00Kernel005[1][0], arg1);
    const ACC<double> argp2(dims_opensbliblock00Kernel005[2][0], arg2);
    const ACC<double> argp3(dims_opensbliblock00Kernel005[3][0], arg3);
    const ACC<double> argp4(dims_opensbliblock00Kernel005[4][0], arg4);
    const ACC<double> argp5(dims_opensbliblock00Kernel005[5][0], arg5);
    const ACC<double> argp6(dims_opensbliblock00Kernel005[6][0], arg6);
    const ACC<double> argp7(dims_opensbliblock00Kernel005[7][0], arg7);
    ACC<double> argp8(dims_opensbliblock00Kernel005[8][0], arg8);
    ACC<double> argp9(dims_opensbliblock00Kernel005[9][0], arg9);
    ACC<double> argp10(dims_opensbliblock00Kernel005[10][0], arg10);
    ACC<double> argp11(dims_opensbliblock00Kernel005[11][0], arg11);
...
void ops_par_loop_opensbliblock00Kernel005(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg8, ops_arg arg9, ops_arg arg10, ops_arg arg11) {
  ...
  create_kerneldesc_and_enque(name, args, 12, 20, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel005_execute);
}
#endif
