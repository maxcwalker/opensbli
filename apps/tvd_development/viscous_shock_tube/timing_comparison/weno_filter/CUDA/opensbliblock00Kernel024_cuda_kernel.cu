...
//
__constant__ int dims_opensbliblock00Kernel024 [16][1];
static int dims_opensbliblock00Kernel024_h [16][1] = {{0}};

//user function
__device__

 void opensbliblock00Kernel024_gpu(const ACC<double> &p_B0,
...
int size1 ){
  ...
  arg0 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel024[0][0];
  arg1 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel024[1][0];
  arg2 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel024[2][0];
  arg3 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel024[3][0];
  arg4 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel024[4][0];
  arg5 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel024[5][0];
  arg6 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel024[6][0];
  arg7 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel024[7][0];
  arg8 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel024[8][0];
  arg9 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel024[9][0];
  arg10 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel024[10][0];
  arg11 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel024[11][0];
  arg12 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel024[12][0];
  arg13 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel024[13][0];
  arg14 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel024[14][0];

  if (idx_x < size0 && idx_y < size1) {
    const ACC<double> argp0(dims_opensbliblock00Kernel024[0][0], arg0);
    const ACC<double> argp1(dims_opensbliblock00Kernel024[1][0], arg1);
    const ACC<double> argp2(dims_opensbliblock00Kernel024[2][0], arg2);
    const ACC<double> argp3(dims_opensbliblock00Kernel024[3][0], arg3);
    const ACC<double> argp4(dims_opensbliblock00Kernel024[4][0], arg4);
    const ACC<double> argp5(dims_opensbliblock00Kernel024[5][0], arg5);
    const ACC<double> argp6(dims_opensbliblock00Kernel024[6][0], arg6);
    const ACC<double> argp7(dims_opensbliblock00Kernel024[7][0], arg7);
    const ACC<double> argp8(dims_opensbliblock00Kernel024[8][0], arg8);
    const ACC<double> argp9(dims_opensbliblock00Kernel024[9][0], arg9);
    const ACC<double> argp10(dims_opensbliblock00Kernel024[10][0], arg10);
    ACC<double> argp11(dims_opensbliblock00Kernel024[11][0], arg11);
    ACC<double> argp12(dims_opensbliblock00Kernel024[12][0], arg12);
    ACC<double> argp13(dims_opensbliblock00Kernel024[13][0], arg13);
    ACC<double> argp14(dims_opensbliblock00Kernel024[14][0], arg14);
...
void ops_par_loop_opensbliblock00Kernel024(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg12, ops_arg arg13, ops_arg arg14, ops_arg arg15) {
  ...
  create_kerneldesc_and_enque(name, args, 16, 15, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel024_execute);
}
#endif
