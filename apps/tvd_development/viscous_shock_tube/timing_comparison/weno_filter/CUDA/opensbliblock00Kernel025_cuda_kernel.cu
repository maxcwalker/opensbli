...
//
__constant__ int dims_opensbliblock00Kernel025 [14][1];
static int dims_opensbliblock00Kernel025_h [14][1] = {{0}};

//user function
__device__

 void opensbliblock00Kernel025_gpu(const ACC<double> &T_B0,
...
int size1 ){
  ...
  arg0 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel025[0][0];
  arg1 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel025[1][0];
  arg2 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel025[2][0];
  arg3 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel025[3][0];
  arg4 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel025[4][0];
  arg5 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel025[5][0];
  arg6 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel025[6][0];
  arg7 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel025[7][0];
  arg8 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel025[8][0];
  arg9 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel025[9][0];
  arg10 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel025[10][0];
  arg11 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel025[11][0];
  arg12 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel025[12][0];

  if (idx_x < size0 && idx_y < size1) {
    const ACC<double> argp0(dims_opensbliblock00Kernel025[0][0], arg0);
    const ACC<double> argp1(dims_opensbliblock00Kernel025[1][0], arg1);
    const ACC<double> argp2(dims_opensbliblock00Kernel025[2][0], arg2);
    const ACC<double> argp3(dims_opensbliblock00Kernel025[3][0], arg3);
    const ACC<double> argp4(dims_opensbliblock00Kernel025[4][0], arg4);
    const ACC<double> argp5(dims_opensbliblock00Kernel025[5][0], arg5);
    const ACC<double> argp6(dims_opensbliblock00Kernel025[6][0], arg6);
    const ACC<double> argp7(dims_opensbliblock00Kernel025[7][0], arg7);
    const ACC<double> argp8(dims_opensbliblock00Kernel025[8][0], arg8);
    const ACC<double> argp9(dims_opensbliblock00Kernel025[9][0], arg9);
    ACC<double> argp10(dims_opensbliblock00Kernel025[10][0], arg10);
    ACC<double> argp11(dims_opensbliblock00Kernel025[11][0], arg11);
    ACC<double> argp12(dims_opensbliblock00Kernel025[12][0], arg12);
...
void ops_par_loop_opensbliblock00Kernel025_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_opensbliblock00Kernel025_h[0][0] || xdim1 != dims_opensbliblock00Kernel025_h[1][0] || xdim2 != dims_opensbliblock00Kernel025_h[2][0] || xdim3 != dims_opensbliblock00Kernel025_h[3][0] || xdim4 != dims_opensbliblock00Kernel025_h[4][0] || xdim5 != dims_opensbliblock00Kernel025_h[5][0] || xdim6 != dims_opensbliblock00Kernel025_h[6][0] || xdim7 != dims_opensbliblock00Kernel025_h[7][0] || xdim8 != dims_opensbliblock00Kernel025_h[8][0] || xdim9 != dims_opensbliblock00Kernel025_h[9][0] || xdim10 != dims_opensbliblock00Kernel025_h[10][0] || xdim11 != dims_opensbliblock00Kernel025_h[11][0] || xdim12 != dims_opensbliblock00Kernel025_h[12][0]) {
    ...
    cutilSafeCall(block->instance->ostream(), cudaMemcpyToSymbol( dims_opensbliblock00Kernel025, dims_opensbliblock00Kernel025_h, sizeof(dims_opensbliblock00Kernel025)));
  }
...
void ops_par_loop_opensbliblock00Kernel025(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg12, ops_arg arg13) {
  ...
  create_kerneldesc_and_enque(name, args, 14, 16, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel025_execute);
}
#endif
