...
void ops_par_loop_opensbliblock00Kernel005_execute(ops_kernel_descriptor *desc) {
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
      const ACC<double> a_B0(xdim0_opensbliblock00Kernel005, a_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel005*1);
      const ACC<double> p_B0(xdim1_opensbliblock00Kernel005, p_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel005*1);
      ...
      const ACC<double> rhou0_B0(xdim4_opensbliblock00Kernel005, rhou0_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel005*1);
      const ACC<double> rhou1_B0(xdim5_opensbliblock00Kernel005, rhou1_B0_p + n_x*1 + n_y * xdim5_opensbliblock00Kernel005*1);
      const ACC<double> u0_B0(xdim6_opensbliblock00Kernel005, u0_B0_p + n_x*1 + n_y * xdim6_opensbliblock00Kernel005*1);
      const ACC<double> u1_B0(xdim7_opensbliblock00Kernel005, u1_B0_p + n_x*1 + n_y * xdim7_opensbliblock00Kernel005*1);
      ACC<double> Residual0_B0(xdim8_opensbliblock00Kernel005, Residual0_B0_p + n_x*1 + n_y * xdim8_opensbliblock00Kernel005*1);
      ACC<double> Residual1_B0(xdim9_opensbliblock00Kernel005, Residual1_B0_p + n_x*1 + n_y * xdim9_opensbliblock00Kernel005*1);
      ACC<double> Residual2_B0(xdim10_opensbliblock00Kernel005, Residual2_B0_p + n_x*1 + n_y * xdim10_opensbliblock00Kernel005*1);
      ACC<double> Residual3_B0(xdim11_opensbliblock00Kernel005, Residual3_B0_p + n_x*1 + n_y * xdim11_opensbliblock00Kernel005*1);
...
void ops_par_loop_opensbliblock00Kernel005(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg8, ops_arg arg9, ops_arg arg10, ops_arg arg11) {
  ...
  create_kerneldesc_and_enque(name, args, 12, 20, dim, 0, range, block, ops_par_loop_opensbliblock00Kernel005_execute);
}
#endif
