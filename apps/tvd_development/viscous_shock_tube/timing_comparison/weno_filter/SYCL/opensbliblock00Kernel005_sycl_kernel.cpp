...
void ops_par_loop_opensbliblock00Kernel005_execute(ops_kernel_descriptor *desc) {
 ...
 arg10, arg11};
  ...
  int xdim3_opensbliblock00Kernel005 = args[3].dat->size[0];
  int xdim4_opensbliblock00Kernel005 = args[4].dat->size[0];
  int xdim5_opensbliblock00Kernel005 = args[5].dat->size[0];
  int xdim6_opensbliblock00Kernel005 = args[6].dat->size[0];
  int xdim7_opensbliblock00Kernel005 = args[7].dat->size[0];
  int xdim8_opensbliblock00Kernel005 = args[8].dat->size[0];
  int xdim9_opensbliblock00Kernel005 = args[9].dat->size[0];
  int xdim10_opensbliblock00Kernel005 = args[10].dat->size[0];
  int xdim11_opensbliblock00Kernel005 = args[11].dat->size[0];
  ...
  double* Residual0_B0_p = (double*)args[8].data_d;

  int base9 = args[9].dat->base_offset/sizeof(double);
  double* Residual1_B0_p = (double*)args[9].data_d;

  int base10 = args[10].dat->base_offset/sizeof(double);
  double* Residual2_B0_p = (double*)args[10].data_d;

  int base11 = args[11].dat->base_offset/sizeof(double);
  double* Residual3_B0_p = (double*)args[11].data_d;
  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      cgh.parallel_for<class opensbliblock00Kernel005_kernel>(cl::sycl::nd_range<2>(cl::sycl::range<2>(
      ...
      , [=](cl::sycl::nd_item<2> item
        ...
        const ACC<double> a_B0(xdim0_opensbliblock00Kernel005, &a_B0_p[0] + base0 + n_x*1 + n_y * xdim0_opensbliblock00Kernel005*1);
        const ACC<double> p_B0(xdim1_opensbliblock00Kernel005, &p_B0_p[0] + base1 + n_x*1 + n_y * xdim1_opensbliblock00Kernel005*1);
        const ACC<double> rhoE_B0(xdim2_opensbliblock00Kernel005, &rhoE_B0_p[0] + base2 + n_x*1 + n_y * xdim2_opensbliblock00Kernel005*1);
        const ACC<double> rho_B0(xdim3_opensbliblock00Kernel005, &rho_B0_p[0] + base3 + n_x*1 + n_y * xdim3_opensbliblock00Kernel005*1);
        const ACC<double> rhou0_B0(xdim4_opensbliblock00Kernel005, &rhou0_B0_p[0] + base4 + n_x*1 + n_y * xdim4_opensbliblock00Kernel005*1);
        const ACC<double> rhou1_B0(xdim5_opensbliblock00Kernel005, &rhou1_B0_p[0] + base5 + n_x*1 + n_y * xdim5_opensbliblock00Kernel005*1);
        const ACC<double> u0_B0(xdim6_opensbliblock00Kernel005, &u0_B0_p[0] + base6 + n_x*1 + n_y * xdim6_opensbliblock00Kernel005*1);
        const ACC<double> u1_B0(xdim7_opensbliblock00Kernel005, &u1_B0_p[0] + base7 + n_x*1 + n_y * xdim7_opensbliblock00Kernel005*1);
        ACC<double> Residual0_B0(xdim8_opensbliblock00Kernel005, &Residual0_B0_p[0] + base8 + n_x*1 + n_y * xdim8_opensbliblock00Kernel005*1);
        ACC<double> Residual1_B0(xdim9_opensbliblock00Kernel005, &Residual1_B0_p[0] + base9 + n_x*1 + n_y * xdim9_opensbliblock00Kernel005*1);
        ACC<double> Residual2_B0(xdim10_opensbliblock00Kernel005, &Residual2_B0_p[0] + base10 + n_x*1 + n_y * xdim10_opensbliblock00Kernel005*1);
        ACC<double> Residual3_B0(xdim11_opensbliblock00Kernel005, &Residual3_B0_p[0] + base11 + n_x*1 + n_y * xdim11_opensbliblock00Kernel005*1);
        //USER CODE
   ...
   max_lambda_22 = shock_filter_control_sycl[0]*cl::sycl::fmax(cl::sycl::fabs(a_B0(0,1) + u1_B0(0,1)), cl::sycl::fabs(a_B0(0,0) + u1_B0(0,0)));

   max_lambda_33 = shock_filter_control_sycl[0]*cl::sycl::fmax(cl::sycl::fabs(-u1_B0(0,1) + a_B0(0,1)), cl::sycl::fabs(-u1_B0(0,0) + a_B0(0,0)));
