 ...
 arg10, arg11, arg12, arg13};
  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      cgh.parallel_for<class opensbliblock00Kernel025_kernel>(cl::sycl::nd_range<2>(cl::sycl::range<2>(
      ...
      , [=](cl::sycl::nd_item<2> item
        ...
        const ACC<double> T_B0(xdim0_opensbliblock00Kernel025, &T_B0_p[0] + base0 + n_x*1 + n_y * xdim0_opensbliblock00Kernel025*1);
        const ACC<double> mu_B0(xdim1_opensbliblock00Kernel025, &mu_B0_p[0] + base1 + n_x*1 + n_y * xdim1_opensbliblock00Kernel025*1);
        const ACC<double> u0_B0(xdim2_opensbliblock00Kernel025, &u0_B0_p[0] + base2 + n_x*1 + n_y * xdim2_opensbliblock00Kernel025*1);
        const ACC<double> u1_B0(xdim3_opensbliblock00Kernel025, &u1_B0_p[0] + base3 + n_x*1 + n_y * xdim3_opensbliblock00Kernel025*1);
        const ACC<double> wk0_B0(xdim4_opensbliblock00Kernel025, &wk0_B0_p[0] + base4 + n_x*1 + n_y * xdim4_opensbliblock00Kernel025*1);
        const ACC<double> wk1_B0(xdim5_opensbliblock00Kernel025, &wk1_B0_p[0] + base5 + n_x*1 + n_y * xdim5_opensbliblock00Kernel025*1);
        const ACC<double> wk2_B0(xdim6_opensbliblock00Kernel025, &wk2_B0_p[0] + base6 + n_x*1 + n_y * xdim6_opensbliblock00Kernel025*1);
        const ACC<double> wk3_B0(xdim7_opensbliblock00Kernel025, &wk3_B0_p[0] + base7 + n_x*1 + n_y * xdim7_opensbliblock00Kernel025*1);
        const ACC<double> wk4_B0(xdim8_opensbliblock00Kernel025, &wk4_B0_p[0] + base8 + n_x*1 + n_y * xdim8_opensbliblock00Kernel025*1);
        const ACC<double> wk5_B0(xdim9_opensbliblock00Kernel025, &wk5_B0_p[0] + base9 + n_x*1 + n_y * xdim9_opensbliblock00Kernel025*1);
        ACC<double> Residual1_B0(xdim10_opensbliblock00Kernel025, &Residual1_B0_p[0] + base10 + n_x*1 + n_y * xdim10_opensbliblock00Kernel025*1);
        ACC<double> Residual2_B0(xdim11_opensbliblock00Kernel025, &Residual2_B0_p[0] + base11 + n_x*1 + n_y * xdim11_opensbliblock00Kernel025*1);
        ACC<double> Residual3_B0(xdim12_opensbliblock00Kernel025, &Residual3_B0_p[0] + base12 + n_x*1 + n_y * xdim12_opensbliblock00Kernel025*1);
        //USER CODE
