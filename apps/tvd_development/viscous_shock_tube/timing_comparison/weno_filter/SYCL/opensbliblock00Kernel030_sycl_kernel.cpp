  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      , [=](cl::sycl::nd_item<2> item
        ...
        ACC<double> x0_B0(xdim4_opensbliblock00Kernel030, &x0_B0_p[0] + base4 + n_x*1 + n_y * xdim4_opensbliblock00Kernel030*1);
        ACC<double> x1_B0(xdim5_opensbliblock00Kernel030, &x1_B0_p[0] + base5 + n_x*1 + n_y * xdim5_opensbliblock00Kernel030*1);
        //USER CODE
