  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      , [=](cl::sycl::nd_item<2> item
        ...
        const ACC<double> T_B0(xdim0_opensbliblock00Kernel015, &T_B0_p[0] + base0 + n_x*1 + n_y * xdim0_opensbliblock00Kernel015*1);
        ACC<double> wk5_B0(xdim1_opensbliblock00Kernel015, &wk5_B0_p[0] + base1 + n_x*1 + n_y * xdim1_opensbliblock00Kernel015*1);
        //USER CODE
   ...
   if (idx[1] == 0){
       ...
       wk5_B0(0,0) = (-3*T_B0(0,2) + 4*T_B0(0,1) - (25.0/12.0)*T_B0(0,0) - (1.0/4.0)*T_B0(0,4) +
            ((4.0/3.0))*T_B0(0,3))*invDelta1block0_sycl[0];
       ...
       wk5_B0(0,0) = (-(5.0/6.0)*T_B0(0,0) - (1.0/2.0)*T_B0(0,2) - (1.0/4.0)*T_B0(0,-1) + ((1.0/12.0))*T_B0(0,3) +
            ((3.0/2.0))*T_B0(0,1))*invDelta1block0_sycl[0];
