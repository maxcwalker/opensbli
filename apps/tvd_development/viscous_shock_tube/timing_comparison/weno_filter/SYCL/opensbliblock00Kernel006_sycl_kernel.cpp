...
void ops_par_loop_opensbliblock00Kernel006_execute(ops_kernel_descriptor *desc) {
 ...
 arg10, arg11, arg12};
  ...
  double* rho_B0_p = (double*)args[9].data_d;

  int base10 = args[10].dat->base_offset/sizeof(double);
  double* rhou0_B0_p = (double*)args[10].data_d;
  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      , [=](cl::sycl::nd_item<2> item
        ...
        const ACC<double> Residual0_B0(xdim0_opensbliblock00Kernel006, &Residual0_B0_p[0] + base0 + n_x*1 + n_y * xdim0_opensbliblock00Kernel006*1);
        const ACC<double> Residual1_B0(xdim1_opensbliblock00Kernel006, &Residual1_B0_p[0] + base1 + n_x*1 + n_y * xdim1_opensbliblock00Kernel006*1);
        const ACC<double> Residual2_B0(xdim2_opensbliblock00Kernel006, &Residual2_B0_p[0] + base2 + n_x*1 + n_y * xdim2_opensbliblock00Kernel006*1);
        const ACC<double> Residual3_B0(xdim3_opensbliblock00Kernel006, &Residual3_B0_p[0] + base3 + n_x*1 + n_y * xdim3_opensbliblock00Kernel006*1);
        const ACC<double> wk0_B0(xdim4_opensbliblock00Kernel006, &wk0_B0_p[0] + base4 + n_x*1 + n_y * xdim4_opensbliblock00Kernel006*1);
        const ACC<double> wk1_B0(xdim5_opensbliblock00Kernel006, &wk1_B0_p[0] + base5 + n_x*1 + n_y * xdim5_opensbliblock00Kernel006*1);
        const ACC<double> wk2_B0(xdim6_opensbliblock00Kernel006, &wk2_B0_p[0] + base6 + n_x*1 + n_y * xdim6_opensbliblock00Kernel006*1);
        const ACC<double> wk3_B0(xdim7_opensbliblock00Kernel006, &wk3_B0_p[0] + base7 + n_x*1 + n_y * xdim7_opensbliblock00Kernel006*1);
        ACC<double> rhoE_B0(xdim8_opensbliblock00Kernel006, &rhoE_B0_p[0] + base8 + n_x*1 + n_y * xdim8_opensbliblock00Kernel006*1);
        ACC<double> rho_B0(xdim9_opensbliblock00Kernel006, &rho_B0_p[0] + base9 + n_x*1 + n_y * xdim9_opensbliblock00Kernel006*1);
        ACC<double> rhou0_B0(xdim10_opensbliblock00Kernel006, &rhou0_B0_p[0] + base10 + n_x*1 + n_y * xdim10_opensbliblock00Kernel006*1);
        ACC<double> rhou1_B0(xdim11_opensbliblock00Kernel006, &rhou1_B0_p[0] + base11 + n_x*1 + n_y * xdim11_opensbliblock00Kernel006*1);
        //USER CODE
...
: (
   1
    ...
    rho_B0(0,0) = (-(-wk0_B0(-1,0) + wk0_B0(0,0))*inv_rfact0_block0_sycl[0] - (-Residual0_B0(0,-1) +
      Residual0_B0(0,0))*inv_rfact1_block0_sycl[0]*Wall)*dt_sycl[0] + rho_B0(0,0);

    rhou0_B0(0,0) = (-(-wk1_B0(-1,0) + wk1_B0(0,0))*inv_rfact0_block0_sycl[0] - (-Residual1_B0(0,-1) +
      Residual1_B0(0,0))*inv_rfact1_block0_sycl[0]*Wall)*dt_sycl[0] + rhou0_B0(0,0);

    rhou1_B0(0,0) = (-(-wk2_B0(-1,0) + wk2_B0(0,0))*inv_rfact0_block0_sycl[0] - (-Residual2_B0(0,-1) +
      Residual2_B0(0,0))*inv_rfact1_block0_sycl[0]*Wall)*dt_sycl[0] + rhou1_B0(0,0);

    rhoE_B0(0,0) = (-(-wk3_B0(-1,0) + wk3_B0(0,0))*inv_rfact0_block0_sycl[0] - (-Residual3_B0(0,-1) +
      Residual3_B0(0,0))*inv_rfact1_block0_sycl[0]*Wall)*dt_sycl[0] + rhoE_B0(0,0);
