...
if (restart == 0){
int iteration_range_30_block0[] = {-5, block0np0 + 5, -5, block0np1 + 5};
ops_par_loop(opensbliblock00Kernel030, "Grid_based_initialisation0", opensbliblock00, 2, iteration_range_30_block0,
...
int iteration_range_26_block0[] = {0, 1, -3, block0np1 + 4};
ops_par_loop(opensbliblock00Kernel026, "AdiabaticWall boundary dir0 side0", opensbliblock00, 2, iteration_range_26_block0,
...
int iteration_range_27_block0[] = {block0np0 - 1, block0np0, -3, block0np1 + 4};
ops_par_loop(opensbliblock00Kernel027, "AdiabaticWall boundary dir0 side1", opensbliblock00, 2, iteration_range_27_block0,
ops_arg_dat(rhoE_B0, 1, stencil_0_44_00_10, "double", OPS_RW),
ops_arg_dat(rho_B0, 1, stencil_0_44_00_10, "double", OPS_RW),
ops_arg_dat(rhou0_B0, 1, stencil_0_44_00_10, "double", OPS_RW),
ops_arg_dat(rhou1_B0, 1, stencil_0_44_00_10, "double", OPS_RW));

int iteration_range_28_block0[] = {-3, block0np0 + 4, 0, 1};
ops_par_loop(opensbliblock00Kernel028, "AdiabaticWall boundary dir1 side0", opensbliblock00, 2, iteration_range_28_block0,
...
int iteration_range_29_block0[] = {-3, block0np0 + 4, block0np1 - 1, block0np1};
ops_par_loop(opensbliblock00Kernel029, "Symmetry boundary dir1 side1", opensbliblock00, 2, iteration_range_29_block0,
...
ops_par_loop(opensbliblock00Kernel008, "CRu0_B0", opensbliblock00, 2, iteration_range_8_block0,
...
ops_par_loop(opensbliblock00Kernel010, "CRu1_B0", opensbliblock00, 2, iteration_range_10_block0,
ops_arg_dat(rho_B0, 1, stencil_0_00_00_2, "double", OPS_READ),
...
ops_par_loop(opensbliblock00Kernel016, "CRp_B0", opensbliblock00, 2, iteration_range_16_block0,
...
ops_par_loop(opensbliblock00Kernel012, "CRT_B0", opensbliblock00, 2, iteration_range_12_block0,
...
ops_par_loop(opensbliblock00Kernel007, "Derivative evaluation CD u0_B0 x0 ", opensbliblock00, 2, iteration_range_7_block0,
...
ops_par_loop(opensbliblock00Kernel009, "Derivative evaluation CD u1_B0 x0 ", opensbliblock00, 2, iteration_range_9_block0,
...
ops_par_loop(opensbliblock00Kernel011, "Derivative evaluation CD T_B0 x0 ", opensbliblock00, 2, iteration_range_11_block0,
...
ops_par_loop(opensbliblock00Kernel013, "Derivative evaluation CD u0_B0 x1 ", opensbliblock00, 2, iteration_range_13_block0,
...
ops_par_loop(opensbliblock00Kernel014, "Derivative evaluation CD u1_B0 x1 ", opensbliblock00, 2, iteration_range_14_block0,
...
ops_par_loop(opensbliblock00Kernel015, "Derivative evaluation CD T_B0 x1 ", opensbliblock00, 2, iteration_range_15_block0,
...
ops_par_loop(opensbliblock00Kernel024, "Convective terms", opensbliblock00, 2, iteration_range_24_block0,
...
ops_par_loop(opensbliblock00Kernel025, "Viscous terms", opensbliblock00, 2, iteration_range_25_block0,
...
ops_par_loop(opensbliblock00Kernel031, "Temporal solution advancement", opensbliblock00, 2, iteration_range_31_block0,
...
int iteration_range_3_block0[] = {-5, block0np0 + 5, -5, block0np1 + 5};
ops_par_loop(opensbliblock00Kernel003, "User kernel: Zero the work arrays", opensbliblock00, 2, iteration_range_3_block0,
ops_arg_dat(Residual0_B0, 1, stencil_0_00_00_2, "double", OPS_WRITE),
ops_arg_dat(Residual1_B0, 1, stencil_0_00_00_2, "double", OPS_WRITE),
ops_arg_dat(Residual2_B0, 1, stencil_0_00_00_2, "double", OPS_WRITE),
ops_arg_dat(Residual3_B0, 1, stencil_0_00_00_2, "double", OPS_WRITE),
...
int iteration_range_4_block0[] = {-1, block0np0 + 1, 0, block0np1};
ops_par_loop(opensbliblock00Kernel004, "User kernel: WENO reconstruction direction 0", opensbliblock00, 2, iteration_range_4_block0,
...
int iteration_range_5_block0[] = {0, block0np0, -1, block0np1 + 1};
ops_par_loop(opensbliblock00Kernel005, "User kernel: WENO reconstruction direction 1", opensbliblock00, 2, iteration_range_5_block0,
...
ops_par_loop(opensbliblock00Kernel006, "User kernel: Non-linear filter application", opensbliblock00, 2, iteration_range_6_block0,
