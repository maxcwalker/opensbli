...
//user function
inline 
 void opensbliblock00Kernel024(const ptr_double Residual0_B0,
...
void opensbliblock00Kernel024_c_wrapper(
  ...
  for ( int n_y=0; n_y<y_size; n_y++ ){
    ...
    for ( int n_x=0; n_x<x_size; n_x++ ){
      ...
      ptr_double ptr4 = {  p_a4 + n_x*1*1 + n_y*xdim4_opensbliblock00Kernel024*1*1, xdim4_opensbliblock00Kernel024};
      ptr_double ptr5 = {  p_a5 + n_x*1*1 + n_y*xdim5_opensbliblock00Kernel024*1*1, xdim5_opensbliblock00Kernel024};
      ptr_double ptr6 = {  p_a6 + n_x*1*1 + n_y*xdim6_opensbliblock00Kernel024*1*1, xdim6_opensbliblock00Kernel024};
      ...
      ptr_double ptr10 = {  p_a10 + n_x*1*1 + n_y*xdim10_opensbliblock00Kernel024*1*1, xdim10_opensbliblock00Kernel024};
