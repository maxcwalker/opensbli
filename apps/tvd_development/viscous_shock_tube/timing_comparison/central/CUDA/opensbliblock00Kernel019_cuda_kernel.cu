...
//
__constant__ int dims_opensbliblock00Kernel019 [4][1];
static int dims_opensbliblock00Kernel019_h [4][1] = {{0}};
...
int size1 ){
  ...
  if (idx_x < size0 && idx_y < size1) {
    ACC<double> argp0(dims_opensbliblock00Kernel019[0][0], arg0);
    ACC<double> argp1(dims_opensbliblock00Kernel019[1][0], arg1);
    ACC<double> argp2(dims_opensbliblock00Kernel019[2][0], arg2);
    ACC<double> argp3(dims_opensbliblock00Kernel019[3][0], arg3);
...
void ops_par_loop_opensbliblock00Kernel019_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_opensbliblock00Kernel019_h[0][0] || xdim1 != dims_opensbliblock00Kernel019_h[1][0] || xdim2 != dims_opensbliblock00Kernel019_h[2][0] || xdim3 != dims_opensbliblock00Kernel019_h[3][0]) {
...
void ops_par_loop_opensbliblock00Kernel019(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2, ops_arg arg3) {
  ...
  create_kerneldesc_and_enque(name, args, 4, 1, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel019_execute);
}
#endif
