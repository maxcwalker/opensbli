...
//
__constant__ int dims_opensbliblock00Kernel018 [14][1];
static int dims_opensbliblock00Kernel018_h [14][1] = {{0}};

//user function
__device__

 void opensbliblock00Kernel018_gpu(const ACC<double> &T_B0,
...
int size1 ){
  ...
  arg0 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel018[0][0];
  arg1 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel018[1][0];
  arg2 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel018[2][0];
  arg3 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel018[3][0];
  arg4 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel018[4][0];
  arg5 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel018[5][0];
  arg6 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel018[6][0];
  arg7 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel018[7][0];
  arg8 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel018[8][0];
  arg9 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel018[9][0];
  arg10 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel018[10][0];
  arg11 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel018[11][0];
  arg12 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel018[12][0];

  if (idx_x < size0 && idx_y < size1) {
    const ACC<double> argp0(dims_opensbliblock00Kernel018[0][0], arg0);
    const ACC<double> argp1(dims_opensbliblock00Kernel018[1][0], arg1);
    const ACC<double> argp2(dims_opensbliblock00Kernel018[2][0], arg2);
    const ACC<double> argp3(dims_opensbliblock00Kernel018[3][0], arg3);
    const ACC<double> argp4(dims_opensbliblock00Kernel018[4][0], arg4);
    const ACC<double> argp5(dims_opensbliblock00Kernel018[5][0], arg5);
    const ACC<double> argp6(dims_opensbliblock00Kernel018[6][0], arg6);
    const ACC<double> argp7(dims_opensbliblock00Kernel018[7][0], arg7);
    const ACC<double> argp8(dims_opensbliblock00Kernel018[8][0], arg8);
    const ACC<double> argp9(dims_opensbliblock00Kernel018[9][0], arg9);
    ACC<double> argp10(dims_opensbliblock00Kernel018[10][0], arg10);
    ACC<double> argp11(dims_opensbliblock00Kernel018[11][0], arg11);
    ACC<double> argp12(dims_opensbliblock00Kernel018[12][0], arg12);
    opensbliblock00Kernel018_gpu(
     argp0, argp1, argp2, argp3, argp4,
     argp5, argp6, argp7, argp8, argp9,
     argp10, argp11, argp12, arg_idx);
  }
...
void ops_par_loop_opensbliblock00Kernel018_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_opensbliblock00Kernel018_h[0][0] || xdim1 != dims_opensbliblock00Kernel018_h[1][0] || xdim2 != dims_opensbliblock00Kernel018_h[2][0] || xdim3 != dims_opensbliblock00Kernel018_h[3][0] || xdim4 != dims_opensbliblock00Kernel018_h[4][0] || xdim5 != dims_opensbliblock00Kernel018_h[5][0] || xdim6 != dims_opensbliblock00Kernel018_h[6][0] || xdim7 != dims_opensbliblock00Kernel018_h[7][0] || xdim8 != dims_opensbliblock00Kernel018_h[8][0] || xdim9 != dims_opensbliblock00Kernel018_h[9][0] || xdim10 != dims_opensbliblock00Kernel018_h[10][0] || xdim11 != dims_opensbliblock00Kernel018_h[11][0] || xdim12 != dims_opensbliblock00Kernel018_h[12][0]) {
    ...
    dims_opensbliblock00Kernel018_h[5][0] = xdim5;
    dims_opensbliblock00Kernel018_h[6][0] = xdim6;
    dims_opensbliblock00Kernel018_h[7][0] = xdim7;
    dims_opensbliblock00Kernel018_h[8][0] = xdim8;
    dims_opensbliblock00Kernel018_h[9][0] = xdim9;
    dims_opensbliblock00Kernel018_h[10][0] = xdim10;
    dims_opensbliblock00Kernel018_h[11][0] = xdim11;
    dims_opensbliblock00Kernel018_h[12][0] = xdim12;
  ...
  if (x_size > 0 && y_size > 0)
    ops_opensbliblock00Kernel018<<<grid, tblock >>> ( 
     ...
     (double *)p_a[12], arg_idx[0], arg_idx[1],
    x_size, y_size);
...
void ops_par_loop_opensbliblock00Kernel018(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg12, ops_arg arg13) {
  ...
  create_kerneldesc_and_enque(name, args, 14, 16, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel018_execute);
}
#endif
