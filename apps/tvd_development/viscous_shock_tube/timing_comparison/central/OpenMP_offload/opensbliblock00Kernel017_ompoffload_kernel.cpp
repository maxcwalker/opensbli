...
void ops_par_loop_opensbliblock00Kernel017_execute(ops_kernel_descriptor *desc) {
  ...
  for ( int n_y=start1; n_y<end1; n_y++ ){
    for ( int n_x=start0; n_x<end0; n_x++ ){
      ...
      const ACC<double> H_B0(xdim0_opensbliblock00Kernel017, H_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel017*1);
      const ACC<double> p_B0(xdim1_opensbliblock00Kernel017, p_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel017*1);
      const ACC<double> rho_B0(xdim2_opensbliblock00Kernel017, rho_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel017*1);
      const ACC<double> rhou0_B0(xdim3_opensbliblock00Kernel017, rhou0_B0_p + n_x*1 + n_y * xdim3_opensbliblock00Kernel017*1);
      const ACC<double> rhou1_B0(xdim4_opensbliblock00Kernel017, rhou1_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel017*1);
      const ACC<double> u0_B0(xdim5_opensbliblock00Kernel017, u0_B0_p + n_x*1 + n_y * xdim5_opensbliblock00Kernel017*1);
      const ACC<double> u1_B0(xdim6_opensbliblock00Kernel017, u1_B0_p + n_x*1 + n_y * xdim6_opensbliblock00Kernel017*1);
      const ACC<double> wk0_B0(xdim7_opensbliblock00Kernel017, wk0_B0_p + n_x*1 + n_y * xdim7_opensbliblock00Kernel017*1);
      const ACC<double> wk1_B0(xdim8_opensbliblock00Kernel017, wk1_B0_p + n_x*1 + n_y * xdim8_opensbliblock00Kernel017*1);
      const ACC<double> wk3_B0(xdim9_opensbliblock00Kernel017, wk3_B0_p + n_x*1 + n_y * xdim9_opensbliblock00Kernel017*1);
      const ACC<double> wk4_B0(xdim10_opensbliblock00Kernel017, wk4_B0_p + n_x*1 + n_y * xdim10_opensbliblock00Kernel017*1);
      ...
      ACC<double> Residual2_B0(xdim13_opensbliblock00Kernel017, Residual2_B0_p + n_x*1 + n_y * xdim13_opensbliblock00Kernel017*1);
      ACC<double> Residual3_B0(xdim14_opensbliblock00Kernel017, Residual3_B0_p + n_x*1 + n_y * xdim14_opensbliblock00Kernel017*1);
...
void ops_par_loop_opensbliblock00Kernel017(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg12, ops_arg arg13, ops_arg arg14, ops_arg arg15) {
  ...
  create_kerneldesc_and_enque(name, args, 16, 15, dim, 0, range, block, ops_par_loop_opensbliblock00Kernel017_execute);
}
#endif
