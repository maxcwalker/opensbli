...
void ops_par_loop_opensbliblock00Kernel017_execute(ops_kernel_descriptor *desc) {
 ...
 arg15};
  ...
  int xdim5_opensbliblock00Kernel017 = args[5].dat->size[0];
  int xdim6_opensbliblock00Kernel017 = args[6].dat->size[0];
  int xdim7_opensbliblock00Kernel017 = args[7].dat->size[0];
  int xdim8_opensbliblock00Kernel017 = args[8].dat->size[0];
  int xdim9_opensbliblock00Kernel017 = args[9].dat->size[0];
  int xdim10_opensbliblock00Kernel017 = args[10].dat->size[0];
  int xdim11_opensbliblock00Kernel017 = args[11].dat->size[0];
  int xdim12_opensbliblock00Kernel017 = args[12].dat->size[0];
  int xdim13_opensbliblock00Kernel017 = args[13].dat->size[0];
  int xdim14_opensbliblock00Kernel017 = args[14].dat->size[0];
  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      cgh.parallel_for<class opensbliblock00Kernel017_kernel>(cl::sycl::nd_range<2>(cl::sycl::range<2>(
      ...
      , [=](cl::sycl::nd_item<2> item
        ...
        const ACC<double> H_B0(xdim0_opensbliblock00Kernel017, &H_B0_p[0] + base0 + n_x*1 + n_y * xdim0_opensbliblock00Kernel017*1);
        const ACC<double> p_B0(xdim1_opensbliblock00Kernel017, &p_B0_p[0] + base1 + n_x*1 + n_y * xdim1_opensbliblock00Kernel017*1);
        const ACC<double> rho_B0(xdim2_opensbliblock00Kernel017, &rho_B0_p[0] + base2 + n_x*1 + n_y * xdim2_opensbliblock00Kernel017*1);
        const ACC<double> rhou0_B0(xdim3_opensbliblock00Kernel017, &rhou0_B0_p[0] + base3 + n_x*1 + n_y * xdim3_opensbliblock00Kernel017*1);
        const ACC<double> rhou1_B0(xdim4_opensbliblock00Kernel017, &rhou1_B0_p[0] + base4 + n_x*1 + n_y * xdim4_opensbliblock00Kernel017*1);
        const ACC<double> u0_B0(xdim5_opensbliblock00Kernel017, &u0_B0_p[0] + base5 + n_x*1 + n_y * xdim5_opensbliblock00Kernel017*1);
        const ACC<double> u1_B0(xdim6_opensbliblock00Kernel017, &u1_B0_p[0] + base6 + n_x*1 + n_y * xdim6_opensbliblock00Kernel017*1);
        const ACC<double> wk0_B0(xdim7_opensbliblock00Kernel017, &wk0_B0_p[0] + base7 + n_x*1 + n_y * xdim7_opensbliblock00Kernel017*1);
        const ACC<double> wk1_B0(xdim8_opensbliblock00Kernel017, &wk1_B0_p[0] + base8 + n_x*1 + n_y * xdim8_opensbliblock00Kernel017*1);
        const ACC<double> wk3_B0(xdim9_opensbliblock00Kernel017, &wk3_B0_p[0] + base9 + n_x*1 + n_y * xdim9_opensbliblock00Kernel017*1);
        const ACC<double> wk4_B0(xdim10_opensbliblock00Kernel017, &wk4_B0_p[0] + base10 + n_x*1 + n_y * xdim10_opensbliblock00Kernel017*1);
        ACC<double> Residual0_B0(xdim11_opensbliblock00Kernel017, &Residual0_B0_p[0] + base11 + n_x*1 + n_y * xdim11_opensbliblock00Kernel017*1);
        ACC<double> Residual1_B0(xdim12_opensbliblock00Kernel017, &Residual1_B0_p[0] + base12 + n_x*1 + n_y * xdim12_opensbliblock00Kernel017*1);
        ACC<double> Residual2_B0(xdim13_opensbliblock00Kernel017, &Residual2_B0_p[0] + base13 + n_x*1 + n_y * xdim13_opensbliblock00Kernel017*1);
        ACC<double> Residual3_B0(xdim14_opensbliblock00Kernel017, &Residual3_B0_p[0] + base14 + n_x*1 + n_y * xdim14_opensbliblock00Kernel017*1);
        //USER CODE
   ...
   if (idx[0] == 0){
       ...
       d1_H_dx = (-3*H_B0(2,0) + 4*H_B0(1,0) - (25.0/12.0)*H_B0(0,0) - (1.0/4.0)*H_B0(4,0) +
            ((4.0/3.0))*H_B0(3,0))*invDelta0block0_sycl[0];

       d1_Hrho_dx = (-3*H_B0(2,0)*rho_B0(2,0) + 4*H_B0(1,0)*rho_B0(1,0) - (25.0/12.0)*H_B0(0,0)*rho_B0(0,0) -
            (1.0/4.0)*H_B0(4,0)*rho_B0(4,0) + ((4.0/3.0))*H_B0(3,0)*rho_B0(3,0))*invDelta0block0_sycl[0];

       d1_Hrhou0_dx = (-3*H_B0(2,0)*rhou0_B0(2,0) + 4*H_B0(1,0)*rhou0_B0(1,0) - (25.0/12.0)*H_B0(0,0)*rhou0_B0(0,0) -
            (1.0/4.0)*H_B0(4,0)*rhou0_B0(4,0) + ((4.0/3.0))*H_B0(3,0)*rhou0_B0(3,0))*invDelta0block0_sycl[0];

       d1_Hu0_dx = (-3*H_B0(2,0)*u0_B0(2,0) + 4*H_B0(1,0)*u0_B0(1,0) - (25.0/12.0)*H_B0(0,0)*u0_B0(0,0) -
            (1.0/4.0)*H_B0(4,0)*u0_B0(4,0) + ((4.0/3.0))*H_B0(3,0)*u0_B0(3,0))*invDelta0block0_sycl[0];
       ...
       d1_rho_dx = (-3*rho_B0(2,0) + 4*rho_B0(1,0) - (25.0/12.0)*rho_B0(0,0) - (1.0/4.0)*rho_B0(4,0) +
            ((4.0/3.0))*rho_B0(3,0))*invDelta0block0_sycl[0];
       ...
       d1_rhou0u1_dx = (-3*u1_B0(2,0)*rhou0_B0(2,0) + 4*u1_B0(1,0)*rhou0_B0(1,0) - (25.0/12.0)*u1_B0(0,0)*rhou0_B0(0,0)
            - (1.0/4.0)*u1_B0(4,0)*rhou0_B0(4,0) + ((4.0/3.0))*u1_B0(3,0)*rhou0_B0(3,0))*invDelta0block0_sycl[0];

       d1_rhou1_dx = (-3*rhou1_B0(2,0) + 4*rhou1_B0(1,0) - (25.0/12.0)*rhou1_B0(0,0) - (1.0/4.0)*rhou1_B0(4,0) +
            ((4.0/3.0))*rhou1_B0(3,0))*invDelta0block0_sycl[0];

       d1_u0u0_dx = (-3*(u0_B0(2,0)*u0_B0(2,0)) + 4*(u0_B0(1,0)*u0_B0(1,0)) - (25.0/12.0)*(u0_B0(0,0)*u0_B0(0,0)) -
            (1.0/4.0)*(u0_B0(4,0)*u0_B0(4,0)) + ((4.0/3.0))*(u0_B0(3,0)*u0_B0(3,0)))*invDelta0block0_sycl[0];

       d1_u0u1_dx = (-3*u0_B0(2,0)*u1_B0(2,0) + 4*u0_B0(1,0)*u1_B0(1,0) - (25.0/12.0)*u0_B0(0,0)*u1_B0(0,0) -
            (1.0/4.0)*u0_B0(4,0)*u1_B0(4,0) + ((4.0/3.0))*u0_B0(3,0)*u1_B0(3,0))*invDelta0block0_sycl[0];
       ...
       d1_H_dx = (-(5.0/6.0)*H_B0(0,0) - (1.0/2.0)*H_B0(2,0) - (1.0/4.0)*H_B0(-1,0) + ((1.0/12.0))*H_B0(3,0) +
            ((3.0/2.0))*H_B0(1,0))*invDelta0block0_sycl[0];
       ...
       d1_Hrho_dx = (-(5.0/6.0)*H_B0(0,0)*rho_B0(0,0) - (1.0/2.0)*H_B0(2,0)*rho_B0(2,0) -
            ...
            ((3.0/2.0))*H_B0(1,0)*rho_B0(1,0))*invDelta0block0_sycl[0];
       ...
       d1_Hrhou0_dx = (-(5.0/6.0)*H_B0(0,0)*rhou0_B0(0,0) - (1.0/2.0)*H_B0(2,0)*rhou0_B0(2,0) -
            ...
            ((3.0/2.0))*H_B0(1,0)*rhou0_B0(1,0))*invDelta0block0_sycl[0];

       d1_Hu0_dx = (-(5.0/6.0)*H_B0(0,0)*u0_B0(0,0) - (1.0/2.0)*H_B0(2,0)*u0_B0(2,0) - (1.0/4.0)*H_B0(-1,0)*u0_B0(-1,0)
            + ((1.0/12.0))*H_B0(3,0)*u0_B0(3,0) + ((3.0/2.0))*H_B0(1,0)*u0_B0(1,0))*invDelta0block0_sycl[0];
       ...
       d1_rho_dx = (-(5.0/6.0)*rho_B0(0,0) - (1.0/2.0)*rho_B0(2,0) - (1.0/4.0)*rho_B0(-1,0) + ((1.0/12.0))*rho_B0(3,0) +
            ((3.0/2.0))*rho_B0(1,0))*invDelta0block0_sycl[0];
       ...
       d1_rhou0u1_dx = (-(5.0/6.0)*u1_B0(0,0)*rhou0_B0(0,0) - (1.0/2.0)*u1_B0(2,0)*rhou0_B0(2,0) -
            ...
            ((3.0/2.0))*u1_B0(1,0)*rhou0_B0(1,0))*invDelta0block0_sycl[0];

       d1_rhou1_dx = (-(5.0/6.0)*rhou1_B0(0,0) - (1.0/2.0)*rhou1_B0(2,0) - (1.0/4.0)*rhou1_B0(-1,0) +
            ((1.0/12.0))*rhou1_B0(3,0) + ((3.0/2.0))*rhou1_B0(1,0))*invDelta0block0_sycl[0];
       ...
       d1_u0u0_dx = (-(5.0/6.0)*(u0_B0(0,0)*u0_B0(0,0)) - (1.0/2.0)*(u0_B0(2,0)*u0_B0(2,0)) -
            ...
            ((3.0/2.0))*(u0_B0(1,0)*u0_B0(1,0)))*invDelta0block0_sycl[0];
       ...
       d1_u0u1_dx = (-(5.0/6.0)*u0_B0(0,0)*u1_B0(0,0) - (1.0/2.0)*u0_B0(2,0)*u1_B0(2,0) -
            ...
            ((3.0/2.0))*u0_B0(1,0)*u1_B0(1,0))*invDelta0block0_sycl[0];
       ...
       d1_H_dx = (-4*H_B0(-1,0) + 3*H_B0(-2,0) - (4.0/3.0)*H_B0(-3,0) + ((1.0/4.0))*H_B0(-4,0) +
            ((25.0/12.0))*H_B0(0,0))*invDelta0block0_sycl[0];

       d1_Hrho_dx = (-4*H_B0(-1,0)*rho_B0(-1,0) + 3*H_B0(-2,0)*rho_B0(-2,0) - (4.0/3.0)*H_B0(-3,0)*rho_B0(-3,0) +
            ((1.0/4.0))*H_B0(-4,0)*rho_B0(-4,0) + ((25.0/12.0))*H_B0(0,0)*rho_B0(0,0))*invDelta0block0_sycl[0];

       d1_Hrhou0_dx = (-4*H_B0(-1,0)*rhou0_B0(-1,0) + 3*H_B0(-2,0)*rhou0_B0(-2,0) - (4.0/3.0)*H_B0(-3,0)*rhou0_B0(-3,0)
            + ((1.0/4.0))*H_B0(-4,0)*rhou0_B0(-4,0) + ((25.0/12.0))*H_B0(0,0)*rhou0_B0(0,0))*invDelta0block0_sycl[0];

       d1_Hu0_dx = (-4*H_B0(-1,0)*u0_B0(-1,0) + 3*H_B0(-2,0)*u0_B0(-2,0) - (4.0/3.0)*H_B0(-3,0)*u0_B0(-3,0) +
            ((1.0/4.0))*H_B0(-4,0)*u0_B0(-4,0) + ((25.0/12.0))*H_B0(0,0)*u0_B0(0,0))*invDelta0block0_sycl[0];
       ...
       d1_rho_dx = (-4*rho_B0(-1,0) + 3*rho_B0(-2,0) - (4.0/3.0)*rho_B0(-3,0) + ((1.0/4.0))*rho_B0(-4,0) +
            ((25.0/12.0))*rho_B0(0,0))*invDelta0block0_sycl[0];
       ...
       d1_rhou0u1_dx = (-4*u1_B0(-1,0)*rhou0_B0(-1,0) + 3*u1_B0(-2,0)*rhou0_B0(-2,0) -
            ...
            ((25.0/12.0))*u1_B0(0,0)*rhou0_B0(0,0))*invDelta0block0_sycl[0];

       d1_rhou1_dx = (-4*rhou1_B0(-1,0) + 3*rhou1_B0(-2,0) - (4.0/3.0)*rhou1_B0(-3,0) + ((1.0/4.0))*rhou1_B0(-4,0) +
            ((25.0/12.0))*rhou1_B0(0,0))*invDelta0block0_sycl[0];

       d1_u0u0_dx = (-4*(u0_B0(-1,0)*u0_B0(-1,0)) + 3*(u0_B0(-2,0)*u0_B0(-2,0)) - (4.0/3.0)*(u0_B0(-3,0)*u0_B0(-3,0)) +
            ((1.0/4.0))*(u0_B0(-4,0)*u0_B0(-4,0)) + ((25.0/12.0))*(u0_B0(0,0)*u0_B0(0,0)))*invDelta0block0_sycl[0];

       d1_u0u1_dx = (-4*u0_B0(-1,0)*u1_B0(-1,0) + 3*u0_B0(-2,0)*u1_B0(-2,0) - (4.0/3.0)*u0_B0(-3,0)*u1_B0(-3,0) +
            ((1.0/4.0))*u0_B0(-4,0)*u1_B0(-4,0) + ((25.0/12.0))*u0_B0(0,0)*u1_B0(0,0))*invDelta0block0_sycl[0];
       ...
       d1_H_dx = (((1.0/2.0))*H_B0(-2,0) - (3.0/2.0)*H_B0(-1,0) - (1.0/12.0)*H_B0(-3,0) + ((1.0/4.0))*H_B0(1,0) +
            ((5.0/6.0))*H_B0(0,0))*invDelta0block0_sycl[0];
       ...
       d1_Hrho_dx = (((1.0/2.0))*H_B0(-2,0)*rho_B0(-2,0) - (3.0/2.0)*H_B0(-1,0)*rho_B0(-1,0) -
            ...
            ((5.0/6.0))*H_B0(0,0)*rho_B0(0,0))*invDelta0block0_sycl[0];
       ...
       d1_rho_dx = (((1.0/2.0))*rho_B0(-2,0) - (3.0/2.0)*rho_B0(-1,0) - (1.0/12.0)*rho_B0(-3,0) +
            ((1.0/4.0))*rho_B0(1,0) + ((5.0/6.0))*rho_B0(0,0))*invDelta0block0_sycl[0];
       ...
       d1_rhou0u1_dx = (((1.0/2.0))*u1_B0(-2,0)*rhou0_B0(-2,0) - (3.0/2.0)*u1_B0(-1,0)*rhou0_B0(-1,0) -
            ...
            ((5.0/6.0))*u1_B0(0,0)*rhou0_B0(0,0))*invDelta0block0_sycl[0];

       d1_rhou1_dx = (((1.0/2.0))*rhou1_B0(-2,0) - (3.0/2.0)*rhou1_B0(-1,0) - (1.0/12.0)*rhou1_B0(-3,0) +
            ((1.0/4.0))*rhou1_B0(1,0) + ((5.0/6.0))*rhou1_B0(0,0))*invDelta0block0_sycl[0];
       ...
       d1_u0u0_dx = (((1.0/2.0))*(u0_B0(-2,0)*u0_B0(-2,0)) - (3.0/2.0)*(u0_B0(-1,0)*u0_B0(-1,0)) -
            ...
            ((5.0/6.0))*(u0_B0(0,0)*u0_B0(0,0)))*invDelta0block0_sycl[0];
       ...
       d1_u0u1_dx = (((1.0/2.0))*u0_B0(-2,0)*u1_B0(-2,0) - (3.0/2.0)*u0_B0(-1,0)*u1_B0(-1,0) -
            ...
            ((5.0/6.0))*u0_B0(0,0)*u1_B0(0,0))*invDelta0block0_sycl[0];
   ...
   if (idx[1] == 0){
       ...
       d1_H_dy = (-3*H_B0(0,2) + 4*H_B0(0,1) - (25.0/12.0)*H_B0(0,0) - (1.0/4.0)*H_B0(0,4) +
            ((4.0/3.0))*H_B0(0,3))*invDelta1block0_sycl[0];

       d1_Hrho_dy = (-3*H_B0(0,2)*rho_B0(0,2) + 4*H_B0(0,1)*rho_B0(0,1) - (25.0/12.0)*H_B0(0,0)*rho_B0(0,0) -
            (1.0/4.0)*H_B0(0,4)*rho_B0(0,4) + ((4.0/3.0))*H_B0(0,3)*rho_B0(0,3))*invDelta1block0_sycl[0];

       d1_Hrhou1_dy = (-3*H_B0(0,2)*rhou1_B0(0,2) + 4*H_B0(0,1)*rhou1_B0(0,1) - (25.0/12.0)*H_B0(0,0)*rhou1_B0(0,0) -
            (1.0/4.0)*H_B0(0,4)*rhou1_B0(0,4) + ((4.0/3.0))*H_B0(0,3)*rhou1_B0(0,3))*invDelta1block0_sycl[0];

       d1_Hu1_dy = (-3*H_B0(0,2)*u1_B0(0,2) + 4*H_B0(0,1)*u1_B0(0,1) - (25.0/12.0)*H_B0(0,0)*u1_B0(0,0) -
            (1.0/4.0)*H_B0(0,4)*u1_B0(0,4) + ((4.0/3.0))*H_B0(0,3)*u1_B0(0,3))*invDelta1block0_sycl[0];
       ...
       d1_rhou1u0_dy = (-3*u0_B0(0,2)*rhou1_B0(0,2) + 4*u0_B0(0,1)*rhou1_B0(0,1) - (25.0/12.0)*u0_B0(0,0)*rhou1_B0(0,0)
            - (1.0/4.0)*u0_B0(0,4)*rhou1_B0(0,4) + ((4.0/3.0))*u0_B0(0,3)*rhou1_B0(0,3))*invDelta1block0_sycl[0];
       ...
       d1_u0u1_dy = (-3*u0_B0(0,2)*u1_B0(0,2) + 4*u0_B0(0,1)*u1_B0(0,1) - (25.0/12.0)*u0_B0(0,0)*u1_B0(0,0) -
            (1.0/4.0)*u0_B0(0,4)*u1_B0(0,4) + ((4.0/3.0))*u0_B0(0,3)*u1_B0(0,3))*invDelta1block0_sycl[0];

       d1_u1u1_dy = (-3*(u1_B0(0,2)*u1_B0(0,2)) + 4*(u1_B0(0,1)*u1_B0(0,1)) - (25.0/12.0)*(u1_B0(0,0)*u1_B0(0,0)) -
            (1.0/4.0)*(u1_B0(0,4)*u1_B0(0,4)) + ((4.0/3.0))*(u1_B0(0,3)*u1_B0(0,3)))*invDelta1block0_sycl[0];
       ...
       d1_H_dy = (-(5.0/6.0)*H_B0(0,0) - (1.0/2.0)*H_B0(0,2) - (1.0/4.0)*H_B0(0,-1) + ((1.0/12.0))*H_B0(0,3) +
            ((3.0/2.0))*H_B0(0,1))*invDelta1block0_sycl[0];
       ...
       d1_Hrho_dy = (-(5.0/6.0)*H_B0(0,0)*rho_B0(0,0) - (1.0/2.0)*H_B0(0,2)*rho_B0(0,2) -
            ...
            ((3.0/2.0))*H_B0(0,1)*rho_B0(0,1))*invDelta1block0_sycl[0];
       ...
       d1_Hrhou1_dy = (-(5.0/6.0)*H_B0(0,0)*rhou1_B0(0,0) - (1.0/2.0)*H_B0(0,2)*rhou1_B0(0,2) -
            ...
            ((3.0/2.0))*H_B0(0,1)*rhou1_B0(0,1))*invDelta1block0_sycl[0];

       d1_Hu1_dy = (-(5.0/6.0)*H_B0(0,0)*u1_B0(0,0) - (1.0/2.0)*H_B0(0,2)*u1_B0(0,2) - (1.0/4.0)*H_B0(0,-1)*u1_B0(0,-1)
            + ((1.0/12.0))*H_B0(0,3)*u1_B0(0,3) + ((3.0/2.0))*H_B0(0,1)*u1_B0(0,1))*invDelta1block0_sycl[0];
       ...
       d1_rho_dy = (-(5.0/6.0)*rho_B0(0,0) - (1.0/2.0)*rho_B0(0,2) - (1.0/4.0)*rho_B0(0,-1) + ((1.0/12.0))*rho_B0(0,3) +
            ((3.0/2.0))*rho_B0(0,1))*invDelta1block0_sycl[0];

       d1_rhou0_dy = (-(5.0/6.0)*rhou0_B0(0,0) - (1.0/2.0)*rhou0_B0(0,2) - (1.0/4.0)*rhou0_B0(0,-1) +
            ((1.0/12.0))*rhou0_B0(0,3) + ((3.0/2.0))*rhou0_B0(0,1))*invDelta1block0_sycl[0];
       ...
       d1_rhou1u0_dy = (-(5.0/6.0)*u0_B0(0,0)*rhou1_B0(0,0) - (1.0/2.0)*u0_B0(0,2)*rhou1_B0(0,2) -
            ...
            ((3.0/2.0))*u0_B0(0,1)*rhou1_B0(0,1))*invDelta1block0_sycl[0];
       ...
       d1_u0u1_dy = (-(5.0/6.0)*u0_B0(0,0)*u1_B0(0,0) - (1.0/2.0)*u0_B0(0,2)*u1_B0(0,2) -
            ...
            ((3.0/2.0))*u0_B0(0,1)*u1_B0(0,1))*invDelta1block0_sycl[0];
       ...
       d1_u1u1_dy = (-(5.0/6.0)*(u1_B0(0,0)*u1_B0(0,0)) - (1.0/2.0)*(u1_B0(0,2)*u1_B0(0,2)) -
            ...
            ((3.0/2.0))*(u1_B0(0,1)*u1_B0(0,1)))*invDelta1block0_sycl[0];
