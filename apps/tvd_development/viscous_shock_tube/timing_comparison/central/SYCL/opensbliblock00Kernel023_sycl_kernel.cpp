  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      , [=](cl::sycl::nd_item<2> item
        ...
        ACC<double> rhoE_B0(xdim0_opensbliblock00Kernel023, &rhoE_B0_p[0] + base0 + n_x*1 + n_y * xdim0_opensbliblock00Kernel023*1);
        ACC<double> rho_B0(xdim1_opensbliblock00Kernel023, &rho_B0_p[0] + base1 + n_x*1 + n_y * xdim1_opensbliblock00Kernel023*1);
        ACC<double> rhou0_B0(xdim2_opensbliblock00Kernel023, &rhou0_B0_p[0] + base2 + n_x*1 + n_y * xdim2_opensbliblock00Kernel023*1);
        ACC<double> rhou1_B0(xdim3_opensbliblock00Kernel023, &rhou1_B0_p[0] + base3 + n_x*1 + n_y * xdim3_opensbliblock00Kernel023*1);
        ACC<double> x0_B0(xdim4_opensbliblock00Kernel023, &x0_B0_p[0] + base4 + n_x*1 + n_y * xdim4_opensbliblock00Kernel023*1);
        ACC<double> x1_B0(xdim5_opensbliblock00Kernel023, &x1_B0_p[0] + base5 + n_x*1 + n_y * xdim5_opensbliblock00Kernel023*1);
        //USER CODE
   ...
   double u1 = 0.0;
   double x_grid = 0.0;
   x_grid = Delta0block0_sycl[0]*idx[0];

   x0_B0(0,0) = x_grid;

   x1_B0(0,0) = Delta1block0_sycl[0]*idx[1];
...
: (
   ...
   rhoE_B0(0,0) = p/(-1.0 + gama_sycl[0]) + 0.5*((u0*u0) + (u1*u1))*rho;
