...
void ops_par_loop_opensbliblock00Kernel012_execute(ops_kernel_descriptor *desc) {
  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      cgh.parallel_for<class opensbliblock00Kernel012_kernel>(cl::sycl::nd_range<2>(cl::sycl::range<2>(
      ...
      , [=](cl::sycl::nd_item<2> item
        ...
        const ACC<double> rhoE_B0(xdim0_opensbliblock00Kernel012, &rhoE_B0_p[0] + base0 + n_x*1 + n_y * xdim0_opensbliblock00Kernel012*1);
        const ACC<double> rho_B0(xdim1_opensbliblock00Kernel012, &rho_B0_p[0] + base1 + n_x*1 + n_y * xdim1_opensbliblock00Kernel012*1);
        const ACC<double> u0_B0(xdim2_opensbliblock00Kernel012, &u0_B0_p[0] + base2 + n_x*1 + n_y * xdim2_opensbliblock00Kernel012*1);
        const ACC<double> u1_B0(xdim3_opensbliblock00Kernel012, &u1_B0_p[0] + base3 + n_x*1 + n_y * xdim3_opensbliblock00Kernel012*1);
        ACC<double> p_B0(xdim4_opensbliblock00Kernel012, &p_B0_p[0] + base4 + n_x*1 + n_y * xdim4_opensbliblock00Kernel012*1);
        //USER CODE
