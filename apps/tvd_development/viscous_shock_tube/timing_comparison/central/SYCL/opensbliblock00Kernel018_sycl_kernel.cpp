...
void ops_par_loop_opensbliblock00Kernel018_execute(ops_kernel_descriptor *desc) {
 ...
 arg10, arg11, arg12, arg13};
  ...
  int xdim5_opensbliblock00Kernel018 = args[5].dat->size[0];
  int xdim6_opensbliblock00Kernel018 = args[6].dat->size[0];
  int xdim7_opensbliblock00Kernel018 = args[7].dat->size[0];
  int xdim8_opensbliblock00Kernel018 = args[8].dat->size[0];
  int xdim9_opensbliblock00Kernel018 = args[9].dat->size[0];
  int xdim10_opensbliblock00Kernel018 = args[10].dat->size[0];
  int xdim11_opensbliblock00Kernel018 = args[11].dat->size[0];
  int xdim12_opensbliblock00Kernel018 = args[12].dat->size[0];
  ...
  double* wk4_B0_p = (double*)args[8].data_d;

  int base9 = args[9].dat->base_offset/sizeof(double);
  double* wk5_B0_p = (double*)args[9].data_d;
  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      cgh.parallel_for<class opensbliblock00Kernel018_kernel>(cl::sycl::nd_range<2>(cl::sycl::range<2>(
      ...
      , [=](cl::sycl::nd_item<2> item
        ...
        const ACC<double> T_B0(xdim0_opensbliblock00Kernel018, &T_B0_p[0] + base0 + n_x*1 + n_y * xdim0_opensbliblock00Kernel018*1);
        const ACC<double> mu_B0(xdim1_opensbliblock00Kernel018, &mu_B0_p[0] + base1 + n_x*1 + n_y * xdim1_opensbliblock00Kernel018*1);
        const ACC<double> u0_B0(xdim2_opensbliblock00Kernel018, &u0_B0_p[0] + base2 + n_x*1 + n_y * xdim2_opensbliblock00Kernel018*1);
        const ACC<double> u1_B0(xdim3_opensbliblock00Kernel018, &u1_B0_p[0] + base3 + n_x*1 + n_y * xdim3_opensbliblock00Kernel018*1);
        const ACC<double> wk0_B0(xdim4_opensbliblock00Kernel018, &wk0_B0_p[0] + base4 + n_x*1 + n_y * xdim4_opensbliblock00Kernel018*1);
        const ACC<double> wk1_B0(xdim5_opensbliblock00Kernel018, &wk1_B0_p[0] + base5 + n_x*1 + n_y * xdim5_opensbliblock00Kernel018*1);
        const ACC<double> wk2_B0(xdim6_opensbliblock00Kernel018, &wk2_B0_p[0] + base6 + n_x*1 + n_y * xdim6_opensbliblock00Kernel018*1);
        const ACC<double> wk3_B0(xdim7_opensbliblock00Kernel018, &wk3_B0_p[0] + base7 + n_x*1 + n_y * xdim7_opensbliblock00Kernel018*1);
        const ACC<double> wk4_B0(xdim8_opensbliblock00Kernel018, &wk4_B0_p[0] + base8 + n_x*1 + n_y * xdim8_opensbliblock00Kernel018*1);
        const ACC<double> wk5_B0(xdim9_opensbliblock00Kernel018, &wk5_B0_p[0] + base9 + n_x*1 + n_y * xdim9_opensbliblock00Kernel018*1);
        ACC<double> Residual1_B0(xdim10_opensbliblock00Kernel018, &Residual1_B0_p[0] + base10 + n_x*1 + n_y * xdim10_opensbliblock00Kernel018*1);
        ACC<double> Residual2_B0(xdim11_opensbliblock00Kernel018, &Residual2_B0_p[0] + base11 + n_x*1 + n_y * xdim11_opensbliblock00Kernel018*1);
        ACC<double> Residual3_B0(xdim12_opensbliblock00Kernel018, &Residual3_B0_p[0] + base12 + n_x*1 + n_y * xdim12_opensbliblock00Kernel018*1);
        //USER CODE
   ...
   if (idx[1] == 0){
    ...
    Residual1_B0(0,0) = (wk1_B0(0,0) + wk3_B0(0,0))*invRe_sycl[0]*d1_mu_dy + ((1.0/3.0))*(3*d2_u0_dy + 4*d2_u0_dx +
      d1_wk1_dy)*invRe_sycl[0]*mu_B0(0,0) + ((2.0/3.0))*(-wk4_B0(0,0) + 2*wk0_B0(0,0))*invRe_sycl[0]*d1_mu_dx + Residual1_B0(0,0);

    Residual2_B0(0,0) = (wk1_B0(0,0) + wk3_B0(0,0))*invRe_sycl[0]*d1_mu_dx - (2.0/3.0)*(-2*wk4_B0(0,0) +
      wk0_B0(0,0))*invRe_sycl[0]*d1_mu_dy + ((1.0/3.0))*(3*d2_u1_dx + 4*d2_u1_dy + d1_wk0_dy)*invRe_sycl[0]*mu_B0(0,0) +
      Residual2_B0(0,0);

    Residual3_B0(0,0) = (wk1_B0(0,0) + wk3_B0(0,0))*invRe_sycl[0]*mu_B0(0,0)*wk1_B0(0,0) + (wk1_B0(0,0) +
      wk3_B0(0,0))*invRe_sycl[0]*mu_B0(0,0)*wk3_B0(0,0) + (wk1_B0(0,0) + wk3_B0(0,0))*invRe_sycl[0]*u0_B0(0,0)*d1_mu_dy + (wk1_B0(0,0) +
      wk3_B0(0,0))*invRe_sycl[0]*u1_B0(0,0)*d1_mu_dx - (2.0/3.0)*(-2*wk4_B0(0,0) + wk0_B0(0,0))*invRe_sycl[0]*mu_B0(0,0)*wk4_B0(0,0) -
      (2.0/3.0)*(-2*wk4_B0(0,0) + wk0_B0(0,0))*invRe_sycl[0]*u1_B0(0,0)*d1_mu_dy + ((1.0/3.0))*(3*d2_u0_dy + 4*d2_u0_dx +
      d1_wk1_dy)*invRe_sycl[0]*mu_B0(0,0)*u0_B0(0,0) + ((1.0/3.0))*(3*d2_u1_dx + 4*d2_u1_dy +
      d1_wk0_dy)*invRe_sycl[0]*mu_B0(0,0)*u1_B0(0,0) + ((2.0/3.0))*(-wk4_B0(0,0) + 2*wk0_B0(0,0))*invRe_sycl[0]*mu_B0(0,0)*wk0_B0(0,0) +
      ((2.0/3.0))*(-wk4_B0(0,0) + 2*wk0_B0(0,0))*invRe_sycl[0]*u0_B0(0,0)*d1_mu_dx + (d2_T_dx +
      d2_T_dy)*invPr_sycl[0]*invRe_sycl[0]*inv2Minf_sycl[0]*inv_gamma_m1_sycl[0]*mu_B0(0,0) + invPr_sycl[0]*invRe_sycl[0]*inv2Minf_sycl[0]*inv_gamma_m1_sycl[0]*wk2_B0(0,0)*d1_mu_dx +
      invPr_sycl[0]*invRe_sycl[0]*inv2Minf_sycl[0]*inv_gamma_m1_sycl[0]*wk5_B0(0,0)*d1_mu_dy + Residual3_B0(0,0);
...
void ops_par_loop_opensbliblock00Kernel018(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg12, ops_arg arg13) {
  ...
  desc->args[13] = arg13;
  desc->function = ops_par_loop_opensbliblock00Kernel018_execute;
  if (block->instance->OPS_diags > 1) {
    ops_timing_realloc(block->instance,16,"opensbliblock00Kernel018");
  }
