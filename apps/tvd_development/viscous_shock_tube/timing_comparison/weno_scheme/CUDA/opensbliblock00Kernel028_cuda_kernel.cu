...
//
__constant__ int dims_opensbliblock00Kernel028 [4][1];
static int dims_opensbliblock00Kernel028_h [4][1] = {{0}};
...
void ops_par_loop_opensbliblock00Kernel028(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2, ops_arg arg3) {
  ...
  create_kerneldesc_and_enque(name, args, 4, 3, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel028_execute);
}
#endif
