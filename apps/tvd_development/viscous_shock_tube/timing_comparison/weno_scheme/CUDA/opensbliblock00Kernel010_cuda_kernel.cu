...
//
__constant__ int dims_opensbliblock00Kernel010 [12][1];
static int dims_opensbliblock00Kernel010_h [12][1] = {{0}};

//user function
__device__

 void opensbliblock00Kernel010_gpu(const ACC<double> &wk0_B0,
...
int size1 ){
  ...
  if (idx_x < size0 && idx_y < size1) {
    ...
    ACC<double> argp8(dims_opensbliblock00Kernel010[8][0], arg8);
...
void ops_par_loop_opensbliblock00Kernel010(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg8, ops_arg arg9, ops_arg arg10, ops_arg arg11) {
  ...
  create_kerneldesc_and_enque(name, args, 12, 12, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel010_execute);
}
#endif
