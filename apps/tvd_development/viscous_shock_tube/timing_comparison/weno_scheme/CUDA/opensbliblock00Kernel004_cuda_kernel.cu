...
//
__constant__ int dims_opensbliblock00Kernel004 [5][1];
static int dims_opensbliblock00Kernel004_h [5][1] = {{0}};

//user function
__device__

 void opensbliblock00Kernel004_gpu(const ACC<double> &rhoE_B0,
...
int size1 ){
  ...
  if (idx_x < size0 && idx_y < size1) {
    ...
    ACC<double> argp4(dims_opensbliblock00Kernel004[4][0], arg4);
...
void ops_par_loop_opensbliblock00Kernel004_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_opensbliblock00Kernel004_h[0][0] || xdim1 != dims_opensbliblock00Kernel004_h[1][0] || xdim2 != dims_opensbliblock00Kernel004_h[2][0] || xdim3 != dims_opensbliblock00Kernel004_h[3][0] || xdim4 != dims_opensbliblock00Kernel004_h[4][0]) {
...
void ops_par_loop_opensbliblock00Kernel004(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4) {
  ...
  create_kerneldesc_and_enque(name, args, 5, 7, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel004_execute);
}
#endif
