...
//
__constant__ int dims_opensbliblock00Kernel024 [11][1];
static int dims_opensbliblock00Kernel024_h [11][1] = {{0}};

//user function
__device__

 void opensbliblock00Kernel024_gpu(const ACC<double> &T_B0,
...
void ops_par_loop_opensbliblock00Kernel024(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg8, ops_arg arg9, ops_arg arg10) {
  ...
  create_kerneldesc_and_enque(name, args, 11, 19, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel024_execute);
}
#endif
