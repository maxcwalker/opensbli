...
void ops_par_loop_opensbliblock00Kernel001_execute(ops_kernel_descriptor *desc) {
  ...
  double * __restrict__ wk6_B0_p = (double *)(args[10].data + base10);
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
      ...
      const ACC<double> rhoE_B0(xdim2_opensbliblock00Kernel001, rhoE_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel001*1);
      const ACC<double> rho_B0(xdim3_opensbliblock00Kernel001, rho_B0_p + n_x*1 + n_y * xdim3_opensbliblock00Kernel001*1);
      const ACC<double> rhou0_B0(xdim4_opensbliblock00Kernel001, rhou0_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel001*1);
      const ACC<double> rhou1_B0(xdim5_opensbliblock00Kernel001, rhou1_B0_p + n_x*1 + n_y * xdim5_opensbliblock00Kernel001*1);
      ...
      ACC<double> wk4_B0(xdim8_opensbliblock00Kernel001, wk4_B0_p + n_x*1 + n_y * xdim8_opensbliblock00Kernel001*1);
      ACC<double> wk5_B0(xdim9_opensbliblock00Kernel001, wk5_B0_p + n_x*1 + n_y * xdim9_opensbliblock00Kernel001*1);
      ACC<double> wk6_B0(xdim10_opensbliblock00Kernel001, wk6_B0_p + n_x*1 + n_y * xdim10_opensbliblock00Kernel001*1);
      ACC<double> wk7_B0(xdim11_opensbliblock00Kernel001, wk7_B0_p + n_x*1 + n_y * xdim11_opensbliblock00Kernel001*1);
...
void ops_par_loop_opensbliblock00Kernel001(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg8, ops_arg arg9, ops_arg arg10, ops_arg arg11) {
  ...
  create_kerneldesc_and_enque(name, args, 12, 11, dim, 0, range, block, ops_par_loop_opensbliblock00Kernel001_execute);
}
#endif
