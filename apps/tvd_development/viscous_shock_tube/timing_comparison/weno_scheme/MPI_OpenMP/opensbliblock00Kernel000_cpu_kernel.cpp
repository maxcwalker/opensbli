...
void ops_par_loop_opensbliblock00Kernel000_execute(ops_kernel_descriptor *desc) {
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
      ...
      const ACC<double> u1_B0(xdim7_opensbliblock00Kernel000, u1_B0_p + n_x*1 + n_y * xdim7_opensbliblock00Kernel000*1);
      ACC<double> wk0_B0(xdim8_opensbliblock00Kernel000, wk0_B0_p + n_x*1 + n_y * xdim8_opensbliblock00Kernel000*1);
      ACC<double> wk1_B0(xdim9_opensbliblock00Kernel000, wk1_B0_p + n_x*1 + n_y * xdim9_opensbliblock00Kernel000*1);
      ACC<double> wk2_B0(xdim10_opensbliblock00Kernel000, wk2_B0_p + n_x*1 + n_y * xdim10_opensbliblock00Kernel000*1);
      ACC<double> wk3_B0(xdim11_opensbliblock00Kernel000, wk3_B0_p + n_x*1 + n_y * xdim11_opensbliblock00Kernel000*1);
...
void ops_par_loop_opensbliblock00Kernel000(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg8, ops_arg arg9, ops_arg arg10, ops_arg arg11) {
  ...
  create_kerneldesc_and_enque(name, args, 12, 10, dim, 0, range, block, ops_par_loop_opensbliblock00Kernel000_execute);
}
#endif
