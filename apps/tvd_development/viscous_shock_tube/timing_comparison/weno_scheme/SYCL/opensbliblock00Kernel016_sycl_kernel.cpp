  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      , [=](cl::sycl::nd_item<2> item
        ...
        const ACC<double> u2_B0(xdim0_opensbliblock00Kernel016, &u2_B0_p[0] + base0 + n_x*1 + n_y * xdim0_opensbliblock00Kernel016*1);
        ACC<double> wk2_B0(xdim1_opensbliblock00Kernel016, &wk2_B0_p[0] + base1 + n_x*1 + n_y * xdim1_opensbliblock00Kernel016*1);
        //USER CODE
   ...
   if (idx[0] == 0){
       ...
       wk2_B0(0,0) = (-3*u2_B0(2,0) + 4*u2_B0(1,0) - (25.0/12.0)*u2_B0(0,0) - (1.0/4.0)*u2_B0(4,0) +
            ((4.0/3.0))*u2_B0(3,0))*invDelta0block0_sycl[0];
       ...
       wk2_B0(0,0) = (-(5.0/6.0)*u2_B0(0,0) - (1.0/2.0)*u2_B0(2,0) - (1.0/4.0)*u2_B0(-1,0) + ((1.0/12.0))*u2_B0(3,0) +
            ((3.0/2.0))*u2_B0(1,0))*invDelta0block0_sycl[0];
       ...
       wk2_B0(0,0) = (-4*u2_B0(-1,0) + 3*u2_B0(-2,0) - (4.0/3.0)*u2_B0(-3,0) + ((1.0/4.0))*u2_B0(-4,0) +
            ((25.0/12.0))*u2_B0(0,0))*invDelta0block0_sycl[0];
       ...
       wk2_B0(0,0) = (((1.0/2.0))*u2_B0(-2,0) - (3.0/2.0)*u2_B0(-1,0) - (1.0/12.0)*u2_B0(-3,0) + ((1.0/4.0))*u2_B0(1,0)
            + ((5.0/6.0))*u2_B0(0,0))*invDelta0block0_sycl[0];
       ...
       wk2_B0(0,0) = (-(2.0/3.0)*u2_B0(-1,0) - (1.0/12.0)*u2_B0(2,0) + ((1.0/12.0))*u2_B0(-2,0) +
            ((2.0/3.0))*u2_B0(1,0))*invDelta0block0_sycl[0];
