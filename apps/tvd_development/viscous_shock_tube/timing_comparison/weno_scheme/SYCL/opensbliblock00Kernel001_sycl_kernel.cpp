...
void ops_par_loop_opensbliblock00Kernel001_execute(ops_kernel_descriptor *desc) {
 ...
 arg10, arg11};
  ...
  double* wk6_B0_p = (double*)args[10].data_d;

  int base11 = args[11].dat->base_offset/sizeof(double);
  double* wk7_B0_p = (double*)args[11].data_d;
  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      , [=](cl::sycl::nd_item<2> item
        ...
        const ACC<double> a_B0(xdim0_opensbliblock00Kernel001, &a_B0_p[0] + base0 + n_x*1 + n_y * xdim0_opensbliblock00Kernel001*1);
        const ACC<double> p_B0(xdim1_opensbliblock00Kernel001, &p_B0_p[0] + base1 + n_x*1 + n_y * xdim1_opensbliblock00Kernel001*1);
        const ACC<double> rhoE_B0(xdim2_opensbliblock00Kernel001, &rhoE_B0_p[0] + base2 + n_x*1 + n_y * xdim2_opensbliblock00Kernel001*1);
        const ACC<double> rho_B0(xdim3_opensbliblock00Kernel001, &rho_B0_p[0] + base3 + n_x*1 + n_y * xdim3_opensbliblock00Kernel001*1);
        const ACC<double> rhou0_B0(xdim4_opensbliblock00Kernel001, &rhou0_B0_p[0] + base4 + n_x*1 + n_y * xdim4_opensbliblock00Kernel001*1);
        const ACC<double> rhou1_B0(xdim5_opensbliblock00Kernel001, &rhou1_B0_p[0] + base5 + n_x*1 + n_y * xdim5_opensbliblock00Kernel001*1);
        const ACC<double> u0_B0(xdim6_opensbliblock00Kernel001, &u0_B0_p[0] + base6 + n_x*1 + n_y * xdim6_opensbliblock00Kernel001*1);
        const ACC<double> u1_B0(xdim7_opensbliblock00Kernel001, &u1_B0_p[0] + base7 + n_x*1 + n_y * xdim7_opensbliblock00Kernel001*1);
        ACC<double> wk4_B0(xdim8_opensbliblock00Kernel001, &wk4_B0_p[0] + base8 + n_x*1 + n_y * xdim8_opensbliblock00Kernel001*1);
        ACC<double> wk5_B0(xdim9_opensbliblock00Kernel001, &wk5_B0_p[0] + base9 + n_x*1 + n_y * xdim9_opensbliblock00Kernel001*1);
        ACC<double> wk6_B0(xdim10_opensbliblock00Kernel001, &wk6_B0_p[0] + base10 + n_x*1 + n_y * xdim10_opensbliblock00Kernel001*1);
        ACC<double> wk7_B0(xdim11_opensbliblock00Kernel001, &wk7_B0_p[0] + base11 + n_x*1 + n_y * xdim11_opensbliblock00Kernel001*1);
        //USER CODE
