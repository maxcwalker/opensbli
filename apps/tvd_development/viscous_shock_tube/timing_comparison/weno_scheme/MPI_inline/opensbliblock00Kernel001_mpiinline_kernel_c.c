...
void opensbliblock00Kernel001_c_wrapper(
  ...
  for ( int n_y=0; n_y<y_size; n_y++ ){
    for ( int n_x=0; n_x<x_size; n_x++ ){
      ...
      const ptr_double rhoE_B0 = { rhoE_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel001*1, xdim2_opensbliblock00Kernel001};
      const ptr_double rho_B0 = { rho_B0_p + n_x*1 + n_y * xdim3_opensbliblock00Kernel001*1, xdim3_opensbliblock00Kernel001};
      const ptr_double rhou0_B0 = { rhou0_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel001*1, xdim4_opensbliblock00Kernel001};
      const ptr_double rhou1_B0 = { rhou1_B0_p + n_x*1 + n_y * xdim5_opensbliblock00Kernel001*1, xdim5_opensbliblock00Kernel001};
      ...
      ptr_double wk4_B0 = { wk4_B0_p + n_x*1 + n_y * xdim8_opensbliblock00Kernel001*1, xdim8_opensbliblock00Kernel001};
      ptr_double wk5_B0 = { wk5_B0_p + n_x*1 + n_y * xdim9_opensbliblock00Kernel001*1, xdim9_opensbliblock00Kernel001};
      ptr_double wk6_B0 = { wk6_B0_p + n_x*1 + n_y * xdim10_opensbliblock00Kernel001*1, xdim10_opensbliblock00Kernel001};
      ptr_double wk7_B0 = { wk7_B0_p + n_x*1 + n_y * xdim11_opensbliblock00Kernel001*1, xdim11_opensbliblock00Kernel001};
   ...
   omega_2 = alpha_2*inv_alpha_sum;
    ...
    OPS_ACC(wk5_B0, 0,0) = AVG_1_rho*Recon_1 + AVG_1_u0*Recon_0 + 0.707106781186547*AVG_1_rho*AVG_1_u0*Recon_2*inv_AVG_a +
      0.707106781186547*AVG_1_rho*AVG_1_u0*Recon_3*inv_AVG_a;

    OPS_ACC(wk6_B0, 0,0) = AVG_1_u1*Recon_0 + 0.707106781186547*(-AVG_1_a + AVG_1_u1)*AVG_1_rho*Recon_3*inv_AVG_a +
