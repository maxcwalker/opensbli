...
void opensbliblock00Kernel000_c_wrapper(
  ...
  for ( int n_y=0; n_y<y_size; n_y++ ){
    for ( int n_x=0; n_x<x_size; n_x++ ){
      ...
      const ptr_double u1_B0 = { u1_B0_p + n_x*1 + n_y * xdim7_opensbliblock00Kernel000*1, xdim7_opensbliblock00Kernel000};
      ptr_double wk0_B0 = { wk0_B0_p + n_x*1 + n_y * xdim8_opensbliblock00Kernel000*1, xdim8_opensbliblock00Kernel000};
      ptr_double wk1_B0 = { wk1_B0_p + n_x*1 + n_y * xdim9_opensbliblock00Kernel000*1, xdim9_opensbliblock00Kernel000};
      ptr_double wk2_B0 = { wk2_B0_p + n_x*1 + n_y * xdim10_opensbliblock00Kernel000*1, xdim10_opensbliblock00Kernel000};
      ptr_double wk3_B0 = { wk3_B0_p + n_x*1 + n_y * xdim11_opensbliblock00Kernel000*1, xdim11_opensbliblock00Kernel000};
