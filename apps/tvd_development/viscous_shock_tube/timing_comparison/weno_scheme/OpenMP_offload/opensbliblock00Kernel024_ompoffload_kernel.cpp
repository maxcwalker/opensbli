...
void ops_par_loop_opensbliblock00Kernel024_execute(ops_kernel_descriptor *desc) {
  ...
  for ( int n_y=start1; n_y<end1; n_y++ ){
    for ( int n_x=start0; n_x<end0; n_x++ ){
      ...
      const ACC<double> T_B0(xdim0_opensbliblock00Kernel024, T_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel024*1);
      const ACC<double> u0_B0(xdim1_opensbliblock00Kernel024, u0_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel024*1);
      const ACC<double> u1_B0(xdim2_opensbliblock00Kernel024, u1_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel024*1);
      const ACC<double> wk0_B0(xdim3_opensbliblock00Kernel024, wk0_B0_p + n_x*1 + n_y * xdim3_opensbliblock00Kernel024*1);
      const ACC<double> wk1_B0(xdim4_opensbliblock00Kernel024, wk1_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel024*1);
      const ACC<double> wk3_B0(xdim5_opensbliblock00Kernel024, wk3_B0_p + n_x*1 + n_y * xdim5_opensbliblock00Kernel024*1);
      const ACC<double> wk4_B0(xdim6_opensbliblock00Kernel024, wk4_B0_p + n_x*1 + n_y * xdim6_opensbliblock00Kernel024*1);
      ACC<double> Residual1_B0(xdim7_opensbliblock00Kernel024, Residual1_B0_p + n_x*1 + n_y * xdim7_opensbliblock00Kernel024*1);
      ACC<double> Residual2_B0(xdim8_opensbliblock00Kernel024, Residual2_B0_p + n_x*1 + n_y * xdim8_opensbliblock00Kernel024*1);
      ACC<double> Residual3_B0(xdim9_opensbliblock00Kernel024, Residual3_B0_p + n_x*1 + n_y * xdim9_opensbliblock00Kernel024*1);
...
void ops_par_loop_opensbliblock00Kernel024(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg8, ops_arg arg9, ops_arg arg10) {
  ...
  create_kerneldesc_and_enque(name, args, 11, 19, dim, 0, range, block, ops_par_loop_opensbliblock00Kernel024_execute);
}
#endif
