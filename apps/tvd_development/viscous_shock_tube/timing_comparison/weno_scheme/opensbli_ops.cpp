...
ops_par_loop_opensbliblock00Kernel003("CRu0", opensbliblock00, 2, iteration_range_3_block0,
...
ops_par_loop_opensbliblock00Kernel005("CRu1", opensbliblock00, 2, iteration_range_5_block0,
             ops_arg_dat(rho_B0, 1, stencil_0_00_00_2, "double", OPS_READ),
...
ops_par_loop_opensbliblock00Kernel006("CRp", opensbliblock00, 2, iteration_range_6_block0,
...
ops_par_loop_opensbliblock00Kernel008("CRa", opensbliblock00, 2, iteration_range_8_block0,
...
ops_par_loop_opensbliblock00Kernel011("CRT_B0", opensbliblock00, 2, iteration_range_11_block0,
             ops_arg_dat(p_B0, 1, stencil_0_00_00_2, "double", OPS_READ),
             ops_arg_dat(rho_B0, 1, stencil_0_00_00_2, "double", OPS_READ),
...
ops_par_loop_opensbliblock00Kernel010("LFWeno Residual", opensbliblock00, 2, iteration_range_10_block0,
...
ops_par_loop_opensbliblock00Kernel012("Derivative evaluation CD u0_B0 x0 ", opensbliblock00, 2, iteration_range_12_block0,
             ops_arg_dat(u0_B0, 1, stencil_0_44_00_10, "double", OPS_READ),
             ops_arg_dat(wk0_B0, 1, stencil_0_00_00_2, "double", OPS_WRITE),
             ops_arg_idx());

int iteration_range_14_block0[] = {0, block0np0, -2, block0np1 + 2};
ops_par_loop_opensbliblock00Kernel014("Derivative evaluation CD u1_B0 x0 ", opensbliblock00, 2, iteration_range_14_block0,
             ops_arg_dat(u1_B0, 1, stencil_0_44_00_10, "double", OPS_READ),
             ops_arg_dat(wk1_B0, 1, stencil_0_00_00_2, "double", OPS_WRITE),
             ops_arg_idx());

int iteration_range_16_block0[] = {0, block0np0, 0, block0np1};
ops_par_loop_opensbliblock00Kernel016("Derivative evaluation CD u2_B0 x0 ", opensbliblock00, 2, iteration_range_16_block0,
             ops_arg_dat(u2_B0, 1, stencil_0_44_00_10, "double", OPS_READ),
             ops_arg_dat(wk2_B0, 1, stencil_0_00_00_2, "double", OPS_WRITE),
             ops_arg_idx());

int iteration_range_18_block0[] = {0, block0np0, 0, block0np1};
ops_par_loop_opensbliblock00Kernel018("Derivative evaluation CD u0_B0 x1 ", opensbliblock00, 2, iteration_range_18_block0,
             ops_arg_dat(u0_B0, 1, stencil_0_00_24_8, "double", OPS_READ),
             ops_arg_dat(wk3_B0, 1, stencil_0_00_00_2, "double", OPS_WRITE),
             ops_arg_idx());

int iteration_range_19_block0[] = {0, block0np0, 0, block0np1};
ops_par_loop_opensbliblock00Kernel019("Derivative evaluation CD u1_B0 x1 ", opensbliblock00, 2, iteration_range_19_block0,
             ops_arg_dat(u1_B0, 1, stencil_0_00_24_8, "double", OPS_READ),
             ops_arg_dat(wk4_B0, 1, stencil_0_00_00_2, "double", OPS_WRITE),
             ops_arg_idx());

int iteration_range_20_block0[] = {0, block0np0, 0, block0np1};
ops_par_loop_opensbliblock00Kernel020("Derivative evaluation CD u2_B0 x1 ", opensbliblock00, 2, iteration_range_20_block0,
             ops_arg_dat(u2_B0, 1, stencil_0_00_24_8, "double", OPS_READ),
             ops_arg_dat(wk5_B0, 1, stencil_0_00_00_2, "double", OPS_WRITE),
             ops_arg_idx());

int iteration_range_24_block0[] = {0, block0np0, 0, block0np1};
ops_par_loop_opensbliblock00Kernel024("Viscous terms", opensbliblock00, 2, iteration_range_24_block0,
