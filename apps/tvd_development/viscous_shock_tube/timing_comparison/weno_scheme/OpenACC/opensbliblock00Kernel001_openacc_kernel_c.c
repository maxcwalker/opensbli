...
void opensbliblock00Kernel001_c_wrapper(
  ...
  for ( int n_y=0; n_y<y_size; n_y++ ){
    ...
    for ( int n_x=0; n_x<x_size; n_x++ ){
      ...
      ptr_double ptr8 = {  p_a8 + n_x*1*1 + n_y*xdim8_opensbliblock00Kernel001*1*1, xdim8_opensbliblock00Kernel001};
      ptr_double ptr9 = {  p_a9 + n_x*1*1 + n_y*xdim9_opensbliblock00Kernel001*1*1, xdim9_opensbliblock00Kernel001};
      ptr_double ptr10 = {  p_a10 + n_x*1*1 + n_y*xdim10_opensbliblock00Kernel001*1*1, xdim10_opensbliblock00Kernel001};
      ptr_double ptr11 = {  p_a11 + n_x*1*1 + n_y*xdim11_opensbliblock00Kernel001*1*1, xdim11_opensbliblock00Kernel001};
