...
//
    ...
    void buildOpenCLKernels_opensbliblock00Kernel002(OPS_instance *instance, int xdim0, int xdim1, int xdim2) {
      ...
      if(!isbuilt_opensbliblock00Kernel002) {
        ...
        instance->opencl_instance->OPS_opencl_core.kernel[5] = clCreateKernel(instance->opencl_instance->OPS_opencl_core.program, "ops_opensbliblock00Kernel002", &ret);
        clSafeCall( ret );
...
void ops_par_loop_opensbliblock00Kernel002(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  if (block->instance->OPS_diags > 1) {
    ops_timing_realloc(block->instance,5,"opensbliblock00Kernel002");
  ...
  if (globalWorkSize[0]>0 && globalWorkSize[1]>0 && globalWorkSize[2]>0) {
    ...
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[5], 3, sizeof(cl_int), (void*) &base0 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[5], 4, sizeof(cl_int), (void*) &base1 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[5], 5, sizeof(cl_int), (void*) &base2 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[5], 6, sizeof(cl_int), (void*) &x_size ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[5], 7, sizeof(cl_int), (void*) &y_size ));
