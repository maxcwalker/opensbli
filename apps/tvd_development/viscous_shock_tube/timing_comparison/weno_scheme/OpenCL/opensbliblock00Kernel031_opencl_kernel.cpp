...
//
    ...
    void buildOpenCLKernels_opensbliblock00Kernel031(OPS_instance *instance, int xdim0, int xdim1, int xdim2, int xdim3, int xdim4, int xdim5, int xdim6, int xdim7, int xdim8, int xdim9, int xdim10, int xdim11) {
      ...
      if(!isbuilt_opensbliblock00Kernel031) {
        ...
        instance->opencl_instance->OPS_opencl_core.kernel[20] = clCreateKernel(instance->opencl_instance->OPS_opencl_core.program, "ops_opensbliblock00Kernel031", &ret);
        clSafeCall( ret );
...
void ops_par_loop_opensbliblock00Kernel031(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg12, ops_arg arg13) {
  ...
  if (block->instance->OPS_diags > 1) {
    ops_timing_realloc(block->instance,20,"opensbliblock00Kernel031");
