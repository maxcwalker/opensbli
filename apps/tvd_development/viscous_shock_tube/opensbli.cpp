...
if (restart == 0){
int iteration_range_22_block0[] = {-5, block0np0 + 5, -5, block0np1 + 5};
ops_par_loop(opensbliblock00Kernel022, "Grid_based_initialisation0", opensbliblock00, 2, iteration_range_22_block0,
...
int iteration_range_18_block0[] = {0, 1, -2, block0np1 + 2};
ops_par_loop(opensbliblock00Kernel018, "AdiabaticWall boundary dir0 side0", opensbliblock00, 2, iteration_range_18_block0,
...
int iteration_range_19_block0[] = {block0np0 - 1, block0np0, -2, block0np1 + 2};
ops_par_loop(opensbliblock00Kernel019, "AdiabaticWall boundary dir0 side1", opensbliblock00, 2, iteration_range_19_block0,
...
int iteration_range_20_block0[] = {-2, block0np0 + 2, 0, 1};
ops_par_loop(opensbliblock00Kernel020, "AdiabaticWall boundary dir1 side0", opensbliblock00, 2, iteration_range_20_block0,
...
int iteration_range_21_block0[] = {-2, block0np0 + 2, block0np1 - 1, block0np1};
ops_par_loop(opensbliblock00Kernel021, "Symmetry boundary dir1 side1", opensbliblock00, 2, iteration_range_21_block0,
...
int iteration_range_9_block0[] = {-2, block0np0 + 2, -2, block0np1 + 2};
ops_par_loop(opensbliblock00Kernel009, "CRp_B0", opensbliblock00, 2, iteration_range_9_block0,
...
ops_par_loop(opensbliblock00Kernel013, "CRT_B0", opensbliblock00, 2, iteration_range_13_block0,
...
ops_par_loop(opensbliblock00Kernel000, "Derivative evaluation CD u0_B0 x0 ", opensbliblock00, 2, iteration_range_0_block0,
...
ops_par_loop(opensbliblock00Kernel002, "Derivative evaluation CD u1_B0 x0 ", opensbliblock00, 2, iteration_range_2_block0,
...
ops_par_loop(opensbliblock00Kernel004, "Derivative evaluation CD u2_B0 x0 ", opensbliblock00, 2, iteration_range_4_block0,
...
ops_par_loop(opensbliblock00Kernel006, "Derivative evaluation CD u0_B0 x1 ", opensbliblock00, 2, iteration_range_6_block0,
...
ops_par_loop(opensbliblock00Kernel007, "Derivative evaluation CD u1_B0 x1 ", opensbliblock00, 2, iteration_range_7_block0,
...
ops_par_loop(opensbliblock00Kernel008, "Derivative evaluation CD u2_B0 x1 ", opensbliblock00, 2, iteration_range_8_block0,
...
ops_par_loop(opensbliblock00Kernel016, "Convective terms", opensbliblock00, 2, iteration_range_16_block0,
...
ops_par_loop(opensbliblock00Kernel017, "Viscous terms", opensbliblock00, 2, iteration_range_17_block0,
...
ops_par_loop(opensbliblock00Kernel023, "Temporal solution advancement", opensbliblock00, 2, iteration_range_23_block0,
