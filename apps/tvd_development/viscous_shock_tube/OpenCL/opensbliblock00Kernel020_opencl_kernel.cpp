...
//
    ...
    void buildOpenCLKernels_opensbliblock00Kernel020(OPS_instance *instance, int xdim0, int xdim1, int xdim2, int xdim3) {
      ...
      if(!isbuilt_opensbliblock00Kernel020) {
        ...
        instance->opencl_instance->OPS_opencl_core.kernel[3] = clCreateKernel(instance->opencl_instance->OPS_opencl_core.program, "ops_opensbliblock00Kernel020", &ret);
        clSafeCall( ret );
...
void ops_par_loop_opensbliblock00Kernel020(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2, ops_arg arg3) {
  ...
  if (block->instance->OPS_diags > 1) {
    ops_timing_realloc(block->instance,3,"opensbliblock00Kernel020");
