...
void ops_par_loop_opensbliblock00Kernel017_execute(ops_kernel_descriptor *desc) {
  ...
  double * __restrict__ u0_B0_p = (double *)(args[1].data_d + base1);

  int base2 = args[2].dat->base_offset;
  double * __restrict__ u1_B0_p = (double *)(args[2].data_d + base2);

  int base3 = args[3].dat->base_offset;
  double * __restrict__ wk0_B0_p = (double *)(args[3].data_d + base3);

  int base4 = args[4].dat->base_offset;
  double * __restrict__ wk1_B0_p = (double *)(args[4].data_d + base4);

  int base5 = args[5].dat->base_offset;
  double * __restrict__ wk3_B0_p = (double *)(args[5].data_d + base5);

  int base6 = args[6].dat->base_offset;
  double * __restrict__ wk4_B0_p = (double *)(args[6].data_d + base6);

  int base7 = args[7].dat->base_offset;
  double * __restrict__ Residual1_B0_p = (double *)(args[7].data_d + base7);

  int base8 = args[8].dat->base_offset;
  double * __restrict__ Residual2_B0_p = (double *)(args[8].data_d + base8);

  int base9 = args[9].dat->base_offset;
  double * __restrict__ Residual3_B0_p = (double *)(args[9].data_d + base9);
  ...
  for ( int n_y=start1; n_y<end1; n_y++ ){
    for ( int n_x=start0; n_x<end0; n_x++ ){
      ...
      const ACC<double> T_B0(xdim0_opensbliblock00Kernel017, T_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel017*1);
      const ACC<double> u0_B0(xdim1_opensbliblock00Kernel017, u0_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel017*1);
      const ACC<double> u1_B0(xdim2_opensbliblock00Kernel017, u1_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel017*1);
      ...
      ACC<double> Residual1_B0(xdim7_opensbliblock00Kernel017, Residual1_B0_p + n_x*1 + n_y * xdim7_opensbliblock00Kernel017*1);
      ACC<double> Residual2_B0(xdim8_opensbliblock00Kernel017, Residual2_B0_p + n_x*1 + n_y * xdim8_opensbliblock00Kernel017*1);
...
void ops_par_loop_opensbliblock00Kernel017(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg8, ops_arg arg9, ops_arg arg10) {
  ...
  create_kerneldesc_and_enque(name, args, 11, 16, dim, 0, range, block, ops_par_loop_opensbliblock00Kernel017_execute);
}
#endif
