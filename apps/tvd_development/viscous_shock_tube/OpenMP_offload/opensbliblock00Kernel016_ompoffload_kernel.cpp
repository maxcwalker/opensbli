...
void ops_par_loop_opensbliblock00Kernel016_execute(ops_kernel_descriptor *desc) {
  ...
  double * __restrict__ Residual0_B0_p = (double *)(args[6].data_d + base6);
  ...
  for ( int n_y=start1; n_y<end1; n_y++ ){
    for ( int n_x=start0; n_x<end0; n_x++ ){
      ...
      const ACC<double> p_B0(xdim0_opensbliblock00Kernel016, p_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel016*1);
      const ACC<double> rhoE_B0(xdim1_opensbliblock00Kernel016, rhoE_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel016*1);
      const ACC<double> rhou0_B0(xdim2_opensbliblock00Kernel016, rhou0_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel016*1);
      const ACC<double> rhou1_B0(xdim3_opensbliblock00Kernel016, rhou1_B0_p + n_x*1 + n_y * xdim3_opensbliblock00Kernel016*1);
      const ACC<double> u0_B0(xdim4_opensbliblock00Kernel016, u0_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel016*1);
      const ACC<double> u1_B0(xdim5_opensbliblock00Kernel016, u1_B0_p + n_x*1 + n_y * xdim5_opensbliblock00Kernel016*1);
      ACC<double> Residual0_B0(xdim6_opensbliblock00Kernel016, Residual0_B0_p + n_x*1 + n_y * xdim6_opensbliblock00Kernel016*1);
      ACC<double> Residual1_B0(xdim7_opensbliblock00Kernel016, Residual1_B0_p + n_x*1 + n_y * xdim7_opensbliblock00Kernel016*1);
      ACC<double> Residual2_B0(xdim8_opensbliblock00Kernel016, Residual2_B0_p + n_x*1 + n_y * xdim8_opensbliblock00Kernel016*1);
      ACC<double> Residual3_B0(xdim9_opensbliblock00Kernel016, Residual3_B0_p + n_x*1 + n_y * xdim9_opensbliblock00Kernel016*1);
...
void ops_par_loop_opensbliblock00Kernel016(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg8, ops_arg arg9, ops_arg arg10) {
  ...
  create_kerneldesc_and_enque(name, args, 11, 15, dim, 0, range, block, ops_par_loop_opensbliblock00Kernel016_execute);
}
#endif
