...
void ops_par_loop_opensbliblock00Kernel018_execute(ops_kernel_descriptor *desc) {
  ...
  for ( int n_y=start1; n_y<end1; n_y++ ){
    for ( int n_x=start0; n_x<end0; n_x++ ){
      ACC<double> rhoE_B0(xdim0_opensbliblock00Kernel018, rhoE_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel018*1);
      ACC<double> rho_B0(xdim1_opensbliblock00Kernel018, rho_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel018*1);
      ACC<double> rhou0_B0(xdim2_opensbliblock00Kernel018, rhou0_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel018*1);
      ACC<double> rhou1_B0(xdim3_opensbliblock00Kernel018, rhou1_B0_p + n_x*1 + n_y * xdim3_opensbliblock00Kernel018*1);
...
void ops_par_loop_opensbliblock00Kernel018(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2, ops_arg arg3) {
  ...
  create_kerneldesc_and_enque(name, args, 4, 1, dim, 0, range, block, ops_par_loop_opensbliblock00Kernel018_execute);
}
#endif
