...
//
__constant__ int dims_opensbliblock00Kernel028 [11][1];
static int dims_opensbliblock00Kernel028_h [11][1] = {{0}};
...
int size1 ){
  ...
  arg4 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel028[4][0];
  arg5 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel028[5][0];
  arg6 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel028[6][0];
  arg7 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel028[7][0];
  arg8 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel028[8][0];
  arg9 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel028[9][0];

  if (idx_x < size0 && idx_y < size1) {
    const ACC<double> argp0(dims_opensbliblock00Kernel028[0][0], arg0);
    const ACC<double> argp1(dims_opensbliblock00Kernel028[1][0], arg1);
    const ACC<double> argp2(dims_opensbliblock00Kernel028[2][0], arg2);
    const ACC<double> argp3(dims_opensbliblock00Kernel028[3][0], arg3);
    const ACC<double> argp4(dims_opensbliblock00Kernel028[4][0], arg4);
    const ACC<double> argp5(dims_opensbliblock00Kernel028[5][0], arg5);
    const ACC<double> argp6(dims_opensbliblock00Kernel028[6][0], arg6);
    ACC<double> argp7(dims_opensbliblock00Kernel028[7][0], arg7);
    ACC<double> argp8(dims_opensbliblock00Kernel028[8][0], arg8);
    ACC<double> argp9(dims_opensbliblock00Kernel028[9][0], arg9);
...
void ops_par_loop_opensbliblock00Kernel028_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_opensbliblock00Kernel028_h[0][0] || xdim1 != dims_opensbliblock00Kernel028_h[1][0] || xdim2 != dims_opensbliblock00Kernel028_h[2][0] || xdim3 != dims_opensbliblock00Kernel028_h[3][0] || xdim4 != dims_opensbliblock00Kernel028_h[4][0] || xdim5 != dims_opensbliblock00Kernel028_h[5][0] || xdim6 != dims_opensbliblock00Kernel028_h[6][0] || xdim7 != dims_opensbliblock00Kernel028_h[7][0] || xdim8 != dims_opensbliblock00Kernel028_h[8][0] || xdim9 != dims_opensbliblock00Kernel028_h[9][0]) {
    ...
    dims_opensbliblock00Kernel028_h[9][0] = xdim9;
...
void ops_par_loop_opensbliblock00Kernel028(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg8, ops_arg arg9, ops_arg arg10) {
  ...
  create_kerneldesc_and_enque(name, args, 11, 16, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel028_execute);
}
#endif
