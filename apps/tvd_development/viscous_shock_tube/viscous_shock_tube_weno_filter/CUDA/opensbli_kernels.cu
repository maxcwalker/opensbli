...
int size, char *dat, char const *name){
  ...
  if (!strcmp(name,"Ducros_check")) {
    cutilSafeCall(instance->ostream(),cudaMemcpyToSymbol(Ducros_check, dat, dim*size));
  }
  else
  if (!strcmp(name,"Ducros_select")) {
    cutilSafeCall(instance->ostream(),cudaMemcpyToSymbol(Ducros_select, dat, dim*size));
  }
  else
  ...
  if (!strcmp(name,"inv_rfact0_block0")) {
    cutilSafeCall(instance->ostream(),cudaMemcpyToSymbol(inv_rfact0_block0, dat, dim*size));
  }
  else
  if (!strcmp(name,"inv_rfact1_block0")) {
    cutilSafeCall(instance->ostream(),cudaMemcpyToSymbol(inv_rfact1_block0, dat, dim*size));
  }
  else
