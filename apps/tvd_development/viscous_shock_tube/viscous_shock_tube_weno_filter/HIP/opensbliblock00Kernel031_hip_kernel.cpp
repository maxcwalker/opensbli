...
//
__constant__ int dims_opensbliblock00Kernel031 [4][1];
static int dims_opensbliblock00Kernel031_h [4][1] = {{0}};

//user function
__device__

void opensbliblock00Kernel031_gpu(ACC<double> &rhoE_B0,
  ACC<double> &rho_B0,
  ACC<double> &rhou0_B0,
  ACC<double> &rhou1_B0)
{
...
int size1 ){
  ...
  if (idx_x < size0 && idx_y < size1) {
    ACC<double> argp0(dims_opensbliblock00Kernel031[0][0], arg0);
    ACC<double> argp1(dims_opensbliblock00Kernel031[1][0], arg1);
    ACC<double> argp2(dims_opensbliblock00Kernel031[2][0], arg2);
    ACC<double> argp3(dims_opensbliblock00Kernel031[3][0], arg3);
...
void ops_par_loop_opensbliblock00Kernel031_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_opensbliblock00Kernel031_h[0][0] || xdim1 != dims_opensbliblock00Kernel031_h[1][0] || xdim2 != dims_opensbliblock00Kernel031_h[2][0] || xdim3 != dims_opensbliblock00Kernel031_h[3][0]) {
...
void ops_par_loop_opensbliblock00Kernel031(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2, ops_arg arg3) {
  ...
  create_kerneldesc_and_enque(name, args, 4, 3, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel031_execute);
}
#endif
