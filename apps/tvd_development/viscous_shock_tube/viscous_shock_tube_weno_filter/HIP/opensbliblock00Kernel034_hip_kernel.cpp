...
//
__constant__ int dims_opensbliblock00Kernel034 [14][1];
static int dims_opensbliblock00Kernel034_h [14][1] = {{0}};

//user function
__device__

 void opensbliblock00Kernel034_gpu(const ACC<double> &Residual0_B0,
...
int size1 ){
  ...
  if (idx_x < size0 && idx_y < size1) {
    ...
    ACC<double> argp4(dims_opensbliblock00Kernel034[4][0], arg4);
    ACC<double> argp5(dims_opensbliblock00Kernel034[5][0], arg5);
    ACC<double> argp6(dims_opensbliblock00Kernel034[6][0], arg6);
    ACC<double> argp7(dims_opensbliblock00Kernel034[7][0], arg7);
    ACC<double> argp8(dims_opensbliblock00Kernel034[8][0], arg8);
    ACC<double> argp9(dims_opensbliblock00Kernel034[9][0], arg9);
    ACC<double> argp10(dims_opensbliblock00Kernel034[10][0], arg10);
    ACC<double> argp11(dims_opensbliblock00Kernel034[11][0], arg11);
...
void ops_par_loop_opensbliblock00Kernel034(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg12, ops_arg arg13) {
  ...
  create_kerneldesc_and_enque(name, args, 14, 17, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel034_execute);
}
#endif
