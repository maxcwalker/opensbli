...
//
__constant__ int dims_opensbliblock00Kernel030 [4][1];
static int dims_opensbliblock00Kernel030_h [4][1] = {{0}};
...
void ops_par_loop_opensbliblock00Kernel030_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_opensbliblock00Kernel030_h[0][0] || xdim1 != dims_opensbliblock00Kernel030_h[1][0] || xdim2 != dims_opensbliblock00Kernel030_h[2][0] || xdim3 != dims_opensbliblock00Kernel030_h[3][0]) {
...
void ops_par_loop_opensbliblock00Kernel030(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2, ops_arg arg3) {
  ...
  create_kerneldesc_and_enque(name, args, 4, 2, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel030_execute);
}
#endif
