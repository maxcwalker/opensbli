...
void ops_par_loop_opensbliblock00Kernel010_execute(ops_kernel_descriptor *desc) {
  ...
  double * __restrict__ WENO_filter_B0_p = (double *)(args[9].data + base9);
  ...
  double * __restrict__ rhou0_B0_p = (double *)(args[12].data + base12);

  int base13 = args[13].dat->base_offset;
  double * __restrict__ rhou1_B0_p = (double *)(args[13].data + base13);
