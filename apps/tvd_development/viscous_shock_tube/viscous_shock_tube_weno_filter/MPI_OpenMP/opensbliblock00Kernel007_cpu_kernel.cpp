...
void ops_par_loop_opensbliblock00Kernel007_execute(ops_kernel_descriptor *desc) {
  ...
  int xdim6_opensbliblock00Kernel007 = args[6].dat->size[0];
  int xdim7_opensbliblock00Kernel007 = args[7].dat->size[0];
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
      ACC<double> Residual0_B0(xdim0_opensbliblock00Kernel007, Residual0_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel007*1);
      ACC<double> Residual1_B0(xdim1_opensbliblock00Kernel007, Residual1_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel007*1);
      ACC<double> Residual2_B0(xdim2_opensbliblock00Kernel007, Residual2_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel007*1);
      ACC<double> Residual3_B0(xdim3_opensbliblock00Kernel007, Residual3_B0_p + n_x*1 + n_y * xdim3_opensbliblock00Kernel007*1);
      ACC<double> wk0_B0(xdim4_opensbliblock00Kernel007, wk0_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel007*1);
      ACC<double> wk1_B0(xdim5_opensbliblock00Kernel007, wk1_B0_p + n_x*1 + n_y * xdim5_opensbliblock00Kernel007*1);
      ACC<double> wk2_B0(xdim6_opensbliblock00Kernel007, wk2_B0_p + n_x*1 + n_y * xdim6_opensbliblock00Kernel007*1);
      ACC<double> wk3_B0(xdim7_opensbliblock00Kernel007, wk3_B0_p + n_x*1 + n_y * xdim7_opensbliblock00Kernel007*1);
...
void ops_par_loop_opensbliblock00Kernel007(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4, ops_arg arg5, ops_arg arg6, ops_arg arg7) {
  ...
  create_kerneldesc_and_enque(name, args, 8, 20, dim, 0, range, block, ops_par_loop_opensbliblock00Kernel007_execute);
}
#endif
