...
void ops_par_loop_opensbliblock00Kernel008_execute(ops_kernel_descriptor *desc) {
 ...
 arg10, arg11, arg12};
  ...
  if (block->instance->OPS_diags > 1) {
    ops_timing_realloc(block->instance,21,"opensbliblock00Kernel008");
  ...
  int xdim3_opensbliblock00Kernel008 = args[3].dat->size[0];
  int xdim4_opensbliblock00Kernel008 = args[4].dat->size[0];
  int xdim5_opensbliblock00Kernel008 = args[5].dat->size[0];
  int xdim6_opensbliblock00Kernel008 = args[6].dat->size[0];
  int xdim7_opensbliblock00Kernel008 = args[7].dat->size[0];
  int xdim8_opensbliblock00Kernel008 = args[8].dat->size[0];
  int xdim9_opensbliblock00Kernel008 = args[9].dat->size[0];
  int xdim10_opensbliblock00Kernel008 = args[10].dat->size[0];
  int xdim11_opensbliblock00Kernel008 = args[11].dat->size[0];
  int xdim12_opensbliblock00Kernel008 = args[12].dat->size[0];
  ...
  double* kappa_B0_p = (double*)args[1].data_d;
  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      auto sensor_theta_sycl = (*sensor_theta_p).template get_access<cl::sycl::access::mode::read>(cgh);
      auto shock_filter_control_sycl = (*shock_filter_control_p).template get_access<cl::sycl::access::mode::read>(cgh);

      cgh.parallel_for<class opensbliblock00Kernel008_kernel>(cl::sycl::nd_range<2>(cl::sycl::range<2>(
      ...
      , [=](cl::sycl::nd_item<2> item
        ...
        const ACC<double> a_B0(xdim0_opensbliblock00Kernel008, &a_B0_p[0] + base0 + n_x*1 + n_y * xdim0_opensbliblock00Kernel008*1);
        const ACC<double> kappa_B0(xdim1_opensbliblock00Kernel008, &kappa_B0_p[0] + base1 + n_x*1 + n_y * xdim1_opensbliblock00Kernel008*1);
        const ACC<double> p_B0(xdim2_opensbliblock00Kernel008, &p_B0_p[0] + base2 + n_x*1 + n_y * xdim2_opensbliblock00Kernel008*1);
        const ACC<double> rhoE_B0(xdim3_opensbliblock00Kernel008, &rhoE_B0_p[0] + base3 + n_x*1 + n_y * xdim3_opensbliblock00Kernel008*1);
        const ACC<double> rho_B0(xdim4_opensbliblock00Kernel008, &rho_B0_p[0] + base4 + n_x*1 + n_y * xdim4_opensbliblock00Kernel008*1);
        const ACC<double> rhou0_B0(xdim5_opensbliblock00Kernel008, &rhou0_B0_p[0] + base5 + n_x*1 + n_y * xdim5_opensbliblock00Kernel008*1);
        const ACC<double> rhou1_B0(xdim6_opensbliblock00Kernel008, &rhou1_B0_p[0] + base6 + n_x*1 + n_y * xdim6_opensbliblock00Kernel008*1);
        const ACC<double> u0_B0(xdim7_opensbliblock00Kernel008, &u0_B0_p[0] + base7 + n_x*1 + n_y * xdim7_opensbliblock00Kernel008*1);
        const ACC<double> u1_B0(xdim8_opensbliblock00Kernel008, &u1_B0_p[0] + base8 + n_x*1 + n_y * xdim8_opensbliblock00Kernel008*1);
        ACC<double> wk0_B0(xdim9_opensbliblock00Kernel008, &wk0_B0_p[0] + base9 + n_x*1 + n_y * xdim9_opensbliblock00Kernel008*1);
        ACC<double> wk1_B0(xdim10_opensbliblock00Kernel008, &wk1_B0_p[0] + base10 + n_x*1 + n_y * xdim10_opensbliblock00Kernel008*1);
        ACC<double> wk2_B0(xdim11_opensbliblock00Kernel008, &wk2_B0_p[0] + base11 + n_x*1 + n_y * xdim11_opensbliblock00Kernel008*1);
        ACC<double> wk3_B0(xdim12_opensbliblock00Kernel008, &wk3_B0_p[0] + base12 + n_x*1 + n_y * xdim12_opensbliblock00Kernel008*1);
        //USER CODE
   ...
   double rj2 = 0.0;
   double rj3 = 0.0;
    if (cl::sycl::fmax(kappa_B0(2,0), cl::sycl::fmax(kappa_B0(1,0), cl::sycl::fmax(kappa_B0(-3,0), cl::sycl::fmax(kappa_B0(-2,0), cl::sycl::fmax(kappa_B0(-1,0),
      kappa_B0(0,0)))))) > Ducros_check_sycl[0]){

      AVG_0_rho = cl::sycl::sqrt(rho_B0(0,0)*rho_B0(1,0));

      AVG_0_inv_rho = 1.0/((cl::sycl::sqrt(rho_B0(0,0)) + cl::sycl::sqrt(rho_B0(1,0))));

      AVG_0_u0 = (cl::sycl::sqrt(rho_B0(0,0))*u0_B0(0,0) + cl::sycl::sqrt(rho_B0(1,0))*u0_B0(1,0))*AVG_0_inv_rho;

      AVG_0_u1 = (cl::sycl::sqrt(rho_B0(0,0))*u1_B0(0,0) + cl::sycl::sqrt(rho_B0(1,0))*u1_B0(1,0))*AVG_0_inv_rho;

       AVG_0_a = cl::sycl::sqrt((-(1.0/2.0)*((AVG_0_u0*AVG_0_u0) + (AVG_0_u1*AVG_0_u1)) + ((p_B0(0,0) +
            rhoE_B0(0,0))/cl::sycl::sqrt(rho_B0(0,0)) + (p_B0(1,0) + rhoE_B0(1,0))/cl::sycl::sqrt(rho_B0(1,0)))*AVG_0_inv_rho)*gamma_m1_sycl[0]);
      ...
      inv_AVG_rho = 1.0/(AVG_0_rho);
       ...
       AVG_0_0_LEV_00 = -(1.0/2.0)*(-2 - (AVG_0_u0*AVG_0_u0)*(inv_AVG_a*inv_AVG_a) -
            (AVG_0_u1*AVG_0_u1)*(inv_AVG_a*inv_AVG_a) + (AVG_0_u0*AVG_0_u0)*(inv_AVG_a*inv_AVG_a)*gama_sycl[0] +
            (AVG_0_u1*AVG_0_u1)*(inv_AVG_a*inv_AVG_a)*gama_sycl[0]);

      AVG_0_0_LEV_01 = (inv_AVG_a*inv_AVG_a)*gamma_m1_sycl[0]*AVG_0_u0;

      AVG_0_0_LEV_02 = (inv_AVG_a*inv_AVG_a)*gamma_m1_sycl[0]*AVG_0_u1;

      AVG_0_0_LEV_03 = -(inv_AVG_a*inv_AVG_a)*gamma_m1_sycl[0];

      AVG_0_0_LEV_10 = AVG_0_u1*inv_AVG_rho;

      AVG_0_0_LEV_12 = -inv_AVG_rho;

       AVG_0_0_LEV_20 = -0.353553390593274*((AVG_0_u0*AVG_0_u0) + (AVG_0_u1*AVG_0_u1) - (AVG_0_u0*AVG_0_u0)*gama_sycl[0] -
            (AVG_0_u1*AVG_0_u1)*gama_sycl[0] + 2*AVG_0_a*AVG_0_u0)*inv_AVG_a*inv_AVG_rho;

      AVG_0_0_LEV_21 = 0.707106781186547*(-gama_sycl[0]*AVG_0_u0 + AVG_0_a + AVG_0_u0)*inv_AVG_a*inv_AVG_rho;

      AVG_0_0_LEV_22 = -0.707106781186547*gamma_m1_sycl[0]*AVG_0_u1*inv_AVG_a*inv_AVG_rho;

      AVG_0_0_LEV_23 = 0.707106781186547*gamma_m1_sycl[0]*inv_AVG_a*inv_AVG_rho;

       AVG_0_0_LEV_30 = 0.353553390593274*(-(AVG_0_u0*AVG_0_u0) - (AVG_0_u1*AVG_0_u1) + (AVG_0_u0*AVG_0_u0)*gama_sycl[0] +
            (AVG_0_u1*AVG_0_u1)*gama_sycl[0] + 2*AVG_0_a*AVG_0_u0)*inv_AVG_a*inv_AVG_rho;

      AVG_0_0_LEV_31 = -0.707106781186547*(-AVG_0_u0 + gama_sycl[0]*AVG_0_u0 + AVG_0_a)*inv_AVG_a*inv_AVG_rho;

      AVG_0_0_LEV_32 = -0.707106781186547*gamma_m1_sycl[0]*AVG_0_u1*inv_AVG_a*inv_AVG_rho;

      AVG_0_0_LEV_33 = 0.707106781186547*gamma_m1_sycl[0]*inv_AVG_a*inv_AVG_rho;
      ...
      max_lambda_00 = shock_filter_control_sycl[0]*cl::sycl::fmax(cl::sycl::fabs(u0_B0(0,0)), cl::sycl::fabs(u0_B0(1,0)));

      max_lambda_11 = max_lambda_00;

      max_lambda_22 = shock_filter_control_sycl[0]*cl::sycl::fmax(cl::sycl::fabs(a_B0(0,0) + u0_B0(0,0)), cl::sycl::fabs(a_B0(1,0) + u0_B0(1,0)));

      max_lambda_33 = shock_filter_control_sycl[0]*cl::sycl::fmax(cl::sycl::fabs(-u0_B0(1,0) + a_B0(1,0)), cl::sycl::fabs(-u0_B0(0,0) + a_B0(0,0)));
       ...
       alpha_1 = 0.6 + ((3.0/5.0))*(cl::sycl::fabs(-beta_2 + beta_0)*cl::sycl::fabs(-beta_2 + beta_0))/((1.0e-40 + beta_1)*(1.0e-40 +
            beta_1));
      ...
      omega_2 = alpha_2*inv_alpha_sum;
       ...
       rj0 = (pow(cl::sycl::fabs(-1.0 + 10*omega_2), sensor_theta_sycl[0]) + pow(cl::sycl::fabs(-1.0 + ((5.0/3.0))*omega_1), sensor_theta_sycl[0]) +
            pow(cl::sycl::fabs(-1.0 + ((10.0/3.0))*omega_0), sensor_theta_sycl[0]))/(2 + pow(9.0, sensor_theta_sycl[0]));
      ...
      omega_2 = alpha_2*inv_alpha_sum;
       ...
       rj0 = cl::sycl::fmax(rj0, (pow(cl::sycl::fabs(-1.0 + 10*omega_0), sensor_theta_sycl[0]) + pow(cl::sycl::fabs(-1.0 + ((5.0/3.0))*omega_1), sensor_theta_sycl[0])
            + pow(cl::sycl::fabs(-1.0 + ((10.0/3.0))*omega_2), sensor_theta_sycl[0]))/(2 + pow(9.0, sensor_theta_sycl[0])));
      ...
      omega_2 = alpha_2*inv_alpha_sum;
       ...
       rj1 = (pow(cl::sycl::fabs(-1.0 + 10*omega_2), sensor_theta_sycl[0]) + pow(cl::sycl::fabs(-1.0 + ((5.0/3.0))*omega_1), sensor_theta_sycl[0]) +
            pow(cl::sycl::fabs(-1.0 + ((10.0/3.0))*omega_0), sensor_theta_sycl[0]))/(2 + pow(9.0, sensor_theta_sycl[0]));
      ...
      omega_2 = alpha_2*inv_alpha_sum;
       ...
       rj1 = cl::sycl::fmax(rj1, (pow(cl::sycl::fabs(-1.0 + 10*omega_0), sensor_theta_sycl[0]) + pow(cl::sycl::fabs(-1.0 + ((5.0/3.0))*omega_1), sensor_theta_sycl[0])
            + pow(cl::sycl::fabs(-1.0 + ((10.0/3.0))*omega_2), sensor_theta_sycl[0]))/(2 + pow(9.0, sensor_theta_sycl[0])));
      ...
      omega_2 = alpha_2*inv_alpha_sum;
       ...
       rj2 = (pow(cl::sycl::fabs(-1.0 + 10*omega_2), sensor_theta_sycl[0]) + pow(cl::sycl::fabs(-1.0 + ((5.0/3.0))*omega_1), sensor_theta_sycl[0]) +
            pow(cl::sycl::fabs(-1.0 + ((10.0/3.0))*omega_0), sensor_theta_sycl[0]))/(2 + pow(9.0, sensor_theta_sycl[0]));
      ...
      omega_2 = alpha_2*inv_alpha_sum;
       ...
       rj2 = cl::sycl::fmax(rj2, (pow(cl::sycl::fabs(-1.0 + 10*omega_0), sensor_theta_sycl[0]) + pow(cl::sycl::fabs(-1.0 + ((5.0/3.0))*omega_1), sensor_theta_sycl[0])
            + pow(cl::sycl::fabs(-1.0 + ((10.0/3.0))*omega_2), sensor_theta_sycl[0]))/(2 + pow(9.0, sensor_theta_sycl[0])));
      ...
      omega_2 = alpha_2*inv_alpha_sum;
       ...
       rj3 = (pow(cl::sycl::fabs(-1.0 + 10*omega_2), sensor_theta_sycl[0]) + pow(cl::sycl::fabs(-1.0 + ((5.0/3.0))*omega_1), sensor_theta_sycl[0]) +
            pow(cl::sycl::fabs(-1.0 + ((10.0/3.0))*omega_0), sensor_theta_sycl[0]))/(2 + pow(9.0, sensor_theta_sycl[0]));
      ...
      omega_2 = alpha_2*inv_alpha_sum;
       ...
       rj3 = cl::sycl::fmax(rj3, (pow(cl::sycl::fabs(-1.0 + 10*omega_0), sensor_theta_sycl[0]) + pow(cl::sycl::fabs(-1.0 + ((5.0/3.0))*omega_1), sensor_theta_sycl[0])
            + pow(cl::sycl::fabs(-1.0 + ((10.0/3.0))*omega_2), sensor_theta_sycl[0]))/(2 + pow(9.0, sensor_theta_sycl[0])));
      ...
      Recon_3 = (-(1.0/60.0)*(-8*CF_31 - 8*CF_34 + 37*CF_32 + 37*CF_33 + CF_30 + CF_35) + Recon_3)*rj3;
       ...
       wk3_B0(0,0) = (((1.0/2.0))*(AVG_0_u0*AVG_0_u0) + ((1.0/2.0))*(AVG_0_u1*AVG_0_u1))*Recon_0 -
            ...
            (AVG_0_u1*AVG_0_u1))*gamma_m1_sycl[0])*invgamma_m1_sycl[0] + AVG_0_a*AVG_0_u0)*AVG_0_rho*Recon_2*inv_AVG_a +
            0.707106781186547*(((AVG_0_a*AVG_0_a) + ((1.0/2.0))*((AVG_0_u0*AVG_0_u0) +
            (AVG_0_u1*AVG_0_u1))*gamma_m1_sycl[0])*invgamma_m1_sycl[0] - AVG_0_a*AVG_0_u0)*AVG_0_rho*Recon_3*inv_AVG_a;
...
void ops_par_loop_opensbliblock00Kernel008(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg12) {
  ...
  desc->function = ops_par_loop_opensbliblock00Kernel008_execute;
  if (block->instance->OPS_diags > 1) {
    ops_timing_realloc(block->instance,21,"opensbliblock00Kernel008");
  }
