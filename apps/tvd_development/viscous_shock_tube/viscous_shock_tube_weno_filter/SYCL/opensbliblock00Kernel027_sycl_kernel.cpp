 ...
 arg10};
  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      cgh.parallel_for<class opensbliblock00Kernel027_kernel>(cl::sycl::nd_range<2>(cl::sycl::range<2>(
      ...
      , [=](cl::sycl::nd_item<2> item
        ...
        const ACC<double> p_B0(xdim0_opensbliblock00Kernel027, &p_B0_p[0] + base0 + n_x*1 + n_y * xdim0_opensbliblock00Kernel027*1);
        const ACC<double> rhoE_B0(xdim1_opensbliblock00Kernel027, &rhoE_B0_p[0] + base1 + n_x*1 + n_y * xdim1_opensbliblock00Kernel027*1);
        const ACC<double> rhou0_B0(xdim2_opensbliblock00Kernel027, &rhou0_B0_p[0] + base2 + n_x*1 + n_y * xdim2_opensbliblock00Kernel027*1);
        const ACC<double> rhou1_B0(xdim3_opensbliblock00Kernel027, &rhou1_B0_p[0] + base3 + n_x*1 + n_y * xdim3_opensbliblock00Kernel027*1);
        const ACC<double> u0_B0(xdim4_opensbliblock00Kernel027, &u0_B0_p[0] + base4 + n_x*1 + n_y * xdim4_opensbliblock00Kernel027*1);
        const ACC<double> u1_B0(xdim5_opensbliblock00Kernel027, &u1_B0_p[0] + base5 + n_x*1 + n_y * xdim5_opensbliblock00Kernel027*1);
        ACC<double> Residual0_B0(xdim6_opensbliblock00Kernel027, &Residual0_B0_p[0] + base6 + n_x*1 + n_y * xdim6_opensbliblock00Kernel027*1);
        ACC<double> Residual1_B0(xdim7_opensbliblock00Kernel027, &Residual1_B0_p[0] + base7 + n_x*1 + n_y * xdim7_opensbliblock00Kernel027*1);
        ACC<double> Residual2_B0(xdim8_opensbliblock00Kernel027, &Residual2_B0_p[0] + base8 + n_x*1 + n_y * xdim8_opensbliblock00Kernel027*1);
        ACC<double> Residual3_B0(xdim9_opensbliblock00Kernel027, &Residual3_B0_p[0] + base9 + n_x*1 + n_y * xdim9_opensbliblock00Kernel027*1);
        //USER CODE
