...
void ops_par_loop_opensbliblock00Kernel009_execute(ops_kernel_descriptor *desc) {
 ...
 arg10, arg11, arg12};
  ...
  if (!ops_checkpointing_before(args,13,range,22)) return;
  #endif

  if (block->instance->OPS_diags > 1) {
    ops_timing_realloc(block->instance,22,"opensbliblock00Kernel009");
  ...
  int xdim6_opensbliblock00Kernel009 = args[6].dat->size[0];
  int xdim7_opensbliblock00Kernel009 = args[7].dat->size[0];
  int xdim8_opensbliblock00Kernel009 = args[8].dat->size[0];
  int xdim9_opensbliblock00Kernel009 = args[9].dat->size[0];
  int xdim10_opensbliblock00Kernel009 = args[10].dat->size[0];
  int xdim11_opensbliblock00Kernel009 = args[11].dat->size[0];
  int xdim12_opensbliblock00Kernel009 = args[12].dat->size[0];
  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      cgh.parallel_for<class opensbliblock00Kernel009_kernel>(cl::sycl::nd_range<2>(cl::sycl::range<2>(
      ...
      , [=](cl::sycl::nd_item<2> item
        ...
        const ACC<double> a_B0(xdim0_opensbliblock00Kernel009, &a_B0_p[0] + base0 + n_x*1 + n_y * xdim0_opensbliblock00Kernel009*1);
        const ACC<double> kappa_B0(xdim1_opensbliblock00Kernel009, &kappa_B0_p[0] + base1 + n_x*1 + n_y * xdim1_opensbliblock00Kernel009*1);
        const ACC<double> p_B0(xdim2_opensbliblock00Kernel009, &p_B0_p[0] + base2 + n_x*1 + n_y * xdim2_opensbliblock00Kernel009*1);
        const ACC<double> rhoE_B0(xdim3_opensbliblock00Kernel009, &rhoE_B0_p[0] + base3 + n_x*1 + n_y * xdim3_opensbliblock00Kernel009*1);
        const ACC<double> rho_B0(xdim4_opensbliblock00Kernel009, &rho_B0_p[0] + base4 + n_x*1 + n_y * xdim4_opensbliblock00Kernel009*1);
        const ACC<double> rhou0_B0(xdim5_opensbliblock00Kernel009, &rhou0_B0_p[0] + base5 + n_x*1 + n_y * xdim5_opensbliblock00Kernel009*1);
        const ACC<double> rhou1_B0(xdim6_opensbliblock00Kernel009, &rhou1_B0_p[0] + base6 + n_x*1 + n_y * xdim6_opensbliblock00Kernel009*1);
        const ACC<double> u0_B0(xdim7_opensbliblock00Kernel009, &u0_B0_p[0] + base7 + n_x*1 + n_y * xdim7_opensbliblock00Kernel009*1);
        const ACC<double> u1_B0(xdim8_opensbliblock00Kernel009, &u1_B0_p[0] + base8 + n_x*1 + n_y * xdim8_opensbliblock00Kernel009*1);
        ACC<double> Residual0_B0(xdim9_opensbliblock00Kernel009, &Residual0_B0_p[0] + base9 + n_x*1 + n_y * xdim9_opensbliblock00Kernel009*1);
        ACC<double> Residual1_B0(xdim10_opensbliblock00Kernel009, &Residual1_B0_p[0] + base10 + n_x*1 + n_y * xdim10_opensbliblock00Kernel009*1);
        ACC<double> Residual2_B0(xdim11_opensbliblock00Kernel009, &Residual2_B0_p[0] + base11 + n_x*1 + n_y * xdim11_opensbliblock00Kernel009*1);
        ACC<double> Residual3_B0(xdim12_opensbliblock00Kernel009, &Residual3_B0_p[0] + base12 + n_x*1 + n_y * xdim12_opensbliblock00Kernel009*1);
        //USER CODE
   ...
   double rj2 = 0.0;
   double rj3 = 0.0;
    if (cl::sycl::fmax(kappa_B0(0,1), cl::sycl::fmax(kappa_B0(0,-3), cl::sycl::fmax(kappa_B0(0,-1), cl::sycl::fmax(kappa_B0(0,0), cl::sycl::fmax(kappa_B0(0,2),
      kappa_B0(0,-2)))))) > Ducros_check_sycl[0]){

      AVG_1_rho = cl::sycl::sqrt(rho_B0(0,0)*rho_B0(0,1));

      AVG_1_inv_rho = 1.0/((cl::sycl::sqrt(rho_B0(0,0)) + cl::sycl::sqrt(rho_B0(0,1))));

      AVG_1_u0 = (cl::sycl::sqrt(rho_B0(0,0))*u0_B0(0,0) + cl::sycl::sqrt(rho_B0(0,1))*u0_B0(0,1))*AVG_1_inv_rho;

      AVG_1_u1 = (cl::sycl::sqrt(rho_B0(0,0))*u1_B0(0,0) + cl::sycl::sqrt(rho_B0(0,1))*u1_B0(0,1))*AVG_1_inv_rho;

       AVG_1_a = cl::sycl::sqrt((-(1.0/2.0)*((AVG_1_u0*AVG_1_u0) + (AVG_1_u1*AVG_1_u1)) + ((p_B0(0,0) +
            rhoE_B0(0,0))/cl::sycl::sqrt(rho_B0(0,0)) + (p_B0(0,1) + rhoE_B0(0,1))/cl::sycl::sqrt(rho_B0(0,1)))*AVG_1_inv_rho)*gamma_m1_sycl[0]);
      ...
      AVG_1_1_LEV_11 = inv_AVG_rho;
       ...
       AVG_1_1_LEV_20 = -0.353553390593274*((AVG_1_u0*AVG_1_u0) + (AVG_1_u1*AVG_1_u1) - (AVG_1_u0*AVG_1_u0)*gama_sycl[0] -
            (AVG_1_u1*AVG_1_u1)*gama_sycl[0] + 2*AVG_1_a*AVG_1_u1)*inv_AVG_a*inv_AVG_rho;

      AVG_1_1_LEV_21 = -0.707106781186547*gamma_m1_sycl[0]*AVG_1_u0*inv_AVG_a*inv_AVG_rho;

      AVG_1_1_LEV_22 = 0.707106781186547*(-gama_sycl[0]*AVG_1_u1 + AVG_1_a + AVG_1_u1)*inv_AVG_a*inv_AVG_rho;
      ...
      AVG_1_1_LEV_32 = -0.707106781186547*(-AVG_1_u1 + gama_sycl[0]*AVG_1_u1 + AVG_1_a)*inv_AVG_a*inv_AVG_rho;
      ...
      max_lambda_00 = shock_filter_control_sycl[0]*cl::sycl::fmax(cl::sycl::fabs(u1_B0(0,0)), cl::sycl::fabs(u1_B0(0,1)));

      max_lambda_11 = max_lambda_00;

      max_lambda_22 = shock_filter_control_sycl[0]*cl::sycl::fmax(cl::sycl::fabs(a_B0(0,0) + u1_B0(0,0)), cl::sycl::fabs(a_B0(0,1) + u1_B0(0,1)));

      max_lambda_33 = shock_filter_control_sycl[0]*cl::sycl::fmax(cl::sycl::fabs(-u1_B0(0,0) + a_B0(0,0)), cl::sycl::fabs(-u1_B0(0,1) + a_B0(0,1)));
      ...
      Recon_3 = (-(1.0/60.0)*(-8*CF_31 - 8*CF_34 + 37*CF_32 + 37*CF_33 + CF_30 + CF_35) + Recon_3)*rj3;
       ...
       Residual3_B0(0,0) = (((1.0/2.0))*(AVG_1_u0*AVG_1_u0) + ((1.0/2.0))*(AVG_1_u1*AVG_1_u1))*Recon_0 +
            ...
            (AVG_1_u1*AVG_1_u1))*gamma_m1_sycl[0])*invgamma_m1_sycl[0] + AVG_1_a*AVG_1_u1)*AVG_1_rho*Recon_2*inv_AVG_a +
            0.707106781186547*(((AVG_1_a*AVG_1_a) + ((1.0/2.0))*((AVG_1_u0*AVG_1_u0) +
            (AVG_1_u1*AVG_1_u1))*gamma_m1_sycl[0])*invgamma_m1_sycl[0] - AVG_1_a*AVG_1_u1)*AVG_1_rho*Recon_3*inv_AVG_a;
