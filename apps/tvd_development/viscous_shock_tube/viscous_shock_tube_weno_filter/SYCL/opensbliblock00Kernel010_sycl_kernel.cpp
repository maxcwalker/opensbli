...
void ops_par_loop_opensbliblock00Kernel010_execute(ops_kernel_descriptor *desc) {
 ...
 arg10, arg11, arg12, arg13, arg14};
  ...
  int xdim12_opensbliblock00Kernel010 = args[12].dat->size[0];
  int xdim13_opensbliblock00Kernel010 = args[13].dat->size[0];
  ...
  double* WENO_filter_B0_p = (double*)args[9].data_d;
  ...
  double* rho_B0_p = (double*)args[11].data_d;

  int base12 = args[12].dat->base_offset/sizeof(double);
  double* rhou0_B0_p = (double*)args[12].data_d;

  int base13 = args[13].dat->base_offset/sizeof(double);
  double* rhou1_B0_p = (double*)args[13].data_d;
  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      , [=](cl::sycl::nd_item<2> item
        ...
        const ACC<double> Residual0_B0(xdim0_opensbliblock00Kernel010, &Residual0_B0_p[0] + base0 + n_x*1 + n_y * xdim0_opensbliblock00Kernel010*1);
        const ACC<double> Residual1_B0(xdim1_opensbliblock00Kernel010, &Residual1_B0_p[0] + base1 + n_x*1 + n_y * xdim1_opensbliblock00Kernel010*1);
        const ACC<double> Residual2_B0(xdim2_opensbliblock00Kernel010, &Residual2_B0_p[0] + base2 + n_x*1 + n_y * xdim2_opensbliblock00Kernel010*1);
        const ACC<double> Residual3_B0(xdim3_opensbliblock00Kernel010, &Residual3_B0_p[0] + base3 + n_x*1 + n_y * xdim3_opensbliblock00Kernel010*1);
        const ACC<double> kappa_B0(xdim4_opensbliblock00Kernel010, &kappa_B0_p[0] + base4 + n_x*1 + n_y * xdim4_opensbliblock00Kernel010*1);
        const ACC<double> wk0_B0(xdim5_opensbliblock00Kernel010, &wk0_B0_p[0] + base5 + n_x*1 + n_y * xdim5_opensbliblock00Kernel010*1);
        const ACC<double> wk1_B0(xdim6_opensbliblock00Kernel010, &wk1_B0_p[0] + base6 + n_x*1 + n_y * xdim6_opensbliblock00Kernel010*1);
        const ACC<double> wk2_B0(xdim7_opensbliblock00Kernel010, &wk2_B0_p[0] + base7 + n_x*1 + n_y * xdim7_opensbliblock00Kernel010*1);
        const ACC<double> wk3_B0(xdim8_opensbliblock00Kernel010, &wk3_B0_p[0] + base8 + n_x*1 + n_y * xdim8_opensbliblock00Kernel010*1);
        ACC<double> WENO_filter_B0(xdim9_opensbliblock00Kernel010, &WENO_filter_B0_p[0] + base9 + n_x*1 + n_y * xdim9_opensbliblock00Kernel010*1);
        ACC<double> rhoE_B0(xdim10_opensbliblock00Kernel010, &rhoE_B0_p[0] + base10 + n_x*1 + n_y * xdim10_opensbliblock00Kernel010*1);
        ACC<double> rho_B0(xdim11_opensbliblock00Kernel010, &rho_B0_p[0] + base11 + n_x*1 + n_y * xdim11_opensbliblock00Kernel010*1);
        ACC<double> rhou0_B0(xdim12_opensbliblock00Kernel010, &rhou0_B0_p[0] + base12 + n_x*1 + n_y * xdim12_opensbliblock00Kernel010*1);
        ACC<double> rhou1_B0(xdim13_opensbliblock00Kernel010, &rhou1_B0_p[0] + base13 + n_x*1 + n_y * xdim13_opensbliblock00Kernel010*1);
        //USER CODE
   ...
   Wall = ((Grid_0 >= -6 + block0np0_sycl[0] || Grid_0 <= 5 || Grid_1 <= 5) ? (
   0
)
: (
   1
    ...
    WENO_filter_B0(0,0) = ((cl::sycl::fmax(kappa_B0(0,1), cl::sycl::fmax(kappa_B0(2,0), cl::sycl::fmax(kappa_B0(1,0), cl::sycl::fmax(kappa_B0(-1,0),
      cl::sycl::fmax(kappa_B0(0,0), cl::sycl::fmax(kappa_B0(0,2), kappa_B0(0,-1))))))) >= Ducros_select_sycl[0]) ? (
   1
)
: (
   0.0
    ...
    rho_B0(0,0) = (-(-wk0_B0(-1,0) + wk0_B0(0,0))*inv_rfact0_block0_sycl[0] - (-Residual0_B0(0,-1) +
      Residual0_B0(0,0))*inv_rfact1_block0_sycl[0]*Wall)*dt_sycl[0]*WENO_filter_B0(0,0) + rho_B0(0,0);

    rhou0_B0(0,0) = (-(-wk1_B0(-1,0) + wk1_B0(0,0))*inv_rfact0_block0_sycl[0] - (-Residual1_B0(0,-1) +
      Residual1_B0(0,0))*inv_rfact1_block0_sycl[0]*Wall)*dt_sycl[0]*WENO_filter_B0(0,0) + rhou0_B0(0,0);

    rhou1_B0(0,0) = (-(-wk2_B0(-1,0) + wk2_B0(0,0))*inv_rfact0_block0_sycl[0] - (-Residual2_B0(0,-1) +
      Residual2_B0(0,0))*inv_rfact1_block0_sycl[0]*Wall)*dt_sycl[0]*WENO_filter_B0(0,0) + rhou1_B0(0,0);

    rhoE_B0(0,0) = (-(-wk3_B0(-1,0) + wk3_B0(0,0))*inv_rfact0_block0_sycl[0] - (-Residual3_B0(0,-1) +
      Residual3_B0(0,0))*inv_rfact1_block0_sycl[0]*Wall)*dt_sycl[0]*WENO_filter_B0(0,0) + rhoE_B0(0,0);
