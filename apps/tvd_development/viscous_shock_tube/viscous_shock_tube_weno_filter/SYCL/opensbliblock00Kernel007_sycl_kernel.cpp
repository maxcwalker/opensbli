  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      , [=](cl::sycl::nd_item<2> item
        ...
        ACC<double> Residual0_B0(xdim0_opensbliblock00Kernel007, &Residual0_B0_p[0] + base0 + n_x*1 + n_y * xdim0_opensbliblock00Kernel007*1);
        ACC<double> Residual1_B0(xdim1_opensbliblock00Kernel007, &Residual1_B0_p[0] + base1 + n_x*1 + n_y * xdim1_opensbliblock00Kernel007*1);
        ACC<double> Residual2_B0(xdim2_opensbliblock00Kernel007, &Residual2_B0_p[0] + base2 + n_x*1 + n_y * xdim2_opensbliblock00Kernel007*1);
        ACC<double> Residual3_B0(xdim3_opensbliblock00Kernel007, &Residual3_B0_p[0] + base3 + n_x*1 + n_y * xdim3_opensbliblock00Kernel007*1);
        ACC<double> wk0_B0(xdim4_opensbliblock00Kernel007, &wk0_B0_p[0] + base4 + n_x*1 + n_y * xdim4_opensbliblock00Kernel007*1);
        ACC<double> wk1_B0(xdim5_opensbliblock00Kernel007, &wk1_B0_p[0] + base5 + n_x*1 + n_y * xdim5_opensbliblock00Kernel007*1);
        ACC<double> wk2_B0(xdim6_opensbliblock00Kernel007, &wk2_B0_p[0] + base6 + n_x*1 + n_y * xdim6_opensbliblock00Kernel007*1);
        ACC<double> wk3_B0(xdim7_opensbliblock00Kernel007, &wk3_B0_p[0] + base7 + n_x*1 + n_y * xdim7_opensbliblock00Kernel007*1);
        //USER CODE
