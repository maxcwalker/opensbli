  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      , [=](cl::sycl::nd_item<2> item
        ...
        ACC<double> rhoE_B0(xdim0_opensbliblock00Kernel031, &rhoE_B0_p[0] + base0 + n_x*1 + n_y * xdim0_opensbliblock00Kernel031*1);
        ACC<double> rho_B0(xdim1_opensbliblock00Kernel031, &rho_B0_p[0] + base1 + n_x*1 + n_y * xdim1_opensbliblock00Kernel031*1);
        ACC<double> rhou0_B0(xdim2_opensbliblock00Kernel031, &rhou0_B0_p[0] + base2 + n_x*1 + n_y * xdim2_opensbliblock00Kernel031*1);
        ACC<double> rhou1_B0(xdim3_opensbliblock00Kernel031, &rhou1_B0_p[0] + base3 + n_x*1 + n_y * xdim3_opensbliblock00Kernel031*1);
        //USER CODE
   ...
   rhou1_B0(0,-4) = -rhou1_B0(0,4);
    ...
    rhoE_B0(0,0) = (-(9.0/11.0)*(-1 + gama_sycl[0])*(-(((1.0/2.0))*(rhou0_B0(0,2)*rhou0_B0(0,2)) +
      ((1.0/2.0))*(rhou1_B0(0,2)*rhou1_B0(0,2)))/rho_B0(0,2) + rhoE_B0(0,2))*gama_sycl[0]/(inv2Minf_sycl[0]*rho_B0(0,2)) +
      ((2.0/11.0))*(-1 + gama_sycl[0])*(-(((1.0/2.0))*(rhou0_B0(0,3)*rhou0_B0(0,3)) +
      ((1.0/2.0))*(rhou1_B0(0,3)*rhou1_B0(0,3)))/rho_B0(0,3) + rhoE_B0(0,3))*gama_sycl[0]/(inv2Minf_sycl[0]*rho_B0(0,3)) +
      ((18.0/11.0))*(-1 + gama_sycl[0])*(-(((1.0/2.0))*(rhou0_B0(0,1)*rhou0_B0(0,1)) +
      ((1.0/2.0))*(rhou1_B0(0,1)*rhou1_B0(0,1)))/rho_B0(0,1) +
      rhoE_B0(0,1))*gama_sycl[0]/(inv2Minf_sycl[0]*rho_B0(0,1)))*invgama_sycl[0]*inv2Minf_sycl[0]*inv_gamma_m1_sycl[0]*rho_B0(0,0);
