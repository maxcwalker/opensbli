 ...
 arg5, arg6, arg7, arg8};
  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      cgh.parallel_for<class opensbliblock00Kernel003_kernel>(cl::sycl::nd_range<2>(cl::sycl::range<2>(
      ...
      , [=](cl::sycl::nd_item<2> item
        ...
        const ACC<double> rhoE_B0(xdim0_opensbliblock00Kernel003, &rhoE_B0_p[0] + base0 + n_x*1 + n_y * xdim0_opensbliblock00Kernel003*1);
        const ACC<double> rho_B0(xdim1_opensbliblock00Kernel003, &rho_B0_p[0] + base1 + n_x*1 + n_y * xdim1_opensbliblock00Kernel003*1);
        const ACC<double> rhou0_B0(xdim2_opensbliblock00Kernel003, &rhou0_B0_p[0] + base2 + n_x*1 + n_y * xdim2_opensbliblock00Kernel003*1);
        const ACC<double> rhou1_B0(xdim3_opensbliblock00Kernel003, &rhou1_B0_p[0] + base3 + n_x*1 + n_y * xdim3_opensbliblock00Kernel003*1);
        ACC<double> a_B0(xdim4_opensbliblock00Kernel003, &a_B0_p[0] + base4 + n_x*1 + n_y * xdim4_opensbliblock00Kernel003*1);
        ACC<double> kappa_B0(xdim5_opensbliblock00Kernel003, &kappa_B0_p[0] + base5 + n_x*1 + n_y * xdim5_opensbliblock00Kernel003*1);
        ACC<double> u0_B0(xdim6_opensbliblock00Kernel003, &u0_B0_p[0] + base6 + n_x*1 + n_y * xdim6_opensbliblock00Kernel003*1);
        ACC<double> u1_B0(xdim7_opensbliblock00Kernel003, &u1_B0_p[0] + base7 + n_x*1 + n_y * xdim7_opensbliblock00Kernel003*1);
        ACC<double> p_B0(xdim8_opensbliblock00Kernel003, &p_B0_p[0] + base8 + n_x*1 + n_y * xdim8_opensbliblock00Kernel003*1);
        //USER CODE
