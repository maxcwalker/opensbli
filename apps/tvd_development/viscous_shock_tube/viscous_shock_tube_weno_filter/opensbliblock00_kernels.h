...
void opensbliblock00Kernel011(const ACC<double> &u0_B0, ACC<double> &wk0_B0, const int *idx)
{
   if (idx[0] == 0){
...
void opensbliblock00Kernel013(const ACC<double> &u1_B0, ACC<double> &wk1_B0, const int *idx)
{
   if (idx[0] == 0){
...
void opensbliblock00Kernel015(const ACC<double> &u2_B0, ACC<double> &wk2_B0, const int *idx)
{
   if (idx[0] == 0){
...
void opensbliblock00Kernel017(const ACC<double> &u0_B0, ACC<double> &wk3_B0, const int *idx)
{
   if (idx[1] == 0){
...
void opensbliblock00Kernel018(const ACC<double> &u1_B0, ACC<double> &wk4_B0, const int *idx)
{
   if (idx[1] == 0){
...
void opensbliblock00Kernel019(const ACC<double> &u2_B0, ACC<double> &wk5_B0, const int *idx)
{
   if (idx[1] == 0){
 ...
 void opensbliblock00Kernel027(const ACC<double> &p_B0, const ACC<double> &rhoE_B0, const ACC<double> &rhou0_B0, const
...
&Residual1_B0, ACC<double> &Residual2_B0, ACC<double> &Residual3_B0, const int *idx)
{
 ...
 void opensbliblock00Kernel028(const ACC<double> &T_B0, const ACC<double> &u0_B0, const ACC<double> &u1_B0, const
...
&Residual1_B0, ACC<double> &Residual2_B0, ACC<double> &Residual3_B0, const int *idx)
{
 ...
 void opensbliblock00Kernel034(const ACC<double> &Residual0_B0, const ACC<double> &Residual1_B0, const ACC<double>
...
: (
 ...
 void opensbliblock00Kernel007(ACC<double> &Residual0_B0, ACC<double> &Residual1_B0, ACC<double> &Residual2_B0,
ACC<double> &Residual3_B0, ACC<double> &wk0_B0, ACC<double> &wk1_B0, ACC<double> &wk2_B0, ACC<double> &wk3_B0)
{
 ...
 void opensbliblock00Kernel008(const ACC<double> &a_B0, const ACC<double> &kappa_B0, const ACC<double> &p_B0, const
...
&wk3_B0)
{
   ...
   double rj2 = 0.0;
   double rj3 = 0.0;
    if (fmax(kappa_B0(2,0), fmax(kappa_B0(1,0), fmax(kappa_B0(-3,0), fmax(kappa_B0(-2,0), fmax(kappa_B0(-1,0),
      kappa_B0(0,0)))))) > Ducros_check){
      ...
      max_lambda_00 = shock_filter_control*fmax(fabs(u0_B0(0,0)), fabs(u0_B0(1,0)));
 ...
 void opensbliblock00Kernel009(const ACC<double> &a_B0, const ACC<double> &kappa_B0, const ACC<double> &p_B0, const
ACC<double> &rhoE_B0, const ACC<double> &rho_B0, const ACC<double> &rhou0_B0, const ACC<double> &rhou1_B0, const
...
&Residual2_B0, ACC<double> &Residual3_B0)
{
   ...
   double rj2 = 0.0;
   double rj3 = 0.0;
    if (fmax(kappa_B0(0,1), fmax(kappa_B0(0,-3), fmax(kappa_B0(0,-1), fmax(kappa_B0(0,0), fmax(kappa_B0(0,2),
      kappa_B0(0,-2)))))) > Ducros_check){
      ...
      max_lambda_33 = shock_filter_control*fmax(fabs(-u1_B0(0,0) + a_B0(0,0)), fabs(-u1_B0(0,1) + a_B0(0,1)));
 ...
 void opensbliblock00Kernel010(const ACC<double> &Residual0_B0, const ACC<double> &Residual1_B0, const ACC<double>
&Residual2_B0, const ACC<double> &Residual3_B0, const ACC<double> &kappa_B0, const ACC<double> &wk0_B0, const
ACC<double> &wk1_B0, const ACC<double> &wk2_B0, const ACC<double> &wk3_B0, ACC<double> &WENO_filter_B0, ACC<double>
