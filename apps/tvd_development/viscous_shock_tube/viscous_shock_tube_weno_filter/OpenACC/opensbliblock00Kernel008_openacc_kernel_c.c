...
int xdim2_opensbliblock00Kernel008;
int xdim3_opensbliblock00Kernel008;
int xdim4_opensbliblock00Kernel008;
int xdim5_opensbliblock00Kernel008;
int xdim6_opensbliblock00Kernel008;
int xdim7_opensbliblock00Kernel008;
int xdim8_opensbliblock00Kernel008;
int xdim9_opensbliblock00Kernel008;
int xdim10_opensbliblock00Kernel008;
int xdim11_opensbliblock00Kernel008;
int xdim12_opensbliblock00Kernel008;

//user function
inline 
 void opensbliblock00Kernel008(const ptr_double a_B0,
  ...
  ptr_double wk3_B0)
{
   ...
   double rj2 = 0.0;
   double rj3 = 0.0;
    if (fmax(OPS_ACC(kappa_B0, 2,0), fmax(OPS_ACC(kappa_B0, 1,0), fmax(OPS_ACC(kappa_B0, -3,0), fmax(OPS_ACC(kappa_B0, -2,0), fmax(OPS_ACC(kappa_B0, -1,0),
      OPS_ACC(kappa_B0, 0,0)))))) > Ducros_check){
      ...
      AVG_0_0_LEV_33 = 0.707106781186547*gamma_m1*inv_AVG_a*inv_AVG_rho;
       ...
       CF_00 = OPS_ACC(p_B0, -2,0)*AVG_0_0_LEV_01 + OPS_ACC(rhou0_B0, -2,0)*AVG_0_0_LEV_00 + OPS_ACC(p_B0, -2,0)*OPS_ACC(u0_B0, -2,0)*AVG_0_0_LEV_03 +
      ...
      CF_10 = OPS_ACC(rhou0_B0, -2,0)*AVG_0_0_LEV_10 + OPS_ACC(u0_B0, -2,0)*OPS_ACC(rhou1_B0, -2,0)*AVG_0_0_LEV_12;

       CF_20 = OPS_ACC(p_B0, -2,0)*AVG_0_0_LEV_21 + OPS_ACC(rhou0_B0, -2,0)*AVG_0_0_LEV_20 + OPS_ACC(p_B0, -2,0)*OPS_ACC(u0_B0, -2,0)*AVG_0_0_LEV_23 +
       ...
       CF_30 = OPS_ACC(p_B0, -2,0)*AVG_0_0_LEV_31 + OPS_ACC(rhou0_B0, -2,0)*AVG_0_0_LEV_30 + OPS_ACC(p_B0, -2,0)*OPS_ACC(u0_B0, -2,0)*AVG_0_0_LEV_33 +
      ...
      CS_10 = OPS_ACC(rho_B0, -2,0)*AVG_0_0_LEV_10 + OPS_ACC(rhou1_B0, -2,0)*AVG_0_0_LEV_12;
       ...
       CF_01 = OPS_ACC(p_B0, -1,0)*AVG_0_0_LEV_01 + OPS_ACC(rhou0_B0, -1,0)*AVG_0_0_LEV_00 + OPS_ACC(p_B0, -1,0)*OPS_ACC(u0_B0, -1,0)*AVG_0_0_LEV_03 +
      ...
      CF_11 = OPS_ACC(rhou0_B0, -1,0)*AVG_0_0_LEV_10 + OPS_ACC(u0_B0, -1,0)*OPS_ACC(rhou1_B0, -1,0)*AVG_0_0_LEV_12;

       CF_21 = OPS_ACC(p_B0, -1,0)*AVG_0_0_LEV_21 + OPS_ACC(rhou0_B0, -1,0)*AVG_0_0_LEV_20 + OPS_ACC(p_B0, -1,0)*OPS_ACC(u0_B0, -1,0)*AVG_0_0_LEV_23 +
       ...
       CF_31 = OPS_ACC(p_B0, -1,0)*AVG_0_0_LEV_31 + OPS_ACC(rhou0_B0, -1,0)*AVG_0_0_LEV_30 + OPS_ACC(p_B0, -1,0)*OPS_ACC(u0_B0, -1,0)*AVG_0_0_LEV_33 +
      ...
      CS_11 = OPS_ACC(rho_B0, -1,0)*AVG_0_0_LEV_10 + OPS_ACC(rhou1_B0, -1,0)*AVG_0_0_LEV_12;
       ...
       CF_02 = OPS_ACC(p_B0, 0,0)*AVG_0_0_LEV_01 + OPS_ACC(rhou0_B0, 0,0)*AVG_0_0_LEV_00 + OPS_ACC(p_B0, 0,0)*OPS_ACC(u0_B0, 0,0)*AVG_0_0_LEV_03 +
      ...
      CF_12 = OPS_ACC(rhou0_B0, 0,0)*AVG_0_0_LEV_10 + OPS_ACC(u0_B0, 0,0)*OPS_ACC(rhou1_B0, 0,0)*AVG_0_0_LEV_12;

       CF_22 = OPS_ACC(p_B0, 0,0)*AVG_0_0_LEV_21 + OPS_ACC(rhou0_B0, 0,0)*AVG_0_0_LEV_20 + OPS_ACC(p_B0, 0,0)*OPS_ACC(u0_B0, 0,0)*AVG_0_0_LEV_23 +
       ...
       CF_32 = OPS_ACC(p_B0, 0,0)*AVG_0_0_LEV_31 + OPS_ACC(rhou0_B0, 0,0)*AVG_0_0_LEV_30 + OPS_ACC(p_B0, 0,0)*OPS_ACC(u0_B0, 0,0)*AVG_0_0_LEV_33 +
      ...
      CS_12 = OPS_ACC(rho_B0, 0,0)*AVG_0_0_LEV_10 + OPS_ACC(rhou1_B0, 0,0)*AVG_0_0_LEV_12;
       ...
       CF_03 = OPS_ACC(p_B0, 1,0)*AVG_0_0_LEV_01 + OPS_ACC(rhou0_B0, 1,0)*AVG_0_0_LEV_00 + OPS_ACC(p_B0, 1,0)*OPS_ACC(u0_B0, 1,0)*AVG_0_0_LEV_03 +
            OPS_ACC(u0_B0, 1,0)*OPS_ACC(rhoE_B0, 1,0)*AVG_0_0_LEV_03 + OPS_ACC(u0_B0, 1,0)*OPS_ACC(rhou0_B0, 1,0)*AVG_0_0_LEV_01 +
            OPS_ACC(u0_B0, 1,0)*OPS_ACC(rhou1_B0, 1,0)*AVG_0_0_LEV_02;

      CF_13 = OPS_ACC(rhou0_B0, 1,0)*AVG_0_0_LEV_10 + OPS_ACC(u0_B0, 1,0)*OPS_ACC(rhou1_B0, 1,0)*AVG_0_0_LEV_12;

       CF_23 = OPS_ACC(p_B0, 1,0)*AVG_0_0_LEV_21 + OPS_ACC(rhou0_B0, 1,0)*AVG_0_0_LEV_20 + OPS_ACC(p_B0, 1,0)*OPS_ACC(u0_B0, 1,0)*AVG_0_0_LEV_23 +
            OPS_ACC(u0_B0, 1,0)*OPS_ACC(rhoE_B0, 1,0)*AVG_0_0_LEV_23 + OPS_ACC(u0_B0, 1,0)*OPS_ACC(rhou0_B0, 1,0)*AVG_0_0_LEV_21 +
            OPS_ACC(u0_B0, 1,0)*OPS_ACC(rhou1_B0, 1,0)*AVG_0_0_LEV_22;

       CF_33 = OPS_ACC(p_B0, 1,0)*AVG_0_0_LEV_31 + OPS_ACC(rhou0_B0, 1,0)*AVG_0_0_LEV_30 + OPS_ACC(p_B0, 1,0)*OPS_ACC(u0_B0, 1,0)*AVG_0_0_LEV_33 +
            OPS_ACC(u0_B0, 1,0)*OPS_ACC(rhoE_B0, 1,0)*AVG_0_0_LEV_33 + OPS_ACC(u0_B0, 1,0)*OPS_ACC(rhou0_B0, 1,0)*AVG_0_0_LEV_31 +
            OPS_ACC(u0_B0, 1,0)*OPS_ACC(rhou1_B0, 1,0)*AVG_0_0_LEV_32;
      ...
      CS_13 = OPS_ACC(rho_B0, 1,0)*AVG_0_0_LEV_10 + OPS_ACC(rhou1_B0, 1,0)*AVG_0_0_LEV_12;
       ...
       CF_04 = OPS_ACC(p_B0, 2,0)*AVG_0_0_LEV_01 + OPS_ACC(rhou0_B0, 2,0)*AVG_0_0_LEV_00 + OPS_ACC(p_B0, 2,0)*OPS_ACC(u0_B0, 2,0)*AVG_0_0_LEV_03 +
            OPS_ACC(u0_B0, 2,0)*OPS_ACC(rhoE_B0, 2,0)*AVG_0_0_LEV_03 + OPS_ACC(u0_B0, 2,0)*OPS_ACC(rhou0_B0, 2,0)*AVG_0_0_LEV_01 +
            OPS_ACC(u0_B0, 2,0)*OPS_ACC(rhou1_B0, 2,0)*AVG_0_0_LEV_02;

      CF_14 = OPS_ACC(rhou0_B0, 2,0)*AVG_0_0_LEV_10 + OPS_ACC(u0_B0, 2,0)*OPS_ACC(rhou1_B0, 2,0)*AVG_0_0_LEV_12;

       CF_24 = OPS_ACC(p_B0, 2,0)*AVG_0_0_LEV_21 + OPS_ACC(rhou0_B0, 2,0)*AVG_0_0_LEV_20 + OPS_ACC(p_B0, 2,0)*OPS_ACC(u0_B0, 2,0)*AVG_0_0_LEV_23 +
            OPS_ACC(u0_B0, 2,0)*OPS_ACC(rhoE_B0, 2,0)*AVG_0_0_LEV_23 + OPS_ACC(u0_B0, 2,0)*OPS_ACC(rhou0_B0, 2,0)*AVG_0_0_LEV_21 +
            OPS_ACC(u0_B0, 2,0)*OPS_ACC(rhou1_B0, 2,0)*AVG_0_0_LEV_22;

       CF_34 = OPS_ACC(p_B0, 2,0)*AVG_0_0_LEV_31 + OPS_ACC(rhou0_B0, 2,0)*AVG_0_0_LEV_30 + OPS_ACC(p_B0, 2,0)*OPS_ACC(u0_B0, 2,0)*AVG_0_0_LEV_33 +
            OPS_ACC(u0_B0, 2,0)*OPS_ACC(rhoE_B0, 2,0)*AVG_0_0_LEV_33 + OPS_ACC(u0_B0, 2,0)*OPS_ACC(rhou0_B0, 2,0)*AVG_0_0_LEV_31 +
            OPS_ACC(u0_B0, 2,0)*OPS_ACC(rhou1_B0, 2,0)*AVG_0_0_LEV_32;
      ...
      CS_14 = OPS_ACC(rho_B0, 2,0)*AVG_0_0_LEV_10 + OPS_ACC(rhou1_B0, 2,0)*AVG_0_0_LEV_12;
       ...
       CF_05 = OPS_ACC(p_B0, 3,0)*AVG_0_0_LEV_01 + OPS_ACC(rhou0_B0, 3,0)*AVG_0_0_LEV_00 + OPS_ACC(p_B0, 3,0)*OPS_ACC(u0_B0, 3,0)*AVG_0_0_LEV_03 +
      ...
      CF_15 = OPS_ACC(rhou0_B0, 3,0)*AVG_0_0_LEV_10 + OPS_ACC(u0_B0, 3,0)*OPS_ACC(rhou1_B0, 3,0)*AVG_0_0_LEV_12;

       CF_25 = OPS_ACC(p_B0, 3,0)*AVG_0_0_LEV_21 + OPS_ACC(rhou0_B0, 3,0)*AVG_0_0_LEV_20 + OPS_ACC(p_B0, 3,0)*OPS_ACC(u0_B0, 3,0)*AVG_0_0_LEV_23 +
       ...
       CF_35 = OPS_ACC(p_B0, 3,0)*AVG_0_0_LEV_31 + OPS_ACC(rhou0_B0, 3,0)*AVG_0_0_LEV_30 + OPS_ACC(p_B0, 3,0)*OPS_ACC(u0_B0, 3,0)*AVG_0_0_LEV_33 +
      ...
      max_lambda_00 = shock_filter_control*fmax(fabs(OPS_ACC(u0_B0, 0,0)), fabs(OPS_ACC(u0_B0, 1,0)));

      max_lambda_11 = max_lambda_00;

      max_lambda_22 = shock_filter_control*fmax(fabs(OPS_ACC(a_B0, 0,0) + OPS_ACC(u0_B0, 0,0)), fabs(OPS_ACC(a_B0, 1,0) + OPS_ACC(u0_B0, 1,0)));

      max_lambda_33 = shock_filter_control*fmax(fabs(-OPS_ACC(u0_B0, 1,0) + OPS_ACC(a_B0, 1,0)), fabs(-OPS_ACC(u0_B0, 0,0) + OPS_ACC(a_B0, 0,0)));
...
void opensbliblock00Kernel008_c_wrapper(
  ...
  for ( int n_y=0; n_y<y_size; n_y++ ){
    ...
    for ( int n_x=0; n_x<x_size; n_x++ ){
      const ptr_double ptr0 = {  p_a0 + n_x*1*1 + n_y*xdim0_opensbliblock00Kernel008*1*1, xdim0_opensbliblock00Kernel008};
      const ptr_double ptr1 = {  p_a1 + n_x*1*1 + n_y*xdim1_opensbliblock00Kernel008*1*1, xdim1_opensbliblock00Kernel008};
      const ptr_double ptr2 = {  p_a2 + n_x*1*1 + n_y*xdim2_opensbliblock00Kernel008*1*1, xdim2_opensbliblock00Kernel008};
      const ptr_double ptr3 = {  p_a3 + n_x*1*1 + n_y*xdim3_opensbliblock00Kernel008*1*1, xdim3_opensbliblock00Kernel008};
      const ptr_double ptr4 = {  p_a4 + n_x*1*1 + n_y*xdim4_opensbliblock00Kernel008*1*1, xdim4_opensbliblock00Kernel008};
      const ptr_double ptr5 = {  p_a5 + n_x*1*1 + n_y*xdim5_opensbliblock00Kernel008*1*1, xdim5_opensbliblock00Kernel008};
      const ptr_double ptr6 = {  p_a6 + n_x*1*1 + n_y*xdim6_opensbliblock00Kernel008*1*1, xdim6_opensbliblock00Kernel008};
      const ptr_double ptr7 = {  p_a7 + n_x*1*1 + n_y*xdim7_opensbliblock00Kernel008*1*1, xdim7_opensbliblock00Kernel008};
      const ptr_double ptr8 = {  p_a8 + n_x*1*1 + n_y*xdim8_opensbliblock00Kernel008*1*1, xdim8_opensbliblock00Kernel008};
      ptr_double ptr9 = {  p_a9 + n_x*1*1 + n_y*xdim9_opensbliblock00Kernel008*1*1, xdim9_opensbliblock00Kernel008};
      ptr_double ptr10 = {  p_a10 + n_x*1*1 + n_y*xdim10_opensbliblock00Kernel008*1*1, xdim10_opensbliblock00Kernel008};
      ptr_double ptr11 = {  p_a11 + n_x*1*1 + n_y*xdim11_opensbliblock00Kernel008*1*1, xdim11_opensbliblock00Kernel008};
      ptr_double ptr12 = {  p_a12 + n_x*1*1 + n_y*xdim12_opensbliblock00Kernel008*1*1, xdim12_opensbliblock00Kernel008};
