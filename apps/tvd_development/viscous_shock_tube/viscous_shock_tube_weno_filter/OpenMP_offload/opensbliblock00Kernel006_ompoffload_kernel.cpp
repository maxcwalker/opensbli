...
void ops_par_loop_opensbliblock00Kernel006_execute(ops_kernel_descriptor *desc) {
  ...
  double * __restrict__ u1_B0_p = (double *)(args[1].data_d + base1);
  ...
  for ( int n_y=start1; n_y<end1; n_y++ ){
    for ( int n_x=start0; n_x<end0; n_x++ ){
      ...
      const ACC<double> u0_B0(xdim0_opensbliblock00Kernel006, u0_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel006*1);
      const ACC<double> u1_B0(xdim1_opensbliblock00Kernel006, u1_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel006*1);
      ACC<double> kappa_B0(xdim2_opensbliblock00Kernel006, kappa_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel006*1);
...
void ops_par_loop_opensbliblock00Kernel006(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2, ops_arg arg3) {
  ...
  create_kerneldesc_and_enque(name, args, 4, 19, dim, 0, range, block, ops_par_loop_opensbliblock00Kernel006_execute);
}
#endif
