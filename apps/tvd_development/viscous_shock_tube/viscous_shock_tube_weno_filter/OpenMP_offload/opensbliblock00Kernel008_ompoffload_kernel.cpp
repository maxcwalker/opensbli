...
void ops_par_loop_opensbliblock00Kernel008_execute(ops_kernel_descriptor *desc) {
  ...
  double * __restrict__ kappa_B0_p = (double *)(args[1].data_d + base1);
  ...
  for ( int n_y=start1; n_y<end1; n_y++ ){
    for ( int n_x=start0; n_x<end0; n_x++ ){
      const ACC<double> a_B0(xdim0_opensbliblock00Kernel008, a_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel008*1);
      const ACC<double> kappa_B0(xdim1_opensbliblock00Kernel008, kappa_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel008*1);
      const ACC<double> p_B0(xdim2_opensbliblock00Kernel008, p_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel008*1);
      const ACC<double> rhoE_B0(xdim3_opensbliblock00Kernel008, rhoE_B0_p + n_x*1 + n_y * xdim3_opensbliblock00Kernel008*1);
      const ACC<double> rho_B0(xdim4_opensbliblock00Kernel008, rho_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel008*1);
      const ACC<double> rhou0_B0(xdim5_opensbliblock00Kernel008, rhou0_B0_p + n_x*1 + n_y * xdim5_opensbliblock00Kernel008*1);
      const ACC<double> rhou1_B0(xdim6_opensbliblock00Kernel008, rhou1_B0_p + n_x*1 + n_y * xdim6_opensbliblock00Kernel008*1);
      const ACC<double> u0_B0(xdim7_opensbliblock00Kernel008, u0_B0_p + n_x*1 + n_y * xdim7_opensbliblock00Kernel008*1);
      const ACC<double> u1_B0(xdim8_opensbliblock00Kernel008, u1_B0_p + n_x*1 + n_y * xdim8_opensbliblock00Kernel008*1);
      ACC<double> wk0_B0(xdim9_opensbliblock00Kernel008, wk0_B0_p + n_x*1 + n_y * xdim9_opensbliblock00Kernel008*1);
      ACC<double> wk1_B0(xdim10_opensbliblock00Kernel008, wk1_B0_p + n_x*1 + n_y * xdim10_opensbliblock00Kernel008*1);
      ACC<double> wk2_B0(xdim11_opensbliblock00Kernel008, wk2_B0_p + n_x*1 + n_y * xdim11_opensbliblock00Kernel008*1);
      ACC<double> wk3_B0(xdim12_opensbliblock00Kernel008, wk3_B0_p + n_x*1 + n_y * xdim12_opensbliblock00Kernel008*1);
...
void ops_par_loop_opensbliblock00Kernel008(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg12) {
  ...
  create_kerneldesc_and_enque(name, args, 13, 21, dim, 0, range, block, ops_par_loop_opensbliblock00Kernel008_execute);
}
#endif
