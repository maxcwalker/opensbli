...
void ops_par_loop_opensbliblock00Kernel009_execute(ops_kernel_descriptor *desc) {
  ...
  for ( int n_y=start1; n_y<end1; n_y++ ){
    for ( int n_x=start0; n_x<end0; n_x++ ){
      const ACC<double> a_B0(xdim0_opensbliblock00Kernel009, a_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel009*1);
      const ACC<double> kappa_B0(xdim1_opensbliblock00Kernel009, kappa_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel009*1);
      const ACC<double> p_B0(xdim2_opensbliblock00Kernel009, p_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel009*1);
      const ACC<double> rhoE_B0(xdim3_opensbliblock00Kernel009, rhoE_B0_p + n_x*1 + n_y * xdim3_opensbliblock00Kernel009*1);
      const ACC<double> rho_B0(xdim4_opensbliblock00Kernel009, rho_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel009*1);
      const ACC<double> rhou0_B0(xdim5_opensbliblock00Kernel009, rhou0_B0_p + n_x*1 + n_y * xdim5_opensbliblock00Kernel009*1);
      const ACC<double> rhou1_B0(xdim6_opensbliblock00Kernel009, rhou1_B0_p + n_x*1 + n_y * xdim6_opensbliblock00Kernel009*1);
      const ACC<double> u0_B0(xdim7_opensbliblock00Kernel009, u0_B0_p + n_x*1 + n_y * xdim7_opensbliblock00Kernel009*1);
      const ACC<double> u1_B0(xdim8_opensbliblock00Kernel009, u1_B0_p + n_x*1 + n_y * xdim8_opensbliblock00Kernel009*1);
      ACC<double> Residual0_B0(xdim9_opensbliblock00Kernel009, Residual0_B0_p + n_x*1 + n_y * xdim9_opensbliblock00Kernel009*1);
      ACC<double> Residual1_B0(xdim10_opensbliblock00Kernel009, Residual1_B0_p + n_x*1 + n_y * xdim10_opensbliblock00Kernel009*1);
      ACC<double> Residual2_B0(xdim11_opensbliblock00Kernel009, Residual2_B0_p + n_x*1 + n_y * xdim11_opensbliblock00Kernel009*1);
      ACC<double> Residual3_B0(xdim12_opensbliblock00Kernel009, Residual3_B0_p + n_x*1 + n_y * xdim12_opensbliblock00Kernel009*1);
...
void ops_par_loop_opensbliblock00Kernel009(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg12) {
  ...
  create_kerneldesc_and_enque(name, args, 13, 22, dim, 0, range, block, ops_par_loop_opensbliblock00Kernel009_execute);
}
#endif
