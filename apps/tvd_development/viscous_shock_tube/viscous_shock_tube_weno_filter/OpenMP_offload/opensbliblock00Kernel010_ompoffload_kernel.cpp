...
void ops_par_loop_opensbliblock00Kernel010_execute(ops_kernel_descriptor *desc) {
  ...
  double * __restrict__ WENO_filter_B0_p = (double *)(args[9].data_d + base9);

  int base10 = args[10].dat->base_offset;
  double * __restrict__ rhoE_B0_p = (double *)(args[10].data_d + base10);

  int base11 = args[11].dat->base_offset;
  double * __restrict__ rho_B0_p = (double *)(args[11].data_d + base11);

  int base12 = args[12].dat->base_offset;
  double * __restrict__ rhou0_B0_p = (double *)(args[12].data_d + base12);

  int base13 = args[13].dat->base_offset;
  double * __restrict__ rhou1_B0_p = (double *)(args[13].data_d + base13);
  ...
  for ( int n_y=start1; n_y<end1; n_y++ ){
    for ( int n_x=start0; n_x<end0; n_x++ ){
      ...
      const ACC<double> Residual0_B0(xdim0_opensbliblock00Kernel010, Residual0_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel010*1);
      const ACC<double> Residual1_B0(xdim1_opensbliblock00Kernel010, Residual1_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel010*1);
      const ACC<double> Residual2_B0(xdim2_opensbliblock00Kernel010, Residual2_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel010*1);
      const ACC<double> Residual3_B0(xdim3_opensbliblock00Kernel010, Residual3_B0_p + n_x*1 + n_y * xdim3_opensbliblock00Kernel010*1);
      const ACC<double> kappa_B0(xdim4_opensbliblock00Kernel010, kappa_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel010*1);
      const ACC<double> wk0_B0(xdim5_opensbliblock00Kernel010, wk0_B0_p + n_x*1 + n_y * xdim5_opensbliblock00Kernel010*1);
      const ACC<double> wk1_B0(xdim6_opensbliblock00Kernel010, wk1_B0_p + n_x*1 + n_y * xdim6_opensbliblock00Kernel010*1);
      const ACC<double> wk2_B0(xdim7_opensbliblock00Kernel010, wk2_B0_p + n_x*1 + n_y * xdim7_opensbliblock00Kernel010*1);
      const ACC<double> wk3_B0(xdim8_opensbliblock00Kernel010, wk3_B0_p + n_x*1 + n_y * xdim8_opensbliblock00Kernel010*1);
      ACC<double> WENO_filter_B0(xdim9_opensbliblock00Kernel010, WENO_filter_B0_p + n_x*1 + n_y * xdim9_opensbliblock00Kernel010*1);
      ACC<double> rhoE_B0(xdim10_opensbliblock00Kernel010, rhoE_B0_p + n_x*1 + n_y * xdim10_opensbliblock00Kernel010*1);
      ACC<double> rho_B0(xdim11_opensbliblock00Kernel010, rho_B0_p + n_x*1 + n_y * xdim11_opensbliblock00Kernel010*1);
      ACC<double> rhou0_B0(xdim12_opensbliblock00Kernel010, rhou0_B0_p + n_x*1 + n_y * xdim12_opensbliblock00Kernel010*1);
      ACC<double> rhou1_B0(xdim13_opensbliblock00Kernel010, rhou1_B0_p + n_x*1 + n_y * xdim13_opensbliblock00Kernel010*1);
...
void ops_par_loop_opensbliblock00Kernel010(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg12, ops_arg arg13, ops_arg arg14) {
  ...
  create_kerneldesc_and_enque(name, args, 15, 23, dim, 0, range, block, ops_par_loop_opensbliblock00Kernel010_execute);
}
#endif
