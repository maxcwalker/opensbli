...
//
__constant__ int dims_opensbliblock00Kernel017 [11][1];
static int dims_opensbliblock00Kernel017_h [11][1] = {{0}};
...
int size1 ){
  ...
  if (idx_x < size0 && idx_y < size1) {
    ...
    ACC<double> argp7(dims_opensbliblock00Kernel017[7][0], arg7);
    ACC<double> argp8(dims_opensbliblock00Kernel017[8][0], arg8);
...
void ops_par_loop_opensbliblock00Kernel017(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg8, ops_arg arg9, ops_arg arg10) {
  ...
  create_kerneldesc_and_enque(name, args, 11, 16, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel017_execute);
}
#endif
