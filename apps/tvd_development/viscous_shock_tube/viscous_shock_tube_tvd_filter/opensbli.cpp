...
if (restart == 0){
int iteration_range_34_block0[] = {-5, block0np0 + 5, -5, block0np1 + 5};
ops_par_loop(opensbliblock00Kernel034, "Grid_based_initialisation0", opensbliblock00, 2, iteration_range_34_block0,
...
ops_par_loop(opensbliblock00Kernel030, "AdiabaticWall boundary dir0 side0", opensbliblock00, 2, iteration_range_30_block0,
...
ops_par_loop(opensbliblock00Kernel031, "AdiabaticWall boundary dir0 side1", opensbliblock00, 2, iteration_range_31_block0,
...
ops_par_loop(opensbliblock00Kernel032, "AdiabaticWall boundary dir1 side0", opensbliblock00, 2, iteration_range_32_block0,
...
ops_par_loop(opensbliblock00Kernel033, "Symmetry boundary dir1 side1", opensbliblock00, 2, iteration_range_33_block0,
...
ops_par_loop(opensbliblock00Kernel013, "CRu0_B0", opensbliblock00, 2, iteration_range_13_block0,
...
ops_par_loop(opensbliblock00Kernel022, "CRp_B0", opensbliblock00, 2, iteration_range_22_block0,
...
ops_par_loop(opensbliblock00Kernel025, "CRT_B0", opensbliblock00, 2, iteration_range_25_block0,
ops_arg_dat(p_B0, 1, stencil_0_00_00_2, "double", OPS_READ),
ops_arg_dat(rho_B0, 1, stencil_0_00_00_2, "double", OPS_READ),
ops_arg_dat(T_B0, 1, stencil_0_00_00_2, "double", OPS_WRITE));

int iteration_range_12_block0[] = {0, block0np0, -2, block0np1 + 2};
ops_par_loop(opensbliblock00Kernel012, "Derivative evaluation CD u0_B0 x0 ", opensbliblock00, 2, iteration_range_12_block0,
...
ops_par_loop(opensbliblock00Kernel014, "Derivative evaluation CD u1_B0 x0 ", opensbliblock00, 2, iteration_range_14_block0,
...
ops_par_loop(opensbliblock00Kernel016, "Derivative evaluation CD u2_B0 x0 ", opensbliblock00, 2, iteration_range_16_block0,
...
ops_par_loop(opensbliblock00Kernel018, "Derivative evaluation CD u0_B0 x1 ", opensbliblock00, 2, iteration_range_18_block0,
...
ops_par_loop(opensbliblock00Kernel019, "Derivative evaluation CD u1_B0 x1 ", opensbliblock00, 2, iteration_range_19_block0,
...
ops_par_loop(opensbliblock00Kernel020, "Derivative evaluation CD u2_B0 x1 ", opensbliblock00, 2, iteration_range_20_block0,
...
ops_par_loop(opensbliblock00Kernel028, "Convective terms", opensbliblock00, 2, iteration_range_28_block0,
ops_arg_dat(p_B0, 1, stencil_0_44_24_16, "double", OPS_READ),
ops_arg_dat(rhoE_B0, 1, stencil_0_44_24_16, "double", OPS_READ),
...
ops_par_loop(opensbliblock00Kernel029, "Viscous terms", opensbliblock00, 2, iteration_range_29_block0,
...
ops_par_loop(opensbliblock00Kernel035, "Temporal solution advancement", opensbliblock00, 2, iteration_range_35_block0,
...
int iteration_range_3_block0[] = {-1, block0np0 + 2, -1, block0np1 + 2};
ops_par_loop(opensbliblock00Kernel003, "User kernel: Constituent Relations evaluation", opensbliblock00, 2, iteration_range_3_block0,
ops_arg_dat(rhoE_B0, 1, stencil_0_00_00_2, "double", OPS_READ),
ops_arg_dat(rho_B0, 1, stencil_0_00_00_2, "double", OPS_READ),
ops_arg_dat(rhou0_B0, 1, stencil_0_00_00_2, "double", OPS_READ),
ops_arg_dat(rhou1_B0, 1, stencil_0_00_00_2, "double", OPS_READ),
...
ops_par_loop(opensbliblock00Kernel006, "UserDefinedEquations evaluation", opensbliblock00, 2, iteration_range_6_block0,
ops_arg_dat(u0_B0, 1, stencil_0_44_24_16, "double", OPS_READ),
ops_arg_dat(u1_B0, 1, stencil_0_44_24_16, "double", OPS_READ),
ops_arg_dat(kappa_B0, 1, stencil_0_00_00_2, "double", OPS_WRITE),
ops_arg_idx());

int iteration_range_7_block0[] = {-1, block0np0 + 2, -1, block0np1 + 2};
ops_par_loop(opensbliblock00Kernel007, "User kernel: Constituent Relations evaluation", opensbliblock00, 2, iteration_range_7_block0,
ops_arg_dat(rhoE_B0, 1, stencil_0_00_00_2, "double", OPS_READ),
ops_arg_dat(rho_B0, 1, stencil_0_00_00_2, "double", OPS_READ),
ops_arg_dat(rhou0_B0, 1, stencil_0_00_00_2, "double", OPS_READ),
ops_arg_dat(rhou1_B0, 1, stencil_0_00_00_2, "double", OPS_READ),
...
int iteration_range_8_block0[] = {-5, block0np0 + 5, -5, block0np1 + 5};
ops_par_loop(opensbliblock00Kernel008, "User kernel: Zero the work arrays", opensbliblock00, 2, iteration_range_8_block0,
ops_arg_dat(Residual0_B0, 1, stencil_0_00_00_2, "double", OPS_WRITE),
ops_arg_dat(Residual1_B0, 1, stencil_0_00_00_2, "double", OPS_WRITE),
ops_arg_dat(Residual2_B0, 1, stencil_0_00_00_2, "double", OPS_WRITE),
ops_arg_dat(Residual3_B0, 1, stencil_0_00_00_2, "double", OPS_WRITE),
...
int iteration_range_9_block0[] = {-1, block0np0 + 1, 0, block0np1};
ops_par_loop(opensbliblock00Kernel009, "User kernel: TVD reconstruction direction 0", opensbliblock00, 2, iteration_range_9_block0,
...
int iteration_range_10_block0[] = {0, block0np0, -1, block0np1 + 1};
ops_par_loop(opensbliblock00Kernel010, "User kernel: TVD reconstruction direction 1", opensbliblock00, 2, iteration_range_10_block0,
...
ops_par_loop(opensbliblock00Kernel011, "User kernel: Non-linear TVD Filter application", opensbliblock00, 2, iteration_range_11_block0,
