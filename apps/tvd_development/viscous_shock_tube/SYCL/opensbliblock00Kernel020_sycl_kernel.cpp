  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      , [=](cl::sycl::nd_item<2> item
        ...
        ACC<double> rhoE_B0(xdim0_opensbliblock00Kernel020, &rhoE_B0_p[0] + base0 + n_x*1 + n_y * xdim0_opensbliblock00Kernel020*1);
        ACC<double> rho_B0(xdim1_opensbliblock00Kernel020, &rho_B0_p[0] + base1 + n_x*1 + n_y * xdim1_opensbliblock00Kernel020*1);
        ACC<double> rhou0_B0(xdim2_opensbliblock00Kernel020, &rhou0_B0_p[0] + base2 + n_x*1 + n_y * xdim2_opensbliblock00Kernel020*1);
        ACC<double> rhou1_B0(xdim3_opensbliblock00Kernel020, &rhou1_B0_p[0] + base3 + n_x*1 + n_y * xdim3_opensbliblock00Kernel020*1);
        //USER CODE
