...
void ops_par_loop_opensbliblock00Kernel017_execute(ops_kernel_descriptor *desc) {
 ...
 arg10};
  ...
  double* wk0_B0_p = (double*)args[3].data_d;
  ...
  double* wk3_B0_p = (double*)args[5].data_d;
  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      auto mu_sycl = (*mu_p).template get_access<cl::sycl::access::mode::read>(cgh);
      ...
      , [=](cl::sycl::nd_item<2> item
        ...
        const ACC<double> T_B0(xdim0_opensbliblock00Kernel017, &T_B0_p[0] + base0 + n_x*1 + n_y * xdim0_opensbliblock00Kernel017*1);
        const ACC<double> u0_B0(xdim1_opensbliblock00Kernel017, &u0_B0_p[0] + base1 + n_x*1 + n_y * xdim1_opensbliblock00Kernel017*1);
        const ACC<double> u1_B0(xdim2_opensbliblock00Kernel017, &u1_B0_p[0] + base2 + n_x*1 + n_y * xdim2_opensbliblock00Kernel017*1);
        const ACC<double> wk0_B0(xdim3_opensbliblock00Kernel017, &wk0_B0_p[0] + base3 + n_x*1 + n_y * xdim3_opensbliblock00Kernel017*1);
        const ACC<double> wk1_B0(xdim4_opensbliblock00Kernel017, &wk1_B0_p[0] + base4 + n_x*1 + n_y * xdim4_opensbliblock00Kernel017*1);
        const ACC<double> wk3_B0(xdim5_opensbliblock00Kernel017, &wk3_B0_p[0] + base5 + n_x*1 + n_y * xdim5_opensbliblock00Kernel017*1);
        const ACC<double> wk4_B0(xdim6_opensbliblock00Kernel017, &wk4_B0_p[0] + base6 + n_x*1 + n_y * xdim6_opensbliblock00Kernel017*1);
        ACC<double> Residual1_B0(xdim7_opensbliblock00Kernel017, &Residual1_B0_p[0] + base7 + n_x*1 + n_y * xdim7_opensbliblock00Kernel017*1);
        ACC<double> Residual2_B0(xdim8_opensbliblock00Kernel017, &Residual2_B0_p[0] + base8 + n_x*1 + n_y * xdim8_opensbliblock00Kernel017*1);
        ACC<double> Residual3_B0(xdim9_opensbliblock00Kernel017, &Residual3_B0_p[0] + base9 + n_x*1 + n_y * xdim9_opensbliblock00Kernel017*1);
        //USER CODE
   ...
   Residual1_B0(0,0) = ((1.0/3.0))*(3*d2_u0_dy + 4*d2_u0_dx + d1_wk1_dy)*mu_sycl[0]*invRe_sycl[0] + Residual1_B0(0,0);

   Residual2_B0(0,0) = ((1.0/3.0))*(3*d2_u1_dx + 4*d2_u1_dy + d1_wk0_dy)*mu_sycl[0]*invRe_sycl[0] + Residual2_B0(0,0);

    Residual3_B0(0,0) = (wk1_B0(0,0) + wk3_B0(0,0))*mu_sycl[0]*invRe_sycl[0]*wk1_B0(0,0) + (wk1_B0(0,0) +
      wk3_B0(0,0))*mu_sycl[0]*invRe_sycl[0]*wk3_B0(0,0) - (2.0/3.0)*(-2*wk4_B0(0,0) + wk0_B0(0,0))*mu_sycl[0]*invRe_sycl[0]*wk4_B0(0,0) +
      ((1.0/3.0))*(3*d2_u0_dy + 4*d2_u0_dx + d1_wk1_dy)*mu_sycl[0]*invRe_sycl[0]*u0_B0(0,0) + ((1.0/3.0))*(3*d2_u1_dx + 4*d2_u1_dy +
      d1_wk0_dy)*mu_sycl[0]*invRe_sycl[0]*u1_B0(0,0) + ((2.0/3.0))*(-wk4_B0(0,0) + 2*wk0_B0(0,0))*mu_sycl[0]*invRe_sycl[0]*wk0_B0(0,0) + (d2_T_dx +
      d2_T_dy)*mu_sycl[0]*invPr_sycl[0]*invRe_sycl[0]*inv2Minf_sycl[0]*inv_gamma_m1_sycl[0] + Residual3_B0(0,0);
