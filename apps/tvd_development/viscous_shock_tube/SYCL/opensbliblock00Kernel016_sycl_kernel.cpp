  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      , [=](cl::sycl::nd_item<2> item
        ...
        const ACC<double> p_B0(xdim0_opensbliblock00Kernel016, &p_B0_p[0] + base0 + n_x*1 + n_y * xdim0_opensbliblock00Kernel016*1);
        const ACC<double> rhoE_B0(xdim1_opensbliblock00Kernel016, &rhoE_B0_p[0] + base1 + n_x*1 + n_y * xdim1_opensbliblock00Kernel016*1);
        const ACC<double> rhou0_B0(xdim2_opensbliblock00Kernel016, &rhou0_B0_p[0] + base2 + n_x*1 + n_y * xdim2_opensbliblock00Kernel016*1);
        const ACC<double> rhou1_B0(xdim3_opensbliblock00Kernel016, &rhou1_B0_p[0] + base3 + n_x*1 + n_y * xdim3_opensbliblock00Kernel016*1);
        const ACC<double> u0_B0(xdim4_opensbliblock00Kernel016, &u0_B0_p[0] + base4 + n_x*1 + n_y * xdim4_opensbliblock00Kernel016*1);
        const ACC<double> u1_B0(xdim5_opensbliblock00Kernel016, &u1_B0_p[0] + base5 + n_x*1 + n_y * xdim5_opensbliblock00Kernel016*1);
        ACC<double> Residual0_B0(xdim6_opensbliblock00Kernel016, &Residual0_B0_p[0] + base6 + n_x*1 + n_y * xdim6_opensbliblock00Kernel016*1);
        ACC<double> Residual1_B0(xdim7_opensbliblock00Kernel016, &Residual1_B0_p[0] + base7 + n_x*1 + n_y * xdim7_opensbliblock00Kernel016*1);
        ACC<double> Residual2_B0(xdim8_opensbliblock00Kernel016, &Residual2_B0_p[0] + base8 + n_x*1 + n_y * xdim8_opensbliblock00Kernel016*1);
        ACC<double> Residual3_B0(xdim9_opensbliblock00Kernel016, &Residual3_B0_p[0] + base9 + n_x*1 + n_y * xdim9_opensbliblock00Kernel016*1);
        //USER CODE
   ...
   if (idx[0] == 0){
       ...
       d1_prhoEu0_dx = (-3*(p_B0(2,0) + rhoE_B0(2,0))*u0_B0(2,0) + 4*(p_B0(1,0) + rhoE_B0(1,0))*u0_B0(1,0) -
            ...
            ((4.0/3.0))*(p_B0(3,0) + rhoE_B0(3,0))*u0_B0(3,0))*invDelta0block0_sycl[0];
       ...
       d1_prhou0u0_dx = (-3*p_B0(2,0) + 4*p_B0(1,0) - (25.0/12.0)*p_B0(0,0) - (1.0/4.0)*p_B0(4,0) +
            ...
            ((4.0/3.0))*u0_B0(3,0)*rhou0_B0(3,0))*invDelta0block0_sycl[0];
       ...
       d1_prhoEu0_dx = (-(5.0/6.0)*(p_B0(0,0) + rhoE_B0(0,0))*u0_B0(0,0) - (1.0/2.0)*(p_B0(2,0) +
            ...
            rhoE_B0(3,0))*u0_B0(3,0) + ((3.0/2.0))*(p_B0(1,0) + rhoE_B0(1,0))*u0_B0(1,0))*invDelta0block0_sycl[0];
       ...
       d1_prhoEu0_dx = (-4*(p_B0(-1,0) + rhoE_B0(-1,0))*u0_B0(-1,0) + 3*(p_B0(-2,0) + rhoE_B0(-2,0))*u0_B0(-2,0) -
            ...
            ((25.0/12.0))*(p_B0(0,0) + rhoE_B0(0,0))*u0_B0(0,0))*invDelta0block0_sycl[0];
       ...
       d1_prhoEu0_dx = (((1.0/2.0))*(p_B0(-2,0) + rhoE_B0(-2,0))*u0_B0(-2,0) - (3.0/2.0)*(p_B0(-1,0) +
            ...
            rhoE_B0(1,0))*u0_B0(1,0) + ((5.0/6.0))*(p_B0(0,0) + rhoE_B0(0,0))*u0_B0(0,0))*invDelta0block0_sycl[0];
   ...
   if (idx[1] == 0){
       ...
       d1_prhoEu1_dy = (-3*(p_B0(0,2) + rhoE_B0(0,2))*u1_B0(0,2) + 4*(p_B0(0,1) + rhoE_B0(0,1))*u1_B0(0,1) -
            ...
            ((4.0/3.0))*(p_B0(0,3) + rhoE_B0(0,3))*u1_B0(0,3))*invDelta1block0_sycl[0];
       ...
       d1_prhou1u1_dy = (-3*p_B0(0,2) + 4*p_B0(0,1) - (25.0/12.0)*p_B0(0,0) - (1.0/4.0)*p_B0(0,4) +
            ...
            ((4.0/3.0))*u1_B0(0,3)*rhou1_B0(0,3))*invDelta1block0_sycl[0];
       ...
       d1_prhoEu1_dy = (-(5.0/6.0)*(p_B0(0,0) + rhoE_B0(0,0))*u1_B0(0,0) - (1.0/2.0)*(p_B0(0,2) +
            ...
            rhoE_B0(0,3))*u1_B0(0,3) + ((3.0/2.0))*(p_B0(0,1) + rhoE_B0(0,1))*u1_B0(0,1))*invDelta1block0_sycl[0];
