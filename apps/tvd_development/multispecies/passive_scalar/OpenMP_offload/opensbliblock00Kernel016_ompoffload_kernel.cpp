...
void ops_par_loop_opensbliblock00Kernel016_execute(ops_kernel_descriptor *desc) {
  ...
  double * __restrict__ rhoE_RKold_B0_p = (double *)(args[4].data_d + base4);
  ...
  double * __restrict__ rkA = (double *)args[9].data_d;
  double * __restrict__ rkB = (double *)args[10].data_d;
...
void ops_par_loop_opensbliblock00Kernel016(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg8, ops_arg arg9, ops_arg arg10) {
  ...
  create_kerneldesc_and_enque(name, args, 11, 7, dim, 0, range, block, ops_par_loop_opensbliblock00Kernel016_execute);
}
#endif
