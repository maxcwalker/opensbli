...
ops_par_loop(opensbliblock00Kernel016, "Grid_based_initialisation0", opensbliblock00, 1, iteration_range_16_block0,
...
ops_par_loop(opensbliblock00Kernel014, "Dirichlet boundary dir0 side0", opensbliblock00, 1, iteration_range_14_block0,
...
ops_par_loop(opensbliblock00Kernel015, "Dirichlet boundary dir0 side1", opensbliblock00, 1, iteration_range_15_block0,
ops_arg_dat(x0_B0, 1, stencil_0_00_1, "double", OPS_READ),
ops_arg_dat(rhoE_B0, 1, stencil_0_00_1, "double", OPS_WRITE),
ops_arg_dat(rho_B0, 1, stencil_0_00_1, "double", OPS_WRITE),
ops_arg_dat(rhou0_B0, 1, stencil_0_00_1, "double", OPS_WRITE));
...
ops_par_loop(opensbliblock00Kernel013, "Convective terms", opensbliblock00, 1, iteration_range_13_block0,
...
ops_arg_dat(rhof_B0, 1, stencil_0_44_1, "double", OPS_READ),
...
ops_par_loop(opensbliblock00Kernel017, "Temporal solution advancement", opensbliblock00, 1, iteration_range_17_block0,
...
ops_arg_dat(rhof_RKold_B0, 1, stencil_0_00_1, "double", OPS_RW),
...
HDF5_IO_Write_0_opensbliblock00(opensbliblock00, rho_B0, rhou0_B0, rhoE_B0, rhof_B0, x0_B0, HDF5_timing);
ops_exit();
//Main program end 
}