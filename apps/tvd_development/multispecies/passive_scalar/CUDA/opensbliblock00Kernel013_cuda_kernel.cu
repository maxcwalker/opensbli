...
__device__
 ...
 void opensbliblock00Kernel013_gpu(const ACC<double> &x0_B0,
  ACC<double> &rhoE_B0,
  ACC<double> &rho_B0,
  ACC<double>
&rhou0_B0)
...
void ops_par_loop_opensbliblock00Kernel013(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2, ops_arg arg3) {
  ...
  create_kerneldesc_and_enque(name, args, 4, 1, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel013_execute);
}
#endif
