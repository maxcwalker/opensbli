...
void ops_par_loop_opensbliblock00Kernel017_execute(ops_kernel_descriptor *desc) {
  ...
  double * __restrict__ rhof_B0_p = (double *)(args[8].data_d + base8);

  int base9 = args[9].dat->base_offset;
  double * __restrict__ rhof_RKold_B0_p = (double *)(args[9].data_d + base9);
  ...
  for ( int n_x=start0; n_x<end0; n_x++ ){
    ...
    ACC<double> rho_RKold_B0(rho_RKold_B0_p + n_x*1);
    ACC<double> rhof_B0(rhof_B0_p + n_x*1);
    ACC<double> rhof_RKold_B0(rhof_RKold_B0_p + n_x*1);
...
void ops_par_loop_opensbliblock00Kernel017(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg12, ops_arg arg13) {
  ...
  create_kerneldesc_and_enque(name, args, 14, 7, dim, 0, range, block, ops_par_loop_opensbliblock00Kernel017_execute);
}
#endif
