...
//
__constant__ int dims_opensbliblock00Kernel013 [12][1];
static int dims_opensbliblock00Kernel013_h [12][1] = {{0}};
...
void ops_par_loop_opensbliblock00Kernel013_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_opensbliblock00Kernel013_h[0][0] || xdim1 != dims_opensbliblock00Kernel013_h[1][0] || xdim2 != dims_opensbliblock00Kernel013_h[2][0] || xdim3 != dims_opensbliblock00Kernel013_h[3][0] || xdim4 != dims_opensbliblock00Kernel013_h[4][0] || xdim5 != dims_opensbliblock00Kernel013_h[5][0] || xdim6 != dims_opensbliblock00Kernel013_h[6][0] || xdim7 != dims_opensbliblock00Kernel013_h[7][0] || xdim8 != dims_opensbliblock00Kernel013_h[8][0] || xdim9 != dims_opensbliblock00Kernel013_h[9][0] || xdim10 != dims_opensbliblock00Kernel013_h[10][0]) {
...
void ops_par_loop_opensbliblock00Kernel013(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg8, ops_arg arg9, ops_arg arg10, ops_arg arg11) {
  ...
  create_kerneldesc_and_enque(name, args, 12, 6, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel013_execute);
}
#endif
