...
int base[] = {0};
double* value = NULL;
f_B0 = ops_decl_dat(opensbliblock00, 1, size, base, halo_m, halo_p, value, "double", "f_B0");
}
ops_dat p_B0;
{
int halo_p[] = {5};
...
{
if (restart == 1){
rhof_B0 = ops_decl_dat_hdf5(opensbliblock00, 1, "double", "rhof_B0", "restart.h5");
}
else {
int halo_p[] = {5};
int halo_m[] = {-5};
...
int base[] = {0};
double* value = NULL;
rhof_B0 = ops_decl_dat(opensbliblock00, 1, size, base, halo_m, halo_p, value, "double", "rhof_B0");
}
}
ops_dat rhof_RKold_B0;
{
int halo_p[] = {5};
int halo_m[] = {-5};
int size[] = {block0np0};
int base[] = {0};
double* value = NULL;
rhof_RKold_B0 = ops_decl_dat(opensbliblock00, 1, size, base, halo_m, halo_p, value, "double", "rhof_RKold_B0");
}
ops_dat rhou0_B0;
{
if (restart == 1){
