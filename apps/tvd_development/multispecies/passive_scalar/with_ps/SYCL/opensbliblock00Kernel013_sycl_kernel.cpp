...
void ops_par_loop_opensbliblock00Kernel013_execute(ops_kernel_descriptor *desc) {
 ...
 arg10, arg11};
  ...
  double* rhof_B0_p = (double*)args[3].data_d;
  ...
  if ((end[0]-start[0])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      , [=](cl::sycl::nd_item<1> item
        ...
        const ACC<double> rhof_B0(&rhof_B0_p[0] + base3 + n_x*1);
        const ACC<double> rhou0_B0(&rhou0_B0_p[0] + base4 + n_x*1);
        const ACC<double> u0_B0(&u0_B0_p[0] + base5 + n_x*1);
        const ACC<double> wk0_B0(&wk0_B0_p[0] + base6 + n_x*1);
        ACC<double> Residual0_B0(&Residual0_B0_p[0] + base7 + n_x*1);
        ACC<double> Residual1_B0(&Residual1_B0_p[0] + base8 + n_x*1);
        ACC<double> Residual2_B0(&Residual2_B0_p[0] + base9 + n_x*1);
        ACC<double> Residual3_B0(&Residual3_B0_p[0] + base10 + n_x*1);
        //USER CODE
        if (n_x < end_0) {
   ...
   if (idx[0] == 0){
      ...
      d1_p_dx = (3.0*p_B0(1) + 0.333333333333333*p_B0(3) - 1.5*p_B0(2) - 1.83333333333333*p_B0(0))*invDelta0block0_sycl[0];
       ...
       d1_rhofu0_dx = (3.0*u0_B0(1)*rhof_B0(1) + 0.333333333333333*u0_B0(3)*rhof_B0(3) - 1.5*u0_B0(2)*rhof_B0(2) -
            1.83333333333333*u0_B0(0)*rhof_B0(0))*invDelta0block0_sycl[0];
       ...
       d1_rhofu0_dx = (0.0394168524399447*u0_B0(2)*rhof_B0(2) + 0.00571369039775442*u0_B0(4)*rhof_B0(4) +
            ...
            0.0658051057710389*u0_B0(3)*rhof_B0(3) - 0.376283677513354*u0_B0(-1)*rhof_B0(-1))*invDelta0block0_sycl[0];
       ...
       d1_rhofu0_dx = (0.197184333887745*u0_B0(0)*rhof_B0(0) + 0.521455851089587*u0_B0(1)*rhof_B0(1) +
            ...
            0.0367146847001261*u0_B0(2)*rhof_B0(2) - 0.791245592765872*u0_B0(-1)*rhof_B0(-1))*invDelta0block0_sycl[0];
       ...
       d1_rhofu0_dx = (0.0451033223343881*u0_B0(0)*rhof_B0(0) + 0.652141084861241*u0_B0(1)*rhof_B0(1) +
            ...
            0.727822147724592*u0_B0(-1)*rhof_B0(-1) - 0.082033432844602*u0_B0(2)*rhof_B0(2))*invDelta0block0_sycl[0];
      ...
      d1_p_dx = (1.5*p_B0(-2) + 1.83333333333333*p_B0(0) - 3.0*p_B0(-1) - 0.333333333333333*p_B0(-3))*invDelta0block0_sycl[0];
       ...
       d1_rhofu0_dx = (1.5*u0_B0(-2)*rhof_B0(-2) + 1.83333333333333*u0_B0(0)*rhof_B0(0) - 3.0*u0_B0(-1)*rhof_B0(-1) -
            0.333333333333333*u0_B0(-3)*rhof_B0(-3))*invDelta0block0_sycl[0];
       ...
       d1_rhofu0_dx = (0.322484932882161*u0_B0(0)*rhof_B0(0) + 0.0658051057710389*u0_B0(-3)*rhof_B0(-3) +
            ...
            0.00571369039775442*u0_B0(-4)*rhof_B0(-4) - 0.719443173328855*u0_B0(-1)*rhof_B0(-1))*invDelta0block0_sycl[0];
       ...
       d1_rhofu0_dx = (0.00412637789557492*u0_B0(-3)*rhof_B0(-3) + 0.0367146847001261*u0_B0(-2)*rhof_B0(-2) +
            ...
            0.521455851089587*u0_B0(-1)*rhof_B0(-1) - 0.113446470384241*u0_B0(2)*rhof_B0(2))*invDelta0block0_sycl[0];
       ...
       d1_rhofu0_dx = (0.00932597985049999*u0_B0(3)*rhof_B0(3) + 0.727822147724592*u0_B0(1)*rhof_B0(1) +
            ...
            0.652141084861241*u0_B0(-1)*rhof_B0(-1) - 0.121937153224065*u0_B0(2)*rhof_B0(2))*invDelta0block0_sycl[0];
       ...
       d1_rhofu0_dx = (-(2.0/3.0)*u0_B0(-1)*rhof_B0(-1) - (1.0/12.0)*u0_B0(2)*rhof_B0(2) +
            ((1.0/12.0))*u0_B0(-2)*rhof_B0(-2) + ((2.0/3.0))*u0_B0(1)*rhof_B0(1))*invDelta0block0_sycl[0];
