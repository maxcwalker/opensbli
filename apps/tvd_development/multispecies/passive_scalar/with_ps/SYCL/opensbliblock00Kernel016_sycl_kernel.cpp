...
void ops_par_loop_opensbliblock00Kernel016_execute(ops_kernel_descriptor *desc) {
 ...
 arg5};
  ...
  double* rhof_B0_p = (double*)args[2].data_d;
  ...
  if ((end[0]-start[0])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      , [=](cl::sycl::nd_item<1> item
        ...
        ACC<double> rho_B0(&rho_B0_p[0] + base1 + n_x*1);
        ACC<double> rhof_B0(&rhof_B0_p[0] + base2 + n_x*1);
        ACC<double> rhou0_B0(&rhou0_B0_p[0] + base3 + n_x*1);
        ACC<double> x0_B0(&x0_B0_p[0] + base4 + n_x*1);
        //USER CODE
        if (n_x < end_0) {
...
: (
   ...
   rhoE_B0(0) = p/(-1.0 + gama_sycl[0]) + 0.5*d*(u0*u0);
