...
void ops_par_loop_opensbliblock00Kernel004_execute(ops_kernel_descriptor *desc) {
 ...
 arg10};
  ...
  if ((end[0]-start[0])>0) {
   ...
   AVG_0_0_LEV_11 = (inv_AVG_a*inv_AVG_a)*gamma_m1_sycl[0]*AVG_0_f*AVG_0_u0;

   AVG_0_0_LEV_12 = -(inv_AVG_a*inv_AVG_a)*gamma_m1_sycl[0]*AVG_0_f;

   AVG_0_0_LEV_13 = 1;

   AVG_0_0_LEV_20 = 0.25*(inv_AVG_a*inv_AVG_a)*(-AVG_0_u0 + 2*AVG_0_a + gama_sycl[0]*AVG_0_u0)*AVG_0_f*AVG_0_u0;
   ...
   AVG_0_0_LEV_30 = -0.25*(inv_AVG_a*inv_AVG_a)*(2*AVG_0_a - gama_sycl[0]*AVG_0_u0 + AVG_0_u0)*AVG_0_f*AVG_0_u0;
