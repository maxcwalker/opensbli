...
void HDF5_IO_Write_0_opensbliblock00(ops_block& opensbliblock00, ops_dat& rho_B0, ops_dat& rhou0_B0, ops_dat& rhoE_B0, ops_dat& rhof_B0, ops_dat& x0_B0, int HDF5_timing){
...
ops_fetch_dat_hdf5_file(rhof_B0, name0);
