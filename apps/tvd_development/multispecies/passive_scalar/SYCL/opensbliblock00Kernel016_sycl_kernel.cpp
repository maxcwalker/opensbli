...
void ops_par_loop_opensbliblock00Kernel016_execute(ops_kernel_descriptor *desc) {
 ...
 arg10};
  ...
  double* rhoE_RKold_B0_p = (double*)args[4].data_d;
  ...
  double rkA_val = *(double *)args[9].data;


  double rkB_val = *(double *)args[10].data;
  ...
  if ((end[0]-start[0])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      , [=](cl::sycl::nd_item<1> item
        ...
        ACC<double> rhoE_B0(&rhoE_B0_p[0] + base3 + n_x*1);
        ACC<double> rhoE_RKold_B0(&rhoE_RKold_B0_p[0] + base4 + n_x*1);
        ACC<double> rho_B0(&rho_B0_p[0] + base5 + n_x*1);
        ACC<double> rho_RKold_B0(&rho_RKold_B0_p[0] + base6 + n_x*1);
        ACC<double> rhou0_B0(&rhou0_B0_p[0] + base7 + n_x*1);
        ACC<double> rhou0_RKold_B0(&rhou0_RKold_B0_p[0] + base8 + n_x*1);
