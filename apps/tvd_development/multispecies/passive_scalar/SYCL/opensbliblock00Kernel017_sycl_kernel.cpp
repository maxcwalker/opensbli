...
void ops_par_loop_opensbliblock00Kernel017_execute(ops_kernel_descriptor *desc) {
 ...
 arg10, arg11, arg12, arg13};
  ...
  double* rhof_B0_p = (double*)args[8].data_d;

  int base9 = args[9].dat->base_offset/sizeof(double);
  double* rhof_RKold_B0_p = (double*)args[9].data_d;
  ...
  if ((end[0]-start[0])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      , [=](cl::sycl::nd_item<1> item
        ...
        ACC<double> rho_RKold_B0(&rho_RKold_B0_p[0] + base7 + n_x*1);
        ACC<double> rhof_B0(&rhof_B0_p[0] + base8 + n_x*1);
        ACC<double> rhof_RKold_B0(&rhof_RKold_B0_p[0] + base9 + n_x*1);
   ...
   rho_RKold_B0(0) = rkA[0]*rho_RKold_B0(0) + dt_sycl[0]*Residual0_B0(0);

   rho_B0(0) = rkB[0]*rho_RKold_B0(0) + rho_B0(0);

   rhou0_RKold_B0(0) = rkA[0]*rhou0_RKold_B0(0) + dt_sycl[0]*Residual1_B0(0);

   rhou0_B0(0) = rkB[0]*rhou0_RKold_B0(0) + rhou0_B0(0);

   rhoE_RKold_B0(0) = rkA[0]*rhoE_RKold_B0(0) + dt_sycl[0]*Residual2_B0(0);

   rhoE_B0(0) = rkB[0]*rhoE_RKold_B0(0) + rhoE_B0(0);

   rhof_RKold_B0(0) = rkA[0]*rhof_RKold_B0(0) + dt_sycl[0]*Residual3_B0(0);
