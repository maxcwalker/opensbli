...
#define OPENSBLIBLOCK00_KERNEL_H
 void opensbliblock00Kernel016(ACC<double> &rhoE_B0, ACC<double> &rhoN2_B0, ACC<double> &rhoN_B0, ACC<double> &rho_B0,
...
: (
 ...
 void opensbliblock00Kernel014(ACC<double> &rhoE_B0, ACC<double> &rhoN2_B0, ACC<double> &rhoN_B0, ACC<double>
&rhou0_B0)
{
   double dN = 0.0;
   double dN2 = 0.0;
...
void opensbliblock00Kernel006(const ACC<double> &u0_B0, ACC<double> &wk0_B0, const int *idx)
{
 ...
 void opensbliblock00Kernel013(const ACC<double> &p_B0, const ACC<double> &rhoE_B0, const ACC<double> &rhoN2_B0, const
ACC<double> &rhoN_B0, const ACC<double> &rhou0_B0, const ACC<double> &u0_B0, ACC<double> &Residual0_B0, ACC<double>
...
&Residual2_B0, const ACC<double> &Residual3_B0, ACC<double> &rhoE_B0, ACC<double> &rhoE_RKold_B0, ACC<double> &rhoN2_B0,
ACC<double> &rhoN2_RKold_B0, ACC<double> &rhoN_B0, ACC<double> &rhoN_RKold_B0, ACC<double> &rhou0_B0, ACC<double>
&rhou0_RKold_B0, const double *rkA, const double *rkB)
{
   ...
   rhoE_RKold_B0(0) = rkA[0]*rhoE_RKold_B0(0) + dt*Residual3_B0(0);
...
void opensbliblock00Kernel003(ACC<double> &wk0_B0, ACC<double> &wk1_B0, ACC<double> &wk2_B0, ACC<double> &wk3_B0)
{
 ...
 void opensbliblock00Kernel004(const ACC<double> &a_B0, const ACC<double> &rhoE_B0, const ACC<double> &rhoN2_B0, const
ACC<double> &rhoN_B0, const ACC<double> &rhou0_B0, const ACC<double> &u0_B0, ACC<double> &wk0_B0, ACC<double> &wk1_B0,
