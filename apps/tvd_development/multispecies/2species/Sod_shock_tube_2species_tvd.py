...
dN = "Eq(GridVariable(dN), Piecewise((1.0, DataObject(x0) < 0.5), (0.0, True)))"
dN2 = "Eq(GridVariable(dN2), Piecewise((0.0, DataObject(x0) < 0.5), (1.0, True)))"
...
eqns = [x0, u0, p, dN, dN2, rhoN, rhoN2, rho, rhou0, rhoE]
...
left_eqns = [OpenSBLIEq(dN, 1.0), OpenSBLIEq(dN2, 0.0), OpenSBLIEq(u, 0.0), OpenSBLIEq(p, 1.0)] + [parse_expr(eq, local_dict=local_dict) for eq in [rhoN, rhoN2, rhou0, rhoE]]
# Right boundary condition
right_eqns = [OpenSBLIEq(dN, 0.0), OpenSBLIEq(dN2, 1.0), OpenSBLIEq(u, 0.0), OpenSBLIEq(p, 0.1)] + [parse_expr(eq, local_dict=local_dict) for eq in [rhoN, rhoN2, rhou0, rhoE]]
