...
void ops_par_loop_opensbliblock00Kernel017_execute(ops_kernel_descriptor *desc) {
 ...
 arg10, arg11, arg12, arg13};
  ...
  double* rhoN2_RKold_B0_p = (double*)args[7].data_d;

  int base8 = args[8].dat->base_offset/sizeof(double);
  double* rhoN_B0_p = (double*)args[8].data_d;

  int base9 = args[9].dat->base_offset/sizeof(double);
  double* rhoN_RKold_B0_p = (double*)args[9].data_d;
  ...
  if ((end[0]-start[0])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      , [=](cl::sycl::nd_item<1> item
        ...
        ACC<double> rhoE_B0(&rhoE_B0_p[0] + base4 + n_x*1);
        ACC<double> rhoE_RKold_B0(&rhoE_RKold_B0_p[0] + base5 + n_x*1);
        ACC<double> rhoN2_B0(&rhoN2_B0_p[0] + base6 + n_x*1);
        ACC<double> rhoN2_RKold_B0(&rhoN2_RKold_B0_p[0] + base7 + n_x*1);
        ACC<double> rhoN_B0(&rhoN_B0_p[0] + base8 + n_x*1);
        ACC<double> rhoN_RKold_B0(&rhoN_RKold_B0_p[0] + base9 + n_x*1);
        ACC<double> rhou0_B0(&rhou0_B0_p[0] + base10 + n_x*1);
        ACC<double> rhou0_RKold_B0(&rhou0_RKold_B0_p[0] + base11 + n_x*1);
   ...
   rhoE_RKold_B0(0) = rkA[0]*rhoE_RKold_B0(0) + dt_sycl[0]*Residual3_B0(0);
