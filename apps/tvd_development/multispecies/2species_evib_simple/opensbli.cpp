...
if (restart == 0){
int iteration_range_17_block0[] = {-5, block0np0 + 5};
ops_par_loop(opensbliblock00Kernel017, "Grid_based_initialisation0", opensbliblock00, 1, iteration_range_17_block0,
...
int iteration_range_15_block0[] = {-2, 1};
ops_par_loop(opensbliblock00Kernel015, "Dirichlet boundary dir0 side0", opensbliblock00, 1, iteration_range_15_block0,
ops_arg_dat(rhoE_B0, 1, stencil_0_00_1, "double", OPS_WRITE),
ops_arg_dat(rhoN2_B0, 1, stencil_0_00_1, "double", OPS_WRITE),
ops_arg_dat(rhoN_B0, 1, stencil_0_00_1, "double", OPS_WRITE),
ops_arg_dat(rhou0_B0, 1, stencil_0_00_1, "double", OPS_WRITE));

int iteration_range_16_block0[] = {block0np0 - 1, block0np0 + 2};
ops_par_loop(opensbliblock00Kernel016, "Dirichlet boundary dir0 side1", opensbliblock00, 1, iteration_range_16_block0,
ops_arg_dat(rhoE_B0, 1, stencil_0_00_1, "double", OPS_WRITE),
ops_arg_dat(rhoN2_B0, 1, stencil_0_00_1, "double", OPS_WRITE),
ops_arg_dat(rhoN_B0, 1, stencil_0_00_1, "double", OPS_WRITE),
ops_arg_dat(rhou0_B0, 1, stencil_0_00_1, "double", OPS_WRITE));
...
ops_par_loop(opensbliblock00Kernel014, "Convective terms", opensbliblock00, 1, iteration_range_14_block0,
ops_arg_dat(ev_B0, 1, stencil_0_00_1, "double", OPS_READ),
...
ops_arg_dat(tau_B0, 1, stencil_0_00_1, "double", OPS_READ),
ops_arg_dat(u0_B0, 1, stencil_0_44_1, "double", OPS_READ),
...
ops_par_loop(opensbliblock00Kernel018, "Temporal solution advancement", opensbliblock00, 1, iteration_range_18_block0,
...
HDF5_IO_Write_0_opensbliblock00(opensbliblock00, rhoN_B0, rhoN2_B0, rhou0_B0, rhoev_B0, rhoE_B0, x0_B0, p_B0, HDF5_timing);
ops_exit();
//Main program end 
}