...
#define OPENSBLIBLOCK00_KERNEL_H
 void opensbliblock00Kernel017(ACC<double> &rhoE_B0, ACC<double> &rhoN2_B0, ACC<double> &rhoN_B0, ACC<double> &rho_B0,
...
: (
 ...
 void opensbliblock00Kernel015(ACC<double> &rhoE_B0, ACC<double> &rhoN2_B0, ACC<double> &rhoN_B0, ACC<double>
&rhou0_B0)
{
   double dN = 0.0;
   double dN2 = 0.0;
   double p = 0.0;
   double u0 = 0.0;
   dN = 0.800000000000000;

   dN2 = 0.200000000000000;
 ...
 void opensbliblock00Kernel016(ACC<double> &rhoE_B0, ACC<double> &rhoN2_B0, ACC<double> &rhoN_B0, ACC<double>
&rhou0_B0)
{
   double dN = 0.0;
   double dN2 = 0.0;
 ...
 void opensbliblock00Kernel007(const ACC<double> &rhoN2_B0, const ACC<double> &rhoN_B0, const ACC<double> &rhou0_B0,
ACC<double> &u0_B0)
{
 ...
 void opensbliblock00Kernel009(const ACC<double> &rhoE_B0, const ACC<double> &rhoN2_B0, const ACC<double> &rhoN_B0,
const ACC<double> &u0_B0, ACC<double> &p_B0)
{
   p_B0(0) = (-1 + gama)*(-(1.0/2.0)*(u0_B0(0)*u0_B0(0))*(rhoN_B0(0) + rhoN2_B0(0)) + rhoE_B0(0));
...
void opensbliblock00Kernel006(const ACC<double> &u0_B0, ACC<double> &wk0_B0, const int *idx)
{
 ...
 void opensbliblock00Kernel014(const ACC<double> &ev_B0, const ACC<double> &eveqN2_B0, const ACC<double> &p_B0, const
ACC<double> &rhoE_B0, const ACC<double> &rhoN2_B0, const ACC<double> &rhoN_B0, const ACC<double> &rho_B0, const
ACC<double> &rhoev_B0, const ACC<double> &rhou0_B0, const ACC<double> &tau_B0, const ACC<double> &u0_B0, ACC<double>
...
void opensbliblock00Kernel003(ACC<double> &wk0_B0, ACC<double> &wk1_B0, ACC<double> &wk2_B0, ACC<double> &wk3_B0)
{
 ...
 void opensbliblock00Kernel004(const ACC<double> &A_B0, const ACC<double> &a_B0, const ACC<double> &rhoE_B0, const
ACC<double> &rhoN2_B0, const ACC<double> &rhoN_B0, const ACC<double> &rhou0_B0, const ACC<double> &u0_B0, ACC<double>
&wk0_B0, ACC<double> &wk1_B0, ACC<double> &wk2_B0, ACC<double> &wk3_B0)
{
   ...
   AVG_0_0_LEV_00 = -0.5*(AVG_0_u0*AVG_0_u0)*(inv_AVG_a*inv_AVG_a)*gamma_m1*AVG_0_rhoN2/(AVG_0_rhoN + AVG_0_rhoN2);

    AVG_0_0_LEV_01 = 1.0*(1.0*AVG_0_rhoN + 1.0*AVG_0_rhoN2 + 0.5*(AVG_0_u0*AVG_0_u0)*(inv_AVG_a*inv_AVG_a)*AVG_0_rhoN2 -
      0.5*(AVG_0_u0*AVG_0_u0)*(inv_AVG_a*inv_AVG_a)*gama*AVG_0_rhoN2)/(AVG_0_rhoN + AVG_0_rhoN2);

   AVG_0_0_LEV_02 = 1.0*(inv_AVG_a*inv_AVG_a)*gamma_m1*AVG_0_rhoN2*AVG_0_u0/(AVG_0_rhoN + AVG_0_rhoN2);

   AVG_0_0_LEV_03 = -1.0*(inv_AVG_a*inv_AVG_a)*gamma_m1*AVG_0_rhoN2/(AVG_0_rhoN + AVG_0_rhoN2);

    AVG_0_0_LEV_10 = 1.0*(-0.5 - 0.25*(AVG_0_u0*AVG_0_u0)*(inv_AVG_a*inv_AVG_a) +
      0.25*(AVG_0_u0*AVG_0_u0)*(inv_AVG_a*inv_AVG_a)*gama)/((AVG_0_rhoN + AVG_0_rhoN2)*inv_AVG_a);

    AVG_0_0_LEV_11 = 1.0*(-0.5 - 0.25*(AVG_0_u0*AVG_0_u0)*(inv_AVG_a*inv_AVG_a) +
      0.25*(AVG_0_u0*AVG_0_u0)*(inv_AVG_a*inv_AVG_a)*gama)/((AVG_0_rhoN + AVG_0_rhoN2)*inv_AVG_a);

   AVG_0_0_LEV_12 = -0.5*gamma_m1*AVG_0_u0*inv_AVG_a/(AVG_0_rhoN + AVG_0_rhoN2);

   AVG_0_0_LEV_13 = 0.5*gamma_m1*inv_AVG_a/(AVG_0_rhoN + AVG_0_rhoN2);

    AVG_0_0_LEV_20 = 0.25*(-1.0 + 1.0*gama)*(1.0*AVG_0_a - 0.5*AVG_0_u0 +
      0.5*gama*AVG_0_u0)*AVG_0_u0*inv_AVG_a/(AVG_0_rhoN + AVG_0_rhoN2);

    AVG_0_0_LEV_21 = 0.25*(-1.0 + 1.0*gama)*(1.0*AVG_0_a - 0.5*AVG_0_u0 +
      0.5*gama*AVG_0_u0)*AVG_0_u0*inv_AVG_a/(AVG_0_rhoN + AVG_0_rhoN2);

    AVG_0_0_LEV_22 = -0.25*(-1.0 + 1.0*gama)*(1.0*AVG_0_a - 1.0*AVG_0_u0 + 1.0*gama*AVG_0_u0)*inv_AVG_a/(AVG_0_rhoN +
      AVG_0_rhoN2);

   AVG_0_0_LEV_23 = 0.25*((-1.0 + 1.0*gama)*(-1.0 + 1.0*gama))*inv_AVG_a/(AVG_0_rhoN + AVG_0_rhoN2);

    AVG_0_0_LEV_30 = -0.25*(-1.0 + 1.0*gama)*(0.5*AVG_0_u0 + 1.0*AVG_0_a -
      0.5*gama*AVG_0_u0)*AVG_0_u0*inv_AVG_a/(AVG_0_rhoN + AVG_0_rhoN2);

    AVG_0_0_LEV_31 = -0.25*(-1.0 + 1.0*gama)*(0.5*AVG_0_u0 + 1.0*AVG_0_a -
      0.5*gama*AVG_0_u0)*AVG_0_u0*inv_AVG_a/(AVG_0_rhoN + AVG_0_rhoN2);
   ...
   AVG_0_0_LEV_33 = 0.25*((-1.0 + 1.0*gama)*(-1.0 + 1.0*gama))*inv_AVG_a/(AVG_0_rhoN + AVG_0_rhoN2);
    ...
    alpha_00 = (-rhoE_B0(-1) + rhoE_B0(0))*AVG_0_0_LEV_03 + (-rhoN_B0(-1) + rhoN_B0(0))*AVG_0_0_LEV_00 + (-rhoN2_B0(-1)
      + rhoN2_B0(0))*AVG_0_0_LEV_01 + (-rhou0_B0(-1) + rhou0_B0(0))*AVG_0_0_LEV_02;

    alpha_10 = (-rhoE_B0(-1) + rhoE_B0(0))*AVG_0_0_LEV_13 + (-rhoN_B0(-1) + rhoN_B0(0))*AVG_0_0_LEV_10 + (-rhoN2_B0(-1)
      + rhoN2_B0(0))*AVG_0_0_LEV_11 + (-rhou0_B0(-1) + rhou0_B0(0))*AVG_0_0_LEV_12;

    alpha_20 = (-rhoE_B0(-1) + rhoE_B0(0))*AVG_0_0_LEV_23 + (-rhoN_B0(-1) + rhoN_B0(0))*AVG_0_0_LEV_20 + (-rhoN2_B0(-1)
      + rhoN2_B0(0))*AVG_0_0_LEV_21 + (-rhou0_B0(-1) + rhou0_B0(0))*AVG_0_0_LEV_22;

    alpha_30 = (-rhoE_B0(-1) + rhoE_B0(0))*AVG_0_0_LEV_33 + (-rhoN_B0(-1) + rhoN_B0(0))*AVG_0_0_LEV_30 + (-rhoN2_B0(-1)
   ...
   AVG_0_0_LEV_33 = 0.25*((-1.0 + 1.0*gama)*(-1.0 + 1.0*gama))*inv_AVG_a/(AVG_0_rhoN + AVG_0_rhoN2);
    ...
    alpha_01 = (-rhoE_B0(0) + rhoE_B0(1))*AVG_0_0_LEV_03 + (-rhoN_B0(0) + rhoN_B0(1))*AVG_0_0_LEV_00 + (-rhoN2_B0(0) +
      rhoN2_B0(1))*AVG_0_0_LEV_01 + (-rhou0_B0(0) + rhou0_B0(1))*AVG_0_0_LEV_02;

    alpha_11 = (-rhoE_B0(0) + rhoE_B0(1))*AVG_0_0_LEV_13 + (-rhoN_B0(0) + rhoN_B0(1))*AVG_0_0_LEV_10 + (-rhoN2_B0(0) +
      rhoN2_B0(1))*AVG_0_0_LEV_11 + (-rhou0_B0(0) + rhou0_B0(1))*AVG_0_0_LEV_12;

    alpha_21 = (-rhoE_B0(0) + rhoE_B0(1))*AVG_0_0_LEV_23 + (-rhoN_B0(0) + rhoN_B0(1))*AVG_0_0_LEV_20 + (-rhoN2_B0(0) +
      rhoN2_B0(1))*AVG_0_0_LEV_21 + (-rhou0_B0(0) + rhou0_B0(1))*AVG_0_0_LEV_22;

    alpha_31 = (-rhoE_B0(0) + rhoE_B0(1))*AVG_0_0_LEV_33 + (-rhoN_B0(0) + rhoN_B0(1))*AVG_0_0_LEV_30 + (-rhoN2_B0(0) +
   ...
   AVG_0_0_LEV_33 = 0.25*((-1.0 + 1.0*gama)*(-1.0 + 1.0*gama))*inv_AVG_a/(AVG_0_rhoN + AVG_0_rhoN2);
    ...
    alpha_02 = (-rhoE_B0(1) + rhoE_B0(2))*AVG_0_0_LEV_03 + (-rhoN_B0(1) + rhoN_B0(2))*AVG_0_0_LEV_00 + (-rhoN2_B0(1) +
      rhoN2_B0(2))*AVG_0_0_LEV_01 + (-rhou0_B0(1) + rhou0_B0(2))*AVG_0_0_LEV_02;

    alpha_12 = (-rhoE_B0(1) + rhoE_B0(2))*AVG_0_0_LEV_13 + (-rhoN_B0(1) + rhoN_B0(2))*AVG_0_0_LEV_10 + (-rhoN2_B0(1) +
      rhoN2_B0(2))*AVG_0_0_LEV_11 + (-rhou0_B0(1) + rhou0_B0(2))*AVG_0_0_LEV_12;

    alpha_22 = (-rhoE_B0(1) + rhoE_B0(2))*AVG_0_0_LEV_23 + (-rhoN_B0(1) + rhoN_B0(2))*AVG_0_0_LEV_20 + (-rhoN2_B0(1) +
      rhoN2_B0(2))*AVG_0_0_LEV_21 + (-rhou0_B0(1) + rhou0_B0(2))*AVG_0_0_LEV_22;

    alpha_32 = (-rhoE_B0(1) + rhoE_B0(2))*AVG_0_0_LEV_33 + (-rhoN_B0(1) + rhoN_B0(2))*AVG_0_0_LEV_30 + (-rhoN2_B0(1) +
...
: (
   ...
   phi_star_3 = kappa_TVD*phi_3*theta_3;
    ...
    wk0_B0(0) = 0.5*(AVG_0_REV_00*phi_star_0 + AVG_0_REV_01*phi_star_1 + AVG_0_REV_02*phi_star_2 +
      AVG_0_REV_03*phi_star_3);

   wk1_B0(0) = 0.5*(AVG_0_REV_10*phi_star_0 + AVG_0_REV_12*phi_star_2 + AVG_0_REV_13*phi_star_3);

   wk2_B0(0) = 0.5*(AVG_0_REV_21*phi_star_1 + AVG_0_REV_22*phi_star_2 + AVG_0_REV_23*phi_star_3);
...
ACC<double> &wk3_B0, ACC<double> &rhoE_B0, ACC<double> &rhoN2_B0, ACC<double> &rhoN_B0, ACC<double> &rhou0_B0, const int
*idx)
{
   double Grid_0 = 0.0;
   double Wall = 0.0;
