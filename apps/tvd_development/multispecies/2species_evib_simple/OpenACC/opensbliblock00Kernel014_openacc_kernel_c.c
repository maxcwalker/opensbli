...
int xdim13_opensbliblock00Kernel014;
int xdim14_opensbliblock00Kernel014;
int xdim15_opensbliblock00Kernel014;

//user function
inline 
 void opensbliblock00Kernel014(const ptr_double ev_B0,
  ...
  const int *idx)
{
   ...
   OPS_ACC(Residual0_B0, 0) = -d1_rhoNu0_dx;

   OPS_ACC(Residual1_B0, 0) = -d1_rhoN2u0_dx;

   OPS_ACC(Residual2_B0, 0) = -d1_prhou0u0_dx;

   OPS_ACC(Residual3_B0, 0) = -d1_rhoevu0_dx + (OPS_ACC(rhoN2_B0, 0)*OPS_ACC(eveqN2_B0, 0) - OPS_ACC(ev_B0, 0)*OPS_ACC(rho_B0, 0))/OPS_ACC(tau_B0, 0);
