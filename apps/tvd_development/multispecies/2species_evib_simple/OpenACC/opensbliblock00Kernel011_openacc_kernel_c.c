...
int xdim9_opensbliblock00Kernel011;
int xdim10_opensbliblock00Kernel011;
int xdim11_opensbliblock00Kernel011;

//user function
inline 
 void opensbliblock00Kernel011(const ptr_double Residual0_B0,
