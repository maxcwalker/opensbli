...
//
__constant__ int dims_opensbliblock00Kernel011 [14][1];
static int dims_opensbliblock00Kernel011_h [14][1] = {{0}};

//user function
__device__

 void opensbliblock00Kernel011_gpu(const ACC<double> &Residual0_B0,
...
void ops_par_loop_opensbliblock00Kernel011_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_opensbliblock00Kernel011_h[0][0] || xdim1 != dims_opensbliblock00Kernel011_h[1][0] || xdim2 != dims_opensbliblock00Kernel011_h[2][0] || xdim3 != dims_opensbliblock00Kernel011_h[3][0] || xdim4 != dims_opensbliblock00Kernel011_h[4][0] || xdim5 != dims_opensbliblock00Kernel011_h[5][0] || xdim6 != dims_opensbliblock00Kernel011_h[6][0] || xdim7 != dims_opensbliblock00Kernel011_h[7][0] || xdim8 != dims_opensbliblock00Kernel011_h[8][0] || xdim9 != dims_opensbliblock00Kernel011_h[9][0] || xdim10 != dims_opensbliblock00Kernel011_h[10][0] || xdim11 != dims_opensbliblock00Kernel011_h[11][0]) {
    ...
    dims_opensbliblock00Kernel011_h[9][0] = xdim9;
    dims_opensbliblock00Kernel011_h[10][0] = xdim10;
    dims_opensbliblock00Kernel011_h[11][0] = xdim11;
...
void ops_par_loop_opensbliblock00Kernel011(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg12, ops_arg arg13) {
  ...
  create_kerneldesc_and_enque(name, args, 14, 7, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel011_execute);
}
#endif
