...
//
__constant__ int dims_opensbliblock00Kernel014 [17][1];
static int dims_opensbliblock00Kernel014_h [17][1] = {{0}};

//user function
__device__

 void opensbliblock00Kernel014_gpu(const ACC<double> &ev_B0,
...
void ops_par_loop_opensbliblock00Kernel014_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_opensbliblock00Kernel014_h[0][0] || xdim1 != dims_opensbliblock00Kernel014_h[1][0] || xdim2 != dims_opensbliblock00Kernel014_h[2][0] || xdim3 != dims_opensbliblock00Kernel014_h[3][0] || xdim4 != dims_opensbliblock00Kernel014_h[4][0] || xdim5 != dims_opensbliblock00Kernel014_h[5][0] || xdim6 != dims_opensbliblock00Kernel014_h[6][0] || xdim7 != dims_opensbliblock00Kernel014_h[7][0] || xdim8 != dims_opensbliblock00Kernel014_h[8][0] || xdim9 != dims_opensbliblock00Kernel014_h[9][0] || xdim10 != dims_opensbliblock00Kernel014_h[10][0] || xdim11 != dims_opensbliblock00Kernel014_h[11][0] || xdim12 != dims_opensbliblock00Kernel014_h[12][0] || xdim13 != dims_opensbliblock00Kernel014_h[13][0] || xdim14 != dims_opensbliblock00Kernel014_h[14][0] || xdim15 != dims_opensbliblock00Kernel014_h[15][0]) {
    ...
    dims_opensbliblock00Kernel014_h[13][0] = xdim13;
    dims_opensbliblock00Kernel014_h[14][0] = xdim14;
    dims_opensbliblock00Kernel014_h[15][0] = xdim15;
...
void ops_par_loop_opensbliblock00Kernel014(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg16) {
  ...
  create_kerneldesc_and_enque(name, args, 17, 6, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel014_execute);
}
#endif
