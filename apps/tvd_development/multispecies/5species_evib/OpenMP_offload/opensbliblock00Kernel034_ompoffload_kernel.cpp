...
void ops_par_loop_opensbliblock00Kernel034_execute(ops_kernel_descriptor *desc) {
  ...
  double * __restrict__ evN2_B0_p = (double *)(args[0].data_d + base0);

  int base1 = args[1].dat->base_offset;
  double * __restrict__ evNO_B0_p = (double *)(args[1].data_d + base1);

  int base2 = args[2].dat->base_offset;
  double * __restrict__ evO2_B0_p = (double *)(args[2].data_d + base2);

  int base3 = args[3].dat->base_offset;
  double * __restrict__ eveqN2_B0_p = (double *)(args[3].data_d + base3);

  int base4 = args[4].dat->base_offset;
  double * __restrict__ eveqNO_B0_p = (double *)(args[4].data_d + base4);

  int base5 = args[5].dat->base_offset;
  double * __restrict__ eveqO2_B0_p = (double *)(args[5].data_d + base5);

  int base6 = args[6].dat->base_offset;
  double * __restrict__ p_B0_p = (double *)(args[6].data_d + base6);

  int base7 = args[7].dat->base_offset;
  double * __restrict__ ptauN2_B0_p = (double *)(args[7].data_d + base7);

  int base8 = args[8].dat->base_offset;
  double * __restrict__ ptauNO_B0_p = (double *)(args[8].data_d + base8);

  int base9 = args[9].dat->base_offset;
  double * __restrict__ ptauO2_B0_p = (double *)(args[9].data_d + base9);

  int base10 = args[10].dat->base_offset;
  double * __restrict__ rhoE_B0_p = (double *)(args[10].data_d + base10);

  int base11 = args[11].dat->base_offset;
  double * __restrict__ rhoN2_B0_p = (double *)(args[11].data_d + base11);

  int base12 = args[12].dat->base_offset;
  double * __restrict__ rhoNO_B0_p = (double *)(args[12].data_d + base12);

  int base13 = args[13].dat->base_offset;
  double * __restrict__ rhoN_B0_p = (double *)(args[13].data_d + base13);

  int base14 = args[14].dat->base_offset;
  double * __restrict__ rhoO2_B0_p = (double *)(args[14].data_d + base14);

  int base15 = args[15].dat->base_offset;
  double * __restrict__ rhoO_B0_p = (double *)(args[15].data_d + base15);

  int base16 = args[16].dat->base_offset;
  double * __restrict__ rhoev_B0_p = (double *)(args[16].data_d + base16);
  ...
  double * __restrict__ u0_B0_p = (double *)(args[18].data_d + base18);

  int base19 = args[19].dat->base_offset;
  double * __restrict__ wdotN2_B0_p = (double *)(args[19].data_d + base19);

  int base20 = args[20].dat->base_offset;
  double * __restrict__ wdotNO_B0_p = (double *)(args[20].data_d + base20);

  int base21 = args[21].dat->base_offset;
  double * __restrict__ wdotN_B0_p = (double *)(args[21].data_d + base21);

  int base22 = args[22].dat->base_offset;
  double * __restrict__ wdotO2_B0_p = (double *)(args[22].data_d + base22);

  int base23 = args[23].dat->base_offset;
  double * __restrict__ wdotO_B0_p = (double *)(args[23].data_d + base23);

  int base24 = args[24].dat->base_offset;
  double * __restrict__ wk0_B0_p = (double *)(args[24].data_d + base24);

  int base25 = args[25].dat->base_offset;
  double * __restrict__ Residual0_B0_p = (double *)(args[25].data_d + base25);

  int base26 = args[26].dat->base_offset;
  double * __restrict__ Residual1_B0_p = (double *)(args[26].data_d + base26);

  int base27 = args[27].dat->base_offset;
  double * __restrict__ Residual2_B0_p = (double *)(args[27].data_d + base27);

  int base28 = args[28].dat->base_offset;
  double * __restrict__ Residual3_B0_p = (double *)(args[28].data_d + base28);

  int base29 = args[29].dat->base_offset;
  double * __restrict__ Residual4_B0_p = (double *)(args[29].data_d + base29);

  int base30 = args[30].dat->base_offset;
  double * __restrict__ Residual5_B0_p = (double *)(args[30].data_d + base30);

  int base31 = args[31].dat->base_offset;
  double * __restrict__ Residual6_B0_p = (double *)(args[31].data_d + base31);

  int base32 = args[32].dat->base_offset;
  double * __restrict__ Residual7_B0_p = (double *)(args[32].data_d + base32);
...
void ops_par_loop_opensbliblock00Kernel034(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg32, ops_arg arg33) {
  ...
  create_kerneldesc_and_enque(name, args, 34, 25, dim, 0, range, block, ops_par_loop_opensbliblock00Kernel034_execute);
}
#endif
