...
extern double MN2;
cl::sycl::buffer<double,1> *MNO_p=nullptr;
extern double MNO;
cl::sycl::buffer<double,1> *MO_p=nullptr;
extern double MO;
cl::sycl::buffer<double,1> *MO2_p=nullptr;
extern double MO2;
cl::sycl::buffer<double,1> *Re_p=nullptr;
extern double Re;
cl::sycl::buffer<double,1> *Rhat_p=nullptr;
extern double Rhat;
cl::sycl::buffer<double,1> *Sc_p=nullptr;
extern double Sc;
...
extern double cN2;
cl::sycl::buffer<double,1> *cNO_p=nullptr;
extern double cNO;
cl::sycl::buffer<double,1> *cO_p=nullptr;
extern double cO;
cl::sycl::buffer<double,1> *cO2_p=nullptr;
extern double cO2;
cl::sycl::buffer<double,1> *delta_TVD_p=nullptr;
extern double delta_TVD;
cl::sycl::buffer<double,1> *dhN_p=nullptr;
extern double dhN;
cl::sycl::buffer<double,1> *dhNO_p=nullptr;
extern double dhNO;
cl::sycl::buffer<double,1> *dhO_p=nullptr;
extern double dhO;
...
cl::sycl::buffer<double,1> *invMNO_p=nullptr;
extern double invMNO;
cl::sycl::buffer<double,1> *invMO_p=nullptr;
extern double invMO;
cl::sycl::buffer<double,1> *invMO2_p=nullptr;
...
cl::sycl::buffer<double,1> *invSc_p=nullptr;
extern double invSc;
...
cl::sycl::buffer<double,1> *thetavNO_p=nullptr;
extern double thetavNO;
cl::sycl::buffer<double,1> *thetavO2_p=nullptr;
...
void ops_decl_const_char(OPS_instance *instance, int dim, char const * type, int size, char * dat, char const * name ) {
  ...
  if (!strcmp(name,"MNO")) {
    if (MNO_p == nullptr) MNO_p = new cl::sycl::buffer<double,1>(cl::sycl::range<1>(dim));
    auto accessor = (*MNO_p).get_access<cl::sycl::access::mode::write>();
    for ( int d=0; d<dim; d++ ){
      accessor[d] = ((double*)dat)[d];
    }
  }
  ...
  if (!strcmp(name,"MO")) {
    if (MO_p == nullptr) MO_p = new cl::sycl::buffer<double,1>(cl::sycl::range<1>(dim));
    auto accessor = (*MO_p).get_access<cl::sycl::access::mode::write>();
    for ( int d=0; d<dim; d++ ){
      accessor[d] = ((double*)dat)[d];
    }
  }
  ...
  if (!strcmp(name,"MO2")) {
    if (MO2_p == nullptr) MO2_p = new cl::sycl::buffer<double,1>(cl::sycl::range<1>(dim));
    auto accessor = (*MO2_p).get_access<cl::sycl::access::mode::write>();
    for ( int d=0; d<dim; d++ ){
      accessor[d] = ((double*)dat)[d];
    }
  }
  ...
  if (!strcmp(name,"Sc")) {
    if (Sc_p == nullptr) Sc_p = new cl::sycl::buffer<double,1>(cl::sycl::range<1>(dim));
    auto accessor = (*Sc_p).get_access<cl::sycl::access::mode::write>();
    for ( int d=0; d<dim; d++ ){
      accessor[d] = ((double*)dat)[d];
    }
  }
  ...
  if (!strcmp(name,"cNO")) {
    if (cNO_p == nullptr) cNO_p = new cl::sycl::buffer<double,1>(cl::sycl::range<1>(dim));
    auto accessor = (*cNO_p).get_access<cl::sycl::access::mode::write>();
    for ( int d=0; d<dim; d++ ){
      accessor[d] = ((double*)dat)[d];
    }
  }
  ...
  if (!strcmp(name,"cO")) {
    if (cO_p == nullptr) cO_p = new cl::sycl::buffer<double,1>(cl::sycl::range<1>(dim));
    auto accessor = (*cO_p).get_access<cl::sycl::access::mode::write>();
    for ( int d=0; d<dim; d++ ){
      accessor[d] = ((double*)dat)[d];
    }
  }
  ...
  if (!strcmp(name,"cO2")) {
    if (cO2_p == nullptr) cO2_p = new cl::sycl::buffer<double,1>(cl::sycl::range<1>(dim));
    auto accessor = (*cO2_p).get_access<cl::sycl::access::mode::write>();
    for ( int d=0; d<dim; d++ ){
      accessor[d] = ((double*)dat)[d];
    }
  }
  ...
  if (!strcmp(name,"dhNO")) {
    if (dhNO_p == nullptr) dhNO_p = new cl::sycl::buffer<double,1>(cl::sycl::range<1>(dim));
    auto accessor = (*dhNO_p).get_access<cl::sycl::access::mode::write>();
    for ( int d=0; d<dim; d++ ){
      accessor[d] = ((double*)dat)[d];
    }
  }
  ...
  if (!strcmp(name,"dhO")) {
    if (dhO_p == nullptr) dhO_p = new cl::sycl::buffer<double,1>(cl::sycl::range<1>(dim));
    auto accessor = (*dhO_p).get_access<cl::sycl::access::mode::write>();
    for ( int d=0; d<dim; d++ ){
      accessor[d] = ((double*)dat)[d];
    }
  }
  ...
  if (!strcmp(name,"invMNO")) {
    if (invMNO_p == nullptr) invMNO_p = new cl::sycl::buffer<double,1>(cl::sycl::range<1>(dim));
    auto accessor = (*invMNO_p).get_access<cl::sycl::access::mode::write>();
    for ( int d=0; d<dim; d++ ){
      accessor[d] = ((double*)dat)[d];
    }
  }
  ...
  if (!strcmp(name,"invMO")) {
    if (invMO_p == nullptr) invMO_p = new cl::sycl::buffer<double,1>(cl::sycl::range<1>(dim));
    auto accessor = (*invMO_p).get_access<cl::sycl::access::mode::write>();
    for ( int d=0; d<dim; d++ ){
      accessor[d] = ((double*)dat)[d];
    }
  }
  ...
  if (!strcmp(name,"invMO2")) {
    if (invMO2_p == nullptr) invMO2_p = new cl::sycl::buffer<double,1>(cl::sycl::range<1>(dim));
    auto accessor = (*invMO2_p).get_access<cl::sycl::access::mode::write>();
    for ( int d=0; d<dim; d++ ){
      accessor[d] = ((double*)dat)[d];
    }
  }
  ...
  if (!strcmp(name,"invSc")) {
    if (invSc_p == nullptr) invSc_p = new cl::sycl::buffer<double,1>(cl::sycl::range<1>(dim));
    auto accessor = (*invSc_p).get_access<cl::sycl::access::mode::write>();
    for ( int d=0; d<dim; d++ ){
      accessor[d] = ((double*)dat)[d];
    }
  }
  ...
  if (!strcmp(name,"thetavNO")) {
    if (thetavNO_p == nullptr) thetavNO_p = new cl::sycl::buffer<double,1>(cl::sycl::range<1>(dim));
    auto accessor = (*thetavNO_p).get_access<cl::sycl::access::mode::write>();
    for ( int d=0; d<dim; d++ ){
      accessor[d] = ((double*)dat)[d];
    }
  }
  ...
  if (!strcmp(name,"thetavO2")) {
    if (thetavO2_p == nullptr) thetavO2_p = new cl::sycl::buffer<double,1>(cl::sycl::range<1>(dim));
    auto accessor = (*thetavO2_p).get_access<cl::sycl::access::mode::write>();
    for ( int d=0; d<dim; d++ ){
      accessor[d] = ((double*)dat)[d];
    }
  }
