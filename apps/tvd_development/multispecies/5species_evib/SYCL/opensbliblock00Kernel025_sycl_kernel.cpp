...
void ops_par_loop_opensbliblock00Kernel025_execute(ops_kernel_descriptor *desc) {
  ...
  double* evO2_B0_p = (double*)args[1].data_d;
  ...
  if ((end[0]-start[0])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      , [=](cl::sycl::nd_item<1> item
        ...
        ACC<double> evO2_B0(&evO2_B0_p[0] + base1 + n_x*1);
        //USER CODE
        if (n_x < end_0) {
          
   evO2_B0(0) = Rhat_sycl[0]*invMO2_sycl[0]*thetavO2_sycl[0]/(-1.0 + cl::sycl::exp(thetavO2_sycl[0]/Tv_B0(0)));
