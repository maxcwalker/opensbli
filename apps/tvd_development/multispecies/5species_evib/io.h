...
ops_write_const_hdf5("MNO", 1, "double", (char*)&MNO, filename);
ops_write_const_hdf5("MO", 1, "double", (char*)&MO, filename);
ops_write_const_hdf5("MO2", 1, "double", (char*)&MO2, filename);
ops_write_const_hdf5("Re", 1, "double", (char*)&Re, filename);
ops_write_const_hdf5("Rhat", 1, "double", (char*)&Rhat, filename);
ops_write_const_hdf5("Sc", 1, "double", (char*)&Sc, filename);
...
ops_write_const_hdf5("cNO", 1, "double", (char*)&cNO, filename);
ops_write_const_hdf5("cO", 1, "double", (char*)&cO, filename);
ops_write_const_hdf5("cO2", 1, "double", (char*)&cO2, filename);
ops_write_const_hdf5("delta_TVD", 1, "double", (char*)&delta_TVD, filename);
ops_write_const_hdf5("dhN", 1, "double", (char*)&dhN, filename);
ops_write_const_hdf5("dhNO", 1, "double", (char*)&dhNO, filename);
ops_write_const_hdf5("dhO", 1, "double", (char*)&dhO, filename);
...
ops_write_const_hdf5("thetavNO", 1, "double", (char*)&thetavNO, filename);
ops_write_const_hdf5("thetavO2", 1, "double", (char*)&thetavO2, filename);
...
void HDF5_IO_Write_0_opensbliblock00_dynamic(ops_block& opensbliblock00, int iter, ops_dat& rhoO_B0, ops_dat& rhoO2_B0, ops_dat& rhoN_B0, ops_dat& rhoN2_B0, ops_dat& rhoNO_B0, ops_dat& rhou0_B0, ops_dat& rhoev_B0, ops_dat& rhoE_B0, ops_dat& x0_B0, int HDF5_timing){
...
ops_fetch_dat_hdf5_file(rhoO_B0, name0);
ops_fetch_dat_hdf5_file(rhoO2_B0, name0);
ops_fetch_dat_hdf5_file(rhoN_B0, name0);
ops_fetch_dat_hdf5_file(rhoN2_B0, name0);
ops_fetch_dat_hdf5_file(rhoNO_B0, name0);
...
void HDF5_IO_Write_0_opensbliblock00(ops_block& opensbliblock00, ops_dat& rhoO_B0, ops_dat& rhoO2_B0, ops_dat& rhoN_B0, ops_dat& rhoN2_B0, ops_dat& rhoNO_B0, ops_dat& rhou0_B0, ops_dat& rhoev_B0, ops_dat& rhoE_B0, ops_dat& x0_B0, int HDF5_timing){
double cpu_start0, elapsed_start0;
if (HDF5_timing == 1){
ops_timers(&cpu_start0, &elapsed_start0);
}
