...
//
__constant__ int dims_opensbliblock00Kernel042 [8][1];
static int dims_opensbliblock00Kernel042_h [8][1] = {{0}};
...
void ops_par_loop_opensbliblock00Kernel042(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4, ops_arg arg5, ops_arg arg6, ops_arg arg7) {
  ...
  create_kerneldesc_and_enque(name, args, 8, 1, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel042_execute);
}
#endif
