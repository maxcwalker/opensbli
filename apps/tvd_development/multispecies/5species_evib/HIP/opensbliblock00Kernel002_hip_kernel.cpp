...
//
__constant__ int dims_opensbliblock00Kernel002 [9][1];
static int dims_opensbliblock00Kernel002_h [9][1] = {{0}};
...
void ops_par_loop_opensbliblock00Kernel002(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg8) {
  ...
  create_kerneldesc_and_enque(name, args, 9, 28, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel002_execute);
}
#endif
