...
void opensbliblock00Kernel025_gpu(const ACC<double> &Tv_B0,
  ACC<double> &evO2_B0)
{
...
void ops_par_loop_opensbliblock00Kernel025(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1) {
  ...
  create_kerneldesc_and_enque(name, args, 2, 13, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel025_execute);
}
#endif
