...
#define OPENSBLIBLOCK00_KERNEL_H
 void opensbliblock00Kernel022(ACC<double> &rhoE_B0, ACC<double> &rhoN2_B0, ACC<double> &rhoN_B0, ACC<double> &rhoev_B0,
...
{
    T_B0(0) = (-0.5*(u0_B0(0)*u0_B0(0))*(rhoN_B0(0) + rhoN2_B0(0)) - 1.0e-14*dhN*invMN*rhoN_B0(0) +
...
void opensbliblock00Kernel018(const ACC<double> &T_B0, ACC<double> &eveqN2_B0)
{
 ...
 void opensbliblock00Kernel019(const ACC<double> &T_B0, const ACC<double> &rhoN2_B0, const ACC<double> &rhoN_B0,
...
void opensbliblock00Kernel008(const ACC<double> &T_B0, ACC<double> &wk1_B0, const int *idx)
{
   if (idx[0] == 0){

      wk1_B0(0) = (3.0*T_B0(1) + 0.333333333333333*T_B0(3) - 1.5*T_B0(2) - 1.83333333333333*T_B0(0))*invDelta0block0;

   }

   else if (idx[0] == 1){

       wk1_B0(0) = (0.0394168524399447*T_B0(2) + 0.00571369039775442*T_B0(4) + 0.719443173328855*T_B0(1) -
       ...
       wk1_B0(0) = (0.197184333887745*T_B0(0) + 0.521455851089587*T_B0(1) + 0.113446470384241*T_B0(-2) -
       ...
       wk1_B0(0) = (0.0451033223343881*T_B0(0) + 0.652141084861241*T_B0(1) + 0.121937153224065*T_B0(-2) -
       ...
       wk1_B0(0) = (1.5*T_B0(-2) + 1.83333333333333*T_B0(0) - 3.0*T_B0(-1) -
            0.333333333333333*T_B0(-3))*invDelta0block0;

   }

   else if (idx[0] == -2 + block0np0){

       wk1_B0(0) = (0.322484932882161*T_B0(0) + 0.0658051057710389*T_B0(-3) + 0.376283677513354*T_B0(1) -
       ...
       wk1_B0(0) = (0.00412637789557492*T_B0(-3) + 0.0367146847001261*T_B0(-2) + 0.791245592765872*T_B0(1) -
       ...
       wk1_B0(0) = (0.00932597985049999*T_B0(3) + 0.727822147724592*T_B0(1) + 0.082033432844602*T_B0(-2) -
       ...
       wk1_B0(0) = (-(2.0/3.0)*T_B0(-1) - (1.0/12.0)*T_B0(2) + ((1.0/12.0))*T_B0(-2) +
 ...
 void opensbliblock00Kernel016(const ACC<double> &eveqN2_B0, const ACC<double> &p_B0, const ACC<double> &ptauN2_B0,
const ACC<double> &rhoE_B0, const ACC<double> &rhoN2_B0, const ACC<double> &rhoN_B0, const ACC<double> &rhoev_B0, const
ACC<double> &rhou0_B0, const ACC<double> &u0_B0, const ACC<double> &wdotN2_B0, const ACC<double> &wdotN_B0, ACC<double>
...
void opensbliblock00Kernel017(const ACC<double> &T_B0, ACC<double> &Residual4_B0, const int *idx)
{
   double d2_T_dx = 0.0;
   if (idx[0] == 0){
...
ACC<double> &u0_B0, ACC<double> &wk0_B0, ACC<double> &wk1_B0, ACC<double> &wk2_B0, ACC<double> &wk3_B0, ACC<double>
&wk4_B0)
{
