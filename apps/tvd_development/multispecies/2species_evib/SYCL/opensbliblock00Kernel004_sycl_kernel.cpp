...
void ops_par_loop_opensbliblock00Kernel004_execute(ops_kernel_descriptor *desc) {
 ...
 arg10, arg11, arg12};
  ...
  if ((end[0]-start[0])>0) {
   ...
   AVG_0_0_LEV_03 = 1.0*(inv_AVG_a*inv_AVG_a)*gamma_m1_sycl[0]*AVG_0_rhoN/(AVG_0_rhoN + AVG_0_rhoN2);
   ...
   AVG_0_0_LEV_22 = -0.5*(-1.0 + 1.0*gama_sycl[0])*AVG_0_u0*inv_AVG_a/(AVG_0_rhoN + AVG_0_rhoN2);

   AVG_0_0_LEV_23 = -0.5*gamma_m1_sycl[0]*inv_AVG_a/(AVG_0_rhoN + AVG_0_rhoN2);

   AVG_0_0_LEV_24 = 0.5*(-1.0 + 1.0*gama_sycl[0])*inv_AVG_a/(AVG_0_rhoN + AVG_0_rhoN2);
   ...
   AVG_0_0_LEV_34 = 0.25*((-1.0 + 1.0*gama_sycl[0])*(-1.0 + 1.0*gama_sycl[0]))*inv_AVG_a/(AVG_0_rhoN + AVG_0_rhoN2);
    ...
    AVG_0_0_LEV_42 = 0.25*(-1.0 + 1.0*gama_sycl[0])*(1.0*AVG_0_a + 1.0*AVG_0_u0 - 1.0*gama_sycl[0]*AVG_0_u0)*inv_AVG_a/(AVG_0_rhoN +
      AVG_0_rhoN2);

   AVG_0_0_LEV_43 = -0.25*((-1.0 + 1.0*gama_sycl[0])*(-1.0 + 1.0*gama_sycl[0]))*inv_AVG_a/(AVG_0_rhoN + AVG_0_rhoN2);

   AVG_0_0_LEV_44 = 0.25*((-1.0 + 1.0*gama_sycl[0])*(-1.0 + 1.0*gama_sycl[0]))*inv_AVG_a/(AVG_0_rhoN + AVG_0_rhoN2);
   ...
   AVG_0_REV_42 = -2.0*(0.5*(AVG_0_u0*AVG_0_u0) + AVG_0_ev)*(AVG_0_rhoN + AVG_0_rhoN2)*inv_AVG_a;
    ...
    AVG_0_REV_43 = 2.0*(AVG_0_rhoN + AVG_0_rhoN2)*((AVG_0_a*AVG_0_a) + (AVG_0_a*AVG_0_a)*gamma_m1_sycl[0] +
      (0.5*(AVG_0_u0*AVG_0_u0) + AVG_0_ev)*gama_sycl[0]*gamma_m1_sycl[0] -
      gama_sycl[0]*gamma_m1_sycl[0]*AVG_0_a*AVG_0_u0)*invgama_sycl[0]*inv2gamma_m1_sycl[0]*inv_AVG_a;

    AVG_0_REV_44 = 2.0*(AVG_0_rhoN + AVG_0_rhoN2)*((AVG_0_a*AVG_0_a) + (AVG_0_a*AVG_0_a)*gamma_m1_sycl[0] +
      (0.5*(AVG_0_u0*AVG_0_u0) + AVG_0_ev)*gama_sycl[0]*gamma_m1_sycl[0] +
      gama_sycl[0]*gamma_m1_sycl[0]*AVG_0_a*AVG_0_u0)*invgama_sycl[0]*inv2gamma_m1_sycl[0]*inv_AVG_a;
