...
//
__constant__ int dims_opensbliblock00Kernel005 [11][1];
static int dims_opensbliblock00Kernel005_h [11][1] = {{0}};
...
void ops_par_loop_opensbliblock00Kernel005(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg8, ops_arg arg9, ops_arg arg10) {
  ...
  create_kerneldesc_and_enque(name, args, 11, 16, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel005_execute);
}
#endif
