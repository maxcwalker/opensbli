...
//
__constant__ int dims_opensbliblock00Kernel043 [1][1];
static int dims_opensbliblock00Kernel043_h [1][1] = {{0}};

//user function
__device__

void opensbliblock00Kernel043_gpu(ACC<double> &wdotO2_B0)
{
   wdotO2_B0(0) = 0.0;
...
void ops_par_loop_opensbliblock00Kernel043_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_opensbliblock00Kernel043_h[0][0]) {
...
void ops_par_loop_opensbliblock00Kernel043(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0) {
  ...
  create_kerneldesc_and_enque(name, args, 1, 10, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel043_execute);
}
#endif
