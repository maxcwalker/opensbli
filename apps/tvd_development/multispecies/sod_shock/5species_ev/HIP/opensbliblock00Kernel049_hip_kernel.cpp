...
//
__constant__ int dims_opensbliblock00Kernel049 [1][1];
static int dims_opensbliblock00Kernel049_h [1][1] = {{0}};

//user function
__device__

void opensbliblock00Kernel049_gpu(ACC<double> &wdotO_B0)
{
   wdotO_B0(0) = 0.0;
...
void ops_par_loop_opensbliblock00Kernel049_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_opensbliblock00Kernel049_h[0][0]) {
...
void ops_par_loop_opensbliblock00Kernel049(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0) {
  ...
  create_kerneldesc_and_enque(name, args, 1, 14, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel049_execute);
}
#endif
