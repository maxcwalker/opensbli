...
//
__constant__ int dims_opensbliblock00Kernel038 [1][1];
static int dims_opensbliblock00Kernel038_h [1][1] = {{0}};

//user function
__device__

void opensbliblock00Kernel038_gpu(ACC<double> &wdotN_B0)
{
   wdotN_B0(0) = 0.0;
...
void ops_par_loop_opensbliblock00Kernel038_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_opensbliblock00Kernel038_h[0][0]) {
...
void ops_par_loop_opensbliblock00Kernel038(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0) {
  ...
  create_kerneldesc_and_enque(name, args, 1, 8, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel038_execute);
}
#endif
