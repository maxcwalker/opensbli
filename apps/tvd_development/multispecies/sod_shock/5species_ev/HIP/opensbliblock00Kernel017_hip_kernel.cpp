...
//
__constant__ int dims_opensbliblock00Kernel017 [9][1];
static int dims_opensbliblock00Kernel017_h [9][1] = {{0}};

//user function
__device__

 void opensbliblock00Kernel017_gpu(const ACC<double> &rhoE_B0,
...
void ops_par_loop_opensbliblock00Kernel017(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg8) {
  ...
  create_kerneldesc_and_enque(name, args, 9, 12, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel017_execute);
}
#endif
