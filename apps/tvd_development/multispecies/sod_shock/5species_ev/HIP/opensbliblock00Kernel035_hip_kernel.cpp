...
//
__constant__ int dims_opensbliblock00Kernel035 [7][1];
static int dims_opensbliblock00Kernel035_h [7][1] = {{0}};
...
ACC<double> &XN_B0,
  ...
  ACC<double> &mu_B0)
{
    mu_B0(0) = (1.0 - exp(-0.010568*T_B0(0)))*(8.0133632789385e-7*pow(T_B0(0), 0.42509 +
      0.022652*log(T_B0(0)))*(XN_B0(0) + XO_B0(0)) + 1.34007484243992e-6*pow(T_B0(0), 0.34567 +
...
void ops_par_loop_opensbliblock00Kernel035_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_opensbliblock00Kernel035_h[0][0] || xdim1 != dims_opensbliblock00Kernel035_h[1][0] || xdim2 != dims_opensbliblock00Kernel035_h[2][0] || xdim3 != dims_opensbliblock00Kernel035_h[3][0] || xdim4 != dims_opensbliblock00Kernel035_h[4][0] || xdim5 != dims_opensbliblock00Kernel035_h[5][0] || xdim6 != dims_opensbliblock00Kernel035_h[6][0]) {
...
void ops_par_loop_opensbliblock00Kernel035(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4, ops_arg arg5, ops_arg arg6) {
  ...
  create_kerneldesc_and_enque(name, args, 7, 26, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel035_execute);
}
#endif
