...
//
__constant__ int dims_opensbliblock00Kernel016 [6][1];
static int dims_opensbliblock00Kernel016_h [6][1] = {{0}};

//user function
__device__

 void opensbliblock00Kernel016_gpu(const ACC<double> &rhoN2_B0,
  ...
  ACC<double> &XN_B0)
{
    XN_B0(0) = invMN*rhoN_B0(0)/(invMN*rhoN_B0(0) + invMO*rhoO_B0(0) + invMN2*rhoN2_B0(0) + invMNO*rhoNO_B0(0) +
      invMO2*rhoO2_B0(0));
...
void ops_par_loop_opensbliblock00Kernel016_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_opensbliblock00Kernel016_h[0][0] || xdim1 != dims_opensbliblock00Kernel016_h[1][0] || xdim2 != dims_opensbliblock00Kernel016_h[2][0] || xdim3 != dims_opensbliblock00Kernel016_h[3][0] || xdim4 != dims_opensbliblock00Kernel016_h[4][0] || xdim5 != dims_opensbliblock00Kernel016_h[5][0]) {
...
void ops_par_loop_opensbliblock00Kernel016(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4, ops_arg arg5) {
  ...
  create_kerneldesc_and_enque(name, args, 6, 5, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel016_execute);
}
#endif
