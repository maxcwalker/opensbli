...
__device__
 ...
 void opensbliblock00Kernel047_gpu(const ACC<double> &rhoN2_B0,
  ...
  ACC<double> &yO2_B0)
{
   yO2_B0(0) = rhoO2_B0(0)/(rhoN_B0(0) + rhoO_B0(0) + rhoN2_B0(0) + rhoNO_B0(0) + rhoO2_B0(0));
...
void ops_par_loop_opensbliblock00Kernel047_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_opensbliblock00Kernel047_h[0][0] || xdim1 != dims_opensbliblock00Kernel047_h[1][0] || xdim2 != dims_opensbliblock00Kernel047_h[2][0] || xdim3 != dims_opensbliblock00Kernel047_h[3][0] || xdim4 != dims_opensbliblock00Kernel047_h[4][0] || xdim5 != dims_opensbliblock00Kernel047_h[5][0]) {
...
void ops_par_loop_opensbliblock00Kernel047(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4, ops_arg arg5) {
  ...
  create_kerneldesc_and_enque(name, args, 6, 12, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel047_execute);
}
#endif
