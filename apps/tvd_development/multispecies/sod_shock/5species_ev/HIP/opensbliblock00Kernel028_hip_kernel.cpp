...
//
__constant__ int dims_opensbliblock00Kernel028 [10][1];
static int dims_opensbliblock00Kernel028_h [10][1] = {{0}};
...
void ops_par_loop_opensbliblock00Kernel028(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg8, ops_arg arg9) {
  ...
  create_kerneldesc_and_enque(name, args, 10, 0, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel028_execute);
}
#endif
