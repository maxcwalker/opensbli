...
numerical_values     = [    '0.0000002', '600',       '200', '1.0/(block0np0-1)']
substitute_simulation_parameters(numerical_constants, numerical_values)

shockcap_data   = [    'eps', 'inv_rfact0_block0',     'lambda0_TVD', 'TENO_CT','kappa_TVD']
shockcap_values = ['1.0e-16',  '1.0/Delta0block0', 'dt/Delta0block0',  '1.0e-5','1.0']
