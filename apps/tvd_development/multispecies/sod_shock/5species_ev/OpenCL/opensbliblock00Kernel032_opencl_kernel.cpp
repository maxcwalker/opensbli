...
//
    ...
    void buildOpenCLKernels_opensbliblock00Kernel032(OPS_instance *instance, int xdim0, int xdim1, int xdim2, int xdim3, int xdim4, int xdim5, int xdim6, int xdim7, int xdim8) {
      ...
      if(!isbuilt_opensbliblock00Kernel032) {
        ...
        instance->ostream() <<"Compiling opensbliblock00Kernel032 "<<OCL_FMA<<" source -- start \n";
          ...
          if (pPath!=NULL)
            if(OCL_FMA)
              sprintf(buildOpts,"-cl-mad-enable -DOCL_FMA -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_opensbliblock00Kernel032=%d  -Dxdim1_opensbliblock00Kernel032=%d  -Dxdim2_opensbliblock00Kernel032=%d  -Dxdim3_opensbliblock00Kernel032=%d  -Dxdim4_opensbliblock00Kernel032=%d  -Dxdim5_opensbliblock00Kernel032=%d  -Dxdim6_opensbliblock00Kernel032=%d  -Dxdim7_opensbliblock00Kernel032=%d  -Dxdim8_opensbliblock00Kernel032=%d ", pPath, 32,xdim0,xdim1,xdim2,xdim3,xdim4,xdim5,xdim6,xdim7,xdim8);
            else
        ...
        instance->opencl_instance->OPS_opencl_core.kernel[19] = clCreateKernel(instance->opencl_instance->OPS_opencl_core.program, "ops_opensbliblock00Kernel032", &ret);
        clSafeCall( ret );
...
void ops_par_loop_opensbliblock00Kernel032(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg8) {
  ...
  #ifdef CHECKPOINTING
  if (!ops_checkpointing_before(args,9,range,19)) return;
  #endif

  if (block->instance->OPS_diags > 1) {
    ops_timing_realloc(block->instance,19,"opensbliblock00Kernel032");
  ...
  if (globalWorkSize[0]>0 && globalWorkSize[1]>0 && globalWorkSize[2]>0) {
    ...
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[19], 9, sizeof(cl_double), (void*) &dhf0N ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[19], 10, sizeof(cl_double), (void*) &dhf0NO ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[19], 11, sizeof(cl_double), (void*) &dhf0O ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[19], 12, sizeof(cl_double), (void*) &invMN ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[19], 13, sizeof(cl_double), (void*) &invMN2 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[19], 14, sizeof(cl_double), (void*) &invMNO ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[19], 15, sizeof(cl_double), (void*) &invMO ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[19], 16, sizeof(cl_double), (void*) &invMO2 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[19], 17, sizeof(cl_double), (void*) &invRhat ));
    ...
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[19], 27, sizeof(cl_int), (void*) &x_size ));
