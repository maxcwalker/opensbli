...
//user function
inline 
 void opensbliblock00Kernel056(const ptr_double rhoN2_B0,
  ...
  ptr_double yN2_B0)
{
   OPS_ACC(yN2_B0, 0) = OPS_ACC(rhoN2_B0, 0)/(OPS_ACC(rhoN_B0, 0) + OPS_ACC(rhoO_B0, 0) + OPS_ACC(rhoN2_B0, 0) + OPS_ACC(rhoNO_B0, 0) + OPS_ACC(rhoO2_B0, 0));
