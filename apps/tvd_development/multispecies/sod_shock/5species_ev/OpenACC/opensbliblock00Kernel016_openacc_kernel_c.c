...
//user function
inline 
 void opensbliblock00Kernel016(const ptr_double rhoN2_B0,
  ...
  ptr_double XN_B0)
{
    OPS_ACC(XN_B0, 0) = invMN*OPS_ACC(rhoN_B0, 0)/(invMN*OPS_ACC(rhoN_B0, 0) + invMO*OPS_ACC(rhoO_B0, 0) + invMN2*OPS_ACC(rhoN2_B0, 0) + invMNO*OPS_ACC(rhoNO_B0, 0) +
