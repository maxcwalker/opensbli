...
int xdim23_opensbliblock00Kernel029;

//user function
inline 
 void opensbliblock00Kernel029(const ptr_double Residual0_B0,
  ...
  const double *rkB)
{
   ...
   OPS_ACC(rhoO_RKold_B0, 0) = rkA[0]*OPS_ACC(rhoO_RKold_B0, 0) + dt*OPS_ACC(Residual2_B0, 0);

   OPS_ACC(rhoO_B0, 0) = rkB[0]*OPS_ACC(rhoO_RKold_B0, 0) + OPS_ACC(rhoO_B0, 0);

   OPS_ACC(rhoO2_RKold_B0, 0) = rkA[0]*OPS_ACC(rhoO2_RKold_B0, 0) + dt*OPS_ACC(Residual3_B0, 0);
