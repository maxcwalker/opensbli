...
void ops_par_loop_opensbliblock00Kernel032_execute(ops_kernel_descriptor *desc) {
 ...
 arg5, arg6, arg7, arg8};
  ...
  double* Tv_B0_p = (double*)args[8].data_d;
  ...
  if ((end[0]-start[0])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      cgh.parallel_for<class opensbliblock00Kernel032_kernel>(cl::sycl::nd_range<1>(cl::sycl::range<1>(
      ...
      , [=](cl::sycl::nd_item<1> item
        ...
        ACC<double> Tv_B0(&Tv_B0_p[0] + base8 + n_x*1);
        //USER CODE
        if (n_x < end_0) {
          
    Tv_B0(0) = (-rhoev_B0(0) - 0.5*(u0_B0(0)*u0_B0(0))*(rhoN_B0(0) + rhoO_B0(0) + rhoN2_B0(0) + rhoNO_B0(0) +
      rhoO2_B0(0)) - dhf0N_sycl[0]*invMN_sycl[0]*rhoN_B0(0) - dhf0O_sycl[0]*invMO_sycl[0]*rhoO_B0(0) - dhf0NO_sycl[0]*invMNO_sycl[0]*rhoNO_B0(0) +
      rhoE_B0(0))*invRhat_sycl[0]/(1.5*invMN_sycl[0]*rhoN_B0(0) + 1.5*invMO_sycl[0]*rhoO_B0(0) + 2.5*invMN2_sycl[0]*rhoN2_B0(0) + 2.5*invMNO_sycl[0]*rhoNO_B0(0)
      + 2.5*invMO2_sycl[0]*rhoO2_B0(0));
