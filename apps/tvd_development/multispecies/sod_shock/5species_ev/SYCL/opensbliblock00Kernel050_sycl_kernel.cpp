...
void ops_par_loop_opensbliblock00Kernel050_execute(ops_kernel_descriptor *desc) {
 ...
 arg5, arg6};
  ...
  double* cp_B0_p = (double*)args[0].data_d;
  ...
  double* gammaf_B0_p = (double*)args[6].data_d;
  ...
  if ((end[0]-start[0])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      cgh.parallel_for<class opensbliblock00Kernel050_kernel>(cl::sycl::nd_range<1>(cl::sycl::range<1>(
      ...
      , [=](cl::sycl::nd_item<1> item
        ...
        const ACC<double> cp_B0(&cp_B0_p[0] + base0 + n_x*1);
        ...
        ACC<double> gammaf_B0(&gammaf_B0_p[0] + base6 + n_x*1);
        //USER CODE
        if (n_x < end_0) {
          
    gammaf_B0(0) = cp_B0(0)/(-(invMN_sycl[0]*yN_B0(0) + invMO_sycl[0]*yO_B0(0) + invMN2_sycl[0]*yN2_B0(0) + invMNO_sycl[0]*yNO_B0(0) +
      invMO2_sycl[0]*yO2_B0(0))*Rhat_sycl[0] + cp_B0(0));
