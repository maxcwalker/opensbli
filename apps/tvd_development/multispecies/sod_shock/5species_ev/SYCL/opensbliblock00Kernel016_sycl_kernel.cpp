...
void ops_par_loop_opensbliblock00Kernel016_execute(ops_kernel_descriptor *desc) {
 ...
 arg5, arg6};
  ...
  double* ptauNO_B0_p = (double*)args[6].data_d;
  ...
  if ((end[0]-start[0])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      , [=](cl::sycl::nd_item<1> item
        ...
        ACC<double> ptauNO_B0(&ptauNO_B0_p[0] + base6 + n_x*1);
        //USER CODE
        if (n_x < end_0) {
          
    ptauNO_B0(0) = (6.69952094392908e-11*invMO2_sycl[0]*rhoO2_B0(0)*cl::sycl::exp(168.0*pow(T_B0(0), -0.333333333333333)) +
      1.07234831431176e-10*invMO_sycl[0]*rhoO_B0(0)*cl::sycl::exp(168.0*pow(T_B0(0), -0.333333333333333)) +
      1.18607665290378e-10*invMN_sycl[0]*rhoN_B0(0)*cl::sycl::exp(168.0*pow(T_B0(0), -0.333333333333333)) +
      7.04583049652578e-11*invMNO_sycl[0]*rhoNO_B0(0)*cl::sycl::exp(168.0*pow(T_B0(0), -0.333333333333333)) +
      7.28659255329465e-11*invMN2_sycl[0]*rhoN2_B0(0)*cl::sycl::exp(168.0*pow(T_B0(0), -0.333333333333333)))/(invMN_sycl[0]*rhoN_B0(0) +
