 ...
 arg25};
  ...
  if ((end[0]-start[0])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      cgh.parallel_for<class opensbliblock00Kernel060_kernel>(cl::sycl::nd_range<1>(cl::sycl::range<1>(
   ...
   rhoN2_RKold_B0(0) = rkA[0]*rhoN2_RKold_B0(0) + dt_sycl[0]*Residual0_B0(0);
   ...
   rhoNO_RKold_B0(0) = rkA[0]*rhoNO_RKold_B0(0) + dt_sycl[0]*Residual2_B0(0);

   rhoNO_B0(0) = rkB[0]*rhoNO_RKold_B0(0) + rhoNO_B0(0);

   rhoN_RKold_B0(0) = rkA[0]*rhoN_RKold_B0(0) + dt_sycl[0]*Residual3_B0(0);

   rhoN_B0(0) = rkB[0]*rhoN_RKold_B0(0) + rhoN_B0(0);

   rhoO_RKold_B0(0) = rkA[0]*rhoO_RKold_B0(0) + dt_sycl[0]*Residual4_B0(0);

   rhoO_B0(0) = rkB[0]*rhoO_RKold_B0(0) + rhoO_B0(0);

   rhoev_RKold_B0(0) = rkA[0]*rhoev_RKold_B0(0) + dt_sycl[0]*Residual5_B0(0);

   rhoev_B0(0) = rkB[0]*rhoev_RKold_B0(0) + rhoev_B0(0);

   rhou0_RKold_B0(0) = rkA[0]*rhou0_RKold_B0(0) + dt_sycl[0]*Residual6_B0(0);
...
void ops_par_loop_opensbliblock00Kernel060(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg24, ops_arg arg25) {
  ...
  desc->function = ops_par_loop_opensbliblock00Kernel060_execute;
  if (block->instance->OPS_diags > 1) {
    ops_timing_realloc(block->instance,45,"opensbliblock00Kernel060");
  }
