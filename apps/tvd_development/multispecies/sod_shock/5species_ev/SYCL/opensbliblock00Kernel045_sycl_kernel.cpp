...
void ops_par_loop_opensbliblock00Kernel045_execute(ops_kernel_descriptor *desc) {
 ...
 arg5, arg6, arg7};
  ...
  double* gammaf_B0_p = (double*)args[1].data_d;
  ...
  double* yO_B0_p = (double*)args[6].data_d;

  int base7 = args[7].dat->base_offset/sizeof(double);
  double* af_B0_p = (double*)args[7].data_d;
  ...
  if ((end[0]-start[0])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      , [=](cl::sycl::nd_item<1> item
        ...
        const ACC<double> gammaf_B0(&gammaf_B0_p[0] + base1 + n_x*1);
        ...
        const ACC<double> yO2_B0(&yO2_B0_p[0] + base5 + n_x*1);
        const ACC<double> yO_B0(&yO_B0_p[0] + base6 + n_x*1);
        ACC<double> af_B0(&af_B0_p[0] + base7 + n_x*1);
        //USER CODE
        if (n_x < end_0) {
          
    af_B0(0) = cl::sycl::sqrt((invMN_sycl[0]*yN_B0(0) + invMO_sycl[0]*yO_B0(0) + invMN2_sycl[0]*yN2_B0(0) + invMNO_sycl[0]*yNO_B0(0) +
      invMO2_sycl[0]*yO2_B0(0))*Rhat_sycl[0]*T_B0(0)*gammaf_B0(0));
