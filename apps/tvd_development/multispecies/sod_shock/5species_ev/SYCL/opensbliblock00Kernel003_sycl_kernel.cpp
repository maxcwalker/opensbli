  ...
  if ((end[0]-start[0])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      , [=](cl::sycl::nd_item<1> item
        ...
        ACC<double> wk0_B0(&wk0_B0_p[0] + base0 + n_x*1);
        ...
        ACC<double> wk5_B0(&wk5_B0_p[0] + base5 + n_x*1);
        ACC<double> wk6_B0(&wk6_B0_p[0] + base6 + n_x*1);
        ACC<double> wk7_B0(&wk7_B0_p[0] + base7 + n_x*1);
        //USER CODE
        if (n_x < end_0) {
