...
void ops_par_loop_opensbliblock00Kernel048_execute(ops_kernel_descriptor *desc) {
 ...
 arg5};
  ...
  double* yNO_B0_p = (double*)args[5].data_d;
  ...
  if ((end[0]-start[0])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      cgh.parallel_for<class opensbliblock00Kernel048_kernel>(cl::sycl::nd_range<1>(cl::sycl::range<1>(
      ...
      , [=](cl::sycl::nd_item<1> item
        ...
        ACC<double> yNO_B0(&yNO_B0_p[0] + base5 + n_x*1);
        //USER CODE
        if (n_x < end_0) {
