...
void ops_par_loop_opensbliblock00Kernel054_execute(ops_kernel_descriptor *desc) {
 ...
 arg5, arg6, arg7};
  ...
  double* tauO2_B0_p = (double*)args[7].data_d;
  ...
  if ((end[0]-start[0])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      cgh.parallel_for<class opensbliblock00Kernel054_kernel>(cl::sycl::nd_range<1>(cl::sycl::range<1>(
      ...
      , [=](cl::sycl::nd_item<1> item
        ...
        ACC<double> tauO2_B0(&tauO2_B0_p[0] + base7 + n_x*1);
        //USER CODE
        if (n_x < end_0) {
          
    tauO2_B0(0) = (invMN_sycl[0]*rhoN_B0(0) + invMO_sycl[0]*rhoO_B0(0) + invMN2_sycl[0]*rhoN2_B0(0) + invMNO_sycl[0]*rhoNO_B0(0) +
      invMO2_sycl[0]*rhoO2_B0(0))*(1.7158145830879e-15*invMNO_sycl[0]*p_B0(0)*rhoNO_B0(0)*cl::sycl::exp(136.0/cl::sycl::cbrt(T_B0(0))) +
      1.57253339053915e-15*invMO2_sycl[0]*p_B0(0)*rhoO2_B0(0)*cl::sycl::exp(138.0/cl::sycl::cbrt(T_B0(0))) +
      1.89588916228607e-15*invMN2_sycl[0]*p_B0(0)*rhoN2_B0(0)*cl::sycl::exp(134.0/cl::sycl::cbrt(T_B0(0))) +
      3.33376684850184e-14*invMN_sycl[0]*p_B0(0)*rhoN_B0(0)*cl::sycl::exp(72.4/cl::sycl::cbrt(T_B0(0))) +
      5.92030485539722e-15*invMO_sycl[0]*p_B0(0)*rhoO_B0(0)*cl::sycl::exp(47.7/cl::sycl::cbrt(T_B0(0))));
