 ...
 arg5, arg6, arg7};
  ...
  if ((end[0]-start[0])>0) {
   ...
   cNO = 0.00118857968659901;
    ...
    r = 1.0*invRhat_sycl[0]/(0.234274464914474*invMO_sycl[0] + 0.0660716949064288*invMN2_sycl[0] + 0.00118857968659901*invMNO_sycl[0] +
      2.66329755868373e-5*invMO2_sycl[0] + 0.698438627516912*invMN_sycl[0]);
