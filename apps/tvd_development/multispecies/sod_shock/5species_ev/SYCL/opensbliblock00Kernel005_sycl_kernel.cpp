...
void ops_par_loop_opensbliblock00Kernel005_execute(ops_kernel_descriptor *desc) {
 ...
 arg20, arg21};
  ...
  double* wdotN2_B0_p = (double*)args[0].data_d;

  int base1 = args[1].dat->base_offset/sizeof(double);
  double* wdotNO_B0_p = (double*)args[1].data_d;

  int base2 = args[2].dat->base_offset/sizeof(double);
  double* wdotN_B0_p = (double*)args[2].data_d;

  int base3 = args[3].dat->base_offset/sizeof(double);
  double* wdotO2_B0_p = (double*)args[3].data_d;

  int base4 = args[4].dat->base_offset/sizeof(double);
  double* wdotO_B0_p = (double*)args[4].data_d;
  ...
  double* rhoE_B0_p = (double*)args[13].data_d;

  int base14 = args[14].dat->base_offset/sizeof(double);
  double* rhoN2_B0_p = (double*)args[14].data_d;

  int base15 = args[15].dat->base_offset/sizeof(double);
  double* rhoNO_B0_p = (double*)args[15].data_d;

  int base16 = args[16].dat->base_offset/sizeof(double);
  double* rhoN_B0_p = (double*)args[16].data_d;

  int base17 = args[17].dat->base_offset/sizeof(double);
  double* rhoO2_B0_p = (double*)args[17].data_d;
  ...
  double* rhoev_B0_p = (double*)args[19].data_d;

  int base20 = args[20].dat->base_offset/sizeof(double);
  double* rhou0_B0_p = (double*)args[20].data_d;
  ...
  if ((end[0]-start[0])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      , [=](cl::sycl::nd_item<1> item
        ...
        const ACC<double> wdotN2_B0(&wdotN2_B0_p[0] + base0 + n_x*1);
        const ACC<double> wdotNO_B0(&wdotNO_B0_p[0] + base1 + n_x*1);
        const ACC<double> wdotN_B0(&wdotN_B0_p[0] + base2 + n_x*1);
        const ACC<double> wdotO2_B0(&wdotO2_B0_p[0] + base3 + n_x*1);
        const ACC<double> wdotO_B0(&wdotO_B0_p[0] + base4 + n_x*1);
        const ACC<double> wk0_B0(&wk0_B0_p[0] + base5 + n_x*1);
        const ACC<double> wk1_B0(&wk1_B0_p[0] + base6 + n_x*1);
        const ACC<double> wk2_B0(&wk2_B0_p[0] + base7 + n_x*1);
        const ACC<double> wk3_B0(&wk3_B0_p[0] + base8 + n_x*1);
        const ACC<double> wk4_B0(&wk4_B0_p[0] + base9 + n_x*1);
        const ACC<double> wk5_B0(&wk5_B0_p[0] + base10 + n_x*1);
        const ACC<double> wk6_B0(&wk6_B0_p[0] + base11 + n_x*1);
        const ACC<double> wk7_B0(&wk7_B0_p[0] + base12 + n_x*1);
        ACC<double> rhoE_B0(&rhoE_B0_p[0] + base13 + n_x*1);
        ACC<double> rhoN2_B0(&rhoN2_B0_p[0] + base14 + n_x*1);
        ACC<double> rhoNO_B0(&rhoNO_B0_p[0] + base15 + n_x*1);
        ACC<double> rhoN_B0(&rhoN_B0_p[0] + base16 + n_x*1);
        ACC<double> rhoO2_B0(&rhoO2_B0_p[0] + base17 + n_x*1);
        ACC<double> rhoO_B0(&rhoO_B0_p[0] + base18 + n_x*1);
        ACC<double> rhoev_B0(&rhoev_B0_p[0] + base19 + n_x*1);
        ACC<double> rhou0_B0(&rhou0_B0_p[0] + base20 + n_x*1);
        //USER CODE
        if (n_x < end_0) {
   ...
   rhoN2_B0(0) = (-(-wk0_B0(-1) + wk0_B0(0))*invDelta0block0_sycl[0] + wdotN2_B0(0))*dt_sycl[0] + rhoN2_B0(0);

   rhoO_B0(0) = (-(-wk1_B0(-1) + wk1_B0(0))*invDelta0block0_sycl[0] + wdotO_B0(0))*dt_sycl[0] + rhoO_B0(0);

   rhoO2_B0(0) = (-(-wk2_B0(-1) + wk2_B0(0))*invDelta0block0_sycl[0] + wdotO2_B0(0))*dt_sycl[0] + rhoO2_B0(0);

   rhoNO_B0(0) = (-(-wk3_B0(-1) + wk3_B0(0))*invDelta0block0_sycl[0] + wdotNO_B0(0))*dt_sycl[0] + rhoNO_B0(0);

   rhoN_B0(0) = (-(-wk4_B0(-1) + wk4_B0(0))*invDelta0block0_sycl[0] + wdotN_B0(0))*dt_sycl[0] + rhoN_B0(0);

   rhoev_B0(0) = -(-wk5_B0(-1) + wk5_B0(0))*dt_sycl[0]*invDelta0block0_sycl[0] + rhoev_B0(0);

   rhou0_B0(0) = -(-wk6_B0(-1) + wk6_B0(0))*dt_sycl[0]*invDelta0block0_sycl[0] + rhou0_B0(0);

   rhoE_B0(0) = -(-wk7_B0(-1) + wk7_B0(0))*dt_sycl[0]*invDelta0block0_sycl[0] + rhoE_B0(0);
