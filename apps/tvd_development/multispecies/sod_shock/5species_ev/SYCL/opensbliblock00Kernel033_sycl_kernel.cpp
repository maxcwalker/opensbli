 ...
 arg5, arg6};
  ...
  if ((end[0]-start[0])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      cgh.parallel_for<class opensbliblock00Kernel033_kernel>(cl::sycl::nd_range<1>(cl::sycl::range<1>(
      ...
      , [=](cl::sycl::nd_item<1> item
        ...
        const ACC<double> XN2_B0(&XN2_B0_p[0] + base1 + n_x*1);
        const ACC<double> XNO_B0(&XNO_B0_p[0] + base2 + n_x*1);
        const ACC<double> XN_B0(&XN_B0_p[0] + base3 + n_x*1);
        const ACC<double> XO2_B0(&XO2_B0_p[0] + base4 + n_x*1);
        const ACC<double> XO_B0(&XO_B0_p[0] + base5 + n_x*1);
        ACC<double> kappa_B0(&kappa_B0_p[0] + base6 + n_x*1);
        //USER CODE
        if (n_x < end_0) {
          
    kappa_B0(0) = (1.0 - cl::sycl::exp(-0.010568*T_B0(0)))*(0.00177095328464541*pow(T_B0(0), 0.42509 +
