...
void ops_par_loop_opensbliblock00Kernel031_execute(ops_kernel_descriptor *desc) {
 ...
 arg5};
  ...
  double* yN_B0_p = (double*)args[5].data_d;
  ...
  if ((end[0]-start[0])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      , [=](cl::sycl::nd_item<1> item
        ...
        ACC<double> yN_B0(&yN_B0_p[0] + base5 + n_x*1);
        //USER CODE
        if (n_x < end_0) {
          
    yN_B0(0) = invMN_sycl[0]*rhoN_B0(0)/(invMN_sycl[0]*rhoN_B0(0) + invMO_sycl[0]*rhoO_B0(0) + invMN2_sycl[0]*rhoN2_B0(0) + invMNO_sycl[0]*rhoNO_B0(0) +
