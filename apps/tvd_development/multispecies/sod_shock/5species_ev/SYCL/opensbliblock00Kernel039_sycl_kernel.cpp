...
void ops_par_loop_opensbliblock00Kernel039_execute(ops_kernel_descriptor *desc) {
 ...
 arg5, arg6, arg7};
  ...
  double* rhoNO_B0_p = (double*)args[3].data_d;
  ...
  double* rhoO2_B0_p = (double*)args[5].data_d;

  int base6 = args[6].dat->base_offset/sizeof(double);
  double* rhoO_B0_p = (double*)args[6].data_d;

  int base7 = args[7].dat->base_offset/sizeof(double);
  double* tauN2_B0_p = (double*)args[7].data_d;
  ...
  if ((end[0]-start[0])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      , [=](cl::sycl::nd_item<1> item
        ...
        const ACC<double> rhoNO_B0(&rhoNO_B0_p[0] + base3 + n_x*1);
        const ACC<double> rhoN_B0(&rhoN_B0_p[0] + base4 + n_x*1);
        const ACC<double> rhoO2_B0(&rhoO2_B0_p[0] + base5 + n_x*1);
        const ACC<double> rhoO_B0(&rhoO_B0_p[0] + base6 + n_x*1);
        ACC<double> tauN2_B0(&tauN2_B0_p[0] + base7 + n_x*1);
        //USER CODE
        if (n_x < end_0) {
          
    tauN2_B0(0) = (invMN_sycl[0]*rhoN_B0(0) + invMO_sycl[0]*rhoO_B0(0) + invMN2_sycl[0]*rhoN2_B0(0) + invMNO_sycl[0]*rhoNO_B0(0) +
      invMO2_sycl[0]*rhoO2_B0(0))*(1.45842652127424e-17*invMO2_sycl[0]*p_B0(0)*rhoO2_B0(0)*cl::sycl::exp(299.0/cl::sycl::cbrt(T_B0(0))) +
      1.35360721002158e-16*invMNO_sycl[0]*p_B0(0)*rhoNO_B0(0)*cl::sycl::exp(225.0/cl::sycl::cbrt(T_B0(0))) +
      1.62624395940909e-16*invMN2_sycl[0]*p_B0(0)*rhoN2_B0(0)*cl::sycl::exp(221.0/cl::sycl::cbrt(T_B0(0))) +
      3.33376684850184e-14*invMO_sycl[0]*p_B0(0)*rhoO_B0(0)*cl::sycl::exp(72.4/cl::sycl::cbrt(T_B0(0))) +
      8.83987765311328e-16*invMN_sycl[0]*p_B0(0)*rhoN_B0(0)*cl::sycl::exp(180.0/cl::sycl::cbrt(T_B0(0))));
