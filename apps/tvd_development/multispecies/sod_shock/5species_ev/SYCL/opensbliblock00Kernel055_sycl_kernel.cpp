...
void ops_par_loop_opensbliblock00Kernel055_execute(ops_kernel_descriptor *desc) {
 ...
 arg5, arg6};
  ...
  #ifdef OPS_DEBUG
  ops_register_args(block->instance, args, "opensbliblock00Kernel055");
  #endif
  ...
  double* yNO_B0_p = (double*)args[2].data_d;

  int base3 = args[3].dat->base_offset/sizeof(double);
  double* yN_B0_p = (double*)args[3].data_d;

  int base4 = args[4].dat->base_offset/sizeof(double);
  double* yO2_B0_p = (double*)args[4].data_d;
  ...
  double* cp_B0_p = (double*)args[6].data_d;
  ...
  if ((end[0]-start[0])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      cgh.parallel_for<class opensbliblock00Kernel055_kernel>(cl::sycl::nd_range<1>(cl::sycl::range<1>(
      ...
      , [=](cl::sycl::nd_item<1> item
        ...
        const ACC<double> yNO_B0(&yNO_B0_p[0] + base2 + n_x*1);
        const ACC<double> yN_B0(&yN_B0_p[0] + base3 + n_x*1);
        const ACC<double> yO2_B0(&yO2_B0_p[0] + base4 + n_x*1);
        const ACC<double> yO_B0(&yO_B0_p[0] + base5 + n_x*1);
        ACC<double> cp_B0(&cp_B0_p[0] + base6 + n_x*1);
        //USER CODE
        if (n_x < end_0) {
          
    cp_B0(0) = 2.5*Rhat_sycl[0]*invMN_sycl[0]*yN_B0(0) + 2.5*Rhat_sycl[0]*invMO_sycl[0]*yO_B0(0) + (3.5 +
      (thetavN2_sycl[0]*thetavN2_sycl[0])*cl::sycl::exp(thetavN2_sycl[0]/T_B0(0))/(((-1.0 + cl::sycl::exp(thetavN2_sycl[0]/T_B0(0)))*(-1.0 +
      cl::sycl::exp(thetavN2_sycl[0]/T_B0(0))))*(T_B0(0)*T_B0(0))))*Rhat_sycl[0]*invMN2_sycl[0]*yN2_B0(0) + (3.5 +
      (thetavNO_sycl[0]*thetavNO_sycl[0])*cl::sycl::exp(thetavNO_sycl[0]/T_B0(0))/(((-1.0 + cl::sycl::exp(thetavNO_sycl[0]/T_B0(0)))*(-1.0 +
      cl::sycl::exp(thetavNO_sycl[0]/T_B0(0))))*(T_B0(0)*T_B0(0))))*Rhat_sycl[0]*invMNO_sycl[0]*yNO_B0(0) + (3.5 +
      (thetavO2_sycl[0]*thetavO2_sycl[0])*cl::sycl::exp(thetavO2_sycl[0]/T_B0(0))/(((-1.0 + cl::sycl::exp(thetavO2_sycl[0]/T_B0(0)))*(-1.0 +
      cl::sycl::exp(thetavO2_sycl[0]/T_B0(0))))*(T_B0(0)*T_B0(0))))*Rhat_sycl[0]*invMO2_sycl[0]*yO2_B0(0);
