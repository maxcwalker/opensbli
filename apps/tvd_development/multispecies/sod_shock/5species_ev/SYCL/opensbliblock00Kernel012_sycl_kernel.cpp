...
void ops_par_loop_opensbliblock00Kernel012_execute(ops_kernel_descriptor *desc) {
 ...
 arg5, arg6};
  ...
  double* DN_B0_p = (double*)args[6].data_d;
  ...
  if ((end[0]-start[0])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      , [=](cl::sycl::nd_item<1> item
        ...
        ACC<double> DN_B0(&DN_B0_p[0] + base6 + n_x*1);
        //USER CODE
        if (n_x < end_0) {
          
   DN_B0(0) = invRe_sycl[0]*invSc_sycl[0]*mu_B0(0)/(rhoN_B0(0) + rhoO_B0(0) + rhoN2_B0(0) + rhoNO_B0(0) + rhoO2_B0(0));
