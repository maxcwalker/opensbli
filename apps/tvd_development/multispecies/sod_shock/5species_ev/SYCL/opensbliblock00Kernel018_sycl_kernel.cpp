...
void ops_par_loop_opensbliblock00Kernel018_execute(ops_kernel_descriptor *desc) {
  ...
  double* rhoO2_B0_p = (double*)args[2].data_d;
  ...
  double* Tv_B0_p = (double*)args[4].data_d;
  ...
  if ((end[0]-start[0])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      , [=](cl::sycl::nd_item<1> item
        ...
        const ACC<double> rhoO2_B0(&rhoO2_B0_p[0] + base2 + n_x*1);
        const ACC<double> rhoev_B0(&rhoev_B0_p[0] + base3 + n_x*1);
        ACC<double> Tv_B0(&Tv_B0_p[0] + base4 + n_x*1);
        //USER CODE
        if (n_x < end_0) {
          
    Tv_B0(0) = (invMN2_sycl[0]*thetavN2_sycl[0]*rhoN2_B0(0) + invMNO_sycl[0]*thetavNO_sycl[0]*rhoNO_B0(0) +
      invMO2_sycl[0]*thetavO2_sycl[0]*rhoO2_B0(0))/((invMN2_sycl[0]*rhoN2_B0(0) + invMNO_sycl[0]*rhoNO_B0(0) + invMO2_sycl[0]*rhoO2_B0(0))*log(1.0 +
      (invMN2_sycl[0]*thetavN2_sycl[0]*rhoN2_B0(0) + invMNO_sycl[0]*thetavNO_sycl[0]*rhoNO_B0(0) + invMO2_sycl[0]*thetavO2_sycl[0]*rhoO2_B0(0))*Rhat_sycl[0]/rhoev_B0(0)));
