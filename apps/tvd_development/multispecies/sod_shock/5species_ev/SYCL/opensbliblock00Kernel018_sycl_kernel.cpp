  ...
  if ((end[0]-start[0])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      , [=](cl::sycl::nd_item<1> item
        ...
        ACC<double> XO2_B0(&XO2_B0_p[0] + base5 + n_x*1);
        //USER CODE
        if (n_x < end_0) {
          
    XO2_B0(0) = invMO2_sycl[0]*rhoO2_B0(0)/(invMN_sycl[0]*rhoN_B0(0) + invMO_sycl[0]*rhoO_B0(0) + invMN2_sycl[0]*rhoN2_B0(0) + invMNO_sycl[0]*rhoNO_B0(0) +
