...
void ops_par_loop_opensbliblock00Kernel034_execute(ops_kernel_descriptor *desc) {
 ...
 arg5, arg6};
  ...
  double* kappav_B0_p = (double*)args[6].data_d;
  ...
  if ((end[0]-start[0])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      , [=](cl::sycl::nd_item<1> item
        ...
        ACC<double> kappav_B0(&kappav_B0_p[0] + base6 + n_x*1);
        //USER CODE
        if (n_x < end_0) {
          
    kappav_B0(0) = (1.0 - cl::sycl::exp(-0.010568*T_B0(0)))*(0.000384199457327525*pow(T_B0(0), 0.34567 +
