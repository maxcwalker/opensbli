...
void ops_par_loop_opensbliblock00Kernel004_execute(ops_kernel_descriptor *desc) {
  ...
  ops_arg args[19] = { arg0, arg1, arg2, arg3, arg4,
 ...
 arg15, arg16, arg17, arg18};
  ...
  if (!ops_checkpointing_before(args,19,range,17)) return;
  #endif

  if (block->instance->OPS_diags > 1) {
    ops_timing_realloc(block->instance,17,"opensbliblock00Kernel004");
  ...
  double* rhoNO_B0_p = (double*)args[4].data_d;
  ...
  double* rhoO2_B0_p = (double*)args[6].data_d;

  int base7 = args[7].dat->base_offset/sizeof(double);
  double* rhoO_B0_p = (double*)args[7].data_d;
  ...
  double* wk5_B0_p = (double*)args[16].data_d;

  int base17 = args[17].dat->base_offset/sizeof(double);
  double* wk6_B0_p = (double*)args[17].data_d;

  int base18 = args[18].dat->base_offset/sizeof(double);
  double* wk7_B0_p = (double*)args[18].data_d;
  ...
  if ((end[0]-start[0])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      , [=](cl::sycl::nd_item<1> item
        ...
        const ACC<double> rhoNO_B0(&rhoNO_B0_p[0] + base4 + n_x*1);
        const ACC<double> rhoN_B0(&rhoN_B0_p[0] + base5 + n_x*1);
        const ACC<double> rhoO2_B0(&rhoO2_B0_p[0] + base6 + n_x*1);
        const ACC<double> rhoO_B0(&rhoO_B0_p[0] + base7 + n_x*1);
        const ACC<double> rhoev_B0(&rhoev_B0_p[0] + base8 + n_x*1);
        const ACC<double> rhou0_B0(&rhou0_B0_p[0] + base9 + n_x*1);
        const ACC<double> u0_B0(&u0_B0_p[0] + base10 + n_x*1);
        ACC<double> wk0_B0(&wk0_B0_p[0] + base11 + n_x*1);
        ACC<double> wk1_B0(&wk1_B0_p[0] + base12 + n_x*1);
        ACC<double> wk2_B0(&wk2_B0_p[0] + base13 + n_x*1);
        ACC<double> wk3_B0(&wk3_B0_p[0] + base14 + n_x*1);
        ACC<double> wk4_B0(&wk4_B0_p[0] + base15 + n_x*1);
        ACC<double> wk5_B0(&wk5_B0_p[0] + base16 + n_x*1);
        ACC<double> wk6_B0(&wk6_B0_p[0] + base17 + n_x*1);
        ACC<double> wk7_B0(&wk7_B0_p[0] + base18 + n_x*1);
        //USER CODE
        if (n_x < end_0) {
   ...
   inv_AVG_rho = 1.0/(AVG_0_rho);
    ...
    AVG_0_0_LEV_00 = ((1.0/2.0))*(AVG_0_u0*AVG_0_u0)*(inv_AVG_a*inv_AVG_a)*gamma_m1_sycl[0]*AVG_0_rhoO/(AVG_0_rhoN + AVG_0_rhoN2
    ...
    AVG_0_0_LEV_01 = -(1.0/2.0)*(2*AVG_0_rhoN + 2*AVG_0_rhoN2 + 2*AVG_0_rhoNO + 2*AVG_0_rhoO + 2*AVG_0_rhoO2 +
      ...
      (AVG_0_u0*AVG_0_u0)*(inv_AVG_a*inv_AVG_a)*gama_sycl[0]*AVG_0_rhoO)/(AVG_0_rhoN + AVG_0_rhoN2 + AVG_0_rhoNO + AVG_0_rhoO +
      AVG_0_rhoO2);

    AVG_0_0_LEV_02 = ((1.0/2.0))*(AVG_0_u0*AVG_0_u0)*(inv_AVG_a*inv_AVG_a)*gamma_m1_sycl[0]*AVG_0_rhoO/(AVG_0_rhoN + AVG_0_rhoN2
      + AVG_0_rhoNO + AVG_0_rhoO + AVG_0_rhoO2);

    AVG_0_0_LEV_03 = ((1.0/2.0))*(AVG_0_u0*AVG_0_u0)*(inv_AVG_a*inv_AVG_a)*gamma_m1_sycl[0]*AVG_0_rhoO/(AVG_0_rhoN + AVG_0_rhoN2
      + AVG_0_rhoNO + AVG_0_rhoO + AVG_0_rhoO2);

    AVG_0_0_LEV_04 = ((1.0/2.0))*(AVG_0_u0*AVG_0_u0)*(inv_AVG_a*inv_AVG_a)*gamma_m1_sycl[0]*AVG_0_rhoO/(AVG_0_rhoN + AVG_0_rhoN2
      + AVG_0_rhoNO + AVG_0_rhoO + AVG_0_rhoO2);

    AVG_0_0_LEV_05 = -(inv_AVG_a*inv_AVG_a)*gamma_m1_sycl[0]*AVG_0_rhoO/(AVG_0_rhoN + AVG_0_rhoN2 + AVG_0_rhoNO + AVG_0_rhoO +
      AVG_0_rhoO2);

    AVG_0_0_LEV_06 = -(inv_AVG_a*inv_AVG_a)*gamma_m1_sycl[0]*AVG_0_rhoO*AVG_0_u0/(AVG_0_rhoN + AVG_0_rhoN2 + AVG_0_rhoNO +
      AVG_0_rhoO + AVG_0_rhoO2);

    AVG_0_0_LEV_07 = (inv_AVG_a*inv_AVG_a)*gamma_m1_sycl[0]*AVG_0_rhoO/(AVG_0_rhoN + AVG_0_rhoN2 + AVG_0_rhoNO + AVG_0_rhoO +
      AVG_0_rhoO2);

    AVG_0_0_LEV_10 = ((1.0/2.0))*(AVG_0_u0*AVG_0_u0)*(inv_AVG_a*inv_AVG_a)*gamma_m1_sycl[0]*AVG_0_rhoO2/(AVG_0_rhoN +
      AVG_0_rhoN2 + AVG_0_rhoNO + AVG_0_rhoO + AVG_0_rhoO2);

    AVG_0_0_LEV_11 = ((1.0/2.0))*(AVG_0_u0*AVG_0_u0)*(inv_AVG_a*inv_AVG_a)*gamma_m1_sycl[0]*AVG_0_rhoO2/(AVG_0_rhoN +
      AVG_0_rhoN2 + AVG_0_rhoNO + AVG_0_rhoO + AVG_0_rhoO2);
    ...
    AVG_0_0_LEV_12 = -(1.0/2.0)*(2*AVG_0_rhoN + 2*AVG_0_rhoN2 + 2*AVG_0_rhoNO + 2*AVG_0_rhoO + 2*AVG_0_rhoO2 +
      ...
      (AVG_0_u0*AVG_0_u0)*(inv_AVG_a*inv_AVG_a)*gama_sycl[0]*AVG_0_rhoO2)/(AVG_0_rhoN + AVG_0_rhoN2 + AVG_0_rhoNO + AVG_0_rhoO +
      AVG_0_rhoO2);

    AVG_0_0_LEV_13 = ((1.0/2.0))*(AVG_0_u0*AVG_0_u0)*(inv_AVG_a*inv_AVG_a)*gamma_m1_sycl[0]*AVG_0_rhoO2/(AVG_0_rhoN +
      AVG_0_rhoN2 + AVG_0_rhoNO + AVG_0_rhoO + AVG_0_rhoO2);

    AVG_0_0_LEV_14 = ((1.0/2.0))*(AVG_0_u0*AVG_0_u0)*(inv_AVG_a*inv_AVG_a)*gamma_m1_sycl[0]*AVG_0_rhoO2/(AVG_0_rhoN +
      AVG_0_rhoN2 + AVG_0_rhoNO + AVG_0_rhoO + AVG_0_rhoO2);

    AVG_0_0_LEV_15 = -(inv_AVG_a*inv_AVG_a)*gamma_m1_sycl[0]*AVG_0_rhoO2/(AVG_0_rhoN + AVG_0_rhoN2 + AVG_0_rhoNO + AVG_0_rhoO +
      AVG_0_rhoO2);

    AVG_0_0_LEV_16 = -(inv_AVG_a*inv_AVG_a)*gamma_m1_sycl[0]*AVG_0_rhoO2*AVG_0_u0/(AVG_0_rhoN + AVG_0_rhoN2 + AVG_0_rhoNO +
      AVG_0_rhoO + AVG_0_rhoO2);

    AVG_0_0_LEV_17 = (inv_AVG_a*inv_AVG_a)*gamma_m1_sycl[0]*AVG_0_rhoO2/(AVG_0_rhoN + AVG_0_rhoN2 + AVG_0_rhoNO + AVG_0_rhoO +
      AVG_0_rhoO2);

    AVG_0_0_LEV_20 = ((1.0/2.0))*(AVG_0_u0*AVG_0_u0)*(inv_AVG_a*inv_AVG_a)*gamma_m1_sycl[0]*AVG_0_rhoNO/(AVG_0_rhoN +
      AVG_0_rhoN2 + AVG_0_rhoNO + AVG_0_rhoO + AVG_0_rhoO2);

    AVG_0_0_LEV_21 = ((1.0/2.0))*(AVG_0_u0*AVG_0_u0)*(inv_AVG_a*inv_AVG_a)*gamma_m1_sycl[0]*AVG_0_rhoNO/(AVG_0_rhoN +
      AVG_0_rhoN2 + AVG_0_rhoNO + AVG_0_rhoO + AVG_0_rhoO2);

    AVG_0_0_LEV_22 = ((1.0/2.0))*(AVG_0_u0*AVG_0_u0)*(inv_AVG_a*inv_AVG_a)*gamma_m1_sycl[0]*AVG_0_rhoNO/(AVG_0_rhoN +
      AVG_0_rhoN2 + AVG_0_rhoNO + AVG_0_rhoO + AVG_0_rhoO2);
    ...
    AVG_0_0_LEV_23 = -(1.0/2.0)*(2*AVG_0_rhoN + 2*AVG_0_rhoN2 + 2*AVG_0_rhoNO + 2*AVG_0_rhoO + 2*AVG_0_rhoO2 +
      ...
      (AVG_0_u0*AVG_0_u0)*(inv_AVG_a*inv_AVG_a)*gama_sycl[0]*AVG_0_rhoNO)/(AVG_0_rhoN + AVG_0_rhoN2 + AVG_0_rhoNO + AVG_0_rhoO +
      AVG_0_rhoO2);

    AVG_0_0_LEV_24 = ((1.0/2.0))*(AVG_0_u0*AVG_0_u0)*(inv_AVG_a*inv_AVG_a)*gamma_m1_sycl[0]*AVG_0_rhoNO/(AVG_0_rhoN +
      AVG_0_rhoN2 + AVG_0_rhoNO + AVG_0_rhoO + AVG_0_rhoO2);

    AVG_0_0_LEV_25 = -(inv_AVG_a*inv_AVG_a)*gamma_m1_sycl[0]*AVG_0_rhoNO/(AVG_0_rhoN + AVG_0_rhoN2 + AVG_0_rhoNO + AVG_0_rhoO +
      AVG_0_rhoO2);

    AVG_0_0_LEV_26 = -(inv_AVG_a*inv_AVG_a)*gamma_m1_sycl[0]*AVG_0_rhoNO*AVG_0_u0/(AVG_0_rhoN + AVG_0_rhoN2 + AVG_0_rhoNO +
      AVG_0_rhoO + AVG_0_rhoO2);

    AVG_0_0_LEV_27 = (inv_AVG_a*inv_AVG_a)*gamma_m1_sycl[0]*AVG_0_rhoNO/(AVG_0_rhoN + AVG_0_rhoN2 + AVG_0_rhoNO + AVG_0_rhoO +
      AVG_0_rhoO2);

    AVG_0_0_LEV_30 = ((1.0/2.0))*(AVG_0_u0*AVG_0_u0)*(inv_AVG_a*inv_AVG_a)*gamma_m1_sycl[0]*AVG_0_rhoN/(AVG_0_rhoN + AVG_0_rhoN2
      + AVG_0_rhoNO + AVG_0_rhoO + AVG_0_rhoO2);

    AVG_0_0_LEV_31 = ((1.0/2.0))*(AVG_0_u0*AVG_0_u0)*(inv_AVG_a*inv_AVG_a)*gamma_m1_sycl[0]*AVG_0_rhoN/(AVG_0_rhoN + AVG_0_rhoN2
      + AVG_0_rhoNO + AVG_0_rhoO + AVG_0_rhoO2);

    AVG_0_0_LEV_32 = ((1.0/2.0))*(AVG_0_u0*AVG_0_u0)*(inv_AVG_a*inv_AVG_a)*gamma_m1_sycl[0]*AVG_0_rhoN/(AVG_0_rhoN + AVG_0_rhoN2
      + AVG_0_rhoNO + AVG_0_rhoO + AVG_0_rhoO2);

    AVG_0_0_LEV_33 = ((1.0/2.0))*(AVG_0_u0*AVG_0_u0)*(inv_AVG_a*inv_AVG_a)*gamma_m1_sycl[0]*AVG_0_rhoN/(AVG_0_rhoN + AVG_0_rhoN2
      + AVG_0_rhoNO + AVG_0_rhoO + AVG_0_rhoO2);
    ...
    AVG_0_0_LEV_34 = ((1.0/2.0))*(-2*AVG_0_rhoN - 2*AVG_0_rhoN2 - 2*AVG_0_rhoNO - 2*AVG_0_rhoO - 2*AVG_0_rhoO2 -
      ...
      (AVG_0_u0*AVG_0_u0)*(inv_AVG_a*inv_AVG_a)*gama_sycl[0]*AVG_0_rhoN)/(AVG_0_rhoN + AVG_0_rhoN2 + AVG_0_rhoNO + AVG_0_rhoO +
      AVG_0_rhoO2);

    AVG_0_0_LEV_35 = -(inv_AVG_a*inv_AVG_a)*gamma_m1_sycl[0]*AVG_0_rhoN/(AVG_0_rhoN + AVG_0_rhoN2 + AVG_0_rhoNO + AVG_0_rhoO +
      AVG_0_rhoO2);

    AVG_0_0_LEV_36 = -(inv_AVG_a*inv_AVG_a)*gamma_m1_sycl[0]*AVG_0_rhoN*AVG_0_u0/(AVG_0_rhoN + AVG_0_rhoN2 + AVG_0_rhoNO +
      AVG_0_rhoO + AVG_0_rhoO2);

    AVG_0_0_LEV_37 = (inv_AVG_a*inv_AVG_a)*gamma_m1_sycl[0]*AVG_0_rhoN/(AVG_0_rhoN + AVG_0_rhoN2 + AVG_0_rhoNO + AVG_0_rhoO +
      AVG_0_rhoO2);
   ...
   AVG_0_0_LEV_45 = (inv_AVG_a*inv_AVG_a)*gamma_m1_sycl[0];

   AVG_0_0_LEV_46 = (inv_AVG_a*inv_AVG_a)*gamma_m1_sycl[0]*AVG_0_u0;

   AVG_0_0_LEV_47 = -(inv_AVG_a*inv_AVG_a)*gamma_m1_sycl[0];

    AVG_0_0_LEV_50 = -(1.0/4.0)*pow(2, 1.0/(2))*(AVG_0_u0*AVG_0_u0)*(-2 - (AVG_0_u0*AVG_0_u0)*(inv_AVG_a*inv_AVG_a) -
      2*(inv_AVG_a*inv_AVG_a)*AVG_0_ev + (AVG_0_u0*AVG_0_u0)*(inv_AVG_a*inv_AVG_a)*gama_sycl[0] +
      2*(inv_AVG_a*inv_AVG_a)*gama_sycl[0]*AVG_0_ev);
    ...
    AVG_0_0_LEV_56 = ((1.0/2.0))*pow(2, 1.0/(2))*(inv_AVG_a*inv_AVG_a)*((AVG_0_u0*AVG_0_u0) +
      2*AVG_0_ev)*gamma_m1_sycl[0]*AVG_0_u0;

   AVG_0_0_LEV_57 = -(1.0/2.0)*pow(2, 1.0/(2))*(inv_AVG_a*inv_AVG_a)*((AVG_0_u0*AVG_0_u0) + 2*AVG_0_ev)*gamma_m1_sycl[0];

    AVG_0_0_LEV_60 = -(1.0/4.0)*(inv_AVG_a*inv_AVG_a)*(2*AVG_0_a - gama_sycl[0]*AVG_0_u0 +
      AVG_0_u0)*AVG_0_rhoN2*AVG_0_u0/(AVG_0_rhoN + AVG_0_rhoN2 + AVG_0_rhoNO + AVG_0_rhoO + AVG_0_rhoO2);

    AVG_0_0_LEV_61 = -(1.0/4.0)*(inv_AVG_a*inv_AVG_a)*(2*AVG_0_a - gama_sycl[0]*AVG_0_u0 +
      AVG_0_u0)*AVG_0_rhoN2*AVG_0_u0/(AVG_0_rhoN + AVG_0_rhoN2 + AVG_0_rhoNO + AVG_0_rhoO + AVG_0_rhoO2);

    AVG_0_0_LEV_62 = -(1.0/4.0)*(inv_AVG_a*inv_AVG_a)*(2*AVG_0_a - gama_sycl[0]*AVG_0_u0 +
      AVG_0_u0)*AVG_0_rhoN2*AVG_0_u0/(AVG_0_rhoN + AVG_0_rhoN2 + AVG_0_rhoNO + AVG_0_rhoO + AVG_0_rhoO2);

    AVG_0_0_LEV_63 = -(1.0/4.0)*(inv_AVG_a*inv_AVG_a)*(2*AVG_0_a - gama_sycl[0]*AVG_0_u0 +
      AVG_0_u0)*AVG_0_rhoN2*AVG_0_u0/(AVG_0_rhoN + AVG_0_rhoN2 + AVG_0_rhoNO + AVG_0_rhoO + AVG_0_rhoO2);

    AVG_0_0_LEV_64 = -(1.0/4.0)*(inv_AVG_a*inv_AVG_a)*(2*AVG_0_a - gama_sycl[0]*AVG_0_u0 +
      AVG_0_u0)*AVG_0_rhoN2*AVG_0_u0/(AVG_0_rhoN + AVG_0_rhoN2 + AVG_0_rhoNO + AVG_0_rhoO + AVG_0_rhoO2);

    AVG_0_0_LEV_65 = -(1.0/2.0)*(inv_AVG_a*inv_AVG_a)*gamma_m1_sycl[0]*AVG_0_rhoN2/(AVG_0_rhoN + AVG_0_rhoN2 + AVG_0_rhoNO +
      AVG_0_rhoO + AVG_0_rhoO2);

    AVG_0_0_LEV_66 = ((1.0/2.0))*(inv_AVG_a*inv_AVG_a)*(-gama_sycl[0]*AVG_0_u0 + AVG_0_a + AVG_0_u0)*AVG_0_rhoN2/(AVG_0_rhoN +
      AVG_0_rhoN2 + AVG_0_rhoNO + AVG_0_rhoO + AVG_0_rhoO2);

    AVG_0_0_LEV_67 = ((1.0/2.0))*(inv_AVG_a*inv_AVG_a)*gamma_m1_sycl[0]*AVG_0_rhoN2/(AVG_0_rhoN + AVG_0_rhoN2 + AVG_0_rhoNO +
      AVG_0_rhoO + AVG_0_rhoO2);

    AVG_0_0_LEV_70 = ((1.0/4.0))*(inv_AVG_a*inv_AVG_a)*(-AVG_0_u0 + 2*AVG_0_a +
      gama_sycl[0]*AVG_0_u0)*AVG_0_rhoN2*AVG_0_u0/(AVG_0_rhoN + AVG_0_rhoN2 + AVG_0_rhoNO + AVG_0_rhoO + AVG_0_rhoO2);
    ...
    AVG_0_0_LEV_75 = -(1.0/2.0)*(inv_AVG_a*inv_AVG_a)*gamma_m1_sycl[0]*AVG_0_rhoN2/(AVG_0_rhoN + AVG_0_rhoN2 + AVG_0_rhoNO +
      AVG_0_rhoO + AVG_0_rhoO2);

    AVG_0_0_LEV_76 = -(1.0/2.0)*(inv_AVG_a*inv_AVG_a)*(-AVG_0_u0 + gama_sycl[0]*AVG_0_u0 + AVG_0_a)*AVG_0_rhoN2/(AVG_0_rhoN +
      AVG_0_rhoN2 + AVG_0_rhoNO + AVG_0_rhoO + AVG_0_rhoO2);

    AVG_0_0_LEV_77 = ((1.0/2.0))*(inv_AVG_a*inv_AVG_a)*gamma_m1_sycl[0]*AVG_0_rhoN2/(AVG_0_rhoN + AVG_0_rhoN2 + AVG_0_rhoNO +
      AVG_0_rhoO + AVG_0_rhoO2);
   ...
   AVG_0_REV_75 = pow(2, 1.0/(2))/2;
    ...
    AVG_0_REV_76 = ((1.0/2.0))*(AVG_0_rhoN + AVG_0_rhoN2 + AVG_0_rhoNO + AVG_0_rhoO + AVG_0_rhoO2)*(-(AVG_0_u0*AVG_0_u0)
      - 2*AVG_0_ev + 2*(AVG_0_a*AVG_0_a) + (AVG_0_u0*AVG_0_u0)*gama_sycl[0] - 2*AVG_0_a*AVG_0_u0 + 2*gama_sycl[0]*AVG_0_ev +
      2*gama_sycl[0]*AVG_0_a*AVG_0_u0)*invgamma_m1_sycl[0]/AVG_0_rhoN2;

    AVG_0_REV_77 = ((1.0/2.0))*(AVG_0_rhoN + AVG_0_rhoN2 + AVG_0_rhoNO + AVG_0_rhoO + AVG_0_rhoO2)*(-(AVG_0_u0*AVG_0_u0)
      - 2*AVG_0_ev + 2*(AVG_0_a*AVG_0_a) + (AVG_0_u0*AVG_0_u0)*gama_sycl[0] + 2*gama_sycl[0]*AVG_0_ev + 2*AVG_0_a*AVG_0_u0 -
      2*gama_sycl[0]*AVG_0_a*AVG_0_u0)*invgamma_m1_sycl[0]/AVG_0_rhoN2;
...
: (
    ...
    sigma_0_5 = ((cl::sycl::fabs(ws_lambda_55) >= delta_TVD_sycl[0]) ? (
   cl::sycl::fabs(ws_lambda_55)
)
: (

      ((1.0/2.0))*(1.0/(invdelta_TVD_sycl[0]*invdelta_TVD_sycl[0]) + (ws_lambda_55*ws_lambda_55))*invdelta_TVD_sycl[0]
));

    sigma_0_6 = ((cl::sycl::fabs(ws_lambda_66) >= delta_TVD_sycl[0]) ? (
   cl::sycl::fabs(ws_lambda_66)
)
: (

      ((1.0/2.0))*(1.0/(invdelta_TVD_sycl[0]*invdelta_TVD_sycl[0]) + (ws_lambda_66*ws_lambda_66))*invdelta_TVD_sycl[0]
));

    sigma_0_7 = ((cl::sycl::fabs(ws_lambda_77) >= delta_TVD_sycl[0]) ? (
   cl::sycl::fabs(ws_lambda_77)
)
: (

      ((1.0/2.0))*(1.0/(invdelta_TVD_sycl[0]*invdelta_TVD_sycl[0]) + (ws_lambda_77*ws_lambda_77))*invdelta_TVD_sycl[0]
));
   ...
   t1 = cl::sycl::fmax(0.0, cl::sycl::fmin(S*alpha_50, 2*cl::sycl::fabs(alpha_51)));

   t2 = cl::sycl::fmin(cl::sycl::fabs(alpha_51), 2*S*alpha_50);

   g_50 = S*cl::sycl::fmax(t1, t2);

   S = (alpha_61 > 0) ? 1 : ((alpha_61 < 0) ? -1 : 0);

   t1 = cl::sycl::fmax(0.0, cl::sycl::fmin(S*alpha_60, 2*cl::sycl::fabs(alpha_61)));

   t2 = cl::sycl::fmin(cl::sycl::fabs(alpha_61), 2*S*alpha_60);

   g_60 = S*cl::sycl::fmax(t1, t2);

   S = (alpha_71 > 0) ? 1 : ((alpha_71 < 0) ? -1 : 0);

   t1 = cl::sycl::fmax(0.0, cl::sycl::fmin(S*alpha_70, 2*cl::sycl::fabs(alpha_71)));

   t2 = cl::sycl::fmin(cl::sycl::fabs(alpha_71), 2*S*alpha_70);

   g_70 = S*cl::sycl::fmax(t1, t2);
   ...
   t1 = cl::sycl::fmax(0.0, cl::sycl::fmin(S*alpha_51, 2*cl::sycl::fabs(alpha_52)));

   t2 = cl::sycl::fmin(cl::sycl::fabs(alpha_52), 2*S*alpha_51);

   g_51 = S*cl::sycl::fmax(t1, t2);

   S = (alpha_62 > 0) ? 1 : ((alpha_62 < 0) ? -1 : 0);

   t1 = cl::sycl::fmax(0.0, cl::sycl::fmin(S*alpha_61, 2*cl::sycl::fabs(alpha_62)));

   t2 = cl::sycl::fmin(cl::sycl::fabs(alpha_62), 2*S*alpha_61);

   g_61 = S*cl::sycl::fmax(t1, t2);

   S = (alpha_72 > 0) ? 1 : ((alpha_72 < 0) ? -1 : 0);

   t1 = cl::sycl::fmax(0.0, cl::sycl::fmin(S*alpha_71, 2*cl::sycl::fabs(alpha_72)));

   t2 = cl::sycl::fmin(cl::sycl::fabs(alpha_72), 2*S*alpha_71);

   g_71 = S*cl::sycl::fmax(t1, t2);
...
: (
   (-g_50 + g_51)*alpha_51*sigma_0_5/((alpha_51*alpha_51) + eps_TVD_sycl[0])
));
...
: (
   (-g_60 + g_61)*alpha_61*sigma_0_6/((alpha_61*alpha_61) + eps_TVD_sycl[0])
));
...
: (
   (-g_70 + g_71)*alpha_71*sigma_0_7/((alpha_71*alpha_71) + eps_TVD_sycl[0])
));
...
: (
   ((1.0/2.0))*(1.0/(invdelta_TVD_sycl[0]*invdelta_TVD_sycl[0])
    ...
    sigma_1_5 = ((cl::sycl::fabs(gamma_5) >= delta_TVD_sycl[0]) ? (
   cl::sycl::fabs(gamma_5)
)
: (
   ((1.0/2.0))*(1.0/(invdelta_TVD_sycl[0]*invdelta_TVD_sycl[0])
      + (gamma_5*gamma_5))*invdelta_TVD_sycl[0]
));

    sigma_1_6 = ((cl::sycl::fabs(gamma_6) >= delta_TVD_sycl[0]) ? (
   cl::sycl::fabs(gamma_6)
)
: (
   ((1.0/2.0))*(1.0/(invdelta_TVD_sycl[0]*invdelta_TVD_sycl[0])
      + (gamma_6*gamma_6))*invdelta_TVD_sycl[0]
));

    sigma_1_7 = ((cl::sycl::fabs(gamma_7) >= delta_TVD_sycl[0]) ? (
   cl::sycl::fabs(gamma_7)
)
: (
   ((1.0/2.0))*(1.0/(invdelta_TVD_sycl[0]*invdelta_TVD_sycl[0])
      + (gamma_7*gamma_7))*invdelta_TVD_sycl[0]
));
   ...
   phi_5 = -cl::sycl::fabs(sigma_0_5 + sigma_1_5)*alpha_51 + 0.5*(g_50 + g_51)*sigma_0_5;

   phi_6 = -cl::sycl::fabs(sigma_0_6 + sigma_1_6)*alpha_61 + 0.5*(g_60 + g_61)*sigma_0_6;

   phi_7 = -cl::sycl::fabs(sigma_0_7 + sigma_1_7)*alpha_71 + 0.5*(g_70 + g_71)*sigma_0_7;
   ...
   t1 = -cl::sycl::fabs(alpha_50) + cl::sycl::fabs(alpha_51);

   t2 = cl::sycl::fabs(alpha_50) + cl::sycl::fabs(alpha_51) + eps_TVD_sycl[0];

   theta_hat_50 = (cl::sycl::fabs(t1/t2)*cl::sycl::fabs(t1/t2));

   t1 = -cl::sycl::fabs(alpha_60) + cl::sycl::fabs(alpha_61);

   t2 = cl::sycl::fabs(alpha_60) + cl::sycl::fabs(alpha_61) + eps_TVD_sycl[0];

   theta_hat_60 = (cl::sycl::fabs(t1/t2)*cl::sycl::fabs(t1/t2));

   t1 = -cl::sycl::fabs(alpha_70) + cl::sycl::fabs(alpha_71);

   t2 = cl::sycl::fabs(alpha_70) + cl::sycl::fabs(alpha_71) + eps_TVD_sycl[0];

   theta_hat_70 = (cl::sycl::fabs(t1/t2)*cl::sycl::fabs(t1/t2));
   ...
   t1 = -cl::sycl::fabs(alpha_51) + cl::sycl::fabs(alpha_52);

   t2 = cl::sycl::fabs(alpha_51) + cl::sycl::fabs(alpha_52) + eps_TVD_sycl[0];

   theta_hat_51 = (cl::sycl::fabs(t1/t2)*cl::sycl::fabs(t1/t2));

   t1 = -cl::sycl::fabs(alpha_61) + cl::sycl::fabs(alpha_62);

   t2 = cl::sycl::fabs(alpha_61) + cl::sycl::fabs(alpha_62) + eps_TVD_sycl[0];

   theta_hat_61 = (cl::sycl::fabs(t1/t2)*cl::sycl::fabs(t1/t2));

   t1 = -cl::sycl::fabs(alpha_71) + cl::sycl::fabs(alpha_72);

   t2 = cl::sycl::fabs(alpha_71) + cl::sycl::fabs(alpha_72) + eps_TVD_sycl[0];

   theta_hat_71 = (cl::sycl::fabs(t1/t2)*cl::sycl::fabs(t1/t2));
   ...
   theta_5 = cl::sycl::fmax(theta_hat_50, theta_hat_51);

   theta_6 = cl::sycl::fmax(theta_hat_60, theta_hat_61);

   theta_7 = cl::sycl::fmax(theta_hat_70, theta_hat_71);
   ...
   phi_star_5 = kappa_TVD_sycl[0]*phi_5*theta_5;

   phi_star_6 = kappa_TVD_sycl[0]*phi_6*theta_6;

   phi_star_7 = kappa_TVD_sycl[0]*phi_7*theta_7;
  ...
  if (block->instance->OPS_diags > 1) {
    ...
    block->instance->OPS_kernels[17].transfer += ops_compute_transfer(dim, start, end, &arg12);
    block->instance->OPS_kernels[17].transfer += ops_compute_transfer(dim, start, end, &arg13);
    block->instance->OPS_kernels[17].transfer += ops_compute_transfer(dim, start, end, &arg14);
    block->instance->OPS_kernels[17].transfer += ops_compute_transfer(dim, start, end, &arg15);
    block->instance->OPS_kernels[17].transfer += ops_compute_transfer(dim, start, end, &arg16);
    block->instance->OPS_kernels[17].transfer += ops_compute_transfer(dim, start, end, &arg17);
    block->instance->OPS_kernels[17].transfer += ops_compute_transfer(dim, start, end, &arg18);
  }
}
