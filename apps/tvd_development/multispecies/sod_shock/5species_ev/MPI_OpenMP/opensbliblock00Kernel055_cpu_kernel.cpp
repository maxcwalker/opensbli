...
void ops_par_loop_opensbliblock00Kernel055_execute(ops_kernel_descriptor *desc) {
  ...
  double * __restrict__ yNO_B0_p = (double *)(args[2].data + base2);

  int base3 = args[3].dat->base_offset;
  double * __restrict__ yN_B0_p = (double *)(args[3].data + base3);

  int base4 = args[4].dat->base_offset;
  double * __restrict__ yO2_B0_p = (double *)(args[4].data + base4);

  int base5 = args[5].dat->base_offset;
  double * __restrict__ yO_B0_p = (double *)(args[5].data + base5);

  int base6 = args[6].dat->base_offset;
  double * __restrict__ cp_B0_p = (double *)(args[6].data + base6);
