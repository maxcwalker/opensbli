...
void ops_par_loop_opensbliblock00Kernel036_execute(ops_kernel_descriptor *desc) {
  ...
  double * __restrict__ DN2_B0_p = (double *)(args[0].data + base0);

  int base1 = args[1].dat->base_offset;
  double * __restrict__ DNO_B0_p = (double *)(args[1].data + base1);

  int base2 = args[2].dat->base_offset;
  double * __restrict__ DN_B0_p = (double *)(args[2].data + base2);

  int base3 = args[3].dat->base_offset;
  double * __restrict__ DO2_B0_p = (double *)(args[3].data + base3);

  int base4 = args[4].dat->base_offset;
  double * __restrict__ DO_B0_p = (double *)(args[4].data + base4);

  int base5 = args[5].dat->base_offset;
  double * __restrict__ T_B0_p = (double *)(args[5].data + base5);

  int base6 = args[6].dat->base_offset;
  double * __restrict__ Tv_B0_p = (double *)(args[6].data + base6);

  int base7 = args[7].dat->base_offset;
  double * __restrict__ XN2_B0_p = (double *)(args[7].data + base7);

  int base8 = args[8].dat->base_offset;
  double * __restrict__ XNO_B0_p = (double *)(args[8].data + base8);

  int base9 = args[9].dat->base_offset;
  double * __restrict__ XN_B0_p = (double *)(args[9].data + base9);

  int base10 = args[10].dat->base_offset;
  double * __restrict__ XO2_B0_p = (double *)(args[10].data + base10);

  int base11 = args[11].dat->base_offset;
  double * __restrict__ XO_B0_p = (double *)(args[11].data + base11);

  int base12 = args[12].dat->base_offset;
  double * __restrict__ af_B0_p = (double *)(args[12].data + base12);

  int base13 = args[13].dat->base_offset;
  double * __restrict__ cp_B0_p = (double *)(args[13].data + base13);

  int base14 = args[14].dat->base_offset;
  double * __restrict__ dumgaama_B0_p = (double *)(args[14].data + base14);

  int base15 = args[15].dat->base_offset;
  double * __restrict__ evN2_B0_p = (double *)(args[15].data + base15);

  int base16 = args[16].dat->base_offset;
  double * __restrict__ evNO_B0_p = (double *)(args[16].data + base16);

  int base17 = args[17].dat->base_offset;
  double * __restrict__ evO2_B0_p = (double *)(args[17].data + base17);

  int base18 = args[18].dat->base_offset;
  double * __restrict__ eveqN2_B0_p = (double *)(args[18].data + base18);

  int base19 = args[19].dat->base_offset;
  double * __restrict__ eveqNO_B0_p = (double *)(args[19].data + base19);

  int base20 = args[20].dat->base_offset;
  double * __restrict__ eveqO2_B0_p = (double *)(args[20].data + base20);

  int base21 = args[21].dat->base_offset;
  double * __restrict__ gammaf_B0_p = (double *)(args[21].data + base21);

  int base22 = args[22].dat->base_offset;
  double * __restrict__ p_B0_p = (double *)(args[22].data + base22);
  ...
  double * __restrict__ rhoN2_B0_p = (double *)(args[24].data + base24);

  int base25 = args[25].dat->base_offset;
  double * __restrict__ rhoNO_B0_p = (double *)(args[25].data + base25);

  int base26 = args[26].dat->base_offset;
  double * __restrict__ rhoN_B0_p = (double *)(args[26].data + base26);

  int base27 = args[27].dat->base_offset;
  double * __restrict__ rhoO2_B0_p = (double *)(args[27].data + base27);

  int base28 = args[28].dat->base_offset;
  double * __restrict__ rhoO_B0_p = (double *)(args[28].data + base28);

  int base29 = args[29].dat->base_offset;
  double * __restrict__ rhoev_B0_p = (double *)(args[29].data + base29);

  int base30 = args[30].dat->base_offset;
  double * __restrict__ rhou0_B0_p = (double *)(args[30].data + base30);

  int base31 = args[31].dat->base_offset;
  double * __restrict__ tauN2_B0_p = (double *)(args[31].data + base31);

  int base32 = args[32].dat->base_offset;
  double * __restrict__ tauNO_B0_p = (double *)(args[32].data + base32);

  int base33 = args[33].dat->base_offset;
  double * __restrict__ tauO2_B0_p = (double *)(args[33].data + base33);

  int base34 = args[34].dat->base_offset;
  double * __restrict__ u0_B0_p = (double *)(args[34].data + base34);

  int base35 = args[35].dat->base_offset;
  double * __restrict__ wdotN2_B0_p = (double *)(args[35].data + base35);

  int base36 = args[36].dat->base_offset;
  double * __restrict__ wdotNO_B0_p = (double *)(args[36].data + base36);

  int base37 = args[37].dat->base_offset;
  double * __restrict__ wdotN_B0_p = (double *)(args[37].data + base37);

  int base38 = args[38].dat->base_offset;
  double * __restrict__ wdotO2_B0_p = (double *)(args[38].data + base38);

  int base39 = args[39].dat->base_offset;
  double * __restrict__ wdotO_B0_p = (double *)(args[39].data + base39);

  int base40 = args[40].dat->base_offset;
  double * __restrict__ wk0_B0_p = (double *)(args[40].data + base40);

  int base41 = args[41].dat->base_offset;
  double * __restrict__ wk1_B0_p = (double *)(args[41].data + base41);

  int base42 = args[42].dat->base_offset;
  double * __restrict__ yN2_B0_p = (double *)(args[42].data + base42);

  int base43 = args[43].dat->base_offset;
  double * __restrict__ yNO_B0_p = (double *)(args[43].data + base43);

  int base44 = args[44].dat->base_offset;
  double * __restrict__ yN_B0_p = (double *)(args[44].data + base44);

  int base45 = args[45].dat->base_offset;
  double * __restrict__ yO2_B0_p = (double *)(args[45].data + base45);

  int base46 = args[46].dat->base_offset;
  double * __restrict__ yO_B0_p = (double *)(args[46].data + base46);

  int base47 = args[47].dat->base_offset;
  double * __restrict__ Residual0_B0_p = (double *)(args[47].data + base47);
  ...
  double * __restrict__ Residual2_B0_p = (double *)(args[49].data + base49);

  int base50 = args[50].dat->base_offset;
  double * __restrict__ Residual3_B0_p = (double *)(args[50].data + base50);

  int base51 = args[51].dat->base_offset;
  double * __restrict__ Residual4_B0_p = (double *)(args[51].data + base51);

  int base52 = args[52].dat->base_offset;
  double * __restrict__ Residual5_B0_p = (double *)(args[52].data + base52);

  int base53 = args[53].dat->base_offset;
  double * __restrict__ Residual6_B0_p = (double *)(args[53].data + base53);

  int base54 = args[54].dat->base_offset;
  double * __restrict__ Residual7_B0_p = (double *)(args[54].data + base54);
