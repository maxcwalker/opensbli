...
void ops_par_loop_opensbliblock00Kernel058_execute(ops_kernel_descriptor *desc) {
  ...
  double * __restrict__ rhoN_B0_p = (double *)(args[1].data + base1);

  int base2 = args[2].dat->base_offset;
  double * __restrict__ rhoO_B0_p = (double *)(args[2].data + base2);
  ...
  double * __restrict__ rhoNO_B0_p = (double *)(args[6].data + base6);

  int base7 = args[7].dat->base_offset;
  double * __restrict__ rhoO2_B0_p = (double *)(args[7].data + base7);
