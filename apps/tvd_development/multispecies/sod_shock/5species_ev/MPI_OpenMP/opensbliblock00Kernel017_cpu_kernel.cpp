...
void ops_par_loop_opensbliblock00Kernel017_execute(ops_kernel_descriptor *desc) {
  ...
  double * __restrict__ XN_B0_p = (double *)(args[5].data + base5);
  ...
  for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
    ...
    ACC<double> XN_B0(XN_B0_p + n_x*1);
...
void ops_par_loop_opensbliblock00Kernel017(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4, ops_arg arg5) {
  ...
  create_kerneldesc_and_enque(name, args, 6, 5, dim, 0, range, block, ops_par_loop_opensbliblock00Kernel017_execute);
}
#endif
