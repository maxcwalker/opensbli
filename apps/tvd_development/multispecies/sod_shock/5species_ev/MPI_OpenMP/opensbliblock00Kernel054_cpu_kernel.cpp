...
void ops_par_loop_opensbliblock00Kernel054_execute(ops_kernel_descriptor *desc) {
  ...
  double * __restrict__ tauO2_B0_p = (double *)(args[7].data + base7);
  ...
  for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
    ...
    ACC<double> tauO2_B0(tauO2_B0_p + n_x*1);
...
void ops_par_loop_opensbliblock00Kernel054(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4, ops_arg arg5, ops_arg arg6, ops_arg arg7) {
  ...
  create_kerneldesc_and_enque(name, args, 8, 39, dim, 0, range, block, ops_par_loop_opensbliblock00Kernel054_execute);
}
#endif
