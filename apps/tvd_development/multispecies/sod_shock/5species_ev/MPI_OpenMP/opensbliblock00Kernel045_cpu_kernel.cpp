...
void ops_par_loop_opensbliblock00Kernel045_execute(ops_kernel_descriptor *desc) {
  ...
  double * __restrict__ gammaf_B0_p = (double *)(args[1].data + base1);
  ...
  double * __restrict__ yO_B0_p = (double *)(args[6].data + base6);

  int base7 = args[7].dat->base_offset;
  double * __restrict__ af_B0_p = (double *)(args[7].data + base7);
