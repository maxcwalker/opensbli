...
void ops_par_loop_opensbliblock00Kernel037_execute(ops_kernel_descriptor *desc) {
  ...
  double * __restrict__ XN2_B0_p = (double *)(args[2].data_d + base2);

  int base3 = args[3].dat->base_offset;
  double * __restrict__ XNO_B0_p = (double *)(args[3].data_d + base3);

  int base4 = args[4].dat->base_offset;
  double * __restrict__ XN_B0_p = (double *)(args[4].data_d + base4);

  int base5 = args[5].dat->base_offset;
  double * __restrict__ XO2_B0_p = (double *)(args[5].data_d + base5);

  int base6 = args[6].dat->base_offset;
  double * __restrict__ XO_B0_p = (double *)(args[6].data_d + base6);

  int base7 = args[7].dat->base_offset;
  double * __restrict__ kappa_B0_p = (double *)(args[7].data_d + base7);

  int base8 = args[8].dat->base_offset;
  double * __restrict__ kappav_B0_p = (double *)(args[8].data_d + base8);

  int base9 = args[9].dat->base_offset;
  double * __restrict__ mu_B0_p = (double *)(args[9].data_d + base9);
  ...
  double * __restrict__ Residual5_B0_p = (double *)(args[18].data_d + base18);

  int base19 = args[19].dat->base_offset;
  double * __restrict__ Residual6_B0_p = (double *)(args[19].data_d + base19);

  int base20 = args[20].dat->base_offset;
  double * __restrict__ Residual7_B0_p = (double *)(args[20].data_d + base20);
