...
void ops_par_loop_opensbliblock00Kernel032_execute(ops_kernel_descriptor *desc) {
  ...
  double * __restrict__ Tv_B0_p = (double *)(args[8].data_d + base8);
  ...
  for ( int n_x=start0; n_x<end0; n_x++ ){
    ...
    ACC<double> Tv_B0(Tv_B0_p + n_x*1);
...
void ops_par_loop_opensbliblock00Kernel032(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg8) {
  ...
  create_kerneldesc_and_enque(name, args, 9, 19, dim, 0, range, block, ops_par_loop_opensbliblock00Kernel032_execute);
}
#endif
