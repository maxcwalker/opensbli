...
void ops_par_loop_opensbliblock00Kernel035_execute(ops_kernel_descriptor *desc) {
  ...
  double * __restrict__ mu_B0_p = (double *)(args[6].data_d + base6);
  ...
  for ( int n_x=start0; n_x<end0; n_x++ ){
    ...
    ACC<double> mu_B0(mu_B0_p + n_x*1);
...
void ops_par_loop_opensbliblock00Kernel035(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4, ops_arg arg5, ops_arg arg6) {
  ...
  create_kerneldesc_and_enque(name, args, 7, 26, dim, 0, range, block, ops_par_loop_opensbliblock00Kernel035_execute);
}
#endif
