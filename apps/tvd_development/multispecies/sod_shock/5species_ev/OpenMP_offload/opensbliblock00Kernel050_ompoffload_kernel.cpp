...
void ops_par_loop_opensbliblock00Kernel050_execute(ops_kernel_descriptor *desc) {
  ...
  double * __restrict__ cp_B0_p = (double *)(args[0].data_d + base0);
  ...
  double * __restrict__ gammaf_B0_p = (double *)(args[6].data_d + base6);
  ...
  for ( int n_x=start0; n_x<end0; n_x++ ){
    ...
    ACC<double> gammaf_B0(gammaf_B0_p + n_x*1);
...
void ops_par_loop_opensbliblock00Kernel050(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4, ops_arg arg5, ops_arg arg6) {
  ...
  create_kerneldesc_and_enque(name, args, 7, 38, dim, 0, range, block, ops_par_loop_opensbliblock00Kernel050_execute);
}
#endif
