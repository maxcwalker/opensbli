...
void ops_par_loop_opensbliblock00Kernel002_execute(ops_kernel_descriptor *desc) {
  ...
  double * __restrict__ a_B0_p = (double *)(args[7].data_d + base7);
...
void ops_par_loop_opensbliblock00Kernel002(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg8, ops_arg arg9) {
  ...
  create_kerneldesc_and_enque(name, args, 10, 15, dim, 0, range, block, ops_par_loop_opensbliblock00Kernel002_execute);
}
#endif
