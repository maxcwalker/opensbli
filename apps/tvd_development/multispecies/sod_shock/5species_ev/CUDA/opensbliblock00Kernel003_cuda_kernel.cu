...
__device__
 ...
 void opensbliblock00Kernel003_gpu(ACC<double> &wk0_B0,
  ACC<double> &wk1_B0,
  ACC<double> &wk2_B0,
  ACC<double> &wk3_B0,
  ACC<double> &wk4_B0,
...
void ops_par_loop_opensbliblock00Kernel003(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4, ops_arg arg5, ops_arg arg6, ops_arg arg7) {
  ...
  create_kerneldesc_and_enque(name, args, 8, 16, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel003_execute);
}
#endif
