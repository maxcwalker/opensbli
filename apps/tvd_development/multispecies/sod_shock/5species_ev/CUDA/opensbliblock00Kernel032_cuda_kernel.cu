...
//
__constant__ int dims_opensbliblock00Kernel032 [9][1];
static int dims_opensbliblock00Kernel032_h [9][1] = {{0}};

//user function
__device__

 void opensbliblock00Kernel032_gpu(const ACC<double> &rhoE_B0,
...
ACC<double> &u0_B0,
  ACC<double> &Tv_B0)
{
    Tv_B0(0) = (-rhoev_B0(0) - 0.5*(u0_B0(0)*u0_B0(0))*(rhoN_B0(0) + rhoO_B0(0) + rhoN2_B0(0) + rhoNO_B0(0) +
      rhoO2_B0(0)) - dhf0N*invMN*rhoN_B0(0) - dhf0O*invMO*rhoO_B0(0) - dhf0NO*invMNO*rhoNO_B0(0) +
      rhoE_B0(0))*invRhat/(1.5*invMN*rhoN_B0(0) + 1.5*invMO*rhoO_B0(0) + 2.5*invMN2*rhoN2_B0(0) + 2.5*invMNO*rhoNO_B0(0)
      + 2.5*invMO2*rhoO2_B0(0));
...
void ops_par_loop_opensbliblock00Kernel032_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_opensbliblock00Kernel032_h[0][0] || xdim1 != dims_opensbliblock00Kernel032_h[1][0] || xdim2 != dims_opensbliblock00Kernel032_h[2][0] || xdim3 != dims_opensbliblock00Kernel032_h[3][0] || xdim4 != dims_opensbliblock00Kernel032_h[4][0] || xdim5 != dims_opensbliblock00Kernel032_h[5][0] || xdim6 != dims_opensbliblock00Kernel032_h[6][0] || xdim7 != dims_opensbliblock00Kernel032_h[7][0] || xdim8 != dims_opensbliblock00Kernel032_h[8][0]) {
...
void ops_par_loop_opensbliblock00Kernel032(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg8) {
  ...
  create_kerneldesc_and_enque(name, args, 9, 19, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel032_execute);
}
#endif
