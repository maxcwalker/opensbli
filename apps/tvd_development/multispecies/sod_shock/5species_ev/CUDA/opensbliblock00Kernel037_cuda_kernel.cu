...
//
__constant__ int dims_opensbliblock00Kernel037 [2][1];
static int dims_opensbliblock00Kernel037_h [2][1] = {{0}};
...
void ops_par_loop_opensbliblock00Kernel037(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1) {
  ...
  create_kerneldesc_and_enque(name, args, 2, 19, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel037_execute);
}
#endif
