...
void ops_par_loop_opensbliblock00Kernel023_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_opensbliblock00Kernel023_h[0][0] || xdim1 != dims_opensbliblock00Kernel023_h[1][0] || xdim2 != dims_opensbliblock00Kernel023_h[2][0] || xdim3 != dims_opensbliblock00Kernel023_h[3][0] || xdim4 != dims_opensbliblock00Kernel023_h[4][0] || xdim5 != dims_opensbliblock00Kernel023_h[5][0] || xdim6 != dims_opensbliblock00Kernel023_h[6][0]) {
...
void ops_par_loop_opensbliblock00Kernel023(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4, ops_arg arg5, ops_arg arg6) {
  ...
  create_kerneldesc_and_enque(name, args, 7, 9, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel023_execute);
}
#endif
