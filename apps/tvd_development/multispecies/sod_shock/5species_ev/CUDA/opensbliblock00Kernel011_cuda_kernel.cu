...
//
__constant__ int dims_opensbliblock00Kernel011 [9][1];
static int dims_opensbliblock00Kernel011_h [9][1] = {{0}};

//user function
__device__

 void opensbliblock00Kernel011_gpu(const ACC<double> &rhoE_B0,
...
void ops_par_loop_opensbliblock00Kernel011(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg8) {
  ...
  create_kerneldesc_and_enque(name, args, 9, 4, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel011_execute);
}
#endif
