...
//
__constant__ int dims_opensbliblock00Kernel045 [8][1];
static int dims_opensbliblock00Kernel045_h [8][1] = {{0}};

//user function
__device__

 void opensbliblock00Kernel045_gpu(const ACC<double> &T_B0,
...
void ops_par_loop_opensbliblock00Kernel045(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4, ops_arg arg5, ops_arg arg6, ops_arg arg7) {
  ...
  create_kerneldesc_and_enque(name, args, 8, 40, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel045_execute);
}
#endif
