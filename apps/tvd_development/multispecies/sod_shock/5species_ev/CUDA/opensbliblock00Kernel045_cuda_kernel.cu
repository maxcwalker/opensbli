...
//
__constant__ int dims_opensbliblock00Kernel045 [26][1];
static int dims_opensbliblock00Kernel045_h [26][1] = {{0}};

//user function
__device__

 void opensbliblock00Kernel045_gpu(const ACC<double> &Residual0_B0,
...
void ops_par_loop_opensbliblock00Kernel045_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_opensbliblock00Kernel045_h[0][0] || xdim1 != dims_opensbliblock00Kernel045_h[1][0] || xdim2 != dims_opensbliblock00Kernel045_h[2][0] || xdim3 != dims_opensbliblock00Kernel045_h[3][0] || xdim4 != dims_opensbliblock00Kernel045_h[4][0] || xdim5 != dims_opensbliblock00Kernel045_h[5][0] || xdim6 != dims_opensbliblock00Kernel045_h[6][0] || xdim7 != dims_opensbliblock00Kernel045_h[7][0] || xdim8 != dims_opensbliblock00Kernel045_h[8][0] || xdim9 != dims_opensbliblock00Kernel045_h[9][0] || xdim10 != dims_opensbliblock00Kernel045_h[10][0] || xdim11 != dims_opensbliblock00Kernel045_h[11][0] || xdim12 != dims_opensbliblock00Kernel045_h[12][0] || xdim13 != dims_opensbliblock00Kernel045_h[13][0] || xdim14 != dims_opensbliblock00Kernel045_h[14][0] || xdim15 != dims_opensbliblock00Kernel045_h[15][0] || xdim16 != dims_opensbliblock00Kernel045_h[16][0] || xdim17 != dims_opensbliblock00Kernel045_h[17][0] || xdim18 != dims_opensbliblock00Kernel045_h[18][0] || xdim19 != dims_opensbliblock00Kernel045_h[19][0] || xdim20 != dims_opensbliblock00Kernel045_h[20][0] || xdim21 != dims_opensbliblock00Kernel045_h[21][0] || xdim22 != dims_opensbliblock00Kernel045_h[22][0] || xdim23 != dims_opensbliblock00Kernel045_h[23][0]) {
    ...
    dims_opensbliblock00Kernel045_h[14][0] = xdim14;
    dims_opensbliblock00Kernel045_h[15][0] = xdim15;
    dims_opensbliblock00Kernel045_h[16][0] = xdim16;
    dims_opensbliblock00Kernel045_h[17][0] = xdim17;
    dims_opensbliblock00Kernel045_h[18][0] = xdim18;
    dims_opensbliblock00Kernel045_h[19][0] = xdim19;
    dims_opensbliblock00Kernel045_h[20][0] = xdim20;
    dims_opensbliblock00Kernel045_h[21][0] = xdim21;
    dims_opensbliblock00Kernel045_h[22][0] = xdim22;
    dims_opensbliblock00Kernel045_h[23][0] = xdim23;
...
void ops_par_loop_opensbliblock00Kernel045(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg24, ops_arg arg25) {
  ...
  create_kerneldesc_and_enque(name, args, 26, 27, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel045_execute);
}
#endif
