...
//
__constant__ int dims_opensbliblock00Kernel033 [6][1];
static int dims_opensbliblock00Kernel033_h [6][1] = {{0}};

//user function
__device__

 void opensbliblock00Kernel033_gpu(const ACC<double> &rhoN2_B0,
...
void ops_par_loop_opensbliblock00Kernel033(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4, ops_arg arg5) {
  ...
  create_kerneldesc_and_enque(name, args, 6, 11, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel033_execute);
}
#endif
