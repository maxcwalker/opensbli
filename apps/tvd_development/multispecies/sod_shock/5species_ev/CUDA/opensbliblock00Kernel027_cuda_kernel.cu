...
//
__constant__ int dims_opensbliblock00Kernel027 [9][1];
static int dims_opensbliblock00Kernel027_h [9][1] = {{0}};

//user function
__device__

 void opensbliblock00Kernel027_gpu(const ACC<double> &x0_B0,
  ACC<double> &rhoE_B0,
  ACC<double> &rhoN2_B0,
  ACC<double>
&rhoNO_B0,
...
void ops_par_loop_opensbliblock00Kernel027_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_opensbliblock00Kernel027_h[0][0] || xdim1 != dims_opensbliblock00Kernel027_h[1][0] || xdim2 != dims_opensbliblock00Kernel027_h[2][0] || xdim3 != dims_opensbliblock00Kernel027_h[3][0] || xdim4 != dims_opensbliblock00Kernel027_h[4][0] || xdim5 != dims_opensbliblock00Kernel027_h[5][0] || xdim6 != dims_opensbliblock00Kernel027_h[6][0] || xdim7 != dims_opensbliblock00Kernel027_h[7][0] || xdim8 != dims_opensbliblock00Kernel027_h[8][0]) {
...
void ops_par_loop_opensbliblock00Kernel027(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg8) {
  ...
  create_kerneldesc_and_enque(name, args, 9, 2, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel027_execute);
}
#endif
