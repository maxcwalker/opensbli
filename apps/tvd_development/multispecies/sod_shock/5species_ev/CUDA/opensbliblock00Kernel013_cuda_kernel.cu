...
//
__constant__ int dims_opensbliblock00Kernel013 [34][1];
static int dims_opensbliblock00Kernel013_h [34][1] = {{0}};

//user function
__device__

 void opensbliblock00Kernel013_gpu(const ACC<double> &T_B0,
...
__global__ void ops_opensbliblock00Kernel013(
...
void ops_par_loop_opensbliblock00Kernel013_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_opensbliblock00Kernel013_h[0][0] || xdim1 != dims_opensbliblock00Kernel013_h[1][0] || xdim2 != dims_opensbliblock00Kernel013_h[2][0] || xdim3 != dims_opensbliblock00Kernel013_h[3][0] || xdim4 != dims_opensbliblock00Kernel013_h[4][0] || xdim5 != dims_opensbliblock00Kernel013_h[5][0] || xdim6 != dims_opensbliblock00Kernel013_h[6][0] || xdim7 != dims_opensbliblock00Kernel013_h[7][0] || xdim8 != dims_opensbliblock00Kernel013_h[8][0] || xdim9 != dims_opensbliblock00Kernel013_h[9][0] || xdim10 != dims_opensbliblock00Kernel013_h[10][0] || xdim11 != dims_opensbliblock00Kernel013_h[11][0] || xdim12 != dims_opensbliblock00Kernel013_h[12][0] || xdim13 != dims_opensbliblock00Kernel013_h[13][0] || xdim14 != dims_opensbliblock00Kernel013_h[14][0] || xdim15 != dims_opensbliblock00Kernel013_h[15][0] || xdim16 != dims_opensbliblock00Kernel013_h[16][0] || xdim17 != dims_opensbliblock00Kernel013_h[17][0] || xdim18 != dims_opensbliblock00Kernel013_h[18][0] || xdim19 != dims_opensbliblock00Kernel013_h[19][0] || xdim20 != dims_opensbliblock00Kernel013_h[20][0] || xdim21 != dims_opensbliblock00Kernel013_h[21][0] || xdim22 != dims_opensbliblock00Kernel013_h[22][0] || xdim23 != dims_opensbliblock00Kernel013_h[23][0] || xdim24 != dims_opensbliblock00Kernel013_h[24][0] || xdim25 != dims_opensbliblock00Kernel013_h[25][0] || xdim26 != dims_opensbliblock00Kernel013_h[26][0] || xdim27 != dims_opensbliblock00Kernel013_h[27][0] || xdim28 != dims_opensbliblock00Kernel013_h[28][0] || xdim29 != dims_opensbliblock00Kernel013_h[29][0] || xdim30 != dims_opensbliblock00Kernel013_h[30][0] || xdim31 != dims_opensbliblock00Kernel013_h[31][0] || xdim32 != dims_opensbliblock00Kernel013_h[32][0]) {
    dims_opensbliblock00Kernel013_h[0][0] = xdim0;
    dims_opensbliblock00Kernel013_h[1][0] = xdim1;
    dims_opensbliblock00Kernel013_h[2][0] = xdim2;
    dims_opensbliblock00Kernel013_h[3][0] = xdim3;
    dims_opensbliblock00Kernel013_h[4][0] = xdim4;
    dims_opensbliblock00Kernel013_h[5][0] = xdim5;
    dims_opensbliblock00Kernel013_h[6][0] = xdim6;
    dims_opensbliblock00Kernel013_h[7][0] = xdim7;
    dims_opensbliblock00Kernel013_h[8][0] = xdim8;
    dims_opensbliblock00Kernel013_h[9][0] = xdim9;
    dims_opensbliblock00Kernel013_h[10][0] = xdim10;
    dims_opensbliblock00Kernel013_h[11][0] = xdim11;
    dims_opensbliblock00Kernel013_h[12][0] = xdim12;
    dims_opensbliblock00Kernel013_h[13][0] = xdim13;
    dims_opensbliblock00Kernel013_h[14][0] = xdim14;
    dims_opensbliblock00Kernel013_h[15][0] = xdim15;
    dims_opensbliblock00Kernel013_h[16][0] = xdim16;
    dims_opensbliblock00Kernel013_h[17][0] = xdim17;
    dims_opensbliblock00Kernel013_h[18][0] = xdim18;
    dims_opensbliblock00Kernel013_h[19][0] = xdim19;
    dims_opensbliblock00Kernel013_h[20][0] = xdim20;
    dims_opensbliblock00Kernel013_h[21][0] = xdim21;
    dims_opensbliblock00Kernel013_h[22][0] = xdim22;
    dims_opensbliblock00Kernel013_h[23][0] = xdim23;
    dims_opensbliblock00Kernel013_h[24][0] = xdim24;
    dims_opensbliblock00Kernel013_h[25][0] = xdim25;
    dims_opensbliblock00Kernel013_h[26][0] = xdim26;
    dims_opensbliblock00Kernel013_h[27][0] = xdim27;
    dims_opensbliblock00Kernel013_h[28][0] = xdim28;
    dims_opensbliblock00Kernel013_h[29][0] = xdim29;
    dims_opensbliblock00Kernel013_h[30][0] = xdim30;
    dims_opensbliblock00Kernel013_h[31][0] = xdim31;
    dims_opensbliblock00Kernel013_h[32][0] = xdim32;
    cutilSafeCall(block->instance->ostream(), cudaMemcpyToSymbol( dims_opensbliblock00Kernel013, dims_opensbliblock00Kernel013_h, sizeof(dims_opensbliblock00Kernel013)));
  }
  ...
  if (x_size > 0)
    ops_opensbliblock00Kernel013<<<grid, tblock >>> ( 
...
void ops_par_loop_opensbliblock00Kernel013(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg32, ops_arg arg33) {
  ...
  create_kerneldesc_and_enque(name, args, 34, 13, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel013_execute);
}
#endif
