...
__device__
 ...
 void opensbliblock00Kernel012_gpu(const ACC<double> &rhoN2_B0,
...
void ops_par_loop_opensbliblock00Kernel012(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4) {
  ...
  create_kerneldesc_and_enque(name, args, 5, 4, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel012_execute);
}
#endif
