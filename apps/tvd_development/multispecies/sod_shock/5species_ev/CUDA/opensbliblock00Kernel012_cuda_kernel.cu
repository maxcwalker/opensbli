...
//
__constant__ int dims_opensbliblock00Kernel012 [7][1];
static int dims_opensbliblock00Kernel012_h [7][1] = {{0}};

//user function
__device__

 void opensbliblock00Kernel012_gpu(const ACC<double> &mu_B0,
...
ACC<double> &rhoN_B0,
  ...
  ACC<double> &DN_B0)
{
   DN_B0(0) = invRe*invSc*mu_B0(0)/(rhoN_B0(0) + rhoO_B0(0) + rhoN2_B0(0) + rhoNO_B0(0) + rhoO2_B0(0));
...
void ops_par_loop_opensbliblock00Kernel012_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_opensbliblock00Kernel012_h[0][0] || xdim1 != dims_opensbliblock00Kernel012_h[1][0] || xdim2 != dims_opensbliblock00Kernel012_h[2][0] || xdim3 != dims_opensbliblock00Kernel012_h[3][0] || xdim4 != dims_opensbliblock00Kernel012_h[4][0] || xdim5 != dims_opensbliblock00Kernel012_h[5][0] || xdim6 != dims_opensbliblock00Kernel012_h[6][0]) {
...
void ops_par_loop_opensbliblock00Kernel012(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4, ops_arg arg5, ops_arg arg6) {
  ...
  create_kerneldesc_and_enque(name, args, 7, 33, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel012_execute);
}
#endif
