...
//
__constant__ int dims_opensbliblock00Kernel060 [26][1];
static int dims_opensbliblock00Kernel060_h [26][1] = {{0}};

//user function
__device__

 void opensbliblock00Kernel060_gpu(const ACC<double> &Residual0_B0,
...
&rhou0_RKold_B0,
  ...
  const double *rkB)
{
   rhoN2_RKold_B0(0) = rkA[0]*rhoN2_RKold_B0(0) + dt*Residual0_B0(0);
   ...
   rhoNO_RKold_B0(0) = rkA[0]*rhoNO_RKold_B0(0) + dt*Residual2_B0(0);

   rhoNO_B0(0) = rkB[0]*rhoNO_RKold_B0(0) + rhoNO_B0(0);

   rhoN_RKold_B0(0) = rkA[0]*rhoN_RKold_B0(0) + dt*Residual3_B0(0);

   rhoN_B0(0) = rkB[0]*rhoN_RKold_B0(0) + rhoN_B0(0);

   rhoO_RKold_B0(0) = rkA[0]*rhoO_RKold_B0(0) + dt*Residual4_B0(0);

   rhoO_B0(0) = rkB[0]*rhoO_RKold_B0(0) + rhoO_B0(0);

   rhoev_RKold_B0(0) = rkA[0]*rhoev_RKold_B0(0) + dt*Residual5_B0(0);

   rhoev_B0(0) = rkB[0]*rhoev_RKold_B0(0) + rhoev_B0(0);

   rhou0_RKold_B0(0) = rkA[0]*rhou0_RKold_B0(0) + dt*Residual6_B0(0);
...
__global__ void ops_opensbliblock00Kernel060(
...
#else
void ops_par_loop_opensbliblock00Kernel060_execute(ops_kernel_descriptor *desc) {
  int dim = desc->dim;
  #if OPS_MPI
  ...
  if (xdim0 != dims_opensbliblock00Kernel060_h[0][0] || xdim1 != dims_opensbliblock00Kernel060_h[1][0] || xdim2 != dims_opensbliblock00Kernel060_h[2][0] || xdim3 != dims_opensbliblock00Kernel060_h[3][0] || xdim4 != dims_opensbliblock00Kernel060_h[4][0] || xdim5 != dims_opensbliblock00Kernel060_h[5][0] || xdim6 != dims_opensbliblock00Kernel060_h[6][0] || xdim7 != dims_opensbliblock00Kernel060_h[7][0] || xdim8 != dims_opensbliblock00Kernel060_h[8][0] || xdim9 != dims_opensbliblock00Kernel060_h[9][0] || xdim10 != dims_opensbliblock00Kernel060_h[10][0] || xdim11 != dims_opensbliblock00Kernel060_h[11][0] || xdim12 != dims_opensbliblock00Kernel060_h[12][0] || xdim13 != dims_opensbliblock00Kernel060_h[13][0] || xdim14 != dims_opensbliblock00Kernel060_h[14][0] || xdim15 != dims_opensbliblock00Kernel060_h[15][0] || xdim16 != dims_opensbliblock00Kernel060_h[16][0] || xdim17 != dims_opensbliblock00Kernel060_h[17][0] || xdim18 != dims_opensbliblock00Kernel060_h[18][0] || xdim19 != dims_opensbliblock00Kernel060_h[19][0] || xdim20 != dims_opensbliblock00Kernel060_h[20][0] || xdim21 != dims_opensbliblock00Kernel060_h[21][0] || xdim22 != dims_opensbliblock00Kernel060_h[22][0] || xdim23 != dims_opensbliblock00Kernel060_h[23][0]) {
    dims_opensbliblock00Kernel060_h[0][0] = xdim0;
    dims_opensbliblock00Kernel060_h[1][0] = xdim1;
    dims_opensbliblock00Kernel060_h[2][0] = xdim2;
    dims_opensbliblock00Kernel060_h[3][0] = xdim3;
    dims_opensbliblock00Kernel060_h[4][0] = xdim4;
    dims_opensbliblock00Kernel060_h[5][0] = xdim5;
    dims_opensbliblock00Kernel060_h[6][0] = xdim6;
    dims_opensbliblock00Kernel060_h[7][0] = xdim7;
    dims_opensbliblock00Kernel060_h[8][0] = xdim8;
    dims_opensbliblock00Kernel060_h[9][0] = xdim9;
    dims_opensbliblock00Kernel060_h[10][0] = xdim10;
    dims_opensbliblock00Kernel060_h[11][0] = xdim11;
    dims_opensbliblock00Kernel060_h[12][0] = xdim12;
    dims_opensbliblock00Kernel060_h[13][0] = xdim13;
    dims_opensbliblock00Kernel060_h[14][0] = xdim14;
    dims_opensbliblock00Kernel060_h[15][0] = xdim15;
    dims_opensbliblock00Kernel060_h[16][0] = xdim16;
    dims_opensbliblock00Kernel060_h[17][0] = xdim17;
    dims_opensbliblock00Kernel060_h[18][0] = xdim18;
    dims_opensbliblock00Kernel060_h[19][0] = xdim19;
    dims_opensbliblock00Kernel060_h[20][0] = xdim20;
    dims_opensbliblock00Kernel060_h[21][0] = xdim21;
    dims_opensbliblock00Kernel060_h[22][0] = xdim22;
    dims_opensbliblock00Kernel060_h[23][0] = xdim23;
    cutilSafeCall(block->instance->ostream(), cudaMemcpyToSymbol( dims_opensbliblock00Kernel060, dims_opensbliblock00Kernel060_h, sizeof(dims_opensbliblock00Kernel060)));
  }
  ...
  if (x_size > 0)
    ops_opensbliblock00Kernel060<<<grid, tblock >>> ( 
...
void ops_par_loop_opensbliblock00Kernel060(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg24, ops_arg arg25) {
  ...
  create_kerneldesc_and_enque(name, args, 26, 45, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel060_execute);
}
#endif
