...
ops_par_loop_opensbliblock00Kernel010("CRu0_B0", opensbliblock00, 1, iteration_range_10_block0,
...
ops_par_loop_opensbliblock00Kernel020("CReveqN2_B0", opensbliblock00, 1, iteration_range_20_block0,
             ops_arg_dat(T_B0, 1, stencil_0_00_1, "double", OPS_READ),
...
ops_par_loop_opensbliblock00Kernel022("CRptauNO_B0", opensbliblock00, 1, iteration_range_22_block0,
             ops_arg_dat(T_B0, 1, stencil_0_00_1, "double", OPS_READ),
             ops_arg_dat(rhoN2_B0, 1, stencil_0_00_1, "double", OPS_READ),
             ops_arg_dat(rhoNO_B0, 1, stencil_0_00_1, "double", OPS_READ),
             ops_arg_dat(rhoN_B0, 1, stencil_0_00_1, "double", OPS_READ),
...
ops_par_loop_opensbliblock00Kernel023("CRptauN2_B0", opensbliblock00, 1, iteration_range_23_block0,
             ops_arg_dat(T_B0, 1, stencil_0_00_1, "double", OPS_READ),
             ops_arg_dat(rhoN2_B0, 1, stencil_0_00_1, "double", OPS_READ),
             ops_arg_dat(rhoNO_B0, 1, stencil_0_00_1, "double", OPS_READ),
             ops_arg_dat(rhoN_B0, 1, stencil_0_00_1, "double", OPS_READ),
...
ops_par_loop_opensbliblock00Kernel024("CReveqO2_B0", opensbliblock00, 1, iteration_range_24_block0,
             ops_arg_dat(T_B0, 1, stencil_0_00_1, "double", OPS_READ),
             ops_arg_dat(eveqO2_B0, 1, stencil_0_00_1, "double", OPS_WRITE));

int iteration_range_25_block0[] = {0, block0np0};
ops_par_loop_opensbliblock00Kernel025("CReveqNO_B0", opensbliblock00, 1, iteration_range_25_block0,
             ops_arg_dat(T_B0, 1, stencil_0_00_1, "double", OPS_READ),
