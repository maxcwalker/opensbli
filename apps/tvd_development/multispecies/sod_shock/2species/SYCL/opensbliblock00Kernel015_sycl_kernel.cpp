...
void ops_par_loop_opensbliblock00Kernel015_execute(ops_kernel_descriptor *desc) {
 ...
 arg10, arg11, arg12, arg13};
  ...
  double* wdotN2_B0_p = (double*)args[7].data_d;

  int base8 = args[8].dat->base_offset/sizeof(double);
  double* wdotN_B0_p = (double*)args[8].data_d;
  ...
  if ((end[0]-start[0])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      , [=](cl::sycl::nd_item<1> item
        ...
        const ACC<double> wdotN2_B0(&wdotN2_B0_p[0] + base7 + n_x*1);
        const ACC<double> wdotN_B0(&wdotN_B0_p[0] + base8 + n_x*1);
        ACC<double> Residual0_B0(&Residual0_B0_p[0] + base9 + n_x*1);
        ACC<double> Residual1_B0(&Residual1_B0_p[0] + base10 + n_x*1);
        ACC<double> Residual2_B0(&Residual2_B0_p[0] + base11 + n_x*1);
        ACC<double> Residual3_B0(&Residual3_B0_p[0] + base12 + n_x*1);
        //USER CODE
        if (n_x < end_0) {
   ...
   Residual3_B0(0) = -d1_prhoEu0_dx + kappa_sycl[0]*d2_T_dx;
