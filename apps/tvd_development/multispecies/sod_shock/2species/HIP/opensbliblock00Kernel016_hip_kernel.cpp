...
__device__
 ...
 void opensbliblock00Kernel016_gpu(ACC<double> &rhoE_B0,
  ACC<double> &rhoN2_B0,
  ACC<double> &rhoN_B0,
  ACC<double> &rho_B0,
  ACC<double> &rhou0_B0,
...
void ops_par_loop_opensbliblock00Kernel016(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4, ops_arg arg5, ops_arg arg6) {
  ...
  create_kerneldesc_and_enque(name, args, 7, 0, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel016_execute);
}
#endif
