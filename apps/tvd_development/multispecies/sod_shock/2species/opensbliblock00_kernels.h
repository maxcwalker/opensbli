...
#define OPENSBLIBLOCK00_KERNEL_H
 void opensbliblock00Kernel018(ACC<double> &rhoE_B0, ACC<double> &rhoN2_B0, ACC<double> &rhoN_B0, ACC<double> &rhou0_B0,
...
&rhou0_B0)
{
 ...
 void opensbliblock00Kernel017(ACC<double> &rhoE_B0, ACC<double> &rhoN2_B0, ACC<double> &rhoN_B0, ACC<double>
&rhou0_B0)
{
   double T0 = 0.0;
   double cN = 0.0;
...
void opensbliblock00Kernel006(const ACC<double> &u_B0, ACC<double> &wk0_B0, const int *idx)
{
 ...
 void opensbliblock00Kernel015(const ACC<double> &T_B0, const ACC<double> &p_B0, const ACC<double> &rhoE_B0, const
ACC<double> &rhoN2_B0, const ACC<double> &rhoN_B0, const ACC<double> &rhou0_B0, const ACC<double> &u0_B0, const
ACC<double> &wdotN2_B0, const ACC<double> &wdotN_B0, ACC<double> &Residual0_B0, ACC<double> &Residual1_B0, ACC<double>
&Residual2_B0, ACC<double> &Residual3_B0, const int *idx)
{
   ...
   Residual3_B0(0) = -d1_prhoEu0_dx + kappa*d2_T_dx;

}

 void opensbliblock00Kernel019(const ACC<double> &Residual0_B0, const ACC<double> &Residual1_B0, const ACC<double>
