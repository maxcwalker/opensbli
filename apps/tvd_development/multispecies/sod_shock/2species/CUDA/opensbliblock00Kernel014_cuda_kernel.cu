...
__device__
 ...
 void opensbliblock00Kernel014_gpu(ACC<double> &rhoE_B0,
  ACC<double> &rhoN2_B0,
  ACC<double> &rhoN_B0,
  ACC<double> &rhoev_B0,
  ACC<double> &rhou0_B0)
...
void ops_par_loop_opensbliblock00Kernel014(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4) {
  ...
  create_kerneldesc_and_enque(name, args, 5, 2, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel014_execute);
}
#endif
