...
__device__
 ...
 void opensbliblock00Kernel017_gpu(const ACC<double> &Residual0_B0,
...
void ops_par_loop_opensbliblock00Kernel017(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg12, ops_arg arg13) {
  ...
  create_kerneldesc_and_enque(name, args, 14, 5, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel017_execute);
}
#endif
