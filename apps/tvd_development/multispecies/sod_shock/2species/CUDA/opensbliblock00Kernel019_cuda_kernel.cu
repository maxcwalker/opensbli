...
//
__constant__ int dims_opensbliblock00Kernel019 [14][1];
static int dims_opensbliblock00Kernel019_h [14][1] = {{0}};

//user function
__device__

 void opensbliblock00Kernel019_gpu(const ACC<double> &Residual0_B0,
...
void ops_par_loop_opensbliblock00Kernel019(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg12, ops_arg arg13) {
  ...
  create_kerneldesc_and_enque(name, args, 14, 7, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel019_execute);
}
#endif
