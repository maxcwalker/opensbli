...
void ops_par_loop_opensbliblock00Kernel015_execute(ops_kernel_descriptor *desc) {
  ...
  double * __restrict__ wdotN2_B0_p = (double *)(args[7].data + base7);

  int base8 = args[8].dat->base_offset;
  double * __restrict__ wdotN_B0_p = (double *)(args[8].data + base8);
...
void ops_par_loop_opensbliblock00Kernel015(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg12, ops_arg arg13) {
  ...
  create_kerneldesc_and_enque(name, args, 14, 6, dim, 0, range, block, ops_par_loop_opensbliblock00Kernel015_execute);
}
#endif
