...
void ops_par_loop_opensbliblock00Kernel016_execute(ops_kernel_descriptor *desc) {
 ...
 arg15, arg16};
  ...
  double* wdotN2_B0_p = (double*)args[9].data_d;

  int base10 = args[10].dat->base_offset/sizeof(double);
  double* wdotN_B0_p = (double*)args[10].data_d;
  ...
  double* Residual4_B0_p = (double*)args[15].data_d;
  ...
  if ((end[0]-start[0])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      , [=](cl::sycl::nd_item<1> item
        ...
        const ACC<double> wdotN2_B0(&wdotN2_B0_p[0] + base9 + n_x*1);
        const ACC<double> wdotN_B0(&wdotN_B0_p[0] + base10 + n_x*1);
        ACC<double> Residual0_B0(&Residual0_B0_p[0] + base11 + n_x*1);
        ACC<double> Residual1_B0(&Residual1_B0_p[0] + base12 + n_x*1);
        ACC<double> Residual2_B0(&Residual2_B0_p[0] + base13 + n_x*1);
        ACC<double> Residual3_B0(&Residual3_B0_p[0] + base14 + n_x*1);
        ACC<double> Residual4_B0(&Residual4_B0_p[0] + base15 + n_x*1);
        //USER CODE
        if (n_x < end_0) {
