...
void ops_par_loop_opensbliblock00Kernel015_execute(ops_kernel_descriptor *desc) {
  ...
  double * __restrict__ T_B0_p = (double *)(args[4].data + base4);
...
void ops_par_loop_opensbliblock00Kernel015(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4) {
  ...
  create_kerneldesc_and_enque(name, args, 5, 4, dim, 0, range, block, ops_par_loop_opensbliblock00Kernel015_execute);
}
#endif
