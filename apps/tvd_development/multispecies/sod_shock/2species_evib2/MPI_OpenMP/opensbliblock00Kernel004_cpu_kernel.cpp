...
void ops_par_loop_opensbliblock00Kernel004_execute(ops_kernel_descriptor *desc) {
  ...
  double * __restrict__ rhoev_B0_p = (double *)(args[5].data + base5);
...
void ops_par_loop_opensbliblock00Kernel004(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg12) {
  ...
  create_kerneldesc_and_enque(name, args, 13, 13, dim, 0, range, block, ops_par_loop_opensbliblock00Kernel004_execute);
}
#endif
