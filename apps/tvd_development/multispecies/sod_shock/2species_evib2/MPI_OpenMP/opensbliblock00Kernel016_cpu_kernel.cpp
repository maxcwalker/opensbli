...
void ops_par_loop_opensbliblock00Kernel016_execute(ops_kernel_descriptor *desc) {
  ...
  double * __restrict__ eveqN2_B0_p = (double *)(args[1].data + base1);

  int base2 = args[2].dat->base_offset;
  double * __restrict__ p_B0_p = (double *)(args[2].data + base2);

  int base3 = args[3].dat->base_offset;
  double * __restrict__ ptauN2_B0_p = (double *)(args[3].data + base3);
  ...
  double * __restrict__ wdotN2_B0_p = (double *)(args[10].data + base10);

  int base11 = args[11].dat->base_offset;
  double * __restrict__ wdotN_B0_p = (double *)(args[11].data + base11);
...
void ops_par_loop_opensbliblock00Kernel016(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg16, ops_arg arg17) {
  ...
  create_kerneldesc_and_enque(name, args, 18, 9, dim, 0, range, block, ops_par_loop_opensbliblock00Kernel016_execute);
}
#endif
