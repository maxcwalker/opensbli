...
//
__constant__ int dims_opensbliblock00Kernel015 [7][1];
static int dims_opensbliblock00Kernel015_h [7][1] = {{0}};
...
void ops_par_loop_opensbliblock00Kernel015(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4, ops_arg arg5, ops_arg arg6) {
  ...
  create_kerneldesc_and_enque(name, args, 7, 0, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel015_execute);
}
#endif
