...
void ops_par_loop_opensbliblock00Kernel016_execute(ops_kernel_descriptor *desc) {
 ...
 arg15, arg16, arg17};
  ...
  double* wdotN2_B0_p = (double*)args[10].data_d;

  int base11 = args[11].dat->base_offset/sizeof(double);
  double* wdotN_B0_p = (double*)args[11].data_d;
  ...
  if ((end[0]-start[0])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      , [=](cl::sycl::nd_item<1> item
        ...
        const ACC<double> eveqN2_B0(&eveqN2_B0_p[0] + base1 + n_x*1);
        const ACC<double> p_B0(&p_B0_p[0] + base2 + n_x*1);
        const ACC<double> ptauN2_B0(&ptauN2_B0_p[0] + base3 + n_x*1);
        ...
        const ACC<double> u0_B0(&u0_B0_p[0] + base9 + n_x*1);
        const ACC<double> wdotN2_B0(&wdotN2_B0_p[0] + base10 + n_x*1);
        const ACC<double> wdotN_B0(&wdotN_B0_p[0] + base11 + n_x*1);
        ACC<double> Residual0_B0(&Residual0_B0_p[0] + base12 + n_x*1);
        ACC<double> Residual1_B0(&Residual1_B0_p[0] + base13 + n_x*1);
        ACC<double> Residual2_B0(&Residual2_B0_p[0] + base14 + n_x*1);
        ACC<double> Residual3_B0(&Residual3_B0_p[0] + base15 + n_x*1);
        ACC<double> Residual4_B0(&Residual4_B0_p[0] + base16 + n_x*1);
        //USER CODE
        if (n_x < end_0) {
   ...
   Residual2_B0(0) = -d1_prhou0u0_dx;
    ...
    Residual3_B0(0) = -d1_rhoevu0_dx + 9.86923266716013e-6*(-rhoev_B0(0) +
      rhoN2_B0(0)*eveqN2_B0(0))*Lref_sycl[0]*invuref_sycl[0]*p_B0(0)/ptauN2_B0(0) + wdotN_B0(0) + wdotN2_B0(0);

   Residual4_B0(0) = -d1_prhoEu0_dx + kappa_sycl[0]*d2_T_dx;
