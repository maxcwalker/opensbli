...
invuref = 1.0/(uref);ops_decl_const2( "Delta0block0",1, "double",&Delta0block0);ops_decl_const2( "HDF5_timing",1, "int",&HDF5_timing);ops_decl_const2( "Lref",1, "double",&Lref);ops_decl_const2( "MN",1, "double",&MN);ops_decl_const2( "MN2",1, "double",&MN2);ops_decl_const2( "Rhat",1, "double",&Rhat);ops_decl_const2( "block0np0",1, "int",&block0np0);ops_decl_const2( "cN",1, "double",&cN);ops_decl_const2( "cN2",1, "double",&cN2);ops_decl_const2( "delta_TVD",1, "double",&delta_TVD);ops_decl_const2( "dhN",1, "double",&dhN);ops_decl_const2( "dt",1, "double",&dt);ops_decl_const2( "eps_TVD",1, "double",&eps_TVD);ops_decl_const2( "gama",1, "double",&gama);ops_decl_const2( "gamma_m1",1, "double",&gamma_m1);ops_decl_const2( "inv2Delta0block0",1, "double",&inv2Delta0block0);ops_decl_const2( "inv2uref",1, "double",&inv2uref);ops_decl_const2( "invDelta0block0",1, "double",&invDelta0block0);ops_decl_const2( "invMN",1, "double",&invMN);ops_decl_const2( "invMN2",1, "double",&invMN2);ops_decl_const2( "invRhat",1, "double",&invRhat);ops_decl_const2( "invdelta_TVD",1, "double",&invdelta_TVD);ops_decl_const2( "invgamma_m1",1, "double",&invgamma_m1);ops_decl_const2( "invuref",1, "double",&invuref);ops_decl_const2( "kappa",1, "double",&kappa);ops_decl_const2( "kappa_TVD",1, "double",&kappa_TVD);ops_decl_const2( "niter",1, "int",&niter);ops_decl_const2( "simulation_time",1, "double",&simulation_time);ops_decl_const2( "start_iter",1, "int",&start_iter);ops_decl_const2( "thetavN2",1, "double",&thetavN2);ops_decl_const2( "uref",1, "double",&uref);
...
if (restart == 0){
int iteration_range_21_block0[] = {-5, block0np0 + 5}; ops_par_loop_opensbliblock00Kernel021("Grid_based_initialisation0", opensbliblock00, 1, iteration_range_21_block0,
...
int iteration_range_19_block0[] = {-2, 1}; ops_par_loop_opensbliblock00Kernel019("Dirichlet boundary dir0 side0", opensbliblock00, 1, iteration_range_19_block0,
             ops_arg_dat(rhoE_B0, 1, stencil_0_00_1, "double", OPS_WRITE),
             ops_arg_dat(rhoN2_B0, 1, stencil_0_00_1, "double", OPS_WRITE),
             ops_arg_dat(rhoN_B0, 1, stencil_0_00_1, "double", OPS_WRITE),
             ops_arg_dat(rhoev_B0, 1, stencil_0_00_1, "double", OPS_WRITE),
...
int iteration_range_20_block0[] = {block0np0 - 1, block0np0 + 2}; ops_par_loop_opensbliblock00Kernel020("Dirichlet boundary dir0 side1", opensbliblock00, 1, iteration_range_20_block0,
             ops_arg_dat(rhoE_B0, 1, stencil_0_00_1, "double", OPS_WRITE),
             ops_arg_dat(rhoN2_B0, 1, stencil_0_00_1, "double", OPS_WRITE),
             ops_arg_dat(rhoN_B0, 1, stencil_0_00_1, "double", OPS_WRITE),
             ops_arg_dat(rhoev_B0, 1, stencil_0_00_1, "double", OPS_WRITE),
...
{
int iteration_range_9_block0[] = {-2, block0np0 + 2}; ops_par_loop_opensbliblock00Kernel009("CRu0_B0", opensbliblock00, 1, iteration_range_9_block0,
...
int iteration_range_11_block0[] = {-2, block0np0 + 2}; ops_par_loop_opensbliblock00Kernel011("CRT_B0", opensbliblock00, 1, iteration_range_11_block0,
...
int iteration_range_10_block0[] = {-2, block0np0 + 2}; ops_par_loop_opensbliblock00Kernel010("CRp_B0", opensbliblock00, 1, iteration_range_10_block0,
             ops_arg_dat(T_B0, 1, stencil_0_00_1, "double", OPS_READ),
             ops_arg_dat(rhoN2_B0, 1, stencil_0_00_1, "double", OPS_READ),
             ops_arg_dat(rhoN_B0, 1, stencil_0_00_1, "double", OPS_READ),
             ops_arg_dat(p_B0, 1, stencil_0_00_1, "double", OPS_WRITE));

int iteration_range_17_block0[] = {0, block0np0}; ops_par_loop_opensbliblock00Kernel017("CReveqN2_B0", opensbliblock00, 1, iteration_range_17_block0,
             ops_arg_dat(T_B0, 1, stencil_0_00_1, "double", OPS_READ),
             ops_arg_dat(eveqN2_B0, 1, stencil_0_00_1, "double", OPS_WRITE));

int iteration_range_18_block0[] = {0, block0np0}; ops_par_loop_opensbliblock00Kernel018("CRptauN2_B0", opensbliblock00, 1, iteration_range_18_block0,
             ops_arg_dat(T_B0, 1, stencil_0_00_1, "double", OPS_READ),
             ops_arg_dat(rhoN2_B0, 1, stencil_0_00_1, "double", OPS_READ),
             ops_arg_dat(rhoN_B0, 1, stencil_0_00_1, "double", OPS_READ),
             ops_arg_dat(ptauN2_B0, 1, stencil_0_00_1, "double", OPS_WRITE));

int iteration_range_6_block0[] = {0, block0np0}; ops_par_loop_opensbliblock00Kernel006("Derivative evaluation CD u_B0 x0 ", opensbliblock00, 1, iteration_range_6_block0,
             ops_arg_dat(u_B0, 1, stencil_0_44_1, "double", OPS_READ),
             ops_arg_dat(wk0_B0, 1, stencil_0_00_1, "double", OPS_WRITE),
             ops_arg_idx());

int iteration_range_16_block0[] = {0, block0np0}; ops_par_loop_opensbliblock00Kernel016("Convective terms", opensbliblock00, 1, iteration_range_16_block0,
...
int iteration_range_22_block0[] = {0, block0np0}; ops_par_loop_opensbliblock00Kernel022("Temporal solution advancement", opensbliblock00, 1, iteration_range_22_block0,
...
int iteration_range_2_block0[] = {-1, block0np0 + 2}; ops_par_loop_opensbliblock00Kernel002("User kernel: Constituent Relations evaluation", opensbliblock00, 1, iteration_range_2_block0,
             ops_arg_dat(rhoE_B0, 1, stencil_0_00_1, "double", OPS_READ),
...
int iteration_range_3_block0[] = {-5, block0np0 + 5}; ops_par_loop_opensbliblock00Kernel003("User kernel: Zero the work arrays", opensbliblock00, 1, iteration_range_3_block0,
             ops_arg_dat(wk0_B0, 1, stencil_0_00_1, "double", OPS_WRITE),
             ops_arg_dat(wk1_B0, 1, stencil_0_00_1, "double", OPS_WRITE),
             ops_arg_dat(wk2_B0, 1, stencil_0_00_1, "double", OPS_WRITE));

int iteration_range_4_block0[] = {-1, block0np0 + 1}; ops_par_loop_opensbliblock00Kernel004("User kernel: TVD reconstruction direction 0", opensbliblock00, 1, iteration_range_4_block0,
...
int iteration_range_5_block0[] = {0, block0np0}; ops_par_loop_opensbliblock00Kernel005("User kernel: Non-linear TVD Filter application", opensbliblock00, 1, iteration_range_5_block0,
