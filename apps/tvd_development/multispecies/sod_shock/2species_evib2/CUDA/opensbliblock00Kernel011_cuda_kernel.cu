...
//
__constant__ int dims_opensbliblock00Kernel011 [6][1];
static int dims_opensbliblock00Kernel011_h [6][1] = {{0}};
...
void ops_par_loop_opensbliblock00Kernel011_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_opensbliblock00Kernel011_h[0][0] || xdim1 != dims_opensbliblock00Kernel011_h[1][0] || xdim2 != dims_opensbliblock00Kernel011_h[2][0] || xdim3 != dims_opensbliblock00Kernel011_h[3][0] || xdim4 != dims_opensbliblock00Kernel011_h[4][0] || xdim5 != dims_opensbliblock00Kernel011_h[5][0]) {
...
void ops_par_loop_opensbliblock00Kernel011(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4, ops_arg arg5) {
  ...
  create_kerneldesc_and_enque(name, args, 6, 4, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel011_execute);
}
#endif
