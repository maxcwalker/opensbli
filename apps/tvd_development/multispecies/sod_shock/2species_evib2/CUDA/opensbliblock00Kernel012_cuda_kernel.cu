...
__device__
 ...
 void opensbliblock00Kernel012_gpu(const ACC<double> &T_B0,
...
void ops_par_loop_opensbliblock00Kernel012(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2, ops_arg arg3) {
  ...
  create_kerneldesc_and_enque(name, args, 4, 7, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel012_execute);
}
#endif
