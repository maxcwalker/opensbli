...
//
__constant__ int dims_opensbliblock00Kernel022 [17][1];
static int dims_opensbliblock00Kernel022_h [17][1] = {0};

//user function
__device__

 void opensbliblock00Kernel022_gpu(const ACC<double> &Residual0_B0,
