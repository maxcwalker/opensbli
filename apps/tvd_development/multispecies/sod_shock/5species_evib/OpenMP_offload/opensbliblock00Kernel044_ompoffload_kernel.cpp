...
void ops_par_loop_opensbliblock00Kernel044_execute(ops_kernel_descriptor *desc) {
  ...
  double * __restrict__ x0_B0_p = (double *)(args[8].data_d + base8);
...
void ops_par_loop_opensbliblock00Kernel044(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg8, ops_arg arg9) {
  ...
  create_kerneldesc_and_enque(name, args, 10, 0, dim, 0, range, block, ops_par_loop_opensbliblock00Kernel044_execute);
}
#endif
