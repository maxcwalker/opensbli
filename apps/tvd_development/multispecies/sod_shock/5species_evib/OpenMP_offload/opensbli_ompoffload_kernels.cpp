...
int size, char *dat, char const *name){
  ...
  if (!strcmp(name,"MNO")) {
    #pragma omp target enter data map(to:MNO)
  }
  else
  if (!strcmp(name,"MO")) {
    #pragma omp target enter data map(to:MO)
  }
  else
  if (!strcmp(name,"MO2")) {
    #pragma omp target enter data map(to:MO2)
  }
  else
  if (!strcmp(name,"Re")) {
  ...
  if (!strcmp(name,"cNO")) {
    #pragma omp target enter data map(to:cNO)
  }
  else
  if (!strcmp(name,"cO")) {
    #pragma omp target enter data map(to:cO)
  }
  else
  if (!strcmp(name,"cO2")) {
    #pragma omp target enter data map(to:cO2)
  }
  else
  ...
  if (!strcmp(name,"dhNO")) {
    #pragma omp target enter data map(to:dhNO)
  }
  else
  if (!strcmp(name,"dhO")) {
    #pragma omp target enter data map(to:dhO)
  }
  else
  if (!strcmp(name,"dt")) {
  ...
  if (!strcmp(name,"invMNO")) {
    #pragma omp target enter data map(to:invMNO)
  }
  else
  if (!strcmp(name,"invMO")) {
    #pragma omp target enter data map(to:invMO)
  }
  else
  if (!strcmp(name,"invMO2")) {
    #pragma omp target enter data map(to:invMO2)
  }
  else
  ...
  if (!strcmp(name,"thetavNO")) {
    #pragma omp target enter data map(to:thetavNO)
  }
  else
  if (!strcmp(name,"thetavO2")) {
    #pragma omp target enter data map(to:thetavO2)
  }
  else
