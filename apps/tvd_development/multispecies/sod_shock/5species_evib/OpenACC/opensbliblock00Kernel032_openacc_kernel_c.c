...
//user function
inline 
 void opensbliblock00Kernel032(const ptr_double rhoN2_B0,
  ...
  ptr_double yO2_B0)
{
    OPS_ACC(yO2_B0, 0) = invMO2*OPS_ACC(rhoO2_B0, 0)/(invMN*OPS_ACC(rhoN_B0, 0) + invMO*OPS_ACC(rhoO_B0, 0) + invMN2*OPS_ACC(rhoN2_B0, 0) + invMNO*OPS_ACC(rhoNO_B0, 0) +
