...
//
__constant__ int dims_opensbliblock00Kernel041 [2][1];
static int dims_opensbliblock00Kernel041_h [2][1] = {{0}};
...
void ops_par_loop_opensbliblock00Kernel041(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1) {
  ...
  create_kerneldesc_and_enque(name, args, 2, 23, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel041_execute);
}
#endif
