...
//
__constant__ int dims_opensbliblock00Kernel018 [5][1];
static int dims_opensbliblock00Kernel018_h [5][1] = {{0}};
...
void ops_par_loop_opensbliblock00Kernel018(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4) {
  ...
  create_kerneldesc_and_enque(name, args, 5, 4, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel018_execute);
}
#endif
