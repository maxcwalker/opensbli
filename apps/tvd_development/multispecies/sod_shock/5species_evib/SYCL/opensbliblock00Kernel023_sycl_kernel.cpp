...
void ops_par_loop_opensbliblock00Kernel023_execute(ops_kernel_descriptor *desc) {
  ...
  double* Tv_B0_p = (double*)args[0].data_d;
  ...
  if ((end[0]-start[0])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      , [=](cl::sycl::nd_item<1> item
        ...
        const ACC<double> Tv_B0(&Tv_B0_p[0] + base0 + n_x*1);
        ACC<double> evN2_B0(&evN2_B0_p[0] + base1 + n_x*1);
        //USER CODE
        if (n_x < end_0) {
          
   evN2_B0(0) = Rhat_sycl[0]*invMN2_sycl[0]*thetavN2_sycl[0]/(-1.0 + cl::sycl::exp(thetavN2_sycl[0]/Tv_B0(0)));
