...
void ops_par_loop_opensbliblock00Kernel002_execute(ops_kernel_descriptor *desc) {
 ...
 arg5, arg6, arg7, arg8};
  ...
  double* a_B0_p = (double*)args[6].data_d;
  ...
  if ((end[0]-start[0])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      , [=](cl::sycl::nd_item<1> item
        ...
        ACC<double> a_B0(&a_B0_p[0] + base6 + n_x*1);
        ACC<double> u0_B0(&u0_B0_p[0] + base7 + n_x*1);
        ACC<double> p_B0(&p_B0_p[0] + base8 + n_x*1);
        //USER CODE
        if (n_x < end_0) {
   ...
   p_B0(0) = (-1 + gama_sycl[0])*(-0.5*(rhoN_B0(0)*rhoN_B0(0))*inv_rho + rhoE_B0(0));
