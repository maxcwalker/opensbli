...
void ops_par_loop_opensbliblock00Kernel004_execute(ops_kernel_descriptor *desc) {
 ...
 arg15, arg16, arg17, arg18};
  ...
  double* af_B0_p = (double*)args[0].data_d;

  int base1 = args[1].dat->base_offset/sizeof(double);
  double* gamaf_B0_p = (double*)args[1].data_d;
  ...
  if ((end[0]-start[0])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      , [=](cl::sycl::nd_item<1> item
        ...
        const ACC<double> af_B0(&af_B0_p[0] + base0 + n_x*1);
        const ACC<double> gamaf_B0(&gamaf_B0_p[0] + base1 + n_x*1);
