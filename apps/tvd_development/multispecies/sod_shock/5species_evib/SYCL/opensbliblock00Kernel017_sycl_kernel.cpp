 ...
 arg5, arg6, arg7, arg8};
  ...
  if ((end[0]-start[0])>0) {
    ...
    T_B0(0) = (-rhoev_B0(0) - 0.5*(u0_B0(0)*u0_B0(0))*(rhoN_B0(0) + rhoO_B0(0) + rhoN2_B0(0) + rhoNO_B0(0) +
      rhoO2_B0(0)) - 4186800.0*dhN_sycl[0]*invMN_sycl[0]*rhoN_B0(0) - 4186800.0*dhO_sycl[0]*invMO_sycl[0]*rhoO_B0(0) - 4186800.0*dhNO_sycl[0]*invMNO_sycl[0]*rhoNO_B0(0)
      + rhoE_B0(0))*invRhat_sycl[0]/(1.5*invMN_sycl[0]*rhoN_B0(0) + 1.5*invMO_sycl[0]*rhoO_B0(0) + 2.5*invMN2_sycl[0]*rhoN2_B0(0) +
