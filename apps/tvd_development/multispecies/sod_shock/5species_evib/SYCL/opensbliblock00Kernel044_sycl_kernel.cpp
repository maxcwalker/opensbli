 ...
 arg5, arg6, arg7, arg8, arg9};
  ...
  if ((end[0]-start[0])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      auto cNO_sycl = (*cNO_p).template get_access<cl::sycl::access::mode::read>(cgh);
      auto cO_sycl = (*cO_p).template get_access<cl::sycl::access::mode::read>(cgh);
      auto cO2_sycl = (*cO2_p).template get_access<cl::sycl::access::mode::read>(cgh);
      ...
      cgh.parallel_for<class opensbliblock00Kernel044_kernel>(cl::sycl::nd_range<1>(cl::sycl::range<1>(
...
: (
   ...
   Tv = p0/(Rhat_sycl[0]*(cN_sycl[0]*rhoref/MN_sycl[0] + cN2_sycl[0]*rhoref/MN2_sycl[0] + cNO_sycl[0]*rhoref/MNO_sycl[0] + cO_sycl[0]*rhoref/MO_sycl[0] + cO2_sycl[0]*rhoref/MO2_sycl[0]));

   rhoref = 1.0*p0/(Rhat_sycl[0]*T0*(cN_sycl[0]/MN_sycl[0] + cN2_sycl[0]/MN2_sycl[0] + cNO_sycl[0]/MNO_sycl[0] + cO_sycl[0]/MO_sycl[0] + cO2_sycl[0]/MO2_sycl[0]));

   rhoN2_B0(0) = cN2_sycl[0]*rhoref;

   rhoN_B0(0) = cN_sycl[0]*rhoref;

   rhoO2_B0(0) = cO2_sycl[0]*rhoref;

   rhoO_B0(0) = cO_sycl[0]*rhoref;

   rhoNO_B0(0) = cNO_sycl[0]*rhoref;

   rhou0_B0(0) = u0*(cN_sycl[0]*rhoref + cN2_sycl[0]*rhoref + cNO_sycl[0]*rhoref + cO_sycl[0]*rhoref + cO2_sycl[0]*rhoref);

   evO2 = Rhat_sycl[0]*thetavO2_sycl[0]/(MO2_sycl[0]*(-1.0 + cl::sycl::exp(thetavO2_sycl[0]/Tv)));

   evN2 = Rhat_sycl[0]*thetavN2_sycl[0]/(MN2_sycl[0]*(-1.0 + cl::sycl::exp(thetavN2_sycl[0]/Tv)));

   evNO = Rhat_sycl[0]*thetavNO_sycl[0]/(MNO_sycl[0]*(-1.0 + cl::sycl::exp(thetavNO_sycl[0]/Tv)));

   rhou0_B0(0) = u0*(cN_sycl[0]*rhoref + cN2_sycl[0]*rhoref + cNO_sycl[0]*rhoref + cO_sycl[0]*rhoref + cO2_sycl[0]*rhoref);

    rhoev_B0(0) = (cN2_sycl[0]*evN2*rhoref + cNO_sycl[0]*evNO*rhoref + cO2_sycl[0]*evO2*rhoref)*(cN_sycl[0]*rhoref + cN2_sycl[0]*rhoref + cNO_sycl[0]*rhoref + cO_sycl[0]*rhoref
      + cO2_sycl[0]*rhoref)/(cN2_sycl[0]*rhoref + cNO_sycl[0]*rhoref + cO2_sycl[0]*rhoref);

    rhoE_B0(0) = (u0*u0)*(0.5*cN_sycl[0]*rhoref + 0.5*cN2_sycl[0]*rhoref + 0.5*cNO_sycl[0]*rhoref + 0.5*cO_sycl[0]*rhoref + 0.5*cO2_sycl[0]*rhoref) +
      cN2_sycl[0]*evN2*rhoref + cNO_sycl[0]*evNO*rhoref + cO2_sycl[0]*evO2*rhoref + p0*(1.5*cN_sycl[0]*rhoref/MN_sycl[0] + 1.5*cO_sycl[0]*rhoref/MO_sycl[0] + 2.5*cN2_sycl[0]*rhoref/MN2_sycl[0]
      + 2.5*cNO_sycl[0]*rhoref/MNO_sycl[0] + 2.5*cO2_sycl[0]*rhoref/MO2_sycl[0])/(cN_sycl[0]*rhoref/MN_sycl[0] + cN2_sycl[0]*rhoref/MN2_sycl[0] + cNO_sycl[0]*rhoref/MNO_sycl[0] + cO_sycl[0]*rhoref/MO_sycl[0] +
      cO2_sycl[0]*rhoref/MO2_sycl[0]) + 4186800.0*cN_sycl[0]*dhN_sycl[0]*rhoref/MN_sycl[0] + 4186800.0*cNO_sycl[0]*dhNO_sycl[0]*rhoref/MNO_sycl[0] + 4186800.0*cO_sycl[0]*dhO_sycl[0]*rhoref/MO_sycl[0];
