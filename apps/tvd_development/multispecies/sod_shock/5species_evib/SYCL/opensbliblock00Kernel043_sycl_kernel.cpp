 ...
 arg5, arg6, arg7};
  ...
  if ((end[0]-start[0])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      cgh.parallel_for<class opensbliblock00Kernel043_kernel>(cl::sycl::nd_range<1>(cl::sycl::range<1>(
   ...
   cN2_sycl[0] = 0.0693020000000000;

   cN_sycl[0] = 0.145363000000000;

   cO2_sycl[0] = 2.50000000000000e-5;

   cO_sycl[0] = 0.745802000000000;

   cNO_sycl[0] = 0.0395080000000000;
