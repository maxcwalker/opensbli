...
void ops_par_loop_opensbliblock00Kernel024_execute(ops_kernel_descriptor *desc) {
 ...
 arg15, arg16, arg17, arg18};
  ...
  double* eveqN2_B0_p = (double*)args[0].data_d;
  ...
  double* ptauN2_B0_p = (double*)args[2].data_d;

  int base3 = args[3].dat->base_offset/sizeof(double);
  double* qv0_B0_p = (double*)args[3].data_d;
  ...
  double* rhoN_B0_p = (double*)args[6].data_d;

  int base7 = args[7].dat->base_offset/sizeof(double);
  double* rhoev_B0_p = (double*)args[7].data_d;
  ...
  double* tau00_B0_p = (double*)args[9].data_d;
  ...
  double* wdotN2_B0_p = (double*)args[11].data_d;

  int base12 = args[12].dat->base_offset/sizeof(double);
  double* wdotN_B0_p = (double*)args[12].data_d;
  ...
  if ((end[0]-start[0])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      cgh.parallel_for<class opensbliblock00Kernel024_kernel>(cl::sycl::nd_range<1>(cl::sycl::range<1>(
      ...
      , [=](cl::sycl::nd_item<1> item
        ...
        const ACC<double> eveqN2_B0(&eveqN2_B0_p[0] + base0 + n_x*1);
        const ACC<double> p_B0(&p_B0_p[0] + base1 + n_x*1);
        const ACC<double> ptauN2_B0(&ptauN2_B0_p[0] + base2 + n_x*1);
        const ACC<double> qv0_B0(&qv0_B0_p[0] + base3 + n_x*1);
        const ACC<double> rhoE_B0(&rhoE_B0_p[0] + base4 + n_x*1);
        const ACC<double> rhoN2_B0(&rhoN2_B0_p[0] + base5 + n_x*1);
        const ACC<double> rhoN_B0(&rhoN_B0_p[0] + base6 + n_x*1);
        const ACC<double> rhoev_B0(&rhoev_B0_p[0] + base7 + n_x*1);
        const ACC<double> rhou0_B0(&rhou0_B0_p[0] + base8 + n_x*1);
        const ACC<double> tau00_B0(&tau00_B0_p[0] + base9 + n_x*1);
        const ACC<double> u0_B0(&u0_B0_p[0] + base10 + n_x*1);
        const ACC<double> wdotN2_B0(&wdotN2_B0_p[0] + base11 + n_x*1);
        const ACC<double> wdotN_B0(&wdotN_B0_p[0] + base12 + n_x*1);
   ...
   if (idx[0] == 0){
       ...
       d1_qv0_dx = (3.0*qv0_B0(1) + 0.333333333333333*qv0_B0(3) - 1.5*qv0_B0(2) -
            1.83333333333333*qv0_B0(0))*invDelta0block0_sycl[0];
       ...
       d1_tau00_dx = (3.0*tau00_B0(1) + 0.333333333333333*tau00_B0(3) - 1.5*tau00_B0(2) -
            1.83333333333333*tau00_B0(0))*invDelta0block0_sycl[0];

       d1_u0_dx = (3.0*u0_B0(1) + 0.333333333333333*u0_B0(3) - 1.5*u0_B0(2) -
            1.83333333333333*u0_B0(0))*invDelta0block0_sycl[0];
       ...
       d1_qv0_dx = (0.0394168524399447*qv0_B0(2) + 0.00571369039775442*qv0_B0(4) + 0.719443173328855*qv0_B0(1) -
            0.322484932882161*qv0_B0(0) - 0.0658051057710389*qv0_B0(3) - 0.376283677513354*qv0_B0(-1))*invDelta0block0_sycl[0];
       ...
       d1_tau00_dx = (0.0394168524399447*tau00_B0(2) + 0.00571369039775442*tau00_B0(4) + 0.719443173328855*tau00_B0(1) -
            ...
            0.376283677513354*tau00_B0(-1))*invDelta0block0_sycl[0];

       d1_u0_dx = (0.0394168524399447*u0_B0(2) + 0.00571369039775442*u0_B0(4) + 0.719443173328855*u0_B0(1) -
            0.322484932882161*u0_B0(0) - 0.0658051057710389*u0_B0(3) - 0.376283677513354*u0_B0(-1))*invDelta0block0_sycl[0];
       ...
       d1_qv0_dx = (0.197184333887745*qv0_B0(0) + 0.521455851089587*qv0_B0(1) + 0.113446470384241*qv0_B0(-2) -
            ...
            0.791245592765872*qv0_B0(-1))*invDelta0block0_sycl[0];
       ...
       d1_tau00_dx = (0.197184333887745*tau00_B0(0) + 0.521455851089587*tau00_B0(1) + 0.113446470384241*tau00_B0(-2) -
            ...
            0.791245592765872*tau00_B0(-1))*invDelta0block0_sycl[0];

       d1_u0_dx = (0.197184333887745*u0_B0(0) + 0.521455851089587*u0_B0(1) + 0.113446470384241*u0_B0(-2) -
            0.00412637789557492*u0_B0(3) - 0.0367146847001261*u0_B0(2) - 0.791245592765872*u0_B0(-1))*invDelta0block0_sycl[0];
       ...
       d1_qv0_dx = (0.0451033223343881*qv0_B0(0) + 0.652141084861241*qv0_B0(1) + 0.121937153224065*qv0_B0(-2) -
            ...
            0.082033432844602*qv0_B0(2))*invDelta0block0_sycl[0];
       ...
       d1_tau00_dx = (0.0451033223343881*tau00_B0(0) + 0.652141084861241*tau00_B0(1) + 0.121937153224065*tau00_B0(-2) -
            ...
            0.082033432844602*tau00_B0(2))*invDelta0block0_sycl[0];

       d1_u0_dx = (0.0451033223343881*u0_B0(0) + 0.652141084861241*u0_B0(1) + 0.121937153224065*u0_B0(-2) -
            0.00932597985049999*u0_B0(-3) - 0.727822147724592*u0_B0(-1) - 0.082033432844602*u0_B0(2))*invDelta0block0_sycl[0];
       ...
       d1_qv0_dx = (1.5*qv0_B0(-2) + 1.83333333333333*qv0_B0(0) - 3.0*qv0_B0(-1) -
            0.333333333333333*qv0_B0(-3))*invDelta0block0_sycl[0];
       ...
       d1_tau00_dx = (1.5*tau00_B0(-2) + 1.83333333333333*tau00_B0(0) - 3.0*tau00_B0(-1) -
            0.333333333333333*tau00_B0(-3))*invDelta0block0_sycl[0];

       d1_u0_dx = (1.5*u0_B0(-2) + 1.83333333333333*u0_B0(0) - 3.0*u0_B0(-1) -
            0.333333333333333*u0_B0(-3))*invDelta0block0_sycl[0];
       ...
       d1_qv0_dx = (0.322484932882161*qv0_B0(0) + 0.0658051057710389*qv0_B0(-3) + 0.376283677513354*qv0_B0(1) -
            ...
            0.719443173328855*qv0_B0(-1))*invDelta0block0_sycl[0];
       ...
       d1_tau00_dx = (0.322484932882161*tau00_B0(0) + 0.0658051057710389*tau00_B0(-3) + 0.376283677513354*tau00_B0(1) -
            ...
            0.719443173328855*tau00_B0(-1))*invDelta0block0_sycl[0];
       ...
       d1_u0_dx = (0.322484932882161*u0_B0(0) + 0.0658051057710389*u0_B0(-3) + 0.376283677513354*u0_B0(1) -
            ...
            0.719443173328855*u0_B0(-1))*invDelta0block0_sycl[0];
       ...
       d1_qv0_dx = (0.00412637789557492*qv0_B0(-3) + 0.0367146847001261*qv0_B0(-2) + 0.791245592765872*qv0_B0(1) -
            0.197184333887745*qv0_B0(0) - 0.521455851089587*qv0_B0(-1) - 0.113446470384241*qv0_B0(2))*invDelta0block0_sycl[0];
       ...
       d1_tau00_dx = (0.00412637789557492*tau00_B0(-3) + 0.0367146847001261*tau00_B0(-2) + 0.791245592765872*tau00_B0(1)
            ...
            0.113446470384241*tau00_B0(2))*invDelta0block0_sycl[0];

       d1_u0_dx = (0.00412637789557492*u0_B0(-3) + 0.0367146847001261*u0_B0(-2) + 0.791245592765872*u0_B0(1) -
            0.197184333887745*u0_B0(0) - 0.521455851089587*u0_B0(-1) - 0.113446470384241*u0_B0(2))*invDelta0block0_sycl[0];
       ...
       d1_qv0_dx = (0.00932597985049999*qv0_B0(3) + 0.727822147724592*qv0_B0(1) + 0.082033432844602*qv0_B0(-2) -
            0.0451033223343881*qv0_B0(0) - 0.652141084861241*qv0_B0(-1) - 0.121937153224065*qv0_B0(2))*invDelta0block0_sycl[0];
       ...
       d1_tau00_dx = (0.00932597985049999*tau00_B0(3) + 0.727822147724592*tau00_B0(1) + 0.082033432844602*tau00_B0(-2) -
            ...
            0.121937153224065*tau00_B0(2))*invDelta0block0_sycl[0];

       d1_u0_dx = (0.00932597985049999*u0_B0(3) + 0.727822147724592*u0_B0(1) + 0.082033432844602*u0_B0(-2) -
            0.0451033223343881*u0_B0(0) - 0.652141084861241*u0_B0(-1) - 0.121937153224065*u0_B0(2))*invDelta0block0_sycl[0];
       ...
       d1_qv0_dx = (-(2.0/3.0)*qv0_B0(-1) - (1.0/12.0)*qv0_B0(2) + ((1.0/12.0))*qv0_B0(-2) +
            ((2.0/3.0))*qv0_B0(1))*invDelta0block0_sycl[0];
       ...
       d1_tau00_dx = (-(2.0/3.0)*tau00_B0(-1) - (1.0/12.0)*tau00_B0(2) + ((1.0/12.0))*tau00_B0(-2) +
            ((2.0/3.0))*tau00_B0(1))*invDelta0block0_sycl[0];

       d1_u0_dx = (-(2.0/3.0)*u0_B0(-1) - (1.0/12.0)*u0_B0(2) + ((1.0/12.0))*u0_B0(-2) +
            ((2.0/3.0))*u0_B0(1))*invDelta0block0_sycl[0];
