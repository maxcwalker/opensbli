...
void ops_par_loop_opensbliblock00Kernel017_execute(ops_kernel_descriptor *desc) {
  ...
  double* T_B0_p = (double*)args[4].data_d;
  ...
  if ((end[0]-start[0])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      , [=](cl::sycl::nd_item<1> item
        ...
        const ACC<double> u0_B0(&u0_B0_p[0] + base3 + n_x*1);
        ACC<double> T_B0(&T_B0_p[0] + base4 + n_x*1);
        //USER CODE
        if (n_x < end_0) {
          
    T_B0(0) = (-0.5*(u0_B0(0)*u0_B0(0))*(rhoN_B0(0) + rhoN2_B0(0)) - 1.0e-5*dhN_sycl[0]*invMN_sycl[0]*rhoN_B0(0) +
