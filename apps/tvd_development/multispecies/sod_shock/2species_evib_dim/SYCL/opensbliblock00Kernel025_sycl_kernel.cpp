...
void ops_par_loop_opensbliblock00Kernel025_execute(ops_kernel_descriptor *desc) {
 ...
 arg10};
  ...
  double* YN2_B0_p = (double*)args[1].data_d;

  int base2 = args[2].dat->base_offset/sizeof(double);
  double* YN_B0_p = (double*)args[2].data_d;

  int base3 = args[3].dat->base_offset/sizeof(double);
  double* evN2_B0_p = (double*)args[3].data_d;

  int base4 = args[4].dat->base_offset/sizeof(double);
  double* mu_B0_p = (double*)args[4].data_d;
  ...
  double* yN_B0_p = (double*)args[6].data_d;
  ...
  double* Residual4_B0_p = (double*)args[9].data_d;
  ...
  if ((end[0]-start[0])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      cgh.parallel_for<class opensbliblock00Kernel025_kernel>(cl::sycl::nd_range<1>(cl::sycl::range<1>(
      ...
      , [=](cl::sycl::nd_item<1> item
        ...
        const ACC<double> YN2_B0(&YN2_B0_p[0] + base1 + n_x*1);
        const ACC<double> YN_B0(&YN_B0_p[0] + base2 + n_x*1);
        const ACC<double> evN2_B0(&evN2_B0_p[0] + base3 + n_x*1);
        const ACC<double> mu_B0(&mu_B0_p[0] + base4 + n_x*1);
        const ACC<double> yN2_B0(&yN2_B0_p[0] + base5 + n_x*1);
        const ACC<double> yN_B0(&yN_B0_p[0] + base6 + n_x*1);
        ACC<double> Residual0_B0(&Residual0_B0_p[0] + base7 + n_x*1);
        ACC<double> Residual1_B0(&Residual1_B0_p[0] + base8 + n_x*1);
        ACC<double> Residual4_B0(&Residual4_B0_p[0] + base9 + n_x*1);
        //USER CODE
        if (n_x < end_0) {
   ...
   Residual0_B0(0) = invRe_sycl[0]*invSc_sycl[0]*mu_B0(0)*d2_yN_dx + invRe_sycl[0]*invSc_sycl[0]*d1_mu_dx*d1_yN_dx + Residual0_B0(0);

   Residual1_B0(0) = invRe_sycl[0]*invSc_sycl[0]*mu_B0(0)*d2_yN2_dx + invRe_sycl[0]*invSc_sycl[0]*d1_mu_dx*d1_yN2_dx + Residual1_B0(0);

    Residual4_B0(0) = invRe_sycl[0]*kappa_sycl[0]*d2_T_dx + invRe_sycl[0]*invSc_sycl[0]*mu_B0(0)*evN2_B0(0)*d2_yN2_dx +
      invRe_sycl[0]*invSc_sycl[0]*mu_B0(0)*d1_evN2_dx*d1_yN2_dx + invRe_sycl[0]*invSc_sycl[0]*evN2_B0(0)*d1_mu_dx*d1_yN2_dx + (2.5*invMN_sycl[0]*d1_yN_dx +
      3.5*invMN2_sycl[0]*d1_YN2_dx)*Rhat_sycl[0]*invRe_sycl[0]*invSc_sycl[0]*T_B0(0)*d1_mu_dx + (2.5*invMN_sycl[0]*d1_yN_dx +
      3.5*invMN2_sycl[0]*d1_YN2_dx)*Rhat_sycl[0]*invRe_sycl[0]*invSc_sycl[0]*mu_B0(0)*d1_T_dx + (2.5*invMN_sycl[0]*d2_yN_dx +
      3.5*invMN2_sycl[0]*d2_YN2_dx)*Rhat_sycl[0]*invRe_sycl[0]*invSc_sycl[0]*T_B0(0)*mu_B0(0) + 4186800.0*dhN_sycl[0]*invMN_sycl[0]*invRe_sycl[0]*invSc_sycl[0]*mu_B0(0)*d2_YN_dx +
      4186800.0*dhN_sycl[0]*invMN_sycl[0]*invRe_sycl[0]*invSc_sycl[0]*d1_YN_dx*d1_mu_dx + Residual4_B0(0);
