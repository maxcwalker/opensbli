...
void ops_par_loop_opensbliblock00Kernel021_execute(ops_kernel_descriptor *desc) {
 ...
 arg5, arg6, arg7, arg8};
  ...
  double* Sc_B0_p = (double*)args[0].data_d;

  int base1 = args[1].dat->base_offset/sizeof(double);
  double* T_B0_p = (double*)args[1].data_d;

  int base2 = args[2].dat->base_offset/sizeof(double);
  double* mu_B0_p = (double*)args[2].data_d;

  int base3 = args[3].dat->base_offset/sizeof(double);
  double* yN2_B0_p = (double*)args[3].data_d;
  ...
  double* Residual0_B0_p = (double*)args[5].data_d;

  int base6 = args[6].dat->base_offset/sizeof(double);
  double* Residual1_B0_p = (double*)args[6].data_d;

  int base7 = args[7].dat->base_offset/sizeof(double);
  double* Residual4_B0_p = (double*)args[7].data_d;
  ...
  if ((end[0]-start[0])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      , [=](cl::sycl::nd_item<1> item
        ...
        const ACC<double> Sc_B0(&Sc_B0_p[0] + base0 + n_x*1);
        const ACC<double> T_B0(&T_B0_p[0] + base1 + n_x*1);
        const ACC<double> mu_B0(&mu_B0_p[0] + base2 + n_x*1);
        const ACC<double> yN2_B0(&yN2_B0_p[0] + base3 + n_x*1);
        const ACC<double> yN_B0(&yN_B0_p[0] + base4 + n_x*1);
        ACC<double> Residual0_B0(&Residual0_B0_p[0] + base5 + n_x*1);
        ACC<double> Residual1_B0(&Residual1_B0_p[0] + base6 + n_x*1);
        ACC<double> Residual4_B0(&Residual4_B0_p[0] + base7 + n_x*1);
        //USER CODE
        if (n_x < end_0) {
   ...
   if (idx[0] == 0){
       ...
       d1_Sc_dx = (3.0*Sc_B0(1) + 0.333333333333333*Sc_B0(3) - 1.5*Sc_B0(2) -
            1.83333333333333*Sc_B0(0))*invDelta0block0_sycl[0];
       ...
       d1_Sc_dx = (0.0394168524399447*Sc_B0(2) + 0.00571369039775442*Sc_B0(4) + 0.719443173328855*Sc_B0(1) -
            0.322484932882161*Sc_B0(0) - 0.0658051057710389*Sc_B0(3) - 0.376283677513354*Sc_B0(-1))*invDelta0block0_sycl[0];
       ...
       d1_Sc_dx = (0.197184333887745*Sc_B0(0) + 0.521455851089587*Sc_B0(1) + 0.113446470384241*Sc_B0(-2) -
            0.00412637789557492*Sc_B0(3) - 0.0367146847001261*Sc_B0(2) - 0.791245592765872*Sc_B0(-1))*invDelta0block0_sycl[0];
       ...
       d1_Sc_dx = (0.0451033223343881*Sc_B0(0) + 0.652141084861241*Sc_B0(1) + 0.121937153224065*Sc_B0(-2) -
            0.00932597985049999*Sc_B0(-3) - 0.727822147724592*Sc_B0(-1) - 0.082033432844602*Sc_B0(2))*invDelta0block0_sycl[0];
       ...
       d1_Sc_dx = (1.5*Sc_B0(-2) + 1.83333333333333*Sc_B0(0) - 3.0*Sc_B0(-1) -
            0.333333333333333*Sc_B0(-3))*invDelta0block0_sycl[0];
       ...
       d1_Sc_dx = (0.322484932882161*Sc_B0(0) + 0.0658051057710389*Sc_B0(-3) + 0.376283677513354*Sc_B0(1) -
            ...
            0.719443173328855*Sc_B0(-1))*invDelta0block0_sycl[0];
       ...
       d1_Sc_dx = (0.00412637789557492*Sc_B0(-3) + 0.0367146847001261*Sc_B0(-2) + 0.791245592765872*Sc_B0(1) -
            0.197184333887745*Sc_B0(0) - 0.521455851089587*Sc_B0(-1) - 0.113446470384241*Sc_B0(2))*invDelta0block0_sycl[0];
       ...
       d1_Sc_dx = (0.00932597985049999*Sc_B0(3) + 0.727822147724592*Sc_B0(1) + 0.082033432844602*Sc_B0(-2) -
            0.0451033223343881*Sc_B0(0) - 0.652141084861241*Sc_B0(-1) - 0.121937153224065*Sc_B0(2))*invDelta0block0_sycl[0];
       ...
       d1_Sc_dx = (-(2.0/3.0)*Sc_B0(-1) - (1.0/12.0)*Sc_B0(2) + ((1.0/12.0))*Sc_B0(-2) +
            ((2.0/3.0))*Sc_B0(1))*invDelta0block0_sycl[0];
   ...
   if (idx[0] == 0){
    ...
    Residual0_B0(0) = invRe_sycl[0]*mu_B0(0)*d2_yN_dx/Sc_B0(0) + invRe_sycl[0]*d1_mu_dx*d1_yN_dx/Sc_B0(0) -
      invRe_sycl[0]*mu_B0(0)*d1_Sc_dx*d1_yN_dx/(Sc_B0(0)*Sc_B0(0)) + Residual0_B0(0);

    Residual1_B0(0) = invRe_sycl[0]*mu_B0(0)*d2_yN2_dx/Sc_B0(0) + invRe_sycl[0]*d1_mu_dx*d1_yN2_dx/Sc_B0(0) -
      invRe_sycl[0]*mu_B0(0)*d1_Sc_dx*d1_yN2_dx/(Sc_B0(0)*Sc_B0(0)) + Residual1_B0(0);

   Residual4_B0(0) = invRe_sycl[0]*kappa_sycl[0]*d2_T_dx + Residual4_B0(0);
