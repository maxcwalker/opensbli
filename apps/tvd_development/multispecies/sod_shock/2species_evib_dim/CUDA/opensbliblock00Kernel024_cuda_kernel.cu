...
//
__constant__ int dims_opensbliblock00Kernel024 [19][1];
static int dims_opensbliblock00Kernel024_h [19][1] = {{0}};

//user function
__device__

 void opensbliblock00Kernel024_gpu(const ACC<double> &eveqN2_B0,
  const ACC<double> &p_B0,
  const ACC<double> &ptauN2_B0,
  const ACC<double> &qv0_B0,
...
__global__ void ops_opensbliblock00Kernel024(
...
void ops_par_loop_opensbliblock00Kernel024_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_opensbliblock00Kernel024_h[0][0] || xdim1 != dims_opensbliblock00Kernel024_h[1][0] || xdim2 != dims_opensbliblock00Kernel024_h[2][0] || xdim3 != dims_opensbliblock00Kernel024_h[3][0] || xdim4 != dims_opensbliblock00Kernel024_h[4][0] || xdim5 != dims_opensbliblock00Kernel024_h[5][0] || xdim6 != dims_opensbliblock00Kernel024_h[6][0] || xdim7 != dims_opensbliblock00Kernel024_h[7][0] || xdim8 != dims_opensbliblock00Kernel024_h[8][0] || xdim9 != dims_opensbliblock00Kernel024_h[9][0] || xdim10 != dims_opensbliblock00Kernel024_h[10][0] || xdim11 != dims_opensbliblock00Kernel024_h[11][0] || xdim12 != dims_opensbliblock00Kernel024_h[12][0] || xdim13 != dims_opensbliblock00Kernel024_h[13][0] || xdim14 != dims_opensbliblock00Kernel024_h[14][0] || xdim15 != dims_opensbliblock00Kernel024_h[15][0] || xdim16 != dims_opensbliblock00Kernel024_h[16][0] || xdim17 != dims_opensbliblock00Kernel024_h[17][0]) {
    dims_opensbliblock00Kernel024_h[0][0] = xdim0;
    dims_opensbliblock00Kernel024_h[1][0] = xdim1;
    dims_opensbliblock00Kernel024_h[2][0] = xdim2;
    dims_opensbliblock00Kernel024_h[3][0] = xdim3;
    dims_opensbliblock00Kernel024_h[4][0] = xdim4;
    dims_opensbliblock00Kernel024_h[5][0] = xdim5;
    dims_opensbliblock00Kernel024_h[6][0] = xdim6;
    dims_opensbliblock00Kernel024_h[7][0] = xdim7;
    dims_opensbliblock00Kernel024_h[8][0] = xdim8;
    dims_opensbliblock00Kernel024_h[9][0] = xdim9;
    dims_opensbliblock00Kernel024_h[10][0] = xdim10;
    dims_opensbliblock00Kernel024_h[11][0] = xdim11;
    dims_opensbliblock00Kernel024_h[12][0] = xdim12;
    dims_opensbliblock00Kernel024_h[13][0] = xdim13;
    dims_opensbliblock00Kernel024_h[14][0] = xdim14;
    dims_opensbliblock00Kernel024_h[15][0] = xdim15;
    dims_opensbliblock00Kernel024_h[16][0] = xdim16;
    dims_opensbliblock00Kernel024_h[17][0] = xdim17;
    cutilSafeCall(block->instance->ostream(), cudaMemcpyToSymbol( dims_opensbliblock00Kernel024, dims_opensbliblock00Kernel024_h, sizeof(dims_opensbliblock00Kernel024)));
  }
  ...
  if (x_size > 0)
    ops_opensbliblock00Kernel024<<<grid, tblock >>> ( 
...
void ops_par_loop_opensbliblock00Kernel024(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg16, ops_arg arg17, ops_arg arg18) {
  ...
  create_kerneldesc_and_enque(name, args, 19, 9, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel024_execute);
}
#endif
