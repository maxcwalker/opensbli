...
__device__
 ...
 void opensbliblock00Kernel028_gpu(ACC<double> &rhoE_B0,
  ACC<double> &rhoN2_B0,
  ACC<double> &rhoN_B0,
  ACC<double> &rhoev_B0,
  ACC<double> &rhou0_B0)
...
void ops_par_loop_opensbliblock00Kernel028_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_opensbliblock00Kernel028_h[0][0] || xdim1 != dims_opensbliblock00Kernel028_h[1][0] || xdim2 != dims_opensbliblock00Kernel028_h[2][0] || xdim3 != dims_opensbliblock00Kernel028_h[3][0] || xdim4 != dims_opensbliblock00Kernel028_h[4][0]) {
