...
__device__
 ...
 void opensbliblock00Kernel020_gpu(const ACC<double> &eveqN2_B0,
...
void ops_par_loop_opensbliblock00Kernel020(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg16) {
  ...
  create_kerneldesc_and_enque(name, args, 17, 9, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel020_execute);
}
#endif
