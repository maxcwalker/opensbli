...
void ops_par_loop_opensbliblock00Kernel025_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_opensbliblock00Kernel025_h[0][0] || xdim1 != dims_opensbliblock00Kernel025_h[1][0] || xdim2 != dims_opensbliblock00Kernel025_h[2][0] || xdim3 != dims_opensbliblock00Kernel025_h[3][0] || xdim4 != dims_opensbliblock00Kernel025_h[4][0] || xdim5 != dims_opensbliblock00Kernel025_h[5][0] || xdim6 != dims_opensbliblock00Kernel025_h[6][0] || xdim7 != dims_opensbliblock00Kernel025_h[7][0] || xdim8 != dims_opensbliblock00Kernel025_h[8][0] || xdim9 != dims_opensbliblock00Kernel025_h[9][0]) {
...
void ops_par_loop_opensbliblock00Kernel025(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg8, ops_arg arg9, ops_arg arg10) {
  ...
  create_kerneldesc_and_enque(name, args, 11, 10, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel025_execute);
}
#endif
