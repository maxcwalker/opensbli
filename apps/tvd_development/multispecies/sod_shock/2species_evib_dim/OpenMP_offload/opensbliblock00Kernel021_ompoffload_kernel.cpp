...
void ops_par_loop_opensbliblock00Kernel021_execute(ops_kernel_descriptor *desc) {
  ...
  double * __restrict__ Sc_B0_p = (double *)(args[0].data_d + base0);

  int base1 = args[1].dat->base_offset;
  double * __restrict__ T_B0_p = (double *)(args[1].data_d + base1);

  int base2 = args[2].dat->base_offset;
  double * __restrict__ mu_B0_p = (double *)(args[2].data_d + base2);

  int base3 = args[3].dat->base_offset;
  double * __restrict__ yN2_B0_p = (double *)(args[3].data_d + base3);
  ...
  double * __restrict__ Residual4_B0_p = (double *)(args[7].data_d + base7);
  ...
  for ( int n_x=start0; n_x<end0; n_x++ ){
    ...
    const ACC<double> Sc_B0(Sc_B0_p + n_x*1);
...
void ops_par_loop_opensbliblock00Kernel021(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg8) {
  ...
  create_kerneldesc_and_enque(name, args, 9, 10, dim, 0, range, block, ops_par_loop_opensbliblock00Kernel021_execute);
}
#endif
