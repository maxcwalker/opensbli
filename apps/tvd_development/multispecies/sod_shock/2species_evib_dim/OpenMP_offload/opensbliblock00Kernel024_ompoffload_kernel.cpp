...
void ops_par_loop_opensbliblock00Kernel024_execute(ops_kernel_descriptor *desc) {
  ...
  double * __restrict__ eveqN2_B0_p = (double *)(args[0].data_d + base0);

  int base1 = args[1].dat->base_offset;
  double * __restrict__ p_B0_p = (double *)(args[1].data_d + base1);

  int base2 = args[2].dat->base_offset;
  double * __restrict__ ptauN2_B0_p = (double *)(args[2].data_d + base2);

  int base3 = args[3].dat->base_offset;
  double * __restrict__ qv0_B0_p = (double *)(args[3].data_d + base3);
  ...
  double * __restrict__ rhoN_B0_p = (double *)(args[6].data_d + base6);
  ...
  double * __restrict__ tau00_B0_p = (double *)(args[9].data_d + base9);

  int base10 = args[10].dat->base_offset;
  double * __restrict__ u0_B0_p = (double *)(args[10].data_d + base10);

  int base11 = args[11].dat->base_offset;
  double * __restrict__ wdotN2_B0_p = (double *)(args[11].data_d + base11);

  int base12 = args[12].dat->base_offset;
  double * __restrict__ wdotN_B0_p = (double *)(args[12].data_d + base12);
  ...
  for ( int n_x=start0; n_x<end0; n_x++ ){
    ...
    const ACC<double> qv0_B0(qv0_B0_p + n_x*1);
...
void ops_par_loop_opensbliblock00Kernel024(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg16, ops_arg arg17, ops_arg arg18) {
  ...
  create_kerneldesc_and_enque(name, args, 19, 9, dim, 0, range, block, ops_par_loop_opensbliblock00Kernel024_execute);
}
#endif
