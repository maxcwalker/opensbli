...
int iteration_range_19_block0[] = {-3, 1};
...
int iteration_range_20_block0[] = {block0np0 - 1, block0np0 + 4};
...
ops_par_loop(opensbliblock00Kernel017, "CRptauN2_B0", opensbliblock00, 1, iteration_range_17_block0,
ops_arg_dat(T_B0, 1, stencil_0_00_1, "double", OPS_READ),
ops_arg_dat(rhoN2_B0, 1, stencil_0_00_1, "double", OPS_READ),
ops_arg_dat(rhoN_B0, 1, stencil_0_00_1, "double", OPS_READ),
...
ops_par_loop(opensbliblock00Kernel018, "CReveqN2_B0", opensbliblock00, 1, iteration_range_18_block0,
ops_arg_dat(T_B0, 1, stencil_0_00_1, "double", OPS_READ),
...
int iteration_range_2_block0[] = {-3, block0np0 + 4};
...
ops_par_loop(opensbliblock00Kernel004, "User kernel: WENO reconstruction direction 0", opensbliblock00, 1, iteration_range_4_block0,
ops_arg_dat(a_B0, 1, stencil_0_01_1, "double", OPS_READ),
ops_arg_dat(ev_B0, 1, stencil_0_01_1, "double", OPS_READ),
ops_arg_dat(p_B0, 1, stencil_0_23_1, "double", OPS_READ),
ops_arg_dat(rhoE_B0, 1, stencil_0_23_1, "double", OPS_READ),
ops_arg_dat(rhoN2_B0, 1, stencil_0_23_1, "double", OPS_READ),
ops_arg_dat(rhoN_B0, 1, stencil_0_23_1, "double", OPS_READ),
ops_arg_dat(rhoev_B0, 1, stencil_0_23_1, "double", OPS_READ),
ops_arg_dat(rhou0_B0, 1, stencil_0_23_1, "double", OPS_READ),
ops_arg_dat(u0_B0, 1, stencil_0_23_1, "double", OPS_READ),
ops_arg_dat(u_B0, 1, stencil_0_01_1, "double", OPS_READ),
ops_arg_dat(wk0_B0, 1, stencil_0_00_1, "double", OPS_WRITE),
ops_arg_dat(wk1_B0, 1, stencil_0_00_1, "double", OPS_WRITE),
ops_arg_dat(wk2_B0, 1, stencil_0_00_1, "double", OPS_WRITE),
ops_arg_dat(wk3_B0, 1, stencil_0_00_1, "double", OPS_WRITE),
...
ops_par_loop(opensbliblock00Kernel005, "User kernel: Non-linear filter application", opensbliblock00, 1, iteration_range_5_block0,
