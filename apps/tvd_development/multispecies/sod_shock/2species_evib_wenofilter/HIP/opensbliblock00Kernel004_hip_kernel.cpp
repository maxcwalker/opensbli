...
//
__constant__ int dims_opensbliblock00Kernel004 [15][1];
static int dims_opensbliblock00Kernel004_h [15][1] = {{0}};
...
void ops_par_loop_opensbliblock00Kernel004(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg12, ops_arg arg13, ops_arg arg14) {
  ...
  create_kerneldesc_and_enque(name, args, 15, 13, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel004_execute);
}
#endif
