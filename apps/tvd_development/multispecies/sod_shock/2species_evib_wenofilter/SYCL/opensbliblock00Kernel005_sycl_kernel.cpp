...
void ops_par_loop_opensbliblock00Kernel005_execute(ops_kernel_descriptor *desc) {
 ...
 arg10};
  ...
  if ((end[0]-start[0])>0) {
   ...
   rhoN_B0(0) = -(-wk0_B0(-1) + wk0_B0(0))*dt_sycl[0]*inv_rfact0_block0_sycl[0] + rhoN_B0(0);

   rhoN2_B0(0) = -(-wk1_B0(-1) + wk1_B0(0))*dt_sycl[0]*inv_rfact0_block0_sycl[0] + rhoN2_B0(0);

   rhou0_B0(0) = -(-wk2_B0(-1) + wk2_B0(0))*dt_sycl[0]*inv_rfact0_block0_sycl[0] + rhou0_B0(0);

   rhoev_B0(0) = -(-wk3_B0(-1) + wk3_B0(0))*dt_sycl[0]*inv_rfact0_block0_sycl[0] + rhoev_B0(0);

   rhoE_B0(0) = -(-wk4_B0(-1) + wk4_B0(0))*dt_sycl[0]*inv_rfact0_block0_sycl[0] + rhoE_B0(0);
