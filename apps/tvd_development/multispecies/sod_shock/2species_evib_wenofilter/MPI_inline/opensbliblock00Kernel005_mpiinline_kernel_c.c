...
void opensbliblock00Kernel005_c_wrapper(
  ...
  for ( int n_x=0; n_x<x_size; n_x++ ){
   ...
   OPS_ACC(rhoN_B0, 0) = -(-OPS_ACC(wk0_B0, -1) + OPS_ACC(wk0_B0, 0))*dt*inv_rfact0_block0 + OPS_ACC(rhoN_B0, 0);

   OPS_ACC(rhoN2_B0, 0) = -(-OPS_ACC(wk1_B0, -1) + OPS_ACC(wk1_B0, 0))*dt*inv_rfact0_block0 + OPS_ACC(rhoN2_B0, 0);

   OPS_ACC(rhou0_B0, 0) = -(-OPS_ACC(wk2_B0, -1) + OPS_ACC(wk2_B0, 0))*dt*inv_rfact0_block0 + OPS_ACC(rhou0_B0, 0);

   OPS_ACC(rhoev_B0, 0) = -(-OPS_ACC(wk3_B0, -1) + OPS_ACC(wk3_B0, 0))*dt*inv_rfact0_block0 + OPS_ACC(rhoev_B0, 0);

   OPS_ACC(rhoE_B0, 0) = -(-OPS_ACC(wk4_B0, -1) + OPS_ACC(wk4_B0, 0))*dt*inv_rfact0_block0 + OPS_ACC(rhoE_B0, 0);
