...
void ops_par_loop_opensbliblock00Kernel016_execute(ops_kernel_descriptor *desc) {
  ...
  double * __restrict__ rhoN2_B0_p = (double *)(args[4].data + base4);
  ...
  double * __restrict__ wdotN2_B0_p = (double *)(args[9].data + base9);

  int base10 = args[10].dat->base_offset;
  double * __restrict__ wdotN_B0_p = (double *)(args[10].data + base10);
  ...
  double * __restrict__ Residual4_B0_p = (double *)(args[15].data + base15);
