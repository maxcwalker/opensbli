...
void ops_par_loop_opensbliblock00Kernel016_execute(ops_kernel_descriptor *desc) {
  ...
  double * __restrict__ wdotN2_B0_p = (double *)(args[9].data_d + base9);

  int base10 = args[10].dat->base_offset;
  double * __restrict__ wdotN_B0_p = (double *)(args[10].data_d + base10);
...
void ops_par_loop_opensbliblock00Kernel016(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg16) {
  ...
  create_kerneldesc_and_enque(name, args, 17, 9, dim, 0, range, block, ops_par_loop_opensbliblock00Kernel016_execute);
}
#endif
