...
//
__constant__ int dims_opensbliblock00Kernel016 [17][1];
static int dims_opensbliblock00Kernel016_h [17][1] = {{0}};

//user function
__device__

 void opensbliblock00Kernel016_gpu(const ACC<double> &eveqN2_B0,
...
void ops_par_loop_opensbliblock00Kernel016(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg16) {
  ...
  create_kerneldesc_and_enque(name, args, 17, 9, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel016_execute);
}
#endif
