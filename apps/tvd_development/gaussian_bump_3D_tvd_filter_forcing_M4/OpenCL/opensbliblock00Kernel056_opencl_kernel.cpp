...
//
    ...
    void buildOpenCLKernels_opensbliblock00Kernel056(OPS_instance *instance, int xdim0, int ydim0, int xdim1, int ydim1, int xdim2, int ydim2, int xdim3, int ydim3, int xdim4, int ydim4, int xdim5, int ydim5, int xdim6, int ydim6, int xdim7, int ydim7, int xdim8, int ydim8, int xdim9, int ydim9, int xdim10, int ydim10, int xdim11, int ydim11) {
      ...
      if(!isbuilt_opensbliblock00Kernel056) {
        ...
        instance->opencl_instance->OPS_opencl_core.kernel[6] = clCreateKernel(instance->opencl_instance->OPS_opencl_core.program, "ops_opensbliblock00Kernel056", &ret);
        clSafeCall( ret );
