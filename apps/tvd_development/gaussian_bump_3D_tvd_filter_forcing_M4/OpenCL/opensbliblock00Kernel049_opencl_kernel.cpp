...
//
    ...
    void buildOpenCLKernels_opensbliblock00Kernel049(OPS_instance *instance, int xdim0, int ydim0, int xdim1, int ydim1, int xdim2, int ydim2, int xdim3, int ydim3, int xdim4, int ydim4) {
      ...
      if(!isbuilt_opensbliblock00Kernel049) {
        ...
        instance->opencl_instance->OPS_opencl_core.kernel[5] = clCreateKernel(instance->opencl_instance->OPS_opencl_core.program, "ops_opensbliblock00Kernel049", &ret);
        clSafeCall( ret );
...
void ops_par_loop_opensbliblock00Kernel049(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4) {
  ...
  if (block->instance->OPS_diags > 1) {
    ops_timing_realloc(block->instance,5,"opensbliblock00Kernel049");
