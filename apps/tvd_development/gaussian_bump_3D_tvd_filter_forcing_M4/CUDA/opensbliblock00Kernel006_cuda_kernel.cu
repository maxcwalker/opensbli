...
void opensbliblock00Kernel006_gpu(const ACC<double> &u1_B0,
  ACC<double> &wk1_B0,
  const int *idx)
{
   if (idx[0] == 0){
...
int size2 ){
  ...
  if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
    ...
    ACC<double> argp1(dims_opensbliblock00Kernel006[1][0], dims_opensbliblock00Kernel006[1][1], arg1);
...
void ops_par_loop_opensbliblock00Kernel006_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_opensbliblock00Kernel006_h[0][0] || ydim0 != dims_opensbliblock00Kernel006_h[0][1] || xdim1 != dims_opensbliblock00Kernel006_h[1][0] || ydim1 != dims_opensbliblock00Kernel006_h[1][1]) {
