  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0 && (end[2]-start[2])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      , [=](cl::sycl::nd_item<3> item
        ...
        const ACC<double> rhoE_B0(xdim0_opensbliblock00Kernel020, ydim0_opensbliblock00Kernel020, &rhoE_B0_p[0] + base0 + n_x*1 + n_y * xdim0_opensbliblock00Kernel020*1 + n_z * xdim0_opensbliblock00Kernel020 * ydim0_opensbliblock00Kernel020*1);
        const ACC<double> rho_B0(xdim1_opensbliblock00Kernel020, ydim1_opensbliblock00Kernel020, &rho_B0_p[0] + base1 + n_x*1 + n_y * xdim1_opensbliblock00Kernel020*1 + n_z * xdim1_opensbliblock00Kernel020 * ydim1_opensbliblock00Kernel020*1);
        const ACC<double> u0_B0(xdim2_opensbliblock00Kernel020, ydim2_opensbliblock00Kernel020, &u0_B0_p[0] + base2 + n_x*1 + n_y * xdim2_opensbliblock00Kernel020*1 + n_z * xdim2_opensbliblock00Kernel020 * ydim2_opensbliblock00Kernel020*1);
        const ACC<double> u1_B0(xdim3_opensbliblock00Kernel020, ydim3_opensbliblock00Kernel020, &u1_B0_p[0] + base3 + n_x*1 + n_y * xdim3_opensbliblock00Kernel020*1 + n_z * xdim3_opensbliblock00Kernel020 * ydim3_opensbliblock00Kernel020*1);
        const ACC<double> u2_B0(xdim4_opensbliblock00Kernel020, ydim4_opensbliblock00Kernel020, &u2_B0_p[0] + base4 + n_x*1 + n_y * xdim4_opensbliblock00Kernel020*1 + n_z * xdim4_opensbliblock00Kernel020 * ydim4_opensbliblock00Kernel020*1);
        ACC<double> p_B0(xdim5_opensbliblock00Kernel020, ydim5_opensbliblock00Kernel020, &p_B0_p[0] + base5 + n_x*1 + n_y * xdim5_opensbliblock00Kernel020*1 + n_z * xdim5_opensbliblock00Kernel020 * ydim5_opensbliblock00Kernel020*1);
        //USER CODE
