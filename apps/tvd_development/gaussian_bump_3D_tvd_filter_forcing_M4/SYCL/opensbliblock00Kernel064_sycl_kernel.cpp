...
void ops_par_loop_opensbliblock00Kernel064_execute(ops_kernel_descriptor *desc) {
  ...
  ops_arg args[18] = { arg0, arg1, arg2, arg3, arg4,
 ...
 arg15, arg16, arg17};
  ...
  double* a_B0_p = (double*)args[2].data_d;

  int base3 = args[3].dat->base_offset/sizeof(double);
  double* detJ_B0_p = (double*)args[3].data_d;

  int base4 = args[4].dat->base_offset/sizeof(double);
  double* kappa_B0_p = (double*)args[4].data_d;
  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0 && (end[2]-start[2])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      auto Ducros_check_sycl = (*Ducros_check_p).template get_access<cl::sycl::access::mode::read>(cgh);
      ...
      , [=](cl::sycl::nd_item<3> item
        ...
        const ACC<double> D00_B0(xdim0_opensbliblock00Kernel064, ydim0_opensbliblock00Kernel064, &D00_B0_p[0] + base0 + n_x*1 + n_y * xdim0_opensbliblock00Kernel064*1 + n_z * xdim0_opensbliblock00Kernel064 * ydim0_opensbliblock00Kernel064*1);
        const ACC<double> D01_B0(xdim1_opensbliblock00Kernel064, ydim1_opensbliblock00Kernel064, &D01_B0_p[0] + base1 + n_x*1 + n_y * xdim1_opensbliblock00Kernel064*1 + n_z * xdim1_opensbliblock00Kernel064 * ydim1_opensbliblock00Kernel064*1);
        const ACC<double> a_B0(xdim2_opensbliblock00Kernel064, ydim2_opensbliblock00Kernel064, &a_B0_p[0] + base2 + n_x*1 + n_y * xdim2_opensbliblock00Kernel064*1 + n_z * xdim2_opensbliblock00Kernel064 * ydim2_opensbliblock00Kernel064*1);
        const ACC<double> detJ_B0(xdim3_opensbliblock00Kernel064, ydim3_opensbliblock00Kernel064, &detJ_B0_p[0] + base3 + n_x*1 + n_y * xdim3_opensbliblock00Kernel064*1 + n_z * xdim3_opensbliblock00Kernel064 * ydim3_opensbliblock00Kernel064*1);
        const ACC<double> kappa_B0(xdim4_opensbliblock00Kernel064, ydim4_opensbliblock00Kernel064, &kappa_B0_p[0] + base4 + n_x*1 + n_y * xdim4_opensbliblock00Kernel064*1 + n_z * xdim4_opensbliblock00Kernel064 * ydim4_opensbliblock00Kernel064*1);
        const ACC<double> rhoE_B0(xdim5_opensbliblock00Kernel064, ydim5_opensbliblock00Kernel064, &rhoE_B0_p[0] + base5 + n_x*1 + n_y * xdim5_opensbliblock00Kernel064*1 + n_z * xdim5_opensbliblock00Kernel064 * ydim5_opensbliblock00Kernel064*1);
        const ACC<double> rho_B0(xdim6_opensbliblock00Kernel064, ydim6_opensbliblock00Kernel064, &rho_B0_p[0] + base6 + n_x*1 + n_y * xdim6_opensbliblock00Kernel064*1 + n_z * xdim6_opensbliblock00Kernel064 * ydim6_opensbliblock00Kernel064*1);
        const ACC<double> rhou0_B0(xdim7_opensbliblock00Kernel064, ydim7_opensbliblock00Kernel064, &rhou0_B0_p[0] + base7 + n_x*1 + n_y * xdim7_opensbliblock00Kernel064*1 + n_z * xdim7_opensbliblock00Kernel064 * ydim7_opensbliblock00Kernel064*1);
        const ACC<double> rhou1_B0(xdim8_opensbliblock00Kernel064, ydim8_opensbliblock00Kernel064, &rhou1_B0_p[0] + base8 + n_x*1 + n_y * xdim8_opensbliblock00Kernel064*1 + n_z * xdim8_opensbliblock00Kernel064 * ydim8_opensbliblock00Kernel064*1);
        const ACC<double> rhou2_B0(xdim9_opensbliblock00Kernel064, ydim9_opensbliblock00Kernel064, &rhou2_B0_p[0] + base9 + n_x*1 + n_y * xdim9_opensbliblock00Kernel064*1 + n_z * xdim9_opensbliblock00Kernel064 * ydim9_opensbliblock00Kernel064*1);
        const ACC<double> u0_B0(xdim10_opensbliblock00Kernel064, ydim10_opensbliblock00Kernel064, &u0_B0_p[0] + base10 + n_x*1 + n_y * xdim10_opensbliblock00Kernel064*1 + n_z * xdim10_opensbliblock00Kernel064 * ydim10_opensbliblock00Kernel064*1);
        const ACC<double> u1_B0(xdim11_opensbliblock00Kernel064, ydim11_opensbliblock00Kernel064, &u1_B0_p[0] + base11 + n_x*1 + n_y * xdim11_opensbliblock00Kernel064*1 + n_z * xdim11_opensbliblock00Kernel064 * ydim11_opensbliblock00Kernel064*1);
        const ACC<double> u2_B0(xdim12_opensbliblock00Kernel064, ydim12_opensbliblock00Kernel064, &u2_B0_p[0] + base12 + n_x*1 + n_y * xdim12_opensbliblock00Kernel064*1 + n_z * xdim12_opensbliblock00Kernel064 * ydim12_opensbliblock00Kernel064*1);
        ACC<double> wk0_B0(xdim13_opensbliblock00Kernel064, ydim13_opensbliblock00Kernel064, &wk0_B0_p[0] + base13 + n_x*1 + n_y * xdim13_opensbliblock00Kernel064*1 + n_z * xdim13_opensbliblock00Kernel064 * ydim13_opensbliblock00Kernel064*1);
        ACC<double> wk1_B0(xdim14_opensbliblock00Kernel064, ydim14_opensbliblock00Kernel064, &wk1_B0_p[0] + base14 + n_x*1 + n_y * xdim14_opensbliblock00Kernel064*1 + n_z * xdim14_opensbliblock00Kernel064 * ydim14_opensbliblock00Kernel064*1);
        ACC<double> wk2_B0(xdim15_opensbliblock00Kernel064, ydim15_opensbliblock00Kernel064, &wk2_B0_p[0] + base15 + n_x*1 + n_y * xdim15_opensbliblock00Kernel064*1 + n_z * xdim15_opensbliblock00Kernel064 * ydim15_opensbliblock00Kernel064*1);
        ACC<double> wk3_B0(xdim16_opensbliblock00Kernel064, ydim16_opensbliblock00Kernel064, &wk3_B0_p[0] + base16 + n_x*1 + n_y * xdim16_opensbliblock00Kernel064*1 + n_z * xdim16_opensbliblock00Kernel064 * ydim16_opensbliblock00Kernel064*1);
        ACC<double> wk4_B0(xdim17_opensbliblock00Kernel064, ydim17_opensbliblock00Kernel064, &wk4_B0_p[0] + base17 + n_x*1 + n_y * xdim17_opensbliblock00Kernel064*1 + n_z * xdim17_opensbliblock00Kernel064 * ydim17_opensbliblock00Kernel064*1);
        //USER CODE
   ...
   double phi_0_sycl[0] = 0.0;
   double phi_1_sycl[0] = 0.0;
   double phi_2_sycl[0] = 0.0;
   double phi_3 = 0.0;
   double phi_4 = 0.0;
   ...
   double ws_lambda_44 = 0.0;
    if (cl::sycl::fmax(kappa_B0(2,0,0), cl::sycl::fmax(kappa_B0(0,0,0), cl::sycl::fmax(kappa_B0(-3,0,0), cl::sycl::fmax(kappa_B0(1,0,0), cl::sycl::fmax(kappa_B0(-2,0,0),
      kappa_B0(-1,0,0)))))) > Ducros_check_sycl[0]){
      ...
      ws_lambda_22 = (D00_B0(0,0,0)*AVG_0_u0 + D01_B0(0,0,0)*AVG_0_u1)*detJ_B0(0,0,0);
       ...
       ws_lambda_33 = cl::sycl::sqrt((D00_B0(0,0,0)*D00_B0(0,0,0))*(detJ_B0(0,0,0)*detJ_B0(0,0,0)) +
       ...
       ws_lambda_44 = -cl::sycl::sqrt((D00_B0(0,0,0)*D00_B0(0,0,0))*(detJ_B0(0,0,0)*detJ_B0(0,0,0)) +
            (D01_B0(0,0,0)*D01_B0(0,0,0))*(detJ_B0(0,0,0)*detJ_B0(0,0,0)))*AVG_0_a +
            D00_B0(0,0,0)*detJ_B0(0,0,0)*AVG_0_u0 + D01_B0(0,0,0)*detJ_B0(0,0,0)*AVG_0_u1;
...
: (
            ...
            ((1.0/2.0))*(1.0/(invdelta_TVD_sycl[0]*invdelta_TVD_sycl[0]) + (gamma_0*gamma_0))*invdelta_TVD_sycl[0]
));
...
: (
            ...
            ((1.0/2.0))*(1.0/(invdelta_TVD_sycl[0]*invdelta_TVD_sycl[0]) + (gamma_1*gamma_1))*invdelta_TVD_sycl[0]
));
...
: (
            ...
            ((1.0/2.0))*(1.0/(invdelta_TVD_sycl[0]*invdelta_TVD_sycl[0]) + (gamma_2*gamma_2))*invdelta_TVD_sycl[0]
));
...
: (
            ...
            ((1.0/2.0))*(1.0/(invdelta_TVD_sycl[0]*invdelta_TVD_sycl[0]) + (gamma_3*gamma_3))*invdelta_TVD_sycl[0]
));
...
: (
            ...
            ((1.0/2.0))*(1.0/(invdelta_TVD_sycl[0]*invdelta_TVD_sycl[0]) + (gamma_4*gamma_4))*invdelta_TVD_sycl[0]
));

      phi_0_sycl[0] = -cl::sycl::fabs(sigma_0_0 + sigma_1_0)*alpha_01 + 0.5*(g_00 + g_01)*sigma_0_0;

      phi_1_sycl[0] = -cl::sycl::fabs(sigma_0_1 + sigma_1_1)*alpha_11 + 0.5*(g_10 + g_11)*sigma_0_1;

      phi_2_sycl[0] = -cl::sycl::fabs(sigma_0_2 + sigma_1_2)*alpha_21 + 0.5*(g_20 + g_21)*sigma_0_2;
      ...
      phi_star_0 = kappa_TVD_sycl[0]*phi_0_sycl[0]*theta_0;

      phi_star_1 = kappa_TVD_sycl[0]*phi_1_sycl[0]*theta_1;

      phi_star_2 = kappa_TVD_sycl[0]*phi_2_sycl[0]*theta_2;
...
void ops_par_loop_opensbliblock00Kernel064(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg16, ops_arg arg17) {
  ...
  desc->nargs = 18;
  desc->args = (ops_arg*)ops_malloc(18*sizeof(ops_arg));
  desc->args[0] = arg0;
