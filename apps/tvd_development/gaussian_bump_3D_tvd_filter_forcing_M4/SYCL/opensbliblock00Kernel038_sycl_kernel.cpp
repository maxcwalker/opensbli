...
void ops_par_loop_opensbliblock00Kernel038_execute(ops_kernel_descriptor *desc) {
 ...
 arg5, arg6, arg7};
  ...
  int ydim2_opensbliblock00Kernel038 = args[2].dat->size[1];
  int xdim3_opensbliblock00Kernel038 = args[3].dat->size[0];
  int ydim3_opensbliblock00Kernel038 = args[3].dat->size[1];
  int xdim4_opensbliblock00Kernel038 = args[4].dat->size[0];
  int ydim4_opensbliblock00Kernel038 = args[4].dat->size[1];
  int xdim5_opensbliblock00Kernel038 = args[5].dat->size[0];
  int ydim5_opensbliblock00Kernel038 = args[5].dat->size[1];
  int xdim6_opensbliblock00Kernel038 = args[6].dat->size[0];
  int ydim6_opensbliblock00Kernel038 = args[6].dat->size[1];
  int xdim7_opensbliblock00Kernel038 = args[7].dat->size[0];
  int ydim7_opensbliblock00Kernel038 = args[7].dat->size[1];
  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0 && (end[2]-start[2])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      , [=](cl::sycl::nd_item<3> item
        ...
        const ACC<double> x0_B0(xdim1_opensbliblock00Kernel038, ydim1_opensbliblock00Kernel038, &x0_B0_p[0] + base1 + n_x*1 + n_y * xdim1_opensbliblock00Kernel038*1 + n_z * xdim1_opensbliblock00Kernel038 * ydim1_opensbliblock00Kernel038*1);
        const ACC<double> x2_B0(xdim2_opensbliblock00Kernel038, ydim2_opensbliblock00Kernel038, &x2_B0_p[0] + base2 + n_x*1 + n_y * xdim2_opensbliblock00Kernel038*1 + n_z * xdim2_opensbliblock00Kernel038 * ydim2_opensbliblock00Kernel038*1);
        ACC<double> rhoE_B0(xdim3_opensbliblock00Kernel038, ydim3_opensbliblock00Kernel038, &rhoE_B0_p[0] + base3 + n_x*1 + n_y * xdim3_opensbliblock00Kernel038*1 + n_z * xdim3_opensbliblock00Kernel038 * ydim3_opensbliblock00Kernel038*1);
        ACC<double> rho_B0(xdim4_opensbliblock00Kernel038, ydim4_opensbliblock00Kernel038, &rho_B0_p[0] + base4 + n_x*1 + n_y * xdim4_opensbliblock00Kernel038*1 + n_z * xdim4_opensbliblock00Kernel038 * ydim4_opensbliblock00Kernel038*1);
        ACC<double> rhou0_B0(xdim5_opensbliblock00Kernel038, ydim5_opensbliblock00Kernel038, &rhou0_B0_p[0] + base5 + n_x*1 + n_y * xdim5_opensbliblock00Kernel038*1 + n_z * xdim5_opensbliblock00Kernel038 * ydim5_opensbliblock00Kernel038*1);
        ACC<double> rhou1_B0(xdim6_opensbliblock00Kernel038, ydim6_opensbliblock00Kernel038, &rhou1_B0_p[0] + base6 + n_x*1 + n_y * xdim6_opensbliblock00Kernel038*1 + n_z * xdim6_opensbliblock00Kernel038 * ydim6_opensbliblock00Kernel038*1);
        ACC<double> rhou2_B0(xdim7_opensbliblock00Kernel038, ydim7_opensbliblock00Kernel038, &rhou2_B0_p[0] + base7 + n_x*1 + n_y * xdim7_opensbliblock00Kernel038*1 + n_z * xdim7_opensbliblock00Kernel038 * ydim7_opensbliblock00Kernel038*1);
