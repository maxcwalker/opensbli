...
void ops_par_loop_opensbliblock00Kernel034_execute(ops_kernel_descriptor *desc) {
  ...
  double * __restrict__ wk10_B0_p = (double *)(args[14].data_d + base14);
  ...
  double * __restrict__ wk8_B0_p = (double *)(args[20].data_d + base20);

  int base21 = args[21].dat->base_offset;
  double * __restrict__ wk9_B0_p = (double *)(args[21].data_d + base21);

  int base22 = args[22].dat->base_offset;
  double * __restrict__ Residual0_B0_p = (double *)(args[22].data_d + base22);

  int base23 = args[23].dat->base_offset;
  double * __restrict__ Residual1_B0_p = (double *)(args[23].data_d + base23);

  int base24 = args[24].dat->base_offset;
  double * __restrict__ Residual2_B0_p = (double *)(args[24].data_d + base24);

  int base25 = args[25].dat->base_offset;
  double * __restrict__ Residual3_B0_p = (double *)(args[25].data_d + base25);

  int base26 = args[26].dat->base_offset;
  double * __restrict__ Residual4_B0_p = (double *)(args[26].data_d + base26);
