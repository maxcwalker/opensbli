...
void ops_par_loop_opensbliblock00Kernel065_execute(ops_kernel_descriptor *desc) {
  ...
  double * __restrict__ kappa_B0_p = (double *)(args[4].data_d + base4);
  ...
  double * __restrict__ rhou0_B0_p = (double *)(args[7].data_d + base7);

  int base8 = args[8].dat->base_offset;
  double * __restrict__ rhou1_B0_p = (double *)(args[8].data_d + base8);

  int base9 = args[9].dat->base_offset;
  double * __restrict__ rhou2_B0_p = (double *)(args[9].data_d + base9);
  ...
  double * __restrict__ u2_B0_p = (double *)(args[12].data_d + base12);

  int base13 = args[13].dat->base_offset;
  double * __restrict__ Residual0_B0_p = (double *)(args[13].data_d + base13);
  ...
  for ( int n_z=start2; n_z<end2; n_z++ ){
    for ( int n_y=start1; n_y<end1; n_y++ ){
      for ( int n_x=start0; n_x<end0; n_x++ ){
        const ACC<double> D10_B0(xdim0_opensbliblock00Kernel065, ydim0_opensbliblock00Kernel065, D10_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel065*1 + n_z * xdim0_opensbliblock00Kernel065 * ydim0_opensbliblock00Kernel065*1);
        const ACC<double> D11_B0(xdim1_opensbliblock00Kernel065, ydim1_opensbliblock00Kernel065, D11_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel065*1 + n_z * xdim1_opensbliblock00Kernel065 * ydim1_opensbliblock00Kernel065*1);
        const ACC<double> a_B0(xdim2_opensbliblock00Kernel065, ydim2_opensbliblock00Kernel065, a_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel065*1 + n_z * xdim2_opensbliblock00Kernel065 * ydim2_opensbliblock00Kernel065*1);
        const ACC<double> detJ_B0(xdim3_opensbliblock00Kernel065, ydim3_opensbliblock00Kernel065, detJ_B0_p + n_x*1 + n_y * xdim3_opensbliblock00Kernel065*1 + n_z * xdim3_opensbliblock00Kernel065 * ydim3_opensbliblock00Kernel065*1);
        const ACC<double> kappa_B0(xdim4_opensbliblock00Kernel065, ydim4_opensbliblock00Kernel065, kappa_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel065*1 + n_z * xdim4_opensbliblock00Kernel065 * ydim4_opensbliblock00Kernel065*1);
        const ACC<double> rhoE_B0(xdim5_opensbliblock00Kernel065, ydim5_opensbliblock00Kernel065, rhoE_B0_p + n_x*1 + n_y * xdim5_opensbliblock00Kernel065*1 + n_z * xdim5_opensbliblock00Kernel065 * ydim5_opensbliblock00Kernel065*1);
        const ACC<double> rho_B0(xdim6_opensbliblock00Kernel065, ydim6_opensbliblock00Kernel065, rho_B0_p + n_x*1 + n_y * xdim6_opensbliblock00Kernel065*1 + n_z * xdim6_opensbliblock00Kernel065 * ydim6_opensbliblock00Kernel065*1);
        const ACC<double> rhou0_B0(xdim7_opensbliblock00Kernel065, ydim7_opensbliblock00Kernel065, rhou0_B0_p + n_x*1 + n_y * xdim7_opensbliblock00Kernel065*1 + n_z * xdim7_opensbliblock00Kernel065 * ydim7_opensbliblock00Kernel065*1);
        const ACC<double> rhou1_B0(xdim8_opensbliblock00Kernel065, ydim8_opensbliblock00Kernel065, rhou1_B0_p + n_x*1 + n_y * xdim8_opensbliblock00Kernel065*1 + n_z * xdim8_opensbliblock00Kernel065 * ydim8_opensbliblock00Kernel065*1);
        const ACC<double> rhou2_B0(xdim9_opensbliblock00Kernel065, ydim9_opensbliblock00Kernel065, rhou2_B0_p + n_x*1 + n_y * xdim9_opensbliblock00Kernel065*1 + n_z * xdim9_opensbliblock00Kernel065 * ydim9_opensbliblock00Kernel065*1);
        const ACC<double> u0_B0(xdim10_opensbliblock00Kernel065, ydim10_opensbliblock00Kernel065, u0_B0_p + n_x*1 + n_y * xdim10_opensbliblock00Kernel065*1 + n_z * xdim10_opensbliblock00Kernel065 * ydim10_opensbliblock00Kernel065*1);
        const ACC<double> u1_B0(xdim11_opensbliblock00Kernel065, ydim11_opensbliblock00Kernel065, u1_B0_p + n_x*1 + n_y * xdim11_opensbliblock00Kernel065*1 + n_z * xdim11_opensbliblock00Kernel065 * ydim11_opensbliblock00Kernel065*1);
        const ACC<double> u2_B0(xdim12_opensbliblock00Kernel065, ydim12_opensbliblock00Kernel065, u2_B0_p + n_x*1 + n_y * xdim12_opensbliblock00Kernel065*1 + n_z * xdim12_opensbliblock00Kernel065 * ydim12_opensbliblock00Kernel065*1);
        ACC<double> Residual0_B0(xdim13_opensbliblock00Kernel065, ydim13_opensbliblock00Kernel065, Residual0_B0_p + n_x*1 + n_y * xdim13_opensbliblock00Kernel065*1 + n_z * xdim13_opensbliblock00Kernel065 * ydim13_opensbliblock00Kernel065*1);
        ACC<double> Residual1_B0(xdim14_opensbliblock00Kernel065, ydim14_opensbliblock00Kernel065, Residual1_B0_p + n_x*1 + n_y * xdim14_opensbliblock00Kernel065*1 + n_z * xdim14_opensbliblock00Kernel065 * ydim14_opensbliblock00Kernel065*1);
        ACC<double> Residual2_B0(xdim15_opensbliblock00Kernel065, ydim15_opensbliblock00Kernel065, Residual2_B0_p + n_x*1 + n_y * xdim15_opensbliblock00Kernel065*1 + n_z * xdim15_opensbliblock00Kernel065 * ydim15_opensbliblock00Kernel065*1);
        ACC<double> Residual3_B0(xdim16_opensbliblock00Kernel065, ydim16_opensbliblock00Kernel065, Residual3_B0_p + n_x*1 + n_y * xdim16_opensbliblock00Kernel065*1 + n_z * xdim16_opensbliblock00Kernel065 * ydim16_opensbliblock00Kernel065*1);
        ACC<double> Residual4_B0(xdim17_opensbliblock00Kernel065, ydim17_opensbliblock00Kernel065, Residual4_B0_p + n_x*1 + n_y * xdim17_opensbliblock00Kernel065*1 + n_z * xdim17_opensbliblock00Kernel065 * ydim17_opensbliblock00Kernel065*1);
...
void ops_par_loop_opensbliblock00Kernel065(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg16, ops_arg arg17) {
  ...
  create_kerneldesc_and_enque(name, args, 18, 37, dim, 0, range, block, ops_par_loop_opensbliblock00Kernel065_execute);
}
#endif
