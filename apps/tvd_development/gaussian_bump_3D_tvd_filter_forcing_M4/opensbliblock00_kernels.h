...
ACC<double> &Residual3_B0, ACC<double> &Residual4_B0, const int *idx)
{
   ...
   if (idx[1] == 0){
    ...
    d1_rhoE_dz = (-(2.0/3.0)*rhoE_B0(0,0,-1) - (1.0/12.0)*rhoE_B0(0,0,2) + ((1.0/12.0))*rhoE_B0(0,0,-2) +
    ...
    d1_inv_rhoErhou2_dz = (-(2.0/3.0)*u2_B0(0,0,-1)*rhoE_B0(0,0,-1)/rho_B0(0,0,-1) -
      (1.0/12.0)*u2_B0(0,0,2)*rhoE_B0(0,0,2)/rho_B0(0,0,2) + ((1.0/12.0))*u2_B0(0,0,-2)*rhoE_B0(0,0,-2)/rho_B0(0,0,-2) +
      ((2.0/3.0))*u2_B0(0,0,1)*rhoE_B0(0,0,1)/rho_B0(0,0,1))*invDelta2block0;
...
&wk3_B0, ACC<double> &wk4_B0)
{
   ...
   double ws_lambda_44 = 0.0;
    if (fmax(kappa_B0(2,0,0), fmax(kappa_B0(-1,0,0), fmax(kappa_B0(0,0,0), fmax(kappa_B0(-3,0,0), fmax(kappa_B0(1,0,0),
...
&Residual2_B0, ACC<double> &Residual3_B0, ACC<double> &Residual4_B0)
{
   ...
   double ws_lambda_33 = 0.0;
   double ws_lambda_44 = 0.0;
    if (fmax(kappa_B0(0,2,0), fmax(kappa_B0(0,-1,0), fmax(kappa_B0(0,0,0), fmax(kappa_B0(0,-3,0), fmax(kappa_B0(0,1,0),
...
: (
   1
    ...
    TVD_filter_B0(0,0,0) = ((fmax(kappa_B0(0,1,0), fmax(kappa_B0(0,0,1), fmax(kappa_B0(-1,0,0), fmax(kappa_B0(0,-1,0),
      fmax(kappa_B0(0,0,0), fmax(kappa_B0(1,0,0), kappa_B0(0,0,-1))))))) >= Ducros_select) ? (
   1
)
: (
   0.0
