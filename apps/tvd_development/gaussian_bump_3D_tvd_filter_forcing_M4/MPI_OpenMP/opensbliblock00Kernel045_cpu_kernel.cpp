  ...
  for ( int n_z=start[2]; n_z<end[2]; n_z++ ){
    for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
      ...
      for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
        ...
        const ACC<double> x0_B0(xdim0_opensbliblock00Kernel045, ydim0_opensbliblock00Kernel045, x0_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel045*1 + n_z * xdim0_opensbliblock00Kernel045 * ydim0_opensbliblock00Kernel045*1);
        const ACC<double> x1_B0(xdim1_opensbliblock00Kernel045, ydim1_opensbliblock00Kernel045, x1_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel045*1 + n_z * xdim1_opensbliblock00Kernel045 * ydim1_opensbliblock00Kernel045*1);
        ACC<double> D00_B0(xdim2_opensbliblock00Kernel045, ydim2_opensbliblock00Kernel045, D00_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel045*1 + n_z * xdim2_opensbliblock00Kernel045 * ydim2_opensbliblock00Kernel045*1);
        ACC<double> D01_B0(xdim3_opensbliblock00Kernel045, ydim3_opensbliblock00Kernel045, D01_B0_p + n_x*1 + n_y * xdim3_opensbliblock00Kernel045*1 + n_z * xdim3_opensbliblock00Kernel045 * ydim3_opensbliblock00Kernel045*1);
        ACC<double> D10_B0(xdim4_opensbliblock00Kernel045, ydim4_opensbliblock00Kernel045, D10_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel045*1 + n_z * xdim4_opensbliblock00Kernel045 * ydim4_opensbliblock00Kernel045*1);
        ACC<double> D11_B0(xdim5_opensbliblock00Kernel045, ydim5_opensbliblock00Kernel045, D11_B0_p + n_x*1 + n_y * xdim5_opensbliblock00Kernel045*1 + n_z * xdim5_opensbliblock00Kernel045 * ydim5_opensbliblock00Kernel045*1);
        ACC<double> detJ_B0(xdim6_opensbliblock00Kernel045, ydim6_opensbliblock00Kernel045, detJ_B0_p + n_x*1 + n_y * xdim6_opensbliblock00Kernel045*1 + n_z * xdim6_opensbliblock00Kernel045 * ydim6_opensbliblock00Kernel045*1);
        ACC<double> wk0_B0(xdim7_opensbliblock00Kernel045, ydim7_opensbliblock00Kernel045, wk0_B0_p + n_x*1 + n_y * xdim7_opensbliblock00Kernel045*1 + n_z * xdim7_opensbliblock00Kernel045 * ydim7_opensbliblock00Kernel045*1);
        ACC<double> wk1_B0(xdim8_opensbliblock00Kernel045, ydim8_opensbliblock00Kernel045, wk1_B0_p + n_x*1 + n_y * xdim8_opensbliblock00Kernel045*1 + n_z * xdim8_opensbliblock00Kernel045 * ydim8_opensbliblock00Kernel045*1);
        ACC<double> wk3_B0(xdim9_opensbliblock00Kernel045, ydim9_opensbliblock00Kernel045, wk3_B0_p + n_x*1 + n_y * xdim9_opensbliblock00Kernel045*1 + n_z * xdim9_opensbliblock00Kernel045 * ydim9_opensbliblock00Kernel045*1);
        ACC<double> wk4_B0(xdim10_opensbliblock00Kernel045, ydim10_opensbliblock00Kernel045, wk4_B0_p + n_x*1 + n_y * xdim10_opensbliblock00Kernel045*1 + n_z * xdim10_opensbliblock00Kernel045 * ydim10_opensbliblock00Kernel045*1);
...
void ops_par_loop_opensbliblock00Kernel045(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg8, ops_arg arg9, ops_arg arg10, ops_arg arg11) {
  ...
  create_kerneldesc_and_enque(name, args, 12, 1, dim, 0, range, block, ops_par_loop_opensbliblock00Kernel045_execute);
}
#endif
