...
//
__constant__ int dims_opensbliblock00Kernel046 [5][2];
static int dims_opensbliblock00Kernel046_h [5][2] = {{0}};

//user function
__device__

 void opensbliblock00Kernel046_gpu(ACC<double> &D00_B0,
  ACC<double> &D01_B0,
  ACC<double> &D10_B0,
  ACC<double> &D11_B0,
  ACC<double> &detJ_B0)
...
int size2 ){
  ...
  if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
    ACC<double> argp0(dims_opensbliblock00Kernel046[0][0], dims_opensbliblock00Kernel046[0][1], arg0);
    ACC<double> argp1(dims_opensbliblock00Kernel046[1][0], dims_opensbliblock00Kernel046[1][1], arg1);
    ACC<double> argp2(dims_opensbliblock00Kernel046[2][0], dims_opensbliblock00Kernel046[2][1], arg2);
    ACC<double> argp3(dims_opensbliblock00Kernel046[3][0], dims_opensbliblock00Kernel046[3][1], arg3);
    ACC<double> argp4(dims_opensbliblock00Kernel046[4][0], dims_opensbliblock00Kernel046[4][1], arg4);
...
void ops_par_loop_opensbliblock00Kernel046(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4) {
  ...
  create_kerneldesc_and_enque(name, args, 5, 2, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel046_execute);
}
#endif
