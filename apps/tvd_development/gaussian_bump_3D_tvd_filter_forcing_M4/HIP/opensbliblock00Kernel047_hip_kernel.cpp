...
//
__constant__ int dims_opensbliblock00Kernel047 [5][2];
static int dims_opensbliblock00Kernel047_h [5][2] = {{0}};

//user function
__device__

 void opensbliblock00Kernel047_gpu(ACC<double> &D00_B0,
  ACC<double> &D01_B0,
  ACC<double> &D10_B0,
  ACC<double> &D11_B0,
  ACC<double> &detJ_B0)
...
int size2 ){
  ...
  if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
    ACC<double> argp0(dims_opensbliblock00Kernel047[0][0], dims_opensbliblock00Kernel047[0][1], arg0);
    ACC<double> argp1(dims_opensbliblock00Kernel047[1][0], dims_opensbliblock00Kernel047[1][1], arg1);
    ACC<double> argp2(dims_opensbliblock00Kernel047[2][0], dims_opensbliblock00Kernel047[2][1], arg2);
    ACC<double> argp3(dims_opensbliblock00Kernel047[3][0], dims_opensbliblock00Kernel047[3][1], arg3);
    ACC<double> argp4(dims_opensbliblock00Kernel047[4][0], dims_opensbliblock00Kernel047[4][1], arg4);
...
void ops_par_loop_opensbliblock00Kernel047_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_opensbliblock00Kernel047_h[0][0] || ydim0 != dims_opensbliblock00Kernel047_h[0][1] || xdim1 != dims_opensbliblock00Kernel047_h[1][0] || ydim1 != dims_opensbliblock00Kernel047_h[1][1] || xdim2 != dims_opensbliblock00Kernel047_h[2][0] || ydim2 != dims_opensbliblock00Kernel047_h[2][1] || xdim3 != dims_opensbliblock00Kernel047_h[3][0] || ydim3 != dims_opensbliblock00Kernel047_h[3][1] || xdim4 != dims_opensbliblock00Kernel047_h[4][0] || ydim4 != dims_opensbliblock00Kernel047_h[4][1]) {
...
void ops_par_loop_opensbliblock00Kernel047(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4) {
  ...
  create_kerneldesc_and_enque(name, args, 5, 3, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel047_execute);
}
#endif
