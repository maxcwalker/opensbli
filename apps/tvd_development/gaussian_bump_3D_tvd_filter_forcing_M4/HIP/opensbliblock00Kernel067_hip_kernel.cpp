...
//
__constant__ int dims_opensbliblock00Kernel067 [23][2];
static int dims_opensbliblock00Kernel067_h [23][2] = {{0}};

//user function
__device__

 void opensbliblock00Kernel067_gpu(const ACC<double> &Residual0_B0,
...
: (
   1
    ...
    TVD_filter_B0(0,0,0) = ((fmax(kappa_B0(0,0,-1), fmax(kappa_B0(0,0,1), fmax(kappa_B0(0,1,0), fmax(kappa_B0(0,0,0),
      fmax(kappa_B0(1,0,0), fmax(kappa_B0(-1,0,0), kappa_B0(0,-1,0))))))) >= Ducros_select) ? (
   1
)
: (
   0.0
...
int size2 ){
  ...
  arg8 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel067[8][0] + idx_z * 1*1 * dims_opensbliblock00Kernel067[8][0] * dims_opensbliblock00Kernel067[8][1];
  arg9 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel067[9][0] + idx_z * 1*1 * dims_opensbliblock00Kernel067[9][0] * dims_opensbliblock00Kernel067[9][1];
  arg10 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel067[10][0] + idx_z * 1*1 * dims_opensbliblock00Kernel067[10][0] * dims_opensbliblock00Kernel067[10][1];
  arg11 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel067[11][0] + idx_z * 1*1 * dims_opensbliblock00Kernel067[11][0] * dims_opensbliblock00Kernel067[11][1];
  arg12 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel067[12][0] + idx_z * 1*1 * dims_opensbliblock00Kernel067[12][0] * dims_opensbliblock00Kernel067[12][1];
  arg13 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel067[13][0] + idx_z * 1*1 * dims_opensbliblock00Kernel067[13][0] * dims_opensbliblock00Kernel067[13][1];
  arg14 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel067[14][0] + idx_z * 1*1 * dims_opensbliblock00Kernel067[14][0] * dims_opensbliblock00Kernel067[14][1];
  arg15 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel067[15][0] + idx_z * 1*1 * dims_opensbliblock00Kernel067[15][0] * dims_opensbliblock00Kernel067[15][1];
  arg16 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel067[16][0] + idx_z * 1*1 * dims_opensbliblock00Kernel067[16][0] * dims_opensbliblock00Kernel067[16][1];
  arg17 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel067[17][0] + idx_z * 1*1 * dims_opensbliblock00Kernel067[17][0] * dims_opensbliblock00Kernel067[17][1];
  arg18 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel067[18][0] + idx_z * 1*1 * dims_opensbliblock00Kernel067[18][0] * dims_opensbliblock00Kernel067[18][1];
  arg19 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel067[19][0] + idx_z * 1*1 * dims_opensbliblock00Kernel067[19][0] * dims_opensbliblock00Kernel067[19][1];
  arg20 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel067[20][0] + idx_z * 1*1 * dims_opensbliblock00Kernel067[20][0] * dims_opensbliblock00Kernel067[20][1];
  arg21 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel067[21][0] + idx_z * 1*1 * dims_opensbliblock00Kernel067[21][0] * dims_opensbliblock00Kernel067[21][1];

  if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
    const ACC<double> argp0(dims_opensbliblock00Kernel067[0][0], dims_opensbliblock00Kernel067[0][1], arg0);
    const ACC<double> argp1(dims_opensbliblock00Kernel067[1][0], dims_opensbliblock00Kernel067[1][1], arg1);
    const ACC<double> argp2(dims_opensbliblock00Kernel067[2][0], dims_opensbliblock00Kernel067[2][1], arg2);
    const ACC<double> argp3(dims_opensbliblock00Kernel067[3][0], dims_opensbliblock00Kernel067[3][1], arg3);
    const ACC<double> argp4(dims_opensbliblock00Kernel067[4][0], dims_opensbliblock00Kernel067[4][1], arg4);
    const ACC<double> argp5(dims_opensbliblock00Kernel067[5][0], dims_opensbliblock00Kernel067[5][1], arg5);
    const ACC<double> argp6(dims_opensbliblock00Kernel067[6][0], dims_opensbliblock00Kernel067[6][1], arg6);
    const ACC<double> argp7(dims_opensbliblock00Kernel067[7][0], dims_opensbliblock00Kernel067[7][1], arg7);
    const ACC<double> argp8(dims_opensbliblock00Kernel067[8][0], dims_opensbliblock00Kernel067[8][1], arg8);
    const ACC<double> argp9(dims_opensbliblock00Kernel067[9][0], dims_opensbliblock00Kernel067[9][1], arg9);
    const ACC<double> argp10(dims_opensbliblock00Kernel067[10][0], dims_opensbliblock00Kernel067[10][1], arg10);
    const ACC<double> argp11(dims_opensbliblock00Kernel067[11][0], dims_opensbliblock00Kernel067[11][1], arg11);
    const ACC<double> argp12(dims_opensbliblock00Kernel067[12][0], dims_opensbliblock00Kernel067[12][1], arg12);
    const ACC<double> argp13(dims_opensbliblock00Kernel067[13][0], dims_opensbliblock00Kernel067[13][1], arg13);
    const ACC<double> argp14(dims_opensbliblock00Kernel067[14][0], dims_opensbliblock00Kernel067[14][1], arg14);
    const ACC<double> argp15(dims_opensbliblock00Kernel067[15][0], dims_opensbliblock00Kernel067[15][1], arg15);
    ACC<double> argp16(dims_opensbliblock00Kernel067[16][0], dims_opensbliblock00Kernel067[16][1], arg16);
    ACC<double> argp17(dims_opensbliblock00Kernel067[17][0], dims_opensbliblock00Kernel067[17][1], arg17);
    ACC<double> argp18(dims_opensbliblock00Kernel067[18][0], dims_opensbliblock00Kernel067[18][1], arg18);
    ACC<double> argp19(dims_opensbliblock00Kernel067[19][0], dims_opensbliblock00Kernel067[19][1], arg19);
    ACC<double> argp20(dims_opensbliblock00Kernel067[20][0], dims_opensbliblock00Kernel067[20][1], arg20);
    ACC<double> argp21(dims_opensbliblock00Kernel067[21][0], dims_opensbliblock00Kernel067[21][1], arg21);
...
void ops_par_loop_opensbliblock00Kernel067_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_opensbliblock00Kernel067_h[0][0] || ydim0 != dims_opensbliblock00Kernel067_h[0][1] || xdim1 != dims_opensbliblock00Kernel067_h[1][0] || ydim1 != dims_opensbliblock00Kernel067_h[1][1] || xdim2 != dims_opensbliblock00Kernel067_h[2][0] || ydim2 != dims_opensbliblock00Kernel067_h[2][1] || xdim3 != dims_opensbliblock00Kernel067_h[3][0] || ydim3 != dims_opensbliblock00Kernel067_h[3][1] || xdim4 != dims_opensbliblock00Kernel067_h[4][0] || ydim4 != dims_opensbliblock00Kernel067_h[4][1] || xdim5 != dims_opensbliblock00Kernel067_h[5][0] || ydim5 != dims_opensbliblock00Kernel067_h[5][1] || xdim6 != dims_opensbliblock00Kernel067_h[6][0] || ydim6 != dims_opensbliblock00Kernel067_h[6][1] || xdim7 != dims_opensbliblock00Kernel067_h[7][0] || ydim7 != dims_opensbliblock00Kernel067_h[7][1] || xdim8 != dims_opensbliblock00Kernel067_h[8][0] || ydim8 != dims_opensbliblock00Kernel067_h[8][1] || xdim9 != dims_opensbliblock00Kernel067_h[9][0] || ydim9 != dims_opensbliblock00Kernel067_h[9][1] || xdim10 != dims_opensbliblock00Kernel067_h[10][0] || ydim10 != dims_opensbliblock00Kernel067_h[10][1] || xdim11 != dims_opensbliblock00Kernel067_h[11][0] || ydim11 != dims_opensbliblock00Kernel067_h[11][1] || xdim12 != dims_opensbliblock00Kernel067_h[12][0] || ydim12 != dims_opensbliblock00Kernel067_h[12][1] || xdim13 != dims_opensbliblock00Kernel067_h[13][0] || ydim13 != dims_opensbliblock00Kernel067_h[13][1] || xdim14 != dims_opensbliblock00Kernel067_h[14][0] || ydim14 != dims_opensbliblock00Kernel067_h[14][1] || xdim15 != dims_opensbliblock00Kernel067_h[15][0] || ydim15 != dims_opensbliblock00Kernel067_h[15][1] || xdim16 != dims_opensbliblock00Kernel067_h[16][0] || ydim16 != dims_opensbliblock00Kernel067_h[16][1] || xdim17 != dims_opensbliblock00Kernel067_h[17][0] || ydim17 != dims_opensbliblock00Kernel067_h[17][1] || xdim18 != dims_opensbliblock00Kernel067_h[18][0] || ydim18 != dims_opensbliblock00Kernel067_h[18][1] || xdim19 != dims_opensbliblock00Kernel067_h[19][0] || ydim19 != dims_opensbliblock00Kernel067_h[19][1] || xdim20 != dims_opensbliblock00Kernel067_h[20][0] || ydim20 != dims_opensbliblock00Kernel067_h[20][1] || xdim21 != dims_opensbliblock00Kernel067_h[21][0] || ydim21 != dims_opensbliblock00Kernel067_h[21][1]) {
    ...
    dims_opensbliblock00Kernel067_h[8][0] = xdim8;
    dims_opensbliblock00Kernel067_h[8][1] = ydim8;
    dims_opensbliblock00Kernel067_h[9][0] = xdim9;
    dims_opensbliblock00Kernel067_h[9][1] = ydim9;
    dims_opensbliblock00Kernel067_h[10][0] = xdim10;
    dims_opensbliblock00Kernel067_h[10][1] = ydim10;
    dims_opensbliblock00Kernel067_h[11][0] = xdim11;
    dims_opensbliblock00Kernel067_h[11][1] = ydim11;
    dims_opensbliblock00Kernel067_h[12][0] = xdim12;
    dims_opensbliblock00Kernel067_h[12][1] = ydim12;
    dims_opensbliblock00Kernel067_h[13][0] = xdim13;
    dims_opensbliblock00Kernel067_h[13][1] = ydim13;
    dims_opensbliblock00Kernel067_h[14][0] = xdim14;
    dims_opensbliblock00Kernel067_h[14][1] = ydim14;
    dims_opensbliblock00Kernel067_h[15][0] = xdim15;
    dims_opensbliblock00Kernel067_h[15][1] = ydim15;
    dims_opensbliblock00Kernel067_h[16][0] = xdim16;
    dims_opensbliblock00Kernel067_h[16][1] = ydim16;
    dims_opensbliblock00Kernel067_h[17][0] = xdim17;
    dims_opensbliblock00Kernel067_h[17][1] = ydim17;
    dims_opensbliblock00Kernel067_h[18][0] = xdim18;
    dims_opensbliblock00Kernel067_h[18][1] = ydim18;
    dims_opensbliblock00Kernel067_h[19][0] = xdim19;
    dims_opensbliblock00Kernel067_h[19][1] = ydim19;
    dims_opensbliblock00Kernel067_h[20][0] = xdim20;
    dims_opensbliblock00Kernel067_h[20][1] = ydim20;
    dims_opensbliblock00Kernel067_h[21][0] = xdim21;
    dims_opensbliblock00Kernel067_h[21][1] = ydim21;
...
void ops_par_loop_opensbliblock00Kernel067(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg20, ops_arg arg21, ops_arg arg22) {
  ...
  create_kerneldesc_and_enque(name, args, 23, 39, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel067_execute);
}
#endif
