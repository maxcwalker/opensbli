...
//
__constant__ int dims_opensbliblock00Kernel063 [15][2];
static int dims_opensbliblock00Kernel063_h [15][2] = {{0}};

//user function
__device__

 void opensbliblock00Kernel063_gpu(ACC<double> &Residual0_B0,
...
int size2 ){
  ...
  arg8 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel063[8][0] + idx_z * 1*1 * dims_opensbliblock00Kernel063[8][0] * dims_opensbliblock00Kernel063[8][1];
  arg9 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel063[9][0] + idx_z * 1*1 * dims_opensbliblock00Kernel063[9][0] * dims_opensbliblock00Kernel063[9][1];
  arg10 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel063[10][0] + idx_z * 1*1 * dims_opensbliblock00Kernel063[10][0] * dims_opensbliblock00Kernel063[10][1];
  arg11 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel063[11][0] + idx_z * 1*1 * dims_opensbliblock00Kernel063[11][0] * dims_opensbliblock00Kernel063[11][1];
  arg12 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel063[12][0] + idx_z * 1*1 * dims_opensbliblock00Kernel063[12][0] * dims_opensbliblock00Kernel063[12][1];
  arg13 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel063[13][0] + idx_z * 1*1 * dims_opensbliblock00Kernel063[13][0] * dims_opensbliblock00Kernel063[13][1];
  arg14 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel063[14][0] + idx_z * 1*1 * dims_opensbliblock00Kernel063[14][0] * dims_opensbliblock00Kernel063[14][1];

  if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
    ACC<double> argp0(dims_opensbliblock00Kernel063[0][0], dims_opensbliblock00Kernel063[0][1], arg0);
    ACC<double> argp1(dims_opensbliblock00Kernel063[1][0], dims_opensbliblock00Kernel063[1][1], arg1);
    ...
    ACC<double> argp8(dims_opensbliblock00Kernel063[8][0], dims_opensbliblock00Kernel063[8][1], arg8);
    ACC<double> argp9(dims_opensbliblock00Kernel063[9][0], dims_opensbliblock00Kernel063[9][1], arg9);
    ACC<double> argp10(dims_opensbliblock00Kernel063[10][0], dims_opensbliblock00Kernel063[10][1], arg10);
    ACC<double> argp11(dims_opensbliblock00Kernel063[11][0], dims_opensbliblock00Kernel063[11][1], arg11);
    ACC<double> argp12(dims_opensbliblock00Kernel063[12][0], dims_opensbliblock00Kernel063[12][1], arg12);
    ACC<double> argp13(dims_opensbliblock00Kernel063[13][0], dims_opensbliblock00Kernel063[13][1], arg13);
    ACC<double> argp14(dims_opensbliblock00Kernel063[14][0], dims_opensbliblock00Kernel063[14][1], arg14);
...
void ops_par_loop_opensbliblock00Kernel063_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_opensbliblock00Kernel063_h[0][0] || ydim0 != dims_opensbliblock00Kernel063_h[0][1] || xdim1 != dims_opensbliblock00Kernel063_h[1][0] || ydim1 != dims_opensbliblock00Kernel063_h[1][1] || xdim2 != dims_opensbliblock00Kernel063_h[2][0] || ydim2 != dims_opensbliblock00Kernel063_h[2][1] || xdim3 != dims_opensbliblock00Kernel063_h[3][0] || ydim3 != dims_opensbliblock00Kernel063_h[3][1] || xdim4 != dims_opensbliblock00Kernel063_h[4][0] || ydim4 != dims_opensbliblock00Kernel063_h[4][1] || xdim5 != dims_opensbliblock00Kernel063_h[5][0] || ydim5 != dims_opensbliblock00Kernel063_h[5][1] || xdim6 != dims_opensbliblock00Kernel063_h[6][0] || ydim6 != dims_opensbliblock00Kernel063_h[6][1] || xdim7 != dims_opensbliblock00Kernel063_h[7][0] || ydim7 != dims_opensbliblock00Kernel063_h[7][1] || xdim8 != dims_opensbliblock00Kernel063_h[8][0] || ydim8 != dims_opensbliblock00Kernel063_h[8][1] || xdim9 != dims_opensbliblock00Kernel063_h[9][0] || ydim9 != dims_opensbliblock00Kernel063_h[9][1] || xdim10 != dims_opensbliblock00Kernel063_h[10][0] || ydim10 != dims_opensbliblock00Kernel063_h[10][1] || xdim11 != dims_opensbliblock00Kernel063_h[11][0] || ydim11 != dims_opensbliblock00Kernel063_h[11][1] || xdim12 != dims_opensbliblock00Kernel063_h[12][0] || ydim12 != dims_opensbliblock00Kernel063_h[12][1] || xdim13 != dims_opensbliblock00Kernel063_h[13][0] || ydim13 != dims_opensbliblock00Kernel063_h[13][1] || xdim14 != dims_opensbliblock00Kernel063_h[14][0] || ydim14 != dims_opensbliblock00Kernel063_h[14][1]) {
    ...
    dims_opensbliblock00Kernel063_h[8][0] = xdim8;
    dims_opensbliblock00Kernel063_h[8][1] = ydim8;
    dims_opensbliblock00Kernel063_h[9][0] = xdim9;
    dims_opensbliblock00Kernel063_h[9][1] = ydim9;
    dims_opensbliblock00Kernel063_h[10][0] = xdim10;
    dims_opensbliblock00Kernel063_h[10][1] = ydim10;
    dims_opensbliblock00Kernel063_h[11][0] = xdim11;
    dims_opensbliblock00Kernel063_h[11][1] = ydim11;
    dims_opensbliblock00Kernel063_h[12][0] = xdim12;
    dims_opensbliblock00Kernel063_h[12][1] = ydim12;
    dims_opensbliblock00Kernel063_h[13][0] = xdim13;
    dims_opensbliblock00Kernel063_h[13][1] = ydim13;
    dims_opensbliblock00Kernel063_h[14][0] = xdim14;
    dims_opensbliblock00Kernel063_h[14][1] = ydim14;
...
void ops_par_loop_opensbliblock00Kernel063(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg12, ops_arg arg13, ops_arg arg14) {
  ...
  create_kerneldesc_and_enque(name, args, 15, 35, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel063_execute);
}
#endif
