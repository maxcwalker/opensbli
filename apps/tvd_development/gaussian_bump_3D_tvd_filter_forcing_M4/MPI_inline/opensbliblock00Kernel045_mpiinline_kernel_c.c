  ...
  for ( int n_z=0; n_z<z_size; n_z++ ){
    for ( int n_y=0; n_y<y_size; n_y++ ){
      for ( int n_x=0; n_x<x_size; n_x++ ){
        ...
        const ptr_double x0_B0 = { x0_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel045*1 + n_z * xdim0_opensbliblock00Kernel045 * ydim0_opensbliblock00Kernel045*1, xdim0_opensbliblock00Kernel045, ydim0_opensbliblock00Kernel045};
        const ptr_double x1_B0 = { x1_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel045*1 + n_z * xdim1_opensbliblock00Kernel045 * ydim1_opensbliblock00Kernel045*1, xdim1_opensbliblock00Kernel045, ydim1_opensbliblock00Kernel045};
        ptr_double D00_B0 = { D00_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel045*1 + n_z * xdim2_opensbliblock00Kernel045 * ydim2_opensbliblock00Kernel045*1, xdim2_opensbliblock00Kernel045, ydim2_opensbliblock00Kernel045};
        ptr_double D01_B0 = { D01_B0_p + n_x*1 + n_y * xdim3_opensbliblock00Kernel045*1 + n_z * xdim3_opensbliblock00Kernel045 * ydim3_opensbliblock00Kernel045*1, xdim3_opensbliblock00Kernel045, ydim3_opensbliblock00Kernel045};
        ptr_double D10_B0 = { D10_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel045*1 + n_z * xdim4_opensbliblock00Kernel045 * ydim4_opensbliblock00Kernel045*1, xdim4_opensbliblock00Kernel045, ydim4_opensbliblock00Kernel045};
        ptr_double D11_B0 = { D11_B0_p + n_x*1 + n_y * xdim5_opensbliblock00Kernel045*1 + n_z * xdim5_opensbliblock00Kernel045 * ydim5_opensbliblock00Kernel045*1, xdim5_opensbliblock00Kernel045, ydim5_opensbliblock00Kernel045};
        ptr_double detJ_B0 = { detJ_B0_p + n_x*1 + n_y * xdim6_opensbliblock00Kernel045*1 + n_z * xdim6_opensbliblock00Kernel045 * ydim6_opensbliblock00Kernel045*1, xdim6_opensbliblock00Kernel045, ydim6_opensbliblock00Kernel045};
        ptr_double wk0_B0 = { wk0_B0_p + n_x*1 + n_y * xdim7_opensbliblock00Kernel045*1 + n_z * xdim7_opensbliblock00Kernel045 * ydim7_opensbliblock00Kernel045*1, xdim7_opensbliblock00Kernel045, ydim7_opensbliblock00Kernel045};
        ptr_double wk1_B0 = { wk1_B0_p + n_x*1 + n_y * xdim8_opensbliblock00Kernel045*1 + n_z * xdim8_opensbliblock00Kernel045 * ydim8_opensbliblock00Kernel045*1, xdim8_opensbliblock00Kernel045, ydim8_opensbliblock00Kernel045};
        ptr_double wk3_B0 = { wk3_B0_p + n_x*1 + n_y * xdim9_opensbliblock00Kernel045*1 + n_z * xdim9_opensbliblock00Kernel045 * ydim9_opensbliblock00Kernel045*1, xdim9_opensbliblock00Kernel045, ydim9_opensbliblock00Kernel045};
        ptr_double wk4_B0 = { wk4_B0_p + n_x*1 + n_y * xdim10_opensbliblock00Kernel045*1 + n_z * xdim10_opensbliblock00Kernel045 * ydim10_opensbliblock00Kernel045*1, xdim10_opensbliblock00Kernel045, ydim10_opensbliblock00Kernel045};
