...
void opensbliblock00Kernel065_c_wrapper(
  ...
  for ( int n_z=0; n_z<z_size; n_z++ ){
   ...
   double ws_lambda_44 = 0.0;
    if (fmax(OPS_ACC(kappa_B0, 0,2,0), fmax(OPS_ACC(kappa_B0, 0,0,0), fmax(OPS_ACC(kappa_B0, 0,-3,0), fmax(OPS_ACC(kappa_B0, 0,1,0), fmax(OPS_ACC(kappa_B0, 0,-2,0),
      OPS_ACC(kappa_B0, 0,-1,0)))))) > Ducros_check){
