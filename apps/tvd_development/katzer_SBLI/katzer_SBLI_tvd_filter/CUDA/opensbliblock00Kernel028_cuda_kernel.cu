...
//
__constant__ int dims_opensbliblock00Kernel028 [2][1];
static int dims_opensbliblock00Kernel028_h [2][1] = {{0}};

//user function
__device__

void opensbliblock00Kernel028_gpu(ACC<double> &D11_B0,
  ACC<double> &detJ_B0)
{
...
int size1 ){
  ...
  if (idx_x < size0 && idx_y < size1) {
    ACC<double> argp0(dims_opensbliblock00Kernel028[0][0], arg0);
...
void ops_par_loop_opensbliblock00Kernel028(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1) {
  ...
  create_kerneldesc_and_enque(name, args, 2, 2, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel028_execute);
}
#endif
