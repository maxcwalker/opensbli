...
//
__constant__ int dims_opensbliblock00Kernel038 [14][1];
static int dims_opensbliblock00Kernel038_h [14][1] = {0};

//user function
__device__

 void opensbliblock00Kernel038_gpu(const ACC<double> &D11_B0,
...
int size1 ){
  ...
  arg12 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel038[12][0];
  ...
  if (idx_x < size0 && idx_y < size1) {
    ...
    const ACC<double> argp4(dims_opensbliblock00Kernel038[4][0], arg4);
    const ACC<double> argp5(dims_opensbliblock00Kernel038[5][0], arg5);
    const ACC<double> argp6(dims_opensbliblock00Kernel038[6][0], arg6);
    const ACC<double> argp7(dims_opensbliblock00Kernel038[7][0], arg7);
    const ACC<double> argp8(dims_opensbliblock00Kernel038[8][0], arg8);
    ...
    ACC<double> argp12(dims_opensbliblock00Kernel038[12][0], arg12);
...
void ops_par_loop_opensbliblock00Kernel038_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_opensbliblock00Kernel038_h[0][0] || xdim1 != dims_opensbliblock00Kernel038_h[1][0] || xdim2 != dims_opensbliblock00Kernel038_h[2][0] || xdim3 != dims_opensbliblock00Kernel038_h[3][0] || xdim4 != dims_opensbliblock00Kernel038_h[4][0] || xdim5 != dims_opensbliblock00Kernel038_h[5][0] || xdim6 != dims_opensbliblock00Kernel038_h[6][0] || xdim7 != dims_opensbliblock00Kernel038_h[7][0] || xdim8 != dims_opensbliblock00Kernel038_h[8][0] || xdim9 != dims_opensbliblock00Kernel038_h[9][0] || xdim10 != dims_opensbliblock00Kernel038_h[10][0] || xdim11 != dims_opensbliblock00Kernel038_h[11][0] || xdim12 != dims_opensbliblock00Kernel038_h[12][0]) {
    ...
    dims_opensbliblock00Kernel038_h[12][0] = xdim12;
  ...
  if (x_size > 0 && y_size > 0)
    ops_opensbliblock00Kernel038<<<grid, tblock >>> (  (double *)p_a[0], (double *)p_a[1],
         ...
         (double *)p_a[12], arg_idx[0], arg_idx[1],x_size, y_size);
