...
int size, char *dat, char const *name){
  ...
  if (!strcmp(name,"Lx1")) {
    cutilSafeCall(instance->ostream(),cudaMemcpyToSymbol(Lx1, dat, dim*size));
  }
  else
  if (!strcmp(name,"Minf")) {
  ...
  if (!strcmp(name,"by")) {
    cutilSafeCall(instance->ostream(),cudaMemcpyToSymbol(by, dat, dim*size));
  }
  else
  ...
  if (!strcmp(name,"invLx1")) {
    cutilSafeCall(instance->ostream(),cudaMemcpyToSymbol(invLx1, dat, dim*size));
  }
  else
