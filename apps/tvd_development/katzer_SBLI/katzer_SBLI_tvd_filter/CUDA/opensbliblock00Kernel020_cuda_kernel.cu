...
//
__constant__ int dims_opensbliblock00Kernel020 [16][1];
static int dims_opensbliblock00Kernel020_h [16][1] = {{0}};
...
void ops_par_loop_opensbliblock00Kernel020(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg12, ops_arg arg13, ops_arg arg14, ops_arg arg15) {
  ...
  create_kerneldesc_and_enque(name, args, 16, 23, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel020_execute);
}
#endif
