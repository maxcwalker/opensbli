...
__device__
 ...
 void opensbliblock00Kernel042_gpu(const ACC<double> &D11_B0,
...
int size1 ){
  ...
  if (idx_x < size0 && idx_y < size1) {
    ...
    ACC<double> argp10(dims_opensbliblock00Kernel042[10][0], arg10);
    ACC<double> argp11(dims_opensbliblock00Kernel042[11][0], arg11);
...
void ops_par_loop_opensbliblock00Kernel042(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg12, ops_arg arg13, ops_arg arg14, ops_arg arg15) {
  ...
  create_kerneldesc_and_enque(name, args, 16, 31, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel042_execute);
}
#endif
