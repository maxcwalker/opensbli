...
int size1 ){
  ...
  if (idx_x < size0 && idx_y < size1) {
    ...
    ACC<double> argp1(dims_opensbliblock00Kernel010[1][0], arg1);
    opensbliblock00Kernel010_gpu(argp0, argp1, arg_idx);
  }
...
void ops_par_loop_opensbliblock00Kernel010_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_opensbliblock00Kernel010_h[0][0] || xdim1 != dims_opensbliblock00Kernel010_h[1][0]) {
