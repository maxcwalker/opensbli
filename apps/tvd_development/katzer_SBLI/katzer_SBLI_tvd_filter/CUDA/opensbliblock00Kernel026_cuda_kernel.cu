...
void opensbliblock00Kernel026_gpu(ACC<double> &D11_B0,
  ACC<double> &detJ_B0)
{
...
void ops_par_loop_opensbliblock00Kernel026(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1) {
  ...
  create_kerneldesc_and_enque(name, args, 2, 3, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel026_execute);
}
#endif
