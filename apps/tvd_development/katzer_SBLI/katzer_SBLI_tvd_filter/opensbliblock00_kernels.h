...
: (
 ...
 void opensbliblock00Kernel027(const ACC<double> &x1_B0, ACC<double> &D11_B0, ACC<double> &detJ_B0, ACC<double> &wk3_B0,
const int *idx)
{
   double d1_x1_dy = 0.0;
...
void opensbliblock00Kernel033(const ACC<double> &D11_B0, ACC<double> &SD111_B0, const int *idx)
{
...
void opensbliblock00Kernel011(const ACC<double> &T_B0, ACC<double> &wk5_B0, const int *idx)
{
 ...
 void opensbliblock00Kernel019(const ACC<double> &D11_B0, const ACC<double> &p_B0, const ACC<double> &rhoE_B0, const
...
&Residual0_B0, ACC<double> &Residual1_B0, ACC<double> &Residual2_B0, ACC<double> &Residual3_B0, const int *idx)
{
 ...
 void opensbliblock00Kernel020(const ACC<double> &D11_B0, const ACC<double> &SD111_B0, const ACC<double> &T_B0, const
...
&rhou1_RKold_B0, const double *rkA, const double *rkB)
{
 ...
 void opensbliblock00Kernel034(const ACC<double> &rhoE_B0, const ACC<double> &rho_B0, const ACC<double> &rhou0_B0, const
...
&p_B0)
{
 ...
 void opensbliblock00Kernel037(const ACC<double> &D11_B0, const ACC<double> &u0_B0, const ACC<double> &u1_B0,
...
: (
 ...
 void opensbliblock00Kernel038(const ACC<double> &rhoE_B0, const ACC<double> &rho_B0, const ACC<double> &rhou0_B0, const
ACC<double> &rhou1_B0, ACC<double> &a_B0, ACC<double> &u0_B0, ACC<double> &u1_B0, ACC<double> &p_B0)
{
 ...
 void opensbliblock00Kernel039(ACC<double> &Residual0_B0, ACC<double> &Residual1_B0, ACC<double> &Residual2_B0,
ACC<double> &Residual3_B0, ACC<double> &wk0_B0, ACC<double> &wk1_B0, ACC<double> &wk2_B0, ACC<double> &wk3_B0)
{
 ...
 void opensbliblock00Kernel040(const ACC<double> &a_B0, const ACC<double> &detJ_B0, const ACC<double> &rhoE_B0, const
...
: (
 ...
 void opensbliblock00Kernel042(const ACC<double> &D11_B0, const ACC<double> &Residual0_B0, const ACC<double>
