...
void opensbliblock00Kernel037_c_wrapper(
  ...
  for ( int n_y=0; n_y<y_size; n_y++ ){
    for ( int n_x=0; n_x<x_size; n_x++ ){
      const ptr_double a_B0 = { a_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel037*1, xdim0_opensbliblock00Kernel037};
      const ptr_double detJ_B0 = { detJ_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel037*1, xdim1_opensbliblock00Kernel037};
      const ptr_double p_B0 = { p_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel037*1, xdim2_opensbliblock00Kernel037};
      const ptr_double rhoE_B0 = { rhoE_B0_p + n_x*1 + n_y * xdim3_opensbliblock00Kernel037*1, xdim3_opensbliblock00Kernel037};
      const ptr_double rho_B0 = { rho_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel037*1, xdim4_opensbliblock00Kernel037};
      const ptr_double rhou0_B0 = { rhou0_B0_p + n_x*1 + n_y * xdim5_opensbliblock00Kernel037*1, xdim5_opensbliblock00Kernel037};
      const ptr_double rhou1_B0 = { rhou1_B0_p + n_x*1 + n_y * xdim6_opensbliblock00Kernel037*1, xdim6_opensbliblock00Kernel037};
      const ptr_double u0_B0 = { u0_B0_p + n_x*1 + n_y * xdim7_opensbliblock00Kernel037*1, xdim7_opensbliblock00Kernel037};
      const ptr_double u1_B0 = { u1_B0_p + n_x*1 + n_y * xdim8_opensbliblock00Kernel037*1, xdim8_opensbliblock00Kernel037};
      ptr_double Residual0_B0 = { Residual0_B0_p + n_x*1 + n_y * xdim9_opensbliblock00Kernel037*1, xdim9_opensbliblock00Kernel037};
      ptr_double Residual1_B0 = { Residual1_B0_p + n_x*1 + n_y * xdim10_opensbliblock00Kernel037*1, xdim10_opensbliblock00Kernel037};
      ptr_double Residual2_B0 = { Residual2_B0_p + n_x*1 + n_y * xdim11_opensbliblock00Kernel037*1, xdim11_opensbliblock00Kernel037};
      ptr_double Residual3_B0 = { Residual3_B0_p + n_x*1 + n_y * xdim12_opensbliblock00Kernel037*1, xdim12_opensbliblock00Kernel037};
   ...
   AVG_1_1_LEV_33 = 0.707106781186547*gamma_m1*inv_AVG_a*inv_AVG_rho;
    ...
    CF_00 = OPS_ACC(p_B0, 0,-2)*AVG_1_1_LEV_02 + OPS_ACC(p_B0, 0,-2)*OPS_ACC(u1_B0, 0,-2)*AVG_1_1_LEV_03 + OPS_ACC(u1_B0, 0,-2)*OPS_ACC(rho_B0, 0,-2)*AVG_1_1_LEV_00
   ...
   CF_10 = (OPS_ACC(rho_B0, 0,-2)*AVG_1_1_LEV_10 + OPS_ACC(rhou0_B0, 0,-2)*AVG_1_1_LEV_11)*OPS_ACC(u1_B0, 0,-2);

    CF_20 = OPS_ACC(p_B0, 0,-2)*AVG_1_1_LEV_22 + OPS_ACC(p_B0, 0,-2)*OPS_ACC(u1_B0, 0,-2)*AVG_1_1_LEV_23 + OPS_ACC(u1_B0, 0,-2)*OPS_ACC(rho_B0, 0,-2)*AVG_1_1_LEV_20
    ...
    CF_30 = OPS_ACC(p_B0, 0,-2)*AVG_1_1_LEV_32 + OPS_ACC(p_B0, 0,-2)*OPS_ACC(u1_B0, 0,-2)*AVG_1_1_LEV_33 + OPS_ACC(u1_B0, 0,-2)*OPS_ACC(rho_B0, 0,-2)*AVG_1_1_LEV_30
   ...
   CS_10 = OPS_ACC(rho_B0, 0,-2)*AVG_1_1_LEV_10 + OPS_ACC(rhou0_B0, 0,-2)*AVG_1_1_LEV_11;
    ...
    CF_01 = OPS_ACC(p_B0, 0,-1)*AVG_1_1_LEV_02 + OPS_ACC(p_B0, 0,-1)*OPS_ACC(u1_B0, 0,-1)*AVG_1_1_LEV_03 + OPS_ACC(u1_B0, 0,-1)*OPS_ACC(rho_B0, 0,-1)*AVG_1_1_LEV_00
   ...
   CF_11 = (OPS_ACC(rho_B0, 0,-1)*AVG_1_1_LEV_10 + OPS_ACC(rhou0_B0, 0,-1)*AVG_1_1_LEV_11)*OPS_ACC(u1_B0, 0,-1);

    CF_21 = OPS_ACC(p_B0, 0,-1)*AVG_1_1_LEV_22 + OPS_ACC(p_B0, 0,-1)*OPS_ACC(u1_B0, 0,-1)*AVG_1_1_LEV_23 + OPS_ACC(u1_B0, 0,-1)*OPS_ACC(rho_B0, 0,-1)*AVG_1_1_LEV_20
    ...
    CF_31 = OPS_ACC(p_B0, 0,-1)*AVG_1_1_LEV_32 + OPS_ACC(p_B0, 0,-1)*OPS_ACC(u1_B0, 0,-1)*AVG_1_1_LEV_33 + OPS_ACC(u1_B0, 0,-1)*OPS_ACC(rho_B0, 0,-1)*AVG_1_1_LEV_30
   ...
   CS_11 = OPS_ACC(rho_B0, 0,-1)*AVG_1_1_LEV_10 + OPS_ACC(rhou0_B0, 0,-1)*AVG_1_1_LEV_11;
    ...
    CF_02 = OPS_ACC(p_B0, 0,0)*AVG_1_1_LEV_02 + OPS_ACC(p_B0, 0,0)*OPS_ACC(u1_B0, 0,0)*AVG_1_1_LEV_03 + OPS_ACC(u1_B0, 0,0)*OPS_ACC(rho_B0, 0,0)*AVG_1_1_LEV_00 +
   ...
   CF_12 = (OPS_ACC(rho_B0, 0,0)*AVG_1_1_LEV_10 + OPS_ACC(rhou0_B0, 0,0)*AVG_1_1_LEV_11)*OPS_ACC(u1_B0, 0,0);

    CF_22 = OPS_ACC(p_B0, 0,0)*AVG_1_1_LEV_22 + OPS_ACC(p_B0, 0,0)*OPS_ACC(u1_B0, 0,0)*AVG_1_1_LEV_23 + OPS_ACC(u1_B0, 0,0)*OPS_ACC(rho_B0, 0,0)*AVG_1_1_LEV_20 +
    ...
    CF_32 = OPS_ACC(p_B0, 0,0)*AVG_1_1_LEV_32 + OPS_ACC(p_B0, 0,0)*OPS_ACC(u1_B0, 0,0)*AVG_1_1_LEV_33 + OPS_ACC(u1_B0, 0,0)*OPS_ACC(rho_B0, 0,0)*AVG_1_1_LEV_30 +
   ...
   CS_12 = OPS_ACC(rho_B0, 0,0)*AVG_1_1_LEV_10 + OPS_ACC(rhou0_B0, 0,0)*AVG_1_1_LEV_11;
    ...
    CF_03 = OPS_ACC(p_B0, 0,1)*AVG_1_1_LEV_02 + OPS_ACC(p_B0, 0,1)*OPS_ACC(u1_B0, 0,1)*AVG_1_1_LEV_03 + OPS_ACC(u1_B0, 0,1)*OPS_ACC(rho_B0, 0,1)*AVG_1_1_LEV_00 +
      OPS_ACC(u1_B0, 0,1)*OPS_ACC(rhoE_B0, 0,1)*AVG_1_1_LEV_03 + OPS_ACC(u1_B0, 0,1)*OPS_ACC(rhou0_B0, 0,1)*AVG_1_1_LEV_01 +
      OPS_ACC(u1_B0, 0,1)*OPS_ACC(rhou1_B0, 0,1)*AVG_1_1_LEV_02;

   CF_13 = (OPS_ACC(rho_B0, 0,1)*AVG_1_1_LEV_10 + OPS_ACC(rhou0_B0, 0,1)*AVG_1_1_LEV_11)*OPS_ACC(u1_B0, 0,1);

    CF_23 = OPS_ACC(p_B0, 0,1)*AVG_1_1_LEV_22 + OPS_ACC(p_B0, 0,1)*OPS_ACC(u1_B0, 0,1)*AVG_1_1_LEV_23 + OPS_ACC(u1_B0, 0,1)*OPS_ACC(rho_B0, 0,1)*AVG_1_1_LEV_20 +
      OPS_ACC(u1_B0, 0,1)*OPS_ACC(rhoE_B0, 0,1)*AVG_1_1_LEV_23 + OPS_ACC(u1_B0, 0,1)*OPS_ACC(rhou0_B0, 0,1)*AVG_1_1_LEV_21 +
      OPS_ACC(u1_B0, 0,1)*OPS_ACC(rhou1_B0, 0,1)*AVG_1_1_LEV_22;

    CF_33 = OPS_ACC(p_B0, 0,1)*AVG_1_1_LEV_32 + OPS_ACC(p_B0, 0,1)*OPS_ACC(u1_B0, 0,1)*AVG_1_1_LEV_33 + OPS_ACC(u1_B0, 0,1)*OPS_ACC(rho_B0, 0,1)*AVG_1_1_LEV_30 +
      OPS_ACC(u1_B0, 0,1)*OPS_ACC(rhoE_B0, 0,1)*AVG_1_1_LEV_33 + OPS_ACC(u1_B0, 0,1)*OPS_ACC(rhou0_B0, 0,1)*AVG_1_1_LEV_31 +
      OPS_ACC(u1_B0, 0,1)*OPS_ACC(rhou1_B0, 0,1)*AVG_1_1_LEV_32;
   ...
   CS_13 = OPS_ACC(rho_B0, 0,1)*AVG_1_1_LEV_10 + OPS_ACC(rhou0_B0, 0,1)*AVG_1_1_LEV_11;
    ...
    CF_04 = OPS_ACC(p_B0, 0,2)*AVG_1_1_LEV_02 + OPS_ACC(p_B0, 0,2)*OPS_ACC(u1_B0, 0,2)*AVG_1_1_LEV_03 + OPS_ACC(u1_B0, 0,2)*OPS_ACC(rho_B0, 0,2)*AVG_1_1_LEV_00 +
      OPS_ACC(u1_B0, 0,2)*OPS_ACC(rhoE_B0, 0,2)*AVG_1_1_LEV_03 + OPS_ACC(u1_B0, 0,2)*OPS_ACC(rhou0_B0, 0,2)*AVG_1_1_LEV_01 +
      OPS_ACC(u1_B0, 0,2)*OPS_ACC(rhou1_B0, 0,2)*AVG_1_1_LEV_02;

   CF_14 = (OPS_ACC(rho_B0, 0,2)*AVG_1_1_LEV_10 + OPS_ACC(rhou0_B0, 0,2)*AVG_1_1_LEV_11)*OPS_ACC(u1_B0, 0,2);

    CF_24 = OPS_ACC(p_B0, 0,2)*AVG_1_1_LEV_22 + OPS_ACC(p_B0, 0,2)*OPS_ACC(u1_B0, 0,2)*AVG_1_1_LEV_23 + OPS_ACC(u1_B0, 0,2)*OPS_ACC(rho_B0, 0,2)*AVG_1_1_LEV_20 +
      OPS_ACC(u1_B0, 0,2)*OPS_ACC(rhoE_B0, 0,2)*AVG_1_1_LEV_23 + OPS_ACC(u1_B0, 0,2)*OPS_ACC(rhou0_B0, 0,2)*AVG_1_1_LEV_21 +
      OPS_ACC(u1_B0, 0,2)*OPS_ACC(rhou1_B0, 0,2)*AVG_1_1_LEV_22;

    CF_34 = OPS_ACC(p_B0, 0,2)*AVG_1_1_LEV_32 + OPS_ACC(p_B0, 0,2)*OPS_ACC(u1_B0, 0,2)*AVG_1_1_LEV_33 + OPS_ACC(u1_B0, 0,2)*OPS_ACC(rho_B0, 0,2)*AVG_1_1_LEV_30 +
      OPS_ACC(u1_B0, 0,2)*OPS_ACC(rhoE_B0, 0,2)*AVG_1_1_LEV_33 + OPS_ACC(u1_B0, 0,2)*OPS_ACC(rhou0_B0, 0,2)*AVG_1_1_LEV_31 +
      OPS_ACC(u1_B0, 0,2)*OPS_ACC(rhou1_B0, 0,2)*AVG_1_1_LEV_32;
   ...
   CS_14 = OPS_ACC(rho_B0, 0,2)*AVG_1_1_LEV_10 + OPS_ACC(rhou0_B0, 0,2)*AVG_1_1_LEV_11;
    ...
    CF_05 = OPS_ACC(p_B0, 0,3)*AVG_1_1_LEV_02 + OPS_ACC(p_B0, 0,3)*OPS_ACC(u1_B0, 0,3)*AVG_1_1_LEV_03 + OPS_ACC(u1_B0, 0,3)*OPS_ACC(rho_B0, 0,3)*AVG_1_1_LEV_00 +
   ...
   CF_15 = (OPS_ACC(rho_B0, 0,3)*AVG_1_1_LEV_10 + OPS_ACC(rhou0_B0, 0,3)*AVG_1_1_LEV_11)*OPS_ACC(u1_B0, 0,3);

    CF_25 = OPS_ACC(p_B0, 0,3)*AVG_1_1_LEV_22 + OPS_ACC(p_B0, 0,3)*OPS_ACC(u1_B0, 0,3)*AVG_1_1_LEV_23 + OPS_ACC(u1_B0, 0,3)*OPS_ACC(rho_B0, 0,3)*AVG_1_1_LEV_20 +
    ...
    CF_35 = OPS_ACC(p_B0, 0,3)*AVG_1_1_LEV_32 + OPS_ACC(p_B0, 0,3)*OPS_ACC(u1_B0, 0,3)*AVG_1_1_LEV_33 + OPS_ACC(u1_B0, 0,3)*OPS_ACC(rho_B0, 0,3)*AVG_1_1_LEV_30 +
   ...
   max_lambda_00 = shock_filter_control*fmax(fabs(OPS_ACC(u1_B0, 0,0)*OPS_ACC(detJ_B0, 0,0)), fabs(OPS_ACC(u1_B0, 0,1)*OPS_ACC(detJ_B0, 0,1)));

   max_lambda_11 = max_lambda_00;

    max_lambda_22 = shock_filter_control*fmax(fabs(OPS_ACC(a_B0, 0,0)*OPS_ACC(detJ_B0, 0,0) + OPS_ACC(u1_B0, 0,0)*OPS_ACC(detJ_B0, 0,0)),
      fabs(OPS_ACC(a_B0, 0,1)*OPS_ACC(detJ_B0, 0,1) + OPS_ACC(u1_B0, 0,1)*OPS_ACC(detJ_B0, 0,1)));

    max_lambda_33 = shock_filter_control*fmax(fabs(OPS_ACC(a_B0, 0,1)*OPS_ACC(detJ_B0, 0,1) - OPS_ACC(u1_B0, 0,1)*OPS_ACC(detJ_B0, 0,1)),
      fabs(OPS_ACC(a_B0, 0,0)*OPS_ACC(detJ_B0, 0,0) - OPS_ACC(u1_B0, 0,0)*OPS_ACC(detJ_B0, 0,0)));
