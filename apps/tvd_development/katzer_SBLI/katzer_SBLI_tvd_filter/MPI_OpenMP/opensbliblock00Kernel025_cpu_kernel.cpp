...
void ops_par_loop_opensbliblock00Kernel025_execute(ops_kernel_descriptor *desc) {
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
      ...
      ACC<double> x0_B0(xdim4_opensbliblock00Kernel025, x0_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel025*1);
      ACC<double> x1_B0(xdim5_opensbliblock00Kernel025, x1_B0_p + n_x*1 + n_y * xdim5_opensbliblock00Kernel025*1);
...
void ops_par_loop_opensbliblock00Kernel025(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4, ops_arg arg5, ops_arg arg6) {
  ...
  create_kerneldesc_and_enque(name, args, 7, 0, dim, 0, range, block, ops_par_loop_opensbliblock00Kernel025_execute);
}
#endif
