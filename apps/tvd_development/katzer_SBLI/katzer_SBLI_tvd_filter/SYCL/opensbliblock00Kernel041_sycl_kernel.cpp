  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      , [=](cl::sycl::nd_item<2> item
        ...
        ACC<double> Residual0_B0(xdim8_opensbliblock00Kernel041, &Residual0_B0_p[0] + base8 + n_x*1 + n_y * xdim8_opensbliblock00Kernel041*1);
        ACC<double> Residual1_B0(xdim9_opensbliblock00Kernel041, &Residual1_B0_p[0] + base9 + n_x*1 + n_y * xdim9_opensbliblock00Kernel041*1);
        ACC<double> Residual2_B0(xdim10_opensbliblock00Kernel041, &Residual2_B0_p[0] + base10 + n_x*1 + n_y * xdim10_opensbliblock00Kernel041*1);
        ACC<double> Residual3_B0(xdim11_opensbliblock00Kernel041, &Residual3_B0_p[0] + base11 + n_x*1 + n_y * xdim11_opensbliblock00Kernel041*1);
        //USER CODE
