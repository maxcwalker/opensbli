  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      , [=](cl::sycl::nd_item<2> item
        ...
        const ACC<double> u0_B0(xdim0_opensbliblock00Kernel000, &u0_B0_p[0] + base0 + n_x*1 + n_y * xdim0_opensbliblock00Kernel000*1);
        ACC<double> wk0_B0(xdim1_opensbliblock00Kernel000, &wk0_B0_p[0] + base1 + n_x*1 + n_y * xdim1_opensbliblock00Kernel000*1);
        //USER CODE
