...
void ops_par_loop_opensbliblock00Kernel036_execute(ops_kernel_descriptor *desc) {
 ...
 arg10, arg11, arg12};
  ...
  if (!ops_checkpointing_before(args,13,range,26)) return;
  #endif

  if (block->instance->OPS_diags > 1) {
    ops_timing_realloc(block->instance,26,"opensbliblock00Kernel036");
  ...
  int xdim2_opensbliblock00Kernel036 = args[2].dat->size[0];
  int xdim3_opensbliblock00Kernel036 = args[3].dat->size[0];
  int xdim4_opensbliblock00Kernel036 = args[4].dat->size[0];
  int xdim5_opensbliblock00Kernel036 = args[5].dat->size[0];
  int xdim6_opensbliblock00Kernel036 = args[6].dat->size[0];
  int xdim7_opensbliblock00Kernel036 = args[7].dat->size[0];
  int xdim8_opensbliblock00Kernel036 = args[8].dat->size[0];
  int xdim9_opensbliblock00Kernel036 = args[9].dat->size[0];
  int xdim10_opensbliblock00Kernel036 = args[10].dat->size[0];
  int xdim11_opensbliblock00Kernel036 = args[11].dat->size[0];
  int xdim12_opensbliblock00Kernel036 = args[12].dat->size[0];
  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      cgh.parallel_for<class opensbliblock00Kernel036_kernel>(cl::sycl::nd_range<2>(cl::sycl::range<2>(
      ...
      , [=](cl::sycl::nd_item<2> item
        ...
        const ACC<double> a_B0(xdim0_opensbliblock00Kernel036, &a_B0_p[0] + base0 + n_x*1 + n_y * xdim0_opensbliblock00Kernel036*1);
        const ACC<double> detJ_B0(xdim1_opensbliblock00Kernel036, &detJ_B0_p[0] + base1 + n_x*1 + n_y * xdim1_opensbliblock00Kernel036*1);
        const ACC<double> p_B0(xdim2_opensbliblock00Kernel036, &p_B0_p[0] + base2 + n_x*1 + n_y * xdim2_opensbliblock00Kernel036*1);
        const ACC<double> rhoE_B0(xdim3_opensbliblock00Kernel036, &rhoE_B0_p[0] + base3 + n_x*1 + n_y * xdim3_opensbliblock00Kernel036*1);
        const ACC<double> rho_B0(xdim4_opensbliblock00Kernel036, &rho_B0_p[0] + base4 + n_x*1 + n_y * xdim4_opensbliblock00Kernel036*1);
        const ACC<double> rhou0_B0(xdim5_opensbliblock00Kernel036, &rhou0_B0_p[0] + base5 + n_x*1 + n_y * xdim5_opensbliblock00Kernel036*1);
        const ACC<double> rhou1_B0(xdim6_opensbliblock00Kernel036, &rhou1_B0_p[0] + base6 + n_x*1 + n_y * xdim6_opensbliblock00Kernel036*1);
        const ACC<double> u0_B0(xdim7_opensbliblock00Kernel036, &u0_B0_p[0] + base7 + n_x*1 + n_y * xdim7_opensbliblock00Kernel036*1);
        const ACC<double> u1_B0(xdim8_opensbliblock00Kernel036, &u1_B0_p[0] + base8 + n_x*1 + n_y * xdim8_opensbliblock00Kernel036*1);
        ACC<double> wk0_B0(xdim9_opensbliblock00Kernel036, &wk0_B0_p[0] + base9 + n_x*1 + n_y * xdim9_opensbliblock00Kernel036*1);
        ACC<double> wk1_B0(xdim10_opensbliblock00Kernel036, &wk1_B0_p[0] + base10 + n_x*1 + n_y * xdim10_opensbliblock00Kernel036*1);
        ACC<double> wk2_B0(xdim11_opensbliblock00Kernel036, &wk2_B0_p[0] + base11 + n_x*1 + n_y * xdim11_opensbliblock00Kernel036*1);
        ACC<double> wk3_B0(xdim12_opensbliblock00Kernel036, &wk3_B0_p[0] + base12 + n_x*1 + n_y * xdim12_opensbliblock00Kernel036*1);
        //USER CODE
   ...
   max_lambda_00 = shock_filter_control_sycl[0]*cl::sycl::fmax(cl::sycl::fabs(u0_B0(0,0)*detJ_B0(0,0)), cl::sycl::fabs(u0_B0(1,0)*detJ_B0(1,0)));

   max_lambda_11 = max_lambda_00;

    max_lambda_22 = shock_filter_control_sycl[0]*cl::sycl::fmax(cl::sycl::fabs(cl::sycl::sqrt((detJ_B0(0,0)*detJ_B0(0,0)))*a_B0(0,0) +
      u0_B0(0,0)*detJ_B0(0,0)), cl::sycl::fabs(cl::sycl::sqrt((detJ_B0(1,0)*detJ_B0(1,0)))*a_B0(1,0) + u0_B0(1,0)*detJ_B0(1,0)));

    max_lambda_33 = shock_filter_control_sycl[0]*cl::sycl::fmax(cl::sycl::fabs(cl::sycl::sqrt((detJ_B0(0,0)*detJ_B0(0,0)))*a_B0(0,0) -
      u0_B0(0,0)*detJ_B0(0,0)), cl::sycl::fabs(cl::sycl::sqrt((detJ_B0(1,0)*detJ_B0(1,0)))*a_B0(1,0) - u0_B0(1,0)*detJ_B0(1,0)));
