  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      , [=](cl::sycl::nd_item<2> item
        ...
        const ACC<double> T_B0(xdim0_opensbliblock00Kernel016, &T_B0_p[0] + base0 + n_x*1 + n_y * xdim0_opensbliblock00Kernel016*1);
        ACC<double> mu_B0(xdim1_opensbliblock00Kernel016, &mu_B0_p[0] + base1 + n_x*1 + n_y * xdim1_opensbliblock00Kernel016*1);
        //USER CODE
        if (n_x < end_0 && n_y < end_1) {
          
   mu_B0(0,0) = T_B0(0,0)*cl::sycl::sqrt(T_B0(0,0))*(1.0 + SuthT_sycl[0]*invRefT_sycl[0])/(SuthT_sycl[0]*invRefT_sycl[0] + T_B0(0,0));
