...
void ops_par_loop_opensbliblock00Kernel040_execute(ops_kernel_descriptor *desc) {
 ...
 arg10, arg11};
  ...
  int xdim6_opensbliblock00Kernel040 = args[6].dat->size[0];
  int xdim7_opensbliblock00Kernel040 = args[7].dat->size[0];
  int xdim8_opensbliblock00Kernel040 = args[8].dat->size[0];
  int xdim9_opensbliblock00Kernel040 = args[9].dat->size[0];
  int xdim10_opensbliblock00Kernel040 = args[10].dat->size[0];
  int xdim11_opensbliblock00Kernel040 = args[11].dat->size[0];
  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      cgh.parallel_for<class opensbliblock00Kernel040_kernel>(cl::sycl::nd_range<2>(cl::sycl::range<2>(
      ...
      , [=](cl::sycl::nd_item<2> item
        ...
        const ACC<double> a_B0(xdim0_opensbliblock00Kernel040, &a_B0_p[0] + base0 + n_x*1 + n_y * xdim0_opensbliblock00Kernel040*1);
        const ACC<double> detJ_B0(xdim1_opensbliblock00Kernel040, &detJ_B0_p[0] + base1 + n_x*1 + n_y * xdim1_opensbliblock00Kernel040*1);
        const ACC<double> rhoE_B0(xdim2_opensbliblock00Kernel040, &rhoE_B0_p[0] + base2 + n_x*1 + n_y * xdim2_opensbliblock00Kernel040*1);
        const ACC<double> rho_B0(xdim3_opensbliblock00Kernel040, &rho_B0_p[0] + base3 + n_x*1 + n_y * xdim3_opensbliblock00Kernel040*1);
        const ACC<double> rhou0_B0(xdim4_opensbliblock00Kernel040, &rhou0_B0_p[0] + base4 + n_x*1 + n_y * xdim4_opensbliblock00Kernel040*1);
        const ACC<double> rhou1_B0(xdim5_opensbliblock00Kernel040, &rhou1_B0_p[0] + base5 + n_x*1 + n_y * xdim5_opensbliblock00Kernel040*1);
        const ACC<double> u0_B0(xdim6_opensbliblock00Kernel040, &u0_B0_p[0] + base6 + n_x*1 + n_y * xdim6_opensbliblock00Kernel040*1);
        const ACC<double> u1_B0(xdim7_opensbliblock00Kernel040, &u1_B0_p[0] + base7 + n_x*1 + n_y * xdim7_opensbliblock00Kernel040*1);
        ACC<double> wk0_B0(xdim8_opensbliblock00Kernel040, &wk0_B0_p[0] + base8 + n_x*1 + n_y * xdim8_opensbliblock00Kernel040*1);
        ACC<double> wk1_B0(xdim9_opensbliblock00Kernel040, &wk1_B0_p[0] + base9 + n_x*1 + n_y * xdim9_opensbliblock00Kernel040*1);
        ACC<double> wk2_B0(xdim10_opensbliblock00Kernel040, &wk2_B0_p[0] + base10 + n_x*1 + n_y * xdim10_opensbliblock00Kernel040*1);
        ACC<double> wk3_B0(xdim11_opensbliblock00Kernel040, &wk3_B0_p[0] + base11 + n_x*1 + n_y * xdim11_opensbliblock00Kernel040*1);
        //USER CODE
   ...
   ws_lambda_22 = cl::sycl::sqrt((detJ_B0(0,0)*detJ_B0(0,0)))*AVG_0_a + detJ_B0(0,0)*AVG_0_u0;

   ws_lambda_33 = detJ_B0(0,0)*AVG_0_u0 - cl::sycl::sqrt((detJ_B0(0,0)*detJ_B0(0,0)))*AVG_0_a;
   ...
   AVG_0_REV_31 = -AVG_0_rho*AVG_0_u1;
    ...
    AVG_0_REV_32 = 0.707106781186547*(((AVG_0_a*AVG_0_a) + ((1.0/2.0))*((AVG_0_u0*AVG_0_u0) +
      (AVG_0_u1*AVG_0_u1))*gamma_m1_sycl[0])*invgamma_m1_sycl[0] + AVG_0_a*AVG_0_u0)*AVG_0_rho*inv_AVG_a;
