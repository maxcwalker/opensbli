...
void ops_par_loop_opensbliblock00Kernel018_execute(ops_kernel_descriptor *desc) {
  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0) {
   ...
   ub0 = cl::sycl::fabs(rhou0_B0(0,0)/rho_B0(0,0));

   ub1 = cl::sycl::fabs(rhou1_B0(0,0)/rho_B0(0,0));

   pb = (-1 + gama_sycl[0])*(-0.5*((ub0*ub0) + (ub1*ub1))*rhob + rhoE_B0(0,0));

   ab = cl::sycl::sqrt(gama_sycl[0]*pb/rhob);
