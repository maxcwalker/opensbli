  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      , [=](cl::sycl::nd_item<2> item
        ...
        const ACC<double> mu_B0(xdim3_opensbliblock00Kernel017, &mu_B0_p[0] + base3 + n_x*1 + n_y * xdim3_opensbliblock00Kernel017*1);
        const ACC<double> u0_B0(xdim4_opensbliblock00Kernel017, &u0_B0_p[0] + base4 + n_x*1 + n_y * xdim4_opensbliblock00Kernel017*1);
        const ACC<double> u1_B0(xdim5_opensbliblock00Kernel017, &u1_B0_p[0] + base5 + n_x*1 + n_y * xdim5_opensbliblock00Kernel017*1);
        const ACC<double> wk0_B0(xdim6_opensbliblock00Kernel017, &wk0_B0_p[0] + base6 + n_x*1 + n_y * xdim6_opensbliblock00Kernel017*1);
        const ACC<double> wk1_B0(xdim7_opensbliblock00Kernel017, &wk1_B0_p[0] + base7 + n_x*1 + n_y * xdim7_opensbliblock00Kernel017*1);
        const ACC<double> wk2_B0(xdim8_opensbliblock00Kernel017, &wk2_B0_p[0] + base8 + n_x*1 + n_y * xdim8_opensbliblock00Kernel017*1);
        ...
        const ACC<double> wk5_B0(xdim11_opensbliblock00Kernel017, &wk5_B0_p[0] + base11 + n_x*1 + n_y * xdim11_opensbliblock00Kernel017*1);
