...
//
    ...
    void buildOpenCLKernels_opensbliblock00Kernel019(OPS_instance *instance, int xdim0, int xdim1, int xdim2, int xdim3, int xdim4, int xdim5, int xdim6, int xdim7, int xdim8, int xdim9, int xdim10) {
      ...
      if(!isbuilt_opensbliblock00Kernel019) {
        ...
        instance->ostream() <<"Compiling opensbliblock00Kernel019 "<<OCL_FMA<<" source -- start \n";
          ...
          if (pPath!=NULL)
            if(OCL_FMA)
              sprintf(buildOpts,"-cl-mad-enable -DOCL_FMA -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_opensbliblock00Kernel019=%d  -Dxdim1_opensbliblock00Kernel019=%d  -Dxdim2_opensbliblock00Kernel019=%d  -Dxdim3_opensbliblock00Kernel019=%d  -Dxdim4_opensbliblock00Kernel019=%d  -Dxdim5_opensbliblock00Kernel019=%d  -Dxdim6_opensbliblock00Kernel019=%d  -Dxdim7_opensbliblock00Kernel019=%d  -Dxdim8_opensbliblock00Kernel019=%d  -Dxdim9_opensbliblock00Kernel019=%d  -Dxdim10_opensbliblock00Kernel019=%d ", pPath, 32,xdim0,xdim1,xdim2,xdim3,xdim4,xdim5,xdim6,xdim7,xdim8,xdim9,xdim10);
            else
        ...
        instance->opencl_instance->OPS_opencl_core.kernel[22] = clCreateKernel(instance->opencl_instance->OPS_opencl_core.program, "ops_opensbliblock00Kernel019", &ret);
        clSafeCall( ret );
