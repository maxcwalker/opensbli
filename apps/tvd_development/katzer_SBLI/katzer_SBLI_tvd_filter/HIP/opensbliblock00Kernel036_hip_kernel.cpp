...
//
__constant__ int dims_opensbliblock00Kernel036 [13][1];
static int dims_opensbliblock00Kernel036_h [13][1] = {{0}};

//user function
__device__

 void opensbliblock00Kernel036_gpu(const ACC<double> &a_B0,
...
&wk3_B0)
{
   ...
   max_lambda_00 = shock_filter_control*fmax(fabs(u0_B0(1,0)*detJ_B0(1,0)), fabs(u0_B0(0,0)*detJ_B0(0,0)));
...
int size1 ){
  ...
  arg0 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel036[0][0];
  arg1 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel036[1][0];
  arg2 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel036[2][0];
  arg3 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel036[3][0];
  arg4 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel036[4][0];
  arg5 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel036[5][0];
  arg6 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel036[6][0];
  arg7 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel036[7][0];
  arg8 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel036[8][0];
  arg9 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel036[9][0];
  arg10 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel036[10][0];
  arg11 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel036[11][0];
  arg12 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel036[12][0];

  if (idx_x < size0 && idx_y < size1) {
    const ACC<double> argp0(dims_opensbliblock00Kernel036[0][0], arg0);
    const ACC<double> argp1(dims_opensbliblock00Kernel036[1][0], arg1);
    const ACC<double> argp2(dims_opensbliblock00Kernel036[2][0], arg2);
    const ACC<double> argp3(dims_opensbliblock00Kernel036[3][0], arg3);
    const ACC<double> argp4(dims_opensbliblock00Kernel036[4][0], arg4);
    const ACC<double> argp5(dims_opensbliblock00Kernel036[5][0], arg5);
    const ACC<double> argp6(dims_opensbliblock00Kernel036[6][0], arg6);
    const ACC<double> argp7(dims_opensbliblock00Kernel036[7][0], arg7);
    const ACC<double> argp8(dims_opensbliblock00Kernel036[8][0], arg8);
    ACC<double> argp9(dims_opensbliblock00Kernel036[9][0], arg9);
    ACC<double> argp10(dims_opensbliblock00Kernel036[10][0], arg10);
    ACC<double> argp11(dims_opensbliblock00Kernel036[11][0], arg11);
    ACC<double> argp12(dims_opensbliblock00Kernel036[12][0], arg12);
