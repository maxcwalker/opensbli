...
//
__constant__ int dims_opensbliblock00Kernel035 [8][1];
static int dims_opensbliblock00Kernel035_h [8][1] = {{0}};

//user function
__device__

 void opensbliblock00Kernel035_gpu(ACC<double> &Residual0_B0,
...
int size1 ){
  ...
  if (size0==-1) dims_opensbliblock00Kernel035[0][0]=0;


  int idx_y = hipBlockDim_y * hipBlockIdx_y + hipThreadIdx_y;
  int idx_x = hipBlockDim_x * hipBlockIdx_x + hipThreadIdx_x;

  arg0 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel035[0][0];
  arg1 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel035[1][0];
  arg2 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel035[2][0];
  arg3 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel035[3][0];
  arg4 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel035[4][0];
  arg5 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel035[5][0];
  arg6 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel035[6][0];
  arg7 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel035[7][0];

  if (idx_x < size0 && idx_y < size1) {
    ACC<double> argp0(dims_opensbliblock00Kernel035[0][0], arg0);
    ACC<double> argp1(dims_opensbliblock00Kernel035[1][0], arg1);
    ACC<double> argp2(dims_opensbliblock00Kernel035[2][0], arg2);
    ACC<double> argp3(dims_opensbliblock00Kernel035[3][0], arg3);
    ACC<double> argp4(dims_opensbliblock00Kernel035[4][0], arg4);
    ACC<double> argp5(dims_opensbliblock00Kernel035[5][0], arg5);
    ACC<double> argp6(dims_opensbliblock00Kernel035[6][0], arg6);
    ACC<double> argp7(dims_opensbliblock00Kernel035[7][0], arg7);
    opensbliblock00Kernel035_gpu(argp0, argp1, argp2, argp3,
...
void ops_par_loop_opensbliblock00Kernel035_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_opensbliblock00Kernel035_h[0][0] || xdim1 != dims_opensbliblock00Kernel035_h[1][0] || xdim2 != dims_opensbliblock00Kernel035_h[2][0] || xdim3 != dims_opensbliblock00Kernel035_h[3][0] || xdim4 != dims_opensbliblock00Kernel035_h[4][0] || xdim5 != dims_opensbliblock00Kernel035_h[5][0] || xdim6 != dims_opensbliblock00Kernel035_h[6][0] || xdim7 != dims_opensbliblock00Kernel035_h[7][0]) {
    ...
    hipSafeCall(block->instance->ostream(), hipMemcpyToSymbol(HIP_SYMBOL(dims_opensbliblock00Kernel035), dims_opensbliblock00Kernel035_h, sizeof(dims_opensbliblock00Kernel035)));
  }
  ...
  if (x_size > 0 && y_size > 0)
    hipLaunchKernelGGL(ops_opensbliblock00Kernel035,grid ,tblock ,0 ,0 , (double *)p_a[0], (double *)p_a[1],
