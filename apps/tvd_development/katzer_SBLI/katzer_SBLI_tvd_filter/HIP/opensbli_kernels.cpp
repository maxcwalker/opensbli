...
int size, char *dat, char const *name){
  ...
  if (!strcmp(name,"Lx1")) {
    hipSafeCall(instance->ostream(),hipMemcpyToSymbol(HIP_SYMBOL(Lx1), dat, dim*size));
  }
  else
  if (!strcmp(name,"Minf")) {
  ...
  if (!strcmp(name,"by")) {
    hipSafeCall(instance->ostream(),hipMemcpyToSymbol(HIP_SYMBOL(by), dat, dim*size));
  }
  else
  ...
  if (!strcmp(name,"invLx1")) {
    hipSafeCall(instance->ostream(),hipMemcpyToSymbol(HIP_SYMBOL(invLx1), dat, dim*size));
  }
  else
