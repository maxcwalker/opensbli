...
//
__constant__ int dims_opensbliblock00Kernel015 [5][1];
static int dims_opensbliblock00Kernel015_h [5][1] = {{0}};
...
int size1 ){
  ...
  arg3 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel015[3][0];
  arg4 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel015[4][0];
  ...
  if (idx_x < size0 && idx_y < size1) {
    ...
    const ACC<double> argp2(dims_opensbliblock00Kernel015[2][0], arg2);
    const ACC<double> argp3(dims_opensbliblock00Kernel015[3][0], arg3);
    ACC<double> argp4(dims_opensbliblock00Kernel015[4][0], arg4);
...
void ops_par_loop_opensbliblock00Kernel015_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_opensbliblock00Kernel015_h[0][0] || xdim1 != dims_opensbliblock00Kernel015_h[1][0] || xdim2 != dims_opensbliblock00Kernel015_h[2][0] || xdim3 != dims_opensbliblock00Kernel015_h[3][0] || xdim4 != dims_opensbliblock00Kernel015_h[4][0]) {
