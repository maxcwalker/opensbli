...
//
__constant__ int dims_opensbliblock00Kernel043 [14][1];
static int dims_opensbliblock00Kernel043_h [14][1] = {{0}};

//user function
__device__

 void opensbliblock00Kernel043_gpu(const ACC<double> &Residual0_B0,
...
int size1 ){
  ...
  if (idx_x < size0 && idx_y < size1) {
    ...
    ACC<double> argp4(dims_opensbliblock00Kernel043[4][0], arg4);
    ACC<double> argp5(dims_opensbliblock00Kernel043[5][0], arg5);
    ACC<double> argp6(dims_opensbliblock00Kernel043[6][0], arg6);
    ACC<double> argp7(dims_opensbliblock00Kernel043[7][0], arg7);
    ACC<double> argp8(dims_opensbliblock00Kernel043[8][0], arg8);
    ACC<double> argp9(dims_opensbliblock00Kernel043[9][0], arg9);
...
void ops_par_loop_opensbliblock00Kernel043(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg12, ops_arg arg13) {
  ...
  create_kerneldesc_and_enque(name, args, 14, 24, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel043_execute);
}
#endif
