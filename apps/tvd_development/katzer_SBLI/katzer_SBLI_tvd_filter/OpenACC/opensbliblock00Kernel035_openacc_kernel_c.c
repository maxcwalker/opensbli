...
//user function
inline 
 void opensbliblock00Kernel035(ptr_double Residual0_B0,
...
void opensbliblock00Kernel035_c_wrapper(
  ...
  for ( int n_y=0; n_y<y_size; n_y++ ){
    ...
    for ( int n_x=0; n_x<x_size; n_x++ ){
      ptr_double ptr0 = {  p_a0 + n_x*1*1 + n_y*xdim0_opensbliblock00Kernel035*1*1, xdim0_opensbliblock00Kernel035};
      ptr_double ptr1 = {  p_a1 + n_x*1*1 + n_y*xdim1_opensbliblock00Kernel035*1*1, xdim1_opensbliblock00Kernel035};
      ptr_double ptr2 = {  p_a2 + n_x*1*1 + n_y*xdim2_opensbliblock00Kernel035*1*1, xdim2_opensbliblock00Kernel035};
      ptr_double ptr3 = {  p_a3 + n_x*1*1 + n_y*xdim3_opensbliblock00Kernel035*1*1, xdim3_opensbliblock00Kernel035};
