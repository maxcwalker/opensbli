...
//user function
inline 
 void opensbliblock00Kernel037(const ptr_double a_B0,
...
void opensbliblock00Kernel037_c_wrapper(
  ...
  for ( int n_y=0; n_y<y_size; n_y++ ){
    ...
    for ( int n_x=0; n_x<x_size; n_x++ ){
      const ptr_double ptr0 = {  p_a0 + n_x*1*1 + n_y*xdim0_opensbliblock00Kernel037*1*1, xdim0_opensbliblock00Kernel037};
      const ptr_double ptr1 = {  p_a1 + n_x*1*1 + n_y*xdim1_opensbliblock00Kernel037*1*1, xdim1_opensbliblock00Kernel037};
      const ptr_double ptr2 = {  p_a2 + n_x*1*1 + n_y*xdim2_opensbliblock00Kernel037*1*1, xdim2_opensbliblock00Kernel037};
      const ptr_double ptr3 = {  p_a3 + n_x*1*1 + n_y*xdim3_opensbliblock00Kernel037*1*1, xdim3_opensbliblock00Kernel037};
      const ptr_double ptr4 = {  p_a4 + n_x*1*1 + n_y*xdim4_opensbliblock00Kernel037*1*1, xdim4_opensbliblock00Kernel037};
      const ptr_double ptr5 = {  p_a5 + n_x*1*1 + n_y*xdim5_opensbliblock00Kernel037*1*1, xdim5_opensbliblock00Kernel037};
      const ptr_double ptr6 = {  p_a6 + n_x*1*1 + n_y*xdim6_opensbliblock00Kernel037*1*1, xdim6_opensbliblock00Kernel037};
      const ptr_double ptr7 = {  p_a7 + n_x*1*1 + n_y*xdim7_opensbliblock00Kernel037*1*1, xdim7_opensbliblock00Kernel037};
      const ptr_double ptr8 = {  p_a8 + n_x*1*1 + n_y*xdim8_opensbliblock00Kernel037*1*1, xdim8_opensbliblock00Kernel037};
      ptr_double ptr9 = {  p_a9 + n_x*1*1 + n_y*xdim9_opensbliblock00Kernel037*1*1, xdim9_opensbliblock00Kernel037};
      ptr_double ptr10 = {  p_a10 + n_x*1*1 + n_y*xdim10_opensbliblock00Kernel037*1*1, xdim10_opensbliblock00Kernel037};
      ptr_double ptr11 = {  p_a11 + n_x*1*1 + n_y*xdim11_opensbliblock00Kernel037*1*1, xdim11_opensbliblock00Kernel037};
      ptr_double ptr12 = {  p_a12 + n_x*1*1 + n_y*xdim12_opensbliblock00Kernel037*1*1, xdim12_opensbliblock00Kernel037};
