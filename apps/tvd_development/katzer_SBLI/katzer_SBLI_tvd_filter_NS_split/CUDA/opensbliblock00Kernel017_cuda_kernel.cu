...
int size1 ){
  ...
  if (idx_x < size0 && idx_y < size1) {
    ...
    const ACC<double> argp11(dims_opensbliblock00Kernel017[11][0], arg11);
...
void ops_par_loop_opensbliblock00Kernel017(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg12, ops_arg arg13, ops_arg arg14, ops_arg arg15) {
  ...
  create_kerneldesc_and_enque(name, args, 16, 23, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel017_execute);
}
#endif
