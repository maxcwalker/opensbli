  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      , [=](cl::sycl::nd_item<2> item
        ...
        const ACC<double> T_B0(xdim0_opensbliblock00Kernel008, &T_B0_p[0] + base0 + n_x*1 + n_y * xdim0_opensbliblock00Kernel008*1);
        ACC<double> wk5_B0(xdim1_opensbliblock00Kernel008, &wk5_B0_p[0] + base1 + n_x*1 + n_y * xdim1_opensbliblock00Kernel008*1);
        //USER CODE
   ...
   if (idx[1] == 0){
       ...
       wk5_B0(0,0) = (3.0*T_B0(0,1) + 0.333333333333333*T_B0(0,3) - 1.5*T_B0(0,2) -
            1.83333333333333*T_B0(0,0))*invDelta1block0_sycl[0];
       ...
       wk5_B0(0,0) = (0.0394168524399447*T_B0(0,2) + 0.00571369039775442*T_B0(0,4) + 0.719443173328855*T_B0(0,1) -
            0.322484932882161*T_B0(0,0) - 0.0658051057710389*T_B0(0,3) - 0.376283677513354*T_B0(0,-1))*invDelta1block0_sycl[0];
       ...
       wk5_B0(0,0) = (0.197184333887745*T_B0(0,0) + 0.521455851089587*T_B0(0,1) + 0.113446470384241*T_B0(0,-2) -
            ...
            0.791245592765872*T_B0(0,-1))*invDelta1block0_sycl[0];
       ...
       wk5_B0(0,0) = (0.0451033223343881*T_B0(0,0) + 0.652141084861241*T_B0(0,1) + 0.121937153224065*T_B0(0,-2) -
            ...
            0.082033432844602*T_B0(0,2))*invDelta1block0_sycl[0];
       ...
       wk5_B0(0,0) = (1.5*T_B0(0,-2) + 1.83333333333333*T_B0(0,0) - 3.0*T_B0(0,-1) -
            0.333333333333333*T_B0(0,-3))*invDelta1block0_sycl[0];
       ...
       wk5_B0(0,0) = (0.322484932882161*T_B0(0,0) + 0.0658051057710389*T_B0(0,-3) + 0.376283677513354*T_B0(0,1) -
            ...
            0.719443173328855*T_B0(0,-1))*invDelta1block0_sycl[0];
       ...
       wk5_B0(0,0) = (0.00412637789557492*T_B0(0,-3) + 0.0367146847001261*T_B0(0,-2) + 0.791245592765872*T_B0(0,1) -
            0.197184333887745*T_B0(0,0) - 0.521455851089587*T_B0(0,-1) - 0.113446470384241*T_B0(0,2))*invDelta1block0_sycl[0];
       ...
       wk5_B0(0,0) = (0.00932597985049999*T_B0(0,3) + 0.727822147724592*T_B0(0,1) + 0.082033432844602*T_B0(0,-2) -
            0.0451033223343881*T_B0(0,0) - 0.652141084861241*T_B0(0,-1) - 0.121937153224065*T_B0(0,2))*invDelta1block0_sycl[0];
       ...
       wk5_B0(0,0) = (-(2.0/3.0)*T_B0(0,-1) - (1.0/12.0)*T_B0(0,2) + ((1.0/12.0))*T_B0(0,-2) +
            ((2.0/3.0))*T_B0(0,1))*invDelta1block0_sycl[0];
