...
ops_par_loop(opensbliblock00Kernel022, "Similiarity solution laminar boundary-layer initialisation0", opensbliblock00, 2, iteration_range_22_block0,
...
ops_par_loop(opensbliblock00Kernel024, "MetricsEquation evaluation", opensbliblock00, 2, iteration_range_24_block0,
...
int iteration_range_25_block0[] = {0, 1, -2, block0np1 + 2};
ops_par_loop(opensbliblock00Kernel025, "Metric_copy_block0 boundary dir0 side0", opensbliblock00, 2, iteration_range_25_block0,
ops_arg_dat(D11_B0, 1, stencil_0_22_00_4, "double", OPS_RW),
ops_arg_dat(detJ_B0, 1, stencil_0_22_00_4, "double", OPS_RW));

int iteration_range_26_block0[] = {block0np0 - 1, block0np0, -2, block0np1 + 2};
ops_par_loop(opensbliblock00Kernel026, "Metric_copy_block0 boundary dir0 side1", opensbliblock00, 2, iteration_range_26_block0,
ops_arg_dat(D11_B0, 1, stencil_0_22_00_4, "double", OPS_RW),
ops_arg_dat(detJ_B0, 1, stencil_0_22_00_4, "double", OPS_RW));

int iteration_range_27_block0[] = {-2, block0np0 + 2, 0, 1};
ops_par_loop(opensbliblock00Kernel027, "Metric_copy_block0 boundary dir1 side0", opensbliblock00, 2, iteration_range_27_block0,
ops_arg_dat(D11_B0, 1, stencil_0_00_22_4, "double", OPS_RW),
ops_arg_dat(detJ_B0, 1, stencil_0_00_22_4, "double", OPS_RW));

int iteration_range_28_block0[] = {-2, block0np0 + 2, block0np1 - 1, block0np1};
ops_par_loop(opensbliblock00Kernel028, "Metric_copy_block0 boundary dir1 side1", opensbliblock00, 2, iteration_range_28_block0,
ops_arg_dat(D11_B0, 1, stencil_0_00_22_4, "double", OPS_RW),
ops_arg_dat(detJ_B0, 1, stencil_0_00_22_4, "double", OPS_RW));
...
ops_par_loop(opensbliblock00Kernel018, "InletPressureExtrapolate boundary dir0 side0", opensbliblock00, 2, iteration_range_18_block0,
...
ops_par_loop(opensbliblock00Kernel019, "Extrapolation boundary dir0 side1", opensbliblock00, 2, iteration_range_19_block0,
...
ops_par_loop(opensbliblock00Kernel020, "IsothermalWall boundary dir1 side0", opensbliblock00, 2, iteration_range_20_block0,
...
int iteration_range_21_block0[] = {-2, block0np0 + 2, block0np1 - 1, block0np1 + 2};
ops_par_loop(opensbliblock00Kernel021, "Dirichlet boundary dir1 side1", opensbliblock00, 2, iteration_range_21_block0,
ops_arg_dat(rhoE_B0, 1, stencil_0_00_00_2, "double", OPS_WRITE),
ops_arg_dat(rho_B0, 1, stencil_0_00_00_2, "double", OPS_WRITE),
ops_arg_dat(rhou0_B0, 1, stencil_0_00_00_2, "double", OPS_WRITE),
ops_arg_dat(rhou1_B0, 1, stencil_0_00_00_2, "double", OPS_WRITE),
...
ops_par_loop(opensbliblock00Kernel013, "CRmu_B0", opensbliblock00, 2, iteration_range_13_block0,
...
ops_par_loop(opensbliblock00Kernel004, "Derivative evaluation CD T_B0 xi0 ", opensbliblock00, 2, iteration_range_4_block0,
...
ops_par_loop(opensbliblock00Kernel006, "Derivative evaluation CD u0_B0 xi1 ", opensbliblock00, 2, iteration_range_6_block0,
ops_arg_dat(u0_B0, 1, stencil_0_00_44_10, "double", OPS_READ),
ops_arg_dat(wk3_B0, 1, stencil_0_00_00_2, "double", OPS_WRITE),
ops_arg_idx());

int iteration_range_7_block0[] = {0, block0np0, 0, block0np1};
ops_par_loop(opensbliblock00Kernel007, "Derivative evaluation CD u1_B0 xi1 ", opensbliblock00, 2, iteration_range_7_block0,
...
ops_par_loop(opensbliblock00Kernel008, "Derivative evaluation CD T_B0 xi1 ", opensbliblock00, 2, iteration_range_8_block0,
