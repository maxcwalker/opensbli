...
void ops_par_loop_opensbliblock00Kernel017_execute(ops_kernel_descriptor *desc) {
  ...
  for ( int n_y=start1; n_y<end1; n_y++ ){
    for ( int n_x=start0; n_x<end0; n_x++ ){
      ...
      const ACC<double> mu_B0(xdim3_opensbliblock00Kernel017, mu_B0_p + n_x*1 + n_y * xdim3_opensbliblock00Kernel017*1);
      const ACC<double> u0_B0(xdim4_opensbliblock00Kernel017, u0_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel017*1);
      const ACC<double> u1_B0(xdim5_opensbliblock00Kernel017, u1_B0_p + n_x*1 + n_y * xdim5_opensbliblock00Kernel017*1);
      ...
      const ACC<double> wk5_B0(xdim11_opensbliblock00Kernel017, wk5_B0_p + n_x*1 + n_y * xdim11_opensbliblock00Kernel017*1);
...
void ops_par_loop_opensbliblock00Kernel017(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg12, ops_arg arg13, ops_arg arg14, ops_arg arg15) {
  ...
  create_kerneldesc_and_enque(name, args, 16, 23, dim, 0, range, block, ops_par_loop_opensbliblock00Kernel017_execute);
}
#endif
