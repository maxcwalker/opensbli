...
//
    ...
    void buildOpenCLKernels_opensbliblock00Kernel004(OPS_instance *instance, int xdim0, int xdim1) {
      ...
      if(!isbuilt_opensbliblock00Kernel004) {
        ...
        instance->ostream() <<"Compiling opensbliblock00Kernel004 "<<OCL_FMA<<" source -- start \n";
          ...
          if (pPath!=NULL)
            if(OCL_FMA)
              sprintf(buildOpts,"-cl-mad-enable -DOCL_FMA -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_opensbliblock00Kernel004=%d  -Dxdim1_opensbliblock00Kernel004=%d ", pPath, 32,xdim0,xdim1);
            else
              sprintf(buildOpts,"-cl-mad-enable -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_opensbliblock00Kernel004=%d  -Dxdim1_opensbliblock00Kernel004=%d ", pPath, 32,xdim0,xdim1);
          else {
