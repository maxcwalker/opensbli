...
void opensbliblock00Kernel004_gpu(const ACC<double> &T_B0,
  ACC<double> &wk2_B0,
  const int *idx)
{
   if (idx[0] == 0){
...
int size1 ){
  ...
  if (idx_x < size0 && idx_y < size1) {
    ...
    ACC<double> argp1(dims_opensbliblock00Kernel004[1][0], arg1);
...
void ops_par_loop_opensbliblock00Kernel004(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  create_kerneldesc_and_enque(name, args, 3, 17, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel004_execute);
}
#endif
