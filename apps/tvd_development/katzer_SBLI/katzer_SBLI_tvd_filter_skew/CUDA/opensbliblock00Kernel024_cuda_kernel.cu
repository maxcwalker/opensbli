...
__device__
 ...
 void opensbliblock00Kernel024_gpu(const ACC<double> &x1_B0,
  ACC<double> &D11_B0,
  ACC<double> &detJ_B0,
  ACC<double> &wk3_B0,
  const int *idx)
...
void ops_par_loop_opensbliblock00Kernel024(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4) {
  ...
  create_kerneldesc_and_enque(name, args, 5, 1, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel024_execute);
}
#endif
