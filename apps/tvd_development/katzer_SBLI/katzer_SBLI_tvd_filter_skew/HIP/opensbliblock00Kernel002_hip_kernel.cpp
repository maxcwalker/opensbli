...
int size1 ){
  ...
  if (idx_x < size0 && idx_y < size1) {
    ...
    ACC<double> argp1(dims_opensbliblock00Kernel002[1][0], arg1);
...
void ops_par_loop_opensbliblock00Kernel002_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_opensbliblock00Kernel002_h[0][0] || xdim1 != dims_opensbliblock00Kernel002_h[1][0]) {
...
void ops_par_loop_opensbliblock00Kernel002(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  create_kerneldesc_and_enque(name, args, 3, 16, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel002_execute);
}
#endif
