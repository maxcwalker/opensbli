...
//
__constant__ int dims_opensbliblock00Kernel017 [14][1];
static int dims_opensbliblock00Kernel017_h [14][1] = {{0}};

//user function
__device__

 void opensbliblock00Kernel017_gpu(const ACC<double> &D11_B0,
...
int size1 ){
  ...
  if (idx_x < size0 && idx_y < size1) {
    ...
    ACC<double> argp10(dims_opensbliblock00Kernel017[10][0], arg10);
...
void ops_par_loop_opensbliblock00Kernel017(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg12, ops_arg arg13) {
  ...
  create_kerneldesc_and_enque(name, args, 14, 22, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel017_execute);
}
#endif
