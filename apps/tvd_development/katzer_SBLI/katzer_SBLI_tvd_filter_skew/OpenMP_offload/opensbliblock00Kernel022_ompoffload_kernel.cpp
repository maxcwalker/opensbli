...
void ops_par_loop_opensbliblock00Kernel022_execute(ops_kernel_descriptor *desc) {
  ...
  for ( int n_y=start1; n_y<end1; n_y++ ){
    for ( int n_x=start0; n_x<end0; n_x++ ){
      ...
      ACC<double> rhoE_B0(xdim0_opensbliblock00Kernel022, rhoE_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel022*1);
      ACC<double> rho_B0(xdim1_opensbliblock00Kernel022, rho_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel022*1);
      ...
      ACC<double> x0_B0(xdim4_opensbliblock00Kernel022, x0_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel022*1);
      ACC<double> x1_B0(xdim5_opensbliblock00Kernel022, x1_B0_p + n_x*1 + n_y * xdim5_opensbliblock00Kernel022*1);
