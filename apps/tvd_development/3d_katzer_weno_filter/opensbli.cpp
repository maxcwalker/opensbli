...
int iteration_range_49_block0[] = {-3, block0np0 + 4, block0np1 - 1, block0np1, -3, block0np2 + 4};
...
int iteration_range_36_block0[] = {0, 1, -3, block0np1 + 4, -3, block0np2 + 4};
...
int iteration_range_37_block0[] = {block0np0 - 1, block0np0, -3, block0np1 + 4, -3, block0np2 + 4};
...
int iteration_range_38_block0[] = {-3, block0np0 + 4, 0, 1, -3, block0np2 + 4};
ops_par_loop(opensbliblock00Kernel038, "IsothermalWall boundary dir1 side0", opensbliblock00, 3, iteration_range_38_block0,
...
int iteration_range_39_block0[] = {-3, block0np0 + 4, block0np1 - 1, block0np1, -3, block0np2 + 4};
...
ops_par_loop(opensbliblock00Kernel067, "Temporal solution advancement", opensbliblock00, 3, iteration_range_67_block0,
...
int iteration_range_57_block0[] = {-3, block0np0 + 4, -3, block0np1 + 4, -3, block0np2 + 4};
...
int iteration_range_62_block0[] = {-5, block0np0 + 5, -5, block0np1 + 5, -5, block0np2 + 5};
ops_par_loop(opensbliblock00Kernel062, "User kernel: Zero the work arrays", opensbliblock00, 3, iteration_range_62_block0,
ops_arg_dat(Residual0_B0, 1, stencil_0_00_00_00_3, "double", OPS_WRITE),
ops_arg_dat(Residual1_B0, 1, stencil_0_00_00_00_3, "double", OPS_WRITE),
ops_arg_dat(Residual2_B0, 1, stencil_0_00_00_00_3, "double", OPS_WRITE),
ops_arg_dat(Residual3_B0, 1, stencil_0_00_00_00_3, "double", OPS_WRITE),
...
int iteration_range_63_block0[] = {-1, block0np0 + 1, 0, block0np1, 0, block0np2};
ops_par_loop(opensbliblock00Kernel063, "User kernel: WENO reconstruction direction 0", opensbliblock00, 3, iteration_range_63_block0,
...
int iteration_range_64_block0[] = {0, block0np0, -1, block0np1 + 1, 0, block0np2};
ops_par_loop(opensbliblock00Kernel064, "User kernel: WENO reconstruction direction 1", opensbliblock00, 3, iteration_range_64_block0,
...
int iteration_range_65_block0[] = {0, block0np0, 0, block0np1, -1, block0np2 + 1};
ops_par_loop(opensbliblock00Kernel065, "User kernel: WENO reconstruction direction 2", opensbliblock00, 3, iteration_range_65_block0,
...
ops_par_loop(opensbliblock00Kernel066, "User kernel: Non-linear filter application", opensbliblock00, 3, iteration_range_66_block0,
