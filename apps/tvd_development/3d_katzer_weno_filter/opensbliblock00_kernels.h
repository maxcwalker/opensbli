   ...
   double rj4 = 0.0;
    if (fmax(kappa_B0(0,-2,0), fmax(kappa_B0(0,-1,0), fmax(kappa_B0(0,0,0), fmax(kappa_B0(0,1,0), fmax(kappa_B0(0,-3,0),
      ...
      max_lambda_22 = max_lambda_00;
       ...
       max_lambda_44 =
            shock_filter_control*fmax(fabs(-sqrt((D10_B0(0,1,0)*D10_B0(0,1,0))*(detJ_B0(0,1,0)*detJ_B0(0,1,0)) +
            (D11_B0(0,1,0)*D11_B0(0,1,0))*(detJ_B0(0,1,0)*detJ_B0(0,1,0)))*a_B0(0,1,0) +
            u0_B0(0,1,0)*D10_B0(0,1,0)*detJ_B0(0,1,0) + u1_B0(0,1,0)*D11_B0(0,1,0)*detJ_B0(0,1,0)),
...
: (
   1
    ...
    WENO_filter_B0(0,0,0) = ((fmax(kappa_B0(0,-1,0), fmax(kappa_B0(0,0,-1), fmax(kappa_B0(-1,0,0), fmax(kappa_B0(0,0,2),
      fmax(kappa_B0(0,1,0), fmax(kappa_B0(2,0,0), fmax(kappa_B0(0,0,0), fmax(kappa_B0(1,0,0), fmax(kappa_B0(0,0,1),
