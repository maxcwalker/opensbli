...
&Residual3_B0, ACC<double> &Residual4_B0)
{
   ...
   d1_mu_dx = ((1.0/12.0))*(-mu_B0(2,0,0) - 8*mu_B0(-1,0,0) + 8*mu_B0(1,0,0) + mu_B0(-2,0,0))*invDelta0block0;
    ...
    d2_u0_dx = -(1.0/12.0)*(-16*u0_B0(1,0,0) - 16*u0_B0(-1,0,0) + 30*u0_B0(0,0,0) + u0_B0(-2,0,0) +
    ...
    d2_u2_dx = ((1.0/12.0))*(-u2_B0(-2,0,0) - u2_B0(2,0,0) - 30*u2_B0(0,0,0) + 16*u2_B0(1,0,0) +
      16*u2_B0(-1,0,0))*inv2Delta0block0;
   ...
   d1_mu_dy = ((1.0/12.0))*(-mu_B0(0,2,0) - 8*mu_B0(0,-1,0) + 8*mu_B0(0,1,0) + mu_B0(0,-2,0))*invDelta1block0;
    ...
    d2_u0_dy = -(1.0/12.0)*(-16*u0_B0(0,1,0) - 16*u0_B0(0,-1,0) + 30*u0_B0(0,0,0) + u0_B0(0,-2,0) +
    ...
    d2_u2_dy = ((1.0/12.0))*(-u2_B0(0,-2,0) - u2_B0(0,2,0) - 30*u2_B0(0,0,0) + 16*u2_B0(0,1,0) +
      16*u2_B0(0,-1,0))*inv2Delta1block0;
