  ...
  for ( int n_z=0; n_z<z_size; n_z++ ){
    for ( int n_y=0; n_y<y_size; n_y++ ){
      for ( int n_x=0; n_x<x_size; n_x++ ){
        const ptr_double a_B0 = { a_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel046*1 + n_z * xdim0_opensbliblock00Kernel046 * ydim0_opensbliblock00Kernel046*1, xdim0_opensbliblock00Kernel046, ydim0_opensbliblock00Kernel046};
        const ptr_double rhoE_B0 = { rhoE_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel046*1 + n_z * xdim1_opensbliblock00Kernel046 * ydim1_opensbliblock00Kernel046*1, xdim1_opensbliblock00Kernel046, ydim1_opensbliblock00Kernel046};
        const ptr_double rho_B0 = { rho_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel046*1 + n_z * xdim2_opensbliblock00Kernel046 * ydim2_opensbliblock00Kernel046*1, xdim2_opensbliblock00Kernel046, ydim2_opensbliblock00Kernel046};
        const ptr_double rhou0_B0 = { rhou0_B0_p + n_x*1 + n_y * xdim3_opensbliblock00Kernel046*1 + n_z * xdim3_opensbliblock00Kernel046 * ydim3_opensbliblock00Kernel046*1, xdim3_opensbliblock00Kernel046, ydim3_opensbliblock00Kernel046};
        const ptr_double rhou1_B0 = { rhou1_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel046*1 + n_z * xdim4_opensbliblock00Kernel046 * ydim4_opensbliblock00Kernel046*1, xdim4_opensbliblock00Kernel046, ydim4_opensbliblock00Kernel046};
        const ptr_double rhou2_B0 = { rhou2_B0_p + n_x*1 + n_y * xdim5_opensbliblock00Kernel046*1 + n_z * xdim5_opensbliblock00Kernel046 * ydim5_opensbliblock00Kernel046*1, xdim5_opensbliblock00Kernel046, ydim5_opensbliblock00Kernel046};
        const ptr_double u0_B0 = { u0_B0_p + n_x*1 + n_y * xdim6_opensbliblock00Kernel046*1 + n_z * xdim6_opensbliblock00Kernel046 * ydim6_opensbliblock00Kernel046*1, xdim6_opensbliblock00Kernel046, ydim6_opensbliblock00Kernel046};
        const ptr_double u1_B0 = { u1_B0_p + n_x*1 + n_y * xdim7_opensbliblock00Kernel046*1 + n_z * xdim7_opensbliblock00Kernel046 * ydim7_opensbliblock00Kernel046*1, xdim7_opensbliblock00Kernel046, ydim7_opensbliblock00Kernel046};
        const ptr_double u2_B0 = { u2_B0_p + n_x*1 + n_y * xdim8_opensbliblock00Kernel046*1 + n_z * xdim8_opensbliblock00Kernel046 * ydim8_opensbliblock00Kernel046*1, xdim8_opensbliblock00Kernel046, ydim8_opensbliblock00Kernel046};
        ptr_double Residual0_B0 = { Residual0_B0_p + n_x*1 + n_y * xdim9_opensbliblock00Kernel046*1 + n_z * xdim9_opensbliblock00Kernel046 * ydim9_opensbliblock00Kernel046*1, xdim9_opensbliblock00Kernel046, ydim9_opensbliblock00Kernel046};
        ptr_double Residual1_B0 = { Residual1_B0_p + n_x*1 + n_y * xdim10_opensbliblock00Kernel046*1 + n_z * xdim10_opensbliblock00Kernel046 * ydim10_opensbliblock00Kernel046*1, xdim10_opensbliblock00Kernel046, ydim10_opensbliblock00Kernel046};
        ptr_double Residual2_B0 = { Residual2_B0_p + n_x*1 + n_y * xdim11_opensbliblock00Kernel046*1 + n_z * xdim11_opensbliblock00Kernel046 * ydim11_opensbliblock00Kernel046*1, xdim11_opensbliblock00Kernel046, ydim11_opensbliblock00Kernel046};
        ptr_double Residual3_B0 = { Residual3_B0_p + n_x*1 + n_y * xdim12_opensbliblock00Kernel046*1 + n_z * xdim12_opensbliblock00Kernel046 * ydim12_opensbliblock00Kernel046*1, xdim12_opensbliblock00Kernel046, ydim12_opensbliblock00Kernel046};
        ptr_double Residual4_B0 = { Residual4_B0_p + n_x*1 + n_y * xdim13_opensbliblock00Kernel046*1 + n_z * xdim13_opensbliblock00Kernel046 * ydim13_opensbliblock00Kernel046*1, xdim13_opensbliblock00Kernel046, ydim13_opensbliblock00Kernel046};
   ...
   alpha_00 = (-OPS_ACC(rho_B0, 0,-1,0) + OPS_ACC(rho_B0, 0,0,0))*AVG_1_1_LEV_00 + (-OPS_ACC(rhou2_B0, 0,-1,0) + OPS_ACC(rhou2_B0, 0,0,0))*AVG_1_1_LEV_03;
   ...
   alpha_01 = (-OPS_ACC(rho_B0, 0,0,0) + OPS_ACC(rho_B0, 0,1,0))*AVG_1_1_LEV_00 + (-OPS_ACC(rhou2_B0, 0,0,0) + OPS_ACC(rhou2_B0, 0,1,0))*AVG_1_1_LEV_03;
   ...
   alpha_02 = (-OPS_ACC(rho_B0, 0,1,0) + OPS_ACC(rho_B0, 0,2,0))*AVG_1_1_LEV_00 + (-OPS_ACC(rhou2_B0, 0,1,0) + OPS_ACC(rhou2_B0, 0,2,0))*AVG_1_1_LEV_03;
...
: (
   ...
   OPS_ACC(Residual0_B0, 0,0,0) = 0.5*(AVG_1_REV_01*phi_star_1 + AVG_1_REV_03*phi_star_3 + AVG_1_REV_04*phi_star_4);

    OPS_ACC(Residual1_B0, 0,0,0) = 0.5*(AVG_1_REV_11*phi_star_1 + AVG_1_REV_12*phi_star_2 + AVG_1_REV_13*phi_star_3 +
      AVG_1_REV_14*phi_star_4);

   OPS_ACC(Residual2_B0, 0,0,0) = 0.5*(AVG_1_REV_21*phi_star_1 + AVG_1_REV_23*phi_star_3 + AVG_1_REV_24*phi_star_4);
