...
void ops_par_loop_opensbliblock00Kernel029_execute(ops_kernel_descriptor *desc) {
  ...
  double * __restrict__ H_B0_p = (double *)(args[0].data_d + base0);
  ...
  double * __restrict__ Residual0_B0_p = (double *)(args[18].data_d + base18);

  int base19 = args[19].dat->base_offset;
  double * __restrict__ Residual1_B0_p = (double *)(args[19].data_d + base19);

  int base20 = args[20].dat->base_offset;
  double * __restrict__ Residual2_B0_p = (double *)(args[20].data_d + base20);

  int base21 = args[21].dat->base_offset;
  double * __restrict__ Residual3_B0_p = (double *)(args[21].data_d + base21);

  int base22 = args[22].dat->base_offset;
  double * __restrict__ Residual4_B0_p = (double *)(args[22].data_d + base22);
