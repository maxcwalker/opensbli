...
void ops_par_loop_opensbliblock00Kernel047_execute(ops_kernel_descriptor *desc) {
  ...
  double * __restrict__ rho_RKold_B0_p = (double *)(args[10].data_d + base10);

  int base11 = args[11].dat->base_offset;
  double * __restrict__ rhou0_RKold_B0_p = (double *)(args[11].data_d + base11);

  int base12 = args[12].dat->base_offset;
  double * __restrict__ rhou1_RKold_B0_p = (double *)(args[12].data_d + base12);

  int base13 = args[13].dat->base_offset;
  double * __restrict__ rhou2_RKold_B0_p = (double *)(args[13].data_d + base13);
  ...
  for ( int n_z=start2; n_z<end2; n_z++ ){
    for ( int n_y=start1; n_y<end1; n_y++ ){
      for ( int n_x=start0; n_x<end0; n_x++ ){
        const ACC<double> a_B0(xdim0_opensbliblock00Kernel047, ydim0_opensbliblock00Kernel047, a_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel047*1 + n_z * xdim0_opensbliblock00Kernel047 * ydim0_opensbliblock00Kernel047*1);
        const ACC<double> rhoE_B0(xdim1_opensbliblock00Kernel047, ydim1_opensbliblock00Kernel047, rhoE_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel047*1 + n_z * xdim1_opensbliblock00Kernel047 * ydim1_opensbliblock00Kernel047*1);
        const ACC<double> rho_B0(xdim2_opensbliblock00Kernel047, ydim2_opensbliblock00Kernel047, rho_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel047*1 + n_z * xdim2_opensbliblock00Kernel047 * ydim2_opensbliblock00Kernel047*1);
        const ACC<double> rhou0_B0(xdim3_opensbliblock00Kernel047, ydim3_opensbliblock00Kernel047, rhou0_B0_p + n_x*1 + n_y * xdim3_opensbliblock00Kernel047*1 + n_z * xdim3_opensbliblock00Kernel047 * ydim3_opensbliblock00Kernel047*1);
        const ACC<double> rhou1_B0(xdim4_opensbliblock00Kernel047, ydim4_opensbliblock00Kernel047, rhou1_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel047*1 + n_z * xdim4_opensbliblock00Kernel047 * ydim4_opensbliblock00Kernel047*1);
        const ACC<double> rhou2_B0(xdim5_opensbliblock00Kernel047, ydim5_opensbliblock00Kernel047, rhou2_B0_p + n_x*1 + n_y * xdim5_opensbliblock00Kernel047*1 + n_z * xdim5_opensbliblock00Kernel047 * ydim5_opensbliblock00Kernel047*1);
        const ACC<double> u0_B0(xdim6_opensbliblock00Kernel047, ydim6_opensbliblock00Kernel047, u0_B0_p + n_x*1 + n_y * xdim6_opensbliblock00Kernel047*1 + n_z * xdim6_opensbliblock00Kernel047 * ydim6_opensbliblock00Kernel047*1);
        const ACC<double> u1_B0(xdim7_opensbliblock00Kernel047, ydim7_opensbliblock00Kernel047, u1_B0_p + n_x*1 + n_y * xdim7_opensbliblock00Kernel047*1 + n_z * xdim7_opensbliblock00Kernel047 * ydim7_opensbliblock00Kernel047*1);
        const ACC<double> u2_B0(xdim8_opensbliblock00Kernel047, ydim8_opensbliblock00Kernel047, u2_B0_p + n_x*1 + n_y * xdim8_opensbliblock00Kernel047*1 + n_z * xdim8_opensbliblock00Kernel047 * ydim8_opensbliblock00Kernel047*1);
        ACC<double> rhoE_RKold_B0(xdim9_opensbliblock00Kernel047, ydim9_opensbliblock00Kernel047, rhoE_RKold_B0_p + n_x*1 + n_y * xdim9_opensbliblock00Kernel047*1 + n_z * xdim9_opensbliblock00Kernel047 * ydim9_opensbliblock00Kernel047*1);
        ACC<double> rho_RKold_B0(xdim10_opensbliblock00Kernel047, ydim10_opensbliblock00Kernel047, rho_RKold_B0_p + n_x*1 + n_y * xdim10_opensbliblock00Kernel047*1 + n_z * xdim10_opensbliblock00Kernel047 * ydim10_opensbliblock00Kernel047*1);
        ACC<double> rhou0_RKold_B0(xdim11_opensbliblock00Kernel047, ydim11_opensbliblock00Kernel047, rhou0_RKold_B0_p + n_x*1 + n_y * xdim11_opensbliblock00Kernel047*1 + n_z * xdim11_opensbliblock00Kernel047 * ydim11_opensbliblock00Kernel047*1);
        ACC<double> rhou1_RKold_B0(xdim12_opensbliblock00Kernel047, ydim12_opensbliblock00Kernel047, rhou1_RKold_B0_p + n_x*1 + n_y * xdim12_opensbliblock00Kernel047*1 + n_z * xdim12_opensbliblock00Kernel047 * ydim12_opensbliblock00Kernel047*1);
        ACC<double> rhou2_RKold_B0(xdim13_opensbliblock00Kernel047, ydim13_opensbliblock00Kernel047, rhou2_RKold_B0_p + n_x*1 + n_y * xdim13_opensbliblock00Kernel047*1 + n_z * xdim13_opensbliblock00Kernel047 * ydim13_opensbliblock00Kernel047*1);
...
void ops_par_loop_opensbliblock00Kernel047(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg12, ops_arg arg13) {
  ...
  create_kerneldesc_and_enque(name, args, 14, 24, dim, 0, range, block, ops_par_loop_opensbliblock00Kernel047_execute);
}
#endif
