...
void ops_par_loop_opensbliblock00Kernel029_execute(ops_kernel_descriptor *desc) {
  ...
  double * __restrict__ H_B0_p = (double *)(args[0].data + base0);
  ...
  double * __restrict__ wk1_B0_p = (double *)(args[10].data + base10);
  ...
  double * __restrict__ Residual0_B0_p = (double *)(args[18].data + base18);

  int base19 = args[19].dat->base_offset;
  double * __restrict__ Residual1_B0_p = (double *)(args[19].data + base19);

  int base20 = args[20].dat->base_offset;
  double * __restrict__ Residual2_B0_p = (double *)(args[20].data + base20);

  int base21 = args[21].dat->base_offset;
  double * __restrict__ Residual3_B0_p = (double *)(args[21].data + base21);

  int base22 = args[22].dat->base_offset;
  double * __restrict__ Residual4_B0_p = (double *)(args[22].data + base22);
  ...
  for ( int n_z=start[2]; n_z<end[2]; n_z++ ){
    for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
      ...
      for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
        const ACC<double> H_B0(xdim0_opensbliblock00Kernel029, ydim0_opensbliblock00Kernel029, H_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel029*1 + n_z * xdim0_opensbliblock00Kernel029 * ydim0_opensbliblock00Kernel029*1);
        const ACC<double> p_B0(xdim1_opensbliblock00Kernel029, ydim1_opensbliblock00Kernel029, p_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel029*1 + n_z * xdim1_opensbliblock00Kernel029 * ydim1_opensbliblock00Kernel029*1);
        const ACC<double> rho_B0(xdim2_opensbliblock00Kernel029, ydim2_opensbliblock00Kernel029, rho_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel029*1 + n_z * xdim2_opensbliblock00Kernel029 * ydim2_opensbliblock00Kernel029*1);
        const ACC<double> rhou0_B0(xdim3_opensbliblock00Kernel029, ydim3_opensbliblock00Kernel029, rhou0_B0_p + n_x*1 + n_y * xdim3_opensbliblock00Kernel029*1 + n_z * xdim3_opensbliblock00Kernel029 * ydim3_opensbliblock00Kernel029*1);
        const ACC<double> rhou1_B0(xdim4_opensbliblock00Kernel029, ydim4_opensbliblock00Kernel029, rhou1_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel029*1 + n_z * xdim4_opensbliblock00Kernel029 * ydim4_opensbliblock00Kernel029*1);
        const ACC<double> rhou2_B0(xdim5_opensbliblock00Kernel029, ydim5_opensbliblock00Kernel029, rhou2_B0_p + n_x*1 + n_y * xdim5_opensbliblock00Kernel029*1 + n_z * xdim5_opensbliblock00Kernel029 * ydim5_opensbliblock00Kernel029*1);
        const ACC<double> u0_B0(xdim6_opensbliblock00Kernel029, ydim6_opensbliblock00Kernel029, u0_B0_p + n_x*1 + n_y * xdim6_opensbliblock00Kernel029*1 + n_z * xdim6_opensbliblock00Kernel029 * ydim6_opensbliblock00Kernel029*1);
        const ACC<double> u1_B0(xdim7_opensbliblock00Kernel029, ydim7_opensbliblock00Kernel029, u1_B0_p + n_x*1 + n_y * xdim7_opensbliblock00Kernel029*1 + n_z * xdim7_opensbliblock00Kernel029 * ydim7_opensbliblock00Kernel029*1);
        const ACC<double> u2_B0(xdim8_opensbliblock00Kernel029, ydim8_opensbliblock00Kernel029, u2_B0_p + n_x*1 + n_y * xdim8_opensbliblock00Kernel029*1 + n_z * xdim8_opensbliblock00Kernel029 * ydim8_opensbliblock00Kernel029*1);
        const ACC<double> wk0_B0(xdim9_opensbliblock00Kernel029, ydim9_opensbliblock00Kernel029, wk0_B0_p + n_x*1 + n_y * xdim9_opensbliblock00Kernel029*1 + n_z * xdim9_opensbliblock00Kernel029 * ydim9_opensbliblock00Kernel029*1);
        const ACC<double> wk1_B0(xdim10_opensbliblock00Kernel029, ydim10_opensbliblock00Kernel029, wk1_B0_p + n_x*1 + n_y * xdim10_opensbliblock00Kernel029*1 + n_z * xdim10_opensbliblock00Kernel029 * ydim10_opensbliblock00Kernel029*1);
        const ACC<double> wk2_B0(xdim11_opensbliblock00Kernel029, ydim11_opensbliblock00Kernel029, wk2_B0_p + n_x*1 + n_y * xdim11_opensbliblock00Kernel029*1 + n_z * xdim11_opensbliblock00Kernel029 * ydim11_opensbliblock00Kernel029*1);
        const ACC<double> wk3_B0(xdim12_opensbliblock00Kernel029, ydim12_opensbliblock00Kernel029, wk3_B0_p + n_x*1 + n_y * xdim12_opensbliblock00Kernel029*1 + n_z * xdim12_opensbliblock00Kernel029 * ydim12_opensbliblock00Kernel029*1);
        const ACC<double> wk4_B0(xdim13_opensbliblock00Kernel029, ydim13_opensbliblock00Kernel029, wk4_B0_p + n_x*1 + n_y * xdim13_opensbliblock00Kernel029*1 + n_z * xdim13_opensbliblock00Kernel029 * ydim13_opensbliblock00Kernel029*1);
        const ACC<double> wk5_B0(xdim14_opensbliblock00Kernel029, ydim14_opensbliblock00Kernel029, wk5_B0_p + n_x*1 + n_y * xdim14_opensbliblock00Kernel029*1 + n_z * xdim14_opensbliblock00Kernel029 * ydim14_opensbliblock00Kernel029*1);
        const ACC<double> wk6_B0(xdim15_opensbliblock00Kernel029, ydim15_opensbliblock00Kernel029, wk6_B0_p + n_x*1 + n_y * xdim15_opensbliblock00Kernel029*1 + n_z * xdim15_opensbliblock00Kernel029 * ydim15_opensbliblock00Kernel029*1);
        const ACC<double> wk7_B0(xdim16_opensbliblock00Kernel029, ydim16_opensbliblock00Kernel029, wk7_B0_p + n_x*1 + n_y * xdim16_opensbliblock00Kernel029*1 + n_z * xdim16_opensbliblock00Kernel029 * ydim16_opensbliblock00Kernel029*1);
        const ACC<double> wk8_B0(xdim17_opensbliblock00Kernel029, ydim17_opensbliblock00Kernel029, wk8_B0_p + n_x*1 + n_y * xdim17_opensbliblock00Kernel029*1 + n_z * xdim17_opensbliblock00Kernel029 * ydim17_opensbliblock00Kernel029*1);
        ACC<double> Residual0_B0(xdim18_opensbliblock00Kernel029, ydim18_opensbliblock00Kernel029, Residual0_B0_p + n_x*1 + n_y * xdim18_opensbliblock00Kernel029*1 + n_z * xdim18_opensbliblock00Kernel029 * ydim18_opensbliblock00Kernel029*1);
        ACC<double> Residual1_B0(xdim19_opensbliblock00Kernel029, ydim19_opensbliblock00Kernel029, Residual1_B0_p + n_x*1 + n_y * xdim19_opensbliblock00Kernel029*1 + n_z * xdim19_opensbliblock00Kernel029 * ydim19_opensbliblock00Kernel029*1);
        ACC<double> Residual2_B0(xdim20_opensbliblock00Kernel029, ydim20_opensbliblock00Kernel029, Residual2_B0_p + n_x*1 + n_y * xdim20_opensbliblock00Kernel029*1 + n_z * xdim20_opensbliblock00Kernel029 * ydim20_opensbliblock00Kernel029*1);
        ACC<double> Residual3_B0(xdim21_opensbliblock00Kernel029, ydim21_opensbliblock00Kernel029, Residual3_B0_p + n_x*1 + n_y * xdim21_opensbliblock00Kernel029*1 + n_z * xdim21_opensbliblock00Kernel029 * ydim21_opensbliblock00Kernel029*1);
        ACC<double> Residual4_B0(xdim22_opensbliblock00Kernel029, ydim22_opensbliblock00Kernel029, Residual4_B0_p + n_x*1 + n_y * xdim22_opensbliblock00Kernel029*1 + n_z * xdim22_opensbliblock00Kernel029 * ydim22_opensbliblock00Kernel029*1);
...
void ops_par_loop_opensbliblock00Kernel029(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg20, ops_arg arg21, ops_arg arg22) {
  ...
  create_kerneldesc_and_enque(name, args, 23, 17, dim, 0, range, block, ops_par_loop_opensbliblock00Kernel029_execute);
}
#endif
