...
void ops_par_loop_opensbliblock00Kernel042_execute(ops_kernel_descriptor *desc) {
  ...
  double * __restrict__ divV_B0_p = (double *)(args[9].data + base9);
  ...
  #pragma omp parallel for reduction(+:p_a5_0) reduction(+:p_a6_0) reduction(+:p_a7_0) reduction(+:p_a8_0)
  for ( int n_z=start[2]; n_z<end[2]; n_z++ ){
    for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
      #ifdef __INTEL_COMPILER
      #pragma loop_count(10000)
      #pragma omp simd reduction(+:p_a5_0) reduction(+:p_a6_0) reduction(+:p_a7_0) reduction(+:p_a8_0)
