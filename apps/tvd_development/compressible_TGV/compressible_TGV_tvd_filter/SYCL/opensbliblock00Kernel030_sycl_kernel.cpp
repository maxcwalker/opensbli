...
void ops_par_loop_opensbliblock00Kernel030_execute(ops_kernel_descriptor *desc) {
 ...
 arg15, arg16, arg17};
  ...
  double* mu_B0_p = (double*)args[1].data_d;
  ...
  double* wk6_B0_p = (double*)args[11].data_d;

  int base12 = args[12].dat->base_offset/sizeof(double);
  double* wk7_B0_p = (double*)args[12].data_d;

  int base13 = args[13].dat->base_offset/sizeof(double);
  double* wk8_B0_p = (double*)args[13].data_d;
  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0 && (end[2]-start[2])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      , [=](cl::sycl::nd_item<3> item
        ...
        const ACC<double> T_B0(xdim0_opensbliblock00Kernel030, ydim0_opensbliblock00Kernel030, &T_B0_p[0] + base0 + n_x*1 + n_y * xdim0_opensbliblock00Kernel030*1 + n_z * xdim0_opensbliblock00Kernel030 * ydim0_opensbliblock00Kernel030*1);
        const ACC<double> mu_B0(xdim1_opensbliblock00Kernel030, ydim1_opensbliblock00Kernel030, &mu_B0_p[0] + base1 + n_x*1 + n_y * xdim1_opensbliblock00Kernel030*1 + n_z * xdim1_opensbliblock00Kernel030 * ydim1_opensbliblock00Kernel030*1);
        const ACC<double> u0_B0(xdim2_opensbliblock00Kernel030, ydim2_opensbliblock00Kernel030, &u0_B0_p[0] + base2 + n_x*1 + n_y * xdim2_opensbliblock00Kernel030*1 + n_z * xdim2_opensbliblock00Kernel030 * ydim2_opensbliblock00Kernel030*1);
        const ACC<double> u1_B0(xdim3_opensbliblock00Kernel030, ydim3_opensbliblock00Kernel030, &u1_B0_p[0] + base3 + n_x*1 + n_y * xdim3_opensbliblock00Kernel030*1 + n_z * xdim3_opensbliblock00Kernel030 * ydim3_opensbliblock00Kernel030*1);
        const ACC<double> u2_B0(xdim4_opensbliblock00Kernel030, ydim4_opensbliblock00Kernel030, &u2_B0_p[0] + base4 + n_x*1 + n_y * xdim4_opensbliblock00Kernel030*1 + n_z * xdim4_opensbliblock00Kernel030 * ydim4_opensbliblock00Kernel030*1);
        const ACC<double> wk0_B0(xdim5_opensbliblock00Kernel030, ydim5_opensbliblock00Kernel030, &wk0_B0_p[0] + base5 + n_x*1 + n_y * xdim5_opensbliblock00Kernel030*1 + n_z * xdim5_opensbliblock00Kernel030 * ydim5_opensbliblock00Kernel030*1);
        const ACC<double> wk1_B0(xdim6_opensbliblock00Kernel030, ydim6_opensbliblock00Kernel030, &wk1_B0_p[0] + base6 + n_x*1 + n_y * xdim6_opensbliblock00Kernel030*1 + n_z * xdim6_opensbliblock00Kernel030 * ydim6_opensbliblock00Kernel030*1);
        const ACC<double> wk2_B0(xdim7_opensbliblock00Kernel030, ydim7_opensbliblock00Kernel030, &wk2_B0_p[0] + base7 + n_x*1 + n_y * xdim7_opensbliblock00Kernel030*1 + n_z * xdim7_opensbliblock00Kernel030 * ydim7_opensbliblock00Kernel030*1);
        const ACC<double> wk3_B0(xdim8_opensbliblock00Kernel030, ydim8_opensbliblock00Kernel030, &wk3_B0_p[0] + base8 + n_x*1 + n_y * xdim8_opensbliblock00Kernel030*1 + n_z * xdim8_opensbliblock00Kernel030 * ydim8_opensbliblock00Kernel030*1);
        const ACC<double> wk4_B0(xdim9_opensbliblock00Kernel030, ydim9_opensbliblock00Kernel030, &wk4_B0_p[0] + base9 + n_x*1 + n_y * xdim9_opensbliblock00Kernel030*1 + n_z * xdim9_opensbliblock00Kernel030 * ydim9_opensbliblock00Kernel030*1);
        const ACC<double> wk5_B0(xdim10_opensbliblock00Kernel030, ydim10_opensbliblock00Kernel030, &wk5_B0_p[0] + base10 + n_x*1 + n_y * xdim10_opensbliblock00Kernel030*1 + n_z * xdim10_opensbliblock00Kernel030 * ydim10_opensbliblock00Kernel030*1);
        const ACC<double> wk6_B0(xdim11_opensbliblock00Kernel030, ydim11_opensbliblock00Kernel030, &wk6_B0_p[0] + base11 + n_x*1 + n_y * xdim11_opensbliblock00Kernel030*1 + n_z * xdim11_opensbliblock00Kernel030 * ydim11_opensbliblock00Kernel030*1);
        const ACC<double> wk7_B0(xdim12_opensbliblock00Kernel030, ydim12_opensbliblock00Kernel030, &wk7_B0_p[0] + base12 + n_x*1 + n_y * xdim12_opensbliblock00Kernel030*1 + n_z * xdim12_opensbliblock00Kernel030 * ydim12_opensbliblock00Kernel030*1);
        const ACC<double> wk8_B0(xdim13_opensbliblock00Kernel030, ydim13_opensbliblock00Kernel030, &wk8_B0_p[0] + base13 + n_x*1 + n_y * xdim13_opensbliblock00Kernel030*1 + n_z * xdim13_opensbliblock00Kernel030 * ydim13_opensbliblock00Kernel030*1);
        ACC<double> Residual1_B0(xdim14_opensbliblock00Kernel030, ydim14_opensbliblock00Kernel030, &Residual1_B0_p[0] + base14 + n_x*1 + n_y * xdim14_opensbliblock00Kernel030*1 + n_z * xdim14_opensbliblock00Kernel030 * ydim14_opensbliblock00Kernel030*1);
        ACC<double> Residual2_B0(xdim15_opensbliblock00Kernel030, ydim15_opensbliblock00Kernel030, &Residual2_B0_p[0] + base15 + n_x*1 + n_y * xdim15_opensbliblock00Kernel030*1 + n_z * xdim15_opensbliblock00Kernel030 * ydim15_opensbliblock00Kernel030*1);
        ACC<double> Residual3_B0(xdim16_opensbliblock00Kernel030, ydim16_opensbliblock00Kernel030, &Residual3_B0_p[0] + base16 + n_x*1 + n_y * xdim16_opensbliblock00Kernel030*1 + n_z * xdim16_opensbliblock00Kernel030 * ydim16_opensbliblock00Kernel030*1);
        ACC<double> Residual4_B0(xdim17_opensbliblock00Kernel030, ydim17_opensbliblock00Kernel030, &Residual4_B0_p[0] + base17 + n_x*1 + n_y * xdim17_opensbliblock00Kernel030*1 + n_z * xdim17_opensbliblock00Kernel030 * ydim17_opensbliblock00Kernel030*1);
        //USER CODE
   ...
   double d2_u2_dy = 0.0;
   double d2_u2_dz = 0.0;
   d1_T_dx = -(1.0/12.0)*(-T_B0(-2,0,0) - 8*T_B0(1,0,0) + 8*T_B0(-1,0,0) + T_B0(2,0,0))*invDelta0block0_sycl[0];

    d2_T_dx = -(1.0/12.0)*(-16*T_B0(1,0,0) - 16*T_B0(-1,0,0) + 30*T_B0(0,0,0) + T_B0(-2,0,0) +
      T_B0(2,0,0))*inv2Delta0block0_sycl[0];

   d1_mu_dx = ((1.0/12.0))*(-mu_B0(2,0,0) - 8*mu_B0(-1,0,0) + 8*mu_B0(1,0,0) + mu_B0(-2,0,0))*invDelta0block0_sycl[0];

    d2_u0_dx = ((1.0/12.0))*(-u0_B0(-2,0,0) - u0_B0(2,0,0) - 30*u0_B0(0,0,0) + 16*u0_B0(1,0,0) +
      16*u0_B0(-1,0,0))*inv2Delta0block0_sycl[0];

    d2_u1_dx = ((1.0/12.0))*(-u1_B0(-2,0,0) - u1_B0(2,0,0) - 30*u1_B0(0,0,0) + 16*u1_B0(1,0,0) +
      16*u1_B0(-1,0,0))*inv2Delta0block0_sycl[0];

    d2_u2_dx = -(1.0/12.0)*(-16*u2_B0(1,0,0) - 16*u2_B0(-1,0,0) + 30*u2_B0(0,0,0) + u2_B0(-2,0,0) +
      u2_B0(2,0,0))*inv2Delta0block0_sycl[0];

   d1_T_dy = -(1.0/12.0)*(-T_B0(0,-2,0) - 8*T_B0(0,1,0) + 8*T_B0(0,-1,0) + T_B0(0,2,0))*invDelta1block0_sycl[0];

    d2_T_dy = -(1.0/12.0)*(-16*T_B0(0,1,0) - 16*T_B0(0,-1,0) + 30*T_B0(0,0,0) + T_B0(0,-2,0) +
      T_B0(0,2,0))*inv2Delta1block0_sycl[0];

   d1_mu_dy = ((1.0/12.0))*(-mu_B0(0,2,0) - 8*mu_B0(0,-1,0) + 8*mu_B0(0,1,0) + mu_B0(0,-2,0))*invDelta1block0_sycl[0];

    d2_u0_dy = ((1.0/12.0))*(-u0_B0(0,-2,0) - u0_B0(0,2,0) - 30*u0_B0(0,0,0) + 16*u0_B0(0,1,0) +
      16*u0_B0(0,-1,0))*inv2Delta1block0_sycl[0];

    d2_u1_dy = ((1.0/12.0))*(-u1_B0(0,-2,0) - u1_B0(0,2,0) - 30*u1_B0(0,0,0) + 16*u1_B0(0,1,0) +
      16*u1_B0(0,-1,0))*inv2Delta1block0_sycl[0];

    d2_u2_dy = -(1.0/12.0)*(-16*u2_B0(0,1,0) - 16*u2_B0(0,-1,0) + 30*u2_B0(0,0,0) + u2_B0(0,-2,0) +
      u2_B0(0,2,0))*inv2Delta1block0_sycl[0];

   d1_wk0_dy = -(1.0/12.0)*(-wk0_B0(0,-2,0) - 8*wk0_B0(0,1,0) + 8*wk0_B0(0,-1,0) + wk0_B0(0,2,0))*invDelta1block0_sycl[0];

   d1_wk1_dy = -(1.0/12.0)*(-wk1_B0(0,-2,0) - 8*wk1_B0(0,1,0) + 8*wk1_B0(0,-1,0) + wk1_B0(0,2,0))*invDelta1block0_sycl[0];

   d1_T_dz = ((1.0/12.0))*(-T_B0(0,0,2) - 8*T_B0(0,0,-1) + 8*T_B0(0,0,1) + T_B0(0,0,-2))*invDelta2block0_sycl[0];
   ...
   d1_wk5_dz = ((1.0/12.0))*(-wk5_B0(0,0,2) - 8*wk5_B0(0,0,-1) + 8*wk5_B0(0,0,1) + wk5_B0(0,0,-2))*invDelta2block0_sycl[0];
    ...
    Residual1_B0(0,0,0) = (wk1_B0(0,0,0) + wk3_B0(0,0,0))*invRe_sycl[0]*d1_mu_dy + (wk2_B0(0,0,0) +
      wk6_B0(0,0,0))*invRe_sycl[0]*d1_mu_dz + ((1.0/3.0))*(3*d2_u0_dy + 3*d2_u0_dz + 4*d2_u0_dx + d1_wk1_dy +
      d1_wk2_dz)*invRe_sycl[0]*mu_B0(0,0,0) + ((2.0/3.0))*(-wk4_B0(0,0,0) - wk8_B0(0,0,0) + 2*wk0_B0(0,0,0))*invRe_sycl[0]*d1_mu_dx +
      Residual1_B0(0,0,0);

    Residual2_B0(0,0,0) = (wk1_B0(0,0,0) + wk3_B0(0,0,0))*invRe_sycl[0]*d1_mu_dx + (wk5_B0(0,0,0) +
      wk7_B0(0,0,0))*invRe_sycl[0]*d1_mu_dz - (2.0/3.0)*(-2*wk4_B0(0,0,0) + wk0_B0(0,0,0) + wk8_B0(0,0,0))*invRe_sycl[0]*d1_mu_dy +
      ((1.0/3.0))*(3*d2_u1_dx + 3*d2_u1_dz + 4*d2_u1_dy + d1_wk0_dy + d1_wk5_dz)*invRe_sycl[0]*mu_B0(0,0,0) +
      Residual2_B0(0,0,0);

    Residual3_B0(0,0,0) = (wk2_B0(0,0,0) + wk6_B0(0,0,0))*invRe_sycl[0]*d1_mu_dx + (wk5_B0(0,0,0) +
      wk7_B0(0,0,0))*invRe_sycl[0]*d1_mu_dy - (2.0/3.0)*(-2*wk8_B0(0,0,0) + wk0_B0(0,0,0) + wk4_B0(0,0,0))*invRe_sycl[0]*d1_mu_dz +
      ((1.0/3.0))*(3*d2_u2_dx + 3*d2_u2_dy + 4*d2_u2_dz + d1_wk0_dz + d1_wk4_dz)*invRe_sycl[0]*mu_B0(0,0,0) +
      Residual3_B0(0,0,0);

    Residual4_B0(0,0,0) = (wk1_B0(0,0,0) + wk3_B0(0,0,0))*invRe_sycl[0]*mu_B0(0,0,0)*wk1_B0(0,0,0) + (wk1_B0(0,0,0) +
      wk3_B0(0,0,0))*invRe_sycl[0]*mu_B0(0,0,0)*wk3_B0(0,0,0) + (wk1_B0(0,0,0) + wk3_B0(0,0,0))*invRe_sycl[0]*u0_B0(0,0,0)*d1_mu_dy +
      (wk1_B0(0,0,0) + wk3_B0(0,0,0))*invRe_sycl[0]*u1_B0(0,0,0)*d1_mu_dx + (wk2_B0(0,0,0) +
      wk6_B0(0,0,0))*invRe_sycl[0]*mu_B0(0,0,0)*wk2_B0(0,0,0) + (wk2_B0(0,0,0) + wk6_B0(0,0,0))*invRe_sycl[0]*mu_B0(0,0,0)*wk6_B0(0,0,0)
      + (wk2_B0(0,0,0) + wk6_B0(0,0,0))*invRe_sycl[0]*u0_B0(0,0,0)*d1_mu_dz + (wk2_B0(0,0,0) +
      wk6_B0(0,0,0))*invRe_sycl[0]*u2_B0(0,0,0)*d1_mu_dx + (wk5_B0(0,0,0) + wk7_B0(0,0,0))*invRe_sycl[0]*mu_B0(0,0,0)*wk5_B0(0,0,0) +
      (wk5_B0(0,0,0) + wk7_B0(0,0,0))*invRe_sycl[0]*mu_B0(0,0,0)*wk7_B0(0,0,0) + (wk5_B0(0,0,0) +
      wk7_B0(0,0,0))*invRe_sycl[0]*u1_B0(0,0,0)*d1_mu_dz + (wk5_B0(0,0,0) + wk7_B0(0,0,0))*invRe_sycl[0]*u2_B0(0,0,0)*d1_mu_dy -
      (2.0/3.0)*(-2*wk4_B0(0,0,0) + wk0_B0(0,0,0) + wk8_B0(0,0,0))*invRe_sycl[0]*mu_B0(0,0,0)*wk4_B0(0,0,0) -
      (2.0/3.0)*(-2*wk4_B0(0,0,0) + wk0_B0(0,0,0) + wk8_B0(0,0,0))*invRe_sycl[0]*u1_B0(0,0,0)*d1_mu_dy -
      (2.0/3.0)*(-2*wk8_B0(0,0,0) + wk0_B0(0,0,0) + wk4_B0(0,0,0))*invRe_sycl[0]*mu_B0(0,0,0)*wk8_B0(0,0,0) -
      (2.0/3.0)*(-2*wk8_B0(0,0,0) + wk0_B0(0,0,0) + wk4_B0(0,0,0))*invRe_sycl[0]*u2_B0(0,0,0)*d1_mu_dz + ((1.0/3.0))*(3*d2_u0_dy
      + 3*d2_u0_dz + 4*d2_u0_dx + d1_wk1_dy + d1_wk2_dz)*invRe_sycl[0]*mu_B0(0,0,0)*u0_B0(0,0,0) + ((1.0/3.0))*(3*d2_u1_dx +
      3*d2_u1_dz + 4*d2_u1_dy + d1_wk0_dy + d1_wk5_dz)*invRe_sycl[0]*mu_B0(0,0,0)*u1_B0(0,0,0) + ((1.0/3.0))*(3*d2_u2_dx +
      3*d2_u2_dy + 4*d2_u2_dz + d1_wk0_dz + d1_wk4_dz)*invRe_sycl[0]*mu_B0(0,0,0)*u2_B0(0,0,0) + ((2.0/3.0))*(-wk4_B0(0,0,0) -
      wk8_B0(0,0,0) + 2*wk0_B0(0,0,0))*invRe_sycl[0]*mu_B0(0,0,0)*wk0_B0(0,0,0) + ((2.0/3.0))*(-wk4_B0(0,0,0) - wk8_B0(0,0,0) +
      2*wk0_B0(0,0,0))*invRe_sycl[0]*u0_B0(0,0,0)*d1_mu_dx + (d2_T_dx + d2_T_dy +
      d2_T_dz)*invPr_sycl[0]*invRe_sycl[0]*inv2Minf_sycl[0]*inv_gamma_m1_sycl[0]*mu_B0(0,0,0) + invPr_sycl[0]*invRe_sycl[0]*inv2Minf_sycl[0]*inv_gamma_m1_sycl[0]*d1_T_dx*d1_mu_dx +
      invPr_sycl[0]*invRe_sycl[0]*inv2Minf_sycl[0]*inv_gamma_m1_sycl[0]*d1_T_dy*d1_mu_dy + invPr_sycl[0]*invRe_sycl[0]*inv2Minf_sycl[0]*inv_gamma_m1_sycl[0]*d1_T_dz*d1_mu_dz +
      Residual4_B0(0,0,0);
