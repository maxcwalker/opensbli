...
void ops_par_loop_opensbliblock00Kernel037_execute(ops_kernel_descriptor *desc) {
 ...
 arg5, arg6, arg7, arg8};
  ...
  int ydim0_opensbliblock00Kernel037 = args[0].dat->size[1];
  int xdim1_opensbliblock00Kernel037 = args[1].dat->size[0];
  int ydim1_opensbliblock00Kernel037 = args[1].dat->size[1];
  int xdim2_opensbliblock00Kernel037 = args[2].dat->size[0];
  int ydim2_opensbliblock00Kernel037 = args[2].dat->size[1];
  int xdim3_opensbliblock00Kernel037 = args[3].dat->size[0];
  int ydim3_opensbliblock00Kernel037 = args[3].dat->size[1];
  int xdim4_opensbliblock00Kernel037 = args[4].dat->size[0];
  int ydim4_opensbliblock00Kernel037 = args[4].dat->size[1];
  int xdim5_opensbliblock00Kernel037 = args[5].dat->size[0];
  int ydim5_opensbliblock00Kernel037 = args[5].dat->size[1];
  int xdim6_opensbliblock00Kernel037 = args[6].dat->size[0];
  int ydim6_opensbliblock00Kernel037 = args[6].dat->size[1];
  int xdim7_opensbliblock00Kernel037 = args[7].dat->size[0];
  int ydim7_opensbliblock00Kernel037 = args[7].dat->size[1];
  ...
  double* x1_B0_p = (double*)args[6].data_d;

  int base7 = args[7].dat->base_offset/sizeof(double);
  double* x2_B0_p = (double*)args[7].data_d;
  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0 && (end[2]-start[2])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      cgh.parallel_for<class opensbliblock00Kernel037_kernel>(cl::sycl::nd_range<3>(cl::sycl::range<3>(
      ...
      , [=](cl::sycl::nd_item<3> item
        ...
        ACC<double> rhoE_B0(xdim0_opensbliblock00Kernel037, ydim0_opensbliblock00Kernel037, &rhoE_B0_p[0] + base0 + n_x*1 + n_y * xdim0_opensbliblock00Kernel037*1 + n_z * xdim0_opensbliblock00Kernel037 * ydim0_opensbliblock00Kernel037*1);
        ACC<double> rho_B0(xdim1_opensbliblock00Kernel037, ydim1_opensbliblock00Kernel037, &rho_B0_p[0] + base1 + n_x*1 + n_y * xdim1_opensbliblock00Kernel037*1 + n_z * xdim1_opensbliblock00Kernel037 * ydim1_opensbliblock00Kernel037*1);
        ACC<double> rhou0_B0(xdim2_opensbliblock00Kernel037, ydim2_opensbliblock00Kernel037, &rhou0_B0_p[0] + base2 + n_x*1 + n_y * xdim2_opensbliblock00Kernel037*1 + n_z * xdim2_opensbliblock00Kernel037 * ydim2_opensbliblock00Kernel037*1);
        ACC<double> rhou1_B0(xdim3_opensbliblock00Kernel037, ydim3_opensbliblock00Kernel037, &rhou1_B0_p[0] + base3 + n_x*1 + n_y * xdim3_opensbliblock00Kernel037*1 + n_z * xdim3_opensbliblock00Kernel037 * ydim3_opensbliblock00Kernel037*1);
        ACC<double> rhou2_B0(xdim4_opensbliblock00Kernel037, ydim4_opensbliblock00Kernel037, &rhou2_B0_p[0] + base4 + n_x*1 + n_y * xdim4_opensbliblock00Kernel037*1 + n_z * xdim4_opensbliblock00Kernel037 * ydim4_opensbliblock00Kernel037*1);
        ACC<double> x0_B0(xdim5_opensbliblock00Kernel037, ydim5_opensbliblock00Kernel037, &x0_B0_p[0] + base5 + n_x*1 + n_y * xdim5_opensbliblock00Kernel037*1 + n_z * xdim5_opensbliblock00Kernel037 * ydim5_opensbliblock00Kernel037*1);
        ACC<double> x1_B0(xdim6_opensbliblock00Kernel037, ydim6_opensbliblock00Kernel037, &x1_B0_p[0] + base6 + n_x*1 + n_y * xdim6_opensbliblock00Kernel037*1 + n_z * xdim6_opensbliblock00Kernel037 * ydim6_opensbliblock00Kernel037*1);
        ACC<double> x2_B0(xdim7_opensbliblock00Kernel037, ydim7_opensbliblock00Kernel037, &x2_B0_p[0] + base7 + n_x*1 + n_y * xdim7_opensbliblock00Kernel037*1 + n_z * xdim7_opensbliblock00Kernel037 * ydim7_opensbliblock00Kernel037*1);
        //USER CODE
   ...
   u0 = cl::sycl::cos(x1)*cl::sycl::cos(x2)*cl::sycl::sin(x0);

   u1 = -cl::sycl::cos(x0)*cl::sycl::cos(x2)*cl::sycl::sin(x1);

   u2 = 0.0;

   p = (2.0 + cl::sycl::cos(2.0*x2))*(0.0625*cl::sycl::cos(2.0*x0) + 0.0625*cl::sycl::cos(2.0*x1)) + 1.0/((Minf_sycl[0]*Minf_sycl[0])*gama_sycl[0]);

   r = gama_sycl[0]*p*(Minf_sycl[0]*Minf_sycl[0]);
   ...
   rhoE_B0(0,0,0) = p/(-1 + gama_sycl[0]) + 0.5*r*((u0*u0) + (u1*u1) + (u2*u2));
