...
void ops_par_loop_opensbliblock00Kernel046_execute(ops_kernel_descriptor *desc) {
 ...
 arg10, arg11, arg12, arg13};
  ...
  double* Residual0_B0_p = (double*)args[9].data_d;

  int base10 = args[10].dat->base_offset/sizeof(double);
  double* Residual1_B0_p = (double*)args[10].data_d;

  int base11 = args[11].dat->base_offset/sizeof(double);
  double* Residual2_B0_p = (double*)args[11].data_d;

  int base12 = args[12].dat->base_offset/sizeof(double);
  double* Residual3_B0_p = (double*)args[12].data_d;
  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0 && (end[2]-start[2])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      , [=](cl::sycl::nd_item<3> item
        ...
        const ACC<double> a_B0(xdim0_opensbliblock00Kernel046, ydim0_opensbliblock00Kernel046, &a_B0_p[0] + base0 + n_x*1 + n_y * xdim0_opensbliblock00Kernel046*1 + n_z * xdim0_opensbliblock00Kernel046 * ydim0_opensbliblock00Kernel046*1);
        const ACC<double> rhoE_B0(xdim1_opensbliblock00Kernel046, ydim1_opensbliblock00Kernel046, &rhoE_B0_p[0] + base1 + n_x*1 + n_y * xdim1_opensbliblock00Kernel046*1 + n_z * xdim1_opensbliblock00Kernel046 * ydim1_opensbliblock00Kernel046*1);
        const ACC<double> rho_B0(xdim2_opensbliblock00Kernel046, ydim2_opensbliblock00Kernel046, &rho_B0_p[0] + base2 + n_x*1 + n_y * xdim2_opensbliblock00Kernel046*1 + n_z * xdim2_opensbliblock00Kernel046 * ydim2_opensbliblock00Kernel046*1);
        const ACC<double> rhou0_B0(xdim3_opensbliblock00Kernel046, ydim3_opensbliblock00Kernel046, &rhou0_B0_p[0] + base3 + n_x*1 + n_y * xdim3_opensbliblock00Kernel046*1 + n_z * xdim3_opensbliblock00Kernel046 * ydim3_opensbliblock00Kernel046*1);
        const ACC<double> rhou1_B0(xdim4_opensbliblock00Kernel046, ydim4_opensbliblock00Kernel046, &rhou1_B0_p[0] + base4 + n_x*1 + n_y * xdim4_opensbliblock00Kernel046*1 + n_z * xdim4_opensbliblock00Kernel046 * ydim4_opensbliblock00Kernel046*1);
        const ACC<double> rhou2_B0(xdim5_opensbliblock00Kernel046, ydim5_opensbliblock00Kernel046, &rhou2_B0_p[0] + base5 + n_x*1 + n_y * xdim5_opensbliblock00Kernel046*1 + n_z * xdim5_opensbliblock00Kernel046 * ydim5_opensbliblock00Kernel046*1);
        const ACC<double> u0_B0(xdim6_opensbliblock00Kernel046, ydim6_opensbliblock00Kernel046, &u0_B0_p[0] + base6 + n_x*1 + n_y * xdim6_opensbliblock00Kernel046*1 + n_z * xdim6_opensbliblock00Kernel046 * ydim6_opensbliblock00Kernel046*1);
        const ACC<double> u1_B0(xdim7_opensbliblock00Kernel046, ydim7_opensbliblock00Kernel046, &u1_B0_p[0] + base7 + n_x*1 + n_y * xdim7_opensbliblock00Kernel046*1 + n_z * xdim7_opensbliblock00Kernel046 * ydim7_opensbliblock00Kernel046*1);
        const ACC<double> u2_B0(xdim8_opensbliblock00Kernel046, ydim8_opensbliblock00Kernel046, &u2_B0_p[0] + base8 + n_x*1 + n_y * xdim8_opensbliblock00Kernel046*1 + n_z * xdim8_opensbliblock00Kernel046 * ydim8_opensbliblock00Kernel046*1);
        ACC<double> Residual0_B0(xdim9_opensbliblock00Kernel046, ydim9_opensbliblock00Kernel046, &Residual0_B0_p[0] + base9 + n_x*1 + n_y * xdim9_opensbliblock00Kernel046*1 + n_z * xdim9_opensbliblock00Kernel046 * ydim9_opensbliblock00Kernel046*1);
        ACC<double> Residual1_B0(xdim10_opensbliblock00Kernel046, ydim10_opensbliblock00Kernel046, &Residual1_B0_p[0] + base10 + n_x*1 + n_y * xdim10_opensbliblock00Kernel046*1 + n_z * xdim10_opensbliblock00Kernel046 * ydim10_opensbliblock00Kernel046*1);
        ACC<double> Residual2_B0(xdim11_opensbliblock00Kernel046, ydim11_opensbliblock00Kernel046, &Residual2_B0_p[0] + base11 + n_x*1 + n_y * xdim11_opensbliblock00Kernel046*1 + n_z * xdim11_opensbliblock00Kernel046 * ydim11_opensbliblock00Kernel046*1);
        ACC<double> Residual3_B0(xdim12_opensbliblock00Kernel046, ydim12_opensbliblock00Kernel046, &Residual3_B0_p[0] + base12 + n_x*1 + n_y * xdim12_opensbliblock00Kernel046*1 + n_z * xdim12_opensbliblock00Kernel046 * ydim12_opensbliblock00Kernel046*1);
        ACC<double> Residual4_B0(xdim13_opensbliblock00Kernel046, ydim13_opensbliblock00Kernel046, &Residual4_B0_p[0] + base13 + n_x*1 + n_y * xdim13_opensbliblock00Kernel046*1 + n_z * xdim13_opensbliblock00Kernel046 * ydim13_opensbliblock00Kernel046*1);
        //USER CODE
   ...
   AVG_1_1_LEV_03 = -inv_AVG_rho;
    ...
    AVG_1_1_LEV_10 = -(1.0/2.0)*(-2 - (AVG_1_u0*AVG_1_u0)*(inv_AVG_a*inv_AVG_a) -
      ...
      (AVG_1_u0*AVG_1_u0)*(inv_AVG_a*inv_AVG_a)*gama_sycl[0] + (AVG_1_u1*AVG_1_u1)*(inv_AVG_a*inv_AVG_a)*gama_sycl[0] +
      (AVG_1_u2*AVG_1_u2)*(inv_AVG_a*inv_AVG_a)*gama_sycl[0]);

   AVG_1_1_LEV_11 = (inv_AVG_a*inv_AVG_a)*gamma_m1_sycl[0]*AVG_1_u0;

   AVG_1_1_LEV_12 = (inv_AVG_a*inv_AVG_a)*gamma_m1_sycl[0]*AVG_1_u1;

   AVG_1_1_LEV_13 = (inv_AVG_a*inv_AVG_a)*gamma_m1_sycl[0]*AVG_1_u2;

   AVG_1_1_LEV_14 = -(inv_AVG_a*inv_AVG_a)*gamma_m1_sycl[0];
   ...
   AVG_1_1_LEV_31 = -0.707106781186547*gamma_m1_sycl[0]*AVG_1_u0*inv_AVG_a*inv_AVG_rho;

   AVG_1_1_LEV_32 = 0.707106781186547*(-gama_sycl[0]*AVG_1_u1 + AVG_1_a + AVG_1_u1)*inv_AVG_a*inv_AVG_rho;
   ...
   AVG_1_1_LEV_41 = -0.707106781186547*gamma_m1_sycl[0]*AVG_1_u0*inv_AVG_a*inv_AVG_rho;

   AVG_1_1_LEV_42 = -0.707106781186547*(-AVG_1_u1 + gama_sycl[0]*AVG_1_u1 + AVG_1_a)*inv_AVG_a*inv_AVG_rho;
   ...
   AVG_1_REV_42 = AVG_1_rho*AVG_1_u0;
    ...
    AVG_1_REV_43 = 0.707106781186547*(((AVG_1_a*AVG_1_a) + ((1.0/2.0))*((AVG_1_u0*AVG_1_u0) + (AVG_1_u1*AVG_1_u1) +
      (AVG_1_u2*AVG_1_u2))*gamma_m1_sycl[0])*invgamma_m1_sycl[0] + AVG_1_a*AVG_1_u1)*AVG_1_rho*inv_AVG_a;
