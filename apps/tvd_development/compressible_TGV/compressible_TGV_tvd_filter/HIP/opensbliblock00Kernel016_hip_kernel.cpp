...
//
__constant__ int dims_opensbliblock00Kernel016 [4][2];
static int dims_opensbliblock00Kernel016_h [4][2] = {{0}};
...
int size2 ){
  ...
  if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
    ...
    ACC<double> argp3(dims_opensbliblock00Kernel016[3][0], dims_opensbliblock00Kernel016[3][1], arg3);
...
void ops_par_loop_opensbliblock00Kernel016_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_opensbliblock00Kernel016_h[0][0] || ydim0 != dims_opensbliblock00Kernel016_h[0][1] || xdim1 != dims_opensbliblock00Kernel016_h[1][0] || ydim1 != dims_opensbliblock00Kernel016_h[1][1] || xdim2 != dims_opensbliblock00Kernel016_h[2][0] || ydim2 != dims_opensbliblock00Kernel016_h[2][1] || xdim3 != dims_opensbliblock00Kernel016_h[3][0] || ydim3 != dims_opensbliblock00Kernel016_h[3][1]) {
...
void ops_par_loop_opensbliblock00Kernel016(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2, ops_arg arg3) {
  ...
  create_kerneldesc_and_enque(name, args, 4, 5, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel016_execute);
}
#endif
