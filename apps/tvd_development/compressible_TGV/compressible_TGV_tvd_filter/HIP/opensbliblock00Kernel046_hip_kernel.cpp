...
//
__constant__ int dims_opensbliblock00Kernel046 [14][2];
static int dims_opensbliblock00Kernel046_h [14][2] = {{0}};

//user function
__device__

 void opensbliblock00Kernel046_gpu(const ACC<double> &a_B0,
...
int size2 ){
  ...
  if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
    ...
    ACC<double> argp9(dims_opensbliblock00Kernel046[9][0], dims_opensbliblock00Kernel046[9][1], arg9);
    ACC<double> argp10(dims_opensbliblock00Kernel046[10][0], dims_opensbliblock00Kernel046[10][1], arg10);
    ACC<double> argp11(dims_opensbliblock00Kernel046[11][0], dims_opensbliblock00Kernel046[11][1], arg11);
    ACC<double> argp12(dims_opensbliblock00Kernel046[12][0], dims_opensbliblock00Kernel046[12][1], arg12);
    ACC<double> argp13(dims_opensbliblock00Kernel046[13][0], dims_opensbliblock00Kernel046[13][1], arg13);
...
void ops_par_loop_opensbliblock00Kernel046(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg12, ops_arg arg13) {
  ...
  create_kerneldesc_and_enque(name, args, 14, 23, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel046_execute);
}
#endif
