...
void ops_par_loop_opensbliblock00Kernel038_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_opensbliblock00Kernel038_h[0][0] || xdim1 != dims_opensbliblock00Kernel038_h[1][0] || xdim2 != dims_opensbliblock00Kernel038_h[2][0] || xdim3 != dims_opensbliblock00Kernel038_h[3][0]) {
...
void ops_par_loop_opensbliblock00Kernel038(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4) {
  ...
  create_kerneldesc_and_enque(name, args, 5, 26, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel038_execute);
}
#endif
