...
//
__constant__ int dims_opensbliblock00Kernel035 [9][1];
static int dims_opensbliblock00Kernel035_h [9][1] = {{0}};

//user function
__device__

 void opensbliblock00Kernel035_gpu(const ACC<double> &rhoE_B0,
...
int size1 ){
  ...
  arg8 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel035[8][0];

  if (idx_x < size0 && idx_y < size1) {
    const ACC<double> argp0(dims_opensbliblock00Kernel035[0][0], arg0);
    const ACC<double> argp1(dims_opensbliblock00Kernel035[1][0], arg1);
    const ACC<double> argp2(dims_opensbliblock00Kernel035[2][0], arg2);
    const ACC<double> argp3(dims_opensbliblock00Kernel035[3][0], arg3);
    ...
    ACC<double> argp8(dims_opensbliblock00Kernel035[8][0], arg8);
...
void ops_par_loop_opensbliblock00Kernel035(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg8) {
  ...
  create_kerneldesc_and_enque(name, args, 9, 25, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel035_execute);
}
#endif
