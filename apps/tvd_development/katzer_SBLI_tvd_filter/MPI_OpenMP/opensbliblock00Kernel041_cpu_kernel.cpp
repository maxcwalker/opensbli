...
void ops_par_loop_opensbliblock00Kernel041_execute(ops_kernel_descriptor *desc) {
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
      ...
      ACC<double> wk0_B0(xdim8_opensbliblock00Kernel041, wk0_B0_p + n_x*1 + n_y * xdim8_opensbliblock00Kernel041*1);
      ACC<double> wk1_B0(xdim9_opensbliblock00Kernel041, wk1_B0_p + n_x*1 + n_y * xdim9_opensbliblock00Kernel041*1);
      ACC<double> wk2_B0(xdim10_opensbliblock00Kernel041, wk2_B0_p + n_x*1 + n_y * xdim10_opensbliblock00Kernel041*1);
      ACC<double> wk3_B0(xdim11_opensbliblock00Kernel041, wk3_B0_p + n_x*1 + n_y * xdim11_opensbliblock00Kernel041*1);
...
void ops_par_loop_opensbliblock00Kernel041(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg8, ops_arg arg9, ops_arg arg10, ops_arg arg11) {
  ...
  create_kerneldesc_and_enque(name, args, 12, 29, dim, 0, range, block, ops_par_loop_opensbliblock00Kernel041_execute);
}
#endif
