...
ACC<double> &x0_B0, ACC<double> &x1_B0, const int *idx)
{
   ...
   x1b0 = 0;
    ...
    rhou0 = ((-x1b0 + x1_B0(0,0) < 3.47434743474347) ? (
   -9.17067005123441e-7 + 1.24225192461634e-7*pow(-x1b0 +
      x1_B0(0,0), 23) + 1.89852844314995e-11*pow(-x1b0 + x1_B0(0,0), 29) + 1.76866484357092e-11*pow(-x1b0 + x1_B0(0,0),
      30) + 1.93885270573009e-8*pow(-x1b0 + x1_B0(0,0), 24) + 2.35704636424992e-22*pow(-x1b0 + x1_B0(0,0), 50) +
      8.55538615732343e-18*pow(-x1b0 + x1_B0(0,0), 41) + 0.137059939569722*((-x1b0 + x1_B0(0,0))*(-x1b0 +
      x1_B0(0,0))*(-x1b0 + x1_B0(0,0))) + 5.38134402045905e-16*pow(-x1b0 + x1_B0(0,0), 38) + 4.89915997493703*pow(-x1b0
      + x1_B0(0,0), 7) + 7.78685161587897e-17*pow(-x1b0 + x1_B0(0,0), 40) + 0.0951694366546827*pow(-x1b0 + x1_B0(0,0),
      12) + 5.89461685665962e-12*pow(-x1b0 + x1_B0(0,0), 31) + 0.423485027065778*x1_B0(0,0) +
      0.0359510929378061*pow(-x1b0 + x1_B0(0,0), 11) + 1.04904785609036e-12*pow(-x1b0 + x1_B0(0,0), 32) +
      1.24379951617903*((-x1b0 + x1_B0(0,0))*(-x1b0 + x1_B0(0,0))*(-x1b0 + x1_B0(0,0))*(-x1b0 + x1_B0(0,0))*(-x1b0 +
      x1_B0(0,0))) + 0.000614017777178235*pow(-x1b0 + x1_B0(0,0), 16) + 2.86778862105967e-16*pow(-x1b0 + x1_B0(0,0), 39)
      + 1.76792776779669e-20*pow(-x1b0 + x1_B0(0,0), 47) + 5.55514522503853e-22*pow(-x1b0 + x1_B0(0,0), 48) +
      3.24118837121159e-7*pow(-x1b0 + x1_B0(0,0), 22) + 0.00017691036322404*pow(-x1b0 + x1_B0(0,0), 17) +
      4.28094523150489e-20*pow(-x1b0 + x1_B0(0,0), 46) + 3.37370803498559*pow(-x1b0 + x1_B0(0,0), 9) -
      1.09599582944174e-7*pow(-x1b0 + x1_B0(0,0), 21) - 3.04338935918078*((-x1b0 + x1_B0(0,0))*(-x1b0 +
      x1_B0(0,0))*(-x1b0 + x1_B0(0,0))*(-x1b0 + x1_B0(0,0))*(-x1b0 + x1_B0(0,0))*(-x1b0 + x1_B0(0,0))) -
      0.338659486805532*((-x1b0 + x1_B0(0,0))*(-x1b0 + x1_B0(0,0))*(-x1b0 + x1_B0(0,0))*(-x1b0 + x1_B0(0,0))) -
      4.43597627824384e-6*pow(-x1b0 + x1_B0(0,0), 20) - 1.03761285021065e-13*pow(-x1b0 + x1_B0(0,0), 34) -
      1.1904195233597e-10*pow(-x1b0 + x1_B0(0,0), 28) - 3.03740634090451e-20*pow(-x1b0 + x1_B0(0,0), 45) -
      1.15705905568163*pow(-x1b0 + x1_B0(0,0), 10) - 5.15676786737886*pow(-x1b0 + x1_B0(0,0), 8) -
      5.69178036284884e-19*pow(-x1b0 + x1_B0(0,0), 44) - 2.65285463634731e-9*pow(-x1b0 + x1_B0(0,0), 26) -
      0.00596081896661716*pow(-x1b0 + x1_B0(0,0), 13) - 0.423485027065778*x1b0 - 1.626101789295e-5*pow(-x1b0 +
      x1_B0(0,0), 19) - 0.000525101055091924*pow(-x1b0 + x1_B0(0,0), 15) - 0.00843501463753711*pow(-x1b0 + x1_B0(0,0),
      14) - 2.01042980007294e-21*pow(-x1b0 + x1_B0(0,0), 49) - 2.10203300765344e-18*pow(-x1b0 + x1_B0(0,0), 43) -
      9.50679804589229e-15*pow(-x1b0 + x1_B0(0,0), 36) - 3.82231790993861e-14*pow(-x1b0 + x1_B0(0,0), 33) -
      6.16209659178133e-16*pow(-x1b0 + x1_B0(0,0), 37) - 4.18364196114496e-14*pow(-x1b0 + x1_B0(0,0), 35) -
      2.7575511143641e-9*pow(-x1b0 + x1_B0(0,0), 25) - 6.17136541436375e-6*pow(-x1b0 + x1_B0(0,0), 18) -
      8.29582001993868e-10*pow(-x1b0 + x1_B0(0,0), 27) - 3.20359956687463e-18*pow(-x1b0 + x1_B0(0,0), 42) -
      0.00373992141485225*((-x1b0 + x1_B0(0,0))*(-x1b0 + x1_B0(0,0)))
)
: (
   0.999999408128542
));

    rhou1 = ((-x1b0 + x1_B0(0,0) < 3.47434743474347) ? (
   -3.80679681067714e-8 + 3.29846675411759e-16*pow(-x1b0 +
      x1_B0(0,0), 33) + 2.61275508113875e-10*pow(-x1b0 + x1_B0(0,0), 24) + 7.68574110284603e-24*pow(-x1b0 + x1_B0(0,0),
      48) + 1.35323977844145e-9*pow(-x1b0 + x1_B0(0,0), 23) + 0.00117080257104008*((-x1b0 + x1_B0(0,0))*(-x1b0 +
      x1_B0(0,0))*(-x1b0 + x1_B0(0,0))) + 2.89430209659987e-9*pow(-x1b0 + x1_B0(0,0), 22) +
      6.17437187057097e-8*pow(-x1b0 + x1_B0(0,0), 18) + 0.00121959011594368*pow(-x1b0 + x1_B0(0,0), 12) +
      7.98844794928792e-14*pow(-x1b0 + x1_B0(0,0), 29) + 7.95464042481137e-19*pow(-x1b0 + x1_B0(0,0), 40) +
      4.24813155042447e-18*pow(-x1b0 + x1_B0(0,0), 38) + 2.15865800042069e-24*pow(-x1b0 + x1_B0(0,0), 50) +
      6.10513599670814e-14*pow(-x1b0 + x1_B0(0,0), 31) + 4.13310783502624e-6*x1_B0(0,0) + 0.00108954905829642*((-x1b0 +
      x1_B0(0,0))*(-x1b0 + x1_B0(0,0))) + 2.24860629089468e-6*pow(-x1b0 + x1_B0(0,0), 17) + 0.0823410737373266*pow(-x1b0
      + x1_B0(0,0), 7) + 1.6174078889092e-13*pow(-x1b0 + x1_B0(0,0), 30) + 0.0477784799016573*pow(-x1b0 + x1_B0(0,0), 9)
      + 2.69890056196645e-18*pow(-x1b0 + x1_B0(0,0), 39) + 0.0243865951159709*((-x1b0 + x1_B0(0,0))*(-x1b0 +
      x1_B0(0,0))*(-x1b0 + x1_B0(0,0))*(-x1b0 + x1_B0(0,0))*(-x1b0 + x1_B0(0,0))) + 1.7055391408529e-22*pow(-x1b0 +
      x1_B0(0,0), 47) + 6.18773615874405e-6*pow(-x1b0 + x1_B0(0,0), 16) + 1.25440137460712e-14*pow(-x1b0 + x1_B0(0,0),
      32) + 3.81994769602819e-22*pow(-x1b0 + x1_B0(0,0), 46) + 1.06115103525624e-19*pow(-x1b0 + x1_B0(0,0), 41) -
      2.46652488461641e-20*pow(-x1b0 + x1_B0(0,0), 42) - 8.98633668089322e-12*pow(-x1b0 + x1_B0(0,0), 27) -
      1.63208286244267e-7*pow(-x1b0 + x1_B0(0,0), 19) - 4.25687499702529e-22*pow(-x1b0 + x1_B0(0,0), 45) -
      1.02381592451835e-17*pow(-x1b0 + x1_B0(0,0), 37) - 0.00652911498352473*((-x1b0 + x1_B0(0,0))*(-x1b0 +
      x1_B0(0,0))*(-x1b0 + x1_B0(0,0))*(-x1b0 + x1_B0(0,0))) - 0.01446720339027*pow(-x1b0 + x1_B0(0,0), 10) -
      1.03892000308286e-11*pow(-x1b0 + x1_B0(0,0), 25) - 1.24342987234473e-5*pow(-x1b0 + x1_B0(0,0), 13) -
      4.19966153437464e-9*pow(-x1b0 + x1_B0(0,0), 21) - 1.95905282984507e-20*pow(-x1b0 + x1_B0(0,0), 43) -
      1.13784302859786e-5*pow(-x1b0 + x1_B0(0,0), 15) - 2.49689948800864e-11*pow(-x1b0 + x1_B0(0,0), 26) -
      8.91370360285635e-16*pow(-x1b0 + x1_B0(0,0), 34) - 4.13310783502624e-6*x1b0 - 0.079816511281852*pow(-x1b0 +
      x1_B0(0,0), 8) - 0.000172963128972276*pow(-x1b0 + x1_B0(0,0), 11) - 1.89304809671526e-23*pow(-x1b0 + x1_B0(0,0),
      49) - 0.000100734046898598*pow(-x1b0 + x1_B0(0,0), 14) - 5.70270016042851e-21*pow(-x1b0 + x1_B0(0,0), 44) -
      1.5880110864569e-12*pow(-x1b0 + x1_B0(0,0), 28) - 0.0553962782187771*((-x1b0 + x1_B0(0,0))*(-x1b0 +
      x1_B0(0,0))*(-x1b0 + x1_B0(0,0))*(-x1b0 + x1_B0(0,0))*(-x1b0 + x1_B0(0,0))*(-x1b0 + x1_B0(0,0))) -
      5.39132580497585e-8*pow(-x1b0 + x1_B0(0,0), 20) - 4.10642441245297e-16*pow(-x1b0 + x1_B0(0,0), 35) -
      1.03104385935066e-16*pow(-x1b0 + x1_B0(0,0), 36)
)
: (
   0.00564965542373382
));

    T = ((-x1b0 + x1_B0(0,0) < 3.47434743474347) ? (
   1.67619353419338 + 0.0159918674882209*((-x1b0 +
      x1_B0(0,0))*(-x1b0 + x1_B0(0,0))*(-x1b0 + x1_B0(0,0))) + 0.267013267028522*((-x1b0 + x1_B0(0,0))*(-x1b0 +
      x1_B0(0,0))*(-x1b0 + x1_B0(0,0))*(-x1b0 + x1_B0(0,0))*(-x1b0 + x1_B0(0,0))) + 0.0548594058643695*pow(-x1b0 +
      x1_B0(0,0), 10) + 0.00248603775221472*pow(-x1b0 + x1_B0(0,0), 13) + 7.67501675059693e-20*pow(-x1b0 + x1_B0(0,0),
      44) + 0.0260581589554733*pow(-x1b0 + x1_B0(0,0), 9) + 2.85584692828756e-14*pow(-x1b0 + x1_B0(0,0), 33) +
      0.000569072519921043*pow(-x1b0 + x1_B0(0,0), 14) + 1.03697988408799e-15*pow(-x1b0 + x1_B0(0,0), 36) +
      2.60932171894467e-22*pow(-x1b0 + x1_B0(0,0), 45) + 1.89606475248294e-14*pow(-x1b0 + x1_B0(0,0), 34) +
      3.30298011931638e-19*pow(-x1b0 + x1_B0(0,0), 43) + 6.69000976315786e-19*pow(-x1b0 + x1_B0(0,0), 42) +
      3.06271478019502e-12*pow(-x1b0 + x1_B0(0,0), 28) + 9.68279100912383e-10*pow(-x1b0 + x1_B0(0,0), 25) +
      2.79501805547067e-7*pow(-x1b0 + x1_B0(0,0), 20) + 2.23763760866334e-6*pow(-x1b0 + x1_B0(0,0), 19) +
      7.42471368773055e-5*x1_B0(0,0) + 5.25705555243653e-6*pow(-x1b0 + x1_B0(0,0), 18) + 3.08132091149806e-22*pow(-x1b0
      + x1_B0(0,0), 49) + 9.11642831582433e-11*pow(-x1b0 + x1_B0(0,0), 27) + 5.96572787863795e-15*pow(-x1b0 +
      x1_B0(0,0), 35) + 4.19441883538477e-10*pow(-x1b0 + x1_B0(0,0), 26) + 0.461494984043315*pow(-x1b0 + x1_B0(0,0), 7)
      - 2.93295287432836e-12*pow(-x1b0 + x1_B0(0,0), 30) - 9.35036870196331e-8*pow(-x1b0 + x1_B0(0,0), 21) -
      7.39485079253344e-13*pow(-x1b0 + x1_B0(0,0), 31) - 6.28278114745813e-12*pow(-x1b0 + x1_B0(0,0), 29) -
      0.262070267598408*pow(-x1b0 + x1_B0(0,0), 8) - 0.000147531418337662*pow(-x1b0 + x1_B0(0,0), 15) -
      8.31714021156921e-5*pow(-x1b0 + x1_B0(0,0), 16) - 0.0232212941375499*pow(-x1b0 + x1_B0(0,0), 11) -
      4.44270002387968e-17*pow(-x1b0 + x1_B0(0,0), 39) - 7.24235206895746e-21*pow(-x1b0 + x1_B0(0,0), 46) -
      3.79986748654156e-23*pow(-x1b0 + x1_B0(0,0), 50) - 1.00465392922336e-17*pow(-x1b0 + x1_B0(0,0), 40) -
      5.70558207845977e-8*pow(-x1b0 + x1_B0(0,0), 22) - 1.09723055361591e-16*pow(-x1b0 + x1_B0(0,0), 38) -
      0.291740705816082*((-x1b0 + x1_B0(0,0))*(-x1b0 + x1_B0(0,0))) - 5.06193769657999e-19*pow(-x1b0 + x1_B0(0,0), 41) -
      7.42471368773055e-5*x1b0 - 8.17081779115842e-24*pow(-x1b0 + x1_B0(0,0), 48) - 7.62484338661256e-14*pow(-x1b0 +
      x1_B0(0,0), 32) - 2.58561170446381e-21*pow(-x1b0 + x1_B0(0,0), 47) - 3.69910522230883e-10*pow(-x1b0 + x1_B0(0,0),
      24) - 0.10327552060774*((-x1b0 + x1_B0(0,0))*(-x1b0 + x1_B0(0,0))*(-x1b0 + x1_B0(0,0))*(-x1b0 + x1_B0(0,0))) -
      0.425422766840604*((-x1b0 + x1_B0(0,0))*(-x1b0 + x1_B0(0,0))*(-x1b0 + x1_B0(0,0))*(-x1b0 + x1_B0(0,0))*(-x1b0 +
      x1_B0(0,0))*(-x1b0 + x1_B0(0,0))) - 4.75320971755367e-17*pow(-x1b0 + x1_B0(0,0), 37) -
      0.00342181196999882*pow(-x1b0 + x1_B0(0,0), 12) - 1.33864283457839e-8*pow(-x1b0 + x1_B0(0,0), 23) -
      7.35829985092262e-6*pow(-x1b0 + x1_B0(0,0), 17)
)
: (
   1.0000005881953
));
...
ACC<double> &Residual3_B0, ACC<double> &wk0_B0, ACC<double> &wk1_B0, ACC<double> &wk2_B0, ACC<double> &wk3_B0)
{
 ...
 void opensbliblock00Kernel041(const ACC<double> &a_B0, const ACC<double> &detJ_B0, const ACC<double> &kappa_B0, const
...
&wk3_B0)
{
   ...
   double ws_lambda_33 = 0.0;
    if (fmax(kappa_B0(0,0), fmax(kappa_B0(-3,0), fmax(kappa_B0(1,0), fmax(kappa_B0(-2,0), fmax(kappa_B0(-1,0),
      kappa_B0(2,0)))))) > Ducros_check){
...
: (
 ...
 void opensbliblock00Kernel042(const ACC<double> &a_B0, const ACC<double> &detJ_B0, const ACC<double> &kappa_B0, const
ACC<double> &rhoE_B0, const ACC<double> &rho_B0, const ACC<double> &rhou0_B0, const ACC<double> &rhou1_B0, const
...
&Residual2_B0, ACC<double> &Residual3_B0)
{
   ...
   double ws_lambda_22 = 0.0;
   double ws_lambda_33 = 0.0;
    if (fmax(kappa_B0(0,0), fmax(kappa_B0(0,2), fmax(kappa_B0(0,-2), fmax(kappa_B0(0,-1), fmax(kappa_B0(0,1),
      kappa_B0(0,-3)))))) > Ducros_check){
...
: (
   1
    ...
    TVD_filter_B0(0,0) = ((fmax(kappa_B0(0,0), fmax(kappa_B0(1,0), fmax(kappa_B0(-1,0), fmax(kappa_B0(0,-1),
      kappa_B0(0,1))))) >= Ducros_select) ? (
   1
)
: (
   0.0
    ...
    rho_B0(0,0) = (-(-wk0_B0(-1,0) + wk0_B0(0,0))*invDelta0block0 - (-Residual0_B0(0,-1) +
      Residual0_B0(0,0))*invDelta1block0*D11_B0(0,0)*Wall)*dt*TVD_filter_B0(0,0) + rho_B0(0,0);

    rhou0_B0(0,0) = (-(-wk1_B0(-1,0) + wk1_B0(0,0))*invDelta0block0 - (-Residual1_B0(0,-1) +
      Residual1_B0(0,0))*invDelta1block0*D11_B0(0,0)*Wall)*dt*TVD_filter_B0(0,0) + rhou0_B0(0,0);

    rhou1_B0(0,0) = (-(-wk2_B0(-1,0) + wk2_B0(0,0))*invDelta0block0 - (-Residual2_B0(0,-1) +
      Residual2_B0(0,0))*invDelta1block0*D11_B0(0,0)*Wall)*dt*TVD_filter_B0(0,0) + rhou1_B0(0,0);

    rhoE_B0(0,0) = (-(-wk3_B0(-1,0) + wk3_B0(0,0))*invDelta0block0 - (-Residual3_B0(0,-1) +
      Residual3_B0(0,0))*invDelta1block0*D11_B0(0,0)*Wall)*dt*TVD_filter_B0(0,0) + rhoE_B0(0,0);
