  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      , [=](cl::sycl::nd_item<2> item
        ...
        const ACC<double> p_B0(xdim1_opensbliblock00Kernel020, &p_B0_p[0] + base1 + n_x*1 + n_y * xdim1_opensbliblock00Kernel020*1);
        const ACC<double> rhoE_B0(xdim2_opensbliblock00Kernel020, &rhoE_B0_p[0] + base2 + n_x*1 + n_y * xdim2_opensbliblock00Kernel020*1);
   ...
   if (idx[0] == 0){
       ...
       d1_inv_rhoErho_dx = (1.5*rhoE_B0(-2,0)/rho_B0(-2,0) + 1.83333333333333*rhoE_B0(0,0)/rho_B0(0,0) -
            3.0*rhoE_B0(-1,0)/rho_B0(-1,0) - 0.333333333333333*rhoE_B0(-3,0)/rho_B0(-3,0))*invDelta0block0_sycl[0];
       ...
       d1_inv_rhoErho_dx = (0.322484932882161*rhoE_B0(0,0)/rho_B0(0,0) + 0.0658051057710389*rhoE_B0(-3,0)/rho_B0(-3,0) +
            ...
            0.719443173328855*rhoE_B0(-1,0)/rho_B0(-1,0))*invDelta0block0_sycl[0];
       ...
       d1_inv_rhoErho_dx = (0.00412637789557492*rhoE_B0(-3,0)/rho_B0(-3,0) +
            ...
            0.113446470384241*rhoE_B0(2,0)/rho_B0(2,0))*invDelta0block0_sycl[0];
       ...
       d1_inv_rhoErho_dx = (0.00932597985049999*rhoE_B0(3,0)/rho_B0(3,0) + 0.727822147724592*rhoE_B0(1,0)/rho_B0(1,0) +
            ...
            0.652141084861241*rhoE_B0(-1,0)/rho_B0(-1,0) - 0.121937153224065*rhoE_B0(2,0)/rho_B0(2,0))*invDelta0block0_sycl[0];
   ...
   if (idx[1] == 0){
       ...
       d1_inv_rhoErho_dy = (1.5*rhoE_B0(0,-2)/rho_B0(0,-2) + 1.83333333333333*rhoE_B0(0,0)/rho_B0(0,0) -
            3.0*rhoE_B0(0,-1)/rho_B0(0,-1) - 0.333333333333333*rhoE_B0(0,-3)/rho_B0(0,-3))*invDelta1block0_sycl[0];
       ...
       d1_inv_rhoErho_dy = (0.322484932882161*rhoE_B0(0,0)/rho_B0(0,0) + 0.0658051057710389*rhoE_B0(0,-3)/rho_B0(0,-3) +
            ...
            0.719443173328855*rhoE_B0(0,-1)/rho_B0(0,-1))*invDelta1block0_sycl[0];
       ...
       d1_inv_rhoErho_dy = (0.00412637789557492*rhoE_B0(0,-3)/rho_B0(0,-3) +
            ...
            0.113446470384241*rhoE_B0(0,2)/rho_B0(0,2))*invDelta1block0_sycl[0];
       ...
       d1_inv_rhoErho_dy = (0.00932597985049999*rhoE_B0(0,3)/rho_B0(0,3) + 0.727822147724592*rhoE_B0(0,1)/rho_B0(0,1) +
            ...
            0.652141084861241*rhoE_B0(0,-1)/rho_B0(0,-1) - 0.121937153224065*rhoE_B0(0,2)/rho_B0(0,2))*invDelta1block0_sycl[0];
