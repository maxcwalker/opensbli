  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      , [=](cl::sycl::nd_item<2> item
        ...
        const ACC<double> a_B0(xdim0_opensbliblock00Kernel042, &a_B0_p[0] + base0 + n_x*1 + n_y * xdim0_opensbliblock00Kernel042*1);
        const ACC<double> detJ_B0(xdim1_opensbliblock00Kernel042, &detJ_B0_p[0] + base1 + n_x*1 + n_y * xdim1_opensbliblock00Kernel042*1);
        const ACC<double> rhoE_B0(xdim2_opensbliblock00Kernel042, &rhoE_B0_p[0] + base2 + n_x*1 + n_y * xdim2_opensbliblock00Kernel042*1);
        const ACC<double> rho_B0(xdim3_opensbliblock00Kernel042, &rho_B0_p[0] + base3 + n_x*1 + n_y * xdim3_opensbliblock00Kernel042*1);
        const ACC<double> rhou0_B0(xdim4_opensbliblock00Kernel042, &rhou0_B0_p[0] + base4 + n_x*1 + n_y * xdim4_opensbliblock00Kernel042*1);
        const ACC<double> rhou1_B0(xdim5_opensbliblock00Kernel042, &rhou1_B0_p[0] + base5 + n_x*1 + n_y * xdim5_opensbliblock00Kernel042*1);
        const ACC<double> u0_B0(xdim6_opensbliblock00Kernel042, &u0_B0_p[0] + base6 + n_x*1 + n_y * xdim6_opensbliblock00Kernel042*1);
        const ACC<double> u1_B0(xdim7_opensbliblock00Kernel042, &u1_B0_p[0] + base7 + n_x*1 + n_y * xdim7_opensbliblock00Kernel042*1);
        ACC<double> Residual0_B0(xdim8_opensbliblock00Kernel042, &Residual0_B0_p[0] + base8 + n_x*1 + n_y * xdim8_opensbliblock00Kernel042*1);
        ACC<double> Residual1_B0(xdim9_opensbliblock00Kernel042, &Residual1_B0_p[0] + base9 + n_x*1 + n_y * xdim9_opensbliblock00Kernel042*1);
        ACC<double> Residual2_B0(xdim10_opensbliblock00Kernel042, &Residual2_B0_p[0] + base10 + n_x*1 + n_y * xdim10_opensbliblock00Kernel042*1);
        ACC<double> Residual3_B0(xdim11_opensbliblock00Kernel042, &Residual3_B0_p[0] + base11 + n_x*1 + n_y * xdim11_opensbliblock00Kernel042*1);
        //USER CODE
   ...
   AVG_1_REV_31 = AVG_1_rho*AVG_1_u0;
    ...
    AVG_1_REV_32 = 0.707106781186547*(((AVG_1_a*AVG_1_a) + ((1.0/2.0))*((AVG_1_u0*AVG_1_u0) +
      (AVG_1_u1*AVG_1_u1))*gamma_m1_sycl[0])*invgamma_m1_sycl[0] + AVG_1_a*AVG_1_u1)*AVG_1_rho*inv_AVG_a;
