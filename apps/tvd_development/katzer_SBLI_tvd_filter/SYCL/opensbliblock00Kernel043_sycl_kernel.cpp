...
void ops_par_loop_opensbliblock00Kernel043_execute(ops_kernel_descriptor *desc) {
 ...
 arg15};
  ...
  int xdim2_opensbliblock00Kernel043 = args[2].dat->size[0];
  int xdim3_opensbliblock00Kernel043 = args[3].dat->size[0];
  int xdim4_opensbliblock00Kernel043 = args[4].dat->size[0];
  int xdim5_opensbliblock00Kernel043 = args[5].dat->size[0];
  int xdim6_opensbliblock00Kernel043 = args[6].dat->size[0];
  int xdim7_opensbliblock00Kernel043 = args[7].dat->size[0];
  int xdim8_opensbliblock00Kernel043 = args[8].dat->size[0];
  int xdim9_opensbliblock00Kernel043 = args[9].dat->size[0];
  int xdim10_opensbliblock00Kernel043 = args[10].dat->size[0];
  int xdim11_opensbliblock00Kernel043 = args[11].dat->size[0];
  int xdim12_opensbliblock00Kernel043 = args[12].dat->size[0];
  int xdim13_opensbliblock00Kernel043 = args[13].dat->size[0];
  int xdim14_opensbliblock00Kernel043 = args[14].dat->size[0];
  ...
  double* TVD_filter_B0_p = (double*)args[10].data_d;
  ...
  double* rho_B0_p = (double*)args[12].data_d;
  ...
  double* rhou1_B0_p = (double*)args[14].data_d;
  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      cgh.parallel_for<class opensbliblock00Kernel043_kernel>(cl::sycl::nd_range<2>(cl::sycl::range<2>(
      ...
      , [=](cl::sycl::nd_item<2> item
        ...
        const ACC<double> D11_B0(xdim0_opensbliblock00Kernel043, &D11_B0_p[0] + base0 + n_x*1 + n_y * xdim0_opensbliblock00Kernel043*1);
        const ACC<double> Residual0_B0(xdim1_opensbliblock00Kernel043, &Residual0_B0_p[0] + base1 + n_x*1 + n_y * xdim1_opensbliblock00Kernel043*1);
        const ACC<double> Residual1_B0(xdim2_opensbliblock00Kernel043, &Residual1_B0_p[0] + base2 + n_x*1 + n_y * xdim2_opensbliblock00Kernel043*1);
        const ACC<double> Residual2_B0(xdim3_opensbliblock00Kernel043, &Residual2_B0_p[0] + base3 + n_x*1 + n_y * xdim3_opensbliblock00Kernel043*1);
        const ACC<double> Residual3_B0(xdim4_opensbliblock00Kernel043, &Residual3_B0_p[0] + base4 + n_x*1 + n_y * xdim4_opensbliblock00Kernel043*1);
        const ACC<double> kappa_B0(xdim5_opensbliblock00Kernel043, &kappa_B0_p[0] + base5 + n_x*1 + n_y * xdim5_opensbliblock00Kernel043*1);
        const ACC<double> wk0_B0(xdim6_opensbliblock00Kernel043, &wk0_B0_p[0] + base6 + n_x*1 + n_y * xdim6_opensbliblock00Kernel043*1);
        const ACC<double> wk1_B0(xdim7_opensbliblock00Kernel043, &wk1_B0_p[0] + base7 + n_x*1 + n_y * xdim7_opensbliblock00Kernel043*1);
        const ACC<double> wk2_B0(xdim8_opensbliblock00Kernel043, &wk2_B0_p[0] + base8 + n_x*1 + n_y * xdim8_opensbliblock00Kernel043*1);
        const ACC<double> wk3_B0(xdim9_opensbliblock00Kernel043, &wk3_B0_p[0] + base9 + n_x*1 + n_y * xdim9_opensbliblock00Kernel043*1);
        ACC<double> TVD_filter_B0(xdim10_opensbliblock00Kernel043, &TVD_filter_B0_p[0] + base10 + n_x*1 + n_y * xdim10_opensbliblock00Kernel043*1);
        ACC<double> rhoE_B0(xdim11_opensbliblock00Kernel043, &rhoE_B0_p[0] + base11 + n_x*1 + n_y * xdim11_opensbliblock00Kernel043*1);
        ACC<double> rho_B0(xdim12_opensbliblock00Kernel043, &rho_B0_p[0] + base12 + n_x*1 + n_y * xdim12_opensbliblock00Kernel043*1);
        ACC<double> rhou0_B0(xdim13_opensbliblock00Kernel043, &rhou0_B0_p[0] + base13 + n_x*1 + n_y * xdim13_opensbliblock00Kernel043*1);
        ACC<double> rhou1_B0(xdim14_opensbliblock00Kernel043, &rhou1_B0_p[0] + base14 + n_x*1 + n_y * xdim14_opensbliblock00Kernel043*1);
        //USER CODE
...
: (
   1
    ...
    TVD_filter_B0(0,0) = ((cl::sycl::fmax(kappa_B0(0,-1), cl::sycl::fmax(kappa_B0(1,0), cl::sycl::fmax(kappa_B0(0,2), cl::sycl::fmax(kappa_B0(0,0),
      cl::sycl::fmax(kappa_B0(-1,0), cl::sycl::fmax(kappa_B0(2,0), kappa_B0(0,1))))))) >= Ducros_select_sycl[0]) ? (
   1
)
: (
   0.0
    ...
    rho_B0(0,0) = (-(-wk0_B0(-1,0) + wk0_B0(0,0))*invDelta0block0_sycl[0] - (-Residual0_B0(0,-1) +
      Residual0_B0(0,0))*invDelta1block0_sycl[0]*D11_B0(0,0))*dt_sycl[0]*TVD_filter_B0(0,0) + rho_B0(0,0);

    rhou0_B0(0,0) = (-(-wk1_B0(-1,0) + wk1_B0(0,0))*invDelta0block0_sycl[0] - (-Residual1_B0(0,-1) +
      Residual1_B0(0,0))*invDelta1block0_sycl[0]*D11_B0(0,0))*dt_sycl[0]*TVD_filter_B0(0,0) + rhou0_B0(0,0);

    rhou1_B0(0,0) = (-(-wk2_B0(-1,0) + wk2_B0(0,0))*invDelta0block0_sycl[0] - (-Residual2_B0(0,-1) +
      Residual2_B0(0,0))*invDelta1block0_sycl[0]*D11_B0(0,0))*dt_sycl[0]*TVD_filter_B0(0,0) + rhou1_B0(0,0);

    rhoE_B0(0,0) = (-(-wk3_B0(-1,0) + wk3_B0(0,0))*invDelta0block0_sycl[0] - (-Residual3_B0(0,-1) +
      Residual3_B0(0,0))*invDelta1block0_sycl[0]*D11_B0(0,0))*dt_sycl[0]*TVD_filter_B0(0,0) + rhoE_B0(0,0);
