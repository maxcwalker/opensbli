  ...
  for ( int n_z=start2; n_z<end2; n_z++ ){
    for ( int n_y=start1; n_y<end1; n_y++ ){
      for ( int n_x=start0; n_x<end0; n_x++ ){
        ...
        const ACC<double> u1_B0(xdim0_opensbliblock00Kernel006, ydim0_opensbliblock00Kernel006, u1_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel006*1 + n_z * xdim0_opensbliblock00Kernel006 * ydim0_opensbliblock00Kernel006*1);
        ACC<double> wk1_B0(xdim1_opensbliblock00Kernel006, ydim1_opensbliblock00Kernel006, wk1_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel006*1 + n_z * xdim1_opensbliblock00Kernel006 * ydim1_opensbliblock00Kernel006*1);
