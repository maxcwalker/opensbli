  ...
  for ( int n_z=start2; n_z<end2; n_z++ ){
    for ( int n_y=start1; n_y<end1; n_y++ ){
      for ( int n_x=start0; n_x<end0; n_x++ ){
        ...
        const ACC<double> u2_B0(xdim0_opensbliblock00Kernel008, ydim0_opensbliblock00Kernel008, u2_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel008*1 + n_z * xdim0_opensbliblock00Kernel008 * ydim0_opensbliblock00Kernel008*1);
        ACC<double> wk2_B0(xdim1_opensbliblock00Kernel008, ydim1_opensbliblock00Kernel008, wk2_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel008*1 + n_z * xdim1_opensbliblock00Kernel008 * ydim1_opensbliblock00Kernel008*1);
...
void ops_par_loop_opensbliblock00Kernel008(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  create_kerneldesc_and_enque(name, args, 3, 19, dim, 0, range, block, ops_par_loop_opensbliblock00Kernel008_execute);
}
#endif
