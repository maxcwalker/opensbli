...
//
__constant__ int dims_opensbliblock00Kernel038 [8][2];
static int dims_opensbliblock00Kernel038_h [8][2] = {{0}};

//user function
__device__

 void opensbliblock00Kernel038_gpu(const int *iter,
...
int size2 ){
  ...
  arg2 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel038[2][0] + idx_z * 1*1 * dims_opensbliblock00Kernel038[2][0] * dims_opensbliblock00Kernel038[2][1];
  arg3 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel038[3][0] + idx_z * 1*1 * dims_opensbliblock00Kernel038[3][0] * dims_opensbliblock00Kernel038[3][1];
  arg4 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel038[4][0] + idx_z * 1*1 * dims_opensbliblock00Kernel038[4][0] * dims_opensbliblock00Kernel038[4][1];
  arg5 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel038[5][0] + idx_z * 1*1 * dims_opensbliblock00Kernel038[5][0] * dims_opensbliblock00Kernel038[5][1];
  arg6 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel038[6][0] + idx_z * 1*1 * dims_opensbliblock00Kernel038[6][0] * dims_opensbliblock00Kernel038[6][1];
  arg7 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel038[7][0] + idx_z * 1*1 * dims_opensbliblock00Kernel038[7][0] * dims_opensbliblock00Kernel038[7][1];

  if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
    const ACC<double> argp1(dims_opensbliblock00Kernel038[1][0], dims_opensbliblock00Kernel038[1][1], arg1);
    const ACC<double> argp2(dims_opensbliblock00Kernel038[2][0], dims_opensbliblock00Kernel038[2][1], arg2);
    ACC<double> argp3(dims_opensbliblock00Kernel038[3][0], dims_opensbliblock00Kernel038[3][1], arg3);
    ACC<double> argp4(dims_opensbliblock00Kernel038[4][0], dims_opensbliblock00Kernel038[4][1], arg4);
    ACC<double> argp5(dims_opensbliblock00Kernel038[5][0], dims_opensbliblock00Kernel038[5][1], arg5);
    ACC<double> argp6(dims_opensbliblock00Kernel038[6][0], dims_opensbliblock00Kernel038[6][1], arg6);
    ACC<double> argp7(dims_opensbliblock00Kernel038[7][0], dims_opensbliblock00Kernel038[7][1], arg7);
...
void ops_par_loop_opensbliblock00Kernel038_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim1 != dims_opensbliblock00Kernel038_h[1][0] || ydim1 != dims_opensbliblock00Kernel038_h[1][1] || xdim2 != dims_opensbliblock00Kernel038_h[2][0] || ydim2 != dims_opensbliblock00Kernel038_h[2][1] || xdim3 != dims_opensbliblock00Kernel038_h[3][0] || ydim3 != dims_opensbliblock00Kernel038_h[3][1] || xdim4 != dims_opensbliblock00Kernel038_h[4][0] || ydim4 != dims_opensbliblock00Kernel038_h[4][1] || xdim5 != dims_opensbliblock00Kernel038_h[5][0] || ydim5 != dims_opensbliblock00Kernel038_h[5][1] || xdim6 != dims_opensbliblock00Kernel038_h[6][0] || ydim6 != dims_opensbliblock00Kernel038_h[6][1] || xdim7 != dims_opensbliblock00Kernel038_h[7][0] || ydim7 != dims_opensbliblock00Kernel038_h[7][1]) {
    ...
    dims_opensbliblock00Kernel038_h[2][1] = ydim2;
    dims_opensbliblock00Kernel038_h[3][0] = xdim3;
    dims_opensbliblock00Kernel038_h[3][1] = ydim3;
    dims_opensbliblock00Kernel038_h[4][0] = xdim4;
    dims_opensbliblock00Kernel038_h[4][1] = ydim4;
    dims_opensbliblock00Kernel038_h[5][0] = xdim5;
    dims_opensbliblock00Kernel038_h[5][1] = ydim5;
    dims_opensbliblock00Kernel038_h[6][0] = xdim6;
    dims_opensbliblock00Kernel038_h[6][1] = ydim6;
    dims_opensbliblock00Kernel038_h[7][0] = xdim7;
    dims_opensbliblock00Kernel038_h[7][1] = ydim7;
...
void ops_par_loop_opensbliblock00Kernel038(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4, ops_arg arg5, ops_arg arg6, ops_arg arg7) {
  ...
  create_kerneldesc_and_enque(name, args, 8, 9, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel038_execute);
}
#endif
