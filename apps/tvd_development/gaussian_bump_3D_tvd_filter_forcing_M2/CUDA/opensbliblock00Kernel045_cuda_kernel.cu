...
//
__constant__ int dims_opensbliblock00Kernel045 [12][2];
static int dims_opensbliblock00Kernel045_h [12][2] = {{0}};

//user function
__device__

 void opensbliblock00Kernel045_gpu(const ACC<double> &x0_B0,
...
int size2 ){
  ...
  if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
    ...
    ACC<double> argp2(dims_opensbliblock00Kernel045[2][0], dims_opensbliblock00Kernel045[2][1], arg2);
    ACC<double> argp3(dims_opensbliblock00Kernel045[3][0], dims_opensbliblock00Kernel045[3][1], arg3);
    ACC<double> argp4(dims_opensbliblock00Kernel045[4][0], dims_opensbliblock00Kernel045[4][1], arg4);
    ACC<double> argp5(dims_opensbliblock00Kernel045[5][0], dims_opensbliblock00Kernel045[5][1], arg5);
    ACC<double> argp6(dims_opensbliblock00Kernel045[6][0], dims_opensbliblock00Kernel045[6][1], arg6);
    ACC<double> argp7(dims_opensbliblock00Kernel045[7][0], dims_opensbliblock00Kernel045[7][1], arg7);
    ACC<double> argp8(dims_opensbliblock00Kernel045[8][0], dims_opensbliblock00Kernel045[8][1], arg8);
...
void ops_par_loop_opensbliblock00Kernel045_execute(ops_kernel_descriptor *desc) {
  ...
  if (block->instance->OPS_diags > 1) {
    ops_timing_realloc(block->instance,1,"opensbliblock00Kernel045");
...
void ops_par_loop_opensbliblock00Kernel045(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg8, ops_arg arg9, ops_arg arg10, ops_arg arg11) {
  ...
  create_kerneldesc_and_enque(name, args, 12, 1, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel045_execute);
}
#endif
