...
//
__constant__ int dims_opensbliblock00Kernel056 [13][2];
static int dims_opensbliblock00Kernel056_h [13][2] = {{0}};

//user function
__device__

 void opensbliblock00Kernel056_gpu(const ACC<double> &D00_B0,
...
int size2 ){
  ...
  if (idx_x < size0 && idx_y < size1 && idx_z < size2) {
    ...
    ACC<double> argp4(dims_opensbliblock00Kernel056[4][0], dims_opensbliblock00Kernel056[4][1], arg4);
    ACC<double> argp5(dims_opensbliblock00Kernel056[5][0], dims_opensbliblock00Kernel056[5][1], arg5);
    ACC<double> argp6(dims_opensbliblock00Kernel056[6][0], dims_opensbliblock00Kernel056[6][1], arg6);
    ACC<double> argp7(dims_opensbliblock00Kernel056[7][0], dims_opensbliblock00Kernel056[7][1], arg7);
    ACC<double> argp8(dims_opensbliblock00Kernel056[8][0], dims_opensbliblock00Kernel056[8][1], arg8);
    ACC<double> argp9(dims_opensbliblock00Kernel056[9][0], dims_opensbliblock00Kernel056[9][1], arg9);
    ACC<double> argp10(dims_opensbliblock00Kernel056[10][0], dims_opensbliblock00Kernel056[10][1], arg10);
    ACC<double> argp11(dims_opensbliblock00Kernel056[11][0], dims_opensbliblock00Kernel056[11][1], arg11);
...
void ops_par_loop_opensbliblock00Kernel056(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg12) {
  ...
  create_kerneldesc_and_enque(name, args, 13, 6, dim, 1, range, block, ops_par_loop_opensbliblock00Kernel056_execute);
}
#endif
