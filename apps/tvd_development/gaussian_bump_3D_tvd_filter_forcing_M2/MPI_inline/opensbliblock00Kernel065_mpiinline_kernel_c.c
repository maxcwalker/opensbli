...
int ydim2_opensbliblock00Kernel065;
int xdim3_opensbliblock00Kernel065;
int ydim3_opensbliblock00Kernel065;
int xdim4_opensbliblock00Kernel065;
int ydim4_opensbliblock00Kernel065;
int xdim5_opensbliblock00Kernel065;
int ydim5_opensbliblock00Kernel065;
int xdim6_opensbliblock00Kernel065;
int ydim6_opensbliblock00Kernel065;
int xdim7_opensbliblock00Kernel065;
int ydim7_opensbliblock00Kernel065;
int xdim8_opensbliblock00Kernel065;
int ydim8_opensbliblock00Kernel065;
int xdim9_opensbliblock00Kernel065;
int ydim9_opensbliblock00Kernel065;
int xdim10_opensbliblock00Kernel065;
int ydim10_opensbliblock00Kernel065;
int xdim11_opensbliblock00Kernel065;
int ydim11_opensbliblock00Kernel065;
int xdim12_opensbliblock00Kernel065;
int ydim12_opensbliblock00Kernel065;
int xdim13_opensbliblock00Kernel065;
int ydim13_opensbliblock00Kernel065;
int xdim14_opensbliblock00Kernel065;
int ydim14_opensbliblock00Kernel065;
int xdim15_opensbliblock00Kernel065;
int ydim15_opensbliblock00Kernel065;
int xdim16_opensbliblock00Kernel065;
int ydim16_opensbliblock00Kernel065;
int xdim17_opensbliblock00Kernel065;
int ydim17_opensbliblock00Kernel065;
  ...
  for ( int n_z=0; n_z<z_size; n_z++ ){
    for ( int n_y=0; n_y<y_size; n_y++ ){
      for ( int n_x=0; n_x<x_size; n_x++ ){
        const ptr_double D10_B0 = { D10_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel065*1 + n_z * xdim0_opensbliblock00Kernel065 * ydim0_opensbliblock00Kernel065*1, xdim0_opensbliblock00Kernel065, ydim0_opensbliblock00Kernel065};
        const ptr_double D11_B0 = { D11_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel065*1 + n_z * xdim1_opensbliblock00Kernel065 * ydim1_opensbliblock00Kernel065*1, xdim1_opensbliblock00Kernel065, ydim1_opensbliblock00Kernel065};
        const ptr_double a_B0 = { a_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel065*1 + n_z * xdim2_opensbliblock00Kernel065 * ydim2_opensbliblock00Kernel065*1, xdim2_opensbliblock00Kernel065, ydim2_opensbliblock00Kernel065};
        const ptr_double detJ_B0 = { detJ_B0_p + n_x*1 + n_y * xdim3_opensbliblock00Kernel065*1 + n_z * xdim3_opensbliblock00Kernel065 * ydim3_opensbliblock00Kernel065*1, xdim3_opensbliblock00Kernel065, ydim3_opensbliblock00Kernel065};
        const ptr_double kappa_B0 = { kappa_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel065*1 + n_z * xdim4_opensbliblock00Kernel065 * ydim4_opensbliblock00Kernel065*1, xdim4_opensbliblock00Kernel065, ydim4_opensbliblock00Kernel065};
        const ptr_double rhoE_B0 = { rhoE_B0_p + n_x*1 + n_y * xdim5_opensbliblock00Kernel065*1 + n_z * xdim5_opensbliblock00Kernel065 * ydim5_opensbliblock00Kernel065*1, xdim5_opensbliblock00Kernel065, ydim5_opensbliblock00Kernel065};
        const ptr_double rho_B0 = { rho_B0_p + n_x*1 + n_y * xdim6_opensbliblock00Kernel065*1 + n_z * xdim6_opensbliblock00Kernel065 * ydim6_opensbliblock00Kernel065*1, xdim6_opensbliblock00Kernel065, ydim6_opensbliblock00Kernel065};
        const ptr_double rhou0_B0 = { rhou0_B0_p + n_x*1 + n_y * xdim7_opensbliblock00Kernel065*1 + n_z * xdim7_opensbliblock00Kernel065 * ydim7_opensbliblock00Kernel065*1, xdim7_opensbliblock00Kernel065, ydim7_opensbliblock00Kernel065};
        const ptr_double rhou1_B0 = { rhou1_B0_p + n_x*1 + n_y * xdim8_opensbliblock00Kernel065*1 + n_z * xdim8_opensbliblock00Kernel065 * ydim8_opensbliblock00Kernel065*1, xdim8_opensbliblock00Kernel065, ydim8_opensbliblock00Kernel065};
        const ptr_double rhou2_B0 = { rhou2_B0_p + n_x*1 + n_y * xdim9_opensbliblock00Kernel065*1 + n_z * xdim9_opensbliblock00Kernel065 * ydim9_opensbliblock00Kernel065*1, xdim9_opensbliblock00Kernel065, ydim9_opensbliblock00Kernel065};
        const ptr_double u0_B0 = { u0_B0_p + n_x*1 + n_y * xdim10_opensbliblock00Kernel065*1 + n_z * xdim10_opensbliblock00Kernel065 * ydim10_opensbliblock00Kernel065*1, xdim10_opensbliblock00Kernel065, ydim10_opensbliblock00Kernel065};
        const ptr_double u1_B0 = { u1_B0_p + n_x*1 + n_y * xdim11_opensbliblock00Kernel065*1 + n_z * xdim11_opensbliblock00Kernel065 * ydim11_opensbliblock00Kernel065*1, xdim11_opensbliblock00Kernel065, ydim11_opensbliblock00Kernel065};
        const ptr_double u2_B0 = { u2_B0_p + n_x*1 + n_y * xdim12_opensbliblock00Kernel065*1 + n_z * xdim12_opensbliblock00Kernel065 * ydim12_opensbliblock00Kernel065*1, xdim12_opensbliblock00Kernel065, ydim12_opensbliblock00Kernel065};
        ptr_double Residual0_B0 = { Residual0_B0_p + n_x*1 + n_y * xdim13_opensbliblock00Kernel065*1 + n_z * xdim13_opensbliblock00Kernel065 * ydim13_opensbliblock00Kernel065*1, xdim13_opensbliblock00Kernel065, ydim13_opensbliblock00Kernel065};
        ptr_double Residual1_B0 = { Residual1_B0_p + n_x*1 + n_y * xdim14_opensbliblock00Kernel065*1 + n_z * xdim14_opensbliblock00Kernel065 * ydim14_opensbliblock00Kernel065*1, xdim14_opensbliblock00Kernel065, ydim14_opensbliblock00Kernel065};
        ptr_double Residual2_B0 = { Residual2_B0_p + n_x*1 + n_y * xdim15_opensbliblock00Kernel065*1 + n_z * xdim15_opensbliblock00Kernel065 * ydim15_opensbliblock00Kernel065*1, xdim15_opensbliblock00Kernel065, ydim15_opensbliblock00Kernel065};
        ptr_double Residual3_B0 = { Residual3_B0_p + n_x*1 + n_y * xdim16_opensbliblock00Kernel065*1 + n_z * xdim16_opensbliblock00Kernel065 * ydim16_opensbliblock00Kernel065*1, xdim16_opensbliblock00Kernel065, ydim16_opensbliblock00Kernel065};
        ptr_double Residual4_B0 = { Residual4_B0_p + n_x*1 + n_y * xdim17_opensbliblock00Kernel065*1 + n_z * xdim17_opensbliblock00Kernel065 * ydim17_opensbliblock00Kernel065*1, xdim17_opensbliblock00Kernel065, ydim17_opensbliblock00Kernel065};
   ...
   double ws_lambda_44 = 0.0;
    if (fmax(OPS_ACC(kappa_B0, 0,1,0), fmax(OPS_ACC(kappa_B0, 0,2,0), fmax(OPS_ACC(kappa_B0, 0,-3,0), fmax(OPS_ACC(kappa_B0, 0,-2,0), fmax(OPS_ACC(kappa_B0, 0,-1,0),
      OPS_ACC(kappa_B0, 0,0,0)))))) > Ducros_check){
      ...
      AVG_1_1_LEV_44 = 0.707106781186547*gamma_m1*inv_AVG_a*inv_AVG_rho;
       ...
       alpha_00 = (-OPS_ACC(rho_B0, 0,-1,0) + OPS_ACC(rho_B0, 0,0,0))*AVG_1_1_LEV_00 + (-OPS_ACC(rhoE_B0, 0,-1,0) + OPS_ACC(rhoE_B0, 0,0,0))*AVG_1_1_LEV_04
            + (-OPS_ACC(rhou0_B0, 0,-1,0) + OPS_ACC(rhou0_B0, 0,0,0))*AVG_1_1_LEV_01 + (-OPS_ACC(rhou1_B0, 0,-1,0) +
            OPS_ACC(rhou1_B0, 0,0,0))*AVG_1_1_LEV_02 + (-OPS_ACC(rhou2_B0, 0,-1,0) + OPS_ACC(rhou2_B0, 0,0,0))*AVG_1_1_LEV_03;

       alpha_10 = (-OPS_ACC(rho_B0, 0,-1,0) + OPS_ACC(rho_B0, 0,0,0))*AVG_1_1_LEV_10 + (-OPS_ACC(rhoE_B0, 0,-1,0) + OPS_ACC(rhoE_B0, 0,0,0))*AVG_1_1_LEV_14
            + (-OPS_ACC(rhou0_B0, 0,-1,0) + OPS_ACC(rhou0_B0, 0,0,0))*AVG_1_1_LEV_11 + (-OPS_ACC(rhou1_B0, 0,-1,0) +
            OPS_ACC(rhou1_B0, 0,0,0))*AVG_1_1_LEV_12 + (-OPS_ACC(rhou2_B0, 0,-1,0) + OPS_ACC(rhou2_B0, 0,0,0))*AVG_1_1_LEV_13;

       alpha_20 = (-OPS_ACC(rho_B0, 0,-1,0) + OPS_ACC(rho_B0, 0,0,0))*AVG_1_1_LEV_20 + (-OPS_ACC(rhou0_B0, 0,-1,0) +
            OPS_ACC(rhou0_B0, 0,0,0))*AVG_1_1_LEV_21 + (-OPS_ACC(rhou1_B0, 0,-1,0) + OPS_ACC(rhou1_B0, 0,0,0))*AVG_1_1_LEV_22;

       alpha_30 = (-OPS_ACC(rho_B0, 0,-1,0) + OPS_ACC(rho_B0, 0,0,0))*AVG_1_1_LEV_30 + (-OPS_ACC(rhoE_B0, 0,-1,0) + OPS_ACC(rhoE_B0, 0,0,0))*AVG_1_1_LEV_34
            + (-OPS_ACC(rhou0_B0, 0,-1,0) + OPS_ACC(rhou0_B0, 0,0,0))*AVG_1_1_LEV_31 + (-OPS_ACC(rhou1_B0, 0,-1,0) +
            OPS_ACC(rhou1_B0, 0,0,0))*AVG_1_1_LEV_32 + (-OPS_ACC(rhou2_B0, 0,-1,0) + OPS_ACC(rhou2_B0, 0,0,0))*AVG_1_1_LEV_33;

       alpha_40 = (-OPS_ACC(rho_B0, 0,-1,0) + OPS_ACC(rho_B0, 0,0,0))*AVG_1_1_LEV_40 + (-OPS_ACC(rhoE_B0, 0,-1,0) + OPS_ACC(rhoE_B0, 0,0,0))*AVG_1_1_LEV_44
            + (-OPS_ACC(rhou0_B0, 0,-1,0) + OPS_ACC(rhou0_B0, 0,0,0))*AVG_1_1_LEV_41 + (-OPS_ACC(rhou1_B0, 0,-1,0) +
            OPS_ACC(rhou1_B0, 0,0,0))*AVG_1_1_LEV_42 + (-OPS_ACC(rhou2_B0, 0,-1,0) + OPS_ACC(rhou2_B0, 0,0,0))*AVG_1_1_LEV_43;
      ...
      AVG_1_1_LEV_44 = 0.707106781186547*gamma_m1*inv_AVG_a*inv_AVG_rho;
       ...
       alpha_01 = (-OPS_ACC(rho_B0, 0,0,0) + OPS_ACC(rho_B0, 0,1,0))*AVG_1_1_LEV_00 + (-OPS_ACC(rhoE_B0, 0,0,0) + OPS_ACC(rhoE_B0, 0,1,0))*AVG_1_1_LEV_04 +
            (-OPS_ACC(rhou0_B0, 0,0,0) + OPS_ACC(rhou0_B0, 0,1,0))*AVG_1_1_LEV_01 + (-OPS_ACC(rhou1_B0, 0,0,0) + OPS_ACC(rhou1_B0, 0,1,0))*AVG_1_1_LEV_02 +
            (-OPS_ACC(rhou2_B0, 0,0,0) + OPS_ACC(rhou2_B0, 0,1,0))*AVG_1_1_LEV_03;

       alpha_11 = (-OPS_ACC(rho_B0, 0,0,0) + OPS_ACC(rho_B0, 0,1,0))*AVG_1_1_LEV_10 + (-OPS_ACC(rhoE_B0, 0,0,0) + OPS_ACC(rhoE_B0, 0,1,0))*AVG_1_1_LEV_14 +
            (-OPS_ACC(rhou0_B0, 0,0,0) + OPS_ACC(rhou0_B0, 0,1,0))*AVG_1_1_LEV_11 + (-OPS_ACC(rhou1_B0, 0,0,0) + OPS_ACC(rhou1_B0, 0,1,0))*AVG_1_1_LEV_12 +
            (-OPS_ACC(rhou2_B0, 0,0,0) + OPS_ACC(rhou2_B0, 0,1,0))*AVG_1_1_LEV_13;

       alpha_21 = (-OPS_ACC(rho_B0, 0,0,0) + OPS_ACC(rho_B0, 0,1,0))*AVG_1_1_LEV_20 + (-OPS_ACC(rhou0_B0, 0,0,0) + OPS_ACC(rhou0_B0, 0,1,0))*AVG_1_1_LEV_21
            + (-OPS_ACC(rhou1_B0, 0,0,0) + OPS_ACC(rhou1_B0, 0,1,0))*AVG_1_1_LEV_22;

       alpha_31 = (-OPS_ACC(rho_B0, 0,0,0) + OPS_ACC(rho_B0, 0,1,0))*AVG_1_1_LEV_30 + (-OPS_ACC(rhoE_B0, 0,0,0) + OPS_ACC(rhoE_B0, 0,1,0))*AVG_1_1_LEV_34 +
            (-OPS_ACC(rhou0_B0, 0,0,0) + OPS_ACC(rhou0_B0, 0,1,0))*AVG_1_1_LEV_31 + (-OPS_ACC(rhou1_B0, 0,0,0) + OPS_ACC(rhou1_B0, 0,1,0))*AVG_1_1_LEV_32 +
            (-OPS_ACC(rhou2_B0, 0,0,0) + OPS_ACC(rhou2_B0, 0,1,0))*AVG_1_1_LEV_33;

       alpha_41 = (-OPS_ACC(rho_B0, 0,0,0) + OPS_ACC(rho_B0, 0,1,0))*AVG_1_1_LEV_40 + (-OPS_ACC(rhoE_B0, 0,0,0) + OPS_ACC(rhoE_B0, 0,1,0))*AVG_1_1_LEV_44 +
            (-OPS_ACC(rhou0_B0, 0,0,0) + OPS_ACC(rhou0_B0, 0,1,0))*AVG_1_1_LEV_41 + (-OPS_ACC(rhou1_B0, 0,0,0) + OPS_ACC(rhou1_B0, 0,1,0))*AVG_1_1_LEV_42 +
            (-OPS_ACC(rhou2_B0, 0,0,0) + OPS_ACC(rhou2_B0, 0,1,0))*AVG_1_1_LEV_43;

      ws_lambda_00 = (OPS_ACC(D10_B0, 0,0,0)*AVG_1_u0 + OPS_ACC(D11_B0, 0,0,0)*AVG_1_u1)*OPS_ACC(detJ_B0, 0,0,0);

      ws_lambda_11 = (OPS_ACC(D10_B0, 0,0,0)*AVG_1_u0 + OPS_ACC(D11_B0, 0,0,0)*AVG_1_u1)*OPS_ACC(detJ_B0, 0,0,0);

      ws_lambda_22 = (OPS_ACC(D10_B0, 0,0,0)*AVG_1_u0 + OPS_ACC(D11_B0, 0,0,0)*AVG_1_u1)*OPS_ACC(detJ_B0, 0,0,0);

       ws_lambda_33 = sqrt((OPS_ACC(D10_B0, 0,0,0)*OPS_ACC(D10_B0, 0,0,0))*(OPS_ACC(detJ_B0, 0,0,0)*OPS_ACC(detJ_B0, 0,0,0)) +
            (OPS_ACC(D11_B0, 0,0,0)*OPS_ACC(D11_B0, 0,0,0))*(OPS_ACC(detJ_B0, 0,0,0)*OPS_ACC(detJ_B0, 0,0,0)))*AVG_1_a +
            OPS_ACC(D10_B0, 0,0,0)*OPS_ACC(detJ_B0, 0,0,0)*AVG_1_u0 + OPS_ACC(D11_B0, 0,0,0)*OPS_ACC(detJ_B0, 0,0,0)*AVG_1_u1;

       ws_lambda_44 = -sqrt((OPS_ACC(D10_B0, 0,0,0)*OPS_ACC(D10_B0, 0,0,0))*(OPS_ACC(detJ_B0, 0,0,0)*OPS_ACC(detJ_B0, 0,0,0)) +
            (OPS_ACC(D11_B0, 0,0,0)*OPS_ACC(D11_B0, 0,0,0))*(OPS_ACC(detJ_B0, 0,0,0)*OPS_ACC(detJ_B0, 0,0,0)))*AVG_1_a +
            OPS_ACC(D10_B0, 0,0,0)*OPS_ACC(detJ_B0, 0,0,0)*AVG_1_u0 + OPS_ACC(D11_B0, 0,0,0)*OPS_ACC(detJ_B0, 0,0,0)*AVG_1_u1;
      ...
      AVG_1_u0 = ((1.0/2.0))*(OPS_ACC(u0_B0, 0,1,0) + OPS_ACC(u0_B0, 0,2,0));

      AVG_1_u2 = ((1.0/2.0))*(OPS_ACC(u2_B0, 0,1,0) + OPS_ACC(u2_B0, 0,2,0));

      AVG_1_rho = ((1.0/2.0))*(OPS_ACC(rho_B0, 0,1,0) + OPS_ACC(rho_B0, 0,2,0));

      AVG_1_u1 = ((1.0/2.0))*(OPS_ACC(u1_B0, 0,1,0) + OPS_ACC(u1_B0, 0,2,0));

      AVG_1_a = ((1.0/2.0))*(OPS_ACC(a_B0, 0,1,0) + OPS_ACC(a_B0, 0,2,0));
      ...
      AVG_1_1_LEV_44 = 0.707106781186547*gamma_m1*inv_AVG_a*inv_AVG_rho;
       ...
       alpha_02 = (-OPS_ACC(rho_B0, 0,1,0) + OPS_ACC(rho_B0, 0,2,0))*AVG_1_1_LEV_00 + (-OPS_ACC(rhoE_B0, 0,1,0) + OPS_ACC(rhoE_B0, 0,2,0))*AVG_1_1_LEV_04 +
            (-OPS_ACC(rhou0_B0, 0,1,0) + OPS_ACC(rhou0_B0, 0,2,0))*AVG_1_1_LEV_01 + (-OPS_ACC(rhou1_B0, 0,1,0) + OPS_ACC(rhou1_B0, 0,2,0))*AVG_1_1_LEV_02 +
            (-OPS_ACC(rhou2_B0, 0,1,0) + OPS_ACC(rhou2_B0, 0,2,0))*AVG_1_1_LEV_03;

       alpha_12 = (-OPS_ACC(rho_B0, 0,1,0) + OPS_ACC(rho_B0, 0,2,0))*AVG_1_1_LEV_10 + (-OPS_ACC(rhoE_B0, 0,1,0) + OPS_ACC(rhoE_B0, 0,2,0))*AVG_1_1_LEV_14 +
            (-OPS_ACC(rhou0_B0, 0,1,0) + OPS_ACC(rhou0_B0, 0,2,0))*AVG_1_1_LEV_11 + (-OPS_ACC(rhou1_B0, 0,1,0) + OPS_ACC(rhou1_B0, 0,2,0))*AVG_1_1_LEV_12 +
            (-OPS_ACC(rhou2_B0, 0,1,0) + OPS_ACC(rhou2_B0, 0,2,0))*AVG_1_1_LEV_13;

       alpha_22 = (-OPS_ACC(rho_B0, 0,1,0) + OPS_ACC(rho_B0, 0,2,0))*AVG_1_1_LEV_20 + (-OPS_ACC(rhou0_B0, 0,1,0) + OPS_ACC(rhou0_B0, 0,2,0))*AVG_1_1_LEV_21
            + (-OPS_ACC(rhou1_B0, 0,1,0) + OPS_ACC(rhou1_B0, 0,2,0))*AVG_1_1_LEV_22;

       alpha_32 = (-OPS_ACC(rho_B0, 0,1,0) + OPS_ACC(rho_B0, 0,2,0))*AVG_1_1_LEV_30 + (-OPS_ACC(rhoE_B0, 0,1,0) + OPS_ACC(rhoE_B0, 0,2,0))*AVG_1_1_LEV_34 +
            (-OPS_ACC(rhou0_B0, 0,1,0) + OPS_ACC(rhou0_B0, 0,2,0))*AVG_1_1_LEV_31 + (-OPS_ACC(rhou1_B0, 0,1,0) + OPS_ACC(rhou1_B0, 0,2,0))*AVG_1_1_LEV_32 +
            (-OPS_ACC(rhou2_B0, 0,1,0) + OPS_ACC(rhou2_B0, 0,2,0))*AVG_1_1_LEV_33;

       alpha_42 = (-OPS_ACC(rho_B0, 0,1,0) + OPS_ACC(rho_B0, 0,2,0))*AVG_1_1_LEV_40 + (-OPS_ACC(rhoE_B0, 0,1,0) + OPS_ACC(rhoE_B0, 0,2,0))*AVG_1_1_LEV_44 +
            (-OPS_ACC(rhou0_B0, 0,1,0) + OPS_ACC(rhou0_B0, 0,2,0))*AVG_1_1_LEV_41 + (-OPS_ACC(rhou1_B0, 0,1,0) + OPS_ACC(rhou1_B0, 0,2,0))*AVG_1_1_LEV_42 +
            (-OPS_ACC(rhou2_B0, 0,1,0) + OPS_ACC(rhou2_B0, 0,2,0))*AVG_1_1_LEV_43;
...
: (
      ...
      phi_star_4 = kappa_TVD*phi_4*theta_4;
       ...
       OPS_ACC(Residual0_B0, 0,0,0) = 0.5*(AVG_1_REV_00*phi_star_0 + AVG_1_REV_01*phi_star_1 + AVG_1_REV_03*phi_star_3 +
            AVG_1_REV_04*phi_star_4);

       OPS_ACC(Residual1_B0, 0,0,0) = 0.5*(AVG_1_REV_10*phi_star_0 + AVG_1_REV_11*phi_star_1 + AVG_1_REV_12*phi_star_2 +
            AVG_1_REV_13*phi_star_3 + AVG_1_REV_14*phi_star_4);

       OPS_ACC(Residual2_B0, 0,0,0) = 0.5*(AVG_1_REV_20*phi_star_0 + AVG_1_REV_21*phi_star_1 + AVG_1_REV_22*phi_star_2 +
            AVG_1_REV_23*phi_star_3 + AVG_1_REV_24*phi_star_4);

       OPS_ACC(Residual3_B0, 0,0,0) = 0.5*(AVG_1_REV_30*phi_star_0 + AVG_1_REV_31*phi_star_1 + AVG_1_REV_33*phi_star_3 +
            AVG_1_REV_34*phi_star_4);

       OPS_ACC(Residual4_B0, 0,0,0) = 0.5*(AVG_1_REV_40*phi_star_0 + AVG_1_REV_41*phi_star_1 + AVG_1_REV_42*phi_star_2 +
