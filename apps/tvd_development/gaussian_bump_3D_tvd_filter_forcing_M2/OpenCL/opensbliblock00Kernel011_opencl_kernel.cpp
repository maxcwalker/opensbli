...
//
    ...
    void buildOpenCLKernels_opensbliblock00Kernel011(OPS_instance *instance, int xdim0, int ydim0, int xdim1, int ydim1, int xdim2, int ydim2) {
      ...
      if(!isbuilt_opensbliblock00Kernel011) {
        ...
        instance->ostream() <<"Compiling opensbliblock00Kernel011 "<<OCL_FMA<<" source -- start \n";
          ...
          if (pPath!=NULL)
            if(OCL_FMA)
              sprintf(buildOpts,"-cl-mad-enable -DOCL_FMA -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_opensbliblock00Kernel011=%d  -Dydim0_opensbliblock00Kernel011=%d  -Dxdim1_opensbliblock00Kernel011=%d  -Dydim1_opensbliblock00Kernel011=%d  -Dxdim2_opensbliblock00Kernel011=%d  -Dydim2_opensbliblock00Kernel011=%d ", pPath, 32,xdim0,ydim0,xdim1,ydim1,xdim2,ydim2);
            else
...
void ops_par_loop_opensbliblock00Kernel011(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  if (globalWorkSize[0]>0 && globalWorkSize[1]>0 && globalWorkSize[2]>0) {
    ...
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[15], 3, sizeof(cl_double), (void*) &Minf ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[15], 4, sizeof(cl_double), (void*) &gama ));
    ...
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[15], 8, sizeof(cl_int), (void*) &x_size ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[15], 9, sizeof(cl_int), (void*) &y_size ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[15], 10, sizeof(cl_int), (void*) &z_size ));
