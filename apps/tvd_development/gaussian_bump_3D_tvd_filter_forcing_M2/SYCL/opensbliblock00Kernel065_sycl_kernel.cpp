...
void ops_par_loop_opensbliblock00Kernel065_execute(ops_kernel_descriptor *desc) {
 ...
 arg15, arg16, arg17};
  ...
  #ifdef OPS_DEBUG
  ops_register_args(block->instance, args, "opensbliblock00Kernel065");
  #endif
  ...
  int xdim0_opensbliblock00Kernel065 = args[0].dat->size[0];
  int ydim0_opensbliblock00Kernel065 = args[0].dat->size[1];
  int xdim1_opensbliblock00Kernel065 = args[1].dat->size[0];
  int ydim1_opensbliblock00Kernel065 = args[1].dat->size[1];
  int xdim2_opensbliblock00Kernel065 = args[2].dat->size[0];
  int ydim2_opensbliblock00Kernel065 = args[2].dat->size[1];
  int xdim3_opensbliblock00Kernel065 = args[3].dat->size[0];
  int ydim3_opensbliblock00Kernel065 = args[3].dat->size[1];
  int xdim4_opensbliblock00Kernel065 = args[4].dat->size[0];
  int ydim4_opensbliblock00Kernel065 = args[4].dat->size[1];
  int xdim5_opensbliblock00Kernel065 = args[5].dat->size[0];
  int ydim5_opensbliblock00Kernel065 = args[5].dat->size[1];
  int xdim6_opensbliblock00Kernel065 = args[6].dat->size[0];
  int ydim6_opensbliblock00Kernel065 = args[6].dat->size[1];
  int xdim7_opensbliblock00Kernel065 = args[7].dat->size[0];
  int ydim7_opensbliblock00Kernel065 = args[7].dat->size[1];
  int xdim8_opensbliblock00Kernel065 = args[8].dat->size[0];
  int ydim8_opensbliblock00Kernel065 = args[8].dat->size[1];
  int xdim9_opensbliblock00Kernel065 = args[9].dat->size[0];
  int ydim9_opensbliblock00Kernel065 = args[9].dat->size[1];
  int xdim10_opensbliblock00Kernel065 = args[10].dat->size[0];
  int ydim10_opensbliblock00Kernel065 = args[10].dat->size[1];
  int xdim11_opensbliblock00Kernel065 = args[11].dat->size[0];
  int ydim11_opensbliblock00Kernel065 = args[11].dat->size[1];
  int xdim12_opensbliblock00Kernel065 = args[12].dat->size[0];
  int ydim12_opensbliblock00Kernel065 = args[12].dat->size[1];
  int xdim13_opensbliblock00Kernel065 = args[13].dat->size[0];
  int ydim13_opensbliblock00Kernel065 = args[13].dat->size[1];
  int xdim14_opensbliblock00Kernel065 = args[14].dat->size[0];
  int ydim14_opensbliblock00Kernel065 = args[14].dat->size[1];
  int xdim15_opensbliblock00Kernel065 = args[15].dat->size[0];
  int ydim15_opensbliblock00Kernel065 = args[15].dat->size[1];
  int xdim16_opensbliblock00Kernel065 = args[16].dat->size[0];
  int ydim16_opensbliblock00Kernel065 = args[16].dat->size[1];
  int xdim17_opensbliblock00Kernel065 = args[17].dat->size[0];
  int ydim17_opensbliblock00Kernel065 = args[17].dat->size[1];
  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0 && (end[2]-start[2])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      cgh.parallel_for<class opensbliblock00Kernel065_kernel>(cl::sycl::nd_range<3>(cl::sycl::range<3>(
      ...
      , [=](cl::sycl::nd_item<3> item
        ...
        const ACC<double> D10_B0(xdim0_opensbliblock00Kernel065, ydim0_opensbliblock00Kernel065, &D10_B0_p[0] + base0 + n_x*1 + n_y * xdim0_opensbliblock00Kernel065*1 + n_z * xdim0_opensbliblock00Kernel065 * ydim0_opensbliblock00Kernel065*1);
        const ACC<double> D11_B0(xdim1_opensbliblock00Kernel065, ydim1_opensbliblock00Kernel065, &D11_B0_p[0] + base1 + n_x*1 + n_y * xdim1_opensbliblock00Kernel065*1 + n_z * xdim1_opensbliblock00Kernel065 * ydim1_opensbliblock00Kernel065*1);
        const ACC<double> a_B0(xdim2_opensbliblock00Kernel065, ydim2_opensbliblock00Kernel065, &a_B0_p[0] + base2 + n_x*1 + n_y * xdim2_opensbliblock00Kernel065*1 + n_z * xdim2_opensbliblock00Kernel065 * ydim2_opensbliblock00Kernel065*1);
        const ACC<double> detJ_B0(xdim3_opensbliblock00Kernel065, ydim3_opensbliblock00Kernel065, &detJ_B0_p[0] + base3 + n_x*1 + n_y * xdim3_opensbliblock00Kernel065*1 + n_z * xdim3_opensbliblock00Kernel065 * ydim3_opensbliblock00Kernel065*1);
        const ACC<double> kappa_B0(xdim4_opensbliblock00Kernel065, ydim4_opensbliblock00Kernel065, &kappa_B0_p[0] + base4 + n_x*1 + n_y * xdim4_opensbliblock00Kernel065*1 + n_z * xdim4_opensbliblock00Kernel065 * ydim4_opensbliblock00Kernel065*1);
        const ACC<double> rhoE_B0(xdim5_opensbliblock00Kernel065, ydim5_opensbliblock00Kernel065, &rhoE_B0_p[0] + base5 + n_x*1 + n_y * xdim5_opensbliblock00Kernel065*1 + n_z * xdim5_opensbliblock00Kernel065 * ydim5_opensbliblock00Kernel065*1);
        const ACC<double> rho_B0(xdim6_opensbliblock00Kernel065, ydim6_opensbliblock00Kernel065, &rho_B0_p[0] + base6 + n_x*1 + n_y * xdim6_opensbliblock00Kernel065*1 + n_z * xdim6_opensbliblock00Kernel065 * ydim6_opensbliblock00Kernel065*1);
        const ACC<double> rhou0_B0(xdim7_opensbliblock00Kernel065, ydim7_opensbliblock00Kernel065, &rhou0_B0_p[0] + base7 + n_x*1 + n_y * xdim7_opensbliblock00Kernel065*1 + n_z * xdim7_opensbliblock00Kernel065 * ydim7_opensbliblock00Kernel065*1);
        const ACC<double> rhou1_B0(xdim8_opensbliblock00Kernel065, ydim8_opensbliblock00Kernel065, &rhou1_B0_p[0] + base8 + n_x*1 + n_y * xdim8_opensbliblock00Kernel065*1 + n_z * xdim8_opensbliblock00Kernel065 * ydim8_opensbliblock00Kernel065*1);
        const ACC<double> rhou2_B0(xdim9_opensbliblock00Kernel065, ydim9_opensbliblock00Kernel065, &rhou2_B0_p[0] + base9 + n_x*1 + n_y * xdim9_opensbliblock00Kernel065*1 + n_z * xdim9_opensbliblock00Kernel065 * ydim9_opensbliblock00Kernel065*1);
        const ACC<double> u0_B0(xdim10_opensbliblock00Kernel065, ydim10_opensbliblock00Kernel065, &u0_B0_p[0] + base10 + n_x*1 + n_y * xdim10_opensbliblock00Kernel065*1 + n_z * xdim10_opensbliblock00Kernel065 * ydim10_opensbliblock00Kernel065*1);
        const ACC<double> u1_B0(xdim11_opensbliblock00Kernel065, ydim11_opensbliblock00Kernel065, &u1_B0_p[0] + base11 + n_x*1 + n_y * xdim11_opensbliblock00Kernel065*1 + n_z * xdim11_opensbliblock00Kernel065 * ydim11_opensbliblock00Kernel065*1);
        const ACC<double> u2_B0(xdim12_opensbliblock00Kernel065, ydim12_opensbliblock00Kernel065, &u2_B0_p[0] + base12 + n_x*1 + n_y * xdim12_opensbliblock00Kernel065*1 + n_z * xdim12_opensbliblock00Kernel065 * ydim12_opensbliblock00Kernel065*1);
        ACC<double> Residual0_B0(xdim13_opensbliblock00Kernel065, ydim13_opensbliblock00Kernel065, &Residual0_B0_p[0] + base13 + n_x*1 + n_y * xdim13_opensbliblock00Kernel065*1 + n_z * xdim13_opensbliblock00Kernel065 * ydim13_opensbliblock00Kernel065*1);
        ACC<double> Residual1_B0(xdim14_opensbliblock00Kernel065, ydim14_opensbliblock00Kernel065, &Residual1_B0_p[0] + base14 + n_x*1 + n_y * xdim14_opensbliblock00Kernel065*1 + n_z * xdim14_opensbliblock00Kernel065 * ydim14_opensbliblock00Kernel065*1);
        ACC<double> Residual2_B0(xdim15_opensbliblock00Kernel065, ydim15_opensbliblock00Kernel065, &Residual2_B0_p[0] + base15 + n_x*1 + n_y * xdim15_opensbliblock00Kernel065*1 + n_z * xdim15_opensbliblock00Kernel065 * ydim15_opensbliblock00Kernel065*1);
        ACC<double> Residual3_B0(xdim16_opensbliblock00Kernel065, ydim16_opensbliblock00Kernel065, &Residual3_B0_p[0] + base16 + n_x*1 + n_y * xdim16_opensbliblock00Kernel065*1 + n_z * xdim16_opensbliblock00Kernel065 * ydim16_opensbliblock00Kernel065*1);
        ACC<double> Residual4_B0(xdim17_opensbliblock00Kernel065, ydim17_opensbliblock00Kernel065, &Residual4_B0_p[0] + base17 + n_x*1 + n_y * xdim17_opensbliblock00Kernel065*1 + n_z * xdim17_opensbliblock00Kernel065 * ydim17_opensbliblock00Kernel065*1);
        //USER CODE
   ...
   double ws_lambda_44 = 0.0;
    if (cl::sycl::fmax(kappa_B0(0,1,0), cl::sycl::fmax(kappa_B0(0,2,0), cl::sycl::fmax(kappa_B0(0,-3,0), cl::sycl::fmax(kappa_B0(0,-2,0), cl::sycl::fmax(kappa_B0(0,-1,0),
...
void ops_par_loop_opensbliblock00Kernel065(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg16, ops_arg arg17) {
  ...
  desc->function = ops_par_loop_opensbliblock00Kernel065_execute;
  if (block->instance->OPS_diags > 1) {
    ops_timing_realloc(block->instance,37,"opensbliblock00Kernel065");
  }
