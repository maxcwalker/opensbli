  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0 && (end[2]-start[2])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      , [=](cl::sycl::nd_item<3> item
        ...
        ACC<double> SD000_B0(xdim4_opensbliblock00Kernel056, ydim4_opensbliblock00Kernel056, &SD000_B0_p[0] + base4 + n_x*1 + n_y * xdim4_opensbliblock00Kernel056*1 + n_z * xdim4_opensbliblock00Kernel056 * ydim4_opensbliblock00Kernel056*1);
        ACC<double> SD001_B0(xdim5_opensbliblock00Kernel056, ydim5_opensbliblock00Kernel056, &SD001_B0_p[0] + base5 + n_x*1 + n_y * xdim5_opensbliblock00Kernel056*1 + n_z * xdim5_opensbliblock00Kernel056 * ydim5_opensbliblock00Kernel056*1);
        ACC<double> SD010_B0(xdim6_opensbliblock00Kernel056, ydim6_opensbliblock00Kernel056, &SD010_B0_p[0] + base6 + n_x*1 + n_y * xdim6_opensbliblock00Kernel056*1 + n_z * xdim6_opensbliblock00Kernel056 * ydim6_opensbliblock00Kernel056*1);
        ACC<double> SD011_B0(xdim7_opensbliblock00Kernel056, ydim7_opensbliblock00Kernel056, &SD011_B0_p[0] + base7 + n_x*1 + n_y * xdim7_opensbliblock00Kernel056*1 + n_z * xdim7_opensbliblock00Kernel056 * ydim7_opensbliblock00Kernel056*1);
        ACC<double> SD100_B0(xdim8_opensbliblock00Kernel056, ydim8_opensbliblock00Kernel056, &SD100_B0_p[0] + base8 + n_x*1 + n_y * xdim8_opensbliblock00Kernel056*1 + n_z * xdim8_opensbliblock00Kernel056 * ydim8_opensbliblock00Kernel056*1);
        ACC<double> SD101_B0(xdim9_opensbliblock00Kernel056, ydim9_opensbliblock00Kernel056, &SD101_B0_p[0] + base9 + n_x*1 + n_y * xdim9_opensbliblock00Kernel056*1 + n_z * xdim9_opensbliblock00Kernel056 * ydim9_opensbliblock00Kernel056*1);
        ACC<double> SD110_B0(xdim10_opensbliblock00Kernel056, ydim10_opensbliblock00Kernel056, &SD110_B0_p[0] + base10 + n_x*1 + n_y * xdim10_opensbliblock00Kernel056*1 + n_z * xdim10_opensbliblock00Kernel056 * ydim10_opensbliblock00Kernel056*1);
        ACC<double> SD111_B0(xdim11_opensbliblock00Kernel056, ydim11_opensbliblock00Kernel056, &SD111_B0_p[0] + base11 + n_x*1 + n_y * xdim11_opensbliblock00Kernel056*1 + n_z * xdim11_opensbliblock00Kernel056 * ydim11_opensbliblock00Kernel056*1);
        //USER CODE
