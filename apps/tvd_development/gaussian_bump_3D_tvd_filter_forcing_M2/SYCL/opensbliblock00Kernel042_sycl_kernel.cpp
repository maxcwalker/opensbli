  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0 && (end[2]-start[2])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      , [=](cl::sycl::nd_item<3> item
        ...
        ACC<double> rhoE_B0(xdim0_opensbliblock00Kernel042, ydim0_opensbliblock00Kernel042, &rhoE_B0_p[0] + base0 + n_x*1 + n_y * xdim0_opensbliblock00Kernel042*1 + n_z * xdim0_opensbliblock00Kernel042 * ydim0_opensbliblock00Kernel042*1);
        ACC<double> rho_B0(xdim1_opensbliblock00Kernel042, ydim1_opensbliblock00Kernel042, &rho_B0_p[0] + base1 + n_x*1 + n_y * xdim1_opensbliblock00Kernel042*1 + n_z * xdim1_opensbliblock00Kernel042 * ydim1_opensbliblock00Kernel042*1);
        ACC<double> rhou0_B0(xdim2_opensbliblock00Kernel042, ydim2_opensbliblock00Kernel042, &rhou0_B0_p[0] + base2 + n_x*1 + n_y * xdim2_opensbliblock00Kernel042*1 + n_z * xdim2_opensbliblock00Kernel042 * ydim2_opensbliblock00Kernel042*1);
        ACC<double> rhou1_B0(xdim3_opensbliblock00Kernel042, ydim3_opensbliblock00Kernel042, &rhou1_B0_p[0] + base3 + n_x*1 + n_y * xdim3_opensbliblock00Kernel042*1 + n_z * xdim3_opensbliblock00Kernel042 * ydim3_opensbliblock00Kernel042*1);
        ACC<double> rhou2_B0(xdim4_opensbliblock00Kernel042, ydim4_opensbliblock00Kernel042, &rhou2_B0_p[0] + base4 + n_x*1 + n_y * xdim4_opensbliblock00Kernel042*1 + n_z * xdim4_opensbliblock00Kernel042 * ydim4_opensbliblock00Kernel042*1);
        ACC<double> x0_B0(xdim5_opensbliblock00Kernel042, ydim5_opensbliblock00Kernel042, &x0_B0_p[0] + base5 + n_x*1 + n_y * xdim5_opensbliblock00Kernel042*1 + n_z * xdim5_opensbliblock00Kernel042 * ydim5_opensbliblock00Kernel042*1);
        ACC<double> x2_B0(xdim6_opensbliblock00Kernel042, ydim6_opensbliblock00Kernel042, &x2_B0_p[0] + base6 + n_x*1 + n_y * xdim6_opensbliblock00Kernel042*1 + n_z * xdim6_opensbliblock00Kernel042 * ydim6_opensbliblock00Kernel042*1);
        ACC<double> x1_B0(xdim7_opensbliblock00Kernel042, ydim7_opensbliblock00Kernel042, &x1_B0_p[0] + base7 + n_x*1 + n_y * xdim7_opensbliblock00Kernel042*1 + n_z * xdim7_opensbliblock00Kernel042 * ydim7_opensbliblock00Kernel042*1);
        //USER CODE
   ...
   x0_B0(0,0,0) = Delta0block0_sycl[0]*idx[0];
    ...
    x1_B0(0,0,0) = ((1.0/20.0))*H_sycl[0]*cl::sycl::exp(-((-(1.0/2.0)*L_sycl[0] + Delta0block0_sycl[0]*idx[0])*(-(1.0/2.0)*L_sycl[0] +
     ...
     wall_0 =  ((1.0/20.0))*H_sycl[0]*cl::sycl::exp(-((-(1.0/2.0)*L_sycl[0] + Delta0block0_sycl[0]*idx[0])*(-(1.0/2.0)*L_sycl[0] +
      Delta0block0_sycl[0]*idx[0]))*inv2a_sycl[0]);
