 ...
 arg15, arg16, arg17};
  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0 && (end[2]-start[2])>0) {
   ...
   double ws_lambda_44 = 0.0;
    if (cl::sycl::fmax(kappa_B0(1,0,0), cl::sycl::fmax(kappa_B0(2,0,0), cl::sycl::fmax(kappa_B0(-3,0,0), cl::sycl::fmax(kappa_B0(-2,0,0), cl::sycl::fmax(kappa_B0(-1,0,0),
      kappa_B0(0,0,0)))))) > Ducros_check_sycl[0]){
