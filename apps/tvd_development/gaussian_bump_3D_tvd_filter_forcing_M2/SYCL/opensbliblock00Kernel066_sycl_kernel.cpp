...
void ops_par_loop_opensbliblock00Kernel066_execute(ops_kernel_descriptor *desc) {
 ...
 arg15};
  ...
  double* u1_B0_p = (double*)args[9].data_d;

  int base10 = args[10].dat->base_offset/sizeof(double);
  double* u2_B0_p = (double*)args[10].data_d;

  int base11 = args[11].dat->base_offset/sizeof(double);
  double* rhoE_RKold_B0_p = (double*)args[11].data_d;

  int base12 = args[12].dat->base_offset/sizeof(double);
  double* rho_RKold_B0_p = (double*)args[12].data_d;

  int base13 = args[13].dat->base_offset/sizeof(double);
  double* rhou0_RKold_B0_p = (double*)args[13].data_d;

  int base14 = args[14].dat->base_offset/sizeof(double);
  double* rhou1_RKold_B0_p = (double*)args[14].data_d;

  int base15 = args[15].dat->base_offset/sizeof(double);
  double* rhou2_RKold_B0_p = (double*)args[15].data_d;
  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0 && (end[2]-start[2])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      cgh.parallel_for<class opensbliblock00Kernel066_kernel>(cl::sycl::nd_range<3>(cl::sycl::range<3>(
      ...
      , [=](cl::sycl::nd_item<3> item
        ...
        const ACC<double> a_B0(xdim0_opensbliblock00Kernel066, ydim0_opensbliblock00Kernel066, &a_B0_p[0] + base0 + n_x*1 + n_y * xdim0_opensbliblock00Kernel066*1 + n_z * xdim0_opensbliblock00Kernel066 * ydim0_opensbliblock00Kernel066*1);
        const ACC<double> detJ_B0(xdim1_opensbliblock00Kernel066, ydim1_opensbliblock00Kernel066, &detJ_B0_p[0] + base1 + n_x*1 + n_y * xdim1_opensbliblock00Kernel066*1 + n_z * xdim1_opensbliblock00Kernel066 * ydim1_opensbliblock00Kernel066*1);
        const ACC<double> kappa_B0(xdim2_opensbliblock00Kernel066, ydim2_opensbliblock00Kernel066, &kappa_B0_p[0] + base2 + n_x*1 + n_y * xdim2_opensbliblock00Kernel066*1 + n_z * xdim2_opensbliblock00Kernel066 * ydim2_opensbliblock00Kernel066*1);
        const ACC<double> rhoE_B0(xdim3_opensbliblock00Kernel066, ydim3_opensbliblock00Kernel066, &rhoE_B0_p[0] + base3 + n_x*1 + n_y * xdim3_opensbliblock00Kernel066*1 + n_z * xdim3_opensbliblock00Kernel066 * ydim3_opensbliblock00Kernel066*1);
        const ACC<double> rho_B0(xdim4_opensbliblock00Kernel066, ydim4_opensbliblock00Kernel066, &rho_B0_p[0] + base4 + n_x*1 + n_y * xdim4_opensbliblock00Kernel066*1 + n_z * xdim4_opensbliblock00Kernel066 * ydim4_opensbliblock00Kernel066*1);
        const ACC<double> rhou0_B0(xdim5_opensbliblock00Kernel066, ydim5_opensbliblock00Kernel066, &rhou0_B0_p[0] + base5 + n_x*1 + n_y * xdim5_opensbliblock00Kernel066*1 + n_z * xdim5_opensbliblock00Kernel066 * ydim5_opensbliblock00Kernel066*1);
        const ACC<double> rhou1_B0(xdim6_opensbliblock00Kernel066, ydim6_opensbliblock00Kernel066, &rhou1_B0_p[0] + base6 + n_x*1 + n_y * xdim6_opensbliblock00Kernel066*1 + n_z * xdim6_opensbliblock00Kernel066 * ydim6_opensbliblock00Kernel066*1);
        const ACC<double> rhou2_B0(xdim7_opensbliblock00Kernel066, ydim7_opensbliblock00Kernel066, &rhou2_B0_p[0] + base7 + n_x*1 + n_y * xdim7_opensbliblock00Kernel066*1 + n_z * xdim7_opensbliblock00Kernel066 * ydim7_opensbliblock00Kernel066*1);
        const ACC<double> u0_B0(xdim8_opensbliblock00Kernel066, ydim8_opensbliblock00Kernel066, &u0_B0_p[0] + base8 + n_x*1 + n_y * xdim8_opensbliblock00Kernel066*1 + n_z * xdim8_opensbliblock00Kernel066 * ydim8_opensbliblock00Kernel066*1);
        const ACC<double> u1_B0(xdim9_opensbliblock00Kernel066, ydim9_opensbliblock00Kernel066, &u1_B0_p[0] + base9 + n_x*1 + n_y * xdim9_opensbliblock00Kernel066*1 + n_z * xdim9_opensbliblock00Kernel066 * ydim9_opensbliblock00Kernel066*1);
        const ACC<double> u2_B0(xdim10_opensbliblock00Kernel066, ydim10_opensbliblock00Kernel066, &u2_B0_p[0] + base10 + n_x*1 + n_y * xdim10_opensbliblock00Kernel066*1 + n_z * xdim10_opensbliblock00Kernel066 * ydim10_opensbliblock00Kernel066*1);
        ACC<double> rhoE_RKold_B0(xdim11_opensbliblock00Kernel066, ydim11_opensbliblock00Kernel066, &rhoE_RKold_B0_p[0] + base11 + n_x*1 + n_y * xdim11_opensbliblock00Kernel066*1 + n_z * xdim11_opensbliblock00Kernel066 * ydim11_opensbliblock00Kernel066*1);
        ACC<double> rho_RKold_B0(xdim12_opensbliblock00Kernel066, ydim12_opensbliblock00Kernel066, &rho_RKold_B0_p[0] + base12 + n_x*1 + n_y * xdim12_opensbliblock00Kernel066*1 + n_z * xdim12_opensbliblock00Kernel066 * ydim12_opensbliblock00Kernel066*1);
        ACC<double> rhou0_RKold_B0(xdim13_opensbliblock00Kernel066, ydim13_opensbliblock00Kernel066, &rhou0_RKold_B0_p[0] + base13 + n_x*1 + n_y * xdim13_opensbliblock00Kernel066*1 + n_z * xdim13_opensbliblock00Kernel066 * ydim13_opensbliblock00Kernel066*1);
        ACC<double> rhou1_RKold_B0(xdim14_opensbliblock00Kernel066, ydim14_opensbliblock00Kernel066, &rhou1_RKold_B0_p[0] + base14 + n_x*1 + n_y * xdim14_opensbliblock00Kernel066*1 + n_z * xdim14_opensbliblock00Kernel066 * ydim14_opensbliblock00Kernel066*1);
        ACC<double> rhou2_RKold_B0(xdim15_opensbliblock00Kernel066, ydim15_opensbliblock00Kernel066, &rhou2_RKold_B0_p[0] + base15 + n_x*1 + n_y * xdim15_opensbliblock00Kernel066*1 + n_z * xdim15_opensbliblock00Kernel066 * ydim15_opensbliblock00Kernel066*1);
        //USER CODE
   ...
   double ws_lambda_44 = 0.0;
    if (cl::sycl::fmax(kappa_B0(0,0,-3), cl::sycl::fmax(kappa_B0(0,0,1), cl::sycl::fmax(kappa_B0(0,0,-2), cl::sycl::fmax(kappa_B0(0,0,-1), cl::sycl::fmax(kappa_B0(0,0,2),
