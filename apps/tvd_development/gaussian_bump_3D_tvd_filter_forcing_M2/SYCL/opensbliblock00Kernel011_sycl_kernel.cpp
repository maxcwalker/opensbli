  ...
  if ((end[0]-start[0])>0 && (end[1]-start[1])>0 && (end[2]-start[2])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      , [=](cl::sycl::nd_item<3> item
        ...
        ACC<double> T_B0(xdim2_opensbliblock00Kernel011, ydim2_opensbliblock00Kernel011, &T_B0_p[0] + base2 + n_x*1 + n_y * xdim2_opensbliblock00Kernel011*1 + n_z * xdim2_opensbliblock00Kernel011 * ydim2_opensbliblock00Kernel011*1);
        //USER CODE
