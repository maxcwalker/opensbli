  ...
  for ( int n_z=start[2]; n_z<end[2]; n_z++ ){
    for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
      ...
      for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
        ...
        ACC<double> SD000_B0(xdim4_opensbliblock00Kernel056, ydim4_opensbliblock00Kernel056, SD000_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel056*1 + n_z * xdim4_opensbliblock00Kernel056 * ydim4_opensbliblock00Kernel056*1);
        ACC<double> SD001_B0(xdim5_opensbliblock00Kernel056, ydim5_opensbliblock00Kernel056, SD001_B0_p + n_x*1 + n_y * xdim5_opensbliblock00Kernel056*1 + n_z * xdim5_opensbliblock00Kernel056 * ydim5_opensbliblock00Kernel056*1);
        ACC<double> SD010_B0(xdim6_opensbliblock00Kernel056, ydim6_opensbliblock00Kernel056, SD010_B0_p + n_x*1 + n_y * xdim6_opensbliblock00Kernel056*1 + n_z * xdim6_opensbliblock00Kernel056 * ydim6_opensbliblock00Kernel056*1);
        ACC<double> SD011_B0(xdim7_opensbliblock00Kernel056, ydim7_opensbliblock00Kernel056, SD011_B0_p + n_x*1 + n_y * xdim7_opensbliblock00Kernel056*1 + n_z * xdim7_opensbliblock00Kernel056 * ydim7_opensbliblock00Kernel056*1);
        ACC<double> SD100_B0(xdim8_opensbliblock00Kernel056, ydim8_opensbliblock00Kernel056, SD100_B0_p + n_x*1 + n_y * xdim8_opensbliblock00Kernel056*1 + n_z * xdim8_opensbliblock00Kernel056 * ydim8_opensbliblock00Kernel056*1);
        ACC<double> SD101_B0(xdim9_opensbliblock00Kernel056, ydim9_opensbliblock00Kernel056, SD101_B0_p + n_x*1 + n_y * xdim9_opensbliblock00Kernel056*1 + n_z * xdim9_opensbliblock00Kernel056 * ydim9_opensbliblock00Kernel056*1);
        ACC<double> SD110_B0(xdim10_opensbliblock00Kernel056, ydim10_opensbliblock00Kernel056, SD110_B0_p + n_x*1 + n_y * xdim10_opensbliblock00Kernel056*1 + n_z * xdim10_opensbliblock00Kernel056 * ydim10_opensbliblock00Kernel056*1);
        ACC<double> SD111_B0(xdim11_opensbliblock00Kernel056, ydim11_opensbliblock00Kernel056, SD111_B0_p + n_x*1 + n_y * xdim11_opensbliblock00Kernel056*1 + n_z * xdim11_opensbliblock00Kernel056 * ydim11_opensbliblock00Kernel056*1);
...
void ops_par_loop_opensbliblock00Kernel056(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg12) {
  ...
  create_kerneldesc_and_enque(name, args, 13, 6, dim, 0, range, block, ops_par_loop_opensbliblock00Kernel056_execute);
}
#endif
