...
void opensbliblock00Kernel004_c_wrapper(
  ...
  for ( int n_y=0; n_y<y_size; n_y++ ){
    for ( int n_x=0; n_x<x_size; n_x++ ){
      const ptr_double u0_B0 = { u0_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel004*1, xdim0_opensbliblock00Kernel004};
      const ptr_double u1_B0 = { u1_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel004*1, xdim1_opensbliblock00Kernel004};
      const ptr_double p_B0 = { p_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel004*1, xdim2_opensbliblock00Kernel004};
      const ptr_double rhoE_B0 = { rhoE_B0_p + n_x*1 + n_y * xdim3_opensbliblock00Kernel004*1, xdim3_opensbliblock00Kernel004};
      ...
      const ptr_double a_B0 = { a_B0_p + n_x*1 + n_y * xdim6_opensbliblock00Kernel004*1, xdim6_opensbliblock00Kernel004};
      const ptr_double rho_B0 = { rho_B0_p + n_x*1 + n_y * xdim7_opensbliblock00Kernel004*1, xdim7_opensbliblock00Kernel004};
      const ptr_double theta_B0 = { theta_B0_p + n_x*1 + n_y * xdim8_opensbliblock00Kernel004*1, xdim8_opensbliblock00Kernel004};
      ptr_double wk6_B0 = { wk6_B0_p + n_x*1 + n_y * xdim9_opensbliblock00Kernel004*1, xdim9_opensbliblock00Kernel004};
      ptr_double wk7_B0 = { wk7_B0_p + n_x*1 + n_y * xdim10_opensbliblock00Kernel004*1, xdim10_opensbliblock00Kernel004};
      ptr_double wk5_B0 = { wk5_B0_p + n_x*1 + n_y * xdim11_opensbliblock00Kernel004*1, xdim11_opensbliblock00Kernel004};
      ptr_double wk4_B0 = { wk4_B0_p + n_x*1 + n_y * xdim12_opensbliblock00Kernel004*1, xdim12_opensbliblock00Kernel004};
   ...
   CS_15 = AVG_1_1_LEV_10*OPS_ACC(rho_B0, 0,3) + AVG_1_1_LEV_11*OPS_ACC(rhou0_B0, 0,3);
    ...
    max_lambda_1_00 = fmax(fabs(OPS_ACC(u1_B0, 0,0)), fmax(fabs(OPS_ACC(u1_B0, 0,-2)),
      fmax(fabs(OPS_ACC(u1_B0, 0,-1)), fmax(fabs(OPS_ACC(u1_B0, 0,1)), fmax(fabs(OPS_ACC(u1_B0, 0,2)),
      fabs(OPS_ACC(u1_B0, 0,3)))))));

   max_lambda_1_11 = max_lambda_1_00;

    max_lambda_1_22 = fmax(fabs(OPS_ACC(a_B0, 0,0) + OPS_ACC(u1_B0, 0,0)), fmax(fabs(OPS_ACC(a_B0, 0,3) +
      OPS_ACC(u1_B0, 0,3)), fmax(fabs(OPS_ACC(a_B0, 0,-2) + OPS_ACC(u1_B0, 0,-2)), fmax(fabs(OPS_ACC(a_B0, 0,-1) +
      OPS_ACC(u1_B0, 0,-1)), fmax(fabs(OPS_ACC(a_B0, 0,1) + OPS_ACC(u1_B0, 0,1)), fabs(OPS_ACC(a_B0, 0,2) +
      OPS_ACC(u1_B0, 0,2)))))));

    max_lambda_1_33 = fmax(fabs(OPS_ACC(a_B0, 0,2) - OPS_ACC(u1_B0, 0,2)), fmax(fabs(OPS_ACC(a_B0, 0,-1) -
      OPS_ACC(u1_B0, 0,-1)), fmax(fabs(OPS_ACC(a_B0, 0,0) - OPS_ACC(u1_B0, 0,0)), fmax(fabs(OPS_ACC(a_B0, 0,-2) -
      OPS_ACC(u1_B0, 0,-2)), fmax(fabs(OPS_ACC(a_B0, 0,1) - OPS_ACC(u1_B0, 0,1)), fabs(OPS_ACC(a_B0, 0,3) -
      OPS_ACC(u1_B0, 0,3)))))));
