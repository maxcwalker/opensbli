...
void opensbliblock00Kernel017_c_wrapper(
  ...
  for ( int n_y=0; n_y<y_size; n_y++ ){
    for ( int n_x=0; n_x<x_size; n_x++ ){
      const ptr_double rho_B0 = { rho_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel017*1, xdim0_opensbliblock00Kernel017};
      const ptr_double p_B0 = { p_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel017*1, xdim1_opensbliblock00Kernel017};
      ptr_double T_B0 = { T_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel017*1, xdim2_opensbliblock00Kernel017};
