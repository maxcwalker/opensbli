...
void ops_par_loop_opensbliblock00Kernel004_execute(ops_kernel_descriptor *desc) {
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
      ...
      const ACC<double> rhou1_B0(xdim1_opensbliblock00Kernel004, rhou1_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel004*1);
      const ACC<double> rho_B0(xdim2_opensbliblock00Kernel004, rho_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel004*1);
      const ACC<double> theta_B0(xdim3_opensbliblock00Kernel004, theta_B0_p + n_x*1 + n_y * xdim3_opensbliblock00Kernel004*1);
      const ACC<double> p_B0(xdim4_opensbliblock00Kernel004, p_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel004*1);
      const ACC<double> rhoE_B0(xdim5_opensbliblock00Kernel004, rhoE_B0_p + n_x*1 + n_y * xdim5_opensbliblock00Kernel004*1);
      ...
      const ACC<double> rhou0_B0(xdim8_opensbliblock00Kernel004, rhou0_B0_p + n_x*1 + n_y * xdim8_opensbliblock00Kernel004*1);
