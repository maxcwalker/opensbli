...
void ops_par_loop_opensbliblock00Kernel028_execute(ops_kernel_descriptor *desc) {
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    wk6_B0(0,0) = ((idx[1] == 0) ? (
   inv_1*(-3*T_B0(0,2) + (rc9)*T_B0(0,3) -
      rc10*T_B0(0,0) - rc8*T_B0(0,4) + 4*T_B0(0,1))
)
: ((idx[1] == 1) ? (

      (rc11)*inv_1*(-3*T_B0(0,-1) - 6*T_B0(0,2) + T_B0(0,3) - 10*T_B0(0,0) +
      18*T_B0(0,1))
)
: ((idx[1] == block0np1 - 1) ? (
   inv_1*(-4*T_B0(0,-1) +
      3*T_B0(0,-2) + (rc8)*T_B0(0,-4) + (rc10)*T_B0(0,0) - rc9*T_B0(0,-3))
)
:
      ((idx[1] == block0np1 - 2) ? (
   (rc11)*inv_1*(-18*T_B0(0,-1) + 6*T_B0(0,-2) +
      10*T_B0(0,0) - T_B0(0,-3) + 3*T_B0(0,1))
)
: (

      (rc11)*inv_1*(-8*T_B0(0,-1) + T_B0(0,-2) - T_B0(0,2) +
      8*T_B0(0,1))
)))));
