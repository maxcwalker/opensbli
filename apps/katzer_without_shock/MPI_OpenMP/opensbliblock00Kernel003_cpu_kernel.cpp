...
void ops_par_loop_opensbliblock00Kernel003_execute(ops_kernel_descriptor *desc) {
  ...
  double * __restrict__ theta_B0_p = (double *)(args[2].data + base2);
  ...
  double * __restrict__ wk2_B0_p = (double *)(args[10].data + base10);
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
      const ACC<double> rho_B0(xdim0_opensbliblock00Kernel003, rho_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel003*1);
      const ACC<double> u0_B0(xdim1_opensbliblock00Kernel003, u0_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel003*1);
      const ACC<double> theta_B0(xdim2_opensbliblock00Kernel003, theta_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel003*1);
      const ACC<double> rhou1_B0(xdim3_opensbliblock00Kernel003, rhou1_B0_p + n_x*1 + n_y * xdim3_opensbliblock00Kernel003*1);
      const ACC<double> u1_B0(xdim4_opensbliblock00Kernel003, u1_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel003*1);
      const ACC<double> p_B0(xdim5_opensbliblock00Kernel003, p_B0_p + n_x*1 + n_y * xdim5_opensbliblock00Kernel003*1);
      const ACC<double> a_B0(xdim6_opensbliblock00Kernel003, a_B0_p + n_x*1 + n_y * xdim6_opensbliblock00Kernel003*1);
      const ACC<double> rhou0_B0(xdim7_opensbliblock00Kernel003, rhou0_B0_p + n_x*1 + n_y * xdim7_opensbliblock00Kernel003*1);
      const ACC<double> rhoE_B0(xdim8_opensbliblock00Kernel003, rhoE_B0_p + n_x*1 + n_y * xdim8_opensbliblock00Kernel003*1);
      ACC<double> wk0_B0(xdim9_opensbliblock00Kernel003, wk0_B0_p + n_x*1 + n_y * xdim9_opensbliblock00Kernel003*1);
      ACC<double> wk2_B0(xdim10_opensbliblock00Kernel003, wk2_B0_p + n_x*1 + n_y * xdim10_opensbliblock00Kernel003*1);
      ...
      ACC<double> wk3_B0(xdim13_opensbliblock00Kernel003, wk3_B0_p + n_x*1 + n_y * xdim13_opensbliblock00Kernel003*1);
