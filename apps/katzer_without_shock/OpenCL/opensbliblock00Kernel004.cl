...
//user function
 ...
 void opensbliblock00Kernel004(const ptr_double rho_B0,
  ...
  ptr_double wk7_B0,
  ptr_double wk5_B0,
  ptr_double wk6_B0, const double eps, const double gama, const double gamma_m1, const double teno_a1, const double teno_a2, const double rc8, const double rc11, const double rc13, const double rc15, const double rc16, const double rc17, const double rc18, const double rc19, const double rc20, const double rc21, const double rc22, const double rc23, const double rcinv24)
{
   ...
   AVG_1_inv_rho = 1.0/(sqrt(OPS_ACCS(rho_B0, 0,1)) + sqrt(OPS_ACCS(rho_B0, 0,0)));

    AVG_1_u0 = AVG_1_inv_rho*(sqrt(OPS_ACCS(rho_B0, 0,1))*OPS_ACCS(u0_B0, 0,1) +
      sqrt(OPS_ACCS(rho_B0, 0,0))*OPS_ACCS(u0_B0, 0,0));

    AVG_1_u1 = AVG_1_inv_rho*(sqrt(OPS_ACCS(rho_B0, 0,1))*OPS_ACCS(u1_B0, 0,1) +
      sqrt(OPS_ACCS(rho_B0, 0,0))*OPS_ACCS(u1_B0, 0,0));

    AVG_1_a = sqrt(gamma_m1*(AVG_1_inv_rho*((OPS_ACCS(p_B0, 0,1) + OPS_ACCS(rhoE_B0, 0,1))/sqrt(OPS_ACCS(rho_B0, 0,1)) +
      (OPS_ACCS(p_B0, 0,0) + OPS_ACCS(rhoE_B0, 0,0))/sqrt(OPS_ACCS(rho_B0, 0,0))) - rc13*(pow(AVG_1_u0, 2) +
      pow(AVG_1_u1, 2))));
   ...
   CS_15 = AVG_1_1_LEV_10*OPS_ACCS(rho_B0, 0,3) + AVG_1_1_LEV_11*OPS_ACCS(rhou0_B0, 0,3);
    ...
    max_lambda_1_00 = fmax(fabs(OPS_ACCS(u1_B0, 0,2)), fmax(fabs(OPS_ACCS(u1_B0, 0,-1)),
      fmax(fabs(OPS_ACCS(u1_B0, 0,3)), fmax(fabs(OPS_ACCS(u1_B0, 0,0)), fmax(fabs(OPS_ACCS(u1_B0, 0,1)),
      fabs(OPS_ACCS(u1_B0, 0,-2)))))));

   max_lambda_1_11 = max_lambda_1_00;

    max_lambda_1_22 = fmax(fabs(OPS_ACCS(a_B0, 0,-2) + OPS_ACCS(u1_B0, 0,-2)), fmax(fabs(OPS_ACCS(a_B0, 0,-1) +
      OPS_ACCS(u1_B0, 0,-1)), fmax(fabs(OPS_ACCS(a_B0, 0,1) + OPS_ACCS(u1_B0, 0,1)), fmax(fabs(OPS_ACCS(a_B0, 0,3) +
      OPS_ACCS(u1_B0, 0,3)), fmax(fabs(OPS_ACCS(a_B0, 0,2) + OPS_ACCS(u1_B0, 0,2)), fabs(OPS_ACCS(a_B0, 0,0) +
      OPS_ACCS(u1_B0, 0,0)))))));

    max_lambda_1_33 = fmax(fabs(OPS_ACCS(a_B0, 0,0) - OPS_ACCS(u1_B0, 0,0)), fmax(fabs(OPS_ACCS(a_B0, 0,1) -
      OPS_ACCS(u1_B0, 0,1)), fmax(fabs(OPS_ACCS(a_B0, 0,3) - OPS_ACCS(u1_B0, 0,3)), fmax(fabs(OPS_ACCS(a_B0, 0,-1) -
      OPS_ACCS(u1_B0, 0,-1)), fmax(fabs(OPS_ACCS(a_B0, 0,-2) - OPS_ACCS(u1_B0, 0,-2)), fabs(OPS_ACCS(a_B0, 0,2) -
      OPS_ACCS(u1_B0, 0,2)))))));
