...
int size1 ){
  ...
  if (idx_x < size0 && idx_y < size1) {
    ...
    ACC<double> argp2(dims_opensbliblock00Kernel017[2][0], arg2);
    opensbliblock00Kernel017_gpu(argp0, argp1, argp2);
  }
...
void ops_par_loop_opensbliblock00Kernel017_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_opensbliblock00Kernel017_h[0][0] || xdim1 != dims_opensbliblock00Kernel017_h[1][0] || xdim2 != dims_opensbliblock00Kernel017_h[2][0]) {
