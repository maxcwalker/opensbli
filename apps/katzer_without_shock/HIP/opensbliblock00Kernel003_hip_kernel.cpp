...
//
__constant__ int dims_opensbliblock00Kernel003 [14][1];
static int dims_opensbliblock00Kernel003_h [14][1] = {{0}};

//user function
__device__

 void opensbliblock00Kernel003_gpu(const ACC<double> &u0_B0,
  ...
  ACC<double> &wk0_B0)
{
   ...
   AVG_0_inv_rho = 1.0/(sqrt(rho_B0(1,0)) + sqrt(rho_B0(0,0)));

    AVG_0_u0 = AVG_0_inv_rho*(sqrt(rho_B0(1,0))*u0_B0(1,0) +
      sqrt(rho_B0(0,0))*u0_B0(0,0));

    AVG_0_u1 = AVG_0_inv_rho*(sqrt(rho_B0(1,0))*u1_B0(1,0) +
      sqrt(rho_B0(0,0))*u1_B0(0,0));

    AVG_0_a = sqrt(gamma_m1*(AVG_0_inv_rho*((p_B0(0,0) + rhoE_B0(0,0))/sqrt(rho_B0(0,0)) +
      (p_B0(1,0) + rhoE_B0(1,0))/sqrt(rho_B0(1,0))) - rc13*(pow(AVG_0_u0, 2) +
      pow(AVG_0_u1, 2))));
   ...
   AVG_0_0_LEV_33 = 0.707106781186547*gamma_m1*inv_AVG_a*inv_AVG_rho;
    ...
    CF_00 = AVG_0_0_LEV_00*rhou0_B0(-2,0) + AVG_0_0_LEV_01*p_B0(-2,0) +
      AVG_0_0_LEV_01*rhou0_B0(-2,0)*u0_B0(-2,0) +
      AVG_0_0_LEV_02*rhou1_B0(-2,0)*u0_B0(-2,0) +
      AVG_0_0_LEV_03*p_B0(-2,0)*u0_B0(-2,0) +
      AVG_0_0_LEV_03*rhoE_B0(-2,0)*u0_B0(-2,0);

   CF_10 = AVG_0_0_LEV_10*rhou0_B0(-2,0) + AVG_0_0_LEV_12*rhou1_B0(-2,0)*u0_B0(-2,0);

    CF_20 = AVG_0_0_LEV_20*rhou0_B0(-2,0) + AVG_0_0_LEV_21*p_B0(-2,0) +
      AVG_0_0_LEV_21*rhou0_B0(-2,0)*u0_B0(-2,0) +
      AVG_0_0_LEV_22*rhou1_B0(-2,0)*u0_B0(-2,0) +
      AVG_0_0_LEV_23*p_B0(-2,0)*u0_B0(-2,0) +
      AVG_0_0_LEV_23*rhoE_B0(-2,0)*u0_B0(-2,0);

    CF_30 = AVG_0_0_LEV_30*rhou0_B0(-2,0) + AVG_0_0_LEV_31*p_B0(-2,0) +
      AVG_0_0_LEV_31*rhou0_B0(-2,0)*u0_B0(-2,0) +
      AVG_0_0_LEV_32*rhou1_B0(-2,0)*u0_B0(-2,0) +
      AVG_0_0_LEV_33*p_B0(-2,0)*u0_B0(-2,0) +
      AVG_0_0_LEV_33*rhoE_B0(-2,0)*u0_B0(-2,0);

    CF_01 = AVG_0_0_LEV_00*rhou0_B0(-1,0) + AVG_0_0_LEV_01*p_B0(-1,0) +
      AVG_0_0_LEV_01*rhou0_B0(-1,0)*u0_B0(-1,0) +
      AVG_0_0_LEV_02*rhou1_B0(-1,0)*u0_B0(-1,0) +
      AVG_0_0_LEV_03*p_B0(-1,0)*u0_B0(-1,0) +
      AVG_0_0_LEV_03*rhoE_B0(-1,0)*u0_B0(-1,0);

   CF_11 = AVG_0_0_LEV_10*rhou0_B0(-1,0) + AVG_0_0_LEV_12*rhou1_B0(-1,0)*u0_B0(-1,0);

    CF_21 = AVG_0_0_LEV_20*rhou0_B0(-1,0) + AVG_0_0_LEV_21*p_B0(-1,0) +
      AVG_0_0_LEV_21*rhou0_B0(-1,0)*u0_B0(-1,0) +
      AVG_0_0_LEV_22*rhou1_B0(-1,0)*u0_B0(-1,0) +
      AVG_0_0_LEV_23*p_B0(-1,0)*u0_B0(-1,0) +
      AVG_0_0_LEV_23*rhoE_B0(-1,0)*u0_B0(-1,0);

    CF_31 = AVG_0_0_LEV_30*rhou0_B0(-1,0) + AVG_0_0_LEV_31*p_B0(-1,0) +
      AVG_0_0_LEV_31*rhou0_B0(-1,0)*u0_B0(-1,0) +
      AVG_0_0_LEV_32*rhou1_B0(-1,0)*u0_B0(-1,0) +
      AVG_0_0_LEV_33*p_B0(-1,0)*u0_B0(-1,0) +
      AVG_0_0_LEV_33*rhoE_B0(-1,0)*u0_B0(-1,0);

    CF_02 = AVG_0_0_LEV_00*rhou0_B0(0,0) + AVG_0_0_LEV_01*p_B0(0,0) +
      AVG_0_0_LEV_01*rhou0_B0(0,0)*u0_B0(0,0) +
      AVG_0_0_LEV_02*rhou1_B0(0,0)*u0_B0(0,0) +
      AVG_0_0_LEV_03*p_B0(0,0)*u0_B0(0,0) +
      AVG_0_0_LEV_03*rhoE_B0(0,0)*u0_B0(0,0);

   CF_12 = AVG_0_0_LEV_10*rhou0_B0(0,0) + AVG_0_0_LEV_12*rhou1_B0(0,0)*u0_B0(0,0);

    CF_22 = AVG_0_0_LEV_20*rhou0_B0(0,0) + AVG_0_0_LEV_21*p_B0(0,0) +
      AVG_0_0_LEV_21*rhou0_B0(0,0)*u0_B0(0,0) +
      AVG_0_0_LEV_22*rhou1_B0(0,0)*u0_B0(0,0) +
      AVG_0_0_LEV_23*p_B0(0,0)*u0_B0(0,0) +
      AVG_0_0_LEV_23*rhoE_B0(0,0)*u0_B0(0,0);

    CF_32 = AVG_0_0_LEV_30*rhou0_B0(0,0) + AVG_0_0_LEV_31*p_B0(0,0) +
      AVG_0_0_LEV_31*rhou0_B0(0,0)*u0_B0(0,0) +
      AVG_0_0_LEV_32*rhou1_B0(0,0)*u0_B0(0,0) +
      AVG_0_0_LEV_33*p_B0(0,0)*u0_B0(0,0) +
      AVG_0_0_LEV_33*rhoE_B0(0,0)*u0_B0(0,0);

    CF_03 = AVG_0_0_LEV_00*rhou0_B0(1,0) + AVG_0_0_LEV_01*p_B0(1,0) +
      AVG_0_0_LEV_01*rhou0_B0(1,0)*u0_B0(1,0) +
      AVG_0_0_LEV_02*rhou1_B0(1,0)*u0_B0(1,0) +
      AVG_0_0_LEV_03*p_B0(1,0)*u0_B0(1,0) +
      AVG_0_0_LEV_03*rhoE_B0(1,0)*u0_B0(1,0);

   CF_13 = AVG_0_0_LEV_10*rhou0_B0(1,0) + AVG_0_0_LEV_12*rhou1_B0(1,0)*u0_B0(1,0);

    CF_23 = AVG_0_0_LEV_20*rhou0_B0(1,0) + AVG_0_0_LEV_21*p_B0(1,0) +
      AVG_0_0_LEV_21*rhou0_B0(1,0)*u0_B0(1,0) +
      AVG_0_0_LEV_22*rhou1_B0(1,0)*u0_B0(1,0) +
      AVG_0_0_LEV_23*p_B0(1,0)*u0_B0(1,0) +
      AVG_0_0_LEV_23*rhoE_B0(1,0)*u0_B0(1,0);

    CF_33 = AVG_0_0_LEV_30*rhou0_B0(1,0) + AVG_0_0_LEV_31*p_B0(1,0) +
      AVG_0_0_LEV_31*rhou0_B0(1,0)*u0_B0(1,0) +
      AVG_0_0_LEV_32*rhou1_B0(1,0)*u0_B0(1,0) +
      AVG_0_0_LEV_33*p_B0(1,0)*u0_B0(1,0) +
      AVG_0_0_LEV_33*rhoE_B0(1,0)*u0_B0(1,0);

    CF_04 = AVG_0_0_LEV_00*rhou0_B0(2,0) + AVG_0_0_LEV_01*p_B0(2,0) +
      AVG_0_0_LEV_01*rhou0_B0(2,0)*u0_B0(2,0) +
      AVG_0_0_LEV_02*rhou1_B0(2,0)*u0_B0(2,0) +
      AVG_0_0_LEV_03*p_B0(2,0)*u0_B0(2,0) +
      AVG_0_0_LEV_03*rhoE_B0(2,0)*u0_B0(2,0);

   CF_14 = AVG_0_0_LEV_10*rhou0_B0(2,0) + AVG_0_0_LEV_12*rhou1_B0(2,0)*u0_B0(2,0);

    CF_24 = AVG_0_0_LEV_20*rhou0_B0(2,0) + AVG_0_0_LEV_21*p_B0(2,0) +
      AVG_0_0_LEV_21*rhou0_B0(2,0)*u0_B0(2,0) +
      AVG_0_0_LEV_22*rhou1_B0(2,0)*u0_B0(2,0) +
      AVG_0_0_LEV_23*p_B0(2,0)*u0_B0(2,0) +
      AVG_0_0_LEV_23*rhoE_B0(2,0)*u0_B0(2,0);

    CF_34 = AVG_0_0_LEV_30*rhou0_B0(2,0) + AVG_0_0_LEV_31*p_B0(2,0) +
      AVG_0_0_LEV_31*rhou0_B0(2,0)*u0_B0(2,0) +
      AVG_0_0_LEV_32*rhou1_B0(2,0)*u0_B0(2,0) +
      AVG_0_0_LEV_33*p_B0(2,0)*u0_B0(2,0) +
      AVG_0_0_LEV_33*rhoE_B0(2,0)*u0_B0(2,0);

    CF_05 = AVG_0_0_LEV_00*rhou0_B0(3,0) + AVG_0_0_LEV_01*p_B0(3,0) +
      AVG_0_0_LEV_01*rhou0_B0(3,0)*u0_B0(3,0) +
      AVG_0_0_LEV_02*rhou1_B0(3,0)*u0_B0(3,0) +
      AVG_0_0_LEV_03*p_B0(3,0)*u0_B0(3,0) +
      AVG_0_0_LEV_03*rhoE_B0(3,0)*u0_B0(3,0);

   CF_15 = AVG_0_0_LEV_10*rhou0_B0(3,0) + AVG_0_0_LEV_12*rhou1_B0(3,0)*u0_B0(3,0);

    CF_25 = AVG_0_0_LEV_20*rhou0_B0(3,0) + AVG_0_0_LEV_21*p_B0(3,0) +
      AVG_0_0_LEV_21*rhou0_B0(3,0)*u0_B0(3,0) +
      AVG_0_0_LEV_22*rhou1_B0(3,0)*u0_B0(3,0) +
      AVG_0_0_LEV_23*p_B0(3,0)*u0_B0(3,0) +
      AVG_0_0_LEV_23*rhoE_B0(3,0)*u0_B0(3,0);

    CF_35 = AVG_0_0_LEV_30*rhou0_B0(3,0) + AVG_0_0_LEV_31*p_B0(3,0) +
      AVG_0_0_LEV_31*rhou0_B0(3,0)*u0_B0(3,0) +
      AVG_0_0_LEV_32*rhou1_B0(3,0)*u0_B0(3,0) +
      AVG_0_0_LEV_33*p_B0(3,0)*u0_B0(3,0) +
      AVG_0_0_LEV_33*rhoE_B0(3,0)*u0_B0(3,0);
   ...
   CS_10 = AVG_0_0_LEV_10*rho_B0(-2,0) + AVG_0_0_LEV_12*rhou1_B0(-2,0);

   CS_11 = AVG_0_0_LEV_10*rho_B0(-1,0) + AVG_0_0_LEV_12*rhou1_B0(-1,0);

   CS_12 = AVG_0_0_LEV_10*rho_B0(0,0) + AVG_0_0_LEV_12*rhou1_B0(0,0);

   CS_13 = AVG_0_0_LEV_10*rho_B0(1,0) + AVG_0_0_LEV_12*rhou1_B0(1,0);

   CS_14 = AVG_0_0_LEV_10*rho_B0(2,0) + AVG_0_0_LEV_12*rhou1_B0(2,0);

   CS_15 = AVG_0_0_LEV_10*rho_B0(3,0) + AVG_0_0_LEV_12*rhou1_B0(3,0);
    ...
    max_lambda_0_00 = fmax(fabs(u0_B0(-2,0)), fmax(fabs(u0_B0(-1,0)),
      fmax(fabs(u0_B0(3,0)), fmax(fabs(u0_B0(2,0)), fmax(fabs(u0_B0(1,0)),
      fabs(u0_B0(0,0)))))));

   max_lambda_0_11 = max_lambda_0_00;

    max_lambda_0_22 = fmax(fabs(a_B0(-1,0) + u0_B0(-1,0)), fmax(fabs(a_B0(2,0) +
      u0_B0(2,0)), fmax(fabs(a_B0(1,0) + u0_B0(1,0)), fmax(fabs(a_B0(0,0) +
      u0_B0(0,0)), fmax(fabs(a_B0(3,0) + u0_B0(3,0)), fabs(a_B0(-2,0) +
      u0_B0(-2,0)))))));

    max_lambda_0_33 = fmax(fabs(a_B0(0,0) - u0_B0(0,0)), fmax(fabs(a_B0(2,0) -
      u0_B0(2,0)), fmax(fabs(a_B0(-1,0) - u0_B0(-1,0)), fmax(fabs(a_B0(3,0) -
      u0_B0(3,0)), fmax(fabs(a_B0(-2,0) - u0_B0(-2,0)), fabs(a_B0(1,0) -
      u0_B0(1,0)))))));
...
: (
   ...
   inv_omega_sum = 1.0/((rc17)*delta_0 + (rc18)*delta_1 + (rc19)*delta_2);
    ...
    wk1_B0(0,0) = 0.707106781186547*AVG_0_rho*Recon_2*inv_AVG_a*(AVG_0_a + AVG_0_u0) +
      0.707106781186547*AVG_0_rho*Recon_3*inv_AVG_a*(-AVG_0_a + AVG_0_u0) + AVG_0_u0*Recon_0;

    wk2_B0(0,0) = 0.707106781186547*AVG_0_rho*AVG_0_u1*Recon_2*inv_AVG_a +
      0.707106781186547*AVG_0_rho*AVG_0_u1*Recon_3*inv_AVG_a - AVG_0_rho*Recon_1 + AVG_0_u1*Recon_0;

    wk3_B0(0,0) = -AVG_0_rho*AVG_0_u1*Recon_1 +
...
int size1 ){
  ...
  if (size0==-1) dims_opensbliblock00Kernel003[0][0]=0;


  int idx_y = hipBlockDim_y * hipBlockIdx_y + hipThreadIdx_y;
  int idx_x = hipBlockDim_x * hipBlockIdx_x + hipThreadIdx_x;

  arg0 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel003[0][0];
  arg1 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel003[1][0];
  arg2 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel003[2][0];
  arg3 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel003[3][0];
  arg4 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel003[4][0];
  arg5 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel003[5][0];
  arg6 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel003[6][0];
  arg7 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel003[7][0];
  arg8 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel003[8][0];
  arg9 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel003[9][0];
  arg10 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel003[10][0];
  arg11 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel003[11][0];
  arg12 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel003[12][0];
  arg13 += idx_x * 1*1 + idx_y * 1*1 * dims_opensbliblock00Kernel003[13][0];

  if (idx_x < size0 && idx_y < size1) {
    const ACC<double> argp0(dims_opensbliblock00Kernel003[0][0], arg0);
    const ACC<double> argp1(dims_opensbliblock00Kernel003[1][0], arg1);
    const ACC<double> argp2(dims_opensbliblock00Kernel003[2][0], arg2);
    const ACC<double> argp3(dims_opensbliblock00Kernel003[3][0], arg3);
    const ACC<double> argp4(dims_opensbliblock00Kernel003[4][0], arg4);
    const ACC<double> argp5(dims_opensbliblock00Kernel003[5][0], arg5);
    const ACC<double> argp6(dims_opensbliblock00Kernel003[6][0], arg6);
    const ACC<double> argp7(dims_opensbliblock00Kernel003[7][0], arg7);
    const ACC<double> argp8(dims_opensbliblock00Kernel003[8][0], arg8);
    ACC<double> argp9(dims_opensbliblock00Kernel003[9][0], arg9);
    ACC<double> argp10(dims_opensbliblock00Kernel003[10][0], arg10);
    ACC<double> argp11(dims_opensbliblock00Kernel003[11][0], arg11);
    ACC<double> argp12(dims_opensbliblock00Kernel003[12][0], arg12);
    ACC<double> argp13(dims_opensbliblock00Kernel003[13][0], arg13);
    opensbliblock00Kernel003_gpu(argp0, argp1, argp2, argp3,
...
void ops_par_loop_opensbliblock00Kernel003_execute(ops_kernel_descriptor *desc) {
  ...
  if (!ops_checkpointing_before(args,14,range,18)) return;
  #endif
  ...
  if (xdim0 != dims_opensbliblock00Kernel003_h[0][0] || xdim1 != dims_opensbliblock00Kernel003_h[1][0] || xdim2 != dims_opensbliblock00Kernel003_h[2][0] || xdim3 != dims_opensbliblock00Kernel003_h[3][0] || xdim4 != dims_opensbliblock00Kernel003_h[4][0] || xdim5 != dims_opensbliblock00Kernel003_h[5][0] || xdim6 != dims_opensbliblock00Kernel003_h[6][0] || xdim7 != dims_opensbliblock00Kernel003_h[7][0] || xdim8 != dims_opensbliblock00Kernel003_h[8][0] || xdim9 != dims_opensbliblock00Kernel003_h[9][0] || xdim10 != dims_opensbliblock00Kernel003_h[10][0] || xdim11 != dims_opensbliblock00Kernel003_h[11][0] || xdim12 != dims_opensbliblock00Kernel003_h[12][0] || xdim13 != dims_opensbliblock00Kernel003_h[13][0]) {
    ...
    dims_opensbliblock00Kernel003_h[3][0] = xdim3;
    dims_opensbliblock00Kernel003_h[4][0] = xdim4;
    dims_opensbliblock00Kernel003_h[5][0] = xdim5;
    dims_opensbliblock00Kernel003_h[6][0] = xdim6;
    dims_opensbliblock00Kernel003_h[7][0] = xdim7;
    dims_opensbliblock00Kernel003_h[8][0] = xdim8;
    dims_opensbliblock00Kernel003_h[9][0] = xdim9;
    dims_opensbliblock00Kernel003_h[10][0] = xdim10;
    dims_opensbliblock00Kernel003_h[11][0] = xdim11;
    dims_opensbliblock00Kernel003_h[12][0] = xdim12;
    dims_opensbliblock00Kernel003_h[13][0] = xdim13;
    hipSafeCall(block->instance->ostream(), hipMemcpyToSymbol(HIP_SYMBOL(dims_opensbliblock00Kernel003), dims_opensbliblock00Kernel003_h, sizeof(dims_opensbliblock00Kernel003)));
  }
  ...
  if (x_size > 0 && y_size > 0)
    hipLaunchKernelGGL(ops_opensbliblock00Kernel003,grid ,tblock ,0 ,0 , (double *)p_a[0], (double *)p_a[1],
