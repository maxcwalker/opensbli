...
//
__constant__ int dims_opensbliblock00Kernel021 [3][1];
static int dims_opensbliblock00Kernel021_h [3][1] = {{0}};

//user function
__device__

void opensbliblock00Kernel021_gpu(const ACC<double> &u0_B0,
  ACC<double> &wk1_B0,
  const int *idx)
{
    wk1_B0(0,0) = ((idx[0] == 0) ? (
...
int size1 ){
  ...
  if (idx_x < size0 && idx_y < size1) {
    ...
    ACC<double> argp1(dims_opensbliblock00Kernel021[1][0], arg1);
    opensbliblock00Kernel021_gpu(argp0, argp1, arg_idx);
  }
...
void ops_par_loop_opensbliblock00Kernel021_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_opensbliblock00Kernel021_h[0][0] || xdim1 != dims_opensbliblock00Kernel021_h[1][0]) {
