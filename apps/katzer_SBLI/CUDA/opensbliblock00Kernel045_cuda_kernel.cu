...
//
__constant__ int dims_opensbliblock00Kernel045 [2][1];
static int dims_opensbliblock00Kernel045_h [2][1] = {0};

//user function
__device__

void opensbliblock00Kernel045_gpu(ACC<double> &D11_B0,
  ACC<double> &detJ_B0)
{
...
void ops_par_loop_opensbliblock00Kernel045_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_opensbliblock00Kernel045_h[0][0] || xdim1 != dims_opensbliblock00Kernel045_h[1][0]) {
  ...
  if (x_size > 0 && y_size > 0)
    ops_opensbliblock00Kernel045<<<grid, tblock >>> (  (double *)p_a[0], (double *)p_a[1],x_size, y_size);
