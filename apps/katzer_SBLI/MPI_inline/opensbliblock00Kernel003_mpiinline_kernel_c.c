...
void opensbliblock00Kernel003_c_wrapper(
  ...
  for ( int n_y=0; n_y<y_size; n_y++ ){
    for ( int n_x=0; n_x<x_size; n_x++ ){
      ...
      const ptr_double rhou0_B0 = { rhou0_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel003*1, xdim1_opensbliblock00Kernel003};
      ...
      const ptr_double theta_B0 = { theta_B0_p + n_x*1 + n_y * xdim6_opensbliblock00Kernel003*1, xdim6_opensbliblock00Kernel003};
      const ptr_double u0_B0 = { u0_B0_p + n_x*1 + n_y * xdim7_opensbliblock00Kernel003*1, xdim7_opensbliblock00Kernel003};
      const ptr_double u1_B0 = { u1_B0_p + n_x*1 + n_y * xdim8_opensbliblock00Kernel003*1, xdim8_opensbliblock00Kernel003};
      ...
      ptr_double wk1_B0 = { wk1_B0_p + n_x*1 + n_y * xdim11_opensbliblock00Kernel003*1, xdim11_opensbliblock00Kernel003};
      ptr_double TENO_B0 = { TENO_B0_p + n_x*1 + n_y * xdim12_opensbliblock00Kernel003*1, xdim12_opensbliblock00Kernel003};
   ...
   AVG_0_inv_rho = 1.0/(sqrt(OPS_ACC(rho_B0, 0,0)) + sqrt(OPS_ACC(rho_B0, 1,0)));
    ...
    AVG_0_a = sqrt(gamma_m1*(AVG_0_inv_rho*((OPS_ACC(p_B0, 1,0) + OPS_ACC(rhoE_B0, 1,0))/sqrt(OPS_ACC(rho_B0, 1,0)) +
      (OPS_ACC(p_B0, 0,0) + OPS_ACC(rhoE_B0, 0,0))/sqrt(OPS_ACC(rho_B0, 0,0))) - rc13*(pow(AVG_0_u0, 2) +
      pow(AVG_0_u1, 2))));
   ...
   CS_15 = AVG_0_0_LEV_10*OPS_ACC(rho_B0, 3,0) + AVG_0_0_LEV_12*OPS_ACC(rhou1_B0, 3,0);
    ...
    max_lambda_0_00 = fmax(fabs(OPS_ACC(u0_B0, -2,0)), fmax(fabs(OPS_ACC(u0_B0, -1,0)),
      fmax(fabs(OPS_ACC(u0_B0, 2,0)), fmax(fabs(OPS_ACC(u0_B0, 0,0)), fmax(fabs(OPS_ACC(u0_B0, 3,0)),
      fabs(OPS_ACC(u0_B0, 1,0)))))));

   max_lambda_0_11 = max_lambda_0_00;

    max_lambda_0_22 = fmax(fabs(OPS_ACC(a_B0, -2,0) + OPS_ACC(u0_B0, -2,0)), fmax(fabs(OPS_ACC(a_B0, 0,0) +
      OPS_ACC(u0_B0, 0,0)), fmax(fabs(OPS_ACC(a_B0, 3,0) + OPS_ACC(u0_B0, 3,0)), fmax(fabs(OPS_ACC(a_B0, 1,0) +
      OPS_ACC(u0_B0, 1,0)), fmax(fabs(OPS_ACC(a_B0, -1,0) + OPS_ACC(u0_B0, -1,0)), fabs(OPS_ACC(a_B0, 2,0) +
      OPS_ACC(u0_B0, 2,0)))))));

    max_lambda_0_33 = fmax(fabs(OPS_ACC(a_B0, 1,0) - OPS_ACC(u0_B0, 1,0)), fmax(fabs(OPS_ACC(a_B0, 3,0) -
      OPS_ACC(u0_B0, 3,0)), fmax(fabs(OPS_ACC(a_B0, 0,0) - OPS_ACC(u0_B0, 0,0)), fmax(fabs(OPS_ACC(a_B0, -1,0) -
      OPS_ACC(u0_B0, -1,0)), fmax(fabs(OPS_ACC(a_B0, 2,0) - OPS_ACC(u0_B0, 2,0)), fabs(OPS_ACC(a_B0, -2,0) -
      OPS_ACC(u0_B0, -2,0)))))));
