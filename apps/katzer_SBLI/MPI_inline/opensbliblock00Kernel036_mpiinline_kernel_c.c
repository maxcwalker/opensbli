...
void opensbliblock00Kernel036_c_wrapper(
  ...
  for ( int n_y=0; n_y<y_size; n_y++ ){
    for ( int n_x=0; n_x<x_size; n_x++ ){
      ptr_double rhou0_B0 = { rhou0_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel036*1, xdim0_opensbliblock00Kernel036};
      ptr_double rhoE_B0 = { rhoE_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel036*1, xdim1_opensbliblock00Kernel036};
