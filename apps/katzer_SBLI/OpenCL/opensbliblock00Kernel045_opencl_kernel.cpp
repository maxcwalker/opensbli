...
//
    ...
    void buildOpenCLKernels_opensbliblock00Kernel045(OPS_instance *instance, int xdim0, int xdim1) {
      ...
      if(!isbuilt_opensbliblock00Kernel045) {
        ...
        instance->ostream() <<"Compiling opensbliblock00Kernel045 "<<OCL_FMA<<" source -- start \n";
          ...
          if (pPath!=NULL)
            if(OCL_FMA)
              sprintf(buildOpts,"-cl-mad-enable -DOCL_FMA -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_opensbliblock00Kernel045=%d  -Dxdim1_opensbliblock00Kernel045=%d ", pPath, 32,xdim0,xdim1);
            else
              sprintf(buildOpts,"-cl-mad-enable -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_opensbliblock00Kernel045=%d  -Dxdim1_opensbliblock00Kernel045=%d ", pPath, 32,xdim0,xdim1);
          else {
        ...
        instance->opencl_instance->OPS_opencl_core.kernel[4] = clCreateKernel(instance->opencl_instance->OPS_opencl_core.program, "ops_opensbliblock00Kernel045", &ret);
        clSafeCall( ret );
...
void ops_par_loop_opensbliblock00Kernel045(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1) {
  ...
  if (block->instance->OPS_diags > 1) {
    ops_timing_realloc(block->instance,4,"opensbliblock00Kernel045");
