...
//
    ...
    void buildOpenCLKernels_opensbliblock00Kernel014(OPS_instance *instance, int xdim0, int xdim1, int xdim2, int xdim3, int xdim4, int xdim5, int xdim6, int xdim7, int xdim8, int xdim9, int xdim10, int xdim11, int xdim12) {
      ...
      if(!isbuilt_opensbliblock00Kernel014) {
        ...
        instance->opencl_instance->OPS_opencl_core.kernel[20] = clCreateKernel(instance->opencl_instance->OPS_opencl_core.program, "ops_opensbliblock00Kernel014", &ret);
        clSafeCall( ret );
...
void ops_par_loop_opensbliblock00Kernel014(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg9, ops_arg arg10, ops_arg arg11, ops_arg arg12) {
  ...
  if (globalWorkSize[0]>0 && globalWorkSize[1]>0 && globalWorkSize[2]>0) {
    ...
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[20], 13, sizeof(cl_double), (void*) &inv_0 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[20], 14, sizeof(cl_double), (void*) &inv_1 ));
    ...
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[20], 27, sizeof(cl_int), (void*) &base12 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[20], 28, sizeof(cl_int), (void*) &x_size ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[20], 29, sizeof(cl_int), (void*) &y_size ));
