...
void ops_par_loop_opensbliblock00Kernel014_execute(ops_kernel_descriptor *desc) {
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
      const ACC<double> wk0_B0(xdim0_opensbliblock00Kernel014, wk0_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel014*1);
      const ACC<double> wk5_B0(xdim1_opensbliblock00Kernel014, wk5_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel014*1);
      const ACC<double> wk6_B0(xdim2_opensbliblock00Kernel014, wk6_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel014*1);
      const ACC<double> wk2_B0(xdim3_opensbliblock00Kernel014, wk2_B0_p + n_x*1 + n_y * xdim3_opensbliblock00Kernel014*1);
      const ACC<double> wk3_B0(xdim4_opensbliblock00Kernel014, wk3_B0_p + n_x*1 + n_y * xdim4_opensbliblock00Kernel014*1);
      const ACC<double> wk4_B0(xdim5_opensbliblock00Kernel014, wk4_B0_p + n_x*1 + n_y * xdim5_opensbliblock00Kernel014*1);
      const ACC<double> wk1_B0(xdim6_opensbliblock00Kernel014, wk1_B0_p + n_x*1 + n_y * xdim6_opensbliblock00Kernel014*1);
      const ACC<double> D11_B0(xdim7_opensbliblock00Kernel014, D11_B0_p + n_x*1 + n_y * xdim7_opensbliblock00Kernel014*1);
      const ACC<double> wk7_B0(xdim8_opensbliblock00Kernel014, wk7_B0_p + n_x*1 + n_y * xdim8_opensbliblock00Kernel014*1);
      ACC<double> Residual1_B0(xdim9_opensbliblock00Kernel014, Residual1_B0_p + n_x*1 + n_y * xdim9_opensbliblock00Kernel014*1);
      ACC<double> Residual3_B0(xdim10_opensbliblock00Kernel014, Residual3_B0_p + n_x*1 + n_y * xdim10_opensbliblock00Kernel014*1);
      ACC<double> Residual2_B0(xdim11_opensbliblock00Kernel014, Residual2_B0_p + n_x*1 + n_y * xdim11_opensbliblock00Kernel014*1);
      ACC<double> Residual0_B0(xdim12_opensbliblock00Kernel014, Residual0_B0_p + n_x*1 + n_y * xdim12_opensbliblock00Kernel014*1);
