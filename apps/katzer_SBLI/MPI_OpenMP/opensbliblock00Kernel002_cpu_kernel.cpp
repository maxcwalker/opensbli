...
void ops_par_loop_opensbliblock00Kernel002_execute(ops_kernel_descriptor *desc) {
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
      ...
      const ACC<double> D11_B0(xdim0_opensbliblock00Kernel002, D11_B0_p + n_x*1 + n_y * xdim0_opensbliblock00Kernel002*1);
      const ACC<double> u0_B0(xdim1_opensbliblock00Kernel002, u0_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel002*1);
      const ACC<double> u1_B0(xdim2_opensbliblock00Kernel002, u1_B0_p + n_x*1 + n_y * xdim2_opensbliblock00Kernel002*1);
   ...
   double localeval_2 = 0.0;
    localeval_0 = ((idx[1] == 0) ? (
   inv_0*(-rc9*u1_B0(0,0) - rc8*u1_B0(0,4) +
      4*u1_B0(0,1) - 3*u1_B0(0,2) + (rc10)*u1_B0(0,3))
)
: ((idx[1] == 1) ? (

      (rc11)*inv_0*(-10*u1_B0(0,0) + 18*u1_B0(0,1) - 3*u1_B0(0,-1) -
      6*u1_B0(0,2) + u1_B0(0,3))
)
: ((idx[1] == block0np1 - 1) ? (

      inv_0*((rc8)*u1_B0(0,-4) + (rc9)*u1_B0(0,0) - rc10*u1_B0(0,-3) +
      3*u1_B0(0,-2) - 4*u1_B0(0,-1))
)
: ((idx[1] == block0np1 - 2) ? (

      (rc11)*inv_0*(10*u1_B0(0,0) - u1_B0(0,-3) + 3*u1_B0(0,1) - 18*u1_B0(0,-1)
      + 6*u1_B0(0,-2))
)
: (
   (rc11)*inv_0*(u1_B0(0,-2) - 8*u1_B0(0,-1) +
      8*u1_B0(0,1) - u1_B0(0,2))
)))));

    localeval_1 = ((idx[0] == 0) ? (
   inv_1*(-rc8*u0_B0(4,0) + (rc10)*u0_B0(3,0) -
      3*u0_B0(2,0) + 4*u0_B0(1,0) - rc9*u0_B0(0,0))
)
: ((idx[0] == 1) ? (

      (rc11)*inv_1*(-3*u0_B0(-1,0) + u0_B0(3,0) - 6*u0_B0(2,0) + 18*u0_B0(1,0) -
      10*u0_B0(0,0))
)
: ((idx[0] == block0np0 - 1) ? (
   inv_1*(-4*u0_B0(-1,0) +
      3*u0_B0(-2,0) - rc10*u0_B0(-3,0) + (rc8)*u0_B0(-4,0) +
      (rc9)*u0_B0(0,0))
)
: ((idx[0] == block0np0 - 2) ? (
   (rc11)*inv_1*(6*u0_B0(-2,0) -
      18*u0_B0(-1,0) - u0_B0(-3,0) + 3*u0_B0(1,0) + 10*u0_B0(0,0))
)
: (

      (rc11)*inv_1*(u0_B0(-2,0) - u0_B0(2,0) - 8*u0_B0(-1,0) +
      8*u0_B0(1,0))
)))));

    localeval_2 = ((idx[0] == 0) ? (
   inv_1*(-rc9*u1_B0(0,0) + 4*u1_B0(1,0) -
      3*u1_B0(2,0) - rc8*u1_B0(4,0) + (rc10)*u1_B0(3,0))
)
: ((idx[0] == 1) ? (

      (rc11)*inv_1*(-10*u1_B0(0,0) + 18*u1_B0(1,0) - 6*u1_B0(2,0) -
      3*u1_B0(-1,0) + u1_B0(3,0))
)
: ((idx[0] == block0np0 - 1) ? (

      inv_1*((rc9)*u1_B0(0,0) + (rc8)*u1_B0(-4,0) - rc10*u1_B0(-3,0) +
      3*u1_B0(-2,0) - 4*u1_B0(-1,0))
)
: ((idx[0] == block0np0 - 2) ? (

      (rc11)*inv_1*(10*u1_B0(0,0) + 3*u1_B0(1,0) - u1_B0(-3,0) - 18*u1_B0(-1,0)
      + 6*u1_B0(-2,0))
)
: (
   (rc11)*inv_1*(8*u1_B0(1,0) - 8*u1_B0(-1,0) +
      u1_B0(-2,0) - u1_B0(2,0))
)))));

    localeval_3 = ((idx[1] == 0) ? (
   inv_0*((rc10)*u0_B0(0,3) - 3*u0_B0(0,2) +
      4*u0_B0(0,1) - rc8*u0_B0(0,4) - rc9*u0_B0(0,0))
)
: ((idx[1] == 1) ? (

      (rc11)*inv_0*(u0_B0(0,3) - 6*u0_B0(0,2) - 3*u0_B0(0,-1) + 18*u0_B0(0,1) -
      10*u0_B0(0,0))
)
: ((idx[1] == block0np1 - 1) ? (
   inv_0*(-4*u0_B0(0,-1) +
      3*u0_B0(0,-2) - rc10*u0_B0(0,-3) + (rc9)*u0_B0(0,0) +
      (rc8)*u0_B0(0,-4))
)
: ((idx[1] == block0np1 - 2) ? (
   (rc11)*inv_0*(-18*u0_B0(0,-1) +
      6*u0_B0(0,-2) + 3*u0_B0(0,1) - u0_B0(0,-3) + 10*u0_B0(0,0))
)
: (

      (rc11)*inv_0*(-u0_B0(0,2) + 8*u0_B0(0,1) - 8*u0_B0(0,-1) +
      u0_B0(0,-2))
)))));

    theta_B0(0,0) = pow(localeval_0*D11_B0(0,0) + localeval_1,
      2)*(-rc13*tanh(250.0*localeval_0*D11_B0(0,0) + 250.0*localeval_1 + 2.5) + rc13)/(epsilon +
      pow(localeval_2 - localeval_3*D11_B0(0,0), 2) + pow(localeval_0*D11_B0(0,0) + localeval_1,
      2));
