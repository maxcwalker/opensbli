...
void ops_par_loop_opensbliblock00Kernel028_execute(ops_kernel_descriptor *desc) {
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    wk6_B0(0,0) = ((idx[1] == 0) ? (
   inv_0*(-3*T_B0(0,2) + 4*T_B0(0,1) -
      rc9*T_B0(0,0) - rc8*T_B0(0,4) + (rc10)*T_B0(0,3))
)
: ((idx[1] == 1) ? (

      (rc11)*inv_0*(-6*T_B0(0,2) + 18*T_B0(0,1) - 3*T_B0(0,-1) - 10*T_B0(0,0) +
      T_B0(0,3))
)
: ((idx[1] == block0np1 - 1) ? (
   inv_0*((rc8)*T_B0(0,-4) -
      4*T_B0(0,-1) + 3*T_B0(0,-2) + (rc9)*T_B0(0,0) - rc10*T_B0(0,-3))
)
:
      ((idx[1] == block0np1 - 2) ? (
   (rc11)*inv_0*(3*T_B0(0,1) - 18*T_B0(0,-1) +
      6*T_B0(0,-2) + 10*T_B0(0,0) - T_B0(0,-3))
)
: (

      (rc11)*inv_0*(T_B0(0,-2) - 8*T_B0(0,-1) + 8*T_B0(0,1) - T_B0(0,2))
)))));
