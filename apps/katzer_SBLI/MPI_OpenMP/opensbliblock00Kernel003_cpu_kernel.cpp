...
void ops_par_loop_opensbliblock00Kernel003_execute(ops_kernel_descriptor *desc) {
  ...
  double * __restrict__ theta_B0_p = (double *)(args[6].data + base6);
  ...
  double * __restrict__ TENO_B0_p = (double *)(args[12].data + base12);
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
      ...
      const ACC<double> rhou0_B0(xdim1_opensbliblock00Kernel003, rhou0_B0_p + n_x*1 + n_y * xdim1_opensbliblock00Kernel003*1);
      ...
      const ACC<double> theta_B0(xdim6_opensbliblock00Kernel003, theta_B0_p + n_x*1 + n_y * xdim6_opensbliblock00Kernel003*1);
      const ACC<double> u0_B0(xdim7_opensbliblock00Kernel003, u0_B0_p + n_x*1 + n_y * xdim7_opensbliblock00Kernel003*1);
      const ACC<double> u1_B0(xdim8_opensbliblock00Kernel003, u1_B0_p + n_x*1 + n_y * xdim8_opensbliblock00Kernel003*1);
      ...
      ACC<double> wk1_B0(xdim11_opensbliblock00Kernel003, wk1_B0_p + n_x*1 + n_y * xdim11_opensbliblock00Kernel003*1);
      ACC<double> TENO_B0(xdim12_opensbliblock00Kernel003, TENO_B0_p + n_x*1 + n_y * xdim12_opensbliblock00Kernel003*1);
