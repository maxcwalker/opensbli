...
//
__constant__ int dims_opensbliblock00Kernel043 [2][1];
static int dims_opensbliblock00Kernel043_h [2][1] = {{0}};

//user function
__device__

void opensbliblock00Kernel043_gpu(ACC<double> &D11_B0,
  ACC<double> &detJ_B0)
{
...
int size1 ){
  ...
  if (idx_x < size0 && idx_y < size1) {
    ACC<double> argp0(dims_opensbliblock00Kernel043[0][0], arg0);
...
void ops_par_loop_opensbliblock00Kernel043_execute(ops_kernel_descriptor *desc) {
  ...
  if (x_size > 0 && y_size > 0)
    hipLaunchKernelGGL(ops_opensbliblock00Kernel043,grid ,tblock ,0 ,0 , (double *)p_a[0], (double *)p_a[1],x_size, y_size);
