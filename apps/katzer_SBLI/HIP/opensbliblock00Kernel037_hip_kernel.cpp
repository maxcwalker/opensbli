...
//
__constant__ int dims_opensbliblock00Kernel037 [4][1];
static int dims_opensbliblock00Kernel037_h [4][1] = {{0}};

//user function
__device__

void opensbliblock00Kernel037_gpu(ACC<double> &rhou0_B0,
  ACC<double> &rhoE_B0,
  ACC<double> &rhou1_B0,
  ACC<double> &rho_B0)
{
...
int size1 ){
  ...
  if (idx_x < size0 && idx_y < size1) {
    ACC<double> argp0(dims_opensbliblock00Kernel037[0][0], arg0);
    ACC<double> argp1(dims_opensbliblock00Kernel037[1][0], arg1);
    ACC<double> argp2(dims_opensbliblock00Kernel037[2][0], arg2);
