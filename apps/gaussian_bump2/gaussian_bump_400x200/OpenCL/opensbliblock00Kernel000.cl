...
//user function
 ...
 void opensbliblock00Kernel000(const ptr_double rho_B0,
  ...
  ptr_double wk3_B0,
  ptr_double wk0_B0,
  ptr_double wk1_B0, const double gama, const double gamma_m1, const double rc7, const double rc15, const double rc16, const double rc17, const double rc18, const double rc21, const double rc22, const double rc23, const double rc24, const double rc25, const double rc26, const double rc27, const double rc28, const double rc29, const double rc30, const double rc31, const double rc32, const double rc33, const double rc34, const double rcinv35)
{
   ...
   double Recon_1 = 0.0;
   double CF_20 = 0.0;
   AVG_0_rho = (rc17)*(OPS_ACCS(rho_B0, 0,0) + OPS_ACCS(rho_B0, 1,0));

   AVG_0_u1 = (rc17)*(OPS_ACCS(u1_B0, 1,0) + OPS_ACCS(u1_B0, 0,0));

   AVG_0_u0 = (rc17)*(OPS_ACCS(u0_B0, 1,0) + OPS_ACCS(u0_B0, 0,0));

   AVG_0_a = (rc17)*(OPS_ACCS(a_B0, 0,0) + OPS_ACCS(a_B0, 1,0));

   AVG_0_D01 = (rc17)*(OPS_ACCS(D01_B0, 1,0) + OPS_ACCS(D01_B0, 0,0));

   AVG_0_D00 = (rc17)*(OPS_ACCS(D00_B0, 1,0) + OPS_ACCS(D00_B0, 0,0));
   ...
   AVG_0_0_LEV_33 = 0.707106781186547*gamma_m1*inv_AVG_a*inv_AVG_rho;
    ...
    max_lambda_0_00 = fmax(fabs(OPS_ACCS(D00_B0, -2,0)*OPS_ACCS(u0_B0, -2,0) +
      ...
      OPS_ACCS(D01_B0, 2,0)*OPS_ACCS(u1_B0, 2,0)), fmax(fabs(OPS_ACCS(D00_B0, -1,0)*OPS_ACCS(u0_B0, -1,0) +
      OPS_ACCS(D01_B0, -1,0)*OPS_ACCS(u1_B0, -1,0)), fmax(fabs(OPS_ACCS(D00_B0, 0,0)*OPS_ACCS(u0_B0, 0,0) +
      OPS_ACCS(D01_B0, 0,0)*OPS_ACCS(u1_B0, 0,0)), fabs(OPS_ACCS(D00_B0, 3,0)*OPS_ACCS(u0_B0, 3,0) +
      OPS_ACCS(D01_B0, 3,0)*OPS_ACCS(u1_B0, 3,0)))))));

   max_lambda_0_11 = max_lambda_0_00;

    max_lambda_0_22 = fmax(fabs(sqrt(pow(OPS_ACCS(D00_B0, 3,0), 2) + pow(OPS_ACCS(D01_B0, 3,0), 2))*OPS_ACCS(a_B0, 3,0)
      + OPS_ACCS(D00_B0, 3,0)*OPS_ACCS(u0_B0, 3,0) + OPS_ACCS(D01_B0, 3,0)*OPS_ACCS(u1_B0, 3,0)),
      fmax(fabs(sqrt(pow(OPS_ACCS(D00_B0, 0,0), 2) + pow(OPS_ACCS(D01_B0, 0,0), 2))*OPS_ACCS(a_B0, 0,0) +
      ...
      fmax(fabs(sqrt(pow(OPS_ACCS(D00_B0, -1,0), 2) + pow(OPS_ACCS(D01_B0, -1,0), 2))*OPS_ACCS(a_B0, -1,0) +
      OPS_ACCS(D00_B0, -1,0)*OPS_ACCS(u0_B0, -1,0) + OPS_ACCS(D01_B0, -1,0)*OPS_ACCS(u1_B0, -1,0)),
      fabs(sqrt(pow(OPS_ACCS(D00_B0, 2,0), 2) + pow(OPS_ACCS(D01_B0, 2,0), 2))*OPS_ACCS(a_B0, 2,0) +
      OPS_ACCS(D00_B0, 2,0)*OPS_ACCS(u0_B0, 2,0) + OPS_ACCS(D01_B0, 2,0)*OPS_ACCS(u1_B0, 2,0)))))));

    max_lambda_0_33 = fmax(fabs(-sqrt(pow(OPS_ACCS(D00_B0, 1,0), 2) + pow(OPS_ACCS(D01_B0, 1,0), 2))*OPS_ACCS(a_B0, 1,0)
      + OPS_ACCS(D00_B0, 1,0)*OPS_ACCS(u0_B0, 1,0) + OPS_ACCS(D01_B0, 1,0)*OPS_ACCS(u1_B0, 1,0)),
      fmax(fabs(-sqrt(pow(OPS_ACCS(D00_B0, 3,0), 2) + pow(OPS_ACCS(D01_B0, 3,0), 2))*OPS_ACCS(a_B0, 3,0) +
      OPS_ACCS(D00_B0, 3,0)*OPS_ACCS(u0_B0, 3,0) + OPS_ACCS(D01_B0, 3,0)*OPS_ACCS(u1_B0, 3,0)),
      fmax(fabs(-sqrt(pow(OPS_ACCS(D00_B0, 2,0), 2) + pow(OPS_ACCS(D01_B0, 2,0), 2))*OPS_ACCS(a_B0, 2,0) +
      OPS_ACCS(D00_B0, 2,0)*OPS_ACCS(u0_B0, 2,0) + OPS_ACCS(D01_B0, 2,0)*OPS_ACCS(u1_B0, 2,0)),
      fmax(fabs(-sqrt(pow(OPS_ACCS(D00_B0, -2,0), 2) + pow(OPS_ACCS(D01_B0, -2,0), 2))*OPS_ACCS(a_B0, -2,0) +
