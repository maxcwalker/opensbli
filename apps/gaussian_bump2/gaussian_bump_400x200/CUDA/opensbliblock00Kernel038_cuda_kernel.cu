...
void opensbliblock00Kernel038_gpu(const ACC<double> &u0_B0,
  ...
  const int *idx)
{
    wk10_B0(0,0) = inv_2*((idx[1] == 0) ? (
   -rc39*u0_B0(0,3) + (rc38)*u0_B0(0,0) +
      (rc34)*u0_B0(0,4) - rc37*u0_B0(0,1) + (rc36)*u0_B0(0,2)
)
: ((idx[1] == 1) ? (

      -rc16*u0_B0(0,3) + (rc34)*u0_B0(0,-1) - rc22*u0_B0(0,0) +
      (rc17)*u0_B0(0,1) + (rc7)*u0_B0(0,2)
)
: (
   -rc16*u0_B0(0,-2) +
      (rc12)*u0_B0(0,-1) - rc40*u0_B0(0,0) + (rc12)*u0_B0(0,1) -
      rc16*u0_B0(0,2)
)));
