  ...
  const int *idx)
{
   ...
   (rc38)*u1_B0(0,0) + (rc34)*u1_B0(0,4) -
      rc37*u1_B0(0,1) + (rc36)*u1_B0(0,2) - rc39*u1_B0(0,3)
)
: ((idx[1] == 1) ? (

      -rc22*u1_B0(0,0) + (rc17)*u1_B0(0,1) + (rc34)*u1_B0(0,-1) +
      (rc7)*u1_B0(0,2) - rc16*u1_B0(0,3)
)
: (
   -rc40*u1_B0(0,0) +
      (rc12)*u1_B0(0,1) - rc16*u1_B0(0,-2) + (rc12)*u1_B0(0,-1) -
      rc16*u1_B0(0,2)
)));
