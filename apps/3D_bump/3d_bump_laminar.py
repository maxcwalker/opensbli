...
Re, xMach, Tinf,Twall = 950.0, 2.0, 288.0, 1.68
...
#              Slicing																								 #																																									
##################################################################################################################
#([DataObject('x2'), DataObject('x1')], 0, int(200 * Nx/L)),([DataObject('x2'), DataObject('x1')], 0, int(210 * Nx/L)),([DataObject('x2'), DataObject('x1')], 0, int(220 * Nx/L)),([DataObject('x2'), DataObject('x1')], 0, int(230 * Nx/L)), ([DataObject('x2'), DataObject('x1')], 0, int(240 * Nx/L)),([DataObject('x2'), DataObject('x1')], 0, int(250 * Nx/L)),([DataObject('x2'), DataObject('x1')], 0, int(275 * Nx/L)),([DataObject('x2'), DataObject('x1')], 0, int(300 * Nx/L)),([DataObject('x2'), DataObject('x1')], 0, int(310 * Nx/L)),([DataObject('x2'), DataObject('x1')], 0, int(325 * Nx/L)),([DataObject('x2'), DataObject('x1')], 0,int(350 * Nx/L)), ([DataObject('x2'), DataObject('x1')], 0, int(375 * Nx/L)), ([DataObject('x2'), DataObject('x1')], 0, int(390 * Nx/L)),([DataObject('x2'), DataObject('x1')], 0, int(395 * Nx/L)),\
if slices:
    # Add grid coordinates to the slices, once at the start of the simulation
    grid_slice_hdf5 = iohdf5_slices(**{'iotype': "Init"})
    coords = [([DataObject('x0'), DataObject('x2')], 1, 1), ([DataObject('x0'), DataObject('x2')], 1, 20),\
              ([DataObject('x2'), DataObject('x1')], 0, int(50 * Nx/L)), ([DataObject('x2'), DataObject('x1')], 0, int(90 * Nx/L)), ([DataObject('x2'), DataObject('x1')], 0, int(100 * Nx/L)), ([DataObject('x2'), DataObject('x1')], 0, int(110 * Nx/L)), ([DataObject('x2'), DataObject('x1')], 0, int(125 * Nx/L)),([DataObject('x2'), DataObject('x1')], 0, int(150 * Nx/L)),([DataObject('x2'), DataObject('x1')], 0, int(160 * Nx/L)),([DataObject('x2'), DataObject('x1')], 0, int(170 * Nx/L)),([DataObject('x2'), DataObject('x1')], 0, int(180 * Nx/L)),([DataObject('x2'), DataObject('x1')], 0, int(190 * Nx/L)),\
              ([DataObject('x0'), DataObject('x1')], 2, 'block0np2/2')] # q vector, x-z, j=1 plane, # q vector, x-y, z=Lz/2 plane
    grid_slice_hdf5.add_slices(coords)
    # Q vector slices written out in time
    slices_hdf5 = iohdf5_slices(save_every= 1000, **{'iotype': "Write"})
