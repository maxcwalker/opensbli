  ...
  if ((end[0]-start[0])>0) {
    block->instance->sycl_instance->queue->submit([&](cl::sycl::handler &cgh) {
      ...
      , [=](cl::sycl::nd_item<1> item
        ...
        ACC<double> wk0_B0(&wk0_B0_p[0] + base5 + n_x*1);
        ACC<double> wk1_B0(&wk1_B0_p[0] + base6 + n_x*1);
   ...
   AVG_0_REV_20 = ((1.0/2.0))*(AVG_0_u0*AVG_0_u0) + (AVG_0_a*AVG_0_a)*invgamma_m1_sycl[0] - AVG_0_a*AVG_0_u0;

   AVG_0_REV_21 = ((1.0/2.0))*(AVG_0_u0*AVG_0_u0);

   AVG_0_REV_22 = ((1.0/2.0))*(AVG_0_u0*AVG_0_u0) + (AVG_0_a*AVG_0_a)*invgamma_m1_sycl[0] + AVG_0_a*AVG_0_u0;
