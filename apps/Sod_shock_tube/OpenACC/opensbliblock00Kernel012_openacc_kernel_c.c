  ...
  const int *idx)
{
   ...
   if (idx[0] == 0){
       ...
       d1_rhou0_dx = (3.0*OPS_ACC(u0_B0, 1)*OPS_ACC(rho_B0, 1) + 0.333333333333333*OPS_ACC(u0_B0, 3)*OPS_ACC(rho_B0, 3) - 1.5*OPS_ACC(u0_B0, 2)*OPS_ACC(rho_B0, 2) -
            1.83333333333333*OPS_ACC(u0_B0, 0)*OPS_ACC(rho_B0, 0))*invDelta0block0;
       ...
       d1_rhou0_dx = (0.0394168524399447*OPS_ACC(u0_B0, 2)*OPS_ACC(rho_B0, 2) + 0.00571369039775442*OPS_ACC(u0_B0, 4)*OPS_ACC(rho_B0, 4) +
            0.719443173328855*OPS_ACC(u0_B0, 1)*OPS_ACC(rho_B0, 1) - 0.322484932882161*OPS_ACC(u0_B0, 0)*OPS_ACC(rho_B0, 0) -
            0.0658051057710389*OPS_ACC(u0_B0, 3)*OPS_ACC(rho_B0, 3) - 0.376283677513354*OPS_ACC(u0_B0, -1)*OPS_ACC(rho_B0, -1))*invDelta0block0;
       ...
       d1_rhou0_dx = (0.197184333887745*OPS_ACC(u0_B0, 0)*OPS_ACC(rho_B0, 0) + 0.521455851089587*OPS_ACC(u0_B0, 1)*OPS_ACC(rho_B0, 1) +
            0.113446470384241*OPS_ACC(u0_B0, -2)*OPS_ACC(rho_B0, -2) - 0.00412637789557492*OPS_ACC(u0_B0, 3)*OPS_ACC(rho_B0, 3) -
            0.0367146847001261*OPS_ACC(u0_B0, 2)*OPS_ACC(rho_B0, 2) - 0.791245592765872*OPS_ACC(u0_B0, -1)*OPS_ACC(rho_B0, -1))*invDelta0block0;
       ...
       d1_rhou0_dx = (0.0451033223343881*OPS_ACC(u0_B0, 0)*OPS_ACC(rho_B0, 0) + 0.652141084861241*OPS_ACC(u0_B0, 1)*OPS_ACC(rho_B0, 1) +
            0.121937153224065*OPS_ACC(u0_B0, -2)*OPS_ACC(rho_B0, -2) - 0.00932597985049999*OPS_ACC(u0_B0, -3)*OPS_ACC(rho_B0, -3) -
            0.727822147724592*OPS_ACC(u0_B0, -1)*OPS_ACC(rho_B0, -1) - 0.082033432844602*OPS_ACC(u0_B0, 2)*OPS_ACC(rho_B0, 2))*invDelta0block0;
       ...
       d1_rhou0_dx = (1.5*OPS_ACC(u0_B0, -2)*OPS_ACC(rho_B0, -2) + 1.83333333333333*OPS_ACC(u0_B0, 0)*OPS_ACC(rho_B0, 0) - 3.0*OPS_ACC(u0_B0, -1)*OPS_ACC(rho_B0, -1) -
            0.333333333333333*OPS_ACC(u0_B0, -3)*OPS_ACC(rho_B0, -3))*invDelta0block0;
       ...
       d1_rhou0_dx = (0.322484932882161*OPS_ACC(u0_B0, 0)*OPS_ACC(rho_B0, 0) + 0.0658051057710389*OPS_ACC(u0_B0, -3)*OPS_ACC(rho_B0, -3) +
            0.376283677513354*OPS_ACC(u0_B0, 1)*OPS_ACC(rho_B0, 1) - 0.0394168524399447*OPS_ACC(u0_B0, -2)*OPS_ACC(rho_B0, -2) -
            0.00571369039775442*OPS_ACC(u0_B0, -4)*OPS_ACC(rho_B0, -4) - 0.719443173328855*OPS_ACC(u0_B0, -1)*OPS_ACC(rho_B0, -1))*invDelta0block0;
       ...
       d1_rhou0_dx = (0.00412637789557492*OPS_ACC(u0_B0, -3)*OPS_ACC(rho_B0, -3) + 0.0367146847001261*OPS_ACC(u0_B0, -2)*OPS_ACC(rho_B0, -2) +
            0.791245592765872*OPS_ACC(u0_B0, 1)*OPS_ACC(rho_B0, 1) - 0.197184333887745*OPS_ACC(u0_B0, 0)*OPS_ACC(rho_B0, 0) -
            0.521455851089587*OPS_ACC(u0_B0, -1)*OPS_ACC(rho_B0, -1) - 0.113446470384241*OPS_ACC(u0_B0, 2)*OPS_ACC(rho_B0, 2))*invDelta0block0;
       ...
       d1_rhou0_dx = (0.00932597985049999*OPS_ACC(u0_B0, 3)*OPS_ACC(rho_B0, 3) + 0.727822147724592*OPS_ACC(u0_B0, 1)*OPS_ACC(rho_B0, 1) +
            0.082033432844602*OPS_ACC(u0_B0, -2)*OPS_ACC(rho_B0, -2) - 0.0451033223343881*OPS_ACC(u0_B0, 0)*OPS_ACC(rho_B0, 0) -
            0.652141084861241*OPS_ACC(u0_B0, -1)*OPS_ACC(rho_B0, -1) - 0.121937153224065*OPS_ACC(u0_B0, 2)*OPS_ACC(rho_B0, 2))*invDelta0block0;
       ...
       d1_rhou0_dx = (-(2.0/3.0)*OPS_ACC(u0_B0, -1)*OPS_ACC(rho_B0, -1) - (1.0/12.0)*OPS_ACC(u0_B0, 2)*OPS_ACC(rho_B0, 2) +
            ((1.0/12.0))*OPS_ACC(u0_B0, -2)*OPS_ACC(rho_B0, -2) + ((2.0/3.0))*OPS_ACC(u0_B0, 1)*OPS_ACC(rho_B0, 1))*invDelta0block0;

   }

   OPS_ACC(Residual0_B0, 0) = -d1_rhou0_dx;

   OPS_ACC(Residual1_B0, 0) = -d1_prhou0u0_dx;

   OPS_ACC(Residual2_B0, 0) = -d1_prhoEu0_dx;
