  ...
  ptr_double wk2_B0)
{
   ...
   AVG_0_0_LEV_22 = ((1.0/2.0))*(inv_AVG_a*inv_AVG_a)*gamma_m1;
    ...
    alpha_10 = (-OPS_ACC(rho_B0, -1) + OPS_ACC(rho_B0, 0))*AVG_0_0_LEV_10 + (-OPS_ACC(rhoE_B0, -1) + OPS_ACC(rhoE_B0, 0))*AVG_0_0_LEV_12 + (-OPS_ACC(rhou0_B0, -1) +
      OPS_ACC(rhou0_B0, 0))*AVG_0_0_LEV_11;
   ...
   AVG_0_0_LEV_22 = ((1.0/2.0))*(inv_AVG_a*inv_AVG_a)*gamma_m1;
    ...
    alpha_11 = (-OPS_ACC(rho_B0, 0) + OPS_ACC(rho_B0, 1))*AVG_0_0_LEV_10 + (-OPS_ACC(rhoE_B0, 0) + OPS_ACC(rhoE_B0, 1))*AVG_0_0_LEV_12 + (-OPS_ACC(rhou0_B0, 0) +
      OPS_ACC(rhou0_B0, 1))*AVG_0_0_LEV_11;
   ...
   AVG_0_0_LEV_22 = ((1.0/2.0))*(inv_AVG_a*inv_AVG_a)*gamma_m1;
    ...
    alpha_12 = (-OPS_ACC(rho_B0, 1) + OPS_ACC(rho_B0, 2))*AVG_0_0_LEV_10 + (-OPS_ACC(rhoE_B0, 1) + OPS_ACC(rhoE_B0, 2))*AVG_0_0_LEV_12 + (-OPS_ACC(rhou0_B0, 1) +
      OPS_ACC(rhou0_B0, 2))*AVG_0_0_LEV_11;
...
: (
   ...
   OPS_ACC(wk1_B0, 0) = 0.5*(AVG_0_REV_10*phi_star_0 + AVG_0_REV_11*phi_star_1 + AVG_0_REV_12*phi_star_2);

   OPS_ACC(wk2_B0, 0) = 0.5*(AVG_0_REV_20*phi_star_0 + AVG_0_REV_21*phi_star_1 + AVG_0_REV_22*phi_star_2);
