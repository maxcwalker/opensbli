...
//
__constant__ int dims_opensbliblock00Kernel001 [3][1];
static int dims_opensbliblock00Kernel001_h [3][1] = {{0}};
...
void opensbliblock00Kernel001_gpu(const ACC<double> &rho_B0,
  ...
  ACC<double> &a_B0)
{
   a_B0(0) = sqrt(gama*p_B0(0)/rho_B0(0));
...
int size0 ){
  ...
  if (idx_x < size0) {
    ...
    opensbliblock00Kernel001_gpu(argp0, argp1, argp2);
  }
...
void ops_par_loop_opensbliblock00Kernel001_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_opensbliblock00Kernel001_h[0][0] || xdim1 != dims_opensbliblock00Kernel001_h[1][0] || xdim2 != dims_opensbliblock00Kernel001_h[2][0]) {
